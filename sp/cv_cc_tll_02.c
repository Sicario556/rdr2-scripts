...
{
	if (!_is_scenario_group_enabled_hash(iLocal_59))
	{
		_set_scenario_group_enabled_hash(iLocal_59, true);
	}
	return true;
}
...
{
	_set_scenario_group_enabled_hash(iLocal_59, false);
	return true;
}
...
bool func_95(var uParam0)
{
	...
	if (!is_sphere_visible(vLocal_56, 1f))
	{
		_set_scenario_group_enabled_hash(iLocal_59, true);
		return true;
	}
