			...
			else
			{
				...
				switch (Local_14)
				{
					...
					case 37:
						...
						else if (func_10(&Local_14, &(Local_14.f_178), func_105(), 0, 1, 0) && !is_entity_in_volume(Global_35, Local_14.f_164, true, 0))
						{
							func_57(&Local_14, 6);
						}
						break;
					case 42:
						func_106(14, 2);
						if (_0x1f0e401031e20146(Local_14.f_179, func_26()) && (_get_anim_scene_progress(Local_14.f_179) >= 0.6f || _0x8d81e7824b7753f7(Local_14.f_179, "s_base_end", 1)))
						{
...
void func_16(int iParam0)
{
	if ((((((*iParam0 <= 2 || *iParam0 >= 49) || *iParam0 == 42) || *iParam0 == 44) || *iParam0 == 46) || *iParam0 == 3) || *iParam0 == 5)
	{
		if ((iParam0->f_246 != 3 || func_145(iParam0->f_211[0], 1, 0)) || func_145(iParam0->f_211[1], 1, 0))
		{
			...
			func_111(iParam0->f_211[0], 0, 0);
			func_111(iParam0->f_211[1], 0, 0);
			iParam0->f_246 = 3;
		}
	}
		...
		if (!func_8(iParam0->f_180, 2))
		{
			if (is_entity_in_volume(Global_35, iParam0->f_164, true, 0) && !is_ped_on_mount(Global_35))
			{
				if (iParam0->f_246 != 2 || !func_145(iParam0->f_211[0], 1, 0))
				{
					func_109(&(iParam0->f_190), 0);
					func_63(iParam0, 1);
					func_111(iParam0->f_211[0], 1, 0);
					func_111(iParam0->f_211[1], 1, 0);
					iParam0->f_246 = 2;
				}
...
void func_63(int iParam0, bool bParam1)
{
	...
	Var2 = "SPD_UC_ANT";
	Var2.f_1 = 648122183;
	func_184(iParam0->f_211[0], Var0, "", Var0.f_1, 0, 0, 0, 1, 0);
	func_184(iParam0->f_211[1], Var2, "", Var2.f_1, 0, 0, 0, 1, 0);
}
...
{
	func_190(&((*Global_1396257)[iParam0]->f_626), iParam1, 0);
}
...
void func_110(int iParam0, bool bParam1)
{
	...
	Var2 = "SPD_UC_ANT";
	Var2.f_1 = 648122183;
	func_191(iParam0->f_211[0], Var0, 100, "", Var0.f_1, 0, 0, 0, 1);
	func_184(iParam0->f_211[1], Var2, "", Var2.f_1, 0, 0, 0, 1, 0);
}
...
int func_112(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	iParam3 = iParam3;
	iParam4 = iParam4;
	if (!is_entity_dead(iParam2) && (func_197(iParam2, iParam3, 1, 1) < 70f || bParam5))
	{
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_195((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_196(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
int func_149(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_264(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_269(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_152(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0]->f_6 == 1 && func_286(func_285(-1342635612)) < 5)
	{
...
{
	func_190(&((*Global_1396257)[iParam0]->f_626), iParam1, 1);
}
...
bool func_160()
{
	if (((!func_290() && !func_291(Global_35, -208384378)) && (!does_entity_exist(func_220()) || !is_entity_in_air(func_220(), 1))) && (!does_entity_exist(_get_first_entity_ped_is_carrying(Global_35)) || !is_entity_in_air(_get_first_entity_ped_is_carrying(Global_35), 1)))
	{
		return true;
	}
	if (func_292())
...
bool func_161(var uParam0, vector3 vParam1, float fParam4, var uParam5, int iParam6, int iParam7, float fParam8)
{
	switch (*uParam5)
	{
		case 0:
			...
			break;
		case 1:
			if (func_294(*uParam0, vParam1, fParam4, iParam7, fParam8, 0) || get_script_task_status(*uParam0, 242628503, true) == 8)
			{
				return true;
			}
			break;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_341(1) || *uParam0 & 8192 != 0))
				{
...
bool func_226(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_354(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_352(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_353(uParam2)
				{
					func_348(uParam2, 1);
					return true;
				}
...
bool func_227(int iParam0, var uParam1)
{
	...
	if (func_344(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_353(uParam1)
		{
...
bool func_261(var uParam0, vector3 vParam1, int iParam4)
{
...
bool func_262(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (!is_itemset_valid(*uParam0))
	{
		*uParam0 = create_itemset(true);
...
bool func_266(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (func_259(iParam4, 2048))
		{
			iVar6 |= 4;
		}
		if (func_259(iParam4, 32768))
		{
			iVar6 |= 128;
		}
		if (func_259(iParam4, 4096))
		{
			iVar6 |= 16;
		}
		if (func_259(iParam4, 8388608) || func_259(iParam4, 8192))
		{
			iVar6 |= 256;
		}
		if (func_259(iParam4, 4194304))
		{
			iVar6 |= 64;
		}
		if (func_259(iParam4, 268435456))
		{
			iVar6 |= 8192;
		}
...
bool func_290()
{
	if (_is_ped_carrying(Global_35) || func_292())
	{
		return true;
	}
	return false;
...
{
	fVar0 = func_417(get_entity_heading(iParam0));
...
void func_313(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3)
{
	iVar0 = 0;
...
void func_381(int iParam0, vector3 vParam1, int iParam4)
{
...
void func_386(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_196(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_109(iParam0, 0);
		}
...
void func_400(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_111((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
void func_413(int iParam0)
{
	...
	if (!func_407(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
int func_478(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_382(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_481(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
