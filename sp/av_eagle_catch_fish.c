void __EntryFunction__()
{
	...
	Var0 = Local_42;
	Var0.f_1 = Local_42.f_11;
	Var0.f_483 = { Local_42.f_1 };
	Var0.f_486 = { Local_42.f_4 };
	Var0.f_489 = Local_42.f_7;
	Var0.f_20[0] = Local_42.f_8;
	Var0.f_453 = Local_42.f_9;
	Var0.f_500 = Local_42.f_10;
	Var0.f_503 = Local_42.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 10732, 10769, 11794);
}
...
{
	func_46(uParam0, "EAGLE_CATCH_FISH", "script@ambient@animal@EAGLE_CATCH_FISH@action", vParam1, vParam4);
...
{
	sVar0 = "script_amb@animal@EAGLE_CATCH_FISH";
	sVar1 = "eagle_exit_a";
	sVar2 = "fish_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	if (!&uParam0->f_469[0])
	{
		...
		if ((func_60(uParam0, &uLocal_11, 0) || func_61(&(uParam0->f_20[0]), Global_35, 1) < 225f) || func_62(Global_35, uParam0->f_483, 1) < 49f)
		{
							...
							if (!is_entity_dead(&(uParam0->f_20[0])))
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
								{
									if (does_entity_exist(&(uParam0->f_20[1])))
									{
										...
										attach_entity_to_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), get_ped_bone_index(&(uParam0->f_20[0]), 38142), vVar3, vVar6, true, false, false, false, 2, true, true, false);
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (is_entity_on_screen(&(uParam0->f_20[iVar2])) || ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_61(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f))
				{
					return 0;
				}
			}
...
void func_68(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 914255117))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_61(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_61(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_63(&(uParam0->f_490)))
							{
