...
{
	func_33(uParam0, 10745, 10864, 11206);
}
...
{
	func_46(uParam0, "MAN_STAND_AT_WAGON", "", vParam1, vParam4);
	func_49(uParam0, 0, "MSAWP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -2.5f, 0f), (179f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, "WAGON", iLocal_38, vParam1, vParam4.z, 0, 0, 1, 0);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_68(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				_give_weapon_to_ped_2(&(uParam0->f_20[0]), -183018591, 500, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				task_start_scenario_at_position(&(uParam0->f_20[0]), 1452745259, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, "WORLD_HUMAN_GUARD_LEAN_WALL_MALE_E", -1f, false);
				func_69(uParam0->f_20[0], 0, 1);
				set_ped_config_flag(&(uParam0->f_20[0]), 297, true);
				set_ped_config_flag(&(uParam0->f_20[0]), 130, false);
				Local_39.f_3 = Global_35;
				Local_39.f_7 = 0;
			}
			iLocal_9 = 1;
			break;
		case 1:
			...
			break;
		case 2:
			_0x66f9eb44342bb4c5(&(uParam0->f_20[0]), &Local_39);
			break;
	}
	return 0;
}
...
bool func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_132(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_168(1) || *uParam0 & 8192 != 0))
				{
...
bool func_127(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_171(iParam0, uParam1, iVar2))
			{
				return false;
			}
			if (func_172(iParam0, iVar2) <= func_173(uParam1))
			{
				return true;
			}
			break;
...
bool func_129(int iParam0, var uParam1)
{
	...
	if (!is_entity_dead(iParam0))
	{
		if (func_177(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_178(uParam1);
			if (func_179(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
bool func_130(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_181(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_178(uParam2);
		if (func_179(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_180(uParam2)
				{
					func_175(uParam2, 1);
					return true;
				}
...
bool func_131(int iParam0, var uParam1)
{
	...
	if (func_171(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = get_game_timer();
		}
		else if (get_game_timer() - uParam1->f_3) > func_180(uParam1)
		{
			fVar3 = func_178(uParam1);
...
{
	if (uParam2->f_12 < IntToFloat(func_184(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (is_shocking_event_in_sphere(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_186(iParam1, vVar0, vVar4))
					{
						func_175(uParam2, 1);
						return true;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (is_shocking_event_in_sphere(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_186(iParam1, vVar0, vVar7))
					{
						func_175(uParam2, 1);
						return true;
					}
...
bool func_137(int iParam0, var uParam1)
{
	...
	{
		if (!func_171(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_187(&(Global_1935630->f_34[iVar0]));
			...
			if (func_188(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_189(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_190(uParam1, iParam0, fVar1, iVar0))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				uParam1->f_10 = iParam0;
...
bool func_143(int iParam0, int iParam1)
{
	if (!is_entity_dead(iParam1))
	{
		...
		if (func_194(iParam0, iParam1, 1, 1) < 4f)
		{
...
bool func_145(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !is_this_model_a_train(get_entity_model(iVar0)))
	{
		...
		if (func_195(iVar0, iParam1, vVar1))
		{
...
bool func_148(var uParam0, int iParam1)
{
	...
	fVar0 = func_173(uParam0);
	if (uParam0->f_12 > func_197(uParam0) && uParam0->f_12 > fVar0)
	{
		return false;
	}
	iVar2 = func_198(iParam1);
	iVar1 = func_199(uParam0->f_14);
...
int func_149(int iParam0, int iParam1, var uParam2)
{
	...
	return func_200(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_154(int iParam0, var uParam1)
{
	...
	else if (func_146() - uParam1->f_4) > func_204(uParam1)
	{
		return func_205(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
{
	return func_194(iParam0, iParam1, 1, 1);
}
...
bool func_174(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_194(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_179(var uParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_217(iVar0, 0)))
		{
			if (func_219(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_186(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_190(var uParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_222(iParam1))
	{
...
bool func_195(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_200(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	if (Global_1935630->f_40 != 0)
	{
		bVar0 = true;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_194(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_194(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
bool func_201(int iParam0, var uParam1, bool bParam2)
{
	...
	if (does_entity_exist(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (_0x06087579e7aa85a9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (has_entity_clear_los_to_entity(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_202(uParam1, iVar0))
					{
						return true;
					}
				}
	...
	if (does_entity_exist(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_202(uParam1, iVar1))
				{
...
int func_203(int iParam0)
{
	...
	return func_225((*Global_1347702)[58]->f_15, 1);
}
...
int func_205(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
bool func_218(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_219(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
