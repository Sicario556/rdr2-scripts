...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_51(uParam0, 0, "MWLP_MAN", iVar0, vParam1, fVar2, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MWLP_HORSE", iVar1, vParam1, fVar2, 1, 1, 1, 1, 41788943, 1);
	...
	switch (iLocal_9)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				func_69(&(uParam0->f_20[1]), uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 2, 1073741824);
				func_70(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 1, -1, 1);
				attach_entity_to_entity(&(uParam0->f_372[0]), &(uParam0->f_20[1]), get_ped_bone_index(&(uParam0->f_20[1]), 62111), -0.32f, 0.05f, -0.22f, 0f, 53f, 0f, false, false, false, false, 2, true, true, false);
			...
			{
				set_entity_lod_dist(&(uParam0->f_372[0]), 150);
			}
			iLocal_9 = 1;
			break;
		case 1:
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_106(Global_35) && is_player_teleport_active())
	{
	}
	if (func_107(iParam0))
	{
		if (func_108(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_109(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_109(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_109(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_109(iParam5, 32), true);
	...
	else if (func_109(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_109(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_109(iParam5, 64))
		{
