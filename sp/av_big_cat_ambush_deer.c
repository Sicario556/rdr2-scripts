void __EntryFunction__()
{
	...
	Var0 = Local_62;
	Var0.f_1 = Local_62.f_11;
	Var0.f_483 = { Local_62.f_1 };
	Var0.f_486 = { Local_62.f_4 };
	Var0.f_489 = Local_62.f_7;
	Var0.f_20[0] = Local_62.f_8;
	Var0.f_453 = Local_62.f_9;
	Var0.f_500 = Local_62.f_10;
	Var0.f_503 = Local_62.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	fLocal_61 = get_random_float_in_range(10f, 20f);
}
...
{
	if (!_has_scenario_type_loaded(-963073294, false))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	...
	if (!_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[1])))
	{
		return false;
	}
...
{
	_request_scenario_type(-963073294, 1, 0, 0);
	func_57(&uLocal_23, 0);
	func_58(&uLocal_23, 1);
	func_59(&uLocal_23, 1);
	func_60(&uLocal_23, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_51 == 1)
		{
			if ((func_65(uParam0, &uLocal_23, 1) || func_66(Global_35, &(uParam0->f_20[0]), 1) <= 400f) || func_66(Global_35, &(uParam0->f_20[1]), 1) <= 400f)
			{
				bLocal_51 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_51)
	{
					...
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								if (_get_anim_scene_entity_matrix(uParam0->f_3.f_1, uParam0->f_20[0]->f_1, &Local_11, true, "pbl_action", 2))
								{
		...
		if (&uParam0->f_469[2])
		{
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
							{
								...
								func_56(uParam0->f_20[0], 1, 1);
								uVar0[0] = Global_35;
								_0x34eddd59364ad74a(&(uParam0->f_20[0]), &uVar0);
								_0xa3a9299c4f2adb98(&(uParam0->f_20[0]));
								task_start_scenario_at_position(&(uParam0->f_20[0]), -963073294, Local_11.f_6, Local_11.f_9.f_2, 0, false, true, 0, -1f, false);
			...
			else if (!&uParam0->f_469[4])
			{
				...
				{
					if (_is_ped_using_scenario_hash(&(uParam0->f_20[0]), -963073294))
					{
						if (!_0x0c3cb2e600c8977d(&(uParam0->f_20[0]), 0) && !func_79(&uLocal_58))
						{
							task_smart_flee_ped(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 25f, -1, 0, 1f, 0);
...
float func_66(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_109(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_71(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 830334344))
		{
			activate_physics(&(uParam0->f_20[1]));
			set_ped_to_ragdoll(&(uParam0->f_20[1]), 1000, 1000, 0, false, false, false);
			func_115(&(uParam0->f_20[1]), 0, 0);
		}
		else if (!func_116(&(uParam0->f_20[1]), 518218985))
		{
			if (has_anim_event_fired(&(uParam0->f_20[1]), -344192410))
			{
				if (is_entity_dead(&(uParam0->f_20[0])))
				{
					set_ped_config_flag(&(uParam0->f_20[1]), 336, true);
					set_ped_to_ragdoll(&(uParam0->f_20[1]), 250, 250, 0, false, false, false);
				}
			}
	...
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (!func_116(&(uParam0->f_20[0]), 1287254818))
		{
			_0x802092b07e3b1eea(&(uParam0->f_20[0]), Global_36, 0);
			if (has_anim_event_fired(&(uParam0->f_20[0]), 8631722))
			{
				if (is_entity_dead(&(uParam0->f_20[1])))
				{
					set_ped_to_ragdoll(&(uParam0->f_20[0]), 250, 250, 0, false, false, false);
				}
			}
			if (func_66(&(uParam0->f_20[0]), Global_35, 1) < 900f)
			{
				task_combat_ped(&(uParam0->f_20[0]), Global_35, 0, 0);
			}
			else
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[0]), Global_35, 2, 256, -1082130432, -1, 0);
			}
			set_ped_keep_task(&(uParam0->f_20[0]), true);
		}
	}
...
void func_73(var uParam0)
{
	if (!bLocal_53)
	{
		if (has_anim_event_fired(&(uParam0->f_20[0]), 8631722))
		{
			set_ped_config_flag(&(uParam0->f_20[0]), 138, true);
			bLocal_53 = true;
		}
	}
	else if (!has_anim_event_fired(&(uParam0->f_20[0]), 8631722))
	{
		set_ped_config_flag(&(uParam0->f_20[0]), 138, false);
		bLocal_53 = false;
	}
	if (!bLocal_54)
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), -344192410))
		{
			set_ped_config_flag(&(uParam0->f_20[1]), 138, true);
			bLocal_54 = true;
		}
	}
	else if (!has_anim_event_fired(&(uParam0->f_20[1]), -344192410))
	{
		set_ped_config_flag(&(uParam0->f_20[1]), 138, false);
		bLocal_54 = false;
	}
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_66(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_66(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_67(&(uParam0->f_490)))
							{
...
bool func_85(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_127(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_86(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_128(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_108(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_148(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_114(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
