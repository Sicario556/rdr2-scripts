void __EntryFunction__()
{
	...
	{
		_0xe7282390542f570d(vScriptParam_0.x);
		terminate_this_thread();
	}
	if (!_does_scenario_point_exist(vScriptParam_0.y))
	{
		_0xe7282390542f570d(vScriptParam_0.x);
		terminate_this_thread();
	}
...
bool func_1(struct<2> Param0, var uParam2)
{
	...
	{
		case 0:
			if (func_2() && _is_imap_active_2(204868257))
			{
				iLocal_0 = func_3("INSPECT_GENERIC", -719620017, _get_scenario_point_coords(Param0.f_1, true), 4f, 1, 1, 0, 3, 570, 4000, 10, 1073741824, 0, 1704213876, 0);
				iLocal_1 = create_camera_with_params(26379945, 2511.907f, -1160.024f, 52.5668f, -3.9115f, 0f, -90.0969f, 51.282f, false, 2);
				iLocal_10 = 1;
			}
			break;
		case 1:
			if (!bLocal_2)
			{
				...
				{
					set_cam_active(iLocal_1, true);
					_0x80fdeb3a9e9aa578(Global_35, 0);
...
int func_3(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_14(iVar0, 2))
		{
			if (func_15(vParam2, (*Global_1945938)[iVar0]->f_6, 0.01f, 1) && iParam1 == (*Global_1945938)[iVar0]->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
...
void func_26(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_14(iParam0, 8))
		{
