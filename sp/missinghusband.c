...
int func_55(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!_does_volume_exist(func_102(iParam3)))
	{
		return 0;
	}
	if (!is_entity_in_volume(Global_35, func_102(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if (iParam7 && func_107(get_player_index(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_129(&cVar6, 109029619), sVar9, func_129(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_129(&cVar6, 109029619), func_129(&cVar10, 109029619));
		}
...
bool func_106(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_164(iVar0) && func_165((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
char* func_129(char* sParam0, int iParam1)
{
	...
	return func_180(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_132(int iParam0)
{
	...
	if (func_181())
	{
		if (!func_182((*Global_1835011)[3]->f_1, 1))
		{
...
void func_143(int iParam0)
{
	...
	if (!func_137(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_186(Global_1935369->f_5[iParam0]->f_6, 1);
	func_187(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_113(Global_1914319->f_3[iParam0]->f_21) && func_189(Global_1914319->f_3[iParam0]->f_21))
	{
		func_190(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_191(Global_1914319->f_3[iParam0]->f_10, 0);
...
{
	func_210(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
