...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_203(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_205(iParam0);
					_0x7b204f88f6c3d287(func_206(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_206(iParam0, 0));
					func_207(iParam0);
				}
			}
			else
...
void func_116(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_217(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	func_218(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_221(iParam0), 137, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_221(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_221(iParam0), 204, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_221(iParam0);
	if (((does_entity_exist(iVar1) && func_223(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_236(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_237(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
{
	uParam0->f_107[iParam1]->f_32.f_35 = fParam2;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_262(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_57(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_263(uParam0->f_107[iVar12]->f_2);
				}
				else if (func_50(uParam0->f_107[iVar12]->f_7))
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_204(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_201(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_167(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_201(uParam0->f_107[iVar0]->f_8.f_3))
			{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_264(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_265(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_171(var uParam0, int iParam1)
{
	...
	func_271(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_272(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_172(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_273(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_173(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_275(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_175(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_276(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_278(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_278(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_183(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_279(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_185(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_201(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
				iVar0 = func_280(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_280(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_186(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_274() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_199(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_297(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_222(int iParam0)
{
	if (func_50(iParam0))
	{
		if (does_entity_exist(func_221(iParam0)))
		{
...
int func_248(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
...
bool func_269(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_280(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_280(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
int func_320(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_263(iParam0), 0);
}
...
int func_321(int iParam0, bool bParam1)
{
	...
	{
		func_227(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_215() == -1)
		{
		...
		case 6:
			if (func_120(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_272(Global_1360165[iParam0], 1);
				}
			}
			func_384(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_271(Global_1360165[iParam0]))
				{
				}
			}
...
int func_371(var uParam0, int iParam1)
{
	...
	{
		func_264(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_204(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_201(vVar0)) && !func_202(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
			...
			{
				_0x63aa2b8eb087886a(func_204(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_387(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_219(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_219(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_219(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_219(iParam5, 32), true);
	...
	else if (func_219(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_219(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_219(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_393(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_225(iParam0)))
	{
		return false;
	}
...
bool func_408(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_204(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_273(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_410(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_221(iParam1)))
	{
		_0x931b241409216c1f(func_221(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_221(iParam1), iParam0);
...
int func_418(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3 && does_entity_exist(func_221(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
