		...
		if (get_game_timer() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_33));
					...
					Global_1897950 = -1;
					iLocal_34 = (get_game_timer() + iLocal_30);
					iLocal_31 = 2;
					break;
				case 2:
					if (func_11() || iLocal_34 < get_game_timer())
					{
						func_12(iLocal_33);
						iLocal_34 = (get_game_timer() + iLocal_30);
						iLocal_31 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_33) || iLocal_34 < get_game_timer())
					{
						func_14(iLocal_33);
						iLocal_34 = (get_game_timer() + iLocal_30);
						iLocal_31 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_33) || iLocal_34 < get_game_timer())
					{
						func_16(iLocal_33);
						iLocal_34 = (iLocal_30 + get_game_timer());
						iLocal_31 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_33)))
					{
						if (func_17(func_6(iLocal_33), 4) && !iLocal_34 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_33) || iLocal_34 < get_game_timer())
							{
								func_19(iLocal_33, 4);
								iLocal_34 = (iLocal_30 + get_game_timer());
								iLocal_31 = 7;
							...
							Jump @807; //curOff = 475
							if (iLocal_34 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_33);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_33]->f_10);
							if ((*Global_1888801)[iLocal_33]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_33]->f_11);
							}
							Jump @807; //curOff = 788
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_33]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_33]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_5(int iParam0)
{
	...
	_0x1bc47a9dedc8df5d(1934463007, 0);
}
...
bool func_11()
{
	iLocal_14 = _create_volume_box_with_custom_name(894.7135f, 260.2712f, 129.5878f, 0f, 0f, -0.492423f, 88.10741f, 65.87466f, 39.61107f, "Larned Sod - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_16 = _create_volume_aggregate_with_custom_name("Larned Sod - m_volTenantOwner_Threat Agg");
		_0x39816f6f94f385ad(iLocal_16, 901.97f, 261.5441f, 115.7395f, 0f, 0f, -0.825771f, 12.77186f, 7.290863f, 4.182421f);
		_0x39816f6f94f385ad(iLocal_16, 886.826f, 258.2958f, 120.034f, 0f, 0f, 0f, 6.865234f, 13.71682f, 18.96277f);
		_0xbce668aaf83608be(iLocal_16, 887.2566f, 258.3552f, 121.8763f, 0f, 0f, -0.580099f, 4.594322f, 6.421996f, 6.34872f);
		_0x39816f6f94f385ad(iLocal_16, 889.3727f, 250.7424f, 120.034f, 0f, 0f, -71.9487f, 5.361883f, 5.311553f, 18.96277f);
		_0x39816f6f94f385ad(iLocal_16, 884.868f, 250.9919f, 120.034f, 0f, 0f, -31.54634f, 3.975522f, 1.561551f, 18.96277f);
		_0x39816f6f94f385ad(iLocal_16, 886.9943f, 250.5041f, 120.034f, 0f, 0f, -51.34731f, 3.201982f, 2.32918f, 18.96277f);
		_0x39816f6f94f385ad(iLocal_16, 943.6283f, 240.538f, 120.034f, 0f, 0f, 36.22269f, 2.583991f, 1.168234f, 18.96277f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Larned Sod - m_volTenantOwner_Restricted Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_16);
		_0xbce668aaf83608be(iLocal_15, 899.733f, 262.0444f, 121.8763f, 0f, 0f, -8.182039f, 26.6654f, 26.8703f, 20f);
		_0xbce668aaf83608be(iLocal_15, 943.883f, 240.5778f, 121.8763f, 0f, 0f, -8.182041f, 4.201227f, 4.104132f, 20f);
		iLocal_17 = _create_volume_aggregate_with_custom_name("Larned Sod - m_volTenantOwner_Warning Agg");
		_0x6e0d3c3f828da773(iLocal_17, iLocal_15);
		_0xbce668aaf83608be(iLocal_17, 895.8494f, 261.3904f, 121.8763f, 0f, 0f, -8.182039f, 38.88291f, 38.47965f, 20f);
		_0xbce668aaf83608be(iLocal_17, 940.5317f, 241.0733f, 121.8763f, 0f, 0f, -8.182038f, 10.83869f, 7.036053f, 20f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("Larned Sod - m_volTenantOwner_Registration Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_17);
		_0xbce668aaf83608be(iLocal_18, 895.8494f, 261.3904f, 121.8763f, 0f, 0f, -8.182039f, 46.9045f, 46.40221f, 20f);
		sLocal_19 = "LARNED_SOD";
		_create_guard_zone(sLocal_19);
		_0x8c598a930f471938(sLocal_19, iLocal_18);
		_0x35815f372d43e1e5(sLocal_19, iLocal_15);
		_0xa1b0e6301e2e02a6(sLocal_19, iLocal_16);
		_0xad3e07c37a7c1adc(sLocal_19, iLocal_17);
		_set_guard_zone_position(sLocal_19, 901.2f, 262.7f, 116.4f);
		_0xa8a74aa79fb67159(sLocal_19, iLocal_14);
	}
	return true;
}
...
void func_28(int iParam0)
{
	...
	if (!func_53(iVar1, 0))
	{
		...
		_0x53d05d60e5f5b40c(iLocal_15, 3, 1, func_55(iVar0));
		_0x53d05d60e5f5b40c(iLocal_15, 3, 1, func_55(735));
		_0x931b241409216c1f(func_52(iVar0), func_52(735), 0);
	}
}
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_62(&Global_1935630, 16384)) || func_62(&Global_1935630, 8388608))
	{
		return;
	}
...
void func_46(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_47(iParam0, 0, 0);
	if (func_87(iParam0))
	{
		...
		if (bParam3)
		{
			func_88(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_60()
{
	...
	{
		_0x24c82ef607105faa(func_52(735), -1049646341);
		bLocal_29 = true;
	}
...
void func_61()
{
	iVar0 = _0x112ddf56300bc6e5(-1956453623);
	if (!_0x800df3fc913355f3(iVar0))
	{
...
bool func_66(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_105(iParam0));
}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_107(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_119(&cVar6, 109029619), sVar9, func_119(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_119(&cVar6, 109029619), func_119(&cVar10, 109029619));
		}
...
{
	_remove_guard_zone(sLocal_19);
	func_134(iLocal_17);
	func_134(iLocal_16);
	func_135(&uLocal_20, 106);
	if (_does_volume_exist(iLocal_15))
	{
		_0x998202b206872672(iLocal_15);
...
void func_84(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_139(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_88(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_87(iParam0))
	{
...
int func_98(int iParam0, bool bParam1)
{
	...
	{
		func_144(iParam0, _create_persistent_character(func_143(iParam0)));
		if (func_20() == -1)
		{
			if (func_140(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_55(iParam0));
				func_145(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_55(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_55(iParam0)))
	{
		func_145(iParam0, 128);
		return 1;
	}
	func_144(iParam0, _create_persistent_character(func_143(iParam0)));
	_0x4f81ead1de8fa19b(func_55(iParam0));
	if (func_140(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_55(iParam0));
		func_145(iParam0, 2048);
...
bool func_99(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_52(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_55(iParam0));
}
	...
	if (has_named_ptfx_asset_loaded(-458373790))
	{
		if (!func_147(uParam0->f_1, 8))
		{
			if (!does_particle_fx_looped_exist(*uParam0))
			{
				...
				uParam0->f_2 = func_150(get_distance_between_coords(get_gameplay_cam_coord(), vParam1, true));
				...
				*uParam0 = start_particle_fx_looped_at_coord(sVar0, vParam1, 0f, 0f, 0f, func_154(iParam4), false, false, false, false);
				uParam0->f_4 = get_frame_count();
				if (func_155(vParam1, 1) > (get_gameplay_cam_fov() + 15f))
				{
...
char* func_107(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
...
bool func_122(int iParam0)
{
	...
	if (func_167())
	{
		if (!func_168((*Global_1835011)[3]->f_1, 1))
		{
...
void func_133(int iParam0)
{
	...
	if (!func_127(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_172(Global_1935369->f_5[iParam0]->f_6, 1);
	func_173(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_96(Global_1914319->f_3[iParam0]->f_21) && func_175(Global_1914319->f_3[iParam0]->f_21))
	{
		func_176(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_177(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_139(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_141(int iParam0, bool bParam1)
{
	...
	func_184(iParam0);
	_0xfc77c5b44d5ff7c0(func_55(iParam0));
	func_144(iParam0, 0);
	return 1;
}
...
void func_149(var uParam0, vector3 vParam1, int iParam4, float fParam5)
{
	...
	else
	{
		...
		fVar3 = func_187(uParam0->f_2, uParam0->f_3, fVar0);
...
{
	vVar0 = { func_189(0) };
	vVar3 = { func_190(vParam0 - get_gameplay_cam_coord()) };
	if (bParam3)
	{
...
{
	func_200(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
{
	fVar0 = (2f * sin((180f * (fParam0 / func_151(iParam1)))));
	if (fVar0 < 0f)
	{
		return 0f;
	}
...
bool func_196(vector3 vParam0, int iParam3)
{
	func_211(iParam3, &vVar0, &Var3, &uVar6);
	if (func_212(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
