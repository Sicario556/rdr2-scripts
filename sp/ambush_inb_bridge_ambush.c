...
bool func_20()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(Local_15[iVar0]), 0, 0))
		{
			...
			set_ped_combat_attributes(&(Local_15[iVar0]), 45, false);
			set_ped_combat_attributes(&(Local_15[iVar0]), 47, true);
			set_ped_combat_attributes(&(Local_15[iVar0]), 51, false);
			set_ped_combat_attributes(&(Local_15[iVar0]), 62, false);
			...
			switch (iVar0)
			{
				...
				case 2:
					...
					_task_use_scenario_point(&(Local_15[iVar0]), &(Local_274.f_47[0]), 0, -1, false, true, 0, false, -1f, false);
					break;
			}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_187(to_float(iVar0), 1, 0);
	}
	else
	{
		func_187((to_float(200) / 3f), 1, 0);
	}
}
	...
	if (func_30(iParam0, 16384))
	{
		if (func_61(Global_35, 0, 1))
		{
			if (!func_30(iParam0, 1024))
			{
				...
				{
					compendium_gang_ambush_survived(func_188(iParam0->f_181));
...
void func_49()
{
	if (func_61(&(Local_15[2]), 0, 0))
	{
		...
		{
			_task_flee_from_coord(&(Local_15[2]), Local_15.f_209, 0f, 0f, 0f, 300f, -1, 294912, 2f, 0);
		}
	}
	func_175();
}
...
bool func_83()
{
	...
	*Local_274.f_51[0] = { func_246(&Local_274) };
	*Local_274.f_51[1] = { func_247(&Local_274) };
	*Local_274.f_58[0] = { func_248(&Local_274) };
	*Local_274.f_58[1] = { func_249(&Local_274) };
...
void func_126(int iParam0)
{
	...
	func_272(&(Local_15[iParam0]), -618550132, -1, 0, 0, 1056964608, 1065353216, 0);
	iVar0 = func_273(iParam0);
	switch (iVar0)
	{
		case 1845102363:
			func_274(&Local_15, &(Local_15[iParam0]), 1845102363, 1);
			break;
		default:
...
bool func_142()
{
	...
	if (Local_274.f_3 >= 1)
	{
		if (func_280(*Local_274.f_58[0], *Local_274.f_58[1], Global_36))
		{
			func_279(1);
			return true;
		}
...
void func_143()
{
	if (!func_61(Local_15.f_56, 0, 0))
	{
		...
		if (func_61(Local_15.f_56, 0, 0))
		{
			set_entity_can_be_damaged_by_relationship_group(Local_15.f_56, false, func_282(Local_15.f_181));
		}
	}
}
...
void func_144()
{
	if (_0x4a98e228a936dbcc(&(Local_15[0])) == 841045117)
	{
		bVar2 = true;
	}
	...
	while (iVar0 <= 4)
	{
		...
		else
		{
			switch (iVar0)
			{
				...
				case 3:
				case 4:
					if (!is_entity_visible(&(Local_15[iVar0])))
					{
						if (is_entity_on_screen(&(Local_15[iVar0])))
						{
							delete_ped(Local_15[iVar0]);
							Jump @324; //curOff = 200
						}
...
bool func_151()
{
	...
	if (func_140(&(Local_274.f_27[4]), vVar0))
	{
		...
		{
			if (!_get_ped_crouch_movement(Global_35) || _0x06087579e7aa85a9(&(Local_15[2]), Global_35, -1f, -1f, -1f, -1f))
			{
				return true;
			}
		}
	...
	if (bVar1 && iParam0->f_182.f_17 & 1 != 0)
	{
		if (!func_294(&(iParam0->f_182), 2))
		{
			...
			else
			{
				...
				{
					bVar4 = func_302(Global_35, &(iParam0->f_182.f_6), iParam0->f_182.f_5, 0, 0, 1084227584, 100, 0, 0);
				}
				if (bVar4)
				{
...
bool func_155()
{
	...
	switch (Local_274.f_5)
	{
		case 0:
			...
			func_284(&(Local_15[2]), Global_36, 2, 0, 3);
			task_follow_nav_mesh_to_coord(&(Local_15[2]), vVar0, 2f, 20000, 0.25f, 0, 40000f);
			func_158(&Local_274, 1);
			break;
		case 1:
			func_306();
			if (func_47(Local_274.f_8[1], 0.5f))
			{
				func_190(Local_274.f_8[1]);
		...
		case 2:
			func_306();
			if (func_47(Local_274.f_8[1], 1.5f) || func_222(&(Local_15[0]), 1116471296, -1082130432, -1082130432, -1082130432))
			{
				func_307();
				func_190(Local_274.f_8[1]);
		...
		case 3:
			func_306();
			if (func_47(Local_274.f_8[1], 2.5f))
			{
		...
		case 4:
			func_306();
			if (func_47(Local_274.f_8[1], 6.5f))
			{
				func_190(Local_274.f_8[1]);
...
void func_156()
{
	...
	if (!func_280(*Local_274.f_51[0], *Local_274.f_51[1], Global_36))
	{
		return;
	}
	iVar0 = 0;
		...
		case 3:
			if (!func_139(&Local_274, 4096))
			{
				if (func_327(-2f, 1, 0, 0))
				{
					...
					while (iVar0 <= 4)
					{
						if (func_61(&(Local_15[iVar0]), 0, 0) && is_entity_visible(&(Local_15[iVar0])))
						{
...
void func_175()
{
	if (func_61(Local_15.f_56, 0, 0))
	{
		set_entity_can_be_damaged_by_relationship_group(Local_15.f_56, true, func_282(Local_15.f_181));
	}
}
...
void func_185(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_343(Global_1310750[iVar0], iParam0))
		{
			if (!func_344(iVar0))
			{
				iVar1 = 1;
...
void func_256(int iParam0, float fParam1)
{
	...
	func_379(iParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432);
	vVar0 = { iParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { iParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_364(vVar0, vVar3, 0) };
	vVar9 = { func_365(vVar0, vVar3, 0) };
...
int func_302(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_369(*uParam1, 2))
	{
		...
		else if ((func_184(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_184(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_184(iParam2, 1024))) || func_184(iParam2, 8)) && !func_369(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_415(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_184(iParam2, 4096)) && !func_369(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_415(uParam1, 2048);
			func_415(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_184(iParam2, 32)) && !func_369(*uParam1, 5632))
		{
...
void func_303()
{
	...
	if (Local_274.f_5 >= 2)
	{
		if (func_61(&(Local_15[2]), 0, 0))
		{
			if ((func_152(&(Local_15[2]), Global_36, 0) < 9f || func_280(*Local_274.f_58[0], *Local_274.f_58[1], get_entity_coords(&(Local_15[2]), true, false))) || has_entity_been_damaged_by_any_ped(&(Local_15[2])))
			{
				clear_ped_tasks(&(Local_15[2]), 1, 0);
				task_combat_ped(&(Local_15[2]), Global_35, 0, 0);
				func_285(&Local_15, 2, 831283580, 0);
				set_ped_combat_attributes(&(Local_15[2]), 45, true);
...
void func_307()
{
	...
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, vVar1, 2f, 20000, 6f, 1, 40000f);
	...
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, vVar1, 2f, 20000, 4f, 1, 40000f);
	task_go_to_coord_while_aiming_at_entity(0, vVar1, Global_35, 2f, 0, 1056964608, 1082130432, 1, 0, 0, -687903391, 20000, 0);
	task_combat_ped(0, Global_35, 33554432, 0);
...
void func_310(int iParam0)
{
	...
	if (would_entity_be_occluded(363815774, get_entity_coords(&(Local_15[iParam0]), true, false), true))
	{
		func_129(&Local_15, iParam0, 1);
		func_421(&(Local_15[iParam0]), vVar0, 4f, 1, 0);
		set_ped_combat_attributes(&(Local_15[iParam0]), 51, true);
		_set_ped_crouch_movement(&(Local_15[iParam0]), true, 0, false);
		task_combat_ped(&(Local_15[iParam0]), Global_35, 0, 0);
		func_285(&Local_15, iParam0, 831283580, 0);
	}
	else
	{
		delete_ped(Local_15[iParam0]);
	}
}
...
bool func_321(int iParam0, int iParam1)
{
	if (does_entity_exist(iParam0) && is_entity_a_ped(iParam0))
	{
		...
		return func_426(iParam0, 2084597891, iParam1, iVar0);
	}
		...
		while (iVar0 <= 4)
		{
			switch (iVar0)
			{
				...
				case 4:
					if (func_61(&(Local_15[iVar0]), 0, 0))
					{
						_0xfc3db99c8144cd81(&(Local_15[iVar0]), &(Local_274.f_27[5]), 0, 0, 0);
					}
					break;
			}
			iVar0++;
		...
		while (iVar0 <= 4)
		{
			switch (iVar0)
			{
				...
				case 1:
					if (func_61(&(Local_15[iVar0]), 0, 0))
					{
						_0xfc3db99c8144cd81(&(Local_15[iVar0]), &(Local_274.f_27[6]), 0, 0, 0);
					}
					break;
			}
			iVar0++;
...
{
	iParam1->f_27[5] = _create_volume_box_with_custom_name(2814.386f, 445.5465f, 67.50465f, 0f, 0f, 62.93483f, 5.748168f, 39.38161f, 10f, "volBridge");
	iParam1->f_27[4] = _create_volume_cylinder_with_custom_name(2813.597f, 445.7023f, 59.1671f, 0f, 0f, -27f, 60f, 35f, 15f, "volBridgeDetect");
	iParam0->f_237 = _create_volume_cylinder_with_custom_name(iParam0->f_209, 0f, 0f, 0f, 110f, 110f, 40f, "volAmbush");
	if (func_139(iParam1, 1))
	{
		iParam1->f_27[6] = _create_volume_aggregate_with_custom_name("volBridgeFrontDef");
		_0x39816f6f94f385ad(&(iParam1->f_27[6]), 2827.341f, 439.3731f, 67.50465f, 0f, 0f, 62.93483f, 7f, 28.56506f, 9.370356f);
		_0x39816f6f94f385ad(&(iParam1->f_27[6]), 2841.807f, 437.2561f, 64.24197f, 0f, 0f, 153.2607f, 11.81811f, 21.68164f, 9.370356f);
		iParam1->f_27[3] = _create_volume_box_with_custom_name(2806.544f, 450.0001f, 67.50465f, 0f, 0f, 62.93483f, 7f, 25f, 10f, "volTrigger");
		iParam1->f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_27[1]), 2812.615f, 446.5732f, 47.3556f, 0f, 0f, -25.3182f, 18.13761f, 436.6708f, 30.21985f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(2788.401f, 459.2708f, 67.50465f, 0f, 0f, 62.93483f, 28.68821f, 31.2372f, 10f, "volSlow");
		iParam0->f_182[1] = _create_volume_box_with_custom_name(2803.505f, 451.5533f, 67.50465f, 0f, 0f, 62.93483f, 7.022682f, 31.2372f, 10f, "volSlower");
		iParam0->f_182[2] = _create_volume_box_with_custom_name(2820.574f, 442.8313f, 67.50465f, 0f, 0f, 62.93483f, 7f, 28.56506f, 9.370356f, "volSlowest");
	}
	else
	{
		iParam1->f_27[6] = _create_volume_aggregate_with_custom_name("volBridgeFrontDef");
		_0x39816f6f94f385ad(&(iParam1->f_27[6]), 2803.01f, 451.7733f, 67.50465f, 0f, 0f, -117.505f, 7f, 28.56506f, 9.370356f);
		_0x39816f6f94f385ad(&(iParam1->f_27[6]), 2785.092f, 461.1254f, 64.24197f, 0f, 0f, -38.17911f, 14.911f, 29.76691f, 9.370356f);
		iParam1->f_27[3] = _create_volume_box_with_custom_name(2822.164f, 441.8563f, 67.32871f, 0f, 0f, -117.5f, 6.013498f, 25f, 10f, "volTrigger");
		iParam1->f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_27[1]), 2812.615f, 446.5732f, 47.3556f, 0f, 0f, -25.3182f, 18.13761f, 436.6708f, 30.21985f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(2836.517f, 433.8827f, 64.26667f, 0f, 0f, -117.9647f, 28.68821f, 31.2372f, 13.67471f, "volSlow");
		iParam0->f_182[1] = _create_volume_box_with_custom_name(2824.718f, 440.9388f, 67.33965f, 0f, 0f, -117.9647f, 11.79473f, 31.2372f, 10f, "volSlower");
		iParam0->f_182[2] = _create_volume_box_with_custom_name(2811.41f, 447.2833f, 65.66281f, 0f, 0f, -117.5f, 6.206553f, 30.70701f, 10f, "volSlowest");
	}
}
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_448(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
bool func_399(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		{
			if (func_462(iParam2, 1065353216))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
int func_400(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_441((*Global_1835011)[4]->f_1, 1))
		{
			if (func_484(5))
			{
				func_485(5);
	...
	if ((bVar0 && func_441((*Global_1835011)[37]->f_1, 1)) && !func_441((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_441((*Global_1835011)[43]->f_1, 1)) && !func_441((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
bool func_405(int iParam0)
{
	...
	if (func_184(Global_1392581->f_3, 4) || is_player_riding_train(player_id()))
	{
		func_514(22);
		return true;
	}
...
void func_420(int iParam0, var uParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, bool bParam13, float fParam14)
{
	...
	if (func_523(get_entity_coords(iParam0, true, false), uParam1, fParam7))
	{
		set_gameplay_ped_hint(iParam0, Vector(0f, 0f, 0f) + vParam2, bParam5, iParam8, iParam9, iParam10);
		func_524(uParam1, get_entity_coords(iParam0, true, false), fParam6, iParam9);
	}
}
...
int func_453(int iParam0, bool bParam1)
{
	...
	{
		case 860033945:
			bVar1 = func_449(1845102363);
			bVar2 = func_449(392538360);
			if (!bVar1 && bVar2)
			{
				iParam0 = 392538360;
			}
...
int func_454(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case -594562071:
			...
			break;
		case -1101297303:
			bVar2 = func_543(127400949);
			bVar3 = func_543(2075992054);
			if (!bVar2 && !bVar3)
			{
				iParam0 = 379542007;
			}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_546(1) || *iParam0 & 8192 != 0))
				{
...
bool func_460(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_559(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_557(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_558(iParam2)
				{
					func_553(iParam2, 1);
					return true;
				}
...
bool func_461(int iParam0, int iParam1)
{
	...
	if (func_549(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_558(iParam1)
		{
...
void func_486(int iParam0)
{
	...
	func_586(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_587(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_588(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_589(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_590(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_591(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_592(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_593(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_594(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_595(_get_map_zone_at_coords(vParam0, 10));
}
...
int func_510(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_620(func_619(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
int func_515(int iParam0, float fParam1, int iParam2)
{
	...
	return func_621(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}
	...
	while (iVar0 < 27)
	{
		if (func_626(iVar0))
		{
			...
			if (fVar6 <= 10000f && fVar6 > 0f)
			{
				...
				if (func_372(get_entity_coords(iVar1, true, false), vVar2) > fVar5)
				{
...
void func_527(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_638(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_640(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_644((*Global_1900383)[iParam0]->f_26);
		func_645((*Global_1900383)[iParam0]->f_26);
...
{
	return func_647(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
void func_542(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_398(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_555(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_374(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_668(iVar0, 0)))
		{
...
bool func_559(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_668(iVar0, 0)))
		{
			if (func_670(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_575(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_374(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_602(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_324())
	{
		...
		{
			bVar0 = false;
			if (!func_441((*Global_1835011)[15]->f_1, 1) && !func_637(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_441((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_694();
				*iParam1 = func_695();
				*uParam2 = func_696();
...
int func_631(var uParam0)
{
	...
	return (func_182() - round((uParam0->f_1 * 1000f)));
}
...
bool func_632(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (func_722(get_entity_coords(iParam0, true, false), fParam1, iParam2, 1, fParam5))
	{
		return true;
	}
	return false;
...
{
	vVar0 = { func_723(0) };
	vVar3 = { func_409(vParam0 - get_gameplay_cam_coord()) };
	if (bParam3)
	{
...
void func_638(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_727(func_726(255), 109029619));
	}
	else if (func_687())
	{
...
bool func_669(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_670(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_683(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_660(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_685(int iParam0)
{
	...
	if (func_740(get_entity_model(iParam0)))
	{
		return true;
	}
...
{
	func_746(&uVar0, &uVar1, &iVar2, &iVar3, 529461124, 1410914475, -1497929239, 665185216, 2);
	if (!bParam2)
	{
		if (iVar2 != 0 || iVar3 != 0)
		{
...
bool func_733(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_660(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_736(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_660(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_743(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_660(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
{
	return _0x033ee4b89f3ac545(func_660(bParam2), uParam0, iParam1);
}
...
struct<28> func_756(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_660(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_751(&Var28) };
...
struct<17> func_758(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_660(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_751(&Var17) };
