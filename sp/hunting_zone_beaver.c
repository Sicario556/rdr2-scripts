...
bool func_42(var uParam0)
{
	*uParam0 = 1;
	...
	uParam0->f_596[2] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = 759906147;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = -1212478257;
	return true;
}
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_BV");
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2452.319f, 444.1567f, 81.7503f;
				case 1:
					return 2480.229f, 529.2425f, 63.9784f;
				case 2:
					return 2422.063f, 592.2469f, 67.191f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 0:
					return 2504.876f, 539.3447f, 67.0684f;
				case 1:
					return 2434.036f, 599.1665f, 66.8838f;
				case 2:
					return 2426.634f, 447.8579f, 80.8048f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				...
				case 1:
					return 2479.031f, 587.5114f, 67.5733f;
				case 2:
					return 2423.946f, 499.9196f, 77.5533f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 0:
					return 2401.63f, 484.0867f, 87.0127f;
				case 1:
					return 2510.779f, 560.1169f, 69.7076f;
				case 2:
					return 2423.642f, 537.4789f, 70.8208f;
			}
			break;
	}
	return 0f, 0f, 0f;
