void __EntryFunction__()
{
	...
	if (!bVar683)
	{
		...
		if (func_7(1) > 0)
		{
			func_8(&uLocal_661, 2048);
		}
		func_9();
	}
	while (true)
	{
		func_11(bVar683, 1389, 0);
		if (bVar683)
		{
			wait(0);
		}
		else
		{
			...
			switch (iVar534)
			{
				...
				case 3:
					if (func_15())
					{
						func_16(&Local_228, &uLocal_649, &(Local_228.f_51.f_4));
						func_18(&Local_228, uVar647, 2816);
						func_19();
						func_20();
						iLocal_536 = 4;
					}
				...
				case 4:
					...
					if (!Local_228.f_46)
					{
						if ((func_25(&(uLocal_484[0]), 0, &(Local_228.f_5), &uLocal_537, 0, 0) || is_ped_ragdoll(&(uLocal_484[0]))) || func_26(&uLocal_581) > 7.5f)
						{
							if ((is_ped_ragdoll(&(uLocal_484[0])) || _0x29fce825613fefca(&(uLocal_484[0]), 250)) || has_entity_been_damaged_by_entity(&(uLocal_484[0]), Global_35, 1, 1))
							{
								clear_ped_tasks(&(uLocal_484[0]), 1, 0);
								clear_ped_secondary_task(&(uLocal_484[0]));
							}
							iLocal_677 = 0;
							if (iVar535 == 8 && func_27(&uLocal_575))
							{
							}
							else
							{
								if (_0x79c2bec82cfd7f7f(uVar453))
								{
									_0x4fd80c3dd84b817b(&(uLocal_484[0]));
									_0x58f7db5bd8fa2288(&(uLocal_484[0]));
									set_ped_max_move_blend_ratio(&(uLocal_484[0]), 3f);
									iLocal_680 = 0;
									iLocal_681 = 0;
									func_28(Local_614[0], 0, 0);
									func_28(Local_614[1], 0, 0);
								}
								Local_228.f_46 = 1;
								Local_228.f_44 = 1;
								func_29(&Local_228);
					...
					{
						set_ped_reset_flag(&(uLocal_484[0]), 134, true);
					}
					if (func_32())
					{
						Local_228.f_50 = 1;
...
int func_7(bool bParam0)
{
	...
	get_group_size(func_48(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_48(), iVar3);
		if (func_49(iVar4))
		{
			iVar0++;
		}
...
void func_10()
{
	...
	{
		iLocal_675 = 1;
		if (_0x0d0ae5081f88cfe1(1836621877))
		{
			_0x154340e87d8cc178(1836621877);
		}
		...
		if (_does_volume_exist(iLocal_210))
		{
			_0xd17672447692478e(iLocal_210, 0);
		}
		if (_does_volume_exist(iLocal_211))
		{
			_0xd17672447692478e(iLocal_211, 0);
		}
		func_55(&iLocal_669);
		func_56(&uLocal_538, 1);
		if ((Local_228.f_46 == 0 && !func_57(iVar659, 32)) && !func_57(iVar659, 32768))
		{
			Local_228.f_45 = 0;
			func_58(&Local_228);
		}
		...
		{
			_0x74c2b3dc0b294102(iVar488);
			_0xa1cfb35069d23c23(iVar488);
			_delete_volume(iVar488);
		}
		func_59();
		if (func_31(&(uLocal_484[0]), 0, 1))
		{
			set_ped_config_flag(&(uLocal_484[0]), 137, false);
			set_ped_config_flag(&(uLocal_484[0]), 169, false);
			set_ped_config_flag(&(uLocal_484[0]), 170, false);
			set_ped_config_flag(&(uLocal_484[0]), 370, false);
			_0x4b436bac8cbe9b07(&(uLocal_484[0]), -1, 0);
			if (func_60(Global_35, &(uLocal_484[0]), 1, 1) > 80f && is_entity_occluded(&(uLocal_484[0])))
			{
				delete_ped(uLocal_484[0]);
			}
			else
			{
				_task_smart_flee_style_ped(&(uLocal_484[0]), Global_35, 4, 256, -1082130432, -1, 0);
				_0x39a2fc5af55a52b1(&(uLocal_484[0]), -1);
				set_ped_as_no_longer_needed(uLocal_484[0]);
				Local_228.f_50 = 1;
			}
		}
	...
	if (iVar671 == 1)
	{
		if (_does_scenario_point_exist(iVar490))
		{
			_delete_scenario_point(iVar490);
		}
		if (does_entity_exist(&(uLocal_484[0])))
		{
			if (does_entity_belong_to_this_script(&(uLocal_484[0]), true))
			{
				_0x39a2fc5af55a52b1(&(uLocal_484[0]), -1);
				set_ped_as_no_longer_needed(uLocal_484[0]);
			}
		}
		func_62(&Local_228, &uLocal_484, &uLocal_486, iLocal_227, uVar647, Local_228.f_51.f_4, 0, 1, 0, 1);
	...
	switch (iVar531)
	{
		case 0:
			if (func_64(&Local_228))
			{
				...
				func_66();
				func_67();
				_0xd9130842d7226045(func_68(), 0);
				_0xd9130842d7226045(func_69(), 0);
				iLocal_533 = 1;
			}
			break;
		case 1:
			...
			while (iVar0 < 1)
			{
				if (!has_model_loaded(Local_422[iVar0]->f_1))
				{
					return false;
				}
				iVar0++;
			...
			if (!_0xd9130842d7226045("RELP_Sounds", 0))
			{
				return false;
			}
			return true;
...
void func_19()
{
	if (func_31(&(uLocal_484[0]), 0, 1))
	{
		...
		remove_all_ped_weapons(&(uLocal_484[0]), true, true);
		set_ped_config_flag(&(uLocal_484[0]), 137, true);
		set_ped_config_flag(&(uLocal_484[0]), 169, true);
		set_ped_config_flag(&(uLocal_484[0]), 170, true);
		set_ped_config_flag(&(uLocal_484[0]), 6, true);
		set_ped_config_flag(&(uLocal_484[0]), 370, true);
		func_82(&(uLocal_484[0]), 0);
		decor_set_bool(&(uLocal_484[0]), "bIsCriminal", true);
		_0x923583741dc87bce(&(uLocal_484[0]), "lone_prisoner");
		set_ped_max_move_blend_ratio(&(uLocal_484[0]), 1.5f);
		_0x3ad8eff9703be657(&(uLocal_484[0]), 0f);
		func_83(&(uLocal_484[0]));
		func_84(&(uLocal_484[0]), 1);
		iLocal_455 = iVar453;
		func_85(&uLocal_490, get_entity_coords(&(uLocal_484[0]), true, false), 0f, 0f, 0f, 5f, 5f, 5f);
		_0x18262cafebb5fbe1(iVar488, 0, 0, 0, -1, -1, 0);
		_0xb56d41a694e42e86(iVar488, 0, 0, 0, -1, -1, 0);
		_0x7c00cfc48a782dc0(iVar488, &(uLocal_484[0]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
		_0xc17a94cc8fc3c61a(&(uLocal_484[0]), 45454, 0.7f, 1f, 1f);
		_0xc17a94cc8fc3c61a(&(uLocal_484[0]), 33646, 0.7f, 1f, 1f);
		_0xc17a94cc8fc3c61a(&(uLocal_484[0]), 55120, 0.8f, 0.8f, 1f);
		_0xc17a94cc8fc3c61a(&(uLocal_484[0]), 43312, 0.8f, 0.8f, 1f);
		iLocal_455 = add_rope(0f, 0f, 1f, 0f, 0f, 0f, 0.32f, 7, -1f, 0.2f, 0.2f, false, true, false, 1.25f, true, 0, true);
		_0xdede679ed29dd4e7(iVar453, 0);
		attach_entities_to_rope(iVar453, &(uLocal_484[0]), &(uLocal_484[0]), 0.3f, 0f, 0.095f, 0.3f, 0f, -0.095f, 0.32f, 0, 0, "", "", 0, 55120, 43312, 0, 0, 1, 1);
		_0xfb9153a54ac713e8(iVar453, 1);
		task_set_crouch_movement(&(uLocal_484[0]), true, 0, false);
		func_86(uLocal_484[0], 1);
		add_relationship_group("Beat_Prisoner", &uLocal_590);
		set_ped_relationship_group_hash(&(uLocal_484[0]), iVar588);
		_0x946d46cd6dfb9742(get_player_index(), 0, -646092206);
		_0xbf4dc1784be94dfa(&(uLocal_484[0]), true, get_hash_key("RELP_FOOTSTEP_SWEETENER_Soundset"));
		func_87(&uLocal_494);
	}
}
...
void func_20()
{
	func_88(Local_614[0], "RE_INTER_POS", 0, -163964935, 0, 0, 0, 1, 0);
	func_88(Local_614[1], "RE_INTER_ANTAGONIZE", 0, 648122183, 0, 0, 0, 1, 0);
	func_28(Local_614[0], 0, 0);
	func_28(Local_614[1], 0, 0);
}
...
void func_22()
{
	...
	{
		if (_is_ped_lassoed(&(uLocal_484[0])) || _is_ped_hogtied(&(uLocal_484[0])))
		{
			iVar0 = 1;
		}
	}
	if (has_entity_been_damaged_by_entity(&(uLocal_484[0]), Global_35, 1, 1) || iVar0 == 1)
	{
...
bool func_25(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_108(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
...
void func_30(int iParam0, int iParam1)
{
	...
	{
		func_8((*Global_1955500)[iParam0], iParam1);
	}
}
...
bool func_32()
{
	...
	if (func_31(&(uLocal_484[0]), 0, 1))
	{
		if (iVar682 == 0)
		{
			set_ped_can_play_gesture_anims(&(uLocal_484[0]), 1, 1);
		}
		if (((Local_228.f_46 == 0 && bVar668 == 1) && !func_57(iVar659, 1)) && func_145(&(uLocal_484[0]), 1, 1) < 5f)
		{
			set_ped_reset_flag(&(uLocal_484[0]), 36, true);
			set_ped_reset_flag(&(uLocal_484[0]), 31, true);
	...
	if (iVar676 == 0)
	{
		...
		{
			iLocal_678 = 1;
			set_ped_config_flag(&(uLocal_484[0]), 220, false);
			_0x4fd80c3dd84b817b(&(uLocal_484[0]));
			_0x58f7db5bd8fa2288(&(uLocal_484[0]));
			set_ped_max_move_blend_ratio(&(uLocal_484[0]), 3f);
			_0xbf4dc1784be94dfa(&(uLocal_484[0]), false, get_hash_key("RELP_FOOTSTEP_SWEETENER_Soundset"));
			_0x4b436bac8cbe9b07(&(uLocal_484[0]), -1, 0);
			iLocal_680 = 0;
			iLocal_681 = 0;
			func_28(Local_614[0], 0, 0);
	...
	if (iVar675 == 1)
	{
		set_ped_can_play_ambient_anims(&(uLocal_484[0]), false);
		_0x66f9eb44342bb4c5(&(uLocal_484[0]), &Local_458);
	}
	switch (iVar533)
	{
		case 0:
		...
		case 1:
			...
			break;
		case 3:
			if (!func_57(iVar659, 128))
			{
				if (!is_any_speech_playing(&(uLocal_484[0])) && func_57(iVar659, 16))
				{
					func_28(Local_614[0], 1, 0);
					func_28(Local_614[1], 1, 0);
					iLocal_680 = 1;
					iLocal_681 = 1;
					iLocal_682 = 1;
					func_8(&uLocal_661, 128);
					iLocal_483 = 0;
				}
			}
			if (_0x79c2bec82cfd7f7f(uVar453))
			{
				...
				iLocal_665 = get_game_timer();
				iLocal_687 = 1;
				if (!func_57(iVar659, 4096))
				{
					func_150(12, 0, 0, "RE_HONOR_HELPED_STRANGER", &(uLocal_484[0]), 0, 1065353216, 0);
					func_8(&uLocal_661, 4096);
			...
			if (func_145(&(uLocal_484[0]), 1, 1) < (fVar655 + 5f) && !is_any_speech_playing(&(uLocal_484[0])))
			{
				func_154();
				if ((func_26(&uLocal_563) > 2f && !is_any_speech_playing(Global_35)) && !is_any_speech_playing(&(uLocal_484[0])))
				{
					if (!func_57(iVar659, 4194304))
					{
						func_8(&uLocal_661, 4194304);
						fLocal_657 = (fVar655 + 1f);
						return false;
					}
				}
				if (((func_57(iVar659, 4194304) && func_26(&uLocal_563) > 2f) && !is_any_speech_playing(Global_35)) && !is_any_speech_playing(&(uLocal_484[0])))
				{
					func_154();
					iLocal_491 = _create_volume_cylinder(get_entity_coords(&(uLocal_484[0]), true, false), 0f, 0f, 0f, 3f, 3f, 5f);
					_0x7c00cfc48a782dc0(iVar489, &(uLocal_484[0]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
					iLocal_493 = func_155(&(uLocal_484[0]), iVar489, 28);
					set_relationship_between_groups(6, iVar588, 707888648);
					set_relationship_between_groups(6, 707888648, iVar588);
					iLocal_535 = 4;
				}
			}
			break;
		case 4:
			if (iVar681 == 0)
			{
				...
				func_161();
				iLocal_687 = 1;
				if (!func_162(-2f) || _0x79c2bec82cfd7f7f(uVar453))
				{
					if (_0x79c2bec82cfd7f7f(uVar453))
					{
						if (Local_228.f_44 == 0)
						...
						set_ped_max_move_blend_ratio(&(uLocal_484[0]), 3f);
						func_163();
						set_ped_config_flag(&(uLocal_484[0]), 277, true);
						set_entity_is_target_priority(&(uLocal_484[0]), false, 0f);
						if (!func_57(iVar659, 1))
						{
							func_164(&(uLocal_484[0]), 50);
							_play_sound_from_position("SHOOT_LOCK", vLocal_650, "RELP_Sounds", false, 0, true, 0);
							func_165(49);
						}
						if (!func_27(&uLocal_548) && !is_any_speech_playing(Global_35))
						{
							if (iLocal_227 == 0)
							{
						...
						iLocal_681 = 0;
						func_53("PRIS_SHOOT_CHAIN", 1);
						clear_sequence_task(&iLocal_488);
						open_sequence_task(&iLocal_488);
						clear_ped_secondary_task(&(uLocal_484[0]));
						if (func_57(iVar659, 1))
						{
							task_play_anim(0, &(Local_128[10]), Local_128[10]->f_1, 2f, -2f, -1, 0, 0.27f, false, 0, false, 0, false);
						}
						else
						{
							task_play_anim(0, &(Local_128[10]), Local_128[10]->f_1, 8f, -2f, -1, 0, 0f, false, 0, false, 0, false);
						}
						task_play_upper_anim_facing_entity(0, &(Local_128[11]), Local_128[11]->f_1, Global_35, 1633, 2f, -2f, 67109392, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
						task_turn_ped_to_face_entity(0, Global_35, -1, -1082130432, -1082130432, -1082130432);
						task_turn_ped_to_face_entity(0, Global_35, -1, -1082130432, -1082130432, -1082130432);
						func_168(&(uLocal_484[0]), &iLocal_488, 0, 0, 1, 1);
						set_ped_reset_flag(&(uLocal_484[0]), 4, false);
						iLocal_670 = 0;
						func_169(&Local_614, 0, 0);
						func_170(Local_592[0], 0);
						if (func_57(iVar659, 1))
						{
							func_167(&(uLocal_484[0]), Global_35, func_166("THANKS"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
							func_8(&uLocal_661, 64);
						}
						settimera(0);
						iLocal_483 = 2;
						func_24(&uLocal_560);
					...
					{
						if (iVar681 == 0 && Local_228.f_46 == 0)
						{
							func_153();
						}
						if (((((func_171(&(uLocal_484[0]), &iLocal_665, 35000) && !is_any_speech_playing(&(uLocal_484[0]))) && !is_any_speech_playing(Global_35)) && iVar658 == 0) || func_57(iVar659, 1)) || iVar681 == 1)
						{
							...
							func_173();
							func_88(Local_614[1], "RE_INTER_ANTAGONIZE", " ", 648122183, 0, 0, 0, 0, 0);
							func_170(Local_592[0], 0);
							func_28(Local_614[0], 0, 0);
							func_28(Local_614[1], 0, 0);
							iLocal_680 = 1;
						...
						func_174();
						if (!func_57(iVar659, 8192))
						{
							if ((((func_175(&(uLocal_484[0]), 242628503) && get_sequence_progress(&(uLocal_484[0])) >= 1) || (func_27(&uLocal_548) && (!func_175(&(uLocal_484[0]), 1435919172) || func_175(&(uLocal_484[0]), 1682639051)))) || is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[11]), Local_128[11]->f_1, 1)) && !is_any_speech_playing(&(uLocal_484[0])))
							{
								func_176(&(Local_228.f_5), 1);
								func_8(&uLocal_661, 8192);
								set_ped_can_be_targetted(&(uLocal_484[0]), true);
								set_ped_config_flag(&(uLocal_484[0]), 137, false);
								set_ped_config_flag(&(uLocal_484[0]), 169, false);
								set_ped_config_flag(&(uLocal_484[0]), 170, false);
								set_ped_config_flag(&(uLocal_484[0]), 370, false);
						...
						if (func_57(iVar659, 524288) && func_57(iVar659, 1))
						{
							_0x89f5e7adecccb49c(&(uLocal_484[0]), "normal");
							func_173();
							func_28(Local_614[0], 0, 0);
							func_28(Local_614[1], 0, 0);
							iLocal_483 = 2;
						...
						func_178(Local_592[0], &Local_614);
						func_179(&(uLocal_484[0]), 0);
						clear_ped_secondary_task(&(uLocal_484[0]));
						set_ped_config_flag(Global_35, 26, false);
						_0x463803429297117c(&(uLocal_484[0]), Global_36, 3, 0);
						iLocal_687 = 3;
						if (bVar668)
						{
							set_ped_flee_attributes(&(uLocal_484[0]), 262144, true);
							_0x89f5e7adecccb49c(&(uLocal_484[0]), "chain_gang_legs");
							_task_smart_flee_style_ped(&(uLocal_484[0]), Global_35, 2, 524320, -1082130432, -1, 0);
						}
						else
						{
							_task_smart_flee_style_ped(&(uLocal_484[0]), Global_35, 2, 524320, -1082130432, -1, 0);
						...
						set_ped_config_flag(&(uLocal_484[0]), 220, false);
						set_ped_config_flag(&(uLocal_484[0]), 370, false);
						set_ped_keep_task(&(uLocal_484[0]), true);
						...
						if (func_31(&(uLocal_484[0]), 0, 0))
						{
							...
							{
								if (!func_57(iVar659, -2147483648))
								{
									if (!has_entity_been_damaged_by_entity(&(uLocal_484[0]), Global_35, 1, 1))
									{
										func_182(0);
									...
									func_8(&uLocal_661, -2147483648);
								}
							}
							if (((!func_57(iVar659, 268435456) && func_57(iVar659, 134217728)) && !func_57(iVar659, 33554432)) && !func_57(iVar659, 67108864))
							{
								if ((!is_any_speech_playing(Global_35) && !is_any_speech_playing(&(uLocal_484[0]))) && Local_228.f_46 == 0)
								{
									if (iLocal_227 == 0)
									{
							...
							if (iVar672 == 0)
							{
								...
								clear_ped_secondary_task(&(uLocal_484[0]));
								set_ped_can_be_targetted(&(uLocal_484[0]), true);
								set_ped_config_flag(&(uLocal_484[0]), 277, false);
								func_42(&(Local_228.f_5), 1);
								func_172(&(Local_228.f_5), 1);
								func_176(&(Local_228.f_5), 1);
								set_ped_config_flag(&(uLocal_484[0]), 137, false);
								...
								if (Local_228.f_46 == 0)
								{
									...
									if (func_57(iVar659, 1))
									{
										task_turn_ped_to_face_entity(0, Global_35, 2250, -1082130432, -1082130432, 0.52f);
										func_185(&uLocal_569, -3f, 0);
									}
									else if (func_57(iVar659, 8))
									{
										task_turn_ped_to_face_entity(0, Global_35, 550, -1082130432, -1082130432, 0.52f);
										func_180(&uLocal_569, 0);
									}
									else
									{
										task_turn_ped_to_face_entity(0, Global_35, 5000, -1082130432, -1082130432, 0.52f);
										func_180(&uLocal_569, 0);
									}
									if (func_186(&(uLocal_484[0]), vLocal_206, 1) > 7f)
									{
										task_follow_nav_mesh_to_coord(0, vLocal_203, 1.5f, -1, 5f, 0, 40000f);
									}
									_task_use_scenario_point(0, uVar490, 0, 0, true, false, 0, false, -1f, false);
									func_168(&(uLocal_484[0]), &iLocal_488, 0, 0, 1, 1);
									set_ped_keep_task(&(uLocal_484[0]), true);
									if (iVar681 == 0)
									{
									...
									_0x3ad8eff9703be657(&(uLocal_484[0]), 1.2f);
								}
							}
							else if (!is_any_speech_playing(Global_35) && !is_any_speech_playing(&(uLocal_484[0])))
							{
								if (func_23(&uLocal_569, 5f))
								{
									if (func_27(&uLocal_548))
									{
										func_187(&uLocal_661, 33554432);
										func_187(&uLocal_661, 67108864);
										func_28(Local_614[0], 1, 0);
										func_28(Local_614[1], 1, 0);
										iLocal_680 = 1;
										iLocal_681 = 1;
							...
							func_188();
							if ((func_57(iVar659, 1) && bVar668 == 1) && !func_27(&uLocal_548))
							{
								if (_0x79c2bec82cfd7f7f(uVar453))
								{
									if (Local_228.f_44 == 0)
									...
									_0x58f7db5bd8fa2288(&(uLocal_484[0]));
									set_ped_max_move_blend_ratio(&(uLocal_484[0]), 3f);
									if (((Local_228.f_46 == 0 && func_31(&(uLocal_484[0]), 0, 1)) && !has_entity_been_damaged_by_entity(&(uLocal_484[0]), Global_35, 1, 1)) && !_is_ped_lassoed(&(uLocal_484[0])))
									{
										func_163();
										if (!func_57(iVar659, 4096))
										{
										...
										_play_sound_from_position("SHOOT_LOCK", vLocal_650, "RELP_Sounds", false, 0, true, 0);
										func_165(49);
										task_react(&(uLocal_484[0]), Global_35, 0f, 0f, 0f, "DEFAULT_PANIC", 2f, 0, 4);
							...
							if ((func_31(&(uLocal_484[0]), 0, 1) && func_145(&(uLocal_484[0]), 1, 1) > 100f) && is_entity_occluded(&(uLocal_484[0])))
							{
								if (func_31(&(uLocal_484[0]), 0, 1))
								{
									set_ped_config_flag(&(uLocal_484[0]), 137, false);
...
bool func_33(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, float fParam9, int iParam10, int iParam11, int iParam12)
{
	fVar0 = 0f;
	if (uParam0->f_1 >= 4)
	{
...
void func_54(int iParam0, bool bParam1)
{
	if (*iParam0 > -1 && *iParam0 < 4)
	{
		if (*Global_1955500)[*iParam0]->f_3 == get_id_of_this_thread()
		{
			...
			if (bParam1)
			{
				func_208((*Global_1955500)[*iParam0]->f_1);
			}
...
void func_59()
{
	if (func_212(&(uLocal_484[0]), 1) || Local_228.f_46 == 1)
	{
		...
		if (bLocal_195)
		{
			if (func_213(Local_228.f_3, 0) != 2 && func_57(iVar659, 64))
			{
				if (iLocal_227 == 0)
				{
					func_214(37, 4, 1);
				...
				if (iVar664 >= 3 && (func_57(iVar659, 32) || func_57(iVar659, 32768)))
				{
					Local_228.f_44 = 1;
					func_214(37, 5, 1);
				}
		...
		{
			if (func_213(Local_228.f_3, 1) != 2 && func_57(iVar659, 64))
			{
				if (iLocal_227 == 0)
				{
					func_214(37, 7, 1);
		...
		if ((Local_228.f_46 == 1 || func_57(iVar659, 32)) || func_57(iVar659, 32768))
		{
			Local_228.f_44 = 1;
		}
		return;
...
void func_61(int iParam0, bool bParam1)
{
	...
	while (iVar0 < iVar1)
	{
		...
		if (func_219(iVar2))
		{
			if (bParam1)
			{
				set_blocking_of_non_temporary_events(func_220(iVar2), false);
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_223(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
...
void func_65()
{
	switch (func_35())
	{
		...
		case 4:
		case 9:
			Local_422[0]->f_1 = -1096778781;
			Local_422[0]->f_3 = 629490500;
			StringCopy(&(Local_422[0]->f_23), "1057_G_M_M_UniCriminals_01_WHITE_04", 64);
			break;
		case 0:
		case 2:
		case 11:
			Local_422[0]->f_1 = -1096778781;
			Local_422[0]->f_3 = 937486331;
			StringCopy(&(Local_422[0]->f_23), "1056_G_M_M_UniCriminals_01_WHITE_03", 64);
			break;
	}
	Local_422[0] = 4;
	func_237(&(Local_422[0]->f_22));
	func_238(Local_228.f_3);
}

void func_66()
{
	Local_128[1] = "script_re@lone_prisoner";
	Local_128[1]->f_1 = "callout_idle";
	Local_128[2] = "script_re@lone_prisoner";
	Local_128[2]->f_1 = "callout_far";
	Local_128[3] = "script_re@lone_prisoner";
	Local_128[3]->f_1 = "please_mister";
	Local_128[4] = "script_re@lone_prisoner";
	Local_128[4]->f_1 = "ive_been_on_the_run";
	Local_128[5] = "script_re@lone_prisoner";
	Local_128[5]->f_1 = "dialogue_idle";
	Local_128[6] = "script_re@lone_prisoner";
	Local_128[6]->f_1 = "free_enter";
	Local_128[7] = "script_re@lone_prisoner";
	Local_128[7]->f_1 = "free_idle";
	Local_128[8] = "script_re@lone_prisoner";
	Local_128[8]->f_1 = "cmon_now";
	Local_128[9] = "script_re@lone_prisoner";
	Local_128[9]->f_1 = "shoot_damn_things";
	Local_128[10] = "script_re@lone_prisoner";
	Local_128[10]->f_1 = "free_ped";
	Local_128[11] = "script_re@lone_prisoner";
	Local_128[11]->f_1 = "free_ped_upper";
	Local_128[12] = "script_re@lone_prisoner";
	Local_128[12]->f_1 = "ah";
	Local_128[13] = "script_re@lone_prisoner";
	Local_128[13]->f_1 = "aim_at_ped";
	func_239(&(Local_128[2]), &uLocal_15);
}
...
bool func_74(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_256(iParam1, func_255(uParam0), &(uParam0->f_172)))
		{
...
void func_76(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_75(uParam0->f_3, 1))
	{
		func_258(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
bool func_80(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_261() || !func_262((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
void func_85(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	...
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_267());
	}
}
...
void func_94(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_223(uParam0->f_3));
...
bool func_97(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	fVar0 = 30f;
	fVar1 = 150f;
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_108(player_id(), 1, 0, 1))
		{
			return false;
		}
...
void func_98(var uParam0, int iParam1)
{
	if (func_302(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_267());
		bVar1 = func_228(!func_75(uParam0->f_3, 1), 20f, -1f);
		uParam0->f_51.f_11 = func_306(iVar2, func_305(uParam0->f_3), 1, iParam1, 8, 0, bVar1);
	}
}
...
bool func_106(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_330(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_328(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_329(iParam2)
				{
					func_324(iParam2, 1);
					return true;
				}
...
bool func_107(int iParam0, int iParam1)
{
	...
	if (func_320(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_329(iParam1)
		{
...
int func_130(int iParam0, int iParam1)
{
	...
	{
		return func_353(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
bool func_140(int iParam0, bool bParam1, bool bParam2)
{
	if (iParam0 > -1 && iParam0 < 4)
	{
...
void func_142()
{
	if (func_31(&(uLocal_484[0]), 0, 1))
	{
		if (iLocal_227 == 0)
		{
			if (iVar647 == 9)
			{
				if (has_anim_event_fired(&(uLocal_484[0]), -2028378164))
				{
					func_176(&(Local_228.f_5), 0);
					set_ped_config_flag(&(uLocal_484[0]), 220, true);
					func_42(&(Local_228.f_5), 0);
					func_172(&(Local_228.f_5), 0);
					_0x4b436bac8cbe9b07(&(uLocal_484[0]), 1, 0);
				}
				if (!func_57(iVar659, 256))
				{
					if (has_anim_event_fired(&(uLocal_484[0]), -420486889))
					{
						func_167(&(uLocal_484[0]), Global_35, func_166("GOT_TO_HELP"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
						func_8(&uLocal_661, 256);
					}
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 2020835214))
				{
					...
					func_8(&uLocal_661, 16);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 1332120064))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("PRIS_HELP"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_356(1891783641, &(uLocal_484[0]), 1);
					func_180(&uLocal_563, 0);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -2028307303))
				{
					...
					func_8(&uLocal_661, 32);
					func_176(&(Local_228.f_5), 0);
					func_42(&(Local_228.f_5), 0);
					func_172(&(Local_228.f_5), 0);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -131692014))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("CMON"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_8(&uLocal_661, 512);
					if (func_57(iVar659, 8388608))
					{
						func_8(&uLocal_661, 536870912);
					}
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -560083606))
				{
					if (!func_351(0))
					{
						func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_DAMN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
						func_8(&uLocal_661, 1024);
						if (func_57(iVar659, 8388608))
						{
							func_8(&uLocal_661, 536870912);
						}
				...
				if (has_anim_event_fired(&(uLocal_484[0]), -1266346729))
				{
					if (func_351(0))
					{
				...
				if (has_anim_event_fired(&(uLocal_484[0]), -264929638))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_SHACKLES"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -544853791))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("THANKS"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_8(&uLocal_661, 64);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -2146471051))
				{
			...
			{
				if (has_anim_event_fired(&(uLocal_484[0]), 18861647))
				{
					func_176(&(Local_228.f_5), 0);
					set_ped_config_flag(&(uLocal_484[0]), 220, true);
					func_42(&(Local_228.f_5), 0);
				...
				if (!func_57(iVar659, 256))
				{
					if (has_anim_event_fired(&(uLocal_484[0]), 238912189))
					{
						func_167(&(uLocal_484[0]), Global_35, func_166("GOT_TO_HELP"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
						func_8(&uLocal_661, 256);
					}
				}
				if (has_anim_event_fired(&(uLocal_484[0]), -1140740474))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("PRIS_CALLOVER"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_356(1891783641, &(uLocal_484[0]), 1);
					func_8(&uLocal_661, 16);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 1632412321))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("PRIS_HELP"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_356(1891783641, &(uLocal_484[0]), 1);
					func_180(&uLocal_563, 0);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 429969869))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("ON_RUN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_356(249295937, &(uLocal_484[0]), 1);
					func_8(&uLocal_661, 32);
				...
				if (has_anim_event_fired(&(uLocal_484[0]), -1843392261))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("CMON"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_8(&uLocal_661, 512);
					if (func_57(iVar659, 8388608))
				...
				if (has_anim_event_fired(&(uLocal_484[0]), -1149542874))
				{
					if (func_351(0))
					{
						func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_DAMN_SICK"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				...
				if (has_anim_event_fired(&(uLocal_484[0]), 1779172406))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_SHACKLES"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 1096541137))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("THANKS"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_8(&uLocal_661, 64);
				}
				if (has_anim_event_fired(&(uLocal_484[0]), 1914467392))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("HR_NO_PAY"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_42(&(Local_228.f_5), 1);
					func_172(&(Local_228.f_5), 1);
		...
		{
			if (has_anim_event_fired(&(uLocal_484[0]), 1605908301))
			{
				func_176(&(Local_228.f_5), 0);
				set_ped_config_flag(&(uLocal_484[0]), 220, true);
				func_42(&(Local_228.f_5), 0);
			...
			if (has_anim_event_fired(&(uLocal_484[0]), 1110040269))
			{
				if (!func_351(0))
				{
			...
			if (has_anim_event_fired(&(uLocal_484[0]), -25133812))
			{
				if (func_351(0))
				{
		...
		{
			if (has_anim_event_fired(&(uLocal_484[0]), 1066143374))
			{
				func_176(&(Local_228.f_5), 0);
				set_ped_config_flag(&(uLocal_484[0]), 220, true);
				func_42(&(Local_228.f_5), 0);
			...
			if (has_anim_event_fired(&(uLocal_484[0]), 1175149287))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("PRIS_CALLOVER_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_356(1891783641, &(uLocal_484[0]), 1);
				func_8(&uLocal_661, 16);
			}
			if (has_anim_event_fired(&(uLocal_484[0]), -1880587081))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("PRIS_HELP_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_356(1891783641, &(uLocal_484[0]), 1);
				func_180(&uLocal_563, 0);
			}
			if (has_anim_event_fired(&(uLocal_484[0]), -815641095))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("ON_RUN_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_356(249295937, &(uLocal_484[0]), 1);
				func_8(&uLocal_661, 32768);
			...
			if (has_anim_event_fired(&(uLocal_484[0]), -390119130))
			{
				if (func_51(37, 7) >= 1)
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("CMON_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			...
			if (has_anim_event_fired(&(uLocal_484[0]), -1486203918))
			{
				if (func_351(0))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_DAMN_SICK_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			...
			if (has_anim_event_fired(&(uLocal_484[0]), -2119958604))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_SHACKLES_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			}
			if (has_anim_event_fired(&(uLocal_484[0]), -1187377914))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("THANKS_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_8(&uLocal_661, 64);
			}
			if (has_anim_event_fired(&(uLocal_484[0]), -108754809))
			{
				func_167(&(uLocal_484[0]), Global_35, func_166("HR_NO_PAY_AGAIN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_42(&(Local_228.f_5), 1);
				func_172(&(Local_228.f_5), 1);
...
void func_143()
{
	...
	{
		case 0:
			_0x8b3b71c80a29a4bb(&(uLocal_484[0]), -217808743, 6);
			break;
		case 1:
			_0x8b3b71c80a29a4bb(&(uLocal_484[0]), 746733444, 6);
			break;
		case 2:
			_0x8b3b71c80a29a4bb(&(uLocal_484[0]), -725351883, 6);
			break;
		case 3:
			_0x8b3b71c80a29a4bb(&(uLocal_484[0]), -578377130, 6);
			break;
	}
}
...
void func_144()
{
	...
	iVar1 = -1;
	iVar1 = func_359(uLocal_484[0], Local_592[0], 50f, &Local_614, &(Local_228.f_192), 0f, 1, 0, 0, iVar0, 0, 0, 2, 1, -1082130432, 0);
	if (iVar1 == 0)
	{
		switch (iVar481)
		{
	...
	if (iVar682 == 1)
	{
		if (is_any_speech_playing(&(uLocal_484[0])))
		{
		}
		else
		{
	...
	if (func_26(&uLocal_560) > 1f && !is_any_speech_playing(Global_35))
	{
		switch (iVar481)
		{
			case 0:
				func_182(0);
				if (!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[13]), Local_128[13]->f_1, 1))
				{
					if (iLocal_227 == 0)
					{
			...
			case 2:
				...
				else if (func_57(iVar659, 67108864))
				{
					if (iLocal_227 == 0)
					{
						if (iVar668 == 1)
...
void func_148()
{
	...
	{
		iLocal_210 = _create_volume_sphere_with_custom_name(vLocal_197, 0f, 0f, 0f, 8f, 8f, 8f, "RoadNodeVol");
		if (_does_volume_exist(iLocal_210))
		{
			_0xc1799fafd2fdf52b(iLocal_210, 0, 0, 0);
		}
	}
	if (!func_247(vLocal_200))
	{
		iLocal_211 = _create_volume_sphere_with_custom_name(vLocal_200, 0f, 0f, 0f, 8f, 8f, 8f, "RoadNodeVol2");
		if (_does_volume_exist(iLocal_211))
		{
			_0xc1799fafd2fdf52b(iLocal_211, 0, 0, 0);
		}
	}
}
...
bool func_149()
{
	...
	{
		case 0:
			task_turn_ped_to_face_entity(&(uLocal_484[0]), Global_35, -1, -1082130432, -1082130432, -1082130432);
		...
		case 1:
			...
			{
				_0x89f5e7adecccb49c(&(uLocal_484[0]), "chain_gang_legs");
				task_set_crouch_movement(&(uLocal_484[0]), false, 0, false);
				open_sequence_task(&iLocal_488);
				task_set_crouch_movement(0, false, 0, false);
				task_go_to_entity(0, Global_35, -1, 6f, 1.5f, 4f, 0);
				func_168(&(uLocal_484[0]), &iLocal_488, 0, 0, 1, 1);
				iLocal_669 = add_shocking_event_for_entity(-998484125, &(uLocal_484[0]), 0f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				uLocal_666 = iVar664 + 1;
			}
			break;
		case 2:
			if (func_145(&(uLocal_484[0]), 1, 1) < 40f && func_363(&Local_228, 3f, 45f, 45f, 1, 0, 1, -1082130432, 1, 1125515264, 0, 0))
			{
				...
				clear_sequence_task(&iLocal_488);
				open_sequence_task(&iLocal_488);
				task_play_upper_anim_facing_entity(0, &(Local_128[2]), Local_128[2]->f_1, Global_35, 2500, 8f, -2f, 67109392, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
				task_go_to_entity(0, Global_35, -1, 6f, 1.5f, 4f, 0);
				task_turn_ped_to_face_entity(0, Global_35, -1, -1082130432, -1082130432, 0.52f);
				close_sequence_task(iVar486);
				task_perform_sequence(&(uLocal_484[0]), iVar486);
				clear_sequence_task(&iLocal_488);
				uLocal_666 = iVar664 + 1;
			}
			break;
...
void func_150(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	...
	if ((Global_36616 && func_264(iParam1)) != 0)
	{
		return;
	}
...
void func_153()
{
	...
	{
		if (!func_57(iVar659, 32) && !func_57(iVar659, 32768))
		{
			iLocal_683 = 1;
		}
		else if (fVar654 != 15f)
...
void func_154()
{
	...
	{
		case 0:
			if ((((!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[3]), Local_128[3]->f_1, 1) && !is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[2]), Local_128[2]->f_1, 1)) && !is_any_speech_playing(&(uLocal_484[0]))) && !is_any_speech_playing(Global_35)) && (!func_27(&uLocal_551) || (func_27(&uLocal_551) && func_26(&uLocal_551) > 2f)))
			{
				task_play_anim(&(uLocal_484[0]), &(Local_128[3]), Local_128[3]->f_1, 2f, -2f, 5833, 67109392, 0f, false, 1245184, false, "UpperbodyFixup_filter", false);
				uLocal_664 = iVar662 + 1;
			}
			break;
		case 1:
			if (((!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[3]), Local_128[3]->f_1, 1) && !is_any_speech_playing(&(uLocal_484[0]))) && !is_any_speech_playing(Global_35)) && func_57(iVar659, 4194304))
			{
				open_sequence_task(&iLocal_488);
				task_play_upper_anim_facing_entity(0, &(Local_128[4]), Local_128[4]->f_1, Global_35, 8500, 2f, -2f, 67109392, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
				task_turn_ped_to_face_entity(0, Global_35, -1, -1082130432, -1082130432, 0.52f);
				func_168(&(uLocal_484[0]), &iLocal_488, 0, 0, 1, 1);
			...
			break;
		case 2:
			if ((func_368(&(uLocal_484[0])) >= 1 && func_26(&uLocal_578) > 8.5f) && !is_any_speech_playing(&(uLocal_484[0])))
			{
				iLocal_682 = 1;
				uLocal_664 = iVar662 + 1;
			}
			break;
		case 3:
			if (!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[1]), Local_128[1]->f_1, 1))
			{
			...
			break;
		case 4:
			if (func_57(iVar659, 32768) || func_57(iVar659, 32))
			{
				if (((func_26(&uLocal_551) > 7f && !func_57(iVar659, 2)) && !func_370(&(uLocal_484[0]), 0)) && !func_370(Global_35, 0))
				{
					if (iVar674 == 1)
					{
						func_189(&uLocal_551);
					...
					if (iLocal_227 == 0)
					{
						task_play_anim(&(uLocal_484[0]), &(Local_128[5]), Local_128[5]->f_1, 2f, -2f, 3500, 67109392, 0f, false, 1245184, false, "UpperbodyFixup_filter", false);
						uLocal_664 = iVar662 + 1;
					}
			...
			break;
		case 5:
			if (!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[5]), Local_128[5]->f_1, 1))
			{
				func_189(&uLocal_551);
				uLocal_664 = iVar662 + 1;
			}
			break;
		case 6:
			if (((func_26(&uLocal_551) > 9f && !func_57(iVar659, 2)) && !func_57(iVar659, 512)) && !func_57(iVar659, 1))
			{
				if (iLocal_227 == 0)
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("CMON"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
...
int func_155(int iParam0, int iParam1, int iParam2)
{
	...
	if ((iVar0 > -1 && iVar0 < 4) && _does_volume_exist(iParam1))
	{
		...
		if (func_57(Global_1955500[iVar0], 0))
		{
			func_30(iVar0, 1024);
			func_30(iVar0, 16);
			func_30(iVar0, 256);
...
void func_157()
{
	...
	if (!func_57(iVar659, 4) && (func_57(iVar659, 32) || func_57(iVar659, 32768)))
	{
		if (!is_any_speech_playing(&(uLocal_484[0])) && !is_any_speech_playing(Global_35))
		{
			func_8(&uLocal_661, 4);
			iLocal_483 = 1;
	...
	{
		if ((iVar1 != -1569615261 && iVar1 != -618550132) && func_31(&(uLocal_484[0]), 0, 1))
		{
			if (func_60(Global_35, &(uLocal_484[0]), 1, 1) < 3f)
			{
				...
				{
					iLocal_672 = 1;
					set_ped_config_flag(Global_35, 26, bVar0);
				}
			}
			else
			{
	...
	if (!func_57(iVar659, 2) && func_57(iVar659, 4))
	{
		if (get_current_ped_weapon(Global_35, &iVar1, true, 0, false))
		{
			if ((iVar1 != -1569615261 && func_326(&(uLocal_484[0]), 1, 1, 1, 0, 0)) && get_ped_reset_flag(Global_35, 0) == 1)
			{
				if (!is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[8]), Local_128[8]->f_1, 1) && !is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[9]), Local_128[9]->f_1, 1))
				{
					func_373(&(uLocal_484[0]));
					clear_sequence_task(&iLocal_488);
					open_sequence_task(&iLocal_488);
					task_play_upper_anim_facing_entity(0, &(Local_128[6]), Local_128[6]->f_1, Global_35, 800, 2f, -2f, 67109392, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, 5000, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					if (!func_57(iVar659, 512))
					{
						task_play_upper_anim_facing_entity(0, &(Local_128[8]), Local_128[8]->f_1, Global_35, 1266, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					}
					task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, 5000, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					if (!func_57(iVar659, 1024))
					{
						task_play_upper_anim_facing_entity(0, &(Local_128[9]), Local_128[9]->f_1, Global_35, 3366, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					}
					task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, -1, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
					close_sequence_task(iVar486);
					task_perform_sequence(&(uLocal_484[0]), iVar486);
					clear_sequence_task(&iLocal_488);
					_0xdd1232b332cbb9e7(3, 1, 0);
					stop_current_playing_ambient_speech(&(uLocal_484[0]), 0);
					func_8(&uLocal_661, 2);
				}
			}
		}
	}
	if (func_57(iVar659, 4))
	{
		switch (iVar658)
		{
			case 0:
				func_374();
				if (is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[5]), Local_128[5]->f_1, 1) || is_entity_playing_anim(&(uLocal_484[0]), &(Local_128[7]), Local_128[7]->f_1, 1))
				{
			...
			case 1:
				func_374();
				if (func_375(&(uLocal_484[0]), 1090519040, 1103626240, 1097859072, 0) && get_ped_reset_flag(Global_35, 0) == 1)
				{
					func_189(&uLocal_539);
				...
				iVar2 = 0;
				if (get_ped_reset_flag(Global_35, 0) == 1 && func_326(&(uLocal_484[0]), 1, 1, 1, 0, 0))
				{
					iVar2 = 1;
				}
				if (((iVar2 == 0 || (iVar2 == 1 && func_26(&uLocal_542) > 35f)) || func_57(iVar659, 8388608)) || iVar666 >= iVar665)
				{
					if (((func_315(&uLocal_539) > fVar654 || (iVar2 == 1 && func_26(&uLocal_542) > 35f)) && !is_any_speech_playing(&(uLocal_484[0]))) || iVar666 >= iVar665)
					{
						if (!func_57(iVar659, 1))
						{
							func_8(&uLocal_661, 1);
	...
	switch (iVar660)
	{
		...
		case 1:
			if (!is_any_speech_playing(&(uLocal_484[0])))
			{
				...
				if (is_string_null(sVar684))
				{
					func_147();
				}
				if (bVar454 == 0 || (bLocal_195 == 0 && bLocal_196 == 0))
				{
					iLocal_662 = 5;
				}
				else
			...
			break;
		case 2:
			if (!is_any_speech_playing(Global_35) && !is_any_speech_playing(&(uLocal_484[0])))
			{
				if (!func_57(iVar659, 8))
				{
					func_182(0);
					if (iLocal_227 == 0)
					{
		...
		case 3:
			...
			if (((!is_any_speech_playing(Global_35) && !is_any_speech_playing(&(uLocal_484[0]))) && (((get_script_task_status(&(uLocal_484[0]), 242628503, true) == 1 && get_sequence_progress(&(uLocal_484[0])) > 3) || func_175(&(uLocal_484[0]), 1682639051)) || iVar0 == 1)) && func_57(iVar659, 8192))
			{
				func_182(0);
				func_167(&(uLocal_484[0]), Global_35, sVar684, 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		...
		case 4:
			if (!is_any_speech_playing(&(uLocal_484[0])))
			{
				...
				func_30(iVar491, 1);
				func_100(&(uLocal_484[0]));
				func_8(&uLocal_661, 134217728);
				return true;
			}
			break;
		case 5:
			fLocal_658 = _get_entity_anim_current_time(&(uLocal_484[0]), &(Local_128[12]), Local_128[12]->f_1);
			if ((fVar656 > 0.97f || func_175(&(uLocal_484[0]), 1682639051)) || (bVar454 == 0 || (bLocal_195 == 0 && bLocal_196 == 0)))
			{
				if (bVar454 == 0 || (bLocal_195 == 0 && bLocal_196 == 0))
				{
					if (iLocal_227 == 0)
...
void func_159()
{
	if (func_57(iVar659, 4194304) || func_57(iVar659, 32))
	{
		if (func_26(&uLocal_557) > 1f)
		{
			...
			{
				func_24(&uLocal_557);
				task_perform_sequence(&(uLocal_484[0]), iVar487);
			}
		}
	}
}
...
void func_160()
{
	if (!func_31(&(uLocal_484[0]), 0, 1) || iVar662 < 5)
	{
		return;
	}
	if (func_145(&(uLocal_484[0]), 1, 1) < fVar655)
	{
		if (bVar669)
		{
			iLocal_671 = 0;
	...
	else if (!bVar669)
	{
		...
		if (func_57(iVar659, 2))
		{
			func_187(&uLocal_661, 2);
		}
	}
	if (!func_57(iVar659, 131072))
	{
		if (bVar669 == 0)
		{
			func_369(&(uLocal_484[0]), Global_35, &uLocal_494, -1082130432, 0, 0, 3f, -1f, 1, 8, 0, 0, 3f, 1073741824, 1050253722, 4f, 0, 0, -1, 1, -1082130432, -1082130432, 1);
...
void func_161()
{
	...
	{
		if ((_0x9c81338b2e62ce0a(player_id(), &(uLocal_484[0]), 1000) && !_0x79c2bec82cfd7f7f(uVar453)) && !is_any_speech_playing(&(uLocal_484[0])))
		{
			func_164(&(uLocal_484[0]), 0);
			switch (iVar666)
			{
				case 0:
					func_378(&(uLocal_484[0]), "GENERIC_SHOCKED_MED", 1808677283, Global_35, 1, &(Local_422[0]->f_23), 1, 1);
					break;
				case 1:
					func_378(&(uLocal_484[0]), "GENERIC_SHOCKED_MED", 1808677283, Global_35, 1, &(Local_422[0]->f_23), 2, 1);
					break;
				case 2:
					func_378(&(uLocal_484[0]), "GENERIC_SHOCKED_HIGH", 1808677283, Global_35, 1, &(Local_422[0]->f_23), 1, 1);
					break;
				case 3:
					func_378(&(uLocal_484[0]), "GENERIC_SHOCKED_HIGH", 1808677283, Global_35, 1, &(Local_422[0]->f_23), 2, 1);
					break;
			}
			uLocal_668 = iVar666 + 1;
			func_189(&uLocal_566);
			if (iVar666 >= iVar665)
			{
				fLocal_656 = 5f;
...
void func_163()
{
	...
	vLocal_653 = { get_entity_coords(&(uLocal_484[0]), true, false) };
	fLocal_659 = get_entity_heading(&(uLocal_484[0]));
	vLocal_650 = { _get_object_offset_from_coords(vLocal_653, fVar657, 0f, 0.1f, -0.9f) };
}
...
void func_165(int iParam0)
{
	...
	func_388(_create_var_string(6, func_386(iParam0), fVar1), "itemtype_textures", func_387(iVar0), 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_169(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_28((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
bool func_171(int iParam0, int iParam1, int iParam2)
{
	...
	else if ((get_game_timer() - *iParam1) > iParam2)
	{
		return true;
	}
...
void func_173()
{
	func_88(Local_614[0], "RE_INTER_POS", 0, -163964935, 0, 0, 0, 0, 0);
	func_88(Local_614[1], "RE_INTER_ANTAGONIZE", 0, 648122183, 0, 0, 0, 0, 0);
	func_28(Local_614[0], 0, 0);
	func_28(Local_614[1], 0, 0);
}
...
void func_174()
{
	...
	if (func_57(iVar659, 65536))
	{
		return;
	}
	if ((get_script_task_status(&(uLocal_484[0]), 242628503, true) == 1 && get_sequence_progress(&(uLocal_484[0])) > 2) || iVar660 >= 3)
	{
		func_369(&(uLocal_484[0]), Global_35, &uLocal_494, -1082130432, 0, 0, 3f, -1f, 1, 8, 0, 0, 3f, 1073741824, 1050253722, 4f, 0, 0, -1, 1, -1082130432, -1082130432, 1);
		func_156(&(uLocal_484[0]), Global_35, 1, 1, 0, 0, 0, 1, 0, 1, 1);
		func_8(&uLocal_661, 65536);
	}
}
		...
		if (!func_57(iVar659, 16384))
		{
			if (func_26(&uLocal_554) > 15f && (func_186(&(uLocal_484[0]), vLocal_206, 1) < 7f && func_60(&(uLocal_484[0]), Global_35, 1, 1) < 7f))
			{
				if (!is_any_speech_playing(Global_35) && !is_any_speech_playing(&(uLocal_484[0])))
				{
					...
					func_189(&uLocal_554);
					func_8(&uLocal_661, 16384);
				}
			}
		}
		else if (!func_57(iVar659, 1073741824))
		{
...
void func_188()
{
	if (_is_ped_hogtied(&(uLocal_484[0])))
	{
		if (!func_57(iVar659, 2097152))
		{
			if (!is_ambient_speech_playing(&(uLocal_484[0])) && !is_any_speech_playing(&(uLocal_484[0])))
			{
				if (iVar676 == 1)
				{
...
{
	if (is_entity_on_screen(iParam0) && func_405(Global_35, iParam0, 0, fParam1, 0))
	{
		return true;
	}
	return false;
...
void func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_141(Global_1360165[iParam0], 0);
	...
	else
	{
		...
		{
			func_24(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
bool func_226(var uParam0, var uParam1)
{
	...
	{
		if (func_428(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
void func_229(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_31(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			clear_ped_secondary_task(iParam0);
			fVar2 = func_228(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
void func_240(int iParam0)
{
	...
	while (iVar0 < *iParam0)
	{
		func_434(&((*iParam0)[iVar0]->f_1));
		func_434(&((*iParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
void func_243(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_267());
		if (func_441(Global_1310750[iParam0], 33554432))
		{
...
int func_251(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (func_453(&(uParam0->f_37), 500))
	{
		...
		while (iVar0 < 8)
		{
			if (!func_247(*uParam0->f_12[iVar0]))
			{
...
bool func_262(var uParam0, var uParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				{
					bVar1 = (bParam6 || func_465(&(uParam0->f_22)));
					Var2 = { func_461(vParam2, fParam5, uParam0->f_6, bVar1) };
					Var2.f_3 = func_462(fParam5, uParam0->f_9, bVar1);
				}
				*uParam1 = func_463(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
void func_276(int iParam0, int iParam1)
{
	...
	func_475(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_476(iParam0, 0);
	func_477(iParam0);
	func_478(1);
...
{
	if (uParam0->f_177 != -1 || func_441(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_486(uParam0->f_177));
			}
		}
	}
...
bool func_292(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_501(&(Global_1898164->f_1[0]));
		if (func_502(iVar0) && func_503((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
int func_306(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
...
bool func_326(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_60(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_328(int iParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_338(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_339(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_340(int iParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_291(iParam1))
	{
...
bool func_344(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_348(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_60(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
void func_357()
{
	...
	{
		if ((func_26(&uLocal_584) > 1f && !is_any_speech_playing(Global_35)) && !is_any_speech_playing(&(uLocal_484[0])))
		{
			if (!func_57(iVar659, 1024) && !func_57(iVar659, 2))
			{
				if (!func_351(0))
				{
					func_167(&(uLocal_484[0]), Global_35, func_166("SHOOT_DAMN"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
	...
	if ((iVar660 >= 3 && !func_57(iVar659, 268435456)) && !func_57(iVar659, 8))
	{
		return;
	}
	if (iVar481 == 3)
	...
	if ((is_any_speech_playing(&(uLocal_484[0])) || is_any_speech_playing(Global_35)) || (iVar662 > 0 && iVar481 == 0))
	{
		if (iVar680 == 1)
		{
			iLocal_682 = 0;
	...
	else if (iVar680 == 0 && func_57(iVar659, 4))
	{
		iLocal_682 = 1;
		if (iVar678 == 1)
		{
...
void func_360(int iParam0)
{
	...
	else if ((iVar646 == 11 || iVar646 == 2) || iVar646 == 0)
	{
		func_214(37, 3, 1);
	}
	if (func_57(iVar658, 2))
	{
		task_play_upper_anim_facing_entity(&(uLocal_484[0]), &(Local_128[7]), Local_128[7]->f_1, Global_35, -1, 2f, -2f, 67109392, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
		iVar0 = 7500;
		clear_sequence_task(&uLocal_489);
		open_sequence_task(&uLocal_489);
		task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, iVar0, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
		if (func_57(iVar658, 1024) && func_57(iVar658, 512))
		{
			task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, -1, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
			iLocal_660 = 1;
			fLocal_656 = 2f;
		}
		else if (func_57(iVar658, 512))
		{
			task_play_upper_anim_facing_entity(0, &(Local_128[9]), Local_128[9]->f_1, Global_35, 3366, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
			task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, -1, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
		}
...
{
	return func_530(_get_map_zone_at_coords(vParam0, 10));
}
...
int func_362(int iParam0)
{
	...
	vVar9 = { func_531(6) };
	vVar12 = { func_531(7) };
	fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
	fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
	fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
	fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
	fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
	*vLocal_163[0] = { vVar0 };
	*vLocal_163[1] = { vVar3 };
	*vLocal_163[2] = { vVar6 };
	*vLocal_163[3] = { vVar9 };
	*vLocal_163[4] = { vVar12 };
	...
	if (get_distance_between_coords(*vLocal_163[0], vVar0, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
		iLocal_157[0] = 2;
	}
	else if (get_distance_between_coords(*vLocal_163[0], vVar3, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
		iLocal_157[0] = 0;
	}
	else if (get_distance_between_coords(*vLocal_163[0], vVar6, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
		iLocal_157[0] = 3;
	}
	else if (get_distance_between_coords(*vLocal_163[0], vVar9, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
		iLocal_157[0] = 6;
	}
	else if (get_distance_between_coords(*vLocal_163[0], vVar12, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
		iLocal_157[0] = 7;
	}
	if (get_distance_between_coords(*vLocal_163[1], vVar0, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
		iLocal_157[1] = 2;
	}
	else if (get_distance_between_coords(*vLocal_163[1], vVar3, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
		iLocal_157[1] = 0;
	}
	else if (get_distance_between_coords(*vLocal_163[1], vVar6, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
		iLocal_157[1] = 3;
	}
	else if (get_distance_between_coords(*vLocal_163[1], vVar9, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
		iLocal_157[1] = 6;
	}
	else if (get_distance_between_coords(*vLocal_163[1], vVar12, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
		iLocal_157[1] = 7;
	}
	if (get_distance_between_coords(*vLocal_163[2], vVar0, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
		iLocal_157[2] = 2;
	}
	else if (get_distance_between_coords(*vLocal_163[2], vVar3, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
		iLocal_157[2] = 0;
	}
	else if (get_distance_between_coords(*vLocal_163[2], vVar6, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
		iLocal_157[2] = 3;
	}
	else if (get_distance_between_coords(*vLocal_163[2], vVar9, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
		iLocal_157[2] = 6;
	}
	else if (get_distance_between_coords(*vLocal_163[2], vVar12, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
		iLocal_157[2] = 7;
	}
	if (get_distance_between_coords(*vLocal_163[3], vVar0, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
		iLocal_157[3] = 2;
	}
	else if (get_distance_between_coords(*vLocal_163[3], vVar3, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
		iLocal_157[3] = 0;
	}
	else if (get_distance_between_coords(*vLocal_163[3], vVar6, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
		iLocal_157[3] = 3;
	}
	else if (get_distance_between_coords(*vLocal_163[3], vVar9, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
		iLocal_157[3] = 6;
	}
	else if (get_distance_between_coords(*vLocal_163[3], vVar12, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
		iLocal_157[3] = 7;
	}
	if (get_distance_between_coords(*vLocal_163[4], vVar0, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar0, true);
		iLocal_157[4] = 2;
	}
	else if (get_distance_between_coords(*vLocal_163[4], vVar3, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar3, true);
		iLocal_157[4] = 0;
	}
	else if (get_distance_between_coords(*vLocal_163[4], vVar6, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar6, true);
		iLocal_157[4] = 3;
	}
	else if (get_distance_between_coords(*vLocal_163[4], vVar9, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar9, true);
		iLocal_157[4] = 6;
	}
	else if (get_distance_between_coords(*vLocal_163[4], vVar12, true) < 1f)
	{
		fVar15 = get_distance_between_coords(Local_228.f_51, vVar12, true);
		iLocal_157[4] = 7;
	}
...
bool func_363(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	bVar1 = false;
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		...
		if (func_284(&(uParam0->f_121), iParam4, fParam1))
		{
			...
			if (uParam0->f_186)
			{
				_0xb2a38826e5886e83(func_232(uParam0->f_3, uParam0->f_185), 0);
			}
			return true;
		}
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_388(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_388(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_388(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_388(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
void func_374()
{
	vVar6 = { get_ped_bone_coords(&(uLocal_484[0]), 56200, 0.2f, 0.11f, 0f) };
	vVar3 = { get_ped_bone_coords(&(uLocal_484[0]), 21030, 0f, 0f, 0f) };
	_0x3daabe78a23694bc(get_player_index(), &vVar0);
	fVar9 = get_distance_between_coords(vVar0, vVar3, true);
	fVar10 = get_distance_between_coords(vVar0, vVar6, true);
	iVar11 = 0;
	vVar12 = { func_547(0) };
	vVar15 = { func_548(vVar3 - get_gameplay_cam_coord()) };
	fVar18 = absf(get_angle_between_2d_vectors(vVar15.x, vVar15.y, vVar12.x, vVar12.y));
	fVar19 = absf(get_angle_between_2d_vectors(vVar15.y, vVar15.z, vVar12.y, vVar12.z));
	if (fVar18 < 4f)
	{
		if (fVar19 < 4f)
		{
	...
	if ((func_326(&(uLocal_484[0]), 1, 1, 1, 0, 0) || iVar11 == 1) && get_ped_reset_flag(Global_35, 0) == 1)
	{
		if ((fVar9 < 0.3f || fVar10 < 0.3f) || iVar11 == 1)
		{
			...
			if (func_26(&uLocal_581) > 7.5f && !is_any_speech_playing(&(uLocal_484[0])))
			{
			}
		}
		...
		if (func_57(iVar659, 1048576))
		{
			return;
		}
		if (fVar9 < 0.3f || fVar10 < 0.3f)
		{
			if (!is_any_speech_playing(&(uLocal_484[0])) && func_26(&uLocal_581) > 0.75f)
			{
				clear_sequence_task(&iLocal_488);
				open_sequence_task(&iLocal_488);
				task_play_upper_anim_facing_entity(0, &(Local_128[13]), Local_128[13]->f_1, Global_35, 7166, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
				task_play_upper_anim_facing_entity(0, &(Local_128[7]), Local_128[7]->f_1, Global_35, 5000, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
				if (!func_57(iVar659, 512))
				{
					task_play_upper_anim_facing_entity(0, &(Local_128[8]), Local_128[8]->f_1, Global_35, 1266, 2f, -2f, 67109393, 0f, false, false, -1f, "UpperbodyFixup_filter", 1245184, -1f);
...
bool func_375(int iParam0, float fParam1, float fParam2, float fParam3, bool bParam4)
{
	...
	{
		fVar0 = func_60(iParam0, player_ped_id(), 0, 1);
		if (fVar0 < fParam3 && fVar0 > 0.5f)
		{
			if (is_player_free_aiming(player_id()) || is_player_targetting_entity(player_id(), iParam0, false))
			{
				...
				iVar3 = func_517(player_ped_id(), 0);
				if (func_549(iVar3) && !is_control_pressed(0, 130948705))
				{
					return false;
				}
...
bool func_376()
{
	if (has_anim_event_fired(&(uLocal_484[0]), func_550(14)) && iVar589 == 2)
	{
		return true;
	}
	if (has_anim_event_fired(&(uLocal_484[0]), func_550(22)) && iVar589 == 0)
	{
		return true;
	}
	return false;
...
bool func_379(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
int func_390(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_570(func_378(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_403(int iParam0, int iParam1)
{
	if (func_140(iParam0, 1, 1))
	{
		return func_57(Global_1955500[iParam0], iParam1);
	}
	return false;
}
...
void func_410(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_576(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_411(int iParam0, int iParam1, bool bParam2)
{
	...
	func_577(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_420(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_220(iParam0);
	if (((does_entity_exist(iVar1) && func_580(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
int func_425(int iParam0, bool bParam1)
{
	...
	{
		_0x0de02da3c0f66955(func_220(iParam0), _0xb7e0590c86e1711f(get_player_group(get_player_index())));
		_0x61bda07407754a5c(func_220(iParam0), Global_1391438->f_414.f_37);
	}
	_0x89e59dbd15e21177(func_48(), 0);
	func_590(iParam0);
...
int func_426(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (does_blip_exist(func_591(iParam0)) && !is_entity_dead(iVar0))
	{
...
{
	fVar0 = func_228(bParam6, fParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
...
int func_463(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_609(iVar0))
		{
		...
		if (func_610(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_611(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_617(&(uParam1->f_22)));
		...
		if (!func_609(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_620(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_621(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_621(&(uParam1->f_22)));
...
void func_469(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_623(iParam0, 8))
		{
...
void func_475(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_211(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_481(int iParam0)
{
	...
	if (!func_257(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_482(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_634(to_float(iVar0), 1, 0);
	}
	else
	{
		func_634((to_float(200) / 3f), 1, 0);
	}
}
...
bool func_489(var uParam0, float fParam1, float fParam2, int iParam3)
{
	if (fParam1 > fParam2)
	{
		return false;
...
bool func_490(var uParam0, float fParam1, float fParam2, int iParam3)
{
...
bool func_499(bool bParam0, int iParam1, int iParam2)
{
...
int func_526(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_228(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
...
void func_532(var uParam0, int iParam1, vector3 vParam2, var uParam5)
{
	...
	while (iVar0 < iParam1)
	{
		fVar3 = get_distance_between_coords(vParam2, *(*uParam5)[iVar0], true);
		iVar1 = 0;
		while (iVar1 < iParam1)
		{
			fVar4 = get_distance_between_coords(vParam2, *(*uParam5)[iVar1], true);
			if (fVar4 <= fVar3)
			{
				fVar3 = fVar4;
				*(*uParam0)[iVar0] = { *(*uParam5)[iVar1] };
				iVar2 = iVar1;
			}
			iVar1++;
		}
...
int func_534(int iParam0)
{
	...
	fVar1 = func_228(absf(fVar1) < 1f, func_228(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
int func_544(int iParam0, int iParam1)
{
	...
	if (!func_671(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
void func_553(int iParam0, bool bParam1)
{
	...
	_uilog_add_entry_hash(4, func_676(iParam0), func_531(iParam0), get_hash_key(sVar4), get_hash_key(sVar5), 0);
	_uilog_set_entry_brief_texture(4, func_676(iParam0), get_hash_key(sVar6), -445557482);
	_uilog_set_entry_icon_texture(4, func_676(iParam0), iVar2, iVar3);
	_uilog_add_or_update_objective(4, func_676(iParam0), get_hash_key(sVar0), sVar0, false, false, false);
	if (bParam1)
	{
		return;
	}
...
int func_562(float fParam0, float fParam1)
{
	...
	fVar1 = to_float(func_680(iVar0));
	fVar2 = to_float(func_680(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_565(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = _create_var_string(10, sVar0, func_687(iParam0));
...
bool func_569(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return false;
...
{
	return func_520(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}

bool func_573(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
...
int func_585(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_141(iVar0, 0))
	{
		if (func_141(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_582(iParam0)) || func_583(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_695(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_697(iParam0);
					_0x7b204f88f6c3d287(func_698(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_698(iParam0, 0));
					func_699(iParam0);
				}
			}
			else
	...
	{
		if (func_141((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_574(iParam0, 32768, 1))
			{
...
bool func_586(int iParam0, bool bParam1)
{
	...
	return is_ped_group_member(iVar0, func_48(), 1);
}
...
{
	iVar0 = func_220(iParam0);
	if (!func_407(iParam0) || is_entity_dead(iVar0))
	{
		return;
	}
...
void func_590(int iParam0)
{
	if (func_407(iParam0))
	{
		...
		_0xdeb369f6ad168c58(func_220(iParam0), iVar0);
		_0x1740e3dee0ae4d27(func_220(iParam0), iVar1);
	}
}
...
void func_592(int iParam0, int iParam1)
{
	...
	if ((*Global_1360165)[iParam0]->f_12 == 0 || func_576(&((*Global_1360165)[iParam0]->f_12), 1))
	{
		if (does_blip_exist(*iParam1))
		{
			func_703(iParam0);
	...
	iVar0 = 0;
	iVar1 = 0;
	bVar2 = func_576(&((*Global_1360165)[iParam0]->f_12), 512);
	if (func_576(&((*Global_1360165)[iParam0]->f_12), 128))
	{
		iVar0 = 942020339;
	}
	else if (func_576(&((*Global_1360165)[iParam0]->f_12), 8))
	{
		iVar0 = -546708623;
	}
	if (func_576(&((*Global_1360165)[iParam0]->f_12), 256))
	{
		iVar1 = func_704(-1739349092);
	}
	if (!does_blip_exist(*iParam1))
	{
		*iParam1 = _blip_add_for_entity(422991367, func_220(iParam0));
	}
	if (does_blip_exist(*iParam1))
	{
		if (iVar0 != 0)
		...
		if (bVar2 && !func_292(0, 0, 1))
		{
			...
			if (func_576(&((*Global_1360165)[iParam0]->f_12), 1024))
			{
				_blip_set_modifier(*iParam1, -46775694);
			}
			if (func_576(&((*Global_1360165)[iParam0]->f_12), 2048))
			{
		...
		if (!is_string_null_or_empty(&((*Global_1360165)[iParam0]->f_14)) && func_576(&((*Global_1360165)[iParam0]->f_12), 8))
		{
			set_blip_name_from_text_file(*iParam1, &((*Global_1360165)[iParam0]->f_14));
		}
		else
		{
			set_blip_name_from_text_file(*iParam1, func_705(iParam0, 0));
		}
	}
}
...
void func_596(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_475(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_476(iParam0, 1);
	if (!bParam2)
	{
		func_210(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_713(iParam0))
		{
...
bool func_602(vector3 vParam0)
{
	...
	{
		if (!func_247(*Global_1310750->f_16043[iVar0]))
		{
			if (func_193(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
void func_625(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_441(Global_1310750[iVar0], iParam0))
		{
			if (!func_433(iVar0))
			{
				iVar1 = 1;
...
bool func_641(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_2(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_734(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_648(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_738(Global_35)) || func_739(Global_35)) || func_740(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_741(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_742(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_743(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_391(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_653(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_741(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
{
	func_758(iParam0, 4);
	func_760(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_759(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_759(iParam0));
	}
}
...
int func_683(int iParam0)
{
	...
	{
		case 0:
			return _0xe787f05dfc977bde(func_766(0), -1845241476, 0);
		case 1:
			return _0xe787f05dfc977bde(func_766(0), 1654063339, 0);
		case 2:
			return _0xe787f05dfc977bde(func_766(0), 1623931083, 0);
	}
	return 0;
}
...
char* func_685(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
float func_695(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_193(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_696(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_768(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_698(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_769(iParam0);
	}
...
void func_701(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		_0xd428c3f92fc3f6f8(iVar0, func_771(iParam0));
...
char* func_705(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_523((*Global_1835011)[59]->f_1, 1) || func_523((*Global_1347702)[1]->f_15, 1)) || func_774((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
...
void func_706(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_220(iVar0), func_48(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_777() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_777();
					}
					func_778(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
...
bool func_719(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
bool func_729(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_786((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_731(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_787(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
...
bool func_735(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	iVar0 = 0;
	if (func_789(16))
	{
...
void func_736(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_787(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
bool func_744(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
...
bool func_762(int iParam0)
{
	...
	return func_774((*Global_1347702)[iParam0]->f_15);
}
...
int func_763(int iParam0)
{
	...
	return func_804((*Global_1347702)[iParam0]->f_15);
}
...
bool func_770(int iParam0)
{
	if (func_407(iParam0))
	{
		if (func_141(Global_1360165[iParam0], 0))
		{
			return true;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_570(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
