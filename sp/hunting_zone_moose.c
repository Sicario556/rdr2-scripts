...
bool func_42(var uParam0)
{
	*uParam0 = 12;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = 1549722570;
	uParam0->f_572[1] = 666462942;
	uParam0->f_572[2] = 1187982516;
	uParam0->f_580[0] = 5;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 5;
	...
	uParam0->f_12.f_1 = -1098441944;
	uParam0->f_12.f_3 = 1.35f;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = 1415163930;
	return true;
}
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_MO");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_MO");
}
...
Vector3 func_165()
{
	return func_203("ATZ_INS_TRB_MO");
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2700.37f, 2123.778f, 166.0227f;
				case 1:
					return 2801.177f, 2284.213f, 156.2252f;
				case 2:
					return 2711.611f, 2360.467f, 163.4895f;
			}
			break;
		case 1:
			switch (iParam1)
		...
		case 2:
			...
			{
				case 0:
					return 2763.556f, 2268.943f, 157.3732f;
				case 1:
					return 2709.607f, 2206.442f, 156.3639f;
				case 2:
					return 2744.499f, 2205.549f, 156.5387f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 0:
					return 2737.672f, 2169.843f, 156.0805f;
				case 1:
					return 2760.128f, 2198.124f, 155.971f;
				case 2:
					return 2718.78f, 2279.259f, 156.8531f;
			}
			break;
	}
	return 0f, 0f, 0f;
