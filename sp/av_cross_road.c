void __EntryFunction__()
{
	...
	Var0 = Local_17;
	Var0.f_1 = Local_17.f_11;
	Var0.f_483 = { Local_17.f_1 };
	Var0.f_486 = { Local_17.f_4 };
	Var0.f_489 = Local_17.f_7;
	Var0.f_20[0] = Local_17.f_8;
	Var0.f_453 = Local_17.f_9;
	Var0.f_500 = Local_17.f_10;
	Var0.f_503 = Local_17.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 11152, 11161, 11552);
}
...
{
	func_46(uParam0, "CROSS_ROAD", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 78:
			iLocal_10 = -1797625440;
			iLocal_12 = -830507952;
			break;
		case 125:
			iLocal_10 = 2028722809;
		...
		case 157:
			...
			iLocal_12 = -1181541851;
			break;
		case 171:
			iLocal_10 = 252669332;
			iLocal_12 = 1935884576;
			break;
		case 173:
			iLocal_10 = -753902995;
			iLocal_12 = -1986793661;
			break;
		case 179:
			iLocal_10 = -1854059305;
			iLocal_12 = -830507952;
			break;
		case 180:
			iLocal_10 = -593056309;
			...
			break;
		case 181:
			iLocal_10 = 1751700893;
			iLocal_12 = 1189123422;
			break;
		case 185:
			iLocal_10 = -1134449699;
			iLocal_12 = -1931496610;
			break;
		case 191:
			iLocal_10 = 1007418994;
			iLocal_12 = -2042157234;
			break;
		case 195:
			iLocal_10 = 1458540991;
			iLocal_12 = 1051774341;
			break;
		case 193:
			iLocal_10 = -541762431;
			iLocal_12 = -1374871530;
			break;
		case 197:
			iLocal_10 = -1568716381;
			iLocal_12 = -1177922299;
			break;
		case 210:
			iLocal_10 = 40345436;
			iLocal_12 = -1268535563;
			break;
		case 211:
			iLocal_10 = -1211566332;
			iLocal_12 = -2131366097;
			break;
		case 212:
			iLocal_10 = 545068538;
			iLocal_12 = -830507952;
		...
		case 214:
			...
			iLocal_12 = -1874044762;
			break;
		case 229:
			iLocal_10 = -2011226991;
			iLocal_12 = -1365219416;
			break;
	}
	func_47(uParam0, 0, "CRP_ANIMAL", iLocal_10, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	switch (iLocal_13)
	{
		case 0:
			...
			{
				func_55(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_12, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
		...
		case 1:
			if (func_57(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					vVar0 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 10f, 0f) };
					vVar3 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, -1f, 0f) };
					func_55(&vVar0, 50, 10, 0);
					_0xa3a9299c4f2adb98(&(uParam0->f_20[0]));
					_task_smart_flee_style_coord(&(uParam0->f_20[0]), vVar3, iLocal_11, 66816, fLocal_9, -1, 0);
					set_ped_config_flag(&(uParam0->f_20[0]), 230, true);
					_0xf9cbd46433e36713(Global_35, &(uParam0->f_20[0]), 0f, 0f, 0f, 10f, 40f, 70f, 20f, "CRP_ANIMAL");
				}
				func_58(*uParam0, 0);
				func_59(*uParam0, uParam0->f_483, 0);
				func_60(&uLocal_14);
				iLocal_13 = 2;
			}
			break;
		case 2:
			if (!func_61(&(uParam0->f_20[0]), 518218985))
			{
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_65(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
bool func_51()
{
	return (Global_1894899 & 1 != 0 && func_63() != -1);
}
...
int func_53(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_81(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_57(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
...
void func_59(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0]->f_5)
	{
		Global_32074.f_2697.f_6[iParam0]->f_5 = func_40();
...
void func_62(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (bParam1)
	{
		if (_does_anim_scene_exist(uParam0->f_3.f_1))
...
bool func_65(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

bool func_66(vector3 vParam0, float fParam3)
{
	iVar0 = 0;
	while (iVar0 < 4)
	{
		...
		{
			if (func_94(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_67(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_95(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	if (!does_entity_exist(iParam0) || is_entity_dead(iParam0))
	{
		return;
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_94(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
