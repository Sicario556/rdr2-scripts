...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 1085457901, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_29 = func_153(uParam0, 2095602337, 0f, 0f, 0f, "NEWSPAPER", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0, -1073741824, 1065353216, 1);
...
int func_216(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_321(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_218(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_322(iParam0);
	}
...
bool func_247(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_328(&(Global_1898164->f_1[0]));
		if (func_329(iVar0) && func_330((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_331(&(Global_1898164->f_1[0])))
	{
		return true;
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_337(747937920, 1) && !func_418((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
