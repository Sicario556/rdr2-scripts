...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[57]->f_4;
	iLocal_15 = _create_volume_cylinder(1411.869f, -7032.472f, 71.50774f, 0f, 0f, -25.35288f, 142.4495f, 133.1683f, 45.87774f);
	return true;
}
...
bool func_38(int iParam0)
{
	...
	if (_does_volume_exist(iLocal_15))
	{
		if (func_58(57, 33554432))
		{
			if (!bLocal_16)
			{
				_0xf2a2177ac848b3a8(iLocal_15, 0, 1);
				bLocal_16 = true;
			}
		}
		else if (bLocal_16)
		{
			_0xf2a2177ac848b3a8(iLocal_15, 1, 1);
			bLocal_16 = false;
		}
	}
	return false;
...
bool func_57(int iParam0)
{
	...
	return func_106((*Global_1835011)[iParam0]->f_1);
}
...
int func_88(int iParam0, bool bParam1)
{
	...
	{
		func_143(iParam0, _create_persistent_character(func_142(iParam0)));
		if (func_20() == -1)
		{
...
{
	if (func_86(Global_1914319->f_3[iParam0]->f_21) && func_172(Global_1914319->f_3[iParam0]->f_21))
	{
...
bool func_183(int iParam0, int iParam1)
{
	...
	{
		return func_199(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
