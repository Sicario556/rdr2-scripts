void __EntryFunction__()
{
	...
	while (!func_5(&Local_103, 1))
	{
		...
		if (((((func_6(&Local_103) >= 5 && func_6(&Local_103) <= 7) && !func_5(&Local_103, 4096)) && _does_anim_scene_exist(Local_103.f_428.f_444)) && _is_anim_scene_started(Local_103.f_428.f_444, false)) && !_is_anim_scene_paused(Local_103.f_428.f_444))
		{
		...
		switch (func_6(&Local_103))
		{
			...
			case 3:
				...
				func_39(&Local_103);
				if (func_40(func_32((*Global_1835011)[Local_103]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_103.f_428)) == 4 && _does_anim_scene_exist(Local_103.f_428.f_444)) && _is_anim_scene_paused(Local_103.f_428.f_444))
				{
					func_37(Local_103);
					func_17(&Local_103, 7);
				}
...
void func_43(int iParam0)
{
	if (!func_158(iLocal_94, 0))
	{
		...
		func_131(iParam0, iLocal_94, "Horse_01^1", 0, 0, 1);
	}
}
...
bool func_53(int iParam0)
{
	...
	{
		delete_ped(iLocal_86[0]);
	}
	delete_ped(iLocal_86[1]);
	if (_does_volume_exist(iLocal_95))
	{
		func_166(&uLocal_97, iLocal_95, 0);
		_delete_volume(iLocal_95);
	}
	if (_does_volume_exist(iLocal_96))
	{
		func_166(&uLocal_98, iLocal_96, 0);
		_delete_volume(iLocal_96);
	}
	if (func_167(1, 0))
	{
		func_168(1, 0, 1, 0, 0);
	...
	func_171(583884620);
	func_171(261929195);
	if (func_172((*Global_1835011)[69], 1024))
	{
		func_173((*Global_1835011)[69], 65536);
	}
	return true;
}
...
void func_56(int iParam0)
{
	...
	while (iVar2 < 27)
	{
		...
		else
		{
			...
			{
				func_175(iParam0, iVar3, iVar4, 0, bVar0, !bVar1, 0);
			}
		}
		iVar2++;
	}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_187(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_187(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_74(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_183(&(Global_1898164->f_1[0]));
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_187(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_187(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_187(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_187(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_260(iVar0), func_261(), 1))
			{
...
{
	if (!does_entity_exist(&(uLocal_84[0])))
	{
	...
	if (!does_entity_exist(&(iLocal_92[0])))
	{
	...
	if (!_does_volume_exist(iLocal_95))
	{
		func_279(&iLocal_95, -309.1536f, 807.8724f, 117.9846f, 0f, 0f, 9.50955f, 11.31853f, 23.76741f, 11.20267f, "m_volPedBlock");
		return false;
	}
	else if (!_0x91a5f9cbebb9d936(uLocal_97))
	{
		uLocal_97 = func_280(iLocal_95, 0, 0, 10208);
		func_281(iLocal_95, 0, 0);
	}
	if (!_does_volume_exist(iLocal_96))
	{
		func_279(&iLocal_96, -302.9859f, 793.3909f, 118.461f, 0f, 0f, 9.721658f, 4.348468f, 3.904367f, 3.210507f, "m_volHitchBlock");
		return false;
	}
	else if (!_0x91a5f9cbebb9d936(uLocal_98))
	{
		uLocal_98 = func_280(iLocal_96, 0, 0, 0);
		func_281(iLocal_96, 0, 0);
	}
	func_282(uParam0, iLocal_95);
	func_284(&(uParam0->f_428), 36177);
	func_164(69, 0);
	func_138(2);
	func_285(32, 1);
	func_138(2);
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_260(iVar0));
...
bool func_137(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		set_current_ped_weapon(iVar0, -1569615261, true, 0, false, false);
	}
	if (bParam7)
	{
		iVar0 = &iLocal_92[iParam1];
	...
	func_295(iVar0, vParam2, fParam5, 2, 1073741824);
...
int func_139(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_300(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_300(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_300(iParam0));
	...
	_0x7b204f88f6c3d287(func_300(iParam0));
	return 1;
}
...
bool func_142()
{
	return func_302(get_id_of_this_thread());
}
...
void func_144(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_307(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_148(int iParam0)
{
	...
	return func_315((*Global_1835011)[iParam0]->f_1);
}
...
void func_153()
{
	if (!bLocal_100)
	{
		...
		{
			if (does_entity_exist(&(vLocal_29[iVar0])))
			{
				if (_get_anim_scene_entity_matrix(iLocal_99, vLocal_29[iVar0]->f_2, &vLocal_72, false, 0, 2))
				{
					create_model_hide_excluding_script_objects(vLocal_72, 5f, vLocal_29[iVar0]->f_1, false);
				}
			}
			iVar0++;
		}
...
int func_155(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_324(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_307(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_307(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_331(uParam0, uParam0->f_1684))
				{
					...
					{
						func_333(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		if (func_306(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_307(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_327(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_333(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_157(int iParam0)
{
	...
	if (vdist2(func_187(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
...
int func_160(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	Var1.f_10 = 7;
	Var1 = iParam4;
	Var1.f_1 = iParam5;
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_359(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_360(uParam0->f_1522[iVar0], 128))
				{
					func_361(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
int func_165(int iParam0)
{
	...
	_0x4f81ead1de8fa19b(func_300(iParam0));
	return 1;
}
...
void func_175(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_172((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_172((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_391(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_176(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_393((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_395((*uParam1)[iVar0]))
		{
			if (func_393((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_396((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_397((*uParam2)[iVar0]))
		{
			if (func_393((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_398((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_399((*uParam3)[iVar0]))
		{
			if (func_393((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_400((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_402((*uParam5)[iVar0]))
		{
			if (func_393((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_403((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_402((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_404((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_393((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_405((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_406((*uParam6)[iVar0]))
		{
			if (func_393((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_407((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_408((*uParam7)[iVar0]))
		{
			if (func_393((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_409((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_410((*uParam8)[iVar0]))
		{
			if (func_393((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_411((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_412((*uParam9)[iVar0]))
		{
			if (func_393((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_413((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_414((*uParam10)[iVar0]))
		{
			if (func_393((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_415((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_416((*uParam11)[iVar0]))
		{
			if (func_393((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_417((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_188(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_280(iParam1, 0, 0, 0);
}
...
void func_196(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_427(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_206(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_431(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_186());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
...
void func_230(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_447(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_430() };
...
void func_231(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_247(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_448(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
void func_239(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_465() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_241(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_466(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_295(iVar1, func_466(uParam0), func_467(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_295(iVar3, func_466(uParam0), func_467(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_466(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_466(uParam0) };
			func_295(iVar0, vVar1, func_468(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_247(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_471(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_471(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_475(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_473(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_251(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_483(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_256(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_487(iParam3, 1)])
			{
				func_490(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_474(32768) && iParam1 != &Global_1946804->f_57[func_487(iParam3, 1)])
			{
				func_491();
...
void func_257(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_496(0), &Var5, iParam1);
}
...
bool func_258(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_354(*iParam1, 2))
	{
		...
		else if ((func_500(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_500(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_500(iParam2, 1024))) || func_500(iParam2, 8)) && !func_354(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_501(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_500(iParam2, 4096)) && !func_354(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_501(iParam1, 2048);
			func_501(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_500(iParam2, 32)) && !func_354(*iParam1, 5632))
		{
...
int func_270(var uParam0, int iParam1)
{
	...
	if (func_142())
	{
		...
		if (func_507(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_508(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_306(uParam0, 8) && _0xdd0b7c5ae58f721d(func_509()))
	{
		_0x798be43c9393632b(func_509());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_509())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_273(int iParam0)
{
	...
	return func_384((*Global_1835011)[iParam0]->f_1);
}
...
bool func_277(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (!does_entity_exist(&(iLocal_86[iVar0])))
		{
			...
			if (iVar0 != 4)
			{
				...
				if (has_model_loaded(iVar1))
				{
					if (iVar0 == 2)
					{
						iLocal_86[iVar0] = func_522(iVar1, vVar2, fVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
						_set_ped_outfit_preset(&(iLocal_86[iVar0]), 3, 0);
						_update_ped_variation(&(iLocal_86[iVar0]), false, true, false, false, false);
					}
					else if (iVar0 == 3)
					{
						iLocal_86[iVar0] = func_522(iVar1, vVar2, fVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
						_set_ped_outfit_preset(&(iLocal_86[iVar0]), 6, 0);
						_update_ped_variation(&(iLocal_86[iVar0]), false, true, false, false, false);
					}
					else
					{
		...
		else
		{
			...
			set_ped_relationship_group_hash(&(iLocal_86[iVar0]), 1030835986);
		}
		iVar0++;
	}
	return true;
...
bool func_278(var uParam0)
{
	...
	while (iVar0 < 14)
	{
		if (!does_entity_exist(&(vLocal_29[iVar0])))
		{
			...
			{
				case 0:
					vLocal_29[iVar0]->f_1 = iLocal_19;
					vLocal_29[iVar0]->f_2 = "P_ASHTRAY01X";
					break;
				case 1:
					vLocal_29[iVar0]->f_1 = iLocal_20;
					vLocal_29[iVar0]->f_2 = "p_Windsorchair03x";
					break;
				case 2:
					vLocal_29[iVar0]->f_1 = iLocal_20;
					vLocal_29[iVar0]->f_2 = "p_Windsorchair03x^1";
					break;
				case 3:
					vLocal_29[iVar0]->f_1 = iLocal_21;
					vLocal_29[iVar0]->f_2 = "p_bottlebeer01x";
					break;
				case 4:
					vLocal_29[iVar0]->f_1 = iLocal_21;
					vLocal_29[iVar0]->f_2 = "p_bottleBeer01x^1";
					break;
				case 5:
					vLocal_29[iVar0]->f_1 = iLocal_22;
					vLocal_29[iVar0]->f_2 = "p_bottleJD01x";
					break;
				case 6:
					vLocal_29[iVar0]->f_1 = iLocal_23;
					vLocal_29[iVar0]->f_2 = "p_cs_newspaper_01x";
					break;
				case 7:
					vLocal_29[iVar0]->f_1 = iLocal_24;
					vLocal_29[iVar0]->f_2 = "p_glass_cs06x";
					break;
				case 8:
					vLocal_29[iVar0]->f_1 = iLocal_24;
					vLocal_29[iVar0]->f_2 = "p_glass_cs06x^1";
					break;
				case 9:
					vLocal_29[iVar0]->f_1 = iLocal_25;
					vLocal_29[iVar0]->f_2 = "p_rag02x";
					break;
				case 10:
					vLocal_29[iVar0]->f_1 = iLocal_26;
					vLocal_29[iVar0]->f_2 = "p_nutBowl01x";
					break;
				case 11:
					vLocal_29[iVar0]->f_1 = iLocal_27;
					vLocal_29[iVar0]->f_2 = "p_coin01x";
					break;
				case 12:
					vLocal_29[iVar0]->f_1 = iLocal_27;
					vLocal_29[iVar0]->f_2 = "p_coin01x^1";
					break;
				case 13:
					vLocal_29[iVar0]->f_1 = iLocal_28;
					vLocal_29[iVar0]->f_2 = "p_knife02x";
					break;
			}
			request_model(vLocal_29[iVar0]->f_1, false);
			if (has_model_loaded(vLocal_29[iVar0]->f_1))
			{
				vLocal_29[iVar0] = create_object(vLocal_29[iVar0]->f_1, vVar1, true, true, false, false, true);
			}
			return false;
		}
		else
		{
			func_286(uParam0, &(vLocal_29[iVar0]), vLocal_29[iVar0]->f_2, 0, 0, 1, 0);
		}
		iVar0++;
	}
	return true;
...
void func_279(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
	*iParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, sParam10);
}

var func_280(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
{
	func_533(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_534(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
int func_291(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_392((*uParam0)[iVar1]))
		{
			if (func_393((*uParam0)[iVar1]->f_2, iParam12))
			{
				if (!func_536((*uParam0)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam1)
	{
		if (func_395((*uParam1)[iVar1]))
		{
			if (func_393((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_537((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_397((*uParam2)[iVar1]))
		{
			if (func_393((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_538((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		if (func_399((*uParam3)[iVar1]))
		{
			if (func_393((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_402((*uParam5)[iVar1]))
		{
			if (func_393((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_539((*uParam5)[iVar1]))
				{
					if (!func_540((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
			...
			if (func_393((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_539((*uParam5)[iVar1]))
				{
					if (func_540((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_404((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_541((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_406((*uParam6)[iVar1]))
		{
			if (func_393((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_542((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_408((*uParam7)[iVar1]))
		{
			if (func_393((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_543((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_410((*uParam8)[iVar1]))
		{
			if (func_393((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_544((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_412((*uParam9)[iVar1]))
		{
			if (func_393((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_545((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_414((*uParam10)[iVar1]))
		{
			if (func_393((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_546((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_416((*uParam11)[iVar1]))
		{
			if (func_393((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_547((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
void func_295(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_549(Global_35) && is_player_teleport_active())
	{
	}
	if (func_550(iParam0))
	{
		if (func_551(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_354(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_354(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_354(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_354(iParam5, 32), true);
	...
	else if (func_354(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_354(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_354(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_325(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_561(1));
		if (!has_anim_dict_loaded(func_561(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_326(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_307(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	if (func_63(uParam0, 16))
	{
		...
		fVar5 = func_468(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_333(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_566(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_336(uParam0, 4);
			...
			if (func_258(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_305(uParam0, 4);
...
void func_333(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_555(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
...
void func_334(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_340(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_573(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_573(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_575(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_575(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_569(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_575(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_577(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_468(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_575(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_575(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_575(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_579(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_579(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_597(uParam0)) && _is_anim_scene_started(func_597(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_597(uParam0));
				bVar1 = _is_anim_scene_finished(func_597(uParam0), false);
				bVar2 = _is_anim_scene_active(func_597(uParam0));
...
int func_352(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_598(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
int func_358(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_604((*Global_1835011)[4]->f_1, 1))
		{
			if (func_605(5))
			{
				func_606(5);
	...
	if ((bVar0 && func_604((*Global_1835011)[37]->f_1, 1)) && !func_604((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_604((*Global_1835011)[43]->f_1, 1)) && !func_604((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
int func_372(int iParam0, bool bParam1)
{
	...
	func_371(iParam0);
	_0xfc77c5b44d5ff7c0(func_300(iParam0));
	func_634(iParam0, 0);
	return 1;
}
...
bool func_374(int iParam0)
{
	...
	return (!func_603() || is_bit_set(Global_40.f_7854, iParam0));
}
...
{
	return func_640(iParam0, iParam1, 4, get_hash_key(func_639(iParam1)));
}
...
{
	func_644(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_391(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_158(Global_1360165[iParam0], 0);
	...
	if (bParam3)
	{
		...
		func_651(iParam0, 1056964608, -1, 1061158912);
	...
	if (!func_658(uParam0->f_2, 1))
	{
		if (func_539(uParam0))
		{
			if (_is_anim_scene_metadata_loaded(uParam0->f_1, false))
			{
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_zero") && func_265())
				{
					set_anim_scene_entity(uParam0->f_1, "player_zero", Global_35, 0);
				}
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_662())
				{
...
void func_428(struct<4> Param0)
{
	...
	if (func_669(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_669(20))
			{
				return;
			}
			iVar0++;
...
int func_439(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_673(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
void func_457()
{
	...
	if (func_470(iVar0))
	{
		...
		{
			func_684(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
{
	return ((Global_1946804->f_57[func_487(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_477(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_475(1108822547, 6))
	{
		if (bParam2)
		{
			func_473(iParam0, iVar0, func_259() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_487(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_487(iParam0, 1)])->f_10 || iParam1);
}

void func_480(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_487(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_487(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_487(iParam0, 1)])->f_10 && iParam1));
}
...
bool func_488(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_474(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_704(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_704(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_706(iParam0, iParam2, iParam1, func_259() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_480(func_478(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
struct<4> func_494(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_496(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_495(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_496(bParam6), &Var0, 0);
	return uVar4;
}
...
void func_505(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_715(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_716(1, bVar1, 1, uVar2);
		func_717(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_718(ceil(&(Global_40.f_11095.f_11[iParam0])));
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_267(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_391(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
				else if (func_158(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_158(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_295(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_724(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_726(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_158(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_728(Global_1360165[iParam0], 1);
				}
			}
			func_722(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_729(Global_1360165[iParam0]))
				{
				}
			}
			func_730(iParam0, Global_1360165[iParam0]);
...
void func_518(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_163() || !_0x6f1f0b17109309da(Global_43800, func_216(iParam0))))
	{
...
int func_521(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	if (!func_504(iParam1))
	{
		return 0;
	...
	if ((!does_entity_exist(iVar0) || !func_158(iVar0, 0)) || (bParam3 && !func_736(iParam1)))
	{
		if (bParam2)
		{
			if (func_737(iParam1, 1) != 0)
			{
				iVar0 = func_738(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, fParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
	...
	if (does_entity_exist(iVar0) && func_158(iVar0, 0))
	{
		*uParam0 = 2;
		(*Global_1360165)[iParam1]->f_70.f_2 = 0;
		func_739(iParam1, iVar0);
...
int func_522(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_741(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_523(int iParam0, bool bParam1)
{
	...
	{
		func_634(iParam0, _create_persistent_character(func_298(iParam0)));
		if (func_259() == -1)
		{
			if (func_368(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_300(iParam0));
				func_370(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_300(iParam0));
		}
		return false;
	}
...
int func_524(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_367(iParam0)) && !is_entity_dead(iVar0))
	{
...
void func_525(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_745(), true);
	}
}
...
int func_529(int iParam0, int iParam1)
{
	...
	if (iVar2 != -1)
	{
		if (iParam1 == 1)
		{
			func_752((*Global_1392915)[iVar0]->f_4);
		}
...
void func_530(int iParam0)
{
	...
	if (func_181((*Global_1392915)[iParam0]->f_4))
	{
		func_753((*Global_1392915)[iParam0]->f_4, 1, 2);
	}
...
{
	func_757((*Global_1392915)[iParam0]);
	func_758(Global_1392915->f_121[iParam0]);
}

void func_533(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	{
		iVar1 = func_760(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_761(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_483(uParam0->f_13[iVar0], 2);
		}
	}
}

void func_534(int iParam0, int iParam1, char* sParam2)
{
	func_763(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
void func_562(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_579(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_563(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
		{
			...
			else if ((!func_770(512) || func_771(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_555(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_772(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_333(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
				...
				else if (func_775(uParam0->f_1633[iVar2]) != 0)
				{
					func_774(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_555(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_198(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_772(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_566(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_776(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_567(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_779(uParam0, iVar0)) && !func_507(uParam0->f_1016[iVar0], 1))
			{
				if (!func_780(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_781(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_782(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_581(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_776(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_307(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_598(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_598(uParam0->f_475[iParam1], 64) && func_785(uParam0, iParam1, 0))
				{
					func_786(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_787(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_598(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_787(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_584(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_332(uParam0) != 11) && func_331(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_360(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_360(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_781(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_586(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_332(uParam0))
	{
		case 0:
			...
			if (((!func_307(uParam0->f_1016[iVar2], 32) && func_790()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_307(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_307(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_331(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_307(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_307(uParam0->f_1016[iVar2], 256) || !func_451(&uVar5)) || bVar0)
			{
				if (func_795())
				{
					func_796();
...
bool func_589(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_800(uParam0, 0))
		{
			if (func_801(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_802(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_802(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_802(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_802(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_802(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_802(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_802(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_802(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_802(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_802(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_802(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_802(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_802(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_802(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_802(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_801(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_802(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_802(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_802(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_801(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_804(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_803(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_802(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_782(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_430() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_805(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_800(uParam0, 45))
				{
					if (func_801(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_806(uParam0->f_1522[iVar16], 2);
							func_803(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_807(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_806(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_801(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_806(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_806(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_800(uParam0, 57))
				{
					if (func_801(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_801(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_801(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_810(iVar17);
							}
							if (func_801(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_811(iVar17);
							}
							func_801(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_802(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_802(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_802(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_801(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_802(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_801(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_801(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_802(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_800(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_807(uParam0, 87, uParam0->f_1345[iVar18]);
						func_803(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_803(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_802(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_802(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_801(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_812(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_800(uParam0, 98))
				{
					if (func_801(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_813(uParam0, 99, uParam0->f_1633[iVar16]);
							func_813(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_813(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_801(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_804(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_590(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_360(uParam0->f_1522[iVar0], 2)) && !func_360(uParam0->f_1522[iVar0], 16)) && func_815(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_806(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_806(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_591(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_360(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_509());
		func_506(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_509()))
		{
...
bool func_592(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_360(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_816(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_806(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_593(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_550(uParam0->f_3[iVar0]->f_2)) && func_470(uParam0->f_3[iVar0]->f_10)) && !func_809(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_817(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_818(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_607(int iParam0)
{
	...
	func_827(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_828(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_829(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_830(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_831(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_832(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_833(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_834(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_835(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_836(_get_map_zone_at_coords(vParam0, 10));
}
...
struct<6> func_622()
{
	if (func_852(-997150586, &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_852(-1189569496, &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_852(325139909, &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_852(1310070322, &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_852(986998820, &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_852(-415648720, &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
void func_623(int iParam0, var uParam1, var uParam2, int iParam3)
{
	if (!does_entity_exist(iParam0))
	{
		return;
	...
	func_853(iParam0);
	func_854(iParam0, uParam1);
	func_855(iParam0);
	func_856(iParam0, uParam2);
	if (iParam3 != 0)
	{
		func_857(iParam0, iParam3, 0);
	}
...
char* func_625(int iParam0)
{
	...
	{
		return func_858(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_859(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_642(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!_0x01f4d242765c6b24(func_865(iParam0)))
		{
			_0xca41e86545413b5b(func_182(iParam0), func_183(iParam0), func_866(iParam0), func_865(iParam0), Global_36);
		}
	}
	func_867(iParam0, 1);
	bParam1 = bParam1;
...
void func_643(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_418(Global_1898330[iParam0]);
		func_868((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}
...
void func_644(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_869(uParam0, iParam1);
	}
...
void func_646(int iParam0, int iParam1, bool bParam2)
{
	...
	func_871(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_654(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_260(iParam0);
	if (((does_entity_exist(iVar1) && func_874(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
int func_666(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
int func_684(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_881(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
{
	return func_494(1328661203, func_885(), -1591664384, bParam0);
}
...
struct<4> func_691(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_494(923904168, func_689(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_494(923904168, func_689(bParam0), -740156546, 0) };
		}
...
struct<4> func_695(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_494(271701509, func_689(bParam0), 12999093, 0) };
		}
...
bool func_697(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_496(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_700(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_699(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	func_888(&(Global_1946804->f_2589), iParam0);
}

void func_703(int iParam0, int iParam1)
{
	func_889(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
{
	iVar1 = 12;
	iVar2 = func_453(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_476(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_453(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_892(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_453(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_699(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_892(&(Global_1946804->f_1497.f_1[iVar1])) || func_699(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_453(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_453(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_453(&(uParam0->f_1[iVar1])) || func_699(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_707(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_475(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_896(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_708(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_898(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_259() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_899(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_900(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_900(Global_40.f_7729);
				Global_1946804->f_1378 = func_900(Global_40.f_7729);
...
bool func_712(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_384((*Global_1360165)[iParam0]->f_4.f_2) || func_315((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_908((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_910(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_649(iParam0, 44, 1);
			}
...
void func_730(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_684(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_684(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_737(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_930(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_738(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			if (func_158((*Global_1360165)[iParam0]->f_124, 0))
			{
				func_932(iParam0, 3);
			}
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_737(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_937(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_935();
				}
			}
			if ((bParam2 && !func_90(vVar0)) && !func_579(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_295((*Global_1360165)[iParam0]->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
			...
			func_938((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_737(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_741(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
int func_748(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_158(iVar0, 0))
	{
		if (func_158(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_746(iParam0)) || func_736(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_947(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_948(iParam0);
					_0x7b204f88f6c3d287(func_931(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_931(iParam0, 0));
					func_949(iParam0);
				}
			}
			else
...
{
	if (func_434(Global_1392915->f_121[iParam0]->f_3))
	{
		_display_hud_component(-1744263063);
		func_435(&(Global_1392915->f_121[iParam0]->f_3), 1, 0);
...
void func_753(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_641(iParam0) == 3 || (func_641(iParam0) == 1 && _0x01f4d242765c6b24(func_865(iParam0))))
	{
...
void func_763(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	func_962(uParam0);
	iVar0 = func_963(uParam0, iParam1);
	if (bParam3)
	{
		if (is_string_null_or_empty(sParam2))
		{
...
void func_764(int iParam0)
{
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_967(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_969((*Global_1900383)[iParam0]->f_26);
		func_970((*Global_1900383)[iParam0]->f_26);
...
void func_768(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_769(iParam1)) };
...
{
	switch (func_775(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_555(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_451(&(uParam0->f_1903)))
				{
					func_794(uParam0->f_1903, 0);
					func_972(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_555(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_973())
				{
					func_972(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_777(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_468(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_778(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_977(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_780(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_507(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_783(int iParam0, float fParam1)
{
	...
	if (!(func_980(17) && func_198(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_786(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_359(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
			if (!is_string_null_or_empty(&cVar1) && _0x6f1f0b17109309da(iParam1, &cVar1))
			{
				...
				{
					func_787(iVar9, Global_35, uParam2, uParam3);
				}
			}
		}
		iVar0++;
...
void func_787(int iParam0, var uParam1, var uParam2, var uParam3)
{
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
...
void func_788(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_360(uParam0->f_1522[iVar0], 1))
			{
			...
			{
				if ((func_8(uParam0) > 3 && !func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_981(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_662(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_806(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_361(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_598(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_327(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_506(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_216(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_307(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_789(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_598(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_791(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_307(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_307(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_470(func_469(Global_35, 0, 1, 0)) && !func_470(func_469(Global_35, 1, 1, 0))))
		{
			if (func_331(uParam0, uParam0->f_1684))
			{
				func_983(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_307(uParam0->f_1016[uParam0->f_1684], 16) && (func_470(func_469(Global_35, 0, 1, 0)) || func_470(func_469(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_307(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_331(uParam0, uParam0->f_1684) && !func_340(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_595(uParam0, 3);
	}
...
void func_792(var uParam0, int iParam1, bool bParam2)
{
	...
	func_982(uParam0, func_575(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_985(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_782(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_508(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_983(vVar1);
	...
	if (func_598(uParam0->f_475[iParam1], 16))
	{
		func_986(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_797(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_993(iVar0));
		iVar0++;
	}
}
...
bool func_803(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_808(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if (((func_809(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_436(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_994(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_436(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_436(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_994(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_994(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_813(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_815(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_360(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_598(uParam0->f_475[iVar0], 512)) || func_598(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_809(uParam0->f_3[iVar0]->f_1))
				{
					if (func_662())
					{
						StringCopy(&cVar1, func_436(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_820(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_971(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
int func_842(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_603())
	{
		...
		{
			bVar0 = false;
			if (!func_604((*Global_1835011)[15]->f_1, 1) && !func_886(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_604((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_1013();
				*iParam1 = func_1014();
				*uParam2 = func_1015();
...
bool func_850(int iParam0, var uParam1)
{
	...
	*uParam1 = func_1026(Var0, 1415981582, 0);
...
bool func_851(int iParam0, var uParam1)
{
	...
	*uParam1 = func_1026(Var0, -2119169513, 0);
	if (!func_452(*uParam1, 0))
	{
		return false;
	}
...
void func_854(int iParam0, var uParam1)
{
	...
	func_1029(iParam0, *uParam1);
	func_1029(iParam0, uParam1->f_1);
}
...
void func_856(int iParam0, var uParam1)
{
	...
	func_1029(iParam0, *uParam1);
	func_1029(iParam0, uParam1->f_1);
	func_1029(iParam0, uParam1->f_2);
	func_1029(iParam0, uParam1->f_3);
	func_1029(iParam0, uParam1->f_4);
	func_1029(iParam0, uParam1->f_5);
}
...
char* func_869(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_1038(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_881(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
		...
		while (iVar28 < 4)
		{
			...
			if (func_693(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_1043(0))
				{
					...
					func_1044(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_884(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_1047("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_1046(iParam1, 512) && func_887(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_817(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_1046(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_1046(iParam1, 4))) && (!func_817(Var4.f_4) || func_1046(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_1046(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_1046(iParam1, 1048576)))
				{
...
void func_888(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1052(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_1052(uParam0->f_2[iVar0], 1))
				{
					func_1053(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_890(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_487(iParam0, 1)] != &Global_1946804->f_57[func_487(iParam0, 1)];
}
...
{
	if (iParam0 == &Global_1946804->f_57[func_487(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_898(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_259() == -1)
	{
		func_1057(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_1058(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_1059(&(Global_1946804->f_1378), iParam0);
...
float func_904()
{
	...
	func_1069(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_905()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_1069(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_906()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_1069(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_907(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_604((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_604((*Global_1347702)[63]->f_15, 1) || func_315((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_604((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_604((*Global_1347702)[134]->f_15, 1) || func_315((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_604((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_1075(747937920, 1) && !func_604((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> func_910(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
void func_918(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_914(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_914(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_914(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_914(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_914(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_914(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_914(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_914(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_914(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_914(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_914(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_914(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_914(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_914(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_914(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_914(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_914(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_914(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_914(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_914(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_914(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_914(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_914(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_914(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_914(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_914(iParam1, 1544915253))
	{
...
int func_931(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_1081(iParam0);
	}
...
bool func_936(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_737(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_522(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_937(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_1083(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_938(int iParam0, int iParam1)
{
	...
	func_945(iParam0, func_1084(iParam1));
...
void func_940(int iParam0, float fParam1, bool bParam2)
{
	if (!is_entity_dead(iParam0))
	{
...
bool func_946(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_632(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_300(iParam0));
}

float func_947(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
...
int func_952(int iParam0)
{
	switch (func_182(iParam0))
	{
		...
		case 8:
			...
			if (func_195((*Global_1347702)[iVar1]->f_12, 1))
			{
...
int func_954()
{
	...
	else if (!func_604((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_604((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_604((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_604((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_604((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_604((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_966(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_1098(func_1097(255), 109029619));
	}
	else if (func_265())
	{
...
bool func_976(var uParam0, int iParam1)
{
	...
	if ((func_470(func_818(Global_35, 0, 0, 0)) && !func_307(uParam0->f_1016[iParam1], 16)) && !func_307(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_982(var uParam0, bool bParam1)
{
	...
	if ((func_327(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_307(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_506(uParam0, 64);
	}
...
{
	if (func_598(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_554(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_507(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_468(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_554(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_507(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_468(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_1104(uParam0) };
		...
		else if (!func_507(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_468(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
{
	func_1105(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_1105(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_1106(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_987(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_468(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_507(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_988(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_468(Global_36, vParam3, 1), 0);
		}
		...
		if (func_598(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_507(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_507(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
bool func_1003(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_496(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_1004(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
...
bool func_1005(int iParam0)
{
	...
	if (func_1122(get_entity_model(iParam0)))
	{
		return true;
	}
...
int func_1026(struct<4> Param0, int iParam4, int iParam5)
{
	Var0.f_9 = -1591664384;
...
var func_1038(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}
...
bool func_1042(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_496(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_1043(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_496(bParam0));
}
...
void func_1045(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_1133(_get_weapon_clip_size(iParam0), iParam1);
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_496(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_1059(var uParam0, int iParam1)
{
	if (func_259() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_1057(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_1058(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
char* func_1098(char* sParam0, int iParam1)
{
	...
	return func_1145(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
{
	iVar0 = func_818(Global_35, 0, iParam0, 0);
	if (func_470(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
...
bool func_1115(struct<4> Param0, int iParam4)
{
	if (!func_1043(0))
	{
	...
	if (!_0x734311e2852760d0(func_496(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_1117(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
...
bool func_1118(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_496(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
int func_1119(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	if (!_0xb881ca836cc4b6d4(&Param0) || !_0xb881ca836cc4b6d4(&Param4))
	{
		return -1;
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar32 = func_1155(1168099063, &Var16, bParam9);
	if (iVar32 == -1)
	{
		return -1;
	}
...
int func_1121(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	if (!_0xb881ca836cc4b6d4(&Param0) || !_0xb881ca836cc4b6d4(&Param4))
	{
		return -1;
	...
	{
		iVar60 = func_1155(1168099063, &Var28, 0);
		iVar60 = func_1155(1168099063, &Var44, 0);
	}
	return iVar60;
}
...
bool func_1125(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_496(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
void func_1143(int iParam0, int iParam1)
{
	...
	else
	{
		...
		while (iVar0 < iParam1)
		{
			func_1160(iVar0, iVar0 + 1);
			iVar0++;
		}
	}
	if (func_181(&(Global_1898164->f_1[0])))
	{
		func_867(&(Global_1898164->f_1[0]), 3);
	}
}
...
bool func_1144(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_1161(&(Global_1109400->f_4), iVar0, 5);
	}
	if (iParam1 == func_1162())
	{
		return func_1161(&(Global_1109400->f_4), iVar0, 5);
	}
	...
	{
		return func_1161(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_1149(int iParam0, int iParam1)
{
	...
	iVar0 = func_1163(iParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_1047("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
...
int func_1150(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		return func_1164(iParam0, 0);
	}
	uVar2 = _0xe787f05dfc977bde(func_496(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_1151()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_817(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_817(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_1152(struct<4> Param0, int iParam4, bool bParam5)
{
	iVar0 = -1;
	if (!_0xb881ca836cc4b6d4(&Param0))
	{
	...
	if (iVar15 == -1784221369)
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_1166(-1230526146, &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == -1037537535)
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_1168(-1230526146, &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var61 = { func_1154(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_1155(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_1153(var uParam0, int iParam1, bool bParam2)
{
	return _0x033ee4b89f3ac545(func_496(bParam2), uParam0, iParam1);
}

struct<16> func_1154(var uParam0)
{
	Var0.f_9 = 1;
...
bool func_1161(var uParam0, int iParam1, int iParam2)
{
...
int func_1163(int iParam0, int iParam1)
{
	...
	{
		func_1171(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_1164(int iParam0, bool bParam1)
{
	if (!is_weapon_valid(iParam0))
	{
		return 0;
	}
	Var0 = { func_1172(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_1173(&Var0, func_691(0));
	}
	if (!func_1174(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_1049(iVar14);
...
struct<28> func_1165(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_496(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_1154(&Var28) };
...
struct<17> func_1167(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_496(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_1154(&Var17) };
...
void func_1171(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
struct<14> func_1172(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
...
void func_1173(var uParam0, struct<4> Param1)
{
...
bool func_1174(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_496(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
