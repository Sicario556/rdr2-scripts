...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 4.1112f, -7.5077f, 0.7655f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_150(uParam0, 1.53f, 0.16f, 1f, 0f, 3f, 3f, 3f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, 1.47142f, 0.305939f, 1.00063f, 0f, 1f, 1f, 3f, 665633627, 1);
	func_152(uParam0, 5, 0);
	iLocal_14 = func_152(uParam0, 3, 0);
	func_153(uParam0, "script@vignette@hosea_17@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@hosea_17@action_a", 2, 0, 1, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@hosea_17@action_b", 2, 0, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@hosea_17@action_b_alt_front", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@hosea_17@action_b_alt_back", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@hosea_17@exit", 0, 0, 0, 0);
	func_154(uParam0, "CH17AUD");
	func_155(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_156(uParam0, iLocal_14, 3, -1);
	Local_20 = { func_157(uParam0, 1.252f, 0.159f, 0.994f, 142.92f, 8f, 0.5f, 0.5f) };
	Local_30 = { func_157(uParam0, 1.2517f, 0.1585f, 0.9939f, -51.84f, 8f, 0.4f, 0.4f) };
	return true;
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_293(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_294(uParam0->f_107[iVar0]->f_1, fVar4);
				func_293(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_370(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_294(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(747937920, 1) && !func_385((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
