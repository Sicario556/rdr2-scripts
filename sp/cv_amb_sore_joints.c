...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 681.0845f, -1246.778f, 43f, 0f, 0f, 150f);
			break;
		default:
			return false;
	}
	func_151(uParam0, -0.0024f, 0.0058f, 0f, -113.79f, 1f, 1f, 2f, 665633627, -1, 1, 1, 1);
	iLocal_15 = func_152(uParam0, "script@vignette@ambient@av_sore_joints@pl_action", 0, 1, 0, 0);
	switch (func_19(uParam0))
	{
		case 19:
			func_153(uParam0, 19, "Ped");
			iLocal_16 = func_154(uParam0, iLocal_15, "PL_FEMALE_ACTION", 1);
			func_155(uParam0, iLocal_14, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 0, 25f, 1065353216, 1);
			break;
		case 18:
			iLocal_14 = func_153(uParam0, 17, "Ped");
			iLocal_16 = func_154(uParam0, iLocal_15, "PL_MALE_ACTION", 1);
			func_155(uParam0, iLocal_14, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_I", -1, 0, 25f, 1065353216, 1);
...
{
	func_190(uParam0, iLocal_15, "BOOL_BASE_LOOP", 1);
	return true;
}
