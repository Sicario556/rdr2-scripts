...
{
	if (!_is_scenario_group_enabled_hash(iLocal_24))
	{
		_set_scenario_group_enabled_hash(iLocal_24, true);
	}
	return true;
}
...
bool func_72(var uParam0)
{
	...
	iLocal_19 = func_151(uParam0, 1843407141, 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_17 = func_151(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_18 = func_151(uParam0, -1916489787, 0f, 0f, 0f, "WashBoard", 0, 1, 1);
	...
	func_159(uParam0, iLocal_14, 2, -1119935472, "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	func_160(uParam0, iLocal_14, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 3, -1147740400, "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 20f, 1065353216, 1);
...
bool func_86(var uParam0)
{
	if (_is_scenario_group_enabled_hash(iLocal_24))
	{
		_set_scenario_group_enabled_hash(iLocal_24, false);
	}
	return true;
}
...
{
	iVar0 = uParam0->f_107[iLocal_15]->f_32.f_21;
	...
	if (!is_sphere_visible(vLocal_21, 2f))
	{
		_set_scenario_group_enabled_hash(iLocal_24, true);
		return true;
	}
