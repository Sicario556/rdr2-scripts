void __EntryFunction__()
{
	...
	Var0 = Local_13;
	Var0.f_1 = Local_13.f_11;
	Var0.f_483 = { Local_13.f_1 };
	Var0.f_486 = { Local_13.f_4 };
	Var0.f_489 = Local_13.f_7;
	Var0.f_20[0] = Local_13.f_8;
	Var0.f_453 = Local_13.f_9;
	Var0.f_500 = Local_13.f_10;
	Var0.f_503 = Local_13.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "RGP_HORSE", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "RGP_MAN", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_58(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				...
				func_59(&(uParam0->f_20[0]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
				func_60(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1, -1, 1);
		...
		case 1:
			if (func_62(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					_0x673a8779d229ba5a(&(uParam0->f_20[1]), uParam0->f_20[1]->f_5, 0, 0);
					if (uParam0->f_489 == 1)
					{
						_task_move_in_traffic(&(uParam0->f_20[1]), 0.55f, 128, 0);
					}
					else
					{
						_task_move_in_traffic(&(uParam0->f_20[1]), 2.5f, 256, 0);
					}
...
bool func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_83(iVar0) && func_84((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_85(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_59(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_88(Global_35) && is_player_teleport_active())
	{
	}
	if (func_89(iParam0))
	{
		if (func_90(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_91(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_91(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_91(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_91(iParam5, 32), true);
	...
	else if (func_91(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_91(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_91(iParam5, 64))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_96(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_71(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_104(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_72(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_104(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_100(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_121(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_121(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_121(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_104(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
