...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.33949f, 0.232226f, 1.00873f, 3f, 0.9f, 0.9f, 2.5f, -1612834106, -1689743484, 1, 1, 1);
	func_151(uParam0, 0.476543f, -0.0842055f, 0.549286f, 3f, 0.8f, 2f, 2f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_16 = func_152(uParam0, 463271055, 0f, 0f, 0f, "stool", 0, 0, 1);
	func_153(uParam0, "script@vignette@susan_1@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@susan_1@action_a_left", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@susan_1@action_a_right", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@susan_1@action_b_left", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@susan_1@action_b_right", 0, 0, 0, 1);
	func_154(uParam0, "CSSN1AU");
	func_155(uParam0, -77448442, -1131082880);
	func_156(uParam0, iLocal_14, 3, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824, 0f, 1);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_156(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 0f, 1);
	func_159(uParam0, iLocal_15, 4, 1);
	func_157(uParam0, iLocal_15, 1, -1);
	Local_22 = { func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -151f, 3.555f, 0.4f, 0.4f) };
	Local_32 = { func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -9.75f, 2.41f, 0.4f, 0.745f) };
	if (func_161(2))
	{
		uParam0->f_14 = 1;
	}
...
{
	if (func_192(uParam0, Local_22, 1, 0))
	{
		func_191(uParam0, iLocal_17, 1);
		iLocal_21 = iLocal_19;
		return true;
	}
	else if (func_192(uParam0, Local_32, 1, 0))
	{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_210(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_212(iParam0);
					_0x7b204f88f6c3d287(func_213(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_213(iParam0, 0));
					func_214(iParam0);
				}
			}
			else
...
void func_116(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_224(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	func_225(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_228(iParam0), 137, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_228(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_228(iParam0), 204, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_228(iParam0);
	if (((does_entity_exist(iVar1) && func_230(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_243(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_244(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_159(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_257(func_148(uParam0), func_256(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_211(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_208(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_172(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_208(uParam0->f_107[iVar0]->f_8.f_3))
			{
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_253(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_186(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_253(uParam0, uParam0->f_1976.f_1), 1, func_254(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_190(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_208(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
...
void func_229(int iParam0)
{
	if (func_50(iParam0))
	{
		if (does_entity_exist(func_228(iParam0)))
		{
...
bool func_270(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_253(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
bool func_316()
{
	if (_is_ped_carrying(Global_35) || func_354(Global_35))
	{
		return true;
	}
	return false;
...
int func_335(int iParam0, bool bParam1)
{
	...
	{
		func_234(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_222() == -1)
		{
...
bool func_363(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_394((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_402(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_403(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_405(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_407(iParam0, Global_1360165[iParam0]);
...
void func_383(var uParam0, int iParam1)
{
	...
	func_414(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_384(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_417(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_211(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_424(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_422();
				}
			}
			if ((bParam2 && !func_208(vVar0)) && !func_209(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_402((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_425((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_211(iParam0, 1), get_hash_key(sVar12));
			}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_434((*Global_1360165)[iParam0]->f_4.f_2) || func_435((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_436((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_438(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_402(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_443(Global_35) && is_player_teleport_active())
	{
	}
	if (func_444(iParam0))
	{
	...
	if (func_226(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_226(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_226(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_226(iParam5, 32), true);
	...
	else if (func_226(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_226(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_226(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_408(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_232(iParam0)))
	{
		return false;
	}
...
bool func_423(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_211(iParam0, 1));
...
void func_425(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_228(iParam1)))
	{
		_0x931b241409216c1f(func_228(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_228(iParam1), iParam0);
...
int func_433(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_394((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_394((*Global_1347702)[63]->f_15, 1) || func_435((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_394((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_394((*Global_1347702)[134]->f_15, 1) || func_435((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_394((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_394((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_228(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
