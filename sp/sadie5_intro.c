...
{
	if (is_entity_in_volume(Global_35, iLocal_16, false, 0) || is_entity_in_volume(Global_35, iLocal_17, false, 0))
	{
		set_ped_max_move_blend_ratio(Global_35, 1f);
		disable_control_action(0, -1879280170, false);
	}
	if (is_entity_in_volume(Global_35, iLocal_18, false, 0))
	{
		set_ped_reset_flag(Global_35, 318, true);
	}
	if (is_valid_interior(get_interior_at_coords(-811.6449f, -1320.908f, 43.0856f)) && is_interior_ready(get_interior_at_coords(-811.6449f, -1320.908f, 43.0856f)))
	{
		if (!is_interior_entity_set_active(get_interior_at_coords(-811.6449f, -1320.908f, 43.0856f), "bla_saloon_sadie5setdressing"))
		{
			activate_interior_entity_set(get_interior_at_coords(-811.6449f, -1320.908f, 43.0856f), "bla_saloon_sadie5setdressing", 0);
		}
	}
	set_vehicle_density_multiplier_this_frame(0.75f);
	set_random_vehicle_density_multiplier_this_frame(0.75f);
	_0xab0d553fe20a6e25(0.75f);
	set_scenario_ped_density_multiplier_this_frame(0.75f);
}
...
{
	func_145(23, 0);
	if (((func_162((*Global_1835011)[*iParam0], 2) || func_162((*Global_1835011)[*iParam0], 1024)) || func_162((*Global_1835011)[*iParam0], 2048)) || func_162((*Global_1835011)[*iParam0], 32768))
	{
		if (!is_ped_injured(&(uLocal_14[0])))
		{
			_0x899a04afcc725d04(&(uLocal_14[0]), -1426095133);
		}
	}
	vVar0 = -1;
	vVar0.f_1 = -1;
...
bool func_137(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, bool bParam7)
{
	...
	func_279(iVar0, vParam2, fParam5, 2, 1073741824);
...
void func_141(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	...
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_178());
	}
}
...
bool func_147()
{
	return func_290(get_id_of_this_thread());
}
...
void func_149(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_295(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
int func_156(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_295(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_295(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
	...
	if (bVar0)
	{
		...
		if (func_294(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_295(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_327(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_328(uParam0->f_1522[iVar0], 128))
				{
					func_329(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_167(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_162((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_162((*Global_1835011)[*iParam0], 65536);
		}
	}
...
bool func_211(bool bParam0, bool bParam1)
{
	if (!func_390(Global_43801))
	{
		Global_43801 = func_395("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
bool func_226()
{
	return func_393(_0xc17f69e1418cd11f(3));
}
...
void func_233(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_422(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_279(iVar1, func_422(uParam0), func_423(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_279(iVar3, func_422(uParam0), func_423(uParam0), 2, 1073741824);
		}
	}
}
...
void func_234(var uParam0)
{
	if ((func_83(uParam0, 268435456) && !func_90(func_422(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		...
		if (!is_entity_dead(iVar0))
		{
			...
			func_279(iVar0, vVar1, func_424(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_239(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_427(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_427(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_431(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_429(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_243(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_439(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_248(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_430(32768) && iParam1 != &Global_1946804->f_57[func_443(iParam3, 1)])
			{
				func_447();
...
bool func_250(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_453(*iParam1, 2))
	{
		...
		else if ((func_457(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_457(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_457(iParam2, 1024))) || func_457(iParam2, 8)) && !func_453(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_458(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_457(iParam2, 4096)) && !func_453(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_458(iParam1, 2048);
			func_458(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_457(iParam2, 32)) && !func_453(*iParam1, 5632))
		{
...
int func_263(var uParam0, int iParam1)
{
	...
	if (func_147())
	{
		...
		if (func_464(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_465(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_294(uParam0, 8) && _0xdd0b7c5ae58f721d(func_466()))
	{
		_0x798be43c9393632b(func_466());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_466())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
void func_279(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_494(Global_35) && is_player_teleport_active())
	{
	}
	if (func_495(iParam0))
	{
		if (func_496(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_453(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_453(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_453(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_453(iParam5, 32), true);
	...
	else if (func_453(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_453(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_453(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_284(int iParam0)
{
	...
	if (func_173((*Global_1392915)[iParam0]->f_4))
	{
		func_508((*Global_1392915)[iParam0]->f_4, 1, 2);
	}
...
{
	func_512((*Global_1392915)[iParam0]);
	func_513(Global_1392915->f_121[iParam0]);
}
...
void func_298(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_519(1));
		if (!has_anim_dict_loaded(func_519(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_299(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_295(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	if (func_63(uParam0, 16))
	{
		...
		fVar5 = func_424(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_524(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_309(uParam0, 4);
...
void func_307(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_313(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_531(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_531(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_533(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_533(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_527(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_533(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_535(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_424(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_533(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_533(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_533(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_555(uParam0)) && _is_anim_scene_started(func_555(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_555(uParam0));
				bVar1 = _is_anim_scene_finished(func_555(uParam0), false);
				bVar2 = _is_anim_scene_active(func_555(uParam0));
...
int func_325(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_556(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
bool func_331(int iParam0)
{
	...
	return (!func_559() || is_bit_set(Global_40.f_7854, iParam0));
}
...
{
	return func_563(iParam0, iParam1, 4, get_hash_key(func_562(iParam1)));
}
...
void func_346(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (bParam3)
	{
		...
		func_574(iParam0, 1056964608, -1, 1061158912);
...
void func_358(var uParam0)
{
	if (!func_582(uParam0->f_2, 1))
	{
		if (func_484(uParam0))
		{
			...
			{
				sVar0 = func_392(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_586())
				{
...
void func_384(struct<4> Param0)
{
	...
	if (func_594(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_594(20))
			{
				return;
			}
			iVar0++;
...
void func_412(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_426(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_413()
{
	...
	if (func_426(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_426(iVar0))
	{
		...
		{
			func_609(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
struct<5> func_441(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_615(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_618(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_618(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_619(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_444(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_430(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_629(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_629(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_631(iParam0, iParam2, iParam1, func_251() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_436(func_434(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_462(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_643(ceil(&(Global_40.f_11095.f_11[iParam0])));
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_279(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_649(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_651(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_253(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_653(Global_1360165[iParam0], 1);
				}
			}
			func_647(iParam0, 7);
		case 7:
			...
			func_654(iParam0, Global_1360165[iParam0]);
...
float func_478()
{
	return (func_660(150f, to_float(Global_1934765->f_286)) / to_float(300));
}
...
char* func_497(int iParam0)
{
	...
	{
		return func_661(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_662(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
{
	if (func_390(Global_1392915->f_121[iParam0]->f_3))
	{
		_display_hud_component(-1744263063);
		func_391(&(Global_1392915->f_121[iParam0]->f_3), 1, 0);
...
void func_508(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_564(iParam0) == 3 || (func_564(iParam0) == 1 && _0x01f4d242765c6b24(func_668(iParam0))))
	{
...
void func_520(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_537(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_521(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
		{
			...
			else if ((!func_685(512) || func_686(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				if (func_687(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
				...
				else if (func_690(uParam0->f_1633[iVar2]) != 0)
				{
					func_689(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_516(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_190(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_687(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_524(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_691(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_525(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_694(uParam0, iVar0)) && !func_464(uParam0->f_1016[iVar0], 1))
			{
				if (!func_695(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_696(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_697(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_539(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_691(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_295(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_556(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_556(uParam0->f_475[iParam1], 64) && func_700(uParam0, iParam1, 0))
				{
					func_701(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_702(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_556(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_702(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_542(var uParam0, int iParam1)
{
	...
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_328(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_328(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_696(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_544(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_305(uParam0))
	{
		case 0:
			...
			if (((!func_295(uParam0->f_1016[iVar2], 32) && func_705()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_295(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_295(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_304(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_295(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_295(uParam0->f_1016[iVar2], 256) || !func_407(&uVar5)) || bVar0)
			{
				if (func_710())
				{
					func_711();
...
bool func_547(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_715(uParam0, 0))
		{
			if (func_716(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_717(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_717(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_717(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_717(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_717(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_717(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_717(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_717(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_717(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_717(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_717(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_717(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_717(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_717(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_717(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_716(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_717(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_717(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_717(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_716(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_719(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_718(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_717(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_697(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_386() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_720(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_715(uParam0, 45))
				{
					if (func_716(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_721(uParam0->f_1522[iVar16], 2);
							func_718(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_722(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_721(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_716(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_721(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_721(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_715(uParam0, 57))
				{
					if (func_716(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_716(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_716(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_725(iVar17);
							}
							if (func_716(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_726(iVar17);
							}
							func_716(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_717(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_717(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_717(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_716(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_717(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_716(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_716(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_717(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_715(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_722(uParam0, 87, uParam0->f_1345[iVar18]);
						func_718(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_718(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_717(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_717(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_716(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_727(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_715(uParam0, 98))
				{
					if (func_716(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_728(uParam0, 99, uParam0->f_1633[iVar16]);
							func_728(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_728(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_716(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_719(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_548(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_328(uParam0->f_1522[iVar0], 2)) && !func_328(uParam0->f_1522[iVar0], 16)) && func_730(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_721(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_721(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_549(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_328(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_466());
		func_463(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_466()))
		{
...
bool func_550(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_328(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_731(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_721(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_551(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_495(uParam0->f_3[iVar0]->f_2)) && func_426(uParam0->f_3[iVar0]->f_10)) && !func_724(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_732(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_733(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_565(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!_0x01f4d242765c6b24(func_668(iParam0)))
		{
			_0xca41e86545413b5b(func_174(iParam0), func_175(iParam0), func_741(iParam0), func_668(iParam0), Global_36);
		}
	}
	func_673(iParam0, 1);
	bParam1 = bParam1;
...
void func_566(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_373(Global_1898330[iParam0]);
		func_742((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}
...
void func_568(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_744(&((*Global_1360165)[iParam0]->f_12), 1))
		{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_426(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_450(1328661203, func_763(), -1591664384, bParam0);
}
...
int func_625(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_624(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_630(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_432(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_770(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_409(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_624(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_770(&(Global_1946804->f_1497.f_1[iVar1])) || func_624(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_409(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_409(&(uParam0->f_1[iVar1])) || func_624(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_632(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_431(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_774(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_633(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_776(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_251() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_340((*Global_1360165)[iParam0]->f_4.f_2) || func_296((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_654(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_609(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_609(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_670(int iParam0)
{
	switch (func_174(iParam0))
	{
		...
		case 8:
			...
			if (func_187((*Global_1347702)[iVar1]->f_12, 1))
			{
...
int func_672()
{
	if (!func_815((*Global_1835011)[4]->f_1, 1))
	{
		return 0;
	}
	else if (!func_815((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_815((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_815((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_815((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_815((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_815((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
{
	switch (func_690(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_516(uParam0->f_1633[iParam1]->f_10, 256))
			{
				...
				{
					func_709(uParam0->f_1903, 0);
					func_824(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_516(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_825())
				{
					func_824(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_692(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_424(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_693(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_829(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_695(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_464(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_698(int iParam0, float fParam1)
{
	...
	if (!(func_832(17) && func_190(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_701(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_327(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
...
void func_703(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_328(uParam0->f_1522[iVar0], 1))
			{
			...
			{
				if ((func_8(uParam0) > 3 && !func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_833(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_586(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_721(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_329(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_556(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_300(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_463(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_208(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_295(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_704(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_556(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_706(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_295(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_295(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_426(func_425(Global_35, 0, 1, 0)) && !func_426(func_425(Global_35, 1, 1, 0))))
		{
			if (func_304(uParam0, uParam0->f_1684))
			{
	...
	if (!func_295(uParam0->f_1016[uParam0->f_1684], 16) && (func_426(func_425(Global_35, 0, 1, 0)) || func_426(func_425(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_295(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
...
void func_707(var uParam0, int iParam1, bool bParam2)
{
	...
	func_834(uParam0, func_533(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	...
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		...
		{
			func_697(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_465(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_835(vVar1);
	...
	if (func_556(uParam0->f_475[iParam1], 16))
	{
...
bool func_723(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_724(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_392(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_808(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_392(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_392(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_808(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_808(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_730(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_328(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_556(uParam0->f_475[iVar0], 512)) || func_556(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_724(uParam0->f_3[iVar0]->f_1))
				{
					if (func_586())
					{
						StringCopy(&cVar1, func_392(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_735(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_823(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_743(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_853(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_753(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_253(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_856(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_858(iParam0);
					_0x7b204f88f6c3d287(func_859(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_859(iParam0, 0));
					func_860(iParam0);
				}
			}
			else
		...
		while (iVar28 < 4)
		{
			...
			if (func_618(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_864(0))
				{
					...
					func_865(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_762(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_868("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_867(iParam1, 512) && func_765(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_732(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_867(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_867(iParam1, 4))) && (!func_732(Var4.f_4) || func_867(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_867(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_867(iParam1, 1048576)))
				{
...
void func_766(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_873(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_873(uParam0->f_2[iVar0], 1))
				{
					func_874(uParam0->f_2[iVar0], 2, 6);
				}
...
float func_782()
{
	...
	func_890(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_783()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_890(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_784()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_890(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_785(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_815((*Global_1347702)[63]->f_15, 1) || func_296((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_815((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_815((*Global_1347702)[134]->f_15, 1) || func_296((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_815((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_896(747937920, 1) && !func_815((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_796(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_792(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_792(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_792(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_792(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_792(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_792(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_792(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_792(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_792(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_792(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_792(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_792(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_792(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_792(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_792(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_792(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_792(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_792(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_792(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_792(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_792(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_792(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_792(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_792(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_792(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_792(iParam1, 1544915253))
	{
...
bool func_828(var uParam0, int iParam1)
{
	...
	if ((func_426(func_733(Global_35, 0, 0, 0)) && !func_295(uParam0->f_1016[iParam1], 16)) && !func_295(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_834(var uParam0, bool bParam1)
{
	...
	if ((func_300(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_295(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_463(uParam0, 64);
	}
...
{
	if (func_556(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_515(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_464(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_424(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		else
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_515(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_464(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_424(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_915(uParam0) };
		...
		else if (!func_464(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_424(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
void func_839(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_424(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_464(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_840(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_424(Global_36, vParam3, 1), 0);
		}
		...
		if (func_556(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_464(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_464(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
void func_909(int iParam0, int iParam1)
{
	...
	{
		func_673(&(Global_1898164->f_1[0]), 3);
	}
}
...
int func_945()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_732(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_732(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
