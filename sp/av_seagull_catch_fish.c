...
{
	func_33(uParam0, 10699, 10736, 11383);
}
...
{
	func_46(uParam0, "SEAGULL_CATCH_FISH", "script@ambient@animal@seagull_catch_fish@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "SEAGULL", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		if (!bLocal_38 == 1)
		{
			if (func_60(uParam0, &uLocal_10, 0) || func_61(Global_35, uParam0->f_483, 1) < 100f)
			{
				bLocal_38 = true;
			}
		}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_111(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_63(&(uParam0->f_490)))
							{
...
void func_104(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_166(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_166(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_166(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
