...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.573273f, 1.16449f, 0.496552f, -23.76f, 1.5f, 1.5f, 3f, -1612834106, 1877049591, 1, 1, 1);
	func_151(uParam0, -0.526581f, -1.20927f, 0.502571f, -21.96f, 1.5f, 1.5f, 3f, -1612834106, 463023307, 1, 1, 1);
	func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON_0", 0, 1, 1);
	iLocal_19 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL_0", 0, 1, 1);
	func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON_1", 0, 1, 1);
	iLocal_20 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL_1", 0, 1, 1);
	iLocal_17 = func_152(uParam0, 1504738597, 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, 264425748, -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@uncle_4@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@uncle_4@action", 0, 0, 1, 0);
	func_154(uParam0, "CUNC4AU");
	func_155(uParam0, -1714605941, 762139108);
	func_156(uParam0, iLocal_16, -1, 0.94f);
	func_157(uParam0, iLocal_14, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_17, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
...
{
	set_entity_coords(func_191(uParam0, iLocal_17), func_192(uParam0, 0.636355f, 1.20493f, -0.00283051f), true, false, true, true);
	set_entity_coords(func_191(uParam0, iLocal_18), func_192(uParam0, -0.494697f, -1.22147f, -0.0016098f), true, false, true, true);
	_0x669655ffb29ef1a9(func_191(uParam0, iLocal_19), 0, "Stew_Fill", 1f);
	_0x669655ffb29ef1a9(func_191(uParam0, iLocal_20), 0, "Stew_Fill", 1f);
	return true;
}
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	if (bParam10)
	{
		vParam1 = { func_192(uParam0, vParam1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_192(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_192(uParam0, uParam0->f_1976.f_1), 1, func_252(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
Vector3 func_192(var uParam0, vector3 vParam1)
{
...
bool func_265(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_192(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
