	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_279(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_279(uParam0, uParam0->f_1976.f_1), 1, func_281(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_260(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_279(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
