...
bool func_29(int iParam0)
{
	...
	func_139(&(uLocal_14[11]), -506285289);
	func_139(&(uLocal_14[11]), 559247042);
	func_139(&(uLocal_14[9]), -2002235300);
	func_139(&(uLocal_14[9]), 2031861036);
...
void func_35(int iParam0)
{
	...
	{
		if (func_151(&((*Global_1835011)[*iParam0]->f_29), 4))
		{
			set_clock_time(func_152(4), 0, 0);
		}
		else if (func_151(&((*Global_1835011)[*iParam0]->f_29), 2))
		{
			set_clock_time(func_152(2), 0, 0);
		}
		else if (func_151(&((*Global_1835011)[*iParam0]->f_29), 8))
		{
			set_clock_time(func_152(8), 0, 0);
		}
		else if (func_151(&((*Global_1835011)[*iParam0]->f_29), 16))
		{
			set_clock_time(func_152(16), 0, 0);
		}
		else if (func_151(&((*Global_1835011)[*iParam0]->f_29), 32))
		{
			set_clock_time(func_152(32), 0, 0);
		}
	}
}
...
void func_36(int iParam0)
{
	if (!bLocal_41)
	{
		func_153(&(iLocal_28[0]), 0);
		if (!has_ped_got_weapon(&(uLocal_14[8]), -665597951, 0, false))
		{
			_give_weapon_to_ped_2(&(uLocal_14[8]), -665597951, 100, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
		}
		set_current_ped_weapon(&(uLocal_14[8]), -665597951, true, 0, false, false);
		set_current_ped_weapon(&(uLocal_14[12]), 36703333, true, 0, false, false);
		set_current_ped_weapon(&(uLocal_14[12]), 13903789, true, 1, false, false);
		bLocal_41 = true;
	}
}
...
int func_39(int iParam0)
{
	...
	{
		iVar3 = 1;
		if (!_does_scenario_point_exist(&(iLocal_44[12])))
		{
			iLocal_44[12] = _find_closest_active_scenario_point_of_type(func_138(12), func_160(12), 1.5f, 0, true);
			if (_does_scenario_point_exist(&(iLocal_44[12])))
			{
				_task_use_scenario_point(&(uLocal_14[12]), &(iLocal_44[12]), 0, -1, false, true, 0, false, -1f, false);
				set_blocking_of_non_temporary_events(&(uLocal_14[12]), false);
			}
			iVar3 = 0;
		}
		bLocal_42 = iVar3;
...
void func_43(int iParam0)
{
	if (!bLocal_37)
	{
		...
		while (iVar0 < 8)
		{
			if (!does_entity_exist(&(iLocal_28[iVar0])))
			{
				if (iVar0 != 0)
				{
					iLocal_28[iVar0] = func_166(func_165(iVar0));
				}
				else
				{
					if (func_167(7))
					...
					iLocal_28[iVar0] = func_168(vLocal_58, fLocal_61, 1, 1, iVar1, 1, 1);
				}
				if (does_entity_exist(&(iLocal_28[iVar0])))
				{
					set_blocking_of_non_temporary_events(&(iLocal_28[iVar0]), true);
					func_131(iParam0, &(iLocal_28[iVar0]), func_169(iVar0), 0, 0, 1);
				}
			}
			iVar0++;
		}
		if (func_170())
		{
			...
			while (iVar2 < 13)
			{
				if (does_entity_exist(&(uLocal_14[iVar2])) && !is_entity_dead(&(uLocal_14[iVar2])))
				{
					freeze_entity_position(&(uLocal_14[iVar2]), false);
					set_entity_completely_disable_collision(&(uLocal_14[iVar2]), true, false);
					set_entity_visible(&(uLocal_14[iVar2]), true);
				}
				iVar2++;
			}
			bLocal_37 = true;
...
bool func_53(int iParam0)
{
	...
	while (iVar0 < 8)
	{
		if (iVar0 != 0)
		{
			func_175(&(iLocal_28[iVar0]), func_165(iVar0), 1, 0, 0);
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 13)
	{
		if (does_entity_exist(&(uLocal_14[iVar1])) && !is_entity_dead(&(uLocal_14[iVar1])))
		{
			freeze_entity_position(&(uLocal_14[iVar1]), false);
			set_entity_completely_disable_collision(&(uLocal_14[iVar1]), true, false);
			set_entity_visible(&(uLocal_14[iVar1]), true);
		}
		iVar1++;
	}
	if (!func_163(iParam0))
	{
		...
		_0x531a78d6bf27014b("BRT3_Sounds");
	}
	return true;
}
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_250(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_262(iVar0), func_264(), 1))
			{
...
bool func_128(int iParam0)
{
	...
	if (!_0xd9130842d7226045("BRT3_Sounds", 0))
	{
		bVar0 = false;
	}
	if (bVar0)
	{
		iLocal_43 = _create_volume_box(655.1594f, -1253.824f, 44.3861f, 0f, 0f, 37.00239f, 23.42593f, 12.2029f, 5.035509f);
		func_279(iParam0, iLocal_43);
		return true;
	}
	return false;
}
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_262(iVar0));
...
void func_137(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!func_90(vParam2))
	{
		clear_ped_tasks_immediately(&(uLocal_14[iParam1]), true, true);
		func_289(&(uLocal_14[iParam1]), vParam2, fParam5, 2, 1073741824);
	}
	...
	if (bParam6)
	{
		freeze_entity_position(&(uLocal_14[iParam1]), true);
		set_entity_completely_disable_collision(&(uLocal_14[iParam1]), false, false);
		set_entity_visible(&(uLocal_14[iParam1]), false);
	}
}
...
void func_140(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_290(&(uParam0->f_428), iParam1);
	if (iVar0 < 0)
	{
		return;
	}
	func_291(uParam0->f_428.f_13[iVar0], iParam2);
}
...
{
	func_294(&(iParam0->f_958), iParam1);
}
...
bool func_154(int iParam0)
{
	...
	return func_309((*Global_1835011)[iParam0]->f_1);
}
...
int func_162(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_311(get_player_index(), 0, 0, 1);
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_318(uParam0, uParam0->f_1684))
				{
					...
					{
						func_320(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_314(uParam0) == 0)
			{
				_0xc9caeaeec1256e54(-1679307491);
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_320(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
bool func_167(int iParam0)
{
	...
	if (func_341(vVar1, vVar4) > func_342(iParam0))
	{
		return true;
	}
	return false;
...
int func_168(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	Var1.f_10 = 7;
	Var1 = iParam4;
	Var1.f_1 = iParam5;
...
bool func_170()
{
	...
	while (iVar1 < 8)
	{
		if (!does_entity_exist(&(iLocal_28[iVar1])))
		{
			if (iVar1 != 0)
			{
			...
			else
			{
				...
				iLocal_28[iVar1] = func_168(vLocal_58, fLocal_61, 1, 1, iVar2, 1, 1);
			}
			iVar0 = 0;
		}
		iVar1++;
...
{
	func_299(&(iParam0->f_958), iParam1);
}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_345(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_346(uParam0->f_1522[iVar0], 128))
				{
					func_347(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_175(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	func_351(iParam1, 39, 1);
	func_352(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_352(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_352(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_353(iParam1, 43, 1);
		}
		if (bParam4)
		{
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_359(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_191(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_393(iParam1, 0, 0, 0);
}
...
void func_193(int iParam0, int iParam1)
{
	...
	func_394(iParam1);
	StringCopy(&cVar0, func_189(), 64);
	func_395(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_199(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_396(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_209(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_400(uParam0->f_5, 0f, 0f, 0f))
	{
	...
	if (_does_volume_exist(uParam0->f_4))
	{
		...
		func_401(uParam0, uParam0->f_4, 0, 1);
...
bool func_222(bool bParam0, bool bParam1)
{
	if (!func_403(Global_43801))
	{
		Global_43801 = func_408("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_409(Global_43801, 0, 1);
		func_410(Global_43801, 6, 1);
		if (bParam1)
		{
			func_410(Global_43801, 14, 1);
		}
	}
	else
	{
		...
		if (func_412(Global_43801, 1) != 0f && bParam0)
		{
		...
		return func_413(Global_43801, 1);
	}
	return false;
}
...
void func_233(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_416(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_399() };
...
void func_234(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_250(uParam0->f_13[iVar0], 2))
		{
			if (func_250(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				func_417(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					iVar1 = get_ped_index_from_entity_index(&(uParam0->f_13[iVar0]));
					if (iVar1 != Global_35 && !func_250(uParam0->f_13[iVar0], 16))
					{
						func_418(iVar1);
					}
				}
...
bool func_237()
{
	return func_406(_0xc17f69e1418cd11f(3));
}
...
void func_244(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_434(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_289(iVar1, func_434(uParam0), func_435(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_289(iVar3, func_434(uParam0), func_435(uParam0), 2, 1073741824);
		}
	}
}
...
void func_245(var uParam0)
{
	if ((func_83(uParam0, 268435456) && !func_90(func_434(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		...
		if (!is_entity_dead(iVar0))
		{
			...
			func_289(iVar0, vVar1, func_436(vVar1, Global_36, 1), 2, 1073741824);
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_250(uParam0->f_13[iVar0], 8))
					{
						if (func_438(func_437(iVar1, 0, 1, 0)))
						{
							if (!func_439(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_439(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_443(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_441(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_254(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_451(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_258(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_457(1, (func_261() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_455(iParam3, 1)])
			{
				func_458(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_442(32768) && iParam1 != &Global_1946804->f_57[func_455(iParam3, 1)])
			{
				func_459();
...
void func_259(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_464(0), &Var5, iParam1);
}
...
bool func_260(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		if (func_465(*iParam1, 2336))
		{
			if (!func_467(iVar2))
			{
			}
			if (func_471(iVar2, *iParam1))
			{
				func_472(iParam1, 32);
				func_472(iParam1, 256);
				func_472(iParam1, 2048);
				func_470(iParam1, 512);
				func_470(iParam1, 1024);
				func_470(iParam1, 4096);
			}
			else
			{
				return false;
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_469(iParam2, 1024))) || func_469(iParam2, 8)) && !func_465(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_470(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_469(iParam2, 4096)) && !func_465(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_470(iParam1, 2048);
			func_470(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_469(iParam2, 32)) && !func_465(*iParam1, 5632))
		{
...
int func_273(var uParam0, int iParam1)
{
	...
	if (func_300(uParam0, 8) && _0xdd0b7c5ae58f721d(func_477()))
	{
...
{
	func_489(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_490(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
void func_289(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_505(Global_35) && is_player_teleport_active())
	{
	}
	if (func_506(iParam0))
	{
		if (func_507(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_465(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_465(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_465(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_465(iParam5, 32), true);
	...
	else if (func_465(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_465(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_465(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_312(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_514(1));
		if (!has_anim_dict_loaded(func_514(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_313(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		{
			fVar0 = func_519(uParam0, uParam0->f_1690);
	...
	if (func_63(uParam0, 16))
	{
		...
		fVar5 = func_436(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_320(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_519(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_294(uParam0, 4);
			...
			if (func_260(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_299(uParam0, 4);
...
void func_320(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_509(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
	func_522(&iVar1, uParam2);
	func_523(&(uParam0->f_1904), iVar0, iVar1, fParam3);
	if (!Global_1935630->f_12)
	{
		if (!func_63(uParam0, 67108864))
		{
...
void func_321(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_326(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_526(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_526(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692.f_8), func_527(), 64);
			}
			disable_control_action(0, -1722177808, false);
		}
		...
		{
			if (!func_528(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_528(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_522(&iVar19, uParam0->f_1345[iVar0]->f_1);
					func_529(&(uParam0->f_1904), iVar19);
				}
			}
			else
			{
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_528(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_530(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_436(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_528(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_528(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_528(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_532(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_532(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_550(uParam0)) && _is_anim_scene_started(func_550(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_550(uParam0));
				bVar1 = _is_anim_scene_finished(func_550(uParam0), false);
				bVar2 = _is_anim_scene_active(func_550(uParam0));
...
int func_338(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_551(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
float func_342(int iParam0)
{
	...
	iVar5 = func_553(iParam0) + 1;
	fVar6 = func_554(iParam0);
	fVar7 = to_float(get_default_attribute_points_needed_for_rank(iVar0, 7, iVar1));
	fVar8 = to_float(get_default_attribute_points_needed_for_rank(iVar0, 7, iVar5));
	fVar9 = (fVar6 - fVar7);
	fVar10 = (fVar8 - fVar7);
	fVar11 = (fVar9 / fVar10);
	fVar12 = func_555(fVar3, fVar4, fVar11);
	return fVar12;
}
...
int func_343(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_557((*Global_1835011)[4]->f_1, 1))
		{
			if (func_558(5))
			{
				func_559(5);
	...
	if ((bVar0 && func_557((*Global_1835011)[37]->f_1, 1)) && !func_557((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_557((*Global_1835011)[43]->f_1, 1)) && !func_557((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
struct<8> func_345(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_579(iParam1), 64);
		if (!is_string_null_or_empty(&cVar0))
		{
			iVar8 = func_580(uParam0, iParam1);
			if (iVar8 > 0)
			{
...
int func_354(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_263(iVar0, 0))
	{
		if (func_263(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_349(iParam0)) || func_350(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_582(player_ped_id(), iVar0, 1) < 10000f))
			{
				iVar1 = func_583(iParam0, 1);
				if (iVar1 != 0)
				{
					...
					func_584(iParam0);
					_0x7b204f88f6c3d287(func_585(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_585(iParam0, 0));
					func_586(iParam0);
				}
			}
			else
	...
	{
		if (func_263((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_270(iParam0, 32768, 1))
			{
...
void func_355(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < &Global_1911670)
	{
		...
		if (_0xf6a8a652a6b186cd(iVar1))
		{
			...
			if (func_532(vVar2, vParam0, 2f, 1))
			{
...
{
	func_588(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_359(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	func_591(iParam0);
	func_592(iParam0);
	func_351(iParam0, 37, 1);
	bVar0 = func_263(Global_1360165[iParam0], 0);
	...
	{
		func_351(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_351(iParam0, 33, 1);
		func_351(iParam0, 34, 1);
		func_594(iParam0, 1056964608, -1, 1061158912);
		func_595(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_353(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_353(iParam0, 35, 1);
			if (bParam8)
			{
				func_353(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		{
			func_157(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
	...
	{
		func_351(iParam0, 45, 1);
	}
	func_598(iParam0, 16, 1);
	func_351(iParam0, 44, 1);
...
void func_371(var uParam0)
{
	if (!func_600(uParam0->f_2, 1))
	{
		if (func_495(uParam0))
		{
			...
			{
				sVar0 = func_405(get_entity_model(Global_35));
				if (_0x6f1f0b17109309da(uParam0->f_1, sVar0))
				{
					set_anim_scene_entity(uParam0->f_1, sVar0, Global_35, 0);
				}
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_zero") && func_268())
				{
					set_anim_scene_entity(uParam0->f_1, "player_zero", Global_35, 0);
				}
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_604())
				{
...
var func_393(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
int func_395(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_609(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}

void func_396(var uParam0, char* sParam1, bool bParam2)
{
	if (is_string_null_or_empty(sParam1))
	{
		return;
...
void func_397(struct<4> Param0)
{
	...
	if (func_612(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_612(20))
			{
				return;
			}
			iVar0++;
...
bool func_400(vector3 vParam0, vector3 vParam3)
{
	return ((vParam0.x == vParam3.x && vParam0.y == vParam3.y) && vParam0.z == vParam3.z);
}

void func_401(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (_0x91a5f9cbebb9d936(uParam0->f_9))
	{
		remove_scenario_blocking_area(uParam0->f_9, false);
...
int func_408(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
...
float func_412(int iParam0, bool bParam1)
{
	if (bParam1 && !func_403(iParam0))
	{
		return 0f;
...
bool func_419(int iParam0)
{
	...
	else if (func_624(-525676072, iParam0))
	{
		if (func_623(iParam0))
		{
			return true;
...
void func_425()
{
	...
	if (func_438(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_438(iVar0))
	{
		...
		{
			func_627(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
{
	return ((Global_1946804->f_57[func_455(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_445(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_443(1108822547, 6))
	{
		if (bParam2)
		{
			func_441(iParam0, iVar0, func_261() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_455(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_455(iParam0, 1)])->f_10 || iParam1);
}

void func_448(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_455(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_455(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_455(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_453(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_633(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_636(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_636(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_637(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_456(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_642(iParam0, 866047851) && func_643(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_442(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_649(iParam0, iParam2, iParam1, func_261() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_448(func_446(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_459()
{
	func_653(&(Global_1946804->f_2776));
	func_654(32768);
...
struct<4> func_462(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_464(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_463(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_464(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_468(int iParam0, vector3 vParam1)
{
	...
	return func_655(vVar0, vVar3, vParam1);
}
...
void func_473(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_658(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_659(1, bVar1, 1, uVar2);
		func_660(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_661(ceil(&(Global_40.f_11095.f_11[iParam0])));
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_270(iParam0, 16, 1))
			{
				...
				else if (func_263(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_263(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_289(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_667(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_669(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_482(iParam0, 25, 0))
						{
							func_351(iParam0, 25, 0);
						}
						func_353(iParam0, 66, 0);
						func_665(iParam0, 5);
		...
		case 6:
			if (func_263(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_671(Global_1360165[iParam0], 1);
				}
			}
			func_665(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_672(Global_1360165[iParam0]))
				{
				}
			}
			func_673(iParam0, Global_1360165[iParam0]);
...
void func_486(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_174() || !_0x6f1f0b17109309da(Global_43800, func_219(iParam0))))
	{
...
void func_489(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_291(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_451(uParam0->f_13[iVar0], 2);
		}
	}
}

void func_490(int iParam0, int iParam1, char* sParam2)
{
	func_682(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
void func_515(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			vVar0 = { uParam0->f_1882 * FtoV(func_688(uParam0->f_1898)) };
			if (!func_532(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_516(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
		{
			...
			else if ((!func_689(512) || func_690(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_509(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_691(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_320(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					...
					func_693(uParam0, iVar2, iVar0, bVar3);
				}
				else if (func_694(uParam0->f_1633[iVar2]) != 0)
				{
					func_693(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_509(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_201(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_691(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
						if (func_260(Global_35, &(uParam0->f_1687), iVar4, 0, 0, 1084227584, 100, 0, 0))
						{
							set_player_control(get_player_index(), true, 0, false);
							uParam0->f_1687 = 0;
							func_299(uParam0, 33554432);
...
float func_519(var uParam0, int iParam1)
{
	fVar16 = 10000f;
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_695(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
		...
		case 1:
			...
			{
				func_696(uParam0, iParam1, &uVar6, vVar9, &fVar12, &fVar13, &fVar14, &fVar15);
				if (fVar14 < fVar15)
				{
...
void func_520(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_698(uParam0, iVar0)) && !func_475(uParam0->f_1016[iVar0], 1))
			{
				if (!func_699(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_159(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_700(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
void func_522(int iParam0, var uParam1)
{
	*iParam0 = 0;
	...
	{
		if (func_528(uParam1, 1))
		{
			*iParam0 = 1;
		}
		else if (func_528(uParam1, 4))
		{
			*iParam0 = 4;
		}
		else if (func_528(uParam1, 2))
		{
			*iParam0 = 2;
		}
	}
...
void func_523(char* sParam0, int iParam1, int iParam2, float fParam3)
{
...
bool func_532(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_534(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_695(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.f_2 > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_301(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_551(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_551(uParam0->f_475[iParam1], 64) && func_703(uParam0, iParam1, 0))
				{
					func_704(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_705(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_551(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_705(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
		case 4:
			func_539(uParam0, iParam1, 0, 0);
			break;
	}
}
...
int func_537(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_319(uParam0) != 11) && func_318(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_346(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_346(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_159(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_539(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_319(uParam0))
	{
		case 0:
			...
			if (((!func_301(uParam0->f_1016[iVar2], 32) && func_708()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_301(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			if (func_260(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4))
			{
				func_709(uParam0);
			}
		...
		case 4:
			...
			if ((func_301(uParam0->f_1016[iVar2], 256) || !func_419(&uVar5)) || bVar0)
			{
				if (func_713())
				{
					func_714();
		...
		case 8:
			...
			if (func_260(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4) || bVar0)
			{
				uParam0->f_1686 = 0;
...
bool func_542(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_718(uParam0, 0))
		{
			if (func_719(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_720(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_720(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_720(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_720(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_720(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_720(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_720(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_720(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_720(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_720(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_720(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_720(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_720(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_720(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_720(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_719(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_720(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_720(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_720(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_719(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_722(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_721(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_720(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_700(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_399() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_723(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_718(uParam0, 45))
				{
					if (func_719(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_724(uParam0->f_1522[iVar16], 2);
							func_721(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_725(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_724(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_719(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_724(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_724(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_718(uParam0, 57))
				{
					if (func_719(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_719(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_719(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_728(iVar17);
							}
							if (func_719(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_729(iVar17);
							}
							func_719(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_720(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_720(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_720(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_719(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_720(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_719(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_719(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_720(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_718(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_725(uParam0, 87, uParam0->f_1345[iVar18]);
						func_721(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_721(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_720(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_720(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_719(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_730(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_718(uParam0, 98))
				{
					if (func_719(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_731(uParam0, 99, uParam0->f_1633[iVar16]);
							func_731(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_731(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_719(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_722(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_543(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_346(uParam0->f_1522[iVar0], 2)) && !func_346(uParam0->f_1522[iVar0], 16)) && func_733(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_724(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_724(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_544(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_346(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	StringCopy(&(Var2.f_8), func_527(), 64);
	uParam0->f_1708 = { Var2 };
	uParam0->f_1731 = { Var2 };
...
bool func_545(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_346(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_734(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_724(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_546(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_506(uParam0->f_3[iVar0]->f_2)) && func_438(uParam0->f_3[iVar0]->f_10)) && !func_727(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_735(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_736(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
float func_555(float fParam0, float fParam1, float fParam2)
{
...
void func_560(int iParam0)
{
	...
	func_743(&Var0);
	func_744(iParam0, Var0);
	func_745(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_746(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_747(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_748(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_749(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_750(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_751(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_752(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_753(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
int func_561(vector3 vParam0)
{
	return func_754(_get_map_zone_at_coords(vParam0, 10));
}
...
int func_578(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_166(iParam1);
	if ((!does_entity_exist(iVar0) || !func_263(iVar0, 0)) || (bParam3 && !func_350(iParam1)))
	{
		if (bParam2)
		{
			if (func_583(iParam1, 1) != 0)
			{
	...
	if (does_entity_exist(iVar0) && func_263(iVar0, 0))
	{
		*uParam0 = 2;
		(*Global_1360165)[iParam1]->f_70.f_2 = 0;
		func_777(iParam1, iVar0);
		func_778(iParam1, bParam13, bParam14, 1);
		return iVar0;
	}
	else
	{
...
char* func_579(int iParam0)
{
	...
	{
		return func_779(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_780(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
float func_582(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
...
int func_583(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_781(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_585(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_782(iParam0);
	}
...
void func_588(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_783(uParam0, iParam1);
	}
...
void func_589(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_784(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_590(int iParam0, int iParam1, bool bParam2)
{
	...
	func_785(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_594(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_262(iParam0), 137, true);
	}
}
...
void func_595(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_351(iParam0, 50, 1);
		func_351(iParam0, 48, 1);
		func_351(iParam0, 49, 1);
		func_351(iParam0, 51, 1);
		func_351(iParam0, 52, 1);
		func_351(iParam0, 54, 1);
		func_351(iParam0, 55, 1);
	}
	else
	{
...
void func_596(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_262(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_262(iParam0), 204, false);
	}
}
...
void func_597(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_262(iParam0);
	if (((does_entity_exist(iVar1) && func_788(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
int func_609(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
bool func_611(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
...
void func_617(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_407(iParam0, 8))
		{
...
{
	iVar0 = func_455(func_793(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	iVar1 = func_455(func_793(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_627(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_795(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_796(iParam0, &iVar0, &fVar25);
...
{
	return func_462(1328661203, func_799(), -1591664384, bParam0);
}
...
struct<4> func_634(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_462(923904168, func_632(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_462(923904168, func_632(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_462(923904168, func_632(bParam0), -740156546, 0);
}
...
bool func_636(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_463(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_637(int iParam0, var uParam1, int iParam2)
{
	if (func_801(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_638(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_462(271701509, func_632(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_462(271701509, func_632(bParam0), 12999093, 0);
}
...
bool func_640(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_464(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_643(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_642(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	func_802(&(Global_1946804->f_2589), iParam0);
}

void func_646(int iParam0, int iParam1)
{
	func_803(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
void func_648(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_444(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_805(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_805(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_805(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_805(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				{
					iVar1 = 35;
					if ((func_806(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_421(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_642(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_806(&(Global_1946804->f_1497.f_1[iVar1])) || func_642(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_421(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_421(&(uParam0->f_1[iVar1])) || func_642(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_807(0);
	if (iParam2 != 0 && func_808(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_809(iParam0, func_446(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_650(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_443(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_810(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_651(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_812(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_261() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_813(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_814(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_814(Global_40.f_7729);
				Global_1946804->f_1378 = func_814(Global_40.f_7729);
...
bool func_655(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
char* func_658(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
void func_659(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
void func_660(bool bParam0, bool bParam1, bool bParam2)
{
	sVar0 = func_817(0, 1, bParam0, bParam1);
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_479((*Global_1360165)[iParam0]->f_4.f_2) || func_309((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_823((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_825(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_351(iParam0, 44, 1);
			}
...
bool func_667(int iParam0, int iParam1)
{
	...
	bVar0 = func_826(iParam0, iParam1);
	return bVar0;
}
...
void func_673(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_627(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_627(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_682(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		...
		iVar0 = func_847(uParam0, sParam2);
		if (iVar0 == -1)
		{
...
void func_683(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_849(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_850(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	fVar15 = func_341(vVar12, Global_36);
	bVar16 = false;
	if (fVar15 > func_342(iParam0))
	{
		bVar16 = true;
	}
	iVar17 = 0;
	...
	if (iVar17 != 0)
	{
		...
		func_853((*Global_1900383)[iParam0]->f_26);
...
void func_687(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_688(iParam1)) };
...
bool func_691(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_693(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (func_694(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_509(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_419(&(uParam0->f_1903)))
				{
					func_712(uParam0->f_1903, 0);
					func_855(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_509(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_856())
				{
					func_855(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
bool func_695(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vVar0 = { vParam4 - vParam1 };
	vVar3 = { vParam1 - vParam10 };
	fVar6 = func_858(vParam7, vVar0);
	fVar7 = -func_858(vParam7, vVar3);
...
void func_696(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_436(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
bool func_699(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
...
void func_701(int iParam0, float fParam1)
{
	...
	if (!(func_861(17) && func_201(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_704(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_345(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
...
void func_706(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_346(uParam0->f_1522[iVar0], 1))
			{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_604(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_724(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_347(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_551(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_314(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_474(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_219(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_707(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_551(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_709(var uParam0)
{
	if (!uParam0->f_1897)
	{
		...
		if (!func_301(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_438(func_437(Global_35, 0, 1, 0)) && !func_438(func_437(Global_35, 1, 1, 0))))
		{
			if (func_318(uParam0, uParam0->f_1684))
			{
				func_864(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_301(uParam0->f_1016[uParam0->f_1684], 16) && (func_438(func_437(Global_35, 0, 1, 0)) || func_438(func_437(Global_35, 1, 1, 0))))
	{
	...
	else if ((!func_318(uParam0, uParam0->f_1684) && !func_326(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_548(uParam0, 3);
	}
...
void func_710(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_865(uParam0, iParam1, &vVar1, &fVar0);
	func_863(uParam0, func_528(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_866(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_700(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
	...
	if (func_551(uParam0->f_475[iParam1], 16))
	{
		func_867(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
		...
		func_868(uParam0, iParam1, bParam2, &vVar4);
	...
	{
		open_sequence_task(&iVar20);
		func_869(uParam0, iParam1, bParam2, vVar1);
		close_sequence_task(iVar20);
		task_perform_sequence(Global_35, iVar20);
		clear_sequence_task(&iVar20);
	}
...
void func_715(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_874(iVar0));
		iVar0++;
	}
}
...
bool func_726(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if (((func_727(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_405(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_875(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_405(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_405(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_875(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_875(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_733(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_346(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_551(uParam0->f_475[iVar0], 512)) || func_551(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_727(uParam0->f_3[iVar0]->f_1))
				{
					if (func_604())
					{
						StringCopy(&cVar1, func_405(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_405(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_738(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_854(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
void func_744(int iParam0, struct<2> Param1)
{
	iParam0 = func_215(iParam0);
	if (iParam0 == -1)
	{
	...
	if (!func_879(iParam0, Param1))
	{
	}
	if (!func_880(iParam0, Param1.f_1))
	{
	}
}
...
int func_757(int iParam0, int iParam1)
{
	...
	if (!func_882(iParam0, &Var0))
	{
		return 0;
	}
	bVar58 = false;
	if (!func_882(iParam1, &Var29))
	{
		bVar58 = true;
	}
	if (bVar58)
	{
		iVar59 = func_883(iParam1);
		if (iVar59 == 0)
		{
			return 0;
		}
		if (!func_884(Var0, Var0.f_5, iVar59, 0, 0))
		{
			return 0;
		}
	}
	else if (!func_885(Var0, Var29, 0, 0))
	{
		return 0;
	}
	return 1;
...
int func_760(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_556())
	{
		...
		{
			bVar0 = false;
			if (!func_557((*Global_1835011)[15]->f_1, 1) && !func_800(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_557((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_894();
				*iParam1 = func_895();
				*uParam2 = func_896();
...
int func_776(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_911(iParam0) && func_912(iParam0, &uVar4))
				{
					_0x187d65f3aec5d679(func_583(iParam0, 1), &uVar4);
				}
				func_352(iParam0, 256, 0);
				func_587(iParam0, 1);
			}
			break;
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_914(iParam0, vVar0, fParam6, iParam10))
				{
					return func_913();
				}
				if (func_263((*Global_1360165)[iParam0]->f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_915(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_913();
				}
			}
			if ((bParam2 && !func_90(vVar0)) && !func_532(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_289((*Global_1360165)[iParam0]->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
				{
					if (func_482(iParam0, 39, 1))
					{
					}
					set_entity_as_mission_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_353(iParam0, 39, 1);
				func_352(iParam0, 8, 1);
				func_352(iParam0, 64, 0);
			...
			func_916((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
				_0xf74e134f40192884((*Global_1360165)[iParam0]->f_124, 1);
			}
			sVar12 = func_917(iParam0, func_604());
			if (!is_string_null_or_empty(sVar12))
			{
				_0x63aa2b8eb087886a(func_583(iParam0, 1), get_hash_key(sVar12));
			}
			(*Global_1360165)[iParam0]->f_70 = (*Global_1360165)[iParam0]->f_124;
			(*Global_1360165)[iParam0]->f_124 = 0;
			func_351(iParam0, 40, 0);
			func_352(iParam0, 32, 0);
			func_587(iParam0, 0);
			return (*Global_1360165)[iParam0]->f_70;
	}
	return func_913();
...
void func_778(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!func_114(iParam0))
	{
		return;
	...
	if (bParam3)
	{
		func_918(func_166(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_837(iParam0);
...
char* func_783(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_919(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_787(int iParam0)
{
	if (func_114(iParam0))
	{
		if (does_entity_exist(func_262(iParam0)))
		{
...
int func_795(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (has_ped_got_weapon(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_922((386 + iVar28), 1);
			if (func_636(iParam0, &Var0, iVar5, 0))
			{
				if (func_637(iParam0, &Var6, iVar5))
				{
					Var29 = { func_462(iParam0, Var0, iVar5, 0) };
					func_923(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_924(0))
				{
					...
					func_925(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_796(int iParam0, int iParam1, float fParam2)
{
	bVar0 = true;
	iVar1 = get_entity_model(iParam0);
...
int func_798(var uParam0, int iParam1, int iParam2)
{
	iVar0 = 0;
	Var4.f_9 = -1591664384;
	bVar18 = func_927(iParam1, 128);
	if (func_928("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_929(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_927(iParam1, 512) && func_801(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_735(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_927(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_927(iParam1, 4))) && (!func_735(Var4.f_4) || func_927(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_927(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_927(iParam1, 1048576)))
				{
...
bool func_801(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_464(0);
	*uParam1 = { func_462(iParam0, func_634(0), iParam3, 0) };
...
void func_802(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_933(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_933(uParam0->f_2[iVar0], 1))
				{
					func_934(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_804(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_455(iParam0, 1)] != &Global_1946804->f_57[func_455(iParam0, 1)];
}

void func_805(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
...
{
	if (iParam0 == &Global_1946804->f_57[func_455(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_812(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
	...
	if (func_261() == -1)
	{
		func_938(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_939(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_940(&(Global_1946804->f_1378), iParam0);
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_658(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_658(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_818()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_949()));
	fVar7 = (func_944(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_950(3, round((to_float(iVar8) * fVar10)), 0);
	func_951(3, fVar9, fVar9 > 100f);
	return func_952(fVar7, -100f, 100f);
}
...
float func_819()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_949()));
	fVar7 = (func_944(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_950(2, round((to_float(iVar8) * fVar10)), 0);
	func_951(2, fVar9, fVar9 > 100f);
	return func_952(fVar7, -100f, 100f);
}
...
float func_820()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_949()));
	fVar7 = (func_944(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_950(1, round((to_float(iVar8) * fVar10)), 0);
	func_951(1, fVar9, fVar9 > 100f);
...
int func_822(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_557((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_557((*Global_1347702)[63]->f_15, 1) || func_309((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_557((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_557((*Global_1347702)[134]->f_15, 1) || func_309((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_557((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
				...
				case 18:
					...
					switch (iParam0)
					{
						...
						case 14:
							...
							break;
						case 4:
							if (func_956(747937920, 1) && !func_557((*Global_1347702)[1]->f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
					...
					if (bParam3 && does_entity_exist(func_262(iParam0)))
					{
						iVar10 = 0;
						while (iVar10 < iVar7)
						{
...
int func_828(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_958(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_958(1237718549, iParam1);
			return func_959(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_833(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_829(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_829(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_829(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_829(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_829(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_829(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_829(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_829(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_829(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_829(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_829(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_829(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_829(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_829(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_829(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_829(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_829(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_829(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_829(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_829(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_829(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_829(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_829(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_829(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_829(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_829(iParam1, 1544915253))
	{
...
void func_837(int iParam0)
{
	...
	if (func_583(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_166(iParam0);
	func_836(iVar0);
	func_352(iParam0, 8192, 1);
}
...
void func_849(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_963(func_962(255), 109029619));
	}
	else if (func_268())
	{
...
void func_850(var uParam0, bool bParam1)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_963(func_962(255), 109029619));
...
bool func_859(var uParam0, int iParam1)
{
	...
	if ((func_438(func_736(Global_35, 0, 0, 0)) && !func_301(uParam0->f_1016[iParam1], 16)) && !func_301(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_862(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		iVar0 = func_736(Global_35, 0, 0, 0);
		if (is_weapon_valid(iVar0))
		{
		...
		iVar0 = func_736(Global_35, 0, 1, 0);
		if (is_weapon_valid(iVar0))
		{
			if (_0x2c83212a7aa51d3d(iVar0))
			{
...
void func_863(var uParam0, bool bParam1)
{
	...
	if ((func_314(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_301(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_474(uParam0, 64);
	}
...
void func_865(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_551(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_508(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_475(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_436(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_508(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_475(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_436(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
...
void func_867(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, var uParam7)
{
	func_969(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_969(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_970(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}

void func_868(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_436(Global_36, *(*uParam3)[0], 1), 0);
	}
...
void func_869(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	vVar0 = { func_971(uParam0, iParam1) };
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_436(Global_36, vParam3, 1), 0);
		}
		...
		if (func_551(uParam0->f_475[iParam1], 256))
		{
...
int func_873(int iParam0, int iParam1)
{
	...
	if (func_642(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
...
bool func_884(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_464(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_885(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	if (!func_924(bParam9))
	{
	...
	if (!func_640(Param0, &Var0, bParam9, 1) || !func_640(Param4, &Var14, bParam9, 1))
	{
		return false;
	}
...
bool func_886(int iParam0)
{
	...
	if (func_986(get_entity_model(iParam0)))
	{
		return true;
	}
...
bool func_914(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	if (!func_348(iParam0))
	{
		return false;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_583(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_991(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_915(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_993(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
	func_352(iParam0, 256, 1);
	return true;
}
...
void func_916(int iParam0, int iParam1)
{
	...
	func_995(iParam0, func_994(iParam1));
	...
	if (does_entity_exist(func_262(iParam1)))
	{
		_0x931b241409216c1f(func_262(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_262(iParam1), iParam0);
		set_ped_config_flag(iParam0, 367, true);
	}
	else
	{
		func_353(iParam1, 38, 1);
	}
	...
	func_778(iParam1, func_992(iParam1, 8192), func_992(iParam1, 16384), 1);
}

char* func_917(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 3:
...
bool func_923(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
	...
	if (!_0x3e4e811480b3ae79(func_464(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_924(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_464(bParam0));
}
...
void func_926(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_999(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_928(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = _0x80d78bdc9d88ef07(func_464(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_929(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
void func_940(var uParam0, int iParam1)
{
	if (func_261() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_938(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_939(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_950(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_817(iParam0, 1, 0, 0);
...
float func_952(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
char* func_963(char* sParam0, int iParam1)
{
	...
	return func_1006(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
{
	iVar0 = func_736(Global_35, 0, iParam0, 0);
	if (func_438(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
		...
		{
			if (func_438(func_736(Global_35, 0, 7, 0)) || func_438(func_736(Global_35, 0, 9, 0)))
			{
				if (func_438(func_736(Global_35, 0, 8, 0)))
				{
					func_1008(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_438(func_736(Global_35, 0, 7, 0)) || func_438(func_736(Global_35, 0, 9, 0)))
			{
				if (func_438(func_736(Global_35, 0, 10, 0)))
				{
					func_1008(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_438(func_736(Global_35, 0, 2, 0)))
				{
...
{
	vVar0 = { func_1009(vParam0, vParam3, fParam9) };
	vVar3 = { func_1009(vParam3, vParam6, fParam9) };
	return func_1009(vVar0, vVar3, fParam9);
}
...
bool func_979(struct<4> Param0, int iParam4)
{
	if (!func_924(0))
	{
		return func_1013(Param0, iParam4, 1) != -1;
	}
	...
	if (!_0x734311e2852760d0(func_464(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_981(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
...
bool func_982(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_464(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
int func_983(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16 = { func_1015(&Var0) };
	Var16.f_4 = { Param4 };
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar32 = func_1016(1168099063, &Var16, bParam9);
	if (iVar32 == -1)
	{
		return -1;
	}
...
int func_985(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	Var0.f_9 = -1591664384;
	Var14.f_9 = -1591664384;
	if (!func_640(Param0, &Var0, 1, 0) || !func_640(Param4, &Var14, 1, 0))
	{
		return -1;
	}
	if (func_984(&(Var0.f_5), &(Var14.f_5)) && Var0.f_9 == Var14.f_9)
	...
	Var28 = { func_1015(&Var0) };
	Var28.f_4 = { Var14.f_5 };
	Var28.f_11 = Var14.f_9;
	Var28.f_10 = (Var14.f_10 || iParam8);
	Var44 = { func_1015(&Var14) };
	Var44.f_4 = { Var0.f_5 };
	Var44.f_11 = Var0.f_9;
	...
	{
		iVar60 = func_1016(1168099063, &Var28, 0);
		iVar60 = func_1016(1168099063, &Var44, 0);
	}
	return iVar60;
}
...
bool func_989(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_464(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
	if (!func_640(Var0, uParam5, bParam6, 0))
	{
		return false;
	}
	return true;
...
int func_991(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_1018(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_1005(int iParam0, int iParam1)
{
	...
	{
		return func_1020(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}

char* func_1006(char* sParam0, int iParam1)
{
...
Vector3 func_1009(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
bool func_1010(int iParam0, int iParam1)
{
	...
	iVar0 = func_1022(iParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_928("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
...
int func_1011(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_420(iParam0, 0))
	{
		return 0;
	...
	{
		return func_1023(iParam0, 0);
	}
	uVar2 = _0xe787f05dfc977bde(func_464(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_1012()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_735(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_735(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_1013(struct<4> Param0, int iParam4, bool bParam5)
{
	iVar0 = -1;
	if (!_0xb881ca836cc4b6d4(&Param0))
	{
	...
	{
		Var16 = { func_1024(Param0, 1) };
		Var16.f_10 = iParam4;
		iVar0 = func_1025(-1230526146, &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var44 = { func_1026(Param0, 1) };
		Var44.f_10 = iParam4;
		iVar0 = func_1027(-1230526146, &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var61 = { func_1015(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_1016(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_1014(var uParam0, int iParam1, bool bParam2)
{
	return _0x033ee4b89f3ac545(func_464(bParam2), uParam0, iParam1);
}

struct<16> func_1015(var uParam0)
{
	Var0.f_9 = 1;
...
void func_1018(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
int func_1022(int iParam0, int iParam1)
{
	...
	if (func_642(iParam0, 1399091007))
	{
		func_1034(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_1023(int iParam0, bool bParam1)
{
	...
	Var0 = { func_1035(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_1036(&Var0, func_634(0));
	}
	if (!func_1037(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_930(iVar14);
...
struct<28> func_1024(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	Var0.f_9 = 1;
	Var0.f_11 = -1591664384;
	if (!_0xb881ca836cc4b6d4(&uParam0))
	...
	if (!_0x025a1b1fb03fbf61(func_464(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_1015(&Var28) };
...
struct<17> func_1026(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	Var0.f_9 = 1;
	Var0.f_11 = -1591664384;
	if (!_0xb881ca836cc4b6d4(&uParam0))
	...
	if (!_0x025a1b1fb03fbf61(func_464(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_1015(&Var17) };
...
void func_1034(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
struct<14> func_1035(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
...
void func_1036(var uParam0, struct<4> Param1)
{
...
bool func_1037(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_464(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
