...
bool func_6(var uParam0)
{
	...
	request_waypoint_recording("sad5_outro");
	if (!get_is_waypoint_recording_loaded("sad5_outro"))
	{
		return false;
	}
...
int func_21(var uParam0)
{
	if (!does_entity_exist(iLocal_14))
	{
		...
		set_ped_config_flag(iLocal_14, 130, true);
		task_follow_waypoint_recording(iLocal_14, "sad5_outro", 0, 9224, -1, 0, 0, -1);
		return 0;
	}
	if (func_45((*Global_1835011)[72]->f_1) == 0)
	{
		if (!does_entity_exist(iLocal_15))
		{
			iLocal_15 = func_46(iLocal_16, -766.3174f, -1262.813f, 43.0245f, 272.9365f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			_set_ped_body_component(iLocal_15, iLocal_17);
			_update_ped_variation(iLocal_15, true, true, true, true, false);
			return 0;
		}
		func_26(1);
		if (!func_47(512))
		...
		_text_database_request("SAD5");
		if (!_text_database_has_loaded("SAD5"))
		{
			return 0;
		}
		func_48(&uLocal_19, iLocal_15, "SAD5_FINLEY", 0);
		set_ped_can_use_auto_conversation_lookat(Global_35, true);
		_0xfca8fb9e15fa80d3(iLocal_15, 202260683);
	}
	return 1;
}
...
bool func_23(var uParam0)
{
	...
	{
		if (func_52(Global_35, iLocal_14, 0, 0) > 150f || !is_waypoint_playback_going_on_for_ped(iLocal_14, 0))
		{
			set_ped_config_flag(iLocal_14, 130, false);
			set_ped_keep_task(iLocal_14, false);
...
void func_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_62(iParam0);
	if (((does_entity_exist(iVar1) && func_64(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_75(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_76(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_78(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_33(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_80(Global_1360165[iParam0], 1);
				}
			}
			func_71(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_81(Global_1360165[iParam0]))
				{
				}
			}
			func_82(iParam0, Global_1360165[iParam0]);
...
bool func_47(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_90(iParam0)))
	{
		return false;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_90(iParam0))))
		{
			return true;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_90(iParam0));
	if (does_entity_exist(iVar0))
	{
	...
	_0x7b204f88f6c3d287(func_90(iParam0));
	return true;
}
...
void func_49(var uParam0)
{
	...
	set_ped_reset_flag(iLocal_15, 49, true);
	...
	switch (iLocal_120)
	{
		case 0:
			if (func_95(Global_35, iLocal_15, 5f, 1))
			{
				...
				{
					func_57(&uLocal_123);
					task_use_nearest_scenario_chain_to_coord(iLocal_15, get_entity_coords(iLocal_15, true, false), 2f, false, false, false, false);
					func_97(&uLocal_19, func_96("SAD5_JRETURN"), 0, -1, 0, 0);
				}
			}
			if (func_98(&uLocal_123) > IntToFloat(get_random_int_in_range(13, 17)))
			{
			...
			if (func_99(player_id(), iLocal_15))
			{
				if (!func_100(&(iLocal_117[0])))
				{
					iLocal_117[0] = func_101("INTERACT_GREET", -163964935, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
					func_102(&(iLocal_117[0]), iLocal_15, 0, 0, 1);
				}
				if (!func_100(&(iLocal_117[1])))
				{
					iLocal_117[1] = func_101("INTERACT_INSULT", 648122183, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
...
void func_75(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_60(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_60(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
	...
	else if (func_60(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_60(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_60(iParam5, 64))
		{
...
void func_92(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	if ((does_entity_exist(iParam0) && !is_entity_dead(iParam0)) && fParam2 > 0f)
	{
		...
		_0x870708a6e147a9ad(iParam0, sParam1, fParam2, iParam4, iParam5, 0, 0, 0, 0, -1);
	}
}
...
{
	if (bParam4 && (!func_100(iParam0) || !does_entity_exist(iParam1)))
	{
		return;
	}
	...
	_uiprompt_set_group((*Global_1945938)[iVar0]->f_3, _uiprompt_get_group_id_for_target_entity(iParam1), iParam2);
}
...
bool func_103(int iParam0)
{
	...
	iVar0 = func_151(iParam0);
	return !_uiprompt_is_enabled((*Global_1945938)[iVar0]->f_3);
}
...
float func_111(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_157(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_112(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_158(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_159(iParam0);
	}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_160((*Global_1347702)[63]->f_15, 1) || func_119((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_160((*Global_1347702)[134]->f_15, 1) || func_119((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_162(747937920, 1) && !func_160((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_178(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_178(iVar0))
		{
	...
	{
		func_181(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_182(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_194(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_198(0))
				{
					...
					func_199(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_184(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_149(iParam0, 8))
		{
...
struct<5> func_192(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_194(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_210(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
void func_200(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_216(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_204(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_196(923904168, func_202(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_196(923904168, func_202(bParam0), -740156546, 0) };
		}
...
struct<4> func_206(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_196(271701509, func_202(bParam0), 12999093, 0) };
		}
...
bool func_211(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_213(0);
