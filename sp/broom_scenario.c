...
void func_6()
{
	switch (iLocal_5)
	{
		case 0:
			...
			iLocal_72 = _get_ped_using_scenario_point(iLocal_3);
			if (!func_12(iLocal_72, 0))
			{
				iLocal_5 = 7;
				return;
			}
			bLocal_79 = _0x800df3fc913355f3(_0x32a1e3b83d501096(iLocal_72));
			if (!bLocal_79)
			{
				_0xe7bbc4e56b989449(iLocal_3, &uLocal_80, 1);
				if (!_does_scenario_point_exist(&(uLocal_80[0])))
				{
					iLocal_5 = 7;
					return;
				}
			}
			iVar0 = floor(_0x6718f40313a2b5a6(iLocal_3));
		...
		case 1:
			...
			if (!_0x9c54041bb66bcf9e(iLocal_72, iLocal_3))
			{
				iLocal_5 = 7;
				return;
			}
			if (func_14(Global_35, iLocal_72, 1) > 1225f)
			{
				return;
			}
			else if (get_entity_speed(Global_35) < 9.5f)
			{
				iLocal_5 = 2;
				return;
			}
		...
		case 2:
			...
			while (iVar1 < 5)
			{
				if (Local_6[iVar1]->f_1 == 0)
				{
					iLocal_74 = iVar1;
				}
				else
				{
					if (!_does_scenario_point_exist(&(Local_6[iVar1])))
					{
						if (iVar1 > 0)
						{
							Local_6[iVar1]->f_7 = { _get_object_offset_from_coords(_get_scenario_point_coords(&(Local_6[(iVar1 - 1)]), true), _get_scenario_point_heading(&(Local_6[(iVar1 - 1)]), true), Local_6[iVar1]->f_4) };
							Local_6[iVar1]->f_11 = (_get_scenario_point_heading(&(Local_6[(iVar1 - 1)]), true) + Local_6[iVar1]->f_10);
						}
						else
						{
							Local_6[iVar1]->f_7 = { _get_object_offset_from_coords(_get_scenario_point_coords(iLocal_3, true), _get_scenario_point_heading(iLocal_3, true), Local_6[iVar1]->f_4) };
							Local_6[iVar1]->f_11 = (_get_scenario_point_heading(iLocal_3, true) + Local_6[iVar1]->f_10);
						}
						Local_6[iVar1] = create_scenario_point(Local_6[iVar1]->f_1, Local_6[iVar1]->f_7, Local_6[iVar1]->f_11, 0, 0, 0);
						_0xe69fda40aac3efc0(&(Local_6[iVar1]), 0);
						_0xa7479fb665361edb(&(Local_6[iVar1]), 0);
					}
					iVar1++;
				}
			}
		...
		case 3:
			...
			if (func_18(&uLocal_75, fLocal_78) && _0x02ebbb3989b7e695(iLocal_72))
			{
				iLocal_5 = 4;
			}
			break;
		case 4:
			...
			if (_0x79197f7d2bb5e73a(iLocal_72, &(Local_6[iLocal_73]), Local_6[iLocal_73]->f_2, Local_6[iLocal_73]->f_3, 0, 0))
			{
				if (_0x9c54041bb66bcf9e(iLocal_72, &(Local_6[iLocal_73])))
				{
					fLocal_78 = Local_6[iLocal_73]->f_12;
					iLocal_73++;
					func_19(&uLocal_75);
		...
		case 6:
			...
			if (!bLocal_79)
			{
				if (!func_20(iLocal_72, -76381094))
				{
					clear_ped_tasks(iLocal_72, 1, 0);
					_task_use_scenario_point(iLocal_72, &(uLocal_80[0]), 0, 0, true, false, 0, false, -1f, false);
					set_ped_keep_task(iLocal_72, true);
				}
				if (_0x9c54041bb66bcf9e(iLocal_72, &(uLocal_80[0])))
				{
					iLocal_5 = 7;
				}
			}
	...
	switch (iParam1)
	{
		case 2147443548:
			switch (iParam0)
			{
				case 0:
					fLocal_78 = 10f;
					if (is_ped_male(iLocal_72))
					{
						func_25(Local_6[0], 1287994422, 4, 10f);
						func_25(Local_6[1], 1287994422, 4, 10f);
						func_25(Local_6[2], 1287994422, 4, 10f);
					}
					else
					{
						func_25(Local_6[0], 1287994422, 5, 10f);
						func_25(Local_6[1], 1287994422, 5, 10f);
						func_25(Local_6[2], 1287994422, 5, 10f);
					}
					return true;
				case 1:
					fLocal_78 = 10f;
					if (is_ped_male(iLocal_72))
					{
						func_25(Local_6[0], 1287994422, 1, 10f);
						func_25(Local_6[1], 1287994422, 1, 10f);
					}
					else
					{
						func_25(Local_6[0], 1287994422, 0, 10f);
						func_25(Local_6[1], 1287994422, 0, 10f);
					}
					return true;
			}
			break;
		case -1101156650:
			switch (iParam0)
			{
				case 0:
					fLocal_78 = 10f;
					func_25(Local_6[0], -688785322, 3, 10f);
					func_25(Local_6[1], -688785322, 3, 10f);
					func_25(Local_6[2], -688785322, 3, 10f);
					func_25(Local_6[3], -688785322, 3, 10f);
					return true;
				case 1:
					fLocal_78 = 10f;
					func_25(Local_6[0], -688785322, 4, 10f);
					func_25(Local_6[1], -688785322, 4, 10f);
					func_25(Local_6[2], -688785322, 4, 10f);
					return true;
			}
			break;
	}
...
bool func_15()
{
	...
	if (iLocal_73 <= 0)
	{
		if (!_0x9c54041bb66bcf9e(iLocal_72, iLocal_3) && !_0x9c54041bb66bcf9e(iLocal_72, &(Local_6[iLocal_73])))
		{
			return true;
		}
	}
	else if (iLocal_73 >= iLocal_74)
	{
		if (!bLocal_79)
		{
			if (!_0x9c54041bb66bcf9e(iLocal_72, &(Local_6[(iLocal_73 - 1)])) && !_0x9c54041bb66bcf9e(iLocal_72, &(uLocal_80[0])))
			{
				return true;
			}
		}
	}
	else if (!_0x9c54041bb66bcf9e(iLocal_72, &(Local_6[(iLocal_73 - 1)])) && !_0x9c54041bb66bcf9e(iLocal_72, &(Local_6[iLocal_73])))
	{
		return true;
	}
	return false;
