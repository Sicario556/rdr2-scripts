...
{
	func_33(uParam0, 10845, 10897, 12049);
}
...
{
	func_46(uParam0, "COYOTE_CATCH_SQUIRREL", "script@ambient@animal@COYOTE_CATCH_SQUIRREL@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "COYOTE", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "SQUIRREL", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
bool func_28(var uParam0)
{
	...
	if (!_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[0])))
	{
		return false;
	}
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		_0x9520175b35e2268d(&(uParam0->f_20[0]), 1);
		func_56(uParam0->f_20[0], 1, 1);
	}
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		func_56(uParam0->f_20[1], 1, 1);
	}
	return true;
}
...
{
	sVar0 = "script_amb@animal@coyote_catch_squirrel";
	sVar1 = "coyote_exit_a";
	sVar2 = "squirrel_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
	...
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		_0x2e1d6d87346bb7d2(&(uParam0->f_20[1]), Global_35, 0, 1);
	}
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if (func_63(uParam0, &uLocal_9, 1) || func_64(Global_35, &(uParam0->f_20[0]), 1) <= 625f)
			{
				bLocal_39 = true;
			}
		}
		if (bLocal_39)
		{
			if ((!has_anim_event_fired(&(uParam0->f_20[0]), 725039534) || is_entity_dead(&(uParam0->f_20[0]))) || is_entity_dead(&(uParam0->f_20[1])))
			{
					...
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								_0x10f96086123b939f(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 5000f);
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
							}
							...
							if (!is_entity_dead(&(uParam0->f_20[0])))
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
								{
									if (does_entity_exist(&(uParam0->f_20[1])))
									{
										...
										set_entity_no_collision_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), false);
										set_entity_no_collision_entity(&(uParam0->f_20[0]), &(uParam0->f_20[1]), false);
										set_ped_can_be_targetted(&(uParam0->f_20[1]), false);
										task_play_anim(&(uParam0->f_20[1]), sVar0, sVar2, 8f, -8f, -1, 1, 0f, false, 0, false, 0, false);
										task_play_anim(&(uParam0->f_20[0]), sVar0, sVar1, 8f, -8f, -1, 65553, 0f, false, 0, false, "FacialWithPHJaw_filter", false);
										attach_entity_to_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), get_ped_bone_index(&(uParam0->f_20[0]), 61276), vVar3, vVar6, true, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
						...
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), 811542464))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									...
									force_ped_motion_state(&(uParam0->f_20[0]), -1115154469, false, 0, false);
									if (!is_entity_dead(Global_35))
									{
										_task_smart_flee_style_coord(&(uParam0->f_20[0]), uParam0->f_20[0]->f_5, 3, 256, -1082130432, -1, 0);
										func_56(uParam0->f_20[0], 0, 1);
...
{
	bVar0 = !is_entity_dead(&(uParam0->f_20[0]));
	bVar1 = !is_entity_dead(&(uParam0->f_20[1]));
	if (uParam0->f_469[4] && !&uParam0->f_469[5])
	{
		if ((!bVar0 || has_bullet_impacted_in_area(get_entity_coords(&(uParam0->f_20[1]), false, false), 0.5f, true, true)) || _0x7a76104cc2cc69e8(&(uParam0->f_20[0]), 1, 1))
		{
			detach_entity(&(uParam0->f_20[1]), true, true);
			if (bVar1)
			{
				func_73(&(uParam0->f_20[1]), 0, 0);
			}
			uParam0->f_469[1] = 1;
		}
	}
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			if (!is_entity_dead(&(uParam0->f_20[iVar2])))
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_64(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
bool func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_89(&(Global_1898164->f_1[0]));
		if (func_90(iVar0) && func_91((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_63(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_102(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
float func_64(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_103(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_69(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 2027708073))
		{
			if (is_entity_attached(&(uParam0->f_20[1])))
			{
				detach_entity(&(uParam0->f_20[1]), true, true);
				activate_physics(&(uParam0->f_20[1]));
				set_ped_to_ragdoll(&(uParam0->f_20[1]), 2000, 2000, 0, false, false, false);
			}
			func_73(&(uParam0->f_20[1]), 0, 0);
		}
		else
		{
			...
			func_56(uParam0->f_20[1], 0, 1);
			set_ped_keep_task(&(uParam0->f_20[1]), true);
		}
	}
	if (!func_109(&(uParam0->f_20[0]), 518218985))
	{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_64(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_64(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_65(&(uParam0->f_490)))
							{
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_142(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_107(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_169(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_169(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_169(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_176(1) || *uParam0 & 8192 != 0))
				{
...
bool func_140(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_189(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_187(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_188(uParam2)
				{
					func_183(uParam2, 1);
					return true;
				}
...
bool func_141(int iParam0, var uParam1)
{
	...
	if (func_179(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_188(uParam1)
		{
...
bool func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_202(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_221(iVar0, 0)))
		{
...
bool func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_221(iVar0, 0)))
		{
			if (func_223(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_208(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_202(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_211(int iParam0)
{
	...
	return func_229((*Global_1347702)[58]->f_15, 1);
}
...
bool func_222(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_223(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
