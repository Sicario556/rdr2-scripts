...
void func_6()
{
	...
	if (bLocal_5)
	{
		if (!does_entity_exist(Local_6.f_3))
		{
			bLocal_0 = false;
		}
		else if (is_ped_dead_or_dying(Local_6.f_3, true))
		{
			bLocal_0 = false;
		}
		else if (!_0x9c54041bb66bcf9e(Local_6.f_3, iLocal_3))
		{
			bLocal_0 = false;
		}
	}
	...
	switch (Local_6.f_7)
	{
		case 0:
			if (!does_entity_exist(Local_6.f_3))
			{
				Local_6.f_3 = _get_ped_using_scenario_point(iLocal_3);
				bLocal_5 = true;
			}
			else
			{
			...
			break;
		case 1:
			if (has_anim_event_fired(Local_6.f_3, -1134697563))
			{
				if (!does_entity_exist(Local_6.f_2))
				{
					Local_6.f_2 = _0x4d0d2e3d8bc000eb(Local_6.f_3, "s_meatbit_Chunck_small01x_PH_L_HAND", 0);
				}
				Local_6.f_7 = 2;
			}
			break;
		case 2:
			if (does_entity_exist(Local_6.f_2))
			{
				Local_6.f_1 = get_object_index_from_entity_index(Local_6.f_2);
				_set_object_burn_level(Local_6.f_1, 0f, true);
				Local_6.f_7 = 3;
			}
			else
			{
			...
			break;
		case 3:
			if (has_anim_event_fired(Local_6.f_3, -1334721097))
			{
				if (does_entity_exist(Local_6.f_2))
				{
		...
		case 4:
			if (does_entity_exist(Local_6.f_2))
			{
				...
				{
					_set_object_burn_level(Local_6.f_1, (Local_6 / 10f), true);
				}
				else
				{
					bLocal_0 = false;
