...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -8.4183f, -1.1202f, 0.8f, 0f, 1.5f, 1.5f, 3f, -1612834106, -727195357, 1, 1, 1);
	func_151(uParam0, 0.72f, -1.1f, 0.8f, 32.76f, 2.3f, 2.68f, 3f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, -862949069, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 1, 1);
	func_152(uParam0, -1025740342, 0f, 0f, 0f, "CHAIR", 0, 1, 1);
	func_153(uParam0, "script@vignette@molly_2@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@molly_2@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@molly_2@action_a_int", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@molly_2@action_b", 2, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@molly_2@action_b_int", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@molly_2@action_c", 0, 0, 0, 0);
	func_154(uParam0, "CML2AUD");
	func_155(uParam0, -534422846, -241283989);
	func_156(uParam0, iLocal_20, -1, 0.86f);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 3, -1);
	func_159(uParam0, iLocal_15, 2, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	Local_21 = { func_160(uParam0, 0.4312f, -1.0244f, 0.9771f, 120.96f, 7f, 0.6f, 0.382f) };
	return true;
}
