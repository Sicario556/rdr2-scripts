void __EntryFunction__()
{
	...
	fLocal_49 = 1f;
	fLocal_50 = 1.5f;
	iLocal_52 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "DAP_CORPSE", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	if (*uParam0 == 239)
	{
		func_48(uParam0, 1, "DAP_LIVE_ANIMAL", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 0f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
		fLocal_51 = get_random_float_in_range(7.5f, 15f);
	}
}
...
int func_31(var uParam0)
{
	if (*uParam0 == 239)
	{
		if (!&uParam0->f_469[1])
		{
			if (func_64(uParam0, &uLocal_10, 0) || func_65(Global_35, &(uParam0->f_20[1]), 1) < 144f)
			{
				func_66(uParam0);
				func_67(uParam0->f_20[1], 0, 1);
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_38)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				if (*uParam0 == 239)
				{
					set_ped_config_flag(&(uParam0->f_20[0]), 243, true);
				}
				task_play_anim(&(uParam0->f_20[0]), sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
				_0x3ca5e58c9731a16b(&(uParam0->f_20[0]), iLocal_52);
				iLocal_41 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, fLocal_49, 1, 36, 0);
				iLocal_42 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, fLocal_50, 2, -1, 0);
			}
			if (*uParam0 == 239)
			{
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					_task_start_scenario_in_place(&(uParam0->f_20[1]), 365448677, 0, false, 0, -1f, false);
