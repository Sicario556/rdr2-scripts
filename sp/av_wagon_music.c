...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iLocal_44 = get_random_int_in_range(1, 3);
	iLocal_45 = get_random_int_in_range(0, 3);
	switch (iLocal_45)
	{
		case 0:
			iLocal_43 = -822103954;
	...
	func_49(uParam0, 0, "WBPP_MAN_1", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "WBPP_MAN_2", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
...
{
	if (!_has_propset_loaded(iLocal_43))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	if (!is_entity_dead(uParam0->f_453))
	{
		set_vehicle_extra(uParam0->f_453, iLocal_44, false);
		_0x8268b098f6fca4e2(uParam0->f_453, 0);
		_0xd80faf919a2e56ea(uParam0->f_453, iLocal_43);
	}
	return true;
}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				set_ped_config_flag(&(uParam0->f_20[0]), 476, true);
				set_ped_config_flag(&(uParam0->f_20[0]), 291, true);
				...
				add_relationship_group("WBPP", &iLocal_46);
				set_ped_relationship_group_hash(&(uParam0->f_20[0]), iLocal_46);
				task_vehicle_drive_wander(&(uParam0->f_20[0]), uParam0->f_453, 3f, 524419);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				set_ped_relationship_group_hash(&(uParam0->f_20[1]), iLocal_46);
				set_current_ped_weapon(&(uParam0->f_20[1]), -1569615261, true, 0, false, false);
				set_ped_as_group_member(&(uParam0->f_20[1]), iLocal_39);
				set_ped_config_flag(&(uParam0->f_20[1]), 291, true);
				set_ped_config_flag(&(uParam0->f_20[1]), 259, false);
		...
		case 2:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					if (uParam0->f_489 == 0)
					{
						uParam0->f_489 = get_random_int_in_range(1, 4);
					}
					switch (uParam0->f_489)
					{
						case 0:
						case 1:
							_0xd65fdc686a031c83(&(uParam0->f_20[1]), 281391541, 10f);
							break;
						case 2:
							_0xd65fdc686a031c83(&(uParam0->f_20[1]), -953151892, 10f);
							break;
						case 3:
							_0xd65fdc686a031c83(&(uParam0->f_20[1]), 290320544, 10f);
							break;
					}
				}
				func_68(&uLocal_40);
...
int func_32(var uParam0, var uParam1)
{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				if (!&uParam0->f_469[1])
				{
					if (iVar0 == 0)
					{
						if (!is_entity_dead(&(uParam0->f_20[iVar0])))
						{
							if (!func_70(&(uParam0->f_20[iVar0]), -258271821))
							{
	...
	if (_does_propset_exist(iLocal_47))
	{
		_set_propset_as_no_longer_needed(iLocal_47);
	}
	return 1;
}
...
bool func_74(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_110(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_75(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_111(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_131(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_169(1) || *uParam0 & 8192 != 0))
				{
...
bool func_129(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_182(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_180(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_181(uParam2)
				{
					func_176(uParam2, 1);
					return true;
				}
...
bool func_130(int iParam0, var uParam1)
{
	...
	if (func_172(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_181(uParam1)
		{
...
void func_156(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_195(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_215(iVar0, 0)))
		{
...
bool func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_215(iVar0, 0)))
		{
			if (func_217(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_201(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_195(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_204(int iParam0)
{
	...
	return func_223((*Global_1347702)[58]->f_15, 1);
}
...
bool func_216(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_217(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
