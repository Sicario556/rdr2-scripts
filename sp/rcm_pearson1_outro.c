...
void func_19(var uParam0)
{
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		uParam0->f_2 = _create_anim_scene("non_final@chp1@rprsn_to_odr1", 0, 0, false, true);
...
{
	if (!_is_anim_scene_started(uParam0->f_2, false))
	{
...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_67(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_69(iParam0);
					_0x7b204f88f6c3d287(func_70(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_70(iParam0, 0));
					func_71(iParam0);
				}
			}
			else
...
float func_67(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_77(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_68(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_78(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_70(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_79(iParam0);
	}
