...
void func_8(var uParam0)
{
	switch (Local_14)
	{
		...
		case 1:
			...
			{
				Local_14.f_1 = get_rayfire_map_object(func_51(0), 10f, "DES_dis_alchemist");
				if (does_rayfire_map_object_exist(Local_14.f_1))
				{
					set_state_of_rayfire_map_object(Local_14.f_1, 4);
					func_50(&Local_14, 2);
				}
			}
			break;
		case 2:
			if (does_rayfire_map_object_exist(Local_14.f_1) && get_state_of_rayfire_map_object(Local_14.f_1) == 5)
			{
				func_50(&Local_14, 3);
			}
			break;
		case 3:
			...
			{
				if (!is_ped_in_any_train(Global_35) && func_53(Global_35, func_51(0), 0))
				{
					func_25(&(Local_14.f_2));
					set_state_of_rayfire_map_object(Local_14.f_1, 6);
					_0x374f0e716bfcde82("EXPLOSIONS_SCRIPTED_WOODEN_BUILDING", func_51(2));
					Local_14.f_5 = add_shocking_event_at_position(-2108467590, func_51(1), 30f, 100f, 150f, -1f, -1f, -1, -1);
					func_50(&Local_14, 4);
				}
			}
			break;
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_53(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
bool func_52(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_101(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_153(int iParam0)
{
	...
	if (!func_112(iParam0, 16) && !func_182(iVar0, 0))
	{
		return false;
	}
	return true;
...
bool func_185(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
