...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 54:
			...
			iLocal_39 = func_49(997958153, 1);
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, _get_object_offset_from_coords(vParam1, vParam4.z, -4f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
		case 74:
			iLocal_38 = func_48(func_47(), 1, 1, 1, 1, 1, 1);
			sLocal_43 = "script_respawn@one_shot@hybrid@near_water@unarmed@crouch_stream_wash@b";
			iLocal_39 = func_49(997958153, 1);
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			fLocal_46 = get_random_float_in_range(0.5f, 4f);
			break;
	}
}
...
{
	request_anim_dict(sLocal_43);
	if (!has_anim_dict_loaded(sLocal_43))
	{
		return 0;
	}
	func_58(&uLocal_10, 0);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (func_65(&(uParam0->f_20[iVar1]), 0, &uLocal_10, &uVar0, 0, 0))
				{
					func_66(uParam0);
					uParam0->f_469[0] = 1;
				}
				...
				switch (iLocal_9)
				{
					case 0:
						...
						{
							func_67(&(uParam0->f_20[1]->f_5), 1, 10, 0);
							task_start_scenario_at_position(&(uParam0->f_20[1]), iLocal_44, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
						...
						if (!is_entity_dead(&(uParam0->f_20[0])))
						{
							...
							func_67(&(uParam0->f_20[0]->f_5), 1, 10, 0);
							func_69(&(uParam0->f_20[0]), uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 2, 1073741824);
							if (*uParam0 == 54)
							{
								func_70(&(uParam0->f_20[0]), -1043454001, 0, 0, 0, -1082130432);
								_0xf9cbd46433e36713(Global_35, &(uParam0->f_20[0]), 0f, 0f, 0f, 4f, 20f, 200f, -1f, "MPDHP_MAN");
							}
							else
							{
								task_play_anim(&(uParam0->f_20[0]), sLocal_43, "respawn_loop", 8f, -8f, -1, 1, 0f, false, 0, false, 0, false);
							}
							func_68(uParam0->f_20[0], 0, 1);
							iLocal_45 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1.5f, 2, 27, 0);
						}
						iLocal_9 = 1;
						break;
					case 1:
						if (*uParam0 == 54)
						{
							if (_0x3ee1f7a8c32f24e1(get_player_index(), &iVar2, 0, 0))
							{
								...
								{
									if (get_ped_index_from_entity_index(iVar2) == &uParam0->f_20[0] && (is_control_just_pressed(0, -163964935) || is_control_just_pressed(0, 648122183)))
									{
										if (_0xc22aa08a8adb87d4(&(uParam0->f_20[0])) != -124850288)
										{
											func_66(uParam0);
											iLocal_9 = 2;
										}
					...
					case 2:
						...
						if (does_entity_exist(Global_35) && does_entity_exist(&(uParam0->f_20[0])))
						{
							if (func_77(&uLocal_40, func_76(*uParam0 == 54, 240f, fLocal_46)) || func_78(&(uParam0->f_20[0]), Global_35, 1) < 100f)
							{
								_0xec6935ebe0847b90(&(uParam0->f_20[0]), uParam0->f_20[1]->f_5);
								open_sequence_task(&iVar3);
								if (*uParam0 != 54)
								{
									task_play_anim(0, sLocal_43, "respawn_action", 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
								}
								task_mount_animal(0, &(uParam0->f_20[1]), -1, -1, 1f, 1, 0, 0);
								_task_move_in_traffic(0, 1f, 128, 0);
								close_sequence_task(iVar3);
								task_perform_sequence(&(uParam0->f_20[0]), iVar3);
								clear_sequence_task(&iVar3);
								set_ped_keep_task(&(uParam0->f_20[0]), true);
								if (func_79(&(uParam0->f_20[1]), 0))
								{
					...
					case 3:
						...
						if (func_77(&uLocal_40, 20f) && func_78(Global_35, &(uParam0->f_20[0]), 1) > 10000f)
						{
							return 1;
						}
						break;
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (does_entity_exist(&(uParam0->f_20[iVar0])))
		{
			if (does_entity_belong_to_this_script(&(uParam0->f_20[iVar0]), true))
			{
				...
				func_80(uParam0->f_20[iVar0], 1, 1, 1);
	...
	if (iLocal_45 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_45, 1);
	}
	return 1;
}
...
bool func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_95(&(Global_1898164->f_1[0]));
		if (func_96(iVar0) && func_97((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_139(Global_35) && is_player_teleport_active())
	{
	}
	if (func_140(iParam0))
	{
		if (func_141(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_142(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_142(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_142(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_142(iParam5, 32), true);
	...
	else if (func_142(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_142(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_142(iParam5, 64))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_78(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
float func_78(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_154(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_84(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_155(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_85(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_150(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
