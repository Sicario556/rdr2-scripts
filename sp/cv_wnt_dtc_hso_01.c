...
bool func_92(var uParam0)
{
	...
	if (!bLocal_94)
	{
		...
		{
			if (!is_entity_dead(func_53(uParam0, iLocal_18)))
			{
				_0xf1c03a5352243a30(func_53(uParam0, iLocal_18));
				task_go_to_entity(func_53(uParam0, iLocal_18), Global_35, -1, 0.5f, 1f, 2f, 0);
				bLocal_94 = true;
			}
		}
	}
	if (bLocal_94)
	{
		...
		{
			if (_0x7f9b9791d4cb71f6(func_53(uParam0, iLocal_18), Global_35, 0, 0) == 1 && !is_ped_using_any_scenario(func_53(uParam0, iLocal_18)))
			{
				func_208(uParam0, &uLocal_20);
				iLocal_96 = func_53(uParam0, iLocal_18);
				_0x3d9da5c9efd20d88(player_id(), &iLocal_96);
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_233(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_235(iParam0);
					_0x7b204f88f6c3d287(func_236(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_236(iParam0, 0));
					func_237(iParam0);
				}
			}
			else
...
void func_127(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_247(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_128(int iParam0, int iParam1, bool bParam2)
{
	...
	func_248(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_251(iParam0), 137, true);
	}
}
...
void func_135(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_251(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_251(iParam0), 204, false);
	}
}
...
void func_137(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_251(iParam0);
	if (((does_entity_exist(iVar1) && func_253(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_154(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_266(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_33(uParam0) < 5)
			{
				if (func_133(uParam0->f_107[iVar0]->f_1, 29, 1) || func_267(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_292(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_62(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_293(uParam0->f_107[iVar12]->f_2);
				}
				else if (func_55(uParam0->f_107[iVar12]->f_7))
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_234(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_294(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_295(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_188(var uParam0, int iParam1)
{
	...
	func_301(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_302(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_189(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_303(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_190(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_305(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_192(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_306(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_308(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_198(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_308(uParam0, uParam0->f_1976.f_1), 1, func_310(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_203(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_123() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_304() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_217(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_274(100f, 140f);
			}
		}
...
float func_233(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_343(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_234(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_344(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_236(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_345(iParam0);
	}
...
void func_252(int iParam0)
{
	if (func_55(iParam0))
	{
		if (does_entity_exist(func_251(iParam0)))
		{
...
bool func_265(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_351(&(Global_1898164->f_1[0]));
		if (func_352(iVar0) && func_353((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_354(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
int func_278(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
...
bool func_289(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_308(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
bool func_326(var uParam0, float fParam1, float fParam2)
{
	iVar1 = 0;
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_207(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_367(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_293(iParam0), 0);
}
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_257(iParam0, _create_persistent_character(func_143(iParam0)));
		if (func_245() == -1)
		{
...
void func_374(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_375(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, var uParam6, var uParam7, bool bParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_385(var uParam0, int iParam1)
{
	...
	func_438(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_386(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_441(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_388(var uParam0, int iParam1)
{
	...
	{
		func_294(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
bool func_397(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Var0.f_5 = 1;
	Var0.f_6 = 1;
	Var0 = sParam1;
		...
		case 6:
			if (func_131(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_302(Global_1360165[iParam0], 1);
				}
			}
			func_465(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_301(Global_1360165[iParam0]))
				{
				}
			}
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_234(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			{
				_0x63aa2b8eb087886a(func_234(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_468(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_249(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_249(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_249(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_249(iParam5, 32), true);
	...
	else if (func_249(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_249(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_249(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_474(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_255(iParam0)))
	{
		return false;
	}
...
bool func_493(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_234(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_303(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_495(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_251(iParam1)))
	{
		_0x931b241409216c1f(func_251(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_251(iParam1), iParam0);
...
int func_503(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_360(747937920, 1) && !func_460((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_251(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
