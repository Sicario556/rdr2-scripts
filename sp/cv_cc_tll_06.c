...
{
	if (!_is_scenario_group_enabled_hash(iLocal_57))
	{
		_set_scenario_group_enabled_hash(iLocal_57, true);
	}
	return true;
}
...
bool func_86(var uParam0)
{
	if (_is_scenario_group_enabled_hash(iLocal_57))
	{
		_set_scenario_group_enabled_hash(iLocal_57, false);
	}
	set_entity_heading(func_193(uParam0, iLocal_23), 138.29f);
	set_entity_coords(func_193(uParam0, iLocal_23), 2356.782f, 1345.284f, 104.8737f, true, false, true, true);
	freeze_entity_position(func_193(uParam0, iLocal_23), true);
	return true;
}
...
bool func_95(var uParam0)
{
	...
	if (!is_sphere_visible(vLocal_54, 1f))
	{
		_set_scenario_group_enabled_hash(iLocal_57, true);
		return true;
	}
