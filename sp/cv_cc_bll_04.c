...
bool func_72(var uParam0)
{
	...
	iLocal_20 = func_151(uParam0, 1230724566, 1.42062f, -0.462748f, 0.00315094f, "CRATE", 1, 0, 1);
	...
	func_154(uParam0, iLocal_14, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_20, 0, -1073741824, 1065353216, 1);
...
{
	if (_does_scenario_group_exist_hash(-1827935080))
	{
		_set_scenario_group_enabled_hash(-1827935080, false);
	}
...
{
	if (!is_sphere_visible(vLocal_43, 1f))
	{
