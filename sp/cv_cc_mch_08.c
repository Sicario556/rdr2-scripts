...
bool func_72(var uParam0)
{
	...
	iLocal_23 = func_152(uParam0, 1547859810, 0f, 0f, 0f, "Knife", 0, 0, 1);
	iLocal_24 = func_152(uParam0, -1419711042, 0f, 0f, 0f, "WOOD", 0, 0, 1);
	iLocal_22 = func_152(uParam0, -1006095118, vLocal_45, "Chair", 1, 0, 1);
	iLocal_21 = func_152(uParam0, -1006095118, vLocal_48, 0, 1, 0, 1);
...
{
	vLocal_51 = { get_entity_coords(func_169(uParam0, iLocal_21), true, false) };
	vLocal_54 = { get_entity_rotation(func_169(uParam0, iLocal_21), 2) };
	vLocal_57 = { get_entity_coords(func_169(uParam0, iLocal_22), true, false) };
	vLocal_60 = { get_entity_rotation(func_169(uParam0, iLocal_22), 2) };
	return true;
}
...
bool func_86(var uParam0)
{
	if (func_148(uParam0) == 2)
	{
		...
		if (does_entity_exist(iVar0))
		{
			_set_entity_coords_and_heading(iVar0, func_187(uParam0, -0.380632f, -6.0838f, 0.155003f), func_188(uParam0, 179.14f), true, false, true);
		}
	}
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		func_198(&uLocal_65);
		iLocal_68 = get_random_int_in_range(8, 15);
		remove_anim_scene_entity(&(uParam0->f_1984[iLocal_19]), "Bill", func_48(uParam0, iLocal_14));
		remove_anim_scene_entity(&(uParam0->f_1984[iLocal_19]), "Knife", func_169(uParam0, iLocal_23));
		remove_anim_scene_entity(&(uParam0->f_1984[iLocal_19]), "WOOD", func_169(uParam0, iLocal_24));
...
bool func_95(var uParam0)
{
	if (!bLocal_63)
	{
		if (is_entity_occluded(func_169(uParam0, iLocal_21)))
		{
			set_entity_coords(func_169(uParam0, iLocal_21), vLocal_51, true, false, true, true);
			set_entity_rotation(func_169(uParam0, iLocal_21), vLocal_54, 2, true);
			bLocal_63 = true;
		}
	}
	if (!bLocal_64)
	{
		if (is_entity_occluded(func_169(uParam0, iLocal_22)))
		{
			set_entity_coords(func_169(uParam0, iLocal_22), vLocal_57, true, false, true, true);
			set_entity_rotation(func_169(uParam0, iLocal_22), vLocal_60, 2, true);
			bLocal_64 = true;
		}
	}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_187(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_181(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_187(uParam0, uParam0->f_1976.f_1), 1, func_188(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_291(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_199(var uParam0, int iParam1, float fParam2)
{
	if (!func_282(iParam1))
	{
		return false;
...
void func_205(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_199(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
int func_210(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_300(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_212(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_301(iParam0);
	}
...
bool func_240(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_308(iVar0) && func_309((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_310(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_318(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_319(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_319(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_320(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_253(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_321(iVar1)))
			{
				func_322(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_323(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_260(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_187(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
bool func_288(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_331(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_316(747937920, 1) && !func_382((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
