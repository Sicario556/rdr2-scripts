...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 3:
			...
			while (iVar0 <= 3)
			{
				request_model(func_59(iVar0), false);
				iVar0++;
			}
			func_49(&Local_14, 4);
			break;
		case 4:
			...
			while (iVar0 <= 3)
			{
				if (!has_model_loaded(func_59(iVar0)))
				{
					return;
				}
				iVar0++;
			...
			{
				Local_14.f_1 = _create_mission_train(func_60(), func_61(0), true, false, true, false);
			}
			if (!_0xbd3c4a2ed509205e(Local_14.f_1))
			{
				return;
			}
			iVar0 = 0;
			while (iVar0 <= 3)
			{
				Local_14.f_2[iVar0] = get_train_carriage(Local_14.f_1, iVar0);
				if (!does_entity_exist(&(Local_14.f_2[iVar0])))
				{
					return;
				}
				else
				{
					set_entity_collision(&(Local_14.f_2[iVar0]), false, false);
					set_entity_alpha(&(Local_14.f_2[iVar0]), 0, true);
					_0xba8818212633500a(&(Local_14.f_2[iVar0]), 4, 1);
					_0xba8818212633500a(&(Local_14.f_2[iVar0]), 5, 1);
					_0xba8818212633500a(&(Local_14.f_2[iVar0]), 6, 1);
				}
				iVar0++;
			}
			func_49(&Local_14, 5);
			break;
		case 5:
			if (!does_entity_exist(Local_14.f_1) || is_entity_dead(Local_14.f_1))
			{
				return;
			}
			...
			set_train_speed(Local_14.f_1, 12f);
			set_train_cruise_speed(Local_14.f_1, 12f);
			_0xba8818212633500a(Local_14.f_1, 4, 1);
			_0xba8818212633500a(&(Local_14.f_2[iVar0]), 5, 1);
			_0xba8818212633500a(&(Local_14.f_2[iVar0]), 6, 1);
			func_49(&Local_14, 6);
			break;
		case 6:
			if (!func_62(&Local_14, 200f, 1084227584))
			{
				return;
			}
			func_49(&Local_14, 7);
		...
		case 7:
			...
			{
				Local_14.f_10 = 1;
				_0x1bfbafcc6760ff02(Local_14.f_1, 0);
				_0xcfe122ec635cc2b2(Local_14.f_1, "PASSING", 0, 0);
			}
			if (is_entity_on_screen(Local_14.f_1))
			{
				Var2.f_4 = -1;
				Var2.f_8 = 2;
				Var2.f_9 = 1;
				...
				Var2.f_13 = 3;
				Var2.f_7 = 500;
				_0x66f9eb44342bb4c5(Global_35, &Var2);
				if (!func_51(func_50()))
				{
					func_63(func_50());
				}
			...
			break;
		case 8:
			if (!func_65(&Local_14, 0f, 1084227584))
			{
				return;
			}
			func_66(uParam0);
		...
		case 9:
			if (does_entity_exist(Local_14.f_1))
			{
				delete_mission_train(&(Local_14.f_1));
			}
			func_49(&Local_14, 10);
			break;
		case 10:
...
bool func_16(int iParam0)
{
	...
	{
		return func_73((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_26(var uParam0)
{
	...
	return (func_79() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_82(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_51(*uParam0))
			{
				uParam0->f_6.f_8 = func_83("DISCO_FOCUS", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", -719620017, Global_35, 2, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_89(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_89(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_90(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_90(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_91(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_105(Global_35))
		{
			return true;
		}
...
bool func_48(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_114(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_62(int iParam0, float fParam1, float fParam2)
{
	...
	fVar2 = (fVar1 / fParam2);
	iParam0->f_9 = floor(func_117(0f, fParam1, fVar2));
	if (IntToFloat(iParam0->f_9) < fParam1)
	{
		iVar0 = 0;
		while (iVar0 <= 3)
		{
			if (does_entity_exist(&(iParam0->f_2[iVar0])))
			{
				if (does_entity_exist(&(iParam0->f_2[iVar0])))
				{
					set_entity_alpha(&(iParam0->f_2[iVar0]), iParam0->f_9, true);
				}
			}
			iVar0++;
		}
...
bool func_65(int iParam0, float fParam1, float fParam2)
{
	...
	fVar3 = (fParam2 - fVar1);
	fVar2 = (fVar3 / fParam2);
	iParam0->f_9 = floor(func_117(fParam1, 200f, fVar2));
	if (IntToFloat(iParam0->f_9) > fParam1)
	{
		iVar0 = 0;
		while (iVar0 <= 3)
...
void func_75(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_123(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_123(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_81(var uParam0, int iParam1)
{
	...
	if (!func_128(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
int func_83(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_136(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_137(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_88(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_136(iParam0, 8))
		{
...
void func_91(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_138(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_138(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_99()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_135(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_143(0), iVar0, 0))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_157(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_157(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_157(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_157(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_127(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_166(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_133(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_128(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_146(int iParam0)
{
	...
	fVar1 = func_182(absf(fVar1) < 1f, func_182(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_185((get_game_timer() + iParam2), !bParam1);
...
void func_152(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_187(iParam0));
...
int func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_143(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	return func_218(1328661203, func_219(), -1591664384, bParam0);
}
