...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.925f, -4.5625f, 0f, -35f, 1f, 1f, 5f, -1612834106, -695792551, 1, 1, 1);
	func_151(uParam0, -0.125f, -0.4125f, 0f, -35f, 1f, 1f, 5f, -1612834106, 211687389, 1, 1, 1);
	func_151(uParam0, -6.55f, 2.7375f, 0f, -35f, 1f, 1f, 5f, -1612834106, -1377448058, 1, 1, 1);
	func_151(uParam0, -4.45f, -4.475f, 0f, -35f, 1f, 1f, 5f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, -0.325f, -0.736f, 0.6f, -35f, 1f, 1f, 2.5f, 665633627, 1);
	func_153(uParam0, -160914303, 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	func_153(uParam0, -1671495534, 0f, 0f, 0f, "cigarette", 0, 1, 1);
	func_153(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 1, 1);
	iLocal_19 = func_153(uParam0, 843299161, 0f, 0f, 0f, "ROPE", 0, 0, 1);
	func_154(uParam0, "script@vignette@kieran_15@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@kieran_15@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@kieran_15@action_b", 0, 0, 0, 0);
	...
	func_161(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_161(uParam0, iLocal_16, 3, -1122379099, "WORLD_HUMAN_STAND_DRINK_FEMALE_D", -1, 1);
	return true;
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_299(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_300(uParam0->f_107[iVar0]->f_1, fVar4);
				func_299(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
bool func_200(var uParam0, int iParam1)
{
	...
	{
		if (!func_303(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_277(var uParam0, int iParam1)
{
	...
	else if (!func_303(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_314()
{
	if (_is_ped_carrying(Global_35) || func_355(Global_35))
	{
		return true;
	}
	return false;
...
void func_341(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_300(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_345(var uParam0, int iParam1)
{
	...
	func_381(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_346(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_384(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_388(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_419(iParam0, func_284());
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_391((*Global_1347702)[63]->f_15, 1) || func_428((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_391((*Global_1347702)[134]->f_15, 1) || func_428((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_391((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
