...
bool func_11()
{
	iLocal_14 = _create_volume_box_with_custom_name(-73.33932f, -398.9078f, 72.24845f, 0f, 0f, 66.15892f, 99.58835f, 86.51411f, 42.63912f, "Granger's Hoggery - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("Granger's Hoggery - m_volRancherThreat Agg");
		_0xbce668aaf83608be(iLocal_17, -68.82082f, -387.3279f, 72.49265f, 0f, 0f, 48.19205f, 0.916038f, 0.967821f, 6.513287f);
		_0xbce668aaf83608be(iLocal_17, -77.56838f, -392.186f, 72.49265f, 0f, 0f, 48.19205f, 2.563069f, 2.387336f, 6.513287f);
		_0xbce668aaf83608be(iLocal_17, -75.34951f, -388.4147f, 72.1382f, 0f, 0f, 22.97115f, 4.397328f, 4.863138f, 6.900121f);
		_0x39816f6f94f385ad(iLocal_17, -62.42026f, -409.1303f, 68.97523f, 0f, 0f, 13.57845f, 13.41282f, 8.335032f, 6.900121f);
		_0x39816f6f94f385ad(iLocal_17, -62.5439f, -392.4335f, 72.1382f, 0f, 0f, 29.04495f, 7.979648f, 6.063315f, 6.900121f);
		_0x39816f6f94f385ad(iLocal_17, -68.68666f, -377.174f, 72.1382f, 0f, 0f, 76.32537f, 1.587863f, 1.493361f, 5.424076f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Granger's Hoggery - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_17);
		_0xbce668aaf83608be(iLocal_16, -66.34515f, -395.8655f, 72.49265f, 0f, 0f, 20.19842f, 20.50491f, 22.65399f, 6.513287f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("Granger's Hoggery - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_16);
		_0xbce668aaf83608be(iLocal_18, -66.34515f, -395.8655f, 72.49265f, 0f, 0f, 20.19842f, 44.28191f, 42.39419f, 6.513287f);
		...
		_set_guard_zone_position(sLocal_15, -62.197f, -392.6637f, 72.1036f);
...
void func_28(int iParam0)
{
	...
	{
		func_19(70, 16);
		set_scenario_group_enabled("Shack_GunslingerLivestock", false);
	}
}
...
bool func_61(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_93(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1934266->f_148 = func_108(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_67()
{
	return (Global_1894899 & 1 != 0 && func_114() != -1);
}
...
void func_69(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_115(iVar1) && !func_118(iVar1, iParam2)) && (!bParam3 || !func_119(iVar1))) && (!bParam4 || !func_120(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_121(iVar0);
...
void func_78(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_126(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
bool func_89(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_134(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_90(iParam0));
}
...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_138(Global_1894899->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_140(func_139(Global_36));
	}
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_143(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_110(int iParam0)
{
	...
	if (func_144())
	{
		if (!func_88((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_148(Global_1935369->f_5[iParam0]->f_6, 1);
	func_149(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_84(Global_1914319->f_3[iParam0]->f_21) && func_151(Global_1914319->f_3[iParam0]->f_21))
	{
		func_152(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_153(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_126(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_137(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_87(iVar0) && func_166((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_170(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
