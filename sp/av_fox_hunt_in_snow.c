...
int func_31(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		bLocal_40 = _0x3ab6c7b0bb0df4b1(&(uParam0->f_20[0]), -1);
	}
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38)
		{
			if ((!bLocal_40 || func_62(uParam0, &uLocal_10, 1)) || func_63(&(uParam0->f_20[0]), Global_35, 1) <= 400f)
			{
				func_64(uParam0);
				if (!&uParam0->f_469[3])
				{
						...
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_is_anim_scene_finished(uParam0->f_3.f_1, false) || _is_anim_scene_active(uParam0->f_3.f_1))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									...
									if (is_model_valid(uParam0->f_20[0]->f_2))
									{
										set_model_as_no_longer_needed(uParam0->f_20[0]->f_2);
									}
								}
								uParam0->f_469[2] = 1;
								return 1;
