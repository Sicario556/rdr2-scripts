...
void func_27(int iParam0)
{
	...
	iParam0->f_58[0] = -1694140847;
	iParam0->f_58[1] = 1597043588;
	iParam0->f_58[2] = 309890055;
	...
	{
		iVar1 = iVar0;
		iLocal_1145[iVar0] = get_hash_key(func_158(iVar1));
		iVar0++;
	}
	iLocal_1154 = 0;
...
void func_63(int iParam0)
{
	...
	if (_is_anim_scene_finished(iParam0->f_48, false))
	{
	}
	func_237(iParam0);
	switch (iVar1138)
	{
		...
		case 1:
			...
			while (iVar2 <= 5)
			{
				...
				if (iVar3 != 3)
				{
					if (!func_142(iParam0->f_48, func_157(iVar3), func_156()))
					{
						return;
					}
				}
		...
		case 3:
			if (fVar1 >= 0.999f)
			{
				freeze_entity_position(&(iParam0->f_81[0]), true);
		...
		case 5:
			...
			{
				func_239(&(iParam0->f_48), "BoolLoop", 1, func_156());
				func_43(&uLocal_1142);
				func_145(iParam0->f_48, func_157(2), func_240());
				iLocal_1154 = 2;
				freeze_entity_position(&(iParam0->f_81[0]), false);
		...
		case 6:
			if (_0x1f0e401031e20146(iParam0->f_48, func_157(2)))
			{
				...
				func_239(&(iParam0->f_48), "BoolLoop", 0, func_156());
		...
		case 7:
			if (fVar1 > 0.99f)
			{
				func_145(iParam0->f_48, func_157(5), func_240());
				iLocal_1154 = 5;
				func_239(&(iParam0->f_48), "BoolLoop", 1, func_156());
			...
			break;
		case 8:
			if (_0x1f0e401031e20146(iParam0->f_48, func_157(5)) && fVar1 > 0.75f)
			{
				func_238(&uLocal_1141, 9);
			}
			break;
		case 9:
	...
	switch (iParam0->f_3)
	{
		case 0:
			if (bVar0)
			{
				if (!does_cam_exist(iParam0->f_4))
				{
					iParam0->f_4 = create_camera_with_params(26379945, func_242(iParam0->f_1, 0), func_243(iParam0->f_1, 0), get_final_rendered_cam_fov(), false, 2);
				}
		...
		case 3:
			...
			if (is_control_just_pressed(2, -1496944061))
			{
				...
				set_cam_coord(iParam0->f_4, func_242(iParam0->f_1, iParam0->f_8));
				set_cam_rot(iParam0->f_4, func_243(iParam0->f_1, iParam0->f_8), 2);
			}
...
{
	func_260(func_259(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}
...
bool func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_265((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_120(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_266((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_265((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_136(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_266((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
void func_168(int iParam0)
{
	...
	{
		iParam0->f_66[0] = create_object(&(iParam0->f_58[0]), func_271(), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[1])))
	{
		iParam0->f_66[1] = create_object(&(iParam0->f_58[1]), func_271(), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[2])))
	{
		iParam0->f_66[2] = create_object(&(iParam0->f_58[2]), func_271(), true, true, false, false, true);
	}
...
void func_169(int iParam0)
{
	...
	set_anim_scene_entity(iParam0->f_48, "ASSISTANT_", &(iParam0->f_81[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "BOX", &(iParam0->f_66[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "Knife", &(iParam0->f_66[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "mask", &(iParam0->f_66[2]), 0);
}
...
int func_181(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_274(iVar0, iParam0, bParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_187(var uParam0, int iParam1)
{
	if (does_entity_exist(*uParam0))
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_280(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_280(), 2, 0, 0);
		}
	}
}
...
int func_209(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	...
	iVar1 = func_288(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_289(iVar0);
	return iVar1;
}
...
void func_215(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar5 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			{
				if (func_290(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 != 5)
				{
					(*uParam1)[iVar5]->f_1 = 5;
				}
			}
			else if (func_290(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 == 5)
			{
			...
			if ((!uParam0->f_19 && !func_290(*uParam0, iVar5)) && (*uParam1)[iVar5]->f_1 != 5)
			{
				if ((*uParam1)[iVar5]->f_9)
				{
					fVar6 = func_294(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 > 2f || !func_295((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_9 = 0;
						uParam0->f_21 = 0;
						(*uParam1)[iVar5]->f_5 = 2;
						func_296((*uParam1)[iVar5], iParam2);
					}
				}
				else if (!uParam0->f_21 && (*uParam1)[iVar5]->f_1 != 6)
				{
					fVar6 = func_294(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 < 1.5f && func_295((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_5 = func_297(iVar5);
						func_296((*uParam1)[iVar5], iParam2);
						(*uParam1)[iVar5]->f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch ((*uParam1)[iVar5]->f_1)
			{
				...
				case 1:
					...
					{
						func_300((*uParam1)[iVar5], func_299(iParam2), 500);
					}
					break;
				case 3:
					func_301((*uParam1)[iVar5], iParam2);
					(*uParam1)[iVar5]->f_1 = 4;
					break;
				case 4:
					bVar7 = false;
				...
				case 5:
					if (!uParam0->f_19)
					{
						func_302(uParam0, (*uParam1)[iVar5]);
					}
					break;
				case 6:
				...
				case 9:
					...
					{
						task_follow_nav_mesh_to_coord(uParam1[iVar5], func_303(iParam2), 1f, -1, 0.25f, 5373953, 40000f);
						_0x2208438012482a1a(uParam1[iVar5], false, false);
						(*uParam1)[iVar5]->f_1 = 10;
					}
					break;
				case 10:
					...
					else if (!func_304(get_entity_coords(uParam1[iVar5], true, false)))
					{
					...
					else if (get_script_task_status(uParam1[iVar5], 713668775, true) != 1 && fVar2 > (func_293(iParam2, iVar5) + 3f))
					{
						(*uParam1)[iVar5]->f_1 = 9;
					}
					break;
...
void func_221(int iParam0)
{
	...
	{
		func_241(iParam0->f_1053[1], 1, 1);
	}
	if (func_224(&(iParam0->f_1053[0])))
	{
		func_241(iParam0->f_1053[0], 1, 1);
	}
	if (func_224(&(iParam0->f_1053[2])))
	{
		func_241(iParam0->f_1053[2], 1, 1);
	}
}
...
int func_225(int iParam0, var uParam1)
{
	...
	_uiprompt_set_group((*Global_1945938)[func_305(&(iParam0->f_1053[1]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	if (!func_232(iParam0->f_1053[0], uParam1, "SHOW_NEG_RESPONSE", 648122183))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_305(&(iParam0->f_1053[0]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	return 1;
}
...
{
	bVar0 = false;
	if ((func_40(&(iParam0->f_950)) && iParam0->f_18 < func_311(*iParam0)) && func_47(&(iParam0->f_950)) > 35000)
	{
		iParam0->f_18++;
		vVar1 = { func_312(*iParam0, 0, 1) };
		bVar0 = true;
	}
	else if (func_313(*iParam0) && !func_314(36))
	{
		iVar4 = get_random_int_in_range(0, 10);
		if (iVar4 < 5)
		{
			vVar1 = { func_312(*iParam0, 2, 1) };
		}
		else
		{
			vVar1 = { func_312(*iParam0, 1, 1) };
		}
	}
	else
	{
	...
	if (func_315(iParam0))
	{
		vVar1 = { func_312(*iParam0, 3, 1) };
	}
	if (func_316(&(iParam0->f_954), vVar1, 1, -1, 0, 0))
	{
		iParam0->f_1052++;
		func_317(iParam0);
		if (bVar0)
...
void func_230()
{
	...
	bVar0 = false;
	if (is_ped_active_in_scenario(Global_35, 1) || (func_314(36) && _0x3ab6c7b0bb0df4b1(Global_35, -1)))
	{
		bVar0 = true;
	}
	if (!bVar0)
	{
		task_play_anim(Global_35, func_159(), func_318(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_159(), func_318(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
{
	bVar0 = false;
	if ((func_40(&(iParam0->f_950)) && iParam0->f_19 < func_311(*iParam0)) && func_47(&(iParam0->f_950)) > 35000)
	{
		iParam0->f_19++;
		vVar1 = { func_312(*iParam0, 0, 0) };
		bVar0 = true;
	}
	else if (func_313(*iParam0) && !func_314(36))
	{
		...
		if (iVar4 < 5)
		{
			vVar1 = { func_312(*iParam0, 2, 0) };
		}
		else
		{
			vVar1 = { func_312(*iParam0, 1, 0) };
		}
	}
	else
	{
...
void func_237(int iParam0)
{
	switch (iVar1151)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(iLocal_1145[iVar1])))
				{
					if (iVar1 == 1)
					{
		...
		case 1:
			break;
		case 2:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(iLocal_1145[6])))
			{
		...
		case 4:
			break;
		case 5:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(iLocal_1145[7])))
			{
...
void func_239(var uParam0, char* sParam1, bool bParam2, char* sParam3)
{
	if (!_does_anim_scene_exist(*uParam0))
	{
		return;
...
void func_260(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = round(func_341(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_274(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_348(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_349(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_350(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_351(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_352(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_353(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_354(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_355(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_356(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_357(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_358(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_359(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_360(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_361(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_362(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_363(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 4:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_364(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_365(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_366(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_367(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 5:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_368(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_369(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_370(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_371(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 6:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_372(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_373(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_374(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_375(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 7:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_376(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_377(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_378(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_379(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 8:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_380(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_381(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_382(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_383(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 9:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_384(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_385(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_386(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_387(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 10:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_388(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_389(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_390(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_391(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 11:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_392(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_393(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_394(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_395(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 12:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_396(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_397(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_398(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_399(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 13:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_400(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_401(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_402(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_403(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 16:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_404(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_405(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_406(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_407(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 17:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_408(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_409(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_410(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_411(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 18:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_412(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_413(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_414(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_415(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 20:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_416(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_417(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_418(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_419(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 21:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_420(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_421(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_422(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_423(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 19:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_424(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_425(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_426(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_427(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 22:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_428(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_405(get_random_int_in_range(0, func_347(16, iParam1, iParam2)));
						case 2:
							return func_406(get_random_int_in_range(0, func_347(16, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_429(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 23:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_430(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_431(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_432(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_433(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 24:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_434(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_435(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_436(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_437(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 25:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_438(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_439(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_440(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_441(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		...
		case 27:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_442(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_443(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_444(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_445(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 28:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_446(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_443(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_444(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_447(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 29:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_448(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_443(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_444(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_449(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 30:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_450(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_443(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_444(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_451(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 31:
			break;
		case 32:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_452(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_453(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 33:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_454(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_455(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 34:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_456(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_457(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 14:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_458(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_459(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_460(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_461(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
		case 15:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_462(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 1:
							return func_459(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
						case 2:
							return func_460(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_463(get_random_int_in_range(0, func_347(iParam0, iParam1, iParam2)));
			}
			break;
	}
	return "FAIL";
...
int func_288(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_464(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !decor_exist_on(iVar2, "bIgnoreThisPed"))
				{
...
int func_292(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return 1;
		case 0:
			if (func_466((*Global_1835011)[36]->f_1))
			{
				return 0;
			}
			else
...
void func_296(int* iParam0, int iParam1)
{
	if ((does_entity_exist(*iParam0) && !iParam0->f_9) && iParam0->f_5 != -1)
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_280(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_280(), 2, 0, 0);
		}
	}
	if (!iParam0->f_9)
	{
...
void func_307(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_310(iParam0, 8))
		{
...
bool func_314(int iParam0)
{
	...
	return func_466((*Global_1835011)[iParam0]->f_1);
}
...
bool func_464(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_485(int iParam0)
{
	...
	if (is_ped_group_member(iParam0, func_488(), 1))
	{
		return true;
	}
	return false;
...
int func_489(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_492(iParam1, &iVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_493(iParam0, iVar0, iVar1, bParam2);
}
...
bool func_492(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_262() != -1;
	switch (iParam0)
	{
...
int func_493(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_495(iVar2) != 0 && _0x800df3fc913355f3(func_496(iVar2)))
		{
