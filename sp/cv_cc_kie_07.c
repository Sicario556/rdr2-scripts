...
bool func_93(var uParam0)
{
	if (!bLocal_120)
	{
		...
		{
			set_entity_visible(func_207(uParam0, iLocal_17), false);
			bLocal_120 = true;
		}
	}
	...
	if (!func_54(uParam0->f_107[iLocal_15]->f_1) && !bLocal_123)
	{
	...
	if (bLocal_122)
	{
		if (is_entity_occluded(func_48(uParam0, iLocal_14)))
		{
			if (_does_scenario_point_exist(uParam0->f_107[iLocal_14]->f_32.f_21))
			{
				_delete_scenario_point(uParam0->f_107[iLocal_14]->f_32.f_21);
			}
			_0x631cd2d77fdc0316(_0x32a1e3b83d501096(func_48(uParam0, iLocal_14)));
			_0xd4b614179bcd0654(_0x32a1e3b83d501096(func_48(uParam0, iLocal_14)));
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_209(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_224(iParam0);
					_0x7b204f88f6c3d287(func_225(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_225(iParam0, 0));
					func_226(iParam0);
				}
			}
			else
...
void func_116(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_236(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	func_237(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_240(iParam0), 137, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_240(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_240(iParam0), 204, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_240(iParam0);
	if (((does_entity_exist(iVar1) && func_242(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_255(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_256(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
{
	uParam0->f_23 = { func_262(iParam1) + Vector(fParam4, fParam3, fParam2) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_223(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_265(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_191(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_265(uParam0, uParam0->f_1976.f_1), 1, func_266(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_196(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_294() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_198(var uParam0, float fParam1, float fParam2)
{
	iVar1 = 0;
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_307(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_206(var uParam0, int iParam1, float fParam2)
{
	if (!func_301(iParam1))
	{
		return false;
...
bool func_212(var uParam0, int iParam1)
{
	...
	{
		if (!func_319(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_213(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_321(100f, 140f);
			}
		}
...
void func_219(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_206(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_237(var uParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		*uParam0 = (*uParam0 || iParam1);
...
void func_241(int iParam0)
{
	if (func_50(iParam0))
	{
		if (does_entity_exist(func_240(iParam0)))
		{
...
bool func_279(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_265(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_287(var uParam0, int iParam1)
{
	...
	else if (!func_319(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
float func_307(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_317(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3)
{
	iVar0 = 0;
...
bool func_329()
{
	if (_is_ped_carrying(Global_35) || func_369(Global_35))
	{
		return true;
	}
	return false;
...
int func_346(int iParam0, bool bParam1)
{
	...
	{
		func_246(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_234() == -1)
		{
...
void func_359(var uParam0, int iParam1)
{
	...
	func_395(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_360(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_398(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
bool func_378(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_405((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_413(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_414(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_416(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_418(iParam0, Global_1360165[iParam0]);
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_223(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_221(vVar0)) && !func_222(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_413((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			{
				_0x63aa2b8eb087886a(func_223(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_413(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_238(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_238(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
	...
	else if (func_238(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_238(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_238(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_430(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_223(iParam0, 1));
...
void func_432(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_240(iParam1)))
	{
		_0x931b241409216c1f(func_240(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_240(iParam1), iParam0);
...
int func_440(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_405((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_405((*Global_1347702)[63]->f_15, 1) || func_442((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_405((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_405((*Global_1347702)[134]->f_15, 1) || func_442((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_405((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(747937920, 1) && !func_405((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_240(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_456(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_420(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_420(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_420(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_420(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_420(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_420(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_420(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_420(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_420(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_420(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_420(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_420(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_420(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_420(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_420(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_420(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_420(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_420(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_420(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_420(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_420(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_420(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_420(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_420(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_420(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_420(iParam1, 1544915253))
	{
