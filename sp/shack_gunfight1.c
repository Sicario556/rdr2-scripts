...
bool func_12(var uParam0)
{
	if (!func_41(uParam0->f_3, 4))
	{
		if (func_42(uParam0))
		{
			...
			while (iVar0 <= (2 - 1))
			{
				if (!does_pickup_exist(&(iLocal_103[iVar0])))
				{
					func_45(&iLocal_106, 2);
					if (iVar0 == 0)
					{
						iLocal_103[iVar0] = create_pickup_rotate(-70127024, func_36(uParam0, 0), func_37(uParam0, 0), iLocal_106, -1, 0, true, 0, 0, 0f, 0);
					}
					else if (iVar0 == 1)
					{
						iLocal_103[iVar0] = create_pickup_rotate(-70127024, func_36(uParam0, 1), func_37(uParam0, 1), iLocal_106, -1, 0, true, 0, 0, 0f, 0);
					}
				}
				iVar0++;
			}
...
void func_48(var uParam0)
{
	...
	func_94(Local_73.f_4[0], &(uParam0->f_13[2]), *Local_73.f_17[0], get_random_float_in_range(0f, 359f), -1f, 15f, *Local_73.f_17[0] + Vector(20f, 0f, 0f), 20f, 20f, 1084227584, 1f, 0, 0, 0);
	func_94(Local_73.f_4[1], &(uParam0->f_13[3]), *Local_73.f_17[1], get_random_float_in_range(0f, 359f), -1f, 15f, *Local_73.f_17[1] + Vector(20f, 0f, 0f), 20f, 20f, 1084227584, 1f, 0, 0, 0);
	func_94(Local_73.f_4[2], &(uParam0->f_13[4]), *Local_73.f_17[2], get_random_float_in_range(0f, 359f), -1f, 15f, *Local_73.f_17[2] + Vector(20f, 0f, 0f), 20f, 20f, 1084227584, 1f, 0, 0, 0);
}
...
void func_52(var uParam0)
{
	...
	while (iVar0 <= (2 - 1))
	{
		if (does_pickup_exist(&(iLocal_103[iVar0])))
		{
			remove_pickup(&(iLocal_103[iVar0]));
		}
		iVar0++;
	}
}
...
{
	if (!func_105(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_105(uParam0, iParam1), func_106(uParam0, iParam1), func_107(uParam0, iParam1), func_108(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
void func_94(var uParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6, float fParam7, vector3 vParam8, int iParam11, int iParam12, float fParam13, var uParam14, bool bParam15, bool bParam16, bool bParam17)
{
	...
	if (*uParam0 < 4)
	{
		if ((func_124(Global_35, iParam1, 1, 1) < fParam13 || is_player_free_aiming_at_entity(player_id(), iParam1)) || bParam16)
		{
			*uParam0 = 4;
		}
	}
	switch (*uParam0)
	{
		...
		case 1:
			...
			else if (get_script_task_status(iParam1, -708058584, true) != 1 && func_128(iParam1, vParam2, 1) < 1f)
			{
				func_125(iParam1, bParam17, &uVar0, &cVar8);
				if (!is_string_null_or_empty(&uVar0))
				{
