...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -31.1981f, 3.29326f, 0.868729f, 0f, 1f, 1f, 2.75f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, -33.4896f, -4.24883f, 0.369225f, 0f, 2.275f, 1.11f, 2.75f, -1612834106, -1749490051, 1, 1, 1);
	Local_24 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, -60f, 6.5f, 0.2825f, 0.7275f) };
	Local_34 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, 26.4f, 6.5f, 0.2775f, 0.6775f) };
	Local_44 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, -151f, 6.5f, 0.285f, 0.66f) };
	iLocal_23 = func_153(uParam0, 1210783447, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_153(uParam0, -1637302654, 0f, 0f, 0f, "TEACUP", 0, 0, 1);
	func_154(uParam0, "script@vignette@beecher@jack_6@Base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_A", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B", 2, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_FRONT", 2, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_LEFT", 2, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_RIGHT", 2, 0, 0, 0);
	iLocal_22 = func_154(uParam0, "script@vignette@beecher@jack_6@EXIT", 0, 0, 0, 0);
	func_155(uParam0, -829542285, -1530738668);
	func_156(uParam0, "BJCK6AU");
	func_157(uParam0, iLocal_14, 3, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 2, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_267(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_57(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_268(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_269(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_270(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_177(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_280(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_179(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_281(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_250(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_283(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_283(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_251(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_187(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_284(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_189(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_285(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_285(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_279() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_295(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
float func_209(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_304(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_210(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_305(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_212(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_306(iParam0);
	}
...
bool func_241(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_312(&(Global_1898164->f_1[0]));
		if (func_313(iVar0) && func_314((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_315(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_324(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_325(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_325(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_326(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_257(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_327(iVar1)))
			{
				func_328(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_329(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_264(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_250(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_272(var uParam0, int iParam1)
{
	...
	else if (!func_331(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_274(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_285(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_285(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_292(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_337(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_301(var uParam0, int iParam1)
{
	...
	{
		if (!func_331(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
bool func_310()
{
	if (_is_ped_carrying(Global_35) || func_347(Global_35))
	{
		return true;
	}
	return false;
...
int func_327(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_268(iParam0), 0);
}
...
bool func_356(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_387((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_395(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_396(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_398(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_400(iParam0, Global_1360165[iParam0]);
...
int func_379(var uParam0, int iParam1)
{
	...
	{
		func_269(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_384(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_417(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_415();
				}
			}
			if ((bParam2 && !func_207(vVar0)) && !func_208(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_395((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_418((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_427((*Global_1360165)[iParam0]->f_4.f_2) || func_428((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_429((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_431(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_395(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_436(Global_35) && is_player_teleport_active())
	{
	}
	if (func_437(iParam0))
	{
		if (func_438(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_417(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_449(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
int func_426(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_387((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_387((*Global_1347702)[63]->f_15, 1) || func_428((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_387((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_387((*Global_1347702)[134]->f_15, 1) || func_428((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_387((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(747937920, 1) && !func_387((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_442(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_402(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_402(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_402(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_402(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_402(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_402(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_402(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_402(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_402(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_402(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_402(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_402(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_402(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_402(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_402(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_402(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_402(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_402(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_402(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_402(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_402(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_402(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_402(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_402(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_402(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_402(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_463(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_474(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_478(0))
				{
					...
					func_479(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<4> func_476(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_494(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_477(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_494(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_478(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_494(bParam0));
}
...
void func_480(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_497(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_490(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_494(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_491(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_494(bParam6), &Var0, 0);
	return uVar4;
}
