...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1590781012, 0f, 0f, 0f, "ROPE", 0, 1, 1);
...
bool func_203(var uParam0, int iParam1)
{
	...
	{
		if (!func_308(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_280(var uParam0, int iParam1)
{
	...
	else if (!func_308(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
void func_423(int iParam0, int iParam1)
{
	...
	func_386(iParam0, func_453(iParam1));
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_397((*Global_1347702)[63]->f_15, 1) || func_433((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_397((*Global_1347702)[134]->f_15, 1) || func_433((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_162(747937920, 1) && !func_397((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
