...
{
	func_33(uParam0, 10784, 10856, 11614);
}
...
{
	if (!has_anim_dict_loaded("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE") || !has_anim_dict_loaded("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE@BASE"))
	{
		return 0;
	}
	return 1;
...
{
	request_anim_dict("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE");
	request_anim_dict("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE@BASE");
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38 == 1)
		{
			if (func_65(uParam0, &uLocal_10, 1) || func_66(Global_35, &(uParam0->f_20[0]), 1) <= 64f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (&uParam0->f_469[0])
	{
		...
		{
			set_ped_config_flag(&(uParam0->f_20[0]), 133, false);
			return 1;
		}
	}
	if (!&uParam0->f_469[0])
	{
		if (!&uParam0->f_469[1])
		{
			if ((!is_entity_dead(Global_35) && !is_entity_dead(&(uParam0->f_20[0]))) && !is_entity_dead(&(uParam0->f_372[0])))
			{
				if (func_73(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_70(uParam0);
								set_entity_no_collision_entity(&(uParam0->f_372[0]), &(uParam0->f_20[0]), false);
								set_entity_no_collision_entity(&(uParam0->f_20[0]), &(uParam0->f_372[0]), false);
								attach_entity_to_entity(&(uParam0->f_372[0]), &(uParam0->f_20[0]), get_ped_bone_index(&(uParam0->f_20[0]), 61276), vVar0, vVar3, true, false, false, false, 2, true, true, false);
			...
			if (!&uParam0->f_469[3])
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_is_anim_scene_finished(uParam0->f_3.f_1, false) || _is_anim_scene_active(uParam0->f_3.f_1))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									if (does_entity_exist(&(uParam0->f_372[0])))
									{
										delete_object(uParam0->f_372[0]);
									}
									func_75(uParam0->f_20[0]);
									uParam0->f_469[3] = 1;
									return 1;
								}
							}
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, var uParam7, int iParam8)
{
	...
	uParam0->f_372[iParam1]->f_6 = uParam7;
...
void func_71(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		set_ped_config_flag(&(uParam0->f_20[0]), 133, true);
		detach_entity(&(uParam0->f_372[0]), true, true);
...
bool func_74(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	if ((get_frame_count() % 8) == 0)
	{
		fParam2 = func_113(fParam2);
