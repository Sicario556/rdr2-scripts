...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "AS_ANIMAL", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.8f, 0f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 0, "AS_CORPSE", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		if (func_63(uParam0, &uLocal_16, 0) || func_64(&(uParam0->f_20[1]), Global_35, 1) < 225f)
		{
	...
	switch (iLocal_11)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				iLocal_44 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1f, 1, 36, 0);
				iLocal_45 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1.5f, 2, -1, 0);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_67(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[1]), iLocal_14, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
				func_65(uParam0->f_20[1], 0, 1);
		...
		case 1:
			...
			break;
		case 2:
			if (!_is_ped_using_scenario_hash(&(uParam0->f_20[1]), iLocal_14))
			{
				return 1;
			}
			break;
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_44 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_44, 1);
	}
	if (iLocal_45 != -1)
	{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_165(1) || *uParam0 & 8192 != 0))
				{
...
bool func_129(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_178(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_176(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_177(uParam2)
				{
					func_172(uParam2, 1);
					return true;
				}
...
bool func_130(int iParam0, var uParam1)
{
	...
	if (func_168(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_177(uParam1)
		{
...
int func_153(int iParam0, var uParam1)
{
	...
	{
		return func_202(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_155(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_203(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_203(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_203(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
