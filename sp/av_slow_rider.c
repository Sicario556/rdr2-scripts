void __EntryFunction__()
{
	...
	Var0 = Local_113;
	Var0.f_1 = Local_113.f_11;
	Var0.f_483 = { Local_113.f_1 };
	Var0.f_486 = { Local_113.f_4 };
	Var0.f_489 = Local_113.f_7;
	Var0.f_20[0] = Local_113.f_8;
	Var0.f_453 = Local_113.f_9;
	Var0.f_500 = Local_113.f_10;
	Var0.f_503 = Local_113.f_12;
	func_2(&Var0);
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	if (*uParam0 == 52)
	{
		...
		func_52(uParam0, 2, "RWP_HORSE_2", iVar2, _get_object_offset_from_coords(vParam1, fVar1, 0f, -4.5f, 0f), fVar1, iVar0, 1, 1, 1, 41788943, 1);
	}
	else
	{
		if (uParam0->f_489 == 1)
...
int func_19(var uParam0)
{
	if (*uParam0 == 52)
	{
		if (_is_metaped_outfit_request_valid(iLocal_112))
		{
			if (!_0x610438375e5d1801(iLocal_112))
			{
				return 0;
			}
		}
	...
	while (iVar12 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar12]->f_2 != 0)
		{
			...
			if (is_entity_dead(&(uParam0->f_20[iVar12])))
			{
				...
				{
					uParam0->f_20[iVar12] = func_59(uParam0->f_20[iVar12]->f_2, uParam0->f_20[iVar12]->f_5, uParam0->f_20[iVar12]->f_8, 1, 1, 0, 1, uParam0->f_20[iVar12]->f_11, uParam0->f_20[iVar12]->f_9, 0, 0, 0, 0);
				}
				...
				if (!is_ped_human(&(uParam0->f_20[iVar12])))
				{
					if (!func_60(&(uParam0->f_20[iVar12])))
					{
...
int func_32(var uParam0)
{
	if (*uParam0 == 52)
	{
		if (!is_entity_dead(&(uParam0->f_20[1])) && !is_entity_dead(&(uParam0->f_20[2])))
		{
			func_70(&(uParam0->f_20[1]), &(uParam0->f_20[2]), 0, 0, 1, 0, 1, 1, 0, 1, 1);
			func_71(&(uParam0->f_20[2]), &(uParam0->f_20[1]), 1, 0, 1, 0, 1, 1, 0, 1, 1);
			if (!bLocal_110)
			{
				if (_is_ped_lassoed(&(uParam0->f_20[2])))
				{
					task_combat_ped(&(uParam0->f_20[1]), Global_35, 0, 0);
					bLocal_110 = true;
					return 1;
				}
			}
	...
	switch (iLocal_9)
	{
		case 0:
			if (*uParam0 == 52)
			{
				if (!_0xa0bc8faed8cfeb3c(&(uParam0->f_20[2])))
				{
					return 0;
				}
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_75(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				func_76(&(uParam0->f_20[0]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
				...
				if (*uParam0 == 52)
				{
					...
					set_ambient_voice_name(&(uParam0->f_20[1]), "0192_A_M_M_HtlRoughTravellers_01_WHITE_01");
					_0x24c82ef607105faa(&(uParam0->f_20[1]), -920810745);
					func_78(&(uParam0->f_20[1]), &(uParam0->f_20[2]), &uLocal_38, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1f, 1092616192, -1, 1, 0, 0, 0, 1);
					_0xaac0ee3b4999abb5(&(uParam0->f_20[1]), 0);
				}
				_task_move_in_traffic(&(uParam0->f_20[1]), 0.101f, 132, 0);
				func_79(uParam0->f_20[1], 0, 1);
			...
			if (*uParam0 == 52)
			{
				if (!is_entity_dead(&(uParam0->f_20[2])))
				{
					...
					_0x34eddd59364ad74a(&(uParam0->f_20[2]), &uLocal_107);
					_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[2]), 5, 0, 1);
					_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[2]), 27, 0, 1);
					set_ped_config_flag(&(uParam0->f_20[2]), 388, true);
					set_ped_config_flag(&(uParam0->f_20[2]), 442, true);
					set_ped_config_flag(&(uParam0->f_20[2]), 136, true);
					set_ped_config_flag(&(uParam0->f_20[2]), 209, true);
					set_ped_config_flag(&(uParam0->f_20[2]), 214, true);
					set_ped_config_flag(&(uParam0->f_20[2]), 419, true);
					iLocal_111 = create_group(0);
					set_ped_as_group_leader(&(uParam0->f_20[1]), iLocal_111, false);
					set_ped_as_group_member(&(uParam0->f_20[2]), iLocal_111);
					_0xae6004120c18df97(&(uParam0->f_20[2]), 0, 0);
					if (!is_entity_dead(&(uParam0->f_20[2])))
					{
						_set_ped_body_component(&(uParam0->f_20[2]), iLocal_76);
						_update_ped_variation(&(uParam0->f_20[2]), false, true, true, true, false);
					}
					func_80(&(uParam0->f_20[2]), &(uParam0->f_20[1]), &uLocal_38, -1082130432, 0, 0, -1082130432, 1f, 1, 32, 0, -4.5f, 4.5f, 1073741824, 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
				}
			}
			iLocal_9 = 1;
			break;
...
int func_33(var uParam0, var uParam1)
{
	if (*uParam0 == 52)
	{
		if (!(is_entity_dead(&(uParam0->f_20[1])) || is_entity_dead(&(uParam0->f_20[2]))))
		{
			func_82(&(uParam0->f_20[1]), 1);
			func_83(&(uParam0->f_20[2]), 1);
		}
		if (_is_metaped_outfit_request_valid(iLocal_112))
		{
			_release_metaped_outfit_request(iLocal_112);
		}
	}
...
void func_53(var uParam0)
{
	...
	iLocal_112 = _request_metaped_outfit(iLocal_78, iLocal_76);
}
...
bool func_54(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_101(&(Global_1898164->f_1[0]));
		if (func_102(iVar0) && func_103((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_104(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_72(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (!_0x331550b212014b92(&(uParam0->f_20[1]), 0) && func_114(&(uParam0->f_20[1]), Global_35, 1) > 225f)
		{
			if (!func_115(&uLocal_104))
			{
				if (bLocal_109)
				{
					vVar0 = { get_random_float_in_range(-15f, -5f), get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f) };
				}
				else
				{
					vVar0 = { get_random_float_in_range(5f, 15f), get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f) };
				}
				Local_79 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[1]), vVar0) };
				Local_79.f_7 = 0;
				bLocal_109 = !bLocal_109;
				func_116(&uLocal_104, get_random_float_in_range(0f, 4.5f));
			}
			if (func_117(&uLocal_104, 15f))
			{
				func_118(&uLocal_104);
			}
			_0x66f9eb44342bb4c5(&(uParam0->f_20[1]), &Local_79);
		}
	}
}
...
bool func_73(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_119(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
void func_76(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_123(Global_35) && is_player_teleport_active())
	{
	}
	if (func_124(iParam0))
	{
		if (func_125(get_ped_index_from_entity_index(iParam0)))
		{
...
void func_78(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	...
	if (!is_string_null_or_empty(sParam6))
	{
		...
		Var0.f_7 = iParam16;
		Var0.f_9 = iParam17;
		task_lead_and_converse(iParam0, iParam1, &Var0, iParam8, iParam9, iParam10, iParam11, iParam13, fParam12);
	}
	else if (!func_122(vParam3, 0f, 0f, 0f))
	{
		...
		Var11.f_9 = iParam17;
		Var11.f_8 = iParam18;
		task_lead_and_converse(iParam0, iParam1, &Var11, iParam8, iParam9, iParam10, iParam11, iParam13, fParam12);
	}
	if (bParam15)
	{
		_set_ped_crouch_movement(iParam0, false, 0, false);
...
void func_80(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, bool bParam8, int iParam9, int iParam10, float fParam11, float fParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	...
	{
		task_follow_and_converse_with_ped(iParam0, iParam1, iParam4, iParam5, iParam6, fParam7, iParam9, iParam10, fParam11, fParam12, iParam13);
	}
	if (bParam19)
	{
		_set_ped_crouch_movement(iParam0, false, 0, false);
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_114(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_88(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_134(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_89(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_135(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
float func_114(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_150(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_186(int iParam0)
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_234(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_234(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_234(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_187(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_241(iVar0, 0)))
		{
...
bool func_209(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_241(iVar0, 0)))
		{
			if (func_243(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_242(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_243(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
