			...
			switch (iVar401)
			{
				...
				case 1:
					if (func_13(&Local_33, &vScriptParam_0, 0, 0, 0, 1, 0, 1))
					{
						...
						func_17(&uLocal_427, Local_33.f_51, 1.5f, 0, 0);
				...
				case 3:
					...
					{
						func_20();
						if (does_entity_exist(Local_324[0]->f_8))
						{
							_mark_object_for_deletion(Local_324[0]->f_8);
							func_21(Local_324[0]->f_8, &Local_33, 0);
							iLocal_439[0] = _create_volume_box(Local_33.f_51, 0f, 0f, 0f, 3f, 1f, 0.75f);
							_0x19c7567d2f2287d6(&(iLocal_439[0]), 7);
							_0x7c00cfc48a782dc0(&(iLocal_439[0]), Local_324[0]->f_8, 0f, 0f, 3.21f, 0f, 0f, 0f, 2, 1);
							iLocal_439[1] = _create_volume_box(Local_33.f_51, 0f, 0f, 0f, 1f, 5f, 0.75f);
							_0x19c7567d2f2287d6(&(iLocal_439[1]), 7);
							_0x7c00cfc48a782dc0(&(iLocal_439[1]), Local_324[0]->f_8, 0f, 0f, 2.25f, -90f, 0f, 0f, 2, 1);
						}
						func_22();
						func_23();
						func_24();
				...
				case 4:
					...
					if (!Local_33.f_46)
					{
						if (func_26())
						{
							iLocal_443[0] = add_shocking_event_for_entity(-1227782948, &(uLocal_404[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
							iLocal_443[1] = add_shocking_event_for_entity(-1227782948, &(uLocal_404[1]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
							iLocal_443[2] = add_shocking_event_for_entity(-1227782948, &(uLocal_404[2]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
...
void func_10()
{
	...
	if (!func_38(iVar420, 1))
	{
		Local_33.f_45 = 0;
		func_39(&Local_33);
	}
	if (does_entity_exist(&(uLocal_404[0])))
	{
		...
		{
			if (is_entity_attached(&(uLocal_404[0])))
			{
				detach_entity(&(uLocal_404[0]), true, true);
			}
		}
	}
	...
	if (!Local_33.f_48)
	{
		...
		{
			delete_vehicle(&iLocal_438);
		}
		if (_does_anim_scene_exist(iVar362))
		{
			_delete_anim_scene(iVar362);
		}
	...
	if (does_entity_exist(iVar436))
	{
		set_vehicle_as_no_longer_needed(&iLocal_438);
	}
	func_50(&Local_33, &uLocal_404, &uLocal_408, 0, uVar462, uVar461, 0, 1, 0, 1);
	if (_does_volume_exist(&(iLocal_439[0])))
	{
		_delete_volume(&(iLocal_439[0]));
	}
	if (_does_volume_exist(&(iLocal_439[1])))
	{
		_delete_volume(&(iLocal_439[1]));
	}
	func_52(func_51(0), 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
	func_53(func_51(0), 0);
	remove_shocking_event(&(iLocal_443[0]));
	remove_shocking_event(&(iLocal_443[1]));
	remove_shocking_event(&(iLocal_443[2]));
	...
	switch (iVar399)
	{
		case 0:
			if (func_55(&Local_33))
			{
				...
				func_62();
				func_63(&Local_324);
				_request_scenario_type(iVar464, 4194304, 0, 0);
				_request_scenario_type(iVar463, 15, 0, 0);
				iLocal_401 = 1;
			}
			break;
		case 1:
			...
			if (!_has_scenario_type_loaded(iVar464, false))
			{
				return false;
			}
			if (!_has_scenario_type_loaded(iVar463, false))
			{
				return false;
			}
			return true;
...
bool func_19()
{
	switch (iVar427)
	{
		...
		case 1:
			...
			set_entity_rotation(Local_324[0]->f_8, 85f, 0f, 0f, 2, true);
			func_82();
			iLocal_429 = 6;
			break;
		case 6:
...
void func_20()
{
	...
	while (iVar0 <= 2)
	{
		if (Local_227[iVar0]->f_1 != 0)
		{
			remove_all_ped_weapons(&(uLocal_404[iVar0]), true, true);
			set_ped_relationship_group_hash(&(uLocal_404[iVar0]), 1222652248);
			set_ped_config_flag(&(uLocal_404[iVar0]), 6, false);
			set_ped_config_flag(&(uLocal_404[iVar0]), 494, true);
			func_83(&(Local_33.f_5), &(uLocal_404[iVar0]), 0);
			func_84(&(uLocal_404[iVar0]), 0);
			func_85(&(uLocal_404[iVar0]), &(Local_227[iVar0]->f_23), 0);
			if (func_86())
			{
			...
			{
				_0xae6004120c18df97(&(uLocal_404[iVar0]), 0, 0);
				_0x18ff3110cf47115d(&(uLocal_404[iVar0]), 7, 0);
				func_90(&(uLocal_404[iVar0]), 1);
			}
		}
		if (func_41(&(uLocal_404[iVar0]), 0, 1))
		{
			set_ped_firing_pattern(&(uLocal_404[iVar0]), -687903391);
		}
		iVar0++;
	}
	if (func_41(Local_227[1]->f_11, 0, 1))
	{
		func_84(Local_227[1]->f_11, 0);
		_set_entity_coords_and_heading(Local_227[1]->f_11, vLocal_29, fLocal_32, true, false, true);
		func_91(&(Local_33.f_5), Local_227[1]->f_11, 0);
	}
}

int func_21(int iParam0, var uParam1, bool bParam2)
{
...
void func_22()
{
	Local_364 = _create_anim_scene(Local_364.f_4, 64, "pblDialogue", false, true);
	set_anim_scene_origin(iVar362, Local_33.f_51, 0f, 0f, Local_33.f_51.f_3, 2);
	set_anim_scene_entity(iVar362, "objCross", Local_324[0]->f_8, 0);
	set_anim_scene_entity(iVar362, "pedRallyA", &(uLocal_404[0]), 0);
	set_anim_scene_entity(iVar362, "pedRallyB", &(uLocal_404[2]), 0);
	set_anim_scene_entity(iVar362, "pedRallyLeader", &(uLocal_404[1]), 0);
	load_anim_scene(iVar362);
}
...
void func_23()
{
	if (func_93(vLocal_435))
	{
		if (does_entity_exist(iVar436))
		{
			vVar0 = { _get_object_offset_from_coords(vLocal_25, fLocal_28, 1.7f, -0.75f, 0f) };
			func_94(&vVar0, 2f);
			vLocal_435 = { vVar0 };
		}
	}
...
void func_24()
{
	func_95(&uLocal_428, vLocal_435, 1f);
}
...
bool func_26()
{
	if (func_105(&uLocal_404, &(Local_33.f_5), &uLocal_425, &uLocal_447, 0, 2, 1))
	{
		return true;
	}
	if (func_38(iVar420, 512))
	{
		return true;
	}
	if (func_38(iVar634, 16))
	{
		return true;
	}
	if (func_38(iVar634, 64))
	{
		return true;
	}
	if (iVar400 > 0)
	{
		...
		{
			if (is_entity_touching_entity(Global_35, Local_324[0]->f_8))
			{
				func_106(&uLocal_422, 32768);
				return true;
			}
...
bool func_28()
{
	...
	{
		case 0:
			if (_is_anim_scene_loaded(iVar362, true, false))
			{
				if (_0x23e33cb9f4a3f547(iVar362, "pblDialogue") && _0x23e33cb9f4a3f547(iVar362, "pblAction"))
				{
					start_anim_scene(iVar362);
					_set_anim_scene_playback_list_bool(iVar362, "pblDialogue", true);
					task_start_scenario_at_position(Local_227[1]->f_11, iVar464, vLocal_29, fLocal_32, -1, false, true, 0, -1f, false);
					request_collision_at_coord(Local_33.f_51);
					iLocal_402 = 1;
				}
				else
				{
					_0xdf7b5144e25cd3fe(iVar362, "pblDialogue");
					_0xdf7b5144e25cd3fe(iVar362, "pblAction");
				}
			}
			break;
		case 1:
		...
		case 2:
			if (func_111(&Local_33, 3f, (80f - 5f), (55f - 5f), 1, 0, 1, -1082130432, 1, 1125515264, 0, 0))
			{
				...
				{
					if (func_38(iVar420, 32) || func_112(1) == 0)
					{
						if (_get_entity_anim_current_time(&(uLocal_404[1]), &(Local_361[0]), "dialogue01_leader") < 0.4f)
						{
							set_anim_scene_bool(iVar362, "bAction", true, false);
							iLocal_402 = 3;
						}
					}
				}
		...
		case 3:
			func_118();
			func_119();
			if ((!_is_anim_scene_started(iVar362, false) || (_is_anim_scene_started(iVar362, false) && _0x005e6f28dd7ed58d(iVar362, "pedRallyLeader"))) || func_120())
			{
				if (!func_38(iVar420, 32768))
				{
					_0x923583741dc87bce(&(uLocal_404[1]), "Rally");
					_0x89f5e7adecccb49c(&(uLocal_404[1]), "Rally_Sad");
					func_106(&uLocal_422, 1024);
					if (func_120() && !func_38(iVar634, 128))
					{
						func_121(1);
					}
					else
					{
						if (_0x3ab6c7b0bb0df4b1(&(uLocal_404[1]), -1))
						{
							remove_anim_scene_entity(iVar362, "pedRallyLeader", &(uLocal_404[1]));
							func_122(iVar362);
							clear_ped_tasks(&(uLocal_404[1]), 1, 0);
						}
						func_121(0);
					}
		...
		case 4:
			...
			if (func_38(iVar420, 1024))
			{
				set_ped_max_move_blend_ratio(&(uLocal_404[1]), 1f);
			}
			if (!func_38(iVar420, 4))
			{
				if (func_125() && !is_scripted_speech_playing(&(uLocal_404[1])))
				{
					_0x66f9eb44342bb4c5(&(uLocal_404[1]), &Local_372);
					func_114(&(uLocal_404[1]), Global_35, "RE_KS_UNI_V1_HANG_OUT", 0, -1082130432, 0, 0, 0, 1, 1, 0, 291934926, 1, 0, 0);
					func_106(&uLocal_422, 4);
					fLocal_423 = 9f;
				}
			}
			else if (!func_38(iVar420, 16384))
			{
				if (!_is_anim_scene_started(iVar362, false) || (_is_anim_scene_started(iVar362, false) && _0x005e6f28dd7ed58d(iVar362, "pedRallyLeader")))
				{
					func_121(0);
				}
			}
			else if (func_126())
			{
				...
				task_smart_flee_ped(&(uLocal_404[1]), Global_35, 1000f, -1, 256, 3f, 0);
				set_ped_keep_task(&(uLocal_404[1]), true);
				func_106(&uLocal_422, 1048576);
				iLocal_402 = 7;
			}
			if (func_44(Global_35, Local_33.f_51, 1) > 150f && func_127(Global_35, &(uLocal_404[1]), 1, 1) < 50f)
			{
				...
				{
					set_blocking_of_non_temporary_events(&(uLocal_404[1]), false);
				}
				iLocal_402 = 7;
			}
			break;
		case 5:
			...
			else
			{
				...
				stop_current_playing_speech(&(uLocal_404[1]), 0);
				if (!func_38(iVar420, 1048576))
				{
		...
		case 6:
			func_135();
			if (func_38(iVar420, 1048576) && !func_38(iVar420, 2097152))
			{
				if (does_blip_exist(&(uLocal_408[1])))
				{
					func_123(uLocal_408[1]);
					func_106(&uLocal_422, 2097152);
				}
			}
			if (func_131())
			{
			...
			if (!func_38(iVar420, 4096))
			{
				if (((((iVar423 == 8192 || iVar423 == 2048) || iVar423 == 1024) || func_38(iVar420, 32768)) || func_38(iVar634, 16)) || func_38(iVar634, 64))
				{
					func_106(&uLocal_422, 256);
					if (func_136(0, 1))
					{
						if (iVar423 == 8192)
						{
						...
						func_137(&(Local_227[1]->f_11), 0, 1, 0);
						func_106(&uLocal_422, 4096);
					}
				}
			...
			if (func_138(&uLocal_451) > fVar422 && func_38(iVar420, 4096))
			{
				if (func_38(iVar634, 16))
				{
					func_139();
		...
		case 7:
			...
			if (!_is_anim_scene_started(iVar362, false) && func_127(Global_35, &(uLocal_404[1]), 1, 1) > 50f)
			{
				return true;
			}
			break;
...
void func_35(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!bParam1)
	{
...
void func_43()
{
	...
	while (iVar0 < 3)
	{
		if (does_entity_exist(Local_324[iVar0]->f_8))
		{
			delete_object(&(Local_324[iVar0]->f_8));
		}
		iVar0++;
	}
}
...
void func_46(var uParam0, bool bParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (does_entity_exist(uParam0[iVar0]) && func_41(uParam0[iVar0], 0, 1))
		{
...
void func_47(bool bParam0)
{
	...
	while (iVar0 < 3)
	{
		if (does_entity_exist(Local_227[iVar0]->f_11))
		{
			_0x0348469daa17576c(Local_227[iVar0]->f_11);
			task_smart_flee_ped(Local_227[iVar0]->f_11, Global_35, 500f, -1, 256, 3f, 0);
			if (bParam0)
			{
				set_ped_keep_task(Local_227[iVar0]->f_11, true);
			}
			_0x39a2fc5af55a52b1(&(uLocal_404[iVar0]), -1);
			set_ped_as_no_longer_needed(uLocal_404[iVar0]);
		}
		iVar0++;
	}
}
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_161(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
...
void func_52(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (!func_173(iParam0))
	{
		return;
	...
	else
	{
		...
		if (fParam4 > 0f)
		{
			...
			func_176(&((*Global_1360165)[iParam0]->f_130), 1);
		}
		else
		{
			func_187(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
int func_53(int iParam0, bool bParam1)
{
	...
	{
		_0x0de02da3c0f66955(func_196(iParam0), _0xb7e0590c86e1711f(get_player_group(get_player_index())));
		_0x61bda07407754a5c(func_196(iParam0), Global_1391438->f_414.f_37);
	}
	_0x89e59dbd15e21177(func_197(), 0);
	func_198(iParam0);
...
void func_56()
{
	Local_227[0]->f_1 = 969427509;
	StringCopy(&(Local_227[0]->f_23), "0060_A_M_M_BlWTownfolk_01_WHITE_01", 64);
	Local_227[0]->f_3 = -552778627;
	func_203(&(Local_227[0]->f_22));
	func_204(&(Local_227[0]->f_22));
	Local_227[1]->f_1 = 969427509;
	StringCopy(&(Local_227[1]->f_23), "RALLY_LEADER", 64);
	Local_227[1]->f_3 = 1455264691;
	Local_227[1]->f_12 = func_205(997958153, 1);
	Local_227[1]->f_15 = { -6.35f, -0.3f, 0f };
	Local_227[1]->f_18 = 114.5f;
	Local_227[1]->f_13 = 0;
	func_203(&(Local_227[1]->f_22));
	func_204(&(Local_227[1]->f_22));
	Local_227[2]->f_1 = 969427509;
	StringCopy(&(Local_227[2]->f_23), "0903_A_M_M_Civ_Poor_White_AGGRESSIVE_03", 64);
	Local_227[2]->f_3 = -1991993107;
	func_203(&(Local_227[2]->f_22));
	func_204(&(Local_227[2]->f_22));
}

void func_57()
{
	Local_227[0]->f_6 = { 0.2f, 2.15f, -0.06f };
	Local_227[0]->f_9 = 180f;
	Local_227[1]->f_6 = { 2.044f, 1.981f, 1f };
	Local_227[1]->f_9 = 128f;
	Local_227[2]->f_6 = { 2.13f, 0.01f, 0.04f };
	Local_227[2]->f_9 = 36.618f;
}

void func_58()
{
	Local_361[0] = "script_re@rally@cross_accident";
	func_206(&(Local_361[0]), &uLocal_16);
}
...
void func_61()
{
	Local_324[0]->f_7 = -1958916332;
	*Local_324[0] = { 0.25f, -1.85f, -0.25f };
	Local_324[0]->f_10 = 0;
	Local_324[1]->f_7 = 1935100224;
	*Local_324[1] = { -1.25f, 1.8f, 0f };
	Local_324[2]->f_7 = -1953196257;
	*Local_324[2] = { 1.6f, -1.4f, 0f };
}
...
int func_68(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		case 0:
			...
			{
				func_212(iParam0, &uVar1, &uVar2, &iVar0, 0);
				bVar4 = false;
				*uParam1 = { func_213(&bVar4, iParam0, uVar2, uVar1) };
				if (bVar4)
				{
					*uParam11 = 1;
					return 0;
...
float func_73(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
void func_74(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!func_153(uParam0))
	{
...
void func_75(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_227());
	}
}
...
void func_77(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_227());
	}
}
...
bool func_79(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_228() || !func_229((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
{
	func_230();
	iLocal_438 = create_vehicle(iLocal_14, vLocal_25, fLocal_28, true, true, true, false);
	set_vehicle_on_ground_properly(iVar436, 0f);
	_0xc399cc89fba05da0(iVar436, 1);
	func_231(iVar436);
}
		...
		else if ((*iParam3)[iVar0]->f_7 != 0 && !func_38((*iParam3)[iVar0]->f_11, 16))
		{
			...
			else
			{
				...
				else
				{
					...
					{
						func_232(&vVar5, (*iParam3)[iVar0]->f_10);
					}
					if (func_38((*iParam3)[iVar0]->f_11, 64))
					{
						(*iParam3)[iVar0]->f_8 = create_object_no_offset((*iParam3)[iVar0]->f_7, vVar5, true, true, false, false);
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
...
void func_95(var uParam0, vector3 vParam1, float fParam4)
{
	iVar0 = 258;
	func_74(uParam0, vParam1, fParam4, 2, iVar0, 0);
}
...
void func_100(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_161(uParam0->f_3));
...
void func_104(var uParam0, int iParam1)
{
	if (func_266(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_227());
		bVar1 = func_166(!func_70(uParam0->f_3, 1), 20f, -1f);
		uParam0->f_51.f_11 = func_270(iVar2, func_269(uParam0->f_3), 1, iParam1, 8, 0, bVar1);
	}
}
...
void func_107()
{
	...
	if (does_entity_exist(iVar436))
	{
		if (is_ped_in_vehicle(Global_35, iVar436, false))
		{
			func_106(&uLocal_422, 512);
		}
	}
}
...
{
	if (iVar397 <= 0 || func_38(iVar631, iParam2))
	{
		return;
	}
	if (&iLocal_641[iParam0] > 0)
	{
		...
		{
			if (!func_38(iVar631, iParam2))
			{
				if (!func_274(&uLocal_397))
				{
					func_116(&uLocal_397);
				}
				else if ((func_138(&uLocal_397) > 4f || is_ped_in_combat(Global_35, 0)) || is_ped_in_combat(&(uLocal_404[iParam0]), Global_35))
				{
					func_275(Local_467[iParam0], uParam1);
					func_106(&uLocal_636, iParam2);
				}
			}
			return;
		}
	...
	if (&iLocal_641[iParam0] > 0)
	{
		if (func_38(iVar417, 1))
		{
			iLocal_637[iParam0] = func_277(uLocal_404[iParam0], Local_467[iParam0], 20f, uParam1, &(Local_33.f_192), 0, 1, 0, "", func_276(3, 0, 0), 0, 0, 2, 1, -1082130432, 0);
		}
		else
		{
			iLocal_637[iParam0] = func_277(uLocal_404[iParam0], Local_467[iParam0], 35f, uParam1, &(Local_33.f_192), 0, 1, 0, "", func_276(3, 0, 0), 0, 0, 2, 1, -1082130432, 0);
		}
	}
	switch (&iLocal_641[iParam0])
	{
		case 0:
			func_279((*uParam1)[0], func_278(7), "", -163964935, 0, 0, 0, 1, 0);
			func_279((*uParam1)[1], func_278(10), "", 648122183, 0, 0, 0, 1, 0);
			func_280((*uParam1)[0], 1, 0);
			func_280((*uParam1)[1], 1, 0);
			iLocal_641[iParam0] = 1;
			break;
		case 1:
			if (func_38(iVar417, 1) || func_38(iVar631, 8))
			{
				if (iParam0 == 0 || iParam0 == 2)
				{
					func_280((*uParam1)[0], 0, 0);
					func_280((*uParam1)[1], 0, 0);
					iLocal_641[iParam0] = 2;
				}
				else
				{
					func_280((*uParam1)[0], 0, 0);
					func_281((*uParam1)[0], 0, 1065353216);
					func_281((*uParam1)[1], 0, 1065353216);
			...
			break;
		case 2:
			if (!func_38(iVar631, 16))
			{
				if (func_38(iVar631, 8))
				{
					if (func_138(&uLocal_457) > 1f)
					{
						func_106(&uLocal_636, 16);
					}
				}
			}
			if (func_38(iVar417, 1))
...
void func_109(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		if ((!bParam2 && !func_282(0)) || (get_game_timer() - iParam0->f_7) > 3500)
		{
...
void func_110()
{
	if (func_41(&(uLocal_404[2]), 0, 1))
	{
		if (has_anim_event_fired(&(uLocal_404[2]), -474540600) || is_ped_ragdoll(&(uLocal_404[2])))
		{
			func_283(&(uLocal_404[2]), 0, 0);
			remove_anim_scene_entity(iVar362, "pedRallyB", &(uLocal_404[2]));
		}
	}
	if (func_41(&(uLocal_404[0]), 0, 1))
	{
		if (has_anim_event_fired(&(uLocal_404[0]), -474540600) || is_ped_ragdoll(&(uLocal_404[0])))
		{
			stop_current_playing_speech(&(uLocal_404[1]), 0);
			func_283(&(uLocal_404[0]), 0, 0);
			remove_anim_scene_entity(iVar362, "pedRallyA", &(uLocal_404[0]));
		}
	}
}
...
bool func_111(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		...
		if (func_248(&(uParam0->f_121), iParam4, fParam1))
		{
			...
			if (uParam0->f_186)
			{
				_0xb2a38826e5886e83(func_170(uParam0->f_3, uParam0->f_185), 0);
			}
			return true;
		}
	}
...
int func_112(bool bParam0)
{
	...
	get_group_size(func_197(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_197(), iVar3);
		if (func_285(iVar4))
		{
			iVar0++;
		}
...
bool func_114(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_286(iParam0, iParam1, sParam2, sParam3, fParam4, iParam5, bParam6, bParam7, iParam8, bParam9, bParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
bool func_117(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_118()
{
	if (has_anim_event_fired(&(uLocal_404[1]), 1384389773))
	{
		func_113(1891783641, Local_33.f_51, 1);
	}
	if (!func_38(iVar420, 8))
	{
		if (is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "sobbing_idle_a_leader", 1))
		{
			func_114(&(uLocal_404[1]), &(uLocal_404[1]), "RE_KS_UNI_V1_SOBBING", 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			func_106(&uLocal_422, 8);
		}
	}
}
...
void func_119()
{
	if (!func_38(iVar420, 1))
	{
		if (_0x23e33cb9f4a3f547(iVar362, "pblAction"))
		{
			if (is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "action_exit_leader", 1))
			{
				func_106(&uLocal_422, 1);
				func_290();
				Local_33.f_44 = 1;
			}
			if (!func_41(&(uLocal_404[1]), 0, 1))
			...
			if (((is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "dialogue01_leader", 1) || is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "dialogue02_leader", 1)) || is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "dialogue03_leader", 1)) || is_entity_playing_anim(&(uLocal_404[1]), &(Local_361[0]), "dialogue04_leader", 1))
			{
				if (func_291(5f))
				{
					_set_anim_scene_playback_list_bool(iVar362, "pblAction", true);
				}
			}
		}
		else
...
bool func_120()
{
	...
	{
		if (((has_anim_event_fired(&(uLocal_404[1]), 596390595) || has_anim_event_fired(&(uLocal_404[1]), 247110940)) || has_anim_event_fired(&(uLocal_404[1]), -676255205)) || func_38(iVar420, 32768))
		{
			if (has_anim_event_fired(&(uLocal_404[1]), 247110940))
			{
			}
			else if (has_anim_event_fired(&(uLocal_404[1]), -676255205))
			{
			}
			return true;
		}
...
void func_121(bool bParam0)
{
	...
	if (bParam0)
	{
		if (_0x3ab6c7b0bb0df4b1(&(uLocal_404[1]), -1))
		{
			remove_anim_scene_entity(iVar361, "pedRallyLeader", &(uLocal_404[1]));
		}
		else
		{
			clear_ped_tasks(&(uLocal_404[1]), 1, 0);
		...
		_0x66f9eb44342bb4c5(&(uLocal_404[1]), &Local_372);
		func_106(&uLocal_422, 8192);
	}
	open_sequence_task(&iVar0);
	if (bParam0)
	{
		task_play_upper_anim_facing_entity(0, &(Local_361[0]), "breakout_stand_front_leader", Global_35, 6000, 4f, -4f, 67108880, 0f, false, false, -1f, 0, 0, -1f);
	}
	if (!func_93(vLocal_435))
	{
		task_follow_nav_mesh_to_coord(0, vLocal_435, 1f, -1, 2f, 0, (fLocal_28 - 90f));
		_task_start_scenario_in_place(0, iVar462, -1, true, 0, -1f, false);
	}
	else
	{
...
bool func_125()
{
	if (func_38(iVar634, 128))
	{
		return false;
	}
	if (func_38(iVar420, 8192))
	{
		if (has_anim_event_fired(&(uLocal_404[1]), -1318650840))
		{
			return true;
		}
	}
...
bool func_126()
{
	if (&Local_33.f_98[1] < 5f)
	{
		...
		{
			if (is_ped_using_any_scenario(&(uLocal_404[1])))
			{
				func_116(&uLocal_454);
			}
		}
		else if (func_138(&uLocal_454) > fVar421 && _0x7f9b9791d4cb71f6(&(uLocal_404[1]), Global_35, false, 0) == 1)
		{
			if (is_ped_using_any_scenario(&(uLocal_404[1])))
			{
				if (_0xeeed8fafec331a70(&(uLocal_404[1]), Global_36, 2))
				{
					return true;
				}
			}
...
void func_128()
{
	if ((does_entity_exist(iVar436) && !is_entity_dead(iVar436)) && !func_38(iVar420, 16384))
	{
		iVar0 = 0;
		while (iVar0 < 6)
		{
			iVar1 = _get_ped_in_draft_seat(iVar436, iVar0);
			if (does_entity_exist(iVar1))
			{
				task_smart_flee_coord(iVar1, Local_33.f_51, 50f, -1, false, 2f);
			}
			iVar0++;
		}
	}
...
bool func_131()
{
	if (Local_33.f_46)
	{
		if (func_38(iVar420, 65536))
		{
			return true;
		}
		if (!func_38(iVar420, 131072))
		{
			if ((!func_41(&(uLocal_404[2]), 0, 1) || is_ped_ragdoll(&(uLocal_404[2]))) || has_entity_been_damaged_by_entity(&(uLocal_404[2]), Global_35, 1, 1))
			{
				func_106(&uLocal_422, 65536);
				return true;
			}
		}
	}
...
void func_132()
{
	if (!func_38(iVar420, 131072))
	{
		if (does_entity_exist(Local_324[0]->f_8))
		{
			if (_is_anim_scene_started(iVar362, false) && _0x3ab6c7b0bb0df4b1(Local_324[0]->f_8, -1))
			{
				remove_anim_scene_entity(iVar362, "objCross", Local_324[0]->f_8);
				if (func_41(&(uLocal_404[0]), 0, 1))
				{
					remove_anim_scene_entity(iVar362, "pedRallyA", &(uLocal_404[0]));
				}
				...
				while (iVar0 < 3)
				{
					if (iVar0 != 1)
					{
						if (func_41(&(uLocal_404[iVar0]), 0, 1))
						{
							if (!is_ped_ragdoll(&(uLocal_404[iVar0])) && !has_entity_been_damaged_by_entity(&(uLocal_404[iVar0]), Global_35, 1, 1))
							{
								set_ped_to_ragdoll_with_fall(&(uLocal_404[iVar0]), 2000, 2000, 2, get_entity_forward_vector(&(uLocal_404[iVar0])), Local_33.f_51.f_2, 0f, 0f, 0f, 0f, 0f, 0f);
				...
				func_290();
				activate_physics(Local_324[0]->f_8);
				func_106(&uLocal_422, 131072);
			}
		}
	}
}
...
bool func_136(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		if (is_ped_using_any_scenario(&(uLocal_404[1])))
		{
			if (_0xeeed8fafec331a70(&(uLocal_404[1]), Global_36, 3))
			{
				open_sequence_task(&iVar0);
				task_smart_flee_ped(0, Global_35, 1000f, -1, 0, 3f, 0);
				func_293(&(uLocal_404[1]), &iVar0, 0, 0, 1, 1);
		...
		{
			open_sequence_task(&iVar0);
			task_react(0, Global_35, Global_36, "TaskCombat_Panic", 1.75f, 0, 4);
			task_smart_flee_ped(0, Global_35, 1000f, -1, 0, 3f, 0);
			func_293(&(uLocal_404[1]), &iVar0, 0, 0, 1, 1);
			func_106(&uLocal_422, 1048576);
			return true;
	...
	{
		open_sequence_task(&iVar0);
		if (func_38(iVar632, 16))
		{
			task_react(0, Global_35, Global_36, "Default_Shocked", 1.5f, 0, 4);
			task_react(0, &(uLocal_404[2]), get_entity_coords(&(uLocal_404[2]), false, false), "TaskCombat_Panic", 1.5f, 0, 4);
		}
		else if (func_38(iVar632, 64))
		{
			task_react(0, Global_35, Global_36, "Default_Shocked", 1.5f, 0, 4);
		}
		if (iVar421 != 1024)
		{
			set_ped_combat_attributes(&(uLocal_404[1]), 92, true);
...
void func_139()
{
	if (func_38(iVar420, 262144) || !func_41(&(uLocal_404[1]), 0, 1))
	{
		return;
	}
	if (func_38(iVar634, 16))
...
void func_140()
{
	if (func_38(iVar420, 524288))
	{
		return;
	}
	if (func_41(&(uLocal_404[1]), 0, 1) && func_117(0, 1, &(uLocal_404[1]), 1))
	{
		if (func_38(iVar420, 256))
		{
			if (func_38(iVar634, 64) || iVar423 == 1024)
			{
...
void func_142(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	if (func_296() != -1)
	{
		return;
	}
	if ((Global_36616 && func_234(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_303(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
...
void func_143()
{
	if (func_41(&(uLocal_404[0]), 0, 1))
	{
		if (!func_38(iVar420, 2048))
		{
			if (func_138(&uLocal_451) > 0.25f)
			{
				func_305(&(uLocal_404[0]), "SCREAM_SHOCKED", -1454469014, 0, 1, 0, 0, 1);
				func_106(&uLocal_422, 2048);
			}
		}
	}
	if (func_41(&(uLocal_404[2]), 0, 1))
	{
		if (!func_38(iVar420, 128))
		{
			if (func_138(&uLocal_451) > 0.75f)
			{
				func_305(&(uLocal_404[2]), "SCREAM_SHOCKED", -1454469014, 0, 1, 0, 0, 1);
				func_106(&uLocal_422, 128);
			}
		}
	}
}

void func_144(var uParam0, var uParam1, float fParam2, int iParam3, bool bParam4)
{
	iVar0 = 0;
	while (iVar0 < *uParam0)
	{
		func_306(uParam0[iVar0], uParam1[iVar0], fParam2, iParam3, bParam4);
		iVar0++;
	}
}
...
void func_145()
{
	...
	if (!func_38(iVar420, 8388608))
	{
		if (func_41(&(uLocal_404[2]), 0, 1))
		{
			if ((get_script_task_status(&(uLocal_404[2]), 1435919172, true) != 1 && !is_ped_ragdoll(&(uLocal_404[2]))) && !_0x3ab6c7b0bb0df4b1(&(uLocal_404[2]), -1))
			{
				func_90(&(uLocal_404[2]), 1);
				task_combat_ped(&(uLocal_404[2]), Global_35, 0, 0);
				func_106(&uLocal_422, 8388608);
			}
		}
	}
	if (!func_38(iVar420, 4194304))
	{
		if (func_41(&(uLocal_404[0]), 0, 1))
		{
			if ((get_script_task_status(&(uLocal_404[0]), 1435919172, true) != 1 && !is_ped_ragdoll(&(uLocal_404[0]))) && !_0x3ab6c7b0bb0df4b1(&(uLocal_404[0]), -1))
			{
				func_90(&(uLocal_404[0]), 1);
				task_combat_ped(&(uLocal_404[0]), Global_35, 0, 0);
				func_106(&uLocal_422, 4194304);
			}
		}
	}
}
...
char* func_150(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_310(sParam1));
}
...
void func_152(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
int func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_317(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_167(int iParam0, float fParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_41(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			clear_ped_secondary_task(iParam0);
			fVar2 = func_166(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
void func_184(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_196(iParam0), 137, true);
	}
}
...
void func_186(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_196(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_196(iParam0), 204, false);
	}
}
...
bool func_192(int iParam0, bool bParam1)
{
	...
	return is_ped_group_member(iVar0, func_197(), 1);
}
...
{
	iVar0 = func_196(iParam0);
	if (!func_173(iParam0) || is_entity_dead(iVar0))
	{
		return;
	}
...
void func_198(int iParam0)
{
	if (func_173(iParam0))
	{
		...
		_0xdeb369f6ad168c58(func_196(iParam0), iVar0);
		_0x1740e3dee0ae4d27(func_196(iParam0), iVar1);
	}
}
...
void func_207(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_342(&((*uParam0)[iVar0]->f_1));
		func_342(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
void func_210(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_227());
		if (func_349(Global_1310750[iParam0], 33554432))
		{
...
bool func_211(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_352(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_99(iParam0, 16))
	{
		...
		fVar2 = to_float(func_353(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
void func_212(int iParam0, float fParam1, float fParam2, int iParam3, bool bParam4)
{
	switch (func_354(iParam0))
	{
		...
		case 1:
			...
			*iParam3 = (*iParam3 * *iParam3);
			break;
		case 2:
			func_356(fParam1, fParam2, iParam3, iParam0, bParam4);
			*fParam1 = (*fParam1 * *fParam1);
			*fParam2 = (*fParam2 * *fParam2);
			*iParam3 = (*iParam3 * *iParam3);
			break;
...
Vector3 func_213(bool bParam0, int iParam1, var uParam2, var uParam3)
{
	fVar7 = 999999.9f;
	fVar8 = 0f;
	*bParam0 = 1;
	...
	while (iVar0 < func_344(iParam1))
	{
		if (!func_357(iParam1, iVar0))
		{
			...
			if (!func_93(vVar4))
			{
				...
				if (fVar8 < fVar7)
				{
					if (func_358(iParam1, vVar4, uParam2, uParam3))
					{
...
bool func_229(var uParam0, var uParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_371(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
int func_236(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_314(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_314(iVar0))
		{
	...
	{
		func_377(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_378(iParam0, &iVar0, &fVar25);
...
void func_240(int iParam0, int iParam1)
{
	...
	func_384(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_385(iParam0, 0);
	func_386(iParam0);
	func_387(1);
...
{
	if (uParam0->f_177 != -1 || func_349(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_395(uParam0->f_177));
			}
		}
	}
...
bool func_257(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_411(&(Global_1898164->f_1[0]));
		if (func_412(iVar0) && func_413((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
int func_270(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_350(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_272(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	iVar0 = get_frame_count();
	if (iVar0 > iParam2->f_5)
	{
		func_422(iParam2, 1, iVar0);
	}
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_424(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!iParam2->f_1 & 8 != 0)
			{
				...
				else if (func_426(iParam0, iParam1, iParam2))
				{
					*uParam3 = 8;
					func_424(iParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630->f_25)
		{
			if (func_428(iParam2, 1065353216))
			{
				...
				{
					if (func_430(Global_35, iParam0, iParam2))
					{
						*uParam3 = 256;
						func_424(iParam0, iParam2, *uParam3);
						return true;
		...
		if (!iParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_431(Global_35, iParam0, iParam2, 0))
				{
					*uParam3 = 16;
					func_424(iParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_431(Global_35, iParam0, iParam2, 1))
			{
				*uParam3 = 16;
				func_424(iParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!iParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_435(iParam0, Global_1935630->f_41, *iParam2 & 128 != 0, 0, *iParam2 & 256 != 0) && func_436(iParam2, iParam0)) && func_437(iParam2, iParam0))
					{
						*uParam3 = 2;
						func_424(iParam0, iParam2, *uParam3);
						return true;
		...
		if (!iParam2->f_1 & 2 != 0)
		{
			if (iParam2->f_12 < 4f)
			{
				if ((func_435(iParam0, Global_1935630->f_41, *iParam2 & 128 != 0, 1, *iParam2 & 256 != 0) && func_436(iParam2, iParam0)) && func_437(iParam2, iParam0))
				{
					*uParam3 = 2;
					func_424(iParam0, iParam2, *uParam3);
					return true;
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_440(iParam2, iParam0) || (iParam2->f_9 > 0 && (func_441() - iParam2->f_9) < 2000))
				{
					if (is_ped_ragdoll(iParam0))
					{
						func_439();
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_444(iParam0, iParam1, iParam2))
				{
					*uParam3 = 2048;
					func_424(iParam0, iParam2, *uParam3);
					return true;
...
void func_279(int* iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8)
{
	iParam0->f_5 = sParam1;
	iParam0->f_7 = iParam3;
	iParam0->f_8 = iParam6;
...
{
	if (bParam1 && !func_465(iParam0, 13))
	{
		func_466(iParam0, 0);
	}
	else
...
int func_286(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	iParam5 = iParam5;
	iParam1 = iParam1;
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_472(func_305(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_290()
{
	if (func_41(Local_227[1]->f_11, 0, 1))
	{
		if (is_ped_using_any_scenario(Local_227[1]->f_11))
		{
			_0xaab050da48b57978(Local_227[1]->f_11, "Flee_Panic", 0, -1, 4);
			if (_0xeeed8fafec331a70(Local_227[1]->f_11, Local_33.f_51, 3))
			{
				_0x673a8779d229ba5a(Local_227[1]->f_11, Local_33.f_51, 0, 0);
				task_smart_flee_coord(Local_227[1]->f_11, Local_33.f_51, 300f, -1, false, 1077936128);
				set_blocking_of_non_temporary_events(Local_227[1]->f_11, false);
				_0x2208438012482a1a(Local_227[1]->f_11, false, false);
			}
		}
	}
}
...
{
	return func_477(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
bool func_295(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
...
void func_299(int iParam0, int iParam1)
{
	...
	iVar4 = func_483(ceil(((fVar6 / fVar7) * 100f)), 0, 100);
	iVar5 = func_483(ceil(((fVar8 / fVar7) * 100f)), 0, 100);
	if ((iVar5 - iVar4) == 0)
	{
		return;
	}
...
void func_303(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = func_491();
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_501(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_501(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_501(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_501(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
void func_306(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (does_blip_exist(iParam1))
	{
		if (func_41(iParam0, 0, 1))
		{
			if (func_44(iParam0, Global_36, iParam3) > fParam2)
			{
				func_123(&iParam1);
				if (bParam4)
				{
...
bool func_312(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = _0x80d78bdc9d88ef07(func_317(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_332(int iParam0)
{
	if (func_173(iParam0))
	{
		if (does_entity_exist(func_196(iParam0)))
		{
...
int func_339(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_154(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_518(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_520(iParam0);
					_0x7b204f88f6c3d287(func_521(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_521(iParam0, 0));
					func_522(iParam0);
				}
			}
			else
...
void func_340(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		_0xd428c3f92fc3f6f8(iVar0, func_525(iParam0));
...
int func_350(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
...
void func_356(float fParam0, float fParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam4)
	{
		*fParam1 = 240f;
...
bool func_358(int iParam0, vector3 vParam1, float fParam4, float fParam5)
{
	if (func_93(vParam1))
	{
		return false;
...
bool func_359(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_360(int iParam0, vector3 vParam1, int iParam4, float fParam5, bool bParam6, int iParam7)
{
	fVar0 = func_166(bParam6, iParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_366(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_441();
			iParam4->f_2 = func_44(iParam0, vParam1, 1);
			iParam4->f_1 = 1;
		}
	}
	else if (fVar0 > iParam4->f_2 || (!func_366(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_441();
		iParam4->f_2 = func_44(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_365(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
bool func_366(vector3 vParam0, int iParam3)
{
	...
	return func_533(vVar0, vParam0) > func_533(vVar0, get_entity_coords(iParam3, true, false));
}
...
Vector3 func_369(vector3 vParam0, bool bParam3, vector3 vParam4, bool bParam7)
{
	if (bParam7)
	{
		return vParam4;
...
int func_371(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	if (bParam6)
	{
	...
	else
	{
		...
		set_ped_config_flag(iVar0, 6, func_544(&(uParam1->f_22)));
		...
		if (!func_537(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_547(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_548(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_548(&(uParam1->f_22)));
...
bool func_375(var uParam0, int iParam1, int iParam2, bool bParam3)
{
		...
		while (iVar28 < 4)
		{
			...
			if (func_553(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_557(0))
				{
					...
					func_558(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_384(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	fVar0 = 0f;
	fVar1 = 0f;
	fVar2 = 0f;
	...
	func_152(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_391(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_573(to_float(iVar0), 1, 0);
	}
	else
	{
		func_573((to_float(200) / 3f), 1, 0);
	}
}
...
bool func_397(var uParam0, float fParam1, float fParam2, int iParam3)
{
	if (fParam1 > fParam2)
	{
		return false;
...
bool func_409(bool bParam0, int iParam1, int iParam2)
{
...
bool func_420(var uParam0, float fParam1)
{
	if (!func_274(uParam0))
	{
		return false;
...
bool func_423(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_580(iParam0, iParam1, iVar2))
			{
				return false;
			}
			if (func_581(iParam0, iVar2) <= func_582(iParam1))
			{
				return true;
			}
			break;
...
bool func_425(int iParam0, int iParam1)
{
	...
	if (!is_entity_dead(iParam0))
	{
		if (func_585(iParam0, !*iParam1 & 268435456 != 0, !*iParam1 & 536870912 != 0, !*iParam1 & 1073741824 != 0, 0, 0))
		{
			if (iParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_586(iParam1);
			if (func_587(iParam1, iParam0, fVar0, fVar1))
			{
				if (iParam1->f_2 == 0)
				{
...
bool func_426(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 85f;
	if (func_589(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		if (iParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_586(iParam2);
		if (func_587(iParam2, iParam0, fVar0, fVar1))
		{
			if (iParam2->f_2 == 0)
			{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_588(iParam2)
				{
					func_584(iParam2, 1);
					return true;
				}
...
bool func_427(int iParam0, int iParam1)
{
	...
	if (func_580(iParam0, iParam1, iVar1))
	{
		if (iParam1->f_3 == 0)
		{
			iParam1->f_3 = get_game_timer();
		}
		else if (get_game_timer() - iParam1->f_3) > func_588(iParam1)
		{
			fVar3 = func_586(iParam1);
...
bool func_430(var uParam0, int iParam1, int iParam2)
{
	if (iParam2->f_12 < IntToFloat(func_591(iParam2)))
	{
...
bool func_431(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	vVar0 = { get_entity_coords(iParam1, false, true) };
	iVar3 = func_592(iParam2);
	if (!bParam3)
	{
		switch (iVar3)
		{
...
bool func_432(int iParam0, int iParam1)
{
	...
	{
		if (!func_580(iParam0, iParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_596(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_597(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_598(iParam1, iParam0, fVar1, iVar0))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
...
bool func_443(int iParam0, int iParam1)
{
	...
	fVar0 = func_582(iParam0);
	if (iParam0->f_12 > func_603(iParam0) && iParam0->f_12 > fVar0)
	{
		return false;
	}
	iVar2 = func_604(iParam1);
	iVar1 = func_605(iParam0->f_14);
...
int func_444(int iParam0, int iParam1, int iParam2)
{
	...
	return func_606(iParam0, iParam1, bVar0, bVar2, iParam2->f_12, bVar1);
}
...
int func_449(int iParam0, int iParam1)
{
	...
	{
		return func_611(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_452(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_468(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_612(iParam0, 0);
		}
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_460((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_468(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
int func_455(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_166(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
...
void func_461(int iParam0, char* sParam1, char* sParam2, bool bParam3)
{
...
void func_462(int iParam0, char* sParam1, bool bParam2)
{
...
{
	if (func_460(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
float func_470(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && is_entity_dead(iParam0))
	{
		return -1f;
...
bool func_471(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return false;
...
bool func_478(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
...
int func_492(int iParam0)
{
	...
	fVar1 = func_166(absf(fVar1) < 1f, func_166(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
struct<4> func_507(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_555(923904168, func_656(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_555(923904168, func_656(bParam0), -740156546, 0) };
		}
...
bool func_509(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_317(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_513(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_384(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_385(iParam0, 1);
	if (!bParam2)
	{
		func_151(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_665(iParam0))
		{
...
float func_518(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_148(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_519(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_668(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_521(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_669(iParam0);
	}
...
bool func_529(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_93(vParam0))
	{
		return false;
...
bool func_531(vector3 vParam0)
{
	...
	{
		if (!func_93(*Global_1310750->f_16043[iVar0]))
		{
			if (func_148(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
struct<5> func_551(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_553(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_679(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_554(int iParam0, var uParam1, int iParam2)
{
...
struct<4> func_555(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_157(iParam0, 0))
	{
		return Var0;
	}
	_0x886dfd3e185c8a89(func_317(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

bool func_556(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_317(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_557(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_317(bParam0));
}
...
void func_559(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_271(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_583(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_585(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	{
		if (_is_weapon_sniper(func_695(iVar0, 0)))
		{
...
bool func_587(int iParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_589(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_695(iVar0, 0)))
		{
			if (func_697(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_593(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_596(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_597(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_598(int iParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_256(iParam1))
	{
...
bool func_602(int iParam0, int iParam1, vector3 vParam2)
{
...
bool func_607(int iParam0, int iParam1, bool bParam2)
{
	...
	if (does_entity_exist(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (_0x06087579e7aa85a9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (has_entity_clear_los_to_entity(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_608(iParam1, iVar0))
					{
						return true;
					}
				}
	...
	if (does_entity_exist(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_608(iParam1, iVar1))
				{
...
int func_609(int iParam0)
{
	...
	return func_700((*Global_1347702)[58]->f_15, 1);
}
...
int func_611(int iParam0, int iParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (iParam1->f_4 == 0)
...
bool func_614(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
...
bool func_621(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_460((*uParam4)[iVar0]->f_6);
		...
		if (func_714(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_715(iParam12, (*uParam4)[iVar0]->f_6))
				{
					...
					{
						func_452(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_634(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_729(iParam0, 8))
		{
...
void func_657(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_196(iVar0), func_197(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_736() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_736();
					}
					func_737(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_37(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
struct<4> func_676(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_555(271701509, func_656(bParam0), 12999093, 0) };
		}
...
bool func_678(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_317(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_679(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_317(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_696(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_697(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_697(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_698(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_701(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_745((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
void func_702(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_719((*uParam0)[iVar0]))
		{
			func_466((*uParam0)[iVar0], 14);
		}
		iVar0++;
	}
}
...
int func_703(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_746(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_460((*uParam2)[iVar0]->f_6))
		{
			func_466((*uParam2)[iVar0], 11);
...
void func_708(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_746(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
{
	return (func_750(iParam0, 4) || func_750(iParam0, 5));
}

int func_711(int iParam0)
{
	return func_750(iParam0, 7);
}

int func_712(int iParam0)
{
	return func_750(iParam0, 6);
}
...
void func_713(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (is_bit_set(*iParam1, 14))
	{
		if (func_719(iParam1))
		{
			...
			func_746(iParam0, iParam1, fParam2, iParam3, iParam4, iParam5, bParam6, 0);
		}
	}
}
...
bool func_714(int iParam0, int* iParam1, int* iParam2, bool bParam3, float fParam4, float fParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, float fParam14, bool bParam15, int iParam16)
{
	...
	{
		bVar1 = false;
		if (func_751(iParam1, iParam2, iParam0, bParam9, bParam10, fParam5, bParam11, bParam12, bParam13, fParam14, bParam15, iParam16))
		{
			bVar1 = true;
		}
		...
		if (bParam8)
		{
			func_753(iParam2->f_6, iParam0, 0, 1, -1);
		}
	}
	return bVar0;
}
...
bool func_715(int iParam0, int iParam1)
{
	...
	{
		if (func_754(iParam1, 1))
		{
			return true;
		}
	}
	else if (func_755(iParam1, 1))
	{
		func_756(iParam1, 1);
		return true;
	}
...
void func_716(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_280((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}

bool func_717(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
...
int func_745(bool bParam0, var uParam1, int iParam2)
{
	if (bParam0)
	{
		return uParam1;
...
void func_746(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_460(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_719(iParam1))
		{
			...
			if (func_460(iParam1->f_6))
			{
				...
				{
					iVar1 = -1;
					func_753(iParam1->f_6, iParam0, 0, 1, iVar1);
				}
				else
				{
...
bool func_751(int* iParam0, int* iParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, bool bParam8, float fParam9, bool bParam10, int iParam11)
{
...
void func_753(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	if (bParam3 && !func_460(iParam0))
	{
		return;
...
{
	return (shift_right(iParam0, 26) & 31 * func_472(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
