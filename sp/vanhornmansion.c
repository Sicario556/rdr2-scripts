...
void func_53()
{
	...
	iVar0 = get_interior_at_coords(func_91(5));
	bVar1 = false;
	...
	{
		if (!is_interior_entity_set_active(iVar0, "Lights"))
		{
			activate_interior_entity_set(iVar0, "Lights", 0);
			bVar1 = true;
		}
	}
	else if (is_interior_entity_set_active(iVar0, "Lights"))
	{
		deactivate_interior_entity_set(iVar0, "Lights", true);
		bVar1 = true;
	}
	if (bVar1)
	{
...
bool func_59(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_99(iParam0));
}
...
{
	func_140(iParam0, 4);
	func_142(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_141(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_141(iParam0));
	}
}
...
{
	if (func_83(Global_1914319->f_3[iParam0]->f_21) && func_175(Global_1914319->f_3[iParam0]->f_21))
	{
...
bool func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_190(iVar0) && func_198((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_199(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
{
	func_204(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
void func_194(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = round(func_221(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
{
	return (shift_right(iParam0, 26) & 31 * func_229(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
