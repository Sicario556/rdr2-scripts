...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 30:
			...
			*vLocal_41[0] = { _get_object_offset_from_coords(vParam1, vParam4.z, -1.5f, 0f, 0f) };
			uLocal_48[0] = vParam4.z;
			iLocal_38[1] = func_49(997958153, 1);
			*vLocal_41[1] = { vParam1 };
			...
			switch (func_50())
			{
				case 76:
					Local_51[0] = 0;
					Local_51[0]->f_1 = { -357.702f, 777.595f, 115.227f };
					Local_51[1] = 0;
					Local_51[1]->f_1 = { -375.986f, 774.763f, 115.194f };
					*vLocal_76[0] = { -380.609f, 783.655f, 115.017f };
					*vLocal_76[1] = { -392.294f, 780.579f, 114.735f };
					fLocal_75 = 10f;
					break;
				case 115:
					Local_51[0] = 0;
					Local_51[0]->f_1 = { -5563.068f, -2989.857f, -1.3539f };
					Local_51[1] = 0;
					Local_51[1]->f_1 = { -5539.921f, -3039.74f, -2.288f };
					*vLocal_76[0] = { -5547.972f, -3041.581f, -2.1309f };
					*vLocal_76[1] = { -5542.16f, -3040.963f, -2.2175f };
					fLocal_75 = 5f;
					break;
				case 5:
					Local_51[0] = 0;
					Local_51[0]->f_1 = { 2536.916f, -1474.124f, 45.058f };
					Local_51[1] = 0;
					Local_51[1]->f_1 = { 2574.454f, -1465.209f, 45.3529f };
					*vLocal_76[0] = { 2680.171f, -1413.008f, 45.4999f };
					*vLocal_76[1] = { 2680.171f, -1413.008f, 45.4999f };
					fLocal_75 = 5f;
					break;
				default:
					Local_51[0] = 0;
			...
			func_51(uParam0, 0, "WWH_MAN", &(iLocal_38[0]), *vLocal_41[0], &(uLocal_48[0]), 1, 1, 1, 1, 41788943, 1);
			func_51(uParam0, 1, "WWH_HORSE", &(iLocal_38[1]), *vLocal_41[1], &(uLocal_48[1]), 1, 1, 1, 1, 41788943, 1);
			break;
	}
}
...
bool func_28(var uParam0)
{
	...
	{
		task_animal_interaction(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 554992710, 0, 0);
		_0x931b241409216c1f(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0);
		iLocal_9 = 1;
		func_59(uParam0->f_20[0], 0, 1);
		func_59(uParam0->f_20[1], 0, 1);
	}
	return func_60(&(uParam0->f_20[0]), -1057545828);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (iLocal_9 > 2)
		{
			if (func_71(uParam0, 2f, 80f, 4, -91962372, 0))
			{
				func_70(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_9)
	{
		case 1:
			...
			break;
		case 2:
			if (!func_60(&(uParam0->f_20[0]), 985146578))
			{
				if (iLocal_74 < Local_51)
				{
					if (!func_7(Local_51[iLocal_74]->f_1))
					{
						clear_ped_tasks(&(uParam0->f_20[0]), 1, 0);
						clear_ped_tasks(&(uParam0->f_20[1]), 1, 0);
						task_lead_and_converse(&(uParam0->f_20[0]), &(uParam0->f_20[1]), Local_51[iLocal_74], 1, 5f, 2.5f, 1070386381, 1092616192, 1065353216);
						task_follow_and_converse_with_ped(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 0, 0, -1082130432, -1082130432, 32, 1.5f, -0.5f, 1069547520, 1073741824);
						iLocal_74++;
						return 0;
					}
				}
				clear_ped_tasks(&(uParam0->f_20[0]), 1, 0);
				clear_ped_tasks(&(uParam0->f_20[1]), 1, 0);
				_task_use_nearest_scenario_to_coord(&(uParam0->f_20[0]), *vLocal_76[0], 2f, 65000, false, true, false, false);
				task_wander_in_area(&(uParam0->f_20[1]), *vLocal_76[1], fLocal_75, 1077936128, 1086324736, 1);
...
void func_51(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	uParam0->f_20[iParam1]->f_2 = uParam3;
...
bool func_76(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_117(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_77(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_118(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_100(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_138(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_101(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_162(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_162(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_162(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_102(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_104(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_163(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
