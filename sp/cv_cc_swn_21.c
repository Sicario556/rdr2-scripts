...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -5.57f, -1.6425f, 0f, 0f, 1.265f, 1.325f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_150(uParam0, -1.081f, -0.2975f, 0f, -5.25f, 1.805f, 1.47f, 5f, -1612834106, 1243438920, 1, 1, 1);
	iLocal_14 = func_151(uParam0, 0, "IG_Dutch 1");
	iLocal_15 = func_151(uParam0, 21, "IG_RevSwanson 1");
	func_152(uParam0, -1914893189, 0f, 0f, 0f, "p_camp_cup_01x", 0, 1, 1);
	Local_21 = { func_153(uParam0, -1.2275f, -0.3401f, 0.988f, 167.5f, 7f, 0.47f, 0.42f) };
	Local_31 = { func_153(uParam0, -1.228f, -0.34f, 0.988f, -112.35f, 7f, 0.2425f, 0.42f) };
	Local_41 = { func_153(uParam0, -1.228f, -0.34f, 0.988f, 95.34f, 7f, 0.38f, 0f) };
	func_154(uParam0, "script@vignette@swanson_21@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@swanson_21@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@swanson_21@action_b", 0, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@swanson_21@action_b_alt_front", 0, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@swanson_21@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@swanson_21@action_b_alt_right", 0, 0, 0, 1);
	func_155(uParam0, "CSW21AU");
	func_156(uParam0, iLocal_14, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, -1043454001, "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 2, -1);
	func_158(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_159(uParam0, iLocal_15, 2, -1043454001, "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	return true;
}
...
struct<10> func_153(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
