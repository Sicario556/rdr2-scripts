...
bool func_93(var uParam0)
{
	if (func_203(uParam0, iLocal_17))
	{
		...
		if (_get_anim_scene_progress(iVar0) > 0.85f)
		{
			if (bLocal_18)
			{
		...
		else if (_get_anim_scene_progress(iVar0) > 0.23f)
		{
			if (!bLocal_18)
			{
	...
	{
		_task_start_scenario_in_place(func_48(uParam0, iLocal_16), -830507952, 45000, false, 0, 1f, false);
	}
	return true;
}
...
int func_143(var uParam0)
{
	if (_is_app_active(1833066477))
	{
		...
		_0xd4b614179bcd0654(func_219(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
