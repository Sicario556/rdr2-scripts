...
{
	_0xc67a4910425f11f1(player_id(), sLocal_35);
...
bool func_79(var uParam0)
{
	if (!bLocal_30)
	{
		if (!is_sphere_visible(vLocal_36, 1.4f))
		{
			clear_area(vLocal_36, 1f, 2097152);
			bLocal_30 = true;
		}
	}
	return bLocal_30;
...
{
	remove_anim_scene_entity(func_196(uParam0, iLocal_15), "JAVIER", func_9(uParam0, iLocal_14));
...
bool func_91(var uParam0)
{
	if (func_197(uParam0))
	{
		iLocal_33 = _0x4d0d2e3d8bc000eb(func_9(uParam0, iLocal_14), "p_Javierknife_temp_PH_R_HAND", 1);
		iLocal_34 = _0x4d0d2e3d8bc000eb(func_9(uParam0, iLocal_14), "p_cs_rag01x_PH_L_HAND", 1);
...
bool func_94(var uParam0)
{
	...
	if (!is_entity_dead(func_9(uParam0, iLocal_14)))
	{
		_0x3946fc742ac305cd(player_id(), func_9(uParam0, iLocal_14), sLocal_35, 0f, 0f, 0f, 0, sLocal_35);
		_0xe98d55c5983f2509(func_9(uParam0, iLocal_14));
	}
...
bool func_97(var uParam0)
{
	...
	{
		_0x2b02db082258625f(func_9(uParam0, iLocal_14), func_209(uParam0, iLocal_18), "p_Javierknife_temp_PH_R_HAND", -1145695909, "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
		_0x2b02db082258625f(func_9(uParam0, iLocal_14), iLocal_34, "p_cs_rag01x_PH_L_HAND", -1145695909, "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
	}
	return true;
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_157(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_190(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_157(uParam0, uParam0->f_1976.f_1), 1, func_263(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_197(var uParam0)
{
	...
	if (!func_48(iLocal_31))
	{
		...
		func_305(iLocal_31, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
...
bool func_276(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_157(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
