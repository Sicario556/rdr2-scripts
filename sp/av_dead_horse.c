void __EntryFunction__()
{
	...
	sLocal_13 = "dead_left";
	iLocal_14 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 10824, 10881, 11314);
}
...
{
	func_46(uParam0, "DEAD_HORSE", "", vParam1, vParam4);
	func_47(&vParam1, 50, 10, 0);
	iLocal_9 = func_48(997958153, 1);
	func_49(uParam0, 0, "DHP_HORSE", iLocal_9, vParam1, vParam4.z, 1, 1, 0, 1, 41788943, 1);
	if (*uParam0 == 150)
	{
		func_49(uParam0, 1, "RDED1_DOG_1", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 1.25f, 0.2f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	}
}
...
{
	if (!has_anim_dict_loaded(sLocal_12))
	{
		return 0;
	}
	return func_50(uParam0, uParam0->f_20[0]->f_5);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_64(uParam0, &uLocal_20, 0))
		{
			func_65(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				task_play_anim(&(uParam0->f_20[0]), sLocal_12, sLocal_13, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
				_0x674b90be1115846d(&(uParam0->f_20[0]), 1);
				_0x3ca5e58c9731a16b(&(uParam0->f_20[0]), iLocal_14);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
				iLocal_15 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1f, 1, 36, 0);
				iLocal_16 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1.5f, 2, -1, 0);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_47(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[1]), -622057267, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
...
int func_32(var uParam0, var uParam1)
{
	...
	remove_anim_dict(sLocal_12);
	if (iLocal_15 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_15, 1);
	}
	if (iLocal_16 != -1)
	{
...
bool func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_112(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_112(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
float func_84(int iParam0, vector3 vParam1, bool bParam4)
{
...
void func_85(int iParam0, vector3 vParam1)
{
	iVar1 = -1;
	iVar0 = 0;
	while (iVar0 < 10)
	{
		...
		{
			if (func_112(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_108(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_120(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_170(1) || *uParam0 & 8192 != 0))
				{
...
bool func_132(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_183(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_181(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_182(uParam2)
				{
					func_177(uParam2, 1);
					return true;
				}
...
bool func_133(int iParam0, var uParam1)
{
	...
	if (func_173(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_182(uParam1)
		{
...
int func_156(int iParam0, var uParam1)
{
	...
	{
		return func_207(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_158(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_208(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_208(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_208(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
