...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.2875f, 0.475f, 1f, 0f, 1.1f, 1.1f, 2.5f, -1612834106, -2087487524, 1, 1, 1);
	func_152(uParam0, 0f, 5.0125f, 1f, 20f, 3f, 3.5f, 5f, -1612834106, -676766751, 1, 1, 1);
	func_152(uParam0, -3.6869f, -0.1059f, 1f, 20f, 2.7225f, 1.5425f, 5f, -1612834106, -676766751, 1, 1, 1);
	iLocal_30 = func_153(uParam0, 1112538153, 0f, 0f, 0f, "HAY", 0, 0, 1);
	func_154(uParam0, "script@vignette@bill_6@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@bill_6@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@bill_6@action_b", 0, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@bill_6@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "CBLL6AU");
	func_156(uParam0, 1882769477, 1891290116);
	...
	Local_20 = { func_159(uParam0, -2.8481f, -0.1114f, 0.8927f, 163.75f, 7f, 0.332f, 0.457f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (func_197(uParam0, iLocal_17))
	{
		...
		iVar0 = func_200(uParam0, iLocal_30);
		if (does_entity_exist(iVar0))
		{
			delete_object(&iVar0);
		}
		task_stand_still(func_48(uParam0, iLocal_16), -1);
	}
	return true;
}
...
void func_198(var uParam0, int iParam1)
{
	...
	if (func_50(uParam0->f_107[iParam1]->f_7))
	{
		if (!func_51(uParam0->f_107[iParam1]->f_7))
		{
			return;
		}
		func_52(uParam0->f_107[iParam1]->f_5, uParam0->f_107[iParam1]->f_7, 1, 0, 0);
	}
}
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_344(100f, 140f);
			}
		}
