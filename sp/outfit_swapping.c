void __EntryFunction__()
{
	...
	if (Local_0.f_4 != -1 && Local_0.f_4 != Global_40.f_7729)
	{
		...
		{
			if (decor_exist_on(Global_35, "playerChangeOutfits"))
			{
				Local_0.f_2 = decor_get_bool(Global_35, "playerChangeOutfits");
			}
			Global_1905943 = 1;
			Local_0.f_1 = 1;
			Global_1905941 = Local_0.f_4;
			if ((((Local_0.f_2 || Global_1935630->f_2 != Global_40.f_39) || get_entity_model(Global_35) != Global_40.f_39) || is_player_teleport_active()) || Global_1879534->f_1)
			{
				func_5(&Local_0, 3);
			}
			while (Local_0 < 3)
...
void func_6(int iParam0)
{
	...
	{
		case 0:
			iParam0->f_3 = (iParam0->f_3 - get_frame_time());
		...
		case 1:
			...
			{
				_0x46743bbfedbc859e(func_14(0), func_12(iParam0->f_4), 1);
			}
			func_15(Global_35, iParam0->f_4, 0, 1, 0);
			func_16(iParam0->f_4);
			func_17(_create_var_string(10, "OUT_SWAP", _create_var_string(0, func_12(iParam0->f_4))), 10000, 0, 0, 0, 1);
			func_5(iParam0, 2);
			break;
		case 2:
			if (is_entity_dead(Global_35))
...
bool func_9()
{
	request_anim_dict(func_8());
	if (has_anim_dict_loaded(func_8()))
	{
		func_10(1);
		return true;
	}
...
int func_11()
{
	...
	if ((func_21(iVar0) || func_21(iVar1)) || _is_weapon_melee(iVar0))
	{
		return 0;
	}
	if (get_ped_reset_flag(iVar5, 267))
	{
		return 0;
	}
	if (bVar3)
...
int func_15(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if ((bParam3 && func_27(iParam1, 4096)) && Global_1946804->f_1497 == iParam4)
	{
		return 1;
	}
...
void func_30()
{
	...
	task_play_anim(Global_35, func_8(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_7(1);
	remove_anim_dict(func_8());
}
...
void func_33(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_40(32768) && &Global_1946804->f_1378.f_1[10] != &Global_1946804->f_57[10])
	{
		func_43();
	}
	...
	{
		func_46(&(Global_1946804->f_1497), iParam1, 1, -1, 1, 1, 1);
	}
}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_66(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_65(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
			...
			else
			{
				...
				if (bParam5)
				{
					...
					else
					{
						...
						{
							if (func_76(iVar3) && func_77(&(uParam0->f_1[iVar1]), iVar3, &iVar0))
							{
					...
					if (bVar2)
					{
						...
						{
							func_78(uParam0, &(uParam0->f_1[&Global_1946804->f_2612[iVar1]]), &(Global_1946804->f_2612[iVar1]), 0, 0);
							iVar1++;
						}
					}
					if (bParam4)
...
void func_55(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_66(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_80(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
{
	(Global_1946804->f_57[func_75(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_75(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_75(iParam0, 1)])->f_10 && iParam1));
}
...
void func_64(struct<4> Param0)
{
	...
	if (func_47(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_47(20))
			{
				return;
			}
			iVar0++;
...
{
	return ((Global_1946804->f_57[func_75(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
{
	(Global_1946804->f_57[func_75(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_75(iParam0, 1)])->f_10 || iParam1);
}
...
void func_74(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 39)
	{
		if (func_86(uParam0->f_1[iVar0], 2))
		{
...
{
	iVar1 = 12;
	iVar2 = func_88(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_67(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_88(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_91(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_88(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_92(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_91(&(Global_1946804->f_1497.f_1[iVar1])) || func_92(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_88(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_88(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_88(&(uParam0->f_1[iVar1])) || func_92(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	if (iParam0 == &Global_1946804->f_57[func_75(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
{
	func_93(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
void func_83(var uParam0, int iParam1)
{
	if (func_25() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_94(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_95(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
bool func_89(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_75(iParam0, 1)] != &Global_1946804->f_57[func_75(iParam0, 1)];
}
