	...
	switch (Local_14)
	{
		...
		case 2:
			if (!is_entity_dead(Global_35))
			{
				...
				{
					if (_does_volume_exist(&(Local_14.f_4[0])) && is_entity_in_volume(Global_35, &(Local_14.f_4[0]), true, 0))
					{
						func_68(*uParam0);
					}
				}
...
void func_9(var uParam0)
{
	...
	if (_is_tracked_point_valid(Local_14.f_8))
	{
		destroy_tracked_point(Local_14.f_8);
	}
...
bool func_52(var uParam0, struct<10> Param1, var uParam11)
{
	if (!_does_volume_exist(*uParam0))
	{
...
{
	iVar0 = iParam0;
	if (!is_string_null_or_empty(func_123(iVar0)))
	{
		iVar1 = get_interior_at_coords(func_54(0));
		if (is_valid_interior(iVar1))
		{
			if (is_interior_ready(iVar1))
			{
				func_124(iVar1, iParam0);
				if (_is_interior_entity_set_valid(iVar1, func_123(iVar0)))
				{
					activate_interior_entity_set(iVar1, func_123(iVar0), 0);
				}
				return true;
			}
		}
...
void func_67(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_126(iParam0))
	{
		...
		if (bParam3)
		{
			func_127(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_69(var uParam0)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			_0xa967d6a8ed2d713b(uParam0->f_3, 0);
			set_ped_config_flag(uParam0->f_3, 525, true);
			set_ped_config_flag(uParam0->f_3, 26, true);
			_0xae6004120c18df97(uParam0->f_3, 0, 0);
			remove_all_ped_weapons(uParam0->f_3, true, true);
			set_ped_can_be_targetted(uParam0->f_3, false);
			set_entity_invincible(uParam0->f_3, true);
			set_blocking_of_non_temporary_events(uParam0->f_3, true);
			_0x8996fa6ad9fe4e90(uParam0->f_3);
			freeze_entity_position(uParam0->f_3, true);
			set_entity_completely_disable_collision(uParam0->f_3, false, false);
			uParam0->f_8 = create_tracked_point();
			set_tracked_point_info(uParam0->f_8, func_54(2), 0.4f);
			uParam0->f_6 = 0;
			func_25(&(uParam0->f_9));
			func_136(&(uParam0->f_1), 2);
			break;
		case 2:
			task_turn_ped_to_face_entity(uParam0->f_3, Global_35, -1, -1082130432, -1082130432, -1082130432);
			func_136(&(uParam0->f_1), 3);
			break;
		case 3:
			if (get_script_task_status(uParam0->f_3, -875674219, true) != 1)
			{
				task_turn_ped_to_face_entity(uParam0->f_3, Global_35, -1, -1082130432, -1082130432, -1082130432);
			}
			if (func_139(Global_35, func_54(3), 2.6f, 1, 1))
			{
				if (is_tracked_point_visible(uParam0->f_8))
				{
					uParam0->f_6 = 1;
				}
				else
...
void func_83(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_145(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_145(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_89(var uParam0, int iParam1)
{
	...
	if (!func_149(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
void func_96(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_157(iParam0, 8))
		{
...
void func_99(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_159(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_159(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_107()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_156(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_164(0), iVar0, 0))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_175(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_175(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_175(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_175(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
void func_124(int iParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		if (iParam1 != iVar2)
		{
			if (is_interior_entity_set_active(iParam0, func_123(iVar2)))
			{
				deactivate_interior_entity_set(iParam0, func_123(iVar2), true);
			}
		}
		iVar2++;
	}
...
void func_127(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_126(iParam0))
	{
...
bool func_139(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_187(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_154(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_149(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
{
	func_208((get_game_timer() + iParam2), !bParam1);
...
void func_172(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_210(iParam0));
...
int func_176(int iParam0, int iParam1)
{
	...
	if (!func_217(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_219(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_205(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_164(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_164(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_243(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_253(923904168, func_252(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_253(923904168, func_252(bParam0), -740156546, 0) };
		}
...
bool func_245(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_164(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_253(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_202(iParam0, 0))
	{
		return Var0;
	}
	_0x886dfd3e185c8a89(func_164(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
