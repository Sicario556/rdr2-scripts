...
void func_8(var uParam0)
{
	...
	switch (vLocal_14.x)
	{
		case 0:
			...
			request_model(func_51(), false);
			if (!has_model_loaded(func_51()))
			{
				return;
			}
			func_50(&vLocal_14, 1);
			break;
		case 1:
			if (!does_entity_exist(vLocal_14.y))
			{
				vLocal_14.f_1 = create_vehicle(func_51(), func_52(0), func_53(0), true, true, false, false);
				return;
			}
			if (!does_entity_exist(vLocal_14.y))
			{
		...
		case 2:
			if (does_entity_exist(vLocal_14.y))
			{
				freeze_entity_position(vLocal_14.y, true);
				vLocal_14.f_2 = 1;
			}
			func_50(&vLocal_14, 3);
			break;
		case 3:
			if (!func_49(func_48()))
			{
				if (does_entity_exist(vLocal_14.y) && is_ped_in_vehicle(Global_35, vLocal_14.y, false))
				{
					if (vLocal_14.z)
					{
						vLocal_14.f_2 = 0;
						freeze_entity_position(vLocal_14.y, false);
					}
					func_54(uParam0);
					func_50(&vLocal_14, 4);
				}
...
int func_26(var uParam0)
{
	...
	return (func_68() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_71(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_72("DISCO_FOCUS", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", -719620017, Global_35, 2, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_78(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_78(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_79(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_79(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_80(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_94(Global_35))
		{
			return true;
		}
...
void func_64(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_105(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_105(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_70(var uParam0, int iParam1)
{
	...
	if (!func_110(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
int func_72(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_118(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_119(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_77(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_118(iParam0, 8))
		{
...
void func_80(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_120(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_120(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_88()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_117(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_125(0), iVar0, 0))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_139(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_139(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_109(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_148(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_115(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_110(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_128(int iParam0)
{
	...
	fVar1 = func_164(absf(fVar1) < 1f, func_164(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_167((get_game_timer() + iParam2), !bParam1);
...
void func_134(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_169(iParam0));
...
void func_142(int iParam0, vector3 vParam1, float fParam4, int iParam5, float fParam6)
{
	...
	if (iParam0 == func_94(Global_35) && is_player_teleport_active())
	{
	}
	if (func_178(iParam0))
	{
		if (func_179(get_ped_index_from_entity_index(iParam0)))
		{
...
int func_161(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_125(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_125(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_125(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return func_203(1328661203, func_204(), -1591664384, bParam0);
}
...
struct<4> func_203(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_125(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
