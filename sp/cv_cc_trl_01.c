...
bool func_73(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, 98537260, "");
	...
	func_155(uParam0, 1211525499, 0f, 0f, 0f, "PIPE", 0, 0, 1);
	iLocal_21 = func_155(uParam0, -862949069, 0f, 0f, 0f, "LEDGER", 0, 0, 1);
	iLocal_19 = func_155(uParam0, -1335015498, 0f, 0f, 0f, "KNITTING", 0, 0, 1);
	iLocal_20 = func_155(uParam0, 1230724566, 1.67941f, -0.624629f, 0.00875473f, 0, 1, 0, 1);
	...
	func_163(uParam0, iLocal_15, 2, -25074136, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
	...
	func_163(uParam0, iLocal_14, 3, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0, -1073741824, 1065353216, 1);
...
{
	if (!is_entity_dead(func_47(uParam0, iLocal_17)))
	{
		set_entity_visible(func_47(uParam0, iLocal_17), false);
		freeze_entity_position(func_47(uParam0, iLocal_17), true);
		set_blocking_of_non_temporary_events(func_47(uParam0, iLocal_17), true);
	}
	return true;
}
...
bool func_94(var uParam0)
{
	if (!bLocal_24)
	{
		...
		{
			_0x2e1d6d87346bb7d2(func_47(uParam0, iLocal_17), func_47(uParam0, iLocal_16), 0, 0);
			bLocal_24 = true;
		}
	}
	if (!bLocal_22)
	{
		...
		{
			freeze_entity_position(func_47(uParam0, iLocal_17), false);
			set_entity_coords(func_47(uParam0, iLocal_17), get_entity_coords(func_203(uParam0, iLocal_21), true, false) + Vector(0.2f, 0f, 0f), true, false, true, true);
			set_entity_heading(func_47(uParam0, iLocal_17), (get_entity_heading(func_47(uParam0, iLocal_16)) + 90f));
			force_ped_motion_state(func_47(uParam0, iLocal_17), -1299979036, false, 0, false);
			task_fly_away(func_47(uParam0, iLocal_17), func_47(uParam0, iLocal_16));
			set_ped_keep_task(func_47(uParam0, iLocal_17), true);
			bLocal_22 = true;
		}
	}
	if (!bLocal_23)
	{
		...
		{
			set_blocking_of_non_temporary_events(func_47(uParam0, iLocal_17), false);
			set_entity_visible(func_47(uParam0, iLocal_17), true);
			set_entity_invincible(func_47(uParam0, iLocal_17), true);
			bLocal_23 = true;
		}
	}
	return true;
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_247(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_152(var uParam0, int iParam1, char* sParam2)
{
	...
	while (iVar0 < uParam0->f_107)
	{
		...
		{
			uParam0->f_107[iVar0] = 1;
			uParam0->f_107[iVar0]->f_3 = iParam1;
			uParam0->f_107[iVar0]->f_4 = sParam2;
			uParam0->f_107[iVar0]->f_104 = 1;
			uParam0->f_106++;
			return iVar0;
		}
		iVar0++;
...
int func_194(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_286() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_252(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (!does_entity_exist(func_47(uParam0, iVar1)))
		{
		}
		else if (!is_entity_occluded(func_47(uParam0, iVar1)))
		{
			iVar0 = 0;
		}
		else
...
void func_306(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_326(100f, 140f);
			}
		}
...
int func_332(int iParam0, bool bParam1)
{
	...
	{
		func_237(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_225() == -1)
		{
