...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	...
	func_160(uParam0, iLocal_14, 4, -472287783, "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0, -1073741824, 1065353216, 1);
...
void func_386(var uParam0, int iParam1)
{
	...
	func_417(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_387(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_420(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_397((*Global_1347702)[63]->f_15, 1) || func_438((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_397((*Global_1347702)[134]->f_15, 1) || func_438((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(747937920, 1) && !func_397((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
