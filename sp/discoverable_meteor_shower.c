...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 2:
			...
			break;
		case 3:
			Local_14.f_7 = start_particle_fx_looped_at_coord(func_57(), func_58(0), 0f, 0f, 0f, 1f, false, false, false, false);
		...
		case 4:
			...
			{
				stop_particle_fx_looped(Local_14.f_7, false);
				func_60(uParam0);
				func_52(&Local_14, 5);
			}
			break;
...
void func_9(var uParam0)
{
	...
	if (does_particle_fx_looped_exist(Local_14.f_7))
	{
		stop_particle_fx_looped(Local_14.f_7, false);
	}
	remove_ptfx_asset();
...
bool func_16(int iParam0)
{
	...
	{
		return func_68((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_26(var uParam0)
{
	...
	return (func_74() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_77(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_84(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_84(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_85(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_85(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_86(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_100(Global_35))
		{
			return true;
		}
...
void func_70(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_111(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_111(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_76(var uParam0, int iParam1)
{
	...
	if (!func_115(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
void func_86(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_125(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_125(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_94()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_122(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_130(0), iVar0, 0))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_144(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_144(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_144(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_144(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_120(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_115(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_165(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_130(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_130(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_130(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_205(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_130(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
