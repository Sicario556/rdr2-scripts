		...
		if (get_game_timer() > iLocal_229)
		{
			...
			switch (iLocal_228)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_230));
					...
					Global_1897950 = -1;
					iLocal_231 = (get_game_timer() + iLocal_227);
					iLocal_228 = 2;
					break;
				case 2:
					if (func_11() || iLocal_231 < get_game_timer())
					{
						func_12(iLocal_230);
						iLocal_231 = (get_game_timer() + iLocal_227);
						iLocal_228 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_230) || iLocal_231 < get_game_timer())
					{
						func_14(iLocal_230);
						iLocal_231 = (get_game_timer() + iLocal_227);
						iLocal_228 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_230) || iLocal_231 < get_game_timer())
					{
						func_16(iLocal_230);
						iLocal_231 = (iLocal_227 + get_game_timer());
						iLocal_228 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_230)))
					{
						if (func_17(func_6(iLocal_230), 4) && !iLocal_231 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_230) || iLocal_231 < get_game_timer())
							{
							...
							Jump @788; //curOff = 456
							if (iLocal_231 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_230);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_229 = (1000 + get_game_timer());
							}
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_230]->f_10);
							if ((*Global_1888801)[iLocal_230]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_230]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_230]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_230]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_48(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!_does_volume_exist(func_80(iParam3)))
	{
		return 0;
	}
	if (!is_entity_in_volume(Global_35, func_80(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if (iParam7 && func_85(get_player_index(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
bool func_84(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_140(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
{
	if (func_96(Global_1914319->f_3[iParam0]->f_21) && func_173(Global_1914319->f_3[iParam0]->f_21))
	{
...
int func_235(int iParam0)
{
	switch (func_233(iParam0))
	{
		...
		case 8:
			...
			if (func_139((*Global_1347702)[iVar1]->f_12, 1))
			{
...
void func_273(int iParam0, int iParam1)
{
	...
	if (func_140(&(Global_1898164->f_1[0])))
	{
