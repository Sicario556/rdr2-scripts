...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (bLocal_39)
		{
			if (has_anim_event_fired(&(uParam0->f_20[0]), 725039534) || is_entity_dead(&(uParam0->f_20[0])))
			{
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_61(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
