...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.5f, -2.6333f, 1f, 0f, 6f, 5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	iLocal_20 = func_152(uParam0, -1006095118, 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	iLocal_21 = func_152(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_22 = func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 1, 1);
	func_153(uParam0, "script@vignette@dutch_22@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_22@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@dutch_22@action_b", 0, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_22@action_b_alt", 0, 0, 0, 1);
	func_154(uParam0, "CDT22AU");
	func_155(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_20, 0, -1073741824, 1065353216, 1);
	...
	func_155(uParam0, iLocal_15, 1, -1489483851, 0, -1, 0, 90f, 1065353216, 1);
	func_156(uParam0, iLocal_15, iLocal_22, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_157(uParam0, iLocal_16, 3, -22664287, "WORLD_HUMAN_SMOKING_FEMALE_B", -1, 1);
	Local_23 = { func_158(uParam0, 0.1451f, -2.8832f, 1f, -177.1645f, 7f, 0.7f, 0.7f) };
	return true;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_207(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_209(iParam0);
					_0x7b204f88f6c3d287(func_210(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_210(iParam0, 0));
					func_211(iParam0);
				}
			}
			else
...
void func_116(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_221(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	func_222(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_225(iParam0), 137, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_225(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_225(iParam0), 204, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_225(iParam0);
	if (((does_entity_exist(iVar1) && func_227(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_240(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_241(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_208(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_205(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_169(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_205(uParam0->f_107[iVar0]->f_8.f_3))
			{
...
void func_187(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_205(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
...
void func_226(int iParam0)
{
	if (func_50(iParam0))
	{
		if (does_entity_exist(func_225(iParam0)))
		{
...
int func_328(int iParam0, bool bParam1)
{
	...
	{
		func_231(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_219() == -1)
		{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_208(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_205(vVar0)) && !func_206(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
			...
			{
				_0x63aa2b8eb087886a(func_208(iParam0, 1), get_hash_key(sVar12));
			}
...
bool func_401(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_229(iParam0)))
	{
		return false;
	}
...
bool func_416(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_208(iParam0, 1));
...
void func_418(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_225(iParam1)))
	{
		_0x931b241409216c1f(func_225(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_225(iParam1), iParam0);
...
int func_426(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3 && does_entity_exist(func_225(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
