...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(1134.233f, 447.732f, 77.166f, 0f, 0f, 0f, 75f, 75f, 75f, "Guthrie Farm - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_18 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherThreat Agg");
		_0x39816f6f94f385ad(iLocal_18, 1119.103f, 491.625f, 94.789f, 0f, 0f, 40.29281f, 4.983408f, 12.47093f, 20f);
		_0x39816f6f94f385ad(iLocal_18, 1116.402f, 489.3356f, 94.789f, 0f, 0f, 40.29281f, 11.85608f, 5.358582f, 20f);
		_0x39816f6f94f385ad(iLocal_18, 1178.083f, 428.8635f, 93.85277f, 0f, 0f, 53.30451f, 6.700057f, 7.386477f, 11.96838f);
		_0x39816f6f94f385ad(iLocal_18, 1122.726f, 433.0324f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		_0x39816f6f94f385ad(iLocal_18, 1117.072f, 440.526f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		_0x39816f6f94f385ad(iLocal_18, 1111.182f, 447.2959f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		iLocal_17 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_17, iLocal_18);
		_0x39816f6f94f385ad(iLocal_17, 1158.519f, 410.6769f, 92.74591f, 0f, 0f, -42.87345f, 53.38902f, 36.78405f, 32.92925f);
		_0x39816f6f94f385ad(iLocal_17, 1183.084f, 409.2454f, 94.789f, 0f, 0f, 62.77261f, 47.98455f, 17.14376f, 15.40531f);
		_0x39816f6f94f385ad(iLocal_17, 1155.914f, 449.3743f, 96.1861f, 0f, 0f, 47.14103f, 50.95671f, 69.55695f, 12.92893f);
		_0xbce668aaf83608be(iLocal_17, 1195.093f, 434.533f, 81.04297f, 0f, 0f, 0f, 7.797928f, 12.21736f, 21.62953f);
		_0x39816f6f94f385ad(iLocal_17, 1170.392f, 385.8856f, 94.80865f, 0f, 0f, 21.33961f, 15.42121f, 9.785769f, 12.92893f);
		_0xbce668aaf83608be(iLocal_17, 1125.095f, 489.7792f, 81.04297f, 0f, 0f, 0f, 22.93393f, 22.40263f, 21.62953f);
		_0x39816f6f94f385ad(iLocal_17, 1116.016f, 455.3546f, 94.789f, 0f, 0f, 39.8431f, 36.45f, 74.7347f, 15.40531f);
		iLocal_19 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_19, iLocal_17);
		_0xbce668aaf83608be(iLocal_19, 1125.095f, 466.7386f, 81.04297f, 0f, 0f, 31.95184f, 48.08396f, 52.23304f, 21.62953f);
		_0xbce668aaf83608be(iLocal_19, 1151.546f, 440.5756f, 81.04297f, 0f, 0f, -44.24499f, 55.60196f, 50.99452f, 21.62953f);
		_0xbce668aaf83608be(iLocal_19, 1158.093f, 392.0394f, 81.04297f, 0f, 0f, -24.17386f, 18.53472f, 13.09556f, 21.62953f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherRegistration Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_19);
		...
		_set_guard_zone_position(sLocal_15, 1117.13f, 490.0274f, 97.598f);
...
void func_28(int iParam0)
{
	...
	_0x4a8fefc43fd8ac9b(iLocal_17, 3, 1);
	_0x53d05d60e5f5b40c(iLocal_17, 3, 1, func_51(746));
	_0x53d05d60e5f5b40c(iLocal_17, 3, 1, func_51(748));
	_0x931b241409216c1f(func_52(745), func_52(748), 0);
}
...
void func_56()
{
	iVar0 = _0x112ddf56300bc6e5(-35439674);
	iVar1 = _0x112ddf56300bc6e5(-1635184241);
	if (_0x800df3fc913355f3(iVar0))
	{
...
bool func_61(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_91(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_105(&cVar6, 109029619), sVar9, func_105(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_105(&cVar6, 109029619), func_105(&cVar10, 109029619));
		}
...
void func_79(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_124(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_87(int iParam0, bool bParam1)
{
	...
	if (func_125(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_51(iParam0));
				func_129(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_51(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_51(iParam0)))
	{
		func_129(iParam0, 128);
		return 1;
	}
	func_128(iParam0, _create_persistent_character(func_127(iParam0)));
	_0x4f81ead1de8fa19b(func_51(iParam0));
	if (func_125(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_51(iParam0));
		func_129(iParam0, 2048);
...
bool func_88(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_51(iParam0));
}
...
bool func_108(int iParam0)
{
	...
	if (func_140())
	{
		if (!func_141((*Global_1835011)[3]->f_1, 1))
		{
...
void func_119(int iParam0)
{
	...
	if (!func_113(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_145(Global_1935369->f_5[iParam0]->f_6, 1);
	func_146(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_85(Global_1914319->f_3[iParam0]->f_21) && func_148(Global_1914319->f_3[iParam0]->f_21))
	{
		func_149(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_150(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_124(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_126(int iParam0, bool bParam1)
{
	...
	func_158(iParam0);
	_0xfc77c5b44d5ff7c0(func_51(iParam0));
	func_128(iParam0, 0);
	return 1;
}
...
bool func_133(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_160(&(Global_1898164->f_1[0]));
		if (func_161(iVar0) && func_162((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_168(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
