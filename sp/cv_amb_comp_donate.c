...
{
	func_22(7, get_random_int_in_range(10, 31) * 10);
	return true;
}
...
void func_22(int iParam0, int iParam1)
{
	...
	if (func_61(iParam0, 0, iParam1, Global_40.f_4283.f_440[0], 0, 1))
	{
		return;
	}
	if (func_61(iParam0, 0, iParam1, Global_40.f_4283.f_440[1], 0, 1))
	{
		if (&Global_40.f_4283.f_440[1] == 0)
		{
			Global_40.f_4283.f_440[1] = func_62(Global_40.f_4283.f_440[0]);
		}
		return;
	}
	func_63(&(Global_40.f_4283.f_440));
	func_61(iParam0, 0, iParam1, Global_40.f_4283.f_440[1], 0, 1);
}
...
bool func_61(int iParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	if (uParam3->f_62 >= 12)
	{
		return false;
...
{
	if (does_entity_exist(func_180(uParam0, iLocal_16)))
	{
		freeze_entity_position(func_180(uParam0, iLocal_16), true);
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			if (func_33(uParam0) < 5)
			{
				...
				if (!uParam0->f_3)
				{
					if (func_117(uParam0->f_107[iVar0]->f_1) && !func_55(uParam0->f_107[iVar0]->f_1))
					{
						func_34(func_19(uParam0), 30);
						return true;
					}
...
bool func_164(int iParam0)
{
	...
	return func_266((*Global_1347702)[iParam0]->f_15);
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_281(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_58(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_282(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_283(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_284(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_183(var uParam0, int iParam1)
{
	...
	func_290(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_291(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_184(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_292(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_185(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_294(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_187(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_295(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_297(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_297(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_195(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_298(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_197(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_299(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_299(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_198(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_116() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_293() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_242(int iParam0, int iParam1)
{
	...
	if (!func_325(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
bool func_243(int iParam0)
{
	...
	return is_bit_set(Global_40.f_4283.f_307, func_327(iParam0, 1));
}
...
void func_244(int iParam0)
{
	...
	set_bit(&(Global_40.f_4283.f_307), func_327(iParam0, 1));
}
...
bool func_252(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_265(iVar0) && func_332((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_333(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_288(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_299(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_299(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_329()
{
	if (_is_ped_carrying(Global_35) || func_364(Global_35))
	{
		return true;
	}
	return false;
...
int func_345(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_282(iParam0), 0);
}
...
int func_346(int iParam0, bool bParam1)
{
	...
	{
		func_240(iParam0, _create_persistent_character(func_136(iParam0)));
		if (func_228() == -1)
		{
...
int func_371(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_108(iParam1);
	if ((!does_entity_exist(iVar0) || !func_124(iVar0, 0)) || (bParam3 && !func_52(iParam1)))
	{
		if (bParam2)
		{
		...
		case 6:
			if (func_124(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_291(Global_1360165[iParam0], 1);
				}
			}
			func_411(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_290(Global_1360165[iParam0]))
				{
				}
			}
...
int func_397(var uParam0, int iParam1)
{
	...
	{
		func_283(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_445((*Global_1360165)[iParam0]->f_4.f_2) || func_266((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_446((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_448(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_106(iParam0, 44, 1);
			}
...
void func_414(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_453(Global_35) && is_player_teleport_active())
	{
	}
	if (func_454(iParam0))
	{
		if (func_455(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_415(int iParam0, int iParam1)
{
	...
	bVar0 = func_456(iParam0, iParam1);
	return bVar0;
}
...
bool func_435(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_292(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_406((*Global_1347702)[63]->f_15, 1) || func_266((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_406((*Global_1347702)[134]->f_15, 1) || func_266((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_339(747937920, 1) && !func_406((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_462(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_479(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_479(iVar0))
		{
...
struct<4> func_491(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_509(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_492(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_509(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_493(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_509(bParam0));
}
...
void func_495(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_512(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_500(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_491(923904168, func_498(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_491(923904168, func_498(bParam0), -740156546, 0) };
		}
...
struct<4> func_502(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_491(271701509, func_498(bParam0), 12999093, 0) };
		}
...
bool func_505(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_509(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_506(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_509(bParam6), &Var0, 0);
	return uVar4;
}

bool func_507(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_509(0);
