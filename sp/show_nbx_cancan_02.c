...
void func_27(int iParam0)
{
	...
	func_154(&(iParam0->f_954), Global_35, "ARTHUR", 0);
	iParam0->f_945 = "CAN1AUD";
	iParam0->f_910 = Local_8;
	func_7(&(iParam0->f_16), 131072);
	if (func_155())
	{
		func_154(&(iParam0->f_954), Global_35, "JOHN", 0);
	}
	else
	{
		func_154(&(iParam0->f_954), Global_35, "ARTHUR", 0);
	...
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@cancan_dance@CanCanDanceP2", 2, 0, false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (11 - 1))
	{
		iVar1 = iVar0;
		Local_1141.f_1[iVar0] = get_hash_key(func_156(iVar1));
		iVar0++;
	}
...
void func_234(int iParam0)
{
	...
	{
		iVar1 = iVar0;
		if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_1[iVar1])))
		{
			if (iVar1 == 1)
			{
