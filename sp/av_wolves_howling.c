...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "WHP_WOLF_2", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 0.5f, 0f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "WHP_WOLF_3", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				uLocal_12[0] = func_65(365448677, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, 0, 0);
			...
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				...
				uLocal_12[1] = func_65(2120307236, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[1]), &(uLocal_12[1]), 0, 0, false, true, 0, false, -1f, false);
				func_66(uParam0->f_20[1], 1, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[2])))
			{
				func_64(&(uParam0->f_20[2]->f_5), 50, 10, 0);
				uLocal_12[2] = func_65(1974927641, uParam0->f_20[2]->f_5, uParam0->f_20[2]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[2]), &(uLocal_12[2]), 0, 0, false, true, 0, false, -1f, false);
				func_66(uParam0->f_20[2], 1, 1);
			}
			iLocal_11 = 1;
			break;
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				_0xe7fa07624574b79a(&(uParam0->f_20[0]), Global_35, 1, 1, 15f, 1, 0, 0, 0);
			...
			break;
		case 3:
			if (!func_69(&(uParam0->f_20[2]), -875674219))
			{
				task_turn_ped_to_face_entity(&(uParam0->f_20[2]), Global_35, 0, -1082130432, -1082130432, -1082130432);
			}
			if (func_70(&(uParam0->f_20[0]), Global_35, 1) < 324f || func_71(&uLocal_19, 12.5f))
			{
				func_72(&(uParam0->f_20[2]));
				func_62(uParam0);
				func_68(&uLocal_16);
				iLocal_11 = 4;
			}
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			func_66(uParam0->f_20[iVar0], 0, 1);
		}
		iVar0++;
	}
}
...
bool func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (_0x9c54041bb66bcf9e(&(uParam0->f_20[iVar0]), &(uLocal_12[iVar0])))
			{
				return false;
			}
		}
