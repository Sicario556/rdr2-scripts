...
bool func_86(var uParam0)
{
	if (iLocal_16 != -1)
	{
		...
		if (does_entity_exist(iVar0))
		{
			set_entity_coords(iVar0, func_189(uParam0, 0.762663f, 0.177343f, 0.465f), true, false, true, true);
		}
	}
	return true;
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_189(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_189(uParam0, uParam0->f_1976.f_1), 1, func_249(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_262(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_189(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
