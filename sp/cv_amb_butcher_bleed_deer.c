...
{
	if (does_entity_belong_to_this_script(uParam0->f_107[iLocal_14]->f_5, true))
	{
		if (does_entity_exist(uParam0->f_107[iLocal_14]->f_5))
		{
			_0x39a2fc5af55a52b1(uParam0->f_107[iLocal_14]->f_5, -1);
			_0x36e4b61dc56de77c(uParam0->f_107[iLocal_14]->f_5, 200f, 201f, 10000000, 1);
			set_ped_as_no_longer_needed(&(uParam0->f_107[iLocal_14]->f_5));
		}
	}
	return true;
}
...
{
	if (does_entity_exist(func_22(uParam0, iLocal_17)))
	{
		_0xcaaf2bccfef37f77(func_22(uParam0, iLocal_17), 32);
	}
	if (does_entity_exist(uParam0->f_107[iLocal_14]->f_5))
	{
		set_ped_config_flag(uParam0->f_107[iLocal_14]->f_5, 186, false);
		set_ped_as_no_longer_needed(&(uParam0->f_107[iLocal_14]->f_5));
	}
	return true;
}
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_242(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_186(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_279() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
{
	if (does_entity_exist(func_49(uParam0, iParam1)))
	{
		func_292(func_49(uParam0, iParam1), 0);
		_0x18ff3110cf47115d(func_49(uParam0, iParam1), 7, 0);
		set_ped_config_flag(func_49(uParam0, iParam1), 243, true);
		set_ped_config_flag(func_49(uParam0, iParam1), 385, true);
		disable_ped_pain_audio(func_49(uParam0, iParam1), true);
		stop_ped_speaking(func_49(uParam0, iParam1), true);
	}
}
...
{
	freeze_entity_position(func_22(uParam0, iLocal_17), true);
	iVar0 = get_ped_bone_index(func_49(uParam0, iLocal_14), 53081);
	iVar1 = get_ped_bone_index(func_49(uParam0, iLocal_14), 41273);
	iVar2 = get_entity_bone_index_by_name(func_22(uParam0, iLocal_17), "bottomHookInd02");
	iVar3 = get_entity_bone_index_by_name(func_22(uParam0, iLocal_17), "bottomHookInd01");
	vVar4 = { get_world_position_of_entity_bone(func_22(uParam0, iLocal_17), iVar2) };
	vVar7 = { get_world_position_of_entity_bone(func_22(uParam0, iLocal_17), iVar3) };
	set_ped_to_ragdoll(func_49(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	_0xe1aadd0055d76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_17), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	_0xe1aadd0055d76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_17), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
...
void func_301(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_340(100f, 140f);
			}
		}
...
int func_327(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_220() == -1)
		{
