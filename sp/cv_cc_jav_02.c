...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5.5054f, 2.453f, 0.9827f, 18.5f, 1.5f, 1.5f, 3f, -1612834106, 271759394, 1, 1, 1);
	func_151(uParam0, 0.45f, 0.3f, 0.983f, 0f, 2f, 2f, 3f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, 546935383, 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	iLocal_20 = func_152(uParam0, 2095602337, 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_21 = func_152(uParam0, 1600083684, 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_14, 3, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_21, 0, -1073741824, 1065353216, 1);
	func_154(uParam0, iLocal_14, iLocal_20, "p_cs_newspaper_03x_PH_R_HAND", 0, 0);
	func_155(uParam0, "script@vignette@javier_2@base", 1, 1, 0, 0);
	iLocal_15 = func_155(uParam0, "script@vignette@javier_2@action_a", 2, 0, 1, 0);
	iLocal_16 = func_155(uParam0, "script@vignette@javier_2@action_b", 8, 0, 0, 0);
	iLocal_17 = func_155(uParam0, "script@vignette@javier_2@action_b_alt_back", 0, 0, 0, 1);
	iLocal_18 = func_155(uParam0, "script@vignette@javier_2@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = func_155(uParam0, "script@vignette@javier_2@action_b_alt_right", 0, 0, 0, 1);
	Local_22 = { func_156(uParam0, 0.0086f, 0.0585f, 0.5012f, -14.4f, 7.425f, 0.3733f, 0.3717f) };
	Local_32 = { func_156(uParam0, 0.0086f, 0.0585f, 0.5012f, -92.84f, 6.3f, 0.5f, 0.5f) };
	Local_42 = { func_156(uParam0, 0.009f, 0.058f, 0.501f, 42.48f, 7.5f, 0.5f, 0.2585f) };
	func_157(uParam0, "CJAV2AU");
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, 1675327700, 1903885572);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (func_200(uParam0, iLocal_17))
	{
		if (func_201(uParam0, iLocal_17, 0.4f))
		{
			...
			func_101(uParam0->f_107[iLocal_14]->f_1, 1, 1, 0);
		}
	}
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_200(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
