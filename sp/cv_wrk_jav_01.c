...
{
	if (_has_scenario_type_loaded(iLocal_27, false))
	{
		_0x4eddd9e9ca5af985(iLocal_27);
	}
	if (_has_scenario_type_loaded(iLocal_28, false))
	{
		_0x4eddd9e9ca5af985(iLocal_28);
	}
	if (_does_scenario_point_exist(iLocal_43))
	{
		_delete_scenario_point(iLocal_43);
	}
	if (_does_scenario_point_exist(iLocal_44))
	{
		_delete_scenario_point(iLocal_44);
	}
	return true;
}
...
{
	if (does_entity_exist(func_22(uParam0, iLocal_18)))
	{
		_0xcaaf2bccfef37f77(func_22(uParam0, iLocal_18), 18);
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	vVar0 = { _get_object_offset_from_coords(vLocal_37, vLocal_40.z, 0.5754f, 1.2328f, 0.6545f) };
	vVar3 = { _get_object_offset_from_coords(vLocal_37, vLocal_40.z, 1.3504f, -0.4797f, 0.6545f) };
	...
	_request_scenario_type(iLocal_27, 15, 0, -1196912204);
	_request_scenario_type(iLocal_28, 15, 0, 1851339470);
	return true;
}
...
{
	if (_has_scenario_type_loaded(iLocal_27, false) && _has_scenario_type_loaded(iLocal_28, false))
	{
		return true;
	}
	return false;
...
{
	if (does_entity_exist(func_22(uParam0, iLocal_21)))
	{
		freeze_entity_position(func_22(uParam0, iLocal_21), true);
	}
	return true;
}
...
{
	vLocal_33 = { _get_object_offset_from_coords(vLocal_37, vLocal_40.z, 1.259f, -0.428f, 0.522f) };
	fLocal_36 = func_155(71.105f, vLocal_40.z);
	vLocal_29 = { _get_object_offset_from_coords(vLocal_37, vLocal_40.z, 0.639f, 1.222f, 0.492f) };
	fLocal_32 = func_155(159.648f, vLocal_40.z);
	iLocal_44 = create_scenario_point(iLocal_28, vLocal_33, fLocal_36, 0, 0, 0);
	iLocal_43 = create_scenario_point(iLocal_27, vLocal_29, fLocal_32, 0, 0, 0);
	if (_does_scenario_point_exist(iLocal_44) && _does_scenario_point_exist(iLocal_43))
	{
		_set_scenario_point_flag(iLocal_44, 23, true);
		_set_scenario_point_flag(iLocal_44, 25, true);
		_set_scenario_point_flag(iLocal_43, 23, true);
		_set_scenario_point_flag(iLocal_43, 25, true);
		func_193(uParam0);
		return true;
	}
	return false;
...
bool func_94(var uParam0)
{
	...
	{
		if ((!bLocal_22 && !is_entity_dead(func_49(uParam0, iLocal_19))) && _does_scenario_point_exist(iLocal_43))
		{
			_task_use_scenario_point(func_49(uParam0, iLocal_19), iLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1f, false);
			set_anim_scene_origin(&(uParam0->f_1984[iLocal_15]), vLocal_37, vLocal_40, 2);
			func_116(&uLocal_24, 0);
			bLocal_22 = true;
		}
		if ((!bLocal_23 && !is_entity_dead(func_49(uParam0, iLocal_20))) && _does_scenario_point_exist(iLocal_44))
		{
			if (func_110(&uLocal_24) > 1.2f)
			{
				_task_use_scenario_point(func_49(uParam0, iLocal_20), iLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1f, false);
				bLocal_23 = true;
			}
		}
	}
	...
	{
		if (!is_entity_dead(func_49(uParam0, iLocal_19)) && !is_entity_dead(func_49(uParam0, iLocal_20)))
		{
			set_ped_can_play_ambient_anims(func_49(uParam0, iLocal_19), false);
			set_ped_can_play_ambient_anims(func_49(uParam0, iLocal_20), false);
			if (_0x02ebbb3989b7e695(func_49(uParam0, iLocal_19)) && _0x02ebbb3989b7e695(func_49(uParam0, iLocal_20)))
			{
				iLocal_45 = get_object_index_from_entity_index(_get_scenario_point_entity(iLocal_44, "p_bottleBeer01x_PH_R_HAND"));
				iLocal_46 = get_object_index_from_entity_index(_get_scenario_point_entity(iLocal_43, "p_bottleJD01x_ph_r_hand"));
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_249(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
{
	uParam0->f_107[iParam1]->f_32.f_13 = iParam2;
}
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_287() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
{
	set_anim_scene_origin(&(uParam0->f_1984[iLocal_15]), vLocal_37, vLocal_40, 2);
	if (_get_anim_scene_entity_matrix(&(uParam0->f_1984[iLocal_15]), "GUITAR", &Var0, false, 0, 2))
	{
		set_entity_coords(func_22(uParam0, iLocal_16), Var0, true, false, true, true);
		set_entity_rotation(func_22(uParam0, iLocal_16), Var0.f_3, 2, true);
		freeze_entity_position(func_22(uParam0, iLocal_16), true);
	}
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_302(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_204(uParam0->f_107[iVar0]->f_1, fVar4);
...
void func_205(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_304(uParam0, iParam1);
	}
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_305(100f, 140f);
			}
		}
...
float func_215(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_309(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_216(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_310(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_218(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_311(iParam0);
	}
...
bool func_247(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_317(&(Global_1898164->f_1[0]));
		if (func_318(iVar0) && func_319((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_320(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_256(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	uParam0->f_23 = { func_327(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
bool func_315()
{
	if (_is_ped_carrying(Global_35) || func_360(Global_35))
	{
		return true;
	}
	return false;
...
int func_334(int iParam0, bool bParam1)
{
	...
	{
		func_239(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_227() == -1)
		{
...
void func_345(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_204(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_349(var uParam0, int iParam1)
{
	...
	func_386(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_350(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_389(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
bool func_369(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_396((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_404(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_405(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_407(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_409(iParam0, Global_1360165[iParam0]);
...
int func_393(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_422(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_420();
				}
			}
			if ((bParam2 && !func_213(vVar0)) && !func_214(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_404((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_423((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_432((*Global_1360165)[iParam0]->f_4.f_2) || func_433((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_434((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_436(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_103(iParam0, 44, 1);
			}
...
void func_404(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_441(Global_35) && is_player_teleport_active())
	{
	}
	if (func_442(iParam0))
	{
		if (func_443(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_422(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_452(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
int func_431(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_396((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_396((*Global_1347702)[63]->f_15, 1) || func_433((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_396((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_396((*Global_1347702)[134]->f_15, 1) || func_433((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_396((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(747937920, 1) && !func_396((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_447(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_411(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_411(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_411(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_411(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_411(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_411(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_411(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_411(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_411(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_411(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_411(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_411(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_411(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_411(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_411(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_411(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_411(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_411(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_411(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_411(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_411(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_411(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_411(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_411(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_411(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_411(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_466(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_477(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_481(0))
				{
					...
					func_482(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<4> func_479(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_497(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_480(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_497(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_481(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_497(bParam0));
}
...
void func_483(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_500(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_493(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_497(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_494(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_497(bParam6), &Var0, 0);
	return uVar4;
}
