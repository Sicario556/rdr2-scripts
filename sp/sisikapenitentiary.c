void __EntryFunction__()
{
	...
	func_1();
	func_2();
	iLocal_28 = get_game_timer();
	iVar0 = 0;
	while (func_3())
	{
		if (get_game_timer() > iLocal_28)
		{
			iLocal_28 = 0;
			...
			switch (iLocal_27)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_29));
					...
					Global_1897950 = -1;
					iLocal_30 = (get_game_timer() + iLocal_26);
					iLocal_27 = 2;
					break;
				case 2:
					if (func_11() || iLocal_30 < get_game_timer())
					{
						func_12(iLocal_29);
						iLocal_30 = (get_game_timer() + iLocal_26);
						iLocal_27 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_29) || iLocal_30 < get_game_timer())
					{
						func_14(iLocal_29);
						iLocal_30 = (get_game_timer() + iLocal_26);
						iLocal_27 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_29) || iLocal_30 < get_game_timer())
					{
						func_16(iLocal_29);
						iLocal_30 = (iLocal_26 + get_game_timer());
						iLocal_27 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_29)))
					{
						if (func_17(func_6(iLocal_29), 4) && !iLocal_30 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_29) || iLocal_30 < get_game_timer())
							{
								func_19(iLocal_29, 4);
								iLocal_30 = (iLocal_26 + get_game_timer());
								iLocal_27 = 7;
							...
							Jump @791; //curOff = 459
							if (iLocal_30 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_29);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_29]->f_10);
							if ((*Global_1888801)[iLocal_29]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_29]->f_11);
							}
							Jump @791; //curOff = 772
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_29]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_29]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_16 = (*Global_1888801)[32]->f_4;
	iLocal_17 = _create_volume_box_with_custom_name(3350.781f, -675.869f, 63.768f, 0f, 0f, 0f, 116.5f, 87.5f, 50f, "Sisika - m_volGTower");
	iVar0 = _create_popzone_from_volume(iLocal_17);
	set_popzone_population_set(iVar0, 414726236);
	_0x7e6bc0b94f5928f0(iVar0, 16, 16);
	_0x0f1861101c9a9944(iVar0, true);
	_0x08892122769770d5(iVar0, true);
	_0x578e2fa64e847c60(iVar0, 0);
	iLocal_18 = _create_volume_aggregate_with_custom_name("Sisika - m_volGBridge");
	_0x39816f6f94f385ad(iLocal_18, 3321.868f, -610.395f, 48.57418f, 0f, 0f, 40f, 15f, 75f, 20f);
	_0x39816f6f94f385ad(iLocal_18, 3319.213f, -584.038f, 47.83653f, 0f, 0f, 40f, 15f, 29f, 20f);
	iVar1 = _create_popzone_from_volume(iLocal_18);
	set_popzone_population_set(iVar1, 414726236);
	_0x7e6bc0b94f5928f0(iVar1, 3, 3);
	_0x0f1861101c9a9944(iVar1, true);
	_0x08892122769770d5(iVar1, true);
	_0x578e2fa64e847c60(iVar1, 0);
	if (!network_is_game_in_progress())
	{
		iLocal_21 = _create_volume_aggregate_with_custom_name("Sisika - m_volGuardThreat Agg");
		_0x39816f6f94f385ad(iLocal_21, 3353.973f, -672.1495f, 63.768f, 0f, 0f, 14.62307f, 68.21951f, 54.663f, 50f);
		_0xbce668aaf83608be(iLocal_21, 3315.974f, -656.2813f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		_0x39816f6f94f385ad(iLocal_21, 3382.837f, -665.3976f, 63.76801f, 0f, 0f, -59.89402f, 51.37444f, 37.32103f, 50f);
		_0x39816f6f94f385ad(iLocal_21, 3381f, -693.5285f, 48.96563f, 0f, 0f, 50.13634f, 11.37222f, 36.9617f, 50f);
		_0x39816f6f94f385ad(iLocal_21, 3364.015f, -686.8185f, 63.76801f, 0f, 0f, 60.3014f, 66.63422f, 46.65413f, 50f);
		_0x39816f6f94f385ad(iLocal_21, 3376.356f, -691.6537f, 63.76801f, 0f, 0f, 50.13634f, 65.99199f, 37.71349f, 50f);
		_0xbce668aaf83608be(iLocal_21, 3328.904f, -704.5117f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 5.205996f, 25.19653f);
		_0xbce668aaf83608be(iLocal_21, 3368.851f, -726.5292f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		_0xbce668aaf83608be(iLocal_21, 3410.578f, -679.0173f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		_0xbce668aaf83608be(iLocal_21, 3386.604f, -637.0076f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		iLocal_20 = _create_volume_aggregate_with_custom_name("Sisika - m_volGuardRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_20, iLocal_21);
		_0xbce668aaf83608be(iLocal_20, 3187.881f, -392.378f, 59.70001f, 0f, 0f, -60.2991f, 106.109f, 89.50376f, 100f);
		_0xbce668aaf83608be(iLocal_20, 3203.627f, -637.6728f, 59.70001f, 0f, 0f, -63.6916f, 207.2567f, 107.2578f, 100f);
		_0xbce668aaf83608be(iLocal_20, 3186.952f, -695.6421f, 59.70001f, 0f, 0f, -63.6916f, 129.2146f, 107.2578f, 100f);
		_0xbce668aaf83608be(iLocal_20, 3297.383f, -592.1081f, 59.70001f, 0f, 0f, -63.6916f, 173.9582f, 92.46152f, 100f);
		_0xbce668aaf83608be(iLocal_20, 3375.808f, -710.6785f, 59.7f, 0f, 0f, -61.08491f, 129.6087f, 116.591f, 100f);
		iLocal_22 = _create_volume_aggregate_with_custom_name("Sisika - m_volGuardWarning Agg");
		_0x6e0d3c3f828da773(iLocal_22, iLocal_20);
		iLocal_19 = _create_volume_aggregate_with_custom_name("Sisika - m_volGuardRegistration Agg");
		_0x6e0d3c3f828da773(iLocal_19, iLocal_22);
		sLocal_23 = "SISIKA";
		_create_guard_zone(sLocal_23);
		_0x8c598a930f471938(sLocal_23, iLocal_19);
		_0xad3e07c37a7c1adc(sLocal_23, iLocal_22);
		_0x35815f372d43e1e5(sLocal_23, iLocal_20);
		_0xa1b0e6301e2e02a6(sLocal_23, iLocal_21);
		_set_guard_zone_position(sLocal_23, 3355.869f, -676.4202f, 49.5715f);
		_0xa8a74aa79fb67159(sLocal_23, iLocal_19);
	}
	return true;
}
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_57(&Global_1935630, 16384)) || func_57(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_60((*uParam0)[iVar3], 1) && func_61(iParam1)) && !func_62(iParam1, 16))
							{
								func_64(iParam1, func_63(), -1, 0, -1, 0);
								func_65((*uParam0)[iVar3], 1);
							}
							func_66(iParam1, 0);
						}
						bVar0 = true;
...
{
	iVar0 = 7;
	uLocal_14[0] = _0x00bbf7ceae8c666a(3360.208f, -678.505f, 41.488f, 60f, iVar0, 16384);
}
...
void func_54()
{
	...
	else if (_0x0dbaca9c38c9a686(sLocal_23))
	{
		bLocal_25 = true;
		_0x75cbf20ba47e4f89(Global_36, -306254848);
	}
}
...
bool func_61(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_96(iParam0));
}
...
void func_66(int iParam0, bool bParam1)
{
	...
	func_116(func_115(-1532769513, -36357794), 1);
...
void func_79(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_129(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_133(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_20() == -1)
		{
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_147(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_113(int iParam0)
{
	...
	if (func_148())
	{
		if (!func_149((*Global_1835011)[3]->f_1, 1))
		{
...
void func_124(int iParam0)
{
	...
	if (!func_118(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_125()
{
	...
	while (iVar0 < 1)
	{
		if (_0xf6a8a652a6b186cd(&(uLocal_14[iVar0])))
		{
			_0xfdfecc6ee4491e11(&(uLocal_14[iVar0]));
		}
		iVar0++;
	}
}
...
{
	func_153(Global_1935369->f_5[iParam0]->f_6, 1);
	func_154(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_85(Global_1914319->f_3[iParam0]->f_21) && func_156(Global_1914319->f_3[iParam0]->f_21))
	{
		func_157(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_158(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_129(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
{
	func_177(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
