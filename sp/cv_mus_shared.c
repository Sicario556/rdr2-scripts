...
bool func_76(var uParam0)
{
	...
	switch (func_20(uParam0))
	{
		...
		case 428:
			...
			_request_scenario_type(iLocal_43, 15, 0, 0);
			break;
		case 429:
			iLocal_22 = func_154(uParam0, 4, 0);
			iLocal_16 = func_154(uParam0, 14, "JackMarston_Teen");
		...
		case 443:
			...
			_request_scenario_type(-1539374245, 1, 0, 0);
		...
		case 444:
			...
			_request_scenario_type(iLocal_43, 1, 0, 0);
			break;
		case 445:
			iLocal_19 = func_154(uParam0, 17, 0);
			iLocal_20 = func_154(uParam0, 8, 0);
	...
	if (func_164(-1))
	{
		func_185(uParam0, get_random_int_in_range(0, uParam0->f_106), "CAMP_SONG_TRANSITION", get_random_int_in_range(2, 4));
	}
	return true;
}
...
bool func_79(var uParam0)
{
	if (iLocal_43 != 0)
	{
		if (_has_scenario_type_loaded(iLocal_43, false))
		{
			return true;
		}
		else
...
bool func_97(var uParam0)
{
	...
	switch (func_20(uParam0))
	{
		case 438:
			...
			{
				if (does_entity_exist(func_227(uParam0, iLocal_34)))
				{
		...
		case 453:
			...
			{
				bLocal_158 = true;
				iLocal_159 = _find_closest_active_scenario_point_of_type(func_229(uParam0, 3.73538f, 2.82993f, -0.2192f), -1147740400, 2.4f, 0, false);
				if (_does_scenario_point_exist(iLocal_159))
				{
					iLocal_160 = _get_scenario_point_entity(iLocal_159, "p_washboard01x_PH_L_HAND");
					set_entity_visible(iLocal_160, false);
				}
			}
			break;
		case 474:
...
bool func_99(var uParam0)
{
	...
	{
		case 453:
			if (bLocal_158 && does_entity_exist(iLocal_160))
			{
				bLocal_158 = false;
				set_entity_visible(iLocal_160, true);
				set_entity_visible(func_227(uParam0, iLocal_157), false);
			}
			break;
	}
	if ((func_164(-1) && !bLocal_150) && !is_string_null_or_empty(sLocal_156))
	{
		func_238();
		if (func_239())
		{
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_277(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_33(uParam0) < 5)
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_278(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_307(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_61(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_308(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_309(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_310(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_201(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_318(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_202(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_320(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_229(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_210(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_229(uParam0, uParam0->f_1976.f_1), 1, func_290(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_215(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_117() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_319() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_334(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_335(uParam0->f_107[iVar0]->f_1, fVar4);
				func_334(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_223(var uParam0)
{
	...
	{
		func_232();
		set_ped_gesture_group(Global_35, "AI_GESTURES@INSTRUMENTS@WHISTLING@120BPM", 1);
		set_ped_can_play_gesture_anims(Global_35, 1, 1);
...
void func_225(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_291(100f, 140f);
			}
		}
...
void func_236(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_226(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_240(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_entity_dead(func_52(uParam0, iParam1)))
	{
		return;
	}
...
float func_244(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_347(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_245(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_348(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_247(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_349(iParam0);
	}
...
bool func_276(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_355(&(Global_1898164->f_1[0]));
		if (func_356(iVar0) && func_357((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_358(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_283(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (!does_entity_exist(func_52(uParam0, iVar1)))
		{
		}
		else if (!is_entity_occluded(func_52(uParam0, iVar1)))
		{
			iVar0 = 0;
		}
		else
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_54(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_368(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_369(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_369(uParam0, 1, 0);
							}
						}
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_370(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_297(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_371(iVar1)))
			{
				func_372(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_373(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_304(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_229(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_312(var uParam0, int iParam1)
{
	...
	else if (!func_375(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_331(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_381(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_337(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_241(iVar0, 2))
		{
			if (func_243(vParam2, (*Global_1945938)[iVar0]->f_6, 0.01f, 1) && iParam1 == (*Global_1945938)[iVar0]->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	if (iVar1 != 0)
	{
		func_384(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
void func_339(var uParam0)
{
	...
	{
		_0x79f9c57b8d0dfe90(&cLocal_146, uParam0->f_2046);
		func_8(&iLocal_45, 1, 1);
		iLocal_45 = func_337(sLocal_47, -473983589, func_229(uParam0, 0f, 0f, 0f), 40f, 1, 0, 0, 4, 570, 4000, 10, 1073741824, 0, 1704213876, 0);
		if (!func_327(-1))
		{
...
bool func_340(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_347(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_343(var uParam0, int iParam1)
{
	...
	{
		if (!func_375(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
int func_371(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_308(iParam0), 0);
}
...
int func_372(int iParam0, bool bParam1)
{
	...
	{
		func_268(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_256() == -1)
		{
...
void func_386(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_335(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_390(var uParam0, int iParam1)
{
	...
	func_434(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_391(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_437(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_393(var uParam0, int iParam1)
{
	...
	{
		func_309(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
bool func_413(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_444((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_452(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_453(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_455(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_457(iParam0, Global_1360165[iParam0]);
...
int func_441(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_470(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_468();
				}
			}
			if ((bParam2 && !func_242(vVar0)) && !func_243(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_452((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_471((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_480((*Global_1360165)[iParam0]->f_4.f_2) || func_481((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_482((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_484(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_107(iParam0, 44, 1);
			}
...
void func_452(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_489(Global_35) && is_player_teleport_active())
	{
	}
	if (func_490(iParam0))
	{
		if (func_491(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_458(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_266(iParam0)))
	{
		return false;
	}
...
bool func_469(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_318(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_470(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_500(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
int func_479(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_444((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_444((*Global_1347702)[63]->f_15, 1) || func_481((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_444((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_444((*Global_1347702)[134]->f_15, 1) || func_481((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_444((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_364(747937920, 1) && !func_444((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_495(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_459(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_459(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_459(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_459(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_459(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_459(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_459(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_459(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_459(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_459(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_459(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_459(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_459(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_459(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_459(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_459(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_459(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_459(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_459(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_459(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_459(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_459(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_459(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_459(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_459(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_459(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_514(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
struct<4> func_527(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_545(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_528(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_545(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_529(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_545(bParam0));
}
...
void func_531(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_548(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_541(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_545(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_542(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_545(bParam6), &Var0, 0);
	return uVar4;
}
