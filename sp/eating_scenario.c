...
void func_6()
{
	if (is_ped_injured(Global_35) || !is_ped_using_any_scenario(Global_35))
	{
		iLocal_0 = 0;
		return;
	}
...
void func_14(int iParam0, bool bParam1)
{
	...
	if (func_36(iParam0) == 2085633299)
	{
		...
		while (iVar29 < Var0)
		{
			...
			{
				fVar36 = func_46(to_float(Var22.f_3), Var22.f_4);
				func_47(19, fVar36);
				bVar41 = true;
			}
...
void func_25(int iParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = func_58(ceil(&(Global_40.f_11095[iParam0])));
	_set_attribute_core_value(Global_35, func_59(iParam0), iVar0);
	func_61(func_60(iParam0), (100f * (to_float(iVar0) / 100f)), 0);
	if (((fParam1 <= func_62(15) && iParam0 == 1) && is_ped_on_foot(Global_35)) && !is_ped_swimming(Global_35))
	{
		func_34(84, 1);
	}
	if (fParam1 <= -99.999f)
...
void func_33(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_58(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
{
	return func_85(to_float(iParam0), fParam1);
}
...
int func_51(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	{
		_set_attribute_core_value(iVar0, func_59(iParam0), ceil(fParam1));
		return 1;
	}
	else
	{
...
{
	return (shift_right(iParam0, 26) & 31 * func_101(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_86(int iParam0)
{
	...
	return func_118((*Global_1347702)[58]->f_15, 1);
}
...
void func_90(int iParam0)
{
	...
	iVar1 = func_120(2);
	func_121(to_float((iParam0 * iVar1)), 0);
}
...
void func_92(int iParam0)
{
	...
	iVar1 = func_123(2);
	func_124(to_float((iParam0 * iVar1)));
}
...
void func_93(int iParam0)
{
	...
	iVar1 = func_125(2);
	func_126(to_float((iParam0 * iVar1)), 0);
}
