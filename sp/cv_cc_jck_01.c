...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 318845623, 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	func_153(uParam0, 1286899977, 0f, 0f, 0f, "NAIL", 0, 0, 1);
	func_153(uParam0, 1052976054, 0f, 0f, 0f, "NAILBOX", 0, 0, 1);
	func_153(uParam0, 1810315535, 0f, 0f, 0f, "STICK", 0, 0, 1);
	if (func_148(uParam0) == 1)
	{
		func_153(uParam0, 1286899977, 0f, 0f, 0f, "NAIL1", 0, 0, 1);
		func_153(uParam0, 1286899977, 0f, 0f, 0f, "NAIL2", 0, 0, 1);
...
bool func_84(var uParam0)
{
	if (func_148(uParam0) == 1)
	{
		_set_scenario_group_enabled_hash(570969137, false);
	}
	return true;
}
...
bool func_93(var uParam0)
{
	if (func_195(uParam0, iLocal_16))
	{
		if (func_196(uParam0, Local_20, 1, 0))
		{
			...
			_0x3946fc742ac305cd(get_player_index(), func_48(uParam0, iLocal_15), "CCJCK_CNV_1", 0f, 0f, 0f, 0, 0);
...
bool func_96(var uParam0)
{
	if (func_148(uParam0) == 1)
	{
		if (!_is_scenario_group_enabled_hash(570969137))
		{
			if (is_sphere_visible(-110.1304f, -45.78891f, 94.60996f, 1f))
			{
			...
			{
				_set_scenario_group_enabled_hash(570969137, true);
				return true;
			}
			return false;
		}
