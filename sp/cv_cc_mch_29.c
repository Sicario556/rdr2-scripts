...
{
	if (does_entity_exist(func_195(uParam0, iLocal_17)))
	{
		set_entity_coords(func_195(uParam0, iLocal_17), 2353.81f, 1373.03f, 105.131f, true, false, true, true);
		set_entity_rotation(func_195(uParam0, iLocal_17), 0f, 0f, 17.515f, 2, true);
	}
	return true;
}
