...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.25767f, -1.88347f, 0.494652f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1877049591, 1, 1, 1);
	func_151(uParam0, -1.26148f, -1.69011f, 0.479202f, 0f, 1.5f, 1.5f, 3f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, 0f, -1.8f, 0f, -9f, 1.75f, 0.89f, 3f, 665633627, 1);
	func_153(uParam0, "script@vignette@uncle_2@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@uncle_2@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@uncle_2@action_b_alt_left", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@uncle_2@action_b_alt_right", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@uncle_2@action_b_alt_back", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@uncle_2@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CCUN2AU");
	func_155(uParam0, -138843134, -605868339);
	func_156(uParam0, iLocal_15, 3, -38747227, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0);
	func_156(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	...
	Local_21 = { func_161(uParam0, -1.2615f, -1.6901f, 0.4792f, 6.83f, 7f, 0.4f, 0.4f) };
	Local_31 = { func_161(uParam0, -1.261f, -1.69f, 0.479f, -65.16f, 7f, 0.4f, 0.4f) };
	Local_41 = { func_161(uParam0, -1.261f, -1.69f, 0.479f, -137.17f, 7f, 0.4f, 0.4f) };
	Local_51 = { func_161(uParam0, -1.261f, -1.69f, 0.479f, 114.84f, 7f, 0.8f, 0.8f) };
	func_162(uParam0, 1);
...
bool func_93(var uParam0)
{
	if (func_200(uParam0, iLocal_16))
	{
		...
		else if (func_201(uParam0, Local_41, 1, 0) || func_201(uParam0, Local_51, 1, 0))
		{
...
void func_158(var uParam0, int iParam1, char* sParam2)
{
	if (!is_string_null_or_empty(sParam2))
	{
