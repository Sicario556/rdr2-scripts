		...
		else
		{
			switch (iVar583)
			{
				case 1:
					...
					{
						func_9(&Local_29, &uLocal_589, &uLocal_590);
						Local_29.f_51.f_4 = iVar588;
						func_11(&Local_29, iVar587, 1560);
						func_12(iVar587, iVar588, &iLocal_14);
						func_13(iLocal_14);
						if (!Local_29.f_161)
						{
						...
						func_17(&Local_29, &uLocal_589, &uLocal_590);
						func_18(&uLocal_557);
						func_19(&Local_16);
						func_20(&Local_231, &vLocal_532, &vLocal_536, &vLocal_543, &uLocal_535);
				...
				case 0:
					...
					else if (!func_23(vdist(Global_36, Local_29.f_51), Local_29.f_3))
					{
						func_6();
					}
					break;
				case 3:
					if (func_24(0, 1))
					{
						...
						func_27(iLocal_14, &(Local_939[0]->f_21));
						func_27(iLocal_14, &(Local_939[1]->f_21));
						func_28();
						iLocal_585 = 4;
					}
					break;
...
void func_6()
{
	...
	func_35();
	if (does_entity_exist(&(uLocal_600[2])))
	{
		_0x39a2fc5af55a52b1(&(uLocal_600[2]), -1);
		_0x36e4b61dc56de77c(&(uLocal_600[2]), 7f, 20f, 5000, 10000);
		set_ped_as_no_longer_needed(uLocal_600[2]);
	}
	if (does_entity_exist(&(uLocal_600[3])))
	{
		_0x39a2fc5af55a52b1(&(uLocal_600[3]), -1);
		_0x36e4b61dc56de77c(&(uLocal_600[3]), 7f, 20f, 5000, 10000);
		set_ped_as_no_longer_needed(uLocal_600[3]);
	}
	...
	if (_does_volume_exist(&(uLocal_620[5])))
	{
		_0x2c87c3e1c7b96ee2(&(uLocal_620[5]));
	...
	{
		set_blocking_of_non_temporary_events(&(uLocal_600[0]), false);
	}
	if (func_40(&(uLocal_600[1]), 0, 1))
	{
		set_blocking_of_non_temporary_events(&(uLocal_600[1]), false);
	}
	...
	if (iVar647 != -1)
	{
		remove_shocking_event(iVar647);
	}
	func_45(&Local_29, &uLocal_600, &uLocal_605, iLocal_14, uVar587, uVar588, 0, 1, func_44(), 1);
...
void func_16(var uParam0, var uParam1)
{
	switch (iLocal_14)
	{
		...
		case 0:
			...
			_0x19c7567d2f2287d6(uParam0[5], 7);
			...
			(*uParam0)[7] = _0x0eb78c2b156635b1(-1612834106, -1784.348f, -404.57f, 156.708f, 0f, 0f, 0f, 1f, 2f, 3f);
			break;
	}
	iVar0 = 0;
	while (iVar0 < 8)
		...
		case 1:
			switch (*uParam2)
			{
				case 0:
					...
					_0xbce668aaf83608be(uParam0->f_173, -1756.639f, -403.6233f, 154.3729f, 0f, 0f, 10f, 20f, 20f, 5f);
					_0xbce668aaf83608be(uParam0->f_173, -1785.022f, -422.8229f, 154.3905f, 0f, 0f, 0.1f, 20f, 20f, 5f);
					break;
			}
			break;
	}
...
void func_19(var uParam0)
{
	if (iLocal_14 == 0)
	{
		(*uParam0)[0]->f_7 = -1751465382;
	}
	else if (iLocal_14 == 2)
	{
		(*uParam0)[0]->f_7 = 548396801;
	}
}
...
void func_20(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	{
		case 0:
			(*uParam0)[2]->f_6 = { 0.02f, -1.51f, 0f };
			(*uParam0)[2]->f_9 = 270.3835f;
			func_57(&((*uParam0)[2]->f_22));
			(*uParam0)[0]->f_6 = { 2.11f, -3.6f, 0f };
			(*uParam0)[0]->f_9 = 358.5339f;
			func_57(&((*uParam0)[0]->f_22));
			(*uParam0)[1]->f_6 = { 3f, -3.45f, 0f };
			(*uParam0)[1]->f_9 = 358.5339f;
			func_57(&((*uParam0)[1]->f_22));
			*uParam1 = { -1784.205f, -404.1717f, 155.4638f };
			*(*uParam2)[0] = { -1775.225f, -400.4953f, 155.4706f };
			*(*uParam2)[1] = { -1770.009f, -397.7302f, 155.0929f };
			*uParam3 = { -1778.943f, -400.5291f, 155.4879f };
			*uParam4 = 0f;
			break;
		case 1:
			(*uParam0)[2]->f_6 = { -2.13f, -1.23f, 0.01f };
			(*uParam0)[2]->f_9 = 263.8729f;
			(*uParam0)[3]->f_6 = { -1.65f, -1.25f, 0.01f };
			(*uParam0)[3]->f_9 = 263.8729f;
			(*uParam0)[0]->f_6 = { 0f, 0f, 0f };
			(*uParam0)[0]->f_9 = 82.6332f;
			(*uParam0)[1]->f_6 = { 0f, 0f, 0f };
			(*uParam0)[1]->f_9 = 82.6332f;
			*uParam1 = { -285.8419f, 865.4821f, 120.2342f };
			*(*uParam2)[0] = { -293.1871f, 835.0521f, 119.1021f };
			*(*uParam2)[1] = { -293.1871f, 835.0521f, 119.1021f };
			*uParam3 = { -287.2625f, 867.8655f, 120.1367f };
			*uParam4 = 84.75f;
			break;
		case 2:
			(*uParam0)[2]->f_6 = { -0.06f, 2.19f, 1.26f };
			(*uParam0)[2]->f_9 = 275.4f;
			(*uParam0)[3]->f_6 = { -0.06f, 2.19f, 1.26f };
			(*uParam0)[3]->f_9 = 275.4f;
			(*uParam0)[0]->f_6 = { 0f, 0f, 0f };
			(*uParam0)[0]->f_9 = 181.3992f;
			(*uParam0)[1]->f_6 = { 0f, 0f, 0f };
			(*uParam0)[1]->f_9 = 181.3992f;
			*uParam1 = { -260.9178f, 733.0137f, 118.1432f };
			*uParam3 = { -275.0332f, 727.3121f, 115.9876f };
			*(*uParam2)[0] = { -251.8502f, 735.5443f, 117.1832f };
			*(*uParam2)[1] = { -251.8502f, 735.5443f, 117.1832f };
			*uParam4 = -180f;
			break;
	}
}
	...
	switch (iVar581)
	{
		case 0:
			if (func_70(&Local_29))
			{
				...
				if (iLocal_14 == 0)
				{
					request_model(-1025740342, false);
					_0x72d4cb5db927009c(1845102363, -1, 0);
					request_waypoint_recording("re_peeping_tom_str");
				}
				if (iLocal_14 == 1)
				{
					request_model(1707504472, false);
				}
				iLocal_583 = 1;
			}
			break;
		case 1:
			...
			if (iLocal_14 == 0)
			{
				...
				if (!has_model_loaded(-1025740342))
				{
					return false;
				}
				if (!get_is_waypoint_recording_loaded("re_peeping_tom_str"))
				{
					return false;
				}
			}
			if (iLocal_14 == 1)
			{
				if (!request_script_audio_bank("PEEPING_TOM"))
				{
					return false;
				}
				if (!has_model_loaded(1707504472))
				{
					return false;
				}
			}
			...
			while (iVar0 < 4)
			{
				if (Local_231[iVar0]->f_1 != 0)
				{
					if (!has_model_loaded(Local_231[iVar0]->f_1))
					{
						return false;
					}
				}
			...
			if (!_is_anim_scene_loaded(Local_223, true, false))
			{
				return false;
			}
			return true;
...
void func_25()
{
	...
	while (iVar0 < 4)
	{
		...
		{
			_request_ped_emotional_preset(&(uLocal_600[iVar0]), func_84(iLocal_14, iVar0));
			set_ped_config_flag(&(uLocal_600[iVar0]), 146, true);
			set_ped_config_flag(&(uLocal_600[iVar0]), 355, true);
			remove_all_ped_weapons(&(uLocal_600[iVar0]), true, true);
		}
		iVar0++;
	}
...
int func_26(vector3 vParam0, int iParam3, float fParam4, bool bParam5, int iParam6, int iParam7, bool bParam8)
{
	...
	while (iVar0 <= iParam7)
	{
		...
		else if ((*iParam3)[iVar0]->f_7 != 0 && !func_86((*iParam3)[iVar0]->f_11, 16))
		{
			...
			else
			{
				if ((*iParam3)[iVar0]->f_9 != -1)
				{
					...
					if (func_86((*iParam3)[iVar0]->f_11, 64))
					{
				...
				{
					if (!func_86((*iParam3)[iVar0]->f_11, 8))
					{
					...
					if (!func_86((*iParam3)[iVar0]->f_11, 128))
					{
						func_87(&vVar5, (*iParam3)[iVar0]->f_10);
					}
					if (func_86((*iParam3)[iVar0]->f_11, 64))
					{
						(*iParam3)[iVar0]->f_8 = create_object_no_offset((*iParam3)[iVar0]->f_7, vVar5, true, true, false, false);
					...
					if (func_86((*iParam3)[iVar0]->f_11, 4))
					{
				...
				if (func_86((*iParam3)[iVar0]->f_11, 2))
				{
					freeze_entity_position((*iParam3)[iVar0]->f_8, true);
				}
				if (func_86((*iParam3)[iVar0]->f_11, 32))
				{
...
{
	func_91((*uParam1)[0], func_90(7), "", -163964935, 0, 0, 0, 1, 0);
	func_91((*uParam1)[1], func_90(10), "", 648122183, 0, 0, 0, 1, 0);
...
void func_28()
{
	...
	{
		case 2:
			set_anim_scene_origin(Local_223, -262.63f, 734.317f, 117.177f, 0f, 0f, 110f, 2);
			break;
		case 1:
			set_anim_scene_origin(Local_223, -291.671f, 866.743f, 120.138f, 0f, 0f, 79.247f, 2);
			break;
		case 0:
			set_anim_scene_origin(Local_223, vVar0, 0f, 0f, fVar533, 2);
			break;
	}
	if (func_40(&(uLocal_600[0]), 0, 1))
	{
		set_anim_scene_entity(Local_223, func_93(0), &(uLocal_600[0]), 0);
	}
	if (func_40(&(uLocal_600[1]), 0, 1))
	{
		set_anim_scene_entity(Local_223, func_93(1), &(uLocal_600[1]), 0);
	}
	start_anim_scene(Local_223);
}
...
void func_30()
{
	if (!Local_29.f_46)
	{
		if (func_104(&uLocal_600, &(Local_29.f_5), &uLocal_650, &uLocal_597, 0, 1, 1))
		{
			Local_29.f_46 = 1;
			if (func_105())
			{
				func_106(&uLocal_591, &vLocal_536);
			}
			else
			{
				func_107(&uLocal_591, &vLocal_536);
			}
			switch (iVar648)
			{
				case 8:
			...
			func_112(&(Local_939[0]->f_21), 0, 0);
			func_112(&(Local_939[1]->f_21), 0, 0);
			func_113(&uLocal_915, 12);
			func_38(&(uLocal_620[7]));
			if (iVar582 < 5)
			{
				func_114(&uLocal_584, 13);
			}
			else
			{
				func_114(&uLocal_584, 11);
			}
		}
	}
	if (iVar582 == 11)
	{
		if (!func_115(131072))
		{
			...
			else if (is_shocking_event_in_sphere(2044016570, vLocal_532, 5f))
			{
				func_116();
				func_109(131072);
			}
...
bool func_31()
{
	if (iVar582 > 2)
	{
		...
		func_120(0, &uLocal_916, 536870912);
		func_120(1, &uLocal_917, 1073741824);
	}
	switch (iVar582)
	{
		case 0:
			func_114(&uLocal_584, 1);
			break;
		case 1:
			if (func_121())
			{
				if (!_0x1f0e401031e20146(Local_223, "pblIdles"))
				{
					_set_anim_scene_playback_list_bool(Local_223, "pblIdles", true);
				}
				else
				{
					func_114(&uLocal_584, 2);
				}
			}
			break;
		case 2:
			...
			if (func_124(&Local_29, 2f, 1114636288, func_123(), 1, 0, 1, -1082130432, 1, 1125515264, 0, 0))
			{
				...
				func_114(&uLocal_584, 3);
			}
			break;
		case 3:
			if (func_122())
			{
				func_114(&uLocal_584, 4);
			}
			break;
		case 4:
			func_125();
			if (func_24(2, 3))
			{
				if (func_126())
				{
					func_127();
					func_128();
					if (!_0x1f0e401031e20146(Local_223.f_1, "pblIdles"))
					{
						_set_anim_scene_playback_list_bool(Local_223.f_1, "pblIdles", true);
						func_114(&uLocal_584, 5);
					}
				}
			}
			break;
		case 5:
			if ((!does_blip_exist(&(uLocal_605[0])) && !func_115(64)) && func_129(Global_35, &(uLocal_600[0]), 1, 10f, 0))
			{
				func_109(64);
			...
			if (func_132())
			{
				...
				func_114(&uLocal_584, 10);
			}
			break;
		case 10:
			func_135();
			if (iVar914 >= 10 && iVar915 >= 10)
			{
				bVar0 = true;
			}
			if ((is_entity_dead(&(uLocal_600[0])) || func_136(&(uLocal_600[0]), vLocal_532, 1) > 4f) && (is_entity_dead(&(uLocal_600[1])) || func_136(&(uLocal_600[1]), vLocal_532, 1) > 4f))
			{
				bVar0 = true;
			}
			if (bVar0)
...
void func_35()
{
	...
	if (!_does_anim_scene_exist(Local_223.f_1))
	{
		return;
	}
	if (!_is_anim_scene_started(Local_223.f_1, false))
	{
		return;
	}
	...
	vVar3 = { 0f, 0f, 110f };
	fVar6 = 0f;
	if (!is_entity_dead(&(uLocal_600[2])))
	{
		if (_0x3ab6c7b0bb0df4b1(&(uLocal_600[2]), Local_223.f_1))
		{
			if (is_entity_playing_anim(&(uLocal_600[2]), &(Local_497[9]), Local_497[9]->f_1, 1))
			{
				iVar7 = 9;
				iVar8 = 133;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[2]), &(Local_497[9]), Local_497[9]->f_1);
			}
			else if (is_entity_playing_anim(&(uLocal_600[2]), &(Local_497[11]), Local_497[11]->f_1, 1))
			{
				iVar7 = 11;
				iVar8 = 134;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[2]), &(Local_497[11]), Local_497[11]->f_1);
			}
			else if (is_entity_playing_anim(&(uLocal_600[2]), &(Local_497[13]), Local_497[13]->f_1, 1))
			{
				iVar7 = 13;
				iVar8 = 134;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[2]), &(Local_497[13]), Local_497[13]->f_1);
			}
			else
			{
				iVar7 = 9;
			...
			set_entity_collision(&(uLocal_600[2]), false, false);
			task_play_anim_advanced(&(uLocal_600[2]), &(Local_497[iVar7]), Local_497[iVar7]->f_1, vVar0, vVar3, 16f, -8f, -1, iVar8, fVar6, 2, 17317919, 0);
			set_ped_keep_task(&(uLocal_600[2]), true);
		}
	}
	if (!is_entity_dead(&(uLocal_600[3])))
	{
		if (_0x3ab6c7b0bb0df4b1(&(uLocal_600[3]), Local_223.f_1))
		{
			if (is_entity_playing_anim(&(uLocal_600[3]), &(Local_497[10]), Local_497[10]->f_1, 1))
			{
				iVar7 = 10;
				iVar8 = 133;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[3]), &(Local_497[10]), Local_497[10]->f_1);
			}
			else if (is_entity_playing_anim(&(uLocal_600[3]), &(Local_497[12]), Local_497[12]->f_1, 1))
			{
				iVar7 = 12;
				iVar8 = 134;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[3]), &(Local_497[12]), Local_497[12]->f_1);
			}
			else if (is_entity_playing_anim(&(uLocal_600[3]), &(Local_497[14]), Local_497[14]->f_1, 1))
			{
				iVar7 = 14;
				iVar8 = 134;
				fVar6 = _get_entity_anim_current_time(&(uLocal_600[3]), &(Local_497[14]), Local_497[14]->f_1);
			}
			else
			{
				iVar7 = 10;
			...
			set_entity_collision(&(uLocal_600[3]), false, false);
			task_play_anim_advanced(&(uLocal_600[3]), &(Local_497[iVar7]), Local_497[iVar7]->f_1, vVar0, vVar3, 16f, -8f, -1, iVar8, fVar6, 2, 17317919, 0);
			set_ped_keep_task(&(uLocal_600[3]), true);
		}
	}
	if (does_entity_exist(Local_16[0]->f_8))
	{
		if (_0x3ab6c7b0bb0df4b1(Local_16[0]->f_8, Local_223.f_1))
		{
			Var9.f_4 = 1065353216;
			Var9.f_5 = 1065353216;
			Var9.f_9 = 1065353216;
			...
			Var9.f_17 = 16f;
			Var9.f_22 = 1;
			Var9.f_1 = &Local_497[16];
			if (func_115(262144))
			{
				Var9.f_2 = Local_497[16]->f_1;
				Var9.f_20 = 262;
			}
			else
			{
				Var9.f_2 = Local_497[15]->f_1;
				Var9.f_20 = 261;
			}
			if (is_entity_playing_anim(Local_16[0]->f_8, Var9.f_1, Var9.f_2, 1))
			{
				Var9.f_3 = _get_entity_anim_current_time(Local_16[0]->f_8, Var9.f_1, Var9.f_2);
			}
			if (is_entity_attached_to_any_ped(Local_16[0]->f_8))
			{
				detach_entity(Local_16[0]->f_8, true, true);
			}
			play_entity_scripted_anim(Local_16[0]->f_8, &Var9);
			if (!_0x0b7cb1300cbfe19c(Local_16[0]->f_8, 1))
			{
				delete_object(&(Local_16[0]->f_8));
			}
		}
	}
}
...
void func_36(var uParam0, bool bParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (does_entity_exist(uParam0[iVar0]) && !is_entity_dead(uParam0[iVar0]))
		{
			if (bParam1)
			{
			}
			set_ped_config_flag(uParam0[iVar0], 448, !bParam1);
		}
		iVar0++;
	}
}
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_151(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
...
int func_47(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_172(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
...
bool func_48(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_176(iParam1, func_175(uParam0), &(uParam0->f_172)))
		{
...
void func_50(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_49(uParam0->f_3, 1))
	{
		func_178(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
void func_71(var uParam0)
{
	...
	{
		case 0:
			(*uParam0)[0]->f_1 = -546133941;
			(*uParam0)[0] = 4;
			StringCopy(&((*uParam0)[0]->f_23), "0925_A_M_M_Civ_Poor_White_AVOID_08", 64);
			(*uParam0)[0]->f_3 = -2101093034;
			(*uParam0)[1]->f_1 = -546133941;
			(*uParam0)[1] = 4;
			StringCopy(&((*uParam0)[1]->f_23), "0924_A_M_M_Civ_Poor_White_AVOID_07", 64);
			(*uParam0)[1]->f_3 = 1906981667;
			(*uParam0)[2]->f_1 = 533829074;
			(*uParam0)[2] = 5;
			StringCopy(&((*uParam0)[2]->f_23), "PEEPED_WOMAN", 64);
			(*uParam0)[2]->f_3 = 1149397788;
			break;
		case 2:
			(*uParam0)[0]->f_1 = -546133941;
			(*uParam0)[0] = 4;
			StringCopy(&((*uParam0)[0]->f_23), "0644_A_M_M_Civ_Poor_White_AGGRESSIVE_19", 64);
			(*uParam0)[0]->f_3 = 681302568;
			(*uParam0)[1]->f_1 = -546133941;
			(*uParam0)[1] = 4;
			StringCopy(&((*uParam0)[1]->f_23), "0643_A_M_M_Poor_White_02", 64);
			(*uParam0)[1]->f_3 = -1426399484;
			(*uParam0)[2]->f_1 = -546133941;
			(*uParam0)[2] = 4;
			StringCopy(&((*uParam0)[2]->f_23), "OPIUM_MAN", 64);
			(*uParam0)[2]->f_3 = 787636659;
			(*uParam0)[3]->f_1 = 533829074;
			(*uParam0)[3] = 5;
			StringCopy(&((*uParam0)[3]->f_23), "OPIUM_WOMAN", 64);
			(*uParam0)[3]->f_3 = -332119951;
			break;
		case 1:
			(*uParam0)[0]->f_1 = -546133941;
			(*uParam0)[0] = 4;
			StringCopy(&((*uParam0)[0]->f_23), "0838_S_M_M_MarketVendor_01_WHITE_01", 64);
			(*uParam0)[0]->f_3 = -986147997;
			(*uParam0)[1]->f_1 = -546133941;
			(*uParam0)[1] = 4;
			StringCopy(&((*uParam0)[1]->f_23), "0816_A_M_M_ValLaborer_01_WHITE_01", 64);
			(*uParam0)[1]->f_3 = 912389556;
			(*uParam0)[2]->f_1 = -546133941;
			(*uParam0)[2] = 4;
			StringCopy(&((*uParam0)[2]->f_23), "SPANKED_COWBOY", 64);
			(*uParam0)[2]->f_3 = 2135582760;
			(*uParam0)[3]->f_1 = 533829074;
			(*uParam0)[3] = 5;
			StringCopy(&((*uParam0)[3]->f_23), "SPANKING_WIFE", 64);
			(*uParam0)[3]->f_3 = 1883654295;
			break;
	}
}
...
void func_72(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_187(&((*uParam0)[iVar0]->f_1));
		func_187(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
void func_74(var uParam0, var uParam1)
{
	if (iLocal_14 == 0)
	{
		(*uParam0)[0] = "script_re@peep_tom@topless_woman";
		(*uParam0)[0]->f_1 = "peepers_breakout_left_peeper01";
		(*uParam0)[1] = "script_re@peep_tom@topless_woman";
		(*uParam0)[1]->f_1 = "peepers_breakout_left_peeper02";
		(*uParam0)[2] = "script_re@peep_tom@topless_woman";
		(*uParam0)[2]->f_1 = "PEEPERS_BREAKOUT_RIGHT_ALT_PEEPER01";
		(*uParam0)[3] = "script_re@peep_tom@topless_woman";
		(*uParam0)[3]->f_1 = "PEEPERS_BREAKOUT_RIGHT_ALT_PEEPER02";
	}
	else if (iLocal_14 == 1)
	{
		(*uParam0)[0] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[0]->f_1 = "peepers_breakout_left_peeper01";
		(*uParam0)[1] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[1]->f_1 = "peepers_breakout_left_peeper02";
		(*uParam0)[2] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[2]->f_1 = "peepers_breakout_right_peeper01";
		(*uParam0)[3] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[3]->f_1 = "peepers_breakout_right_peeper02";
		(*uParam0)[4] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[4]->f_1 = "spanking_breakout_cowboy";
		(*uParam0)[5] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[5]->f_1 = "spanking_breakout_female";
		(*uParam0)[6] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[6]->f_1 = "spanking_breakout_curtains";
		(*uParam0)[7] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[7]->f_1 = "spanking_breakout_cig";
		(*uParam0)[8] = "script_re@peep_tom@spanking_cowboy";
		(*uParam0)[8]->f_1 = "SPANKING_IDLE_CURTAINS";
	}
	else if (iLocal_14 == 2)
	{
		(*uParam0)[0] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[0]->f_1 = "peepers_breakout_left_peeper01";
		(*uParam0)[1] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[1]->f_1 = "peepers_breakout_left_peeper02";
		(*uParam0)[2] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[2]->f_1 = "peepers_breakout_right_peeper01";
		(*uParam0)[3] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[3]->f_1 = "peepers_breakout_right_peeper02";
		(*uParam0)[9] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[9]->f_1 = "SMOKING_IDLE_MALE";
		(*uParam0)[10] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[10]->f_1 = "SMOKING_IDLE_FEMALE";
		(*uParam0)[11] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[11]->f_1 = "SMOKING_EXIT_MALE";
		(*uParam0)[12] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[12]->f_1 = "SMOKING_EXIT_FEMALE";
		(*uParam0)[13] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[13]->f_1 = "SMOKING_EXIT_IDLE_MALE";
		(*uParam0)[14] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[14]->f_1 = "SMOKING_EXIT_IDLE_FEMALE";
		(*uParam0)[15] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[15]->f_1 = "SMOKING_IDLE_PIPE";
		(*uParam0)[16] = "script_re@peep_tom@smoking_opium";
		(*uParam0)[16]->f_1 = "SMOKING_EXIT_PIPE";
	}
	func_188(uParam0[0], uParam1);
}
...
void func_75(int iParam0)
{
	...
	*iParam0 = _create_anim_scene(iParam0->f_4, 0, "pblIdles", false, true);
	if (!is_string_null_or_empty(iParam0->f_4))
	{
...
bool func_82(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, float fParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= iParam7)
	{
		if ((*uParam2)[iVar0]->f_1 != 0)
		{
			if (bParam3 && !func_194(&((*uParam2)[iVar0]->f_22)))
			{
				vVar3 = { _get_object_offset_from_coords(uParam0->f_51, uParam0->f_51.f_3, (*uParam2)[iVar0]->f_6) };
				fVar1 = func_89((uParam0->f_51.f_3 + (*uParam2)[iVar0]->f_9));
			}
			else
			{
				vVar3 = { (*uParam2)[iVar0]->f_6 };
				fVar1 = func_89((*uParam2)[iVar0]->f_9);
			}
			if (!func_195(&((*uParam2)[iVar0]->f_22)))
			{
				func_196(&vVar3, 1, 10, 0);
			}
			if ((*uParam2)[iVar0]->f_12 != 0)
			{
				if (!(*uParam2)[iVar0]->f_19 && !func_194(&((*uParam2)[iVar0]->f_22)))
				{
					vVar6 = { _get_object_offset_from_coords(uParam0->f_51, uParam0->f_51.f_3, (*uParam2)[iVar0]->f_15) };
					fVar2 = func_89((uParam0->f_51.f_3 + (*uParam2)[iVar0]->f_18));
					func_196(&vVar6, 1, 10, 0);
				}
				else
				{
					vVar6 = { (*uParam2)[iVar0]->f_15 };
					fVar2 = func_89((*uParam2)[iVar0]->f_18);
				}
				func_197(uParam1, iVar0 + 15, (*uParam2)[iVar0]->f_12, vVar6, fVar2, iParam4, fParam5, 0, 1, 0);
			}
			func_197(uParam1, iVar0, (*uParam2)[iVar0]->f_1, vVar3, fVar1, iParam4, fParam5, (*uParam2)[iVar0]->f_2, 1, (*uParam2)[iVar0]->f_5);
		}
		iVar0++;
	}
	return true;
...
bool func_83(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (func_198(uParam0, 1))
	{
		...
		while (iVar0 <= iParam6)
		{
			if (!does_entity_exist(uParam2[iVar0]) && (*uParam1)[iVar0]->f_1 != 0)
			{
				(*uParam2)[iVar0] = func_199(uParam0, iVar0);
				if (!is_entity_dead(uParam2[iVar0]))
				{
					if ((*uParam1)[iVar0]->f_12 != 0)
					{
						(*uParam1)[iVar0]->f_11 = func_199(uParam0, iVar0 + 15);
						func_200(&((*uParam1)[iVar0]->f_11), (*uParam1)[iVar0], bParam3, 1);
						_set_entity_health((*uParam1)[iVar0]->f_11, 400, 0);
						_set_random_outfit_variation((*uParam1)[iVar0]->f_11, true);
						_set_ped_body_component((*uParam1)[iVar0]->f_11, 1268180497);
						_update_ped_variation((*uParam1)[iVar0]->f_11, true, true, true, true, false);
						if ((*uParam1)[iVar0]->f_13)
						{
							_set_ped_on_mount(uParam2[iVar0], (*uParam1)[iVar0]->f_11, -1, true);
						}
						set_ped_config_flag(uParam2[iVar0], 307, true);
					}
					if ((*uParam1)[iVar0]->f_10)
					{
						_0x0fb1ba7ff73b41e1(uParam2[iVar0], (*uParam1)[iVar0]->f_4, 0);
					}
					if (bParam4)
					{
						if (!is_string_null_or_empty(&((*uParam1)[iVar0]->f_23)))
						{
							func_201(uParam2[iVar0], &((*uParam1)[iVar0]->f_23), 0);
						}
					}
					if (func_202(&((*uParam1)[iVar0]->f_22)))
					{
						_0xdfce8ce9f3ebe93f(uParam2[iVar0]);
					}
					func_200((*uParam2)[iVar0], (*uParam1)[iVar0], bParam3, 0);
				}
			}
			iVar0++;
		}
...
void func_99(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_151(uParam0->f_3));
...
bool func_102(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_229(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_228(uParam2, fVar1))
		{
			if (!func_230((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
void func_103(var uParam0, int iParam1)
{
	if (func_244(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_247());
		bVar1 = func_156(!func_49(uParam0->f_3, 1), 20f, -1f);
		uParam0->f_51.f_11 = func_249(iVar2, func_248(uParam0->f_3), 1, iParam1, 8, 0, bVar1);
	}
}

bool func_104(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_251(uParam0[*uParam3], 0, iParam1, uParam2, 0, 0))
		{
			return true;
		}
		*uParam3++;
...
void func_106(int iParam0, var uParam1)
{
	...
	{
		case 0:
			*(*uParam1)[0] = { -1774.641f, -404.1791f, 155.4695f };
			*(*uParam1)[1] = { -1773.69f, -391.0948f, 155.7128f };
			break;
		case 2:
			*(*uParam1)[0] = { -251.9975f, 735.3788f, 117.1469f };
			*(*uParam1)[1] = { -254.7075f, 757.2803f, 116.0289f };
			break;
		case 1:
			*(*uParam1)[0] = { -288.2779f, 876.9728f, 119.7318f };
			*(*uParam1)[1] = { -298.1447f, 875.8338f, 119.517f };
			break;
	}
}
...
void func_107(int iParam0, var uParam1)
{
	...
	{
		case 0:
			*(*uParam1)[0] = { -1791.483f, -404.6982f, 152.0737f };
			*(*uParam1)[1] = { -1797.492f, -418.425f, 155.4626f };
			break;
		case 2:
			*(*uParam1)[0] = { -272.4986f, 727.4485f, 116.1223f };
			*(*uParam1)[1] = { -279.9165f, 742.4937f, 116.3102f };
			break;
		case 1:
			*(*uParam1)[0] = { -292.1957f, 856.775f, 119.3069f };
			*(*uParam1)[1] = { -304.7931f, 845.9597f, 118.5402f };
			break;
	}
}
...
void func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_92((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
{
	return func_86(iVar588, iParam0);
}
	...
	switch (iLocal_14)
	{
		case 1:
			if (func_254(Local_223.f_1, "pblIdles") || (func_254(Local_223.f_1, "pblExit") && func_255(Local_223.f_1, 0f, 0.6847f)))
			{
				iLocal_1299 = 1;
				iLocal_587 = 3;
				_set_anim_scene_playback_list_bool(Local_223.f_1, "pblBreakout", true);
				func_109(524288);
				func_256(&uLocal_588, 4);
				func_114(&uLocal_584, 11);
			}
			break;
		case 2:
...
void func_119(bool bParam0)
{
	...
	{
		iVar0 = func_257(uLocal_600[0], Local_939[0], 15f, &(Local_939[0]->f_21), &(Local_29.f_192), 0f, 1, 0, 0, iVar1237, 0, 0, 2, 1, -1082130432, 0);
	}
	if (!func_115(1073741824))
	{
		iVar1 = func_257(uLocal_600[1], Local_939[1], 15f, &(Local_939[1]->f_21), &(Local_29.f_192), 0f, 1, 0, 0, iVar1237, 0, 0, 2, 1, -1082130432, 0);
	}
	if (func_115(1))
	{
		return;
	}
	if ((func_258(Local_939[0]) && iVar0 != -1) || (func_258(Local_939[1]) && iVar1 != -1))
	{
		if (bParam0)
		{
			iLocal_647 = 1;
...
void func_120(int iParam0, var uParam1, int iParam2)
{
	...
	{
		case 0:
			_0x2e1d6d87346bb7d2(&(uLocal_600[iParam0]), Global_35, 0, 0);
			func_113(uParam1, 1);
			break;
		case 1:
			break;
		case 3:
			if (has_anim_event_fired(&(uLocal_600[iParam0]), -1931509438))
			{
				func_264(Local_223, func_93(iParam0), &(uLocal_600[iParam0]));
				if (iLocal_14 != 2)
				{
					force_ped_motion_state(&(uLocal_600[iParam0]), -668482597, false, 0, false);
				}
				open_sequence_task(&iVar0);
				task_follow_nav_mesh_to_coord(0, *vLocal_536[1], 1f, -1, 0.25f, 1, 40000f);
				task_wander_standard(0, 40000f, 0);
				func_265(&(uLocal_600[iParam0]), &iVar0, 0, 0, 1, 1);
				set_ped_keep_task(&(uLocal_600[iParam0]), true);
				func_113(uParam1, 10);
			}
			break;
		case 5:
			if (func_251(&(uLocal_600[iParam0]), 0, Local_651[iParam0], &uVar2, 0, 0))
			{
				open_sequence_task(&iVar0);
				if (func_266(iParam0, 1))
				{
					task_follow_waypoint_recording(0, "re_peeping_tom_str", 0, uVar933, -1, 0, 0, -1);
				}
				_task_smart_flee_style_ped(0, Global_35, 3, 384, -1082130432, -1, 0);
				func_265(&(uLocal_600[iParam0]), &iVar0, 0, 0, 1, 1);
				set_ped_keep_task(&(uLocal_600[iParam0]), true);
				func_263(vLocal_752[iParam0]);
				func_113(uParam1, 11);
			}
			else if (func_267(iParam0))
			{
				if (_does_anim_scene_exist(Local_223) && _is_anim_scene_started(Local_223, false))
				{
					if (!_0x1f0e401031e20146(Local_223, "pblBreakoutL") && !_0x1f0e401031e20146(Local_223, "pblBreakoutR"))
					{
						if (func_115(16))
						{
							if (iLocal_14 == 0)
							...
							_set_anim_scene_playback_list_bool(Local_223, "pblBreakoutL", true);
						}
						else
						{
							_set_anim_scene_playback_list_bool(Local_223, "pblBreakoutR", true);
						}
					}
				}
				else
				{
					...
					task_play_anim(&(uLocal_600[iParam0]), &(Local_497[iVar1]), Local_497[iVar1]->f_1, 8f, -16f, -1, 16384, 0f, false, 0, false, 0, false);
				}
				func_113(uParam1, 6);
			}
			break;
		case 6:
			...
			if (is_ped_dead_or_dying(&(uLocal_600[0]), true) || is_ped_dead_or_dying(&(uLocal_600[1]), true))
			{
				set_ped_reset_flag(&(uLocal_600[iParam0]), 290, true);
				if (!bVar643)
				{
					if (has_anim_event_fired(&(uLocal_600[iParam0]), 865122202))
					{
						if (func_271(&(uLocal_600[iParam0]), func_269(), 291934926, 0, 1, &(Local_231[iParam0]->f_23), func_270(iParam0, iLocal_14, iVar585), 1))
						{
							iLocal_648 = 1;
						}
					}
			...
			if (func_251(&(uLocal_600[iParam0]), 0, Local_651[iParam0], &uVar2, 0, 0) || (_does_anim_scene_exist(Local_223) && !_0x3ab6c7b0bb0df4b1(&(uLocal_600[iParam0]), Local_223)))
			{
				open_sequence_task(&iVar0);
				...
				_task_smart_flee_style_coord(0, vLocal_532, 3, 384, 15f, -1, 0);
				_task_smart_flee_style_ped(0, Global_35, 3, 384, -1082130432, -1, 0);
				func_265(&(uLocal_600[iParam0]), &iVar0, 0, 0, 1, 1);
				set_ped_keep_task(&(uLocal_600[iParam0]), true);
				func_263(vLocal_752[iParam0]);
			...
			else if (has_anim_event_fired(&(uLocal_600[iParam0]), -1931509438))
			{
				func_264(Local_223, func_93(iParam0), &(uLocal_600[iParam0]));
				open_sequence_task(&iVar0);
				...
				{
					task_follow_nav_mesh_to_coord(0, *vLocal_536[0], 2f, -1, 1f, 8193, 40000f);
				}
				_task_smart_flee_style_coord(0, vLocal_532, 3, 384, 15f, -1, 0);
				_task_smart_flee_style_ped(0, Global_35, 3, 384, -1082130432, -1, 0);
				func_265(&(uLocal_600[iParam0]), &iVar0, 0, 0, 1, 1);
			...
			break;
		case 7:
			if (func_272(vLocal_752[iParam0], 5f))
			{
		...
		case 8:
			if (func_267(iParam0))
			{
				func_274(iParam0, 1);
				open_sequence_task(&iVar0);
				task_react(0, Global_35, Global_36, func_84(iLocal_14, iParam0), 0.75f, 0, 4);
				if (func_266(iParam0, 1))
				{
					task_follow_waypoint_recording(0, "re_peeping_tom_str", 0, uVar933, -1, 0, 0, -1);
				}
		...
		case 9:
			...
			break;
		case 10:
			set_ped_reset_flag(&(uLocal_600[iParam0]), 12, true);
			set_ped_reset_flag(&(uLocal_600[iParam0]), 172, true);
			if (func_136(&(uLocal_600[iParam0]), vLocal_532, 1) > 20f || func_136(&(uLocal_600[iParam0]), *vLocal_536[1], 1) < 10f)
			{
				if (func_115(128))
				{
...
bool func_121()
{
	switch (iVar584)
	{
		...
		case 2:
			...
			while (iVar0 < 6)
			{
				if (!is_string_null_or_empty(&(sLocal_546[iVar0])))
				{
					_0xdf7b5144e25cd3fe(Local_223, &(sLocal_546[iVar0]));
				}
				iVar0++;
			}
			iLocal_586 = 3;
		...
		case 3:
			...
			while (iVar0 < 6)
			{
				if (!is_string_null_or_empty(&(sLocal_546[iVar0])))
				{
					if (!_0x23e33cb9f4a3f547(Local_223, &(sLocal_546[iVar0])))
					{
						return false;
					}
				}
...
bool func_122()
{
	switch (iVar1298)
	{
		case 0:
			...
			break;
		case 1:
			iLocal_1301 = get_interior_at_coords(-289.4923f, 865.9225f, 120.1366f);
			iLocal_1300 = 3;
			break;
		case 3:
			if (is_valid_interior(iVar1299))
			{
				if (is_interior_ready(iVar1299))
				{
					if (_is_interior_entity_set_valid(iVar1299, "val_res_a_int_peepcurtain"))
					{
						if (!is_interior_entity_set_active(iVar1299, "val_res_a_int_peepcurtain"))
						{
							activate_interior_entity_set(iVar1299, "val_res_a_int_peepcurtain", 0);
						}
						iLocal_1300 = 2;
					}
				}
			...
			break;
		case 2:
			if (!has_model_loaded(975100514))
			{
				request_model(975100514, false);
			}
			else if (iVar1300 == 0)
			{
				uLocal_1302 = _0x6f3068258a499e52(975100514, -286.4733f, 865.5103f, 120.869f, 5);
			}
			else if (_0x1ff441d7954f8709(iVar1300))
			{
				uLocal_619 = _0x4735e2a4bb83d9da(iVar1300);
				iLocal_1300 = 4;
			}
			else
			{
			...
			break;
		case 4:
			Local_223.f_1 = _create_anim_scene(Local_223.f_5, 0, 0, false, true);
			if (!is_string_null_or_empty(Local_223.f_5))
			{
				if (!_is_anim_scene_loaded(Local_223.f_1, true, false))
				{
					load_anim_scene(Local_223.f_1);
					iLocal_1300 = 5;
				}
			}
			break;
...
bool func_124(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		...
		if (func_226(&(uParam0->f_121), iParam4, fParam1))
		{
			...
			if (uParam0->f_186)
			{
				_0xb2a38826e5886e83(func_160(uParam0->f_3, uParam0->f_185), 0);
			}
			return true;
		}
	}
...
void func_125()
{
	...
	{
		case 2:
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(1)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(2)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(4)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(8)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(16)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(32)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(64)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(128)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(256)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(512)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			break;
		case 1:
			...
			if (has_anim_event_fired(&(uLocal_600[1]), func_275(64)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			if (has_anim_event_fired(&(uLocal_600[0]), func_275(128)))
			{
				func_276(40789253, vLocal_532, 1);
			}
			break;
...
bool func_126()
{
	...
	{
		if (!_0x23e33cb9f4a3f547(Local_223.f_1, &(sLocal_553[0])))
		{
			_0xdf7b5144e25cd3fe(Local_223.f_1, &(sLocal_553[0]));
			return false;
		}
		if (!_0x23e33cb9f4a3f547(Local_223.f_1, &(sLocal_553[1])))
		{
			_0xdf7b5144e25cd3fe(Local_223.f_1, &(sLocal_553[1]));
			return false;
		}
		if (iLocal_14 == 1)
		{
			if (!_0x23e33cb9f4a3f547(Local_223.f_1, &(sLocal_553[2])))
			{
				_0xdf7b5144e25cd3fe(Local_223.f_1, &(sLocal_553[2]));
				return false;
			}
		}
		return true;
...
void func_127()
{
	...
	{
		set_ped_config_flag(&(uLocal_600[2]), 253, true);
		set_ped_config_flag(&(uLocal_600[2]), 301, true);
		set_ped_config_flag(&(uLocal_600[2]), 1, true);
		...
		switch (iLocal_14)
		{
			case 2:
				...
				break;
			case 0:
				_request_ped_emotional_preset(&(uLocal_600[2]), func_84(iLocal_14, 2));
				set_entity_can_be_damaged(&(uLocal_600[2]), false);
				break;
		}
	}
	if (func_40(&(uLocal_600[3]), 0, 1))
	{
		set_ped_config_flag(&(uLocal_600[3]), 253, true);
		set_ped_config_flag(&(uLocal_600[3]), 301, true);
		set_ped_config_flag(&(uLocal_600[3]), 1, true);
...
void func_128()
{
	...
	{
		case 2:
			set_anim_scene_origin(Local_223.f_1, -262.63f, 734.317f, 117.177f, 0f, 0f, 110f, 2);
			set_anim_scene_entity(Local_223.f_1, "objPipe", Local_16[0]->f_8, 0);
			break;
		case 1:
			set_anim_scene_origin(Local_223.f_1, -291.6873f, 866.289f, 120.1314f, 0f, 0f, fVar533, 2);
			break;
		case 0:
			set_anim_scene_origin(Local_223.f_1, vVar0, 0f, 0f, fVar533, 2);
			Local_16[0]->f_8 = _create_weapon_object(1845102363, -1, Local_29.f_51 + Vector(0.1f, 0f, 0f), true, 1f);
			set_anim_scene_entity(Local_223.f_1, "objGun", Local_16[0]->f_8, 0);
			break;
	}
	if (func_40(&(uLocal_600[2]), 0, 1))
	{
		set_anim_scene_entity(Local_223.f_1, func_93(2), &(uLocal_600[2]), 0);
	}
	if (func_40(&(uLocal_600[3]), 0, 1))
	{
		set_anim_scene_entity(Local_223.f_1, func_93(3), &(uLocal_600[3]), 0);
	}
	start_anim_scene(Local_223.f_1);
}
...
void func_131()
{
	if (does_entity_exist(&(uLocal_600[2])))
	{
		set_ped_reset_flag(&(uLocal_600[2]), 258, true);
	}
	if (iLocal_14 != 0 && does_entity_exist(&(uLocal_600[3])))
	{
		set_ped_reset_flag(&(uLocal_600[3]), 258, true);
	}
}
...
bool func_132()
{
	...
	{
		case 0:
			func_113(&uLocal_915, 1);
			break;
		case 1:
			_set_anim_scene_playback_list_bool(Local_223, "pblDialogue", true);
			set_anim_scene_bool(Local_223, "bPlayDialogue", true, false);
			func_113(&uLocal_915, 2);
			break;
		case 2:
			if (func_281() || func_115(1))
			{
				...
				func_113(&uLocal_915, 4);
			}
			else if (_get_anim_scene_progress(Local_223) > func_282(iLocal_14))
			{
				if (func_105() || iLocal_14 == 0)
				{
					func_106(&uLocal_591, &vLocal_536);
					_set_anim_scene_playback_list_bool(Local_223, "pblExitR", true);
				}
				else
				{
					func_107(&uLocal_591, &vLocal_536);
					_set_anim_scene_playback_list_bool(Local_223, "pblExitL", true);
				}
				func_38(&(uLocal_620[7]));
				func_109(16384);
				func_113(&uLocal_916, 3);
				func_113(&uLocal_917, 3);
				func_113(&uLocal_915, 3);
			}
			break;
		case 3:
			...
			break;
		case 4:
			if (!is_entity_dead(&(uLocal_600[0])))
			{
				set_ped_reset_flag(&(uLocal_600[0]), 290, true);
			}
			if (!is_entity_dead(&(uLocal_600[1])))
			{
				set_ped_reset_flag(&(uLocal_600[1]), 290, true);
			}
			...
			else if (func_285(&uLocal_736) > fVar597)
			{
				func_113(&uLocal_915, 5);
			}
			break;
		case 5:
			if (func_105())
			...
			func_263(vLocal_739[0]);
			func_263(vLocal_739[1]);
			func_113(&uLocal_916, 5);
			func_113(&uLocal_917, 5);
			func_113(&uLocal_915, 12);
			break;
		case 12:
			return true;
...
void func_135()
{
	...
	else if (func_115(256))
	{
		...
		{
			func_274(0, 1);
			func_113(&uLocal_916, 9);
			func_113(&uLocal_917, 9);
			func_287(256);
			func_109(512);
		}
		return;
	...
	if (func_115(1))
	{
		if (!bVar645)
		{
			if (func_40(&(uLocal_600[0]), 0, 1))
			{
				_0x2e1d6d87346bb7d2(&(uLocal_600[0]), Global_35, 0, 0);
			}
			if (func_40(&(uLocal_600[1]), 0, 1))
			{
				_0x2e1d6d87346bb7d2(&(uLocal_600[1]), Global_35, 0, 0);
			}
			func_109(256);
		}
	}
	...
	if (func_117(Local_29.f_51, 1) < 15f && func_286(-3f, 1, 0, 0))
	{
		...
		{
			func_109(128);
			func_271(&(uLocal_600[0]), func_288(0, iLocal_14, iVar588), 291934926, 0, 1, &(Local_231[0]->f_23), func_289(0, iLocal_14, iVar588), 1);
		}
		else if (func_129(&(uLocal_600[1]), Global_35, 1, 7f, 0))
		{
			func_109(128);
			func_271(&(uLocal_600[1]), func_288(1, iLocal_14, iVar588), 291934926, 0, 1, &(Local_231[1]->f_23), func_289(1, iLocal_14, iVar588), 1);
		}
	}
}
...
void func_137()
{
	switch (iLocal_14)
	{
		case 0:
			...
			{
				case 0:
					if (!is_entity_dead(&(uLocal_600[2])) && has_anim_event_fired(&(uLocal_600[2]), -219817230))
					{
						func_256(&uLocal_588, 1);
					}
					break;
				case 1:
					if (!is_entity_dead(&(uLocal_600[2])) && has_anim_event_fired(&(uLocal_600[2]), -1140841175))
					{
						func_58(&uLocal_708, 0);
						if ((!_does_anim_scene_exist(Local_1241.f_2) || !_is_anim_scene_started(Local_1241.f_2, false)) || !_0x3ab6c7b0bb0df4b1(Global_35, Local_1241.f_2))
						{
							Local_918.f_11 = 0;
						}
						_fire_single_bullet_ignore_entity_new(&Local_918);
						func_290(1066055203, &(uLocal_600[2]), 1);
						if (does_entity_exist(Local_16[0]->f_8))
						{
							_give_weapon_component_to_weapon_object(&(Local_16[0]->f_8), &(uLocal_600[2]), 752097756, false);
						}
						if (func_117(vLocal_532, 1) < 2f)
						{
							if ((!_does_anim_scene_exist(Local_1241.f_2) || !_is_anim_scene_started(Local_1241.f_2, false)) || !_0x3ab6c7b0bb0df4b1(Global_35, Local_1241.f_2))
							{
								_0x09171a6f8fde5dc1(Global_35, -1784.262f, -403.5812f, 157.1804f, 1);
							}
						}
						iLocal_649 = add_shocking_event_at_position(-1905235087, -1784.146f, -403.6157f, 157.4285f, -1f, 15f, 15f, -1f, -1f, -1, -1);
						func_291(1343354387);
						func_109(1024);
						func_37(uLocal_620[0], uLocal_629[0]);
						func_37(uLocal_620[1], uLocal_629[1]);
						func_256(&uLocal_588, 3);
					}
					break;
				case 3:
					if (!_does_anim_scene_exist(Local_223.f_1) || _is_anim_scene_finished(Local_223.f_1, false))
					{
						if (get_script_task_status(&(uLocal_600[2]), 713668775, true) != 1)
						{
							task_follow_nav_mesh_to_coord(&(uLocal_600[2]), vLocal_543, 2f, 2000, 0.25f, 0, 40000f);
							func_256(&uLocal_588, 5);
						}
					}
					break;
				case 4:
					...
					if (is_entity_dead(&(uLocal_600[2])))
					{
						func_256(&uLocal_588, 6);
					}
					else
					{
						func_108(&(uLocal_600[2]), 0);
						if (_does_anim_scene_exist(Local_223.f_1) && _0x3ab6c7b0bb0df4b1(&(uLocal_600[2]), Local_223.f_1))
						{
						...
						if (does_entity_exist(Local_16[0]->f_8))
						{
							...
							{
								remove_anim_scene_entity(Local_223.f_1, "objGun", Local_16[0]->f_8);
							}
						}
						open_sequence_task(&iVar1);
						task_react(0, Global_35, Global_36, func_84(iLocal_14, 2), 2f, 0, 4);
						task_follow_nav_mesh_to_coord(0, vLocal_543, 2f, 2000, 0.25f, 0, 40000f);
					...
					break;
				case 5:
					if ((iVar585 == 4 && does_entity_exist(&(uLocal_600[2]))) && func_136(&(uLocal_600[2]), vLocal_543, 1) < 2f)
					{
						task_stand_still(&(uLocal_600[2]), -1);
			...
			switch (iVar586)
			{
				case 0:
					if (!func_115(-2147483648))
					{
						if (!is_entity_dead(&(uLocal_600[2])))
						{
							if (has_anim_event_fired(&(uLocal_600[2]), -462412321) && (func_223(Global_35, &(uLocal_620[3]), 1, 0) || func_223(Global_35, &(uLocal_620[4]), 1, 0)))
							{
								func_109(-2147483648);
							}
						}
					}
					if (((!is_entity_dead(&(uLocal_600[3])) && has_anim_event_fired(&(uLocal_600[3]), 528459669)) || !_does_anim_scene_exist(Local_223.f_1)) || _is_anim_scene_finished(Local_223.f_1, false))
					{
						if (!is_entity_dead(&(uLocal_600[2])))
						{
							task_stand_still(&(uLocal_600[2]), -1);
						...
						if (!is_entity_dead(&(uLocal_600[3])))
						{
							task_stand_still(&(uLocal_600[3]), -1);
						}
						func_256(&uLocal_588, 3);
					}
					break;
				case 3:
					if (iVar585 == 4)
					{
						if (!_does_anim_scene_exist(Local_1241.f_2) || !_0x3ab6c7b0bb0df4b1(Global_35, Local_1241.f_2))
						{
							if (is_entity_dead(&(uLocal_600[2])) || !is_scripted_speech_playing(&(uLocal_600[2])))
							{
								func_292(uLocal_600[2]);
				...
				case 4:
					...
					{
						set_anim_scene_paused(Local_223.f_1, true);
						if (does_entity_exist(iVar617))
						{
							play_entity_anim(iVar617, Local_497[8]->f_1, &(Local_497[8]), 1000f, true, true, false, 0f, 0);
						}
						func_292(uLocal_600[2]);
						func_292(uLocal_600[3]);
						func_114(&uLocal_584, 13);
					...
					else if (!_does_anim_scene_exist(Local_223.f_1) || _is_anim_scene_finished(Local_223.f_1, false))
					{
						func_292(uLocal_600[2]);
						func_292(uLocal_600[3]);
						func_114(&uLocal_584, 13);
		...
		case 2:
			...
			{
				case 0:
					if (_does_anim_scene_exist(Local_223.f_1) && _is_anim_scene_started(Local_223.f_1, false))
					{
						if (has_anim_event_fired(&(uLocal_600[2]), -589377963) || has_anim_event_fired(&(uLocal_600[3]), -589377963))
						{
							func_109(2);
							func_256(&uLocal_588, 1);
						}
				...
				case 3:
					if (func_293())
					{
						...
						while (iVar0 <= 3)
						{
							if (does_entity_exist(&(uLocal_600[iVar0])))
							{
								if (func_129(Global_35, &(uLocal_600[iVar0]), 0, 5f, 0))
								{
									delete_ped(uLocal_600[iVar0]);
								}
							}
							iVar0++;
						}
						if ((!func_40(&(uLocal_600[2]), 0, 1) || get_script_task_status(&(uLocal_600[2]), 713668775, true) != 1) && (!func_40(&(uLocal_600[3]), 0, 1) || get_script_task_status(&(uLocal_600[3]), 713668775, true) != 1))
						{
							func_256(&uLocal_588, 6);
						}
					}
...
void func_138()
{
	switch (iLocal_14)
	{
		case 1:
			...
			{
				if (has_anim_event_fired(&(uLocal_600[2]), -167301387))
				{
					func_290(1891783641, &(uLocal_600[2]), 1);
				}
				if (has_anim_event_fired(&(uLocal_600[3]), -1840721831))
				{
					func_290(249295937, &(uLocal_600[3]), 1);
				}
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(1024)))
			{
				if (func_115(-2147483648))
				{
		...
		case 2:
			...
			if (has_anim_event_fired(&(uLocal_600[3]), func_275(2048)))
			{
				func_290(1891783641, &(uLocal_600[3]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(4096)))
			{
				func_290(1891783641, &(uLocal_600[2]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[3]), func_275(8192)))
			{
				func_290(1891783641, &(uLocal_600[3]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(16384)))
			{
				func_290(1891783641, &(uLocal_600[2]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(32768)))
			{
				func_290(1891783641, &(uLocal_600[2]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(65536)))
			{
				func_290(1891783641, &(uLocal_600[2]), 1);
			}
			if (has_anim_event_fired(&(uLocal_600[2]), func_275(131072)))
			{
				func_290(1891783641, &(uLocal_600[2]), 1);
			}
			break;
...
void func_139()
{
	...
	if (_does_anim_scene_exist(Local_223.f_1))
	{
		if (_is_anim_scene_finished(Local_223.f_1, false) || ((_0xa9016536015de29d(Local_223.f_1, &(sLocal_553[1])) && _0x1f0e401031e20146(Local_223.f_1, &(sLocal_553[1]))) && _get_anim_scene_progress(Local_223.f_1) > 0.99f))
		{
			func_109(1048576);
		}
	}
...
void func_140()
{
	...
	switch (iLocal_14)
	{
		case 0:
			...
			{
				if (!is_entity_occluded(&(uLocal_600[2])) || func_223(Global_35, &(uLocal_620[3]), 1, 0))
				{
		...
		default:
			if (func_117(vLocal_532, 1) < 2.5f)
			{
				if (!is_entity_occluded(&(uLocal_600[2])))
				{
...
bool func_141()
{
	...
	if (!func_115(33554432) && iVar1239 == 4)
	{
		func_109(33554432);
	}
	switch (iVar585)
	{
		...
		case 1:
			...
			if (iVar1239 == 4 || func_115(4194304))
			{
				func_304();
				if (iVar1239 == 4)
				{
			...
			break;
		case 2:
			func_303(&Local_1241, 0, 0, bVar1296, 0, 0);
			func_305();
			if (iVar1239 == 4)
			{
				func_109(2048);
			...
			if (iLocal_14 != 0)
			{
				if (!func_115(1024))
				{
					if (iVar1239 == 4 || (func_117(vLocal_532, 1) < 2.5f && !is_entity_occluded(&(uLocal_600[2]))))
					{
						if (func_115(65536))
						{
							func_109(1024);
			...
			if (!func_115(67108864))
			{
				if (!func_306(2))
				{
					if ((iVar1239 == 2 || iVar1239 == 3) || iVar1239 == 4)
					{
						func_307(2);
				...
				{
					if (!is_entity_dead(&(uLocal_600[2])) && has_anim_event_fired(&(uLocal_600[2]), 630311317))
					{
						func_109(67108864);
					}
					if (!func_115(262144))
					...
					{
						case 0:
							if (!is_entity_dead(&(uLocal_600[2])) && has_anim_event_fired(&(uLocal_600[2]), 1123535862))
							{
			...
			switch (iLocal_14)
			{
				...
				case 2:
					...
					if (bVar1296 && func_255(Local_223.f_1, 0.8621f, 1065353216))
					{
						if (func_293())
						{
							iLocal_1299 = 1;
			...
			break;
		case 3:
			func_303(&Local_1241, bVar1297, 1, bVar1296, 0, 0);
			func_287(16777216);
			func_36(&uLocal_610, 1);
			iLocal_587 = 4;
			break;
		case 4:
			...
			switch (iLocal_14)
			{
				case 0:
					...
					if (has_anim_event_fired(Global_35, -1931509438))
					{
						func_109(134217728);
						func_263(&uLocal_749);
					}
...
char* func_147(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_314(sParam1));
}
...
bool func_154(var uParam0, var uParam1)
{
	...
	{
		if (func_317(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
void func_157(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_40(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			fVar2 = func_156(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
void func_165(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_247());
		if (func_332(Global_1310750[iParam0], 33554432))
		{
...
bool func_166(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_335(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_98(iParam0, 16))
	{
		...
		fVar2 = to_float(func_336(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
void func_181(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_247());
	}
}
...
void func_182(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_247());
	}
}
...
int func_186(bool bParam0)
{
	...
	get_group_size(func_351(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_351(), iVar3);
		if (func_352(iVar4))
		{
			iVar0++;
		}
...
void func_197(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)
{
	...
	if (bParam7)
	{
		func_97(&((*uParam0)[uParam0->f_136]->f_6), 4);
	}
	if (bParam8)
	{
		func_97(&((*uParam0)[uParam0->f_136]->f_6), 8);
	}
	if (iParam9 == 1)
	{
		func_97(&((*uParam0)[uParam0->f_136]->f_6), 1);
	}
	else if (iParam9 == 2)
	{
		func_97(&((*uParam0)[uParam0->f_136]->f_6), 2);
	}
	if (bParam10)
	{
		func_97(&((*uParam0)[uParam0->f_136]->f_6), 16);
	}
	uParam0->f_136++;
}
...
bool func_198(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_136)
	{
		if (!does_entity_exist(uParam0[iVar0]) && (*uParam0)[iVar0]->f_1 != 0)
		{
			...
			{
				bVar1 = func_4((*uParam0)[iVar0]->f_6, 4);
				bVar2 = func_4((*uParam0)[iVar0]->f_6, 8);
				bVar3 = func_4((*uParam0)[iVar0]->f_6, 16);
				if (func_4((*uParam0)[iVar0]->f_6, 1))
				{
					bVar4 = true;
				}
				else if (func_4((*uParam0)[iVar0]->f_6, 2))
				{
					bVar4 = 2;
				}
				else
				...
				{
					(*uParam0)[iVar0] = func_356((*uParam0)[iVar0]->f_1, (*uParam0)[iVar0]->f_2, (*uParam0)[iVar0]->f_5, bVar1, bVar2, bVar4, bVar3, 1, 1, 0, 0, 0, 0);
				}
				if (bParam1)
				{
...
void func_200(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		if (!bParam3 && func_359(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(*uParam0, 186, !func_360(&(uParam1->f_22)));
		...
		set_ped_config_flag(*uParam0, 4, func_366(&(uParam1->f_22)));
		set_ped_config_flag(*uParam0, 6, func_367(&(uParam1->f_22)));
...
{
	if (func_205(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
void func_218(int iParam0, int iParam1)
{
	...
	func_379(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_380(iParam0, 0);
	func_381(iParam0);
	func_382(1);
...
{
	if (uParam0->f_177 != -1 || func_332(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_390(uParam0->f_177));
			}
		}
	}
...
bool func_235(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_408(&(Global_1898164->f_1[0]));
		if (func_409(iVar0) && func_410((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_411(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_251(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_421(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630->f_26 && func_229(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
...
{
	if (is_string_null_or_empty(sParam1) || !func_283(iParam0))
	{
		return false;
	}
...
void func_264(int iParam0, char* sParam1, int iParam2)
{
	...
	else if (!_0x3ab6c7b0bb0df4b1(iParam2, iParam0))
	{
		return;
	}
...
bool func_266(int iParam0, bool bParam1)
{
	...
	else if (!get_is_waypoint_recording_loaded("re_peeping_tom_str"))
	{
		return false;
	}
...
bool func_267(int iParam0)
{
	...
	if (!func_284(vLocal_739[iParam0]))
	{
		func_263(vLocal_739[iParam0]);
	}
	else if (func_309(vLocal_739[iParam0]) >= &iLocal_594[iParam0])
	{
		func_300(vLocal_739[iParam0]);
		return true;
	}
	return false;
}
...
void func_273(int iParam0, int iParam1, int iParam2)
{
	...
	func_458(uLocal_600[iParam0], Local_939[iParam0], &(Local_939[iParam0]->f_21), 1, 1);
	set_blocking_of_non_temporary_events(&(uLocal_600[iParam0]), false);
	if (iParam2 != 0)
	{
	...
	_0x24c82ef607105faa(&(uLocal_600[iParam0]), 1789063806);
	_0xe737d5f14304a2ec(&(uLocal_600[iParam0]), get_player_index(), 120000);
}

void func_274(int iParam0, bool bParam1)
{
	if ((func_86(iVar588, 2048) || func_86(iVar588, 262144)) || func_86(iVar588, 512))
	{
		return;
	}
	switch (iLocal_14)
...
{
	return func_461(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
void func_291(int iParam0)
{
	...
	_0xedfc6c1fd1c964f5(player_id(), iParam0, 0, 75f, 100f, 0, 0, 0, 0);
}
...
bool func_293()
{
	if ((iVar1239 < 2 || iVar1239 == 7) || iVar1239 == 8)
	{
		return true;
	}
	return false;
...
void func_297()
{
	...
	{
		func_111(uLocal_605[0]);
		_set_anim_scene_playback_list_bool(Local_223.f_1, "pblExit", true);
		set_anim_scene_bool(Local_223.f_1, "bPlayExit", true, false);
		Local_29.f_44 = 1;
		func_109(262144);
	}
}
...
void func_301(var uParam0, var uParam1, vector3 vParam2)
{
	if (!func_88(vParam2))
	{
		iVar0 = func_471(uParam0, uParam1, *uParam0, vParam2, 25f, 0, 0, 0, -1, 1, 0, -1082130432, 0, 0);
	}
}
...
int func_303(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	{
		case 0:
			if ((func_117(uParam0->f_48, 1) > uParam0->f_45 || _0x74f1d22efa71fab8()) || is_control_pressed(1, 1644850270))
			{
				return 0;
			}
			if (!func_472(uParam0, 8192) && _0xa24c1d341c6e0d53(0, 0, 0))
			{
				if (func_205(uParam0->f_17))
				{
					func_213(&(uParam0->f_17), 1, 1);
				}
				return 0;
			}
			if (_is_ped_carrying(Global_35) || func_473(Global_35, -208384378))
			{
				if (func_205(uParam0->f_17))
				{
					func_213(&(uParam0->f_17), 1, 1);
			...
			if (!func_205(uParam0->f_17))
			{
				uParam0->f_17 = func_474(uParam0->f_16, -1053137564, 3, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
			}
			func_475(uParam0, 16384);
			func_208(uParam0->f_17, 1, 1);
			*uParam0 = 1;
			break;
		case 1:
			if ((func_117(uParam0->f_48, 1) > uParam0->f_45 || _0x74f1d22efa71fab8()) || is_control_pressed(1, 1644850270))
			...
			{
				if (!func_88(uParam0->f_51) || !func_88(uParam0->f_54))
				{
					_get_anim_scene_origin(uParam0->f_2, &vVar3, &vVar6, 2);
					if (!func_355(uParam0->f_51, vVar3) && !func_355(uParam0->f_54, vVar6))
					{
						vVar9 = { uParam0->f_51 };
						vVar12 = { uParam0->f_54 };
						if (func_88(vVar9))
			...
			if (_0x23e33cb9f4a3f547(uParam0->f_2, "pbl_enter"))
			{
				if (func_86(uParam0->f_3, 1) && _0xa9016536015de29d(uParam0->f_2, "pbl_enter_left"))
				{
				...
				if (func_86(uParam0->f_3, 2) && _0xa9016536015de29d(uParam0->f_2, "pbl_enter_right"))
				{
			...
			if (is_string_null_or_empty(uParam0->f_1) || (_is_anim_scene_loaded(uParam0->f_2, true, false) && _0x23e33cb9f4a3f547(uParam0->f_2, "pbl_enter")))
			{
				if (func_476(uParam0->f_17, 1))
				{
					...
					sVar15 = "pbl_enter";
					if (func_88(uParam0->f_48))
					{
						if (_get_anim_scene_entity_matrix(uParam0->f_2, "arthur", &vVar16, true, "pbl_enter", 2))
						{
							uParam0->f_48 = { vVar16 };
						}
						if (((func_86(uParam0->f_3, 1) && _0xa9016536015de29d(uParam0->f_2, "pbl_enter_left")) && _0x23e33cb9f4a3f547(uParam0->f_2, "pbl_enter_left")) && _get_anim_scene_entity_matrix(uParam0->f_2, "arthur", &vVar28, true, "pbl_enter_left", 2))
						{
							if (func_88(vVar28))
							{
							}
						...
						if (((func_86(uParam0->f_3, 2) && _0xa9016536015de29d(uParam0->f_2, "pbl_enter_right")) && _0x23e33cb9f4a3f547(uParam0->f_2, "pbl_enter_right")) && _get_anim_scene_entity_matrix(uParam0->f_2, "arthur", &vVar40, true, "pbl_enter_right", 2))
						{
							if (func_88(vVar40))
							{
							}
					...
					if (_get_ped_crouch_movement(Global_35) && !func_472(uParam0, 128))
					{
					...
					if (func_472(uParam0, 256))
					{
						...
						task_swap_weapon(Global_35, 1, func_472(uParam0, 512), 0, 0);
					}
		...
		case 2:
			...
			if ((!func_476(uParam0->f_17, 1) && !is_control_pressed(0, -1053137564)) && !is_disabled_control_pressed(0, -1053137564))
			{
				vVar0 = { uParam0->f_48 };
				uParam0->f_48 = { vVar0 };
				func_477(Global_35);
				set_player_control(player_id(), true, 0, false);
				if (func_472(uParam0, 4096))
				{
					_0x437c08db4febe2bd(Global_35, "Stealth", uParam0->f_47, -1);
					func_475(uParam0, 4096);
				}
				func_475(uParam0, 16384);
				func_208(uParam0->f_17, 1, 1);
				*uParam0 = 1;
			}
			else if ((is_ped_in_cover(Global_35, 0, 1) || _get_ped_crouch_movement(Global_35)) && func_472(uParam0, 64))
			{
				*uParam0 = 3;
			}
		...
		case 4:
			...
			if (!does_cam_exist(uParam0->f_44) || !is_cam_interpolating(uParam0->f_44))
			{
				if (does_cam_exist(uParam0->f_44))
				{
					...
					fVar56 = (30f * timestep());
					vVar57 = { uParam0->f_10 };
					uParam0->f_13 = (uParam0->f_13 + func_479((((vVar57.x - uParam0->f_13) * 0.05f) * fVar56), -3f, 3f));
					uParam0->f_13.f_1 = (uParam0->f_13.f_1 + func_479((((vVar57.y - uParam0->f_13.f_1) * 0.05f) * fVar56), -3f, 3f));
					uParam0->f_13.f_2 = (uParam0->f_13.f_2 + func_479((((vVar57.z - uParam0->f_13.f_2) * 0.05f) * fVar56), -3f, 3f));
				...
				{
					if (bParam2 || (((!func_86(uParam0->f_3, 4) && !func_476(uParam0->f_17, 1)) && !is_control_pressed(0, -1053137564)) && !is_disabled_control_pressed(0, -1053137564)))
					{
						if ((func_86(uParam0->f_3, 8) && _0xa9016536015de29d(uParam0->f_2, "pbl_exit_alt")) && _0x23e33cb9f4a3f547(uParam0->f_2, "pbl_exit_alt"))
						{
		...
		case 5:
			if (does_cam_exist(uParam0->f_44))
			{
				...
				{
					func_480(_get_object_offset_from_coords(uParam0->f_18, uParam0->f_21.f_2, 0f, 10f, 0f));
					render_script_cams(false, true, 3000, true, false, 0);
					destroy_cam(uParam0->f_44, false);
				}
				else
				{
					func_480(_get_object_offset_from_coords(uParam0->f_25, uParam0->f_28.f_2, 0f, 10f, 0f));
					render_script_cams(false, true, 3000, true, false, 0);
					destroy_cam(uParam0->f_44, false);
				}
			}
			if ((((!_does_anim_scene_exist(uParam0->f_2) || _0xf94692eb9dc15d74(uParam0->f_2, 0)) || _is_anim_scene_finished(uParam0->f_2, false)) || !_is_anim_scene_started(uParam0->f_2, false)) || (func_472(uParam0, 16) && has_anim_event_fired(Global_35, -180478719)))
			{
				if (_does_anim_scene_exist(uParam0->f_2))
				{
					_delete_anim_scene(uParam0->f_2);
				...
				if (func_472(uParam0, 32) && !func_472(uParam0, 128))
				{
					func_475(uParam0, 32);
...
{
	return func_86(iVar590, iParam0);
}
...
int func_309(var uParam0)
{
	...
	return (func_438() - round((uParam0->f_1 * 1000f)));
}
...
{
	fVar0 = func_156(bParam6, iParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_346(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_438();
	...
	else if (fVar0 > iParam4->f_2 || (!func_346(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_438();
		iParam4->f_2 = func_136(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_346(vector3 vParam0, int iParam3)
{
	...
	return func_494(vVar0, vParam0) > func_494(vVar0, get_entity_coords(iParam3, true, false));
}
...
void func_372(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_497(iParam0, 8))
		{
...
void func_385(int iParam0)
{
	...
	if (!func_177(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_386(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_512(to_float(iVar0), 1, 0);
	}
	else
	{
		func_512((to_float(200) / 3f), 1, 0);
	}
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_233(1) || *iParam0 & 8192 != 0))
				{
...
bool func_423(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_528(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_526(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_527(iParam2)
				{
					func_523(iParam2, 1);
					return true;
				}
...
bool func_424(int iParam0, int iParam1)
{
	...
	if (func_519(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_527(iParam1)
		{
...
int func_450(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_156(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_556(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_451(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_261(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
int func_455(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_576(func_271(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_486(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_379(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_380(iParam0, 1);
	if (!bParam2)
	{
		func_483(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_601(iParam0))
		{
...
bool func_492(vector3 vParam0)
{
	...
	while (iVar0 < Global_1310750->f_16043)
	{
		...
		{
			if (func_144(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
void func_503(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_332(Global_1310750[iVar0], iParam0))
		{
			if (!func_324(iVar0))
			{
				iVar1 = 1;
...
bool func_524(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_448(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_623(iVar0, 0)))
		{
...
bool func_528(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_623(iVar0, 0)))
		{
			if (func_625(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_539(int iParam0, int iParam1)
{
	...
	if (func_627(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_545(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_448(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_548(int iParam0)
{
	...
	return func_629((*Global_1347702)[58]->f_15, 1);
}
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_4(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_636(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_559(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_205((*uParam4)[iVar0]->f_6);
		...
		if (func_644(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_645(iParam12, (*uParam4)[iVar0]->f_6))
				{
					...
					{
						func_632(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_205((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_213(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_667(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_667(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_667(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_667(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_582(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_671(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !decor_exist_on(iVar2, "bIgnoreThisPed"))
				{
...
void func_591(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_673(iVar0), func_351(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_675() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_675();
					}
					func_676(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
...
bool func_624(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_625(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_630(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_684((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
void func_632(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_213(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_685(iParam0, 0);
		}
...
int func_633(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_686(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_205((*uParam2)[iVar0]->f_6))
		{
			func_211((*uParam2)[iVar0], 11);
...
void func_638(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_686(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
int func_658(int iParam0)
{
	...
	fVar1 = func_156(absf(fVar1) < 1f, func_156(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
void func_686(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_205(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_648(iParam1))
		{
...
bool func_711(int iParam0, int iParam1, var uParam2)
{
	if (!func_710(iParam0))
	{
		return false;
...
bool func_714(int iParam0)
{
	...
	if (is_ped_group_member(iParam0, func_351(), 1))
	{
		return true;
	}
	return false;
...
{
	return (shift_right(iParam0, 26) & 31 * func_576(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_742(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_743(iVar2) != 0 && _0x800df3fc913355f3(func_744(iVar2)))
		{
