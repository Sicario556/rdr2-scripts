void __EntryFunction__()
{
	...
	if (_does_scenario_point_exist(ScriptParam_0.f_1))
	{
		...
		Local_14.f_1 = _get_entity_scenario_point_is_attached_to(Local_14.f_2);
	}
	else
	{
		func_1(&Local_14);
	}
	vVar0 = { get_entity_coords(Local_14.f_1, false, false) };
	if (!func_2(vVar0))
	{
		func_1(&Local_14);
	}
	while (true)
	{
		...
		switch (func_5(&Local_14))
		{
			case 0:
				...
				if (_does_scenario_point_exist(Local_14.f_2))
				{
