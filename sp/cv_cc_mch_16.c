...
{
	if (!is_entity_dead(func_48(uParam0, iParam1)))
	{
		if (!has_ped_got_weapon(func_48(uParam0, iParam1), iParam2, 0, false))
		{
			func_286(func_48(uParam0, iParam1), iParam2, 1, 1, 0, 1056964608, 1065353216, 0);
		}
		else
		{
			set_current_ped_weapon(func_48(uParam0, iParam1), iParam2, true, 0, false, false);
		}
	}
...
void func_187(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_262(uParam0, uParam0->f_1976.f_1), 1, func_261(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_286(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
...
int func_353(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_404(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_404(iVar0))
		{
...
int func_390(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!does_entity_exist(iVar0) || !func_120(iVar0, 0)) || (bParam3 && !func_51(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_426(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_400(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 1:
			...
			if (func_435(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_434(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_437(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_438(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_440(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_442(iParam0, Global_1360165[iParam0]);
		...
		while (iVar28 < 4)
		{
			...
			if (func_446(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_450(0))
				{
					...
					func_451(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_414(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_363(iParam0, 8))
		{
...
int func_426(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	if (!func_103(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_460(iParam0) && func_461(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_463(iParam0, vVar0, iParam6, iParam10))
				{
					return func_462();
				}
				if (func_120((*Global_1360165)[iParam0]->f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_464(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_462();
				}
			}
			if ((bParam2 && !func_213(vVar0)) && !func_214(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_437((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_465((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
...
bool func_435(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_474((*Global_1360165)[iParam0]->f_4.f_2) || func_475((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_476((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_478(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_437(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_483(Global_35) && is_player_teleport_active())
	{
	}
	if (func_484(iParam0))
	{
		if (func_485(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_446(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_500(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_447(int iParam0, var uParam1, int iParam2)
{
...
bool func_449(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
...
bool func_461(int iParam0, char* sParam1)
{
...
bool func_463(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_464(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_508(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_429((*Global_1347702)[63]->f_15, 1) || func_475((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_429((*Global_1347702)[134]->f_15, 1) || func_475((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(747937920, 1) && !func_429((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<4> func_494(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_448(923904168, func_492(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_448(923904168, func_492(bParam0), -740156546, 0) };
		}
...
struct<4> func_496(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_448(271701509, func_492(bParam0), 12999093, 0) };
		}
