...
bool func_6(var uParam0)
{
	...
	if (func_22(iLocal_20) && _0x5e420ff293ee5472())
	{
		return true;
	}
	return false;
...
{
	if (!is_entity_dead(iLocal_19) && _0x88ad6cc10d8d35b2(iLocal_19))
	{
		set_vehicle_doors_locked(iLocal_19, 1);
		if (func_29(Global_35, get_entity_coords(iLocal_19, true, false), 1) > 22500f)
		{
			delete_vehicle(&iLocal_19);
		}
		else
		{
			set_vehicle_as_no_longer_needed(&iLocal_19);
		}
	}
	func_30(iLocal_20);
...
void func_19(var uParam0)
{
	iLocal_3[0] = 0;
	iLocal_3[1] = 9;
	*vLocal_12[0] = { 2003f, -981.1937f, 43.5958f };
	*vLocal_12[1] = { 2002.926f, -980.459f, 43.5959f };
	iLocal_24 = 3;
	if (_0x5c16855277819bbf() <= iLocal_24)
	{
...
int func_23(var uParam0)
{
	...
	if (!func_50(&iLocal_19, get_entity_coords(&(uLocal_6[1]), true, false), 10f, 1, 4, 0, -1308375373))
	{
		return 0;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (!is_entity_dead(&(uLocal_6[iVar0])))
		{
			set_current_ped_weapon(&(uLocal_6[iVar0]), -1569615261, true, 0, false, false);
		}
		iVar0++;
	}
	return 1;
...
{
	if (is_entity_dead(&(uLocal_6[iParam0])))
	{
		return true;
	}
	...
	else if (func_54(&(uLocal_6[iParam0]), vLocal_25, 100f, 1, 1))
	{
		...
		if (is_ped_in_any_vehicle(&(uLocal_6[iParam0]), false))
		{
			task_leave_any_vehicle(&(uLocal_6[iParam0]), get_random_int_in_range(0, 2), 64);
			set_ped_keep_task(&(uLocal_6[iParam0]), true);
		}
	...
	switch (&iLocal_9[iParam0])
	{
		...
		case 4:
			...
			break;
		case 5:
			if (func_59(&(uLocal_6[iParam0]), *vLocal_12[iParam0], 1f, 4f))
			{
				iLocal_9[iParam0] = 6;
			}
			break;
		case 6:
			func_60(&(uLocal_6[iParam0]), -830507952, *vLocal_12[iParam0], 110.7f, 0, 1, 0, 0, -1082130432);
			iLocal_9[iParam0] = 7;
			break;
		case 7:
			return true;
...
void func_32(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_65(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_33(iParam0, 1, 0);
		}
	}
...
void func_33(int iParam0, int iParam1, bool bParam2)
{
	...
	func_66(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_40(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_69(iParam0), 137, true);
	}
}
...
void func_42(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_69(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_69(iParam0), 204, false);
	}
}
...
void func_44(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_69(iParam0);
	if (((does_entity_exist(iVar1) && func_71(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
	...
	if (*uParam0 == 0)
	{
		*uParam0 = func_79(vParam1, iParam4, iParam5, iParam6, bParam7, iParam8);
		if (!is_entity_dead(*uParam0))
		{
			...
			set_can_climb_on_entity(*uParam0, false);
			set_vehicle_doors_locked(*uParam0, 3);
		}
	}
	return true;
}
...
void func_53(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4)
{
	...
	if (!bParam1)
	{
		if (is_ped_in_any_vehicle(&(uLocal_6[iParam0]), true))
		{
			_0xe0b61ed8bb37712f(&(uLocal_6[iParam0]));
		}
	}
...
bool func_54(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_64(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_56(int iParam0)
{
	...
	{
		_0x104d9a7b1c0d0783(iLocal_19, 12f);
	}
	if (iParam0 == 1)
	{
		if (!func_84(&(uLocal_6[iParam0]), 1199744105) && (does_entity_exist(iLocal_19) && is_vehicle_driveable(iLocal_19, false, false)))
		{
			_task_vehicle_drive_to_destination(&(uLocal_6[iParam0]), iLocal_19, vLocal_25, fVar0, 69732884, 3, fVar1, fVar1, 0);
		}
	}
	return false;
}
...
bool func_58(int iParam0, int iParam1)
{
	...
	if (get_script_task_status(iParam0, 451360105, true) > 1)
	{
		...
		task_leave_vehicle(iParam0, iParam1, 0, 0);
	}
	return false;
}
...
void func_70(int iParam0)
{
	if (func_14(iParam0))
	{
		if (does_entity_exist(func_69(iParam0)))
		{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_31(iParam0, 16, 1))
			{
				...
				else if (func_37(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_37(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_102(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_103(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_105(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_37(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_107(Global_1360165[iParam0], 1);
				}
			}
			func_98(iParam0, 7);
		case 7:
...
int func_79(vector3 vParam0, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	iVar2 = _0x59b57c4b06531e1e(vParam0, iParam3, iVar1, 2);
	if (iVar2 != 0)
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			iVar0 = _0xe578c8ae173719b3(get_indexed_item_in_itemset(iVar3, iVar1));
...
float func_80(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_64(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_89(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_112(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_113(iParam0);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_115((*Global_1360165)[iParam0]->f_4.f_2) || func_116((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_117((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_119(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_36(iParam0, 44, 1);
			}
...
void func_102(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_124(Global_35) && is_player_teleport_active())
	{
	}
	if (func_125(iParam0))
	{
		if (func_126(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_67(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_67(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_67(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_67(iParam5, 32), true);
	...
	else if (func_67(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_67(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_67(iParam5, 64))
		{
...
bool func_110(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (bParam1 && get_vehicle_model_number_of_seats(get_entity_model(iParam0)) >= iParam2)
	{
	...
	if (bParam3 && get_entity_model(iParam0) == iParam4)
	{
		return true;
	}
	return false;
...
int func_114(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_139((*Global_1347702)[63]->f_15, 1) || func_116((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_139((*Global_1347702)[134]->f_15, 1) || func_116((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_141(747937920, 1) && !func_139((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_69(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_134(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_130(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_130(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_130(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_130(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_130(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_130(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_130(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_130(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_130(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_130(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_130(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_130(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_130(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_130(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_130(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_130(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_130(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_130(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_130(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_130(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_130(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_130(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_130(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_130(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_130(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_130(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_157(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_170(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_174(0))
				{
					...
					func_175(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<4> func_172(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_189(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_173(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_189(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_174(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_189(bParam0));
}
...
void func_176(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_192(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_185(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_189(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_186(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_189(bParam6), &Var0, 0);
	return uVar4;
}
