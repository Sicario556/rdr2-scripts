...
{
	func_8(uParam1);
	if (does_entity_exist(uParam1->f_7))
	{
		_0x9dae1380cc5c6451(player_id(), uParam1->f_7);
		_0xdc5e09d012d759c4(uParam1->f_7, uParam1->f_7, 0);
	}
	if (_0x1ff441d7954f8709(uParam1->f_8))
	{
		_0xd2b9c78537ed5759(uParam1->f_8);
	}
	_0xe7282390542f570d(*uParam0);
...
bool func_3(var uParam0, int iParam1)
{
	...
	if (!_does_scenario_point_exist(&(iParam1->f_9[0])))
	{
		iParam1->f_9[0] = create_scenario_point(-1843735114, vVar0 - Vector(0f, 0.3f, 0f), 0f, 0, 0, 0);
	}
	request_model(func_11(), false);
	iParam1->f_4 = get_random_int_in_range(0, 4);
...
{
	if (!does_entity_exist(iParam1->f_6))
	{
		vVar0 = { func_13(uParam0) };
		if (!func_14(vVar0))
		{
			iParam1->f_6 = create_object(func_11(), vVar0, true, true, false, false, true);
		}
	}
	if (!does_entity_exist(iParam1->f_6))
	{
	...
	if (does_entity_exist(iParam1->f_7))
	{
		_0x543dfe14be720027(player_id(), iParam1->f_7, 0);
		_0x6ecfc621a168424c(iParam1->f_7, iParam1->f_7, 0, 0);
	}
	return true;
}
...
bool func_7(var uParam0, int iParam1)
{
	...
	{
		iParam1->f_5 = 0;
		func_19(1798104140, -1763055991, func_18(player_id()), 1, 1);
...
void func_8(var uParam0)
{
	...
	{
		iVar1 = iVar0;
		if (_does_scenario_point_exist(&(uParam0->f_9[iVar1])))
		{
			_delete_scenario_point(&(uParam0->f_9[iVar1]));
		}
		iVar0++;
	}
}
...
Vector3 func_10(var uParam0)
{
	if (_does_scenario_point_exist(uParam0->f_1))
	{
		return _get_scenario_point_coords(uParam0->f_1, true);
	}
	return 0f, 0f, 0f;
}
...
int func_12(int iParam0)
{
	...
	{
		iVar3 = iVar7;
		fVar5 = get_distance_between_coords(vVar0, func_26(iVar3), true);
		if (fVar5 < fVar6)
		{
			fVar6 = fVar5;
			iVar4 = iVar3;
...
Vector3 func_13(var uParam0)
{
	vVar0 = { func_10(uParam0) };
	fVar3 = 0f;
	if (get_ground_z_for_3d_coord(vVar0, &fVar3, true))
	{
...
bool func_15(int iParam0, int iParam1)
{
	if (iParam0->f_8 == 0)
	{
		iParam0->f_8 = _0x6f3068258a499e52(func_27(iParam0->f_1), func_26(iParam0->f_1), 11);
	}
	else if (_0x1ff441d7954f8709(iParam0->f_8))
	{
		iParam0->f_7 = get_object_index_from_entity_index(_0x4735e2a4bb83d9da(iParam0->f_8));
	}
