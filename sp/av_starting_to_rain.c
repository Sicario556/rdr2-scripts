...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	switch (*uParam0)
	{
		...
		case 22:
			...
			iVar0 = func_49(func_47());
			break;
	}
	func_50(uParam0, 1, "PBL_ACTION", "", 0);
	func_51(uParam0, 0, "Ped", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
{
	if (!_has_scenario_type_loaded(iLocal_37, false))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	...
	{
		if (!is_ped_active_in_scenario(&(uParam0->f_20[0]), 1) && !func_59(&(uParam0->f_20[0]), 993674639))
		{
			_0xeeed8fafec331a70(&(uParam0->f_20[0]), get_entity_coords(&(uParam0->f_20[0]), true, false), 3);
			_task_start_scenario_in_place(&(uParam0->f_20[0]), iLocal_37, 0, false, iLocal_38, -1f, false);
		}
		...
		if (_0x02ebbb3989b7e695(&(uParam0->f_20[0])) && func_61(uParam0, 1065353216, 40f, 4, 15f, 15f))
		{
			func_62(uParam0);
			return true;
		}
...
int func_30(var uParam0)
{
	...
	_request_scenario_type(iLocal_37, 15, 0, iLocal_38);
	func_63(&uLocal_9, 0);
	func_64(&uLocal_9, 1);
	func_65(&uLocal_9, 1);
	func_66(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[3])
	{
		if (!&uParam0->f_469[4])
		{
			if (func_71(uParam0, fLocal_39, 1116471296, 4, -91962372, 1))
			{
				func_70(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
	...
	if (!&uParam0->f_469[3])
	{
		if (does_entity_exist(&(uParam0->f_20[0])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
			{
				...
				_task_start_scenario_in_place(&(uParam0->f_20[0]), iLocal_37, 15000, false, iLocal_38, -1f, false);
...
bool func_60(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_92(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_97(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_97(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_98(&(uParam0->f_490)))
							{
