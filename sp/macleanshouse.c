void __EntryFunction__()
{
	...
	func_1();
	func_2();
	iLocal_21 = get_game_timer();
	iVar0 = 0;
	while (func_3())
	{
		if (get_game_timer() > iLocal_21)
		{
			iLocal_21 = 0;
			...
			switch (iLocal_20)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_22));
					...
					Global_1897950 = -1;
					iLocal_23 = (get_game_timer() + iLocal_19);
					iLocal_20 = 2;
					break;
				case 2:
					if (func_11() || iLocal_23 < get_game_timer())
					{
						func_12(iLocal_22);
						iLocal_23 = (get_game_timer() + iLocal_19);
						iLocal_20 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_22) || iLocal_23 < get_game_timer())
					{
						func_14(iLocal_22);
						iLocal_23 = (get_game_timer() + iLocal_19);
						iLocal_20 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_22) || iLocal_23 < get_game_timer())
					{
						func_16(iLocal_22);
						iLocal_23 = (iLocal_19 + get_game_timer());
						iLocal_20 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_22)))
					{
						if (func_17(func_6(iLocal_22), 4) && !iLocal_23 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_22) || iLocal_23 < get_game_timer())
							{
								func_19(iLocal_22, 4);
								iLocal_23 = (iLocal_19 + get_game_timer());
								iLocal_20 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_23 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_22);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_22]->f_10);
							if ((*Global_1888801)[iLocal_22]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_22]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_22]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_22]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(2257.921f, -129.5337f, 51.985f, 0f, -1E-06f, 13.20028f, 82.29547f, 67.60979f, 21.17161f, "MacLean's Ranch - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("MacLean's Ranch - m_volRancherThreat Agg");
		_0x39816f6f94f385ad(iLocal_17, 2241.916f, -109.335f, 47.39677f, 0f, 0f, 81.00094f, 15.27625f, 30.5406f, 14.65559f);
		_0x39816f6f94f385ad(iLocal_17, 2242.125f, -118.91f, 49.79729f, 0f, 0f, -9.792401f, 22.84632f, 3.968585f, 11.03726f);
		_0x39816f6f94f385ad(iLocal_17, 2229.892f, -115.0595f, 50.13812f, 0f, 0f, -43.69167f, 7.061154f, 5.28716f, 10.09026f);
		_0x39816f6f94f385ad(iLocal_17, 2253.012f, -119.7667f, 49.20896f, 0f, 0f, -55.08507f, 2.867169f, 4.725968f, 9.455753f);
		_0x39816f6f94f385ad(iLocal_17, 2244.684f, -99.80244f, 49.79729f, 0f, 0f, -6.792556f, 27.39669f, 5.430289f, 11.03726f);
		_0x39816f6f94f385ad(iLocal_17, 2230.888f, -99.64697f, 49.20896f, 0f, 0f, -141.6504f, 5.207262f, 4.725968f, 9.455753f);
		_0x39816f6f94f385ad(iLocal_17, 2236.452f, -142.7769f, 50.13812f, 0f, 0f, -49.1528f, 7.766057f, 7.596688f, 10.09026f);
		_0x39816f6f94f385ad(iLocal_17, 2236.481f, -142.6387f, 47.39677f, 0f, 0f, 39.75399f, 7.495997f, 7.665227f, 14.65559f);
		_0x39816f6f94f385ad(iLocal_17, 2282.604f, -118.0235f, 45.6339f, 0f, 0f, -24.74522f, 3.359454f, 14.73906f, 12.52731f);
		_0x39816f6f94f385ad(iLocal_17, 2274.63f, -102.5251f, 46.93924f, 0f, 0f, -12.90716f, 17.48779f, 5.873432f, 15.33682f);
		_0x39816f6f94f385ad(iLocal_17, 2273.252f, -116.878f, 46.93924f, 0f, 0f, -9.949313f, 19.00171f, 22.66021f, 15.33682f);
		_0xbce668aaf83608be(iLocal_17, 2283.666f, -109.4251f, 44.44471f, 0f, 0f, 0f, 3.780884f, 6.839418f, 7.568232f);
		_0xbce668aaf83608be(iLocal_17, 2275.129f, -99.41361f, 44.81648f, 0f, 0f, -12.62545f, 8.420317f, 1f, 9.244777f);
		_0xbce668aaf83608be(iLocal_17, 2269.443f, -125.7176f, 44.44471f, 0f, 0f, 73.07793f, 3.302727f, 7.064869f, 7.568232f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("MacLean's Ranch - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_17);
		_0xbce668aaf83608be(iLocal_16, 2255.429f, -122.8375f, 51.985f, -1E-06f, 0f, 78.69922f, 38.29042f, 36.90052f, 21.17161f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("MacLean's Ranch - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_16);
		_0xbce668aaf83608be(iLocal_18, 2254.417f, -126.5447f, 51.985f, -1E-06f, 0f, 78.69922f, 51.7244f, 47.73219f, 21.17161f);
		...
		_set_guard_zone_position(sLocal_15, 2235.653f, -143.1516f, 47.8762f);
...
void func_28(int iParam0)
{
	...
	func_50(905, iLocal_16, 1);
	func_50(772, iLocal_16, 0);
	func_50(906, iLocal_16, 0);
	_0x4a8fefc43fd8ac9b(iLocal_16, 3, 1);
	_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_51(906));
	_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_51(772));
	_0x931b241409216c1f(func_52(905), func_52(772), 0);
}
...
bool func_60(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_90(iParam0));
}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_104(&cVar6, 109029619), sVar9, func_104(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_104(&cVar6, 109029619), func_104(&cVar10, 109029619));
		}
...
void func_78(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_123(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
char* func_104(char* sParam0, int iParam1)
{
	...
	return func_138(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_107(int iParam0)
{
	...
	if (func_139())
	{
		if (!func_140((*Global_1835011)[3]->f_1, 1))
		{
...
void func_118(int iParam0)
{
	...
	if (!func_112(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_144(Global_1935369->f_5[iParam0]->f_6, 1);
	func_145(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_84(Global_1914319->f_3[iParam0]->f_21) && func_147(Global_1914319->f_3[iParam0]->f_21))
	{
		func_148(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_149(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_123(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_132(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_159(&(Global_1898164->f_1[0]));
		if (func_160(iVar0) && func_161((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
