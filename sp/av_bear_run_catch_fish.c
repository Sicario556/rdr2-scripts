...
{
	func_33(uParam0, 10807, 10866, 11671);
}
...
{
	func_46(uParam0, "BEAR_RUN_CATCH_FISH", "script@ambient@animal@BEAR_RUN_CATCH_FISH@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "BEAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39 == 1)
		{
			if (func_64(uParam0, &uLocal_11, 1) || func_65(&(uParam0->f_20[0]), Global_35, 1) <= 400f)
			{
				bLocal_39 = true;
			}
		}
...
void func_70(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 1280756060))
		{
		...
		else if (!func_109(&(uParam0->f_20[1]), 518218985))
		{
	...
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		{
			if (!func_109(&(uParam0->f_20[0]), 780511057))
			{
		...
		else if (!func_109(&(uParam0->f_20[0]), 518218985))
		{
