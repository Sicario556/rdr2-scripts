...
{
	func_33(uParam0, 10972, 11030, 11421);
}
...
{
	func_46(uParam0, "SWIMMING_ANIMAL", "", vParam1, vParam4);
	iVar0 = 1;
	bVar1 = func_47();
	switch (*uParam0)
	{
	...
	func_48(uParam0, 0, "SAP_ANIMAL", iLocal_9, vParam1, vParam4.z, iVar0, 1, 1, 1, iLocal_13, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_63(uParam0, &uLocal_18, 0))
		{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				iLocal_17 = func_66(-830507952, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[0]), iLocal_17, 0, 0, false, true, 0, false, -1f, false);
				_set_scenario_point_flag(iLocal_17, 20, true);
		...
		case 1:
			...
			{
				func_65(uParam0);
				task_follow_nav_mesh_to_coord(&(uParam0->f_20[0]), get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 12f, 0f), 1f, -1, 0.25f, 8193, 40000f);
				iLocal_10 = 3;
			}
			break;
		case 3:
			if (!bLocal_12)
			{
				if (func_70(&(uParam0->f_20[0]), Global_35, 1) < fLocal_11)
				{
					func_64(uParam0->f_20[0], 0, 1);
					bLocal_12 = true;
				}
			}
			if (!func_71(&(uParam0->f_20[0]), 713668775))
			{
				return 1;
			}
			break;
...
int func_155(int iParam0, var uParam1)
{
	...
	else if (func_147() - uParam1->f_4) > func_206(uParam1)
	{
...
void func_158(int iParam0, vector3 vParam1)
{
	iVar1 = -1;
	iVar0 = 0;
	while (iVar0 < 10)
