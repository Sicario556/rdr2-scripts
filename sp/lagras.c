...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[3]->f_4;
	_0xb469cfd9e065eb99(iLocal_14, 1);
	iLocal_15 = _create_volume_box_with_custom_name(2162.926f, -618.1368f, 42.473f, 0f, 0f, 44.5f, 10.521f, 13f, 4f, "Lagras - m_volBaitShop");
	iLocal_16 = _create_volume_box_with_custom_name(2162.323f, -619.085f, 43.189f, 0f, 0f, -44f, 2.27f, 2.954f, 2.579f, "Lagras - m_volBaitPrompt");
	_0xb469cfd9e065eb99(iLocal_15, 10000);
	return true;
}
...
{
	func_50(17, 645, iLocal_15, iParam0, iLocal_16, 0, 12, 50f, 0, 0);
	func_51(17, 2168.851f, -622.9775f, 41.8217f, 332.7766f);
}

void func_28(int iParam0)
{
	func_52(644, iLocal_15, 1);
}
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	if (func_94(iVar0) || func_95(iVar0, iParam0))
	{
		...
		Global_1914319->f_3[iParam0]->f_20 = func_96(5, Global_1914319->f_3[iParam0]->f_10, 2, iVar7);
	}
	*Global_1393529->f_114[iParam0] = { 0f, 0f, 0f };
	...
	func_104(Global_1914319->f_3[iParam0]->f_10);
	func_105(iParam0, 16);
	func_106(iParam0, 4);
...
bool func_61(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_111(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_125(&cVar6, 109029619), sVar9, func_125(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_125(&cVar6, 109029619), func_125(&cVar10, 109029619));
		}
...
void func_79(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_142(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_87(int iParam0, bool bParam1)
{
	...
	if (func_143(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_108(iParam0));
				func_147(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_108(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_108(iParam0)))
	{
		func_147(iParam0, 128);
		return 1;
	}
	func_146(iParam0, _create_persistent_character(func_145(iParam0)));
	_0x4f81ead1de8fa19b(func_108(iParam0));
	if (func_143(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_108(iParam0));
		func_147(iParam0, 2048);
...
{
	return func_150(Global_1914319->f_3[iParam0]->f_5, iParam1);
}

void func_93(int iParam0)
{
	if (func_85(Global_1914319->f_3[iParam0]->f_21) && func_151(Global_1914319->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_142(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_98(int iParam0, int iParam1)
{
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_25))
	{
		...
		func_52(iParam1, Global_1914319->f_3[iParam0]->f_25, 1);
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_28))
	{
		...
		func_52(iParam1, Global_1914319->f_3[iParam0]->f_28, 1);
...
bool func_107(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_162(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_108(iParam0));
}
...
void func_139(int iParam0)
{
	...
	if (!func_133(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
int func_144(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_0xfc77c5b44d5ff7c0(func_108(iParam0));
	func_146(iParam0, 0);
	return 1;
}
...
{
	return func_150(Global_1914319->f_3[iParam0]->f_6, iParam1);
}
...
bool func_172(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_205(iVar0) && func_206((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_212(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
