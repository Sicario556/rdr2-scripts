...
void func_2()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(-3685.423f, -2597.155f, -10f, 0f, 0f, -24.7897f, 116.6365f, 76.68949f, 15f, "m_volArmadillo_Restriction");
	func_7(iLocal_14, 1);
	iLocal_15 = _create_volume_cylinder_with_custom_name(-4800.448f, -2704.913f, 28.17212f, 0f, 0f, -47.25f, 134.75f, 95.75f, 50f, "m_VolRidgewoodFarm_Restriction");
	func_8(iLocal_15, 1);
	iLocal_16 = _create_volume_cylinder_with_custom_name(-3959.882f, -2132.151f, -5.324f, 0f, 0f, 0f, 35f, 35f, 20f, "m_volTwinRocks_Restriction");
	func_8(iLocal_16, 1);
}
...
void func_3()
{
	if (!network_is_game_in_progress())
	{
		if (!func_9())
		{
			iLocal_19 = _create_volume_aggregate_with_custom_name("m_volGuardThreat");
			_0x39816f6f94f385ad(iLocal_19, -3960.03f, -2122.22f, -4.99f, 0f, 0f, 51f, 4.85f, 7.96f, 13.94f);
			_0x39816f6f94f385ad(iLocal_19, -3955.38f, -2127.12f, -4.19f, 0f, 0f, 51f, 7.61f, 7.5f, 12.32f);
			iLocal_18 = _create_volume_aggregate_with_custom_name("m_volGuardRestricted");
			_0x6e0d3c3f828da773(iLocal_18, iLocal_19);
			_0xbce668aaf83608be(iLocal_18, -3962.87f, -2135.84f, -5.32f, 0f, 0f, 0f, 27f, 27f, 20f);
			_0xbce668aaf83608be(iLocal_18, -3934.91f, -2138.85f, -5.32f, 0f, 0f, 0f, 10f, 10f, 20f);
			iLocal_17 = _create_volume_aggregate_with_custom_name("m_volGuardRegistration");
			_0x6e0d3c3f828da773(iLocal_17, iLocal_18);
			_0xbce668aaf83608be(iLocal_17, -3959.88f, -2132.15f, -5.32f, 0f, 0f, 0f, 50f, 50f, 20f);
			sLocal_25 = "TWIN_ROCKS";
			_create_guard_zone(sLocal_25);
			_0x8c598a930f471938(sLocal_25, iLocal_17);
			_0x35815f372d43e1e5(sLocal_25, iLocal_18);
			_0xad3e07c37a7c1adc(sLocal_25, iLocal_18);
			_0xa1b0e6301e2e02a6(sLocal_25, iLocal_19);
		}
	}
}
...
void func_4()
{
	...
	{
		if (!_0xeb98b38ca60742d7(uVar3) && func_10(-154581735))
		{
			if (!_is_position_inside_imap_streaming_extents(-262371610, Global_36))
			{
				func_11(-154581735);
			}
		}
	...
	{
		if (!_0xeb98b38ca60742d7(uVar2) && func_10(-154581735))
		{
			if (!_is_position_inside_imap_streaming_extents(-262371610, Global_36))
			{
				func_11(-154581735);
	...
	{
		if (!_0xeb98b38ca60742d7(uVar1) && func_10(-154581735))
		{
			if (!_is_position_inside_imap_streaming_extents(-262371610, Global_36))
			{
				func_11(-154581735);
	...
	{
		if (!_0xeb98b38ca60742d7(uVar0) && func_10(-154581735))
		{
			if (!_is_position_inside_imap_streaming_extents(-262371610, Global_36))
			{
				func_11(-154581735);
		...
		else if (_0xeb98b38ca60742d7(uVar0) && !func_10(-154581735))
		{
			if (!_is_position_inside_imap_streaming_extents(-262371610, Global_36))
			{
				func_12(-154581735);
