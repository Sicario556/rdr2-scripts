...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 1, "MALE_B", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 2, "MALE_DEAD", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
bool func_28(var uParam0)
{
	...
	set_ped_config_flag(&(uParam0->f_20[2]), 385, true);
	return true;
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 3)
		{
			if (does_entity_exist(&(uParam0->f_20[iVar1])) && !is_entity_dead(&(uParam0->f_20[iVar1])))
			{
				if (func_65(&(uParam0->f_20[iVar1]), 0, &uLocal_9, &uVar0, 0, 0))
				{
		...
		if (&uParam0->f_469[0])
		{
			...
			activate_physics(&(uParam0->f_20[2]));
			set_ped_to_ragdoll(&(uParam0->f_20[2]), 3000, 15000, 0, false, true, false);
			return 1;
		}
	}
	if (!&uParam0->f_469[4])
	{
		if (is_ped_dead_or_dying(&(uParam0->f_20[2]), true))
		{
			if (is_entity_dead(&(uParam0->f_20[2])))
			{
				_0x3ca5e58c9731a16b(&(uParam0->f_20[2]), 60);
				uParam0->f_469[4] = 1;
			}
		}
	}
	...
	if (&uParam0->f_469[2])
	{
		...
		if (does_entity_exist(&(uParam0->f_20[1])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
			{
				...
				task_wander_standard(&(uParam0->f_20[1]), get_entity_heading(&(uParam0->f_20[1])), 1);
...
bool func_65(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_104(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_135(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_135(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_136(&(uParam0->f_490)))
							{
...
bool func_74(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_145(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_75(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_145(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_162(1) || *uParam0 & 8192 != 0))
				{
...
bool func_102(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_175(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_173(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_174(uParam2)
				{
					func_169(uParam2, 1);
					return true;
				}
...
bool func_103(int iParam0, var uParam1)
{
	...
	if (func_165(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_174(uParam1)
		{
...
void func_129(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_200(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_200(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_200(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_130(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_145(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_135(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_201(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
