...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder(1621.408f, -369.203f, 77.527f, 0f, 0f, 0f, 55f, 50f, 20f);
	return true;
}
...
void func_53(int iParam0, int iParam1, int iParam2)
{
	...
	Global_1392240->f_1[iParam0]->f_6[iParam1] = func_94(iParam2, 0, 0);
}
...
void func_80(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_133(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_88(int iParam0, bool bParam1)
{
	...
	{
		func_137(iParam0, _create_persistent_character(func_136(iParam0)));
		if (func_20() == -1)
		{
...
{
	func_141(iParam0, 4);
	func_143(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_142(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_142(iParam0));
	}
}
...
bool func_118(int iParam0)
{
	...
	if (func_159())
	{
		if (!func_160((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_164(Global_1935369->f_5[iParam0]->f_6, 1);
	func_165(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_86(Global_1914319->f_3[iParam0]->f_21) && func_167(Global_1914319->f_3[iParam0]->f_21))
	{
		func_168(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_169(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_133(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_152(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_182(iVar0) && func_187((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
var func_153(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_193(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
{
	func_207(iParam3, &vVar0, &Var3, &uVar6);
	if (func_208(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
