...
bool func_29(int iParam0)
{
	...
	if (func_138(iVar0, 0))
	{
		if (_is_ped_using_scenario_hash(iVar0, 817364163))
		{
			func_139(289);
			bLocal_26 = true;
		}
	...
	iLocal_18 = create_object(-1216485179, 2792.51f, -1170.51f, 46.92f, true, true, false, false, true);
	iLocal_19 = create_object(851401507, 2792.85f, -1169.68f, 47.97f, true, true, false, false, true);
	iLocal_17 = create_object(1843407141, 2793.77f, -1167.79f, 47.97f, true, true, false, false, true);
	func_131(iParam0, Global_35, 0, 0, 0, 1);
	...
	decor_set_int(iLocal_18, func_149(), 1075055456);
	decor_set_int(iLocal_19, func_149(), -1343505693);
	decor_set_int(iLocal_17, func_149(), -140392810);
	decor_set_int(iLocal_16, func_149(), -1801358778);
...
bool func_53(int iParam0)
{
	...
	set_model_as_no_longer_needed(-663641338);
	set_model_as_no_longer_needed(1843407141);
	set_model_as_no_longer_needed(851401507);
	set_model_as_no_longer_needed(-1216485179);
	if (does_entity_exist(iLocal_15) && does_entity_belong_to_this_script(iLocal_15, true))
	{
		func_172(iParam0, 11, iLocal_15, 0, 1, 1, 0);
		func_173(&iLocal_15);
	}
	if (does_entity_exist(iLocal_16) && does_entity_belong_to_this_script(iLocal_16, true))
	{
		func_174(&iLocal_16, 1, 0, 1);
	}
	if (does_entity_exist(iLocal_19) && does_entity_belong_to_this_script(iLocal_19, true))
	{
		set_object_as_no_longer_needed(&iLocal_19);
	}
	if (does_entity_exist(iLocal_17) && does_entity_belong_to_this_script(iLocal_17, true))
	{
		set_object_as_no_longer_needed(&iLocal_17);
	}
	if (does_entity_exist(iLocal_18) && does_entity_belong_to_this_script(iLocal_18, true))
	{
...
bool func_128(var uParam0)
{
	...
	{
		iLocal_24 = _0x0eb78c2b156635b1(665633627, 2793.896f, -1174.261f, 47.724f, 0f, 0f, 0f, 3f, 3f, 2f);
		_0xbe551c2cc421185d(iLocal_24, 1);
		_0x5b23dff8e0948bb2(iLocal_24, 0);
	}
	if (iLocal_25 == 0)
	{
		iLocal_25 = 1;
		request_model(-663641338, false);
		request_model(1843407141, false);
		request_model(851401507, false);
		request_model(-1216485179, false);
	}
	if (((!has_model_loaded(-663641338) || !has_model_loaded(1843407141)) || !has_model_loaded(851401507)) || !has_model_loaded(-1216485179))
	{
		return false;
	}
	return true;
...
int func_139(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_286(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_286(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_286(iParam0));
	...
	_0x7b204f88f6c3d287(func_286(iParam0));
	return 1;
}
...
void func_150(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_304(), true);
	}
}
...
bool func_154()
{
	return func_313(get_id_of_this_thread());
}
...
void func_156(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_318(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_159(int iParam0)
{
	...
	return func_319((*Global_1835011)[iParam0]->f_1);
}
...
int func_163(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_318(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_318(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
	...
	if (bVar0)
	{
		...
		if (func_317(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_318(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
...
int func_171(int iParam0)
{
	...
	_0x4f81ead1de8fa19b(func_286(iParam0));
	return 1;
}
...
void func_241(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_432(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_293(iVar1, func_432(uParam0), func_433(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_293(iVar3, func_432(uParam0), func_433(uParam0), 2, 1073741824);
		}
	}
}
...
void func_242(var uParam0)
{
	if ((func_83(uParam0, 268435456) && !func_90(func_432(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		...
		if (!is_entity_dead(iVar0))
		{
			...
			func_293(iVar0, vVar1, func_434(vVar1, Global_36, 1), 2, 1073741824);
...
bool func_258(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_466(iParam2, 1024))) || func_466(iParam2, 8)) && !func_287(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_467(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_466(iParam2, 4096)) && !func_287(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_467(iParam1, 2048);
			func_467(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_466(iParam2, 32)) && !func_287(*iParam1, 5632))
		{
...
int func_270(var uParam0, int iParam1)
{
	...
	if (func_317(uParam0, 8) && _0xdd0b7c5ae58f721d(func_475()))
	{
				...
				if (func_482((*uParam5)[iVar1]))
				{
					if (func_483((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							...
							{
								if (!func_484((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
...
void func_322(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_318(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
...
void func_356(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_138(Global_1360165[iParam0], 0);
...
bool func_454(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_621(iParam0, iParam2, iParam1, func_259() != -1);
	if (bParam4)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_267(iParam0, 16, 1))
			{
				...
				else if (func_138(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_138(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_293(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_640(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_642(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_138(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_644(Global_1360165[iParam0], 1);
				}
			}
			func_638(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_645(Global_1360165[iParam0]))
				{
				}
			}
			func_646(iParam0, Global_1360165[iParam0]);
...
void func_498(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_168() || !_0x6f1f0b17109309da(Global_43800, func_216(iParam0))))
	{
...
char* func_508(int iParam0)
{
	...
	{
		return func_652(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_653(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			else if (func_516(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_198(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_664(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
void func_525(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_671(uParam0, iVar0)) && !func_473(uParam0->f_1016[iVar0], 1))
			{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_668(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_318(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (func_556(uParam0->f_475[iParam1], 64) && func_677(uParam0, iParam1, 0))
				{
...
int func_544(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_328(uParam0))
	{
		case 0:
			...
			if (((!func_318(uParam0->f_1016[iVar2], 32) && func_682()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_318(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_318(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_327(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_318(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_318(uParam0->f_1016[iVar2], 256) || !func_417(&uVar5)) || bVar0)
			{
				if (func_687())
				{
					func_688();
...
bool func_547(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_692(uParam0, 0))
		{
			if (func_693(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_694(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_694(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_694(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_694(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_694(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_694(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_694(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_694(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_694(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_694(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_694(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_694(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_694(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_694(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_694(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_693(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_694(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_694(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_694(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_693(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_696(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_695(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_694(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_697(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_692(uParam0, 45))
				{
					if (func_693(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_698(uParam0->f_1522[iVar16], 2);
							func_695(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_699(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_698(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_693(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_698(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_698(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_692(uParam0, 57))
				{
					if (func_693(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_693(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_693(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_702(iVar17);
							}
							if (func_693(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_703(iVar17);
							}
							func_693(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_694(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_694(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_694(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_693(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_694(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_693(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_693(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_694(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_692(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_699(uParam0, 87, uParam0->f_1345[iVar18]);
						func_695(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_695(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_694(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_694(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_693(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_704(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_692(uParam0, 98))
				{
					if (func_693(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_705(uParam0, 99, uParam0->f_1633[iVar16]);
							func_705(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_705(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_693(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_696(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_548(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_351(uParam0->f_1522[iVar0], 2)) && !func_351(uParam0->f_1522[iVar0], 16)) && func_707(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_698(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_698(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_351(uParam0->f_1522[iVar0], 64))
			{
				...
				{
					func_708(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_698(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_551(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_502(uParam0->f_3[iVar0]->f_2)) && func_436(uParam0->f_3[iVar0]->f_10)) && !func_701(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_709(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_710(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_559(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_715(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_560(int iParam0, int iParam1, bool bParam2)
{
	...
	func_716(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_568(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_260(iParam0);
	if (((does_entity_exist(iVar1) && func_719(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
{
	return func_460(1328661203, func_734(), -1591664384, bParam0);
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_741(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_419(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_741(&(Global_1946804->f_1497.f_1[iVar1])) || func_614(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_419(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_419(&(uParam0->f_1[iVar1])) || func_614(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_622(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_745(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_623(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_747(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_259() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_477((*Global_1360165)[iParam0]->f_4.f_2) || func_319((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_758((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_760(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_563(iParam0, 44, 1);
			}
	...
	switch (func_667(uParam0->f_1633[iParam1]))
	{
		case 0:
			...
			if (!func_516(uParam0->f_1633[iParam1]->f_10, 256))
			{
				...
				{
					func_686(uParam0->f_1903, 0);
					func_777(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_516(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_778())
				{
					func_777(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_670(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_782(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
void func_675(int iParam0, float fParam1)
{
	...
	if (!(func_785(17) && func_198(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_680(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			{
				if ((func_8(uParam0) > 3 && !func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_786(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					func_698(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
			...
			if (func_556(uParam0->f_475[iParam2], 4))
			{
				...
				if (((((func_323(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_472(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_216(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_318(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
void func_683(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_318(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_318(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_436(func_435(Global_35, 0, 1, 0)) && !func_436(func_435(Global_35, 1, 1, 0))))
		{
			if (func_327(uParam0, uParam0->f_1684))
			{
				func_788(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_318(uParam0->f_1016[uParam0->f_1684], 16) && (func_436(func_435(Global_35, 0, 1, 0)) || func_436(func_435(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_318(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
...
void func_684(var uParam0, int iParam1, bool bParam2)
{
	...
	func_787(uParam0, func_533(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_790(uParam0, &(uParam0->f_475[iParam1])))
		{
	...
	{
		func_791(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_689(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_798(iVar0));
		iVar0++;
	}
}
...
bool func_700(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_701(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_776(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		if ((does_entity_exist(uParam0->f_3[iVar0]->f_2) && !is_string_null_or_empty(uParam0->f_3[iVar0]->f_9)) && _does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, "^"))
		{
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_776(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_776(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_707(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_351(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_556(uParam0->f_475[iVar0], 512)) || func_556(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_701(uParam0->f_3[iVar0]->f_1))
				{
					if (func_577())
					{
...
void func_712(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_170(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_714(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_799(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_724(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_138(iVar0, 0))
	{
		if (func_138(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_721(iParam0)) || func_722(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_802(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_804(iParam0);
					_0x7b204f88f6c3d287(func_805(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_805(iParam0, 0));
					func_806(iParam0);
				}
			}
			else
	...
	{
		if (func_138((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_267(iParam0, 32768, 1))
			{
		...
		while (iVar28 < 4)
		{
			...
			if (func_608(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_810(0))
				{
					...
					func_811(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_733(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_814("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_813(iParam1, 512) && func_736(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_709(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_813(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_813(iParam1, 4))) && (!func_709(Var4.f_4) || func_813(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_813(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_813(iParam1, 1048576)))
				{
...
int func_757(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_841((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_841((*Global_1347702)[63]->f_15, 1) || func_319((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_841((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_841((*Global_1347702)[134]->f_15, 1) || func_319((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_841((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_843(747937920, 1) && !func_841((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_764(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_297(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_297(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_297(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_297(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_297(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_297(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_297(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_297(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_297(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_297(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_297(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_297(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_297(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_297(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_297(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_297(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_297(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_297(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_297(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_297(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_297(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_297(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_297(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_297(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_297(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_297(iParam1, 1544915253))
	{
...
bool func_781(var uParam0, int iParam1)
{
	...
	if ((func_436(func_710(Global_35, 0, 0, 0)) && !func_318(uParam0->f_1016[iParam1], 16)) && !func_318(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_787(var uParam0, bool bParam1)
{
	...
	if ((func_323(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_318(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_472(uParam0, 64);
	}
...
{
	func_855(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_855(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_856(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_812(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_870(_get_weapon_clip_size(iParam0), iParam1);
...
int func_881()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_709(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_709(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
