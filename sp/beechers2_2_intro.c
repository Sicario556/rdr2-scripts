...
void func_51(int iParam0)
{
	...
	if (!func_155(uLocal_64, 8))
	{
		...
		{
			func_156();
			iLocal_51[11] = create_object(func_157(11), func_158(11), true, true, false, false, true);
			set_entity_coords(&(iLocal_51[11]), func_158(11), true, false, true, true);
			set_entity_rotation(&(iLocal_51[11]), func_159(11), 2, true);
...
bool func_53(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iLocal_51)
		{
			if (iVar0 == 10)
			{
				delete_object(iLocal_51[iVar0]);
			}
			else
			{
				_0xcaaf2bccfef37f77(&(iLocal_51[iVar0]), 8);
				set_object_as_no_longer_needed(iLocal_51[iVar0]);
			}
			iVar0++;
		}
		func_56(iParam0);
	}
	freeze_entity_position(&(uLocal_48[1]), false);
	return true;
}
...
bool func_128(int iParam0)
{
	...
	switch (iLocal_47)
	{
		case 0:
			func_268(109);
			Local_34[0] = -722030448;
			Local_34[1] = 2111816145;
			Local_34[2] = 1467774743;
			Local_34[3] = 411742897;
			Local_34[4] = -974480336;
			Local_34[4]->f_1 = 1;
			Local_34[5] = 1532774697;
			Local_34[5]->f_1 = 1;
			func_25(iParam0, 2);
			func_147();
			_set_weather_type(-1148613331, true, true, true, 30f, false);
			StringCopy(&cVar3, "MultiStart", 64);
			func_269(iParam0, cVar3);
			func_270(1);
			break;
		case 1:
			iVar1 = 0;
			while (iVar1 <= 11)
			{
				request_model(func_157(iVar1), false);
				iVar1++;
			}
			func_270(2);
			break;
		case 2:
			...
			while (iVar1 <= 11)
			{
				if (!has_model_loaded(func_157(iVar1)))
				{
					bVar2 = false;
				}
				iVar1++;
		...
		case 3:
			...
			while (iVar1 <= 11)
			{
				...
				{
					iLocal_51[iVar1] = create_object(func_157(iVar1), func_158(iVar1), true, true, false, false, true);
					func_271(iParam0, &(iLocal_51[iVar1]), 0);
					set_entity_rotation(&(iLocal_51[iVar1]), func_159(iVar1), 2, true);
					if (!func_272(iVar1))
					{
						set_entity_collision(&(iLocal_51[iVar1]), false, false);
						set_entity_coords(&(iLocal_51[iVar1]), func_158(iVar1), true, false, true, true);
						set_entity_rotation(&(iLocal_51[iVar1]), func_159(iVar1), 2, true);
					}
					func_274(iParam0, &(iLocal_51[iVar1]), func_273(iVar1), 0, 0, 1, 0);
				}
				iVar1++;
			}
			func_270(4);
		case 4:
			...
			while (iVar0 <= 1)
			{
				if (!func_276(iParam0, func_275(iVar0), uLocal_48[iVar0], 0, iVar0 == 0, -1629.4f, -1398.2f, 84f, 0f, -1341683964, 0, 1, 1))
				{
					bVar2 = false;
				}
				iVar0++;
			...
			if (bVar2)
			{
				set_current_ped_weapon(&(uLocal_48[0]), -1569615261, true, 0, false, false);
				set_current_ped_weapon(&(uLocal_48[0]), -1569615261, true, 1, false, false);
				_hide_ped_weapons(&(uLocal_48[0]), 2, true);
		...
		case 5:
			...
			while (iVar0 <= 1)
			{
				set_blocking_of_non_temporary_events(&(uLocal_48[iVar0]), true);
				func_271(iParam0, &(uLocal_48[iVar0]), 0);
				iVar0++;
			}
			func_162(1);
			func_131(iParam0, &(uLocal_48[0]), "UNCLE", 0, 0, 1);
			func_131(iParam0, &(uLocal_48[1]), "CharlesSmith", 0, 0, 1);
			func_274(iParam0, &(iLocal_51[10]), func_277(10), 0, 0, 1, 0);
			func_235(&(iParam0->f_428), -1649.858f, -1411.841f, 82.8555f, 167.4f, 1);
			func_270(6);
			return true;
	}
	return false;
...
bool func_139()
{
	return func_287(get_id_of_this_thread());
}
...
void func_141(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_292(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
void func_147()
{
	...
	while (iVar0 <= 5)
	{
		if (Local_34[iVar0]->f_1)
		{
			func_294(&(Local_34[iVar0]));
		}
		else
		{
			func_295(&(Local_34[iVar0]));
		}
		iVar0++;
	}
}
...
int func_150(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_292(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_292(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_304(uParam0, uParam0->f_1684))
				{
					...
					{
						func_306(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		if (func_291(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_292(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_306(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_152(int iParam0)
{
	...
	if (vdist2(func_179(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_326(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_327(uParam0->f_1522[iVar0], 128))
				{
					func_328(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
{
	set_ped_config_flag(&(uLocal_48[0]), 130, bParam0);
	set_ped_config_flag(&(uLocal_48[0]), 315, bParam0);
	set_ped_config_flag(&(uLocal_48[0]), 273, bParam0);
}
...
void func_182(int iParam0, int iParam1)
{
	...
	func_369(iParam1);
	StringCopy(&cVar0, func_178(), 64);
	func_370(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_188(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_371(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_198(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_375(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_211(bool bParam0, bool bParam1)
{
	if (!func_378(Global_43801))
	{
		Global_43801 = func_383("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_222(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_391(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_374() };
...
void func_223(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_239(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_392(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_226()
{
	return func_381(_0xc17f69e1418cd11f(3));
}
...
void func_231(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_409() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_233(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_410(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_412(iVar1, func_410(uParam0), func_411(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_412(iVar3, func_410(uParam0), func_411(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_410(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_410(uParam0) };
			func_412(iVar0, vVar1, func_413(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_239(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_416(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_416(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_420(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_418(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_243(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_428(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_248(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_434(1, (func_251() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_419(32768) && iParam1 != &Global_1946804->f_57[func_432(iParam3, 1)])
			{
				func_436();
...
void func_249(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_441(0), &Var5, iParam1);
}
...
bool func_250(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_442(*iParam1, 2))
	{
		...
		else if ((func_155(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
			task_pickup_carriable_entity(iParam0, _get_first_entity_ped_is_carrying(_get_last_mount(iParam0)));
			func_446(iParam1, 128);
			return false;
		}
		else
		{
	...
	{
		if (!func_155(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		if (func_442(*iParam1, 2336))
		{
			...
			if (func_447(iVar2, *iParam1))
			{
				func_448(iParam1, 32);
				func_448(iParam1, 256);
				func_448(iParam1, 2048);
				func_446(iParam1, 512);
				func_446(iParam1, 1024);
				func_446(iParam1, 4096);
			}
			else
			{
				return false;
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_155(iParam2, 1024))) || func_155(iParam2, 8)) && !func_442(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_446(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_155(iParam2, 4096)) && !func_442(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_446(iParam1, 2048);
			func_446(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_155(iParam2, 32)) && !func_442(*iParam1, 5632))
		{
			task_horse_action(iVar2, 3, 0, 0);
			func_446(iParam1, 256);
			func_446(iParam1, 1024);
		}
...
int func_263(var uParam0, int iParam1)
{
	...
	if (func_139())
	{
		...
		if (func_452(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_453(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_291(uParam0, 8) && _0xdd0b7c5ae58f721d(func_454()))
	{
		_0x798be43c9393632b(func_454());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_454())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
void func_269(int iParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8)
{
...
void func_271(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_457(), true);
	}
}
...
{
	func_458(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_459(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
bool func_276(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	if (!func_114(iParam1))
	{
		return false;
	...
	if (!func_463(iParam1, 28, 1))
	{
		func_464(iParam1, 28, 1);
	}
	*uParam2 = func_465(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_466(iParam0, *uParam2);
		func_467(*uParam2, bParam3, bParam4, 0);
		if (bParam4)
		{
...
int func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam5)
	{
		if (func_345((*uParam5)[iVar1]))
		{
			...
			{
				if (func_474((*uParam5)[iVar1]))
				{
					if (!func_475((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
				...
				if (func_474((*uParam5)[iVar1]))
				{
					if (func_475((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							...
							{
								if (!func_476((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
...
void func_298(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_488(1));
		if (!has_anim_dict_loaded(func_488(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_299(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		{
			fVar0 = func_493(uParam0, uParam0->f_1690);
		...
		if (func_292(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	if (func_63(uParam0, 16))
	{
		...
		fVar5 = func_413(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_306(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_493(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_296(uParam0, 4);
...
void func_306(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_485(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
	func_496(&iVar1, uParam2);
	func_497(&(uParam0->f_1904), iVar0, iVar1, fParam3);
	if (!Global_1935630->f_12)
	{
		if (!func_63(uParam0, 67108864))
		{
...
void func_307(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_312(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_500(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692), func_454(), 64);
			}
			if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_10)))
			{
				StringCopy(&(uParam0->f_1692.f_8), func_500(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692.f_8), func_501(), 64);
			}
			disable_control_action(0, -1722177808, false);
		}
		...
		{
			if (!func_502(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_502(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_496(&iVar19, uParam0->f_1345[iVar0]->f_1);
					func_503(&(uParam0->f_1904), iVar19);
				}
			}
			else
			{
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_502(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_504(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_413(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_502(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_502(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_502(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_506(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_506(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
void func_310(var uParam0, int iParam1)
{
	...
	if (func_8(uParam0) > 3)
	{
		...
		while (iVar0 < uParam0->f_1894)
		{
			...
			{
				func_510(uParam0, iVar0, iParam1);
			}
			else if (uParam0->f_475[iVar0]->f_6)
			{
				bVar1 = func_511(uParam0, iVar0);
				if (bVar1)
				{
					func_512(uParam0, iVar0, iParam1);
				}
			}
			iVar0++;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_524(uParam0)) && _is_anim_scene_started(func_524(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_524(uParam0));
				bVar1 = _is_anim_scene_finished(func_524(uParam0), false);
				bVar2 = _is_anim_scene_active(func_524(uParam0));
...
int func_324(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_525(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
struct<8> func_326(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_526(iParam1), 64);
		if (!is_string_null_or_empty(&cVar0))
		{
			iVar8 = func_527(uParam0, iParam1);
			if (iVar8 > 0)
			{
...
void func_334(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (func_463(iParam0, 64, 1))
	{
		func_534(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_534(iParam0, 33, 1);
		func_534(iParam0, 34, 1);
		func_536(iParam0, 1056964608, -1, 1061158912);
		func_537(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_464(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_464(iParam0, 35, 1);
			if (bParam8)
			{
				func_464(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	if (func_463(iParam0, 45, 1))
	{
		func_534(iParam0, 45, 1);
	}
	func_540(iParam0, 16, 1);
	func_534(iParam0, 44, 1);
...
void func_346(var uParam0)
{
	if (!func_544(uParam0->f_2, 1))
	{
		if (func_474(uParam0))
		{
			...
			{
				sVar0 = func_380(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_548())
				{
...
void func_369(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_551(iVar0, 4096, 0);
			func_551(iVar0, 131072, 0);
			func_552(iVar0, 1);
		}
		iVar0++;
	}
...
int func_370(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_553(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
void func_372(struct<4> Param0)
{
	...
	if (func_556(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_556(20))
			{
				return;
			}
			iVar0++;
...
int func_383(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_560(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
bool func_395(int iParam0)
{
	...
	else if (func_568(-525676072, iParam0))
	{
		if (func_567(iParam0))
		{
			return true;
...
void func_400(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_415(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_401()
{
	...
	if (func_415(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_415(iVar0))
	{
		...
		{
			func_571(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_412(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	if (is_entity_dead(iParam0))
	{
		return;
	...
	if (iParam0 == func_575(Global_35) && is_player_teleport_active())
	{
	}
	if (func_576(iParam0))
	{
		if (func_577(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_442(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
		if (is_ped_on_vehicle(iVar1, false))
		{
			...
			if (does_entity_exist(iVar0) && !is_entity_dead(iVar0))
			{
				...
				func_412(iVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (is_ped_on_mount(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_412(iVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_442(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_442(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_442(iParam5, 32), true);
	...
	else if (func_442(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_442(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_442(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_422(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_420(1108822547, 6))
	{
		if (bParam2)
		{
			func_418(iParam0, iVar0, func_251() != -1, 0, 0);
...
struct<5> func_430(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_580(iParam0))
	{
		...
		case -427144552:
			...
			if (bParam2 && func_582(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_583(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_583(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_584(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_586(iParam0, -1823706425))
			{
				Var0 = { func_439(-1838434463, Var0, 1084182731, bParam1) };
				Var0.f_4 = _0x6452b1d357d81742(iParam0, -1838434463);
			}
			else if (func_586(iParam0, -1483207246))
			{
				Var0 = { func_439(889965687, Var0, 1034665895, bParam1) };
				Var0.f_4 = _0x6452b1d357d81742(iParam0, 889965687);
			}
		...
		default:
			...
			else if (_inventory_fits_slot_id(iParam0, -833319691))
			{
				...
				if (!func_587(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
bool func_433(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_588();
	if (iParam2 == 39)
	{
	...
	if (func_589(iParam0, 866047851) && func_590(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_419(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	func_592(iParam2);
	func_593(iParam2, iVar5);
	if (&Global_1946804->f_1378.f_1[iParam2] != &Global_1946804->f_57[iParam2] && Global_1946804->f_57[iParam2]->f_1 > 1)
	{
		func_594(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_594(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_595(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_596(iParam0, iParam2, iParam1, func_251() != -1);
	if (bParam4)
	{
		func_597(&(Global_1946804->f_1378), 1, 3);
	}
	else
	{
		func_597(&(Global_1946804->f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_425(func_423(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_598(&(Global_1946804->f_2589), bParam0, bParam1, bParam2);
}
...
void func_436()
{
	func_600(&(Global_1946804->f_2776));
	func_601(32768);
...
struct<4> func_439(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_396(iParam0, 0))
	{
		return Var0;
	}
	_0x886dfd3e185c8a89(func_441(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_440(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_441(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_445(int iParam0, vector3 vParam1)
{
	...
	return func_602(vVar0, vVar3, vParam1);
}
...
void func_450(int iParam0, float fParam1)
{
	Global_40.f_11095.f_11[iParam0] = fParam1;
	if (iParam0 == 12)
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_605(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_606(1, bVar1, 1, uVar2);
		func_607(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_608(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_458(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	iVar0 = func_611(uParam0, iParam1);
	if (iVar0 != -1)
	{
	...
	{
		iVar1 = func_612(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_613(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_394(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_428(uParam0->f_13[iVar0], 2);
		}
	}
}
...
{
	func_615(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
int func_465(int iParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_114(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_253(Global_1360165[iParam0], 0))
			{
				...
				if (is_ped_ragdoll(Global_1360165[iParam0]))
				{
					if (bParam1)
					{
						func_617(iParam0, 1, "Stealing, but companion is a ragdoll");
					}
					else
					{
						return 0;
		...
		case 1:
			...
			if (!func_463(iParam0, 44, 0))
			{
				func_464(iParam0, 44, 0);
			}
			if (func_619(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_618(iParam0, 2);
			}
			break;
		case 2:
			...
			if (bParam22)
			{
				func_468(iParam0, 0, 0, 1);
			}
			func_534(iParam0, 33, 1);
			func_534(iParam0, 34, 1);
			func_534(iParam0, 29, 1);
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				if (is_entity_attached(Global_1360165[iParam0]))
				{
					...
					{
						func_617(iParam0, 1, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_412(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_620(iParam0, iParam13))
				{
					...
					{
						func_621(iParam0, iParam13, 0);
						func_622(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_463(iParam0, 25, 0))
						{
							func_534(iParam0, 25, 0);
						}
						func_464(iParam0, 66, 0);
						func_618(iParam0, 5);
		...
		case 6:
			if (func_253(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_624(Global_1360165[iParam0], 1);
				}
			}
			func_618(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_625(Global_1360165[iParam0]))
				{
				}
			}
			func_626(iParam0, Global_1360165[iParam0]);
...
void func_467(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_161() || !_0x6f1f0b17109309da(Global_43800, func_208(iParam0))))
	{
...
void func_489(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			vVar0 = { uParam0->f_1882 * FtoV(func_635(uParam0->f_1898)) };
			if (!func_506(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_490(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
		{
			...
			else if ((!func_636(512) || func_637(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_485(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_638(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_306(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					...
					func_640(uParam0, iVar2, iVar0, bVar3);
				}
				else if (func_641(uParam0->f_1633[iVar2]) != 0)
				{
					func_640(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_485(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_190(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_638(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_493(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_642(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
		...
		case 1:
			...
			{
				func_643(uParam0, iParam1, &uVar6, vVar9, &fVar12, &fVar13, &fVar14, &fVar15);
				if (fVar14 < fVar15)
				{
...
void func_494(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_645(uParam0, iVar0)) && !func_452(uParam0->f_1016[iVar0], 1))
			{
				if (!func_646(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_647(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_648(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
void func_496(int iParam0, var uParam1)
{
	*iParam0 = 0;
	...
	{
		if (func_502(uParam1, 1))
		{
			*iParam0 = 1;
		}
		else if (func_502(uParam1, 4))
		{
			*iParam0 = 4;
		}
		else if (func_502(uParam1, 2))
		{
			*iParam0 = 2;
		}
	}
...
void func_497(char* sParam0, int iParam1, int iParam2, float fParam3)
{
	func_503(sParam0, iParam2);
	func_649(iParam1, fParam3);
}
...
char* func_500(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_504(int iParam0, int iParam1, int iParam2)
{
...
void func_505(float fParam0, float fParam1)
{
	set_gameplay_cam_relative_heading(fParam0, 1f);
	set_gameplay_cam_relative_pitch(fParam1, 1f);
}

bool func_506(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_508(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_642(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_292(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_525(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_525(uParam0->f_475[iParam1], 64) && func_651(uParam0, iParam1, 0))
				{
					func_652(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_653(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_525(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_653(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
		case 4:
			func_513(uParam0, iParam1, 0, 0);
			break;
	}
}
...
int func_511(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_305(uParam0) != 11) && func_304(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_327(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_327(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_647(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_513(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_305(uParam0))
	{
		case 0:
			if (!bParam3)
			{
				if (!func_655(uParam0, iVar2))
				{
					uParam0->f_1685 = iParam1;
				}
				uParam0->f_475[iParam1]->f_7 = 1;
			}
			if (((!func_292(uParam0->f_1016[iVar2], 32) && func_656()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_292(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_292(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_304(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			if (func_659(Global_35, 242628503) || bVar0)
			{
				func_522(uParam0, 3);
				if (bVar0)
				{
			...
			break;
		case 3:
			if (!func_292(uParam0->f_1016[iVar2], 256))
			{
				if (func_395(&(uParam0->f_1903)))
				{
					func_660(uParam0->f_1903, 0);
				}
			}
			func_26(&(uParam0->f_1869));
			func_522(uParam0, 4);
		...
		case 4:
			...
			if ((func_292(uParam0->f_1016[iVar2], 256) || !func_395(&uVar5)) || bVar0)
			{
				if (func_661())
				{
					func_662();
...
bool func_516(var uParam0, char* sParam1, int iParam2)
{
	...
	{
		iVar16 = -1;
		func_665(uParam0, iVar18);
		if (func_666(uParam0, 0))
		{
			if (func_667(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					uParam0->f_1016[iVar16]->f_27 = 0;
					func_668(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_668(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_668(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_668(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_668(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_668(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_668(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_668(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_668(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_668(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_668(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_668(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_668(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_668(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_668(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_667(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_668(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_668(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_668(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					if (func_669(uParam0, 21, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_19), {Var20}, 3);
					}
					if (func_669(uParam0, 22, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_22), {Var20}, 3);
					}
					func_667(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_670(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_669(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					if (func_667(uParam0, 39, &iVar17))
					{
					...
					if (func_668(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_648(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_374() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_671(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				{
					if (func_667(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_672(uParam0->f_1522[iVar16], 2);
							func_669(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_673(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_672(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_667(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_672(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_672(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
			...
			while (iVar18 < 35)
			{
				...
				{
					if (func_667(uParam0, 51, &iVar17))
					{
						Var2.f_1 = iVar17;
					}
					func_667(uParam0, 43, &(Var2.f_3));
					if (func_669(uParam0, 52, &Var20))
					{
						MemCopy(&(Var2.f_4), {Var20}, 4);
					}
					func_668(uParam0, 53, &(Var2.f_8));
					if (func_667(uParam0, 54, &iVar17))
					{
						Var2.f_10 = iVar17;
					}
					func_673(uParam0, 55, &(Var2.f_11));
					func_673(uParam0, 56, &(Var2.f_12));
					iVar32 = -1;
					if (func_674(uParam0, Var2.f_1, &iVar32))
					{
				...
				if (func_666(uParam0, 57))
				{
					if (func_667(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_667(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_667(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_676(iVar17);
							}
							if (func_667(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_677(iVar17);
							}
							func_667(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_668(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_668(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_668(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_667(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_668(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_667(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_667(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							if (func_667(uParam0, 73, &iVar17))
							{
								uParam0->f_475[iVar16]->f_17 = iVar17;
							}
							if (func_667(uParam0, 75, &iVar17))
							{
								uParam0->f_475[iVar16]->f_4 = iVar17;
								bVar15 = true;
							}
							func_668(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
							if (func_673(uParam0, 63, &bVar19))
							{
								if (bVar19)
								{
			...
			while (iVar18 < 8)
			{
				...
				{
					func_667(uParam0, 86, &iVar16);
					if (iVar16 >= 0)
					{
						func_673(uParam0, 87, uParam0->f_1345[iVar18]);
						func_669(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_669(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_668(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_668(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_667(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_678(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_666(uParam0, 98))
				{
					if (func_667(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_679(uParam0, 99, uParam0->f_1633[iVar16]);
							func_679(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_679(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_667(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_670(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_517(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_327(uParam0->f_1522[iVar0], 2)) && !func_327(uParam0->f_1522[iVar0], 16)) && func_681(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_672(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_672(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_518(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_327(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	StringCopy(&Var2, func_454(), 64);
	StringCopy(&(Var2.f_8), func_501(), 64);
	uParam0->f_1708 = { Var2 };
	uParam0->f_1731 = { Var2 };
	if (!func_291(uParam0, 8))
	{
		_0x6a4d224fc7643941(func_454());
		func_451(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_454()))
		{
...
bool func_519(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_327(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_682(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_672(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_520(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_576(uParam0->f_3[iVar0]->f_2)) && func_415(uParam0->f_3[iVar0]->f_10)) && !func_675(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_683(uParam0->f_3[iVar0]->f_10))
					{
...
char* func_526(int iParam0)
{
	...
	{
		return func_688(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_689(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
Vector3 func_528(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_529(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_690(uParam0, iParam1);
	}
...
void func_530(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_691(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_531(int iParam0, int iParam1, bool bParam2)
{
	...
	func_692(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_537(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_534(iParam0, 50, 1);
		func_534(iParam0, 48, 1);
		func_534(iParam0, 49, 1);
		func_534(iParam0, 51, 1);
		func_534(iParam0, 52, 1);
		func_534(iParam0, 54, 1);
		func_534(iParam0, 55, 1);
	}
	else
	{
		func_464(iParam0, 50, 1);
		func_464(iParam0, 48, 1);
		func_464(iParam0, 49, 1);
		func_464(iParam0, 51, 1);
		if (bParam3)
		{
			func_464(iParam0, 54, 1);
		}
		else
		{
			func_534(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_464(iParam0, 52, 1);
			if (bParam3)
			{
				func_464(iParam0, 55, 1);
			}
		}
		else
		{
...
void func_539(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_252(iParam0);
	if (((does_entity_exist(iVar1) && func_695(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_542(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (!func_449(iParam1))
	{
		return;
	...
	func_534(iParam1, 39, 1);
	func_699(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_699(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_699(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_464(iParam1, 43, 1);
		}
		if (bParam4)
		{
			func_700(iParam1, 0, 1, 1, 1);
		}
	}
}
...
int func_553(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
void func_561(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_382(iParam0, 8))
		{
...
{
	iVar0 = func_432(func_704(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	if (func_568(81053684, iParam0))
	{
		return true;
	}
	if (func_568(-525676072, iParam0))
	{
		return true;
	}
	return false;
...
{
	iVar1 = func_432(func_704(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_571(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_415(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam0 == Global_35)
	{
		func_706(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_707(iParam0, &iVar0, &fVar25);
...
{
	return func_709(&uVar0, iParam0, iParam1);
}
...
{
	return func_439(1328661203, func_710(), -1591664384, bParam0);
}
...
struct<4> func_581(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_439(923904168, func_579(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_439(923904168, func_579(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_439(923904168, func_579(bParam0), -740156546, 0);
}
...
bool func_583(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_440(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_584(int iParam0, var uParam1, int iParam2)
{
...
struct<4> func_585(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_439(271701509, func_579(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_439(271701509, func_579(bParam0), 12999093, 0);
}
...
bool func_587(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_441(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_590(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_589(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_595(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	iVar1 = 12;
	...
	if (func_421(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
		if (bParam4)
		{
			func_593(iVar1, iVar3);
		}
	}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_717(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_397(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_717(&(Global_1946804->f_1497.f_1[iVar1])) || func_589(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_397(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_397(&(uParam0->f_1[iVar1])) || func_589(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
int func_596(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_720(iParam0, func_423(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_597(var uParam0, bool bParam1, int iParam2)
{
	bVar6 = func_251() != -1;
	iVar7 = func_718(0);
	if (func_419(32768))
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_420(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_721(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_598(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (*uParam0 <= 0)
	{
		return;
	...
	if (func_251() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_724(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_725(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_725(Global_40.f_7729);
				Global_1946804->f_1378 = func_725(Global_40.f_7729);
...
bool func_602(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
char* func_605(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
void func_606(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
{
	sVar0 = func_728(0, 1, bParam0, bParam1);
...
int func_612(var uParam0, char* sParam1)
{
	iVar0 = 0;
	while (iVar0 < 35)
	{
...
void func_615(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
...
void func_617(int iParam0, bool bParam1, char* sParam2)
{
	iVar0 = func_252(iParam0);
...
bool func_619(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_449(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_456((*Global_1360165)[iParam0]->f_4.f_2) || func_293((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_738((*Global_1360165)[iParam0]->f_63))
				{
					if (!func_739(iParam0, 0))
					{
						func_464(iParam0, 25, 0);
					}
				}
			}
			(*Global_1360165)[iParam0]->f_4 = { func_740(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_534(iParam0, 44, 1);
			}
...
void func_621(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_464(iParam0, 25, 1);
	}
}

void func_622(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (!is_entity_dead(iParam1))
	{
		if (func_742(iParam2))
...
void func_626(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_571(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_571(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_634(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_635(iParam1)) };
...
void func_640(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (func_641(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_485(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_395(&(uParam0->f_1903)))
				{
					func_660(uParam0->f_1903, 0);
					func_761(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_485(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_762())
				{
					func_761(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
bool func_642(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vVar0 = { vParam4 - vParam1 };
	vVar3 = { vParam1 - vParam10 };
	fVar6 = func_764(vParam7, vVar0);
	fVar7 = -func_764(vParam7, vVar3);
...
void func_643(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_413(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_644(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_766(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_646(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_452(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
bool func_647(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_649(int iParam0, float fParam1)
{
	if (!is_entity_dead(Global_35))
	{
	...
	if (!(func_769(17) && func_190(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
bool func_651(var uParam0, int iParam1, bool bParam2)
{
...
void func_652(var uParam0, int iParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_326(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
			if (!is_string_null_or_empty(&cVar1) && _0x6f1f0b17109309da(iParam1, &cVar1))
			{
				...
				{
					func_653(iVar9, Global_35, uParam2, uParam3);
				}
			}
		}
		iVar0++;
...
void func_653(int iParam0, var uParam1, var uParam2, var uParam3)
{
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
...
void func_654(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_327(uParam0->f_1522[iVar0], 1))
			{
			...
			{
				if ((func_8(uParam0) > 3 && !func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_770(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_548(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_672(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_328(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_525(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_300(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_451(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_208(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_292(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_655(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_525(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_657(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_292(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_292(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_415(func_414(Global_35, 0, 1, 0)) && !func_415(func_414(Global_35, 1, 1, 0))))
		{
			if (func_304(uParam0, uParam0->f_1684))
			{
				func_772(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_292(uParam0->f_1016[uParam0->f_1684], 16) && (func_415(func_414(Global_35, 0, 1, 0)) || func_415(func_414(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_292(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_304(uParam0, uParam0->f_1684) && !func_312(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_522(uParam0, 3);
	}
...
void func_658(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_773(uParam0, iParam1, &vVar1, &fVar0);
	func_771(uParam0, func_502(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_774(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_648(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_453(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_772(vVar1);
	...
	if (func_525(uParam0->f_475[iParam1], 16))
	{
		func_775(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
		...
		func_776(uParam0, iParam1, bParam2, &vVar4);
	...
	{
		open_sequence_task(&iVar20);
		func_777(uParam0, iParam1, bParam2, vVar1);
		close_sequence_task(iVar20);
		task_perform_sequence(Global_35, iVar20);
		clear_sequence_task(&iVar20);
	}
...
void func_663(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_782(iVar0));
		iVar0++;
	}
}
...
bool func_671(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (bParam7)
	{
...
bool func_674(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if (((func_675(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_380(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_783(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_380(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_380(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_783(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_783(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_679(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_681(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_327(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_525(uParam0->f_475[iVar0], 512)) || func_525(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_675(uParam0->f_3[iVar0]->f_1))
				{
					if (func_548())
					{
						StringCopy(&cVar1, func_380(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_380(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_686(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_760(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_690(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
...
void func_694(int iParam0)
{
	if (func_114(iParam0))
	{
		...
		{
			func_627(iParam0, 67108864, 1);
			func_534(iParam0, 19, 1);
		}
	}
}
...
int func_700(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_449(iParam0))
	{
		return 0;
...
int func_706(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (has_ped_got_weapon(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_793((386 + iVar28), 1);
			if (func_583(iParam0, &Var0, iVar5, 0))
			{
				if (func_584(iParam0, &Var6, iVar5))
				{
					Var29 = { func_439(iParam0, Var0, iVar5, 0) };
					func_794(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_795(0))
				{
					...
					func_796(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_707(int iParam0, int iParam1, float fParam2)
{
	bVar0 = true;
...
int func_709(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_799("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_798(iParam1, 512) && func_712(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_683(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_798(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_798(iParam1, 4))) && (!func_683(Var4.f_4) || func_798(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_798(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_798(iParam1, 1048576)))
				{
	...
	{
		iParam1 |= 512;
		return func_709(uParam0, iParam1, iParam2);
	}
...
{
	iVar0 = func_441(0);
	*uParam1 = { func_439(iParam0, func_581(0), iParam3, 0) };
...
void func_713(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_804(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_804(uParam0->f_2[iVar0], 1))
				{
					func_805(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_716(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (uParam0->f_1[iVar3]->f_1 == 1216705912 || uParam0->f_1[iVar3]->f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_593(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_593(iVar3, iVar0);
		}
	}
...
void func_723(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_251() == -1)
	{
		func_809(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_810(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
char* func_728(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_605(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_605(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_729()
{
	...
	func_821(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_730()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_821(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_731()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_821(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_737(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_826((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_826((*Global_1347702)[63]->f_15, 1) || func_293((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_826((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_826((*Global_1347702)[134]->f_15, 1) || func_293((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_826((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_828(747937920, 1) && !func_826((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
bool func_739(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_463(iParam0, 44, 1))
		{
			return false;
		}
	}
...
int func_743(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_830(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_830(1237718549, iParam1);
			return func_831(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_748(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_744(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_744(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_744(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_744(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_744(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_744(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_744(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_744(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_744(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_744(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_744(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_744(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_744(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_744(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_744(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_744(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_744(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_744(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_744(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_744(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_744(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_744(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_744(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_744(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_744(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_744(iParam1, 1544915253))
	{
...
bool func_765(var uParam0, int iParam1)
{
	...
	if ((func_415(func_684(Global_35, 0, 0, 0)) && !func_292(uParam0->f_1016[iParam1], 16)) && !func_292(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_766(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	if (func_836(uParam0, iParam1, sParam2))
	{
...
void func_767(var uParam0, var uParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
...
void func_771(var uParam0, bool bParam1)
{
	...
	if ((func_300(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_292(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_451(uParam0, 64);
	}
...
void func_773(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_525(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_484(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_452(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_413(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_484(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_452(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_413(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_839(uParam0) };
		...
		else if (!func_452(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_413(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
void func_775(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, var uParam7)
{
	func_840(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_840(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_841(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}

void func_776(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_413(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_452(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
		task_achieve_heading(0, uParam0->f_1016[&uParam0->f_475[iParam1]]->f_40, 0);
	}
	else
	{
		vVar0 = { func_842(uParam0, iParam1) };
		if (!func_90(vVar0))
		{
...
void func_777(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	vVar0 = { func_842(uParam0, iParam1) };
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_413(Global_36, vParam3, 1), 0);
		}
		...
		if (func_525(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_452(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_452(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
int func_781(int iParam0, int iParam1)
{
	...
	if (func_589(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
	...
	else if (func_567(&iVar2))
	{
		if (func_589(iVar2, -1303648999))
		{
			iVar0 = func_846();
		}
		else
...
int func_788(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_851(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_790(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_852(iParam0);
	}
...
bool func_794(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
	...
	Var0.f_9 = -1591664384;
	if (!func_587(*uParam1, &Var0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!_0x3e4e811480b3ae79(func_441(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_795(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_441(bParam0));
}
...
void func_797(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_855(_get_weapon_clip_size(iParam0), iParam1);
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_441(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_811(var uParam0, int iParam1)
{
	if (func_251() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_809(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_810(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
bool func_836(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
void func_837(int iParam0)
{
	...
	if (func_415(iVar0))
	{
		...
		else if (func_683(iVar0))
		{
			if (func_415(func_684(Global_35, 0, 7, 0)) || func_415(func_684(Global_35, 0, 9, 0)))
			{
				if (func_415(func_684(Global_35, 0, 8, 0)))
				{
					func_862(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_415(func_684(Global_35, 0, 7, 0)) || func_415(func_684(Global_35, 0, 9, 0)))
			{
				if (func_415(func_684(Global_35, 0, 10, 0)))
				{
					func_862(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_415(func_684(Global_35, 0, 2, 0)))
				{
...
void func_840(var uParam0, float fParam1, vector3 vParam2, vector3 vParam5)
{
	*uParam0 = fParam1;
	uParam0->f_4 = { vParam2 };
	uParam0->f_1 = { vParam5 };
...
Vector3 func_841(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
	vVar0 = { func_863(vParam0, vParam3, fParam9) };
	vVar3 = { func_863(vParam3, vParam6, fParam9) };
	return func_863(vVar0, vVar3, fParam9);
}

Vector3 func_842(var uParam0, int iParam1)
{
...
bool func_843(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_864(iParam0, 1))
		{
			return false;
		}
	}
	return func_865(iParam0, 0, bParam2) >= iParam1;
}
...
Vector3 func_863(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
int func_865(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_396(iParam0, 0))
	{
		return 0;
	...
	{
		return func_869(iParam0, 0);
	}
	uVar2 = _0xe787f05dfc977bde(func_441(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_866()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_683(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_683(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_869(int iParam0, bool bParam1)
{
	...
	Var0 = { func_872(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_873(&Var0, func_581(0));
	}
...
struct<14> func_872(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_441(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
