...
int func_54(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!_does_volume_exist(func_87(iParam3)))
	{
		return 0;
	}
	if (!is_entity_in_volume(Global_35, func_87(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if (iParam7 && func_92(get_player_index(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_114(&cVar6, 109029619), sVar9, func_114(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_114(&cVar6, 109029619), func_114(&cVar10, 109029619));
		}
...
bool func_90(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_89(vParam0))
	{
		return false;
...
bool func_91(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_142(&(Global_1898164->f_1[0]));
		if (func_143(iVar0) && func_144((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_145(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
char* func_114(char* sParam0, int iParam1)
{
	...
	return func_163(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_117(int iParam0)
{
	...
	if (func_164())
	{
		if (!func_165((*Global_1835011)[3]->f_1, 1))
		{
...
void func_128(int iParam0)
{
	...
	if (!func_122(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_170(Global_1935369->f_5[iParam0]->f_6, 1);
	func_171(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_83(Global_1914319->f_3[iParam0]->f_21) && func_173(Global_1914319->f_3[iParam0]->f_21))
	{
		func_174(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_175(Global_1914319->f_3[iParam0]->f_10, 0);
...
bool func_154(int iParam0, int iParam1, float fParam2)
{
	if (!func_145(iVar0))
	{
...
{
	func_213(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_227(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_208(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_231(iParam0) == 3 || (func_231(iParam0) == 1 && _0x01f4d242765c6b24(func_232(iParam0))))
	{
...
int func_237()
{
	if (!func_165((*Global_1835011)[4]->f_1, 1))
	{
		return 0;
	}
	else if (!func_165((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_165((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_165((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_165((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_165((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_165((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_273(int iParam0, int iParam1)
{
	...
	if (func_145(&(Global_1898164->f_1[0])))
	{
		func_238(&(Global_1898164->f_1[0]), 3);
	}
}
