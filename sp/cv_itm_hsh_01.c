...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, -0.0328f, 1.2303f, 0f, 0f, 1f, 1f, 5f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_16 = func_156(uParam0, -781771732, 0f, 0f, 0f, "s_inv_ginseng01x", 0, 1, 1);
	...
	func_160(uParam0, iLocal_14, 3, 1993269755, "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", -1, 0, -1073741824, 1065353216, 1);
...
{
	iVar0 = func_195(uParam0, iLocal_16);
	if (does_entity_exist(iVar0))
	{
		if (_get_anim_scene_entity_matrix(func_196(uParam0, iLocal_15), "s_inv_ginseng01x", &Var1, false, 0, 2))
		{
			set_entity_coords(iVar0, Var1, true, false, true, true);
			set_entity_rotation(iVar0, Var1.f_3, 2, true);
		}
	}
	if (!is_entity_dead(func_9(uParam0, iLocal_14)))
	{
		set_ped_reset_flag(func_9(uParam0, iLocal_14), 256, true);
	}
	return true;
}
...
bool func_91(var uParam0)
{
	...
	if (func_197(uParam0))
	{
		iLocal_30 = _0x4d0d2e3d8bc000eb(func_9(uParam0, iLocal_14), "p_mortarPestle02x_PH_L_HAND", 1);
		if (does_entity_exist(iLocal_30))
		{
			func_198(iLocal_30, func_196(uParam0, iLocal_15), "p_mortarPestle02x");
		}
		return true;
	}
	return false;
...
bool func_97(var uParam0)
{
	...
	{
		_0x2b02db082258625f(func_9(uParam0, iLocal_14), iLocal_30, "p_mortarPestle02x_PH_L_HAND", 1993269755, "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", 1);
	}
	return true;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_279(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_61(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_280(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_281(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_282(uParam0->f_36[iVar0]->f_1))
				{
				}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_198(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_198(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
{
	if (!func_303(uParam0, Local_17, 1, 0))
	{
		func_8(&iLocal_28, 1, 1);
		if (!is_entity_dead(func_9(uParam0, iLocal_14)))
		{
	...
	if (get_ped_index_from_entity_index(iLocal_29) != func_9(uParam0, iLocal_14))
	{
		func_8(&iLocal_28, 1, 1);
		return false;
	}
	...
	{
		iLocal_28 = func_304("INTERACT_GREET", -163964935, func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
		func_305(iLocal_28, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
	if (func_306(iLocal_28, 1))
	{
		return true;
	}
	return false;
...
bool func_208(var uParam0, int iParam1)
{
	...
	{
		if (!func_325(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_54(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_350(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_351(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_351(uParam0, 1, 0);
							}
						}
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_352(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_269(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_353(iVar1)))
			{
				func_354(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_355(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
void func_284(var uParam0, int iParam1)
{
	...
	else if (!func_325(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
void func_327(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_348(100f, 140f);
			}
		}
...
bool func_336()
{
	if (_is_ped_carrying(Global_35) || func_389(Global_35))
	{
		return true;
	}
	return false;
...
int func_353(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_280(iParam0), 0);
}
...
int func_368(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_423(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (_uilog_is_entry_registered(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489->f_361.f_194 = func_425("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, get_hash_key(func_373(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_382(char* sParam0, int iParam1)
{
	...
	return func_432(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_433((*Global_1835011)[59]->f_1, 1) || func_433((*Global_1347702)[1]->f_15, 1)) || func_434((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_457(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_458(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_460(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_462(iParam0, Global_1360165[iParam0]);
...
void func_439(var uParam0, int iParam1)
{
	...
	func_477(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_440(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_480(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_442(var uParam0, int iParam1)
{
	...
	{
		func_281(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_447(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_487(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_485();
				}
			}
			if ((bParam2 && !func_217(vVar0)) && !func_218(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_457((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_488((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_496((*Global_1360165)[iParam0]->f_4.f_2) || func_434((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_497((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_499(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_107(iParam0, 44, 1);
			}
...
void func_457(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_504(Global_35) && is_player_teleport_active())
	{
	}
	if (func_505(iParam0))
	{
		if (func_506(get_ped_index_from_entity_index(iParam0)))
		{
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_423(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_495(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_433((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_433((*Global_1347702)[63]->f_15, 1) || func_434((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_433((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_433((*Global_1347702)[134]->f_15, 1) || func_434((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_433((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_347(747937920, 1) && !func_433((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_510(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_464(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_464(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_464(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_464(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_464(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_464(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_464(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_464(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_464(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_464(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_464(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_464(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_464(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_464(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_464(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_464(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_464(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_464(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_464(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_464(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_464(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_464(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_464(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_464(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_464(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_464(iParam1, 1544915253))
	{
...
struct<4> func_515(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_423(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_547(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_423(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_548(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_423(bParam0));
}
...
bool func_557(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_423(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_558(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_423(bParam6), &Var0, 0);
	return uVar4;
}
