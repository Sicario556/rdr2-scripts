		...
		if (get_game_timer() > iLocal_238)
		{
			...
			switch (iLocal_237)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_239));
					...
					Global_1897950 = -1;
					iLocal_240 = (get_game_timer() + iLocal_236);
					iLocal_237 = 2;
					break;
				case 2:
					if (func_11() || iLocal_240 < get_game_timer())
					{
						func_12(iLocal_239);
						iLocal_240 = (get_game_timer() + iLocal_236);
						iLocal_237 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_239) || iLocal_240 < get_game_timer())
					{
						func_14(iLocal_239);
						iLocal_240 = (get_game_timer() + iLocal_236);
						iLocal_237 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_239) || iLocal_240 < get_game_timer())
					{
						func_16(iLocal_239);
						iLocal_240 = (iLocal_236 + get_game_timer());
						iLocal_237 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_239)))
					{
						if (func_17(func_6(iLocal_239), 4) && !iLocal_240 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_239) || iLocal_240 < get_game_timer())
							{
							...
							Jump @791; //curOff = 459
							if (iLocal_240 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_239);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_238 = (1000 + get_game_timer());
							}
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_239]->f_10);
							if ((*Global_1888801)[iLocal_239]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_239]->f_11);
							}
							Jump @791; //curOff = 772
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_239]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_239]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_209 = (*Global_1888801)[115]->f_4;
	_0xb469cfd9e065eb99(iLocal_209, 28);
	iLocal_211 = _create_volume_box_with_custom_name(-5507.549f, -2965.196f, -0.228844f, 0f, 0f, 14.50012f, 5.533408f, 8.440951f, 3.311345f, "Tumbleweed - m_volGunsmith");
	iLocal_213 = _create_volume_box(-5508.212f, -2964.63f, -0.4536f, 0f, 0f, 15.48608f, 1.15206f, 1.211619f, 2.44214f);
	iLocal_214 = _create_volume_box(-5506.212f, -2964.24f, -0.546059f, 0f, 0f, 15.38209f, 1.208323f, 1.559606f, 2.24757f);
	iLocal_212 = _create_volume_box(-5508.861f, -2960.149f, -0.730614f, 0f, 0f, 14.06083f, 5.590748f, 1.871594f, 1.963433f);
	_0xb469cfd9e065eb99(iLocal_211, 10108);
	iLocal_215 = _create_volume_aggregate_with_custom_name("Armadillo - m_volGeneral Agg");
	_0x39816f6f94f385ad(iLocal_215, -5486.887f, -2936.958f, -0.631974f, 0f, 0f, 37.50568f, 12.05108f, 6.394965f, 4.543615f);
	_0x39816f6f94f385ad(iLocal_215, -5479.758f, -2933.356f, -0.464321f, 0f, 0f, 37.59521f, 2.825781f, 2.131215f, 1.882721f);
	iLocal_216 = _create_volume_box(-5487.416f, -2939.017f, -0.416119f, 0f, 0f, 36.36512f, 1.251111f, 3.269273f, 2.026726f);
	iLocal_218 = _create_volume_box(-5485.543f, -2937.639f, -0.416119f, 0f, 0f, 36.36512f, 2.087f, 2.06f, 2.027f);
	iLocal_217 = _create_volume_box(-5492.82f, -2941.371f, -0.730614f, 0f, 0f, 127.4349f, 6.522694f, 1.871594f, 1.963433f);
	_0xb469cfd9e065eb99(iLocal_215, 10107);
	iLocal_210 = _create_volume_box_with_custom_name(-5514.454f, -2910.941f, 0.196263f, 0f, 0f, 28.00368f, 12.9595f, 18.61485f, 9.427321f, "Tumbleweed - m_volBartender");
	iLocal_223 = _create_volume_box(-5507.816f, -2947.645f, -1.491075f, 0f, 0f, -17.45158f, 8.984022f, 7.283852f, 4.458558f);
	iLocal_224 = _create_volume_box(-5507.87f, -2947.629f, -1.491075f, 0f, 0f, -17.45158f, 1.750185f, 2.572302f, 2.75889f);
	iLocal_225 = _create_volume_box_with_custom_name(-5539.533f, -3039.824f, 2.031336f, 0f, 0f, 3.990272f, 17.4913f, 32.03522f, 11.8878f, "Tumbleweed - m_volHorseShopPen");
	iLocal_222 = _create_volume_box_with_custom_name(-5602.326f, -2982.253f, 2.901444f, 0f, 0f, 141.0062f, 3.082703f, 10.21471f, 4.224741f, "Tumbleweed - m_volHomeStable");
	if (func_20() == -1)
	{
		iLocal_220 = _create_volume_box_with_custom_name(-5519.228f, -3044.427f, -1.508f, 0f, 0f, 0f, 14.36317f, 12.10584f, 4.473f, "Tumbleweed Horse Shop - m_volHorseShop");
		iLocal_221 = _create_volume_box_with_custom_name(-5510.71f, -3044.394f, -1.897282f, 0f, 0f, 0f, 4.170004f, 4.757886f, 3.852559f, "Tumbleweed Horse Shop - m_volHorseShopOutsideDoor");
		func_46(9, iLocal_221);
		_0xb469cfd9e065eb99(iLocal_220, 10109);
	}
	else
	{
		iLocal_220 = _create_volume_box_with_custom_name(-5519.228f, -3044.427f, -1.40419f, 0f, 0f, 0f, 14.36317f, 12.10584f, 4.472662f, "Tumbleweed Horse Shop - m_volHorseShop");
		_0xb469cfd9e065eb99(iLocal_220, 10109);
	}
	iLocal_226 = _create_volume_aggregate_with_custom_name("Tumbleweed - JAIL");
	_0x39816f6f94f385ad(iLocal_226, -5529.713f, -2927.539f, -1.328089f, 0f, 0f, 24.83998f, 6.747131f, 6.870256f, 6.016601f);
	_0x39816f6f94f385ad(iLocal_226, -5534.146f, -2922.72f, -1.771596f, 0f, 0f, 24.83998f, 10.62026f, 7.054735f, 6.016601f);
	_0x3efabb21e14a6bd1(iLocal_226, 5, 1);
	iLocal_234 = _create_volume_aggregate_with_custom_name("Tumbleweed - m_volGeneralWindowBlocking Agg");
	_0x39816f6f94f385ad(iLocal_234, -5493.421f, -2940.41f, 0.004f, 0f, 0f, 126f, 2.009f, 1.864f, 3f);
	_0x39816f6f94f385ad(iLocal_234, -5482.353f, -2931.596f, -0.675f, 0f, 0f, 126f, 3.034f, 1.23f, 3f);
	_0x39816f6f94f385ad(iLocal_234, -5480.939f, -2938.642f, -0.675f, 0f, 0f, -143f, 1.733f, 3.552f, 3f);
	_0x39816f6f94f385ad(iLocal_234, -5487.038f, -2942.457f, -0.675f, 0f, 0f, -143f, 1.5f, 2.219f, 3f);
	iLocal_235 = _create_volume_aggregate_with_custom_name("Tumbleweed - m_volGunsmithWindowBlocking Agg");
	_0x39816f6f94f385ad(iLocal_235, -5507.813f, -2960.458f, -1.20497f, 0f, 0f, 15f, 1f, 0.5f, 2.5f);
	_0x39816f6f94f385ad(iLocal_235, -5503.76f, -2966.969f, -0.981304f, 0f, 0f, -74.5f, 1.5f, 0.5f, 3f);
	_0x39816f6f94f385ad(iLocal_235, -5504.707f, -2963.481f, -0.981304f, 0f, 0f, -74.5f, 1.5f, 0.5f, 3f);
	return true;
}
...
bool func_15(int iParam0)
{
	if (func_20() == -1)
	{
		_text_database_request("SCTDAUD");
		if (!_text_database_has_loaded("SCTDAUD"))
		{
			return false;
		}
	}
...
void func_27(int iParam0)
{
	...
	func_62(iParam0);
	_0xb469cfd9e065eb99(iLocal_223, 10117);
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_77(&Global_1935630, 16384)) || func_77(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_80((*uParam0)[iVar3], 1) && func_81(iParam1)) && !func_82(iParam1, 16))
							{
								func_84(iParam1, func_83(), -1, 0, -1, 0);
								func_85((*uParam0)[iVar3], 1);
							}
							func_86(iParam1, 0);
						}
						bVar0 = true;
...
void func_49()
{
	...
	{
		iLocal_219 = _create_volume_box(-5514.326f, -2971.64f, 2.676027f, 0f, 0f, 14.88947f, 5.532164f, 5.257469f, 2.883436f);
	}
...
void func_57(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1935369->f_5[iParam0]->f_6 = func_130(iParam5, iParam0);
}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	if (func_136(iVar0) || func_137(iVar0, iParam0))
	{
		...
		Global_1914319->f_3[iParam0]->f_20 = func_138(5, Global_1914319->f_3[iParam0]->f_10, 2, iVar7);
	}
	*Global_1393529->f_114[iParam0] = { 0f, 0f, 0f };
	...
	func_145(Global_1914319->f_3[iParam0]->f_10);
	func_146(iParam0, 16);
	func_147(iParam0, 4);
...
{
	Global_1914319->f_3[iParam0]->f_30 = iParam1;
}
...
{
	func_149(&(Global_1914319->f_3[iParam0]->f_5), iParam1);
}

void func_64(int iParam0, int iParam1)
{
	func_149(&(Global_1914319->f_3[iParam0]->f_6), iParam1);
}
...
void func_70(int iParam0)
{
	...
	while (iVar0 < Global_40.f_9829)
	{
		if (&Global_40.f_9829[iVar0] == iParam0)
		{
			...
			{
				func_159(iVar0, 2);
				if (vdist(func_160(iVar2), Global_36) < 45f)
				{
...
void func_71()
{
	...
	{
		if (!_0x800df3fc913355f3(iLocal_228))
		{
			iLocal_228 = func_151(348);
			iLocal_229 = 0;
			bLocal_227 = false;
		}
		else if (_0xeb98b38ca60742d7(iLocal_228))
		{
			iLocal_229 = 0;
			bLocal_227 = false;
		}
		else if (!does_entity_exist(iLocal_229))
		{
			iLocal_229 = _0x31c70a716cae1fee(iLocal_228);
			bLocal_227 = false;
		}
		else if (is_entity_dead(iLocal_229))
		{
			iLocal_229 = 0;
			bLocal_227 = false;
		}
		...
		{
			_0xe1b3be07d3aadded(iLocal_229, 4, 1);
			bLocal_227 = true;
		}
	}
}
...
void func_72()
{
	...
	{
		if (((!bLocal_233 && !func_165(iVar0, 0)) && _0xbe28db99556ff8d9(iVar1) != 0) && _is_ped_using_scenario_hash(iVar1, 1595886358))
		{
			_0x8e901b65206c2d3e(iVar1);
			_0xb93a769b8b726950(iVar1, -1044357807);
			_0xc4cfce4c656ef480(iVar1);
			bLocal_233 = true;
		}
		else if (bLocal_233 && !_is_ped_using_scenario_hash(iVar1, 1595886358))
		{
			bLocal_233 = false;
		}
	}
...
bool func_81(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_172(iParam0));
}
...
void func_84(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_186(&cVar6, 109029619), sVar9, func_186(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_186(&cVar6, 109029619), func_186(&cVar10, 109029619));
		}
...
void func_96(int iParam0)
{
	...
	if (_does_volume_exist(iLocal_219))
	{
		_delete_volume(iLocal_219);
	}
	if (_does_text_database_exist("SCTDAUD"))
	{
		if (_text_database_has_loaded("SCTDAUD"))
		{
			_text_database_delete("SCTDAUD");
		}
	}
	func_200();
}
...
void func_99(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_202(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_104(int iParam0)
{
	...
	Global_1396116->f_98[iParam0]->f_1 = func_182();
}
...
void func_105()
{
	...
	Local_117[0]->f_43 = 34281;
	Local_117[0]->f_44 = 34560;
	func_209(Local_117[0], 512);
	uVar6 = 5;
	func_206(&Local_117, 353, &uVar6, 1, 0);
	Local_117[1]->f_43 = 34624;
	Local_117[1]->f_44 = 34560;
	func_209(Local_117[1], 512);
}
...
void func_106(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	func_214(iParam0);
	func_215(iParam0, 1);
	Global_40.f_9384[iParam0]->f_1 = func_182();
}
...
int func_112(int iParam0, bool bParam1)
{
	...
	{
		func_216(iParam0, _create_persistent_character(func_205(iParam0)));
		if (func_20() == -1)
		{
			if (func_203(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_151(iParam0));
				func_217(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_151(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_151(iParam0)))
	{
		func_217(iParam0, 128);
		return 1;
	}
	func_216(iParam0, _create_persistent_character(func_205(iParam0)));
	_0x4f81ead1de8fa19b(func_151(iParam0));
	if (func_203(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_151(iParam0));
		func_217(iParam0, 2048);
...
bool func_114(int iParam0)
{
	...
	return (!func_220() || is_bit_set(Global_40.f_7854, iParam0));
}
...
{
	return func_138(iParam0, iParam1, 4, get_hash_key(func_222(iParam1)));
}
...
void func_127(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_229(iParam0))
	{
		...
		if (bParam3)
		{
			func_230(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
{
	func_235(Global_1935369->f_5[iParam0]->f_6, 1);
	func_236(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	return func_239(Global_1914319->f_3[iParam0]->f_5, iParam1);
}

void func_135(int iParam0)
{
	if (func_110(Global_1914319->f_3[iParam0]->f_21) && func_240(Global_1914319->f_3[iParam0]->f_21))
	{
		func_241(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_242(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_202(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_140(int iParam0, int iParam1)
{
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_25))
	{
		...
		func_65(iParam1, Global_1914319->f_3[iParam0]->f_25, 1);
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_28))
	{
		...
		func_65(iParam1, Global_1914319->f_3[iParam0]->f_28, 1);
...
bool func_150(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_155(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_151(iParam0));
}
...
bool func_156(int iParam0, int iParam1)
{
	...
	return func_239(Global_40.f_9829[iParam0]->f_2, iParam1);
}
...
void func_157(int iParam0, int iParam1)
{
	...
	func_149(&(Global_40.f_9829[iParam0]->f_2), iParam1);
}
...
void func_159(int iParam0, int iParam1)
{
	...
	func_259(&(Global_40.f_9829[iParam0]->f_2), iParam1);
}
...
Vector3 func_160(int iParam0)
{
	...
	return _0x5ee6fccc9c832ca2(func_151(iParam0));
}
...
bool func_161(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_128(vVar0))
	{
		_0x59c7ad6fea2ac449(func_151(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = _0x08fc896d2cb31fcc(func_151(iParam0), 0);
	}
	else
	{
		iVar3 = _0x0cadc3a977997472(func_151(iParam0), 0);
	}
	if (!func_128(vVar0))
	{
		_0xbb68908cd11aebdc(func_151(iParam0));
	}
...
void func_170(var uParam0)
{
	...
	{
		if (func_267((*uParam0)[iLocal_116], 1, 1))
		{
			func_268((*uParam0)[iLocal_116]);
		}
	}
	iLocal_116++;
	if (iLocal_116 >= 2)
...
char* func_186(char* sParam0, int iParam1)
{
	...
	return func_276(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_189(int iParam0)
{
	...
	if (func_220())
	{
		if (!func_277((*Global_1835011)[3]->f_1, 1))
		{
...
void func_199(int iParam0)
{
	...
	if (!func_193(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_200()
{
	...
	while (iVar0 < 2)
	{
		if (func_162(&(Local_117[iVar0]->f_34)))
		{
			func_265(&(Local_117[iVar0]->f_34));
		}
		func_281(Local_117[iVar0]->f_38);
		func_281(Local_117[iVar0]->f_39);
		iVar0++;
	}
...
int func_204(int iParam0, bool bParam1)
{
	...
	func_284(iParam0);
	_0xfc77c5b44d5ff7c0(func_151(iParam0));
	func_216(iParam0, 0);
	return 1;
}
...
void func_206(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		func_209((*uParam0)[iParam3], 128);
	}
	if (!func_162(&((*uParam0)[iParam3]->f_34)))
	{
		func_286(&((*uParam0)[iParam3]->f_34), 1);
	}
	func_209((*uParam0)[iParam3], 32768);
	func_209((*uParam0)[iParam3], 1024);
...
bool func_212(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_295(&(Global_1898164->f_1[0]));
		if (func_296(iVar0) && func_297((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_225(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			_0xca41e86545413b5b(func_301(iParam0), func_295(iParam0), func_302(iParam0), func_300(iParam0), Global_36);
		}
	}
	func_303(iParam0, 1);
	bParam1 = bParam1;
...
void func_226(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_247(Global_1898330[iParam0]);
		func_304((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}
...
void func_230(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_229(iParam0))
	{
...
{
	func_259(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_239(Global_1914319->f_3[iParam0]->f_6, iParam1);
}
...
bool func_250(int iParam0)
{
	...
	return func_316((*Global_1835011)[iParam0]->f_1);
}
...
void func_258(struct<16> Param0, int iParam16)
{
	...
	{
		if (_get_number_of_references_of_script_with_name_hash(get_hash_key(&(Param0.f_10))) > 0 || func_318(&(Param0.f_10)))
		{
			return;
		}
	}
...
bool func_261(int iParam0)
{
	...
	{
		_0x49a8c2cd97815215(func_151(iParam0));
		if (!does_entity_exist(_0x0cadc3a977997472(func_151(iParam0), 0)))
		{
			return false;
		}
	}
...
void func_268(var uParam0)
{
	...
	if (is_string_null_or_empty(func_333(&vVar0)))
	{
		return;
	}
	...
	if (!func_287(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			iVar5 = func_155(&(uParam0->f_3[iVar4]));
			if (!func_334(iVar5, 0))
			{
				return;
			}
...
var func_271(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_324(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_364(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_326(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319->f_17371 || func_370(func_155(*uParam0), 1, 1, 1, 0)) || _is_ped_hogtied(func_155(*uParam0)))
	{
		func_366(uParam0);
		return uParam0->f_30;
	}
	if ((((func_371(player_id(), 1, 0, 1) || func_372()) || _0xf46108c50a22b029()) || _0x69e181772886f48b(player_id())) || _0xd1f6b912785bfd35(player_id()))
	{
		return false;
	}
...
void func_330(var uParam0)
{
	...
	if (uParam0->f_2)
	{
		...
		while (iVar1 < 5)
		{
			if (func_110(&(uParam0->f_3[iVar1])) && uParam0->f_3[iVar1]->f_2)
			{
				iVar2 = func_155(&(uParam0->f_3[iVar1]));
				if (does_entity_exist(iVar2))
				{
...
bool func_331(var uParam0, int iParam1)
{
	if (func_287(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			iVar1 = func_155(&(uParam0->f_3[iVar0]));
...
bool func_337(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	...
	else if (func_384(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		iVar0 = uParam0[0];
		iVar1 = uParam0[1];
		if ((does_entity_exist(iVar0) && !func_385(iVar0, 0)) && (does_entity_exist(iVar1) && !func_385(iVar1, 0)))
		{
			if (!func_128(vParam4))
			{
...
{
	func_389(iParam3, &vVar0, &Var3, &uVar6);
	if (func_390(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_346(int iParam0)
{
	...
	return func_316((*Global_1347702)[iParam0]->f_15);
}
...
int func_370(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	{
		if (_is_weapon_sniper(func_397(iVar0, 0)))
		{
...
int func_372()
{
	if (_is_ped_carrying(Global_35) || func_400(Global_35))
	{
		return 1;
	}
	return 0;
...
{
	if (!does_entity_exist(iParam0) || func_385(iParam0, 0))
	{
		return false;
	}
	if (func_401(iParam0))
...
bool func_381(int iParam0, int iParam1)
{
	...
	return func_254(Global_1914319->f_3[iParam0]->f_10, 1024);
}
...
{
	if (((func_394(1) || _0x2b101ad9f651243a()) || is_scripted_speech_playing(iParam0)) || is_any_speech_playing(iParam0))
	{
		return true;
	}
	return false;
