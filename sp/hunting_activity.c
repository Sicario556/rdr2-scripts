...
{
	if (has_force_cleanup_occurred(514) && !func_1(&Global_1935630, 16384))
	{
		func_2(&Local_3);
...
{
	if (does_blip_exist(Local_3.f_46))
	{
		remove_blip(&(Local_3.f_46));
	}
	if (_does_volume_exist(iLocal_85))
	{
		_delete_volume(iLocal_85);
	}
	destroy_itemset(iLocal_70);
	destroy_itemset(iLocal_69);
	destroy_itemset(iLocal_71);
	destroy_itemset(iLocal_72);
	_0x7d4e70a67a651c71(uParam0->f_49);
}
...
bool func_3(var uParam0)
{
	...
	switch (uParam0->f_56)
	{
		...
		case 2:
			...
			{
				if (!is_entity_in_volume(Global_35, func_9(func_8()), true, 0))
				{
					if (!func_10(0))
					{
			...
			if (_0xf256a75210c5c0eb(uParam0->f_51, Global_36))
			{
				uParam0->f_46 = _0xa6ef0c54a3443e70(1247852480, uParam0->f_51);
	...
	switch (uParam0->f_57)
	{
		...
		case 1:
			*uParam0 = func_20();
			...
			fVar0 = 50f;
			uParam0->f_51 = _create_volume_cylinder_with_custom_name(uParam0->f_53, 0f, 0f, 0f, fVar0, fVar0, 20f, "Hunting Grounds");
			if (_does_volume_exist(uParam0->f_51))
			{
				uParam0->f_57 = 2;
			}
			break;
		case 2:
			...
			func_23(&uVar5, 20);
			func_23(&uVar5, 23);
			iLocal_85 = _create_volume_cylinder_with_custom_name(Global_36, 0f, 0f, 0f, 50f, 50f, 20f, "hunting behaviour vol");
			_0x7c00cfc48a782dc0(iLocal_85, Global_35, 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
			_0x3caad93fa5b9579a(iLocal_85, 2, uVar5);
			uParam0->f_45 = func_24(Global_1391438->f_414.f_2);
			iLocal_69 = create_itemset(true);
			iLocal_70 = create_itemset(true);
			iLocal_71 = create_itemset(true);
			iLocal_72 = create_itemset(true);
			func_6(&uLocal_73, 1);
			func_6(&uLocal_82, 1);
			uParam0->f_57 = 3;
			break;
...
int func_14(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_32((*Global_1835011)[59]->f_1, 1) || func_32((*Global_1347702)[1]->f_15, 1)) || func_33((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
...
void func_15(var uParam0)
{
	...
	iVar0 = get_itemset_size(iLocal_70);
	iVar1 = 0;
	while (iVar1 < iVar0)
	{
		iVar2 = _0x3ffb15534067dcd4(get_indexed_item_in_itemset(iVar1, iLocal_70));
		if (func_38(iVar2, Global_35) || func_38(iVar2, uParam0->f_45))
		{
			if (!is_in_itemset(iVar2, iLocal_71))
			{
				func_39("ACT_HUNTING_KILLED_TARGET", 10000, 0, 0, 0, 1);
				add_to_itemset(iVar2, iLocal_71);
				if (!func_10(0))
				{
			...
			else if (!is_in_itemset(iVar2, iLocal_72))
			{
				if (_0x8de41e9902e85756(iVar2))
				{
					add_to_itemset(iVar2, iLocal_72);
...
int func_31(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_57(func_56(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_36()
{
	iVar0 = _0x59b57c4b06531e1e(Global_36, 150f, iLocal_69, 1);
	iVar1 = 0;
	iVar2 = 0;
	while (iVar2 < iVar0)
	{
		iVar3 = _0x3ffb15534067dcd4(get_indexed_item_in_itemset(iVar2, iLocal_69));
		if (does_entity_exist(iVar3))
		{
			if (_0x9a100f1cf4546629(iVar3))
			{
				iVar4 = func_61(iVar3);
				if (iVar4 != -153407852)
				{
					if (!is_in_itemset(iVar3, iLocal_70))
					{
						add_to_itemset(iVar3, iLocal_70);
						iVar1++;
					}
				}
			}
...
{
	if (!_0x9a100f1cf4546629(iParam1))
	{
		return 0;
	}
...
bool func_76(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_32((*Global_1835011)[iParam0]->f_1, 1);
	}
