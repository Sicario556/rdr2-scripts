...
{
	func_33(uParam0, 10772, 10830, 11503);
}
...
{
	func_46(uParam0, "FOX_CATCH_RODENT", "script@ambient@animal@fox_catch_rodent@action", vParam1, vParam4);
	uParam0->f_16 = 1;
...
int func_31(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		bLocal_39 = _0x3ab6c7b0bb0df4b1(&(uParam0->f_20[0]), -1);
	}
	if (!&uParam0->f_469[0])
	{
		if ((func_64(uParam0, &uLocal_10, 1) || func_65(&(uParam0->f_20[0]), Global_35, 1) <= 400f) || is_entity_dead(&(uParam0->f_20[0])))
		{
			func_66(uParam0);
			if (!&uParam0->f_469[5])
			{
	...
	if (&uParam0->f_469[0] == 1)
	{
		if (!bLocal_38)
		{
			if (is_ped_using_any_scenario(&(uParam0->f_20[0])))
			{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_69(uParam0, 1.5f, 1116471296, 4, -91962372, 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
...
bool func_64(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_97(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
float func_65(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_98(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_74(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_115(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_75(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_97(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_136(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_100(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_160(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_160(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_160(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_115(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_173(1) || *uParam0 & 8192 != 0))
				{
...
bool func_134(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_186(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_184(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_185(uParam2)
				{
					func_180(uParam2, 1);
					return true;
				}
...
bool func_135(int iParam0, var uParam1)
{
	...
	if (func_176(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_185(uParam1)
		{
...
int func_136(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
bool func_140(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_158(int iParam0, var uParam1)
{
	...
	else if (func_150() - uParam1->f_4) > func_209(uParam1)
	{
...
void func_160(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
bool func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_199(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_218(iVar0, 0)))
		{
...
bool func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_218(iVar0, 0)))
		{
			if (func_220(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_199(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_208(int iParam0)
{
	...
	return func_226((*Global_1347702)[58]->f_15, 1);
}
...
bool func_219(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_220(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
