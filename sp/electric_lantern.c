void __EntryFunction__()
{
	...
	while (!func_2())
	{
		if (func_3())
		{
			vVar0 = { func_4(get_offset_from_entity_in_world_coords(Global_35, 0f, 5f, 0f) - get_entity_coords(Global_35, true, false)) };
			vVar3 = { func_5() };
...
bool func_3()
{
	...
	if (!does_entity_exist(iLocal_0))
	{
		if (get_current_ped_weapon(Global_35, &iVar0, true, 0, false))
		{
			if (iVar0 == 827679807)
			{
				iLocal_0 = get_object_index_from_entity_index(get_current_ped_weapon_entity_index(Global_35, 0));
			}
		}
	}
	if (does_entity_exist(iLocal_0))
...
bool func_9()
{
	if (get_current_ped_weapon(Global_35, &iVar0, true, 0, false) && iVar0 == 827679807)
	{
		return true;
	}
	if (get_current_ped_weapon(Global_35, &iVar0, true, 1, false) && iVar0 == 827679807)
	{
		return true;
	}
	if (get_current_ped_weapon(Global_35, &iVar0, true, 11, false) && iVar0 == 827679807)
	{
		return true;
	}
	return false;
