void __EntryFunction__()
{
	...
	while (!func_5(&Local_14, 1))
	{
		...
		if (((((func_6(&Local_14) >= 5 && func_6(&Local_14) <= 7) && !func_5(&Local_14, 4096)) && _does_anim_scene_exist(Local_14.f_428.f_444)) && _is_anim_scene_started(Local_14.f_428.f_444, false)) && !_is_anim_scene_paused(Local_14.f_428.f_444))
		{
		...
		switch (func_6(&Local_14))
		{
			...
			case 3:
				...
				func_39(&Local_14);
				if (func_40(func_32((*Global_1835011)[Local_14]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_14.f_428)) == 4 && _does_anim_scene_exist(Local_14.f_428.f_444)) && _is_anim_scene_paused(Local_14.f_428.f_444))
				{
					func_37(Local_14);
					func_17(&Local_14, 7);
				}
...
bool func_29(int iParam0)
{
	...
	{
		if (iParam0->f_4 && (vdist(func_126(*iParam0), Global_36) < 100f || vdist(get_entity_coords(iParam0->f_3, true, false), Global_36) < 100f))
		{
			task_go_to_coord_any_means(iParam0->f_3, func_126(*iParam0), 1f, 0, false, 524419, -1f);
		}
		else
		{
			set_entity_coords(iParam0->f_3, func_126(*iParam0), true, false, true, true);
		}
	}
	return true;
}
...
void func_35(int iParam0)
{
	...
	{
		if (func_142(&((*Global_1835011)[*iParam0]->f_29), 4))
		{
			set_clock_time(func_143(4), 0, 0);
		}
		else if (func_142(&((*Global_1835011)[*iParam0]->f_29), 2))
		{
			set_clock_time(func_143(2), 0, 0);
		}
		else if (func_142(&((*Global_1835011)[*iParam0]->f_29), 8))
		{
			set_clock_time(func_143(8), 0, 0);
		}
		else if (func_142(&((*Global_1835011)[*iParam0]->f_29), 16))
		{
			set_clock_time(func_143(16), 0, 0);
		}
		else if (func_142(&((*Global_1835011)[*iParam0]->f_29), 32))
		{
			set_clock_time(func_143(32), 0, 0);
		}
	}
}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_168(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_168(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_74(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_164(&(Global_1898164->f_1[0]));
		if (func_175(iVar0) && func_176((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_162(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	{
		if ((fVar3 >= func_180(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_181();
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_194("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_197(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_197(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_195(uParam0->f_501, 128))
		{
			func_196();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_93(1, 0);
	func_182(uParam0);
	if (func_210() && _0x6f1f0b17109309da(uParam0->f_444, func_197(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_214(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_228(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_236();
	set_entity_invincible(Global_35, func_195(*uParam0, 8));
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_168(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_168(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_168(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_168(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_241(iVar0), func_243(), 1))
			{
...
Vector3 func_125(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_197(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
{
	func_257(uParam0, iParam1, sParam2, iParam3, iParam4, bParam5, 0);
}
...
void func_133(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 31:
			...
			func_261(&(iParam0->f_428), 75f);
			break;
		case 34:
			func_260(&(iParam0->f_428), 35f);
			func_261(&(iParam0->f_428), 50f);
			break;
		case 62:
			func_260(&(iParam0->f_428), 25f);
			func_261(&(iParam0->f_428), 30f);
			break;
		default:
			break;
	}
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_241(iVar0));
...
bool func_139()
{
	return func_268(get_id_of_this_thread());
}
...
void func_141(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_273(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_144(int iParam0)
{
	...
	return func_274((*Global_1835011)[iParam0]->f_1);
}
...
int func_146(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_202(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
int func_148(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_275(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_273(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_273(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_282(uParam0, uParam0->f_1684))
				{
					...
					{
						func_284(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	bVar0 = func_286(uParam0, iParam5, bParam6);
	...
	if (bVar0)
	{
		...
		if (func_272(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_273(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_278(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_284(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_150(int iParam0)
{
	...
	{
		if (func_304(Global_35, iVar1, 1, 0))
		{
			func_25(iParam0, 8388608);
			return 1;
		}
	}
	if (vdist2(func_168(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_305(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_306(uParam0->f_1522[iVar0], 128))
				{
					func_307(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_156(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_311((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_311((*Global_1835011)[*iParam0], 65536);
		}
	}
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_314((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_316((*uParam1)[iVar0]))
		{
			if (func_314((*uParam1)[iVar0]->f_4, iParam12))
			{
	...
	while (iVar0 < *uParam2)
	{
		if (func_318((*uParam2)[iVar0]))
		{
			if (func_314((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_319((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_320((*uParam3)[iVar0]))
		{
			if (func_314((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_321((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_323((*uParam5)[iVar0]))
		{
			if (func_314((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_324((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_323((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_325((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_314((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_326((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_327((*uParam6)[iVar0]))
		{
			if (func_314((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_328((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_329((*uParam7)[iVar0]))
		{
			if (func_314((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_330((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_331((*uParam8)[iVar0]))
		{
			if (func_314((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_332((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_333((*uParam9)[iVar0]))
		{
			if (func_314((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_334((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_335((*uParam10)[iVar0]))
		{
			if (func_314((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_336((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_337((*uParam11)[iVar0]))
		{
			if (func_314((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_338((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_169(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_346(iParam1, 0, 0, 0);
}
...
void func_171(int iParam0, int iParam1)
{
	...
	func_347(iParam1);
	StringCopy(&cVar0, func_167(), 64);
	func_348(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_177(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_349(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_187(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_353(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_167());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
		...
		func_354(uParam0, uParam0->f_4, 0, 1);
...
bool func_200(bool bParam0, bool bParam1)
{
	if (!func_356(Global_43801))
	{
		Global_43801 = func_361("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_362(Global_43801, 0, 1);
		func_363(Global_43801, 6, 1);
		if (bParam1)
		{
			func_363(Global_43801, 14, 1);
		}
	}
	else
	{
		if (!func_199(Global_43801, 0))
		{
			func_364(Global_43801, 1, 1);
		}
		if (func_365(Global_43801, 1) != 0f && bParam0)
		{
			func_362(Global_43801, 1, 1);
		}
		else
		{
			func_362(Global_43801, 0, 1);
		}
		return func_366(Global_43801, 1);
	}
	return false;
}
...
void func_211(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_369(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_352() };
	func_369(uParam0, &Var1);
...
void func_212(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_228(uParam0->f_13[iVar0], 2))
		{
			if (func_228(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				func_370(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					iVar1 = get_ped_index_from_entity_index(&(uParam0->f_13[iVar0]));
					if (iVar1 != Global_35 && !func_228(uParam0->f_13[iVar0], 16))
					{
						func_371(iVar1);
					}
				}
...
bool func_215()
{
	return func_359(_0xc17f69e1418cd11f(3));
}
...
void func_220(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_387() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if (func_83(uParam0, 2048) && !func_90(func_388(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_390(iVar1, func_388(uParam0), func_389(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_390(iVar3, func_388(uParam0), func_389(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_388(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_388(uParam0) };
			func_390(iVar0, vVar1, func_391(vVar1, Global_36, 1), 2, 1073741824);
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_228(uParam0->f_13[iVar0], 8))
					{
						if (func_393(func_392(iVar1, 0, 1, 0)))
						{
							if (!func_394(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
								set_current_ped_weapon(iVar1, -1569615261, true, 0, false, false);
							}
						}
						if (func_393(func_392(iVar1, 1, 1, 0)))
						{
							if (!func_394(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
...
void func_227(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bVar4 = func_240() != -1;
	...
	else
	{
		...
		{
			func_396(iParam1, 29, bVar4, 1, 0);
			func_396(iParam1, 31, bVar4, 1, 0);
			func_396(iParam1, 30, bVar4, 1, 0);
			func_396(iParam1, 22, bVar4, 1, 0);
			func_396(iParam1, 37, bVar4, 1, 0);
		}
	}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_398(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
					if (!func_398(iVar3, 1) || bParam2)
					{
						...
						if (!bParam6)
						{
							func_396(iParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_396(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_232(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_406(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!func_411(iParam1, iParam2, func_410(iParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	func_412(1, (func_240() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_410(iParam3, 1)])
			{
				func_413(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_397(32768) && iParam1 != &Global_1946804->f_57[func_410(iParam3, 1)])
			{
				func_414();
				func_413(22, iParam3, 256, 0, 0);
			}
	...
	if (!bParam6)
	{
		if (bParam7)
		{
			func_413(22, iParam3, 0, 0, 0);
		}
		return 1;
	}
	iVar5 = func_415(iParam3);
	if (is_ped_a_player(iParam0))
	{
		func_413(19, 0, iVar5, 0, 0);
...
void func_238(int iParam0, int iParam1)
{
	...
	Var5 = { func_417(iParam0, Var0, Var0.f_4, 0) };
	if (func_418(iParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return;
	}
	_0x65a5f70f4a292ebe(func_419(0), &Var5, iParam1);
}

bool func_239(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
	...
	if (func_420(*iParam1, 2))
	{
		...
		else if ((func_424(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
			task_pickup_carriable_entity(iParam0, _get_first_entity_ped_is_carrying(_get_last_mount(iParam0)));
			func_425(iParam1, 128);
			return false;
		}
		else
		{
	...
	{
		if (!func_424(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		if (func_420(*iParam1, 2336))
		{
			...
			if (func_426(iVar2, *iParam1))
			{
				...
				func_427(iParam1, 2048);
				func_425(iParam1, 512);
				func_425(iParam1, 1024);
				func_425(iParam1, 4096);
			}
			else
			{
				return false;
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_424(iParam2, 1024))) || func_424(iParam2, 8)) && !func_420(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_425(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_424(iParam2, 4096)) && !func_420(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_425(iParam1, 2048);
			func_425(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_424(iParam2, 32)) && !func_420(*iParam1, 5632))
		{
			task_horse_action(iVar2, 3, 0, 0);
			func_425(iParam1, 256);
			func_425(iParam1, 1024);
		}
...
int func_252(var uParam0, int iParam1)
{
	...
	if (func_139())
	{
		...
		if (func_431(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_432(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_272(uParam0, 8) && _0xdd0b7c5ae58f721d(func_433()))
	{
		_0x798be43c9393632b(func_433());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_433())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_255(int iParam0)
{
	...
	return func_435((*Global_1835011)[iParam0]->f_1);
}
...
void func_257(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	func_436(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_437(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
void func_259(int iParam0, vector3 vParam1, int iParam4)
{
	...
	func_439(&(iParam0->f_958), iParam4);
}
...
int func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	iVar0 = 1;
	iVar1 = 0;
	while (iVar1 < *uParam0)
	{
		if (func_313((*uParam0)[iVar1]))
		{
			if (func_314((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_316((*uParam1)[iVar1]))
		{
			if (func_314((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_441((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_318((*uParam2)[iVar1]))
		{
			if (func_314((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_442((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		if (func_320((*uParam3)[iVar1]))
		{
			if (func_314((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_321((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_323((*uParam5)[iVar1]))
		{
			if (func_314((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_443((*uParam5)[iVar1]))
				{
					if (!func_444((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
			...
			if (func_314((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_443((*uParam5)[iVar1]))
				{
					if (func_444((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_325((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_445((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_327((*uParam6)[iVar1]))
		{
			if (func_314((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_446((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_329((*uParam7)[iVar1]))
		{
			if (func_314((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_447((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_331((*uParam8)[iVar1]))
		{
			if (func_314((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_448((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_333((*uParam9)[iVar1]))
		{
			if (func_314((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_449((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_335((*uParam10)[iVar1]))
		{
			if (func_314((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_450((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_337((*uParam11)[iVar1]))
		{
			if (func_314((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_451((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
int func_264(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	if (!func_114(iParam1))
	{
		return 0;
	...
	*uParam2 = func_457(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_257(iParam0, *uParam2, 0, 0, 0, 1, 0);
...
Vector3 func_269(var uParam0, int iParam1)
{
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			vVar10 = { func_462(vVar10) * Vector(2f, 2f, 2f) };
...
int func_275(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
void func_276(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_466(1));
		if (!has_anim_dict_loaded(func_466(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_277(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		{
			fVar0 = func_471(uParam0, uParam0->f_1690);
		...
		if (func_273(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_179(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_391(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_284(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_471(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_287(uParam0, 4);
			...
			if (func_239(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_271(uParam0, 4);
...
void func_284(var uParam0, var uParam1, var uParam2, float fParam3)
{
	if (func_463(uParam1, 8))
	{
		iVar0 |= 8;
	}
	if (func_463(uParam1, 8192))
	{
		iVar0 |= 32;
	}
	if (uParam0->f_1897)
	...
	if (func_463(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
	func_474(&iVar1, uParam2);
	func_475(&(uParam0->f_1904), iVar0, iVar1, fParam3);
	if (!Global_1935630->f_12)
	{
		if (!func_63(uParam0, 67108864))
		{
...
void func_285(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_291(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_478(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692), func_433(), 64);
			}
			if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_10)))
			{
				StringCopy(&(uParam0->f_1692.f_8), func_478(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692.f_8), func_479(), 64);
			}
			disable_control_action(0, -1722177808, false);
		}
		...
		{
			if (!func_480(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_480(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_474(&iVar19, uParam0->f_1345[iVar0]->f_1);
					func_481(&(uParam0->f_1904), iVar19);
				}
			}
			else
			{
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_480(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_482(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_391(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_480(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_480(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_480(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_484(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_484(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
int func_286(var uParam0, int iParam1, bool bParam2)
{
...
void func_289(var uParam0, int iParam1)
{
	...
	if (func_8(uParam0) > 3)
	{
		...
		while (iVar0 < uParam0->f_1894)
		{
			...
			{
				func_488(uParam0, iVar0, iParam1);
			}
			else if (uParam0->f_475[iVar0]->f_6)
			{
				bVar1 = func_489(uParam0, iVar0);
				if (bVar1)
				{
					func_490(uParam0, iVar0, iParam1);
				}
			}
			iVar0++;
		}
...
void func_294(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5)
{
	func_493(uParam0, 4);
...
bool func_299(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_179(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_300(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_179(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_502(uParam0)) && _is_anim_scene_started(func_502(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_502(uParam0));
				bVar1 = _is_anim_scene_finished(func_502(uParam0), false);
				bVar2 = _is_anim_scene_active(func_502(uParam0));
...
int func_303(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_503(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
bool func_304(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_308(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < &Global_1911670)
	{
		...
		if (_0xf6a8a652a6b186cd(iVar1))
		{
			...
			if (func_484(vVar2, vParam0, 2f, 1))
			{
...
{
	func_506(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_312(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (!func_114(iParam0))
	{
		return;
	...
	func_507(iParam0, 0);
	func_508(iParam0, 4, 0);
	func_509(iParam0);
	func_510(iParam0);
	func_511(iParam0, 37, 1);
	bVar0 = func_242(Global_1360165[iParam0], 0);
	...
	{
		func_511(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_511(iParam0, 33, 1);
		func_511(iParam0, 34, 1);
		func_513(iParam0, 1056964608, -1, 1061158912);
		func_514(iParam0, 1, 1, 0);
		if (bParam6)
		{
	...
	else
	{
		...
		{
			func_233(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
	...
	if (bParam1 || bParam2)
	{
		if (does_entity_exist(Global_1360165[iParam0]))
		{
			func_516(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	{
		func_511(iParam0, 45, 1);
	}
	func_517(iParam0, 16, 1);
	func_511(iParam0, 44, 1);
...
void func_324(var uParam0)
{
	if (!func_521(uParam0->f_2, 1))
	{
		if (func_443(uParam0))
		{
			...
			{
				sVar0 = func_358(get_entity_model(Global_35));
				if (_0x6f1f0b17109309da(uParam0->f_1, sVar0))
				{
					set_anim_scene_entity(uParam0->f_1, sVar0, Global_35, 0);
				}
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_zero") && func_247())
				{
					set_anim_scene_entity(uParam0->f_1, "player_zero", Global_35, 0);
				}
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_525())
				{
...
var func_346(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
void func_347(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_528(iVar0, 4096, 0);
			func_528(iVar0, 131072, 0);
			func_529(iVar0, 1);
		}
		iVar0++;
	}
...
int func_348(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_530(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}

void func_349(var uParam0, char* sParam1, bool bParam2)
{
	if (is_string_null_or_empty(sParam1))
	{
		return;
...
void func_350(struct<4> Param0)
{
	...
	if (func_533(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_533(20))
			{
				return;
			}
			iVar0++;
...
bool func_353(vector3 vParam0, vector3 vParam3)
{
...
int func_361(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_537(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
float func_365(int iParam0, bool bParam1)
{
	if (bParam1 && !func_356(iParam0))
	{
		return 0f;
...
void func_370(var uParam0, char* sParam1, int iParam2, int iParam3)
{
	if (!does_entity_exist(iParam2))
	{
		return;
...
bool func_373(int iParam0)
{
	...
	else if (func_545(-525676072, iParam0))
	{
		if (func_544(iParam0))
		{
			return true;
...
void func_378(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_393(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_379()
{
	iVar0 = func_392(Global_35, 9, 1, 0);
	if (func_393(iVar0))
	{
		return;
	}
	iVar0 = func_392(Global_35, 7, 1, 0);
	if (func_393(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 8, false, false);
	}
	iVar0 = func_392(Global_35, 0, 1, 0);
	if (func_393(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	}
	iVar0 = func_392(Global_35, 1, 1, 0);
	if (func_393(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	}
	iVar0 = func_392(Global_35, 18, 1, 0);
	if (func_393(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	...
	if (func_393(iVar0))
	{
		...
		{
			func_548(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
int func_381(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_390(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_552(Global_35) && is_player_teleport_active())
	{
	}
	if (func_553(iParam0))
	{
		if (func_554(get_ped_index_from_entity_index(iParam0)))
		{
...
float func_391(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
{
	return ((Global_1946804->f_57[func_410(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_400(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_398(1108822547, 6))
	{
		if (bParam2)
		{
			func_396(iParam0, iVar0, func_240() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_410(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_410(iParam0, 1)])->f_10 || iParam1);
}

void func_403(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_410(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_410(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_410(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_408(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_557(iParam0))
	{
		case -1037537535:
			...
			{
				Var0 = { func_417(889965687, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_417(-1838434463, Var0, 1084182731, bParam1) };
...
bool func_411(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_565();
	if (iParam2 == 39)
	{
		Var0 = { func_408(iParam0, 1, 0) };
		iParam2 = func_410(func_409(Var0.f_4), 1);
	}
	if (iParam2 < 0 || iParam2 >= 39)
	{
		return false;
	}
	if (func_566(iParam0, 866047851) && func_567(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_397(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_571(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_571(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_573(iParam0, iParam2, iParam1, func_240() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_403(func_401(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_412(bool bParam0, bool bParam1, bool bParam2)
{
	func_575(&(Global_1946804->f_2589), bParam0, bParam1, bParam2);
}

void func_413(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam4)
	{
		func_395(16384);
...
struct<4> func_417(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_374(iParam0, 0))
	{
		return Var0;
...
int func_418(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	if (!func_374(iParam0, 0))
	{
		return 0;
	}
	Var0 = { func_417(iParam0, Param1, iParam5, bParam6) };
...
void func_429(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_582(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_583(1, bVar1, 1, uVar2);
		func_584(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_585(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_436(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
...
void func_437(int iParam0, int iParam1, char* sParam2)
{
	func_592(&(iParam0->f_958), iParam1, sParam2, 0);
}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_249(iParam0, 16, 1))
			{
				...
				else if (func_242(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_242(Global_1360165[iParam0], 0))
			{
		...
		case 2:
			...
			func_511(iParam0, 18, 1);
			set_entity_visible(Global_1360165[iParam0], true);
			set_ped_relationship_group_hash(Global_1360165[iParam0], 1030835986);
			_0xf74e134f40192884(Global_1360165[iParam0], 0);
			_0x6759bee6762e140b((*Global_1360165)[iParam0]->f_1);
			set_ped_config_flag(Global_1360165[iParam0], 130, false);
			func_514(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_390(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 6:
			...
			func_595(iParam0, 7);
		case 7:
			func_514(iParam0, bParam9, bParam15, 0);
...
void func_459(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_153() || !_0x6f1f0b17109309da(Global_43800, func_197(iParam0))))
	{
...
void func_467(var uParam0, bool bParam1, bool bParam2)
{
	if (!_does_volume_exist(uParam0->f_1875))
	{
		if (!bParam1)
	...
	else
	{
		...
		if (bParam1)
		{
			vVar0 = { uParam0->f_1882 * FtoV(func_612(uParam0->f_1898)) };
			if (!func_484(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_468(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_179(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_179(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_179(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_613(512) || func_614(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_463(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_615(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_284(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					...
					func_617(uParam0, iVar2, iVar0, bVar3);
				}
				else if (func_618(uParam0->f_1633[iVar2]) != 0)
				{
					func_617(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_463(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_179(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_615(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
						if (func_239(Global_35, &(uParam0->f_1687), iVar4, 0, 0, 1084227584, 100, 0, 0))
						{
							set_player_control(get_player_index(), true, 0, false);
							uParam0->f_1687 = 0;
							func_271(uParam0, 33554432);
...
float func_471(var uParam0, int iParam1)
{
	fVar16 = 10000f;
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_619(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
		...
		case 1:
			...
			{
				func_620(uParam0, iParam1, &uVar6, vVar9, &fVar12, &fVar13, &fVar14, &fVar15);
				if (fVar14 < fVar15)
				{
...
void func_472(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_622(uParam0, iVar0)) && !func_431(uParam0->f_1016[iVar0], 1))
			{
				if (!func_623(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_624(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_625(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
void func_474(int iParam0, var uParam1)
{
	*iParam0 = 0;
	...
	{
		if (func_480(uParam1, 1))
		{
			*iParam0 = 1;
		}
		else if (func_480(uParam1, 4))
		{
			*iParam0 = 4;
		}
		else if (func_480(uParam1, 2))
		{
			*iParam0 = 2;
		}
	}
...
void func_475(char* sParam0, int iParam1, int iParam2, float fParam3)
{
	func_481(sParam0, iParam2);
	func_626(iParam1, fParam3);
}
...
char* func_478(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_482(int iParam0, int iParam1, int iParam2)
{
	vVar0 = { get_entity_coords(iParam0, false, false) };
	vVar3 = { get_entity_coords(iParam1, false, false) };
	return func_391(vVar0, vVar3, iParam2);
}
...
bool func_486(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_619(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_273(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_503(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_503(uParam0->f_475[iParam1], 64) && func_628(uParam0, iParam1, 0))
				{
					func_629(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_630(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_503(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_630(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
		case 4:
			func_491(uParam0, iParam1, 0, 0);
			break;
	}
}
...
int func_489(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_283(uParam0) != 11) && func_282(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_197(Global_35)))
		{
			if (func_306(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_306(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_624(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_491(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_283(uParam0))
	{
		case 0:
			if (!bParam3)
			{
				if (!func_632(uParam0, iVar2))
				{
					uParam0->f_1685 = iParam1;
				}
				uParam0->f_475[iParam1]->f_7 = 1;
			}
			if (((!func_273(uParam0->f_1016[iVar2], 32) && func_633()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_273(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 1:
			...
			if ((((!func_421(Global_35, 716706914) && !func_421(Global_35, 242628503)) && func_21(&(uParam0->f_1869)) >= 2.5f) || (!func_393(func_392(Global_35, 0, 1, 0)) && !func_393(func_392(Global_35, 1, 1, 0)))) || bVar0)
			{
				func_634(uParam0);
				if (bVar0)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_273(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_282(uParam0, uParam0->f_1688))
			...
			if (func_239(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4))
			{
				func_634(uParam0);
			}
		...
		case 7:
			...
			if (func_636(Global_35, 242628503) || bVar0)
			{
				func_500(uParam0, 3);
				if (bVar0)
				{
			...
			break;
		case 3:
			if (!func_273(uParam0->f_1016[iVar2], 256))
			{
				if (func_373(&(uParam0->f_1903)))
				{
					func_637(uParam0->f_1903, 0);
				}
			}
			func_26(&(uParam0->f_1869));
			func_500(uParam0, 4);
		...
		case 4:
			...
			if ((func_273(uParam0->f_1016[iVar2], 256) || !func_373(&uVar5)) || bVar0)
			{
				if (func_638())
				{
					func_639();
		...
		case 8:
			...
			if (func_239(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4) || bVar0)
			{
				uParam0->f_1686 = 0;
...
bool func_494(var uParam0, char* sParam1, int iParam2)
{
	...
	{
		iVar16 = -1;
		func_642(uParam0, iVar18);
		if (func_643(uParam0, 0))
		{
			if (func_644(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					uParam0->f_1016[iVar16]->f_27 = 0;
					func_645(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_645(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_645(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_645(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_645(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_645(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_645(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_645(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_645(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_645(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_645(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_645(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_645(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_645(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_645(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_644(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_645(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_645(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_645(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					if (func_646(uParam0, 21, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_19), {Var20}, 3);
					}
					if (func_646(uParam0, 22, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_22), {Var20}, 3);
					}
					func_644(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_647(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_646(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					if (func_644(uParam0, 39, &iVar17))
					{
					...
					if (func_645(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_625(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_352() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_648(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				{
					if (func_644(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_649(uParam0->f_1522[iVar16], 2);
							func_646(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_650(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_649(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_644(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_649(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_649(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
			...
			while (iVar18 < 35)
			{
				...
				{
					if (func_644(uParam0, 51, &iVar17))
					{
						Var2.f_1 = iVar17;
					}
					func_644(uParam0, 43, &(Var2.f_3));
					if (func_646(uParam0, 52, &Var20))
					{
						MemCopy(&(Var2.f_4), {Var20}, 4);
					}
					func_645(uParam0, 53, &(Var2.f_8));
					if (func_644(uParam0, 54, &iVar17))
					{
						Var2.f_10 = iVar17;
					}
					func_650(uParam0, 55, &(Var2.f_11));
					func_650(uParam0, 56, &(Var2.f_12));
					iVar32 = -1;
					if (func_651(uParam0, Var2.f_1, &iVar32))
					{
				...
				if (func_643(uParam0, 57))
				{
					if (func_644(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_644(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_644(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_653(iVar17);
							}
							if (func_644(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_654(iVar17);
							}
							func_644(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_645(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_645(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_645(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_644(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_645(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_644(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_644(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							if (func_644(uParam0, 73, &iVar17))
							{
								uParam0->f_475[iVar16]->f_17 = iVar17;
							}
							if (func_644(uParam0, 75, &iVar17))
							{
								uParam0->f_475[iVar16]->f_4 = iVar17;
								bVar15 = true;
							}
							func_645(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
							if (func_650(uParam0, 63, &bVar19))
							{
								if (bVar19)
								{
			...
			while (iVar18 < 8)
			{
				...
				{
					func_644(uParam0, 86, &iVar16);
					if (iVar16 >= 0)
					{
						func_650(uParam0, 87, uParam0->f_1345[iVar18]);
						func_646(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_646(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_645(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_645(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_644(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_655(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_643(uParam0, 98))
				{
					if (func_644(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_656(uParam0, 99, uParam0->f_1633[iVar16]);
							func_656(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_656(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_644(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_647(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_495(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_306(uParam0->f_1522[iVar0], 2)) && !func_306(uParam0->f_1522[iVar0], 16)) && func_658(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_649(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_649(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_496(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_306(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
			if (func_658(uParam0, iVar0))
			{
				iVar1 |= 1;
			}
	...
	StringCopy(&Var2, func_433(), 64);
	StringCopy(&(Var2.f_8), func_479(), 64);
	uParam0->f_1708 = { Var2 };
	uParam0->f_1731 = { Var2 };
	if (!func_272(uParam0, 8))
	{
		_0x6a4d224fc7643941(func_433());
		func_430(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_433()))
		{
...
bool func_497(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_306(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_659(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_649(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_498(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_553(uParam0->f_3[iVar0]->f_2)) && func_393(uParam0->f_3[iVar0]->f_10)) && !func_652(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_660(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_661(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
char* func_504(int iParam0)
{
	...
	{
		return func_197(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_665(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_666(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_506(var uParam0, int iParam1, char* sParam2)
{
	if (!_does_anim_scene_exist(uParam0->f_444))
	{
		return;
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_667(uParam0, iParam1);
	}
...
void func_507(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_668(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_508(int iParam0, int iParam1, bool bParam2)
{
	...
	func_669(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}

void func_509(int iParam0)
{
	func_508(iParam0, 8, 0);
}
...
void func_513(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_241(iParam0), 137, true);
	}
}
...
void func_514(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_511(iParam0, 50, 1);
		func_511(iParam0, 48, 1);
		func_511(iParam0, 49, 1);
		func_511(iParam0, 51, 1);
		func_511(iParam0, 52, 1);
		func_511(iParam0, 54, 1);
		func_511(iParam0, 55, 1);
	}
	else
	{
...
void func_515(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_241(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_241(iParam0), 204, false);
	}
}

void func_516(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_114(iParam0))
	{
		return;
	...
	iVar1 = func_241(iParam0);
	if (((does_entity_exist(iVar1) && func_672(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_519(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (!func_428(iParam1))
	{
		return;
	...
	func_511(iParam1, 39, 1);
	func_676(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_676(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_676(iParam1, 512, 1);
...
int func_530(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
void func_537(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
...
void func_538(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_360(iParam0, 8))
		{
...
{
	iVar0 = func_410(func_681(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	if (func_545(81053684, iParam0))
	{
		return true;
	}
	if (func_545(-525676072, iParam0))
	{
		return true;
	}
	return false;
...
{
	iVar1 = func_410(func_681(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_548(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_683(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_684(iParam0, &iVar0, &fVar25);
...
{
	return func_686(&uVar0, iParam0, iParam1);
}
...
{
	return func_417(1328661203, func_687(), -1591664384, bParam0);
}
...
struct<4> func_558(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_417(923904168, func_556(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_417(923904168, func_556(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_417(923904168, func_556(bParam0), -740156546, 0);
}

bool func_559(int iParam0, bool bParam1)
{
	if (func_375(iParam0) == 1779021115)
	{
		return false;
	}
...
{
	return func_418(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_561(int iParam0, var uParam1, int iParam2)
{
	if (func_689(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_562(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_417(271701509, func_556(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_417(271701509, func_556(bParam0), 12999093, 0);
}
...
int func_567(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_566(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	func_690(&(Global_1946804->f_2589), iParam0);
}

void func_570(int iParam0, int iParam1)
{
	func_691(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
{
	iVar1 = 12;
	iVar2 = func_375(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_693(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_693(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_693(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_693(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_375(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_694(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_375(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_566(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_694(&(Global_1946804->f_1497.f_1[iVar1])) || func_566(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_375(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_375(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_375(&(uParam0->f_1[iVar1])) || func_566(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_695(0);
	if (iParam2 != 0 && func_696(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_697(iParam0, func_401(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_574(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_398(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_698(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_575(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_700(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_240() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_701(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_702(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_702(Global_40.f_7729);
				Global_1946804->f_1378 = func_702(Global_40.f_7729);
...
void func_576(struct<4> Param0)
{
	switch (Param0)
	{
		...
		case 35:
		case 36:
			func_416(Param0, Param0.f_1, Param0.f_2);
			break;
	}
}
...
{
	sVar0 = func_705(0, 1, bParam0, bParam1);
...
void func_592(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	func_710(uParam0);
	iVar0 = func_711(uParam0, iParam1);
	if (bParam3)
	{
		if (is_string_null_or_empty(sParam2))
		{
		...
		iVar0 = func_712(uParam0, sParam2);
		if (iVar0 == -1)
		{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_714(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_435((*Global_1360165)[iParam0]->f_4.f_2) || func_274((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_714(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_715((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_717(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_511(iParam0, 44, 1);
			}
...
bool func_597(int iParam0, int iParam1)
{
	...
	bVar0 = func_718(iParam0, iParam1);
	return bVar0;
}
...
void func_599(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (!is_entity_dead(iParam1))
	{
		if (func_719(iParam2))
		{
			iVar0 = func_720(iParam2, -1);
			if (func_721(iParam1, iVar0))
			{
				if (func_722(iParam1, iVar0))
				{
					if (func_723(iParam1, iVar0))
					{
...
void func_603(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_548(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_548(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_611(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_612(iParam1)) };
...
void func_617(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (func_618(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_463(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_373(&(uParam0->f_1903)))
				{
					func_637(uParam0->f_1903, 0);
					func_738(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_463(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_739())
				{
					func_738(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
bool func_619(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vVar0 = { vParam4 - vParam1 };
	vVar3 = { vParam1 - vParam10 };
	fVar6 = func_741(vParam7, vVar0);
	fVar7 = -func_741(vParam7, vVar3);
...
void func_620(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_391(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_621(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_743(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_623(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_431(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
bool func_624(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_626(int iParam0, float fParam1)
{
	...
	if (!(func_746(17) && func_179(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
bool func_628(var uParam0, int iParam1, bool bParam2)
{
...
void func_629(var uParam0, int iParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_305(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
			if (!is_string_null_or_empty(&cVar1) && _0x6f1f0b17109309da(iParam1, &cVar1))
			{
				...
				{
					func_630(iVar9, Global_35, uParam2, uParam3);
				}
			}
		}
		iVar0++;
...
void func_630(int iParam0, var uParam1, var uParam2, var uParam3)
{
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
...
void func_631(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_306(uParam0->f_1522[iVar0], 1))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_197(Global_35), &vVar7, false, 0, 2))
				{
					fVar19 = (func_391(vVar1, Global_36, 1) - func_391(vVar1, vVar7, 1));
					vVar4.f_2 = (vVar4.z + fVar19);
					set_anim_scene_origin(uParam0->f_1522[iVar0]->f_8, vVar1, vVar4, 2);
				}
			}
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_197(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
				if ((func_8(uParam0) > 3 && !func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_747(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_525(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_649(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_307(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_503(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_278(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_430(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_197(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_273(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_197(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_748(uParam0, 0);
				}
			}
...
bool func_632(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_503(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_634(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_273(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_273(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_393(func_392(Global_35, 0, 1, 0)) && !func_393(func_392(Global_35, 1, 1, 0))))
		{
			if (func_282(uParam0, uParam0->f_1684))
			{
				func_749(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_273(uParam0->f_1016[uParam0->f_1684], 16) && (func_393(func_392(Global_35, 0, 1, 0)) || func_393(func_392(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_273(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_282(uParam0, uParam0->f_1684) && !func_291(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_500(uParam0, 3);
	}
...
void func_635(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_750(uParam0, iParam1, &vVar1, &fVar0);
	func_748(uParam0, func_480(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_751(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_625(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_432(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_749(vVar1);
	...
	if (func_503(uParam0->f_475[iParam1], 16))
	{
		func_752(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
		...
		func_753(uParam0, iParam1, bParam2, &vVar4);
	...
	{
		open_sequence_task(&iVar20);
		func_754(uParam0, iParam1, bParam2, vVar1);
		close_sequence_task(iVar20);
		task_perform_sequence(Global_35, iVar20);
		clear_sequence_task(&iVar20);
	}
...
void func_640(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_759(iVar0));
		iVar0++;
	}
}
...
bool func_646(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_651(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if (((func_652(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_358(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_760(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_358(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_358(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_760(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_760(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_656(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_658(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_306(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_503(uParam0->f_475[iVar0], 512)) || func_503(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_652(uParam0->f_3[iVar0]->f_1))
				{
					if (func_525())
					{
						StringCopy(&cVar1, func_358(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_358(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
int func_661(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	iVar0 = -1569615261;
...
void func_663(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_737(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_667(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_761(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_669(var uParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		*uParam0 = (*uParam0 || iParam1);
...
void func_671(int iParam0)
{
	if (func_114(iParam0))
	{
		if (does_entity_exist(func_241(iParam0)))
		{
			func_604(iParam0, 67108864, 1);
			func_511(iParam0, 19, 1);
		}
	}
}
...
int func_677(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_428(iParam0))
	{
		return 0;
	...
	if (func_242(iVar0, 0))
	{
		if (func_242(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_674(iParam0)) || func_675(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_764(player_ped_id(), iVar0, 1) < 10000f))
			{
				iVar1 = func_765(iParam0, 1);
				if (iVar1 != 0)
				{
					if (!_0x88ad6cc10d8d35b2(iVar0))
					{
					...
					func_766(iParam0);
					_0x7b204f88f6c3d287(func_767(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_767(iParam0, 0));
					func_768(iParam0);
				}
			}
			else
	...
	{
		if (func_242((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_249(iParam0, 32768, 1))
			{
...
int func_683(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (has_ped_got_weapon(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_770((386 + iVar28), 1);
			if (func_560(iParam0, &Var0, iVar5, 0))
			{
				if (func_561(iParam0, &Var6, iVar5))
				{
					Var29 = { func_417(iParam0, Var0, iVar5, 0) };
				...
				if (func_772(0))
				{
					...
					func_773(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_686(var uParam0, int iParam1, int iParam2)
{
	iVar0 = 0;
	Var4.f_9 = -1591664384;
	bVar18 = func_775(iParam1, 128);
	if (func_776("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_777(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_775(iParam1, 512) && func_689(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_660(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_775(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_775(iParam1, 4))) && (!func_660(Var4.f_4) || func_775(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_775(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_775(iParam1, 1048576)))
				{
	...
	{
		iParam1 |= 512;
		return func_686(uParam0, iParam1, iParam2);
	}
...
bool func_689(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_419(0);
	*uParam1 = { func_417(iParam0, func_558(0), iParam3, 0) };
...
void func_690(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_781(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_781(uParam0->f_2[iVar0], 1))
				{
					func_782(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_692(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_410(iParam0, 1)] != &Global_1946804->f_57[func_410(iParam0, 1)];
}

void func_693(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
...
{
	if (iParam0 == &Global_1946804->f_57[func_410(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_700(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_240() == -1)
	{
		func_786(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_787(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
char* func_705(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
float func_706()
{
	...
	func_798(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_707()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_798(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_708()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_798(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_712(var uParam0, char* sParam1)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
...
int func_714(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (!func_428(iParam0))
	{
		return 0;
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_803((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_803((*Global_1347702)[63]->f_15, 1) || func_274((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_803((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_803((*Global_1347702)[134]->f_15, 1) || func_274((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_803((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_805(747937920, 1) && !func_803((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_241(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
struct<7> func_717(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
int func_720(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_807(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_807(1237718549, iParam1);
			return func_808(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_725(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_721(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_721(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_721(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_721(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_721(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_721(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_721(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_721(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_721(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_721(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_721(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_721(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_721(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_721(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_721(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_721(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_721(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_721(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_721(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_721(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_721(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_721(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_721(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_721(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_721(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_721(iParam1, 1544915253))
	{
...
void func_729(int iParam0)
{
	...
	if (func_765(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_518(iParam0);
	func_728(iVar0);
	func_676(iParam0, 8192, 1);
}
...
bool func_742(var uParam0, int iParam1)
{
	...
	if ((func_393(func_661(Global_35, 0, 0, 0)) && !func_273(uParam0->f_1016[iParam1], 16)) && !func_273(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_743(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	if (func_813(uParam0, iParam1, sParam2))
	{
...
void func_744(var uParam0, var uParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
...
void func_747(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		iVar0 = func_661(Global_35, 0, 0, 0);
		if (is_weapon_valid(iVar0))
		{
		...
		iVar0 = func_661(Global_35, 0, 1, 0);
		if (is_weapon_valid(iVar0))
		{
			if (_0x2c83212a7aa51d3d(iVar0))
			{
...
void func_748(var uParam0, bool bParam1)
{
	...
	if ((func_278(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_273(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_430(uParam0, 64);
	}
...
void func_749(vector3 vParam0)
{
	iVar0 = 250;
	if (func_393(func_392(Global_35, 0, 1, 0)) || func_393(func_392(Global_35, 1, 1, 0)))
	{
		iVar0 = 2000;
	}
	...
	if (!func_90(vParam0))
	{
		fVar1 = func_391(Global_36, vParam0, 1);
...
void func_750(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_503(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_462(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_431(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_391(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_462(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_431(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_391(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_816(uParam0) };
		...
		else if (!func_431(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_391(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
bool func_751(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_197(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_197(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
void func_752(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, var uParam7)
{
	func_817(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_817(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_818(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}

void func_753(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_391(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_431(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
		task_achieve_heading(0, uParam0->f_1016[&uParam0->f_475[iParam1]]->f_40, 0);
	}
	else
	{
		vVar0 = { func_819(uParam0, iParam1) };
		if (!func_90(vVar0))
		{
...
void func_754(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	vVar0 = { func_819(uParam0, iParam1) };
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_391(Global_36, vParam3, 1), 0);
		}
		fVar3 = func_391(vParam3, vVar0, 1);
		if (func_431(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			fVar3 = uParam0->f_1016[&uParam0->f_475[iParam1]]->f_40;
		}
		if (func_503(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_431(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_431(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
{
	bVar3 = func_822(iParam0);
	if (func_566(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
	...
	else if (func_544(&iVar2))
	{
		if (func_566(iVar2, -1303648999))
		{
			iVar0 = func_823();
		}
		else
...
var func_761(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}
...
float func_764(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
	...
	return func_214(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_765(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_828(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_767(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_829(iParam0);
	}
...
bool func_771(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
...
void func_774(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_832(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_776(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
bool func_777(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
void func_788(var uParam0, int iParam1)
{
	if (func_240() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_786(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_787(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
bool func_813(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
{
	iVar0 = func_661(Global_35, 0, iParam0, 0);
	if (func_393(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
		...
		{
			if (func_393(func_661(Global_35, 0, 7, 0)) || func_393(func_661(Global_35, 0, 9, 0)))
			{
				if (func_393(func_661(Global_35, 0, 8, 0)))
				{
					func_839(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_393(func_661(Global_35, 0, 7, 0)) || func_393(func_661(Global_35, 0, 9, 0)))
			{
				if (func_393(func_661(Global_35, 0, 10, 0)))
				{
					func_839(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_393(func_661(Global_35, 0, 2, 0)))
				{
...
void func_817(var uParam0, float fParam1, vector3 vParam2, vector3 vParam5)
{
	*uParam0 = fParam1;
	uParam0->f_4 = { vParam2 };
	uParam0->f_1 = { vParam5 };
...
Vector3 func_818(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
	vVar0 = { func_840(vParam0, vParam3, fParam9) };
	vVar3 = { func_840(vParam3, vParam6, fParam9) };
	return func_840(vVar0, vVar3, fParam9);
}

Vector3 func_819(var uParam0, int iParam1)
{
...
bool func_820(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_841(iParam0, 1))
		{
			return false;
		}
	}
	return func_842(iParam0, 0, bParam2) >= iParam1;
}
...
bool func_841(int iParam0, int iParam1)
{
	...
	iVar0 = func_845(iParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_776("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
...
int func_842(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_419(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_843()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_660(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_660(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_845(int iParam0, int iParam1)
{
	...
	if (func_566(iParam0, 1399091007))
	{
...
bool func_851(var uParam0, int iParam1, var uParam2, bool bParam3)
{
