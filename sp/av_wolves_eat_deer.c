...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "WED1_WOLF_1", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0.9f, -0.3f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "WED1_WOLF_2", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 3f, 2f, 0f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "WED1_WOLF_3", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, -0.85f, -0.1f, 0f), (-70f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "WED1_VULTURE_1", iLocal_11, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, 0f, 23f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 5, "WED1_VULTURE_2", iLocal_11, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 4f, 28f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "WED1_VULTURE_3", iLocal_11, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 0f, 25f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_12)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				_set_ped_quality(&(uParam0->f_20[0]), 0);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
				iLocal_16 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1f, 1, -1, 0);
				iLocal_17 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1.5f, 2, -1, 0);
				iLocal_18 = _0xfa50f79257745e74(uParam0->f_20[0]->f_5, 1.5f, 4, -1, 0);
				func_66(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[1]), 1974927641, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
				_0x9520175b35e2268d(&(uParam0->f_20[1]), 1);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
				func_66(&(uParam0->f_20[2]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[2]), -1369415261, uParam0->f_20[2]->f_5, uParam0->f_20[2]->f_8, 0, false, true, 0, -1f, false);
				set_ped_keep_task(&(uParam0->f_20[2]), true);
				_0x9520175b35e2268d(&(uParam0->f_20[2]), 1);
				func_66(&(uParam0->f_20[3]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[3]), 1974927641, uParam0->f_20[3]->f_5, uParam0->f_20[3]->f_8, 0, false, true, 0, -1f, false);
				set_ped_keep_task(&(uParam0->f_20[3]), true);
				_0x9520175b35e2268d(&(uParam0->f_20[3]), 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[4])))
			{
				force_ped_motion_state(&(uParam0->f_20[4]), -1299979036, false, 0, false);
				task_flying_circle(&(uParam0->f_20[4]), 1f, uParam0->f_20[4]->f_5, 0f, 15f);
				func_67(uParam0->f_20[4], 0, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[5])))
			{
				force_ped_motion_state(&(uParam0->f_20[5]), -1299979036, false, 0, false);
				task_flying_circle(&(uParam0->f_20[5]), 1f, uParam0->f_20[5]->f_5, 0f, 17f);
				func_67(uParam0->f_20[5], 0, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[6])))
			{
				force_ped_motion_state(&(uParam0->f_20[6]), -1299979036, false, 0, false);
				task_flying_circle(&(uParam0->f_20[6]), 1f, uParam0->f_20[6]->f_5, 0f, 18f);
				func_67(uParam0->f_20[6], 0, 1);
			}
			iLocal_12 = 1;
			break;
		case 1:
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_16 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_16, 1);
	}
	if (iLocal_17 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_17, 1);
	}
	if (iLocal_18 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_18, 1);
	}
	return 1;
}
...
bool func_63(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_98(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
void func_64(var uParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (iVar0 > 3)
			{
				task_fly_away(&(uParam0->f_20[iVar0]), Global_35);
			}
			func_67(uParam0->f_20[iVar0], 0, 1);
		}
		iVar0++;
	}
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_106(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_111(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_111(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_84(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_111(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_133(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_134(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_167(1) || *uParam0 & 8192 != 0))
				{
...
bool func_131(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_180(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_178(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_179(uParam2)
				{
					func_174(uParam2, 1);
					return true;
				}
...
bool func_132(int iParam0, var uParam1)
{
	...
	if (func_170(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_179(uParam1)
		{
...
bool func_137(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_155(int iParam0, var uParam1)
{
	...
	{
		return func_204(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_157(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_205(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_205(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_205(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
bool func_170(int iParam0, var uParam1, int iParam2)
{
...
bool func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_193(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_216(iVar0, 0)))
		{
...
bool func_178(var uParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_180(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_216(iVar0, 0)))
		{
			if (func_218(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_185(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_189(var uParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_221(iParam1))
	{
...
bool func_194(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_199(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_193(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_200(int iParam0, var uParam1, bool bParam2)
{
...
int func_202(int iParam0)
{
	...
	return func_224((*Global_1347702)[58]->f_15, 1);
}
...
bool func_217(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_218(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
