...
void func_27(int iParam0)
{
	...
	iParam0->f_58[0] = 1219622670;
	iParam0->f_58[1] = 1219622670;
	iParam0->f_58[2] = 459594226;
	...
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@fire_dancer@act3_p1@action", 2, 0, false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (12 - 1))
...
void func_166(int iParam0)
{
	...
	{
		iParam0->f_66[0] = create_object(&(iParam0->f_58[0]), 2549.865f, -1310.193f, 49.21665f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[1])))
	{
		iParam0->f_66[1] = create_object(&(iParam0->f_58[1]), 2549.865f, -1310.293f, 49.21665f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[2])))
	{
		iParam0->f_66[2] = create_object(&(iParam0->f_58[2]), 2548.76f, -1308.813f, 48.2199f, true, true, false, false, true);
	}
...
void func_167(int iParam0)
{
	if (does_entity_exist(&(iParam0->f_66[2])))
	{
		set_entity_heading(&(iParam0->f_66[2]), 40f);
	}
	set_anim_scene_entity(iParam0->f_48, "DANCER", &(iParam0->f_81[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "LOTUS_0", &(iParam0->f_66[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "LOTUS_1", &(iParam0->f_66[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "LANTERN", &(iParam0->f_66[2]), 0);
}
...
void func_227()
{
	...
	if (!bVar0)
	{
		task_play_anim(Global_35, func_157(), func_311(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_157(), func_311(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
void func_234()
{
	...
	{
		case 1:
			if (load_stream(func_314(0), func_315()))
			{
				play_stream_from_position(2552.53f, -1310.069f, 49.21665f, _0x0556c784fa056628(func_314(0), func_315()));
				func_316(&(vLocal_1141.f_1), 2);
			}
			break;
		case 2:
			if (is_stream_playing(_0x0556c784fa056628(func_314(0), func_315())))
			{
				func_316(&(vLocal_1141.f_1), 3);
			}
			break;
		case 3:
			if (!is_stream_playing(_0x0556c784fa056628(func_314(0), func_315())) && load_stream(func_314(3), func_315()))
			{
				play_stream_from_position(2552.53f, -1310.069f, 49.21665f, _0x0556c784fa056628(func_314(3), func_315()));
