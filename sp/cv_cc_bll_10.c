...
bool func_72(var uParam0)
{
	...
	iLocal_19 = func_153(uParam0, 264425748, -0.482346f, -1.0508f, -0.000579834f, "BARREL", 1, 0, 1);
	iLocal_16 = func_153(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, -234159968, 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (!func_154(14))
	{
...
{
	vLocal_20 = { get_entity_coords(func_180(uParam0, iLocal_19), true, false) };
	vLocal_23 = { get_entity_rotation(func_180(uParam0, iLocal_19), 2) };
	return true;
}
...
{
	if (is_entity_occluded(func_180(uParam0, iLocal_19)))
	{
		...
		{
			set_entity_coords(func_180(uParam0, iLocal_19), vLocal_20, true, false, true, true);
			set_entity_rotation(func_180(uParam0, iLocal_19), vLocal_23, 2, true);
			return true;
		}
	}
