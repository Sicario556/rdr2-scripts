...
{
	func_33(uParam0, 10689, 10740, 11023);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_63(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[0]), 1542936419, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
...
int func_63(var uParam0, int iParam1, int iParam2, bool bParam3)
{
