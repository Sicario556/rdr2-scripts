void __EntryFunction__()
{
	...
	iLocal_43 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 11023, 11078, 11866);
}
...
{
	func_46(uParam0, "MANGY_DOG_AND_VULTURES", "script@ambient@animal@mangy_dog_and_vultures@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_startLoop", "", 0);
	func_48(uParam0, 0, "COYOTE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "DOG", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 2, "VULTURE1", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 3, "VULTURE2", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 4, "VULTURE3", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 5, "VULTURE4", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 6, "VULTURE5", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
{
	return func_49(uParam0, uParam0->f_20[0]->f_5);
}
...
bool func_28(var uParam0)
{
	...
	set_ped_config_flag(&(uParam0->f_20[0]), 385, true);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (!bLocal_48 == 1)
		{
			if (func_63(uParam0, &uLocal_13, 1) || func_64(Global_35, &(uParam0->f_20[1]), 1) <= 144f)
			{
				bLocal_48 = true;
			}
		}
		if (bLocal_48)
		{
			...
			if (!&uParam0->f_469[3])
			{
				func_68(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
			func_69(uParam0);
			func_70(uParam0);
		...
		if (!bLocal_49)
		{
			if (((uParam0->f_468 == 256 || uParam0->f_468 == 4) || uParam0->f_468 == 2) || uParam0->f_468 == 16)
			{
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					...
					{
						_0xeeed8fafec331a70(&(uParam0->f_20[1]), Global_36, 0);
						bLocal_49 = true;
					}
				}
			}
	...
	if (!&uParam0->f_469[2])
	{
		if (is_ped_dead_or_dying(&(uParam0->f_20[0]), true))
		{
			if (is_entity_dead(&(uParam0->f_20[0])))
			{
				_0x3ca5e58c9731a16b(&(uParam0->f_20[0]), iLocal_43);
				uParam0->f_469[2] = 1;
			}
		}
	}
	if (!&uParam0->f_469[1] && !bLocal_48)
	{
		if (!&uParam0->f_469[3])
		{
			if (func_73(uParam0, 1.5f, 40f, 4, -91962372, 1))
			{
				func_68(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
		...
		if (!bLocal_47)
		{
			...
			while (iVar0 < uParam0->f_19)
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					if (iVar0 != 1)
					{
						func_74(uParam0->f_20[iVar0], 1, 1);
					}
					if (get_entity_model(&(uParam0->f_20[iVar0])) == iLocal_11)
					{
						apply_ped_damage_pack(&(uParam0->f_20[iVar0]), "PD_Vulture_bloody_head", 0f, 1f);
					}
				}
				iVar0++;
			}
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				apply_ped_damage_pack(&(uParam0->f_20[0]), "PD_Coyote_bloody_corpse", 0f, 1f);
			}
			vVar1 = { 0f, 0f, 0f };
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				vVar1 = { get_entity_coords(&(uParam0->f_20[0]), true, false) };
			}
			if (!_does_volume_exist(iLocal_12))
			{
				iLocal_12 = _create_volume_cylinder(vVar1, 0f, 0f, 0f, 30f, 30f, 30f);
				_0xb56d41a694e42e86(iLocal_12, 224, 0, 0, -1, -1, 0);
				_0x18262cafebb5fbe1(iLocal_12, 224, 0, 0, -1, -1, 0);
			}
			iLocal_41 = _0xfa50f79257745e74(vVar1, 5f, 1, -1, 0);
			iLocal_42 = _0xfa50f79257745e74(vVar1, 5f, 2, -1, 0);
			bLocal_47 = true;
		}
	}
	return 0;
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_41 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_41, 1);
	}
	if (iLocal_42 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_42, 1);
	}
	if (_does_volume_exist(iLocal_12))
	{
		_0x74c2b3dc0b294102(iLocal_12);
		_0xa1cfb35069d23c23(iLocal_12);
		func_5(iLocal_12);
	}
	return 1;
}
...
void func_69(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (((uParam0->f_468 == 256 || uParam0->f_468 == 4) || uParam0->f_468 == 2) || uParam0->f_468 == 16)
		{
			if (!func_111(&(uParam0->f_20[1]), 518218985))
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[1]), Global_35, 3, 256, -1082130432, -1, 0);
				func_74(uParam0->f_20[1], 0, 1);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
			}
		}
		else if (!func_111(&(uParam0->f_20[1]), 1139527981))
		{
			task_animal_unalerted(&(uParam0->f_20[1]), -1, 0, 0, 0);
			func_74(uParam0->f_20[1], 0, 1);
			set_ped_keep_task(&(uParam0->f_20[1]), true);
		}
	}
...
{
	set_ped_to_ragdoll(&(uParam0->f_20[0]), 1000, 1000, 0, false, false, false);
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		func_112(&(uParam0->f_20[0]), 0, 0);
	}
}
...
void func_71(var uParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			...
			task_perform_sequence(&(uParam0->f_20[iVar0]), iVar1);
			set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
			func_74(uParam0->f_20[iVar0], 0, 1);
			_0x2208438012482a1a(&(uParam0->f_20[iVar0]), false, false);
...
bool func_79(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_119(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_120(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_90(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_105(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_140(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_110(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_167(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_167(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_167(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_174(1) || *uParam0 & 8192 != 0))
				{
...
bool func_138(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_187(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_185(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_186(uParam2)
				{
					func_181(uParam2, 1);
					return true;
				}
...
bool func_139(int iParam0, var uParam1)
{
	...
	if (func_177(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_186(uParam1)
		{
...
int func_162(int iParam0, var uParam1)
{
	...
	else if (func_154() - uParam1->f_4) > func_210(uParam1)
	{
...
bool func_183(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_219(iVar0, 0)))
		{
...
bool func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_219(iVar0, 0)))
		{
			if (func_221(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_209(int iParam0)
{
	...
	return func_227((*Global_1347702)[58]->f_15, 1);
}
...
bool func_220(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_221(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
