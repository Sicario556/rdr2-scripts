...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, -50684386, "COW");
...
bool func_86(var uParam0)
{
	...
	if (!is_entity_dead(iVar0))
	{
		...
		set_ped_config_flag(iVar0, 288, true);
		set_ped_keep_task(iVar0, true);
	}
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		iLocal_23 = get_game_timer() + 20000;
	...
	if ((func_200(uParam0, iLocal_20) && get_game_timer() > iLocal_23) && is_entity_occluded(func_48(uParam0, iLocal_14)))
	{
		func_190(uParam0, iLocal_19, 1);
	}
	if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_20]), "COW"))
	{
		task_stand_still(func_48(uParam0, iLocal_15), -1);
	}
	return true;
}
...
{
	if (func_208(Global_35, uParam0->f_23, 1) > (50f * 50f) && !is_sphere_visible(uParam0->f_23, 1f))
	{
