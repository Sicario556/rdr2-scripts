...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "AAP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "AAP_ANIMAL", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 4f, 0f), (180f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
{
	if (!has_anim_dict_loaded(sLocal_10) || !has_anim_dict_loaded(sLocal_12))
	{
		return 0;
	}
	return 1;
...
{
	request_anim_dict(sLocal_10);
	request_anim_dict(sLocal_12);
	func_57(&uLocal_16, 0);
	func_58(&uLocal_16, 1);
	func_59(&uLocal_16, 1);
	func_60(&uLocal_16, 1);
...
int func_31(var uParam0)
{
	if (!bLocal_14)
	{
		...
		{
			set_entity_invincible(&(uParam0->f_20[1]), false);
			bLocal_14 = true;
		}
	}
	switch (iLocal_9)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				if (*uParam0 == 45)
				{
					_give_weapon_to_ped_2(&(uParam0->f_20[0]), -570967010, 5000, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
					set_current_ped_weapon(&(uParam0->f_20[0]), -570967010, true, 0, false, false);
					Var0.f_1 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 1f, 0.24f) };
					Var0.f_4 = -1;
					Var0.f_6 = 1;
					Var0.f_7 = 1;
					task_shoot_with_weapon(&(uParam0->f_20[0]), &Var0);
				}
				else
				{
					remove_all_ped_weapons(&(uParam0->f_20[0]), true, true);
					task_play_anim(&(uParam0->f_20[0]), sLocal_10, sLocal_11, 4f, -4f, -1, 1, 0f, false, 0, false, 0, false);
				}
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_66(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				set_ped_config_flag(&(uParam0->f_20[1]), 263, true);
				_0x89f5e7adecccb49c(&(uParam0->f_20[1]), sLocal_13);
		...
		case 3:
			...
			if (!func_73(&(uParam0->f_20[1]), 242628503))
			{
				if (is_entity_dead(&(uParam0->f_20[0])))
				{
					if (*uParam0 == 45)
					{
						if (!func_74(&(uParam0->f_20[0]), Global_35))
						{
							delete_ped(uParam0->f_20[0]);
							delete_ped(uParam0->f_20[1]);
						}
					}
					else
					{
						func_65(uParam0->f_20[1], 0, 1);
					}
					return 1;
				}
			}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_107(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
{
	_0x89f5e7adecccb49c(&(uParam0->f_20[1]), "default");
	open_sequence_task(&iVar0);
	if (*uParam0 == 36)
	{
		task_combat_ped(0, &(uParam0->f_20[0]), 0, 0);
	}
	else
	{
		task_grapple(0, &(uParam0->f_20[0]), iLocal_15, 1, 2f, 0, 0);
	}
	if (*uParam0 == 36)
	{
	...
	if (*uParam0 != 45)
	{
		task_eat(0, &(uParam0->f_20[0]), 0);
	}
	close_sequence_task(iVar0);
	task_perform_sequence(&(uParam0->f_20[1]), iVar0);
	set_ped_config_flag(&(uParam0->f_20[1]), 168, true);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_107(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_108(&(uParam0->f_490)))
							{
