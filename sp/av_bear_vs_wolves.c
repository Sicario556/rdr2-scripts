void __EntryFunction__()
{
	...
	Var0 = Local_46;
	Var0.f_1 = Local_46.f_11;
	Var0.f_483 = { Local_46.f_1 };
	Var0.f_486 = { Local_46.f_4 };
	Var0.f_489 = Local_46.f_7;
	Var0.f_20[0] = Local_46.f_8;
	Var0.f_453 = Local_46.f_9;
	Var0.f_500 = Local_46.f_10;
	Var0.f_503 = Local_46.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 4, "carcass", 1110710183, vParam1, vParam4.z, 1, 0, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	...
	if (!_has_scenario_type_loaded(2075717199, false))
	{
		return 0;
	}
	return func_49(uParam0, uParam0->f_20[4]->f_5);
}
...
{
	_0xf7ea250b9a919e03(-1918659017, &(uParam0->f_20[0]));
	_0xf7ea250b9a919e03(-1918659017, &(uParam0->f_20[1]));
	_0xf7ea250b9a919e03(-1918659017, &(uParam0->f_20[2]));
	if ((!_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[0])) || !_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[1]))) || !_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[2])))
	{
		return false;
	}
	if (!is_entity_dead(&(uParam0->f_20[4])))
	{
		set_ped_config_flag(&(uParam0->f_20[4]), 186, true);
		set_ped_config_flag(&(uParam0->f_20[4]), 243, true);
		_set_ped_quality(&(uParam0->f_20[4]), 0);
		task_play_anim(&(uParam0->f_20[4]), sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		_0x674b90be1115846d(&(uParam0->f_20[4]), 1);
		_0x3ca5e58c9731a16b(&(uParam0->f_20[4]), iLocal_45);
		set_ped_keep_task(&(uParam0->f_20[4]), true);
		set_entity_no_collision_entity(&(uParam0->f_20[4]), &(uParam0->f_20[3]), true);
		set_entity_no_collision_entity(&(uParam0->f_20[3]), &(uParam0->f_20[4]), true);
	}
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[iVar0]), 26, 0, 1);
			func_57(uParam0->f_20[iVar0], 1, 1);
		}
		iVar0++;
	}
	return true;
...
int func_30(var uParam0)
{
	...
	_request_scenario_type(2075717199, 1, -1124266369, 0);
	func_58(&uLocal_11, 0);
	func_59(&uLocal_11, 1);
	func_60(&uLocal_11, 1);
	func_61(&uLocal_11, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0] && !bLocal_41)
	{
		if (!&uParam0->f_469[1])
		{
			if ((!is_entity_dead(Global_35) && !is_entity_dead(&(uParam0->f_20[0]))) && !is_entity_dead(&(uParam0->f_20[1])))
			{
				if (func_76(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
							{
								func_72(uParam0);
								set_anim_scene_bool(uParam0->f_3.f_1, "bStopLoop", true, false);
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
							}
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[8])
			{
				if (func_77(uParam0, 1.5f, 80f, 4, -91962372, 1))
				{
					func_71(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[8] = 1;
				}
				...
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							while (iVar0 <= 2)
							{
								if (has_anim_event_fired(&(uParam0->f_20[iVar0]), 1935919182))
								{
									_0x2e1d6d87346bb7d2(&(uParam0->f_20[iVar0]), &(uParam0->f_20[3]), 0, 0);
								}
								iVar0++;
							}
							if (!&uParam0->f_469[3])
							{
								...
								{
									if (has_anim_event_fired(&(uParam0->f_20[0]), -1795669989))
									{
										remove_anim_scene_entity(uParam0->f_3.f_1, uParam0->f_20[0]->f_1, &(uParam0->f_20[0]));
										force_ped_motion_state(&(uParam0->f_20[0]), -668482597, false, 0, false);
										_task_smart_flee_style_ped(&(uParam0->f_20[0]), &(uParam0->f_20[3]), 2, 256, -1082130432, -1, 0);
										set_ped_desired_move_blend_ratio(&(uParam0->f_20[0]), 1f);
										func_57(uParam0->f_20[0], 0, 1);
							...
							if (!&uParam0->f_469[4])
							{
								...
								{
									if (has_anim_event_fired(&(uParam0->f_20[1]), 811542464))
									{
										remove_anim_scene_entity(uParam0->f_3.f_1, uParam0->f_20[1]->f_1, &(uParam0->f_20[1]));
										force_ped_motion_state(&(uParam0->f_20[1]), -530524, false, 0, false);
										if (!is_entity_dead(&(uParam0->f_20[3])))
										{
											_task_smart_flee_style_ped(&(uParam0->f_20[1]), &(uParam0->f_20[3]), 3, 256, -1082130432, -1, 0);
										}
										set_ped_desired_move_blend_ratio(&(uParam0->f_20[1]), 2f);
										func_57(uParam0->f_20[1], 0, 1);
							...
							if (!&uParam0->f_469[5])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[2]->f_1))
								{
									if (has_anim_event_fired(&(uParam0->f_20[2]), 811542464))
									{
										remove_anim_scene_entity(uParam0->f_3.f_1, uParam0->f_20[2]->f_1, &(uParam0->f_20[2]));
										force_ped_motion_state(&(uParam0->f_20[2]), -530524, false, 0, false);
										if (!is_entity_dead(&(uParam0->f_20[3])))
										{
											_task_smart_flee_style_ped(&(uParam0->f_20[2]), &(uParam0->f_20[3]), 3, 256, -1082130432, -1, 0);
										}
										set_ped_desired_move_blend_ratio(&(uParam0->f_20[2]), 2f);
										func_57(uParam0->f_20[2], 0, 1);
							...
							if (!&uParam0->f_469[6])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[3]->f_1))
								{
									_task_start_scenario_in_place(&(uParam0->f_20[3]), 2075717199, 30000, false, 0, 0.25f, false);
									_0x2208438012482a1a(&(uParam0->f_20[3]), false, false);
									set_ped_keep_task(&(uParam0->f_20[3]), true);
									func_57(uParam0->f_20[3], 0, 1);
									uParam0->f_469[6] = 1;
								}
							}
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (does_entity_exist(&(uParam0->f_20[iVar0])))
		{
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[iVar0]), 26, 0, 0);
			}
		}
		iVar0++;
	}
...
bool func_50(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_94(&(Global_1898164->f_1[0]));
		if (func_95(iVar0) && func_96((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_66(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			_0x2e1d6d87346bb7d2(&(uParam0->f_20[iVar0]), Global_35, 0, 1);
		}
		iVar0++;
	}
}
...
void func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (!func_112(&(uParam0->f_20[iVar0]), 518218985))
			{
	...
	if (!is_entity_dead(&(uParam0->f_20[3])))
	{
		if (!func_112(&(uParam0->f_20[3]), 780511057))
		{
			task_combat_ped(&(uParam0->f_20[3]), Global_35, 0, 0);
			set_ped_keep_task(&(uParam0->f_20[3]), true);
		}
	}
}
...
void func_75(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			func_57(uParam0->f_20[iVar0], 0, 1);
		}
		iVar0++;
	}
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_118(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_118(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_69(&(uParam0->f_490)))
							{
...
void func_110(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_173(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_173(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_173(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_180(1) || *uParam0 & 8192 != 0))
				{
...
bool func_144(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_193(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_191(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_192(uParam2)
				{
					func_187(uParam2, 1);
					return true;
				}
...
bool func_145(int iParam0, var uParam1)
{
	...
	if (func_183(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_192(uParam1)
		{
...
bool func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_206(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_225(iVar0, 0)))
		{
...
bool func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_225(iVar0, 0)))
		{
			if (func_227(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_212(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_206(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_215(int iParam0)
{
	...
	return func_233((*Global_1347702)[58]->f_15, 1);
}
...
bool func_226(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_227(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
