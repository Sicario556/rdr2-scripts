...
bool func_3(var uParam0)
{
	...
	{
		set_object_as_no_longer_needed(&iLocal_70);
	}
	if (does_entity_exist(iLocal_69))
	{
		set_object_as_no_longer_needed(&iLocal_69);
	}
	return true;
}
...
bool func_75(var uParam0)
{
	if (func_148(uParam0) == 3)
	{
		if (!does_entity_exist(iLocal_70))
		{
			...
			if (has_model_loaded(-1623912517))
			{
				iLocal_70 = create_object(-1623912517, func_165(uParam0, 0.778003f, -0.256235f, -0.0359992f), true, true, false, false, true);
				set_entity_heading(iLocal_70, func_166(uParam0, -98.95381f));
			}
			return false;
		}
		if (!does_entity_exist(iLocal_69))
		{
			request_model(1786663937, false);
			if (has_model_loaded(1786663937))
			{
				iLocal_69 = create_object(1786663937, func_165(uParam0, -0.0861425f, 0.136672f, -0.00999832f), true, true, false, false, true);
				set_entity_heading(iLocal_69, func_166(uParam0, -19.09583f));
			}
			return false;
		}
	}
...
bool func_86(var uParam0)
{
	...
	{
		if (has_ped_got_weapon(func_48(uParam0, iLocal_14), 1845380267, 0, false))
		{
			set_current_ped_weapon(func_48(uParam0, iLocal_14), 1845380267, true, 0, false, false);
		}
	}
	return true;
}
...
{
	return (((_0x7f9b9791d4cb71f6(Global_35, func_48(uParam0, iLocal_14), 0, 0) == 1 || _0x7f9b9791d4cb71f6(Global_35, func_48(uParam0, iLocal_15), 0, 0) == 1) || func_191(Global_35, func_48(uParam0, iLocal_14), 8f, 1)) && ((!func_192(uParam0, Local_39, 1, 0) && !func_192(uParam0, Local_49, 1, 0)) && !func_192(uParam0, Local_59, 1, 0)));
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_165(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_165(uParam0, uParam0->f_1976.f_1), 1, func_166(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_322(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_323(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_323(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_324(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_256(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_325(iVar1)))
			{
				func_326(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_327(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_263(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_165(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_271(var uParam0, int iParam1)
{
	...
	else if (!func_329(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_291(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_335(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_300(var uParam0, int iParam1)
{
	...
	{
		if (!func_329(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(747937920, 1) && !func_386((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
