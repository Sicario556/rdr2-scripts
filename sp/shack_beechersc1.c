...
bool func_18(var uParam0)
{
	...
	if (Local_73 >= 1)
	{
		...
		{
			if (_does_volume_exist(Local_73.f_153) && is_entity_in_volume(Global_35, Local_73.f_153, true, 0))
			{
				func_48(uParam0);
			}
		}
		...
		case 8192:
			if (!func_41(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_69(func_68(uParam0->f_5), 2) && !func_45(128, 0, 1)) && !func_70(get_player_index(), 1, 1, 1)) && !func_71()) && !func_72(20)) && !func_69(func_68(uParam0->f_5), 4)) && !func_69(func_68(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
{
	Local_73.f_153 = _create_volume_cylinder_with_custom_name(1759.348f, 480.0096f, 109.4694f, 0f, 0f, -15.84809f, 70.02553f, 56.01433f, 40.77715f, "BeechersC_Discovery");
	return true;
}
...
{
	Var0 = { func_94(0) };
	if (!func_95(Local_73.f_99[0], Var0.f_1, Var0.f_2, Var0.f_5, Var0.f_8, Var0.f_11))
	{
		return false;
	}
	return true;
...
{
	if (!func_106(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_106(uParam0, iParam1), func_107(uParam0, iParam1), func_108(uParam0, iParam1), func_109(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
void func_126(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_138(iParam0) == 3 || (func_138(iParam0) == 1 && _0x01f4d242765c6b24(func_140(iParam0))))
	{
...
int func_143(int iParam0)
{
	switch (func_141(iParam0))
	{
		...
		case 8:
			...
			if (func_89((*Global_1347702)[iVar1]->f_12, 1))
			{
...
int func_145()
{
	if (!func_164((*Global_1835011)[4]->f_1, 1))
	{
		return 0;
	}
	else if (!func_164((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_164((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_164((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_164((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_164((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_164((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_182(int iParam0, int iParam1)
{
	...
	{
		func_146(&(Global_1898164->f_1[0]), 3);
	}
}
