...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, iLocal_14, -1471716628, "GUN");
	...
	func_154(uParam0, iLocal_14, 3, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1);
	func_155(uParam0, iLocal_14, 2, -1);
	func_156(uParam0, iLocal_14, 3, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824, 1065353216, 1);
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_251(func_148(uParam0), func_250(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_283(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_283(uParam0, uParam0->f_1976.f_1), 1, func_285(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_264(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_283(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
