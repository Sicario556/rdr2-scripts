...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1510839859, 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	...
	func_161(uParam0, iLocal_15, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_K", -1, 0, -1073741824, 1065353216, 1);
...
bool func_81(var uParam0)
{
	if (func_164(0))
	{
		if (vdist2(Global_36, vLocal_16) < 169f)
		{
			return false;
		}
	}
...
{
	if (!uParam0->f_107[iLocal_14]->f_32)
	{
		if (func_203(uParam0, iLocal_14))
		{
			force_ped_motion_state(func_48(uParam0, iLocal_14), -1415276238, false, 1, false);
			_0x631cd2d77fdc0316(func_121(0, 0));
		}
	}
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_387((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
