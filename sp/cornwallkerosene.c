		...
		if (get_game_timer() > iLocal_63)
		{
			...
			switch (iLocal_62)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_64));
					...
					Global_1897950 = -1;
					iLocal_65 = (get_game_timer() + iLocal_61);
					iLocal_62 = 2;
					break;
				case 2:
					if (func_11() || iLocal_65 < get_game_timer())
					{
						func_12(iLocal_64);
						iLocal_65 = (get_game_timer() + iLocal_61);
						iLocal_62 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_64) || iLocal_65 < get_game_timer())
					{
						func_14(iLocal_64);
						iLocal_65 = (get_game_timer() + iLocal_61);
						iLocal_62 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_64) || iLocal_65 < get_game_timer())
					{
						func_16(iLocal_64);
						iLocal_65 = (iLocal_61 + get_game_timer());
						iLocal_62 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_64)))
					{
						if (func_17(func_6(iLocal_64), 4) && !iLocal_65 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_64) || iLocal_65 < get_game_timer())
							{
								func_19(iLocal_64, 4);
								iLocal_65 = (iLocal_61 + get_game_timer());
								iLocal_62 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_65 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_64);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_64]->f_10);
							if ((*Global_1888801)[iLocal_64]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_64]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_64]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_64]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[65]->f_4;
	if (!network_is_game_in_progress())
	{
		if (func_46())
		{
			iLocal_18 = _create_volume_aggregate_with_custom_name("Cornwall Factory - m_volThreat Agg");
			_0x39816f6f94f385ad(iLocal_18, 483.178f, 665.0614f, 120.433f, 0f, 0f, -93.35709f, 8.68444f, 49.20877f, 14.62346f);
			_0x39816f6f94f385ad(iLocal_18, 482.0916f, 681.5095f, 120.5672f, 0f, 0f, -94.03097f, 27.47987f, 53.5737f, 19.23399f);
			_0x39816f6f94f385ad(iLocal_18, 457.9885f, 669.1766f, 117.4853f, 0f, 0f, -94.12511f, 8.672241f, 4.046204f, 6.331274f);
			_0x39816f6f94f385ad(iLocal_18, 510.659f, 674.0203f, 119.3904f, 0f, 0f, -95.19305f, 28.2624f, 14.3714f, 11.82121f);
			iLocal_17 = _create_volume_aggregate_with_custom_name("Cornwall Factory - m_volGuardRestricted Agg");
			_0x6e0d3c3f828da773(iLocal_17, iLocal_18);
			_0x39816f6f94f385ad(iLocal_17, 487.0584f, 658.134f, 120.433f, 0f, 0f, -93.35709f, 4.866049f, 58.9538f, 14.62346f);
			_0x39816f6f94f385ad(iLocal_17, 512.4396f, 693.6117f, 119.3904f, 0f, 0f, -95.19305f, 11.77509f, 14.3714f, 11.82121f);
			_0x39816f6f94f385ad(iLocal_17, 503.4485f, 696.999f, 115.9772f, 0f, 0f, 159.3044f, 15.9482f, 28.70993f, 3.623619f);
			_0x39816f6f94f385ad(iLocal_17, 516.3637f, 679.5154f, 117.3018f, 0f, 0f, -92.51744f, 37.73529f, 11.09497f, 5.907578f);
			_0x39816f6f94f385ad(iLocal_17, 511.5199f, 700.011f, 116.2709f, 0f, 0f, 113.6843f, 8.967957f, 14.12305f, 2.935638f);
			_0x39816f6f94f385ad(iLocal_17, 480.135f, 701.7899f, 117.897f, 0f, 0f, -4.999341f, 41.32953f, 28.42523f, 10.07528f);
			_0x39816f6f94f385ad(iLocal_17, 453.424f, 691.8083f, 117.5132f, 0f, 0f, -94.0647f, 40.29486f, 13.86865f, 13.54279f);
			_0x39816f6f94f385ad(iLocal_17, 458.9319f, 701.6198f, 116.6065f, 0f, 0f, -155.9255f, 13.56885f, 23.8696f, 3.378769f);
			_0x39816f6f94f385ad(iLocal_17, 554.0569f, 575.44f, 113.7167f, 0f, 0f, 136.48f, 13.64952f, 28.59466f, 13.59426f);
			_0x39816f6f94f385ad(iLocal_19, 581.2699f, 545.9254f, 114.073f, 0f, 0f, 176.2527f, 70.74225f, 40.8134f, 11.93559f);
			_0x39816f6f94f385ad(iLocal_19, 467.4143f, 614.5461f, 113.2867f, 0f, 0f, 176.2527f, 25.77176f, 46.62182f, 13.5697f);
			_0x39816f6f94f385ad(iLocal_19, 592.3509f, 634.554f, 114.073f, 0f, 0f, -145.3082f, 48.81504f, 43.12697f, 11.93559f);
			iLocal_16 = _create_volume_cylinder_with_custom_name(533.1948f, 634.7332f, 111.7214f, 0f, 0f, 0f, 125.8112f, 137.9227f, 20.39024f, "Cornwall Factory - m_volGuardRegistration");
			sLocal_15 = "CORNWALL_KEROSENE";
			_create_guard_zone(sLocal_15);
			_0x8c598a930f471938(sLocal_15, iLocal_16);
			_0x35815f372d43e1e5(sLocal_15, iLocal_17);
			_0xa1b0e6301e2e02a6(sLocal_15, iLocal_18);
			_0xad3e07c37a7c1adc(sLocal_15, iLocal_19);
			_set_guard_zone_position(sLocal_15, 479.7f, 675f, 118f);
			_0xa8a74aa79fb67159(sLocal_15, iLocal_16);
			iLocal_60 = 1;
		}
		if (func_47(45))
		{
			_0xb56d41a694e42e86(iLocal_14, 10208, 0, 0, -1, -1, 0);
			_0x18262cafebb5fbe1(iLocal_14, 10208, 0, 0, -1, -1, 0);
		}
		else
		{
...
void func_14(int iParam0)
{
	...
	{
		func_49(&uLocal_20, 943, 5, "", 374792535, 442.7123f, 667.0687f, 114.9347f, 8.68f, 0, 0);
		func_49(&uLocal_40, 944, 5, "", 374792535, 436.3587f, 671.5928f, 114.8581f, -28.76f, 0, 0);
	}
}
...
bool func_46()
{
	...
	if (func_59(&Global_1935630, 2048) && Global_1347343->f_2 == (*Global_1835011)[58]->f_1)
	{
		return false;
	}
	return true;
...
void func_58(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_0x800df3fc913355f3(_0x112ddf56300bc6e5(func_98(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_0x187d65f3aec5d679(func_98(uParam0->f_1), &(uParam0->f_3));
			}
			if (does_entity_exist(_0x31c70a716cae1fee(_0x112ddf56300bc6e5(func_98(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
			...
			break;
		case 6:
			if (_0xf8de7154f7d1458f(_0x112ddf56300bc6e5(func_98(uParam0->f_1))) == uParam0->f_11)
			{
				*uParam0 = 9;
			}
			else
			{
				_0x669c25840c6f7ae2(_0x112ddf56300bc6e5(func_98(uParam0->f_1)), uParam0->f_11);
			}
			break;
		case 8:
...
bool func_63(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_107(iParam0));
}
...
void func_78(int iParam0)
{
	...
	{
		_0x998202b206872672(iLocal_17);
		_0x6d5f9e69ba1be783(iLocal_17);
		func_136(iLocal_17);
	}
	if (func_20() == -1 && !func_48(664571177))
	{
...
bool func_84(int iParam0)
{
	...
	return func_143((*Global_1835011)[iParam0]->f_1);
}
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_144(iParam0, _create_persistent_character(func_98(iParam0)));
		if (func_20() == -1)
		{
...
{
	iVar0 = _0x112ddf56300bc6e5(func_98(uParam0->f_1));
...
char* func_121(char* sParam0, int iParam1)
{
	...
	return func_156(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_124(int iParam0)
{
	...
	if (func_157())
	{
		if (!func_158((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_162(Global_1935369->f_5[iParam0]->f_6, 1);
	func_163(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_92(Global_1914319->f_3[iParam0]->f_21) && func_165(Global_1914319->f_3[iParam0]->f_21))
	{
		func_166(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_167(Global_1914319->f_3[iParam0]->f_10, 0);
...
{
	func_183(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
