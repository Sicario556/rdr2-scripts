...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_153(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 0, 1);
	iLocal_19 = func_153(uParam0, -82199229, 0f, 0f, 0f, "MUG1", 0, 0, 1);
	...
	func_157(uParam0, iLocal_15, 2, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, 25f, 1065353216, 1);
	func_158(uParam0, iLocal_15, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, -1489483851, 0, -1, 0, -1073741824, 1065353216, 1);
...
{
	if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_17]), "BOILER"))
	{
		if (_does_scenario_point_exist(iLocal_24))
		{
			if (does_entity_exist(iLocal_23))
			{
				if (_0x8360c47380b6f351(iLocal_24, iLocal_23, "p_boiler02x_PH_L_HAND", 1))
				{
				}
			}
		}
...
int func_167(var uParam0, vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	...
	if (!_does_scenario_point_exist(*iParam5))
	{
		*iParam5 = _find_closest_active_scenario_point_of_type(vParam1, iParam4, 1f, 0, false);
		return 0;
	}
	if (!does_entity_exist(iLocal_23))
	{
		iLocal_23 = get_object_index_from_entity_index(_get_scenario_point_entity(*iParam5, sParam6));
	}
	if (_0x6ef4e31b4d5d2da0(*iParam5, sParam6))
	{
	}
	return 0;
}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_174(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_174(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
int func_209(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_304(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_211(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_305(iParam0);
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(747937920, 1) && !func_384((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
