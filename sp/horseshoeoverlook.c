...
bool func_11()
{
	iLocal_0 = _create_volume_aggregate_with_custom_name("Horseshoe - m_volTown");
	_0xbce668aaf83608be(iLocal_0, -131.6045f, -34.30135f, 102.2093f, 0f, 0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	_0xbce668aaf83608be(iLocal_0, -117.99f, -66.781f, 100f, 0f, 0f, 94f, 16.719f, 19.52f, 13.16044f);
	return true;
}
...
{
	if (load_stream("horseshoe_overlook", "es_camp_memory_sounds"))
	{
		iLocal_1 = _0x0556c784fa056628("horseshoe_overlook", "es_camp_memory_sounds");
...
bool func_38(int iParam0)
{
	if (((func_52(Global_35, iLocal_0, 1, 0) && iLocal_2 < get_game_timer()) && func_54(func_53())) && func_55(6, 18))
	{
		...
		set_ambient_zone_state("AZ_camp_horseshoe_overlook_Endless_Summer", true, true);
		bLocal_3 = true;
		iLocal_2 = get_game_timer() + 30000;
	}
	if (bLocal_3)
	{
		...
		{
			set_ambient_zone_state("AZ_camp_horseshoe_overlook_Endless_Summer", false, true);
			bLocal_3 = false;
		}
	}
	return true;
