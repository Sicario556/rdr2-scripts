...
void func_6()
{
	...
	{
		Local_19 = player_ped_id();
	}
	if (!does_entity_exist(Local_19.f_5))
	{
		func_12(&Local_19);
		bLocal_203 = true;
		Local_19.f_6 = iLocal_3;
		Local_19.f_7 = uLocal_4;
		Local_19.f_5 = _get_entity_scenario_point_is_attached_to(iLocal_3);
		if (does_entity_exist(Local_19.f_5))
		{
			iLocal_197 = get_object_index_from_entity_index(Local_19.f_5);
			_0xb6cbd40f8ea69e8a(get_object_index_from_entity_index(Local_19.f_5));
		}
	}
	switch (iLocal_202)
	{
		case 0:
			if (does_entity_exist(Local_19.f_5) && _0xb6cbd40f8ea69e8a(get_object_index_from_entity_index(Local_19.f_5)))
			{
				if (!_does_scenario_point_exist(Local_19.f_6))
				{
					iLocal_0 = 0;
					return;
				}
				if (_0xb219612b5568e9ec(Local_19.f_5))
				{
					iLocal_0 = 0;
					return;
				}
				...
				Local_19.f_1 = get_entity_model(Local_19.f_5);
				func_20(&Local_19);
				func_21(&uLocal_199);
				iLocal_202 = 1;
			}
		...
		case 1:
			...
			if (bLocal_203)
			{
				...
				while (iLocal_206 < 10)
				{
					_int_to_string(iLocal_206, "%i", &uVar0);
					func_23(uLocal_174[iLocal_206], Local_19.f_12[iLocal_206], &Local_19, uLocal_186[iLocal_206], &uVar0, *Local_19.f_37[iLocal_206], *Local_19.f_68[iLocal_206], 0, 1, 1, func_22(&uLocal_199, 2f), &(Local_19.f_26[iLocal_206]));
					iLocal_206++;
				}
				if (does_entity_exist(Local_19.f_5))
				{
					vVar4 = { get_entity_coords(Local_19.f_5, true, false) };
					vVar7 = { get_entity_rotation(Local_19.f_5, 2) };
				}
				else
				{
					vVar4 = { _get_scenario_point_coords(iLocal_3, true) };
					vVar7 = { 0f, 0f, _get_scenario_point_heading(iLocal_3, true) };
				}
			...
			while (iLocal_206 < 10)
			{
				...
				else
				{
					...
					if (bLocal_203)
					{
						...
						while (iLocal_206 < 10)
						{
							_int_to_string(iLocal_206, "%i", &uVar10);
							func_23(uLocal_174[iLocal_206], Local_19.f_12[iLocal_206], &Local_19, uLocal_186[iLocal_206], &uVar10, *Local_19.f_37[iLocal_206], *Local_19.f_68[iLocal_206], 0, 1, 0, func_22(&uLocal_199, 2f), &(Local_19.f_26[iLocal_206]));
							iLocal_206++;
						}
					}
					bLocal_204 = true;
					...
					while (iLocal_206 < 10)
					{
						...
						else
						{
							...
							Jump @776; //curOff = 734
							if (!_does_scenario_point_exist(Local_19.f_6) || !_0x9c54041bb66bcf9e(Global_35, Local_19.f_6))
							{
								iLocal_0 = 0;
								return;
							}
...
int func_15(int iParam0)
{
	...
	if (func_34(_get_scenario_point_coords(iParam0->f_6, true)))
	{
		return 0;
	}
...
void func_19(int iParam0)
{
	...
	if (func_42(_0x2bf1953c0c21ac88(iVar0), 1))
	{
...
void func_23(var uParam0, var uParam1, int iParam2, var uParam3, char* sParam4, vector3 vParam5, vector3 vParam8, bool bParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	switch (*uParam0)
	{
		case 0:
			...
			break;
		case 1:
			if (has_model_loaded(*uParam1))
			{
				if (does_entity_exist(iParam2->f_5))
				{
					if (iParam2->f_154 != -1)
					{
						vVar3 = { get_world_position_of_entity_bone(iParam2->f_5, iParam2->f_154) };
						vVar0 = { _get_object_offset_from_coords(vVar3, get_entity_heading(iParam2->f_5), vParam5) };
					}
					else
					{
						vVar0 = { get_offset_from_entity_in_world_coords(iParam2->f_5, vParam5) };
					}
				}
				else if (_does_scenario_point_exist(iParam2->f_6))
				{
					vVar0 = { _get_object_offset_from_coords(_get_scenario_point_coords(iParam2->f_6, true), _get_scenario_point_heading(iParam2->f_6, true), vParam5) };
				}
			else
			{
				}
				...
				{
					*uParam3 = create_object(*uParam1, vVar0, true, true, false, false, bParam11);
					set_entity_invincible(*uParam3, true);
					_0x1461df6db886be3f(*uParam3);
					if (bParam12)
					{
						iVar6 = func_49(iParam2->f_4, iParam2->f_154, 0);
						vVar0 = { func_50(iParam2->f_4, vParam5, get_offset_from_entity_given_world_coords(iParam2->f_5, get_entity_coords(*uParam3, true, false))) };
						attach_entity_to_entity(*uParam3, iParam2->f_5, iVar6, vVar0, vParam8, false, false, false, false, 2, true, false, false);
					}
					else
					{
						set_entity_rotation(*uParam3, vParam8, 2, true);
					}
					*uParam0 = 2;
					Jump @359; //curOff = 348
					if (bParam14)
					...
					if (!bParam13)
					{
						...
						else if (_0x8360c47380b6f351(iParam2->f_6, *uParam3, sParam4, 1))
						{
							*uParam0 = iVar7;
						}
						else if (bParam14)
					...
					if (iParam15 != 0)
					{
						_0xa6a76d666a281f2d(*uParam3, iParam15);
						*uParam0 = 4;
					}
				}
			}
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (has_model_loaded(*iParam1))
			{
				...
				iVar0 = create_object(*iParam1, vParam3, true, true, false, false, false);
				if (does_entity_exist(iParam2->f_5))
				{
...
bool func_35(int iParam0)
{
	...
	return func_65((*Global_1835011)[iParam0]->f_1);
}
...
{
	iVar0 = 0;
	if (func_35(3) && get_entity_model(iParam0->f_5) == 114039925)
	{
		iVar0 = 852615066;
	}
	return iVar0;
...
{
	if (!is_string_null_or_empty(func_74(iParam0, iParam1)))
	{
		iVar0 = get_entity_bone_index_by_name(iParam0->f_5, func_74(iParam0, iParam1));
		return iVar0;
	}
	return 0;
}
...
{
	*vVar0[0] = { 0.15f, 0.07f, -0.06f };
	*vVar0[1] = { 0.07f, 0.12f, -0.06f };
	*vVar0[2] = { 0f, 0.08f, -0.06f };
	*vVar0[3] = { -0.09f, 0.13f, -0.06f };
	*vVar0[4] = { -0.15f, 0.08f, -0.06f };
	*vVar0[5] = { -0.16f, 0.24f, -0.06f };
	*vVar0[6] = { -0.1f, 0.29f, -0.06f };
	*vVar0[7] = { 0f, 0.23f, -0.06f };
	*vVar0[8] = { 0.08f, 0.29f, -0.06f };
	*vVar0[9] = { 0.14f, 0.21f, -0.06f };
	func_63(&uVar31, 10, 1);
	iVar42 = 0;
	while (iVar42 < 9)
	{
