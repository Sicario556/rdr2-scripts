...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -967333571, 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	...
	func_158(uParam0, iLocal_14, 3, -1124614608, "WORLD_HUMAN_WAITING_IMPATIENT_MALE_A", -1, 0, 55f, 1065353216, 1);
