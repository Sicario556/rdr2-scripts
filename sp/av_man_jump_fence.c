...
{
	func_33(uParam0, 10689, 10747, 11133);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				_0x89f5e7adecccb49c(&(uParam0->f_20[0]), "Nervous");
				func_65(uParam0->f_20[0], 0, 1);
		...
		case 1:
			...
			{
				func_63(uParam0);
				task_climb(&(uParam0->f_20[0]), false);
				iLocal_9 = 2;
			}
			break;
		case 2:
			...
			if (!func_68(&(uParam0->f_20[0]), -1207763510))
			{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_105(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_106(&(uParam0->f_490)))
							{
