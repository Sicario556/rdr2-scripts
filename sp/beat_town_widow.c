...
void func_4()
{
	...
	if (_0x91a5f9cbebb9d936(uVar411))
	{
		clear_ped_non_creation_area();
		remove_scenario_blocking_area(uVar411, true);
	}
	if (_does_anim_scene_exist(iVar261))
	{
		_delete_anim_scene(iVar261);
	}
	if (does_entity_exist(iVar381))
	{
		delete_object(&iLocal_383);
	}
	...
	_0x24c82ef607105faa(&(uLocal_379[0]), 493038497);
...
bool func_10()
{
	switch (iVar501)
	{
		...
		case 1:
			...
			break;
		case 6:
			if (does_entity_exist(&(uLocal_379[0])))
			{
				set_model_as_no_longer_needed(Local_209[0]->f_1);
			}
			if (!_has_ped_emotional_preset_loaded(&(uLocal_379[0]), "Default_Curious"))
			{
				return false;
			}
			return true;
...
void func_11()
{
	...
	fLocal_414 = 10f;
	iLocal_413 = func_41(vVar0, vVar3, vVar6, uVar412, 0, 0);
}
...
{
	func_52();
	if (is_ped_dead_or_dying(&(uLocal_379[0]), true))
	{
		func_53(9);
	}
	if (!Local_15.f_46)
	{
		if (func_54(&(uLocal_379[0]), 0, &(Local_15.f_5), &uLocal_505, 0, 0))
		{
			Local_15.f_46 = 1;
			_0x2e1d6d87346bb7d2(&(uLocal_379[0]), Global_35, 0, 0);
			if (iVar544 == 1)
			{
				if (!func_55())
				{
					vLocal_385 = { get_entity_coords(&(uLocal_379[0]), true, false) };
					get_ground_z_for_3d_coord(vLocal_385, &(vLocal_385.f_2), false);
					set_anim_scene_origin(iVar261, vLocal_385, get_entity_rotation(&(uLocal_379[0]), 2), 2);
					start_anim_scene(iVar261);
			...
			if (!is_entity_dead(&(uLocal_379[0])))
			{
				if (bVar554)
				{
					func_58(3, 0, 0, 0, &(uLocal_379[0]), 0, 1065353216, 0);
				}
				else
				{
					func_58(2, 0, 0, 0, &(uLocal_379[0]), 0, 1065353216, 0);
				}
			}
			fLocal_568 = 0f;
			fLocal_569 = 0f;
			_0x58f7db5bd8fa2288(&(uLocal_379[0]));
			clear_ped_secondary_task(&(uLocal_379[0]));
			stop_current_playing_speech(&(uLocal_379[0]), 1000);
			func_53(8);
		}
	}
	if (is_entity_dead(&(uLocal_379[0])) && bVar554)
	{
		if (!bVar555)
		{
			func_58(4, 0, 0, "Cruel Killing", &(uLocal_379[0]), 0, 1065353216, 0);
			iLocal_557 = 1;
		}
	}
	if (func_59(iVar382, 2))
	{
		Local_15.f_45 = 1;
	}
	else
	...
	if (bVar537 && !func_60(Global_35, 0))
	{
		if (!bVar554)
		{
			func_58(12, 0, 0, "Offered Help", &(uLocal_379[0]), 0, 1065353216, 0);
...
bool func_14()
{
	switch (iVar499)
	{
		...
		case 8:
			...
			break;
		case 9:
			set_ped_config_flag(&(uLocal_379[0]), 169, false);
			func_71();
			set_ped_keep_task(&(uLocal_379[0]), true);
			Local_15.f_50 = 1;
			if (_does_anim_scene_exist(iVar261))
			{
				_delete_anim_scene(iVar261);
			...
			{
				if (has_entity_clear_los_to_entity_in_front(&(uLocal_379[0]), Global_35, 17))
				{
					if (iVar545 == 0)
					{
						iLocal_547 = 1;
						_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 3, 320, -1082130432, -1, 0);
					}
				}
			}
			if (iVar549 == 0)
			{
				switch (iVar661)
				{
					case 0:
						if (func_75())
						{
							func_76(&(uLocal_379[0]), Global_35, &(sLocal_352[18]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
							_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 6, 0, -1082130432, -1, 0);
							func_77(&uLocal_660);
					...
					case 1:
						...
						{
							func_76(&(uLocal_379[0]), Global_35, &(sLocal_352[19]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
							_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 2, 0, -1082130432, -1, 0);
							iLocal_551 = 1;
						}
						break;
				}
			}
			if (does_blip_exist(&(uLocal_381[0])))
			{
				remove_blip(uLocal_381[0]);
			}
			if (func_79(&(uLocal_379[0]), 1, 1) >= 100f || is_ped_dead_or_dying(&(uLocal_379[0]), true))
			{
				return true;
			}
			break;
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_83(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
...
void func_32()
{
	...
	{
		case 76:
			Local_209[0]->f_1 = 1131330924;
			StringCopy(&(Local_209[0]->f_23), "TOWN_WIDOW", 64);
			Local_209[0]->f_3 = -293772591;
		...
		case 105:
			Local_209[0]->f_1 = 1131330924;
			StringCopy(&(Local_209[0]->f_23), "0854_A_F_M_Civ_Poor_Black_AVOID_04", 64);
			Local_209[0]->f_3 = 1074159868;
...
void func_33()
{
	...
	{
		case 0:
			Local_209[0]->f_6 = { -250.01f, 768.66f, 116.55f };
			Local_209[0]->f_9 = 100.27f;
			break;
		case 1:
			Local_209[0]->f_6 = { -349.09f, 740.88f, 116.43f };
			Local_209[0]->f_9 = -66.99f;
			break;
		case 2:
			Local_209[0]->f_6 = { -212.04f, 640.67f, 111.98f };
			Local_209[0]->f_9 = -132.47f;
			break;
		case 3:
			Local_209[0]->f_6 = { 2938.38f, 1320.05f, 43.23f };
			Local_209[0]->f_9 = 71.15f;
			break;
		case 4:
			Local_209[0]->f_6 = { 2870.76f, 1349.07f, 61.35f };
			Local_209[0]->f_9 = 87.31f;
			break;
		case 5:
			Local_209[0]->f_6 = { 1286.04f, -1287.2f, 74.98f };
			Local_209[0]->f_9 = -28.49f;
			break;
		case 6:
			Local_209[0]->f_6 = { 1366.49f, -1374.91f, 77.85f };
			Local_209[0]->f_9 = -104.77f;
			break;
	}
}
...
void func_34()
{
	Local_242[0] = "script_re@town_widow@encounter";
	Local_242[0]->f_1 = "callover";
	Local_242[1] = "script_re@town_widow@encounter";
	Local_242[1]->f_1 = "confront";
	Local_242[9] = "script_re@town_widow@encounter";
	Local_242[9]->f_1 = "to_crowd";
	Local_242[2] = "script_re@town_widow@encounter";
	Local_242[2]->f_1 = "ignore";
	Local_242[5] = "script_re@town_widow@encounter";
	Local_242[5]->f_1 = "positive";
	Local_242[3] = "script_re@town_widow@encounter";
	Local_242[3]->f_1 = "negative";
	Local_242[6] = "script_re@town_widow@encounter";
	Local_242[6]->f_1 = "positive_plyr_player";
	Local_242[4] = "script_re@town_widow@encounter";
	Local_242[4]->f_1 = "negative_plyr_player";
	Local_242[7] = "script_re@town_widow@encounter";
	Local_242[7]->f_1 = "taunt";
	Local_242[8] = "script_re@town_widow@encounter";
	Local_242[8]->f_1 = "threat";
	switch (iLocal_14)
	{
		case 0:
	...
	func_132(&(Local_242[0]), &uLocal_271);
}

void func_35(var uParam0)
{
	func_134((*uParam0)[0], func_133(7), "", -163964935, 0, 0, 0, 1, 0);
	func_134((*uParam0)[1], "RE_INTER_ANTAGONIZE", "", 648122183, 0, 0, 0, 1, 0);
	func_134(Local_437[2], "INTERACT_ROB", "", -1616532217, 0, 0, 0, 1, 0);
	func_135(Local_437[2], 1);
	func_136(Local_437[2], 3f);
	func_137(Local_437[0], 0, 0);
	func_137(Local_437[1], 0, 0);
	func_137(Local_437[2], 0, 0);
	func_138(Local_437[0], 1);
	func_138(Local_437[1], 1);
	func_138(Local_437[2], 1);
}
...
bool func_38(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_140() || !func_141((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
void func_39()
{
	...
	_0xaab050da48b57978(&(uLocal_379[0]), "Default_Sad", 0, -1, 4);
	func_143(&(uLocal_379[0]), &(Local_209[0]->f_23), 0);
	_set_entity_coords_and_heading(&(uLocal_379[0]), Local_209[0]->f_6, Local_209[0]->f_9, true, false, true);
	set_ped_path_prefer_to_avoid_water(&(uLocal_379[0]), true, 100f);
	set_ped_path_avoid_fire(&(uLocal_379[0]), true);
	_0x42cfd8fd8cc8dc69(&(uLocal_379[0]), 1);
	func_144(&(uLocal_379[0]), 1);
	set_ped_config_flag(&(uLocal_379[0]), 297, true);
	set_ped_config_flag(&(uLocal_379[0]), 130, true);
	set_ped_config_flag(&(uLocal_379[0]), 317, true);
	set_ped_config_flag(&(uLocal_379[0]), 315, true);
	set_entity_is_target_priority(&(uLocal_379[0]), true, 20f);
	_0xf1c03a5352243a30(&(uLocal_379[0]));
	_request_ped_emotional_preset(&(uLocal_379[0]), "Default_Curious");
...
int func_41(vector3 vParam0, vector3 vParam3, vector3 vParam6, var uParam9, float fParam10, int iParam11)
{
	vVar1 = { func_99(vParam0, vParam3, fParam10) };
	vVar4 = { func_100(vParam0, vParam3, fParam10) };
	func_153(vParam6, uParam9, iParam11);
...
void func_47(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_83(uParam0->f_3));
...
bool func_50(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!*uParam1 && func_27(iParam0, 128))
	{
		...
		if (!uParam2->f_48)
		{
			if (func_183(&(uParam2->f_91), 0, 1084227584, 1, 1))
			{
				return false;
			}
		}
...
void func_51(var uParam0, int iParam1)
{
	if (func_184(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_187());
...
{
	iVar0 = -1;
	iVar0 = func_190(uLocal_379[0], &iLocal_416, 15f, &Local_437, &(Local_15.f_192), 0f, 1, 0, 0, iVar618, 0, 0, 2, 1, -1082130432, 0);
	switch (iVar488)
	{
		case 0:
			switch (iVar0)
			{
				case 0:
					...
					{
						task_play_anim(Global_35, &(Local_242[6]), Local_242[6]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
						func_76(Global_35, &(uLocal_379[0]), &(sLocal_352[12]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					}
					else
					{
						func_76(Global_35, &(uLocal_379[0]), &(sLocal_352[12]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					}
					uLocal_560 = &Local_242[5];
					uLocal_561 = Local_242[5]->f_1;
					func_77(&uLocal_515);
					clear_ped_secondary_task(&(uLocal_379[0]));
					stop_current_playing_speech(&(uLocal_379[0]), 1000);
					iLocal_559 = 0;
					func_53(3);
					func_192(Local_437[0], "RE_INTER_POS");
					func_192(Local_437[1], "RE_INTER_ANTAGONIZE");
					break;
				case 1:
					func_137(Local_437[0], 0, 0);
					func_137(Local_437[1], 0, 0);
					Local_15.f_44 = 1;
					uLocal_560 = &Local_242[3];
					uLocal_561 = Local_242[3]->f_1;
					if (func_191(&(uLocal_379[0]), 90f, 0))
					{
						task_play_anim(Global_35, &(Local_242[4]), Local_242[4]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
						func_76(Global_35, &(uLocal_379[0]), &(sLocal_352[13]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					}
					else
					{
						func_76(Global_35, &(uLocal_379[0]), &(sLocal_352[13]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
...
bool func_54(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_202(iParam0, iParam2, *uParam3);
				return true;
			}
		}
...
bool func_55()
{
	if (_does_anim_scene_exist(iVar261))
	{
		if (_is_anim_scene_started(iVar261, false))
		{
			fLocal_568 = _get_anim_scene_progress(iVar261);
			return true;
		}
	}
	return false;
...
void func_56(int iParam0, int iParam1)
{
	...
	if (absf(fVar12) > fVar13)
	{
		...
		else if (func_227(vVar0, vVar0 + vVar6, get_entity_coords(iParam1, true, false)))
		{
			iLocal_489 = 3;
		}
		else
...
void func_57()
{
	...
	if (_0x23e33cb9f4a3f547(iVar261, sVar564))
	{
		_set_anim_scene_playback_list_bool(iVar261, sVar564, true);
	}
}
...
{
	func_233();
	if (func_234(&Local_15, 0f, 1114636288, 40f, 1, 0, 0, -1082130432, 1, 1125515264, 0, 0))
	{
...
void func_63()
{
	set_ped_max_move_blend_ratio(&(uLocal_379[0]), 1f);
	func_236(&(uLocal_379[0]), Global_35, &uLocal_388, -1, 50);
	set_ped_reset_flag(&(uLocal_379[0]), 229, true);
	if (iVar538 == 0)
	{
		if (func_237())
		{
	...
	{
		_0xf1c03a5352243a30(&(uLocal_379[0]));
		task_play_upper_anim_facing_entity(&(uLocal_379[0]), &(Local_242[0]), Local_242[0]->f_1, Global_35, -1, 8f, -8f, 603979792, 0f, false, false, -1f, 0, 1114112, -1f);
		func_236(&(uLocal_379[0]), Global_35, &uLocal_388, 3000, 50);
		func_77(&uLocal_518);
		iLocal_558 = 1;
	}
	else if (!is_entity_playing_anim(&(uLocal_379[0]), &(Local_242[0]), Local_242[0]->f_1, 1) && func_78(&uLocal_518) > 1f)
	{
		func_238();
		uLocal_562 = &Local_242[0];
		uLocal_563 = Local_242[0]->f_1;
		func_239(1515458263, &(uLocal_379[0]), 1);
		if (!does_blip_exist(&(uLocal_381[0])))
		{
			func_240(&(uLocal_379[0]), uLocal_381[0], -89429847, 580546400, 0, "RE_INTER_STRANGER");
		}
		func_138(Local_437[0], 0);
		func_138(Local_437[1], 0);
		func_137(Local_437[0], 1, 0);
		func_137(Local_437[1], 1, 0);
		add_shocking_event_for_entity(-1130398329, &(uLocal_379[0]), 5f, 25f, 25f, 0f, -1f, 180f, false, false, -1, -1);
...
void func_64()
{
	...
	if (!func_59(iVar382, 2))
	{
		if (!is_entity_playing_anim(&(uLocal_379[0]), sVar560, sVar561, 1) && func_245(-4f, 1, &(uLocal_379[0]), 1))
		{
			func_76(&(uLocal_379[0]), Global_35, &(sLocal_352[1]), 0, 15f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			task_play_anim(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1, 1.5f, -1.5f, -1, 67108884, 0f, false, 65536, false, 0, false);
			uLocal_562 = &Local_242[1];
			uLocal_563 = Local_242[1]->f_1;
			func_246(&uLocal_384, 2);
		}
	}
	if (is_entity_playing_anim(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1, 1))
	{
		if (_get_entity_anim_current_time(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1) >= 0.99f)
		{
			iLocal_553 = 1;
		}
	}
	...
	if (iVar540 == 1)
	{
		...
		else if (is_entity_playing_anim(&(uLocal_379[0]), &(Local_242[9]), Local_242[9]->f_1, 1))
		{
			if (_get_entity_anim_current_time(&(uLocal_379[0]), &(Local_242[9]), Local_242[9]->f_1) >= 0.99f)
			{
				Local_15.f_44 = 1;
				func_53(4);
			}
	...
	if (func_59(iVar382, 2))
	{
		if (_get_entity_anim_current_time(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1) >= 0.2f)
		{
			iLocal_490 = 0;
			if (!bVar552)
			{
				func_192(Local_437[0], "RE_INTER_DEFUSE");
				iLocal_554 = 1;
			}
			func_138(Local_437[0], 0);
			func_138(Local_437[1], 0);
		...
		if (!is_entity_at_entity(&(uLocal_379[0]), Global_35, fVar572, fVar572, 5f, false, true, 0))
		{
			if (!func_59(iVar382, 256) && iVar540 == 0)
			{
				func_248();
				clear_ped_secondary_task(&(uLocal_379[0]));
				stop_current_playing_speech(&(uLocal_379[0]), 1000);
				func_77(&uLocal_536);
				func_246(&uLocal_384, 256);
				task_play_anim(&(uLocal_379[0]), &(Local_242[7]), Local_242[7]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
				func_239(1515458263, &(uLocal_379[0]), 1);
				uLocal_562 = &Local_242[7];
				uLocal_563 = Local_242[7]->f_1;
			}
		...
		if (iVar550 == 0)
		{
			if (func_59(iVar382, 256))
			{
				if (is_entity_at_entity(&(uLocal_379[0]), Global_35, fVar572, fVar572, 5f, false, true, 0))
				{
					if (!is_entity_playing_anim(&(uLocal_379[0]), sVar560, sVar561, 1) && func_245(-4f, 1, &(uLocal_379[0]), 1))
					{
						task_play_anim(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1, 1.5f, -1.5f, -1, 67108884, fVar571, false, 65536, false, 0, false);
						uLocal_562 = &Local_242[1];
						uLocal_563 = Local_242[1]->f_1;
						func_198(&uLocal_536);
						iLocal_552 = 1;
...
void func_65()
{
	...
	func_244();
	func_250();
	if (is_entity_playing_anim(Global_35, &(Local_242[6]), Local_242[6]->f_1, 1) || is_entity_playing_anim(Global_35, &(Local_242[4]), Local_242[4]->f_1, 1))
	{
	...
	switch (iVar494)
	{
		case 0:
			if (func_245(-4f, 1, 0, 0) && func_243(&uLocal_515) >= 4f)
			{
				...
				set_ped_config_flag(&(uLocal_379[0]), 169, true);
				clear_ped_secondary_task(&(uLocal_379[0]));
				task_play_anim(&(uLocal_379[0]), sVar558, sVar559, 1.5f, -1.5f, -1, 0, 0f, false, 0, false, 0, false);
				func_251();
				iLocal_496 = 1;
			}
			break;
		case 1:
			if (is_entity_playing_anim(&(uLocal_379[0]), sVar558, sVar559, 1))
			{
				if (_get_entity_anim_current_time(&(uLocal_379[0]), sVar558, sVar559) >= 0.4f)
				{
					iLocal_546 = 1;
			...
			get_ground_z_for_3d_coord(vLocal_385, &(vLocal_385.f_2), false);
			set_anim_scene_origin(iVar261, vLocal_385, get_entity_rotation(&(uLocal_379[0]), 2), 2);
			if (_get_entity_anim_current_time(&(uLocal_379[0]), sVar558, sVar559) >= 0.99f || !is_entity_playing_anim(&(uLocal_379[0]), sVar558, sVar559, 1))
			{
				start_anim_scene(iVar261);
				set_anim_scene_bool(iVar261, "idle", false, false);
				iLocal_546 = 1;
				func_194(&iLocal_416, 0);
				...
				{
					iLocal_490 = 1;
					func_138(Local_437[2], 0);
					func_137(Local_437[2], 1, 0);
					func_192(Local_437[2], "RETWW_MONEY");
				}
				func_77(&uLocal_509);
				remove_anim_dict(&(Local_242[0]));
				func_53(5);
				iLocal_496 = 2;
			}
			break;
	...
	if (_does_anim_scene_exist(iVar261))
	{
		if (_is_anim_scene_loaded(iVar261, true, false))
		{
			func_254();
		}
	}
...
void func_66()
{
	...
	func_192(Local_437[0], "RE_INTER_POS");
	func_192(Local_437[1], "RE_INTER_ANTAGONIZE");
	func_192(Local_437[2], "INTERACT_ROB");
	if (does_entity_exist(iVar381))
	{
		delete_object(&iLocal_383);
	}
	if (!func_255(-2f))
	{
		if (!is_entity_playing_anim(&(uLocal_379[0]), sVar560, sVar561, 1) && func_245(-4f, 1, &(uLocal_379[0]), 1))
		{
			if (func_76(&(uLocal_379[0]), Global_35, &(sLocal_352[7]), 0, -1082130432, 0, 0, 0, 1, 0, 1, 1744022339, 1, 0, 0))
			{
				task_play_anim(&(uLocal_379[0]), &(Local_242[2]), Local_242[2]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
				func_53(6);
			}
		}
	}
	if (bVar553)
	{
		func_76(&(uLocal_379[0]), Global_35, &(sLocal_352[11]), 0, -1082130432, 0, 0, 0, 1, 0, 1, 1744022339, 1, 0, 0);
		task_play_anim(&(uLocal_379[0]), &(Local_242[2]), Local_242[2]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
		func_53(6);
	}
}
...
void func_67()
{
	...
	switch (iVar495)
	{
		case 0:
			...
			if (func_243(&uLocal_509) >= 25f)
			{
				if (!func_260())
				{
					...
					_0xdf7b5144e25cd3fe(iVar261, "PBL_EXIT");
					_0xdf7b5144e25cd3fe(iVar261, "PBL_EXIT");
					func_194(&iLocal_416, 0);
					iLocal_620 = func_1(3, 0, 0);
					func_53(6);
		...
		case 1:
			if (func_260() == 0)
			{
				if (get_sequence_progress(Global_35) >= 1 && _0x23e33cb9f4a3f547(iVar261, sVar562))
				{
					func_262();
					iLocal_497 = 2;
				}
			...
			break;
		case 2:
			if (((((_0x8d81e7824b7753f7(iVar261, "N_TAKE", 1) || _0x8d81e7824b7753f7(iVar261, "L_TAKE", 1)) || _0x8d81e7824b7753f7(iVar261, "R_TAKE", 1)) || _0x8d81e7824b7753f7(iVar261, "REFUSE_N", 1)) || _0x8d81e7824b7753f7(iVar261, "REFUSE_L", 1)) || _0x8d81e7824b7753f7(iVar261, "REFUSE_R", 1))
			{
				iLocal_497 = 3;
			}
			break;
...
void func_68()
{
	...
	if (_does_anim_scene_exist(iVar261))
	{
		if (_0x23e33cb9f4a3f547(iVar261, "PBL_EXIT"))
		{
			_set_anim_scene_playback_list_bool(iVar261, "PBL_EXIT", true);
		}
	}
	if (_does_anim_scene_exist(iVar261))
	{
	...
	{
		set_anim_scene_bool(iVar261, "idle", true, false);
	}
	if (!func_55())
	{
		set_ped_config_flag(&(uLocal_379[0]), 169, false);
		func_145(&(uLocal_379[0]), &uLocal_415, 0, 0);
		_task_move_in_traffic(&(uLocal_379[0]), -1082130432, 1024, 0);
		set_ped_keep_task(&(uLocal_379[0]), true);
		Local_15.f_50 = 1;
		Local_15.f_44 = 1;
		if (does_entity_exist(iVar381))
...
void func_69()
{
	...
	if (func_266())
	{
		if (fVar566 >= 0.68f)
		{
			remove_anim_scene_entity(iVar261, "player", Global_35);
			display_radar(true);
		}
	}
	else if (fVar566 >= 0.66f)
	{
		remove_anim_scene_entity(iVar261, "player", Global_35);
		display_radar(true);
	}
...
void func_70()
{
	...
	if (_is_ped_hogtied(&(uLocal_379[0])) || _is_ped_lassoed(&(uLocal_379[0])))
	{
		_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 2, 320, -1082130432, -1, 0);
	...
	if (iVar541 == 1)
	{
		if (!_is_ped_hogtied(&(uLocal_379[0])) || !_is_ped_lassoed(&(uLocal_379[0])))
		{
			if (!func_59(iVar382, 128))
			{
				if (iVar503 != 8192)
				{
					func_76(&(uLocal_379[0]), Global_35, sVar0, 0, 20f, 0, 0, 0, 2, 1, 1, 1744022339, 1, 0, 0);
				}
				func_246(&uLocal_384, 128);
				if (!func_268(&(uLocal_379[0]), 242628503))
				{
					clear_sequence_task(&uLocal_621);
					open_sequence_task(&uLocal_621);
					_task_smart_flee_style_ped(0, Global_35, 2, 320, -1082130432, -1, 0);
					close_sequence_task(iVar619);
					task_perform_sequence(&(uLocal_379[0]), iVar619);
					clear_sequence_task(&uLocal_621);
				}
			}
			else
	...
	else if (!_is_ped_hogtied(&(uLocal_379[0])) || !_is_ped_lassoed(&(uLocal_379[0])))
	{
		if (!func_59(iVar382, 128))
		{
			if (iVar503 != 8192)
			...
			func_246(&uLocal_384, 128);
			if (!func_55() && !is_entity_playing_anim(&(uLocal_379[0]), sVar558, sVar559, 1))
			{
				if ((!func_72(&(uLocal_379[0]), &(Local_15.f_5)) && !func_73(Global_35, &(uLocal_379[0]), &(Local_15.f_5))) && !func_74(Global_35, &(uLocal_379[0]), &(Local_15.f_5)))
				{
					task_play_anim(&(uLocal_379[0]), &(Local_242[8]), Local_242[8]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
					iLocal_549 = 1;
				}
			}
		}
		else if (!is_entity_playing_anim(&(uLocal_379[0]), &(Local_242[8]), Local_242[8]->f_1, 1) && !is_entity_playing_anim(&(uLocal_379[0]), sVar558, sVar559, 1))
		{
			if (func_55())
			{
				if (fVar566 >= 0.9f || fVar567 >= 0.9f)
				{
					if (iVar547 == 1)
					{
						_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 2, 320, -1082130432, -1, 0);
					...
					{
						_task_smart_flee_style_ped(&(uLocal_379[0]), Global_35, 2, 64, -1082130432, -1, 0);
					}
					func_53(9);
				}
			}
...
bool func_75()
{
	...
	else if (func_243(&uLocal_527) >= 4f)
	{
		...
		{
			if ((func_79(&(uLocal_379[0]), 1, 1) <= 3f && get_ped_desired_move_blend_ratio(Global_35) >= 1f) && iVar548 == 1)
			{
				return true;
			}
			else
...
void func_111(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_187());
		if (func_304(Global_1310750[iParam0], 33554432))
		{
			func_189(iVar0, func_188(iParam0), 1, 0, 2, 0, -1082130432);
		}
		else
		{
			func_189(iVar0, func_188(iParam0), 1, 0, 8, 0, -1082130432);
		}
		if (func_27(iParam0, 1))
		{
...
bool func_119(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	vVar2 = { *uParam0 };
...
int func_130(bool bParam0)
{
	...
	get_group_size(func_325(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_325(), iVar3);
		if (func_326(iVar4))
		{
			iVar0++;
		}
...
void func_131(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_327(&((*uParam0)[iVar0]->f_1));
		func_327(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
	...
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_338(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
void func_158(int iParam0, int iParam1)
{
	...
	func_348(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_349(iParam0, 0);
	func_350(iParam0);
	func_351(1);
	...
	if (uParam0->f_177 != -1 || func_304(Global_1310750[uParam0->f_3], 16777216))
	{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_359(uParam0->f_177));
			}
		}
	}
...
bool func_169(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
bool func_199(int iParam0, int iParam1, char* sParam2, float fParam3)
{
	...
	{
		func_76(iParam0, iParam1, sParam2, 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		func_198(&uLocal_533);
		return true;
	}
	return false;
...
bool func_203(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_402(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_272(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_273(iParam2)
				{
					func_274(iParam2, 1);
					return true;
				}
...
bool func_204(int iParam0, int iParam1)
{
	...
	if (func_399(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_273(iParam1)
		{
...
int func_224(int iParam0, int iParam1)
{
	...
	{
		return func_423(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_233()
{
	if (iVar546 == 0)
	{
		...
		{
			case 0:
				task_start_scenario_at_position(&(uLocal_379[0]), -22664287, Local_209[0]->f_6, Local_209[0]->f_9, -1, false, true, 0, -1f, false);
				break;
			case 1:
				task_start_scenario_at_position(&(uLocal_379[0]), -22664287, Local_209[0]->f_6, Local_209[0]->f_9, -1, false, true, 0, -1f, false);
				break;
...
bool func_237()
{
	...
	{
		task_look_at_entity(&(uLocal_379[0]), Global_35, -1, 0, 51, 0);
		return true;
	}
	return false;
}
...
void func_238()
{
	if (!func_268(&(uLocal_379[0]), 1682639051))
	{
		func_441(&(uLocal_379[0]), Global_35, &uLocal_582, -1082130432, 0, 0, -1082130432, 2f, 1, 256, 0, 0, 1069547520, 1073741824, 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
	}
}
...
void func_241()
{
	func_315(Global_35, get_entity_coords(&(uLocal_379[0]), true, false), &uLocal_654, 1061158912, 0, 0);
	switch (iVar655)
	{
		case 0:
...
void func_244()
{
	if (!is_shocking_event_in_sphere(-23350179, get_entity_coords(&(uLocal_379[0]), true, false), 5f))
	{
		iLocal_499 = add_shocking_event_for_entity(-23350179, &(uLocal_379[0]), -1f, 40f, 30f, 0f, -1f, 180f, false, false, -1, -1);
	}
}
...
{
	iLocal_542 = 1;
	iVar0 = get_ped_nearby_peds(&(uLocal_379[0]), &uLocal_576, -1, -1);
	if (iVar0 > 0)
	{
		iVar1 = 0;
		while (iVar1 < 5)
		{
			if (func_85(&(uLocal_576[iVar1]), 0, 1) && is_ped_human(&(uLocal_576[iVar1])))
			{
				if ((&uLocal_576[iVar1] != Global_35 && !is_ped_on_mount(&(uLocal_576[iVar1]))) && !is_ped_in_any_vehicle(&(uLocal_576[iVar1]), true))
				{
	...
	if (iVar539 == 1)
	{
		if (!is_entity_playing_anim(&(uLocal_379[0]), &(Local_242[9]), Local_242[9]->f_1, 1) && func_245(-4f, 1, &(uLocal_379[0]), 1))
		{
			task_play_anim(&(uLocal_379[0]), &(Local_242[9]), Local_242[9]->f_1, 1.5f, -1.5f, -1, 67108880, 0f, false, 65536, false, 0, false);
			uLocal_562 = &Local_242[9];
			uLocal_563 = Local_242[9]->f_1;
		}
	}
}
...
void func_248()
{
	fVar0 = _get_entity_anim_current_time(&(uLocal_379[0]), &(Local_242[1]), Local_242[1]->f_1);
	if (fVar0 <= 0f)
	{
		fLocal_573 = 0f;
	}
...
void func_250()
{
	if (_does_anim_scene_exist(iVar261))
	{
		if (func_266())
		{
			if (_0x23e33cb9f4a3f547(iVar261, "PB_MTH_ENTER_N"))
			{
				func_447(0, func_446(Global_35, iVar261, "player", "PB_MTH_ENTER_N", 1), 1058642330);
			}
			if (_0x23e33cb9f4a3f547(iVar261, "PB_MTH_ENTER_L"))
			{
				func_447(1, func_446(Global_35, iVar261, "player", "PB_MTH_ENTER_L", 1), 1058642330);
			}
			if (_0x23e33cb9f4a3f547(iVar261, "PB_MTH_ENTER_R"))
			{
				func_447(2, func_446(Global_35, iVar261, "player", "PB_MTH_ENTER_R", 1), 1058642330);
			}
		}
		else
		{
...
void func_251()
{
	...
	{
		case 0:
			Local_263 = _create_anim_scene(Local_263.f_4, 64, "MOURN_IDLE", false, true);
			set_anim_scene_entity(iVar261, "player", player_ped_id(), 0);
			set_anim_scene_entity(iVar261, "Female", &(uLocal_379[0]), 0);
			set_anim_scene_bool(iVar261, "MOURN_BOOL", false, false);
			load_anim_scene(iVar261);
			break;
		case 1:
			Local_263 = _create_anim_scene(Local_263.f_4, 64, "MOURN_IDLE", false, true);
			set_anim_scene_entity(iVar261, "player", player_ped_id(), 0);
...
void func_254()
{
	...
	{
		case 0:
			_0xdf7b5144e25cd3fe(iVar261, "MOURN_IDLE");
			_0xdf7b5144e25cd3fe(iVar261, "PBL_EXIT");
			_0xdf7b5144e25cd3fe(iVar261, "PB_MTH_ENTER_N");
			_0xdf7b5144e25cd3fe(iVar261, "PB_MTH_ENTER_L");
			_0xdf7b5144e25cd3fe(iVar261, "PB_MTH_ENTER_R");
			_0xdf7b5144e25cd3fe(iVar261, "PB_LOOKUP_BL");
			_0xdf7b5144e25cd3fe(iVar261, "PB_LOOKUP_BR");
			_0xdf7b5144e25cd3fe(iVar261, "PB_LOOKUP_L");
			_0xdf7b5144e25cd3fe(iVar261, "PB_LOOKUP_R");
			_0xdf7b5144e25cd3fe(iVar261, "PB_LOOKUP_N");
			_0xdf7b5144e25cd3fe(iVar261, "PB_BRKOUT_BL");
			_0xdf7b5144e25cd3fe(iVar261, "PB_BRKOUT_BR");
			_0xdf7b5144e25cd3fe(iVar261, "PB_BRKOUT_L");
			_0xdf7b5144e25cd3fe(iVar261, "PB_BRKOUT_R");
			_0xdf7b5144e25cd3fe(iVar261, "PB_BRKOUT_N");
			break;
		case 1:
			_0xdf7b5144e25cd3fe(iVar261, "MOURN_IDLE");
			_0xdf7b5144e25cd3fe(iVar261, "PBL_EXIT");
...
void func_256()
{
	...
	{
		if (!is_any_speech_playing(&(uLocal_379[0])))
		{
...
void func_257()
{
	...
	if (_does_anim_scene_exist(iVar261))
	{
		if (_0x1f0e401031e20146(iVar261, uVar562))
		{
			if (fVar566 >= fVar568)
			{
				if (iVar542 == 0)
				{
					iLocal_544 = 1;
					attach_entity_to_entity(iVar381, Global_35, get_ped_bone_index(Global_35, 7966), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, false, false);
				}
			}
			if (fVar566 >= fVar569)
			{
				...
				{
					iLocal_545 = 1;
					attach_entity_to_entity(iVar381, &(uLocal_379[0]), get_ped_bone_index(&(uLocal_379[0]), 7966), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, false, false);
...
void func_258()
{
	...
	{
		func_77(&uLocal_521);
		iLocal_567 = get_random_int_in_range(3, 7);
	}
	else if (func_243(&uLocal_521) >= IntToFloat(iVar565))
	{
		func_56(&(uLocal_379[0]), Global_35);
		switch (iVar487)
		{
		...
		if (_0x23e33cb9f4a3f547(iVar261, sVar563))
		{
			_set_anim_scene_playback_list_bool(iVar261, sVar563, true);
		}
		func_198(&uLocal_521);
	}
}
...
bool func_260()
{
	if ((((is_entity_playing_anim(&(uLocal_379[0]), "script_re@town_widow@give_money", "lookup_back_l", 1) || is_entity_playing_anim(&(uLocal_379[0]), "script_re@town_widow@give_money", "lookup_back_r", 1)) || is_entity_playing_anim(&(uLocal_379[0]), "script_re@town_widow@give_money", "lookup_l", 1)) || is_entity_playing_anim(&(uLocal_379[0]), "script_re@town_widow@give_money", "lookup_r", 1)) || is_entity_playing_anim(&(uLocal_379[0]), "script_re@town_widow@give_money", "lookup_n", 1))
	{
		return true;
	}
	return false;
...
void func_261()
{
	...
	task_enter_anim_scene(0, uVar261, "player", uVar562, 1069379748, 1, 0, 20000, -1082130432);
	close_sequence_task(iVar0);
...
void func_262()
{
	...
	if (!does_entity_exist(iVar381))
	{
		iLocal_383 = create_object(-770982987, get_entity_coords(Global_35, true, false) + Vector(2f, 10f, 10f), true, true, false, false, true);
	}
	if (does_entity_exist(iVar381))
	{
		_set_anim_scene_playback_list_bool(iVar261, sVar562, true);
	...
	switch (iVar498)
	{
		case 0:
			...
			if (func_245(-4f, 1, 0, 0))
			{
				if (func_266())
				{
					func_76(player_ped_id(), &(uLocal_379[0]), &(sLocal_352[14]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				}
				else
				{
					func_76(player_ped_id(), &(uLocal_379[0]), &(sLocal_352[15]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				}
				if (func_266())
				{
					iLocal_500 = 1;
...
bool func_270(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_281(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
int func_277(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_459(func_448(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_321(vector3 vParam0, int iParam3)
{
	...
	return func_474(vVar0, vParam0) > func_474(vVar0, get_entity_coords(iParam3, true, false));
}
...
int func_338(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_484(iVar0))
		{
		...
		if (func_485(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_486(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_492(&(uParam1->f_22)));
		...
		if (!func_484(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_495(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_496(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_496(&(uParam1->f_22)));
...
void func_348(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_20(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_355(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_511(to_float(iVar0), 1, 0);
	}
	else
	{
		func_511((to_float(200) / 3f), 1, 0);
	}
}
...
int func_388(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_89(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
...
void func_389(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_76(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
{
	get_ground_z_and_normal_for_3d_coord(get_entity_coords(iParam0, true, false), &fVar0, &uVar5);
	vVar2 = { get_offset_from_entity_in_world_coords(iParam0, vParam1) };
	if (func_532(&vVar2, 50, 10, 0))
	{
		get_ground_z_and_normal_for_3d_coord(vVar2 + Vector(1f, 0f, 0f), &fVar1, &uVar8);
		fVar11 = (fVar0 - fVar1);
		fVar12 = (fVar11 / 1f);
		fVar13 = atan(fVar12);
		fVar14 = absf(fVar13);
...
bool func_402(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_456(iVar0, 0)))
		{
			if (func_537(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_411(int iParam0, int iParam1)
{
	...
	if (func_393(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_418(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_281(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_421(int iParam0)
{
	...
	return func_540((*Global_1347702)[58]->f_15, 1);
}
...
int func_425(int iParam0)
{
	...
	fVar1 = func_89(absf(fVar1) < 1f, func_89(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
bool func_440()
{
	if (!is_ped_facing_ped(player_ped_id(), &(uLocal_379[0]), fVar573))
	{
...
void func_447(int iParam0, vector3 vParam1, float fParam4)
{
	...
	{
		case 0:
			get_ground_z_for_3d_coord(vParam1, &(vParam1.f_2), false);
			iLocal_622[iParam0] = start_shape_test_capsule(vParam1, vParam1 + Vector(0.6f, 0f, 0f), fParam4, 18, &(uLocal_379[0]), 4);
			iLocal_492[iParam0] = 1;
			break;
		case 1:
			iVar0 = get_shape_test_result(&(iLocal_622[iParam0]), uLocal_626[iParam0], vLocal_630[iParam0], vLocal_640[iParam0], uLocal_650[iParam0]);
			if (iVar0 == 2)
			{
...
bool func_450(int iParam0, int iParam1)
{
	if (does_entity_exist(iParam0) && is_entity_a_ped(iParam0))
	{
		...
		return func_564(iParam0, 2084597891, iParam1, iVar0);
	}
...
bool func_457(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_537(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
void func_466(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_348(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_349(iParam0, 1);
	if (!bParam2)
	{
		func_463(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_574(iParam0))
		{
...
void func_477(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_579(iParam0, 8))
		{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_5(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_595(iParam1, (*uParam2)[iVar8]);
				}
			}
...
void func_562(int iParam0, char* sParam1, int iParam2)
{
	...
	func_437(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, 859817522, 0, 0, 0, 1);
}
...
void func_566(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_622(iVar0), func_325(), 1))
			{
...
bool func_590(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_632((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_592(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_633(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_296((*uParam2)[iVar0]->f_6))
		{
			func_332((*uParam2)[iVar0], 11);
...
void func_597(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_633(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
void func_604(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_137((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
void func_633(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_296(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		...
		if (func_607(iParam1))
		{
			...
			iParam1->f_6 = func_659(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824, 0, 1704213876, iParam1->f_10, 0);
			if (func_296(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_659(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_579(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_669(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
