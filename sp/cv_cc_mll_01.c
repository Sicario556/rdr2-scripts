...
{
	if (!_is_scenario_group_enabled_hash(iLocal_44))
	{
		_set_scenario_group_enabled_hash(iLocal_44, true);
	}
	if (!bLocal_47)
	{
		set_entity_coords(func_8(uParam0, iLocal_23), vLocal_38, true, false, true, true);
		bLocal_47 = true;
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	iLocal_24 = func_154(uParam0, 1623781586, 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	iLocal_21 = func_154(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = func_154(uParam0, -1916489787, 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_154(uParam0, 2038152081, 2.00448f, 2.79416f, 0.00851059f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, -98992470, "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 3, -1147740400, "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216, 1);
...
{
	_set_scenario_group_enabled_hash(iLocal_44, false);
	return true;
}
...
bool func_87(var uParam0)
{
	...
	if (does_entity_exist(iVar0))
	{
		vLocal_38 = { get_entity_coords(iVar0, false, false) };
		set_entity_coords(iVar0, func_191(uParam0, vLocal_41), true, false, true, true);
	}
	return true;
}
...
bool func_96(var uParam0)
{
	...
	if (!is_sphere_visible(vLocal_35, 1f))
	{
		_set_scenario_group_enabled_hash(iLocal_44, true);
		set_entity_coords(func_8(uParam0, iLocal_23), vLocal_38, true, false, true, true);
		bLocal_47 = true;
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_246(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_191(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_191(uParam0, uParam0->f_1976.f_1), 1, func_255(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_269(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_191(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_236(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_224() == -1)
		{
