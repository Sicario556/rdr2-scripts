...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_152(uParam0, -160658674, vVar0, "LOOTBOX", 1, 0, 1);
	...
	func_152(uParam0, -62869733, 0f, 0f, 0f, "MONEYSTACK", 0, 1, 1);
	func_152(uParam0, -62869733, 0f, 0f, 0f, "MONEYSTACK^1", 0, 1, 1);
	...
	func_155(uParam0, iLocal_16, 3, -1539374245, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_A", iLocal_19, 0);
	func_156(uParam0, iLocal_16, 1, 0, 30, 0, 0);
	func_157(uParam0, iLocal_15, 3, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
...
{
	if (does_entity_exist(func_172(uParam0, iLocal_18)))
	{
		freeze_entity_position(func_172(uParam0, iLocal_18), true);
	}
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_20)
	{
		if (func_197(uParam0, iLocal_14))
		{
			...
			set_anim_scene_origin(&(uParam0->f_1984[iLocal_17]), vLocal_22, vLocal_25, 2);
			task_start_scenario_at_position(func_48(uParam0, iLocal_14), -830507952, vVar1, fVar0, 0, true, false, 0, -1f, false);
			bLocal_20 = true;
		}
	}
	if (bLocal_20 && !bLocal_21)
	{
		if (vdist2(Global_36, vLocal_28) <= 9f)
		{
		...
		if (is_ped_active_in_scenario(func_48(uParam0, iLocal_14), 0))
		{
...
bool func_197(var uParam0, int iParam1)
{
	...
	{
		if (!func_301(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_274(var uParam0, int iParam1)
{
	...
	else if (!func_301(uParam0->f_107[iParam1]->f_5, -76381094))
	{
