					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_is_anim_scene_finished(uParam0->f_3.f_1, false) || _is_anim_scene_active(uParam0->f_3.f_1))
							{
								...
								{
									func_65(uParam0->f_20[1]);
									func_65(uParam0->f_20[0]);
									uParam0->f_469[3] = 1;
									return 1;
								}
							}
...
bool func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_81(&(Global_1898164->f_1[0]));
		if (func_82(iVar0) && func_83((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_84(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_98(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_98(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_99(&(uParam0->f_490)))
							{
...
float func_98(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_126(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_109(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_133(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_133(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_133(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
