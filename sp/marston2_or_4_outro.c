...
void func_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_37(Global_1360165[iParam0], 0);
	...
	else
	{
		...
		{
			func_43(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
bool func_23(var uParam0)
{
	...
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		uParam0->f_2 = _create_anim_scene("cutscene@mar24_ptl", 0, "MAR24_PTL", false, true);
	}
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		return false;
	}
	if (!_is_anim_scene_loading(uParam0->f_2, true) && !_is_anim_scene_loaded(uParam0->f_2, true, false))
	{
	...
	if (!_0x0df57f86fe71dbe5(uParam0->f_2, "MAR24_PTL") && !_0x23e33cb9f4a3f547(uParam0->f_2, "MAR24_PTL"))
	{
		_0xdf7b5144e25cd3fe(uParam0->f_2, "MAR24_PTL");
	}
	if (!_0x23e33cb9f4a3f547(uParam0->f_2, "MAR24_PTL"))
	{
		return false;
	}
	return true;
...
int func_24(var uParam0)
{
	...
	if (func_22(5))
	{
		_set_entity_coords_and_heading(Global_35, -2515.059f, 424.7469f, 146.8438f, 90f, false, false, true);
		_0x513f8aa5bf2f17cf(-2515.059f, 424.7469f, 146.8438f, 20f, 0);
	}
	else
	{
		set_entity_coords(Global_35, func_55(67), true, false, true, true);
	}
	func_56(Global_35);
	iVar0 = 0;
	while (iVar0 < 11)
	...
	if (func_22(5))
	{
		...
		{
			iLocal_17 = create_object(655931573, -2517.9f, 424.8f, 147.9f, true, true, false, false, true);
			if (!is_entity_dead(iLocal_17))
			{
				set_entity_coords(iLocal_17, -2517.9f, 424.8f, 147.9f, true, false, true, true);
				set_entity_rotation(iLocal_17, 0f, 0f, 0f, 2, true);
			}
		}
	}
	if (func_22(2))
...
bool func_26(var uParam0)
{
	...
	switch (iLocal_16)
	{
		case 0:
			if (func_22(5))
			{
				set_anim_scene_entity(uParam0->f_2, "JOHN", Global_35, 0);
				set_anim_scene_entity(uParam0->f_2, "P_CS_SACKCORN01X", iLocal_17, 0);
				_set_anim_scene_playback_list_bool(uParam0->f_2, "MAR24_PTL", true);
		...
		case 1:
			...
			break;
		case 2:
			if (!_does_anim_scene_exist(uParam0->f_2) || _is_anim_scene_finished(uParam0->f_2, false))
			{
...
bool func_50(int iParam0)
{
	...
	{
		return func_89((*Global_1835011)[iParam0]->f_1, 1);
	}
...
void func_61(bool bParam0)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (_is_weapon_two_handed(iVar1) || func_99(iVar1))
			{
...
{
	return (func_103(iParam0) && ((*Global_1898346)[iParam0]->f_1 && iParam1) != 0);
}
...
int func_87(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_37(iVar0, 0))
	{
		if (func_37(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
	...
	{
		if (func_37((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_31(iParam0, 32768, 1))
			{
...
bool func_91(int iParam0)
{
	switch (iParam0)
	{
		case 14:
		case 34:
			return !func_127((*Global_1835011)[iParam0]);
	}
	return false;
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (&Global_40.f_7731[iParam0] >= 7 && !func_139(iParam0))
		{
			return;
		}
	}
...
int func_102(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if ((func_89((*Global_1347702)[59]->f_15, 1) && !func_89((*Global_1347702)[61]->f_15, 1)) && Global_40.f_9052.f_21 & 2 == 0)
	{
		return 0;
	}
	if (func_152(player_id(), 1, 0))
	{
		if ((!does_blip_exist((*Global_1835011)[iParam0]->f_27) && !func_153(iParam0)) && !Global_43891)
		{
			func_155(iParam0, vdist2(func_154(iParam0), Global_36), -1, 1, 1);
			func_156((*Global_1835011)[iParam0], 2);
		}
		return 0;
	}
	if (bParam2)
	{
		if (!func_158(func_157(iParam0), func_64(iParam0), 0, (*Global_1835011)[iParam0]->f_21, iParam3))
		{
			return 0;
		}
		if (func_159(1) > 1)
			...
			if ((get_game_timer() - (*Global_1835011)[iParam0]->f_73) < 60000)
			{
				...
				if ((iParam0 == 15 && Global_1357549->f_1494 & 32768 != 0) && func_162(Global_35, func_161(iParam0), 50f, 1, 1))
				{
					if (!_is_tracked_point_valid((*Global_1835011)[iParam0]->f_72))
					{
						...
						set_tracked_point_info((*Global_1835011)[iParam0]->f_72, func_161(iParam0), 5f);
					}
					if (is_screen_faded_in() && (is_tracked_point_visible((*Global_1835011)[iParam0]->f_72) || is_sphere_visible(func_161(iParam0), 2.5f)))
					{
						return 0;
					}
				}
	...
	iVar0 = func_163((*Global_1835011)[iParam0]->f_1);
	if (!func_103(iVar0))
	{
		return 0;
	}
	...
	if (bParam1)
	{
		func_165((*Global_1835011)[iParam0]->f_1);
	}
...
int func_112(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_173(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_174(iParam0);
	}
...
void func_133(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 39)
	{
		if (func_191(uParam0->f_1[iVar0], 2))
		{
...
void func_134(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_180(32768) && &Global_1946804->f_1378.f_1[10] != &Global_1946804->f_57[10])
	{
		func_200();
	}
...
void func_136()
{
	...
	task_play_anim(Global_35, func_203(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_204(1);
	remove_anim_dict(func_203());
}
...
void func_140(int iParam0)
{
	...
	if ((iParam0 >= 4 && Global_1897952->f_41 != 8) && func_89((*Global_1835011)[4]->f_1, 1))
	{
		func_207(493, 0);
	}
}
...
void func_141(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		bVar2 = (&Global_40.f_7731[iParam0] < 7 && func_139(iParam0));
		Global_40.f_7731[iParam0]->f_3 = func_187();
		func_211(iParam0, &iVar0, &iVar1, bVar2);
		func_212(&(Global_40.f_7731[iParam0]->f_3), 0, 0, iVar1, iVar0, 0, 0, 0);
	}
}
...
int func_155(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_198();
	if ((bParam4 && func_185(&((*Global_1835011)[iParam0]->f_29), 512)) && !func_185(&((*Global_1835011)[iParam0]->f_29), 1024))
	{
		if (func_223())
		{
			return 0;
	...
	if (iVar0 == -1)
	{
		if (iParam0 == 19)
		{
			if ((func_89((*Global_1835011)[20]->f_1, 1) && Global_1879514->f_1 == (*Global_1835011)[20]->f_1) && (get_game_timer() - func_225()) <= 2000)
			{
				return 0;
			}
		}
		...
		{
			if ((func_89((*Global_1835011)[19]->f_1, 1) && Global_1879514->f_1 == (*Global_1835011)[19]->f_1) && (get_game_timer() - func_225()) <= 2000)
			{
				return 0;
			}
		}
		...
		{
			if (!func_89((*Global_1347702)[62]->f_15, 1))
			{
				return 0;
			}
		}
	...
	if (!does_blip_exist((*Global_1835011)[iParam0]->f_27))
	{
		...
		{
			if (bParam3 || func_227((*Global_1835011)[iParam0], 2))
			{
				if (func_91(iParam0))
				{
					(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_92(iParam0));
					bVar2 = true;
				}
				else
				{
					(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_55(iParam0));
				}
			}
			else if (func_91(iParam0))
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_area(1673015813, func_92(iParam0), func_228(iParam0), func_229(iParam0));
				bVar2 = true;
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_radius(1673015813, func_230(iParam0), func_231(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_91(iParam0))
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_154(iParam0));
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_92(iParam0));
		...
		else if (func_153(iParam0))
		{
			if (iParam0 == 7)
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(-1337945352, func_55(iParam0));
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_55(iParam0));
	...
	if (bVar1)
	{
		...
		if (!func_185(&((*Global_1835011)[iParam0]->f_29), 1024) && !func_153(iParam0))
		{
			_blip_set_modifier((*Global_1835011)[iParam0]->f_27, 580546400);
			func_232(&((*Global_1835011)[iParam0]->f_29), 1024);
		}
	}
	if (iVar0 != -1)
	{
	...
	if (func_234(iVar4) && func_235((*Global_1888801)[iVar4]->f_13))
	{
		bVar5 = true;
	...
	{
		func_238((*Global_1835011)[iParam0]->f_1, bVar6, bVar5, iVar4);
	}
	if (iParam0 == 7 && !func_239(579))
	{
		func_240(579, (*Global_1835011)[iParam0]->f_27, 0);
	}
	if (iParam0 == 2)
	{
		return 1;
	}
	if (((((((func_185(&((*Global_1835011)[iParam0]->f_29), 4096) && !func_185(&((*Global_1835011)[iParam0]->f_29), 8192)) && IntToFloat(func_225()) >= 10f) && !Global_1935630->f_12) && !Global_16) && !func_241(Global_35, -2016812721)) && !_is_ped_using_scenario_hash(Global_35, -1054012177)) && !_is_ped_using_scenario_hash(Global_35, 1097070152))
	{
		if (!func_226(iParam0, iVar0) || (fParam1 >= (func_242(iParam0) * func_242(iParam0)) && !(*Global_1835011)[iParam0]->f_70))
		{
			MemCopy(&cVar7, {(*Global_1835011)[iParam0]->f_8}, 2);
			StringConCat(&cVar7, "_FIRST", 16);
			func_243(&cVar7, 10000, 0, 0, 0, 1);
			func_232(&((*Global_1835011)[iParam0]->f_29), 8192);
		}
	}
	return 1;
}
			...
			else
			{
				...
				if (bParam5)
				{
					...
					else
					{
						...
						{
							if (func_256(iVar3) && func_257(&(uParam0->f_1[iVar1]), iVar3, &iVar0))
							{
					...
					if (bVar2)
					{
						...
						{
							func_258(uParam0, &(uParam0->f_1[&Global_1946804->f_2612[iVar1]]), &(Global_1946804->f_2612[iVar1]), 0, 0);
							iVar1++;
						}
					}
					if (bParam4)
...
void func_183(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_195(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_260(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
{
	return ((Global_1946804->f_57[func_255(iParam0, 1)])->f_10 && iParam1) != 0;
}

void func_196(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_255(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_255(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_255(iParam0, 1)])->f_10 && iParam1));
}

void func_197(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_255(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_255(iParam0, 1)])->f_10 || iParam1);
}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_195(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_269(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_206(struct<4> Param0)
{
	...
	if (func_213(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_213(20))
			{
				return;
			}
			iVar0++;
...
bool func_224(int iParam0)
{
	...
	{
		case 18:
			return func_89((*Global_1347702)[21]->f_15, 1);
		case 44:
			return func_89((*Global_1347702)[83]->f_15, 1);
	}
	return true;
}
...
bool func_236(int iParam0)
{
	if (!func_285(Global_40.f_4283))
	{
		...
		if (func_286(iParam0))
		{
			if (vdist(Global_36, func_287(iParam0)) < vdist(Global_36, (*Global_1888801)[iParam0]->f_15))
			{
				return get_distance_between_coords(Global_36, func_287(iParam0), false) <= func_288();
			}
		}
		return get_distance_between_coords(Global_36, (*Global_1888801)[iParam0]->f_15, false) <= func_288();
	}
	return func_289();
}
...
void func_238(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	switch (func_290(iParam0))
	{
		case 1:
			...
			{
				if ((func_226(iVar0, -1) && !(*Global_1835011)[iVar0]->f_70) && (*Global_1835011)[iVar0]->f_63 & 2 == 0)
				{
					iVar2 = 1986697381;
				}
				else
			...
			else if ((func_226(iVar0, -1) && !(*Global_1835011)[iVar0]->f_70) && (*Global_1835011)[iVar0]->f_63 & 2 == 0)
			{
				iVar2 = -1559907306;
			}
			else
			...
			if ((*Global_1835011)[iVar0]->f_28 != iVar2)
			{
				...
				if (func_227((*Global_1835011)[iVar0], 2))
				{
...
bool func_244(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_298(iVar0) && func_247((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_249(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			_0xca41e86545413b5b(func_290(iParam0), func_291(iParam0), func_301(iParam0), func_300(iParam0), Global_36);
		}
	}
	func_302(iParam0, 1);
	bParam1 = bParam1;
...
void func_250(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_303(Global_1898330[iParam0]);
...
{
	iVar1 = 12;
	iVar2 = func_305(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_193(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_305(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_308(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_305(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_309(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_308(&(Global_1946804->f_1497.f_1[iVar1])) || func_309(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_305(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_305(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_305(&(uParam0->f_1[iVar1])) || func_309(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	if (iParam0 == &Global_1946804->f_57[func_255(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_275(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_318(to_float(*uParam0), fVar3);
	iVar1 = func_319(to_float(*uParam1), fVar3);
	iVar2 = func_320(to_float(*uParam2), fVar3);
...
bool func_306(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_255(iParam0, 1)] != &Global_1946804->f_57[func_255(iParam0, 1)];
}
...
void func_311(var uParam0, int iParam1)
{
	if (func_198() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_337(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_338(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
