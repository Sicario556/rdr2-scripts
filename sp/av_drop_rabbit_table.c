...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 1, "RABBIT", -541762431, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
bool func_28(var uParam0)
{
	...
	{
		_0x6569f31a01b4c097(&(uParam0->f_20[1]), 0, 0);
		_0x6569f31a01b4c097(&(uParam0->f_20[1]), 1, 0);
...
{
	vVar0 = { _get_object_offset_from_coords(uParam0->f_483, uParam0->f_486.f_2, 1.3375f, -0.4125f, 0.85f) };
	iLocal_37 = _create_volume_by_hash(-1612834106, vVar0, uParam0->f_486, 2.2825f, 2.6175f, 2.0875f);
	func_58(&uLocal_9, 0);
	func_59(&uLocal_9, 1);
	func_60(&uLocal_9, 1);
	func_61(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		{
			if (func_65(&(uParam0->f_20[0]), 0, &uLocal_9, &uVar0, 0, 0))
			{
				_delete_anim_scene(uParam0->f_3.f_1);
				activate_physics(&(uParam0->f_20[1]));
				set_ped_to_ragdoll(&(uParam0->f_20[1]), 1000, 4500, 0, false, true, false);
				func_66(uParam0);
				if (!&uParam0->f_469[2])
				{
	...
	if (&uParam0->f_469[1])
	{
		if (!&uParam0->f_469[2])
		{
			if (func_71(uParam0, 1.2f, 1116471296, 4, -91962372, 1))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[2] = 1;
			}
	...
	if (&uParam0->f_469[1])
	{
		...
		if (does_entity_exist(&(uParam0->f_20[0])))
		{
			...
			{
				task_wander_standard(&(uParam0->f_20[0]), get_entity_heading(&(uParam0->f_20[0])), 1);
...
int func_70(var uParam0)
{
	...
	if (!_0xa9016536015de29d(iVar0, sVar1))
	{
		return 0;
	}
...
bool func_76(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_150(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_77(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_132(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_206(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
