...
{
	func_33(uParam0, 10942, 11001, 12073);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_13 == 1)
		{
			if (func_64(uParam0, &uLocal_19, 1) || func_65(Global_35, &(uParam0->f_20[0]), 1) <= 625f)
			{
				bLocal_13 = true;
			}
		}
		if (bLocal_13)
		{
			if ((!has_anim_event_fired(&(uParam0->f_20[0]), 725039534) || is_entity_dead(&(uParam0->f_20[1]))) || is_entity_dead(&(uParam0->f_20[0])))
			{
	...
	if (!&uParam0->f_469[0] && !bLocal_13)
	{
		switch (iLocal_18)
		{
			case 0:
							...
							if (!&uParam0->f_469[6])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
								{
									if (!is_entity_dead(&(uParam0->f_20[1])))
									{
										...
										force_ped_motion_state(&(uParam0->f_20[1]), -1115154469, false, 0, false);
							...
							if (!&uParam0->f_469[5])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
								{
									if (!is_entity_dead(&(uParam0->f_20[0])))
									{
										...
										task_follow_to_offset_of_entity(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0f, 5f, 0f, 2f, 7500, 1036831949, 1, 1, 0, 1, 1);
				...
				break;
			case 1:
				if (!func_74(&(uParam0->f_20[0]), 1056466932))
				{
...
bool func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_90(&(Global_1898164->f_1[0]));
		if (func_91(iVar0) && func_92((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_64(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_103(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
void func_70(var uParam0)
{
	if (*uParam0 == 247)
	{
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			if (func_65(&(uParam0->f_20[0]), Global_35, 1) <= 3600f)
			{
				if (!func_74(&(uParam0->f_20[0]), 780511057))
				{
			...
			else if (!func_74(&(uParam0->f_20[0]), 518218985))
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[0]), Global_35, 4, 256, -1082130432, -1, 0);
				func_56(uParam0->f_20[0], 0, 1);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
		}
	}
	else if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (!func_74(&(uParam0->f_20[0]), 518218985))
		{
	...
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (!func_74(&(uParam0->f_20[1]), 518218985))
		{
