		...
		if (get_game_timer() > iLocal_18)
		{
			...
			switch (iLocal_17)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_19));
					...
					Global_1897950 = -1;
					iLocal_20 = (get_game_timer() + iLocal_16);
					iLocal_17 = 2;
					break;
				case 2:
					if (func_11() || iLocal_20 < get_game_timer())
					{
						func_12(iLocal_19);
						iLocal_20 = (get_game_timer() + iLocal_16);
						iLocal_17 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_19) || iLocal_20 < get_game_timer())
					{
						func_14(iLocal_19);
						iLocal_20 = (get_game_timer() + iLocal_16);
						iLocal_17 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_19) || iLocal_20 < get_game_timer())
					{
						func_16(iLocal_19);
						iLocal_20 = (iLocal_16 + get_game_timer());
						iLocal_17 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_19)))
					{
						if (func_17(func_6(iLocal_19), 4) && !iLocal_20 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_19) || iLocal_20 < get_game_timer())
							{
								func_19(iLocal_19, 4);
								iLocal_20 = (iLocal_16 + get_game_timer());
								iLocal_17 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_20 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_19);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_19]->f_10);
							if ((*Global_1888801)[iLocal_19]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_19]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_19]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_19]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(-1816.485f, 658.493f, 131.7874f, 0f, 0f, 0f, 8f, 8f, 5f, "Watson's Cabin - m_volWatsCats");
	iVar0 = _create_popzone_from_volume(iLocal_14);
	set_popzone_population_set(iVar0, -1481802551);
	_0x7e6bc0b94f5928f0(iVar0, 1, 1);
...
void func_25()
{
	...
	{
		_set_scenario_group_enabled_hash(63385776, false);
	}
	else
	{
		_set_scenario_group_enabled_hash(63385776, true);
	}
	if (func_50(7, 2048))
	{
...
void func_52(int iParam0)
{
	...
	{
		case 1:
			_set_scenario_group_enabled_hash(-1445320383, false);
			_set_scenario_group_enabled_hash(1296607096, false);
			_set_scenario_group_enabled_hash(-1397600367, false);
			_set_scenario_group_enabled_hash(-680744572, false);
			break;
		case 2:
			func_93(0, 0, 0);
			break;
		case 4:
			...
			break;
		case 7:
			_set_scenario_group_enabled_hash(-238326824, false);
			_set_scenario_group_enabled_hash(-1565410059, false);
			break;
	}
}
...
bool func_61(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_103(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_117(&cVar6, 109029619), sVar9, func_117(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_117(&cVar6, 109029619), func_117(&cVar10, 109029619));
		}
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_139(iParam0, _create_persistent_character(func_138(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_140(iParam0));
				func_141(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_140(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_140(iParam0)))
	{
		func_141(iParam0, 128);
		return 1;
	}
	func_139(iParam0, _create_persistent_character(func_138(iParam0)));
	_0x4f81ead1de8fa19b(func_140(iParam0));
	if (func_136(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_140(iParam0));
		func_141(iParam0, 2048);
...
{
	_set_scenario_group_enabled_hash(-679485167, bParam0);
	_set_scenario_group_enabled_hash(-1060286981, bParam1);
	_set_scenario_group_enabled_hash(15009085, bParam2);
	_set_scenario_group_enabled_hash(419499196, bParam0);
	_set_scenario_group_enabled_hash(-812521832, bParam1);
	_set_scenario_group_enabled_hash(352847158, bParam2);
	_set_scenario_group_enabled_hash(-938921064, bParam0);
	_set_scenario_group_enabled_hash(1294886761, bParam1);
	_set_scenario_group_enabled_hash(1503785868, bParam2);
	_set_scenario_group_enabled_hash(-1566272590, bParam0);
	_set_scenario_group_enabled_hash(-663317585, bParam1);
	_set_scenario_group_enabled_hash(1025159823, bParam2);
	_set_scenario_group_enabled_hash(870756084, bParam3);
	_set_scenario_group_enabled_hash(1973927826, bParam3);
	_set_scenario_group_enabled_hash(-1758360527, bParam3);
	_set_scenario_group_enabled_hash(629800007, bParam3);
	_set_scenario_group_enabled_hash(6786354, bParam3);
}

void func_95(int iParam0)
{
	func_144(iParam0, 4);
	func_146(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_145(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_145(iParam0));
	}
}
...
char* func_117(char* sParam0, int iParam1)
{
	...
	return func_161(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_120(int iParam0)
{
	...
	if (func_162())
	{
		if (!func_163((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_167(Global_1935369->f_5[iParam0]->f_6, 1);
	func_168(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_85(Global_1914319->f_3[iParam0]->f_21) && func_170(Global_1914319->f_3[iParam0]->f_21))
	{
		func_171(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_172(Global_1914319->f_3[iParam0]->f_10, 0);
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_179(iParam0);
	_0xfc77c5b44d5ff7c0(func_140(iParam0));
	func_139(iParam0, 0);
	return 1;
}
...
bool func_150(int iParam0)
{
	...
	return func_186((*Global_1347702)[iParam0]->f_15);
}
...
bool func_155(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_188(&(Global_1898164->f_1[0]));
		if (func_184(iVar0) && func_189((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
var func_156(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_195(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
bool func_191(vector3 vParam0, int iParam3)
{
