...
bool func_27(int iParam0)
{
	...
	if (func_90(func_123(iParam0)))
	{
		...
		if (!is_string_null_or_empty(&vVar0))
		{
			...
			if (!func_90(vVar3))
			{
				if (get_distance_between_coords(vVar3, func_125(*iParam0), true) >= 10f)
				{
...
{
	if (does_entity_exist(&(uLocal_16[1])) && does_entity_belong_to_this_script(&(uLocal_16[1]), true))
	{
		set_object_as_no_longer_needed(uLocal_16[1]);
	}
	if (does_entity_exist(&(uLocal_16[2])) && does_entity_belong_to_this_script(&(uLocal_16[2]), true))
	{
		set_object_as_no_longer_needed(uLocal_16[2]);
	}
	if (!func_5(iParam0, 4096))
	{
		func_161(710);
		if (does_entity_exist(&(uLocal_16[0])))
		{
			set_object_as_no_longer_needed(uLocal_16[0]);
		}
	}
	return true;
}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_176(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_176(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_74(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_172(&(Global_1898164->f_1[0]));
		if (func_183(iVar0) && func_184((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_170(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	{
		if ((fVar3 >= func_188(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_189();
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_202("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_205(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_205(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_203(uParam0->f_501, 128))
		{
			func_204();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_93(1, 0);
	func_190(uParam0);
	if (func_218() && _0x6f1f0b17109309da(uParam0->f_444, func_205(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_222(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_236(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_244();
	set_entity_invincible(Global_35, func_203(*uParam0, 8));
...
void func_109(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_248(iVar0), func_249(), 1))
			{
...
Vector3 func_124(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_205(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
bool func_127(int iParam0)
{
	...
	if (!func_265(uLocal_16[0], 560218013, -2608.021f, 369.9691f, 147.5059f, 90f, 90f, 0f, 1))
	{
		return false;
	}
	if (!func_265(uLocal_16[1], 1547859810, -2587.238f, 500.5319f, 142.8107f, 0f, 0f, 358.1677f, 1))
	{
		return false;
	}
	if (!func_265(uLocal_16[2], 2011276918, -2583.69f, 501.4f, 142.62f, 120f, 89.97f, -170f, 1))
	{
		return false;
	}
	func_266(uLocal_14[0]);
	func_267(&(uLocal_14[0]), 41788943);
	if (func_268(63))
	{
...
bool func_134(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_248(iVar0));
...
char* func_138(int iParam0)
{
	...
	{
		return func_205(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_287(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_288(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_139(var uParam0)
{
	...
	*uParam0 = 0;
	...
	if (func_293((*Global_1835011)[67]->f_1, 1) || func_294(-285172118, 1))
	{
		return;
	}
	if (func_293((*Global_1835011)[65]->f_1, 1) || func_293((*Global_1835011)[66]->f_1, 1))
	{
		*uParam0 = 1;
		if (func_293((*Global_1835011)[65]->f_1, 1))
		{
			iVar0 = 18;
			uParam0->f_1 = 81;
			*uParam0 |= 24;
		}
		else if (func_293((*Global_1835011)[66]->f_1, 1))
		{
			uParam0->f_1 = 81;
			*uParam0 |= 6;
		}
	}
	else if (func_293((*Global_1835011)[64]->f_1, 1))
	{
		uParam0->f_1 = 73;
		*uParam0 |= 1;
	}
	else if (func_293((*Global_1835011)[62]->f_1, 1) || func_293((*Global_1835011)[63]->f_1, 1))
	{
		if (func_293((*Global_1835011)[62]->f_1, 1))
		{
			*uParam0 |= 4;
		}
		else
	...
	else if (func_293((*Global_1835011)[61]->f_1, 1))
	{
		*uParam0 = 24;
		uParam0->f_1 = 77;
	}
...
void func_140(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_297(), true);
	}
}
...
int func_152(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_210(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
int func_154(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_292(get_player_index(), 0, 0, 1);
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_322(uParam0, uParam0->f_1684))
				{
					...
					{
						func_324(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_318(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_109(2);
				func_324(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_156(int iParam0)
{
	...
	if (vdist2(func_176(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
...
int func_157(int iParam0)
{
	...
	{
		if (vdist2(func_176(*iParam0), Global_36) < (10f * 10f))
		{
			func_25(iParam0, 8388608);
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_176(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
			if (func_344(Global_35, &(iParam0->f_421), 0, 256, iVar1, 1084227584, 100, 0, 0))
			{
				set_player_control(get_player_index(), true, 0, false);
			}
		}
	...
	else if (vdist2(func_176(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return 1;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_176(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
int func_161(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_313(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_313(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_313(iParam0));
	...
	_0x7b204f88f6c3d287(func_313(iParam0));
	return 1;
}
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_351((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_351((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_352(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_165(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_354((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_356((*uParam1)[iVar0]))
		{
			if (func_354((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_357((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_358((*uParam2)[iVar0]))
		{
			if (func_354((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_359((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_360((*uParam3)[iVar0]))
		{
			if (func_354((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_361((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_363((*uParam5)[iVar0]))
		{
			if (func_354((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_364((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_363((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_365((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_354((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_366((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_367((*uParam6)[iVar0]))
		{
			if (func_354((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_368((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_369((*uParam7)[iVar0]))
		{
			if (func_354((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_370((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_371((*uParam8)[iVar0]))
		{
			if (func_354((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_372((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_373((*uParam9)[iVar0]))
		{
			if (func_354((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_374((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_375((*uParam10)[iVar0]))
		{
			if (func_354((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_376((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_377((*uParam11)[iVar0]))
		{
			if (func_354((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_378((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_179(int iParam0, int iParam1)
{
	...
	func_387(iParam1);
	StringCopy(&cVar0, func_175(), 64);
	func_388(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_185(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_389(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_195(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_393(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_175());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
...
void func_220(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_236(uParam0->f_13[iVar0], 2))
		{
			if (func_236(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				...
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					...
					if (iVar1 != Global_35 && !func_236(uParam0->f_13[iVar0], 16))
					{
						func_411(iVar1);
					}
				}
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_236(uParam0->f_13[iVar0], 8))
					{
...
int func_258(var uParam0, int iParam1)
{
	...
	if (func_303(uParam0, 8) && _0xdd0b7c5ae58f721d(func_465()))
	{
...
void func_266(var uParam0)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		if (!does_entity_belong_to_this_script(*uParam0, true))
		{
...
bool func_268(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_293((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_353((*uParam0)[iVar1]))
		{
			if (func_354((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_356((*uParam1)[iVar1]))
		{
			if (func_354((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_358((*uParam2)[iVar1]))
		{
			if (func_354((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		if (func_360((*uParam3)[iVar1]))
		{
			if (func_354((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_363((*uParam5)[iVar1]))
		{
			if (func_354((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_354((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_493((*uParam5)[iVar1]))
				{
					if (func_494((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_365((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_367((*uParam6)[iVar1]))
		{
			if (func_354((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_369((*uParam7)[iVar1]))
		{
			if (func_354((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_371((*uParam8)[iVar1]))
		{
			if (func_354((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_373((*uParam9)[iVar1]))
		{
			if (func_354((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_375((*uParam10)[iVar1]))
		{
			if (func_354((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_377((*uParam11)[iVar1]))
		{
			if (func_354((*uParam11)[iVar1]->f_2, iParam12))
			{
...
bool func_296()
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (_is_weapon_two_handed(iVar1) || func_522(iVar1))
			{
				return true;
			}
		}
...
int func_314(int iParam0, bool bParam1)
{
	...
	func_310(iParam0);
	_0xfc77c5b44d5ff7c0(func_313(iParam0));
	func_527(iParam0, 0);
	return 1;
}
...
void func_316(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_528(1));
		if (!has_anim_dict_loaded(func_528(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_317(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		fVar4 = func_187(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_324(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_533(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_148(uParam0, 4);
			...
			if (func_344(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_302(uParam0, 4);
...
void func_325(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_330(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_540(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_540(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_542(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_542(uParam0->f_1345[iVar0]->f_1, 8))
				{
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_542(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_544(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							...
							bVar29 = func_542(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_542(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_542(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_546(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_546(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
bool func_338(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_187(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_339(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_187(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_564(uParam0)) && _is_anim_scene_started(func_564(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_564(uParam0));
				bVar1 = _is_anim_scene_finished(func_564(uParam0), false);
				bVar2 = _is_anim_scene_active(func_564(uParam0));
...
int func_342(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_565(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
bool func_344(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_283(*iParam1, 2))
	{
		...
		else if ((func_568(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_568(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_568(iParam2, 1024))) || func_568(iParam2, 8)) && !func_283(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_569(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_568(iParam2, 4096)) && !func_283(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_569(iParam1, 2048);
			func_569(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_568(iParam2, 32)) && !func_283(*iParam1, 5632))
		{
...
void func_352(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_136(Global_1360165[iParam0], 0);
	...
	else
	{
		...
		{
			func_241(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
void func_364(var uParam0)
{
	if (!func_588(uParam0->f_2, 1))
	{
		if (func_493(uParam0))
		{
			...
			{
				sVar0 = func_398(get_entity_model(Global_35));
...
void func_390(struct<4> Param0)
{
	...
	if (func_600(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_600(20))
			{
				return;
			}
			iVar0++;
...
void func_419()
{
	...
	if (func_433(iVar0))
	{
		...
		{
			func_615(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_430(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_619(Global_35) && is_player_teleport_active())
	{
	}
	if (func_620(iParam0))
	{
		if (func_621(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_283(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_283(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_283(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_283(iParam5, 32), true);
	...
	else if (func_283(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_283(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_283(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
struct<5> func_448(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_624(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_627(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_627(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_628(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_451(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_638(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_638(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_640(iParam0, iParam2, iParam1, func_247() != -1);
	if (bParam4)
	{
...
int func_470(int iParam0, bool bParam1)
{
	...
	{
		func_527(iParam0, _create_persistent_character(func_311(iParam0)));
		if (func_247() == -1)
		{
			if (func_306(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_313(iParam0));
				func_309(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_313(iParam0));
		}
		return 0;
	}
	...
	func_527(iParam0, _create_persistent_character(func_311(iParam0)));
	_0x4f81ead1de8fa19b(func_313(iParam0));
	if (func_306(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_313(iParam0));
		func_309(iParam0, 2048);
...
int func_471(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_307(iParam0)) && !is_entity_dead(iVar0))
	{
...
void func_483()
{
	...
	task_play_anim(Global_35, func_659(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_645(1);
	remove_anim_dict(func_659());
}
...
void func_486(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_437(32768) && &Global_1946804->f_1378.f_1[10] != &Global_1946804->f_57[10])
	{
		func_454();
	}
		...
		case 0:
			...
			if (func_255(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_352(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
				else if (func_136(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_136(Global_1360165[iParam0], 0))
			{
...
void func_509(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_160() || !_0x6f1f0b17109309da(Global_43800, func_205(iParam0))))
	{
...
void func_529(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_546(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_530(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_187(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_187(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_187(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_688(512) || func_689(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				if (func_690(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_324(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
				...
				else if (func_693(uParam0->f_1633[iVar2]) != 0)
				{
					func_692(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_524(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_187(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_690(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
						if (func_344(Global_35, &(uParam0->f_1687), iVar4, 0, 0, 1084227584, 100, 0, 0))
						{
							set_player_control(get_player_index(), true, 0, false);
							uParam0->f_1687 = 0;
							func_302(uParam0, 33554432);
...
float func_533(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_694(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_534(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_697(uParam0, iVar0)) && !func_463(uParam0->f_1016[iVar0], 1))
			{
				if (!func_698(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_699(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
...
bool func_548(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_694(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_565(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_565(uParam0->f_475[iParam1], 64) && func_703(uParam0, iParam1, 0))
				{
		...
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					if ((func_565(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
...
int func_551(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_323(uParam0) != 11) && func_322(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_205(Global_35)))
		{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_699(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_553(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_323(uParam0))
	{
		case 0:
			...
			if (((!func_304(uParam0->f_1016[iVar2], 32) && func_708()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_304(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			if (func_344(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4))
			{
				func_709(uParam0);
			}
		...
		case 4:
			...
			if ((func_304(uParam0->f_1016[iVar2], 256) || !func_413(&uVar5)) || bVar0)
			{
				if (func_713())
				{
					func_714();
		...
		case 8:
			...
			if (func_344(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4) || bVar0)
			{
				uParam0->f_1686 = 0;
		...
		if (func_718(uParam0, 0))
		{
			if (func_719(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					{
						uParam0->f_1016[iVar16]->f_30 = { func_392() };
					}
...
void func_560(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_620(uParam0->f_3[iVar0]->f_2)) && func_433(uParam0->f_3[iVar0]->f_10)) && !func_727(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_522(uParam0->f_3[iVar0]->f_10))
					{
...
void func_574(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_743(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_575(int iParam0, int iParam1, bool bParam2)
{
	...
	func_744(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
{
	return func_457(1328661203, func_762(), -1591664384, bParam0);
}
...
int func_634(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_633(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_769(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_415(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_633(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_769(&(Global_1946804->f_1497.f_1[iVar1])) || func_633(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_415(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_415(&(uParam0->f_1[iVar1])) || func_633(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_641(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_773(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_642(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_775(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_247() == -1)
	{
...
{
	iVar0 = func_248(iParam0);
	if (!func_113(iParam0) || is_entity_dead(iVar0))
	{
		return;
	}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_467((*Global_1360165)[iParam0]->f_4.f_2) || func_315((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_673(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_615(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_615(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
{
	switch (func_693(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_524(uParam0->f_1633[iParam1]->f_10, 256))
			{
				...
				{
					func_712(uParam0->f_1903, 0);
					func_813(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_524(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_814())
				{
					func_813(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_696(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_270(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
void func_701(int iParam0, float fParam1)
{
	...
	if (!(func_820(17) && func_187(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_706(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_205(Global_35), &vVar7, false, 0, 2))
				{
			...
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_205(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
			...
			if (func_565(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_318(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_304(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_304(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_462(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_205(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_304(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_205(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_822(uParam0, 0);
				}
			}
...
bool func_707(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_565(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_709(var uParam0)
{
	if (!uParam0->f_1897)
	{
		...
		if (!func_304(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_433(func_432(Global_35, 0, 1, 0)) && !func_433(func_432(Global_35, 1, 1, 0))))
		{
			if (func_322(uParam0, uParam0->f_1684))
			{
				func_823(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_304(uParam0->f_1016[uParam0->f_1684], 16) && (func_433(func_432(Global_35, 0, 1, 0)) || func_433(func_432(Global_35, 1, 1, 0))))
	{
	...
	else if ((!func_322(uParam0, uParam0->f_1684) && !func_330(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_562(uParam0, 3);
	}
...
void func_710(var uParam0, int iParam1, bool bParam2)
{
	...
	func_822(uParam0, func_542(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_825(uParam0, &(uParam0->f_475[iParam1])))
		{
	...
	if (func_565(uParam0->f_475[iParam1], 16))
	{
		func_826(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_715(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_833(iVar0));
		iVar0++;
	}
}
...
bool func_726(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_398(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_518(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_398(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_398(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_518(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_518(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_733(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_346(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_565(uParam0->f_475[iVar0], 512)) || func_565(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
		...
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_727(uParam0->f_3[iVar0]->f_1))
				{
					if (func_592())
					{
						StringCopy(&cVar1, func_398(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_398(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_737(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_812(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_742(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_834(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_752(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_136(iVar0, 0))
	{
		if (func_136(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_749(iParam0)) || func_750(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_837(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_839(iParam0);
					_0x7b204f88f6c3d287(func_840(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_840(iParam0, 0));
					func_841(iParam0);
				}
			}
			else
	...
	{
		if (func_136((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_255(iParam0, 32768, 1))
			{
		...
		while (iVar28 < 4)
		{
			...
			if (func_627(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_845(0))
				{
					...
					func_846(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_761(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_849("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_848(iParam1, 512) && func_764(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_522(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_848(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_848(iParam1, 4))) && (!func_522(Var4.f_4) || func_848(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_848(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_848(iParam1, 1048576)))
				{
...
void func_765(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_854(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_854(uParam0->f_2[iVar0], 1))
				{
					func_855(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_775(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_247() == -1)
	{
		func_858(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_859(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_780()
{
	...
	func_869(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_781()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_869(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_782()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_869(1, round((to_float(iVar8) * fVar10)), 0);
...
bool func_784(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_313(iParam0));
}
			...
			else
			{
				...
				if (bParam5)
				{
					...
					else
					{
						...
						{
							if (func_877(iVar3) && func_772(&(uParam0->f_1[iVar1]), iVar3, &iVar0))
							{
					...
					if (bVar2)
					{
						...
						{
							func_639(uParam0, &(uParam0->f_1[&Global_1946804->f_2612[iVar1]]), &(Global_1946804->f_2612[iVar1]), 0, 0);
							iVar1++;
						}
					}
					if (bParam4)
...
int func_792(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_293((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_293((*Global_1347702)[63]->f_15, 1) || func_315((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_293((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_293((*Global_1347702)[134]->f_15, 1) || func_315((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_293((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_294(747937920, 1) && !func_293((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
bool func_817(var uParam0, int iParam1)
{
	...
	if ((func_433(func_735(Global_35, 0, 0, 0)) && !func_304(uParam0->f_1016[iParam1], 16)) && !func_304(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_822(var uParam0, bool bParam1)
{
	...
	if ((func_318(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_304(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_462(uParam0, 64);
	}
...
{
	if (func_565(uParam0->f_475[iParam1], 32))
	{
...
bool func_825(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_205(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_205(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
void func_828(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		...
		if (func_565(uParam0->f_475[iParam1], 256))
		{
...
float func_837(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_222(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_838(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_900(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_840(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_901(iParam0);
	}
...
void func_847(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_904(_get_weapon_clip_size(iParam0), iParam1);
...
void func_860(var uParam0, int iParam1)
{
	if (func_247() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_858(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_859(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_876(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 39)
	{
		if (func_908(uParam0->f_1[iVar0], 2))
		{
...
int func_916()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_522(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_522(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
