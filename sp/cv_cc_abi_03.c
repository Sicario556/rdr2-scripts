...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_153(uParam0, 663716280, 0f, 0f, 0f, "BROOM", 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, 704531824, 0, -1, 0, -1073741824, 1065353216, 1);
...
{
	return absf((uParam0->f_23.f_2 - Global_36.f_2)) <= 6f;
}
...
void func_207(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_200(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_394((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
