void __EntryFunction__()
{
	...
	Var0 = Local_41;
	Var0.f_1 = Local_41.f_11;
	Var0.f_483 = { Local_41.f_1 };
	Var0.f_486 = { Local_41.f_4 };
	Var0.f_489 = Local_41.f_7;
	Var0.f_20[0] = Local_41.f_8;
	Var0.f_453 = Local_41.f_9;
	Var0.f_500 = Local_41.f_10;
	Var0.f_503 = Local_41.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "DOG1", 1088428104, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "DOG2", 626176009, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
{
	if (!_has_scenario_type_loaded(825624686, false))
	{
		return 0;
	}
	return 1;
...
{
	_request_scenario_type(825624686, 1, 0, 0);
	func_56(&uLocal_9, 0);
	func_57(&uLocal_9, 1);
	func_58(&uLocal_9, 1);
	func_59(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (bLocal_37)
		{
			...
			if (!&uParam0->f_469[6])
			{
				if (func_67(uParam0, 3f, 50f, 4, -91962372, 1))
				{
					...
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								_0xf9cbd46433e36713(Global_35, &(uParam0->f_20[0]), 0f, 0f, 0f, 10f, 20f, 80f, 20f, "DOGS_PLAYING");
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
							}
							...
							if (!&uParam0->f_469[4])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
								{
									if (!is_entity_dead(&(uParam0->f_20[0])))
									{
										...
										task_wander_in_area(&(uParam0->f_20[0]), uParam0->f_20[0]->f_5, 10f, 1077936128, 1086324736, 0);
							...
							if (!&uParam0->f_469[5])
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
								{
									if (!is_entity_dead(&(uParam0->f_20[1])))
									{
										...
										if (does_script_with_name_hash_exist(-777113702) && _get_number_of_references_of_script_with_name_hash(-777113702) > 0)
										{
											set_ped_config_flag(&(uParam0->f_20[1]), 288, true);
...
int func_32(var uParam0, var uParam1)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		_0x45fea6d5539bd474(&(uParam0->f_20[0]), 0);
		_0xe37acee15ac50c7e(&(uParam0->f_20[0]), 0);
	}
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
...
bool func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_88(&(Global_1898164->f_1[0]));
		if (func_89(iVar0) && func_90((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_63(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_101(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_106(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
...
void func_69(var uParam0)
{
	...
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (!func_113(&(uParam0->f_20[1]), 518218985))
		{
