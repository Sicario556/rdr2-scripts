...
{
	func_169(Global_1935369->f_5[iParam0]->f_6, 1);
	func_170(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_96(Global_1914319->f_3[iParam0]->f_21) && func_172(Global_1914319->f_3[iParam0]->f_21))
	{
		func_173(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_174(Global_1914319->f_3[iParam0]->f_10, 0);
...
{
	func_205(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
