...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(207.2673f, 990.9026f, 190.0828f, 0f, 0f, 0f, 28.40839f, 27.79798f, 6.675867f, "volDeborahWorkingAudio");
	return true;
}
...
bool func_38(int iParam0)
{
	if (func_20() == -1)
	{
		if (func_52(Global_35, iLocal_14, 1, 0))
		{
			if (!bLocal_15)
			{
				if (load_stream("DINO_MIDSTAGE", "267765497_leadin_front"))
				{
					bLocal_15 = true;
				}
				return false;
			...
			if (func_53(39) && !func_54(4))
			{
				if (bLocal_16)
				{
					if (is_ped_shooting(Global_35))
					{
						if (!bLocal_17)
						{
							set_ambient_zone_state_persistent("AZ_Dino_Lady_Working_In_Barn", false, true);
							if (is_stream_playing(_0x0556c784fa056628("DINO_MIDSTAGE", "267765497_leadin_front")))
							{
								stop_stream(_0x0556c784fa056628("DINO_MIDSTAGE", "267765497_leadin_front"));
							}
							bLocal_17 = true;
						}
					}
					...
					{
						set_ambient_zone_state_persistent("AZ_Dino_Lady_Working_In_Barn", true, true);
						bLocal_17 = false;
					}
				}
				if (!func_55())
				{
					...
					{
						set_ambient_zone_state_persistent("AZ_Dino_Lady_Working_In_Barn", true, true);
						play_stream_from_position((*Global_1347702)[40]->f_24, _0x0556c784fa056628("DINO_MIDSTAGE", "267765497_leadin_front"));
						bLocal_16 = true;
...
bool func_53(int iParam0)
{
	...
	return func_94((*Global_1347702)[iParam0]->f_15, 1);
}
...
int func_56(int iParam0)
{
	...
	return (*Global_1347702)[iParam0]->f_15;
}
...
void func_83(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_132(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
char* func_102(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_143(Global_1894899->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_145(func_144(Global_36));
	}
...
bool func_117(int iParam0)
{
	...
	if (func_149())
	{
		if (!func_94((*Global_1835011)[3]->f_1, 1))
		{
...
{
	if (func_89(Global_1914319->f_3[iParam0]->f_21) && func_156(Global_1914319->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_132(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_142(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_93(iVar0) && func_170((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
var func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_174(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
