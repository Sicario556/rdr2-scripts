...
{
	iVar0 = 1;
	if (!_is_anim_scene_loaded(iLocal_9, true, false))
	{
		iVar0 = 0;
	}
	...
	if (does_entity_exist(iLocal_11) && !func_22(13, iLocal_11, -2040275819))
	{
		iVar0 = 0;
	}
	return iVar0;
...
{
	iLocal_9 = _create_anim_scene("script@vignette@beecher@wnt@abigail_gen_3@action", 0, 0, false, true);
	load_anim_scene(iLocal_9);
	iLocal_10 = _create_anim_scene("script@story@fin3@wnt_camera", 0, 0, false, true);
	load_anim_scene(iLocal_10);
	uLocal_58[0] = _0x0eb78c2b156635b1(665633627, -1555.683f, -1417.174f, 90.1822f, 0f, 0f, -19.67098f, 2.626542f, 18.71136f, 3.681293f);
	uLocal_58[1] = _0x0eb78c2b156635b1(665633627, -1558.386f, -1430.378f, 93.68977f, 0f, 0f, -29.25712f, 1.25935f, 3.725714f, 1.587422f);
	uLocal_58[2] = _0x0eb78c2b156635b1(665633627, -1560.36f, -1436.362f, 93.68977f, 0f, 0f, -2.146133f, 1f, 3.464732f, 1.587422f);
	uLocal_58[3] = _0x0eb78c2b156635b1(665633627, -1572.138f, -1442.667f, 90.88407f, 0f, 0f, 126.3318f, 3.18645f, 15.24051f, 4.382712f);
	_text_database_request("bawg3au");
}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_32(iParam0, 16, 1))
			{
				...
				else if (func_38(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_38(Global_1360165[iParam0], 0))
			{
		...
		case 1:
			...
			if (func_51(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_50(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_54(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_55(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_57(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_38(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_59(Global_1360165[iParam0], 1);
				}
			}
			func_50(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_60(Global_1360165[iParam0]))
				{
				}
			}
			func_61(iParam0, Global_1360165[iParam0]);
...
{
	if (!is_entity_dead(iParam1) && !&iLocal_12[iParam0])
	{
...
{
	set_blocking_of_non_temporary_events(iLocal_11, true);
	set_anim_scene_entity(iLocal_9, "ABIGAIL", iLocal_11, 0);
	set_anim_scene_entity(iLocal_9, "JOHN", Global_35, 0);
	func_65((*Global_1835011)[77]->f_1, 1);
	start_anim_scene(iLocal_10);
	set_anim_scene_paused(iLocal_10, true);
	return 1;
}
	...
	switch (iLocal_41)
	{
		case 0:
			if (is_screen_fading_in() || is_screen_faded_in())
			{
				...
				set_anim_scene_paused(iLocal_10, false);
				func_66(&uLocal_64);
				Var0.f_4 = 1065353216;
				Var0.f_5 = 1065353216;
				Var0.f_9 = 1065353216;
		...
		case 1:
			...
			if (bLocal_63)
			{
				func_71(&uLocal_42, iLocal_11);
			}
			else if (!_is_anim_scene_started(iLocal_10, false) && _0xa2b1c7ef759a63ce() == 0f)
			{
				func_72(&uLocal_42);
				bLocal_63 = true;
			}
			if (!_is_anim_scene_started(iLocal_10, false) && !is_player_control_on(player_id()))
			{
				set_player_control(player_id(), true, 0, false);
			}
			if ((!_is_anim_scene_started(iLocal_9, false) && !_is_anim_scene_finished(iLocal_9, false)) && func_73(&uLocal_64) >= 2f)
			{
				start_anim_scene(iLocal_9);
			}
			if (_is_anim_scene_finished(iLocal_9, false))
			{
				return true;
			}
			break;
...
void func_33(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_77(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_34(iParam0, 1, 0);
		}
	}
...
void func_34(int iParam0, int iParam1, bool bParam2)
{
	...
	func_78(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_41(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_81(iParam0), 137, true);
	}
}
...
void func_43(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_81(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_81(iParam0), 204, false);
	}
}
...
void func_45(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_81(iParam0);
	if (((does_entity_exist(iVar1) && func_83(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_51(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_74(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_90((*Global_1360165)[iParam0]->f_4.f_2) || func_91((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_92((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_94(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_37(iParam0, 44, 1);
			}
...
void func_54(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_99(Global_35) && is_player_teleport_active())
	{
	}
	if (func_100(iParam0))
	{
		if (func_101(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_55(int iParam0, int iParam1)
{
	...
	bVar0 = func_102(iParam0, iParam1);
	return bVar0;
}
...
void func_67(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_68(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_78(var uParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_82(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_81(iParam0)))
		{
...
int func_88(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_38(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_124(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_126(iParam0);
					_0x7b204f88f6c3d287(func_127(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_127(iParam0, 0));
					func_128(iParam0);
				}
			}
			else
...
int func_89(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_130((*Global_1347702)[63]->f_15, 1) || func_91((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_130((*Global_1347702)[134]->f_15, 1) || func_91((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_132(747937920, 1) && !func_130((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_81(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_109(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_105(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_105(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_105(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_105(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_105(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_105(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_105(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_105(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_105(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_105(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_105(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_105(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_105(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_105(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_105(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_105(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_105(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_105(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_105(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_105(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_105(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_105(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_105(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_105(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_105(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_105(iParam1, 1544915253))
	{
...
int func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_148(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_148(iVar0))
		{
	...
	{
		func_151(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_152(iParam0, &iVar0, &fVar25);
...
int func_125(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_159(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_127(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_160(iParam0);
	}
		...
		while (iVar28 < 4)
		{
			...
			if (func_167(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_171(0))
				{
					...
					func_172(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<5> func_165(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_167(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_184(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_169(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_187(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_170(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_187(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_171(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_187(bParam0));
}
...
void func_173(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_190(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_178(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_169(923904168, func_176(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_169(923904168, func_176(bParam0), -740156546, 0) };
		}
...
struct<4> func_180(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_169(271701509, func_176(bParam0), 12999093, 0) };
		}
...
bool func_183(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_187(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_184(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_187(bParam6), &Var0, 0);
	return uVar4;
}

bool func_185(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_187(0);
