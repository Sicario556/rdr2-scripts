...
bool func_85(var uParam0)
{
	if (func_156(16))
	{
		iLocal_18 = get_object_index_from_entity_index(_get_first_entity_ped_is_carrying(func_49(uParam0, iLocal_14)));
		if (!does_entity_exist(iLocal_18))
		{
			return false;
		}
		_0xed00d72f81cf7278(iLocal_18, 0, 0);
...
{
	if (!is_sphere_visible(677.8915f, -1253.329f, 43.55917f, 1.5f))
	{
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_245(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_160(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_258(func_256(uParam0), func_257(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_176(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_176(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
int func_336(int iParam0, bool bParam1)
{
	...
	{
		func_235(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_224() == -1)
		{
