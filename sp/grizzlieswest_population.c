...
void func_2()
{
	iLocal_24 = _create_volume_box_with_custom_name(-600f, 2695f, 330f, 0f, 0f, 0f, 250f, 200f, 200f, "m_volAdlerRanch_Restriction");
	func_8(iLocal_24, 1);
	iLocal_25 = _create_volume_aggregate_with_custom_name("m_volColter_Restriction");
	_0xbce668aaf83608be(iLocal_25, -1320f, 2425f, 305f, 0f, 0f, 0f, 115f, 115f, 15f);
	_0xbce668aaf83608be(iLocal_25, -1410f, 2435f, 327.5f, 0f, 0f, 0f, 25f, 25f, 25f);
	func_8(iLocal_25, 1);
	iLocal_26 = _create_volume_box_with_custom_name(-411.5007f, 1732.159f, 220.7082f, 0f, 0f, 17.18846f, 71.74252f, 70.79237f, 31.05772f, "m_volChezPorter_Restriction");
	func_9(iLocal_26, 0, 0, 1);
	iLocal_27 = _create_volume_aggregate_with_custom_name("m_volWinterMiningTown_Restriction");
	_0xbce668aaf83608be(iLocal_27, -1947.5f, 1332.25f, 216f, 0f, 0f, 0f, 8f, 8f, 30f);
	_0xbce668aaf83608be(iLocal_27, -1898.5f, 1346.5f, 216f, 0f, 0f, 0f, 48f, 48f, 30f);
	func_9(iLocal_27, 0, 0, 1);
	iLocal_28 = _create_volume_aggregate_with_custom_name("m_volLakeIsabella_Restriction");
	_0x39816f6f94f385ad(iLocal_28, -1888.756f, 1801.481f, 235.7563f, 0f, 0f, 25.73841f, 74.84248f, 98.28612f, 31.18848f);
	_0xbce668aaf83608be(iLocal_28, -1954.793f, 1783.318f, 243.2873f, 0f, 0f, 0f, 46.64574f, 29.92818f, 11.7102f);
	_0xbce668aaf83608be(iLocal_28, -1762.221f, 1695.654f, 241.4712f, 0f, 0f, 41.08257f, 79.25368f, 154.9331f, 19.56473f);
	_0xbce668aaf83608be(iLocal_28, -1701.788f, 1569.332f, 236.8674f, 0f, 0f, 0f, 35.55024f, 41.68321f, 26.91513f);
	_0xbce668aaf83608be(iLocal_28, -1778.828f, 1559.399f, 224.9684f, 0f, 0f, 52.77263f, 63.78292f, 40.76912f, 36.18432f);
...
void func_4(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1:
			...
			request_model(func_16(uParam0->f_1), false);
			_0xed9582b3da8f02b4(1);
			uParam0->f_9 = 1;
			func_15(uParam0, 2);
			break;
		case 2:
			if (!has_model_loaded(func_16(uParam0->f_1)))
			{
				return;
			}
		...
		case 3:
			...
			set_model_as_no_longer_needed(func_16(uParam0->f_1));
			func_15(uParam0, 4);
			break;
		case 4:
			if (func_21(uParam0))
...
void func_6()
{
	...
	{
		bLocal_29 = func_24(Global_35, -945.34f, 2170.26f, 341.83f, 25f, 0, 1);
	}
	if (bLocal_29)
	{
		if (!Global_40.f_12018)
		{
			...
			{
				if (get_event_at_index(0, iVar5) == 1081092949)
				{
					if (get_event_data(0, iVar5, &iVar0, 5))
					{
						iVar6 = iVar0;
						if (iVar6 == -885810591)
						{
		...
		{
			iVar7 = get_closest_object_of_type(-945.34f, 2170.26f, 341.83f, 2f, -2038347033, true, false, true);
...
void func_19(var uParam0)
{
	...
	uParam0->f_4 = _create_volume_sphere_with_custom_name(uParam0->f_5, func_38(), vVar1, "Special Ambient Horse Unalerted");
}
...
int func_24(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_27(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return 1;
	}
	return 0;
...
bool func_29(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_40((*Global_1835011)[iParam0]->f_1, 1);
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_58(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
