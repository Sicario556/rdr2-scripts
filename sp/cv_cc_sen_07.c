...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			iLocal_19 = _create_volume_box_with_custom_name(-98.0355f, -17.41405f, 96.11881f, 0f, 0f, 0f, 14f, 12f, 3f, "TRIGGER_VOL");
			break;
		case 2:
			func_149(uParam0, 682.339f, -1229.725f, 44.215f, 0f, -2f, -84.6f);
			iLocal_19 = _create_volume_box_with_custom_name(717.5239f, -1193.695f, 45.56543f, 0f, 0f, 20f, 14f, 12f, 3f, "TRIGGER_VOL");
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 490499043, 0f, 0f, 0f, "PLATE", 0, 0, 1);
	func_152(uParam0, iLocal_14, 1845102363, "SHOTGUN");
	func_153(uParam0, "script@vignette@sean_7@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@sean_7@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@sean_7@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@sean_7@action_b_alt", 0, 0, 0, 1);
	func_154(uParam0, "CSEN7");
	func_155(uParam0, -1054889117, -720712865);
...
bool func_93(var uParam0)
{
	...
	{
		if (func_197(Global_35, iLocal_19, 1, 0))
		{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_264(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_57(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_265(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_266(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_267(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_173(var uParam0, int iParam1)
{
	...
	func_273(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_274(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_174(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_275(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_175(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_277(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_177(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_278(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_280(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_280(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_276() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_261(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_280(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
int func_324(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_265(iParam0), 0);
}
		...
		case 6:
			if (func_120(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_274(Global_1360165[iParam0], 1);
				}
			}
			func_387(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_273(Global_1360165[iParam0]))
				{
				}
			}
...
int func_374(var uParam0, int iParam1)
{
	...
	{
		func_266(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_379(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_414(iParam0, func_276());
...
bool func_411(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_275(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
