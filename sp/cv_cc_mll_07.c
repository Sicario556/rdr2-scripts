...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -10.5949f, 2.2941f, 1.1367f, -29f, 4.5f, 4.5f, 4f, -1612834106, -727195357, 1, 1, 1);
	func_152(uParam0, -1671495534, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, "script@vignette@molly_7@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@molly_7@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@molly_7@action_b_alt_right", 0, 0, 0, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@molly_7@action_b_alt_left", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@molly_7@action_b_alt_non_directional", 0, 0, 0, 1);
	func_154(uParam0, "CMLL8AU");
	func_155(uParam0, 1005064782, -1227630889);
	func_156(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1);
	func_159(uParam0, iLocal_14, 1, 180);
	Local_29 = { func_160(uParam0, -8.8956f, 3.1365f, 1.1416f, -131f, 10f, 0.15f, 0.15f) };
	Local_19 = { func_160(uParam0, -8.8956f, 3.1365f, 1.1416f, 68.75f, 15f, 0.15f, 0.15f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, Local_29, 1, 0))
		{
			func_190(uParam0, iLocal_17, 1);
		}
		else if (func_199(uParam0, Local_19, 1, 0))
		{
			func_190(uParam0, iLocal_16, 1);
		}
		else
		{
			func_200(uParam0, iLocal_14, 2, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 0, -1073741824, 1065353216, 1);
			func_201(uParam0);
		}
	}
	if (!bLocal_39)
	{
		...
		{
			_0x673a8779d229ba5a(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 0, 0);
			bLocal_39 = true;
		}
	}
	if (func_203(uParam0, iLocal_14))
	{
		force_ped_motion_state(func_48(uParam0, iLocal_14), -530524, false, 0, false);
		_task_smart_flee_style_coord(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 2, 256, 100f, -1, 0);
		_0x2208438012482a1a(func_48(uParam0, iLocal_14), false, false);
		func_56(uParam0->f_107[iLocal_14]->f_1, 0, 0, 0, 15f, 1, 1, 0, 0, 0, 0);
	}
	return true;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_270(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_57(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_271(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_272(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_273(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_175(var uParam0, int iParam1)
{
	...
	func_279(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_280(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_176(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_281(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_177(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_283(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_179(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_284(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_286(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_286(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_187(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_287(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_189(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_288(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_288(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_282() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_200(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	func_302(uParam0, iParam1, fParam7);
}
...
bool func_203(var uParam0, int iParam1)
{
	...
	{
		if (!func_305(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_209(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_202(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
float func_213(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_308(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_214(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_309(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_216(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_310(iParam0);
	}
...
bool func_245(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_316(&(Global_1898164->f_1[0]));
		if (func_317(iVar0) && func_318((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_319(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_327(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_328(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_328(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_329(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_260(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_330(iVar1)))
			{
				func_331(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_332(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
void func_275(var uParam0, int iParam1)
{
	...
	else if (!func_305(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_277(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_288(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_288(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_295(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_339(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
void func_302(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_343(1101004800, 1123024896);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_303(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_343(100f, 140f);
			}
		}
...
int func_330(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_271(iParam0), 0);
}
		...
		case 6:
			if (func_120(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_280(Global_1360165[iParam0], 1);
				}
			}
			func_394(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_279(Global_1360165[iParam0]))
				{
				}
			}
...
int func_381(var uParam0, int iParam1)
{
	...
	{
		func_272(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
bool func_418(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_281(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_389((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
