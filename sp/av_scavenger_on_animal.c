...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "SOAP_BIRD_1", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, -1f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 0, "SOAP_ANIMAL_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		...
		{
			if (!is_entity_dead(&(uParam0->f_20[1])) && does_entity_exist(&(uParam0->f_20[0])))
			{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				...
				_task_start_scenario_in_place(&(uParam0->f_20[1]), iLocal_12, 0, false, 0, -1f, false);
		...
		case 1:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				{
					task_fly_away(&(uParam0->f_20[1]), Global_35);
					_0x2208438012482a1a(&(uParam0->f_20[1]), false, false);
				}
				func_70(&uLocal_16);
				iLocal_11 = 3;
