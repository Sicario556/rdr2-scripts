void __EntryFunction__()
{
	...
	iLocal_41 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	if (!has_anim_dict_loaded("SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A"))
	{
		return 0;
	}
	return func_49(uParam0, uParam0->f_20[7]->f_5);
}
...
bool func_28(var uParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			...
			set_entity_no_collision_entity(&(uParam0->f_20[iVar0]), &(uParam0->f_20[7]), true);
			set_entity_no_collision_entity(&(uParam0->f_20[7]), &(uParam0->f_20[iVar0]), true);
		}
		iVar0++;
	}
	if (!is_entity_dead(&(uParam0->f_20[7])))
	{
		set_ped_config_flag(&(uParam0->f_20[7]), 186, true);
		_set_ped_quality(&(uParam0->f_20[7]), 0);
		task_play_anim(&(uParam0->f_20[7]), "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A", "LOOP_DEER", 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		freeze_entity_position(&(uParam0->f_20[7]), true);
		_0x674b90be1115846d(&(uParam0->f_20[7]), 1);
		_0x3ca5e58c9731a16b(&(uParam0->f_20[7]), iLocal_41);
		func_57(uParam0->f_20[7], 1, 1);
		set_ped_keep_task(&(uParam0->f_20[7]), true);
	}
	return true;
}
...
{
	request_anim_dict("SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A");
	func_58(&uLocal_13, 0);
	func_59(&uLocal_13, 1);
	func_60(&uLocal_13, 1);
	func_61(&uLocal_13, 1);
				...
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							freeze_entity_position(&(uParam0->f_20[7]), false);
							iLocal_12 = 0;
							uParam0->f_469[1] = 1;
							return 0;
						}
				...
				if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
				{
					if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
					{
						...
						while (iVar0 <= 6)
						{
							...
							if (func_72(&(uParam0->f_20[iVar0]), 518218985))
							{
								Jump @358; //curOff = 344
							}
							else
...
int func_67(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_113(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_73(var uParam0, int iParam1)
{
	if (!is_entity_dead(&(uParam0->f_20[iParam1])))
	{
		if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[iParam1]->f_1))
		{
			...
			func_57(uParam0->f_20[iParam1], 1, 1);
