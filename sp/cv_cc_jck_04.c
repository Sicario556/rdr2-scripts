...
bool func_93(var uParam0)
{
	...
	{
		iLocal_21 = _find_closest_active_scenario_point_of_type(-113.32f, -15.6f, 94.89f, -1805387726, 0.25f, 0, false);
		if (_does_scenario_point_exist(iLocal_21))
		{
			_task_use_scenario_point(func_48(uParam0, iLocal_17), iLocal_21, 0, 0, false, true, 0, false, -1f, false);
			_0x06aade17334f7a40(func_48(uParam0, iLocal_17), -114.838f, -14.87315f, 95.79354f);
			set_ped_keep_task(func_48(uParam0, iLocal_17), true);
			_0x2208438012482a1a(func_48(uParam0, iLocal_17), false, false);
		}
		func_52(func_48(uParam0, iLocal_17), uParam0->f_107[iLocal_17]->f_7, 0, 0, 0);
	}
	return true;
}
...
int func_143(var uParam0)
{
	...
	{
		_0xd4b614179bcd0654(func_121(10, 0));
		_0xd4b614179bcd0654(func_217(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
...
void func_164(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_261(func_149(uParam0), func_260(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_306(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_210(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_312(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_310(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_331(100f, 140f);
			}
		}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(747937920, 1) && !func_394((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
