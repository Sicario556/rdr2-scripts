		...
		switch (iVar903)
		{
			...
			case 3:
				if (func_10())
				{
					...
					{
						case 0:
							delete_ped(uLocal_746[3]);
							break;
					}
					if (func_11())
					{
						func_12();
						freeze_entity_position(iLocal_76, true);
						iLocal_905 = 4;
					}
				}
				break;
...
{
	func_17(&iLocal_820);
	if (_0x91a5f9cbebb9d936(iLocal_78))
	{
		_0xd17672447692478e(iLocal_79, 0);
		clear_ped_non_creation_area();
		remove_scenario_blocking_area(iLocal_78, true);
	}
	set_vehicle_as_no_longer_needed(&iLocal_76);
	func_18(&iLocal_191, &Local_139);
	func_18(&iLocal_118, &Local_139);
	func_18(Local_264[0], &Local_307);
	func_18(Local_264[1], &Local_307);
	if (!is_entity_dead(&(uLocal_746[2])))
	{
		func_19(&(uLocal_746[2]), 1, 1);
	}
	if (!is_entity_dead(&(uLocal_746[3])))
	{
		func_19(&(uLocal_746[3]), 1, 1);
	}
	if (!is_entity_dead(&(uLocal_746[0])))
	{
		_0x24c82ef607105faa(&(uLocal_746[0]), -920810745);
		func_19(&(uLocal_746[0]), 1, 1);
	}
	if (!is_entity_dead(&(uLocal_746[1])))
	{
		_0x24c82ef607105faa(&(uLocal_746[1]), -920810745);
		func_19(&(uLocal_746[1]), 1, 1);
	}
	if (_does_propset_exist(iVar759))
	{
		_set_propset_as_no_longer_needed(iVar759);
	}
	set_ped_config_flag(&(uLocal_746[2]), 301, true);
	set_ped_config_flag(&(uLocal_746[3]), 301, true);
	func_20(&Local_359, &uLocal_746, &iLocal_753, iLocal_14, uVar900, uVar820, 0, 1, 0, 1);
...
bool func_8()
{
	switch (iVar902)
	{
		...
		case 1:
			...
			while (iVar0 < 6)
			{
				if (Local_553[iVar0]->f_1 != 0)
				{
					if (!has_model_loaded(Local_553[iVar0]->f_1) && !has_model_loaded(1596452133))
					{
						return false;
					}
				}
			...
			if (!_has_propset_loaded(iVar758))
			{
				return false;
			}
...
bool func_10()
{
	switch (iVar901)
	{
		...
		case 1:
			...
			if ((does_entity_exist(iLocal_76) && !is_entity_dead(iLocal_76)) && !_does_propset_exist(iVar759))
			{
				_0xd80faf919a2e56ea(iLocal_76, uVar758);
			}
			else
			{
				return false;
			}
			if (does_entity_exist(iLocal_76) && !is_entity_dead(iLocal_76))
			{
				func_43();
				func_44();
				func_45();
...
bool func_11()
{
	...
	{
		case 0:
			if (_0x23e33cb9f4a3f547(Local_110, "pbl_Loops"))
			{
				attach_anim_scene_to_entity(Local_110, iLocal_76, 0);
				_set_anim_scene_playback_list_bool(Local_110, "pbl_Loops", true);
			}
			if (_0x23e33cb9f4a3f547(Local_110.f_1, "pbl_Loops"))
			{
				_set_anim_scene_playback_list_bool(Local_110.f_1, "pbl_Loops", true);
			}
			if (_0x23e33cb9f4a3f547(Local_110.f_2, "pbl_Loops"))
			{
				_set_anim_scene_playback_list_bool(Local_110.f_2, "pbl_Loops", true);
			}
			if (((((_is_anim_scene_loaded(Local_110, true, false) && _is_anim_scene_loaded(Local_110.f_1, true, false)) && _is_anim_scene_loaded(Local_110.f_2, true, false)) && !_is_anim_scene_started(Local_110, false)) && !_is_anim_scene_started(Local_110.f_1, false)) && !_is_anim_scene_started(Local_110.f_2, false))
			{
				start_anim_scene(Local_110);
				start_anim_scene(Local_110.f_1);
				start_anim_scene(Local_110.f_2);
				return true;
			}
			break;
		case 1:
			if (_0x23e33cb9f4a3f547(Local_110, "pbl_Base"))
			{
				attach_anim_scene_to_entity(Local_110, iLocal_76, 0);
				_set_anim_scene_playback_list_bool(Local_110, "pbl_Base", true);
			}
			if (_0x23e33cb9f4a3f547(Local_110.f_1, "pbl_Base"))
			{
				_set_anim_scene_playback_list_bool(Local_110.f_1, "pbl_Base", true);
			}
			if (_0x23e33cb9f4a3f547(Local_110.f_2, "pbl_Base"))
			{
				_set_anim_scene_playback_list_bool(Local_110.f_2, "pbl_Base", true);
			}
			if (((((_is_anim_scene_loaded(Local_110, true, false) && _is_anim_scene_loaded(Local_110.f_1, true, false)) && _is_anim_scene_loaded(Local_110.f_2, true, false)) && !_is_anim_scene_started(Local_110, false)) && !_is_anim_scene_started(Local_110.f_1, false)) && !_is_anim_scene_started(Local_110.f_2, false))
			{
				start_anim_scene(Local_110);
...
void func_12()
{
	...
	{
		case 0:
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P0");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P1");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P2");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P3");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Loops");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Cower");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Back");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Left");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Right");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_front");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Action_P0");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Action_P1");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Action_P2");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Action_P3");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Loops");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_React_Back");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_React_Left");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_React_Right");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_React_front");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Breakout_Back");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Breakout_Left");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Breakout_Right");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Breakout_Front");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Action_P0");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Action_P1");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Action_P2");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Action_P3");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Loops");
			break;
		case 1:
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P0");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Action_P1");
			...
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Loops");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Cower");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Back_Left");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Back_Right");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Left");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_Right");
			_0xdf7b5144e25cd3fe(Local_110, "pbl_React_front");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Action_P0");
...
void func_14()
{
	...
	func_59();
	func_60();
	if (func_61(&(uLocal_746[0]), &(uLocal_746[4]), 1, 1) <= 1f && !is_ped_on_mount(&(uLocal_746[0])))
	{
		_0xba8818212633500a(&(uLocal_746[4]), 0, 1);
	}
	else
	{
		_0xba8818212633500a(&(uLocal_746[4]), 0, 0);
	}
	if (func_61(&(uLocal_746[1]), &(uLocal_746[5]), 1, 1) <= 1f && !is_ped_on_mount(&(uLocal_746[1])))
	{
		_0xba8818212633500a(&(uLocal_746[5]), 0, 1);
	}
	else
	{
		_0xba8818212633500a(&(uLocal_746[5]), 0, 0);
	}
	if (!is_ped_dead_or_dying(&(uLocal_746[0]), true) || !is_ped_dead_or_dying(&(uLocal_746[1]), true))
	{
		func_62();
	}
	if (!bVar856)
	{
		if (_0x3ab6c7b0bb0df4b1(&(uLocal_746[2]), Local_110))
		{
			_0xeaf529446488eb18(iLocal_76);
		}
		else if (is_ped_in_any_vehicle(&(uLocal_746[2]), false))
		{
			_0x5e981c764df33117(iLocal_76, 0);
		}
	}
	else
	{
	...
	if (_does_anim_scene_exist(Local_110))
	{
		if (_is_anim_scene_started(Local_110, false))
		{
			fLocal_859 = _get_anim_scene_progress(Local_110);
		}
	}
	if (_does_anim_scene_exist(Local_110.f_1))
	{
		if (_is_anim_scene_started(Local_110.f_1, false))
		{
			fLocal_860 = _get_anim_scene_progress(Local_110.f_1);
		}
	}
	if (_does_anim_scene_exist(Local_110.f_2))
	{
		if (_is_anim_scene_started(Local_110.f_2, false))
		{
			fLocal_861 = _get_anim_scene_progress(Local_110.f_2);
		}
	}
}
...
{
	func_63();
	if (iVar790 == 2 || iVar790 == 4)
	{
		if (iVar828 == 0 || iVar827 == 1)
		{
			if (_0x1f0e401031e20146(Local_110.f_1, "pbl_Action_P0"))
			{
				if (func_64())
				{
					func_65(4);
	...
	switch (iVar790)
	{
		...
		case 11:
			Local_359.f_50 = 1;
			Local_359.f_44 = 1;
			set_ped_keep_task(&(uLocal_746[2]), true);
			set_ped_keep_task(&(uLocal_746[3]), true);
			set_ped_keep_task(&(uLocal_746[0]), true);
			set_ped_keep_task(&(uLocal_746[1]), true);
			set_blocking_of_non_temporary_events(&(uLocal_746[0]), false);
			set_blocking_of_non_temporary_events(&(uLocal_746[1]), false);
			return true;
		case 10:
			Local_359.f_50 = 1;
			Local_359.f_160 = 1;
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_81(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
...
int func_23(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_112(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
...
bool func_24(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_116(iParam1, func_115(uParam0), &(uParam0->f_172)))
		{
...
void func_26(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_25(uParam0->f_3, 1))
	{
		func_118(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
void func_30()
{
	Local_553[0]->f_1 = -1090280091;
	Local_553[1]->f_1 = -1090280091;
	Local_553[2]->f_1 = -900398648;
	Local_553[3]->f_1 = -292796790;
	Local_553[4]->f_1 = func_124(4, 0, 1);
	Local_553[5]->f_1 = func_124(4, 0, 1);
	switch (iLocal_14)
	{
		case 0:
			Local_553[0]->f_3 = 811170588;
			Local_553[1]->f_3 = 901285354;
			Local_553[2]->f_3 = 618474282;
			break;
		case 1:
			Local_553[0]->f_3 = 1668440413;
			Local_553[1]->f_3 = 1490832433;
			Local_553[2]->f_3 = -221657348;
			Local_553[3]->f_3 = 1195126440;
			break;
	}
	func_125(&Local_553);
}
...
void func_31()
{
	...
	_request_propset(iVar758);
	iLocal_762 = -1785480403;
	_request_propset(iVar760);
}
...
void func_35()
{
	...
	switch (Local_359.f_51.f_4)
	{
		case 0:
			...
			fLocal_84 = 16f;
			Local_553[0]->f_6 = { -2287.31f, -412.72f, 156.64f };
			Local_553[0]->f_9 = 179.5f;
			Local_553[1]->f_6 = { -2286.44f, -419.27f, 156.7f };
			Local_553[1]->f_9 = 38f;
			Local_553[4]->f_6 = { -2284.35f, -417.57f, 156.75f };
			Local_553[4]->f_9 = 156.28f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -2286.6f, -404.74f, 157.58f };
				Local_553[5]->f_9 = -107.16f;
			}
			else
			{
				Local_553[5]->f_6 = { -2292.66f, -399.51f, 157.33f };
				Local_553[5]->f_9 = -65.67f;
			}
		...
		case 1:
			...
			fLocal_84 = 192f;
			Local_553[0]->f_6 = { -1888.47f, 382.64f, 113.36f };
			Local_553[0]->f_9 = 0f;
			Local_553[1]->f_6 = { -1886.39f, 380.91f, 113.34f };
			Local_553[1]->f_9 = -115.16f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -1884.71f, 374.3f, 114.9f };
				Local_553[5]->f_9 = 86.85f;
			}
			else
			{
				Local_553[5]->f_6 = { -1878.43f, 369.3f, 115.32f };
				Local_553[5]->f_9 = 86.08f;
			}
			Local_553[4]->f_6 = { -1888.59f, 388.4f, 113.21f };
			Local_553[4]->f_9 = 29.1f;
		...
		case 2:
			...
			fLocal_84 = 10.98f;
			Local_553[0]->f_6 = { -2646.9f, 208.82f, 152.26f };
			Local_553[0]->f_9 = -57.87f;
			Local_553[1]->f_6 = { -2660.45f, 212.52f, 152.38f };
			Local_553[1]->f_9 = 71.07f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -2657.35f, 223.84f, 151.57f };
				Local_553[5]->f_9 = 54.43f;
			}
			else
			{
				Local_553[5]->f_6 = { -2661.73f, 228.21f, 152.44f };
				Local_553[5]->f_9 = -133.24f;
			}
			Local_553[4]->f_6 = { -2654.4f, 208.38f, 153.07f };
			Local_553[4]->f_9 = -149.77f;
		...
		case 3:
			...
			fLocal_84 = 351.19f;
			Local_553[0]->f_6 = { -1624.68f, 247.9f, 104.5f };
			Local_553[0]->f_9 = -126.23f;
			Local_553[1]->f_6 = { -1624.08f, 242.83f, 104.55f };
			Local_553[1]->f_9 = 11.46f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -1628.61f, 316.47f, 104.32f };
				Local_553[5]->f_9 = 28.92f;
			}
			else
			{
				Local_553[5]->f_6 = { -1623.49f, 310.23f, 104.5f };
				Local_553[5]->f_9 = 28.31f;
			}
			Local_553[4]->f_6 = { -1626.64f, 297.73f, 104.6f };
			Local_553[4]->f_9 = -7.87f;
		...
		case 4:
			...
			fLocal_84 = 186.08f;
			Local_553[0]->f_6 = { -1921.54f, -681.62f, 117.1f };
			Local_553[0]->f_9 = -73.99f;
			Local_553[1]->f_6 = { -1919.2f, -679.21f, 117.24f };
			Local_553[1]->f_9 = 96.49f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -1925.89f, -672.12f, 118.08f };
				Local_553[5]->f_9 = 62.86f;
			}
			else
			{
				Local_553[5]->f_6 = { -1919.7f, -678.02f, 118.28f };
				Local_553[5]->f_9 = 62.15f;
			}
			Local_553[4]->f_6 = { -1925.18f, -656.65f, 119.73f };
			Local_553[4]->f_9 = -39.69f;
		...
		case 5:
			...
			fLocal_84 = 47.07f;
			Local_553[0]->f_6 = { -2687.93f, -302.83f, 148.68f };
			Local_553[0]->f_9 = -73.99f;
			Local_553[1]->f_6 = { -2692.44f, -301.44f, 148.14f };
			Local_553[1]->f_9 = 96.49f;
			if (!bVar764)
			{
				Local_553[5]->f_6 = { -2695.13f, -301.26f, 148.9f };
				Local_553[5]->f_9 = -86.79f;
			}
			else
			{
				Local_553[5]->f_6 = { -2705.15f, -297.78f, 148.9f };
				Local_553[5]->f_9 = -37.33f;
			}
			Local_553[4]->f_6 = { -2683.29f, -313.76f, 149.47f };
			Local_553[4]->f_9 = -87.82f;
			vLocal_15 = { -2524.796f, -283.6344f, 152.113f };
			vLocal_18 = { -2762.467f, -195.4687f, 148.97f };
			break;
	}
	func_126(&(Local_553[0]->f_22));
	func_126(&(Local_553[1]->f_22));
	func_126(&(Local_553[4]->f_22));
	func_126(&(Local_553[5]->f_22));
}
...
void func_37()
{
	func_128(Local_139[0], func_127(7), &(sLocal_62[1]), -163964935, 0, 0, 0, 1, 0);
	func_128(Local_139[1], "INTERACT_INTERVENE", &(sLocal_62[0]), 648122183, 0, 0, 0, 1, 0);
	func_128(Local_139[2], "INTERACT_ROB", &(sLocal_62[3]), -1616532217, 0, 0, 0, 1, 0);
	func_129(Local_139[2], 1);
	func_128(Local_212[0], func_127(7), &(sLocal_62[1]), -163964935, 0, 0, 0, 1, 0);
	func_128(Local_212[1], "INTERACT_INTERVENE", &(sLocal_62[0]), 648122183, 0, 0, 0, 1, 0);
	func_128(Local_212[2], "INTERACT_ROB", &(sLocal_62[3]), -1616532217, 0, 0, 0, 1, 0);
	func_129(Local_212[2], 1);
	func_128(Local_307[0], "RE_INTER_POS", &(sLocal_62[6]), -163964935, 0, 0, 0, 1, 0);
	func_128(Local_307[1], "RE_INTER_ANTAGONIZE", &(sLocal_62[7]), 648122183, 0, 0, 0, 1, 0);
	func_128(Local_307[2], "INTERACT_ROB", &(sLocal_62[8]), -1616532217, 0, 0, 0, 1, 0);
	func_130(Local_307[1], 0, 0);
	func_130(Local_307[0], 0, 0);
	func_129(Local_307[2], 1);
}
...
bool func_41(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_132() || !func_133((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
bool func_42()
{
	if (does_entity_exist(iLocal_76))
	{
		return true;
	}
	else
	{
		iLocal_76 = create_vehicle(1596452133, vLocal_21, fLocal_77, true, true, false, false);
		func_134(iLocal_76);
	}
	return false;
}
...
void func_43()
{
	_set_entity_coords_and_heading(iLocal_76, vLocal_21, fLocal_77, true, false, true);
	set_vehicle_on_ground_properly(iLocal_76, 0f);
	remove_all_ped_weapons(&(uLocal_746[0]), true, true);
	remove_all_ped_weapons(&(uLocal_746[1]), true, true);
	func_136(&(uLocal_746[1]), func_135(0, 1056964608, 1065353216), 99, 1, 0, 1056964608, 1065353216, 0);
	func_136(&(uLocal_746[0]), func_137(268435456, 1056964608, 1065353216), 99, 0, 0, 1056964608, 1065353216, 0);
	set_ped_relationship_group_hash(&(uLocal_746[0]), 1222652248);
	set_ped_relationship_group_hash(&(uLocal_746[1]), 1222652248);
	set_ped_can_be_targetted(&(uLocal_746[4]), false);
	set_ped_can_be_targetted(&(uLocal_746[5]), false);
	set_ped_config_flag(&(uLocal_746[1]), 315, true);
	set_ped_config_flag(&(uLocal_746[1]), 297, true);
	set_ped_config_flag(&(uLocal_746[1]), 130, true);
	set_ped_config_flag(&(uLocal_746[1]), 317, true);
	set_ped_config_flag(&(uLocal_746[1]), 301, false);
	set_ped_config_flag(&(uLocal_746[0]), 347, true);
	set_ped_config_flag(&(uLocal_746[1]), 347, true);
	set_ped_combat_movement(&(uLocal_746[0]), 0);
	set_ped_combat_movement(&(uLocal_746[1]), 2);
	set_ped_combat_attributes(&(uLocal_746[0]), 5, true);
	set_ped_combat_attributes(&(uLocal_746[0]), 17, false);
	set_ped_combat_attributes(&(uLocal_746[1]), 5, true);
	set_ped_combat_attributes(&(uLocal_746[1]), 17, false);
	set_ped_combat_attributes(&(uLocal_746[0]), 1, false);
	set_ped_combat_attributes(&(uLocal_746[1]), 1, false);
	set_ped_combat_attributes(&(uLocal_746[0]), 46, true);
	set_ped_combat_attributes(&(uLocal_746[1]), 46, true);
	set_ped_combat_attributes(&(uLocal_746[0]), 0, false);
	set_ped_combat_attributes(&(uLocal_746[1]), 0, false);
	...
	func_141(&(Local_553[2]->f_22));
	set_ped_config_flag(&(uLocal_746[2]), 146, true);
	set_ped_config_flag(&(uLocal_746[4]), 358, true);
	set_ped_config_flag(&(uLocal_746[5]), 358, true);
	func_142(&(uLocal_746[4]), uLocal_763[0], 1, 1);
	func_142(&(uLocal_746[5]), uLocal_763[1], 1, 1);
	set_ragdoll_blocking_flags(&(uLocal_746[4]), 270352);
	set_ragdoll_blocking_flags(&(uLocal_746[5]), 270352);
	switch (iLocal_14)
	{
		case 0:
			set_ambient_voice_name(&(uLocal_746[0]), "0713_G_M_M_UniRanchers_01_WHITE_03");
			set_ambient_voice_name(&(uLocal_746[1]), "0714_G_M_M_UniRanchers_01_WHITE_04");
			set_ambient_voice_name(&(uLocal_746[2]), "0595_A_M_M_Civ_White_AVOID_11");
			func_143(&(uLocal_746[2]), &Local_359, 0);
			func_143(&(uLocal_746[0]), &Local_359, 0);
			func_143(&(uLocal_746[1]), &Local_359, 0);
			set_ped_into_vehicle(&(uLocal_746[2]), iLocal_76, -1);
			break;
		case 1:
			set_ambient_voice_name(&(uLocal_746[0]), "0711_G_M_M_UniRanchers_01_WHITE_01");
			set_ambient_voice_name(&(uLocal_746[1]), "0712_G_M_M_UniRanchers_01_WHITE_02");
			set_ambient_voice_name(&(uLocal_746[2]), "0927_A_M_M_Civ_Poor_White_AVOID_10");
			set_ambient_voice_name(&(uLocal_746[3]), "REFND_VOLUNTEER");
			func_141(&(Local_553[3]->f_22));
			set_ped_config_flag(&(uLocal_746[3]), 146, true);
			set_ped_into_vehicle(&(uLocal_746[2]), iLocal_76, -1);
			set_ped_into_vehicle(&(uLocal_746[3]), iLocal_76, 0);
			func_143(&(uLocal_746[3]), &Local_359, 0);
			func_143(&(uLocal_746[2]), &Local_359, 0);
			func_143(&(uLocal_746[0]), &Local_359, 0);
			break;
	}
	set_entity_is_target_priority(&(uLocal_746[0]), true, 0f);
	set_entity_is_target_priority(&(uLocal_746[1]), true, 0f);
...
void func_45()
{
	...
	iLocal_79 = _create_volume_box(vVar6, 0f, 0f, 0f, fLocal_80, fLocal_80, fLocal_80);
	_0xc1799fafd2fdf52b(iLocal_79, 0, 0, 0);
	iLocal_78 = func_152(vVar0, vVar3, vVar6, fLocal_80, 0, 0);
}

void func_46()
{
	vVar0 = { get_entity_coords(iLocal_76, true, false) };
	switch (iLocal_14)
	{
		case 0:
			Local_110 = _create_anim_scene(Local_110.f_4, 0, 0, false, true);
			Local_110.f_1 = _create_anim_scene(Local_110.f_5, 64, 0, false, true);
			Local_110.f_2 = _create_anim_scene(Local_110.f_6, 64, 0, false, true);
			get_ground_z_for_3d_coord(get_entity_coords(iLocal_76, true, false), &(vLocal_81.f_2), false);
			set_anim_scene_origin(Local_110, 0f, 0f, 0f, 0f, 0f, 0f, 2);
			set_anim_scene_origin(Local_110.f_1, vVar0.x, vVar0.y, vLocal_81.z, 0f, 0f, fLocal_84, 2);
			set_anim_scene_origin(Local_110.f_2, vVar0.x, vVar0.y, vLocal_81.z, 0f, 0f, fLocal_84, 2);
			set_anim_scene_entity(Local_110, "Victim", &(uLocal_746[2]), 0);
			set_anim_scene_entity(Local_110, "chuckwagon000x", iLocal_76, 0);
			set_anim_scene_entity(Local_110.f_1, "Robber01", &(uLocal_746[0]), 0);
			set_anim_scene_entity(Local_110.f_2, "Robber02", &(uLocal_746[1]), 0);
			if ((!_is_anim_scene_loaded(Local_110, true, false) && !_is_anim_scene_loaded(Local_110.f_1, true, false)) && !_is_anim_scene_loaded(Local_110.f_2, true, false))
			{
				load_anim_scene(Local_110);
				load_anim_scene(Local_110.f_1);
				load_anim_scene(Local_110.f_2);
			}
			set_anim_scene_bool(Local_110, "Internal_Loop", false, false);
			set_anim_scene_bool(Local_110, "Cower_Bool", false, false);
			set_anim_scene_bool(Local_110.f_1, "Internal_Loop", false, false);
			set_anim_scene_bool(Local_110.f_2, "Internal_Loop", false, false);
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Loops");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Loops");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Loops");
			break;
		case 1:
			Local_110 = _create_anim_scene(Local_110.f_4, 0, 0, false, true);
			Local_110.f_1 = _create_anim_scene(Local_110.f_5, 0, 0, false, true);
			Local_110.f_2 = _create_anim_scene(Local_110.f_6, 64, 0, false, true);
			get_ground_z_for_3d_coord(get_entity_coords(iLocal_76, true, false), &(vLocal_81.f_2), false);
			set_anim_scene_origin(Local_110, 0f, 0f, 0f, 0f, 0f, 0f, 2);
			set_anim_scene_origin(Local_110.f_1, vVar0.x, vVar0.y, vLocal_81.z, 0f, 0f, fLocal_84, 2);
			set_anim_scene_origin(Local_110.f_2, vVar0.x, vVar0.y, vLocal_81.z, 0f, 0f, fLocal_84, 2);
			set_anim_scene_entity(Local_110, "Victim", &(uLocal_746[2]), 0);
			set_anim_scene_entity(Local_110, "Victim_Female", &(uLocal_746[3]), 0);
			set_anim_scene_entity(Local_110, "chuckwagon000x", iLocal_76, 0);
			set_anim_scene_entity(Local_110.f_1, "Robber01", &(uLocal_746[0]), 0);
			set_anim_scene_entity(Local_110.f_2, "Robber02", &(uLocal_746[1]), 0);
			if ((!_is_anim_scene_loaded(Local_110, true, false) && !_is_anim_scene_loaded(Local_110.f_1, true, false)) && !_is_anim_scene_loaded(Local_110.f_2, true, false))
			...
			set_anim_scene_bool(Local_110, "Cower_Bool", false, false);
			set_anim_scene_bool(Local_110.f_1, "Internal_Loop", false, false);
			set_anim_scene_bool(Local_110.f_2, "Internal_Loop", true, false);
			set_anim_scene_bool(Local_110, "BaseBool", false, false);
			set_anim_scene_bool(Local_110.f_1, "BaseBool", false, false);
			set_anim_scene_bool(Local_110.f_2, "BaseBool", false, false);
			_0xdf7b5144e25cd3fe(Local_110, "pbl_Base");
			_0xdf7b5144e25cd3fe(Local_110.f_1, "pbl_Base");
			_0xdf7b5144e25cd3fe(Local_110.f_2, "pbl_Base");
			break;
	}
}
...
void func_47()
{
	...
	while (iVar1 < iVar0)
	{
		if (iVar1 != 0 && does_extra_exist(iLocal_76, iVar1))
		{
			set_vehicle_extra(iLocal_76, iVar1, true);
		}
		iVar1++;
	}
}
...
void func_53(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_81(uParam0->f_3));
...
void func_55(var uParam0, int iParam1, float fParam2)
{
	...
	if (!uParam0->f_48 && !func_52(uParam0->f_3, 262144))
	{
		...
		func_163(uParam0->f_121[iParam1], fVar1, 1082130432, 0, 90f, 0, &(uParam0->f_98[iParam1]));
...
bool func_56(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_167(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_166(uParam2, fVar1))
		{
			if (!func_168((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
void func_57(var uParam0, int iParam1)
{
	if (func_183(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_186());
...
void func_58()
{
	if (func_189() == 0)
	{
		if ((((func_190(&(uLocal_746[2]), 0, &(Local_359.f_5), &uLocal_906, 0, 0) || func_190(&(uLocal_746[3]), 0, &(Local_359.f_5), &uLocal_906, 0, 0)) || func_60()) || is_entity_on_fire(iLocal_76)) || func_191())
		{
			if (iVar904 != 256 || (!func_83(&(uLocal_746[0]), 0, 1) && !func_83(&(uLocal_746[1]), 0, 1)))
			{
				if (iVar790 != 5)
				{
					clear_ped_secondary_task(&(uLocal_746[2]));
					clear_ped_secondary_task(&(uLocal_746[3]));
					iLocal_858 = 1;
				}
				else if (iVar904 == 2 || is_entity_on_fire(iLocal_76))
				{
					clear_ped_secondary_task(&(uLocal_746[2]));
					clear_ped_secondary_task(&(uLocal_746[3]));
					iLocal_858 = 1;
...
void func_59()
{
	...
	iVar2 = func_194(uLocal_746[2], Local_264[0], 30f, &Local_307, &(Local_359.f_192), 0f, 1, 0, 0, func_193(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	if (does_entity_exist(&(uLocal_746[3])))
	{
		iVar3 = func_194(uLocal_746[3], Local_264[1], 30f, &Local_307, &(Local_359.f_192), 0f, 1, 0, 0, func_193(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	}
	if (iVar790 != 5 && !bVar856)
	{
		switch (iVar793)
		{
			case 0:
				...
				{
					case 0:
						func_129(Local_139[0], 0);
						func_130(Local_139[0], 0, 0);
						func_129(Local_212[0], 0);
						func_130(Local_212[0], 0, 0);
						switch (iVar0)
						{
							case 1:
								func_195(10, 1682361219, 0, 0, 0, 0, 1065353216, 0);
								iLocal_853 = 1;
								stop_current_playing_speech(&(uLocal_746[0]), 0);
								stop_current_playing_speech(&(uLocal_746[1]), 0);
								stop_current_playing_speech(&(uLocal_746[2]), 0);
								stop_current_playing_speech(&(uLocal_746[3]), 0);
								iLocal_796 = 2;
								break;
						}
						switch (iVar1)
						...
						break;
					case 2:
						func_130(Local_139[1], 0, 0);
						func_130(Local_212[1], 0, 0);
						func_196();
			...
			case 1:
				switch (iVar794)
				{
					case 0:
						...
						{
							func_130(Local_139[0], 1, 0);
							func_130(Local_139[1], 1, 0);
							func_130(Local_139[2], 0, 0);
							func_130(Local_212[0], 1, 0);
							func_130(Local_212[1], 1, 0);
							func_130(Local_212[2], 0, 0);
							switch (iVar0)
							{
								case 0:
									func_130(Local_139[0], 0, 0);
...
bool func_60()
{
	...
	switch (iVar795)
	{
		case 0:
			...
			break;
		case 1:
			_0xa19447d83294e29f(iLocal_76, &iVar0, &iVar1);
			if (iVar1 < 2)
			{
				iLocal_797 = 2;
			}
...
bool func_62()
{
	if (Local_359.f_46 == 0)
	{
		if ((((func_202(&uLocal_746, &(Local_359.f_5), &uLocal_906, &uLocal_821, 0, 1, 1) || has_entity_been_damaged_by_entity(&(uLocal_746[4]), Global_35, 1, 1)) || has_entity_been_damaged_by_entity(&(uLocal_746[5]), Global_35, 1, 1)) || func_203(&(uLocal_746[1]), 1, 1) <= 1f) || bVar856)
		{
			func_204(&(Local_359.f_5), &uLocal_906);
			Local_359.f_46 = 1;
			func_65(5);
			return true;
		}
	...
	if (!Local_359.f_46)
	{
		if (iVar790 >= 4)
		{
			if (!bVar832)
			{
				...
				{
					if ((bVar764 && !bVar856) && !func_83(&(uLocal_746[2]), 0, 1))
					{
		...
		else if (!bVar764)
		{
			if (!is_entity_dead(&(uLocal_746[2])))
			{
				_0x66f9eb44342bb4c5(&(uLocal_746[2]), &Local_767);
...
void func_67()
{
	if (Local_359.f_182 == 0)
	{
		...
		{
			_play_sound_from_position("distant_gunshots", Local_359.f_51, "TRE1_Sounds", false, 0, true, 0);
			remove_anim_scene_entity(Local_110, "Wagon", iLocal_76);
			func_207(&Local_359, &(uLocal_746[0]), 1);
		}
	}
	if (func_208(&Local_359, 1f, 80f, 45f, 1, 0, 1, -1082130432, 1, 1125515264, 0, 0))
	{
		_set_anim_scene_playback_list_bool(Local_110, "pbl_Action_P0", true);
		_set_anim_scene_playback_list_bool(Local_110.f_1, "pbl_Action_P0", true);
		_set_anim_scene_playback_list_bool(Local_110.f_2, "pbl_Action_P0", true);
		iLocal_820 = add_shocking_event_for_entity(513747494, &(uLocal_746[0]), 0f, 50f, 50f, 15f, -1f, 180f, false, false, -1, -1);
		freeze_entity_position(iLocal_76, false);
		func_65(1);
	}
}
...
void func_69()
{
	...
	if (is_ped_dead_or_dying(&(uLocal_746[2]), true) || iVar827 == 1)
	{
		func_130(Local_139[0], 0, 0);
		func_130(Local_139[1], 0, 0);
		func_220(Local_139[0], "RE_INTER_POS");
		func_220(Local_139[1], "RE_INTER_ANTAGONIZE");
		func_130(Local_212[0], 0, 0);
		func_130(Local_212[1], 0, 0);
		func_220(Local_212[0], "RE_INTER_POS");
		func_220(Local_212[1], "RE_INTER_ANTAGONIZE");
		if (iVar793 != 4)
		{
			iLocal_795 = 4;
		}
	...
	if (iVar847 == 1)
	{
		if (!is_ped_dead_or_dying(&(uLocal_746[2]), true))
		{
			func_221();
		}
		else
...
void func_70()
{
	...
	if (!_0x3ab6c7b0bb0df4b1(&(uLocal_746[0]), Local_110.f_1) && !_0x3ab6c7b0bb0df4b1(&(uLocal_746[1]), Local_110.f_2))
	{
		func_65(4);
	}
}
...
void func_71()
{
	...
	if (func_228())
	{
		if (!is_ped_on_mount(&(uLocal_746[0])))
		{
			if (!func_229(&(uLocal_746[4]), 242628503))
			{
				...
				_task_perform_sequence_2(&(uLocal_746[4]), iVar0, 3f, 3f);
				clear_sequence_task(&iVar0);
			}
		}
	}
	if (func_230())
	{
		if (!is_ped_on_mount(&(uLocal_746[1])))
		{
			if (!func_229(&(uLocal_746[5]), 242628503))
			{
				...
				_task_perform_sequence_2(&(uLocal_746[5]), iVar1, 2f, 2f);
				clear_sequence_task(&iVar1);
			}
		}
	}
	...
	if (func_233())
	{
		_0xba8818212633500a(&(uLocal_746[4]), 0, 0);
		_0xba8818212633500a(&(uLocal_746[5]), 0, 0);
		if (is_entity_dead(_get_ped_in_draft_seat(iLocal_76, 0)) && is_entity_dead(_get_ped_in_draft_seat(iLocal_76, 1)))
		{
			func_65(9);
		}
		switch (iLocal_14)
			...
			case 0:
				if (!is_ped_dead_or_dying(&(uLocal_746[2]), true))
				{
					...
					else if ((!func_197(Global_35, 0) && !func_197(&(uLocal_746[2]), 0)) && func_236(&uLocal_865) > 4f)
					{
						...
						set_anim_scene_bool(Local_110, "Cower_Bool", true, false);
						func_195(13, 0, 0, "Saved Victim", 0, 0, 1065353216, 0);
						iLocal_836 = 1;
						iLocal_817 = get_entity_health(&(uLocal_746[0]));
						iLocal_816 = get_entity_health(&(uLocal_746[0]));
						iLocal_819 = get_entity_health(&(uLocal_746[1]));
						iLocal_818 = get_entity_health(&(uLocal_746[1]));
						iLocal_795 = 2;
						iLocal_796 = 0;
						func_235(&uLocal_865);
						func_65(6);
				...
				break;
			case 1:
				if ((!is_ped_dead_or_dying(&(uLocal_746[2]), true) && !is_ped_dead_or_dying(&(uLocal_746[3]), true)) && iVar822 == 0)
				{
					if (!func_234(&uLocal_865))
					{
						func_235(&uLocal_865);
				...
				{
					set_ped_flee_attributes(&(uLocal_746[2]), 2048, false);
					set_ped_flee_attributes(&(uLocal_746[3]), 2048, false);
					set_ped_flee_attributes(&(uLocal_746[2]), 65536, true);
					set_ped_flee_attributes(&(uLocal_746[3]), 65536, true);
					func_65(9);
				}
				break;
		}
	...
	if (iVar822 == 1)
	{
		...
		{
			_task_smart_flee_style_ped(&(uLocal_746[3]), &(uLocal_746[1]), 3, 0, -1082130432, -1, 0);
		}
		if (!func_229(&(uLocal_746[2]), 518218985))
		{
			_task_smart_flee_style_ped(&(uLocal_746[2]), &(uLocal_746[1]), 3, 0, -1082130432, -1, 0);
		}
	}
	if (func_237() || func_60())
	{
		...
		{
			clear_sequence_task(&uLocal_899);
			open_sequence_task(&uLocal_899);
			_task_smart_flee_style_ped(0, &(uLocal_746[1]), 3, 0, -1082130432, -1, 0);
			close_sequence_task(iVar897);
			task_perform_sequence(&(uLocal_746[3]), iVar897);
			clear_sequence_task(&uLocal_899);
		}
		if (!func_229(&(uLocal_746[2]), 242628503))
		{
			clear_sequence_task(&uLocal_898);
			open_sequence_task(&uLocal_898);
			_task_smart_flee_style_ped(0, &(uLocal_746[1]), 3, 0, -1082130432, -1, 0);
			close_sequence_task(iVar896);
			_task_perform_sequence_2(&(uLocal_746[2]), iVar896, 0.5f, 0.5f);
			clear_sequence_task(&uLocal_898);
		}
		set_ped_flee_attributes(&(uLocal_746[3]), 2, false);
		set_ped_flee_attributes(&(uLocal_746[3]), 65536, true);
		set_ped_flee_attributes(&(uLocal_746[3]), 2048, false);
		set_ped_flee_attributes(&(uLocal_746[2]), 2, false);
		set_ped_flee_attributes(&(uLocal_746[2]), 65536, true);
		set_ped_flee_attributes(&(uLocal_746[2]), 2048, false);
	}
	switch (iLocal_14)
	{
		case 1:
			if (is_ped_dead_or_dying(&(uLocal_746[2]), true) && iVar830 == 0)
			{
				iLocal_832 = 1;
				set_ped_flee_attributes(&(uLocal_746[3]), 2, false);
				set_ped_flee_attributes(&(uLocal_746[3]), 65536, true);
			...
			if (is_ped_dead_or_dying(&(uLocal_746[3]), true) && iVar830 == 0)
			{
				iLocal_832 = 1;
				set_ped_flee_attributes(&(uLocal_746[2]), 2, false);
				set_ped_flee_attributes(&(uLocal_746[2]), 65536, true);
...
void func_72()
{
	...
	{
		case 0:
			if ((is_entity_at_coord(&(uLocal_746[0]), vLocal_15, 2f, 2f, 2f, false, true, 0) || (func_203(&(uLocal_746[0]), 1, 1) >= 100f && func_203(&(uLocal_746[1]), 1, 1) >= 100f)) || (is_ped_dead_or_dying(&(uLocal_746[0]), true) && is_ped_dead_or_dying(&(uLocal_746[1]), true)))
			{
				func_65(11);
			}
			break;
...
void func_73()
{
	...
	if (func_242(&uLocal_865) >= 3f || (has_entity_been_damaged_by_entity(&(uLocal_746[2]), Global_35, 1, 1) || has_entity_been_damaged_by_entity(&(uLocal_746[3]), Global_35, 1, 1)))
	{
		func_58();
	}
	if (func_243())
	...
	{
		_task_vehicle_drive_to_destination(&(uLocal_746[2]), iLocal_76, vLocal_18, 3f, 2621463, 6, 3f, 5f, 0);
		func_129(Local_307[2], 0);
		func_129(Local_307[0], 0);
		func_129(Local_307[1], 0);
		func_130(Local_307[2], 0, 0);
		func_130(Local_307[0], 1, 0);
		func_130(Local_307[1], 1, 0);
		func_65(7);
	}
}
...
void func_74()
{
	...
	func_241();
	if (does_blip_exist(&(iLocal_753[2])))
	{
		remove_blip(iLocal_753[2]);
	}
	if (does_blip_exist(&(iLocal_753[3])))
	{
		remove_blip(iLocal_753[3]);
	}
	if (!is_ped_dead_or_dying(&(uLocal_746[2]), true) || !is_ped_dead_or_dying(&(uLocal_746[3]), true))
	{
		func_58();
	}
}
...
void func_79(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_251(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_252(iParam0, 0);
		}
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_253((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_251(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
void func_88(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_83(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			fVar2 = func_87(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
char* func_101(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_269(sParam1));
}
...
void func_103(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_186());
		if (func_275(Global_1310750[iParam0], 33554432))
		{
...
bool func_104(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_278(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_52(iParam0, 16))
	{
		...
		fVar2 = to_float(func_279(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
bool func_111(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	vVar2 = { *uParam0 };
	...
	if (func_287(&(uParam0->f_37), 500))
	{
		...
		while (iVar0 < 8)
		{
			if (!func_107(*uParam0->f_12[iVar0]))
			{
...
int func_122(bool bParam0)
{
	...
	get_group_size(func_296(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_296(), iVar3);
		if (func_297(iVar4))
		{
			iVar0++;
		}
...
void func_125(int iParam0)
{
	...
	while (iVar0 < *iParam0)
	{
		func_302(&((*iParam0)[iVar0]->f_1));
		func_302(&((*iParam0)[iVar0]->f_12));
		iVar0++;
	}
}
	...
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_314(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
int func_135(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_322(iVar5) || _0xf2f585411e748b9c(iVar1, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar1;
		}
	}
	...
	{
		if (!func_322(iVar5) || _0xf2f585411e748b9c(iVar3, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar3;
		}
	}
	...
	{
		if (!func_322(iVar5) || _0xf2f585411e748b9c(iVar2, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar2;
		}
	}
...
void func_156(int iParam0, int iParam1)
{
	...
	func_338(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_339(iParam0, 0);
	func_340(iParam0);
	func_341(1);
...
{
	if (uParam0->f_177 != -1 || func_275(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_349(uParam0->f_177));
			}
		}
	}
...
bool func_167(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_189()
{
	if (!_is_ped_hogtied(&(uLocal_746[0])) && !_is_ped_hogtied(&(uLocal_746[1])))
	{
		return 0;
	}
	if (_is_ped_hogtied(&(uLocal_746[0])))
	{
		if (has_entity_been_damaged_by_entity(&(uLocal_746[0]), Global_35, 1, 1))
		{
			iLocal_817 = get_entity_health(&(uLocal_746[0]));
		}
		if (iVar815 < iVar814)
	...
	if (_is_ped_hogtied(&(uLocal_746[1])))
	{
		if (has_entity_been_damaged_by_entity(&(uLocal_746[1]), Global_35, 1, 1))
		{
			iLocal_819 = get_entity_health(&(uLocal_746[1]));
		}
		if (iVar817 < iVar816)
...
bool func_190(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_381(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630->f_26 && func_167(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_385(iParam2, 1065353216))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
bool func_191()
{
	if (_is_ped_lassoed(&(uLocal_746[2])) || (iLocal_14 == 1 && _is_ped_lassoed(&(uLocal_746[3]))))
	{
		return true;
	}
	return false;
...
void func_192()
{
	...
	switch (iVar797)
	{
		...
		case 1:
			clear_sequence_task(&uLocal_899);
			open_sequence_task(&uLocal_899);
			if (is_ped_in_any_vehicle(&(uLocal_746[3]), false))
			{
			...
			clear_sequence_task(&uLocal_898);
			open_sequence_task(&uLocal_898);
			if (is_ped_in_any_vehicle(&(uLocal_746[2]), false))
			{
				task_leave_any_vehicle(0, 0, 0);
			}
			_task_smart_flee_style_ped(0, Global_35, 3, 0, -1082130432, -1, 0);
			...
			func_18(Local_264[0], &Local_307);
			func_18(Local_264[1], &Local_307);
			func_129(Local_307[0], 1);
			func_129(Local_307[1], 1);
			func_129(Local_307[2], 1);
			iLocal_799 = 2;
			break;
		case 2:
...
void func_199()
{
	_0xe737d5f14304a2ec(&(uLocal_746[0]), player_id(), 120000);
	_0xe737d5f14304a2ec(&(uLocal_746[1]), player_id(), 120000);
	_0xe737d5f14304a2ec(&(uLocal_746[2]), player_id(), 120000);
	if (func_83(&(uLocal_746[3]), 0, 1))
	{
		_0xe737d5f14304a2ec(&(uLocal_746[3]), player_id(), 120000);
	}
}
...
bool func_201(int iParam0)
{
	if (does_entity_exist(*iParam0) && !is_entity_dead(*iParam0))
	{
		...
		{
			if (_0xa19447d83294e29f(*iParam0, &iVar0, &iVar1))
			{
				if (iVar0 == iVar1)
				{
					return true;
...
bool func_202(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_190(uParam0[*uParam3], 0, iParam1, uParam2, 0, 0))
		{
			return true;
		}
		*uParam3++;
...
bool func_208(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		if (iParam4 > 1)
		{
			...
			{
				func_163(uParam0->f_121[iVar0], fVar3, 1082130432, 1, 90f, 0, 0);
				iVar0++;
			}
		}
		else
		{
			func_163(uParam0->f_121[0], fVar3, 1082130432, 1, 90f, 0, 0);
		}
		if (func_164(&(uParam0->f_121), iParam4, fParam1))
		{
			...
			if (uParam0->f_186)
			{
				_0xb2a38826e5886e83(func_91(uParam0->f_3, uParam0->f_185), 0);
			}
			return true;
		}
	}
...
void func_209()
{
	...
	if (iVar825 == 1)
	{
		if (!func_234(&uLocal_877) && is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_746[1]), true, false), 13f, 20f, 3f, false, true, 0))
		{
			func_235(&uLocal_877);
			iLocal_831 = 1;
		}
		...
		{
			if (is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_746[1]), true, false), 13f, 20f, 3f, false, true, 0) && iVar829 == 1)
			{
				iLocal_830 = 1;
			}
			else
	...
	if (func_422() && !is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_746[1]), true, false), 13f, 23f, 3f, false, true, 0))
	{
		iLocal_831 = 0;
		iLocal_830 = 0;
		func_376(&uLocal_877);
...
int func_210()
{
	if (!is_ped_injured(&(uLocal_746[0])) || (!is_ped_injured(&(uLocal_746[1])) && !func_62()))
	{
		if ((func_61(&(uLocal_746[0]), player_ped_id(), 1, 1) <= 25f && has_entity_clear_los_to_entity(&(uLocal_746[0]), player_ped_id(), 17)) || (func_61(&(uLocal_746[1]), player_ped_id(), 1, 1) <= 25f && has_entity_clear_los_to_entity(&(uLocal_746[1]), player_ped_id(), 17)))
		{
			iLocal_827 = 1;
			return 1;
		}
	...
	switch (iVar800)
	{
		case 0:
			...
			if (func_424(-4f, 1, 0, 0))
			{
				...
				task_aim_gun_at_entity(&(uLocal_746[1]), Global_35, -1, 0, 4);
				func_199();
				iLocal_795 = 1;
				func_129(Local_139[0], 0);
				func_130(Local_139[0], 1, 0);
				...
				func_130(Local_212[0], 1, 0);
				func_130(Local_212[1], 1, 0);
				Local_139[0]->f_13 = &sLocal_62[1];
				func_220(Local_139[0], "INTERACT_DEFUSE");
				func_220(Local_212[0], "INTERACT_DEFUSE");
				func_235(&uLocal_886);
		...
		case 1:
			...
			break;
		case 2:
			if ((((func_424(-4f, 1, &(uLocal_746[0]), 1) && func_424(-4f, 1, &(uLocal_746[1]), 1)) && func_424(-4f, 1, &(uLocal_746[2]), 1)) && !func_422()) || iVar846 == 1)
			{
				if (!func_197(Global_35, 0))
				{
...
void func_213()
{
	...
	if (!_0x1f0e401031e20146(Local_110, sVar862) && iVar827 == 0)
	{
		_set_anim_scene_playback_list_bool(Local_110, sVar862, true);
	}
	if (!_0x1f0e401031e20146(Local_110.f_1, sVar861) && func_242(&uLocal_880) >= 1.5f)
	{
		_set_anim_scene_playback_list_bool(Local_110.f_1, sVar861, true);
	}
}
...
void func_214()
{
	...
	switch (iVar801)
	{
		case 0:
			...
			{
				func_198(&(uLocal_746[0]), Global_35, &(sLocal_24[0]), "", 50f, 0, 0, 0, 2, 0, 0, 1744022339, 1, 0, 0);
				task_aim_at_entity(&(uLocal_746[1]), Global_35, -1, 0, 0);
				task_aim_gun_at_entity(&(uLocal_746[1]), Global_35, -1, 0, 4);
				func_199();
				iLocal_795 = 1;
				func_129(Local_139[0], 0);
		...
		case 1:
			...
			break;
		case 2:
			if ((((func_424(-4f, 1, &(uLocal_746[0]), 1) && func_424(-4f, 1, &(uLocal_746[1]), 1)) && func_424(-4f, 1, &(uLocal_746[3]), 1)) && !func_422()) || iVar846 == 1)
			{
				if (!func_197(Global_35, 0))
				{
					func_198(&(uLocal_746[1]), &(uLocal_746[0]), &(sLocal_24[3]), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
...
void func_215()
{
	if (iVar822 == 0)
	{
		...
		if (!_0x1f0e401031e20146(Local_110, sVar862))
		{
			_set_anim_scene_playback_list_bool(Local_110, sVar862, true);
		}
		if (!_0x1f0e401031e20146(Local_110.f_1, sVar861) && func_242(&uLocal_880) >= 1.5f)
...
void func_216()
{
	switch (iVar792)
	{
		case 0:
			...
			task_follow_nav_mesh_to_coord(0, vVar1, 1f, 20000, 0.25f, 0, fVar0);
			task_aim_gun_at_entity(0, &(uLocal_746[2]), 2000, 0, 1);
			task_aim_gun_at_entity(0, &(uLocal_746[2]), 1000, 1, 1);
			close_sequence_task(iVar4);
			task_perform_sequence(&(uLocal_746[1]), iVar4);
			func_130(Local_139[0], 0, 0);
			func_130(Local_139[1], 1, 0);
			func_220(Local_139[0], "RE_INTER_POS");
			func_220(Local_139[1], "RE_INTER_ANTAGONIZE");
			...
			break;
		case 1:
			if (get_sequence_progress(&(uLocal_746[1])) >= 2)
			{
				set_anim_scene_entity(Local_110.f_2, "Robber02", &(uLocal_746[1]), 0);
				_set_anim_scene_playback_list_bool(Local_110, "pbl_Action_P3", true);
				_set_anim_scene_playback_list_bool(Local_110.f_1, "pbl_Action_P3", true);
				_set_anim_scene_playback_list_bool(Local_110.f_2, "pbl_Action_P3", false);
				iLocal_835 = 1;
				iLocal_794 = 2;
			}
			break;
...
void func_218()
{
	switch (iVar792)
	{
		case 0:
			...
			if (!bVar829)
			{
				func_220(Local_139[1], "INTERACT_INTERVENE");
			}
			else
			{
				func_220(Local_139[1], "RE_INTER_ANTAGONIZE");
			...
			if (!bVar829)
			{
				func_220(Local_212[1], "INTERACT_INTERVENE");
			}
			else
			{
				func_220(Local_212[1], "RE_INTER_ANTAGONIZE");
			...
			break;
		case 1:
			if (is_ped_still(&(uLocal_746[1])) && get_sequence_progress(&(uLocal_746[1])) >= 1)
			{
				_set_anim_scene_playback_list_bool(Local_110, "pbl_Action_P3", true);
				_set_anim_scene_playback_list_bool(Local_110.f_1, "pbl_Action_P3", true);
				set_anim_scene_entity(Local_110.f_2, "Robber02", &(uLocal_746[1]), 0);
...
{
	if (func_253(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
		...
		case 0:
			switch (iVar810)
			{
				case 0:
					...
					task_aim_at_entity(&(uLocal_746[1]), Global_35, -1, 0, 0);
					task_aim_gun_at_entity(&(uLocal_746[1]), Global_35, -1, 0, 3);
					iLocal_795 = 4;
					iLocal_796 = 0;
					iLocal_812 = iVar810 + 1;
					break;
				case 1:
					if (iVar844 == 1)
					{
...
int func_222()
{
	if ((func_61(&(uLocal_746[0]), player_ped_id(), 1, 1) <= 10f && has_entity_clear_los_to_entity(&(uLocal_746[0]), player_ped_id(), 17)) || (func_61(&(uLocal_746[1]), player_ped_id(), 1, 1) <= 10f && has_entity_clear_los_to_entity(&(uLocal_746[1]), player_ped_id(), 17)))
	{
		if (iVar823 == 0)
		{
			func_378(0);
...
bool func_223()
{
	...
	switch (iVar806)
	{
		...
		case 2:
			if (fVar857 >= 0.87f)
			{
				_task_vehicle_drive_to_destination(&(uLocal_746[2]), iLocal_76, vLocal_18, 3f, 524311, 6, 3f, 5f, 0);
				iLocal_824 = 1;
				uLocal_808 = iVar806 + 1;
				uLocal_813 = iVar811 + 1;
			}
...
void func_225()
{
	if (iVar849 == 0)
	{
		...
		while (iVar3 < 2)
		{
			...
			{
				func_190(&(uVar0[iVar3]), 0, &(Local_359.f_5), &uLocal_906, 0, 0);
				...
				if ((((((iVar904 == 4 || iVar904 == 0) || iVar904 == 8192) || iVar904 == 16) || iVar904 == 256) || iVar904 == 1) || iVar904 == 2)
				{
					if (iVar837 == 0)
					{
						iLocal_839 = 1;
...
{
	func_196();
	if (is_entity_at_coord(&(uLocal_746[0]), vLocal_21 + Vector(1f, -1f, 0f), 1f, 1f, 1f, false, true, 0) || is_ped_on_vehicle(&(uLocal_746[0]), false))
	{
		set_ped_combat_movement(&(uLocal_746[0]), 0);
	}
	else
	{
		set_ped_combat_movement(&(uLocal_746[0]), 2);
	}
	if (!is_ped_dead_or_dying(&(uLocal_746[0]), true))
	{
		if ((!does_blip_exist(&(iLocal_753[0])) && func_228()) && func_430())
		{
			iLocal_753[0] = _blip_add_for_entity(831283580, &(uLocal_746[0]));
			clear_sequence_task(&iLocal_901);
			open_sequence_task(&iLocal_901);
			if ((((iVar904 == 256 || iVar904 == 4) || iVar904 == 16) || iVar904 == 1) || iVar904 == 2)
			{
				task_combat_ped(0, player_ped_id(), 16793600, 0);
			}
			else
			{
				task_combat_ped(0, player_ped_id(), 16777216, 0);
			}
			if (is_ped_on_mount(&(uLocal_746[0])) || func_431(&(uLocal_746[0]), 1868526510))
			{
	...
	if (!is_ped_dead_or_dying(&(uLocal_746[1]), true))
	{
		if (!does_blip_exist(&(iLocal_753[1])) && func_230())
		{
			iLocal_753[1] = _blip_add_for_entity(831283580, &(uLocal_746[1]));
			clear_sequence_task(&uLocal_900);
			open_sequence_task(&uLocal_900);
			if ((((iVar904 == 256 || iVar904 == 4) || iVar904 == 16) || iVar904 == 1) || iVar904 == 2)
			{
				task_combat_ped(0, player_ped_id(), 16793600, 0);
			}
			...
			close_sequence_task(iVar898);
			task_perform_sequence(&(uLocal_746[1]), iVar898);
			clear_sequence_task(&uLocal_900);
		}
	}
}
...
bool func_228()
{
	...
	{
		case 0:
			if (fVar857 <= 0.85f || fVar857 >= 0.99f)
			{
				return true;
			}
			break;
		case 1:
			if (fVar857 <= 0.9f || fVar857 >= 0.99f)
			{
				return true;
			}
			break;
...
bool func_230()
{
	...
	{
		case 0:
			if (fVar857 <= 0.94f || fVar857 >= 0.99f)
			{
				return true;
			}
			break;
		case 1:
			if (fVar857 <= 0.96f || fVar857 >= 0.99f)
			{
				return true;
			}
			break;
...
void func_231()
{
	...
	{
		if (((!_0x1f0e401031e20146(Local_110, "pbl_Cower") && !is_entity_dead(&(uLocal_746[2]))) && iVar827 == 0) && !bVar856)
		{
			_set_anim_scene_playback_list_bool(Local_110, "pbl_Cower", true);
		}
	}
	if (_0x1f0e401031e20146(Local_110, "pbl_Cower"))
	{
		switch (iVar813)
		{
			case 0:
...
void func_232()
{
	if (iVar822 == 0)
	{
		...
		if (func_242(&uLocal_868) >= fVar0)
		{
			if (((!_0x1f0e401031e20146(Local_110, "pbl_Cower") && !is_entity_dead(&(uLocal_746[2]))) && iVar830 == 0) && !bVar856)
			{
				_set_anim_scene_playback_list_bool(Local_110, "pbl_Cower", true);
			}
		}
...
bool func_233()
{
	if ((is_ped_dead_or_dying(&(uLocal_746[0]), true) || is_ped_fatally_injured(&(uLocal_746[0]))) && (is_ped_dead_or_dying(&(uLocal_746[1]), true) || is_ped_fatally_injured(&(uLocal_746[1]))))
	{
		remove_blip(iLocal_753[0]);
		remove_blip(iLocal_753[1]);
		return true;
	}
	if ((is_ped_dead_or_dying(&(uLocal_746[0]), true) || is_ped_fatally_injured(&(uLocal_746[0]))) && _is_ped_hogtied(&(uLocal_746[1])))
	{
		_task_smart_flee_style_ped(&(uLocal_746[1]), Global_35, 4, 0, -1082130432, -1, 0);
		remove_blip(iLocal_753[0]);
		remove_blip(iLocal_753[1]);
		return true;
	}
	if ((is_ped_dead_or_dying(&(uLocal_746[1]), true) || is_ped_fatally_injured(&(uLocal_746[1]))) && _is_ped_hogtied(&(uLocal_746[0])))
	{
		_task_smart_flee_style_ped(&(uLocal_746[0]), Global_35, 4, 0, -1082130432, -1, 0);
		remove_blip(iLocal_753[0]);
		remove_blip(iLocal_753[1]);
		return true;
	}
...
void func_239(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	{
		task_look_at_entity(iParam0, iParam1, -1, 2048, 51, 1);
	}
	else
	{
...
bool func_240()
{
	...
	if (!bVar854)
	{
		if (fVar857 > fVar0 || !_is_anim_scene_started(Local_110, false))
		{
			force_ped_motion_state(&(uLocal_746[0]), -668482597, false, 0, false);
			clear_sequence_task(&iLocal_901);
			open_sequence_task(&iLocal_901);
			task_mount_animal(0, &(uLocal_746[4]), -1, -1, 1f, 1, 0, 0);
			_task_move_in_traffic_2(0, vLocal_15, 2f, 1.2f, 528, 0);
			_task_move_in_traffic(0, 1.2f, 528, 0);
			func_432(&(uLocal_746[0]), &iLocal_901, 0, 0, 1, 1);
			iLocal_856 = 1;
		}
	}
	if (!bVar855)
	{
		if (fVar857 > fVar1 || !_is_anim_scene_started(Local_110, false))
		{
			force_ped_motion_state(&(uLocal_746[1]), -668482597, false, 0, false);
			clear_sequence_task(&uLocal_900);
			open_sequence_task(&uLocal_900);
			task_mount_animal(0, &(uLocal_746[5]), -1, -1, 1f, 1, 0, 0);
			_task_move_in_traffic_2(0, vLocal_15, 2f, 1.2f, 528, 0);
			_task_move_in_traffic(0, 1.2f, 528, 0);
			close_sequence_task(iVar898);
			task_perform_sequence(&(uLocal_746[1]), iVar898);
...
void func_241()
{
	if (!is_entity_dead(&(uLocal_746[2])))
	{
		if (is_scripted_speech_playing(&(uLocal_746[3])) || is_scripted_speech_playing(&(uLocal_746[2])))
		{
...
bool func_243()
{
	...
	{
		case 0:
			if (func_61(&(uLocal_746[2]), player_ped_id(), 1, 1) <= 30f)
			{
				func_241();
				iLocal_826 = 1;
				return true;
			...
			break;
		case 1:
			if (func_61(&(uLocal_746[2]), player_ped_id(), 1, 1) <= 30f || func_61(&(uLocal_746[3]), player_ped_id(), 1, 1) <= 30f)
			{
				func_241();
				iLocal_826 = 1;
				return true;
...
bool func_246()
{
	if (is_ped_on_specific_vehicle(Global_35, iLocal_76))
	{
		return true;
	}
	return false;
...
int func_276(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
{
	fVar0 = func_87(bParam6, fParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_292(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_398();
	...
	else if (fVar0 > iParam4->f_2 || (!func_292(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_398();
		iParam4->f_2 = func_205(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_292(vector3 vParam0, int iParam3)
{
	...
	return func_452(vVar0, vParam0) > func_452(vVar0, get_entity_coords(iParam3, true, false));
}
...
int func_314(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_463(iVar0))
		{
		...
		if (func_464(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_465(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_471(&(uParam1->f_22)));
		...
		if (!func_463(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_474(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_475(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_475(&(uParam1->f_22)));
...
void func_338(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_265(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_344(int iParam0)
{
	...
	if (!func_117(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_345(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_493(to_float(iVar0), 1, 0);
	}
	else
	{
		func_493((to_float(200) / 3f), 1, 0);
	}
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_171(1) || *iParam0 & 8192 != 0))
				{
...
bool func_383(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_510(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_508(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_509(iParam2)
				{
					func_421(iParam2, 1);
					return true;
				}
...
bool func_384(int iParam0, int iParam1)
{
	...
	if (func_502(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_509(iParam1)
		{
...
int func_406(int iParam0, int iParam1)
{
	...
	{
		return func_532(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
bool func_408()
{
	if (is_ped_in_vehicle(Global_35, iLocal_76, false))
	{
		return true;
	}
	return false;
...
void func_409()
{
	if (iVar850 == 0)
	{
		if (!is_entity_dead(&(uLocal_746[2])))
		{
			func_190(&(uLocal_746[2]), 0, &(Local_359.f_5), &uLocal_906, 0, 0);
			if (_is_ped_hogtied(&(uLocal_746[2])) || _is_ped_lassoed(&(uLocal_746[2])))
			{
				if (iVar839 == 0)
				{
					iLocal_841 = 1;
			...
			if ((((iVar904 == 4 || iVar904 == 256) || iVar904 == 1) || iVar904 == 8192) || iVar904 == 2)
			{
				if (iVar841 == 0)
				{
					iLocal_843 = 1;
			...
			if (_0x29fce825613fefca(&(uLocal_746[2]), 500) || _0xd0b7aeb56229d317(Global_35) == &uLocal_746[2])
			{
				if (iVar842 == 0)
				{
					iLocal_844 = 1;
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_537(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_413(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_198(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_564(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_564(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_564(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_564(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_419(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_568(func_567(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_422()
{
	if ((!is_ped_facing_ped(player_ped_id(), &(uLocal_746[0]), 80f) && !is_ped_facing_ped(player_ped_id(), &(uLocal_746[1]), 80f)) && get_entity_speed(Global_35) >= 0.1f)
	{
		return true;
	}
	return false;
...
void func_425(int iParam0, int iParam1)
{
	...
	if (absf(fVar12) > fVar13)
	{
		...
		else if (func_571(vVar0, vVar0 + vVar6, get_entity_coords(iParam1, true, false)))
		{
			iLocal_793 = 1;
		}
		else
...
bool func_430()
{
	switch (iLocal_14)
	{
		case 0:
			...
			if (_0x1f0e401031e20146(Local_110.f_1, "pbl_Action_P0"))
			{
				if (fVar858 >= 0.59f && fVar858 <= 0.65f)
				{
					return false;
				}
				else if (fVar858 > 0.65f)
				{
					return true;
				}
				else
			...
			if (_0x1f0e401031e20146(Local_110.f_1, "pbl_Action_P3"))
			{
				if (fVar858 <= 0.26f)
				{
					return false;
				}
				else if (fVar858 > 0.26f)
				{
					return true;
				}
				else
			...
			if (!_0x1f0e401031e20146(Local_110.f_1, "pbl_Action_P0") && !_0x1f0e401031e20146(Local_110.f_1, "pbl_Action_P3"))
			{
				iLocal_845 = 1;
			}
			if (iVar843 == 1)
			{
				if (_0x1f0e401031e20146(Local_110.f_1, sVar860))
				{
					iLocal_850 = 1;
				}
				if (iVar848 == 1)
				...
				if (!has_entity_been_damaged_by_entity(&(uLocal_746[0]), Global_35, 1, 1))
				{
					if (iVar848 == 0)
					{
						_set_anim_scene_playback_list_bool(Local_110.f_1, sVar860, true);
					}
				}
				else
				{
...
void func_444(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_338(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_339(iParam0, 1);
	if (!bParam2)
	{
		func_441(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_584(iParam0))
		{
...
bool func_450(vector3 vParam0)
{
	...
	{
		if (!func_107(*Global_1310750->f_16043[iVar0]))
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_596(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_600(0))
				{
					...
					func_601(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_484(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_275(Global_1310750[iVar0], iParam0))
		{
			if (!func_264(iVar0))
			{
				iVar1 = 1;
...
bool func_506(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_61(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_615(iVar0, 0)))
		{
...
bool func_510(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_615(iVar0, 0)))
		{
			if (func_617(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_527(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_61(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_530(int iParam0)
{
	...
	return func_621((*Global_1347702)[58]->f_15, 1);
}
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_3(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_627(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_540(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_631(Global_35)) || func_632(Global_35)) || func_633(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_253((*uParam4)[iVar0]->f_6);
		func_634(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_635(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_636(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_79(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_545(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_634(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
int func_552(int iParam0)
{
	...
	fVar1 = func_87(absf(fVar1) < 1f, func_87(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_654((get_game_timer() + iParam2), !bParam1);
...
void func_559(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_656(iParam0));
...
void func_576(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_668(iVar0), func_296(), 1))
			{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					...
					func_268(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
struct<4> func_598(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_687(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_599(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_687(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_600(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_687(bParam0));
}
...
void func_602(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_420(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_616(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_617(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
void func_637(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_130((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
bool func_665(int iParam0, int iParam1, var uParam2)
{
	if (!func_664(iParam0))
	{
		return false;
...
bool func_684(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_687(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_685(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_687(bParam6), &Var0, 0);
	return uVar4;
}
...
void func_694(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_253(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_640(iParam1))
		{
			...
			iParam1->f_6 = func_722(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824, 0, 1704213876, iParam1->f_10, 0);
			if (func_253(iParam1->f_6))
			{
				if (!bParam6)
				{
...
{
	return (shift_right(iParam0, 26) & 31 * func_568(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
