...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "DIWP_MAN", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -3f, -2f, 0f), (94f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "DIWP_DOG", 626176009, _get_object_offset_from_coords(vParam1, vParam4.z, -5f, -2f, 0f), (-85f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	...
	func_50(uParam0, "WAGON", -283162583, vParam1, vParam4.z, 0, 0, 0, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				func_70(&(uParam0->f_20[0]), 1546182539, 0, 0, 0, -1082130432);
				func_71(uParam0->f_20[0], 0, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_68(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				func_69(&(uParam0->f_20[1]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
				set_ped_config_flag(&(uParam0->f_20[1]), 297, true);
				set_ped_config_flag(&(uParam0->f_20[1]), 130, false);
				set_ped_config_flag(&(uParam0->f_20[1]), 262, true);
				func_70(&(uParam0->f_20[1]), 1951165908, 0, 0, 0, -1082130432);
				func_71(uParam0->f_20[1], 0, 1);
			}
			iLocal_9 = 1;
			break;
		case 1:
			...
			{
				func_67(uParam0);
				task_enter_vehicle(&(uParam0->f_20[1]), uParam0->f_453, -1, 3, 1f, 1, 0);
				task_enter_vehicle(&(uParam0->f_20[0]), uParam0->f_453, -1, -1, 1f, 131072, 0);
			...
			break;
		case 2:
			bVar0 = func_73(&(uParam0->f_20[0]), uParam0->f_453, 0);
			bVar1 = func_73(&(uParam0->f_20[1]), uParam0->f_453, 0);
			if (bVar0 && bVar1)
			{
				func_74(&uLocal_38);
				iLocal_9 = 3;
			...
			else
			{
				if (!bVar1)
				{
					if (!func_75(&(uParam0->f_20[1]), -1794415470))
					{
						task_enter_vehicle(&(uParam0->f_20[1]), uParam0->f_453, -1, 3, 1f, 1, 0);
					}
				}
				if (!bVar0)
				{
					if (!func_75(&(uParam0->f_20[0]), -1794415470))
					{
						task_enter_vehicle(&(uParam0->f_20[0]), uParam0->f_453, -1, -1, 1f, 131072, 0);
					}
				}
...
float func_116(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_169(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_167(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_219(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_219(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_219(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
