...
void func_5()
{
	if (Local_844.f_44)
	{
		if (does_entity_exist(&(iLocal_82[0])) && !func_34(&(iLocal_82[0]), 0, 0))
		{
			_0xcc3edc5614b03f61(77);
		}
		else
		{
			set_ped_keep_task(&(iLocal_82[0]), true);
			_0x39a2fc5af55a52b1(&(iLocal_82[0]), -1);
			func_35(iLocal_82[0], 1);
			if (func_36(&(iLocal_82[0])))
			{
				iVar0 = get_mount(&(iLocal_82[0]));
				set_ped_keep_task(iVar0, true);
				_0x39a2fc5af55a52b1(iVar0, -1);
			}
			_0xcc3edc5614b03f61(33);
		}
	}
	iVar1 = 0;
	while (iVar1 < 5)
	{
		if (func_34(Local_670[iVar1]->f_11, 0, 1))
		{
			set_ped_config_flag(Local_670[iVar1]->f_11, 214, false);
		}
		iVar1++;
	}
	...
	_0x5a4e1a41e3a02ad0(&(iLocal_23[4]), 5, 0);
	_0x5a4e1a41e3a02ad0(&(iLocal_23[4]), 3, 0);
	_0xd17672447692478e(&(iLocal_23[4]), 0);
	func_40(&iLocal_82);
	func_41();
	func_17(1);
	func_42(&uLocal_33);
	...
	func_42(&uLocal_39);
	func_42(&uLocal_42);
	func_43(&Local_844, &iLocal_82, &uLocal_664, 0, uVar832, uVar831, 0, 1, 0, 1);
	func_32(1);
	_0x710448d44a64c213(1);
	func_44(Local_1038);
	remove_shocking_event(iVar836);
	_0x4f81ead1de8fa19b(_0x112ddf56300bc6e5(874853533));
...
void func_7()
{
	if (iLocal_76 < 8)
	{
		if ((((func_46(Global_35, &(iLocal_23[1]), 1, 0) || func_46(Global_1935630->f_41, &(iLocal_23[1]), 1, 0)) && _0x3ab6c7b0bb0df4b1(&(iLocal_82[1]), iVar1036)) && !func_37(16, 0)) && !func_37(4, 0))
		{
			if (!func_47(0, 0))
			{
...
bool func_8()
{
	switch (iLocal_75)
	{
		...
		case 1:
			...
			if (!_is_anim_scene_loaded(iVar1036, true, false))
			{
				return false;
			}
			if (!has_anim_dict_loaded(sVar1044))
			{
				return false;
			}
			if (!func_55())
...
int func_15()
{
	clear_area(vLocal_14, 40f, 1064960);
	if (iVar836 == 0)
	{
		iLocal_838 = add_shocking_event_at_position(-998484125, Local_844.f_51, 60f, 60f, 80f, -1f, -1f, 4, 4);
	}
	if (is_position_occupied(Local_844.f_51, 20f, false, true, false, false, false, 0, false))
	{
...
int func_16(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_65() || !func_66((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return 0;
		}
		iVar0++;
...
void func_18()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			if (!is_string_null_or_empty(&(Local_670[iVar0]->f_23)))
			{
				func_70(&(iLocal_82[iVar0]), &(Local_670[iVar0]->f_23), 0);
			}
			if (&iLocal_82[iVar0] == &iLocal_82[1])
			{
				func_71(&(iLocal_82[iVar0]), &Local_844, 0);
			}
			Local_111[iVar0]->f_3 = iVar0;
			_0x18ff3110cf47115d(&(iLocal_82[iVar0]), 0, 1);
			set_ped_config_flag(&(iLocal_82[iVar0]), 113, true);
			set_ped_combat_attributes(&(iLocal_82[iVar0]), 58, true);
			set_ped_combat_attributes(&(iLocal_82[iVar0]), 46, true);
			set_blocking_of_non_temporary_events(&(iLocal_82[iVar0]), true);
			if (func_72(Local_111[iVar0]->f_3, 1))
			{
				func_73(Local_89, &(iLocal_82[iVar0]));
				func_74(&(Local_844.f_5), &(iLocal_82[iVar0]), Local_670[iVar0]->f_11, 0);
				set_ped_config_flag(&(iLocal_82[iVar0]), 113, true);
				set_ped_config_flag(&(iLocal_82[iVar0]), 317, false);
				set_ped_config_flag(&(iLocal_82[iVar0]), 301, false);
				set_ped_config_flag(&(iLocal_82[iVar0]), 159, true);
				if (func_34(Local_670[iVar0]->f_11, 0, 1))
				{
					set_ped_config_flag(Local_670[iVar0]->f_11, 113, true);
					set_ped_config_flag(Local_670[iVar0]->f_11, 214, true);
				}
				if (Local_111[iVar0]->f_3 == 3)
				{
					Local_111[iVar0]->f_11 = -149.03f;
					Local_111[iVar0] = 1;
				}
				else if (Local_111[iVar0]->f_3 == 4)
				{
					Local_111[iVar0]->f_11 = -107.87f;
					Local_111[iVar0] = 1;
				}
				_request_ped_emotional_preset(&(iLocal_82[iVar0]), "TaskCombat_Medium");
			}
			if (Local_111[iVar0]->f_3 == 0)
			{
				stop_ped_speaking(&(iLocal_82[iVar0]), true);
				set_ped_config_flag(&(iLocal_82[iVar0]), 130, true);
				set_ped_config_flag(&(iLocal_82[iVar0]), 167, false);
				set_ped_config_flag(&(iLocal_82[iVar0]), 301, true);
				set_ped_config_flag(&(iLocal_82[iVar0]), 297, false);
			}
			func_75(&(iLocal_82[iVar0]), 1);
			set_ped_config_flag(&(iLocal_82[iVar0]), 6, true);
		}
		iVar0++;
	}
...
void func_19()
{
	iLocal_23[0] = _create_volume_cylinder_with_custom_name(func_78(1), 0f, 0f, 17f, 11f, 15f, 7f, "volWarn");
	iLocal_23[1] = _create_volume_box_with_custom_name(-3629.785f, -2607.092f, -14.241f, 0f, 0f, 25f, 10.019f, 6.724f, 8f, "volBypass");
	iLocal_23[2] = _create_volume_cylinder_with_custom_name(-3629.785f, -2607.092f, -14.241f, 0f, 0f, 25f, 30f, 30f, 8f, "volAvoid");
	iLocal_23[4] = _create_volume_box_with_custom_name(-3652.028f, -2612.489f, -14.241f, 0f, 0f, 0f, 60f, 50f, 8f, "volRoadBlock");
	_0xb56d41a694e42e86(&(iLocal_23[2]), 10208, 0, 0, -1, -1, 0);
	iLocal_23[5] = _create_volume_aggregate_with_custom_name("volHorseAvoid");
	_0x39816f6f94f385ad(&(iLocal_23[5]), -3648.4f, -2619.293f, -12.378f, 0f, 0f, 0f, 7f, 4f, 5f);
	_0x39816f6f94f385ad(&(iLocal_23[5]), -3657.305f, -2619.293f, -12.378f, 0f, 0f, 0f, 6f, 4f, 5f);
}
...
void func_20()
{
	...
	while (iVar0 < 5)
	{
		remove_all_ped_weapons(&(iLocal_82[iVar0]), true, true);
		switch (iVar0)
		{
			case 2:
				func_79(&(iLocal_82[iVar0]), -183018591, -1, 1, 0, 1056964608, 1065353216, 0);
				break;
			case 0:
...
void func_22()
{
	...
	_0xb03944057fd735ba(&(iLocal_23[4]), 5, 0);
	_0xb03944057fd735ba(&(iLocal_23[4]), 3, 0);
	_0xc1799fafd2fdf52b(&(iLocal_23[4]), 0, 0, 0);
}
...
void func_25()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			set_blocking_of_non_temporary_events(&(iLocal_82[iVar0]), false);
		}
		iVar0++;
	}
	if (((iLocal_76 == 8 && func_34(&(iLocal_82[0]), 0, 1)) && !func_37(1, 0)) && _0x3ec28da1ffac9ddd(&(iLocal_82[0]), Global_35, 1, 1))
	{
		func_83(&(iLocal_82[0]), 942020339, 1);
		func_39(1);
	}
	if (func_84(&iLocal_82, &(Local_844.f_5), &iLocal_73, &uLocal_839, 0, 4, 1))
	{
		if (func_85(iVar837, iLocal_73))
		{
			Local_844.f_46 = 1;
			if (_is_anim_scene_started(iVar1036, false))
			{
			}
			func_86(iVar837);
			switch (iLocal_73)
			{
				case 16:
					if (get_coords_of_projectile_type_within_distance(&(iLocal_82[iVar837]), -1504859554, 20f, &vLocal_17, 0, 0))
					{
						func_39(65536);
						set_blocking_of_non_temporary_events(&(iLocal_82[0]), false);
						set_blocking_of_non_temporary_events(&(iLocal_82[3]), false);
						set_blocking_of_non_temporary_events(&(iLocal_82[4]), false);
						set_blocking_of_non_temporary_events(&(iLocal_82[1]), false);
						set_blocking_of_non_temporary_events(&(iLocal_82[2]), false);
						add_shocking_event_at_position(-966930978, vLocal_17, -1f, -1f, -1f, -1f, -1f, -1, -1);
					}
					break;
			}
			func_39(16);
			...
			{
				if (&iLocal_82[iVar837] == &iLocal_82[2] || _0x3ec28da1ffac9ddd(&(iLocal_82[2]), Global_35, 1, 1))
				{
					func_39(2097152);
				}
			}
		}
		else if (&iLocal_82[iVar837] == &iLocal_82[0])
		{
			if (func_24() == 8)
			{
				if (!func_37(1, 0))
			...
			else if (!func_37(16, 0) || func_24() >= 9)
			{
				switch (iLocal_73)
				{
					...
					case 8192:
						...
						break;
					case 8:
						if ((func_88(Global_35, 1, 0, 0) != 2055893578 && func_37(128, 0)) && !func_37(1, 0))
						{
							func_39(1);
						}
						else
...
bool func_26()
{
	...
	if (iLocal_76 >= 1)
	{
		...
		if (_is_anim_scene_started(iVar1036, false))
		{
			fLocal_841 = _get_anim_scene_time(iVar1036);
		}
		if (!func_37(131072, 0))
		{
			if (is_interior_ready(iVar835))
			{
				pin_interior_in_memory(iVar835);
				func_39(131072);
			}
		}
	}
	...
	switch (iLocal_76)
	{
		case 0:
			func_98(1, 1);
			iLocal_837 = get_interior_from_entity(&(iLocal_82[0]));
			if (!func_37(131072, 0))
			{
				if (is_interior_ready(iVar835))
				{
			...
			_0x14ff0c2545527f9b(Local_670[2]->f_11, -183018591, &(iLocal_82[2]));
			remove_weapon_from_ped(&(iLocal_82[2]), -183018591, true, -142743235);
			func_21(1);
			break;
		case 1:
			if (is_interior_ready(iVar835))
			...
			if (func_80(Global_35, Local_844.f_51, 1) <= 60f || !is_entity_occluded(&(iLocal_82[1])))
			{
		...
		case 2:
			func_103(&fLocal_841);
			if (!get_anim_scene_bool(iVar1036, "Bool"))
			{
				set_anim_scene_bool(iVar1036, "Bool", true, false);
			}
			...
			if (func_104(&(iLocal_82[1]), &(iLocal_82[0]), 4, 1) || fVar839 > 20.8f)
			{
				Local_844.f_44 = 1;
				func_21(4);
			}
		...
		case 4:
			...
			if (func_104(&(iLocal_82[2]), &(iLocal_82[1]), 9, 1) || fVar839 > 38.3f)
			{
				func_21(6);
			}
			break;
		case 6:
			...
			if (func_104(&(iLocal_82[1]), &(iLocal_82[0]), 16, 1) || fVar839 > 59.3f)
			{
				set_anim_scene_entity(iVar1036, "HORSE_A", Local_670[1]->f_11, 0);
				set_anim_scene_entity(iVar1036, "HORSE_B", Local_670[4]->f_11, 0);
				set_anim_scene_entity(iVar1036, "HORSE_C", Local_670[2]->f_11, 0);
				set_anim_scene_entity(iVar1036, "HORSE_D", Local_670[3]->f_11, 0);
				if (!func_37(524288, 0))
				{
		...
		case 8:
			if (!func_37(32, 0))
			{
				if (func_110(0))
				{
					...
					while (iVar0 < 5)
					{
						if (func_34(Local_670[iVar0]->f_11, 0, 1))
						{
							set_ped_config_flag(Local_670[iVar0]->f_11, 214, false);
						}
						iVar0++;
					}
					func_39(32);
			...
			else
			{
				...
				{
					iVar1 = _0xcd66fea29400a0b5(&(iLocal_82[0]));
					iVar2 = Global_35;
					if (iVar1 == iVar2)
					{
						_0x4707e9c23d8ca3fe(&(iLocal_82[0]), Global_35);
					}
				}
				if (func_114(0))
				{
					...
					if (!func_34(&(iLocal_82[0]), 0, 1))
					{
						if (_is_ped_hogtied(&(iLocal_82[0])))
						{
							func_21(11);
						}
						else
					...
					else if (!func_93(0, 1, 0))
					{
						...
						{
							clear_ped_tasks(&(iLocal_82[0]), 1, 0);
							func_87(&(Local_844.f_5), &iLocal_73);
							set_blocking_of_non_temporary_events(&(iLocal_82[0]), true);
						}
						func_111(128);
						iLocal_842 = func_119(&iLocal_82);
					}
					else
					{
						if (func_120(&(iLocal_82[0])))
						{
							_hide_ped_weapons(&(iLocal_82[0]), 2, true);
						}
				...
				{
					func_123();
					if ((func_34(Local_670[2]->f_11, 0, 1) && func_124(Local_670[2]->f_11, Local_670[2]->f_15, 0.5f, 1, 1)) && !func_109(Local_670[2]->f_11, Global_35, 4f, 1))
					{
						if (func_109(&(iLocal_82[2]), Local_670[2]->f_11, 2f, 1) && !is_ped_in_combat(&(iLocal_82[2]), 0))
						{
							if (func_125(&(iLocal_82[2]), -1569615261, 1, 0))
							{
								func_79(&(iLocal_82[2]), -594562071, -1, 1, 0, 1056964608, 1065353216, 0);
							}
							else if (!is_ped_in_combat(&(iLocal_82[2]), Global_35))
							{
								task_combat_ped(&(iLocal_82[2]), Global_35, 0, 0);
							}
						}
					}
					else if (!is_ped_in_combat(&(iLocal_82[2]), 0))
					{
						task_combat_ped(&(iLocal_82[2]), Global_35, 0, 0);
					}
				}
		...
		case 9:
			...
			else if (func_13(&uLocal_45, 2f))
			{
				...
				if (!func_120(&(iLocal_82[0])))
				{
					if ((func_109(&(iLocal_82[0]), Global_35, 10f, 1) && has_entity_clear_los_to_entity_in_front(&(iLocal_82[0]), Global_35, 17)) && func_128(&(iLocal_82[0]), Global_35))
					{
						if (!func_93(0, 4096, 0))
						{
							func_117(0, 4096);
					...
					else if (!func_11(&uLocal_67))
					{
						...
						task_follow_to_offset_of_entity(&(iLocal_82[0]), Global_35, 0f, 0f, 0f, 1f, -1, 8f, 1, 1, 1, 0, 1);
						func_12(&uLocal_67, 0);
						func_106(0, 1, 0);
					}
					else if (func_13(&uLocal_67, 10f) && !func_37(8192, 0))
					{
						if (!func_131(32, 0))
						{
							clear_ped_secondary_task(&(iLocal_82[0]));
							func_132(32);
							iLocal_78 = 3;
						}
					}
					...
					if (func_131(32, 0) && !is_entity_playing_anim(&(iLocal_82[0]), sVar1044, "I_DONT_KNOW_POLICE", 1))
					{
						remove_blip(uLocal_664[0]);
						if (func_133(&(Local_670[0]->f_11)))
						{
							if (!func_134(&(iLocal_82[0]), Local_670[0]->f_11, 0, 1f))
							{
								func_39(1048576);
							}
						}
		...
		case 10:
			...
			if (func_36(&(iLocal_82[0])) || func_37(1048576, 0))
			{
				if (!func_93(0, 1, 0))
				{
					_task_move_in_traffic_3(&(iLocal_82[0]), Global_35, 1f, 0, 0);
					func_117(0, 1);
				}
			}
			else if (func_135(Local_670[0]->f_11))
			{
				if (!func_136(Local_670[0]->f_11, &(iLocal_82[0])))
				{
					if (func_133(&(Local_670[0]->f_11)))
					{
						func_134(&(iLocal_82[0]), Local_670[0]->f_11, 0, 1f);
					}
					else
					{
						func_39(1048576);
		...
		case 11:
			if (func_34(&(iLocal_82[0]), 0, 1))
			{
				if (!func_131(8192, 0))
				{
					...
					_0x30b391915538ebe2(&(iLocal_82[0]));
					func_83(&(iLocal_82[0]), 942020339, 1);
					func_138(&(iLocal_82[0]), uLocal_664[0], 831283580, 580546400, 0, 0);
				}
				if (!is_ped_in_combat(&(iLocal_82[0]), 0))
				{
					task_combat_ped(&(iLocal_82[0]), Global_35, 0, 0);
				}
			}
			else if (func_114(0))
			{
...
void func_31(var uParam0)
{
	...
	{
		iVar1 = iVar0;
		(*uParam0)[iVar0]->f_1 = func_158(iVar1);
		(*uParam0)[iVar0]->f_3 = func_159(iVar1);
		StringCopy(&((*uParam0)[iVar0]->f_23), func_160(iVar1), 64);
		(*uParam0)[iVar0]->f_6 = { func_78(iVar1) };
		(*uParam0)[iVar0]->f_9 = func_161(iVar1);
		if (func_72(iVar1, 1))
		{
			(*uParam0)[iVar0]->f_12 = func_162(5, 0, 1);
			(*uParam0)[iVar0]->f_13 = 0;
			(*uParam0)[iVar0]->f_19 = 1;
			(*uParam0)[iVar0]->f_15 = { func_163(iVar1) };
			(*uParam0)[iVar0]->f_18 = func_164(iVar1);
		}
		else
		{
			(*uParam0)[iVar0]->f_12 = 0;
		}
		func_165(&(Local_670[iVar0]->f_22));
		iVar0++;
	}
	func_166(uParam0);
}
...
void func_40(int iParam0)
{
	...
	while (iVar0 < 5)
	{
		bVar1 = func_170(iParam0[iVar0], Local_670[iVar0]->f_11, 0);
		if (func_171(&(iLocal_82[iVar0]), 180f, 30f, -1082130432, -1082130432))
		{
			set_ped_as_no_longer_needed((*iParam0)[iVar0]);
			if (bVar1)
			{
				set_ped_as_no_longer_needed(&(Local_670[iVar0]->f_11));
			}
		}
		else
		{
			_0x39a2fc5af55a52b1(iParam0[iVar0], -1);
			if (bVar1)
			{
				_0x39a2fc5af55a52b1(Local_670[iVar0]->f_11, -1);
			}
		}
		iVar0++;
	}
...
void func_41()
{
	...
	while (iVar0 < 6)
	{
		if (_does_volume_exist(&(iLocal_23[iVar0])))
		{
			_delete_volume(&(iLocal_23[iVar0]));
		}
		iVar0++;
	}
}
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_172(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
			...
			if (!uParam0->f_50)
			{
				if (func_34(iParam1[iVar0], 0, 1))
				{
					...
					if (!bVar3)
					{
						if (!bParam6)
						{
							func_178(iParam1[iVar0], 1073741824, func_177(iVar0 < iVar2, &(uParam0->f_98[iVar0]), -1f), iVar1, 0);
						}
						else
						{
...
int func_49(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_191(func_190(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_52()
{
	...
	request_anim_dict(sVar1044);
	if (!is_string_null_or_empty(Local_1038.f_4))
	{
		Local_1038 = _create_anim_scene(Local_1038.f_4, 0, 0, false, true);
		if (!_is_anim_scene_loaded(iVar1036, true, false))
		{
			load_anim_scene(iVar1036);
		}
	}
}
...
bool func_55()
{
	uVar0 = _0x112ddf56300bc6e5(874853533);
	if (_0x800df3fc913355f3(uVar0))
	{
		iVar1 = _0x31c70a716cae1fee(uVar0);
		iVar2 = _0xf8de7154f7d1458f(uVar0);
		if (func_34(iVar1, 0, 1))
		{
			if (Local_844.f_161 || is_entity_occluded(iVar1))
			{
				if (does_entity_exist(iVar2))
				{
					if (is_entity_occluded(iVar2) || Local_844.f_161)
					{
						_0x7b204f88f6c3d287(uVar0);
...
void func_56()
{
	if (func_195())
	{
		if (!_does_anim_scene_exist(iVar1036))
		{
			return;
		}
		sVar0 = func_196(0);
		if (_0x0df57f86fe71dbe5(iVar1036, sVar0) || _0x23e33cb9f4a3f547(iVar1036, sVar0))
		{
			return;
		}
		_0xdf7b5144e25cd3fe(iVar1036, func_196(0));
	}
}
...
bool func_60(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	if (Param4.f_6 > -1)
	{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_211(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
...
bool func_61(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_215(iParam1, func_214(uParam0), &(uParam0->f_172)))
		{
...
void func_63(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_62(uParam0->f_3, 1))
	{
		func_217(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
	...
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_222(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
void func_77()
{
	...
	while (iVar0 < 5)
	{
		...
		if (iVar1 == 0)
		{
			...
			func_236(Local_612[0], "INTERACT_GREET", func_48(48), -163964935, 0, 0, 0, 1, 0);
			func_236(Local_612[2], "INTERACT_INSULT", func_48(49), 648122183, 0, 0, 0, 1, 0);
		}
		else if (func_72(iVar1, 1))
		{
			func_235(&(iLocal_82[iVar0]), &(Local_111[iVar0]->f_35), 20f, 3, 0, 0, 0, 0, 0);
			func_236(Local_111[iVar0]->f_35[0], "INTERACT_GREET", "", -163964935, 0, 0, 0, 1, 0);
			func_237(Local_111[iVar0]->f_35[0], 20f);
			func_236(Local_111[iVar0]->f_35[2], "INTERACT_INSULT", "", 648122183, 0, 0, 0, 1, 0);
			func_237(Local_111[iVar0]->f_35[2], 20f);
		}
		iVar0++;
	}
}
...
bool func_82(int iParam0, float fParam1)
{
	if (!is_entity_dead(iParam0))
	{
		if (get_coords_of_projectile_type_within_distance(iParam0, -1504859554, fParam1, &uVar0, 0, 0))
		{
			return true;
		}
		if (get_coords_of_projectile_type_within_distance(iParam0, 1885857703, fParam1, &uVar0, 0, 0))
		{
			return true;
		}
	}
...
bool func_84(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_248(iParam0[*uParam3], 0, iParam1, iParam2, 0, 0))
		{
			return true;
		}
		*uParam3++;
...
bool func_85(int iParam0, int iParam1)
{
	...
	else if (iLocal_76 < 8)
	{
		...
		while (iVar1 < 5)
		{
			if (func_72(iVar1, 1) && (_0x3ec28da1ffac9ddd(&(iLocal_82[iVar1]), Global_35, 1, 1) || (func_34(Global_1935630->f_41, 0, 1) && _0x3ec28da1ffac9ddd(Global_1935630->f_41, Global_35, 1, 1))))
			{
				return true;
			}
			iVar1++;
...
void func_86(int iParam0)
{
	...
	{
		Local_111[3]->f_13 = 0.5f;
	}
	if (iParam0 == 4)
	{
		Local_111[4]->f_13 = 0.5f;
	}
	else
	{
		Local_111[4]->f_13 = 0.5f;
...
{
	func_253(&(Local_111[iParam0]->f_14), 0);
	if (func_34(&(iLocal_82[iParam0]), 0, 0))
	{
		set_ped_config_flag(&(iLocal_82[iParam0]), 301, false);
		set_ped_config_flag(&(iLocal_82[iParam0]), 317, true);
		set_ped_config_flag(&(iLocal_82[iParam0]), 297, true);
	}
	if (bParam1)
	{
		if (!func_254(Local_111[iParam0]->f_35[0], 0))
		{
			func_255(Local_111[iParam0]->f_35[0], 1, 0);
		}
	}
	else if (func_254(Local_111[iParam0]->f_35[0], 0))
	{
		func_255(Local_111[iParam0]->f_35[0], 0, 0);
	}
	if (bParam2)
	{
		if (!func_254(Local_111[iParam0]->f_35[2], 0))
		{
			func_255(Local_111[iParam0]->f_35[2], 1, 0);
		}
	}
	else if (func_254(Local_111[iParam0]->f_35[2], 0))
	{
		func_255(Local_111[iParam0]->f_35[2], 0, 0);
	}
	if (bParam3)
	{
		func_236(Local_111[iParam0]->f_35[0], "", "", -163964935, 0, 0, 0, 1, 0);
		func_236(Local_111[iParam0]->f_35[2], "", "", 648122183, 0, 0, 0, 1, 0);
		set_ped_config_flag(&(iLocal_82[iParam0]), 315, true);
		set_ped_config_flag(&(iLocal_82[iParam0]), 301, true);
		set_ped_config_flag(&(iLocal_82[iParam0]), 317, false);
		set_ped_config_flag(&(iLocal_82[iParam0]), 297, false);
		_0xe98d55c5983f2509(&(iLocal_82[iParam0]));
	}
}
	...
	else
	{
		...
		while (iVar0 < 5)
		{
			if (&Local_111[iVar0])
			{
				...
				switch (Local_111[iVar0]->f_2)
				{
					case 0:
						func_42(&(Local_111[iVar0]->f_88));
						if (&iLocal_82[iVar0] == func_257())
						{
							if (Local_111[iVar0]->f_2 < 7 && func_37(33554432, 0))
							{
								if (func_34(&(iLocal_82[0]), 0, 1))
								{
									func_258(iVar0);
									func_39(64);
									func_117(iVar0, 4);
									func_259(Local_111[iVar0]->f_3, 1);
								}
								else if (func_89(0, 1, Global_35, 1))
								{
									...
									func_39(64);
									func_117(iVar0, 4);
									func_259(Local_111[iVar0]->f_3, 9);
								}
							}
						}
						...
						else if (!_0x3ab6c7b0bb0df4b1(&(iLocal_82[iVar0]), iVar1036))
						{
					...
					case 1:
						if (!func_262(iVar0, bVar2))
						{
							if (func_263(iVar0))
							{
								...
								{
									func_259(Local_111[iVar0]->f_3, 2);
								}
								else if (func_37(33554432, 0))
								{
									iLocal_843 = 1;
									func_259(Local_111[iVar0]->f_3, 7);
								}
								else
								{
									if (Local_111[iVar0]->f_12 == 0f || Local_111[iVar0]->f_12 > func_80(&(iLocal_82[iVar0]), Global_36, 1))
									{
										Local_111[iVar0]->f_12 = func_80(&(iLocal_82[iVar0]), Global_36, 1);
									}
									if (!func_47(2097152, 0))
									{
										func_259(Local_111[iVar0]->f_3, 5);
									}
									else if (!func_47(4194304, 0))
									{
										func_259(Local_111[iVar0]->f_3, 6);
									}
									else
									{
										iLocal_843 = 1;
					...
					case 3:
						if (!func_266(&(iLocal_82[iVar0]), 242628503))
						{
							...
							if (!_0x3ab6c7b0bb0df4b1(&(iLocal_82[iVar0]), iVar1036))
							{
								set_anim_scene_entity(iVar1036, func_267(iVar0), &(iLocal_82[iVar0]), 0);
							}
							Local_111[iVar0]->f_12 = (func_80(&(iLocal_82[iVar0]), Global_36, 1) - 0.5f);
							func_259(Local_111[iVar0]->f_3, 0);
						}
						break;
					case 5:
					...
					case 6:
						...
						break;
					case 7:
						if (!func_11(&(Local_111[iVar0]->f_88)))
						{
							func_12(&(Local_111[iVar0]->f_88), 0);
						}
						if (func_262(iVar0, bVar2) && func_89(0, 1, Global_35, 1))
						{
							func_111(256);
						...
						else if (func_270(iVar0, bVar841))
						{
							func_259(Local_111[iVar0]->f_3, 9);
						}
						break;
						...
						if (func_89(0, 1, &(iLocal_82[1]), 1) || func_37(8388608, 0))
						{
							if (func_37(256, 0))
							{
								...
								else
								{
									...
									{
										func_259(Local_111[iVar0]->f_3, 10);
									}
...
void func_92(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_72(iVar0, 1))
		{
			if (func_34(Local_670[iVar0]->f_11, 0, 1))
			{
				if (!func_135(Local_670[iVar0]->f_11))
				{
					if (func_272(&(iLocal_23[5]), get_entity_coords(Local_670[iVar0]->f_11, true, false)))
					{
						if (!is_ped_fleeing(Local_670[iVar0]->f_11))
						{
							_task_flee_from_coord(Local_670[iVar0]->f_11, Local_670[iVar0]->f_15, 0f, 0f, 0f, 8f, -1, 16640, 1.001f, 0);
						}
					}
				}
				else if (!func_37(8388608, 0))
				{
					if (_get_rider_of_mount(Local_670[iVar0]->f_11, true) == Global_35 || (bParam0 && !func_124(Local_670[iVar0]->f_11, Local_670[iVar0]->f_15, 0.5f, 1, 1)))
					{
						func_39(8388608);
					}
				}
...
{
	if (func_2(Local_111[iParam0]->f_4, iParam1))
	{
		if (bParam2)
		{
		}
...
void func_94()
{
	iVar0 = func_274(iLocal_82[0], &(Local_111[0]->f_14), 8f, &Local_612, &(Local_844.f_192), 0f, 1, 0, 0, func_273(3, 0, 0), 0, 0, 2, 0, -1082130432, 0);
	if (iVar0 != -1)
	{
		if (func_275(&(Local_111[0]->f_14)))
		{
			func_276(&(Local_111[0]->f_35), 0, 0);
		}
	}
	...
	switch (iVar0)
	{
		case 0:
			if (!func_131(64, 0))
			{
				task_play_anim(Global_35, sVar1044, "GOODBYE_POS", 1.5f, -1.5f, -1, 67112976, 0f, false, 0, false, 0, false);
				task_play_anim(&(iLocal_82[0]), sVar1044, "GOODBYE_POS_POLICE", 1.5f, -1.5f, -1, 67112976, 0f, false, 0, false, 0, false);
				func_132(64);
			}
			func_253(&(Local_111[0]->f_14), 0);
			break;
		case 2:
			if (!func_131(128, 0))
			{
				task_play_anim(Global_35, sVar1044, "GOODBYE_NEG", 1.5f, -1.5f, -1, 67112976, 0f, false, 0, false, 0, false);
				task_play_anim(&(iLocal_82[0]), sVar1044, "GOODBYE_NEG_POLICE", 1.5f, -1.5f, -1, 67112976, 0f, false, 0, false, 0, false);
				func_132(128);
			}
			func_253(&(Local_111[0]->f_14), 0);
			break;
...
void func_95()
{
	...
	while (iVar0 < 5)
	{
		if (&Local_111[iVar0])
		{
			iVar1 = func_274(iLocal_82[iVar0], &(Local_111[iVar0]->f_14), 20f, &(Local_111[iVar0]->f_35), &(Local_844.f_192), 0f, 1, 0, 0, func_273(3, 0, 0), 0, 0, 2, 0, -1082130432, 0);
			if (func_34(&(iLocal_82[iVar0]), 0, 1))
			{
				if (!func_37(16, 0) && !func_37(33554432, 0))
				{
					if (!func_277(iVar0))
					{
						...
						{
							func_276(&(Local_111[iVar0]->f_35), 1, 1);
							func_279(Local_111[iVar0]->f_35[0], func_278(8));
							Local_111[iVar0]->f_35[0]->f_13 = func_48(32);
							Local_111[iVar0]->f_35[2]->f_13 = func_48(33);
							func_280(iVar0, &uLocal_835, &uLocal_836);
						}
						else
						{
							func_276(&(Local_111[iVar0]->f_35), !func_47(268435456, 0), 1);
							...
							{
								func_279(Local_111[iVar0]->f_35[0], "INTERACT_GREET");
								Local_111[iVar0]->f_35[0]->f_13 = func_48(28);
								Local_111[iVar0]->f_35[2]->f_13 = func_48(29);
							}
							if (!func_34(&(iLocal_82[0]), 0, 1))
							{
								Local_111[iVar0]->f_35[2]->f_13 = "RE_BBR_ARM_V1_PLAYER_ANT_PRISONER";
								if (func_254(Local_111[iVar0]->f_35[0], 0))
								{
									func_255(Local_111[iVar0]->f_35[0], 0, 0);
								}
							}
							func_280(iVar0, &uLocal_835, &uLocal_836);
						}
					...
					{
						func_276(&(Local_111[iVar0]->f_35), 0, 0);
					}
					if (iVar1 != -1)
					{
						if (func_275(&(Local_111[iVar0]->f_14)))
						{
							func_276(&(Local_111[iVar0]->f_35), 0, 0);
						}
					}
					...
					switch (iVar1)
					{
						case 0:
							...
							else
							{
								...
								if (func_271(&(iLocal_82[iVar0]), Global_35, func_48(iVar833), 0, -1082130432, iVar2, 0, 0, 2, 1, 1, 1988073838, 1, 0, 0))
								{
									func_117(3, 16384);
									func_117(4, 16384);
								}
			...
			{
				func_90(iVar0, 0, 0, 1);
				set_ped_config_flag(&(iLocal_82[iVar0]), 315, true);
				func_117(iVar0, 1024);
			}
		}
		iVar0++;
...
void func_96()
{
	iVar0 = func_274(iLocal_82[1], &(Local_111[1]->f_14), 20f, &(Local_111[1]->f_35), &(Local_844.f_192), 0f, 1, 0, 0, func_273(3, 0, 0), 0, 0, 2, 0, -1082130432, 0);
	if (func_34(&(iLocal_82[1]), 0, 1))
	{
		if (!func_37(16, 0) && !func_37(33554432, 0))
		{
			if (!func_277(1))
			{
				if ((func_34(&(iLocal_82[0]), 0, 1) && func_47(2097152, 0)) && !func_47(268435456, 0))
				{
					func_276(&(Local_111[1]->f_35), 1, 1);
					func_279(Local_111[1]->f_35[0], func_278(8));
					Local_111[1]->f_35[0]->f_13 = func_48(32);
					Local_111[1]->f_35[2]->f_13 = func_48(33);
					func_280(1, &uLocal_835, &uLocal_836);
				}
				else
				{
					...
					if (!func_47(268435456, 0))
					{
						func_279(Local_111[1]->f_35[0], "INTERACT_GREET");
						Local_111[1]->f_35[0]->f_13 = func_48(59);
						Local_111[1]->f_35[2]->f_13 = func_48(60);
					}
					if (!func_34(&(iLocal_82[0]), 0, 1))
					{
						Local_111[1]->f_35[2]->f_13 = "RE_BBR_ARM_V1_PLAYER_ANT_PRISONER";
						func_276(&(Local_111[1]->f_35), 0, 1);
					}
					else
					{
						func_276(&(Local_111[1]->f_35), !func_47(268435456, 0), 1);
					}
				}
			}
			else
			{
				func_276(&(Local_111[1]->f_35), 0, 0);
			}
			if (iVar0 != -1)
			{
				if (func_275(&(Local_111[1]->f_14)))
				{
					func_276(&(Local_111[1]->f_35), 0, 0);
				}
				iVar1 = func_257();
			...
			switch (iVar0)
			{
				case 0:
					if (!func_47(268435456, 0))
					{
						...
						if (func_11(&(Local_111[1]->f_88)))
						{
							func_58(&(Local_111[1]->f_88));
						}
					}
					else
					{
	...
	{
		func_90(1, 0, 0, 1);
		set_ped_config_flag(&(iLocal_82[1]), 315, true);
		func_117(1, 1024);
	}
}
...
void func_97()
{
	iVar0 = func_274(iLocal_82[2], &(Local_111[2]->f_14), 20f, &(Local_111[2]->f_35), &(Local_844.f_192), 2f, 1, 0, 0, func_273(3, 0, 0), 0, 0, 2, 0, -1082130432, 0);
	if (func_34(&(iLocal_82[2]), 0, 1))
	{
		if (func_34(&(iLocal_82[0]), 0, 1) || func_277(2))
		{
			func_276(&(Local_111[2]->f_35), 0, 0);
		}
		else
		{
			...
			if (!func_47(268435456, 0))
			{
				func_279(Local_111[2]->f_35[0], "INTERACT_GREET");
				Local_111[1]->f_35[0]->f_13 = func_48(28);
				Local_111[1]->f_35[2]->f_13 = func_48(29);
			}
			if (!func_34(&(iLocal_82[0]), 0, 1))
			{
				Local_111[2]->f_35[2]->f_13 = "RE_BBR_ARM_V1_PLAYER_ANT_PRISONER";
				func_276(&(Local_111[2]->f_35), 0, 1);
			}
			else
			{
				func_276(&(Local_111[2]->f_35), !func_47(268435456, 0), 1);
			}
		}
		if (!func_37(16, 0))
		{
			...
			switch (iVar0)
			{
				case 0:
					if (!func_47(268435456, 0))
					{
						...
						if (func_11(&(Local_111[2]->f_88)))
						{
							func_58(&(Local_111[2]->f_88));
						}
					}
					else
					{
	...
	{
		func_90(2, 0, 0, 1);
		set_ped_config_flag(&(iLocal_82[2]), 315, true);
		func_117(2, 1024);
	}
}
...
bool func_100(bool bParam0)
{
	...
	if (!bParam0)
	{
		if (_0x23e33cb9f4a3f547(iVar1035, func_196(0)))
		{
			_get_anim_scene_origin(iVar1035, &uVar0, &uVar3, 2);
			set_anim_scene_entity(iVar1035, "Police", &(iLocal_82[0]), 0);
			set_anim_scene_entity(iVar1035, "MALE_B", &(iLocal_82[2]), 0);
			set_anim_scene_entity(iVar1035, "MALE_A", &(iLocal_82[1]), 0);
			set_anim_scene_entity(iVar1035, "MALE_C", &(iLocal_82[3]), 0);
			set_anim_scene_entity(iVar1035, "MALE_D", &(iLocal_82[4]), 0);
			start_anim_scene(iVar1035);
			_set_anim_scene_playback_list_bool(iVar1035, func_196(0), true);
			return true;
		}
	}
	else if (_0x23e33cb9f4a3f547(iVar1035, func_196(0)))
	{
		set_anim_scene_entity(iVar1035, "MALE_A", &(iLocal_82[1]), 0);
		set_anim_scene_entity(iVar1035, "MALE_C", &(iLocal_82[3]), 0);
		set_anim_scene_entity(iVar1035, "MALE_D", &(iLocal_82[4]), 0);
		if (_get_anim_scene_ped(iVar1035, "MALE_A", false) == &iLocal_82[1])
		{
			return true;
		}
	}
	else if (!_0x0df57f86fe71dbe5(iVar1035, func_196(0)))
	{
		_0xdf7b5144e25cd3fe(iVar1035, func_196(0));
	}
	return false;
}
...
void func_101()
{
	...
	{
		if (has_anim_event_fired(&(iLocal_82[iVar0]), 953140441))
		{
			func_282(1066055203, &(iLocal_82[iVar0]), 1);
			if (!func_37(262144, 0))
			{
				uLocal_840 = iVar838 + 1;
				if (iVar838 >= 5)
				{
...
bool func_102(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		if (iParam4 > 1)
		{
			...
			{
				func_286(uParam0->f_121[iVar0], fVar3, 1082130432, 1, 90f, 0, 0);
				iVar0++;
			}
		}
		else
		{
			func_286(uParam0->f_121[0], fVar3, 1082130432, 1, 90f, 0, 0);
		}
...
void func_103(float fParam0)
{
	if (*fParam0 >= 26.1f && *fParam0 < 52.3f)
	{
		if (!func_37(512, 0))
		{
			_hide_ped_weapons(&(iLocal_82[1]), 2, true);
			func_39(512);
		}
	}
	if (func_37(512, 0))
	...
	if (!is_ped_dead_or_dying(&(iLocal_82[0]), true))
	{
		if (*fParam0 >= 54.6f)
		{
			remove_anim_scene_entity(iVar1035, "Police", &(iLocal_82[0]));
			Local_844.f_44 = 1;
...
bool func_104(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((iVar0 != 0 && !func_47(iVar0, 0)) && !func_37(33554432, 0))
	{
		...
		if (has_anim_event_fired(iParam0, func_294(iParam2)))
		{
...
void func_106(int iParam0, int iParam1, bool bParam2)
{
	...
	func_300(&(Local_111[iParam0]->f_4), iParam1);
}
...
void func_107()
{
	...
	{
		if (fVar839 > 67.4f && !func_47(524288, 0))
		{
		...
		if (fVar839 > 74.17f && !func_47(256, 0))
		{
			if (func_89(0, 1, &(iLocal_82[4]), 1))
			{
		...
		if (fVar839 > 71.8f && !func_47(128, 0))
		{
...
bool func_110(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			if (!func_11(&(Local_111[iVar0]->f_91)))
			{
				func_12(&(Local_111[iVar0]->f_91), 0);
			}
			switch (iVar0)
			{
				case 0:
					if (!does_blip_exist(&(uLocal_664[iVar0])))
					{
						func_138(&(iLocal_82[iVar0]), uLocal_664[iVar0], -89429847, 1679075994, 0, "BLIP_MISSION_ALLY");
					}
					if (fVar838 >= 40.15f && fVar838 <= 47.66f)
					{
						remove_anim_scene_entity(iVar1035, func_267(iVar0), &(iLocal_82[iVar0]));
						if (!is_entity_playing_anim(&(iLocal_82[iVar0]), sVar1043, "QUICK_KILL_MALE_C", 1))
						{
							func_116(0);
							func_49(&(iLocal_82[1]), &(iLocal_82[0]), "GENERIC_FRIGHTENED_HIGH", 0, -1082130432, 0, 0, 0, 2, 0, 0, 1744022339, 1, 1, 0, 0);
							task_play_anim(&(iLocal_82[iVar0]), sVar1043, "QUICK_KILL_MALE_C", 16f, -16f, -1, 0, 0f, false, 0, false, 0, false);
						}
					}
					else if (!is_ped_in_combat(&(iLocal_82[iVar0]), 0))
					{
						remove_anim_scene_entity(iVar1035, func_267(iVar0), &(iLocal_82[iVar0]));
						if (func_13(&(Local_111[iVar0]->f_91), get_random_float_in_range(1f, 2f)))
						{
							func_303(&(iLocal_82[0]), &(iLocal_82[1]), 6);
							task_combat_hated_targets_around_ped(&(iLocal_82[0]), 30f, 0, 1);
							func_58(&(Local_111[iVar0]->f_91));
						}
						else
						{
							iVar1 = 0;
				...
				case 1:
					...
					if (fVar838 >= 40.15f && fVar838 <= 47.66f)
					{
						if (!is_entity_playing_anim(&(iLocal_82[iVar0]), sVar1043, "QUICK_KILL_MALE_A", 1) && !func_93(iVar0, 16, 0))
						{
							remove_anim_scene_entity(iVar1035, func_267(iVar0), &(iLocal_82[iVar0]));
							task_play_anim(&(iLocal_82[iVar0]), sVar1043, "QUICK_KILL_MALE_A", 16f, -16f, -1, 0, 0f, false, 0, false, 0, false);
							func_117(iVar0, 16);
						}
					}
					else if (fVar838 < 76.95f && !is_ped_in_combat(&(iLocal_82[iVar0]), 0))
					{
						if (func_13(&(Local_111[iVar0]->f_91), get_random_float_in_range(0.25f, 1f)) && ((!is_ped_fleeing(&(iLocal_82[iVar0])) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0)) && !func_266(&(iLocal_82[iVar0]), 242628503)))
						{
							_0x802092b07e3b1eea(&(iLocal_82[iVar0]), Global_36, 3);
							remove_anim_scene_entity(iVar1035, func_267(iVar0), &(iLocal_82[iVar0]));
							open_sequence_task(&(Local_111[iVar0]->f_87));
							if (!func_93(iVar0, 32768, 0))
							{
								_request_ped_emotional_preset(&(iLocal_82[iVar0]), "TaskCombat_Medium");
								task_react(0, Global_35, get_entity_coords(Global_35, true, false), "TaskCombat_Medium", 0.5f, 1f, 4);
								func_117(iVar0, 32768);
							}
							task_combat_ped(0, Global_35, 33554432, 0);
							func_305(&(iLocal_82[iVar0]), &(Local_111[iVar0]->f_87), 0, 0, 1, 1);
							func_58(&(Local_111[iVar0]->f_91));
						}
						else
						{
				...
				case 2:
					...
					if (fVar838 < 83.78f)
					{
						if (func_13(&(Local_111[iVar0]->f_91), get_random_float_in_range(0.25f, 1f)))
						{
							remove_anim_scene_entity(iVar1035, func_267(iVar0), &(iLocal_82[iVar0]));
							vVar2 = { get_offset_from_entity_in_world_coords(Local_670[iVar0]->f_11, -0.5f, 1f, 0f) };
							open_sequence_task(&(Local_111[iVar0]->f_87));
							task_follow_nav_mesh_to_coord(0, vVar2, 3f, -1, 0.25f, 5242884, 40000f);
							func_305(&(iLocal_82[iVar0]), &(Local_111[iVar0]->f_87), 0, 0, 1, 1);
							func_117(iVar0, 16);
							func_58(&(Local_111[iVar0]->f_91));
						}
				...
				case 3:
					if (!bParam0)
					{
						if (func_13(&(Local_111[iVar0]->f_91), get_random_float_in_range(0f, 1f)))
						{
							func_304(uLocal_664[iVar0], &(iLocal_82[iVar0]), 0);
							_0x802092b07e3b1eea(&(iLocal_82[iVar0]), Global_36, 3);
							if (fVar838 < 83.78f && (!is_ped_fleeing(&(iLocal_82[iVar0])) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0)))
							{
								open_sequence_task(&(Local_111[iVar0]->f_87));
				...
				case 4:
					if (!bParam0)
					{
						if (func_13(&(Local_111[iVar0]->f_91), get_random_float_in_range(0f, 1f)))
						{
							func_304(uLocal_664[iVar0], &(iLocal_82[iVar0]), 0);
							_0x802092b07e3b1eea(&(iLocal_82[iVar0]), Global_36, 3);
							if (fVar838 < 85.44f && (!is_ped_fleeing(&(iLocal_82[iVar0])) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0)))
							{
								open_sequence_task(&(Local_111[iVar0]->f_87));
								if ((func_306(iVar0, 0) == 0 || func_306(iVar0, 0) == 1) || func_306(iVar0, 0) == 3)
								{
...
void func_112()
{
	fVar1 = _get_entity_anim_current_time(&(iLocal_82[1]), sVar1044, "QUICK_KILL_MALE_A");
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (func_34(&(iLocal_82[iVar0]), 0, 1) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0))
		{
			switch (iVar0)
			{
				case 1:
					...
					if (_0x3ab6c7b0bb0df4b1(&(iLocal_82[iVar0]), iVar1036))
					{
						if (fVar839 >= 54.6f)
						{
							if (!func_307(iVar0, 76.95f, 80.18f, iVar1036))
							{
								open_sequence_task(&(Local_111[iVar0]->f_87));
								task_combat_ped(&(iLocal_82[iVar0]), Global_35, 33554432, 0);
								func_305(&(iLocal_82[iVar0]), &(Local_111[iVar0]->f_87), 0.5f, 0, 1, 1);
							}
						}
					}
					else if (is_entity_playing_anim(&(iLocal_82[iVar0]), sVar1044, "QUICK_KILL_MALE_A", 1))
					{
						if (!func_37(2048, 0))
						{
							if (!func_37(1024, 0))
					...
					else if (!is_ped_in_combat(&(iLocal_82[iVar0]), Global_35))
					{
						task_combat_ped(&(iLocal_82[iVar0]), Global_35, 33554432, 0);
					}
					break;
				case 2:
					if (_0x3ab6c7b0bb0df4b1(&(iLocal_82[iVar0]), iVar1036))
					{
						if (fVar839 >= 54.6f)
						{
							if (!func_307(iVar0, 83.78f, 85.44f, iVar1036))
							{
								set_ped_combat_attributes(&(iLocal_82[iVar0]), 38, true);
								task_goto_entity_offset_xy(&(iLocal_82[iVar0]), Local_670[iVar0]->f_11, -1, 0.5f, -0.9f, 0f, 3f, true);
								func_117(iVar0, 16);
							}
						}
					}
					else if (is_entity_playing_anim(&(iLocal_82[iVar0]), sVar1044, "QUICK_KILL_MALE_B", 1))
					{
					...
					else if (is_ped_dead_or_dying(&(iLocal_82[0]), true))
					{
						if (!func_93(iVar0, 16, 0))
						{
							set_ped_combat_attributes(&(iLocal_82[iVar0]), 38, true);
							...
							open_sequence_task(&(Local_111[iVar0]->f_87));
							task_follow_nav_mesh_to_coord(0, vVar2, 3f, -1, 0.25f, 5242884, 40000f);
							func_305(&(iLocal_82[iVar0]), &(Local_111[iVar0]->f_87), Local_111[iVar0]->f_13, 0, 1, 1);
							func_117(iVar0, 16);
						}
					}
					break;
				case 0:
					if (is_entity_playing_anim(&(iLocal_82[1]), sVar1044, "QUICK_KILL_MALE_A", 1) && fVar1 >= 0.315f)
					{
						if (!is_ped_dead_or_dying(&(iLocal_82[0]), true))
						{
							func_289(&(iLocal_82[0]), 0, 0);
					...
					if (!is_ped_dead_or_dying(&(iLocal_82[1]), true) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0))
					{
						task_combat_hated_targets(&(iLocal_82[iVar0]), -1f);
					}
					break;
				case 3:
					if (((((!is_ped_fleeing(&(iLocal_82[iVar0])) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0)) && !func_266(&(iLocal_82[iVar0]), 242628503)) && !func_307(iVar0, 83.78f, 85.44f, iVar1036)) || func_36(&(iLocal_82[iVar0]))) || func_37(33554432, 0))
					{
						if (func_34(&(iLocal_82[0]), 0, 1))
						{
							open_sequence_task(&(Local_111[iVar0]->f_87));
							if (func_37(65536, 0))
							{
								_task_smart_flee_style_coord(&(iLocal_82[iVar0]), vLocal_17, 3, 0, 10f, 3, 0);
							}
							else
							{
								task_combat_ped(0, Global_35, 33554432, 0);
					...
					break;
				case 4:
					if (((((!is_ped_fleeing(&(iLocal_82[iVar0])) && !is_ped_in_combat(&(iLocal_82[iVar0]), 0)) && !func_266(&(iLocal_82[iVar0]), 242628503)) && !func_307(iVar0, 85.44f, 87.53f, iVar1036)) || func_36(&(iLocal_82[iVar0]))) || func_37(33554432, 0))
					{
						if (func_34(&(iLocal_82[0]), 0, 1))
						{
							open_sequence_task(&(Local_111[iVar0]->f_87));
...
void func_113(vector3 vParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_118(&(iLocal_82[iVar0]), 0) || (func_72(iVar0, 1) && func_124(&(iLocal_82[iVar0]), vParam0, 15f, 1, 1)))
		{
			...
			{
				func_309(iLocal_82[iVar0], &(Local_111[iVar0]->f_14), &(Local_111[iVar0]->f_35), 1, 1);
				set_blocking_of_non_temporary_events(&(iLocal_82[iVar0]), false);
...
{
	func_169(&(Local_111[iParam0]->f_4), iParam1);
}
...
bool func_120(int iParam0)
{
	if (does_entity_exist(iParam0))
	{
		if (!is_entity_dead(iParam0))
		{
			...
			{
				if ((iVar0 != 1549070292 && iVar0 != 1030402560) && iVar0 != -1569615261)
				{
					return true;
				}
			}
...
void func_123()
{
	...
	if (!func_131(1024, 0))
	{
		if (func_13(&uLocal_33, get_random_float_in_range(5f, 10f)))
		{
...
void func_126()
{
	...
	while (iVar0 < 5)
	{
		if (func_72(iVar0, 1) && func_34(Local_670[iVar0]->f_11, 0, 1))
		{
			_0x06d26a96ca1bca75(Local_670[iVar0]->f_11, 3, 0f, 0);
			_0x06d26a96ca1bca75(Local_670[iVar0]->f_11, 1, 0f, 0);
			set_ped_reset_flag(Local_670[iVar0]->f_11, 53, true);
			set_ped_reset_flag(Local_670[iVar0]->f_11, 49, true);
		}
		iVar0++;
	}
}
...
void func_129(bool bParam0)
{
	if (iLocal_78 != 3)
	{
		if (func_37(8192, 0))
		{
			...
			{
				if (!has_entity_clear_los_to_entity(&(iLocal_82[0]), Global_35, 17) || !func_128(&(iLocal_82[0]), Global_35))
				{
	...
	{
		case 0:
			if (is_entity_playing_anim(&(iLocal_82[0]), sVar1043, "OH_MY_HOW_LUCKY_POLICE", 1) || bParam0)
			{
				func_42(&uLocal_36);
				iLocal_78 = 1;
			}
			...
			{
				task_play_upper_anim_facing_entity(&(iLocal_82[0]), sVar1043, "OH_MY_HOW_LUCKY_POLICE", Global_35, func_315(sVar1043, "OH_MY_HOW_LUCKY_POLICE"), 1.5f, -2f, 67108888, 0f, false, true, -1f, 0, 0, -1f);
				if (!is_ped_on_mount(Global_35))
				{
					task_play_anim(Global_35, sVar1043, "OH_MY_HOW_LUCKY", 1.5f, -1.5f, -1, 67111984, 0f, false, 0, false, 0, false);
				}
				_blip_set_modifier(&(uLocal_664[0]), -46775694);
				func_39(8192);
			}
			break;
		case 1:
			if (is_entity_playing_anim(&(iLocal_82[0]), sVar1043, "OH_MY_HOW_LUCKY_POLICE", 1))
			{
				fVar0 = _get_entity_anim_current_time(&(iLocal_82[0]), sVar1043, "OH_MY_HOW_LUCKY_POLICE");
				if (!func_131(1, 0))
				{
			...
			{
				task_play_upper_anim_facing_entity(&(iLocal_82[0]), sVar1043, "I_DONT_KNOW_POLICE", Global_35, func_315(sVar1043, "I_DONT_KNOW_POLICE"), 2f, -1.5f, 67178512, 0f, false, true, -1f, 0, 0, -1f);
				if (!is_ped_on_mount(Global_35))
				{
					task_play_anim(Global_35, sVar1043, "I_DONT_KNOW", 1.5f, -1.5f, -1, 67178544, 0f, false, 0, false, 0, false);
				}
				func_39(16384);
			}
			else if (is_entity_playing_anim(&(iLocal_82[0]), sVar1043, "I_DONT_KNOW_POLICE", 1))
			{
				iLocal_78 = 2;
			}
			break;
		case 2:
			...
			{
				fVar0 = _get_entity_anim_current_time(&(iLocal_82[0]), sVar1043, "I_DONT_KNOW_POLICE");
				if (!func_131(8, 0))
				{
...
bool func_133(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_72(iVar0, 1))
		{
			if (!func_135(Local_670[iVar0]->f_11))
			{
				if (func_124(Local_670[iVar0]->f_11, Local_670[iVar0]->f_15, 5f, 1, 1))
				{
					*uParam0 = Local_670[iVar0]->f_11;
					return true;
				}
				else
				{
					vVar1 = { get_entity_coords(Local_670[iVar0]->f_11, true, false) };
				}
			}
		}
		iVar0++;
...
bool func_134(int iParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	if (!func_135(iParam1) && !func_36(iParam0))
	{
		...
		task_follow_nav_mesh_to_coord(0, get_entity_coords(iParam1, true, false), fParam3, -1, 3.5f, 0, 40000f);
		task_mount_animal(0, iParam1, 20000, -1, fParam3, 1, 0, 0);
...
void func_166(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_335(&((*uParam0)[iVar0]->f_1));
		func_335(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
bool func_175(var uParam0, var uParam1)
{
	...
	{
		if (func_337(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
void func_178(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_34(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			fVar2 = func_177(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
int func_193(bool bParam0)
{
	...
	get_group_size(func_352(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_352(), iVar3);
		if (func_353(iVar4))
		{
			iVar0++;
		}
...
void func_201(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_363());
		if (func_364(Global_1310750[iParam0], 33554432))
		{
...
bool func_203(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_369(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_202(iParam0, 16))
	{
		...
		fVar2 = to_float(func_370(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
int func_210(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (func_378(&(uParam0->f_37), 500))
	{
		...
		while (iVar0 < 8)
		{
			if (!func_206(*uParam0->f_12[iVar0]))
			{
...
int func_222(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_390(iVar0))
		{
		...
		if (func_391(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_392(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_397(&(uParam1->f_22)));
		...
		if (!func_390(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_400(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_401(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_401(&(uParam1->f_22)));
...
void func_235(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_403(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
void func_242(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_172(uParam0->f_3));
...
void func_244(var uParam0, int iParam1, float fParam2)
{
	...
	if (!uParam0->f_48 && !func_202(uParam0->f_3, 262144))
	{
		...
		func_286(uParam0->f_121[iParam1], fVar1, 1082130432, 0, 90f, 0, &(uParam0->f_98[iParam1]));
...
bool func_245(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_422(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_421(uParam2, fVar1))
		{
			if (!func_423((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
void func_246(var uParam0, int iParam1)
{
	if (func_436(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_363());
...
bool func_248(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_422(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_443(iParam2, 1065353216))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
int func_256(int iParam0)
{
	...
	if (!func_93(iParam0, 64, 0))
	{
		if (!func_37(64, 0))
		{
			...
			else if (func_46(Global_35, &(iLocal_23[0]), 1, 0) && Local_111[iParam0]->f_12 == 0f)
			{
				bVar0 = true;
			}
			else if (Local_111[iParam0]->f_12 > fVar1 && fVar1 < 10f)
			{
				bVar0 = true;
			}
			else if (fVar1 < 1.5f)
	...
	if (!has_entity_clear_los_to_entity(&(iLocal_82[iParam0]), Global_35, 17))
	{
		bVar0 = false;
	}
	if (bVar0)
	{
		if (!func_11(&(Local_111[iParam0]->f_97)))
		{
			func_12(&(Local_111[iParam0]->f_97), 0);
		}
		else if (func_13(&(Local_111[iParam0]->f_97), 1f))
		{
			return 1;
		}
	}
...
{
	if (_0x3ab6c7b0bb0df4b1(&(iLocal_82[iParam0]), iVar1035))
	{
		remove_anim_scene_entity(iVar1035, func_267(iParam0), &(iLocal_82[iParam0]));
		if (fVar838 < func_470(iParam0))
		{
			func_471(iParam0, &(Local_111[iParam0]->f_10));
			if (!is_entity_playing_anim(&(iLocal_82[iParam0]), sVar1043, func_472(Local_111[iParam0]->f_10), 1))
			{
				task_play_anim(&(iLocal_82[iParam0]), sVar1043, func_472(Local_111[iParam0]->f_10), 4f, -4f, -1, 0, 0f, false, 0, false, 0, false);
			}
		}
		else
		{
...
{
	if (Local_111[iParam0]->f_2 != iParam1)
	{
		Local_111[iParam0]->f_2 = iParam1;
	}
}
...
bool func_260(int iParam0, bool bParam1)
{
	...
	if (func_47(2097152, 0))
	{
		if (((func_37(16777216, 0) && get_entity_speed(Global_35) > 0.5f) && !is_ped_facing_ped(Global_35, &(iLocal_82[iParam0]), 90f)) || (Local_111[iParam0]->f_12 != 0f && (Local_111[iParam0]->f_12 + 2f) < func_80(&(iLocal_82[iParam0]), Global_36, 1)))
		{
			if (!func_11(&(Local_111[iParam0]->f_94)))
			{
				func_12(&(Local_111[iParam0]->f_94), 0);
			}
			else if (func_13(&(Local_111[iParam0]->f_94), 1f))
			{
				if (func_93(iParam0, 512, 0))
				{
				...
				func_42(&(Local_111[iParam0]->f_94));
				return true;
			}
		}
		else if (func_11(&(Local_111[iParam0]->f_94)))
		{
			func_42(&(Local_111[iParam0]->f_94));
		}
	}
	if (func_93(iParam0, 512, 0))
	{
		if (func_80(&(iLocal_82[iParam0]), Global_36, 1) < (Local_111[iParam0]->f_12 + 2f))
		{
			return false;
		}
		else
...
{
	return func_474(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
bool func_262(int iParam0, bool bParam1)
{
	if (func_260(iParam0, bParam1))
	{
		...
		func_259(Local_111[iParam0]->f_3, 3);
		return true;
	}
	return false;
}
...
bool func_263(int iParam0)
{
	if (is_entity_playing_anim(&(iLocal_82[iParam0]), sVar1043, func_472(Local_111[iParam0]->f_10), 1))
	{
		if (_get_entity_anim_current_time(&(iLocal_82[iParam0]), sVar1043, func_472(Local_111[iParam0]->f_10)) >= func_476(Local_111[iParam0]->f_10))
		{
			clear_ped_tasks(&(iLocal_82[iParam0]), 1, 0);
			func_473(&(iLocal_82[iParam0]), Global_35, -1);
		}
	}
	else if (func_261(&(iLocal_82[iParam0]), Global_35, 0.9f))
	{
		_0x8acc0506743a8a5c(&(iLocal_82[iParam0]), 166028666, 2, -1082130432);
		task_aim_gun_at_entity(&(iLocal_82[iParam0]), Global_35, -1, 1, 0);
		return true;
	}
	return false;
}
...
void func_265(int iParam0)
{
	if (!func_266(&(iLocal_82[iParam0]), -1758697641))
	{
		...
		open_sequence_task(&iLocal_831);
		if (func_80(&(iLocal_82[1]), vVar0, 1) > 1.75f)
		{
			task_go_to_coord_while_aiming_at_entity(0, vVar0, Global_35, 1f, 0, 1056964608, 1082130432, 1, 0, 0, -687903391, 20000, 0);
		}
...
bool func_268(int iParam0)
{
	if (!func_47(2097152, 0))
	{
		...
		{
			func_12(&(Local_111[iParam0]->f_88), 0);
			func_50(2097152);
			if (iLocal_88 == 5)
			{
				iLocal_88 = iParam0;
	...
	if (func_13(&(Local_111[iParam0]->f_88), 8f))
	{
		return true;
	}
	return false;
...
bool func_269(int iParam0)
{
	...
	else if (!func_11(&(Local_111[iParam0]->f_88)))
	{
	...
	else if (func_13(&(Local_111[iParam0]->f_88), 12f))
	{
		return true;
	}
	return false;
...
bool func_270(int iParam0, bool bParam1)
{
	if (!func_93(iParam0, 64, 0))
	{
		if (func_89(0, 1, Global_35, 1))
		{
			if (!func_47(0, 0))
			{
				remove_anim_scene_entity(iVar1034, func_267(0), &(iLocal_82[iParam0]));
				remove_anim_scene_entity(iVar1034, func_267(1), &(iLocal_82[iParam0]));
				remove_anim_scene_entity(iVar1034, func_267(2), &(iLocal_82[iParam0]));
				func_479(iVar1034);
				if (func_37(33554432, 0))
				{
					iVar0 = func_257();
				...
				open_sequence_task(&(Local_111[2]->f_87));
				task_turn_ped_to_face_entity(0, Global_35, -1, -1f, -1f, -1082130432);
				func_305(&(iLocal_82[2]), &(Local_111[2]->f_87), 0.5f, 0.5f, 1, 1);
				open_sequence_task(&(Local_111[0]->f_87));
				task_turn_ped_to_face_entity(0, Global_35, -1, -1f, -1f, -1082130432);
				func_305(&(iLocal_82[0]), &(Local_111[0]->f_87), 0.5f, 0.5f, 1, 1);
				if (func_34(&(iLocal_82[iVar1]), 0, 1) && !func_261(&(iLocal_82[iVar1]), Global_35, 130f))
				{
					open_sequence_task(&(Local_111[iVar1]->f_87));
					task_turn_ped_to_face_entity(0, Global_35, -1, -1f, -1f, -1082130432);
					func_305(&(iLocal_82[iVar1]), &(Local_111[iVar1]->f_87), 0.5f, 0.5f, 1, 1);
				}
				if (bParam1)
				{
					iVar2 = 39;
...
void func_276(var uParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		if (!func_254((*uParam0)[0], 0))
		{
			func_255((*uParam0)[0], 1, 0);
		}
	}
	else if (func_254((*uParam0)[0], 0))
	{
		func_255((*uParam0)[0], 0, 0);
	}
	if (bParam2)
	{
		if (!func_254((*uParam0)[2], 0))
		{
			func_255((*uParam0)[2], 1, 0);
		}
	}
	else if (func_254((*uParam0)[2], 0))
	{
...
{
	if (func_404(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
void func_283(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_364(Global_1310750[iVar0], iParam0))
		{
			if (!func_346(iVar0))
			{
				iVar1 = 1;
...
{
	*uParam0 = { get_entity_coords(&(iLocal_82[1]), true, false) };
	...
	if (bParam1)
	{
		_0x4c57f27d1554e6b0(&(iLocal_82[1]), uParam0->f_3, 1, -1082130432, 0, -1082130432);
	}
}
...
{
	iVar0 = 1;
	if (!func_36(&(iLocal_82[iParam0])) && !Local_111[iParam0]->f_1 == 1)
	{
		iVar0 = 0;
		if (_get_anim_scene_time(iVar1034) >= fParam1 || !_0x3ab6c7b0bb0df4b1(&(iLocal_82[iParam0]), iVar1034))
		{
			set_ped_config_flag(Local_670[iParam0]->f_11, 214, false);
			vVar2 = { get_offset_from_entity_in_world_coords(Local_670[iParam0]->f_11, 0.5f, 0.5f, 0f) };
			open_sequence_task(&iVar1);
			if (!func_109(&(iLocal_82[iParam0]), Local_670[iParam0]->f_11, 2f, 1))
			{
				task_follow_nav_mesh_to_coord(0, vVar2, 1f, -1, 3.5f, 4194308, 40000f);
			}
			task_mount_animal(0, Local_670[iParam0]->f_11, 20000, -1, 1f, 1, 0, 0);
			func_305(&(iLocal_82[iParam0]), &iVar1, 0, 0, 1, 1);
			Local_111[iParam0]->f_1 = 1;
		}
		else
		{
			set_entity_no_collision_entity(&(iLocal_82[iParam0]), Local_670[iParam0]->f_11, true);
		}
	}
	return iVar0;
}
...
{
	if (does_entity_exist(&(iLocal_82[iParam0])))
	{
		if (!is_entity_dead(&(iLocal_82[iParam0])) && func_493(&(iLocal_82[iParam0])))
		{
			if (&iLocal_82[iParam0] == &iLocal_82[1])
			{
				if (does_group_exist(iVar825))
				{
					func_494(iLocal_82[iParam0], &iLocal_832, 1, 1, 1, 1, 0);
					set_group_formation(iVar825, 4);
				}
				else
				{
					iLocal_832 = create_group(1);
					func_494(iLocal_82[1], &iLocal_832, 1, 1, 1, 1, 0);
				}
				func_495(&(iLocal_82[1]), 17, 131072, 0, 0);
				open_sequence_task(&(Local_111[iParam0]->f_87));
				_task_move_in_traffic_2(0, vParam1, 15f, fParam4, 4, 0);
				_task_move_in_traffic_3(0, Global_35, fParam4, 4, 0);
				func_305(&(iLocal_82[iParam0]), &(Local_111[iParam0]->f_87), 0, 0, 1, 1);
			}
			else
			{
				if (does_group_exist(iVar825))
				...
				open_sequence_task(&(Local_111[iParam0]->f_87));
				_task_move_in_traffic_2(0, vParam1, 1f, fParam4, 4, 0);
				_task_move_in_traffic_3(0, Global_35, fParam4, 4, 0);
				func_305(&(iLocal_82[iParam0]), &(Local_111[iParam0]->f_87), 0, 0, 1, 1);
			}
			set_ped_keep_task(&(iLocal_82[iParam0]), true);
			func_87(&(Local_844.f_5), &iLocal_73);
			return true;
		}
	}
...
int func_302(int iParam0, vector3 vParam1, float fParam4)
{
	if (!func_37(64, 0))
	{
		if (func_72(iParam0, 1) && !is_ped_in_combat(&(iLocal_82[iParam0]), 0))
		{
...
void func_303(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = get_ped_relationship_group_hash(iParam1);
	set_relationship_between_groups(iParam2, iVar0, iVar1);
}
...
bool func_307(int iParam0, float fParam1, float fParam2, int iParam3)
{
	...
	if (fVar835 > fParam1)
	{
		if (fVar835 >= fParam2)
		{
			remove_anim_scene_entity(iParam3, func_267(iParam0), &(iLocal_82[iParam0]));
			if (!func_36(&(iLocal_82[iParam0])))
			{
				_set_ped_on_mount(&(iLocal_82[iParam0]), Local_670[iParam0]->f_11, -1, true);
			}
		}
		return true;
	}
...
char* func_328(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_514(sParam1));
}
...
{
	fVar0 = func_177(bParam6, fParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_383(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_249();
	...
	else if (fVar0 > iParam4->f_2 || (!func_383(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_249();
		iParam4->f_2 = func_80(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_383(vector3 vParam0, int iParam3)
{
	...
	return func_531(vVar0, vParam0) > func_531(vVar0, get_entity_coords(iParam3, true, false));
}
...
void func_403(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_404(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_535(iParam1))
		{
...
void func_417(int iParam0, int iParam1)
{
	...
	func_489(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_557(iParam0, 0);
	func_558(iParam0);
	func_559(1);
...
{
	if (uParam0->f_177 != -1 || func_364(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_567(uParam0->f_177));
			}
		}
	}
...
bool func_428(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_580(&(Global_1898164->f_1[0]));
		if (func_581(iVar0) && func_582((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_583(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_426(1) || *iParam0 & 8192 != 0))
				{
...
bool func_441(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_598(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_596(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_597(iParam2)
				{
					func_250(iParam2, 1);
					return true;
				}
...
bool func_442(int iParam0, int iParam1)
{
	...
	if (func_591(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_597(iParam1)
		{
...
int func_463(int iParam0, int iParam1)
{
	...
	{
		return func_620(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_475(int iParam0)
{
	...
	_0x89f5e7adecccb49c(&(iLocal_82[iParam0]), "brave");
	open_sequence_task(&(Local_111[iParam0]->f_87));
	task_turn_ped_to_face_entity(0, &(iLocal_82[0]), 0, -1f, -1f, -1082130432);
	func_305(&(iLocal_82[iParam0]), &(Local_111[iParam0]->f_87), fVar0, 0, 1, 1);
}
...
{
	if (func_72(Local_111[iParam0]->f_3, 0))
	{
		if (&Local_111[iParam0])
		{
			return true;
		}
	}
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_629(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_489(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_347(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
int func_497(int iParam0)
{
	...
	fVar1 = func_177(absf(fVar1) < 1f, func_177(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_647((get_game_timer() + iParam2), !bParam1);
...
void func_503(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_649(iParam0));
...
void func_520(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_489(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_557(iParam0, 1);
	if (!bParam2)
	{
		func_517(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_669(iParam0))
		{
...
bool func_529(vector3 vParam0)
{
	...
	{
		if (!func_206(*Global_1310750->f_16043[iVar0]))
		{
			if (func_141(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
void func_542(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_681(iParam0, 8))
		{
...
void func_553(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_247(_get_weapon_clip_size(iParam0), iParam1);
...
void func_562(int iParam0)
{
	...
	if (!func_216(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_563(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_706(to_float(iVar0), 1, 0);
	}
	else
	{
		func_706((to_float(200) / 3f), 1, 0);
	}
}
...
bool func_594(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_188(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_713(iVar0, 0)))
		{
...
bool func_598(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_713(iVar0, 0)))
		{
			if (func_715(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_609(int iParam0, int iParam1)
{
	...
	if (func_88(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_615(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_188(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
{
	return func_720(get_entity_coords(iParam0, true, false), get_entity_coords(iParam1, true, false), iParam2);
}
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_2(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_726(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_632(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_404((*uParam4)[iVar0]->f_6);
		...
		if (func_733(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_734(iParam12, (*uParam4)[iVar0]->f_6))
				{
					...
					{
						func_660(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
bool func_659(int iParam0, int iParam1, var uParam2)
{
	if (!func_657(iParam0))
	{
		return false;
...
void func_661(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_749(iVar0), func_352(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_751() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_751();
					}
					func_752(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_300(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
bool func_714(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_715(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_721(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_766((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_723(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_403(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_404((*uParam2)[iVar0]->f_6))
		{
			func_408((*uParam2)[iVar0], 11);
...
void func_735(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_255((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_191(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
