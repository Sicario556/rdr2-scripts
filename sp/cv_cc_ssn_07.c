...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -5.3825f, 0.085f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, -1612834106, -1689743484, 1, 1, 1);
	func_151(uParam0, 0.875f, -1.25f, 1.15f, -38.44f, 3.51f, 4.1475f, 2.685f, -1612834106, -1377448058, 1, 1, 1);
	iLocal_21 = func_152(uParam0, -1335015498, 0f, 0f, 0f, "KNITING", 0, 0, 1);
	func_152(uParam0, 1623781586, 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	func_152(uParam0, 1230724566, 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@susan_7@base", 1, 1, 0, 0);
	iLocal_14 = func_153(uParam0, "script@vignette@susan_7@action_a", 2, 0, 1, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_7@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@susan_7@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@susan_7@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_15 = func_153(uParam0, "script@vignette@susan_7@action_b", 0, 0, 0, 0);
	func_154(uParam0, iLocal_20, 3, 830847823, "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_20, 2, 0, 30, 0, 0);
	func_154(uParam0, iLocal_19, 3, -98992470, "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_19, 2, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824, 0.3f, 1);
	...
	Local_22 = { func_159(uParam0, 0.8825f, -2.01f, 1.07f, 159f, 6.5f, 0.065f, 0.6375f) };
	Local_32 = { func_159(uParam0, 0.883f, -2.01f, 1.07f, -135.75f, 6.5f, 0.22f, 0.66f) };
	Local_42 = { func_159(uParam0, 0.883f, -2.01f, 1.07f, 68.59f, 6.74f, 0.3675f, 0.3175f) };
	return true;
}
