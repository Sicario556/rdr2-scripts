...
bool func_3(var uParam0)
{
	...
	{
		remove_model_hide(1877.69f, -1861.21f, 42.3149f, 0.5f, -748422618, 1);
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, -182450036, -2.528f, 1.918f, 0.142f, "CRATE", bVar0, 0, 1);
	func_153(uParam0, 1843407141, 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, -1698780291, 0f, 0f, 0f, "LEDGER", 0, 1, 1);
	func_153(uParam0, -1473388640, 0f, 0f, 0f, "PEN", 0, 1, 1);
	if (func_22(uParam0) == 2)
	{
		iLocal_22 = func_153(uParam0, 2006849227, -0.407827f, 3.55382f, -0.0014267f, 0, 1, 0, 1);
		iLocal_23 = func_153(uParam0, 1561132816, -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
	}
	if (func_22(uParam0) == 3)
	{
		iLocal_23 = func_153(uParam0, 1561132816, -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
...
bool func_87(var uParam0)
{
	if (func_22(uParam0) == 2)
	{
		if (does_entity_exist(func_190(uParam0, iLocal_22)))
		{
			set_entity_heading(func_190(uParam0, iLocal_22), 134.4794f);
		}
		if (does_entity_exist(func_190(uParam0, iLocal_23)))
		{
			set_entity_heading(func_190(uParam0, iLocal_23), 131.683f);
		}
	}
	if (func_22(uParam0) == 3)
	{
		create_model_hide(1877.69f, -1861.21f, 42.3149f, 0.5f, -748422618, false);
	}
	return true;
}
