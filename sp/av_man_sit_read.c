...
{
	func_33(uParam0, 10772, 10844, 11400);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar0 = func_48(func_47(), 1, 0, 1, 0, 0, 1);
	iVar1 = func_49(997958153, 1);
	func_50(uParam0, 0, "MSRP_HORSE", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 2.2f, 0f), (60f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "MSRP_MAN", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		if (_0x331550b212014b92(&(uParam0->f_20[1]), Global_35))
		{
			if (!is_ped_active_in_scenario(&(uParam0->f_20[1]), 0))
			{
				func_68(uParam0);
				uParam0->f_469[0] = 1;
			}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_73(&(uParam0->f_20[1]->f_5), 1, 10, 0);
				_0x931b241409216c1f(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 0);
				_0xed1c764997a86d5a(&(uParam0->f_20[1]), &(uParam0->f_20[0]));
				func_74(&uLocal_10, &(uParam0->f_20[1]), &(uParam0->f_20[0]), 0);
				func_75(&(uParam0->f_20[1]), 1491206925, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 0, 1, 0, -1082130432);
				func_76(uParam0->f_20[1], 0, 1);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				func_73(&(uParam0->f_20[0]->f_5), 1, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[0]), 696740378, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
				func_76(uParam0->f_20[0], 0, 1);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			iLocal_38 = _0xfa50f79257745e74(uParam0->f_20[1]->f_5, 4f, 1, 36, 0);
			iLocal_39 = _0xfa50f79257745e74(uParam0->f_20[1]->f_5, 1.5f, 2, -1, 0);
			iLocal_9 = 1;
			break;
		case 1:
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_38 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_38, 1);
	}
	if (iLocal_39 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_39, 1);
	}
	return 1;
}
...
bool func_77(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
...
void func_166(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_216(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_216(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_216(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
