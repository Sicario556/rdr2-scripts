...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_160(uParam0, 0f, 5f, 0f, 0f, 0f, 0f, 8f, 7f, 5f, "volTrigger", -1612834106);
	func_161(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_15]), "COW"))
	{
		task_stand_still(func_48(uParam0, iLocal_17), -1);
	}
	return true;
}
...
bool func_193(var uParam0, int iParam1, bool bParam2)
{
	...
	return func_296(Global_35, *iParam1, 1, 0);
}
