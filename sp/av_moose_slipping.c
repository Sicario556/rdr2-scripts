...
bool func_28(var uParam0)
{
	...
	_0xf7ea250b9a919e03(515906784, &(uParam0->f_20[0]));
	if (!_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[0])) || !_0x854bc9b1a1ccd034(515906784, &(uParam0->f_20[0])))
	{
		return false;
	}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (func_64(uParam0, &uLocal_10, 0) || func_65(Global_35, &(uParam0->f_20[0]), 1) <= 225f)
			{
				bLocal_42 = true;
			}
		}
					...
					if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), 811542464))
							{
								...
								task_smart_flee_coord(&(uParam0->f_20[0]), uParam0->f_20[0]->f_5, -1f, -1, false, 2f);
								set_ped_config_flag(&(uParam0->f_20[0]), 230, true);
								uParam0->f_469[4] = 1;
							}
						}
						if (&uParam0->f_469[4])
...
int func_32(var uParam0, var uParam1)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		set_ped_config_flag(&(uParam0->f_20[0]), 388, false);
		_0xae6004120c18df97(&(uParam0->f_20[0]), 0, 1);
	}
