...
void func_6()
{
	if (!does_entity_exist(Local_19))
	{
		return;
	}
	if (is_ped_injured(Local_19))
	{
		iLocal_0 = 0;
		return;
	}
	...
	switch (func_18())
	{
		case 0:
			if (func_19())
			{
				Local_19.f_4 = _get_scenario_point_type_ped_is_using(Local_19);
				Local_19.f_3 = func_20(Local_19.f_4);
				Local_19.f_2 = _get_scenario_point_ped_is_using(Local_19, false);
				Local_19.f_1 = _get_entity_scenario_point_is_attached_to(Local_19.f_2);
				if (func_12(iLocal_43))
				{
		...
		case 4:
			...
			if (has_anim_event_fired(Local_19, -834364808) && !Local_19.f_13)
			{
				Local_19.f_13 = 1;
			...
			if (has_anim_event_fired(Local_19, 15695821) && !Local_19.f_14)
			{
				Local_19.f_14 = 1;
				if (Local_19 == Global_35)
				{
			...
			if (has_anim_event_fired(Local_19, -1898385492) && !Local_19.f_15)
			{
				if (Local_19.f_3 == 2)
				{
					Local_19.f_15 = 1;
			...
			if (!is_ped_using_any_scenario(Local_19))
			{
				if (!bLocal_44)
				{
					if (func_15(iLocal_42))
				...
				func_35(iLocal_42);
				clear_ped_tasks(Local_19, 1, 0);
				add_shocking_event_at_position(220865698, Global_36, -1f, -1f, -1f, -1f, -1f, -1, -1);
				iLocal_0 = 0;
			}
			break;
	}
...
int func_14()
{
	...
	while (iVar0 <= 25)
	{
		switch (iVar0)
		{
			...
			case 6:
			case 7:
				if (func_40(Global_1914319->f_3[iVar0]->f_25, Global_36))
				{
					return iVar0;
				}
				break;
...
int func_21(int iParam0)
{
	...
	return Global_20710[iVar0]->f_44;
}
...
void func_27()
{
	...
	{
		case 2:
			vLocal_39 = { get_offset_from_entity_in_world_coords(Local_19.f_1, 0.074814f, -0.117756f, 0.059386f) };
			Local_19.f_9[0] = create_object(&(Local_19.f_5[0]), vLocal_39, true, true, false, false, true);
			_0x8360c47380b6f351(Local_19.f_2, &(Local_19.f_9[0]), "OOXO", 1);
			vLocal_39 = { get_offset_from_entity_in_world_coords(Local_19.f_1, -0.082664f, -0.117757f, 0.059386f) };
			Local_19.f_9[1] = create_object(&(Local_19.f_5[0]), vLocal_39, true, true, false, false, true);
			_0x8360c47380b6f351(Local_19.f_2, &(Local_19.f_9[1]), "OXOO", 1);
			vLocal_39 = { get_offset_from_entity_in_world_coords(Local_19.f_1, 0f, 0f, 0f) };
			Local_19.f_9[2] = create_object(&(Local_19.f_5[2]), vLocal_39, true, true, false, false, true);
			_0x8360c47380b6f351(Local_19.f_2, &(Local_19.f_9[2]), "Pick", 1);
			break;
		case 0:
		case 1:
			vLocal_39 = { get_offset_from_entity_in_world_coords(Local_19.f_1, 0.074814f, -0.117756f, 0.059386f) };
...
int func_29(int iParam0, int iParam1)
{
	...
	iVar0 = func_51(iVar0, get_random_int_in_range(2000, 2200), get_random_int_in_range(2800, 3000));
	iVar1 = iVar0;
	iVar2 = floor((0.25f * IntToFloat(func_21(iParam0))));
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_68(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_68(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_68(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_68(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_50(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_73(1811977508, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_54(int iParam0, char* sParam1, int iParam2)
{
	...
	func_68(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_55(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_68(_create_var_string(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		...
		func_68(_create_var_string(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_59(int iParam0)
{
	...
	fVar1 = func_81(absf(fVar1) < 1f, func_81(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_84((get_game_timer() + iParam2), !bParam1);
...
void func_65(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_86(iParam0));
...
void func_79(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_77())
	{
		func_68(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, -585750914, 0, 0, 0, 1);
	}
	else
	{
		func_68(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, -585750914, 0, 0, 0, 1);
	}
}
