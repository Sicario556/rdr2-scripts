...
bool func_1(var uParam0)
{
	if (bLocal_18)
	{
		set_vehicle_doors_locked(Global_36603, 1);
	}
	return true;
}
...
bool func_72(var uParam0)
{
	...
	if (!does_entity_exist(Global_36603))
	{
...
bool func_83(var uParam0)
{
	if (does_entity_exist(Global_36603))
	{
		if (is_ped_in_vehicle(Global_35, Global_36603, true))
		{
			return false;
		}
		if (!bLocal_18)
		{
			set_vehicle_doors_locked(Global_36603, 2);
			bLocal_18 = true;
