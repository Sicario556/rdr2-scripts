...
{
	func_33(uParam0, 10809, 10868, 11772);
}
					...
					if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), 811542464))
							{
								...
								set_ped_config_flag(&(uParam0->f_20[0]), 288, false);
								_task_smart_flee_style_coord(&(uParam0->f_20[0]), uParam0->f_483, 3, 0, -1082130432, -1, 0);
						...
						if (!&uParam0->f_469[5])
						{
							if (has_anim_event_fired(&(uParam0->f_20[1]), 811542464))
							{
								...
								set_ped_config_flag(&(uParam0->f_20[1]), 288, false);
								_task_smart_flee_style_coord(&(uParam0->f_20[1]), uParam0->f_483, 3, 0, -1082130432, -1, 0);
...
void func_69(var uParam0)
{
	...
	if (!func_109(&(uParam0->f_20[1]), 518218985))
	{
...
bool func_78(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_122(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_79(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_122(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_143(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_107(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_170(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_170(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_170(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_108(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_122(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_170(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
