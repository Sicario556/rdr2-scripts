...
{
	func_33(uParam0, 10949, 11007, 11697);
}
...
{
	return has_model_loaded(iLocal_37);
}
...
bool func_28(var uParam0)
{
	...
	{
		uParam0->f_453 = create_vehicle(iLocal_37, uParam0->f_483, uParam0->f_486.f_2, true, true, true, false);
		return false;
	}
	if (does_entity_exist(uParam0->f_453))
	{
		if (!is_entity_dead(uParam0->f_453))
		{
			...
			while (iVar0 <= 10)
			{
				if (does_extra_exist(uParam0->f_453, iVar0))
				{
					set_vehicle_extra(uParam0->f_453, iVar0, true);
				}
				iVar0++;
			}
			freeze_entity_position(uParam0->f_453, true);
			return true;
		}
	}
	return false;
		...
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			if (func_71(uParam0, 1065353216, 55f, 4, 15f, 1112014848))
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					...
					_0xbec65c6049b3219d(&(uParam0->f_20[0]), &(uParam0->f_372[0]), "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", "", 1);
					uParam0->f_469[1] = 1;
					uParam0->f_469[2] = 1;
					return 0;
				}
			...
			if (_does_anim_scene_exist(uParam0->f_3.f_1))
			{
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
					{
						...
						_0x3bbdd6143ff16f98(&(uParam0->f_20[0]), &(uParam0->f_372[0]), "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", 0, 1);
						vVar0 = { func_73(uParam0) };
						if (does_scenario_exist_in_area(vVar0, 0.5f, true, 0, false) && !_0xea31f199a73801d3(_find_closest_active_scenario_point_of_type(vVar0, 704531824, 0.5f, 0, false)))
						{
							_task_use_nearest_scenario_to_coord(&(uParam0->f_20[0]), vVar0, 0.5f, 1000, false, false, false, false);
						}
						else
						{
							task_wander_standard(&(uParam0->f_20[0]), get_entity_heading(&(uParam0->f_20[0])), 0);
						}
						force_ped_motion_state(&(uParam0->f_20[0]), -1401977097, false, 0, true);
...
{
	func_61(uParam0, 1);
	freeze_entity_position(uParam0->f_453, false);
...
{
	if (!does_entity_exist(&(uParam0->f_20[0])) || !does_entity_exist(&(uParam0->f_372[0])))
	{
		return;
	}
	freeze_entity_position(&(uParam0->f_20[0]), !bParam1);
	set_ped_can_ragdoll(&(uParam0->f_20[0]), bParam1);
	set_entity_collision(&(uParam0->f_20[0]), bParam1, false);
	set_entity_collision(&(uParam0->f_372[0]), bParam1, false);
}
...
Vector3 func_73(var uParam0)
{
	...
	switch (func_46())
	{
		case 0:
			...
			{
				case 5:
					*vVar4[0] = { 2601.62f, -1490.32f, 44.97f };
					break;
			}
			break;
		case 9:
			...
			{
				case 76:
					*vVar4[0] = { -283.55f, 775.36f, 117.82f };
					*vVar4[1] = { -269.29f, 641.98f, 112.46f };
					*vVar4[2] = { -366.72f, 778.44f, 115.18f };
					break;
			}
			break;
		case 11:
			...
			{
				case 105:
					*vVar4[0] = { 1326.37f, -1370.9f, 78.99f };
					break;
				default:
					*vVar4[0] = { 1051.79f, -1126.71f, 66.9f };
					break;
			}
			break;
	}
...
void func_103(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_164(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_164(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_164(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
