...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[110]->f_4;
	_0xb469cfd9e065eb99(iLocal_14, 26);
	iLocal_15 = _create_volume_aggregate_with_custom_name("Manzanita - m_volGeneralStore Agg");
	_0x39816f6f94f385ad(iLocal_15, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	_0x39816f6f94f385ad(iLocal_15, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	_0x39816f6f94f385ad(iLocal_15, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	_0x39816f6f94f385ad(iLocal_15, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	iLocal_16 = _create_volume_aggregate_with_custom_name("Manzanita - m_volArtistOwner Agg");
	_0x39816f6f94f385ad(iLocal_16, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	_0x39816f6f94f385ad(iLocal_16, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
	_0xb469cfd9e065eb99(iLocal_15, 10106);
	return true;
}
...
void func_28(int iParam0)
{
	...
	func_50(727, iLocal_15, 1);
	func_50(728, iLocal_15, 0);
	func_50(729, iLocal_15, 0);
	func_50(730, iLocal_15, 0);
	func_50(725, iLocal_16, 1);
	func_50(726, iLocal_16, 0);
}
...
void func_77(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_122(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_85(int iParam0, bool bParam1)
{
	...
	if (func_123(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_87(iParam0));
				func_127(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_87(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_87(iParam0)))
	{
		func_127(iParam0, 128);
		return 1;
	}
	func_126(iParam0, _create_persistent_character(func_125(iParam0)));
	_0x4f81ead1de8fa19b(func_87(iParam0));
	if (func_123(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_87(iParam0));
		func_127(iParam0, 2048);
...
bool func_86(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_87(iParam0));
}
...
{
	if (func_83(Global_1914319->f_3[iParam0]->f_21) && func_147(Global_1914319->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_122(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_124(int iParam0, bool bParam1)
{
	...
	func_157(iParam0);
	_0xfc77c5b44d5ff7c0(func_87(iParam0));
	func_126(iParam0, 0);
	return 1;
}
