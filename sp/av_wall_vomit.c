...
{
	func_33(uParam0, 11160, 11316, 11712);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	switch (*uParam0)
	{
		...
		case 25:
			...
			if (func_51(&(uParam0->f_20[0]), 0))
			{
				iVar0 = get_entity_model(&(uParam0->f_20[0]));
			}
			else
			{
				iVar0 = func_48(func_47());
	...
	while (iVar12 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar12]->f_2 != 0)
		{
			...
			if (is_entity_dead(&(uParam0->f_20[iVar12])))
			{
				...
				{
					uParam0->f_20[iVar12] = func_60(uParam0->f_20[iVar12]->f_2, uParam0->f_20[iVar12]->f_5, uParam0->f_20[iVar12]->f_8, 1, 1, 0, 1, uParam0->f_20[iVar12]->f_11, uParam0->f_20[iVar12]->f_9, 0, 0, 0, 0);
				}
				...
				if (!is_ped_human(&(uParam0->f_20[iVar12])))
				{
					if (!func_61(&(uParam0->f_20[iVar12])))
					{
...
bool func_28(var uParam0)
{
	...
	{
		if (!is_ped_active_in_scenario(&(uParam0->f_20[0]), 1) && !func_62(&(uParam0->f_20[0]), 993674639))
		{
			func_63(&(uParam0->f_20[0]), iLocal_39, 0, 0, 0, -1082130432);
		}
		...
		if (_0x02ebbb3989b7e695(&(uParam0->f_20[0])))
		{
			if (func_65(uParam0, 1065353216, 1116471296, 4, 10f, 1112014848))
			{
				_0x406ccf555b04fad3(&(uParam0->f_20[0]), 1, 0.7f);
				func_66(uParam0);
				return true;
			}
		}
		...
		if (does_entity_exist(&(uParam0->f_20[0])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
			{
				...
				if (!uParam0->f_500)
				{
					if (bLocal_38)
					{
						task_wander_standard(&(uParam0->f_20[0]), 40000f, 0);
					}
					else
					{
						func_63(&(uParam0->f_20[0]), iLocal_39, 45000, 0, 0, -1082130432);
					}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_104(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_105(&(uParam0->f_490)))
							{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_184(1) || *uParam0 & 8192 != 0))
				{
...
bool func_144(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_197(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_195(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_196(uParam2)
				{
					func_191(uParam2, 1);
					return true;
				}
...
bool func_145(int iParam0, var uParam1)
{
	...
	if (func_187(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_196(uParam1)
		{
...
bool func_190(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_210(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_229(iVar0, 0)))
		{
...
bool func_195(var uParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_197(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_229(iVar0, 0)))
		{
			if (func_231(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_202(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_204(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_206(var uParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_234(iParam1))
	{
...
float func_210(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_211(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_216(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_210(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_217(int iParam0, var uParam1, bool bParam2)
{
...
bool func_226(bool bParam0, int iParam1, int iParam2)
{
...
bool func_230(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_231(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_231(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_233(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
