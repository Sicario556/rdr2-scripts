...
{
	func_33(uParam0, 10777, 10829, 12023);
}
				...
				if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_66(uParam0);
								_0x10f96086123b939f(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 180f);
						...
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), -1795669989))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									...
									func_73(uParam0->f_20[0], 1, 1);
									func_75(&(uParam0->f_20[0]), -75130390, vLocal_39, 0f, -1, 1, 0, 0, -1082130432);
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (uParam0->f_469[4] && !&uParam0->f_469[5])
	{
		...
		else if (is_ped_active_in_scenario(&(uParam0->f_20[0]), 0) && _get_scenario_point_type_ped_is_using(&(uParam0->f_20[0])) == -75130390)
		{
			...
			detach_entity(&(uParam0->f_20[1]), true, true);
			set_ped_to_ragdoll(&(uParam0->f_20[1]), 10000, 10000, 0, false, false, false);
	...
	if ((!bParam1 && uParam0->f_469[4]) // PointerArith && !&uParam0->f_469[5])
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (func_77(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
void func_68(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		{
			if (!func_113(&(uParam0->f_20[0]), 518218985))
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[0]), Global_35, 3, 256, -1082130432, -1, 0);
				func_73(uParam0->f_20[0], 0, 1);
			}
		}
		else if (!func_113(&(uParam0->f_20[0]), 1139527981))
		{
...
void func_69(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), -1767074329))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_77(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_77(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_64(&(uParam0->f_490)))
							{
