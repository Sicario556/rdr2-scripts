...
int func_31(var uParam0)
{
	...
	if (!bLocal_40)
	{
		if (has_anim_event_fired(&(uParam0->f_20[0]), 725039534))
		{
			func_61(uParam0->f_20[0], 1, 1);
			func_61(uParam0->f_20[1], 1, 1);
			bLocal_40 = true;
		}
	}
	else if (!has_anim_event_fired(&(uParam0->f_20[0]), 725039534))
	{
		func_61(uParam0->f_20[0], 0, 1);
		func_61(uParam0->f_20[1], 0, 1);
		bLocal_40 = false;
	}
	if (!&uParam0->f_469[0])
	{
		...
		{
			_0x5288b7f0690f7c1f(&(uParam0->f_20[0]));
		}
		if (!bLocal_39 == 1)
		{
			if (((func_62(uParam0, &uLocal_11, 0) || func_63(&(uParam0->f_20[0]), Global_35, 1) < 225f) || func_63(&(uParam0->f_20[1]), Global_35, 1) < 225f) || has_bullet_impacted_in_area(get_entity_coords(&(uParam0->f_20[1]), true, false), 2f, true, true))
			{
				bLocal_39 = true;
			}
		}
							...
							if (!is_entity_dead(&(uParam0->f_20[0])))
							{
								if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
								{
									if (does_entity_exist(&(uParam0->f_20[1])))
									{
										...
										task_play_anim(&(uParam0->f_20[0]), sVar0, sVar1, 8f, -8f, -1, 65553, 0f, false, 0, false, "LegsOnlyBird_filter", false);
										set_ped_can_be_targetted(&(uParam0->f_20[1]), false);
										attach_entity_to_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), get_ped_bone_index(&(uParam0->f_20[0]), 38142), vVar3, vVar6, false, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
			...
			if (!&uParam0->f_469[3])
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), 1688442774))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									remove_anim_scene_entity(uParam0->f_3.f_1, uParam0->f_20[0]->f_1, &(uParam0->f_20[0]));
									force_ped_motion_state(&(uParam0->f_20[0]), -1299979036, false, 0, false);
									task_fly_away(&(uParam0->f_20[0]), Global_35);
									set_ped_keep_task(&(uParam0->f_20[0]), true);
									func_61(uParam0->f_20[0], 1, 1);
									set_ped_config_flag(&(uParam0->f_20[0]), 288, true);
									uParam0->f_469[3] = 1;
								}
							}
						}
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_63(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
void func_68(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		task_force_motion_state(0, -1299979036, false);
...
void func_69(var uParam0)
{
	...
	{
		iVar1 = -1115154469;
		if (has_anim_event_fired(&(uParam0->f_20[1]), -1401953231))
		{
		...
		{
			if (has_anim_event_fired(&(uParam0->f_20[1]), 1118956789))
			{
				iVar1 = -1871534317;
			}
			open_sequence_task(&iVar0);
			task_force_motion_state(0, iVar1, false);
			...
			_0x2208438012482a1a(&(uParam0->f_20[1]), false, false);
			clear_sequence_task(&iVar0);
		}
	}
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_63(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_63(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_64(&(uParam0->f_490)))
							{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_175(1) || *uParam0 & 8192 != 0))
				{
...
bool func_139(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_188(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_186(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_187(uParam2)
				{
					func_182(uParam2, 1);
					return true;
				}
...
bool func_140(int iParam0, var uParam1)
{
	...
	if (func_178(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_187(uParam1)
		{
...
bool func_184(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_220(iVar0, 0)))
		{
...
bool func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_220(iVar0, 0)))
		{
			if (func_222(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_210(int iParam0)
{
	...
	return func_228((*Global_1347702)[58]->f_15, 1);
}
...
bool func_221(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_222(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
