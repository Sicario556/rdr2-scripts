...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	bLocal_12 = func_49();
	iLocal_10 = get_random_int_in_range(0, 11);
	switch (iVar2)
	{
		case 0:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
			uParam0->f_19 = 4;
			break;
		case 1:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -1.75f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, -1f, 0f), (25f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			uParam0->f_19 = 5;
			break;
		case 2:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -1.75f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 2, "RNP_MAN_3", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 1.75f, 0.75f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, -1f, 0f), (25f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 5, "RNP_HORSE_3", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, 2.75f, -1.6f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
	}
}
	...
	while (iVar0 < uParam0->f_19)
	{
		if (does_entity_exist(&(uParam0->f_20[iVar0])))
		{
			...
			if (does_entity_belong_to_this_script(&(uParam0->f_20[iVar0]), true))
			{
				...
				{
					_0x39a2fc5af55a52b1(&(uParam0->f_20[iVar0]), -1);
					_0x36e4b61dc56de77c(&(uParam0->f_20[iVar0]), 5f, 5f, 1000, 1000);
					set_ped_as_no_longer_needed(uParam0->f_20[iVar0]);
				}
...
void func_68(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			_0xeeed8fafec331a70(&(uParam0->f_20[iVar0]), Global_36, 3);
			open_sequence_task(&iVar1);
			if (!is_ped_on_mount(&(uParam0->f_20[iVar0])))
			{
				if (iVar0 == 0)
				{
					task_mount_animal(0, &(uParam0->f_20[3]), -1, -1, 2f, 1, 0, 0);
				}
				else if (iVar0 == 1)
				{
					task_mount_animal(0, &(uParam0->f_20[4]), -1, -1, 2f, 1, 0, 0);
				}
				else
				{
					task_mount_animal(0, &(uParam0->f_20[5]), -1, -1, 2f, 1, 0, 0);
				}
			}
...
void func_69(var uParam0, bool bParam1, int iParam2)
{
	if (!bParam1)
	{
		if (!is_entity_dead(&(uParam0->f_20[iParam2])))
		{
			if (!func_104(&(uParam0->f_20[iParam2]), -76381094))
			{
				func_105(&(uParam0->f_20[iParam2]->f_5), 50, 10, 0);
				if (iParam2 == 1)
				{
					_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[4]), 0);
					iLocal_11 = 871322766;
				}
				else if (iParam2 == 2)
				{
					_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[5]), 0);
					iLocal_11 = 1546182539;
				}
				else
				{
					_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[3]), 0);
				}
				func_106(&(uParam0->f_20[iParam2]), iLocal_11, 0, 0, 0, -1082130432);
				if (!_0x5102307ce88798eb(&(uParam0->f_20[iParam2])))
				{
					request_ped_visibility_tracking(&(uParam0->f_20[iParam2]));
				}
				set_ped_relationship_group_hash(&(uParam0->f_20[iParam2]), -401180987);
				set_ped_config_flag(&(uParam0->f_20[iParam2]), 146, true);
				func_107(uParam0->f_20[iParam2], 1, 1);
				_give_weapon_to_ped_2(&(uParam0->f_20[iParam2]), -2002235300, 500, false, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				set_current_ped_weapon(&(uParam0->f_20[iParam2]), -2002235300, true, 0, true, false);
				return;
			}
		}
	}
	else if (!is_entity_dead(&(uParam0->f_20[iParam2])))
	{
		if (!is_ped_on_mount(&(uParam0->f_20[iParam2])))
		{
			func_105(&(uParam0->f_20[iParam2]->f_5), 50, 10, 0);
			if (iParam2 == 0)
			{
				func_108(&(uParam0->f_20[iParam2]), &(uParam0->f_20[3]), 1, -1, 1);
				_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[3]), 0);
			}
			else if (iParam2 == 1)
			{
				func_108(&(uParam0->f_20[iParam2]), &(uParam0->f_20[4]), 1, -1, 1);
				_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[4]), 0);
			}
			else
			{
				func_108(&(uParam0->f_20[iParam2]), &(uParam0->f_20[5]), 1, -1, 1);
				_0x931b241409216c1f(&(uParam0->f_20[iParam2]), &(uParam0->f_20[5]), 0);
			}
			set_ped_relationship_group_hash(&(uParam0->f_20[iParam2]), -401180987);
			set_ped_config_flag(&(uParam0->f_20[iParam2]), 146, true);
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_113(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
void func_71(var uParam0)
{
	...
	{
		_0x463803429297117c(&(uParam0->f_20[0]), Global_36, 0, 0);
		open_sequence_task(&iVar0);
		if (!is_ped_on_mount(&(uParam0->f_20[0])))
		{
			task_mount_animal(0, &(uParam0->f_20[3]), -1, -1, 1.5f, 1, 0, 0);
		}
		_task_smart_flee_style_ped(0, Global_35, 1, 524288, -1082130432, -1, 0);
	...
	{
		_0x463803429297117c(&(uParam0->f_20[1]), Global_36, 0, 0);
		open_sequence_task(&iVar0);
		if (!is_ped_on_mount(&(uParam0->f_20[1])))
		{
			task_mount_animal(0, &(uParam0->f_20[4]), -1, -1, 1.5f, 1, 0, 0);
		}
		_task_smart_flee_style_ped(0, Global_35, 1, 524288, -1082130432, -1, 0);
		close_sequence_task(iVar0);
		_task_perform_sequence_2(&(uParam0->f_20[1]), iVar0, 1f, 1f);
		set_ped_keep_task(&(uParam0->f_20[1]), true);
		clear_sequence_task(&iVar0);
	}
	if (!is_entity_dead(&(uParam0->f_20[2])))
	{
		_0x463803429297117c(&(uParam0->f_20[2]), Global_36, 0, 0);
		open_sequence_task(&iVar0);
		if (!is_ped_on_mount(&(uParam0->f_20[2])))
		{
			task_mount_animal(0, &(uParam0->f_20[5]), -1, -1, 1.5f, 1, 0, 0);
		}
		_task_smart_flee_style_ped(0, Global_35, 1, 524288, -1082130432, -1, 0);
		close_sequence_task(iVar0);
		_task_perform_sequence_2(&(uParam0->f_20[2]), iVar0, 2.2f, 2.2f);
...
bool func_72(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
			{
				return false;
			}
		}
...
bool func_77(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_118(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_78(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_118(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_119(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_163(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_214(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_214(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_214(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_164(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_118(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
