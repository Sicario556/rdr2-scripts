		...
		if (get_game_timer() > iLocal_85)
		{
			...
			switch (iLocal_84)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_86));
					...
					Global_1897950 = -1;
					iLocal_87 = (get_game_timer() + iLocal_83);
					iLocal_84 = 2;
					break;
				case 2:
					if (func_11() || iLocal_87 < get_game_timer())
					{
						func_12(iLocal_86);
						iLocal_87 = (get_game_timer() + iLocal_83);
						iLocal_84 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_86) || iLocal_87 < get_game_timer())
					{
						func_14(iLocal_86);
						iLocal_87 = (get_game_timer() + iLocal_83);
						iLocal_84 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_86) || iLocal_87 < get_game_timer())
					{
						func_16(iLocal_86);
						iLocal_87 = (iLocal_83 + get_game_timer());
						iLocal_84 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_86)))
					{
						if (func_17(func_6(iLocal_86), 4) && !iLocal_87 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_86) || iLocal_87 < get_game_timer())
							{
								func_19(iLocal_86, 4);
								iLocal_87 = (iLocal_83 + get_game_timer());
								iLocal_84 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_87 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_86);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_86]->f_10);
							if ((*Global_1888801)[iLocal_86]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_86]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_86]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_86]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volTown Agg");
	_0xbce668aaf83608be(iLocal_14, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 69.6883f, 50.95198f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 49.04269f, 28.47917f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583631f, 30.73095f, 51.93652f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76538f, 38.38671f, 59.01843f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 38.38671f, 37.38729f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 11.55689f, 14.41201f, 15.9332f);
	_0x39816f6f94f385ad(iLocal_14, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644386f, 138.1747f, 21.08713f, 16.54283f);
	_0xbce668aaf83608be(iLocal_14, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 8.372574f, 17.93935f, 18.54283f);
	_0x39816f6f94f385ad(iLocal_14, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 15.22373f, 31.89837f, 18.54283f);
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volThreat Agg");
		_0x39816f6f94f385ad(iLocal_17, 2065.472f, -851.4658f, 42.55719f, 0f, 0f, 0f, 19.02366f, 13.64085f, 16.67954f);
		_0x39816f6f94f385ad(iLocal_17, 2019.272f, -774.1213f, 41.40026f, 0f, 0f, 37.13808f, 9.83179f, 10.20259f, 16.67954f);
		_0x39816f6f94f385ad(iLocal_17, 2013.173f, -774.8469f, 41.40026f, 0f, 0f, 37.13808f, 4.350712f, 4.302257f, 16.67954f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_17);
		_0xbce668aaf83608be(iLocal_15, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 36.89741f, 35.70032f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76539f, 36.89741f, 57.33146f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 10.22549f, 13.5511f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 1998.531f, -853.2407f, 44.706f, 0f, 0f, 0f, 45.40543f, 35.23671f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 6.372574f, 15.93935f, 16.54283f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volWarning Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_15);
		_0xbce668aaf83608be(iLocal_16, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 68.19901f, 49.26501f, 15.9332f);
		_0xbce668aaf83608be(iLocal_16, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583632f, 29.24165f, 50.24955f, 15.9332f);
		_0xbce668aaf83608be(iLocal_16, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 47.55339f, 26.7922f, 15.9332f);
		_0x39816f6f94f385ad(iLocal_16, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644384f, 136.6854f, 19.40016f, 15.9332f);
		_0x39816f6f94f385ad(iLocal_16, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 13.22373f, 29.89837f, 16.54283f);
		sLocal_18 = "ORANGE_PLANTATION";
		_create_guard_zone(sLocal_18);
		_0x8c598a930f471938(sLocal_18, iLocal_14);
		_0x35815f372d43e1e5(sLocal_18, iLocal_15);
		_0xad3e07c37a7c1adc(sLocal_18, iLocal_16);
		_0xa1b0e6301e2e02a6(sLocal_18, iLocal_17);
		_set_guard_zone_position(sLocal_18, 2066.902f, -851.1766f, 43.3946f);
		_0xa8a74aa79fb67159(sLocal_18, iLocal_14);
	}
	return true;
}
...
bool func_38(int iParam0)
{
	if (!bLocal_82)
	{
		if (does_entity_exist(iLocal_80))
		{
			...
			{
				if (!decor_exist_on(iLocal_80, "HAS_VOICE") || !decor_get_bool(iLocal_80, "HAS_VOICE"))
				{
					decor_set_bool(iLocal_80, "HAS_VOICE", true);
					set_ambient_voice_name(iLocal_80, "0941_A_M_M_Foreman_White_AVOID_01");
					bLocal_82 = true;
				}
			}
		}
	...
	if (!bLocal_81)
	{
		...
		{
			if (!is_entity_dead(iLocal_79))
			{
				if (!decor_exist_on(iLocal_79, "HAS_VOICE") || !decor_get_bool(iLocal_79, "HAS_VOICE"))
				{
					decor_set_bool(iLocal_79, "HAS_VOICE", true);
					set_ambient_voice_name(iLocal_79, "0946_A_M_M_Guard_White_AGGRESSIVE_01");
					bLocal_81 = true;
				}
			}
		}
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_56(&Global_1935630, 16384)) || func_56(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_59((*uParam0)[iVar3], 1) && func_60(iParam1)) && !func_61(iParam1, 16))
							{
								func_63(iParam1, func_62(), -1, 0, -1, 0);
								func_64((*uParam0)[iVar3], 1);
							}
							func_65(iParam1, 0);
						}
						bVar0 = true;
...
void func_55(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_0x800df3fc913355f3(_0x112ddf56300bc6e5(func_92(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_0x187d65f3aec5d679(func_92(uParam0->f_1), &(uParam0->f_3));
			}
			if (does_entity_exist(_0x31c70a716cae1fee(_0x112ddf56300bc6e5(func_92(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
			...
			break;
		case 6:
			if (_0xf8de7154f7d1458f(_0x112ddf56300bc6e5(func_92(uParam0->f_1))) == uParam0->f_11)
			{
				*uParam0 = 9;
			}
			else
			{
				_0x669c25840c6f7ae2(_0x112ddf56300bc6e5(func_92(uParam0->f_1)), uParam0->f_11);
			}
			break;
		case 8:
...
bool func_60(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_101(iParam0));
}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_115(&cVar6, 109029619), sVar9, func_115(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_115(&cVar6, 109029619), func_115(&cVar10, 109029619));
		}
...
{
	if (func_130(iLocal_80, 0))
	{
		decor_set_bool(iLocal_80, "HAS_VOICE", false);
	}
	if (func_130(iLocal_79, 0))
	{
		decor_set_bool(iLocal_79, "HAS_VOICE", false);
	}
...
void func_78(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_135(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_138(iParam0, _create_persistent_character(func_92(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_90(iParam0));
				func_139(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_90(iParam0));
		}
		return 0;
	}
	...
	func_138(iParam0, _create_persistent_character(func_92(iParam0)));
	_0x4f81ead1de8fa19b(func_90(iParam0));
	if (func_136(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_90(iParam0));
		func_139(iParam0, 2048);
...
{
	iVar0 = _0x112ddf56300bc6e5(func_92(uParam0->f_1));
	if (_0x800df3fc913355f3(iVar0))
	{
...
char* func_115(char* sParam0, int iParam1)
{
	...
	return func_150(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_118(int iParam0)
{
	...
	if (func_151())
	{
		if (!func_152((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_157(Global_1935369->f_5[iParam0]->f_6, 1);
	func_158(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_85(Global_1914319->f_3[iParam0]->f_21) && func_160(Global_1914319->f_3[iParam0]->f_21))
	{
		func_161(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_162(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_135(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_170(iParam0);
	_0xfc77c5b44d5ff7c0(func_90(iParam0));
	func_138(iParam0, 0);
	return 1;
}
...
bool func_144(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_173(iVar0) && func_174((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_180(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
bool func_176(vector3 vParam0, int iParam3)
{
