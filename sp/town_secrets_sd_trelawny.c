...
bool func_17()
{
	...
	{
		iVar1 = iVar0;
		request_model(func_35(iVar1), false);
		iVar0++;
	}
	_0xed9582b3da8f02b4(4);
	if (_does_text_database_exist(func_36()))
	{
		_text_database_request(func_36());
	}
	return true;
}
...
bool func_18()
{
	...
	{
		iVar2 = iVar1;
		if (!has_model_loaded(func_35(iVar2)))
		{
			iVar0 = 0;
		}
		iVar1++;
	}
	if (!_text_database_has_loaded(func_36()))
	{
		iVar0 = 0;
	}
	return iVar0;
...
bool func_19(int iParam0)
{
	...
	while (iVar0 <= (2 - 1))
	{
		if (!_does_volume_exist(&(iParam0->f_7[iVar0])))
		{
			iVar2 = iVar0;
			Var3 = { func_39(iVar2) };
			iParam0->f_7[iVar0] = _create_volume_by_hash_with_custom_name(Var3.f_10, Var3, Var3.f_3, Var3.f_6, Var3.f_9);
		}
		iVar0++;
	}
		...
		if (&Global_40.f_4283.f_6[iVar0] == 176656832)
		{
			...
			if (func_48(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_49(Global_40.f_4283.f_6[iVar4], 1, 0);
					}
					iVar4++;
				}
			}
...
int func_32(int iParam0)
{
	...
	while (iVar0 <= (4 - 1))
	{
		...
		if (is_model_valid(func_35(iVar1)))
		{
			set_model_as_no_longer_needed(func_35(iVar1));
		}
		if (_text_database_has_loaded(func_36()))
		{
			_text_database_delete(func_36());
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (2 - 1))
	{
		if (_does_volume_exist(&(iParam0->f_7[iVar0])))
		{
			_delete_volume(&(iParam0->f_7[iVar0]));
		}
		iVar0++;
	}
