			...
			switch (iLocal_18)
			{
				...
				case 3:
					if (func_20())
					{
						func_21();
						func_22();
						if (_does_volume_exist(Local_37.f_173))
						{
							func_23(&(Local_37.f_173), uLocal_602[2], 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 1, 16384, 1, 0, 0);
						}
						iLocal_606[0] = _create_weapon_object(1885857703, 1, Local_37.f_51, true, 1f);
						iLocal_606[1] = _create_weapon_object(1885857703, 1, Local_37.f_51, true, 1f);
						func_24();
						func_25(-1993960878);
						iLocal_18 = 4;
					}
				...
				case 4:
					...
					if (!Local_37.f_46)
					{
						if (func_27(&uLocal_584, &(Local_37.f_5), &uLocal_623, &uLocal_30, 0, 2, 1))
						{
							Local_37.f_46 = 1;
							if (iVar621 == 1024)
							{
								if (iLocal_17 < 3)
								{
									func_29(uLocal_584[1], iVar342, func_28(1));
...
void func_8()
{
	...
	set_object_as_no_longer_needed(iLocal_606[0]);
	set_object_as_no_longer_needed(iLocal_606[1]);
	func_47();
	...
	switch (iLocal_16)
	{
		case 0:
			if (func_49(&Local_37))
			{
				...
				_0x72d4cb5db927009c(1885857703, -1, 0);
				iLocal_16 = 1;
			}
			break;
		case 1:
			...
			if (!_0xff07cf465f48b830(1885857703))
			{
				return false;
			}
			if (!_is_anim_scene_loaded(iVar342, true, false))
			{
				return false;
			}
			return true;
		...
		case 0:
			switch (*uParam2)
			{
				case 0:
					...
					_0x39816f6f94f385ad(uParam0->f_173, 2500.674f, -1202.069f, 52.246f, 0f, 0f, 0f, 35f, 55f, 10f);
					_0x39816f6f94f385ad(uParam0->f_173, 2498.81f, -1150.182f, 52.246f, 0f, 0f, 0f, 25f, 50f, 10f);
					_0x39816f6f94f385ad(uParam0->f_173, 2492.926f, -1249.251f, 52.246f, 0f, 0f, 0f, 30f, 40f, 10f);
					break;
			}
			break;
	}
...
{
	_get_scenario_point_close_to_coords(vParam0, 2f, uParam3, iParam4);
}
...
void func_19(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < iParam1)
	{
		...
		{
			_set_scenario_point_active(uParam0[iVar0], bParam2);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 3)
	{
		if (!is_entity_dead(&(uLocal_584[iVar0])))
		{
			remove_all_ped_weapons(&(uLocal_584[iVar0]), true, true);
			set_ped_config_flag(&(uLocal_584[iVar0]), 217, true);
			set_ped_relationship_group_hash(&(uLocal_584[iVar0]), 555364152);
			if (func_66(Local_234[iVar0]->f_11, 0, 1))
			{
				uLocal_588[iVar0] = Local_234[iVar0]->f_11;
				func_69(&(uLocal_588[iVar0]), func_67(iVar0), func_68(iVar0), 2, 1073741824);
				_0x931b241409216c1f(&(uLocal_584[iVar0]), &(uLocal_588[iVar0]), 0);
			}
		}
		iVar0++;
	}
	if (does_entity_exist(&(uLocal_588[0])))
	{
		Local_705[0]->f_1[0] = 1446246869;
		Local_705[0]->f_12[0] = 1;
		Local_705[0] = 1;
		Local_705[1]->f_1[0] = -963759116;
		Local_705[1]->f_12[0] = 1;
		Local_705[1] = 1;
		_0xa88e215ceb0435c0(&(uLocal_588[0]), Local_705[0], 205298116, 128, 2, 0);
		_0xa88e215ceb0435c0(&(uLocal_588[0]), Local_705[1], 205298116, 128, 2, 1);
	}
	if (does_entity_exist(&(uLocal_588[2])))
	{
		Local_705[2]->f_1[0] = 1681219929;
		Local_705[2]->f_12[0] = 2;
		Local_705[2] = 2;
		Local_705[3]->f_1[0] = 299161628;
		Local_705[3]->f_12[0] = 1;
		Local_705[3] = 1;
		_0xa88e215ceb0435c0(&(uLocal_588[2]), Local_705[2], 205298116, 128, 2, 0);
		_0xa88e215ceb0435c0(&(uLocal_588[2]), Local_705[3], 205298116, 128, 2, 1);
	}
	if (does_entity_exist(&(uLocal_588[1])))
	{
		Local_705[4]->f_1[0] = 1216207974;
		Local_705[4]->f_12[0] = 1;
		Local_705[4] = 1;
		Local_705[5]->f_1[0] = 1446246869;
		Local_705[5]->f_12[0] = 1;
		Local_705[5] = 1;
		_0xa88e215ceb0435c0(&(uLocal_588[1]), Local_705[4], 205298116, 128, 2, 0);
		_0xa88e215ceb0435c0(&(uLocal_588[1]), Local_705[5], 205298116, 128, 2, 1);
	}
	func_69(&(uLocal_584[1]), func_70(), func_71(), 2, 1073741824);
	func_72(&(uLocal_584[0]), 379542007, -1, 0, 0, 1056964608, 1065353216, 0);
	func_72(&(uLocal_584[1]), 379542007, -1, 0, 0, 1056964608, 1065353216, 0);
	func_72(&(uLocal_584[2]), 379542007, -1, 0, 0, 1056964608, 1065353216, 0);
...
void func_24()
{
	set_anim_scene_entity(iVar342, func_28(0), &(uLocal_584[0]), 0);
	set_anim_scene_entity(iVar342, func_28(2), &(uLocal_584[2]), 0);
	set_anim_scene_entity(iVar342, func_28(1), &(uLocal_584[1]), 0);
	set_anim_scene_entity(iVar342, "molotov_a", &(iLocal_606[0]), 0);
	set_anim_scene_entity(iVar342, "molotov_b", &(iLocal_606[1]), 0);
	set_anim_scene_bool(iVar342, "bool", false, false);
	start_anim_scene(iVar342);
}
...
bool func_27(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
...
{
	if (((!is_entity_dead(*uParam0) && _does_anim_scene_exist(iParam1)) && _is_anim_scene_started(iParam1, false)) && !is_string_null_or_empty(sParam2))
	{
		remove_anim_scene_entity(iParam1, sParam2, *uParam0);
	}
}

void func_30(int iParam0, char* sParam1, float fParam2, float fParam3)
{
	if (is_entity_dead(&(uLocal_584[iParam0])))
	{
		return;
	}
	...
	func_95(&(uLocal_584[iParam0]), uLocal_593[iParam0], 831283580, 580546400, 0, 0);
	func_96(&(uLocal_584[iParam0]));
	open_sequence_task(&iVar0);
	if (!is_string_null_or_empty(sParam1))
	{
		task_react(0, Global_35, Global_36, sParam1, 1f, 0, 4);
	}
	task_combat_ped(0, Global_35, 0, 0);
	func_97(&(uLocal_584[iParam0]), &iVar0, fParam2, fParam3, 1, 1);
	set_ped_keep_task(&(uLocal_584[iParam0]), true);
	iLocal_32[iParam0] = 1;
	if (!is_entity_dead(&(uLocal_588[iParam0])))
	{
...
void func_34()
{
	...
	{
		if (!is_entity_dead(&(uLocal_584[0])) && &uLocal_19[0] != 8)
		{
			func_32(&(uLocal_584[0]), Global_35, 8192, 0, 1073741824, 1);
		}
		else if (!is_entity_dead(&(uLocal_584[2])) && &uLocal_19[2] != 8)
		{
			func_32(&(uLocal_584[0]), Global_35, 8192, 0, 1073741824, 1);
		}
		else if (!is_entity_dead(&(uLocal_584[1])))
		{
	...
	else if (!is_entity_dead(&(uLocal_584[1])) && &uLocal_19[1] != 8)
	{
		func_32(&(uLocal_584[1]), Global_35, 2048, 0, 1073741824, 1);
	}
	else if (!is_entity_dead(&(uLocal_584[0])) && func_107(0))
	{
...
bool func_36()
{
	...
	switch (iLocal_17)
	{
		...
		case 1:
			func_115();
			if (func_116(&Local_37, &uLocal_231, 0.5f, 50f, 20f, 750, 3f, 4.5f, 1, 0, 1, -1082130432, 1, 0, 0))
			{
				func_95(&(uLocal_584[0]), uLocal_593[0], -89429847, 580546400, 0, 0);
				func_117(vLocal_652[1]);
				if (!does_blip_exist(Local_37.f_181))
				{
					func_95(&(uLocal_584[0]), uLocal_593[0], -89429847, 580546400, 0, 0);
				}
				func_118(&Local_331);
				_set_anim_scene_playback_list_bool(iVar342, func_119(1), true);
				func_120(&(Local_357[0]->f_21), Local_357[0]);
				func_120(&(Local_357[2]->f_21), Local_357[2]);
				func_120(&(Local_357[1]->f_21), Local_357[1]);
				func_33(&iLocal_17, 2);
			}
			break;
		case 2:
			...
			if (func_122())
			{
				Local_37.f_44 = 1;
				func_41();
				func_117(vLocal_652[7]);
				func_123(Local_357[0]->f_21[1], 1, 0);
				func_123(Local_357[2]->f_21[1], 1, 0);
				func_123(Local_357[1]->f_21[1], 1, 0);
		...
		case 4:
			...
			{
				func_128();
				func_117(vLocal_652[4]);
				func_33(&iLocal_17, 8);
			}
			if (func_129(&uLocal_588) && func_130(&uLocal_584, &(Local_37.f_5), &uLocal_623, 0, -1))
			{
				func_32(&(uLocal_584[1]), Global_35, 4096, 0, 1073741824, 1);
				func_30(1, "", 0, 0);
				func_30(0, "", 0, 0);
		...
		case 7:
			if (!func_43(268435456))
			{
				...
				{
					func_131(268435456);
					_set_incident_unk(iVar607);
					delete_incident(iVar607);
				}
			}
			if (func_103(-4f, 1, 0, 0))
			{
				if (!func_132(16384))
				{
					...
					while (iVar0 < 3)
					{
						if (!is_entity_dead(&(uLocal_584[iVar0])) && is_entity_on_fire(&(uLocal_584[iVar0])))
						{
							func_32(&(uLocal_584[iVar0]), Global_35, 16384, 0, 1073741824, 1);
						}
						iVar0++;
					}
				}
				...
				{
					if (!is_entity_dead(&(uLocal_584[2])) && is_entity_on_fire(&(uLocal_584[2])))
					{
		...
		case 8:
			...
			else if (func_43(67108864))
			{
				...
				{
					if (func_135(vLocal_652[8], 10f))
					{
						func_33(&iLocal_17, 9);
					}
					else if (!func_136(vLocal_652[8]))
					{
						func_117(vLocal_652[8]);
					}
				}
			}
			else if (func_135(vLocal_652[4], 20f))
			{
				func_33(&iLocal_17, 9);
			}
			break;
...
void func_41()
{
	if (!_does_anim_scene_exist(iVar342))
	{
		return;
	}
	remove_anim_scene_entity(iVar342, func_28(0), &(uLocal_584[0]));
	remove_anim_scene_entity(iVar342, func_28(2), &(uLocal_584[2]));
	remove_anim_scene_entity(iVar342, func_28(1), &(uLocal_584[1]));
	func_149(iLocal_606[0], iVar342, "molotov_a");
	func_149(iLocal_606[1], iVar342, "molotov_b");
}
...
void func_44()
{
	...
	while (iVar0 < 3)
	{
		if (!is_entity_dead(&(uLocal_584[iVar0])) && !&iLocal_32[iVar0])
		{
			func_150(iVar0, 0);
		}
		iVar0++;
...
{
	(*uParam0)[0]->f_1 = -628956517;
	(*uParam0)[0]->f_3 = 1554294233;
	(*uParam0)[0] = 22;
	StringCopy(&((*uParam0)[0]->f_23), "0176_G_M_O_UniExConfeds_01_WHITE_03", 64);
	func_168(&((*uParam0)[0]->f_22));
	(*uParam0)[1]->f_1 = -628956517;
	(*uParam0)[1]->f_3 = 1218969052;
	(*uParam0)[1] = 22;
	StringCopy(&((*uParam0)[1]->f_23), "0179_G_M_Y_UniExConfeds_01_WHITE_03", 64);
	func_168(&((*uParam0)[1]->f_22));
	(*uParam0)[2]->f_1 = -628956517;
	(*uParam0)[2]->f_3 = 755484316;
	(*uParam0)[2] = 22;
	StringCopy(&((*uParam0)[2]->f_23), "0178_G_M_Y_UniExConfeds_01_WHITE_02", 64);
...
void func_52(var uParam0)
{
	...
	(*uParam0)[0]->f_9 = 105.47f;
	(*uParam0)[0]->f_13 = 0;
	(*uParam0)[0]->f_12 = func_169(2, 0, 1);
	(*uParam0)[0]->f_15 = { 2.9f, -3.91f, -0.01f };
	(*uParam0)[0]->f_18 = -158.12f;
	(*uParam0)[1]->f_6 = { 1.64f, -2.48f, 0f };
	(*uParam0)[1]->f_9 = 146.97f;
	(*uParam0)[1]->f_13 = 0;
	(*uParam0)[1]->f_12 = func_169(2, 0, 1);
	(*uParam0)[1]->f_15 = { 2.07f, -5.48f, 0f };
	(*uParam0)[1]->f_18 = -152.52f;
	(*uParam0)[2]->f_6 = { -2.6f, 0.16f, 0f };
	(*uParam0)[2]->f_9 = 161.29f;
	(*uParam0)[2]->f_13 = 0;
	(*uParam0)[2]->f_12 = func_169(2, 0, 1);
	(*uParam0)[2]->f_15 = { 2.97f, -7.2f, 0f };
	(*uParam0)[2]->f_18 = -163.48f;
	func_170(&((*uParam0)[0]->f_22));
	func_170(&((*uParam0)[1]->f_22));
	func_170(&((*uParam0)[2]->f_22));
}
...
void func_53(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_171(&((*uParam0)[iVar0]->f_1));
		func_171(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
void func_54(var uParam0)
{
	...
	*uParam0 = _create_anim_scene(uParam0->f_4, 0, func_119(0), false, true);
...
int func_59(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_186(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
...
bool func_60(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_190(iParam1, func_189(uParam0), &(uParam0->f_172)))
		{
...
void func_62(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_61(uParam0->f_3, 1))
	{
		func_192(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
bool func_65(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_195() || !func_196((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, fParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_198(Global_35) && is_player_teleport_active())
	{
	}
	if (func_199(iParam0))
	{
		if (func_200(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_102(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_102(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_102(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_102(iParam5, 32), true);
	...
	else if (func_102(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_102(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_102(iParam5, 64))
		{
...
void func_79(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_204());
	}
}
...
void func_81(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_204());
	}
}
...
bool func_91(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_220(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_219(uParam2, fVar1))
		{
			if (!func_221((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
	...
	if (!*uParam1 && func_61(iParam0, 128))
	{
		...
		if (!uParam2->f_48)
		{
			if (func_234(&(uParam2->f_91), 0, 1084227584, 1, 1))
			{
				return false;
			}
		}
...
bool func_94(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_242(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630->f_26 && func_220(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
...
bool func_107(int iParam0)
{
	...
	return func_275((*Global_1347702)[58]->f_15, 1);
}
...
void func_111()
{
	if (func_43(1024))
	{
		if (!_does_anim_scene_exist(iVar342) || !_is_anim_scene_started(iVar342, false))
		{
			return;
		}
		fVar0 = _get_anim_scene_progress(iVar342);
		if (func_43(8192))
		{
...
void func_112()
{
	...
	fVar0 = _get_anim_scene_progress(iVar342);
	if (has_anim_event_fired(&(uLocal_584[0]), 889124884))
	{
		func_280(1891783641, &(uLocal_584[0]), 1);
	}
	if (has_anim_event_fired(&(uLocal_584[2]), 889124884))
	{
	...
	if (func_43(8192))
	{
		if (!func_43(32768))
		{
			if (fVar0 > func_281(0))
			{
				...
				iLocal_610[0] = start_script_fire(func_282(0), 3, 50f, false, 0, -1f, 0);
				iLocal_610[1] = start_script_fire(func_282(0), 3, 0f, false, 0, -1f, 0);
				iLocal_610[2] = start_script_fire(func_282(3), 3, 50f, false, 0, -1f, 0);
				iLocal_610[3] = start_script_fire(func_282(4), 3, 50f, false, 0, -1f, 0);
				func_131(32768);
			}
		}
	}
	...
	{
		if (has_anim_event_fired(&(uLocal_584[0]), -1881312968))
		{
			func_131(8192);
		}
	}
	if (func_43(16384))
	{
		if (!func_43(65536))
		{
			...
			{
				func_283(1019805697, func_282(0), 1);
				iLocal_610[4] = start_script_fire(func_282(1), 3, 50f, false, 0, -1f, 0);
				iLocal_610[5] = start_script_fire(func_282(2), 3, 50f, false, 0, -1f, 0);
				iLocal_610[6] = start_script_fire(func_282(5), 3, 20f, false, 0, -1f, 0);
				iLocal_610[7] = start_script_fire(func_282(6), 3, 20f, false, 0, -1f, 0);
				func_131(65536);
			}
		}
	}
	...
	{
		if (has_anim_event_fired(&(uLocal_584[2]), -1881312968))
		{
			func_131(16384);
		}
	}
...
void func_113()
{
	...
	iLocal_353[0] = func_284(uLocal_584[0], Local_357[0], 20f, &(Local_357[0]->f_21), &(Local_37.f_192), 0f, 1, 0, 0, iVar581, 0, 0, 2, 1, -1082130432, 0);
	iLocal_353[2] = func_284(uLocal_584[2], Local_357[2], 20f, &(Local_357[2]->f_21), &(Local_37.f_192), 0f, 1, 0, 0, iVar581, 0, 0, 2, 1, -1082130432, 0);
	iLocal_353[1] = func_284(uLocal_584[1], Local_357[1], 20f, &(Local_357[1]->f_21), &(Local_37.f_192), 0f, 1, 0, 0, iVar581, 0, 0, 2, 1, -1082130432, 0);
	switch (iLocal_23)
	{
		case 0:
			iLocal_23 = 1;
		...
		case 1:
			...
			while (iVar0 < 3)
			{
				if (func_285(Local_357[iVar0]) && &iLocal_353[iVar0] != -1)
				{
					iLocal_622 = iVar0;
					func_286(&(Local_357[0]->f_21), 0, 0);
					func_286(&(Local_357[2]->f_21), 0, 0);
					func_286(&(Local_357[1]->f_21), 0, 0);
					iLocal_23 = 2;
				}
				iVar0++;
			}
			break;
		case 2:
			if (!func_136(vLocal_652[6]) || func_135(vLocal_652[6], 4f))
			{
				func_131(64);
				func_105(Global_35, &(uLocal_584[iVar620]), "RE_IT_NBX_V1_GREET_NEG", 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				iLocal_23 = 3;
			}
			break;
		case 3:
			if (func_103(-4f, 1, 0, 0))
			{
				iVar1 = func_287(&uLocal_584, 1, 0, -1, 0, -1082130432);
			...
			else if (!is_entity_dead(&(uLocal_584[1])))
			{
				...
				{
					func_105(&(uLocal_584[1]), Global_35, func_271("RE_IT_NBX_V1_PROX", "RE_IT_NBX_V1_PROX_SICK"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					iLocal_23 = 4;
				}
			}
			break;
...
bool func_114()
{
	switch (iVar350)
	{
		...
		case 1:
			...
			break;
		case 2:
			_0xdf7b5144e25cd3fe(iVar342, func_119(1));
			iLocal_352 = 3;
			break;
		case 3:
			if (!_0x23e33cb9f4a3f547(iVar342, func_119(1)))
			{
				return false;
			}
			iLocal_352 = 4;
...
void func_115()
{
	if (!func_132(1))
	{
		...
		{
			if (func_105(&(uLocal_584[1]), &(uLocal_584[2]), func_104(1), 0, -1082130432, 0, 0, 0, 1, 1, 0, -500314840, 1, 0, 0))
			{
				func_280(249295937, &(uLocal_584[1]), 1);
				func_289(1);
				func_117(vLocal_652[3]);
			}
		}
	}
	else if (!func_132(2))
	{
		if (func_290(vLocal_652[3]) > 3f)
		{
			if (func_105(&(uLocal_584[2]), &(uLocal_584[1]), func_104(2), 0, -1082130432, 0, 0, 0, 1, 1, 0, -500314840, 1, 0, 0))
			{
				func_289(2);
				func_99(vLocal_652[3]);
			}
		}
	}
}
...
bool func_116(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7, int iParam8, float fParam9, bool bParam10, float fParam11, bool bParam12, int iParam13, bool bParam14)
{
	...
	if (func_293(uParam0, fParam2, 1114636288, (fParam4 + fVar0), iParam8, fParam9, bParam10, fParam11, bParam12, 1125515264, bParam14, 1))
	{
		return true;
	}
	return false;
...
void func_118(var uParam0)
{
	...
	fVar3 = 45f;
	fVar4 = 40f;
	func_295(uParam0, 495656844, "", vVar0, 0, fVar3, fVar4, fVar4, -1082130432, -1082130432, 1127481344, 0);
}
...
{
	func_297((*uParam0)[0], func_296(7), 0, -163964935, 0, 0, 0, 1, 0);
	func_297((*uParam0)[1], func_296(10), 0, 648122183, 0, 0, 0, 1, 0);
...
void func_121()
{
	if (!_is_anim_scene_loaded(iVar342, true, false) || !_is_anim_scene_started(iVar342, false))
	{
		return;
	}
	fVar0 = _get_anim_scene_progress(iVar342);
	...
	if (func_299(0, fVar0))
	{
		func_29(uLocal_584[0], iVar342, func_28(0));
		func_301(uLocal_584[0], 0, &(uLocal_588[0]), func_300(0), 1073741824, -530524, 1);
	}
	if (func_299(2, fVar0))
	{
		func_29(uLocal_584[2], iVar342, func_28(2));
		func_301(uLocal_584[2], 2, &(uLocal_588[2]), func_300(2), 1073741824, -530524, 131072);
	}
	if (func_299(1, fVar0))
	{
		func_29(uLocal_584[1], iVar342, func_28(1));
		func_301(uLocal_584[1], 1, &(uLocal_588[1]), func_300(1), 1073741824, -1871534317, 131073);
	}
}

bool func_122()
{
	if (!_is_anim_scene_started(iVar342, false))
	{
		return true;
	}
	else if (_is_anim_scene_finished(iVar342, false))
	{
		return true;
	}
	else if (((!func_66(&(uLocal_584[0]), 0, 1) || _0xb89fcff19dafff28(iVar342, func_28(0))) && (!func_66(&(uLocal_584[2]), 0, 1) || _0xb89fcff19dafff28(iVar342, func_28(2)))) && (!func_66(&(uLocal_584[1]), 0, 1) || _0xb89fcff19dafff28(iVar342, func_28(1))))
	{
		return true;
	}
	return false;
...
{
	if (!_does_anim_scene_exist(iVar341) || !_is_anim_scene_started(iVar341, false))
	{
		func_307();
		return true;
	}
	if (!func_136(vLocal_652[2]))
	{
		func_117(vLocal_652[2]);
	}
	if (!func_43(1024))
	{
	...
	if (!func_43(8))
	{
		if ((!func_66(&(uLocal_584[1]), 0, 1) || !_0x3ab6c7b0bb0df4b1(&(uLocal_584[1]), iVar341)) || func_290(vLocal_652[2]) > (func_308(1) + fParam0))
		{
	...
	{
		if ((!func_66(&(uLocal_584[0]), 0, 1) || func_290(vLocal_652[2]) > (func_308(0) + fParam0)) || func_299(0, _get_anim_scene_progress(iVar341)))
		{
			...
			{
				func_149(iLocal_606[0], iVar341, "molotov_a");
			}
			func_131(16);
		}
	}
	...
	{
		if ((!func_66(&(uLocal_584[2]), 0, 1) || func_290(vLocal_652[2]) > (func_308(2) + fParam0)) || func_299(2, _get_anim_scene_progress(iVar341)))
		{
			...
			{
				func_149(iLocal_606[1], iVar341, "molotov_b");
			}
			func_131(32);
		}
	}
...
void func_126()
{
	...
	switch (iLocal_24)
	{
		...
		case 1:
			...
			else if (!func_136(vLocal_652[7]))
			{
				func_117(vLocal_652[7]);
			}
			break;
		case 2:
			if (func_136(vLocal_652[5]))
			{
				if (func_311(vLocal_652[5]) < 1000)
				{
					return;
				}
				else
			...
			_0x0c392db374655176(func_205(&Local_37), 60f, iVar3);
			iVar1 = 0;
			while (iVar1 < get_itemset_size(iVar3))
			{
				iVar2 = get_indexed_item_in_itemset(iVar1, iVar3);
				iLocal_592 = get_ped_index_from_entity_index(_get_entity_from_item(iVar2));
				if (!is_entity_dead(iVar590))
				{
					func_131(67108864);
					_play_sound_from_entity("POLICE_WHISTLE_SINGLE", iVar590, "NBD1_Sounds", false, 0, 0);
					func_280(-805893667, iVar590, 1);
					func_309(&iLocal_24, 5);
				}
				iVar1++;
			}
			destroy_itemset(iVar3);
			if (!does_entity_exist(iVar590) || is_entity_dead(iVar590))
			{
				if (iLocal_31 >= 10)
				{
			...
			break;
		case 3:
			if (has_model_loaded(-1448273283))
			{
				iLocal_592 = func_313(-1448273283, func_312(), 0f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				if (does_entity_exist(iVar590))
				{
		...
		case 4:
			...
			else
			{
				...
				task_follow_nav_mesh_to_coord(0, Local_37.f_51, 2f, -1, 10f, 0, 40000f);
				task_investigate(0, Local_37.f_51, 8000, 1);
				task_investigate(0, 2510.293f, -1208.031f, 51.47769f, 12000, 1);
				task_investigate(0, 2510.57f, -1197.194f, 51.47652f, 8000, 1);
				task_wander_standard(0, 40000f, 0);
				func_97(iVar590, &iVar4, 0, 0, 1, 1);
				func_314(&iLocal_592, 1);
				_0xb8b6430ead2d2437(iVar590, -1797934587);
				_0x24c82ef607105faa(iVar590, -930817754);
				_0x819add5ef1742f47(iVar590, 259);
				set_blocking_of_non_temporary_events(iVar590, false);
				set_ped_flee_attributes(iVar590, 512, true);
				set_ped_combat_attributes(iVar590, 58, true);
				func_37(&uLocal_624);
		...
		case 5:
			if (does_entity_exist(iVar590))
			{
				if (is_entity_dead(iVar590) || func_94(iVar590, 0, &uLocal_624, &uVar0, 0, 0))
				{
					func_131(-2147483648);
					func_309(&iLocal_24, 7);
				}
				else if (func_317(iVar590, func_282(0), 1) < 20f)
				{
					iVar5 = 0;
					while (iVar5 < iVar608)
					{
						remove_script_fire(&(iLocal_610[iVar5]));
						iVar5++;
					}
					func_131(1073741824);
			...
			break;
		case 6:
			if ((!does_entity_exist(iVar590) || is_entity_dead(iVar590)) || func_94(iVar590, 0, &uLocal_624, &uVar0, 0, 0))
			{
				func_131(-2147483648);
				func_309(&iLocal_24, 7);
			}
...
{
	if (!func_66(uParam0[0], 0, 1) || _is_ped_lassoed(uParam0[0]))
	{
		return 1;
	}
	if (!func_66(uParam0[2], 0, 1) || _is_ped_lassoed(uParam0[2]))
	{
		return 1;
	}
	if (!func_66(uParam0[1], 0, 1) || _is_ped_lassoed(uParam0[1]))
	{
		return 1;
	}
	return 0;
...
int func_130(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	while (iVar0 <= iParam4)
	{
		if (func_319(uParam0[iVar0], iParam1, uParam2, 0))
		{
			return 1;
		}
		iVar0++;
...
char* func_145(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_323(sParam1));
}
...
{
	if ((((does_entity_exist(*uParam0) && _does_anim_scene_exist(iParam1)) && _is_anim_scene_started(iParam1, false)) && _0x3ab6c7b0bb0df4b1(*uParam0, iParam1)) && !is_string_null_or_empty(sParam2))
	{
		remove_anim_scene_entity(iParam1, sParam2, *uParam0);
	}
}
...
void func_150(int iParam0, bool bParam1)
{
	...
	func_325(&(uLocal_584[iParam0]), 1088421888, 0, 0);
	func_326(uLocal_584[iParam0], Local_357[iParam0], &(Local_357[iParam0]->f_21), 1, 1);
	_0xa3db37edf9a74635(player_id(), &(uLocal_584[iParam0]), 7, 0, 1);
	_0xa3db37edf9a74635(player_id(), &(uLocal_584[iParam0]), 18, 0, 1);
	set_blocking_of_non_temporary_events(&(uLocal_584[iParam0]), false);
	_0xe737d5f14304a2ec(&(uLocal_584[iParam0]), get_player_index(), 120000);
	_0xb8b6430ead2d2437(&(uLocal_584[iParam0]), -1143783207);
	_0x24c82ef607105faa(&(uLocal_584[iParam0]), -920810745);
	open_sequence_task(&iVar0);
	if (!is_entity_dead(&(uLocal_588[iParam0])) && func_327(Global_35) != &uLocal_588[iParam0])
	{
		task_mount_animal(0, &(uLocal_588[iParam0]), 20000, -1, 1073741824, 1, 0, 0);
	}
	if (bParam1)
	{
		_task_move_in_traffic_2(0, func_328(), 2f, 2.5f, 0, Local_37.f_46);
	}
	_task_move_in_traffic_3(0, Global_35, 2.5f, 16, Local_37.f_46);
...
void func_153(int iParam0, bool bParam1)
{
	if (func_66(iParam0, 0, 1))
	{
		...
		func_325(iParam0, 1088421888, 0, 0);
		if (!bParam1)
		{
...
bool func_154(var uParam0, var uParam1)
{
	...
	{
		if (func_329(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
int func_167(bool bParam0)
{
	...
	get_group_size(func_341(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_341(), iVar3);
		if (func_342(iVar4))
		{
			iVar0++;
		}
...
void func_177(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		{
			func_239(iVar0, func_238(iParam0), 1, 0, 2, 0, -1082130432);
		}
		else
		{
			func_239(iVar0, func_238(iParam0), 1, 0, 8, 0, -1082130432);
		}
		if (func_61(iParam0, 1))
		{
...
{
	vVar2 = { *uParam0 };
	func_291(Global_35, *uParam0, &(uParam0->f_37), 1061158912, 0, 0);
	if (func_292(&(uParam0->f_37), 500))
	{
		iVar0 = 0;
		while (iVar0 < 8)
		{
			if (!func_181(*uParam0->f_12[iVar0]))
			{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_378(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
void func_209(int iParam0, int iParam1)
{
	...
	func_387(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_388(iParam0, 0);
	func_389(iParam0);
	func_390(1);
	...
	if (uParam0->f_177 != -1 || func_352(Global_1310750[uParam0->f_3], 16777216))
	{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_398(uParam0->f_177));
			}
		}
	}
...
bool func_226(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_415(&(Global_1898164->f_1[0]));
		if (func_416(iVar0) && func_417((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_224(1) || *iParam0 & 8192 != 0))
				{
...
bool func_244(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_438(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_436(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_437(iParam2)
				{
					func_433(iParam2, 1);
					return true;
				}
...
bool func_245(int iParam0, int iParam1)
{
	...
	if (func_429(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_437(iParam1)
		{
...
bool func_267(int iParam0, int iParam1)
{
	...
	{
		return func_460(iParam0, iParam1, 0, -1082130432);
	}
	return false;
}
...
int func_272(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_464(func_463(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
int func_279(int iParam0, char* sParam1, int iParam2, float fParam3)
{
	if (!func_43(iParam2))
	{
		if (!is_entity_dead(&(iLocal_606[iParam0])) && _0x3ab6c7b0bb0df4b1(&(iLocal_606[iParam0]), iVar338))
		{
			if (fParam3 > func_281(iParam0))
			{
				remove_anim_scene_entity(iVar338, sParam1, &(iLocal_606[iParam0]));
				delete_object(iLocal_606[iParam0]);
				vVar0 = { 2519.15f, -1202.25f, 53.8082f };
				if (iParam2 == 4096)
				{
					vVar0 = { 2518.21f, -1203.14f, 53.5364f };
				}
				add_explosion(vVar0, 2, 1f, true, false, 0f);
				func_131(iParam2);
				return 1;
			}
		}
...
void func_291(int iParam0, vector3 vParam1, int iParam4, float fParam5, bool bParam6, int iParam7)
{
	...
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_367(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_259();
	...
	else if (fVar0 > iParam4->f_2 || (!func_367(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_259();
		iParam4->f_2 = func_317(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_293(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		if (iParam4 > 1)
		{
			...
			{
				func_216(uParam0->f_121[iVar0], fVar3, 1082130432, 1, 90f, 0, 0);
				iVar0++;
			}
		}
		else
		{
			func_216(uParam0->f_121[0], fVar3, 1082130432, 1, 90f, 0, 0);
		}
...
{
	if ((((!_is_anim_scene_loaded(iVar340, true, false) || !_is_anim_scene_started(iVar340, false)) || _is_anim_scene_finished(iVar340, false)) || is_entity_dead(&(uLocal_584[iParam0]))) || !_0x3ab6c7b0bb0df4b1(&(uLocal_584[iParam0]), iVar340))
	{
		return false;
	}
	if (_0xb89fcff19dafff28(iVar340, func_28(iParam0)))
	{
		return false;
	}
	if (has_anim_event_fired(&(uLocal_584[iParam0]), 811542464) || fParam1 > func_481(iParam0))
	{
		return true;
	}
	return false;
...
void func_301(var uParam0, int iParam1, int iParam2, vector3 vParam3, int iParam6, int iParam7, int iParam8)
{
	...
	{
		open_sequence_task(&iVar0);
		if (iParam7 != -1871534317)
		{
			task_force_motion_state(0, iParam7, false);
		}
		if (!is_entity_dead(iParam2))
		{
			task_mount_animal(0, iParam2, -1, -1, iParam6, iParam8, 0, 0);
		}
		else
		{
			task_smart_flee_coord(0, vParam3, -1f, -1, false, 1077936128);
		}
...
void func_307()
{
	if (iVar621 == 1024 && func_66(&(uLocal_584[1]), 0, 1))
	{
	...
	while (iVar1 < 3)
	{
		if (func_66(&(uLocal_584[iVar1]), 0, 0))
		{
			...
			{
				if (func_32(&(uLocal_584[iVar1]), Global_35, 2048, 0, 1073741824, 1))
				{
					bVar0 = true;
				}
			}
...
{
	if (create_incident(6, vParam1, 5, 120f, iParam0, -1082130432, 1))
	{
	}
	if (is_incident_valid(*iParam0))
	{
	}
	iVar0 = 0;
	while (iVar0 < *uParam4)
	{
		if (_does_volume_exist(uParam4[iVar0]))
		{
			_0x74c2b3dc0b294102(uParam4[iVar0]);
			remove_scenario_blocking_area(uParam5[iVar0], false);
		}
		iVar0++;
	}
}
...
int func_311(var uParam0)
{
	...
	return (func_259() - round((uParam0->f_1 * 1000f)));
}
...
void func_318(int iParam0)
{
	...
	switch (&uLocal_19[iParam0])
	{
		case 0:
			...
			func_298(Local_357[iParam0], 0);
			func_486(uLocal_19[iParam0], 2, iParam0);
			break;
		case 1:
			if (func_487(&(uLocal_584[iParam0])))
			{
				if (!is_entity_dead(&(uLocal_588[iParam0])) && !is_ped_on_mount(&(uLocal_584[iParam0])))
				{
					task_mount_animal(&(uLocal_584[iParam0]), &(uLocal_588[iParam0]), -1, -1, 1073741824, 1, 0, 0);
				}
			}
			else
			{
				func_301(uLocal_584[iParam0], iParam0, &(uLocal_588[iParam0]), func_300(iParam0), 2f, -1871534317, 1);
			}
			func_486(uLocal_19[iParam0], 2, iParam0);
			break;
		case 2:
		...
		case 3:
			...
			{
				clear_ped_tasks(&(uLocal_588[iParam0]), 1, 0);
		...
		case 4:
			if (!func_43(4194304))
			{
				...
				else if (!is_ped_on_mount(&(uLocal_584[iParam0])))
				{
					func_486(uLocal_19[iParam0], 2, iParam0);
				}
			}
			...
			if (!iParam1->f_1 & 2 != 0)
			{
				if (func_252(iParam1, 4000))
				{
					if ((func_253(iParam0, Global_1935630->f_41, *iParam1 & 128 != 0, 0, *iParam1 & 256 != 0) && func_254(iParam1, iParam0)) && func_255(iParam1, iParam0))
					{
						func_257();
						*uParam2 = 2;
						func_242(iParam0, iParam1, *uParam2);
						return true;
					}
				}
			}
...
bool func_367(vector3 vParam0, int iParam3)
{
	...
	return func_513(vVar0, vParam0) > func_513(vVar0, get_entity_coords(iParam3, true, false));
}
...
int func_372(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_199(iVar0))
		{
		...
		if (func_517(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_518(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_524(&(uParam1->f_22)));
		...
		if (!func_199(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_527(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_528(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_528(&(uParam1->f_22)));
		...
		while (iVar28 < 4)
		{
			...
			if (func_533(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_537(0))
				{
					...
					func_538(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_394(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_553(to_float(iVar0), 1, 0);
	}
	else
	{
		func_553((to_float(200) / 3f), 1, 0);
	}
}
...
bool func_434(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_451(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_560(iVar0, 0)))
		{
...
bool func_438(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_560(iVar0, 0)))
		{
			if (func_562(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_449(int iParam0, int iParam1)
{
	...
	if (func_565(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_456(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_451(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_572(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_488(var uParam0, var uParam1, float fParam2)
{
	...
	{
		_0x66f9eb44342bb4c5(*uParam0, uParam1);
	}
}
...
void func_490(int iParam0)
{
	if (!is_entity_dead(iParam0))
	{
		task_follow_nav_mesh_to_coord(iParam0, 2492.879f, -1261.992f, 48.14098f, 1.75f, -1, 5f, 0, 40000f);
	}
}
...
void func_494(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	...
	{
		open_sequence_task(&iVar0);
		_task_move_in_traffic_2(0, vParam1, 6f, fParam7, 272, 0);
		_task_move_in_traffic_2(0, vParam4, 10f, fParam7, 272, 0);
...
void func_495(int iParam0, vector3 vParam1, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		_task_move_in_traffic_2(iParam0, vParam1, 2f, fParam4, 0, 0);
	}
}
...
void func_505(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_387(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_388(iParam0, 1);
	if (!bParam2)
	{
		func_502(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_613(iParam0))
		{
...
bool func_511(vector3 vParam0)
{
	...
	{
		if (!func_181(*Global_1310750->f_16043[iVar0]))
		{
			if (func_110(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
struct<5> func_531(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_622(iParam0))
	{
		case -1037537535:
			...
			{
				Var0 = { func_535(889965687, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_535(-1838434463, Var0, 1084182731, bParam1) };
...
struct<4> func_535(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_632(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_536(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_632(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_537(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_632(bParam0));
}
...
void func_539(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_93(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_561(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_562(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_575(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_654(Global_35)) || func_655(Global_35)) || func_656(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_657(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_658(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_659(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_602(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_305((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_306(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
void func_581(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_657(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
void func_588(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_671(iParam0, 8))
		{
...
void func_602(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_306(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_298(iParam0, 0);
		}
...
void func_603(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_678(iVar0), func_341(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_680() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_680();
					}
					func_681(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_322(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
{
	return func_535(1328661203, func_683(), -1591664384, bParam0);
}
...
struct<4> func_623(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_535(923904168, func_621(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_535(923904168, func_621(bParam0), -740156546, 0) };
		}
...
struct<4> func_625(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_535(271701509, func_621(bParam0), 12999093, 0) };
		}
...
bool func_628(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_632(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_629(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_632(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_645(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_686((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
void func_646(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_662((*uParam0)[iVar0]))
		{
			func_303((*uParam0)[iVar0], 14);
		}
		iVar0++;
	}
}
...
int func_647(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_687(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_305((*uParam2)[iVar0]->f_6))
		{
			func_303((*uParam2)[iVar0], 11);
...
void func_652(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_687(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
{
	return (shift_right(iParam0, 26) & 31 * func_464(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_708(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_671(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_717(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
