...
bool func_6(var uParam0)
{
	...
	if (!has_model_loaded(iLocal_54))
	{
		bVar0 = false;
	}
	if (!has_model_loaded(iLocal_55))
	{
		bVar0 = false;
	}
	if (!has_anim_dict_loaded(func_21(1)))
	{
		bVar0 = false;
	}
	if ((!get_is_waypoint_recording_loaded(func_22(0)) || !get_is_waypoint_recording_loaded(func_22(1))) || !get_is_waypoint_recording_loaded(func_22(2)))
	{
		bVar0 = false;
	}
	if (!_is_anim_scene_loaded(&(iLocal_23[0]), true, false))
	{
		bVar0 = false;
	}
	if (!_is_anim_scene_loaded(&(iLocal_23[1]), true, false))
	{
		bVar0 = false;
	}
	if (!_0xaa235e2f2c09e952(func_23()))
	{
		bVar0 = false;
	}
	if (!is_srl_loaded())
	...
	if (!_text_database_has_loaded(func_24()))
	{
		bVar0 = false;
	}
	...
	func_26(7);
	func_26(8);
	_add_blood_pool(983.9f, -6777.3f, 49.1f, true);
	_add_blood_pool(984.7f, -6779.5f, 49.1f, true);
	_add_blood_pool(983.4f, -6781.5f, 49.1f, true);
	_add_blood_pool(982.2f, -6788.4f, 49.1f, true);
	_add_blood_pool(982.3f, -6789.4f, 49.2f, true);
	_add_blood_pool(984.1f, -6786.1f, 49f, true);
	_add_blood_pool(979.8f, -6791.7f, 49.2f, true);
	set_anim_scene_entity(&(iLocal_23[0]), "ARTHUR", Global_35, 0);
	return true;
}
...
int func_11(var uParam0)
{
	...
	while (iVar0 <= 8)
	{
		if (does_entity_exist(&(iLocal_42[iVar0])))
		{
			delete_ped(iLocal_42[iVar0]);
		}
		iVar0++;
	}
	set_player_control(player_id(), true, 0, false);
	_0x43037abfe214a851();
	use_waypoint_recording_as_assisted_movement_route(func_22(2), 0, 1065353216, 1f, 1);
	if (does_entity_exist(iLocal_31))
	{
		delete_vehicle(&iLocal_31);
	}
	func_32(iLocal_28);
	func_32(iLocal_27);
	func_32(iLocal_29);
	func_32(iLocal_30);
	remove_waypoint_recording(func_22(0));
	remove_waypoint_recording(func_22(1));
	remove_waypoint_recording(func_22(2));
	_delete_anim_scene(&(iLocal_23[0]));
	_0x2412216fcc7b4e3e(func_23());
	_text_database_delete(func_24());
	func_33(0);
	return 1;
}
...
void func_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_40(Global_1360165[iParam0], 0);
...
void func_19(var uParam0)
{
	...
	request_model(iLocal_53, false);
	request_model(iLocal_54, false);
	request_model(iLocal_55, false);
	request_anim_dict(func_21(1));
	request_waypoint_recording(func_22(0));
	request_waypoint_recording(func_22(1));
	request_waypoint_recording(func_22(2));
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		iLocal_23[0] = _create_anim_scene(func_52(0, 1), 0, func_52(0, 0), false, true);
	...
	iLocal_23[1] = _create_anim_scene(func_52(1, 1), 2, func_52(1, 0), false, true);
	load_anim_scene(&(iLocal_23[1]));
	_0x1b3c2d961f5fc0e1(func_23());
	end_srl();
	prefetch_srl(func_53(0));
	_0xe296208c273bd7f0(0, 0, 0, 17, 1, 0);
	func_18(uParam0, 8);
}
...
{
	if (does_entity_exist(&(iLocal_42[iParam0])))
	{
		return true;
	}
	if (bLocal_56)
	...
	set_blocking_of_non_temporary_events(&(iLocal_42[iParam0]), true);
	if (iParam1 == iLocal_54)
	{
		set_entity_no_collision_entity(&(iLocal_42[iParam0]), Global_35, false);
	}
	bLocal_56 = true;
	return true;
}
...
void func_26(int iParam0)
{
	if (does_entity_exist(&(iLocal_42[iParam0])))
	{
		if (!is_entity_dead(&(iLocal_42[iParam0])))
		{
			stop_ped_speaking(&(iLocal_42[iParam0]), true);
			remove_all_ped_weapons(&(iLocal_42[iParam0]), true, true);
			_add_blood_pool(get_entity_coords(&(iLocal_42[iParam0]), true, false), true);
			_set_entity_health(&(iLocal_42[iParam0]), 0, 0);
		}
	}
}
...
bool func_29(var uParam0)
{
	...
	_0x702b75dc9d3ede56(true);
	_0xe296208c273bd7f0(0, 0, 0, 17, 1, 0);
	if (does_entity_exist(iLocal_31) && !is_entity_dead(iLocal_31))
	{
		if (!func_60(vLocal_32))
		{
			set_entity_coords_no_offset(iLocal_31, vLocal_32, false, true, true);
			set_entity_rotation(iLocal_31, vLocal_35, 2, true);
			set_entity_collision(iLocal_31, false, false);
			freeze_entity_position(iLocal_31, true);
		}
	}
	if (!bLocal_39)
	{
		bLocal_39 = load_stream("CLOUD_BED", "DEATH_FAIL_RESPAWN_SOUNDS");
	}
	switch (iLocal_26)
	{
		case 0:
			_0x1096603b519c905f("SMG2");
			_set_weather_type(-702816767, true, true, true, 60f, false);
			pause_clock(true, 0);
			iLocal_27 = _create_volume_box(984.2063f, -6781.292f, 49.91065f, 0f, 0f, -20f, 5f, 30f, 4f);
			iLocal_28 = _0x0eb78c2b156635b1(-1612834106, 987.4385f, -6772.322f, 49.94096f, 0f, 0f, -20f, 8f, 5f, 2f);
			iLocal_29 = _0x0eb78c2b156635b1(-1612834106, 985.287f, -6785.009f, 49.76819f, 0f, 0f, -19.99999f, 1f, 30f, 4f);
			iLocal_30 = _0x0eb78c2b156635b1(-1612834106, 981.1976f, -6783.522f, 49.76819f, 0f, 0f, -19.99999f, 1f, 30f, 4f);
			do_screen_fade_in(1000);
			if (!_is_anim_scene_started(&(iLocal_23[0]), false))
			{
				start_anim_scene(&(iLocal_23[0]));
			}
			end_srl();
			prefetch_srl(func_53(1));
			func_56(1);
		case 1:
			bLocal_57 = true;
			...
			if (!does_entity_exist(iLocal_31))
			{
				iLocal_31 = _get_anim_scene_vehicle(&(iLocal_23[0]), "Warship", false);
				if (does_entity_exist(iLocal_31))
				{
					set_entity_as_mission_entity(iLocal_31, true, true);
				}
			}
			if (_0x005e6f28dd7ed58d(&(iLocal_23[0]), "ARTHUR"))
			{
				_get_anim_scene_entity_matrix(&(iLocal_23[0]), "Warship", &Var7, false, 0, 2);
				vLocal_32 = { Var7.f_6 };
				vLocal_35 = { Var7.f_9 };
				remove_anim_scene_entity(&(iLocal_23[0]), "Warship", iLocal_31);
				set_entity_coords_no_offset(iLocal_31, vLocal_32, false, true, true);
				set_entity_rotation(iLocal_31, vLocal_35, 2, true);
				set_entity_collision(iLocal_31, false, false);
				freeze_entity_position(iLocal_31, true);
			...
			break;
		case 2:
			use_waypoint_recording_as_assisted_movement_route(func_22(0), 1, 1065353216, 1f, 1);
			task_fly_to_coord(&(iLocal_42[0]), 2f, 983.9f, -6775.8f, 50f, 1, 1);
			task_fly_to_coord(&(iLocal_42[1]), 2f, 984f, -6775.6f, 50f, 1, 1);
			_0x9587913b9e772d29(&(iLocal_42[2]), 0);
			task_play_anim(&(iLocal_42[2]), func_21(1), func_21(0), 1000f, -1000f, -1, 132, 0.474f, false, 0, false, 0, false);
			func_56(3);
			break;
		case 3:
			if (!bLocal_58)
			{
				...
				{
					task_fly_to_coord(&(iLocal_42[0]), 2f, 975.7f, -6819.1f, 51f, 1, 1);
					task_fly_to_coord(&(iLocal_42[1]), 2f, 975.7f, -6819.1f, 51f, 1, 1);
					task_look_at_entity(Global_35, &(iLocal_42[8]), 5000, 48, 51, 1);
					func_62(Global_35, "COUGH_SICK_SMALL", 1615046335, 0, 1, 0, 0, 1);
					bLocal_58 = true;
				}
			}
			func_63(0);
			if (is_entity_playing_anim(&(iLocal_42[2]), func_21(1), func_21(0), 1))
			{
				if (_get_entity_anim_current_time(&(iLocal_42[2]), func_21(1), func_21(0)) >= 0.75f)
				{
					_set_entity_anim_current_time(&(iLocal_42[2]), func_21(1), func_21(0), 0.474f);
				}
			}
			Var1 = { func_64(1) };
			request_collision_at_coord(Var1);
			if (!is_entity_in_volume(Global_35, iLocal_27, true, 0))
			{
				func_56(4);
			}
			break;
		case 4:
			...
			if (does_entity_exist(&(iLocal_42[2])))
			{
				delete_ped(iLocal_42[2]);
			}
			Var1 = { func_64(1) };
			request_collision_at_coord(Var1);
			func_67(1);
			_set_entity_coords_and_heading(Global_35, Var1, Var1.f_3, true, false, true);
			_0x9587913b9e772d29(Global_35, 0);
			task_follow_waypoint_recording(Global_35, func_22(1), 0, 4194304, -1, 0, 0, -1);
			_0x2208438012482a1a(Global_35, true, false);
			force_ped_motion_state(Global_35, -668482597, false, 0, false);
			_0x5e3ccf03995388b5(get_hash_key(func_68(1)), get_entity_coords(Global_35, true, false));
			_0xbc016635d6a73b31(func_23(), func_69(1), 5);
			func_31(&uLocal_14, 1);
			set_clock_time(19, 40, 0);
			pause_clock(true, 0);
			use_waypoint_recording_as_assisted_movement_route(func_22(0), 0, 1065353216, 1f, 1);
			end_srl();
			prefetch_srl(func_53(2));
			func_56(5);
			break;
		case 5:
			Var1 = { func_64(2) };
		...
		case 6:
			...
			_set_entity_coords_and_heading(Global_35, Var1, Var1.f_3, true, false, true);
			_0x9587913b9e772d29(Global_35, 0);
			task_follow_waypoint_recording(Global_35, func_22(2), 0, 4194304, -1, 0, 0, -1);
			_0x2208438012482a1a(Global_35, true, false);
			force_ped_motion_state(Global_35, -668482597, false, 0, false);
			_0xbc016635d6a73b31(func_23(), func_69(2), 5);
			func_31(&uLocal_14, 1);
			...
			break;
		case 7:
			iVar0 = ((func_70(1) - func_71(&uLocal_14)) - floor((1.6f * 1000f)));
			if (func_73(3, func_72(2), iVar0))
			{
				...
				start_anim_scene(&(iLocal_23[1]));
				if (bLocal_39)
				{
					iLocal_38 = _0x0556c784fa056628("CLOUD_BED", "DEATH_FAIL_RESPAWN_SOUNDS");
					play_stream_frontend(iLocal_38);
				}
				_0x6339c1ea3979b5f7("Clouds", "Death_Fail_Respawn_Scenes");
				func_56(8);
			}
			break;
		case 8:
			if (_get_anim_scene_time(&(iLocal_23[1])) >= 1.6f)
			{
				_0x43037abfe214a851();
				set_entity_coords(Global_35, 1303.8f, -6845.3f, 42.8f, true, false, true, true);
				set_player_control(player_id(), true, 0, false);
				func_56(9);
			}
			break;
		case 9:
			iVar5 = func_78(43);
			iVar6 = func_79(iVar5);
			if ((_get_anim_scene_time(&(iLocal_23[1])) >= (_get_anim_scene_duration(&(iLocal_23[1])) - 1.6f) && func_80(iVar5)) && func_81(iVar6, 128))
			{
		...
		case 10:
			...
			break;
		case 11:
			if (_get_anim_scene_time(&(iLocal_23[1])) >= _get_anim_scene_duration(&(iLocal_23[1])))
			{
				return true;
			}
			break;
...
void func_35(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_88(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_36(iParam0, 1, 0);
		}
	}
...
void func_36(int iParam0, int iParam1, bool bParam2)
{
	...
	func_89(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_92(iParam0), 137, true);
	}
}
...
void func_45(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_92(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_92(iParam0), 204, false);
	}
}
...
void func_47(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_92(iParam0);
	if (((does_entity_exist(iVar1) && func_94(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_63(int iParam0)
{
	...
	if (((!get_control_normal(0, 1301263553) == 0f || !get_control_normal(0, -1260100172) == 0f) || !get_control_normal(0, -1882188328) == 0f) || !get_control_normal(0, -763919645) == 0f)
	{
		bVar0 = true;
	}
	if (!bVar0)
	...
	if (bVar0)
	{
		...
		{
			waypoint_recording_get_num_points(func_22(iParam0), &iVar1);
			iVar2 = func_111(Global_35, func_22(iParam0), &vVar4);
			iVar3 = func_112(iVar2 + 2, 0, (iVar1 - 1));
			waypoint_recording_get_coord(func_22(iParam0), iVar3, &vVar7);
			simulate_player_input_gait(player_id(), 1f, 60, func_113(get_entity_coords(Global_35, true, false), vVar7), false, true);
			func_87(&uLocal_17);
		}
	}
	else if (!func_65(iLocal_52))
	{
		if (func_114(&uLocal_20) >= 5f)
		{
			if (!bLocal_40)
			{
				_text_database_request(func_24());
				bLocal_40 = true;
			}
			else if (!bLocal_41)
			{
...
{
	uVar0 = _0xea113bf9b0c0c5d7(func_23(), func_69(iParam0), 5);
	return uVar0;
}
...
int func_71(var uParam0)
{
	...
	return (func_120() - round((uParam0->f_1 * 1000f)));
}
...
bool func_73(int iParam0, vector3 vParam1, int iParam4)
{
	if (!iParam0 == 3)
	{
		iVar0 = get_hash_key(func_68(iParam0));
		uVar1 = _0x465f04f68ad38197(func_23(), func_69(iParam0), 5);
	}
	else
	{
		uVar1 = _0x465f04f68ad38197(func_23(), func_69(2), 5);
	}
	uVar2 = _0xffe9c53deea3db0b(iParam4, iVar0, vParam1, is_srl_loaded(), uVar1);
	return uVar2;
}
...
{
	return (func_106(iParam0) && ((*Global_1898346)[iParam0]->f_1 && iParam1) != 0);
}
...
void func_93(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_92(iParam0)))
		{
...
int func_99(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_40(iVar0, 0))
	{
		if (func_40(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_96(iParam0)) || func_97(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_128(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_130(iParam0);
					_0x7b204f88f6c3d287(func_131(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_131(iParam0, 0));
					func_132(iParam0);
				}
			}
			else
	...
	{
		if (func_40((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_34(iParam0, 32768, 1))
			{
...
int func_105(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if ((func_140((*Global_1347702)[59]->f_15, 1) && !func_140((*Global_1347702)[61]->f_15, 1)) && Global_40.f_9052.f_21 & 2 == 0)
	{
		return 0;
	}
	if (func_141(player_id(), 1, 0))
	{
		if ((!does_blip_exist((*Global_1835011)[iParam0]->f_27) && !func_142(iParam0)) && !Global_43891)
		{
			func_144(iParam0, vdist2(func_143(iParam0), Global_36), -1, 1, 1);
			func_145((*Global_1835011)[iParam0], 2);
		}
		return 0;
	}
	if (bParam2)
	{
		if (!func_147(func_146(iParam0), func_78(iParam0), 0, (*Global_1835011)[iParam0]->f_21, iParam3))
		{
			return 0;
		}
		if (func_148(1) > 1)
			...
			if ((get_game_timer() - (*Global_1835011)[iParam0]->f_73) < 60000)
			{
				...
				if ((iParam0 == 15 && Global_1357549->f_1494 & 32768 != 0) && func_61(Global_35, func_150(iParam0), 50f, 1, 1))
				{
					if (!_is_tracked_point_valid((*Global_1835011)[iParam0]->f_72))
					{
						...
						set_tracked_point_info((*Global_1835011)[iParam0]->f_72, func_150(iParam0), 5f);
					}
					if (is_screen_faded_in() && (is_tracked_point_visible((*Global_1835011)[iParam0]->f_72) || is_sphere_visible(func_150(iParam0), 2.5f)))
					{
						return 0;
					}
				}
	...
	iVar0 = func_151((*Global_1835011)[iParam0]->f_1);
	if (!func_106(iVar0))
	{
		return 0;
	}
	...
	if (bParam1)
	{
		func_153((*Global_1835011)[iParam0]->f_1);
	}
...
{
	if (does_entity_exist(iParam0) && get_is_waypoint_recording_loaded(sParam1))
	{
		if (is_entity_dead(iParam0))
		{
			bVar1 = false;
		...
		vVar2 = { get_entity_coords(iParam0, bVar1, false) };
		if (waypoint_recording_get_closest_waypoint(sParam1, vVar2, &iVar0))
		{
			if (waypoint_recording_get_coord(sParam1, iVar0, vParam2))
			{
				return iVar0;
			}
		}
...
float func_113(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
float func_128(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_108(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_129(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_163(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_131(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_164(iParam0);
	}
...
bool func_139(int iParam0)
{
	...
	return func_169((*Global_1835011)[iParam0]->f_1);
}
...
int func_144(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_173();
	if ((bParam4 && func_174(&((*Global_1835011)[iParam0]->f_29), 512)) && !func_174(&((*Global_1835011)[iParam0]->f_29), 1024))
	{
		if (func_175())
		{
			return 0;
	...
	if (iVar0 == -1)
	{
		if (iParam0 == 19)
		{
			if ((func_140((*Global_1835011)[20]->f_1, 1) && Global_1879514->f_1 == (*Global_1835011)[20]->f_1) && (get_game_timer() - func_177()) <= 2000)
			{
				return 0;
			}
		}
		...
		{
			if ((func_140((*Global_1835011)[19]->f_1, 1) && Global_1879514->f_1 == (*Global_1835011)[19]->f_1) && (get_game_timer() - func_177()) <= 2000)
			{
				return 0;
			}
		}
		...
		{
			if (!func_140((*Global_1347702)[62]->f_15, 1))
			{
				return 0;
			}
		}
	...
	if (!does_blip_exist((*Global_1835011)[iParam0]->f_27))
	{
		...
		{
			if (bParam3 || func_179((*Global_1835011)[iParam0], 2))
			{
				if (func_180(iParam0))
				{
					(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_181(iParam0));
					bVar2 = true;
				}
				else
				{
					(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_182(iParam0));
				}
			}
			else if (func_180(iParam0))
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_area(1673015813, func_181(iParam0), func_183(iParam0), func_184(iParam0));
				bVar2 = true;
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_radius(1673015813, func_185(iParam0), func_186(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_180(iParam0))
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_143(iParam0));
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_181(iParam0));
		...
		else if (func_142(iParam0))
		{
			if (iParam0 == 7)
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(-1337945352, func_182(iParam0));
			}
			else
			{
				(*Global_1835011)[iParam0]->f_27 = _blip_add_for_coord(1673015813, func_182(iParam0));
	...
	if (bVar1)
	{
		...
		if (!func_174(&((*Global_1835011)[iParam0]->f_29), 1024) && !func_142(iParam0))
		{
			_blip_set_modifier((*Global_1835011)[iParam0]->f_27, 580546400);
			func_187(&((*Global_1835011)[iParam0]->f_29), 1024);
		}
	}
	if (iVar0 != -1)
	{
	...
	if (func_189(iVar4) && func_190((*Global_1888801)[iVar4]->f_13))
	{
		bVar5 = true;
	...
	{
		func_193((*Global_1835011)[iParam0]->f_1, bVar6, bVar5, iVar4);
	}
	if (iParam0 == 7 && !func_194(579))
	{
		func_195(579, (*Global_1835011)[iParam0]->f_27, 0);
	}
	if (iParam0 == 2)
	{
		return 1;
	}
	if (((((((func_174(&((*Global_1835011)[iParam0]->f_29), 4096) && !func_174(&((*Global_1835011)[iParam0]->f_29), 8192)) && IntToFloat(func_177()) >= 10f) && !Global_1935630->f_12) && !Global_16) && !func_196(Global_35, -2016812721)) && !_is_ped_using_scenario_hash(Global_35, -1054012177)) && !_is_ped_using_scenario_hash(Global_35, 1097070152))
	{
		if (!func_178(iParam0, iVar0) || (fParam1 >= (func_197(iParam0) * func_197(iParam0)) && !(*Global_1835011)[iParam0]->f_70))
		{
			MemCopy(&cVar7, {(*Global_1835011)[iParam0]->f_8}, 2);
			StringConCat(&cVar7, "_FIRST", 16);
			func_198(&cVar7, 10000, 0, 0, 0, 1);
			func_187(&((*Global_1835011)[iParam0]->f_29), 8192);
		}
	}
	return 1;
}
...
bool func_176(int iParam0)
{
	...
	{
		case 18:
			return func_140((*Global_1347702)[21]->f_15, 1);
		case 44:
			return func_140((*Global_1347702)[83]->f_15, 1);
	}
	return true;
}
...
bool func_180(int iParam0)
{
	switch (iParam0)
	{
		case 14:
		case 34:
			return !func_212((*Global_1835011)[iParam0]);
	}
	return false;
}
...
bool func_191(int iParam0)
{
	if (!func_213(Global_40.f_4283))
	{
		...
		if (func_214(iParam0))
		{
			if (vdist(Global_36, func_215(iParam0)) < vdist(Global_36, (*Global_1888801)[iParam0]->f_15))
			{
				return get_distance_between_coords(Global_36, func_215(iParam0), false) <= func_216();
			}
		}
		return get_distance_between_coords(Global_36, (*Global_1888801)[iParam0]->f_15, false) <= func_216();
	}
	return func_217();
}
...
void func_193(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	switch (func_218(iParam0))
	{
		case 1:
			...
			{
				if ((func_178(iVar0, -1) && !(*Global_1835011)[iVar0]->f_70) && (*Global_1835011)[iVar0]->f_63 & 2 == 0)
				{
					iVar2 = 1986697381;
				}
				else
			...
			else if ((func_178(iVar0, -1) && !(*Global_1835011)[iVar0]->f_70) && (*Global_1835011)[iVar0]->f_63 & 2 == 0)
			{
				iVar2 = -1559907306;
			}
			else
			...
			if ((*Global_1835011)[iVar0]->f_28 != iVar2)
			{
				...
				if (func_179((*Global_1835011)[iVar0], 2))
				{
...
bool func_199(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_219(&(Global_1898164->f_1[0]));
		if (func_229(iVar0) && func_202((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_206(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_204(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!_0x01f4d242765c6b24(func_231(iParam0)))
		{
			_0xca41e86545413b5b(func_218(iParam0), func_219(iParam0), func_232(iParam0), func_231(iParam0), Global_36);
		}
	}
	func_233(iParam0, 1);
	bParam1 = bParam1;
...
void func_205(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_234(Global_1898330[iParam0]);
		func_235((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}
...
void func_208(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_156(iParam0, 8))
		{
