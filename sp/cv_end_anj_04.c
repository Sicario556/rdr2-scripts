...
{
	if (!is_entity_dead(func_48(uParam0, iLocal_15)))
	{
		set_ped_can_play_ambient_anims(func_48(uParam0, iLocal_15), false);
		set_ped_can_leg_ik(func_48(uParam0, iLocal_15), false);
		set_ped_leg_ik_mode(func_48(uParam0, iLocal_15), 0);
	}
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_249(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_294(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_299(uParam0, iParam1);
	}
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_300(100f, 140f);
			}
		}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(747937920, 1) && !func_391((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
