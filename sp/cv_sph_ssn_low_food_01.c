...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, 1504738597, 0f, 0f, 0f, "CRATE", 1, 0, 1);
	func_152(uParam0, 264325500, 0f, 0f, 0f, "BASKET", 0, 0, 1);
	func_152(uParam0, 927991752, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_16 = func_152(uParam0, 1789147356, 0f, 0f, 0f, "SOCK", 0, 0, 1);
	func_152(uParam0, 164271545, 0f, 0f, 0f, "Nittingneedle", 0, 0, 1);
	func_153(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_153(uParam0, iLocal_15, 3, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_17, 0);
	func_154(uParam0, iLocal_15, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_17, 0, -1073741824, 1065353216, 1);
	...
	iLocal_18 = func_156(uParam0, "script@vignette@susan_speech_low_food@action", 0, 0, 1, 0);
