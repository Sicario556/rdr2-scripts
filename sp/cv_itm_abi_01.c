...
bool func_76(var uParam0)
{
	...
	_request_scenario_type(iLocal_25, 1, 0, 0);
	_request_scenario_type(iLocal_26, 1, 0, 0);
	return true;
}
...
{
	return (_has_scenario_type_loaded(iLocal_25, false) && _has_scenario_type_loaded(iLocal_26, false));
}
...
bool func_97(var uParam0)
{
	...
	{
		set_ped_can_play_ambient_anims(func_9(uParam0, iLocal_15), false);
	}
	switch (iLocal_59)
	{
		case 0:
			...
			{
				iLocal_59 = 1;
				_0x3bbdd6143ff16f98(func_9(uParam0, iLocal_15), uParam0->f_1711[iLocal_21]->f_10, "p_stickFirePoker01x_PH_R_HAND", "WORLD_CAMP_JACK_POKE_GROUND_STICK", 0, 1);
				_task_start_scenario_in_place(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, 1f, true);
			}
			else
			{
				return true;
		...
		case 1:
			_task_start_scenario_in_place(func_9(uParam0, iLocal_14), iLocal_25, 0, false, 0, 0.8f, false);
			bLocal_23 = true;
			iLocal_59 = 3;
		...
		case 3:
			...
			if (func_209(uParam0))
			{
				...
				uParam0->f_1711[iLocal_21]->f_10 = _0x4d0d2e3d8bc000eb(func_9(uParam0, iLocal_15), "p_stickFirePoker01x_PH_R_HAND", 1);
		...
		case 4:
			...
			{
				_task_start_scenario_in_place(func_9(uParam0, iLocal_14), -830507952, 0, false, 0, 0.8f, true);
				_0x3bbdd6143ff16f98(func_9(uParam0, iLocal_15), func_210(uParam0, iLocal_21), "p_stickFirePoker01x_PH_R_HAND", "WORLD_CAMP_JACK_POKE_GROUND_STICK", 0, 1);
				_task_start_scenario_in_place(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, -1f, false);
		...
		case 5:
			if (!func_48(iLocal_28))
			{
				...
				func_212(iLocal_28, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
			}
			if (!func_48(iLocal_29))
			{
				...
				func_212(iLocal_29, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
			}
			if (!func_213(500))
			{
			...
			if (func_215(iLocal_28, 1))
			{
				...
				func_217(cLocal_32);
				skip_to_next_scripted_conversation_line(cLocal_32);
				skip_to_next_scripted_conversation_line(cLocal_32);
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_220(player_ped_id(), iVar0, 1) < 10000f))
			{
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_265(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_179(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_117() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_304() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_181(var uParam0, int iParam1)
{
	...
	func_307(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_308(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_182(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_309(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_183(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_200(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_311(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_311(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_193(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_312(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_195(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_313(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_313(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
void func_208(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_324(uParam0, iParam1);
	}
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_325(100f, 140f);
			}
		}
...
bool func_209(var uParam0)
{
	...
	if (!func_48(iLocal_27))
	{
		...
		func_212(iLocal_27, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
...
void func_218(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	if (func_243() != -1)
	{
		return;
	}
	if ((Global_36616 && func_335(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_337(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
...
void func_219(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !is_bit_set(Global_40.f_6563.f_271, iVar0))
	{
		...
		_0xe824ce7d13fcb300(func_341(iParam0), iVar1);
	}
	else
	{
...
int func_232(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_346(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_234(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_347(iParam0);
	}
...
bool func_263(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_353(&(Global_1898164->f_1[0]));
		if (func_354(iVar0) && func_355((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_356(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_297(var uParam0, int iParam1)
{
	...
	else if (!func_371(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_299(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_313(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_313(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_315(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_377(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_326(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_330(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_229(iParam0, 8))
		{
...
void func_334(int iParam0, char* sParam1, int iParam2)
{
	...
	func_392(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, 859817522, 0, 0, 0, 1);
}
...
void func_337(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = func_393();
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_392(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_392(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_392(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_392(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_344(var uParam0, int iParam1)
{
	...
	{
		if (!func_371(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
bool func_351()
{
	if (_is_ped_carrying(Global_35) || func_409(Global_35))
	{
		return true;
	}
	return false;
...
int func_364(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_415(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!does_entity_exist(iVar1))
	{
		return 0;
	}
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_255(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_243() == -1)
		{
...
void func_383(var uParam0, int iParam1)
{
	...
	func_435(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_384(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_438(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_394(int iParam0)
{
	...
	fVar1 = func_444(absf(fVar1) < 1f, func_444(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_447((get_game_timer() + iParam2), !bParam1);
...
void func_400(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_449(iParam0));
...
int func_403(int iParam0, int iParam1)
{
	...
	if (!func_458(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
int func_415(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	if (!func_108(iParam1))
	{
		return 0;
...
bool func_424(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_54(iParam0))
	{
		return false;
...
int func_425(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_54(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_307(Global_1360165[iParam0]))
				{
				}
			}
...
bool func_458(int iParam0, int iParam1, var uParam2)
{
	if (!func_456(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_502((*Global_1360165)[iParam0]->f_4.f_2) || func_503((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_504((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_506(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_107(iParam0, 44, 1);
			}
...
void func_472(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_511(Global_35) && is_player_teleport_active())
	{
	}
	if (func_512(iParam0))
	{
		if (func_513(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_473(int iParam0, int iParam1)
{
	...
	bVar0 = func_514(iParam0, iParam1);
	return bVar0;
}
...
bool func_491(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_309(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_464((*Global_1347702)[63]->f_15, 1) || func_503((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_464((*Global_1347702)[134]->f_15, 1) || func_503((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_362(747937920, 1) && !func_464((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_520(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
...
struct<4> func_556(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_550(923904168, func_555(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_550(923904168, func_555(bParam0), -740156546, 0) };
		}
...
struct<4> func_558(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_550(271701509, func_555(bParam0), 12999093, 0) };
		}
