...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, 98537260, "CROW");
	...
	iLocal_18 = func_154(uParam0, -862949069, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_159(uParam0, iLocal_14, 2, -25074136, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
...
{
	_0x5288b7f0690f7c1f(func_48(uParam0, iLocal_17));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		task_fly_away(func_48(uParam0, iLocal_17), func_48(uParam0, iLocal_16));
		set_ped_keep_task(func_48(uParam0, iLocal_17), true);
		set_ped_as_no_longer_needed(&(uParam0->f_107[iLocal_17]->f_5));
	}
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_385((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
