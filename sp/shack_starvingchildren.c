		...
		case 1:
			if (!func_43(uParam0->f_3, 4))
			{
				...
				if (func_53(Global_35, func_36(uParam0, 0), 15f, 1, 1))
				{
					...
					{
						_0xa6a76d666a281f2d(&(uParam0->f_29[0]), 1037262907);
					}
					if (func_54())
					{
...
void func_20(var uParam0)
{
	if (!_does_volume_exist(uParam0->f_46))
	{
		if (!func_64(func_63(uParam0)))
		{
			...
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_63(uParam0), func_65(uParam0), func_66(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_63(uParam0), func_65(uParam0), func_66(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_43(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_72(func_71(uParam0->f_5), 2) && !func_73(128, 0, 1)) && !func_74(get_player_index(), 1, 1, 1)) && !func_75()) && !func_76(20)) && !func_72(func_71(uParam0->f_5), 4)) && !func_72(func_71(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_78(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_78(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_78(uParam0, iVar0, 0), iParam1, func_78(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_78(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
	...
	if (!&uParam0->f_6[iParam5] == 0)
	{
		if (!does_entity_exist(&(uParam0->f_13[iParam5])))
		{
			...
			if (uParam0->f_1 == 8192)
			{
				...
				{
					uParam0->f_13[iParam5] = func_83(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, iParam7, 1, 0, 0, 0, 0);
				}
			}
			else
			{
...
{
	if (!is_string_null_or_empty(func_78(uParam0, iParam2, 0)))
	{
...
bool func_53(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_107(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
{
	if (!func_114(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_114(uParam0, iParam1), func_115(uParam0, iParam1), func_116(uParam0, iParam1), func_117(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
bool func_73(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_122(iVar0) && func_123((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	...
	if (!is_string_null_or_empty(func_78(uParam0, iParam2, 0)))
	{
		if (_does_anim_scene_exist(*uParam1))
		{
			if (_is_anim_scene_loaded(*uParam1, true, false))
			{
				...
				if (!is_string_null_or_empty(func_78(uParam0, iParam2, 1)))
				{
					if (_0xa9016536015de29d(*uParam1, func_78(uParam0, iParam2, 1)))
					{
						_set_anim_scene_playback_list_bool(*uParam1, func_78(uParam0, iParam2, 1), true);
					}
				}
			}
		}
...
bool func_126(int iParam0, float fParam1)
{
	iVar0 = func_143(iParam0);
	if (iVar0 != 0)
	{
		*fParam1 = func_144(iParam0);
		return true;
	}
	else
	{
