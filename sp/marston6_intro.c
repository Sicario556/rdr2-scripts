void __EntryFunction__()
{
	...
	while (!func_5(&Local_19, 1))
	{
		...
		if (((((func_6(&Local_19) >= 5 && func_6(&Local_19) <= 7) && !func_5(&Local_19, 4096)) && _does_anim_scene_exist(Local_19.f_428.f_444)) && _is_anim_scene_started(Local_19.f_428.f_444, false)) && !_is_anim_scene_paused(Local_19.f_428.f_444))
		{
		...
		switch (func_6(&Local_19))
		{
			...
			case 3:
				...
				func_39(&Local_19);
				if (func_40(func_32((*Global_1835011)[Local_19]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_19.f_428)) == 4 && _does_anim_scene_exist(Local_19.f_428.f_444)) && _is_anim_scene_paused(Local_19.f_428.f_444))
				{
					func_37(Local_19);
					func_17(&Local_19, 7);
				}
...
bool func_128(int iParam0)
{
	...
	{
		iLocal_15 = _create_volume_box_with_custom_name(-1638.5f, -1358.6f, 83.5f, 0f, 0f, 0f, 23f, 22f, 24.7f, "Intro_Script_Blocking");
		func_261(iParam0, iLocal_15);
	}
	if ((!does_entity_exist(iLocal_16) || is_entity_dead(iLocal_16)) || !does_entity_belong_to_this_script(iLocal_16, true))
	{
		vVar0 = { func_262(0, 1) };
		fVar3 = func_263(0, 1);
		if (func_264(iParam0, 4, &iLocal_16, 0, 1, vVar0.x, vVar0.y, vVar0.z, fVar3, 0, 0, 0, 0))
		{
			clear_ped_tasks(iLocal_16, 1, 0);
			if (!is_entity_a_mission_entity(iLocal_16))
			{
				set_entity_as_mission_entity(iLocal_16, true, true);
			}
	...
	remove_all_ped_weapons(iLocal_16, true, true);
	...
	if ((!does_entity_exist(iLocal_17) || is_entity_dead(iLocal_17)) || !does_entity_belong_to_this_script(iLocal_17, true))
	{
		iLocal_17 = func_267(func_262(0, 0), func_263(0, 0), 0, 0, 0, 1, 1);
		task_stand_still(iLocal_17, -1);
		if (does_entity_exist(iLocal_17) && !is_entity_dead(iLocal_17))
		{
			if (!is_entity_a_mission_entity(iLocal_17))
			{
				set_entity_as_mission_entity(iLocal_17, true, true);
			}
			func_268(iParam0, iLocal_17);
			if (_is_mount_seat_free(iLocal_17, -1) && !is_entity_on_screen(iLocal_17))
			{
				set_blocking_of_non_temporary_events(iLocal_17, true);
				_set_entity_coords_and_heading(iLocal_17, func_262(0, 0), func_263(0, 0), true, false, true);
				task_stand_still(iLocal_17, -1);
			}
		}
	}
	if ((!does_entity_exist(iLocal_18) || is_entity_dead(iLocal_18)) || !does_entity_belong_to_this_script(iLocal_18, true))
	{
		vVar0 = { func_262(0, 2) };
		fVar3 = func_263(0, 2);
		if (!is_entity_on_screen(iLocal_17))
		{
			set_entity_heading(iLocal_18, -80.03f);
			if (does_entity_exist(iLocal_18) && !is_entity_dead(iLocal_18))
			{
				if (!is_entity_a_mission_entity(iLocal_18))
				{
					set_entity_as_mission_entity(iLocal_18, true, true);
				}
	...
	if (_does_text_database_exist("HLP2AUD"))
	{
		_text_database_request("HLP2AUD");
		if (!_text_database_has_loaded("HLP2AUD"))
		{
			return false;
		}
	}
...
bool func_140()
{
	return func_279(get_id_of_this_thread());
}
...
void func_142(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_284(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_147(int iParam0)
{
	...
	return func_300((*Global_1835011)[iParam0]->f_1);
}
...
int func_151(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_284(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_284(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
	...
	if (bVar0)
	{
		...
		if (func_283(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_284(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
...
int func_153(int iParam0)
{
	...
	if (vdist2(func_172(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
...
void func_157(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((does_entity_exist(iVar1) && func_336(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_160(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_341((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_341((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_342(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_344((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_346((*uParam1)[iVar0]))
		{
			if (func_344((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_347((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_348((*uParam2)[iVar0]))
		{
			if (func_344((*uParam2)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam3)
	{
		if (func_350((*uParam3)[iVar0]))
		{
			if (func_344((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_351((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_353((*uParam5)[iVar0]))
		{
			if (func_344((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_354((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_353((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_355((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_344((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_356((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_357((*uParam6)[iVar0]))
		{
			if (func_344((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_358((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_359((*uParam7)[iVar0]))
		{
			if (func_344((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_360((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_361((*uParam8)[iVar0]))
		{
			if (func_344((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_362((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_363((*uParam9)[iVar0]))
		{
			if (func_344((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_364((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_365((*uParam10)[iVar0]))
		{
			if (func_344((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_366((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_367((*uParam11)[iVar0]))
		{
			if (func_344((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_368((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_175(int iParam0, int iParam1)
{
	...
	func_377(iParam1);
	StringCopy(&cVar0, func_171(), 64);
	func_378(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_181(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_379(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_191(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_383(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_204(bool bParam0, bool bParam1)
{
	if (!func_386(Global_43801))
	{
		Global_43801 = func_391("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_215(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_399(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_382() };
...
void func_216(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_232(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_400(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_219()
{
	return func_389(_0xc17f69e1418cd11f(3));
}
...
void func_224(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_417() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_226(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_418(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_420(iVar1, func_418(uParam0), func_419(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_420(iVar3, func_418(uParam0), func_419(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_418(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_418(uParam0) };
			func_420(iVar0, vVar1, func_421(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_232(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_424(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_424(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_428(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_426(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_236(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_436(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_241(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_440(iParam3, 1)])
			{
				func_443(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_427(32768) && iParam1 != &Global_1946804->f_57[func_440(iParam3, 1)])
			{
				func_444();
...
bool func_243(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_454(iParam2, 1024))) || func_454(iParam2, 8)) && !func_450(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_455(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_454(iParam2, 4096)) && !func_450(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_455(iParam1, 2048);
			func_455(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_454(iParam2, 32)) && !func_450(*iParam1, 5632))
		{
...
int func_256(var uParam0, int iParam1)
{
	...
	if (func_140())
	{
		...
		if (func_460(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_461(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_283(uParam0, 8) && _0xdd0b7c5ae58f721d(func_462()))
	{
		_0x798be43c9393632b(func_462());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_462())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
int func_274(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_343((*uParam0)[iVar1]))
		{
			if (func_344((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_346((*uParam1)[iVar1]))
		{
			if (func_344((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_348((*uParam2)[iVar1]))
		{
			if (func_344((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		if (func_350((*uParam3)[iVar1]))
		{
			if (func_344((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_351((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_353((*uParam5)[iVar1]))
		{
			if (func_344((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_344((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_485((*uParam5)[iVar1]))
				{
					if (func_486((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_355((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_357((*uParam6)[iVar1]))
		{
			if (func_344((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_359((*uParam7)[iVar1]))
		{
			if (func_344((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_361((*uParam8)[iVar1]))
		{
			if (func_344((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_363((*uParam9)[iVar1]))
		{
			if (func_344((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_365((*uParam10)[iVar1]))
		{
			if (func_344((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_367((*uParam11)[iVar1]))
		{
			if (func_344((*uParam11)[iVar1]->f_2, iParam12))
			{
...
int func_292(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_246(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_498(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_500(iParam0);
					_0x7b204f88f6c3d287(func_501(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_501(iParam0, 0));
					func_502(iParam0);
				}
			}
			else
...
void func_302(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_508(1));
		if (!has_anim_dict_loaded(func_508(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_303(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_284(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_183(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_421(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_513(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_313(uParam0, 4);
			...
			if (func_243(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_282(uParam0, 4);
...
void func_310(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_496(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
...
void func_311(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_317(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_520(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_520(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_522(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_522(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_516(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_522(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_524(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_421(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_522(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_522(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_522(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_526(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_526(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
bool func_325(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_183(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_326(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_183(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_544(uParam0)) && _is_anim_scene_started(func_544(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_544(uParam0));
				bVar1 = _is_anim_scene_finished(func_544(uParam0), false);
				bVar2 = _is_anim_scene_active(func_544(uParam0));
...
int func_329(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_545(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
void func_342(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (bParam3)
	{
		...
		func_555(iParam0, 1056964608, -1, 1061158912);
...
void func_354(var uParam0)
{
	if (!func_560(uParam0->f_2, 1))
	{
		if (func_485(uParam0))
		{
			...
			{
				sVar0 = func_388(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_564())
				{
...
void func_380(struct<4> Param0)
{
	...
	if (func_572(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_572(20))
			{
				return;
			}
			iVar0++;
...
void func_408(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_423(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_409()
{
	...
	if (func_423(iVar0) && _is_weapon_two_handed(iVar0))
	{
...
void func_420(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_591(Global_35) && is_player_teleport_active())
	{
	}
	if (func_592(iParam0))
	{
		if (func_593(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_450(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_450(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_450(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_450(iParam5, 32), true);
	...
	else if (func_450(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_450(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_450(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
{
	return ((Global_1946804->f_57[func_440(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
{
	(Global_1946804->f_57[func_440(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_440(iParam0, 1)])->f_10 || iParam1);
}

void func_433(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_440(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_440(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_440(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_438(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_596(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_599(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_599(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_600(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_441(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_427(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_610(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_610(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_612(iParam0, iParam2, iParam1, func_244() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_433(func_431(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_458(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_624(ceil(&(Global_40.f_11095.f_11[iParam0])));
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_253(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_342(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_420(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_635(Global_1360165[iParam0]))
				{
				}
			}
			func_636(iParam0, Global_1360165[iParam0]);
...
void func_471(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_156() || !_0x6f1f0b17109309da(Global_43800, func_201(iParam0))))
	{
...
int func_478(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_643((*Global_1835011)[4]->f_1, 1))
		{
			if (func_644(5))
			{
				func_645(5);
	...
	if ((bVar0 && func_643((*Global_1835011)[37]->f_1, 1)) && !func_643((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_643((*Global_1835011)[43]->f_1, 1)) && !func_643((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
void func_479(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_402(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_436(uParam0->f_13[iVar0], 2);
		}
	}
}
...
int func_499(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_671(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_501(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_672(iParam0);
	}
...
void func_509(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_526(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_510(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_183(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_183(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_183(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_679(512) || func_680(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_496(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_681(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
				...
				else if (func_684(uParam0->f_1633[iVar2]) != 0)
				{
					func_683(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_496(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_183(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_681(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_513(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_685(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_514(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_688(uParam0, iVar0)) && !func_460(uParam0->f_1016[iVar0], 1))
			{
				if (!func_689(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_690(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_691(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_528(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_685(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_284(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_545(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_545(uParam0->f_475[iParam1], 64) && func_694(uParam0, iParam1, 0))
				{
					func_695(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_696(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_545(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_696(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_531(var uParam0, int iParam1)
{
	...
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_201(Global_35)))
		{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_690(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_533(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_309(uParam0))
	{
		case 0:
			...
			if (((!func_284(uParam0->f_1016[iVar2], 32) && func_699()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_284(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_284(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_308(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_284(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_284(uParam0->f_1016[iVar2], 256) || !func_403(&uVar5)) || bVar0)
			{
				if (func_704())
				{
					func_705();
...
bool func_536(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_709(uParam0, 0))
		{
			if (func_710(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_711(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_711(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_711(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_711(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_711(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_711(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_711(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_711(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_711(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_711(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_711(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_711(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_711(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_711(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_711(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_710(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_711(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_711(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_711(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_710(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_713(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_712(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_711(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_691(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_382() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_714(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_709(uParam0, 45))
				{
					if (func_710(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_715(uParam0->f_1522[iVar16], 2);
							func_712(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_716(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_715(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_710(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_715(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_715(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_709(uParam0, 57))
				{
					if (func_710(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_710(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_710(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_719(iVar17);
							}
							if (func_710(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_720(iVar17);
							}
							func_710(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_711(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_711(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_711(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_710(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_711(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_710(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_710(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_711(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_709(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_716(uParam0, 87, uParam0->f_1345[iVar18]);
						func_712(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_712(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_711(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_711(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_710(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_721(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_709(uParam0, 98))
				{
					if (func_710(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_722(uParam0, 99, uParam0->f_1633[iVar16]);
							func_722(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_722(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_710(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_713(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_537(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_332(uParam0->f_1522[iVar0], 2)) && !func_332(uParam0->f_1522[iVar0], 16)) && func_724(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_715(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_715(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_538(var uParam0)
{
	...
	{
		_0x6a4d224fc7643941(func_462());
		func_459(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_462()))
		{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_332(uParam0->f_1522[iVar0], 64))
			{
				...
				{
					func_725(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_715(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_540(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_592(uParam0->f_3[iVar0]->f_2)) && func_423(uParam0->f_3[iVar0]->f_10)) && !func_718(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_726(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_727(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
char* func_546(int iParam0)
{
	...
	{
		return func_731(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_732(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_551(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_736(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_552(int iParam0, int iParam1, bool bParam2)
{
	...
	func_737(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_577(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_390(iParam0, 8))
		{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_423(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_447(1328661203, func_748(), -1591664384, bParam0);
}
...
int func_606(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_605(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = 12;
	iVar2 = func_405(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_429(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_405(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_755(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_405(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_755(&(Global_1946804->f_1497.f_1[iVar1])) || func_605(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_405(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_405(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_405(&(uParam0->f_1[iVar1])) || func_605(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_613(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_428(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_759(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_614(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_761(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_244() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_464((*Global_1360165)[iParam0]->f_4.f_2) || func_300((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_646(int iParam0)
{
	...
	func_795(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_796(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_797(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_798(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_799(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_800(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_801(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_802(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_803(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_804(_get_map_zone_at_coords(vParam0, 10));
}
...
struct<6> func_663()
{
	if (func_820(-997150586, &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_820(-1189569496, &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_820(325139909, &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_820(1310070322, &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_820(986998820, &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_820(-415648720, &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
void func_673(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_830(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_832(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_836((*Global_1900383)[iParam0]->f_26);
		func_837((*Global_1900383)[iParam0]->f_26);
...
{
	switch (func_684(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_496(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_403(&(uParam0->f_1903)))
				{
					func_703(uParam0->f_1903, 0);
					func_839(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_496(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_840())
				{
					func_839(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_686(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_421(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_687(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_844(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_689(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_460(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_692(int iParam0, float fParam1)
{
	...
	if (!(func_847(17) && func_183(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_697(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_201(Global_35), &vVar7, false, 0, 2))
				{
			...
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_201(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
				if ((func_8(uParam0) > 3 && !func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_848(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_564(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_715(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
			...
			if (func_545(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_304(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_459(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_201(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_284(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_201(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_849(uParam0, 0);
				}
			}
...
bool func_698(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_545(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_700(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_284(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_284(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_423(func_422(Global_35, 0, 1, 0)) && !func_423(func_422(Global_35, 1, 1, 0))))
		{
			if (func_308(uParam0, uParam0->f_1684))
			{
				func_850(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_284(uParam0->f_1016[uParam0->f_1684], 16) && (func_423(func_422(Global_35, 0, 1, 0)) || func_423(func_422(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_284(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
...
void func_701(var uParam0, int iParam1, bool bParam2)
{
	...
	func_849(uParam0, func_522(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_852(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_691(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_461(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_850(vVar1);
	...
	if (func_545(uParam0->f_475[iParam1], 16))
	{
		func_853(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_706(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_860(iVar0));
		iVar0++;
	}
}
...
bool func_717(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if (((func_718(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_388(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_861(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_388(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_388(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_861(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_861(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_724(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_332(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_545(uParam0->f_475[iVar0], 512)) || func_545(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_718(uParam0->f_3[iVar0]->f_1))
				{
					if (func_564())
					{
						StringCopy(&cVar1, func_388(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_729(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_838(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_735(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_862(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
		...
		while (iVar28 < 4)
		{
			...
			if (func_599(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_865(0))
				{
					...
					func_866(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_747(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_869("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_868(iParam1, 512) && func_750(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_726(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_868(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_868(iParam1, 4))) && (!func_726(Var4.f_4) || func_868(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_868(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_868(iParam1, 1048576)))
				{
...
bool func_753(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_440(iParam0, 1)] != &Global_1946804->f_57[func_440(iParam0, 1)];
}
...
{
	if (iParam0 == &Global_1946804->f_57[func_440(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_761(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_244() == -1)
	{
		func_879(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_880(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_767()
{
	...
	func_891(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_768()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_891(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_769()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_891(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_771(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_643((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_643((*Global_1347702)[63]->f_15, 1) || func_300((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_643((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_643((*Global_1347702)[134]->f_15, 1) || func_300((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_643((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_897(747937920, 1) && !func_643((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_778(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_474(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_474(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_474(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_474(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_474(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_474(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_474(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_474(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_474(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_474(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_474(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_474(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_474(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_474(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_474(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_474(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_474(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_474(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_474(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_474(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_474(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_474(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_474(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_474(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_474(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_474(iParam1, 1544915253))
	{
...
int func_810(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_642())
	{
		...
		{
			bVar0 = false;
			if (!func_643((*Global_1835011)[15]->f_1, 1) && !func_749(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_643((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_921();
				*iParam1 = func_922();
				*uParam2 = func_923();
...
bool func_818(int iParam0, var uParam1)
{
	...
	*uParam1 = func_934(Var0, 1415981582, 0);
...
bool func_819(int iParam0, var uParam1)
{
	...
	*uParam1 = func_934(Var0, -2119169513, 0);
	if (!func_404(*uParam1, 0))
	{
		return false;
	}
...
bool func_843(var uParam0, int iParam1)
{
	...
	if ((func_423(func_727(Global_35, 0, 0, 0)) && !func_284(uParam0->f_1016[iParam1], 16)) && !func_284(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_849(var uParam0, bool bParam1)
{
	...
	if ((func_304(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_284(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_459(uParam0, 64);
	}
...
{
	if (func_545(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_495(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_460(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_421(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_495(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_460(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_421(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_947(uParam0) };
		...
		else if (!func_460(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_421(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
bool func_852(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_201(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_201(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
void func_854(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_421(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_460(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_855(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_421(Global_36, vParam3, 1), 0);
		}
		...
		if (func_545(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_460(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_460(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
void func_867(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_960(_get_weapon_clip_size(iParam0), iParam1);
...
void func_881(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_880(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
bool func_906(int iParam0, int iParam1)
{
	...
	Var29 = { func_447(iParam1, Var0, 1415981582, 0) };
...
bool func_907(int iParam0, int iParam1)
{
	...
	Var29 = { func_447(iParam1, Var0, -2119169513, 0) };
	return func_966(Var29, 1);
}
...
bool func_911(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_449(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_913(int iParam0)
{
	...
	if (func_973(get_entity_model(iParam0)))
	{
		return true;
	}
...
char* func_939(char* sParam0, int iParam1)
{
	...
	return func_979(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
bool func_966(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_449(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_969(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_449(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_976(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_449(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
bool func_978(int iParam0, int iParam1)
{
	...
	{
		return func_992(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
int func_985()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_726(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_726(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_987(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == -1784221369)
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_998(-1230526146, &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == -1037537535)
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_1000(-1230526146, &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_989(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_990(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return _0x033ee4b89f3ac545(func_449(bParam2), uParam0, iParam1);
}
...
struct<28> func_997(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_449(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_989(&Var28) };
...
struct<17> func_999(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_449(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_989(&Var17) };
