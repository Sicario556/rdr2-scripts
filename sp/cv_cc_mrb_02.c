...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	if (!func_154(1) && !func_154(2))
	{
		func_153(uParam0, 463271055, 0f, 0f, 0f, "STOOL", 0, 0, 1);
	}
	if (!func_154(1) && !func_154(2))
	{
	...
	func_158(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1f, 1065353216, 1);
	func_160(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, iLocal_14, 1094713344, 1092616192);
	func_158(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_159(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216, 1);
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_257(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_269(func_149(uParam0), func_268(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_272(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_286(uParam0->f_107[iVar12]->f_1));
				}
...
void func_196(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_266(uParam0, uParam0->f_1976.f_1), 1, func_267(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_201(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_298() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_202(var uParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_272(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
...
bool func_313(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_358(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
void func_319(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_271(100f, 140f);
			}
		}
...
int func_347(int iParam0, bool bParam1)
{
	...
	{
		func_247(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_235() == -1)
		{
