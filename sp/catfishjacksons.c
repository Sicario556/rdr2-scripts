		...
		if (get_game_timer() > iLocal_22)
		{
			...
			switch (iLocal_21)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_23));
					...
					break;
				case 2:
					if (func_11() || iLocal_24 < get_game_timer())
					{
						func_12(iLocal_23);
						iLocal_24 = (get_game_timer() + iLocal_20);
						iLocal_21 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_23) || iLocal_24 < get_game_timer())
					{
						func_14(iLocal_23);
						iLocal_24 = (get_game_timer() + iLocal_20);
						iLocal_21 = 4;
				...
				case 6:
					if (func_7(func_6(iLocal_23)))
					{
						if (func_17(func_6(iLocal_23), 4) && !iLocal_24 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_23) || iLocal_24 < get_game_timer())
							{
								func_19(iLocal_23, 4);
								iLocal_24 = (iLocal_20 + get_game_timer());
								iLocal_21 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_24 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_23);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_23]->f_10);
							if ((*Global_1888801)[iLocal_23]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_23]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_23]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_23]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder(1324.004f, -2287.084f, 50.711f, 0f, 0f, 0f, 57f, 50f, 20f);
	iLocal_15 = _create_volume_sphere(1322.59f, -2285.19f, 51.316f, 0f, 0f, 0f, 0.25f, 0.25f, 0.25f);
	_0x4c39c95ae5db1329(iLocal_15, 0, 16);
	return true;
}
...
{
	func_50(2, iLocal_14);
	func_51(2, 0, -1110806910);
	func_51(2, 1, -1092009223);
	if (func_20() != -1)
	{
		return;
	}
...
bool func_38(int iParam0)
{
	...
	if (!func_59(-2019549022, 1, 0))
	{
		if (!func_60(4))
		{
			if (_does_scenario_point_exist(iLocal_16))
			{
				...
				{
					iLocal_17 = _get_scenario_point_entity(iLocal_16, "PrimaryItem");
					iLocal_18 = get_object_index_from_entity_index(iLocal_17);
					_request_streamed_txd(-451886707, false);
				}
				else if (_has_streamed_txd_loaded(-451886707))
				{
					if (decor_set_int(iLocal_18, "letter_item", -2019549022))
					{
						_set_apply_object_txd(iLocal_18, -451886707, 0, 0);
						func_61(4);
					}
				}
			}
		}
		else if (!decor_exist_on(iLocal_18, "letter_item"))
		{
			func_62(4);
		}
	}
	...
	{
		_set_streamed_txd_as_no_longer_needed(-451886707);
		func_61(8);
	}
	func_63();
	func_64();
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_66(&Global_1935630, 16384)) || func_66(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_69((*uParam0)[iVar3], 1) && func_70(iParam1)) && !func_71(iParam1, 16))
							{
								func_73(iParam1, func_72(), -1, 0, -1, 0);
								func_74((*uParam0)[iVar3], 1);
							}
							func_75(iParam1, 0);
						}
						bVar0 = true;
...
void func_51(int iParam0, int iParam1, int iParam2)
{
	...
	Global_1392240->f_1[iParam0]->f_6[iParam1] = func_97(iParam2, 0, 0);
}
...
bool func_52(int iParam0)
{
	...
	return is_bit_set(Global_40.f_9052, iParam0);
}
...
bool func_59(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_116(iParam0, 0, bParam2) >= iParam1;
}

bool func_60(int iParam0)
{
	return func_117(uLocal_19, iParam0);
}
...
void func_64()
{
	...
	iVar0 = get_interior_at_coords(func_122(2));
	bVar1 = false;
	...
	if (func_103(2, 2))
	{
		iVar2 = Global_40.f_9422[2]->f_1;
		if (iVar2 != -15)
		{
			func_123(iVar2, &uVar3, &uVar4, &uVar5, &iVar6, &uVar7, &uVar8);
		}
		if (iVar6 > 2 || func_124(2, 2))
		{
			...
			func_129(2);
			func_130(2, 2);
			uVar9 = func_131(-658146346);
			if (!_0x113857d66a9cabe6(uVar9))
			{
				return;
			}
			_0xbfcb17895bb99e4e(uVar9, 0);
		}
		else
		{
			...
			uVar10 = func_131(-658146346);
			if (!_0x113857d66a9cabe6(uVar10))
			{
				return;
			}
			_0xbfcb17895bb99e4e(uVar10, 0);
		}
	}
	else
	{
	...
	{
		iLocal_16 = create_scenario_point(-1206647372, 1320.37f, -2274.06f, 49.53f, 7.859f, 0, 0, 0);
	}
	else
	{
		func_61(4);
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		iVar4 = func_147(func_146());
		iVar5 = func_148(func_146());
		if (iVar5 < 10)
		{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			{
				fVar7 = func_149(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(674, sVar8, iVar4, func_150(&cVar6, 109029619), sVar9, func_150(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_150(&cVar6, 109029619), func_150(&cVar10, 109029619));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_151(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_156(func_155(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_156(func_155(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_156(func_155(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_156(func_155(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_156(func_155(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_156(func_155(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_156(func_155(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_78(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_158(iVar1) && !func_161(iVar1, iParam2)) && (!bParam3 || !func_162(iVar1))) && (!bParam4 || !func_163(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_164(iVar0);
...
void func_85(int iParam0)
{
	...
	{
		_set_streamed_txd_as_no_longer_needed(-451886707);
		_delete_scenario_point(iLocal_16);
	}
	if (func_103(2, 2) && !func_124(2, 2))
	{
		uVar0 = func_131(-658146346);
...
void func_88(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_170(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
int func_96(int iParam0, bool bParam1)
{
	...
	if (func_171(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_175(iParam0));
				func_176(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_175(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_175(iParam0)))
	{
		func_176(iParam0, 128);
		return 1;
	}
	func_174(iParam0, _create_persistent_character(func_173(iParam0)));
	_0x4f81ead1de8fa19b(func_175(iParam0));
	if (func_171(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_175(iParam0));
		func_176(iParam0, 2048);
...
{
	func_178(iParam0, 4);
	func_180(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_179(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_179(iParam0));
	}
}
...
int func_100(int iParam0)
{
	...
	if (((!func_183(94) && !func_184(94)) && !func_183(95)) && !func_184(95))
	{
	}
	func_178(iParam0, 1);
	return 1;
...
bool func_102(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_186((*Global_1835011)[iParam0]->f_1, 1);
	}
...
bool func_104(int iParam0)
{
	...
	return func_186((*Global_1392626)[iParam0]->f_3, 1);
}
...
{
	_set_scenario_group_enabled_hash(1117620256, bParam0);
	_set_scenario_group_enabled_hash(-1737126224, bParam1);
	_set_scenario_group_enabled_hash(-796231184, bParam2);
}
...
bool func_115(int iParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_189("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_190(&Var4, iVar3, iVar1, iVar2))
			{
			}
...
int func_116(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_194(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_123(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, var uParam6)
{
	func_196(func_146(), iParam0, uParam1, uParam2, uParam3, iParam4, uParam5, uParam6);
}
...
{
	if (!is_interior_entity_set_active(*iParam0, sParam1))
	{
		*bParam2 = 0;
		return;
	}
...
void func_127(int iParam0, char* sParam1, bool bParam2)
{
	...
	activate_interior_entity_set(*iParam0, sParam1, 0);
	*bParam2 = 1;
}
...
{
	Global_40.f_9422[iParam0]->f_1 = -15;
}
...
char* func_138(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_199(Global_1894899->f_162);
	}
...
char* func_150(char* sParam0, int iParam1)
{
	...
	return func_204(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_151(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Var0 = -2;
	Var0 = iParam2;
	Var0.f_1 = iParam3;
...
bool func_153(int iParam0)
{
	...
	if (func_205())
	{
		if (!func_186((*Global_1835011)[3]->f_1, 1))
		{
...
struct<2> func_155(int iParam0, int iParam1)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	return Var0;
...
void func_164(int iParam0)
{
	...
	if (!func_158(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	Global_40.f_9422[iParam0]->f_1 = func_146();
}
...
{
	func_209(Global_1935369->f_5[iParam0]->f_6, 1);
	func_210(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_94(Global_1914319->f_3[iParam0]->f_21) && func_212(Global_1914319->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_170(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_172(int iParam0, bool bParam1)
{
	...
	func_221(iParam0);
	_0xfc77c5b44d5ff7c0(func_175(iParam0));
	func_174(iParam0, 0);
	return 1;
}
...
void func_180(int iParam0, int iParam1, vector3 vParam2, char* sParam5)
{
	iVar0 = func_222(vParam2);
	iVar1 = 0;
	while (iVar1 < Global_36308)
	{
		if ((func_223(iVar1) == iParam0 && func_224(iVar1) == iParam1) && func_225(iVar1) == iVar0)
		{
...
bool func_183(int iParam0)
{
	...
	return func_227((*Global_1347702)[iParam0]->f_15);
}
...
void func_187(int iParam0, int iParam1)
{
	...
	Global_40.f_9422[iParam0]->f_4 = (Global_40.f_9422[iParam0]->f_4 - (Global_40.f_9422[iParam0]->f_4 && iParam1));
}
...
bool func_189(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = _0x80d78bdc9d88ef07(func_194(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_196(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7)
{
	if (func_236(iParam0, iParam1, 1))
	{
		iVar0 = func_237(iParam1);
		iVar1 = func_238(iParam0);
		iVar2 = (func_238(iParam0) - func_238(iParam1));
		iVar3 = (func_237(iParam0) - func_237(iParam1));
		iVar4 = (func_239(iParam0) - func_239(iParam1));
	...
	else
	{
		...
		iVar3 = (func_237(iParam1) - func_237(iParam0));
		iVar4 = (func_239(iParam1) - func_239(iParam0));
...
bool func_198(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_244(&(Global_1898164->f_1[0]));
		if (func_226(iVar0) && func_245((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_246(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
{
	func_119(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
int func_222(struct<2> Param0, var uParam2)
{
...
struct<4> func_233(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_262(923904168, func_261(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_262(923904168, func_261(bParam0), -740156546, 0) };
		}
...
bool func_235(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_194(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_264(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
{
	func_267(iParam3, &vVar0, &Var3, &uVar6);
	if (func_268(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
{
	return func_262(1328661203, func_272(), -1591664384, bParam0);
}
...
struct<4> func_262(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_194(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
void func_267(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_268(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
