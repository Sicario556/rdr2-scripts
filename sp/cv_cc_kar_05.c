...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_153(uParam0, -686064834, 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, -1119935472, "WORLD_HUMAN_SIT_DRINK_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
...
bool func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_15))
	{
		if (bLocal_40)
		{
			func_56(uParam0->f_107[iLocal_15]->f_1, 0, 0, 0, uParam0->f_107[iLocal_15]->f_32.f_4, 1, 1, 0, 0, 0, 0);
		}
...
bool func_198(var uParam0, int iParam1)
{
	...
	{
		if (!func_300(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_275(var uParam0, int iParam1)
{
	...
	else if (!func_300(uParam0->f_107[iParam1]->f_5, -76381094))
	{
