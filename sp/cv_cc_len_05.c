...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.71f, -1.86f, 1f, 89.64f, 2.75f, 3f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_151(uParam0, -1.4879f, -0.1481f, 0.7299f, 89.64f, 1.5f, 1.5f, 3f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 2095602337, 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_16 = func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 0, 1);
	func_153(uParam0, "script@vignette@lenny_5@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@lenny_5@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@lenny_5@action_a_int_front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@lenny_5@action_a_int_left", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@lenny_5@action_a_int_right", 2, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@lenny_5@action_b", 2, 0, 0, 0);
	iLocal_22 = func_153(uParam0, "script@vignette@lenny_5@exit_action", 0, 0, 0, 0);
	func_154(uParam0, "CLEN5AU");
	func_155(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_156(uParam0, iLocal_14, 3, -1489483851, 0, -1, 0, 117f, 1065353216, 1);
	...
	Local_23 = { func_160(uParam0, -0.2917f, -1.106f, 0.9548f, 5.5117f, 7f, 0.4f, 0.4f) };
	Local_33 = { func_160(uParam0, -0.292f, -1.106f, 0.955f, 77.55f, 7f, 0.4f, 0.4f) };
	Local_43 = { func_160(uParam0, -0.292f, -1.106f, 0.955f, -66.5f, 7f, 0.4f, 0.4f) };
	func_161(uParam0, 2146243937, -817451845);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_201(uParam0, Local_23, 1, 0))
		{
			func_191(uParam0, iLocal_18, 1);
		}
		else if (func_201(uParam0, Local_33, 1, 0))
		{
			func_191(uParam0, iLocal_19, 1);
		}
		else if (func_201(uParam0, Local_43, 1, 0))
		{
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_258(func_148(uParam0), func_257(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
...
bool func_192(int iParam0)
{
	...
	return func_299((*Global_1347702)[iParam0]->f_15);
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_304(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_243(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_298(iVar0) && func_322((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_311(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_330(100f, 140f);
			}
		}
...
bool func_319()
{
	if (_is_ped_carrying(Global_35) || func_357(Global_35))
	{
		return true;
	}
	return false;
...
bool func_366(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_398((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_406(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_407(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_409(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_411(iParam0, Global_1360165[iParam0]);
...
void func_387(var uParam0, int iParam1)
{
	...
	func_419(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_388(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_422(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_395(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_429(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_427();
				}
			}
			if ((bParam2 && !func_209(vVar0)) && !func_210(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_406((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_430((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
				_0xf74e134f40192884((*Global_1360165)[iParam0]->f_124, 1);
			}
			sVar12 = func_431(iParam0, func_286());
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_438((*Global_1360165)[iParam0]->f_4.f_2) || func_299((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_406(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_446(Global_35) && is_player_teleport_active())
	{
	}
	if (func_447(iParam0))
	{
		if (func_448(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_426(int iParam0, char* sParam1)
{
...
bool func_428(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_429(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_459(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_430(int iParam0, int iParam1)
{
	...
	func_397(iParam1, func_458(iParam1, 8192), func_458(iParam1, 16384), 1);
}
...
int func_437(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_398((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_398((*Global_1347702)[63]->f_15, 1) || func_299((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_398((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_398((*Global_1347702)[134]->f_15, 1) || func_299((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_398((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(747937920, 1) && !func_398((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_452(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_413(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_413(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_413(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_413(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_413(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_413(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_413(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_413(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_413(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_413(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_413(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_413(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_413(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_413(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_413(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_413(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_413(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_413(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_413(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_413(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_413(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_413(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_413(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_413(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_413(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_413(iParam1, 1544915253))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_482(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_486(0))
				{
					...
					func_487(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<4> func_484(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_502(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_485(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_502(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_486(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_502(bParam0));
}
...
void func_488(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_505(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_498(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_502(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_499(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_502(bParam6), &Var0, 0);
	return uVar4;
}
