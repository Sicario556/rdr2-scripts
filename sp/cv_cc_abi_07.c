...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, 0.8f, 0.4f, -12f, 3.75f, 2.5f, 2f, -1612834106, 1);
	func_152(uParam0, -0.95f, -1.85f, 0f, 0f, 3.8f, 7f, 5f, -1612834106, -2055224817, 1, 1, 1);
	iLocal_16 = func_153(uParam0, -1006095118, 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	func_154(uParam0, "script@vignette@abigail_7@base_intro", 1, 1, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@abigail_7@trans_from", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@abigail_7@action_a", 2, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@abigail_7@action_b", 2, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@abigail_7@action_b_alt", 2, 0, 0, 1);
	iLocal_21 = func_154(uParam0, "script@vignette@abigail_7@abigail_trans_to", 0, 0, 0, 0);
	func_155(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	func_155(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	func_156(uParam0, iLocal_14, 3, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0);
	func_157(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_15, 2, 640190094, "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", -1, 0);
	func_158(uParam0, "CABI7AU");
	func_159(uParam0, 15f, 20f);
	Local_22 = { func_160(uParam0, 1f, -1.2f, 0.84f, -11f, 6f, 0.2f, 0.2f) };
	return true;
}
...
{
	freeze_entity_position(func_191(uParam0, iLocal_16), true);
	return true;
}
...
{
	return func_193(631.607f, -1249.651f, 40.66633f, 694.4416f, -1262.602f, 43.64066f, Global_36);
}
...
bool func_93(var uParam0)
{
	...
	{
		_0xf60165e1d2c5370b(Global_35, &fVar0, &fVar1);
		if (func_201(uParam0, Local_22, 1, 0) && (fVar0 < 0.8f && fVar1 < 0.8f))
		{
			func_190(uParam0, iLocal_19, 1);
			func_202(uParam0, -1735564658, -1408586199);
...
bool func_193(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, struct<2> Param6, var uParam8)
{
...
bool func_201(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_193(Param1, Param1.f_6, Global_36))
	{
		return false;
	}
	if (func_193(Param1, Param1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
bool func_315()
{
	if (_is_ped_carrying(Global_35) || func_352(Global_35))
	{
		return true;
	}
	return false;
...
bool func_361(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_392((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_400(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_401(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_403(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_405(iParam0, Global_1360165[iParam0]);
...
void func_381(var uParam0, int iParam1)
{
	...
	func_412(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_382(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_415(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_211(vVar0)) && !func_212(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_400((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
...
bool func_422(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_454(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
int func_431(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_392((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_392((*Global_1347702)[63]->f_15, 1) || func_433((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_392((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_392((*Global_1347702)[134]->f_15, 1) || func_433((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_392((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(747937920, 1) && !func_392((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_447(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_407(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_407(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_407(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_407(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_407(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_407(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_407(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_407(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_407(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_407(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_407(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_407(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_407(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_407(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_407(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_407(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_407(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_407(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_407(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_407(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_407(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_407(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_407(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_407(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_407(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_407(iParam1, 1544915253))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_479(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_483(0))
				{
					...
					func_484(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<4> func_481(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_499(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_482(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_499(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_483(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_499(bParam0));
}
...
void func_485(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_502(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_495(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_499(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_496(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_499(bParam6), &Var0, 0);
	return uVar4;
}
