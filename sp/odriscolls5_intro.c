void __EntryFunction__()
{
	...
	while (!func_5(&Local_32, 1))
	{
		...
		if (((((func_6(&Local_32) >= 5 && func_6(&Local_32) <= 7) && !func_5(&Local_32, 4096)) && _does_anim_scene_exist(Local_32.f_428.f_444)) && _is_anim_scene_started(Local_32.f_428.f_444, false)) && !_is_anim_scene_paused(Local_32.f_428.f_444))
		{
		...
		switch (func_6(&Local_32))
		{
			...
			case 3:
				...
				func_39(&Local_32);
				if (func_40(func_32((*Global_1835011)[Local_32]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_32.f_428)) == 4 && _does_anim_scene_exist(Local_32.f_428.f_444)) && _is_anim_scene_paused(Local_32.f_428.f_444))
				{
					func_37(Local_32);
					func_17(&Local_32, 7);
				}
...
bool func_29(int iParam0)
{
	...
	_0xab0d553fe20a6e25(0.7f);
	set_random_vehicle_density_multiplier_this_frame(0.7f);
	func_131(iParam0, Global_35, 0, 0, 0, 1);
	if (!is_entity_dead(iLocal_25))
	{
		set_blocking_of_non_temporary_events(iLocal_25, true);
		set_current_ped_weapon(iLocal_25, -1569615261, true, 0, false, false);
		func_139(iLocal_25, func_138(0, 0), 2, 1073741824);
		func_131(iParam0, iLocal_25, 0, 0, 0, 1);
		func_140(iParam0, iLocal_25, 0);
	}
	if (!is_entity_dead(iLocal_26))
	{
		set_blocking_of_non_temporary_events(iLocal_26, true);
		set_current_ped_weapon(iLocal_26, -1569615261, true, 0, false, false);
		func_139(iLocal_26, func_138(0, 1), 2, 1073741824);
	...
	if (!is_entity_dead(iLocal_27))
	{
		...
		func_139(iLocal_27, func_138(0, 2), 2, 1073741824);
	...
	while (iVar0 < 7)
	{
		if (does_entity_exist(&(vLocal_14.f_2[iVar0])) && (((iVar0 == 2 || iVar0 == 1) || iVar0 == 0) || iVar0 == 6))
		{
	...
	while (iVar0 < 7)
	{
		if (does_entity_exist(&(vLocal_14.f_2[iVar0])) && ((iVar0 == 5 || iVar0 == 4) || iVar0 == 3))
		{
			if (iVar0 == 4)
			{
				set_anim_scene_entity(iLocal_24, "p_cs_sacklarge01x^1", &(vLocal_14.f_2[iVar0]), 0);
			}
			else
			{
				set_anim_scene_entity(iLocal_24, func_143(&(vLocal_14.f_2[iVar0])), &(vLocal_14.f_2[iVar0]), 0);
			}
			func_144(&(iParam0->f_428), &(vLocal_14.f_2[iVar0]), func_143(&(vLocal_14.f_2[iVar0])), 0, 0, 0);
		}
		iVar0++;
	}
	start_anim_scene(iLocal_24);
	iLocal_30 = _create_volume_box_with_custom_name(2793.85f, -1169.772f, 47.924f, 0f, 0f, 59.47334f, 7.5f, 7f, 3.115668f, "m_sbiIntroBlockingVolume");
...
{
	remove_scenario_blocking_area(uLocal_31, false);
	func_154(138, 0, 1, 0, 0);
	iVar0 = 0;
	while (iVar0 < 7)
	{
		if (does_entity_exist(&(vLocal_14.f_2[iVar0])))
		{
			func_140(iParam0, &(vLocal_14.f_2[iVar0]), 0);
		}
		iVar0++;
...
int func_39(int iParam0)
{
	...
	if (((!bLocal_28 && func_160(Global_35, iLocal_25, 1, 1) < 15f) && !_0xa24c1d341c6e0d53(0, 0, 0)) && func_162(&(iParam0->f_958.f_1771), func_161("ODR5_DUTSADBNT"), 0, -1, 0, 0))
	{
		bLocal_28 = true;
	}
	return 1;
...
bool func_53(int iParam0)
{
	if (!func_5(iParam0, 1024))
	{
		...
		while (iVar0 < 7)
		{
			if (does_entity_exist(&(vLocal_14.f_2[iVar0])))
			{
				delete_object(vLocal_14.f_2[iVar0]);
			}
			iVar0++;
		}
	}
...
bool func_128(int iParam0)
{
	...
	if ((does_entity_exist(iLocal_25) && does_entity_exist(iLocal_26)) && does_entity_exist(iLocal_27))
	{
		iLocal_24 = _create_anim_scene("script@story@dst5@leadin@INT@static_scene_props", 1, 0, false, true);
		func_276();
...
bool func_137()
{
	...
	if (!has_model_loaded(-1883578190))
	{
		return false;
	}
	if (!has_model_loaded(851401507))
	{
		return false;
	}
	if (!has_model_loaded(1610236838))
	{
		return false;
	}
	if (!has_model_loaded(633326690))
	{
		return false;
	}
	if (!has_model_loaded(1954479996))
	{
		return false;
	}
	if (!_is_anim_scene_loaded(iLocal_24, true, false))
	{
		return false;
	}
	return true;
...
void func_141(int iParam0, bool bParam1)
{
	...
	{
		vLocal_14.f_2[0] = create_object(-548150401, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[0]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[0]), bParam1);
	}
	func_290(&(vLocal_14.f_2[0]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[0]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[1])) && (iParam0 == -1 || iParam0 == 1))
	{
		vLocal_14.f_2[1] = create_object(1843407141, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[1]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[1]), bParam1);
	}
	func_290(&(vLocal_14.f_2[1]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[1]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[2])) && (iParam0 == -1 || iParam0 == 2))
	{
		vLocal_14.f_2[2] = create_object(-1883578190, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[2]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[2]), bParam1);
	}
	func_290(&(vLocal_14.f_2[2]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[2]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[3])) && (iParam0 == -1 || iParam0 == 3))
	{
		vLocal_14.f_2[3] = create_object(851401507, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[3]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[3]), bParam1);
	}
	func_290(&(vLocal_14.f_2[3]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[3]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[4])) && (iParam0 == -1 || iParam0 == 4))
	{
		vLocal_14.f_2[4] = create_object(1610236838, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[4]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[4]), bParam1);
	}
	func_290(&(vLocal_14.f_2[4]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[4]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[5])) && (iParam0 == -1 || iParam0 == 5))
	{
		vLocal_14.f_2[5] = create_object(633326690, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[5]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[5]), bParam1);
	}
	func_290(&(vLocal_14.f_2[5]), vLocal_14.x);
	func_290(&(vLocal_14.f_2[5]), vLocal_14.y);
	if (!does_entity_exist(&(vLocal_14.f_2[6])) && (iParam0 == -1 || iParam0 == 6))
	{
		vLocal_14.f_2[6] = create_object(1954479996, 2791.106f, -1169.426f, 48.1392f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[6]), 0f, 0f, -19.001f, 2, true);
		freeze_entity_position(&(vLocal_14.f_2[6]), bParam1);
	}
...
void func_144(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_299(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_300(uParam0->f_13[iVar0], 2);
		}
	}
}
...
void func_146(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_303(iParam0))
	{
		...
		if (bParam3)
		{
			func_304(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_155(int iParam0)
{
	...
	return func_326((*Global_1835011)[iParam0]->f_1);
}
...
float func_158()
{
	return (func_327(150f, to_float(Global_1934765->f_286)) / to_float(300));
}

void func_159(float fParam0)
{
	func_328(ceil((to_float(300) - (to_float(300) * fParam0))));
}
...
int func_164(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_330(get_player_index(), 0, 0, 1);
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_337(uParam0, uParam0->f_1684))
				{
					...
					{
						func_339(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_333(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_339(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_360(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_361(uParam0->f_1522[iVar0], 128))
				{
					func_362(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_172(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_366((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_366((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_367(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_173(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_369((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_371((*uParam1)[iVar0]))
		{
			if (func_369((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_372((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_373((*uParam2)[iVar0]))
		{
			if (func_369((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_374((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_375((*uParam3)[iVar0]))
		{
			if (func_369((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_376((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_378((*uParam5)[iVar0]))
		{
			if (func_369((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_379((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_378((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_380((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_369((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_381((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_382((*uParam6)[iVar0]))
		{
			if (func_369((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_383((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_384((*uParam7)[iVar0]))
		{
			if (func_369((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_385((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_386((*uParam8)[iVar0]))
		{
			if (func_369((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_387((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_388((*uParam9)[iVar0]))
		{
			if (func_369((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_389((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_390((*uParam10)[iVar0]))
		{
			if (func_369((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_391((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_392((*uParam11)[iVar0]))
		{
			if (func_369((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_393((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_187(int iParam0, int iParam1)
{
	...
	func_401(iParam1);
	StringCopy(&cVar0, func_183(), 64);
	func_402(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_193(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_403(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_203(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_407(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_216(bool bParam0, bool bParam1)
{
	if (!func_410(Global_43801))
	{
		Global_43801 = func_415("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_227(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_423(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_406() };
...
void func_228(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_244(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_424(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_231()
{
	return func_413(_0xc17f69e1418cd11f(3));
}
...
void func_238(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_441(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_288(iVar1, func_441(uParam0), func_442(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_288(iVar3, func_441(uParam0), func_442(uParam0), 2, 1073741824);
		}
	}
}
...
void func_239(var uParam0)
{
	if ((func_83(uParam0, 268435456) && !func_90(func_441(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		...
		if (!is_entity_dead(iVar0))
		{
			...
			func_288(iVar0, vVar1, func_443(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_244(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_446(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_446(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_450(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_448(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_248(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_300(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_253(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_449(32768) && iParam1 != &Global_1946804->f_57[func_461(iParam3, 1)])
			{
				func_465();
...
bool func_255(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_471(*iParam1, 2))
	{
		...
		else if ((func_475(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_475(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_475(iParam2, 1024))) || func_475(iParam2, 8)) && !func_471(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_476(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_475(iParam2, 4096)) && !func_471(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_476(iParam1, 2048);
			func_476(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_475(iParam2, 32)) && !func_471(*iParam1, 5632))
		{
...
int func_268(var uParam0, int iParam1)
{
	...
	if (func_149())
	{
		...
		if (func_482(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_483(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_314(uParam0, 8) && _0xdd0b7c5ae58f721d(func_484()))
	{
		_0x798be43c9393632b(func_484());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_484())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
int func_275(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_318(iParam0)) && !is_entity_dead(iVar0))
	{
...
void func_276()
{
	request_model(-548150401, false);
	request_model(1843407141, false);
	request_model(-1883578190, false);
	request_model(851401507, false);
	request_model(1610236838, false);
	request_model(633326690, false);
	request_model(1954479996, false);
	load_anim_scene(iLocal_24);
}
...
int func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_368((*uParam0)[iVar1]))
		{
			if (func_369((*uParam0)[iVar1]->f_2, iParam12))
			{
				if (!func_502((*uParam0)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam1)
	{
		if (func_371((*uParam1)[iVar1]))
		{
			if (func_369((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_503((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_373((*uParam2)[iVar1]))
		{
			if (func_369((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_504((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		...
		{
			if (func_369((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_376((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_378((*uParam5)[iVar1]))
		{
			if (func_369((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_505((*uParam5)[iVar1]))
				{
					if (!func_506((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
			...
			if (func_369((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_505((*uParam5)[iVar1]))
				{
					if (func_506((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_380((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_507((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_382((*uParam6)[iVar1]))
		{
			if (func_369((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_508((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_384((*uParam7)[iVar1]))
		{
			if (func_369((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_509((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_386((*uParam8)[iVar1]))
		{
			if (func_369((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_510((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_388((*uParam9)[iVar1]))
		{
			if (func_369((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_511((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_390((*uParam10)[iVar1]))
		{
			if (func_369((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_512((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_392((*uParam11)[iVar1]))
		{
			if (func_369((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_513((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
void func_288(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_518(iParam0))
	{
		if (func_519(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_471(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_471(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_471(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_471(iParam5, 32), true);
	...
	else if (func_471(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_471(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_471(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
char* func_294(int iParam0)
{
	...
	{
		return func_143(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_521(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_304(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_303(iParam0))
	{
...
int func_325(int iParam0, bool bParam1)
{
	...
	if (!_0x800df3fc913355f3(func_324(iParam0)))
	{
		return 1;
	}
	...
	func_321(iParam0);
	_0xfc77c5b44d5ff7c0(func_324(iParam0));
	func_526(iParam0, 0);
	return 1;
}
...
void func_331(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_531(1));
		if (!has_anim_dict_loaded(func_531(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_332(var uParam0, int iParam1, bool bParam2)
{
	...
	if (func_63(uParam0, 16))
	{
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_339(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_536(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_342(uParam0, 4);
...
void func_339(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_524(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
...
void func_340(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_346(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_543(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_543(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_545(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_545(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_539(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_545(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_547(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							...
							bVar29 = func_545(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_545(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_545(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_549(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_549(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_567(uParam0)) && _is_anim_scene_started(func_567(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_567(uParam0));
				bVar1 = _is_anim_scene_finished(func_567(uParam0), false);
				bVar2 = _is_anim_scene_active(func_567(uParam0));
...
int func_358(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_568(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
void func_367(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (bParam3)
	{
		...
		func_577(iParam0, 1056964608, -1, 1061158912);
...
void func_379(var uParam0)
{
	if (!func_585(uParam0->f_2, 1))
	{
		if (func_505(uParam0))
		{
			...
			{
				sVar0 = func_412(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_589())
				{
...
void func_404(struct<4> Param0)
{
	...
	if (func_596(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_596(20))
			{
				return;
			}
			iVar0++;
...
struct<5> func_459(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_617(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_620(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_620(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_621(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_462(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_449(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_631(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_631(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_633(iParam0, iParam2, iParam1, func_256() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_455(func_453(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_480(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_645(ceil(&(Global_40.f_11095.f_11[iParam0])));
		...
		case 0:
			...
			if (func_265(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_367(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_652(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_654(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_258(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_656(Global_1360165[iParam0], 1);
				}
			}
			func_650(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_657(Global_1360165[iParam0]))
				{
				}
			}
			func_658(iParam0, Global_1360165[iParam0]);
...
void func_532(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_549(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_524(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_675(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_339(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
				...
				else if (func_678(uParam0->f_1633[iVar2]) != 0)
				{
					func_677(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_524(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_195(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_675(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_536(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_679(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_537(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_682(uParam0, iVar0)) && !func_482(uParam0->f_1016[iVar0], 1))
			{
				if (!func_683(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_162(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
...
bool func_551(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_679(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_568(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_568(uParam0->f_475[iParam1], 64) && func_687(uParam0, iParam1, 0))
				{
		...
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					if ((func_568(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
...
int func_554(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_338(uParam0) != 11) && func_337(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_361(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_361(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_162(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_556(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_338(uParam0))
	{
		case 0:
			...
			if (((!func_315(uParam0->f_1016[iVar2], 32) && func_692()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_315(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 4:
			...
			if ((func_315(uParam0->f_1016[iVar2], 256) || !func_426(&uVar5)) || bVar0)
			{
				if (func_697())
				{
					func_698();
		...
		if (func_702(uParam0, 0))
		{
			if (func_703(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					{
						uParam0->f_1016[iVar16]->f_30 = { func_406() };
					}
...
bool func_560(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_361(uParam0->f_1522[iVar0], 2)) && !func_361(uParam0->f_1522[iVar0], 16)) && func_717(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
...
void func_561(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_361(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_484());
		func_481(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_484()))
		{
...
bool func_562(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_361(uParam0->f_1522[iVar0], 64))
			{
...
void func_563(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_518(uParam0->f_3[iVar0]->f_2)) && func_445(uParam0->f_3[iVar0]->f_10)) && !func_711(uParam0->f_3[iVar0]->f_1))
		{
...
void func_571(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_725(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_572(int iParam0, int iParam1, bool bParam2)
{
	...
	func_726(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_580(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_257(iParam0);
	if (((does_entity_exist(iVar1) && func_729(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_601(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_414(iParam0, 8))
		{
...
{
	return func_468(1328661203, func_744(), -1591664384, bParam0);
}
...
int func_627(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_626(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_632(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_451(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_751(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_428(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_626(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_751(&(Global_1946804->f_1497.f_1[iVar1])) || func_626(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_428(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_428(&(uParam0->f_1[iVar1])) || func_626(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_634(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_450(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_755(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_635(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_757(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_256() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_486((*Global_1360165)[iParam0]->f_4.f_2) || func_326((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_768((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_770(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_575(iParam0, 44, 1);
			}
...
bool func_664(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_525(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_324(iParam0));
}
...
{
	switch (func_678(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_524(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_426(&(uParam0->f_1903)))
				{
					func_696(uParam0->f_1903, 0);
					func_791(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_524(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_792())
				{
					func_791(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_681(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_796(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_683(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_482(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_685(int iParam0, float fParam1)
{
	...
	if (!(func_798(17) && func_195(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_688(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_360(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
...
void func_690(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_361(uParam0->f_1522[iVar0], 1))
			{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_589(), false);
				}
				...
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					...
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_362(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_568(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_333(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_315(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_315(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_481(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_213(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_315(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_691(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_568(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_693(var uParam0)
{
	if (!uParam0->f_1897)
	{
		...
		if (!func_315(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_445(func_444(Global_35, 0, 1, 0)) && !func_445(func_444(Global_35, 1, 1, 0))))
		{
			if (func_337(uParam0, uParam0->f_1684))
			{
	...
	if (!func_315(uParam0->f_1016[uParam0->f_1684], 16) && (func_445(func_444(Global_35, 0, 1, 0)) || func_445(func_444(Global_35, 1, 1, 0))))
	{
	...
	else if ((!func_337(uParam0, uParam0->f_1684) && !func_346(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_565(uParam0, 3);
	}
...
void func_694(var uParam0, int iParam1, bool bParam2)
{
	...
	func_800(uParam0, func_545(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	...
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_803(uParam0, &(uParam0->f_475[iParam1])))
		{
			...
			_0xcb9401f918cb0f75(Global_35, func_483(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_801(vVar1);
	...
	if (func_568(uParam0->f_475[iParam1], 16))
	{
...
bool func_710(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_412(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_412(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_412(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_717(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_361(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_568(uParam0->f_475[iVar0], 512)) || func_568(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
		...
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_711(uParam0->f_3[iVar0]->f_1))
				{
					if (func_589())
					{
						StringCopy(&cVar1, func_412(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_412(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_722(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_790(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_724(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_812(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_734(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_258(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_815(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_817(iParam0);
					_0x7b204f88f6c3d287(func_818(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_818(iParam0, 0));
					func_819(iParam0);
				}
			}
			else
		...
		while (iVar28 < 4)
		{
			...
			if (func_620(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_823(0))
				{
					...
					func_824(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_743(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_827("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_826(iParam1, 512) && func_746(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_719(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_826(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_826(iParam1, 4))) && (!func_719(Var4.f_4) || func_826(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_826(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_826(iParam1, 1048576)))
				{
...
void func_747(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_832(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_832(uParam0->f_2[iVar0], 1))
				{
					func_833(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_757(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_256() == -1)
	{
		func_837(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_838(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_763()
{
	...
	func_849(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_764()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_849(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_765()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_849(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_767(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_854((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_854((*Global_1347702)[63]->f_15, 1) || func_326((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_854((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_854((*Global_1347702)[134]->f_15, 1) || func_326((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_854((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_856(747937920, 1) && !func_854((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_778(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_774(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_774(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_774(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_774(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_774(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_774(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_774(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_774(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_774(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_774(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_774(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_774(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_774(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_774(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_774(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_774(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_774(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_774(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_774(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_774(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_774(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_774(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_774(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_774(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_774(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_774(iParam1, 1544915253))
	{
...
bool func_795(var uParam0, int iParam1)
{
	...
	if ((func_445(func_720(Global_35, 0, 0, 0)) && !func_315(uParam0->f_1016[iParam1], 16)) && !func_315(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_800(var uParam0, bool bParam1)
{
	...
	if ((func_333(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_315(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_481(uParam0, 64);
	}
...
{
	if (func_568(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_523(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_482(uParam0->f_1016[uParam0->f_1684], 2))
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_523(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_482(uParam0->f_1016[uParam0->f_1688], 2))
			{
	...
	else
	{
		*uParam2 = { func_867(uParam0) };
		...
		else if (!func_482(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_443(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
{
	func_868(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_868(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_869(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_805(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if (func_482(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_806(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		...
		if (func_568(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_482(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_482(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
int func_816(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_879(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_818(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_880(iParam0);
	}
...
void func_825(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_883(_get_weapon_clip_size(iParam0), iParam1);
...
void func_839(var uParam0, int iParam1)
{
	if (func_256() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_837(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_838(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
