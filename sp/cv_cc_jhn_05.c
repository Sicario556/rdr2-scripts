...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, 1210783447, 0f, 0f, 0f, "p_cs_book02x", 0, 0, 1);
	if (!func_153(10))
	{
	...
	func_156(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, 45f, 1065353216, 1);
	func_157(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_A", -1, 1, 30f, 1065353216, 1);
	...
	if (func_153(10))
	{
		...
		func_164(uParam0, iLocal_15, 4, -830507952, 0, -1, 0);
...
bool func_207(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_315(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_335(100f, 140f);
			}
		}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_441((*Global_1360165)[iParam0]->f_4.f_2) || func_442((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_443((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_445(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_409(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_450(Global_35) && is_player_teleport_active())
	{
	}
	if (func_451(iParam0))
	{
		if (func_452(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_431(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_463(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_432(int iParam0, int iParam1)
{
	...
	func_385(iParam0, func_464(iParam1));
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_401((*Global_1347702)[63]->f_15, 1) || func_442((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_401((*Global_1347702)[134]->f_15, 1) || func_442((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(747937920, 1) && !func_401((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_477(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_488(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_492(0))
				{
					...
					func_493(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<5> func_486(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_498(iParam0))
	{
		case -1037537535:
			...
			{
				Var0 = { func_490(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			if (bParam2 && func_500(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_488(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_488(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_489(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_490(-1838434463, Var0, 1084182731, bParam1) };
...
bool func_491(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
...
void func_494(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_511(_get_weapon_clip_size(iParam0), iParam1);
...
{
	return func_490(1328661203, func_512(), -1591664384, bParam0);
}
...
struct<4> func_499(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_490(923904168, func_497(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_490(923904168, func_497(bParam0), -740156546, 0) };
		}
...
struct<4> func_501(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_490(271701509, func_497(bParam0), 12999093, 0) };
		}
...
bool func_506(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_508(0);
