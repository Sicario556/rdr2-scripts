		...
		if (get_game_timer() > iLocal_17)
		{
			...
			switch (iLocal_16)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_18));
					...
					Global_1897950 = -1;
					iLocal_19 = (get_game_timer() + iLocal_15);
					iLocal_16 = 2;
					break;
				case 2:
					if (func_11() || iLocal_19 < get_game_timer())
					{
						func_12(iLocal_18);
						iLocal_19 = (get_game_timer() + iLocal_15);
						iLocal_16 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_18) || iLocal_19 < get_game_timer())
					{
						func_14(iLocal_18);
						iLocal_19 = (get_game_timer() + iLocal_15);
						iLocal_16 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_18) || iLocal_19 < get_game_timer())
					{
						func_16(iLocal_18);
						iLocal_19 = (iLocal_15 + get_game_timer());
						iLocal_16 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_18)))
					{
						if (func_17(func_6(iLocal_18), 4) && !iLocal_19 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_18) || iLocal_19 < get_game_timer())
							{
								func_19(iLocal_18, 4);
								iLocal_19 = (iLocal_15 + get_game_timer());
								iLocal_16 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_19 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_18);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_18]->f_10);
							if ((*Global_1888801)[iLocal_18]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_18]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_18]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_18]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(-337.0264f, -358.9087f, 88.0646f, 0f, 0f, 0f, 94.2006f, 77.56374f, 227f, "m_volSwansonStation");
	return true;
}
...
int func_51(var uParam0, bool bParam1, int iParam2)
{
	if (func_20() != -1)
	{
		return -1;
	...
	func_90(*uParam0, iVar2);
	bVar1 = func_91(uParam0->f_1, 131072);
	func_92(uParam0->f_1);
	iVar3 = func_93(uParam0->f_1, *uParam0);
...
void func_64(int iParam0, bool bParam1)
{
	...
	func_122(func_121(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_122(func_121(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_122(func_121(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_122(func_121(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_122(func_121(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_122(func_121(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_122(func_121(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_87(int iParam0)
{
	...
	return (!func_142() || is_bit_set(Global_40.f_7854, iParam0));
}
...
{
	return func_145(iParam0, iParam1, 4, get_hash_key(func_144(iParam1)));
}
...
int func_99(int iParam0)
{
	...
	else
	{
		...
		else
		{
			...
			{
				if (!func_150(Global_1898330[iVar0]))
				{
...
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_151())
	{
		return true;
	}
	if (iParam0 == 61)
...
char* func_104(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_154(Global_1894899->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_156(func_155(Global_36));
	}
...
char* func_116(char* sParam0, int iParam1)
{
	...
	return func_159(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	if (func_83(Global_1914319->f_3[iParam0]->f_21) && func_167(Global_1914319->f_3[iParam0]->f_21))
	{
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar5 = func_179(iVar3, iVar4, iParam2);
	if (Global_1572887->f_12 == -1)
	{
		iVar0 = iVar1;
		iVar0 = iVar1;
		...
		{
			iVar6 = iVar0;
			if (func_180(iVar6) == iVar5)
			{
				return iVar6;
			}
			if (func_180(iVar6) == 0)
			{
				return func_181(iVar3, iVar4, iParam2, iVar0, iParam3);
			}
			iVar0++;
		}
		iVar1 = 751;
	...
	else
	{
		...
		while (iVar0 <= iVar2)
		{
			...
			{
				return func_181(iVar3, iVar4, iParam2, iVar0, 0);
			}
			iVar0++;
		}
	}
...
void func_148(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!_0x01f4d242765c6b24(func_183(iParam0)))
		{
			_0xca41e86545413b5b(func_184(iParam0), func_185(iParam0), func_186(iParam0), func_183(iParam0), Global_36);
		}
	}
	func_187(iParam0, 1);
	bParam1 = bParam1;
...
void func_149(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_180(Global_1898330[iParam0]);
		func_188((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}
...
bool func_153(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_150(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
int func_181(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_179(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_207(iVar1, 0);
	func_208(iVar1, 0);
	func_209(iVar1, 0);
