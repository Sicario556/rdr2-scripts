void __EntryFunction__()
{
	...
	Var0 = Local_58;
	Var0.f_1 = Local_58.f_11;
	Var0.f_483 = { Local_58.f_1 };
	Var0.f_486 = { Local_58.f_4 };
	Var0.f_489 = Local_58.f_7;
	Var0.f_20[0] = Local_58.f_8;
	Var0.f_453 = Local_58.f_9;
	Var0.f_500 = Local_58.f_10;
	Var0.f_503 = Local_58.f_12;
	func_2(&Var0);
	...
	switch (uParam0->f_464)
	{
		case 0:
			if (func_8(uParam0->f_483))
			{
				if ((get_game_timer() - uParam0->f_481) > 1000)
				{
					...
					else
					{
						...
						if (uParam0->f_480 > 1)
						{
							func_10(&(Global_1415419->f_19[*uParam0]->f_11), 1);
							uParam0->f_464 = 8;
						}
					}
				}
			...
			if (bVar0)
			{
				...
				_0x3145044f3990d321(func_12(*uParam0), uParam0->f_489, uParam0->f_483, &(uParam0->f_20[0]), uParam0->f_453);
				...
				{
					uParam0->f_497 = _create_volume_cylinder(uParam0->f_483, 0f, 0f, 0f, func_16(uParam0));
...
int func_9(bool bParam0, int iParam1, bool bParam2, bool bParam3, float fParam4)
{
	...
	if ((Global_1415419->f_19[bParam0]->f_8 != -1 && Global_1415419->f_19[bParam0]->f_9 < 960) && Global_1415419->f_19[bParam0]->f_9 >= Global_1415419->f_19[bParam0]->f_8)
	{
		...
		{
			*iParam1++;
			if (!func_38(bParam0, *Global_1415419->f_2996[iVar0]))
			{
			}
			else
			{
				...
				{
					iVar5 = func_39(Global_35, *Global_1415419->f_2996[iVar0], 1060437492);
					if (iVar5 == 1)
					{
					}
					else if (fVar6 < fVar2)
					{
						if (func_40(*Global_1415419->f_2996[iVar0], fVar6, (bParam0 <= 33 || bParam0 == 72), fParam4, bVar3, bVar4, bParam0))
						{
							iVar1 = iVar0;
							fVar2 = fVar6;
							if (bParam3)
...
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0]->f_5)
	{
		Global_32074.f_2697.f_6[iParam0]->f_5 = func_41();
	}
	func_42(&(Global_32074.f_2697.f_6[iParam0]->f_5), 0, 0, 1, 0, 0, 0, 0);
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	if (*uParam0 == 42)
	{
		func_52(uParam0, 0, "FRMWP_LEADER", iLocal_53, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, 41788943, 1);
		func_52(uParam0, 1, "FRMWP_FOLLOWER", iLocal_52, vParam1, fVar0, 1, 1, 1, 1, 41788943, 1);
	}
	else
	{
		func_52(uParam0, 0, "FRMWP_LEADER", iLocal_53, _get_object_offset_from_coords(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, 41788943, 1);
		func_52(uParam0, 1, "FRMWP_FOLLOWER", iLocal_52, vParam1, fVar0, 1, 1, 1, 1, 41788943, 1);
	}
	if (*uParam0 == 42)
	{
	...
	else if (*uParam0 == 62)
	{
		...
		func_52(uParam0, 3, "FRMWP_HORSE_LEAD", iLocal_51, _get_object_offset_from_coords(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, 41788943, 1);
	}
	else if (*uParam0 == 56)
	{
		func_52(uParam0, 3, "FRMWP_HORSE_LEAD", iLocal_51, _get_object_offset_from_coords(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, 41788943, 1);
...
bool func_20(var uParam0)
{
	...
	while (iVar1 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar1]->f_2 != 0)
		{
			if (func_8(uParam0->f_20[iVar1]->f_5))
			{
	...
	while (iVar12 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar12]->f_2 != 0)
		{
			...
			if (is_entity_dead(&(uParam0->f_20[iVar12])))
			{
				...
				{
					uParam0->f_20[iVar12] = func_58(uParam0->f_20[iVar12]->f_2, uParam0->f_20[iVar12]->f_5, uParam0->f_20[iVar12]->f_8, 1, 1, 0, 1, uParam0->f_20[iVar12]->f_11, uParam0->f_20[iVar12]->f_9, 0, 0, 0, 0);
				}
				...
				if (!is_ped_human(&(uParam0->f_20[iVar12])))
				{
					if (!func_59(&(uParam0->f_20[iVar12])))
					{
...
int func_26(var uParam0)
{
	...
	while (iVar0 < uParam0->f_371)
	{
		...
		{
			if ((uParam0->f_372[iVar0]->f_7 && func_8(uParam0->f_372[iVar0]->f_3)) && !is_string_null_or_empty(uParam0->f_3))
			{
	...
	switch (iLocal_9)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				if (*uParam0 != 56)
				{
					iLocal_56 = create_group(0);
					set_ped_as_group_leader(&(uParam0->f_20[0]), iLocal_56, false);
					set_ped_config_flag(&(uParam0->f_20[0]), 462, true);
				}
				set_ped_config_flag(&(uParam0->f_20[0]), 297, true);
				set_ped_config_flag(&(uParam0->f_20[0]), 130, false);
				set_ped_config_flag(&(uParam0->f_20[0]), 255, true);
				decor_set_bool(&(uParam0->f_20[0]), "HAS_VOICE", true);
				add_relationship_group("FRMW", &iLocal_50);
				set_ped_relationship_group_hash(&(uParam0->f_20[0]), iLocal_50);
				remove_all_ped_weapons(&(uParam0->f_20[0]), true, true);
				_give_weapon_to_ped_2(&(uParam0->f_20[0]), 379542007, 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				if (*uParam0 == 42)
				{
					set_ambient_voice_name(&(uParam0->f_20[0]), "0465_A_M_M_ValTownfolk_01_WHITE_01");
				}
				else
				{
					set_ambient_voice_name(&(uParam0->f_20[0]), "0418_A_M_M_SclRoughTravellers_01_WHITE_01");
				}
				if (*uParam0 == 62 || *uParam0 == 56)
				{
					_0x931b241409216c1f(&(uParam0->f_20[0]), &(uParam0->f_20[3]), 0);
					func_74(&(uParam0->f_20[0]), uParam0->f_20[3]->f_5, uParam0->f_20[3]->f_8, 2, 1073741824);
					func_75(&(uParam0->f_20[0]), &(uParam0->f_20[3]), 1, -1, 1);
				}
				if (*uParam0 == 62)
				{
					_task_move_in_traffic(&(uParam0->f_20[0]), 0.55f, 0, 0);
				}
				else
				{
					_task_move_in_traffic(&(uParam0->f_20[0]), 0.55f, 128, 0);
				}
				func_76(uParam0->f_20[0], 0, 1);
				set_ped_config_flag(&(uParam0->f_20[0]), 279, true);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_77(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				set_ped_config_flag(&(uParam0->f_20[1]), 297, true);
				set_ped_config_flag(&(uParam0->f_20[1]), 130, false);
				decor_set_bool(&(uParam0->f_20[1]), "HAS_VOICE", true);
				if (*uParam0 != 56)
				{
					remove_all_ped_weapons(&(uParam0->f_20[1]), true, true);
					_give_weapon_to_ped_2(&(uParam0->f_20[1]), 379542007, 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
					set_ped_as_group_member(&(uParam0->f_20[1]), iLocal_56);
					set_ped_config_flag(&(uParam0->f_20[1]), 462, true);
				}
				if (*uParam0 == 42)
				{
					set_ambient_voice_name(&(uParam0->f_20[1]), "0703_A_F_M_RhdUpperClass_01_WHITE_01");
				}
				else if (*uParam0 != 56)
				{
					set_ambient_voice_name(&(uParam0->f_20[1]), "0975_A_M_M_RoughTravellers_White_06");
				}
				if (*uParam0 != 63 && *uParam0 != 56)
				{
					_0x931b241409216c1f(&(uParam0->f_20[1]), &(uParam0->f_20[2]), 0);
					func_74(&(uParam0->f_20[2]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
					func_75(&(uParam0->f_20[1]), &(uParam0->f_20[2]), 1, -1, 1);
				}
				if (*uParam0 == 56)
				{
				...
				set_ped_relationship_group_hash(&(uParam0->f_20[1]), iLocal_50);
				if (*uParam0 == 62)
				{
					task_move_be_in_formation(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 2.5f, 0f, 0f, -1082130432, 0);
				}
				else if (*uParam0 == 63)
				{
					task_move_be_in_formation(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 2f, 0f, 0f, 1f, 0);
				}
				else
				{
					task_move_be_in_formation(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 2f, 0f, 0f, -1082130432, 1);
				}
				func_76(uParam0->f_20[1], 0, 1);
				set_ped_config_flag(&(uParam0->f_20[1]), 279, true);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
				if (*uParam0 == 42)
				{
					_0xcb9401f918cb0f75(&(uParam0->f_20[1]), "SideSaddleRider", 1, -1);
				}
			}
			func_78(&uLocal_44);
			func_78(&uLocal_47);
		...
		case 2:
			if (!&uParam0->f_469[1])
			{
				...
				if (!&uParam0->f_469[4])
				{
					if (func_82(&(uParam0->f_20[1]), Global_35, 0f) == 1 && func_83(&(uParam0->f_20[1]), Global_35, 1) >= 16f)
					{
						func_78(&uLocal_44);
						func_78(&uLocal_47);
						uParam0->f_469[4] = 1;
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_41() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_41();
					}
					func_42(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_10(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
{
	get_closest_vehicle_node_with_heading(vParam0, &uVar1, &fVar0, 1, 3f, 0);
...
int func_51(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (iVar5 > 0)
	{
		iVar0 = &iVar1[get_random_int_in_range(0, iVar5)];
	}
	return iVar0;
}
...
{
	if ((((_0x331550b212014b92(&(uParam0->f_20[0]), 0) || _0x9337183fda2e9035(&(uParam0->f_20[0]), player_id())) || _0xa454d234e45bb6e5(&(uParam0->f_20[0]), player_id())) || uParam0->f_469[1]) // PointerArith)
	{
		task_clear_look_at(&(uParam0->f_20[0]));
	}
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (((!_0x331550b212014b92(&(uParam0->f_20[0]), 0) || !_0xa454d234e45bb6e5(&(uParam0->f_20[0]), get_player_index())) || !is_ped_in_combat(&(uParam0->f_20[0]), 0)) || !&uParam0->f_469[1])
		{
			if (!func_114(&uLocal_41))
			{
				task_look_at_entity(&(uParam0->f_20[0]), &(uParam0->f_20[1]), get_random_int_in_range(3000, 5000), 0, 1, 0);
				func_115(&uLocal_41, get_random_float_in_range(0f, 5f));
			}
...
void func_70(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (((!_0x331550b212014b92(&(uParam0->f_20[1]), 0) || !_0xa454d234e45bb6e5(&(uParam0->f_20[1]), get_player_index())) || !is_ped_in_combat(&(uParam0->f_20[1]), 0)) || !&uParam0->f_469[1])
		{
			if (!func_114(&uLocal_38))
			{
				task_look_at_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), get_random_int_in_range(3000, 5000), 0, 1, 0);
				func_115(&uLocal_38, get_random_float_in_range(0f, 5f));
			}
			if (func_116(&uLocal_38, 15f))
			{
				task_clear_look_at(&(uParam0->f_20[1]));
				func_117(&uLocal_38);
			}
		}
	}
...
int func_71(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_118(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
int func_72(var uParam0)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (_0x331550b212014b92(&(uParam0->f_20[iVar0]), Global_35))
			{
				return 1;
			}
		}
...
void func_74(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_124(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_124(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_124(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_124(iParam5, 32), true);
	...
	else if (func_124(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_124(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_124(iParam5, 64))
		{
...
bool func_79(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_83(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
	...
	if (func_116(&uLocal_44, 2.5f))
	{
		switch (iLocal_54)
		{
			...
			case 1:
				if (*uParam0 != 42)
				{
					func_132(&(uParam0->f_20[0]), &(uParam0->f_20[1]), "HOWS_IT_GOING", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[0]), &(uParam0->f_20[1]), "CHAT_RESPONSE_A", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				iLocal_55 = &uParam0->f_20[0];
				iLocal_54++;
				func_78(&uLocal_44);
				break;
			case 2:
				if (*uParam0 != 42)
				{
					func_132(&(uParam0->f_20[1]), &(uParam0->f_20[0]), "GOING_WELL", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[1]), &(uParam0->f_20[0]), "RESPONSE_A", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				iLocal_55 = &uParam0->f_20[1];
				iLocal_54++;
				func_78(&uLocal_44);
				break;
			case 3:
				if (*uParam0 == 42)
				{
					func_132(&(uParam0->f_20[1]), &(uParam0->f_20[0]), "CONVO_TAIL_OFF", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					iLocal_55 = &uParam0->f_20[1];
				}
				else
				{
					func_132(&(uParam0->f_20[0]), &(uParam0->f_20[1]), "GLAD_TO_HEAR_THAT", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					iLocal_55 = &uParam0->f_20[0];
				}
				iLocal_54++;
				func_78(&uLocal_44);
...
void func_81(var uParam0)
{
	...
	{
		case 0:
			if (func_83(Global_35, &(uParam0->f_20[0]), 1) < 225f)
			{
				func_78(&uLocal_41);
				iLocal_57 = 1;
			}
			break;
		case 1:
			task_look_at_entity(&(uParam0->f_20[1]), Global_35, 3000, 0, 51, 0);
			func_78(&uLocal_38);
			iLocal_57 = 3;
			break;
		case 3:
			...
			{
				task_look_at_entity(&(uParam0->f_20[0]), Global_35, 7000, 0, 51, 0);
				iLocal_57 = 2;
			}
			break;
		case 2:
...
float func_83(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_133(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
		...
		switch (iLocal_54)
		{
			case 4:
				if (!is_any_speech_playing(Global_35))
				{
					...
					{
						func_132(&(uParam0->f_20[1]), &(uParam0->f_20[0]), "CHAT_GOOD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					}
					else
					{
						func_132(&(uParam0->f_20[1]), &(uParam0->f_20[0]), "CHAT_BAD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					}
					iLocal_55 = &uParam0->f_20[1];
					iLocal_54++;
					func_78(&uLocal_44);
			...
			case 5:
				if (!func_135(func_134()))
				{
					func_132(&(uParam0->f_20[0]), &(uParam0->f_20[1]), "RESPONSE_GOOD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[0]), &(uParam0->f_20[1]), "RESPONSE_BAD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				iLocal_55 = &uParam0->f_20[0];
				iLocal_54++;
				func_78(&uLocal_44);
...
bool func_89(vector3 vParam0, float fParam3)
{
	iVar0 = 0;
	while (iVar0 < 4)
	{
		...
		{
			if (func_136(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_90(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_118(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
...
void func_120(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	func_42(&(Global_32074.f_2697.f_6[iParam0]->f_5), 0, 0, Global_1415419->f_19[iParam0]->f_7, 0, 0, 0, 0);
	if (bParam4)
	{
		if (iParam0 <= 74)
		{
	...
	func_43(iParam0, (Global_1415419->f_19[iParam0]->f_7 / 2), 0, 0);
	func_186(iParam0);
...
bool func_131(float fParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_198(1) || *uParam0 & 8192 != 0))
				{
...
bool func_160(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_211(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_209(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_210(uParam2)
				{
					func_205(uParam2, 1);
					return true;
				}
...
bool func_161(int iParam0, var uParam1)
{
	...
	if (func_201(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_210(uParam1)
		{
...
int func_184(int iParam0, var uParam1)
{
	...
	{
		return func_235(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_186(int iParam0)
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_236(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_236(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_236(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_187(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_190(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_137(func_241(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_248(iVar0, 0)))
		{
...
bool func_211(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_248(iVar0, 0)))
		{
			if (func_250(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_222(int iParam0, int iParam1)
{
	...
	if (func_254(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
bool func_225(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_233(int iParam0)
{
	...
	return func_256((*Global_1347702)[58]->f_15, 1);
}
...
bool func_240(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return false;
...
bool func_249(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_250(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_250(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_252(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
