void __EntryFunction__()
{
	...
	Var0 = Local_21;
	Var0.f_1 = Local_21.f_11;
	Var0.f_483 = { Local_21.f_1 };
	Var0.f_486 = { Local_21.f_4 };
	Var0.f_489 = Local_21.f_7;
	Var0.f_20[0] = Local_21.f_8;
	Var0.f_453 = Local_21.f_9;
	Var0.f_500 = Local_21.f_10;
	Var0.f_503 = Local_21.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	if (iVar0 == 0)
	{
		iVar0 = get_random_int_in_range(1, 7);
	}
	switch (iVar0)
	{
		case 1:
...
int func_31(var uParam0)
{
	switch (iLocal_10)
	{
		case 0:
			if (!is_entity_dead(uParam0->f_453))
			{
				set_boat_anchor(uParam0->f_453, true);
				_0x6b53f4b811e583d2(uParam0->f_453, 1);
				_set_boat_frozen_when_anchored(uParam0->f_453, 1, 1);
				func_54(uParam0->f_453, &uLocal_11);
			}
			iLocal_10 = 1;
			break;
		case 1:
			if (_0xc8ccdb712fbcba92(uParam0->f_453) || func_55(Global_35, uParam0->f_453, 1) < 400f)
			{
				func_56(*uParam0, 0);
				iLocal_10 = 2;
			}
...
{
	if (does_entity_exist(uParam0->f_453) && !is_entity_dead(uParam0->f_453))
	{
...
bool func_47(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_71(&(Global_1898164->f_1[0]));
		if (func_72(iVar0) && func_73((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_74(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
float func_55(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_76(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_60(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_77(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_61(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_77(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_78(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
