void __EntryFunction__()
{
	...
	{
		_0x187d65f3aec5d679(-402695257, "BigValley/BGV_Trapper_1");
...
void func_2()
{
	...
	_0xf2cca7b68cfab2b9(904876610, -1927.953f, 412.0278f, 180f, vVar0, vVar3, 9.5f, 50f, 1f, 6f);
}

void func_3()
{
	iLocal_32 = _create_volume_aggregate_with_custom_name("m_volFortRiggsRestriction");
	_0x39816f6f94f385ad(iLocal_32, -1560f, -935f, 85f, 0f, 0f, 0f, 50f, 55f, 20f);
	_0x39816f6f94f385ad(iLocal_32, -1567.5f, -907.5f, 85f, 0f, 0f, 40f, 50f, 40f, 20f);
	_0x39816f6f94f385ad(iLocal_32, -1605f, -882.5f, 85f, 0f, 0f, 0f, 50f, 30f, 20f);
	_0x39816f6f94f385ad(iLocal_32, -1577f, -885.5f, 85f, 0f, 0f, -25.5f, 21f, 30f, 20f);
	_0x39816f6f94f385ad(iLocal_32, -1602.5f, -917.5f, 85f, 0f, 0f, 0f, 35f, 40f, 20f);
	_0x39816f6f94f385ad(iLocal_32, -1592.5f, -935.5f, 85f, 0f, 0f, 55f, 35f, 43f, 20f);
	func_9(iLocal_32, 0, 0, 1);
	iLocal_33 = _create_volume_cylinder_with_custom_name(-2212.354f, 708.9626f, 124.4049f, 0f, 0f, 11.49984f, 68.16475f, 52.09315f, 21.00951f, "m_volHangingDogRanchRestriction");
	func_9(iLocal_33, 0, 0, 1);
	iLocal_34 = _create_volume_cylinder_with_custom_name(-865f, -760f, 75f, 0f, 0f, 0f, 60f, 60f, 30f, "m_volLoneMuleSteadRestriction");
	func_9(iLocal_34, 0, 0, 1);
	iLocal_35 = _create_volume_box_with_custom_name(-1898f, -238.5f, 188f, 0f, 0f, 16.5f, 14f, 59f, 24.5f, "m_volMountainRiverRestriction");
	func_9(iLocal_35, 0, 0, 1);
	iLocal_36 = _create_volume_cylinder_with_custom_name(-1897.5f, 1370f, 215f, 0f, 0f, 0f, 75f, 75f, 25f, "m_volNorthernMiningTownRestriction");
	func_9(iLocal_36, 0, 0, 1);
	iLocal_37 = _create_volume_cylinder_with_custom_name(-617f, -40.2f, 80f, 0f, 0f, 0f, 43.7f, 43.7f, 13f, "m_volPaintedSkyRestriction");
	func_9(iLocal_37, 0, 0, 1);
	iLocal_38 = _create_volume_cylinder_with_custom_name(-1825f, 655f, 120f, 0f, 0f, 0f, 45f, 45f, 20f, "m_volWatsonsCabinRestriction");
	func_9(iLocal_38, 0, 0, 1);
	iLocal_39 = _create_volume_box_with_custom_name(-1554f, 257.4f, 116f, 0f, 0f, 14f, 45f, 45f, 25f, "m_volShepherdsRiseRestriction");
	func_9(iLocal_39, 0, 0, 1);
	iLocal_40 = _create_volume_aggregate_with_custom_name("m_volStrawberryRestriction");
	_0xbce668aaf83608be(iLocal_40, -1820f, -365f, 170f, 0f, 0f, 0f, 80f, 80f, 50f);
	_0xbce668aaf83608be(iLocal_40, -1765f, -420f, 170f, 0f, 0f, 0f, 80f, 80f, 50f);
	func_10(iLocal_40, 1);
	iLocal_41 = _create_volume_cylinder_with_custom_name(-1813.34f, -580.26f, 150f, 0f, 0f, 65f, 52f, 31f, 25f, "m_volStrawberryHorseShopRestriction");
	func_10(iLocal_41, 1);
	if (func_11())
	{
		iLocal_42 = _create_volume_aggregate_with_custom_name("m_volPronghornRanchRestriction");
		_0xbce668aaf83608be(iLocal_42, -2530.598f, 340.663f, 153f, 0f, 0f, 0f, 22f, 22f, 15f);
		_0xbce668aaf83608be(iLocal_42, -2530.057f, 471.4158f, 153f, 0f, 0f, 0f, 30f, 30f, 15f);
		_0xbce668aaf83608be(iLocal_42, -2590.521f, 470.2267f, 153f, 0f, 0f, 0f, 30f, 30f, 15f);
		_0xbce668aaf83608be(iLocal_42, -2572.795f, 343.0885f, 153f, 0f, 0f, 0f, 31f, 31f, 15f);
		_0x39816f6f94f385ad(iLocal_42, -2541.964f, 408.2656f, 153f, 0f, 0f, -3.75f, 75f, 132f, 30f);
		_0x39816f6f94f385ad(iLocal_42, -2574.994f, 411.635f, 153f, 0f, 0f, 7.5f, 75f, 128f, 30f);
		_0x39816f6f94f385ad(iLocal_42, -2555.338f, 340.0247f, 153f, 0f, 0f, 9.25f, 43f, 50f, 30f);
		_0x39816f6f94f385ad(iLocal_42, -2559.616f, 476.0391f, 153f, 0f, 0f, 1.5f, 61f, 50f, 30f);
		func_9(iLocal_42, 0, 0, 1);
	}
	iLocal_43 = _create_volume_cylinder_with_custom_name(-1301.288f, 403.2579f, 102.4782f, 0f, 0f, -27f, 15f, 25f, 15f, "m_volWallaceStationRestriction");
	func_9(iLocal_43, 0, 0, 1);
	iLocal_44 = _create_volume_aggregate_with_custom_name("m_volFlatIronLakeIslandRestriction");
	_0xbce668aaf83608be(iLocal_44, 237.213f, -769.7713f, 42.9804f, 0f, 0f, 0f, 156.4307f, 81.38799f, 25.72252f);
	_0xbce668aaf83608be(iLocal_44, -401.9616f, -1012.638f, 42.9804f, 0f, 0f, -51.00734f, 240.5335f, 103.688f, 24.89919f);
	_0x39816f6f94f385ad(iLocal_44, 440.3216f, -1462.027f, 55.90892f, 0f, 0f, 13.40226f, 421.2939f, 982.8425f, 99.70844f);
	func_12(iLocal_44, 0, 0, 1);
	iLocal_45 = _create_volume_cylinder_with_custom_name(-2172.987f, -253.5375f, 195f, 0f, 0f, -6f, 11f, 15f, 10f, "m_volRockCarvingsRestriction");
	func_9(iLocal_45, 0, 0, 1);
	iLocal_46 = _create_volume_aggregate_with_custom_name("m_volBardsCrossingRestriction");
	_0x39816f6f94f385ad(iLocal_46, -730.6474f, -548.0654f, 77.02292f, 0f, 0f, 27f, 353.0691f, 8.967957f, 13.35221f);
	_0x39816f6f94f385ad(iLocal_46, -892.4706f, -627.4682f, 77.26994f, 0f, 0f, 18.91964f, 20.99991f, 7.632857f, 11.3815f);
...
void func_6(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1:
			...
			request_model(func_20(uParam0->f_1), false);
			_0xed9582b3da8f02b4(1);
			uParam0->f_9 = 1;
			func_19(uParam0, 2);
			break;
		case 2:
			if (!has_model_loaded(func_20(uParam0->f_1)))
			{
				return;
			}
		...
		case 3:
			...
			set_model_as_no_longer_needed(func_20(uParam0->f_1));
			func_19(uParam0, 4);
			break;
		case 4:
			if (func_25(uParam0))
...
void func_7()
{
	...
	if (func_27(8))
	{
		uVar0 = _0x112ddf56300bc6e5(-1452704117);
		uVar1 = _0x112ddf56300bc6e5(-703427271);
		...
		if (_0xeb98b38ca60742d7(uVar0) && _0xeb98b38ca60742d7(uVar1))
		{
			...
			{
				if (!_is_position_inside_imap_streaming_extents(71064384, Global_36))
				{
					func_29(976539083);
				}
			}
	...
	{
		uVar2 = _0x112ddf56300bc6e5(-703427271);
		if (!_0x800df3fc913355f3(uVar2))
		{
			return;
		}
		if (_0xeb98b38ca60742d7(uVar2))
		{
			if (!func_28(976539083))
			{
				if (!_is_position_inside_imap_streaming_extents(71064384, Global_36))
...
{
	iVar0 = 7;
	uLocal_24[0] = _0x00bbf7ceae8c666a(-771.731f, -7.501f, 75.411f, 8f, iVar0, 16384);
}
...
void func_23(var uParam0)
{
	...
	uParam0->f_4 = _create_volume_sphere_with_custom_name(uParam0->f_5, func_44(), vVar1, "Special Ambient Horse Unalerted");
}
...
int func_27(int iParam0)
{
	...
	return func_47((*Global_1392626)[iParam0]->f_3, 1);
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_66(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
