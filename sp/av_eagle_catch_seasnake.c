...
{
	func_33(uParam0, 10732, 10769, 11767);
}
...
{
	func_46(uParam0, "EAGLE_CATCH_SEASNAKE", "script@ambient@animal@EAGLE_CATCH_SEASNAKE@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "SNAKE", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
{
	sVar0 = "script_amb@animal@EAGLE_CATCH_SEASNAKE";
	sVar1 = "eagle_exit_a";
	sVar2 = "snake_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	if (!&uParam0->f_469[0])
	{
		...
		if (func_60(uParam0, &uLocal_11, 0) || func_61(&(uParam0->f_20[0]), Global_35, 1) < 225f)
		{
...
float func_61(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_102(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_67(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 1508352418))
		{
