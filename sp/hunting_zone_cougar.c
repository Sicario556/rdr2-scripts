...
void func_101(var uParam0)
{
	...
	_0xfca8fb9e15fa80d3(uParam0->f_12, func_170());
...
bool func_109()
{
	if (_is_ped_carrying(Global_35) || func_173(Global_35))
	{
		return true;
	}
	return false;
...
int func_110(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_174(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_175(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
{
	return func_132(1328661203, func_189(), -1591664384, bParam0);
}
...
void func_177(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_174(iParam0, 8))
		{
