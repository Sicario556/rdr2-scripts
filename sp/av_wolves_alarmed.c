...
{
	func_33(uParam0, 10857, 10908, 11667);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "WAP_WOLF_2", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.75f, 0.5f, 0f), (20f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "WAP_WOLF_3", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "WAP_WOLF_4", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 3.5f, -2.5f, 0f), (-110f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				func_64(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[0]), -1838821137, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
				func_65(uParam0->f_20[0], 1, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_64(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				task_start_scenario_at_position(&(uParam0->f_20[1]), -1369415261, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
				func_65(uParam0->f_20[1], 1, 1);
			}
			iVar0 = 2;
			while (iVar0 <= 3)
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					func_64(&(uParam0->f_20[iVar0]->f_5), 50, 10, 0);
					task_start_scenario_at_position(&(uParam0->f_20[iVar0]), 1588806187, uParam0->f_20[iVar0]->f_5, uParam0->f_20[iVar0]->f_8, 0, false, true, 0, -1f, false);
					func_65(uParam0->f_20[iVar0], 1, 1);
				}
				iVar0++;
			}
			iLocal_11 = 1;
		...
		case 1:
			if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				clear_ped_tasks(&(uParam0->f_20[2]), 1, 0);
				task_look_at_entity(&(uParam0->f_20[0]), Global_35, -1, 0, 51, 0);
				task_look_at_entity(&(uParam0->f_20[2]), Global_35, -1, 0, 51, 0);
				_0xe7fa07624574b79a(&(uParam0->f_20[1]), Global_35, 1, 1, 15f, 1, 0, 0, 0);
				_0xe7fa07624574b79a(&(uParam0->f_20[3]), Global_35, 1, 1, 15f, 1, 0, 0, 0);
				func_67(&uLocal_15);
				iLocal_11 = 3;
			}
			break;
		case 3:
			if (!func_68(&(uParam0->f_20[0]), -875674219))
			{
				task_turn_ped_to_face_entity(&(uParam0->f_20[0]), Global_35, 0, -1082130432, -1082130432, -1082130432);
			}
			if (!func_68(&(uParam0->f_20[2]), -875674219))
			{
				task_turn_ped_to_face_entity(&(uParam0->f_20[2]), Global_35, 0, -1082130432, -1082130432, -1082130432);
			}
			if (func_69(&(uParam0->f_20[0]), Global_35, 1) < 324f || func_70(&uLocal_15, 12.5f))
			{
				func_71(&(uParam0->f_20[0]));
				func_71(&(uParam0->f_20[2]));
				func_62(uParam0);
				func_67(&uLocal_12);
				iLocal_11 = 4;
			}
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 4)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			...
			_task_smart_flee_style_ped(0, Global_35, 2, 256, -1082130432, -1, 0);
			close_sequence_task(iVar6);
			_task_perform_sequence_2(&(uParam0->f_20[iVar0]), iVar6, &(fVar1[iVar0]), &(fVar1[iVar0]));
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_69(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
