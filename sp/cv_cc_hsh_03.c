...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.0193f, 0.0081f, 0.5071f, 0f, 1.5f, 1.5f, 3f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, "script@vignette@hosea_3@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@hosea_3@actiona", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@hosea_3@actionb", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@hosea_3@actionc", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@hosea_3@base", 1, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@hosea_3@base", 1, 0, 0, 0);
	iLocal_20 = iLocal_16;
	func_154(uParam0, "CHS3AUD");
	func_155(uParam0, iLocal_14, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, 804308578, 1046280453);
	Local_24 = { func_158(uParam0, -0.0193f, 0.0081f, 0.5071f, 93.2119f, 6f, 0.7f, 0.7f) };
	Local_34 = { func_158(uParam0, 1.68f, 0.0081f, 0.5071f, 93.2119f, 9f, 0.8f, 0.8f) };
	func_159(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		if (func_191(uParam0, Local_34, 1, 0))
		{
	...
	if (func_201(uParam0, iLocal_18) || func_201(uParam0, iLocal_19))
	{
		...
		else if (!is_entity_on_screen(func_48(uParam0, iLocal_14)))
		{
