...
void func_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	else
	{
		...
		if (fParam4 > 0f)
		{
			...
			func_32(&((*Global_1360165)[iParam0]->f_130), 1);
		}
		else
		{
...
bool func_21(var uParam0)
{
	...
	{
		iLocal_108 = _get_anim_scene_ped(uParam0->f_2, "U_M_M_ValSheriff_01", false);
		return false;
	}
	if (!func_52(3))
	{
	...
	if (!is_entity_a_mission_entity(iLocal_108))
	{
		set_entity_as_mission_entity(iLocal_108, true, true);
	}
...
bool func_22(var uParam0)
{
	...
	{
		iLocal_109 = _get_anim_scene_ped(uParam0->f_2, "u_m_m_bht_benedictallbright", false);
		return false;
	}
	return true;
}
...
int func_28(var uParam0)
{
	...
	if (func_41(iLocal_108, 0))
	{
		task_use_nearest_scenario_to_coord_warp(iLocal_108, -276.0093f, 810.7167f, 118.3755f, 0.5f, 0, false, false, false, false);
	}
	return 1;
}
...
void func_36(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_83(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_37(iParam0, 1, 0);
		}
	}
...
void func_37(int iParam0, int iParam1, bool bParam2)
{
	...
	func_84(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_44(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_87(iParam0), 137, true);
	}
}
...
void func_46(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_87(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_87(iParam0), 204, false);
	}
}
...
void func_48(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_87(iParam0);
	if (((does_entity_exist(iVar1) && func_89(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_61(int iParam0, int iParam1)
{
	...
	while (iVar0 < Global_40.f_9829)
	{
		if (&Global_40.f_9829[iVar0] == iParam1)
		{
			if (iVar3 >= 0)
			{
				func_60(iVar3, Global_40.f_9829[iVar0]->f_1, iParam1, Global_40.f_9829[iVar0]->f_3);
			}
			iVar3 = iVar0;
			iVar2++;
			if (iVar2 == iVar1)
...
void func_62(int iParam0, int iParam1)
{
	...
	func_101(&(Global_40.f_9829[iParam0]->f_2), iParam1);
}
...
void func_67(char* sParam0, int iParam1)
{
	...
	func_109(get_hash_key(sParam0), iParam1);
}
...
bool func_68()
{
	...
	func_111((*Global_1835011)[7]->f_1, 1);
	func_112(iLocal_3, 76, 2);
	_0x73bad7b2f2db50de(get_player_index(), func_113(76, 1, 1));
	return true;
}
...
void func_69()
{
	if (func_41(iLocal_108, 0))
	{
		...
		{
			case 0:
				if (!_0x3ab6c7b0bb0df4b1(iLocal_108, -1) && is_ped_active_in_scenario(iLocal_108, 1))
				{
					iLocal_6 = 1;
				}
				break;
...
int func_82(int iParam0, bool bParam1)
{
	...
	if (!_0x800df3fc913355f3(func_81(iParam0)))
	{
		return 1;
	}
	...
	func_77(iParam0, 129);
	func_78(iParam0);
	_0xfc77c5b44d5ff7c0(func_81(iParam0));
	func_122(iParam0, 0);
	return 1;
}
...
void func_88(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_87(iParam0)))
		{
...
int func_94(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_41(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_126(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_128(iParam0);
					_0x7b204f88f6c3d287(func_129(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_129(iParam0, 0));
					func_130(iParam0);
				}
			}
			else
...
int func_98(int iParam0)
{
	...
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_81(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_81(iParam0));
	if (does_entity_exist(iVar0))
	{
		if (!_0x88ad6cc10d8d35b2(iVar0))
		{
	...
	_0x7b204f88f6c3d287(func_81(iParam0));
	return 1;
}
...
int func_110(int iParam0, int iParam1)
{
	...
	{
		if (&Global_40.f_9829[iVar3] == iParam0)
		{
			iVar2++;
			if (Global_40.f_9829[iVar3]->f_1 == iParam1)
			{
			}
			else
			{
			...
			_0x8bc555034a5a5e8c(iVar0, iParam1);
			func_136(iVar1, 0);
...
void func_112(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < Global_40.f_9829)
	{
		if (&Global_40.f_9829[iVar0] == iParam1 && Global_40.f_9829[iVar0]->f_1 == iParam0)
		{
			Global_40.f_9829[iVar0]->f_3 = iParam2;
		}
		iVar0++;
	}
}
...
int func_113(int iParam0, bool bParam1, bool bParam2)
{
	switch (iParam0)
	{
		...
		case 22:
			...
			if (func_142((*Global_1835011)[59]->f_1, 1))
			{
				return 965626876;
			}
			else
		...
		case 37:
			...
			if (func_142((*Global_1347702)[9]->f_15, 1))
			{
				return -497792649;
			}
			else if (func_141(45))
...
bool func_114()
{
	...
	{
		if (is_entity_on_screen(iLocal_108) && func_146(Global_35, iLocal_108, 2.5f, 1))
		{
			return true;
		}
	}
...
bool func_117(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	iParam3 = iParam3;
	iParam4 = iParam4;
	if (!is_entity_dead(iParam2) && (func_149(iParam2, iParam3, 1, 1) < 70f || bParam5))
	{
...
int func_127(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_156(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_129(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_157(iParam0);
	}
...
int func_136(int iParam0, bool bParam1)
{
	...
	{
		func_122(iParam0, _create_persistent_character(func_79(iParam0)));
		if (func_95() == -1)
		{
			if (func_54(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_81(iParam0));
				func_77(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_81(iParam0));
		}
		return 0;
	}
	...
	func_122(iParam0, _create_persistent_character(func_79(iParam0)));
	_0x4f81ead1de8fa19b(func_81(iParam0));
	if (func_54(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_81(iParam0));
		func_77(iParam0, 2048);
...
bool func_137(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_162(vVar0))
	{
		_0x59c7ad6fea2ac449(func_81(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = _0x08fc896d2cb31fcc(func_81(iParam0), 0);
	}
	else
	{
		iVar3 = _0x0cadc3a977997472(func_81(iParam0), 0);
	}
	if (!func_162(vVar0))
	{
		_0xbb68908cd11aebdc(func_81(iParam0));
	}
	if (does_entity_exist(iVar3))
	{
		return true;
...
bool func_160(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_121(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_81(iParam0));
}
...
bool func_161(int iParam0)
{
	...
	{
		_0x49a8c2cd97815215(func_81(iParam0));
		if (!does_entity_exist(_0x0cadc3a977997472(func_81(iParam0), 0)))
		{
			return false;
		}
	}
...
void func_168(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3)
{
	iVar0 = 0;
