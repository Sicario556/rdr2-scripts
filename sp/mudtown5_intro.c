void __EntryFunction__()
{
	...
	while (!func_5(&Local_157, 1))
	{
		...
		if (((((func_6(&Local_157) >= 5 && func_6(&Local_157) <= 7) && !func_5(&Local_157, 4096)) && _does_anim_scene_exist(Local_157.f_428.f_444)) && _is_anim_scene_started(Local_157.f_428.f_444, false)) && !_is_anim_scene_paused(Local_157.f_428.f_444))
		{
		...
		switch (func_6(&Local_157))
		{
			...
			case 3:
				...
				func_39(&Local_157);
				if (func_40(func_32((*Global_1835011)[Local_157]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_157.f_428)) == 4 && _does_anim_scene_exist(Local_157.f_428.f_444)) && _is_anim_scene_paused(Local_157.f_428.f_444))
				{
					func_37(Local_157);
					func_17(&Local_157, 7);
				}
...
{
	if (!does_entity_exist(&(uLocal_109[2])))
	{
		return false;
	}
	_text_database_request("cbbr1au");
	set_ped_can_be_targetted(&(uLocal_109[2]), true);
	set_ped_can_be_targetted(&(uLocal_109[0]), false);
	set_ped_can_be_targetted(&(uLocal_109[1]), false);
	set_ped_can_be_targetted(func_137(&(Local_14.f_3[0]), 1), false);
	set_ped_can_be_targetted(func_137(&(Local_14.f_3[0]), 0), false);
	set_ped_relationship_group_hash(func_137(&(Local_14.f_3[0]), 1), -1538724068);
	set_ped_relationship_group_hash(func_137(&(Local_14.f_3[0]), 0), -1538724068);
	set_ped_flee_attributes(func_137(&(Local_14.f_3[0]), 1), 512, true);
	set_ped_flee_attributes(func_137(&(Local_14.f_3[0]), 0), 512, true);
	set_blocking_of_non_temporary_events(func_137(&(Local_14.f_3[0]), 1), true);
	set_blocking_of_non_temporary_events(func_137(&(Local_14.f_3[0]), 0), true);
	task_stand_still(func_137(&(Local_14.f_3[0]), 1), -1);
	task_stand_still(func_137(&(Local_14.f_3[0]), 0), -1);
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 2)
	{
		iVar1 = _get_ped_in_draft_seat(&(Local_14.f_3[0]), iVar0);
		set_ped_can_be_targetted(iVar1, false);
		iVar0++;
	}
	if (!_does_volume_exist(iLocal_127))
	{
		iLocal_127 = _0x0eb78c2b156635b1(665633627, 720.8f, -1242.8f, 45.2f, 0f, 0f, 0f, 1.2f, 1.2f, 1f);
	}
	...
	set_anim_scene_origin(iLocal_148, 700f, -1240f, 45.15f, 0f, 0f, 0f, 2);
	start_anim_scene(iLocal_148);
	start_anim_scene(iLocal_148);
	func_140(iLocal_152, "Lenny", &(uLocal_109[1]));
	func_141(iLocal_152, sLocal_154, 1);
	set_anim_scene_origin(iLocal_152, 699.682f, -1239.705f, 45.10563f, 0f, 0f, 0f, 2);
	_set_anim_scene_playback_list_bool(iLocal_152, "PL_LENNY_ENTER_IDLE", true);
	start_anim_scene(iLocal_152);
	set_vehicle_doors_locked(&(Local_14.f_3[0]), 2);
	_0x63dc1f22c903b709(&(Local_14.f_3[0]), true);
	func_142(iParam0);
	func_143(Local_91[0], "INTERACT_GREET", 0, -163964935, 0, 0, 0, 1, 0);
...
int func_36(int iParam0)
{
	...
	if (_does_anim_scene_exist(iLocal_148))
	{
		reset_anim_scene(iLocal_148, 0);
		_delete_anim_scene(iLocal_148);
	}
	if (_does_anim_scene_exist(iLocal_152))
	{
		reset_anim_scene(iLocal_152, 0);
		_delete_anim_scene(iLocal_152);
	}
	func_154(_get_last_mount(Global_35), 721.2f, -1228.6f, 44.3f, -100.3f, 2, 1073741824);
	func_155(iParam0, 3, &(uLocal_109[2]), 0, 0, 1, 0);
	func_155(iParam0, 20, &(uLocal_109[0]), 0, 0, 1, 0);
	func_155(iParam0, 9, &(uLocal_109[1]), 0, 0, 1, 0);
	if (!is_entity_dead(iLocal_117))
	{
...
{
	set_ped_reset_flag(&(uLocal_109[0]), 185, true);
}
...
{
	freeze_entity_position(&(Local_14.f_3[0]), true);
...
bool func_53(int iParam0)
{
	...
	{
		_delete_anim_scene(iLocal_148);
		set_ped_to_ragdoll(&(uLocal_109[2]), 1000, 2000, 0, false, false, false);
		return false;
	}
	if (_does_anim_scene_exist(iLocal_152))
	{
	...
	_0xc67a4910425f11f1(get_player_index(), 0);
	set_ped_config_flag(&(uLocal_109[2]), 297, false);
	set_ped_config_flag(&(uLocal_109[2]), 130, false);
	set_ped_config_flag(&(uLocal_109[2]), 315, true);
	set_ped_config_flag(&(uLocal_109[2]), 317, false);
	set_ped_can_be_targetted(&(uLocal_109[2]), false);
	func_155(iParam0, 3, &(uLocal_109[2]), 0, 0, 1, 0);
	func_155(iParam0, 20, &(uLocal_109[0]), 0, 0, 1, 0);
	func_155(iParam0, 9, &(uLocal_109[1]), 0, 0, 1, 0);
	...
	_delete_volume(iLocal_122);
	_delete_volume(iLocal_124);
	_delete_volume(iLocal_126);
	_delete_volume(iLocal_125);
	_delete_volume(iLocal_123);
	set_player_control(get_player_index(), true, 0, false);
	display_radar(true);
	display_hud(true);
	stop_entity_fire(&(uLocal_109[2]), 0);
	stop_entity_fire(&(uLocal_109[0]), 0);
	func_157(Local_14.f_3[0]);
	if (!func_167(iParam0))
	{
		delete_object(Local_14.f_6[0]);
		delete_object(Local_14.f_6[1]);
		delete_object(Local_14.f_6[2]);
		delete_object(Local_14.f_6[3]);
		delete_object(Local_14.f_6[4]);
		delete_object(Local_14.f_6[5]);
		delete_object(Local_14.f_6[6]);
		delete_object(Local_14.f_6[7]);
		set_object_as_no_longer_needed(Local_14.f_6[0]);
		set_object_as_no_longer_needed(Local_14.f_6[1]);
		set_object_as_no_longer_needed(Local_14.f_6[2]);
		set_object_as_no_longer_needed(Local_14.f_6[3]);
		set_object_as_no_longer_needed(Local_14.f_6[4]);
		set_object_as_no_longer_needed(Local_14.f_6[5]);
		set_object_as_no_longer_needed(Local_14.f_6[6]);
		set_object_as_no_longer_needed(Local_14.f_6[7]);
	}
	remove_all_cover_blocking_areas();
	return true;
}
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_253(iVar0), func_255(), 1))
			{
...
{
	request_model(1770617692, false);
	request_model(1974613782, false);
	request_model(-162225711, false);
	request_model(1039503043, false);
	request_model(617552302, false);
	request_model(1311783028, false);
	request_model(-748422618, false);
	request_model(39512092, false);
	request_model(707548864, false);
	request_model(-363718050, false);
	request_model(1380116900, false);
	if (!func_269(&iLocal_148, cLocal_149, &uLocal_146, 0, 0))
	{
		return false;
	}
	_0xdf7b5144e25cd3fe(iLocal_148, sLocal_150);
	if (!func_269(&iLocal_152, cLocal_153, &uLocal_147, 0, 0))
	{
		return false;
	}
	_0xdf7b5144e25cd3fe(iLocal_152, sLocal_154);
	if (!has_model_loaded(1770617692))
	{
		return false;
	}
	...
	if (!has_model_loaded(1039503043))
	{
		return false;
	}
	if (!has_model_loaded(617552302))
	{
		return false;
	}
	if (!has_model_loaded(-748422618))
	{
		return false;
	}
	if (!has_model_loaded(1311783028))
	{
		return false;
	}
	if (!has_model_loaded(39512092))
	{
		return false;
	}
	if (!has_model_loaded(707548864))
	{
		return false;
	}
	if (!has_model_loaded(-363718050))
	{
		return false;
	}
	if (!has_model_loaded(1380116900))
	{
		return false;
	}
	if (iLocal_128 == 0 || iLocal_129 == 0)
	{
		iLocal_122 = _create_volume_box(718.1f, -1242.7f, 45.3f, 0f, 0f, -16.70035f, 12f, 12f, 4.347503f);
		iLocal_123 = _create_volume_sphere(708.2f, -1226.8f, 47f, 0f, 0f, -16.70035f, 9f, 9f, 4.347503f);
	...
	{
		iLocal_156 = create_object(1380116900, 720.2059f, -1242.369f, 45.256f, true, true, false, false, true);
		set_entity_quaternion(iLocal_156, -0.6565f, -0.3016f, -0.1817f, 0.667f);
	...
	set_ped_config_flag(&(uLocal_109[0]), 130, false);
	if (!_does_volume_exist(iLocal_125))
	{
		iLocal_125 = _create_volume_sphere(719.8f, -1241.849f, 45.4094f, 0f, 0f, -52.09116f, 5f, 5f, 5f);
	}
	if (!_does_volume_exist(iLocal_124))
	{
		iLocal_124 = _create_volume_sphere(719.8f, -1241.849f, 45.4094f, 0f, 0f, -24.98672f, 20.28144f, 20.15229f, 4.041716f);
	}
	if (!_does_volume_exist(iLocal_126))
	{
		iLocal_126 = _create_volume_box_with_custom_name(719.8f, -1241.849f, 45.4094f, 0f, 0f, 0f, 10f, 10f, 10f, "mudtown5_intro_NO_SCRIPT_CONTENT");
		uParam0->f_426 = iLocal_126;
		_0xeb2ed1dc3aec0654(iLocal_126, 1, 1, 1, 1);
	}
	func_141(iLocal_148, sLocal_150, 1);
	func_141(iLocal_152, sLocal_154, 1);
	func_273(-1, 0);
...
{
	if (!_0x23e33cb9f4a3f547(iParam0, sParam1) && !func_284(iParam0, sParam1))
	{
		return false;
	}
...
void func_154(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_313(Global_35) && is_player_teleport_active())
	{
	}
	if (func_314(iParam0))
	{
		if (func_315(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_316(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_316(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_316(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_316(iParam5, 32), true);
	...
	else if (func_316(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_316(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_316(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_319((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_319((*Global_1835011)[*iParam0], 65536);
		}
	}
...
{
	_0x3ee1f7a8c32f24e1(get_player_index(), &iVar0, false, false);
	...
	func_338(Global_35, _0xf70f00013a62f866(iLocal_124), 0, 30f, 25f, 10f, 5f, 1, 1, 1, 0);
	...
	if (iLocal_29 != 5)
	{
		if (_0x870708a6e147a9ad(&(uLocal_109[2]), "", 5f, 0, 0, 0, 0, 0, 0, -1))
		{
			set_ped_config_flag(&(uLocal_109[2]), 301, false);
			set_ped_config_flag(&(uLocal_109[2]), 297, true);
			set_ped_config_flag(&(uLocal_109[2]), 376, true);
			set_ped_config_flag(&(uLocal_109[2]), 276, true);
		}
	}
	if (iLocal_29 != 5)
	{
		...
		{
			func_341(uLocal_109[2], &iLocal_30, 7f, &Local_91, 0.1f, 3, 0, 0, 1, 0, 0, 2, -1082130432);
			if (func_342(&iLocal_30))
			{
				...
				_0xe98d55c5983f2509(&(uLocal_109[2]));
				if (is_ped_on_mount(Global_35) && iLocal_155 == 0)
				{
					task_dismount_animal(Global_35, 536870976, 0, 0, 0, 0);
					iLocal_155 = 1;
				}
				func_345(uLocal_109[2], &iLocal_30, &Local_91, 5f, -1082130432, 0);
				StringCopy(&cVar4, "2-Nighttime_Start", 64);
				if (!func_346(get_clock_hours(), 6, 12))
				{
	...
	switch (iLocal_29)
	{
		...
		case 5:
			...
			if ((!func_254(iLocal_117, 0) && func_48(&uLocal_142) > 2f) && !is_ped_on_mount(Global_35))
			{
				Var16.f_10 = 7;
				Var16 = 1;
				Var16.f_1 = 1;
				...
				set_blocking_of_non_temporary_events(iLocal_117, true);
				task_stand_still(iLocal_117, -1);
				func_131(iParam0, iLocal_117, "Horse_01", 0, 0, 1);
			}
			if (((iLocal_155 == 0 && func_48(&uLocal_142) > 2f) && func_254(iLocal_117, 0)) || (((iLocal_155 == 1 && func_48(&uLocal_142) > 2.5f) && func_254(iLocal_117, 0)) && !is_ped_on_mount(Global_35)))
			{
				_0x94a3c1b804d291ec(Global_35, 0, 0, 0, 0);
				func_351(_0xf70f00013a62f866(iLocal_124), 30f, 0, 0, 1, 1, 0);
				return 1;
			}
			break;
	}
...
void func_166(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		remove_scenario_blocking_area(*iParam0, bParam2);
	}
}
...
void func_189(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_392(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_199(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_396(uParam0->f_5, 0f, 0f, 0f))
	{
...
void func_223(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_410(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_395() };
...
void func_224(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_240(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_411(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
void func_232(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_428() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_234(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_429(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_154(iVar1, func_429(uParam0), func_430(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_154(iVar3, func_429(uParam0), func_430(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_429(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_429(uParam0) };
			func_154(iVar0, vVar1, func_431(vVar1, Global_36, 1), 2, 1073741824);
...
bool func_251(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_316(*uParam1, 2))
	{
		...
		else if ((func_463(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_463(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_463(iParam2, 1024))) || func_463(iParam2, 8)) && !func_316(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_464(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_463(iParam2, 4096)) && !func_316(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_464(uParam1, 2048);
			func_464(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_463(iParam2, 32)) && !func_316(*uParam1, 5632))
		{
...
int func_264(var uParam0, int iParam1)
{
	...
	if (func_148())
	{
		...
		if (func_469(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_470(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_303(uParam0, 8) && _0xdd0b7c5ae58f721d(func_471()))
	{
		_0x798be43c9393632b(func_471());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_471())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_269(int iParam0, char* sParam1, var uParam2, int iParam3, char* sParam4)
{
	...
	{
		*iParam0 = _create_anim_scene(sParam1, iParam3, sParam4, false, true);
	}
	if (_does_anim_scene_exist(*iParam0))
	{
		if (!_is_anim_scene_loading(*iParam0, true) && *uParam2 == 0)
		{
...
bool func_271(int iParam0, bool bParam1)
{
	...
	iVar0 = -1785480403;
	_request_propset(iVar0);
	if (!_has_propset_loaded(iVar0))
	{
		return false;
	}
	if (!does_entity_exist(&(Local_14.f_3[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_14.f_3[0] = create_vehicle(1770617692, 722.1201f, -1243.783f, 45.1542f, 228.2822f, true, true, false, false);
		_0xc0f0417a90402742(&(Local_14.f_3[0]), iVar0);
...
bool func_272(var uParam0)
{
	...
	func_487(&(uLocal_109[2]), -665597951);
	func_487(&(uLocal_109[2]), 1999408598);
	if (!func_254(&(iLocal_113[2]), 0))
	{
		return false;
	}
	...
	set_blocking_of_non_temporary_events(&(iLocal_113[1]), true);
	set_blocking_of_non_temporary_events(&(iLocal_113[2]), true);
	set_blocking_of_non_temporary_events(&(iLocal_113[0]), true);
	_update_ped_variation(&(uLocal_109[2]), false, true, true, true, false);
	set_ped_config_flag(&(uLocal_109[2]), 297, true);
	set_ped_config_flag(&(uLocal_109[2]), 130, true);
	set_ped_config_flag(&(uLocal_109[2]), 315, true);
	set_ped_config_flag(&(uLocal_109[2]), 317, false);
	return iVar0;
}
...
{
	if (!is_itemset_valid(Local_14.f_5))
	{
		Local_14.f_5 = create_itemset(true);
	}
	if (!does_entity_exist(&(Local_14.f_6[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_14.f_6[0] = create_object(1974613782, 721.2399f, -1243.244f, 45.6207f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[0]), 0f, 0f, -54.3529f, 2, true);
		freeze_entity_position(&(Local_14.f_6[0]), bParam1);
	}
	func_481(&(Local_14.f_6[0]), Local_14);
	func_481(&(Local_14.f_6[0]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[1])) && (iParam0 == -1 || iParam0 == 1))
	{
		Local_14.f_6[1] = create_object(1974613782, 701.7646f, -1220.877f, 45.1493f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[1]), 0f, 0f, 63.9774f, 2, true);
		freeze_entity_position(&(Local_14.f_6[1]), bParam1);
	}
	func_481(&(Local_14.f_6[1]), Local_14);
	func_481(&(Local_14.f_6[1]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[2])) && (iParam0 == -1 || iParam0 == 2))
	{
		Local_14.f_6[2] = create_object(617552302, 701.7646f, -1220.877f, 45.1493f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[2]), 0f, 0f, 63.9774f, 2, true);
		freeze_entity_position(&(Local_14.f_6[2]), bParam1);
	}
	func_481(&(Local_14.f_6[2]), Local_14);
	func_481(&(Local_14.f_6[2]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[3])) && (iParam0 == -1 || iParam0 == 3))
	{
		Local_14.f_6[3] = create_object(-162225711, 701.7646f, -1220.877f, 45.1493f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[3]), 0f, 0f, 63.9774f, 2, true);
		freeze_entity_position(&(Local_14.f_6[3]), bParam1);
	}
	func_481(&(Local_14.f_6[3]), Local_14);
	func_481(&(Local_14.f_6[3]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[4])) && (iParam0 == -1 || iParam0 == 4))
	{
		Local_14.f_6[4] = create_object(-162225711, 701.7646f, -1220.877f, 45.1493f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[4]), 0f, 0f, 63.9774f, 2, true);
		freeze_entity_position(&(Local_14.f_6[4]), bParam1);
	}
	func_481(&(Local_14.f_6[4]), Local_14);
	func_481(&(Local_14.f_6[4]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[5])) && (iParam0 == -1 || iParam0 == 5))
	{
		Local_14.f_6[5] = create_object(39512092, 720.7133f, -1242.581f, 45.5174f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[5]), 0f, 0f, 23.1026f, 2, true);
		freeze_entity_position(&(Local_14.f_6[5]), bParam1);
	}
	func_481(&(Local_14.f_6[5]), Local_14);
	func_481(&(Local_14.f_6[5]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[6])) && (iParam0 == -1 || iParam0 == 6))
	{
		Local_14.f_6[6] = create_object(707548864, 720.8611f, -1242.845f, 45.2674f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[6]), 0f, 0f, 23.1026f, 2, true);
		freeze_entity_position(&(Local_14.f_6[6]), bParam1);
	}
	func_481(&(Local_14.f_6[6]), Local_14);
	func_481(&(Local_14.f_6[6]), Local_14.f_5);
	if (!does_entity_exist(&(Local_14.f_6[7])) && (iParam0 == -1 || iParam0 == 7))
	{
		Local_14.f_6[7] = create_object(-363718050, 721.07f, -1243.034f, 45.2674f, true, true, false, false, true);
		set_entity_rotation(&(Local_14.f_6[7]), 0f, 0f, 23.1026f, 2, true);
		freeze_entity_position(&(Local_14.f_6[7]), bParam1);
	}
...
{
	if (!does_entity_exist(iParam0->f_60) || !func_254(*iParam1, 0))
	{
		return 1;
	}
...
void func_320(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_254(Global_1360165[iParam0], 0);
...
int func_335(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_254(iVar0, 0))
	{
		if (func_254(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_330(iParam0)) || func_331(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_544(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_546(iParam0);
					_0x7b204f88f6c3d287(func_547(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_547(iParam0, 0));
					func_548(iParam0);
				}
			}
			else
	...
	{
		if (func_254((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_261(iParam0, 32768, 1))
			{
...
void func_338(int iParam0, vector3 vParam1, bool bParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if (bParam4)
	{
		if (fVar3 <= fParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_552(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_552(iParam0, -828834893))
			{
...
void func_340(var uParam0, var uParam1, int iParam2)
{
	...
	set_ped_can_head_ik(*uParam0, true);
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
	Var0.f_10 = 1;
...
int func_341(int iParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*iParam0))
	{
		...
		fVar8 = func_554(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*iParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_559(iParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
			...
			case 3:
				...
				if (is_bit_set(iParam1->f_21, 20))
				{
					...
					else if ((((!is_ped_on_mount(Global_35) && func_254(iParam1->f_28, 0)) && func_348(Global_35, iParam1->f_28, iParam1->f_29, 1)) && !func_460(iParam1->f_28, 518218985)) && !func_460(iParam1->f_28, 242628503))
					{
					...
					else if (!(is_bit_set(*iParam1, 12) || func_571(iParam1, iParam0)))
					{
					}
					else if (!(is_bit_set(*iParam1, 13) || func_572(iParam1)))
					{
					}
...
void func_345(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, char* sParam5)
{
	...
	fVar0 = func_554(fParam4 >= 0f, fParam4, vdist(Global_36, get_entity_coords(*iParam0, true, false)));
...
int func_350(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_585((*Global_1835011)[4]->f_1, 1))
		{
			if (func_586(5))
			{
				func_587(5);
	...
	if ((bVar0 && func_585((*Global_1835011)[37]->f_1, 1)) && !func_585((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_585((*Global_1835011)[43]->f_1, 1)) && !func_585((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
	...
	if (!func_611(uParam0->f_2, 1))
	{
		if (func_494(uParam0))
		{
			if (_is_anim_scene_metadata_loaded(uParam0->f_1, false))
			{
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_615())
				{
...
void func_393(struct<4> Param0)
{
	...
	if (func_622(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_622(20))
			{
				return;
			}
			iVar0++;
...
void func_420()
{
	...
	if (func_433(iVar0))
	{
		...
		{
			func_632(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
struct<5> func_448(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_638(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_641(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_641(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_642(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_451(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_652(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_652(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_654(iParam0, iParam2, iParam1, func_252() != -1);
	if (bParam4)
	{
...
void func_467(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_666(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_486(int iParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
	...
	if (!does_entity_exist(&(uLocal_109[iParam1])))
	{
		*iParam3 = 0;
	}
	else
	{
		_set_entity_coords_and_heading(&(uLocal_109[iParam1]), vParam4, fParam7, true, false, true);
	}
}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_261(iParam0, 16, 1))
			{
				...
				else if (func_254(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_254(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_154(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_680(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_682(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_254(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_684(Global_1360165[iParam0], 1);
				}
			}
			func_678(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_685(Global_1360165[iParam0]))
				{
				}
			}
			func_686(iParam0, Global_1360165[iParam0]);
...
void func_509(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_165() || !_0x6f1f0b17109309da(Global_43800, func_209(iParam0))))
	{
...
char* func_512(int iParam0)
{
	...
	{
		return func_692(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_693(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_531(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_697(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_532(int iParam0, int iParam1, bool bParam2)
{
	...
	func_698(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_539(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_253(iParam0);
	if (((does_entity_exist(iVar1) && func_701(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
int func_545(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_705(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_547(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_706(iParam0);
	}
...
bool func_556(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_463(iParam4, 268435456))
			{
				iVar8 = func_714(uParam2, 648122183);
				if (iVar8 > -1)
				{
					func_715(iParam1, (*uParam2)[iVar8]);
				}
			}
...
int func_562(int* iParam0, var uParam1)
{
	...
	iVar0 = 0;
	if (((((is_control_pressed(0, 1287709438) || is_control_pressed(0, 1499911466)) || is_control_pressed(0, -209515122)) || func_718()) || func_719()) || func_720())
	{
		iVar0 = 1;
	}
	if (iVar0 == 1)
...
bool func_563(int iParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_723(Global_35)) || func_724(Global_35)) || func_725(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_726(*iParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_727(*iParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_728(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_711(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_288((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_399(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
void func_568(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_726(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
bool func_571(int* iParam0, int iParam1)
{
	...
	if (!_is_ped_carrying(Global_35) && !func_460(Global_35, -208384378))
	{
	...
	else if (_is_ped_carrying(Global_35) && !func_460(Global_35, -208384378))
	{
...
void func_581(var uParam0, int iParam1, var uParam2, float fParam3)
{
	...
	fVar0 = func_554(fParam3 >= 0f, fParam3, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
	if (fVar0 <= iParam1->f_26 || is_bit_set(iParam1->f_21, 20))
	{
		...
		if ((is_ped_in_any_vehicle(Global_35, false) && is_bit_set(*iParam1, 16)) || (is_ped_on_mount(Global_35) && is_bit_set(*iParam1, 15)))
		{
			...
			func_338(Global_35, get_entity_coords(*uParam0, true, false), bVar2, iParam1->f_30, iParam1->f_31, iParam1->f_32, func_554(bVar3, iParam1->f_33, iParam1->f_34), 0, 1, 0, iVar1);
		}
		else if (((((is_bit_set(*iParam1, 15) && !is_ped_on_mount(Global_35)) && func_254(iParam1->f_28, 0)) && func_348(Global_35, iParam1->f_28, (iParam1->f_26 + 1.75f), 1)) && !func_460(iParam1->f_28, 518218985)) && !func_460(iParam1->f_28, 242628503))
		{
...
void func_583(int* iParam0, var uParam1, int iParam2, bool bParam3, char* sParam4, float fParam5)
{
	...
	fVar0 = func_554(fParam5 >= 0f, fParam5, vdist(Global_36, get_entity_coords(*iParam2, true, false)));
...
{
	return func_457(1328661203, func_790(), -1591664384, bParam0);
}
...
int func_648(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_647(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = 12;
	iVar2 = func_416(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_416(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_797(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_416(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_647(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_797(&(Global_1946804->f_1497.f_1[iVar1])) || func_647(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_416(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_416(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_416(&(uParam0->f_1[iVar1])) || func_647(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_656(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_803(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_252() == -1)
	{
...
int func_672(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_329(iParam1);
	if ((!does_entity_exist(iVar0) || !func_254(iVar0, 0)) || (bParam3 && !func_331(iParam1)))
	{
		if (bParam2)
		{
	...
	if (does_entity_exist(iVar0) && func_254(iVar0, 0))
	{
		*uParam0 = 2;
...
void func_675(int iParam0)
{
	...
	set_blocking_of_non_temporary_events(&(uLocal_109[iParam0]), true);
	clear_ped_tasks(&(uLocal_109[iParam0]), 1, 0);
}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_475((*Global_1360165)[iParam0]->f_4.f_2) || func_336((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_824((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_826(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_332(iParam0, 44, 1);
			}
...
void func_686(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_632(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_632(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
{
	return func_847(get_entity_coords(iParam0, true, false), get_entity_coords(iParam1, true, false), fParam2);
}
...
void func_703(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_851(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_853(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_857((*Global_1900383)[iParam0]->f_26);
		func_858((*Global_1900383)[iParam0]->f_26);
...
bool func_707(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_859((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
void func_711(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_399(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_307(iParam0, 0);
		}
...
int func_737()
{
	...
	func_877(&(Global_1946804->f_57[func_450(iVar1, 1)]), 8);
	func_453(26, 0, 0, 0, 0);
	return 1;
}
...
void func_739(var uParam0, int iParam1)
{
	...
	if (_does_volume_exist(iParam1->f_36) || !func_254(*uParam0, 0))
	{
		return;
	}
...
int func_740(int iParam0)
{
	...
	{
		if (func_433(func_432(Global_35, 0, 1, 0)) && func_432(Global_35, 0, 1, 0) == -1016714371)
		{
	...
	{
		if (((func_433(func_432(Global_35, 0, 1, 0)) && func_432(Global_35, 0, 1, 0) == -1016714371) && !func_460(Global_35, 716706914)) && !func_460(Global_35, 242628503))
		{
			_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
			task_swap_weapon(Global_35, 0, 0, 0, 0);
			_0x2208438012482a1a(Global_35, false, false);
...
void func_744(int* iParam0, var uParam1, int iParam2, char* sParam3)
{
	...
	if (!is_string_null_or_empty(sParam3))
	{
		...
		while (iVar1 < *uParam1)
		{
			if (!func_288((*uParam1)[iVar1]->f_6) || func_881((*uParam1)[iVar1]->f_6) == 0)
			{
			}
			else
			{
				_uiprompt_set_group(func_881((*uParam1)[iVar1]->f_6), iVar0, 0);
			}
			iVar1++;
		}
	}
...
int func_765(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_584())
	{
		...
		{
			bVar0 = false;
			if (!func_585((*Global_1835011)[15]->f_1, 1) && !func_791(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_585((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_900();
				*iParam1 = func_901();
				*uParam2 = func_902();
...
bool func_773(int iParam0, var uParam1)
{
	...
	*uParam1 = func_913(Var0, 1415981582, 0);
...
bool func_774(int iParam0, var uParam1)
{
	...
	*uParam1 = func_913(Var0, -2119169513, 0);
	if (!func_415(*uParam1, 0))
	{
		return false;
	}
		...
		while (iVar28 < 4)
		{
			...
			if (func_641(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_919(0))
				{
					...
					func_920(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_789(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_923("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_922(iParam1, 512) && func_792(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_925(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_922(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_922(iParam1, 4))) && (!func_925(Var4.f_4) || func_922(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_922(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_922(iParam1, 1048576)))
				{
...
void func_793(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_929(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_929(uParam0->f_2[iVar0], 1))
				{
					func_930(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_803(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_252() == -1)
	{
		func_934(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_935(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_809()
{
	...
	func_946(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_810()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_946(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_811()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_946(1, round((to_float(iVar8) * fVar10)), 0);
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_545(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_955(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_953();
				}
			}
			if ((bParam2 && !func_90(vVar0)) && !func_609(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_154((*Global_1360165)[iParam0]->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_956((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_545(iParam0, 1), get_hash_key(sVar12));
			}
...
int func_823(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_585((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_585((*Global_1347702)[63]->f_15, 1) || func_336((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_585((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_585((*Global_1347702)[134]->f_15, 1) || func_336((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_585((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_959(747937920, 1) && !func_585((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_834(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_830(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_830(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_830(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_830(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_830(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_830(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_830(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_830(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_830(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_830(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_830(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_830(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_830(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_830(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_830(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_830(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_830(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_830(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_830(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_830(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_830(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_830(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_830(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_830(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_830(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_830(iParam1, 1544915253))
	{
...
void func_877(int iParam0, int iParam1)
{
	...
	if (((iVar0 == 1108822547 && func_437(32768)) || &Global_1946804->f_1497.f_1[iVar1] != &Global_1946804->f_57[iVar1]) && iParam0 != &Global_1946804->f_1497.f_1[iVar1])
	{
		if (func_980(&(Global_1946804->f_1497.f_1[iVar1])) && func_981(&(Global_1946804->f_1497.f_1[iVar1])))
		{
			iParam1 |= 32;
		}
		if (Global_1946804->f_57[iVar1]->f_1 > 1)
...
bool func_885(int iParam0, int iParam1)
{
	...
	Var29 = { func_457(iParam1, Var0, 1415981582, 0) };
...
bool func_886(int iParam0, int iParam1)
{
	...
	Var29 = { func_457(iParam1, Var0, -2119169513, 0) };
	return func_983(Var29, 1);
}
...
bool func_890(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_459(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_892(int iParam0)
{
	...
	if (func_990(get_entity_model(iParam0)))
	{
		return true;
	}
...
void func_936(var uParam0, int iParam1)
{
	if (func_252() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_934(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_935(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
bool func_954(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_545(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_1001(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_955(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_1003(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_956(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_253(iParam1)))
	{
		_0x931b241409216c1f(func_253(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_253(iParam1), iParam0);
...
int func_970(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_402(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_625(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
{
	(Global_1946804->f_2377[func_450(iParam0, 1)])->f_1 = ((Global_1946804->f_2377[func_450(iParam0, 1)])->f_1 || iParam1);
}
...
bool func_983(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_459(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_986(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_459(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_993(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_459(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
int func_1013()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_925(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_925(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_1015(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		Var61.f_10 = iParam4;
		iVar0 = func_1018(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return _0x033ee4b89f3ac545(func_459(bParam2), uParam0, iParam1);
}
...
struct<28> func_1026(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_459(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
...
struct<17> func_1028(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_459(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
