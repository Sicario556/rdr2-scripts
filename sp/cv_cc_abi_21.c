...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.0125f, 0.5375f, 1.4875f, 0f, 2.1875f, 2.18f, 2.7575f, -1612834106, -2055224817, 1, 1, 1);
	func_153(uParam0, "script@vignette@abigail_21@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@abigail_21@action_a", 0, 0, 1, 0);
	func_154(uParam0, "CAB21AU");
	func_155(uParam0, 507701558, 1912320754);
	func_156(uParam0, iLocal_17, -1, 0.9f);
	func_157(uParam0, iLocal_14, 2, 2090309183, "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 1, 45f, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_14, 1, 24, 0, 0, 0);
	func_160(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1);
	func_157(uParam0, iLocal_15, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1, 35f, 1065353216, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	iLocal_16 = func_161(uParam0, -2.6625f, -3f, 2.6125f, 0f, 0f, 0f, 17.2325f, 16.44f, 3.575f, "Trigger", -1612834106);
	func_162(uParam0, 1);
	return true;
}
...
{
	return func_193(Global_35, iLocal_16, 0, 1);
}
...
bool func_92(var uParam0)
{
	...
	iVar0 = func_196(func_20(uParam0));
	func_197(iVar0);
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_244(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_282() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_359(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_361(&uVar2, func_360(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_362(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_330(int iParam0, bool bParam1)
{
	...
	{
		func_234(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_222() == -1)
		{
...
int func_384(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_419(iParam0, func_282());
...
void func_386(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_420(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_421(iParam0);
