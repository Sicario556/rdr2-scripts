...
bool func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		...
		{
			iLocal_42 = create_scenario_point_attached_to_entity(uParam0->f_1711[iLocal_19]->f_10, 935336933, 0f, 0f, 0.5f, 160f, 0, 0, 0);
			clear_ped_tasks_immediately(func_48(uParam0, iLocal_14), false, true);
			_task_use_scenario_point(func_48(uParam0, iLocal_14), iLocal_42, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", 0, false, true, 0, false, -1f, false);
...
{
	if (!_0x9c54041bb66bcf9e(func_48(uParam0, iLocal_14), iLocal_42))
	{
		return true;
	}
	return false;
...
bool func_202(var uParam0, int iParam1)
{
	...
	{
		if (!func_310(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_281(var uParam0, int iParam1)
{
	...
	else if (!func_310(uParam0->f_107[iParam1]->f_5, -76381094))
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(747937920, 1) && !func_402((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
