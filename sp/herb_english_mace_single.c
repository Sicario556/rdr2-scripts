...
int func_6(int iParam0, vector3 vParam1)
{
	...
	func_48(Global_27573[iVar0], iParam0, vParam1, -15);
	Global_40.f_9273++;
	return iVar0;
}
...
{
	bVar0 = false;
	if (((_get_global_block_can_be_accessed(4) && func_54()) && func_55(player_id(), 1, 0)) && func_56(0) == 1177534031)
	{
		bVar0 = true;
	}
...
void func_13(var uParam0)
{
	...
	if (func_61(&(uParam0->f_25)) >= 1f)
	{
		...
		while (iVar0 < 10)
		{
			if (func_63(&(Global_36581[iVar0]), *uParam0))
			{
				func_64(uParam0, Global_36581[iVar0]->f_1);
			}
			iVar0++;
		}
...
bool func_22(var uParam0)
{
	if (iLocal_15 < 4)
	{
		if (!func_43(*vLocal_23[iLocal_15]))
		{
			if (!&Global_1913812)
			{
				iVar1 = 0;
				...
				{
					iVar1 |= 2;
					*vLocal_23[iLocal_15] = { *vLocal_23[iLocal_15] + func_80(0f, 0.737008f, 1.81999f, uParam0->f_3) };
				}
				if (uParam0->f_18 == 37)
				{
					iVar1 |= 2;
					*vLocal_23[iLocal_15] = { *vLocal_23[iLocal_15] + func_80(0f, 0.5f, 1.81999f, uParam0->f_3) };
				}
				if (func_78(uParam0->f_24, iLocal_15))
				{
					iVar1 |= 1;
				}
				uParam0->f_13[iLocal_15] = _0x5b4bbe80ad5972dc(uParam0->f_38, *vLocal_23[iLocal_15], func_81((uParam0->f_3 + (IntToFloat(iLocal_15) * get_random_float_in_range(0f, 90f)))), iVar1, &uVar0, &(iLocal_36[iLocal_15]));
				...
				if (uParam0->f_18 == 38)
				{
					func_83(uParam0->f_33[iLocal_15], *vLocal_23[iLocal_15], 0.15f);
				}
				iLocal_15++;
				Global_1913812 = 1;
			}
...
bool func_25(int iParam0)
{
	...
	{
		return func_84((*Global_1835011)[iParam0]->f_1, 1);
	}
...
void func_29(int iParam0)
{
	...
	if (func_3() != -1)
	{
		Global_38105[iParam0]->f_2 = func_88();
		return;
	}
	Global_27573[iParam0]->f_2 = func_88();
}
...
void func_34(struct<25> Param0, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41)
{
	...
	if (iVar1 != -1)
	{
		...
		{
			if (func_89(iVar0, Global_35, 0, 1, func_23(get_player_index())))
			{
				if (func_90() && is_ped_on_foot(Global_35))
				{
...
Vector3 func_46(int iParam0)
{
	...
	if (func_3() != -1)
	{
		return func_98(Global_38105[iParam0]->f_1);
	}
	return func_98(Global_27573[iParam0]->f_1);
}
...
bool func_55(int iParam0, int iParam1, bool bParam2)
{
	if (network_is_player_active(iParam0) && iParam1 != -1)
	{
		...
		while (iVar1 <= 5)
		{
			if (Global_1146442->f_1[iVar1]->f_1 == iParam1 && func_102(iVar1, 128, iVar0))
			{
				if (bParam2)
				{
...
bool func_71(int iParam0, float fParam1)
{
	...
	if (!func_65(iVar0) && func_111(_0x126cbebba46693cf(floor(fParam1), 1777389635, 0)))
	{
		return true;
	}
	return false;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	...
	if (func_3() != -1)
	{
		func_121(Global_38105[iParam0], iParam1, iParam2, iParam3, uParam4);
		return;
	}
	func_122(Global_27573[iParam0], iParam1, iParam2, iParam3, uParam4);
}
...
bool func_89(int iParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4)
{
	...
	if (func_24(iParam0, vParam4, &iVar0, &iVar1, 0))
	{
		if ((does_entity_exist(iParam1) && !is_entity_dead(iParam1)) && iParam1 == Global_35)
		{
			...
			if (func_3() == -1)
			{
				if (func_84((*Global_1835011)[4]->f_1, 1))
				{
			...
			func_136(func_135(-1256705067, iVar2), iParam3);
...
void func_92(int iParam0, bool bParam1)
{
	...
	if (func_146(iParam0) == 2085633299)
	{
		...
		while (iVar29 < Var0)
		{
			...
			{
				fVar36 = func_157(to_float(Var22.f_3), Var22.f_4);
				func_158(19, fVar36);
				bVar41 = true;
			}
...
void func_93(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	sVar15 = func_168(_create_var_string(10, &cVar2, _create_var_string(0, func_167(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_145(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
		sVar15 = _create_var_string(0, func_167(iParam0));
	}
	func_169(sVar15, Var7.f_1, get_hash_key(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
int func_95(var uParam0, var uParam1, bool bParam2, var uParam3)
{
	if (*uParam0 < 5)
	{
		if (((func_170() || (_0x3ab6c7b0bb0df4b1(Global_35, -1) && !_0x3ab6c7b0bb0df4b1(Global_35, *uParam1))) || !func_90()) || !is_ped_on_foot(Global_35))
		{
...
{
	return func_174((*Global_1146517)[iParam2][iParam0], iParam1);
}
...
bool func_109(int iParam0)
{
	...
	return func_84((*Global_1347702)[iParam0]->f_15, 1);
}
...
int func_110()
{
	...
	while (iVar1 < 5)
	{
		if (func_177(_0x126cbebba46693cf(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	return (shift_right(iParam0, 26) & 31 * func_178(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
{
	return func_199(to_float(iParam0), fParam1);
}
...
bool func_200(int iParam0)
{
	...
	return func_84((*Global_1347702)[58]->f_15, 1);
}
...
void func_208(int iParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = func_235(ceil(&(Global_40.f_11095[iParam0])));
	_set_attribute_core_value(Global_35, func_236(iParam0), iVar0);
	func_238(func_237(iParam0), (100f * (to_float(iVar0) / 100f)), 0);
	if (((fParam1 <= func_239(15) && iParam0 == 1) && is_ped_on_foot(Global_35)) && !is_ped_swimming(Global_35))
	{
		func_26(84, 1);
	}
	if (fParam1 <= -99.999f)
...
void func_211(int iParam0)
{
	...
	iVar1 = func_242(2);
	func_243(to_float((iParam0 * iVar1)), 0);
}
...
void func_213(int iParam0)
{
	...
	iVar1 = func_246(2);
	func_247(to_float((iParam0 * iVar1)));
}
...
void func_214(int iParam0)
{
	...
	iVar1 = func_248(2);
	func_249(to_float((iParam0 * iVar1)), 0);
}
...
void func_220(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_235(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
int func_229(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	{
		_set_attribute_core_value(iVar0, func_236(iParam0), ceil(fParam1));
		return 1;
	}
	else
	{
...
void func_256(int iParam0, int iParam1, float fParam2)
{
	...
	{
		_0x437c08db4febe2bd(iParam0, func_264(iParam1), fParam2, -1);
	}
}
...
float func_259()
{
	...
	func_273(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_260()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_273(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_261()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_273(1, round((to_float(iVar8) * fVar10)), 0);
