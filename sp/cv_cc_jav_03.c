...
bool func_72(var uParam0)
{
	...
	iLocal_20 = func_153(uParam0, 1230724566, 1.42059f, -0.462698f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, -1103796964, "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0);
	func_157(uParam0, iLocal_14, 3, -1103796964, "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0, -1073741824, 1065353216, 1);
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_301(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_204(var uParam0, int iParam1, float fParam2)
{
	if (!func_293(iParam1))
	{
		return false;
...
void func_211(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_204(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
