void __EntryFunction__()
{
	...
	while (!func_5(&Local_27, 1))
	{
		...
		if (((((func_6(&Local_27) >= 5 && func_6(&Local_27) <= 7) && !func_5(&Local_27, 4096)) && _does_anim_scene_exist(Local_27.f_428.f_444)) && _is_anim_scene_started(Local_27.f_428.f_444, false)) && !_is_anim_scene_paused(Local_27.f_428.f_444))
		{
		...
		switch (func_6(&Local_27))
		{
			...
			case 3:
				...
				func_39(&Local_27);
				if (func_40(func_32((*Global_1835011)[Local_27]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_27.f_428)) == 4 && _does_anim_scene_exist(Local_27.f_428.f_444)) && _is_anim_scene_paused(Local_27.f_428.f_444))
				{
					func_37(Local_27);
					func_17(&Local_27, 7);
				}
...
{
	if (func_5(iParam0, 128) && Global_43838 == 1)
	{
		func_66(iParam0, 128);
	}
}
...
{
	if (!is_ped_injured(&(iLocal_14[3])))
	{
		set_entity_collision(&(iLocal_14[3]), true, false);
		set_entity_visible(&(iLocal_14[3]), true);
		freeze_entity_position(&(iLocal_14[3]), false);
	}
	return 0;
}
...
{
	request_model(1276534479, false);
	if (!_does_volume_exist(iLocal_26))
	{
		func_257(&iLocal_26, 1315.793f, -6864.183f, 50.7832f, 0f, 0f, 146.9f, 133.2f, 155f, 35f, "intro_guarma3_volume");
	}
...
{
	func_262(uParam0, iParam1, sParam2, iParam3, iParam4, bParam5, 0);
}
...
{
	func_272(1303.037f, -6825.166f, 42.27585f, 10f, 1, 0, 0, 0, 0);
	iVar0 = 0;
	while (iVar0 <= (iLocal_14 - 1))
	{
		if (!is_ped_injured(&(iLocal_14[iVar0])))
		{
			switch (iVar0)
			{
				case 0:
				...
				case 3:
					...
					set_entity_collision(&(iLocal_14[iVar0]), false, false);
					freeze_entity_position(&(iLocal_14[iVar0]), true);
					break;
			}
			clear_ped_tasks_immediately(&(iLocal_14[iVar0]), true, true);
			set_entity_coords(&(iLocal_14[iVar0]), vVar1, true, false, true, true);
			set_entity_heading(&(iLocal_14[iVar0]), fVar4);
			func_273(&(iLocal_14[iVar0]), 0, 1, 0);
			func_274(&(iLocal_14[iVar0]));
			func_131(uParam0, &(iLocal_14[iVar0]), 0, 0, 0, 1);
			_0x2208438012482a1a(&(iLocal_14[iVar0]), false, false);
		}
		iVar0++;
	}
}
...
bool func_140()
{
	return func_276(get_id_of_this_thread());
}
...
void func_142(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_281(uParam1->f_1016[uParam1->f_1684], 256))
		{
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_283(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_284(uParam0->f_1522[iVar0], 128))
				{
					func_285(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
{
	return func_286(&(iParam0->f_958));
}

void func_153(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (!func_114(iParam0))
	{
		return;
	...
	if (bParam10)
	{
		func_287(iParam0, 56, 1);
		func_19(&(Global_1359489->f_40), 1);
	}
	func_288(iParam0, 0);
	func_289(iParam0, 4, 0);
	func_290(iParam0);
	func_291(iParam0);
	func_292(iParam0, 37, 1);
	bVar0 = func_242(Global_1360165[iParam0], 0);
	iVar1 = func_293(iParam0, 0);
	bVar2 = _0x800df3fc913355f3(iVar1);
	if (get_ped_config_flag(Global_1360165[iParam0], 503, true) && Global_1359489->f_16 & 8388608 == 0)
	{
		set_ped_config_flag(Global_1360165[iParam0], 503, false);
	}
	if (func_294(iParam0, 64, 1))
	{
		func_292(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_292(iParam0, 33, 1);
		func_292(iParam0, 34, 1);
		func_295(iParam0, 1056964608, -1, 1061158912);
		func_296(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_287(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_287(iParam0, 35, 1);
			if (bParam8)
			{
				func_287(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		func_287(iParam0, 33, 1);
		func_296(iParam0, 0, 1, 0);
		if (fParam4 > 0f)
		{
	...
	if (bParam1 || bParam2)
	{
		...
		{
			func_298(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	if (func_294(iParam0, 45, 1))
	{
		func_292(iParam0, 45, 1);
	}
	func_299(iParam0, 16, 1);
	func_292(iParam0, 44, 1);
	(*Global_1360165)[iParam0]->f_129 = 0;
	Global_40.f_4942[iParam0]->f_4 = 0;
	if (bParam5)
	{
		if (func_242(func_300(iParam0), 0))
		{
			func_301(0, iParam0, bParam3, 0, bParam2);
		}
	}
}
...
void func_156(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_305((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_305((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_153(iParam1, bParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_307((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_309((*uParam1)[iVar0]))
		{
			if (func_307((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_310((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_311((*uParam2)[iVar0]))
		{
			if (func_307((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_312((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_313((*uParam3)[iVar0]))
		{
			if (func_307((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_314((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_316((*uParam5)[iVar0]))
		{
			if (func_307((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_317((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_316((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_318((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_307((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_319((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_320((*uParam6)[iVar0]))
		{
			if (func_307((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_321((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_322((*uParam7)[iVar0]))
		{
			if (func_307((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_323((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_324((*uParam8)[iVar0]))
		{
			if (func_307((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_325((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_326((*uParam9)[iVar0]))
		{
			if (func_307((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_327((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_328((*uParam10)[iVar0]))
		{
			if (func_307((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_329((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_330((*uParam11)[iVar0]))
		{
			if (func_307((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_331((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_169(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_339(iParam1, 0, 0, 0);
}
...
void func_171(int iParam0, int iParam1)
{
	...
	func_340(iParam1);
	StringCopy(&cVar0, func_167(), 64);
	func_341(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_177(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_342(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_187(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_346(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_200(bool bParam0, bool bParam1)
{
	if (!func_349(Global_43801))
	{
		Global_43801 = func_354("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_355(Global_43801, 0, 1);
		func_356(Global_43801, 6, 1);
		if (bParam1)
		{
			func_356(Global_43801, 14, 1);
		}
	}
	else
	{
		if (!func_199(Global_43801, 0))
		{
			func_357(Global_43801, 1, 1);
		}
		if (func_358(Global_43801, 1) != 0f && bParam0)
		{
		...
		return func_359(Global_43801, 1);
	}
	return false;
}
...
void func_211(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_362(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_345() };
...
void func_212(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_228(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_363(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_215()
{
	return func_352(_0xc17f69e1418cd11f(3));
}
...
void func_220(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_380() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_222(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_381(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_383(iVar1, func_381(uParam0), func_382(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_383(iVar3, func_381(uParam0), func_382(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_381(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_381(uParam0) };
			func_383(iVar0, vVar1, func_384(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_228(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_387(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_387(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_391(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_389(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_232(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_399(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_405(1, (func_240() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_403(iParam3, 1)])
			{
				func_406(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_390(32768) && iParam1 != &Global_1946804->f_57[func_403(iParam3, 1)])
			{
				func_407();
...
void func_238(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_412(0), &Var5, iParam1);
}
...
bool func_239(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_413(*uParam1, 2))
	{
		...
		else if ((func_417(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_417(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_417(iParam2, 1024))) || func_417(iParam2, 8)) && !func_413(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_418(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_417(iParam2, 4096)) && !func_413(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_418(uParam1, 2048);
			func_418(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_417(iParam2, 32)) && !func_413(*uParam1, 5632))
		{
...
int func_252(var uParam0, int iParam1)
{
	...
	if (func_140())
	{
		...
		if (func_424(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_425(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_280(uParam0, 8) && _0xdd0b7c5ae58f721d(func_426()))
	{
		_0x798be43c9393632b(func_426());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_426())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_255(int iParam0)
{
	...
	return func_430((*Global_1835011)[iParam0]->f_1);
}
...
void func_257(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
...
int func_259(var uParam0)
{
	...
	{
		if (has_model_loaded(1276534479))
		{
			vVar0 = { 1303.943f, -6825.485f, 42.35506f };
			fVar3 = 13.6963f;
			func_272(vVar0, 5f, 1, 0, 0, 0, 0);
			iLocal_19 = func_431(1276534479, vVar0, fVar3, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			func_273(iLocal_19, 0, 1, 0);
			func_274(iLocal_19);
			func_131(uParam0, iLocal_19, 0, 0, 0, 1);
			func_432(uParam0, iLocal_19, 0);
			_0x2208438012482a1a(iLocal_19, false, false);
			return 1;
		}
	}
	else
...
{
	request_model(1561132816, false);
	request_model(-587928515, false);
	request_model(-1988548788, false);
	func_433(uParam0);
	if (has_model_loaded(-1988548788))
	{
		if (!does_entity_exist(iLocal_25))
		{
			func_272(1343.45f, -6801.3f, 59.9501f, 5f, 1, 0, 0, 0, 0);
			iLocal_25 = create_vehicle(-1988548788, 1343.45f, -6801.3f, 59.9501f, 153.32f, true, true, false, false);
			freeze_entity_position(iLocal_25, true);
			set_vehicle_is_considered_by_player(iLocal_25, false);
			set_entity_coords_no_offset(iLocal_25, 1343.45f, -6801.3f, 59.9501f, false, true, true);
			set_entity_rotation(iLocal_25, 0f, 0f, 153.32f, 2, true);
			func_432(uParam0, iLocal_25, 0);
		}
	}
	if (has_model_loaded(-587928515))
	{
		if (!does_entity_exist(iLocal_24))
		{
			func_272(1303.68f, -6816.97f, 42.2179f, 5f, 1, 0, 0, 0, 0);
			iLocal_24 = create_object(-587928515, 1303.68f, -6816.97f, 42.2179f, true, true, false, false, true);
			set_entity_rotation(iLocal_24, 0.898489f, -8.46271f, -25.8924f, 2, true);
			freeze_entity_position(iLocal_24, true);
			func_262(uParam0, iLocal_24, "s_boat_gua3_ramp", 0, 0, 1, 0);
			func_432(uParam0, iLocal_24, 0);
		}
	}
	if (has_model_loaded(1561132816))
	{
		if (!does_entity_exist(&(iLocal_21[0])))
		{
			iLocal_21[0] = create_object(1561132816, 1303.188f, -6825.43f, 42.18f, true, true, false, false, true);
			set_entity_rotation(&(iLocal_21[0]), 0f, 0f, 0f, 2, true);
			freeze_entity_position(&(iLocal_21[0]), true);
			func_262(uParam0, &(iLocal_21[0]), "p_crate03x", 0, 0, 1, 0);
			decor_set_int(&(iLocal_21[0]), func_434(), -645141044);
			func_432(uParam0, &(iLocal_21[0]), 0);
		}
		if (!does_entity_exist(&(iLocal_21[1])))
		{
			iLocal_21[1] = create_object(1561132816, 1302.2f, -6824.95f, 41.99f, true, true, false, false, true);
			set_entity_rotation(&(iLocal_21[1]), 0f, 0f, 0f, 2, true);
			freeze_entity_position(&(iLocal_21[1]), true);
			func_262(uParam0, &(iLocal_21[1]), "p_crate03x^1", 0, 0, 1, 0);
			decor_set_int(&(iLocal_21[1]), func_434(), -1018314416);
			func_432(uParam0, &(iLocal_21[1]), 0);
		}
	}
	if ((((func_433(uParam0) && does_entity_exist(iLocal_25)) && does_entity_exist(iLocal_24)) && does_entity_exist(&(iLocal_21[0]))) && does_entity_exist(&(iLocal_21[1])))
	{
		return 1;
	}
	return 0;
...
int func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_306((*uParam0)[iVar1]))
		{
			if (func_307((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_309((*uParam1)[iVar1]))
		{
			if (func_307((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_311((*uParam2)[iVar1]))
		{
			if (func_307((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_441((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		if (func_313((*uParam3)[iVar1]))
		{
			if (func_307((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_316((*uParam5)[iVar1]))
		{
			if (func_307((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_307((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_442((*uParam5)[iVar1]))
				{
					if (func_443((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_318((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_444((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_320((*uParam6)[iVar1]))
		{
			if (func_307((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_445((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_322((*uParam7)[iVar1]))
		{
			if (func_307((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_446((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_324((*uParam8)[iVar1]))
		{
			if (func_307((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_447((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_326((*uParam9)[iVar1]))
		{
			if (func_307((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_448((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_328((*uParam10)[iVar1]))
		{
			if (func_307((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_449((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_330((*uParam11)[iVar1]))
		{
			if (func_307((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_450((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
int func_269(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_294(iParam1, 28, 1))
	{
		func_287(iParam1, 28, 1);
	}
	*uParam2 = func_454(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_273(*uParam2, bParam3, bParam4, 0);
		if (bParam4)
		{
...
void func_272(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	iVar0 = 3490746;
	if (bParam4)
	{
...
void func_273(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (is_entity_dead(iParam0))
	{
		return;
	...
	if (bParam2 && (!func_151() || !_0x6f1f0b17109309da(Global_43800, func_197(iParam0))))
	{
...
Vector3 func_277(var uParam0, int iParam1)
{
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			vVar10 = { func_459(vVar10) * Vector(2f, 2f, 2f) };
...
struct<8> func_283(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_462(iParam1), 64);
		if (!is_string_null_or_empty(&cVar0))
		{
			iVar8 = func_463(uParam0, iParam1);
			if (iVar8 > 0)
			{
...
void func_288(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_465(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_289(iParam0, 1, 0);
		}
	}
	func_289(iParam0, 16, bParam1);
}
...
void func_289(int iParam0, int iParam1, bool bParam2)
{
	...
	func_466(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}

void func_290(int iParam0)
{
	func_289(iParam0, 8, 0);
}

void func_291(int iParam0)
{
	func_287(iParam0, 36, 1);
}
...
void func_296(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_292(iParam0, 50, 1);
		func_292(iParam0, 48, 1);
		func_292(iParam0, 49, 1);
		func_292(iParam0, 51, 1);
		func_292(iParam0, 52, 1);
		func_292(iParam0, 54, 1);
		func_292(iParam0, 55, 1);
	}
	else
	{
		func_287(iParam0, 50, 1);
		func_287(iParam0, 48, 1);
		func_287(iParam0, 49, 1);
		func_287(iParam0, 51, 1);
		if (bParam3)
		{
			func_287(iParam0, 54, 1);
		}
		else
		{
			func_292(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_287(iParam0, 52, 1);
			if (bParam3)
			{
				func_287(iParam0, 55, 1);
			}
		}
		else
		{
...
void func_298(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_114(iParam0))
	{
		return;
	...
	iVar0 = func_293(iParam0, 0);
	if (!_is_base_a_persistent_character(iVar0))
	{
		return;
	}
	iVar1 = func_241(iParam0);
	if (((does_entity_exist(iVar1) && func_469(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_301(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (!func_421(iParam1))
	{
		return;
	...
	func_292(iParam1, 39, 1);
	func_473(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_473(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_473(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_287(iParam1, 43, 1);
		}
		if (bParam4)
		{
			func_474(iParam1, 0, 1, 1, 1);
		}
	}
}
...
{
	func_476(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_317(var uParam0)
{
	if (!func_478(uParam0->f_2, 1))
	{
		if (func_442(uParam0))
		{
			...
			{
				sVar0 = func_351(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_482())
				{
...
var func_339(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
void func_340(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_485(iVar0, 4096, 0);
			func_485(iVar0, 131072, 0);
			func_486(iVar0, 1);
		}
		iVar0++;
	}
...
int func_341(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_487(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
void func_371(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_386(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_372()
{
	...
	if (func_386(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_386(iVar0))
	{
		...
		{
			func_505(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_383(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_413(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_413(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_413(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_413(iParam5, 32), true);
	...
	else if (func_413(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_413(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_413(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
{
	return ((Global_1946804->f_57[func_403(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_393(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_391(1108822547, 6))
	{
		if (bParam2)
		{
			func_389(iParam0, iVar0, func_240() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_403(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_403(iParam0, 1)])->f_10 || iParam1);
}

void func_396(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_403(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_403(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_403(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_401(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_514(iParam0))
	{
		case -1037537535:
			...
			{
				Var0 = { func_410(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_517(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_517(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_518(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_520(iParam0, -1823706425))
			{
				Var0 = { func_410(-1838434463, Var0, 1084182731, bParam1) };
				Var0.f_4 = _0x6452b1d357d81742(iParam0, -1838434463);
			}
			else if (func_520(iParam0, -1483207246))
			{
				Var0 = { func_410(889965687, Var0, 1034665895, bParam1) };
				Var0.f_4 = _0x6452b1d357d81742(iParam0, 889965687);
			}
		...
		default:
			...
			else if (_inventory_fits_slot_id(iParam0, -833319691))
			{
				...
				if (!func_521(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
bool func_404(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_523(iParam0, 866047851) && func_524(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_390(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	func_526(iParam2);
	func_527(iParam2, iVar5);
	if (&Global_1946804->f_1378.f_1[iParam2] != &Global_1946804->f_57[iParam2] && Global_1946804->f_57[iParam2]->f_1 > 1)
	{
		func_528(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_528(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_529(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_530(iParam0, iParam2, iParam1, func_240() != -1);
	if (bParam4)
	{
		func_531(&(Global_1946804->f_1378), 1, 3);
	}
	else
	{
		func_531(&(Global_1946804->f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_396(func_394(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_532(&(Global_1946804->f_2589), bParam0, bParam1, bParam2);
}
...
void func_407()
{
	func_534(&(Global_1946804->f_2776));
	func_535(32768);
...
struct<4> func_410(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_412(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_411(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_412(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_416(int iParam0, vector3 vParam1)
{
	...
	return func_536(vVar0, vVar3, vParam1);
}
...
void func_422(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_539(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_540(1, bVar1, 1, uVar2);
		func_541(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_542(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
int func_431(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_547(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_432(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_548(), true);
	}
}

bool func_433(int iParam0)
{
	request_model(1115303244, false);
	_request_propset(-1938677009);
	if (!does_entity_exist(iLocal_20))
	{
		if (has_model_loaded(1115303244) && _has_propset_loaded(-1938677009))
		{
			iLocal_20 = create_vehicle(1115303244, 1295.4f, -6819.75f, 40.27f, -24.7833f, true, true, false, false);
			set_entity_coords_no_offset(iLocal_20, 1295.4f, -6819.75f, 40.27f, false, true, true);
			freeze_entity_position(iLocal_20, true);
			func_262(iParam0, iLocal_20, "ship_nbdguama", 0, 0, 1, 0);
			func_432(iParam0, iLocal_20, 0);
			if (!_0x53784cea0159439b(iLocal_20))
			{
				_0xd80faf919a2e56ea(iLocal_20, -1938677009);
			}
			return true;
...
void func_435(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	iVar0 = func_549(uParam0, iParam1);
	if (iVar0 != -1)
	{
	...
	{
		iVar1 = func_550(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_551(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_365(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_399(uParam0->f_13[iVar0], 2);
		}
	}
}
...
{
	func_553(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
int func_454(int iParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_242(Global_1360165[iParam0], 0))
			{
				...
				if (is_ped_ragdoll(Global_1360165[iParam0]))
				{
					if (bParam1)
					{
						func_554(iParam0, 1, "Stealing, but companion is a ragdoll");
					}
					else
					{
						return 0;
		...
		case 1:
			...
			if (!func_294(iParam0, 44, 0))
			{
				func_287(iParam0, 44, 0);
			}
			if (func_556(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_555(iParam0, 2);
			}
			break;
		case 2:
			...
			func_292(iParam0, 18, 1);
			set_entity_visible(Global_1360165[iParam0], true);
			set_ped_relationship_group_hash(Global_1360165[iParam0], 1030835986);
			_0xf74e134f40192884(Global_1360165[iParam0], 0);
			_0x6759bee6762e140b((*Global_1360165)[iParam0]->f_1);
			set_ped_config_flag(Global_1360165[iParam0], 130, false);
			func_296(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				if (is_entity_attached(Global_1360165[iParam0]))
				{
					...
					{
						func_554(iParam0, 1, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_383(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_557(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						func_558(iParam0, iParam13, 0);
						func_559(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_294(iParam0, 25, 0))
						{
							func_292(iParam0, 25, 0);
						}
						func_287(iParam0, 66, 0);
						func_555(iParam0, 5);
		...
		case 6:
			if (func_242(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_561(Global_1360165[iParam0], 1);
				}
			}
			func_555(iParam0, 7);
		case 7:
			func_296(iParam0, bParam9, bParam15, 0);
			func_289(iParam0, 4, bParam11);
			func_291(iParam0);
			if (bParam20)
			{
				if (func_458(Global_1360165[iParam0]))
				{
				}
			}
			func_562(iParam0, Global_1360165[iParam0]);
...
char* func_462(int iParam0)
{
	...
	{
		return func_568(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_569(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_468(int iParam0)
{
	if (func_114(iParam0))
	{
		...
		{
			func_563(iParam0, 67108864, 1);
			func_292(iParam0, 19, 1);
		}
	}
}
...
int func_474(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_421(iParam0))
	{
		return 0;
	...
	if (func_242(iVar0, 0))
	{
		...
		if ((bParam1 || !func_471(iParam0)) || func_472(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_572(player_ped_id(), iVar0, 1) < 10000f))
			{
				iVar1 = func_573(iParam0, 1);
				if (iVar1 != 0)
				{
					if (!_0x88ad6cc10d8d35b2(iVar0))
					{
					...
					func_574(iParam0);
					_0x7b204f88f6c3d287(func_575(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_575(iParam0, 0));
					func_576(iParam0);
				}
			}
			else
...
void func_476(var uParam0, int iParam1, char* sParam2)
{
	if (!_does_anim_scene_exist(uParam0->f_444))
	{
		return;
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_578(uParam0, iParam1);
	}
...
int func_487(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
{
	iVar0 = func_403(func_582(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	iVar1 = func_403(func_582(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_505(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_386(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam0 == Global_35)
	{
		func_584(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_585(iParam0, &iVar0, &fVar25);
...
{
	return func_410(1328661203, func_588(), -1591664384, bParam0);
}
...
struct<4> func_515(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_410(923904168, func_513(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_410(923904168, func_513(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_410(923904168, func_513(bParam0), -740156546, 0);
}
...
bool func_517(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_411(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_518(int iParam0, var uParam1, int iParam2)
{
	if (func_590(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_519(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_410(271701509, func_513(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_410(271701509, func_513(bParam0), 12999093, 0);
}
...
bool func_521(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_412(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_524(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_523(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_529(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	iVar1 = 12;
	...
	if (func_392(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
		if (bParam4)
		{
			func_527(iVar1, iVar3);
		}
	}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_595(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_368(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_523(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_595(&(Global_1946804->f_1497.f_1[iVar1])) || func_523(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_368(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_368(&(uParam0->f_1[iVar1])) || func_523(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_596(0);
	if (iParam2 != 0 && func_597(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_598(iParam0, func_394(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_531(var uParam0, bool bParam1, int iParam2)
{
	bVar6 = func_240() != -1;
	iVar7 = func_596(0);
	if (func_390(32768))
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_391(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_599(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_532(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (*uParam0 <= 0)
	{
		return;
	...
	while (iVar0 < *uParam0)
	{
		func_601(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_240() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_602(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_603(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_603(Global_40.f_7729);
				Global_1946804->f_1378 = func_603(Global_40.f_7729);
...
bool func_536(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
char* func_539(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
void func_540(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
{
	sVar0 = func_606(0, 1, bParam0, bParam1);
...
void func_547(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
int func_550(var uParam0, char* sParam1)
{
	iVar0 = 0;
	while (iVar0 < 35)
	{
...
void func_553(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
...
void func_554(int iParam0, bool bParam1, char* sParam2)
{
	iVar0 = func_241(iParam0);
...
bool func_556(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_421(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_621(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_430((*Global_1360165)[iParam0]->f_4.f_2) || func_282((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_621(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_622((*Global_1360165)[iParam0]->f_63))
				{
					if (!func_623(iParam0, 0))
					{
						func_287(iParam0, 25, 0);
					}
				}
			}
			(*Global_1360165)[iParam0]->f_4 = { func_624(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_292(iParam0, 44, 1);
			}
...
bool func_557(int iParam0, int iParam1)
{
	...
	bVar0 = func_625(iParam0, iParam1);
	return bVar0;
}
...
float func_572(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
...
int func_573(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_646(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_575(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_647(iParam0);
	}
...
char* func_578(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_648(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_584(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (has_ped_got_weapon(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_649((386 + iVar28), 1);
			if (func_517(iParam0, &Var0, iVar5, 0))
			{
				if (func_518(iParam0, &Var6, iVar5))
				{
				...
				if (func_651(0))
				{
					...
					func_652(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_587(var uParam0, int iParam1, int iParam2)
{
	iVar0 = 0;
	Var4.f_9 = -1591664384;
	bVar18 = func_654(iParam1, 128);
	if (func_655("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_656(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_654(iParam1, 512) && func_590(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_657(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_654(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_654(iParam1, 4))) && (!func_657(Var4.f_4) || func_654(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_654(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_654(iParam1, 1048576)))
				{
...
bool func_590(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_412(0);
	*uParam1 = { func_410(iParam0, func_515(0), iParam3, 0) };
...
void func_591(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_661(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_661(uParam0->f_2[iVar0], 1))
				{
					func_662(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_593(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_403(iParam0, 1)] != &Global_1946804->f_57[func_403(iParam0, 1)];
}
...
void func_594(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (uParam0->f_1[iVar3]->f_1 == 1216705912 || uParam0->f_1[iVar3]->f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_527(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_527(iVar3, iVar0);
		}
	}
...
{
	if (iParam0 == &Global_1946804->f_57[func_403(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_601(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
	...
	if (func_240() == -1)
	{
		func_666(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_667(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_668(&(Global_1946804->f_1378), iParam0);
	func_669(2, iParam0, 6);
	if (bParam1)
	{
		func_605(0, 1);
	}
...
char* func_606(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_539(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_539(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_607()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_677()));
	fVar7 = (func_672(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_678(3, round((to_float(iVar8) * fVar10)), 0);
	func_679(3, fVar9, fVar9 > 100f);
	return func_680(fVar7, -100f, 100f);
}
...
float func_608()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_677()));
	fVar7 = (func_672(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_678(2, round((to_float(iVar8) * fVar10)), 0);
	func_679(2, fVar9, fVar9 > 100f);
	return func_680(fVar7, -100f, 100f);
}
...
float func_609()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_677()));
	fVar7 = (func_672(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_678(1, round((to_float(iVar8) * fVar10)), 0);
	func_679(1, fVar9, fVar9 > 100f);
...
int func_621(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_683((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_683((*Global_1347702)[63]->f_15, 1) || func_282((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_683((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_683((*Global_1347702)[134]->f_15, 1) || func_282((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_683((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_685(747937920, 1) && !func_683((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
bool func_623(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_294(iParam0, 44, 1))
		{
			return false;
		}
	}
...
struct<7> func_624(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
int func_627(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_687(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_687(1237718549, iParam1);
			return func_688(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_632(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_628(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_628(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_628(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_628(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_628(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_628(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_628(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_628(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_628(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_628(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_628(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_628(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_628(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_628(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_628(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_628(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_628(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_628(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_628(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_628(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_628(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_628(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_628(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_628(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_628(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_628(iParam1, 1544915253))
	{
...
{
	func_689(iParam0, 1);
	func_689(iParam0, 128);
	func_689(iParam0, 256);
	func_689(iParam0, 512);
	func_689(iParam0, 1024);
	func_689(iParam0, 2048);
	func_689(iParam0, 4096);
	func_689(iParam0, 65536);
	func_689(iParam0, 16384);
	func_689(iParam0, 262144);
	func_689(iParam0, 524288);
	func_689(iParam0, 1048576);
	func_689(iParam0, 2097152);
	func_689(iParam0, 32768);
	func_689(iParam0, 131072);
	func_689(iParam0, 134217728);
	func_689(iParam0, 1073741824);
}
...
void func_636(int iParam0)
{
	...
	if (func_573(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_300(iParam0);
	func_635(iVar0);
	func_473(iParam0, 8192, 1);
}
...
var func_648(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_650(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_521(*uParam1, &Var0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!_0x3e4e811480b3ae79(func_412(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_651(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_412(bParam0));
}
...
bool func_655(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = _0x80d78bdc9d88ef07(func_412(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_656(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
void func_668(var uParam0, int iParam1)
{
	if (func_240() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_666(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_667(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_678(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_606(iParam0, 1, 0, 0);
