...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_159(uParam0, -0.31f, 9.12f, 0f, 0f, 0f, 0f, 10f, 10f, 5f, "volTrigger", -1612834106);
	func_160(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	if (func_204(uParam0, iLocal_17))
	{
		...
		{
			_task_start_scenario_in_place(func_48(uParam0, iLocal_15), -830507952, 45000, false, 0, 1f, false);
		}
	}
	return true;
}
...
int func_176(int iParam0, int iParam1)
{
	...
	_0xa2f8b3b5fedfc100(iParam1, func_284(iParam0));
...
void func_188(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_259(uParam0, uParam0->f_1976.f_1), 1, func_293(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_425(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_284(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(747937920, 1) && !func_395((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
