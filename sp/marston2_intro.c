...
bool func_29(int iParam0)
{
	...
	func_139(iParam0);
	func_140();
	_0xe5ef9de716ff737e(&(iLocal_30[2]), 0, 0);
	return true;
}
...
{
	if (_does_anim_scene_exist(iLocal_36))
	{
		_delete_anim_scene(iLocal_36);
	}
	func_148(iLocal_15[3], 1);
	if (!is_entity_dead(iLocal_20))
	{
		set_vehicle_is_considered_by_player(iLocal_20, true);
	}
	...
	if (func_116(14))
	{
		...
		func_150(iParam0, 14, &(iLocal_15[0]), 0, 0, 1, 0);
	}
	if (func_116(13))
	{
		if (does_entity_exist(&(iLocal_15[2])))
		{
			freeze_entity_position(&(iLocal_15[1]), false);
		}
		func_150(iParam0, 13, &(iLocal_15[1]), 0, 0, 1, 0);
	}
	if (func_151(710, 0))
	{
		set_entity_visible(&(iLocal_15[2]), true);
		stop_ped_speaking(&(iLocal_15[2]), false);
...
int func_39(int iParam0)
{
	...
	{
		case 0:
			iLocal_36 = _create_anim_scene("script@story@mar2@leadin@int@base", 1, 0, false, true);
			load_anim_scene(iLocal_36);
			func_158(1);
			break;
		case 1:
			if (!_is_anim_scene_loaded(iLocal_36, true, false))
			{
				return 0;
			}
			if (!func_159(1, 1))
			...
			set_anim_scene_entity(iLocal_36, "AbigailRoberts", &(iLocal_15[1]), 0);
			set_anim_scene_entity(iLocal_36, "JackMarston_Teen", &(iLocal_15[0]), 0);
			set_anim_scene_entity(iLocal_36, "p_cs_bookHardCv08x", &(iLocal_21[6]), 0);
			set_anim_scene_entity(iLocal_36, "p_cs_potatoSlice01x", &(iLocal_21[0]), 0);
			set_anim_scene_entity(iLocal_36, "p_knife01x", &(iLocal_21[1]), 0);
			set_anim_scene_entity(iLocal_36, "p_plate01x", &(iLocal_21[4]), 0);
			start_anim_scene(iLocal_36);
			func_158(2);
			break;
		case 2:
			break;
...
bool func_41(int iParam0)
{
	...
	{
		case 0:
			if (is_entity_in_volume(Global_35, &(iLocal_30[0]), false, 1) || is_entity_in_volume(Global_35, &(iLocal_30[1]), false, 1))
			{
...
void func_56(int iParam0)
{
	...
	while (iVar2 < 27)
	{
		...
		else
		{
			...
			{
				func_150(iParam0, iVar3, iVar4, 0, bVar0, !bVar1, 0);
			}
		}
		iVar2++;
	}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_180(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_180(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_74(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_176(&(Global_1898164->f_1[0]));
		if (func_187(iVar0) && func_188((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	{
		if ((fVar3 >= func_192(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_193();
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_206("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_209(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_209(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_207(uParam0->f_501, 128))
		{
			func_208();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_93(1, 0);
	func_194(uParam0);
	if (func_222() && _0x6f1f0b17109309da(uParam0->f_444, func_209(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_226(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_240(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_248();
	set_entity_invincible(Global_35, func_207(*uParam0, 8));
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_180(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_180(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_180(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_180(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		if (func_161(func_253(iVar0), 0))
		{
			if (is_ped_group_member(func_253(iVar0), func_254(), 1))
			{
...
Vector3 func_125(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_209(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_253(iVar0));
...
void func_140()
{
	...
	{
		func_284(-1899662469, 0, 0f, 0, 0, 0, 1, 0);
	}
	if (func_283(1535511805))
	{
		func_284(1535511805, 0, 0f, 0, 0, 0, 1, 0);
	}
}
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (bParam4)
	{
		func_294(iParam0, iParam2, 0);
	}
	if (!bParam6)
	{
		if (!func_5(iParam0, 4194304))
		{
			bParam6 = func_295((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_295((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_296(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_153(int* iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (bParam1)
	{
		func_307(iParam0, bParam2, bParam3);
	}
	else
	{
		func_308(iParam0);
...
void func_154()
{
	...
	while (iVar0 < 3)
	{
		if (_does_volume_exist(&(iLocal_30[iVar0])))
		{
			_delete_volume(&(iLocal_30[iVar0]));
		}
		iVar0++;
	}
}
...
int func_157(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_214(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
{
	return ((iParam0 > -1 && iParam0 < 4) && ((bParam1 && func_161(&(iLocal_15[iParam0]), 0)) || (!bParam1 && does_entity_exist(&(iLocal_15[iParam0])))));
}

bool func_160(int iParam0)
{
	return ((iParam0 > -1 && iParam0 < 8) && does_entity_exist(&(iLocal_21[iParam0])));
}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_313(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_314(uParam0->f_1522[iVar0], 128))
				{
					func_315(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_318((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_320((*uParam1)[iVar0]))
		{
			if (func_318((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_321((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_322((*uParam2)[iVar0]))
		{
			if (func_318((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_323((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_324((*uParam3)[iVar0]))
		{
			if (func_318((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_325((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_327((*uParam5)[iVar0]))
		{
			if (func_318((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_328((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_327((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_329((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_318((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_330((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_331((*uParam6)[iVar0]))
		{
			if (func_318((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_332((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_333((*uParam7)[iVar0]))
		{
			if (func_318((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_334((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_335((*uParam8)[iVar0]))
		{
			if (func_318((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_336((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_337((*uParam9)[iVar0]))
		{
			if (func_318((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_338((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_339((*uParam10)[iVar0]))
		{
			if (func_318((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_340((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_341((*uParam11)[iVar0]))
		{
			if (func_318((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_342((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_181(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_350(iParam1, 0, 0, 0);
}
...
void func_183(int iParam0, int iParam1)
{
	...
	func_351(iParam1);
	StringCopy(&cVar0, func_179(), 64);
	func_352(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_189(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_353(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_199(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_357(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_179());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
		...
		func_358(uParam0, uParam0->f_4, 0, 1);
...
bool func_212(bool bParam0, bool bParam1)
{
	if (!func_360(Global_43801))
	{
		Global_43801 = func_365("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_366(Global_43801, 0, 1);
		func_367(Global_43801, 6, 1);
		if (bParam1)
		{
			func_367(Global_43801, 14, 1);
		}
	}
	else
	{
		...
		if (func_369(Global_43801, 1) != 0f && bParam0)
		{
			func_366(Global_43801, 1, 1);
		}
		else
		{
			func_366(Global_43801, 0, 1);
		}
		return func_370(Global_43801, 1);
	}
	return false;
}
...
void func_223(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_373(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_356() };
...
void func_224(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_240(uParam0->f_13[iVar0], 2))
		{
			if (func_240(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				func_374(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					iVar1 = get_ped_index_from_entity_index(&(uParam0->f_13[iVar0]));
					if (iVar1 != Global_35 && !func_240(uParam0->f_13[iVar0], 16))
					{
						func_375(iVar1);
					}
				}
...
bool func_227()
{
	return func_363(_0xc17f69e1418cd11f(3));
}
...
void func_232(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_391() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if (func_83(uParam0, 2048) && !func_90(func_392(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_394(iVar1, func_392(uParam0), func_393(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_394(iVar3, func_392(uParam0), func_393(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_392(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_392(uParam0) };
			func_394(iVar0, vVar1, func_395(vVar1, Global_36, 1), 2, 1073741824);
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_240(uParam0->f_13[iVar0], 8))
					{
						if (func_397(func_396(iVar1, 0, 1, 0)))
						{
							if (!func_398(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_398(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
...
void func_239(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			func_400(iParam1, 29, bVar4, 1, 0);
			func_400(iParam1, 31, bVar4, 1, 0);
			func_400(iParam1, 30, bVar4, 1, 0);
			func_400(iParam1, 22, bVar4, 1, 0);
			func_400(iParam1, 37, bVar4, 1, 0);
		}
	}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_402(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
					if (!func_402(iVar3, 1) || bParam2)
					{
						...
						if (!bParam6)
						{
							func_400(iParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_400(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_244(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_410(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_249(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_416(1, (func_252() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_414(iParam3, 1)])
			{
				func_417(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_401(32768) && iParam1 != &Global_1946804->f_57[func_414(iParam3, 1)])
			{
				func_418();
...
void func_250(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_423(0), &Var5, iParam1);
}
...
bool func_251(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	{
		if (!func_424(iParam0, 1245594896))
		{
	...
	if (func_310(*uParam1, 2))
	{
		...
		else if ((func_427(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_427(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_427(iParam2, 1024))) || func_427(iParam2, 8)) && !func_310(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_428(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_427(iParam2, 4096)) && !func_310(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_428(uParam1, 2048);
			func_428(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_427(iParam2, 32)) && !func_310(*uParam1, 5632))
		{
...
int func_263(var uParam0, int iParam1)
{
	...
	if (func_143())
	{
		...
		if (func_434(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_435(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_290(uParam0, 8) && _0xdd0b7c5ae58f721d(func_436()))
	{
		_0x798be43c9393632b(func_436());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_436())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_268()
{
	...
	if (!func_441(0))
	{
		...
		request_model(-1693870200, false);
		func_443(0, 1);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		iVar4 = iVar0;
		iVar5 = func_442(iVar4);
		if (iVar5 == 0)
		{
		}
		else
		{
			bVar1 = (bVar1 && has_model_loaded(iVar5));
		}
		iVar0++;
	}
	bVar1 = (bVar1 && has_model_loaded(822759307));
	bVar1 = (bVar1 && has_model_loaded(-1693870200));
	if (bVar1)
	{
		func_443(1, 1);
		return true;
...
bool func_269(var uParam0)
{
	...
	Var0 = { func_444(0, 3) };
	iLocal_20 = create_vehicle(822759307, Var0, Var0.f_3, true, true, true, false);
	if (does_entity_exist(iLocal_20))
	{
		func_273(uParam0, iLocal_20, "UTILLIWAG", 0, 0, 1, 0);
		func_445(uParam0, iLocal_20, 0);
		func_446(uParam0, iLocal_20);
		set_vehicle_is_considered_by_player(iLocal_20, false);
		_0x8268b098f6fca4e2(iLocal_20, 2);
		_0xf89d82a0582e46ed(iLocal_20, 2);
		return true;
	}
	return false;
}
...
bool func_270(int iParam0, int iParam1)
{
	...
	if (!func_447(iParam1, &iVar0, &iVar1, &Var2, &iVar6, &iVar7))
	{
		return false;
	}
	if (iParam1 == 3)
	{
		...
		iLocal_15[iParam1] = func_448(-1693870200, Var2, Var2.f_3, 1, 1, 0, 1, 0, 1, 0, 0, 0, 0);
		if (does_entity_exist(&(iLocal_15[iParam1])))
		{
			_0x316cdb5b6e8f4110(&(iLocal_15[iParam1]), iLocal_20, 0);
			_set_ped_body_component(&(iLocal_15[iParam1]), -937613161);
			_update_ped_variation(&(iLocal_15[iParam1]), false, true, true, true, false);
		}
	}
	else if (iVar0 != -1)
	{
		func_280(iParam0, iVar0, iLocal_15[iParam1], 0, 1, 0, 0, 0, 0, iVar7, 0, 0, 0);
	}
	else if (iVar1 != -1)
	{
		if (_0x800df3fc913355f3(func_305(iVar1)))
		{
			iLocal_15[iParam1] = func_449(iVar1, 1, 0, 0, 1, 1);
		}
		if (!does_entity_exist(&(iLocal_15[iParam1])))
		{
			func_450(iVar1, 1);
			func_451(iVar1, 0, 0, 0, 0, 0);
		}
	}
	if (does_entity_exist(&(iLocal_15[iParam1])))
	{
		_set_entity_coords_and_heading(&(iLocal_15[iParam1]), Var2, Var2.f_3, false, false, true);
		func_452(iParam0, iParam1, iVar6);
		return true;
	}
	return false;
}
...
bool func_271(var uParam0)
{
	...
	while (iVar1 < 8)
	{
		iVar0 = (iVar0 && func_453(uParam0, iVar1));
		iVar1++;
	}
	return iVar0;
}
...
{
	func_455(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_456(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
void func_275(int iParam0, vector3 vParam1, int iParam4)
{
	...
	func_457(&(iParam0->f_958), iParam4);
}
...
int func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_317((*uParam0)[iVar1]))
		{
			if (func_318((*uParam0)[iVar1]->f_2, iParam12))
			{
				if (!func_458((*uParam0)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam1)
	{
		if (func_320((*uParam1)[iVar1]))
		{
			if (func_318((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_459((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_322((*uParam2)[iVar1]))
		{
			if (func_318((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_460((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		if (func_324((*uParam3)[iVar1]))
		{
			if (func_318((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_325((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_327((*uParam5)[iVar1]))
		{
			if (func_318((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_461((*uParam5)[iVar1]))
				{
					if (!func_462((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
			...
			if (func_318((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_461((*uParam5)[iVar1]))
				{
					if (func_462((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_329((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_463((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_331((*uParam6)[iVar1]))
		{
			if (func_318((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_464((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_333((*uParam7)[iVar1]))
		{
			if (func_318((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_465((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_335((*uParam8)[iVar1]))
		{
			if (func_318((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_466((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_337((*uParam9)[iVar1]))
		{
			if (func_318((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_467((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_339((*uParam10)[iVar1]))
		{
			if (func_318((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_468((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_341((*uParam11)[iVar1]))
		{
			if (func_318((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_469((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
int func_280(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_473(iParam1, 28, 1))
	{
		func_474(iParam1, 28, 1);
	}
	*uParam2 = func_475(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_476(iParam0, *uParam2);
		func_477(*uParam2, bParam3, bParam4, 0);
		if (bParam4)
		{
			set_blocking_of_non_temporary_events(*uParam2, true);
			if (!func_424(*uParam2, -982327190))
			{
				task_stand_still(*uParam2, -1);
			}
		}
		func_273(iParam0, *uParam2, 0, 0, 0, 1, 0);
		func_478(iParam1, 0, 0, 1);
		func_479(iParam1);
		return 1;
	}
	return 0;
...
void func_284(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_311(iParam0, 0, 0);
	if (func_312(iParam0))
	{
		...
		if (bParam3)
		{
			func_480(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
		...
		if (is_vehicle_driveable(*iParam0, false, false))
		{
			if (!is_vehicle_seat_free(*iParam0, iVar12))
			{
				...
				if (!is_entity_dead(&(iVar1[iVar0])))
				{
					...
					func_394(&(iVar1[iVar0]), get_offset_from_entity_in_world_coords(*iParam0, 3f, 3f, 0f), get_entity_heading(*iParam0), 2, 1073741824);
				}
			}
		}
		iVar0++;
...
{
	func_487(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_296(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	func_490(iParam0);
	func_491(iParam0);
	func_492(iParam0, 37, 1);
	bVar0 = func_161(Global_1360165[iParam0], 0);
	iVar1 = func_493(iParam0, 0);
	bVar2 = _0x800df3fc913355f3(iVar1);
	if (get_ped_config_flag(Global_1360165[iParam0], 503, true) && Global_1359489->f_16 & 8388608 == 0)
	{
		set_ped_config_flag(Global_1360165[iParam0], 503, false);
	}
	if (func_473(iParam0, 64, 1))
	{
		func_492(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_492(iParam0, 33, 1);
		func_492(iParam0, 34, 1);
		func_494(iParam0, 1056964608, -1, 1061158912);
		func_495(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_474(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_474(iParam0, 35, 1);
			if (bParam8)
			{
				func_474(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		func_474(iParam0, 33, 1);
		func_495(iParam0, 0, 1, 0);
		if (fParam4 > 0f)
		{
		...
		{
			func_245(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
			func_474(iParam0, 34, 1);
		}
	}
	if (bParam1 || bParam2)
	{
		if (does_entity_exist(Global_1360165[iParam0]))
		{
			func_497(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	if (func_473(iParam0, 45, 1))
	{
		func_492(iParam0, 45, 1);
	}
	...
	if (bParam5)
	{
		if (func_161(func_499(iParam0), 0))
		{
			func_500(0, iParam0, bParam3, 0, bParam2);
		}
	}
}
...
int func_306(int iParam0, bool bParam1)
{
	...
	if (!_0x800df3fc913355f3(func_305(iParam0)))
	{
		return 1;
	}
	...
	func_302(iParam0);
	_0xfc77c5b44d5ff7c0(func_305(iParam0));
	func_503(iParam0, 0);
	return 1;
}
...
struct<8> func_313(var uParam0, int iParam1)
{
...
void func_315(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_328(var uParam0)
{
	if (!func_509(uParam0->f_2, 1))
	{
		if (func_461(uParam0))
		{
			...
			{
				sVar0 = func_362(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_513())
				{
...
var func_350(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
void func_351(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_516(iVar0, 4096, 0);
			func_516(iVar0, 131072, 0);
			func_517(iVar0, 1);
		}
		iVar0++;
	}
...
int func_352(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_518(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}

void func_353(var uParam0, char* sParam1, bool bParam2)
{
	if (is_string_null_or_empty(sParam1))
	{
		return;
...
void func_354(struct<4> Param0)
{
	...
	if (func_521(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_521(20))
			{
				return;
			}
			iVar0++;
...
bool func_357(vector3 vParam0, vector3 vParam3)
{
...
int func_365(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_525(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
void func_374(var uParam0, char* sParam1, int iParam2, int iParam3)
{
	if (!does_entity_exist(iParam2))
	{
		return;
...
bool func_377(int iParam0)
{
	...
	else if (func_533(-525676072, iParam0))
	{
		if (func_532(iParam0))
		{
			return true;
...
void func_382(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_397(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_383()
{
	...
	if (func_397(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_397(iVar0))
	{
		...
		{
			func_536(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
int func_385(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_394(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_540(Global_35) && is_player_teleport_active())
	{
	}
	if (func_541(iParam0))
	{
		if (func_542(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_310(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_310(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_310(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_310(iParam5, 32), true);
	...
	else if (func_310(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_310(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_310(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
{
	return ((Global_1946804->f_57[func_414(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_404(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_402(1108822547, 6))
	{
		if (bParam2)
		{
			func_400(iParam0, iVar0, func_252() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_414(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_414(iParam0, 1)])->f_10 || iParam1);
}

void func_407(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_414(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_414(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_414(iParam0, 1)])->f_10 && iParam1));
}
...
bool func_415(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_553();
	if (iParam2 == 39)
	{
	...
	if (func_554(iParam0, 866047851) && func_555(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_401(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	func_557(iParam2);
	func_558(iParam2, iVar5);
	if (&Global_1946804->f_1378.f_1[iParam2] != &Global_1946804->f_57[iParam2] && Global_1946804->f_57[iParam2]->f_1 > 1)
	{
		func_559(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_559(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_560(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_561(iParam0, iParam2, iParam1, func_252() != -1);
	if (bParam4)
	{
		func_562(&(Global_1946804->f_1378), 1, 3);
	}
	else
	{
		func_562(&(Global_1946804->f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_407(func_405(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_563(&(Global_1946804->f_2589), bParam0, bParam1, bParam2);
}
...
void func_418()
{
	func_565(&(Global_1946804->f_2776));
	func_566(32768);
...
bool func_425(int iParam0)
{
	...
	if (func_424(iParam0, 1041577989))
	{
		return false;
	}
...
bool func_426(int iParam0, vector3 vParam1)
{
	vVar0 = { get_entity_coords(iParam0, true, false) };
	vVar3 = { vVar0 + get_entity_forward_vector(iParam0) };
	return func_567(vVar0, vVar3, vParam1);
}
...
void func_432(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_570(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_571(1, bVar1, 1, uVar2);
		func_572(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_573(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
struct<4> func_444(int iParam0, int iParam1)
{
...
void func_445(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_579(), true);
	}
}
...
bool func_447(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	*iParam1 = -1;
	*iParam2 = -1;
	*uParam3 = { func_580() };
	...
	*iParam5 = 0;
	...
	return ((*iParam1 != -1 || *iParam2 != -1) || iParam0 == 3);
}

int func_448(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
...
int func_449(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_298(iParam0)) && !is_entity_dead(iVar0))
	{
...
int func_450(int iParam0, bool bParam1)
{
	...
	{
		func_503(iParam0, _create_persistent_character(func_303(iParam0)));
		if (func_252() == -1)
		{
			if (func_299(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_305(iParam0));
				func_301(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_305(iParam0));
		}
		return 0;
	}
	...
	func_503(iParam0, _create_persistent_character(func_303(iParam0)));
	_0x4f81ead1de8fa19b(func_305(iParam0));
	if (func_299(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_305(iParam0));
		func_301(iParam0, 2048);
...
int func_451(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_297(iParam0))
	{
		return 0;
	...
	if (!func_90(vVar0))
	{
		_0x59c7ad6fea2ac449(func_305(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = _0x08fc896d2cb31fcc(func_305(iParam0), 0);
	}
	else
	{
		iVar3 = _0x0cadc3a977997472(func_305(iParam0), 0);
	}
	if (!func_90(vVar0))
	{
		_0xbb68908cd11aebdc(func_305(iParam0));
	}
...
void func_452(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 0:
			set_blocking_of_non_temporary_events(&(iLocal_15[iParam1]), true);
			func_131(iParam0, &(iLocal_15[iParam1]), "JackMarston_Teen", 0, 0, 1);
			freeze_entity_position(&(iLocal_15[iParam1]), true);
			func_587(&(iLocal_15[iParam1]), 0, 1);
			break;
		case 1:
			set_blocking_of_non_temporary_events(&(iLocal_15[iParam1]), true);
			func_131(iParam0, &(iLocal_15[iParam1]), "AbigailRoberts", 0, 0, 1);
			freeze_entity_position(&(iLocal_15[iParam1]), true);
			break;
		case 2:
			set_blocking_of_non_temporary_events(&(iLocal_15[iParam1]), true);
			clear_ped_tasks(&(iLocal_15[iParam1]), 1, 0);
			func_131(iParam0, &(iLocal_15[iParam1]), "TomDickens", 0, 0, 1);
			set_entity_visible(&(iLocal_15[iParam1]), false);
			stop_ped_speaking(&(iLocal_15[iParam1]), true);
			freeze_entity_position(&(iLocal_15[iParam1]), true);
			break;
		case 3:
			set_ped_can_be_targetted(&(iLocal_15[iParam1]), false);
			set_entity_only_damaged_by_player(&(iLocal_15[iParam1]), true);
			set_ped_config_flag(&(iLocal_15[iParam1]), 301, true);
			set_blocking_of_non_temporary_events(&(iLocal_15[iParam1]), false);
			func_446(iParam0, &(iLocal_15[iParam1]));
			break;
	}
	if (iParam2 != 0)
	{
		func_588(&(iLocal_15[iParam1]), iParam2);
	}
}
...
int func_453(var uParam0, int iParam1)
{
	...
	iLocal_21[iParam1] = create_object(iVar0, Var1, true, true, false, false, true);
	if (does_entity_exist(&(iLocal_21[iParam1])))
	{
		set_entity_coords(&(iLocal_21[iParam1]), Var1, true, false, true, true);
		set_entity_rotation(&(iLocal_21[iParam1]), 0f, 0f, Var1.f_3, 2, true);
		func_273(uParam0, &(iLocal_21[iParam1]), cVar5, 0, 0, 1, 0);
		func_445(uParam0, &(iLocal_21[iParam1]), 0);
		return 1;
	}
	return 0;
}
...
{
	if (_does_volume_exist(&(iLocal_30[iParam0])))
	{
		return 1;
	}
	switch (iParam0)
	...
	iLocal_30[iParam0] = _create_volume_by_hash(iVar0, vVar1, vVar4, vVar7);
	if (_does_volume_exist(&(iLocal_30[iParam0])))
	{
		return 1;
	}
...
void func_455(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	iVar0 = func_590(uParam0, iParam1);
	if (iVar0 != -1)
	{
	...
	{
		iVar1 = func_591(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_592(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
...
void func_456(int iParam0, int iParam1, char* sParam2)
{
	func_594(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
int func_475(int iParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_114(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_260(iParam0, 16, 1))
			{
				...
				else if (func_161(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_161(Global_1360165[iParam0], 0))
			{
				...
				if (is_ped_ragdoll(Global_1360165[iParam0]))
				{
					if (bParam1)
					{
						func_596(iParam0, 1, "Stealing, but companion is a ragdoll");
					}
					else
					{
						return 0;
		...
		case 1:
			...
			if (!func_473(iParam0, 44, 0))
			{
				func_474(iParam0, 44, 0);
			}
			if (func_598(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_597(iParam0, 2);
			}
			break;
		case 2:
			...
			func_492(iParam0, 18, 1);
			set_entity_visible(Global_1360165[iParam0], true);
			set_ped_relationship_group_hash(Global_1360165[iParam0], 1030835986);
			_0xf74e134f40192884(Global_1360165[iParam0], 0);
			_0x6759bee6762e140b((*Global_1360165)[iParam0]->f_1);
			set_ped_config_flag(Global_1360165[iParam0], 130, false);
			func_495(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				if (is_entity_attached(Global_1360165[iParam0]))
				{
					...
					{
						func_596(iParam0, 1, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_394(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_599(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						func_600(iParam0, iParam13, 0);
						func_601(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_473(iParam0, 25, 0))
						{
							func_492(iParam0, 25, 0);
						}
						func_474(iParam0, 66, 0);
						func_597(iParam0, 5);
		...
		case 6:
			if (func_161(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_603(Global_1360165[iParam0], 1);
				}
			}
			func_597(iParam0, 7);
		case 7:
			func_495(iParam0, bParam9, bParam15, 0);
			func_489(iParam0, 4, bParam11);
			func_491(iParam0);
			if (bParam20)
			{
				if (func_604(Global_1360165[iParam0]))
				{
				}
			}
			func_605(iParam0, Global_1360165[iParam0]);
...
void func_477(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_166() || !_0x6f1f0b17109309da(Global_43800, func_209(iParam0))))
	{
...
void func_480(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_312(iParam0))
	{
...
void func_487(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_611(uParam0, iParam1);
	}
...
void func_488(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_612(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_489(int iParam0, int iParam1, bool bParam2)
{
	...
	func_613(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_494(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_473(iParam0, 5, 1))
	{
		set_ped_config_flag(func_253(iParam0), 137, true);
	}
}
...
void func_495(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_474(iParam0, 50, 1);
		func_474(iParam0, 48, 1);
		func_474(iParam0, 49, 1);
		func_474(iParam0, 51, 1);
		if (bParam3)
		{
			func_474(iParam0, 54, 1);
		}
		else
		{
			func_492(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_474(iParam0, 52, 1);
			if (bParam3)
			{
				func_474(iParam0, 55, 1);
			}
		}
		else
		{
...
void func_496(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_253(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_253(iParam0), 204, false);
	}
}

void func_497(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_114(iParam0))
	{
		return;
	...
	iVar0 = func_493(iParam0, 0);
	if (!_is_base_a_persistent_character(iVar0))
	{
		return;
	}
	iVar1 = func_253(iParam0);
	if (((does_entity_exist(iVar1) && func_616(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_500(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (!func_431(iParam1))
	{
		return;
	...
	func_492(iParam1, 39, 1);
	func_620(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_620(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_620(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_474(iParam1, 43, 1);
		}
		if (bParam4)
		{
			func_621(iParam1, 0, 1, 1, 1);
		}
	}
}
...
char* func_505(int iParam0)
{
	...
	{
		return func_209(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_622(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_623(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
bool func_507(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_518(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
bool func_520(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
...
void func_526(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_364(iParam0, 8))
		{
...
{
	iVar0 = func_414(func_627(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	if (func_533(81053684, iParam0))
	{
		return true;
	}
	if (func_533(-525676072, iParam0))
	{
		return true;
	}
	return false;
...
{
	iVar1 = func_414(func_627(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_536(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_397(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_421(1328661203, func_633(), -1591664384, bParam0);
}
...
struct<4> func_546(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_421(923904168, func_544(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_421(923904168, func_544(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_421(923904168, func_544(bParam0), -740156546, 0);
}

bool func_547(int iParam0, bool bParam1)
{
	if (func_379(iParam0) == 1779021115)
	{
		return false;
	}
...
struct<4> func_550(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_421(271701509, func_544(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_421(271701509, func_544(bParam0), 12999093, 0);
}
...
bool func_552(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
void func_560(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	iVar1 = 12;
	iVar2 = func_379(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_403(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
		if (bParam4)
		{
			func_558(iVar1, iVar3);
		}
	}
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_379(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_640(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_379(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_640(&(Global_1946804->f_1497.f_1[iVar1])) || func_554(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_379(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_379(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_379(&(uParam0->f_1[iVar1])) || func_554(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_641(0);
	if (iParam2 != 0 && func_642(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_643(iParam0, func_405(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_562(var uParam0, bool bParam1, int iParam2)
{
	bVar6 = func_252() != -1;
	iVar7 = func_641(0);
	if (func_401(32768))
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_402(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_644(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_563(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (*uParam0 <= 0)
	{
		return;
	...
	while (iVar0 < *uParam0)
	{
		func_646(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_252() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_647(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_648(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_648(Global_40.f_7729);
				Global_1946804->f_1378 = func_648(Global_40.f_7729);
...
bool func_567(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
char* func_570(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
void func_571(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
void func_572(bool bParam0, bool bParam1, bool bParam2)
{
	sVar0 = func_651(0, 1, bParam0, bParam1);
...
struct<4> func_578(int iParam0, int iParam1)
{
	Var0 = { func_656(iParam0, iParam1) };
	Var0.f_3 = func_657(iParam0, iParam1);
	return Var0;
}
...
bool func_585(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_501(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_305(iParam0));
}
...
bool func_586(int iParam0)
{
	...
	{
		_0x49a8c2cd97815215(func_305(iParam0));
		if (!does_entity_exist(_0x0cadc3a977997472(func_305(iParam0), 0)))
		{
			return false;
		}
	}
...
void func_594(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	func_666(uParam0);
	iVar0 = func_667(uParam0, iParam1);
	if (bParam3)
	{
		if (is_string_null_or_empty(sParam2))
		{
		...
		iVar0 = func_668(uParam0, sParam2);
		if (iVar0 == -1)
		{
...
void func_596(int iParam0, bool bParam1, char* sParam2)
{
	iVar0 = func_253(iParam0);
...
bool func_598(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_431(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_671(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_440((*Global_1360165)[iParam0]->f_4.f_2) || func_309((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_671(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_672((*Global_1360165)[iParam0]->f_63))
				{
					if (!func_673(iParam0, 0))
					{
						func_474(iParam0, 25, 0);
					}
				}
			}
			(*Global_1360165)[iParam0]->f_4 = { func_674(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_492(iParam0, 44, 1);
			}
		...
		case 2:
			if (!func_161(func_253(iParam0), 0))
			{
				return false;
			}
			if (iParam5 && iParam10)
...
bool func_599(int iParam0, int iParam1)
{
	...
	bVar0 = func_675(iParam0, iParam1);
	return bVar0;
}
...
void func_605(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_536(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_536(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
char* func_611(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_690(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_615(int iParam0)
{
	if (func_114(iParam0))
	{
		if (does_entity_exist(func_253(iParam0)))
		{
			func_606(iParam0, 67108864, 1);
...
int func_621(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_431(iParam0))
	{
		return 0;
	...
	if (func_161(iVar0, 0))
	{
		if (func_161(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_618(iParam0)) || func_619(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_693(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_695(iParam0);
					_0x7b204f88f6c3d287(func_696(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_696(iParam0, 0));
					func_697(iParam0);
				}
			}
			else
	...
	{
		if (func_161((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_260(iParam0, 32768, 1))
			{
		...
		while (iVar28 < 4)
		{
			...
			if (func_548(iParam0, &Var0, iVar5, 0))
			{
				if (func_549(iParam0, &Var6, iVar5))
				{
					...
					func_701(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
...
int func_632(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_706("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_705(iParam1, 512) && func_635(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_708(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_705(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_705(iParam1, 4))) && (!func_708(Var4.f_4) || func_705(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_705(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_705(iParam1, 1048576)))
				{
	...
	{
		iParam1 |= 512;
		return func_632(uParam0, iParam1, iParam2);
	}
...
{
	iVar0 = func_423(0);
	*uParam1 = { func_421(iParam0, func_546(0), iParam3, 0) };
...
void func_636(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_712(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_712(uParam0->f_2[iVar0], 1))
				{
					func_713(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_638(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_414(iParam0, 1)] != &Global_1946804->f_57[func_414(iParam0, 1)];
}
...
void func_639(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (uParam0->f_1[iVar3]->f_1 == 1216705912 || uParam0->f_1[iVar3]->f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_558(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_558(iVar3, iVar0);
		}
	}
...
{
	if (iParam0 == &Global_1946804->f_57[func_414(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_646(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_252() == -1)
	{
		func_717(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_718(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_719(&(Global_1946804->f_1378), iParam0);
	func_720(2, iParam0, 6);
	if (bParam1)
	{
		func_650(0, 1);
	}
...
char* func_651(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_570(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_570(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_652()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_728()));
	fVar7 = (func_723(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_729(3, round((to_float(iVar8) * fVar10)), 0);
	func_730(3, fVar9, fVar9 > 100f);
	return func_731(fVar7, -100f, 100f);
}
...
float func_653()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_728()));
	fVar7 = (func_723(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_729(2, round((to_float(iVar8) * fVar10)), 0);
	func_730(2, fVar9, fVar9 > 100f);
	return func_731(fVar7, -100f, 100f);
}
...
float func_654()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_728()));
	fVar7 = (func_723(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_729(1, round((to_float(iVar8) * fVar10)), 0);
	func_730(1, fVar9, fVar9 > 100f);
...
int func_668(var uParam0, char* sParam1)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
...
int func_671(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_734((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_734((*Global_1347702)[63]->f_15, 1) || func_309((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_734((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_734((*Global_1347702)[134]->f_15, 1) || func_309((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_734((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_736(747937920, 1) && !func_734((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_253(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
bool func_673(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_473(iParam0, 44, 1))
		{
			return false;
		}
	}
...
struct<7> func_674(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
int func_677(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_738(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_738(1237718549, iParam1);
			return func_739(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_678(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_662(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_662(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_662(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_662(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_662(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_662(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_662(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_662(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_662(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_662(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_662(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_662(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_662(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_662(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_662(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_662(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_662(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_662(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_662(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_662(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_662(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_662(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_662(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_662(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_662(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_662(iParam1, 1544915253))
	{
...
{
	func_740(iParam0, 1);
	func_740(iParam0, 128);
	func_740(iParam0, 256);
	func_740(iParam0, 512);
	func_740(iParam0, 1024);
	func_740(iParam0, 2048);
	func_740(iParam0, 4096);
	func_740(iParam0, 65536);
	func_740(iParam0, 16384);
	func_740(iParam0, 262144);
	func_740(iParam0, 524288);
	func_740(iParam0, 1048576);
	func_740(iParam0, 2097152);
	func_740(iParam0, 32768);
	func_740(iParam0, 131072);
	func_740(iParam0, 134217728);
	func_740(iParam0, 1073741824);
}
...
void func_682(int iParam0)
{
	...
	if (func_694(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_499(iParam0);
	func_681(iVar0);
	func_620(iParam0, 8192, 1);
}
...
void func_689(int iParam0)
{
	...
	iVar0 = func_499(iParam0);
	func_688(iVar0);
	func_620(iParam0, 16384, 0);
}

var func_690(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_693(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
	...
	return func_226(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_694(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_743(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_696(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_744(iParam0);
	}
...
bool func_701(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
...
void func_704(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_747(_get_weapon_clip_size(iParam0), iParam1);
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_423(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_719(var uParam0, int iParam1)
{
	if (func_252() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_717(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_718(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_729(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_651(iParam0, 1, 0, 0);
	sVar0 = _create_var_string(2, sVar0, sParam1);
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[iParam0]->f_12[1]), sVar0);
	_databinding_write_data_bool(&(Global_1955569->f_5.f_2[iParam0]->f_16[1]), bParam2);
}

void func_730(int iParam0, float fParam1, bool bParam2)
{
	sVar0 = func_651(iParam0, 2, 0, 0);
