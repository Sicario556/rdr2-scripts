...
bool func_72(var uParam0)
{
	...
	request_model(1504738597, false);
...
bool func_75(var uParam0)
{
	...
	if (!has_model_loaded(1504738597))
	{
		return false;
	}
	return true;
...
{
	iLocal_15 = create_object_no_offset(1504738597, 1881.71f, -1833.58f, 42.25f, true, true, false, true);
	set_entity_heading(iLocal_15, 65f);
	iLocal_16 = create_object_no_offset(1504738597, 1881.5f, -1834.79f, 42.25f, true, true, false, true);
	set_entity_heading(iLocal_16, 105f);
	return true;
}
