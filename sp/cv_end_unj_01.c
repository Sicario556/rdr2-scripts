...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -169316936, 3f, 3f, 0f, "Feather", 0, 0, 1);
	...
	func_159(uParam0, iLocal_14, 2, -1043454001, "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 1, -1073741824, 1065353216, 1);
...
bool func_93(var uParam0)
{
	if (func_201(uParam0, iLocal_16))
	{
		...
		{
			iVar1 = get_random_int_in_range(iLocal_19, iLocal_20 + 1);
...
bool func_300(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_202(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_392((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
