...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7063f, 0.0071f, 0f, 1.5f, 2f, 2f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, -799374629, 0f, 0f, 0f, "CRATE", iVar0, 0, 1);
	func_152(uParam0, 927991752, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	func_154(uParam0, iLocal_15, 1);
	func_155(uParam0, "script@vignette@pearson_speech_low_food_1@base_intro", 1, 1, 0, 0);
	iLocal_14 = func_155(uParam0, "script@vignette@pearson_speech_low_food_1@action", 2, 0, 1, 0);
	StringCopy(uParam0->f_2236[0], sLocal_20, 64);
	func_156(uParam0, "CPLF1AU");
	func_157(uParam0, -451953278, 1724981740);
...
bool func_93(var uParam0)
{
	if (func_199(uParam0, iLocal_14))
	{
		if (!bLocal_19)
		{
			func_115(&uLocal_16, 0);
			bLocal_19 = true;
			task_play_anim(func_48(uParam0, iLocal_15), uParam0->f_2236[0], "exit_back", 1000f, -8f, -1, 8192, 0f, false, 0, false, 0, false);
			_0x2208438012482a1a(func_48(uParam0, iLocal_15), true, false);
		}
	}
