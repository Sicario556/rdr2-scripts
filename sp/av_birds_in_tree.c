...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BLS_BIRD_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, -1f), (0f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 1, "BLS_BIRD_2", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.5f, 0.5f, -1f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "BLS_BIRD_3", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, 0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 3, "BLS_BIRD_4", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, 0f, -1f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "BLS_BIRD_5", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.75f, 0f, -1f), (-100f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 5, "BLS_BIRD_6", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.45f, -0.5f, -1f), (-135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "BLS_BIRD_7", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.5f, -0.25f, -1f), (-145f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 7, "BLS_BIRD_8", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "BLS_BIRD_9", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 9, "BLS_BIRD_10", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -0.75f, -1f), (50f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 10, "BLS_BIRD_11", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0.5f, -1f), (0f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 11, "BLS_BIRD_12", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.75f, 0.5f, -1f), (35f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_64(uParam0->f_20[iLocal_42], 1, 1);
				freeze_entity_position(&(uParam0->f_20[iLocal_42]), true);
				task_start_scenario_at_position(&(uParam0->f_20[iLocal_42]), -830507952, uParam0->f_20[iLocal_42]->f_5, uParam0->f_20[iLocal_42]->f_8, 0, false, true, 0, -1f, false);
			}
			iLocal_42++;
			if (iLocal_42 >= 12)
			{
		...
		case 2:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				while (iVar1 <= 11)
				{
					...
					{
						func_66(&(uParam0->f_20[iVar1]), get_offset_from_entity_in_world_coords(&(uParam0->f_20[iVar1]), 0f, 0f, 4.5f), uParam0->f_486.f_2, 32, 1073741824);
						freeze_entity_position(&(uParam0->f_20[iVar1]), false);
						force_ped_motion_state(&(uParam0->f_20[iVar1]), -1299979036, true, 0, false);
						open_sequence_task(&iVar0);
						task_fly_to_coord(0, 3f, get_offset_from_entity_in_world_coords(&(uParam0->f_20[iVar1]), 0f, 2.5f, 0f), 0, 0);
						task_fly_away(0, Global_35);
						close_sequence_task(iVar0);
						task_perform_sequence(&(uParam0->f_20[iVar1]), iVar0);
						set_ped_keep_task(&(uParam0->f_20[iVar1]), true);
...
bool func_62(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_96(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_103(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
void func_66(int iParam0, vector3 vParam1, float fParam4, int iParam5, float fParam6)
{
	...
	if (func_110(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		...
		if (is_ped_on_vehicle(iVar1, false))
		{
			...
			if (does_entity_exist(iVar0) && !is_entity_dead(iVar0))
			{
				...
				func_66(iVar0, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
		else if (is_ped_on_mount(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_66(iVar2, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
	}
...
bool func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_113(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_113(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_114(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_96(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_134(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_135(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
float func_103(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_160(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_172(1) || *uParam0 & 8192 != 0))
				{
...
bool func_132(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_185(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_183(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_184(uParam2)
				{
					func_179(uParam2, 1);
					return true;
				}
...
bool func_133(int iParam0, var uParam1)
{
	...
	if (func_175(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_184(uParam1)
		{
...
void func_158(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_210(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_210(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_210(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_159(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_113(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_198(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
int func_204(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_198(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
