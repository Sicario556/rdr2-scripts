...
{
	return (_is_anim_scene_loaded(uParam0->f_2, true, false) && _text_database_has_loaded("WNT2AUD"));
}
...
void func_19(var uParam0)
{
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		uParam0->f_2 = _create_anim_scene("script@story@wnt1@wnt1_to_wnt2", 2, "PL_HouseExt", false, true);
		load_anim_scene(uParam0->f_2);
	}
	_text_database_request("WNT2AUD");
}
...
int func_21(var uParam0)
{
	...
	{
		if (does_entity_exist(func_43(13)))
		{
			set_anim_scene_entity(uParam0->f_2, func_44(func_43(13)), func_43(13), 0);
		}
...
void func_27(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_53(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_28(iParam0, 1, 0);
		}
	}
...
void func_28(int iParam0, int iParam1, bool bParam2)
{
	...
	func_54(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_43(iParam0), 137, true);
	}
}
...
void func_37(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_43(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_43(iParam0), 204, false);
	}
}
...
void func_57(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_43(iParam0)))
		{
...
int func_63(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_70(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_72(iParam0);
					_0x7b204f88f6c3d287(func_73(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_73(iParam0, 0));
					func_74(iParam0);
				}
			}
			else
...
float func_70(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_80(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_71(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_81(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_73(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_82(iParam0);
	}
