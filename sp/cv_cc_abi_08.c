...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.275f, -0.1f, 0f, -16f, 5.855f, 3f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, "script@vignette@abigail_8@base", 1, 1, 0, 0);
	iLocal_16 = func_152(uParam0, "script@vignette@abigail_8@action_a", 2, 0, 1, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@abigail_8@action_b", 0, 0, 0, 0);
	iLocal_18 = func_152(uParam0, "script@vignette@abigail_8@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = func_152(uParam0, "script@vignette@abigail_8@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_152(uParam0, "script@vignette@abigail_8@action_b_alt_right", 0, 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 1, 2087366558, 0, -1, 0, 90f, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1.5f, 1f, 10f);
	func_155(uParam0, iLocal_15, 1, 6, 0, 0, 0);
	func_156(uParam0, iLocal_15, 1, 600);
	func_157(uParam0, iLocal_15, 1, 830847823, 0, -1, 0, -1073741824, 1065353216, 1);
...
void func_158(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(747937920, 1) && !func_390((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
