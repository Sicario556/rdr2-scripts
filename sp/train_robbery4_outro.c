...
{
	_0x1b3c2d961f5fc0e1("script@Story@FIN1@ride_to_beavers");
	prefetch_srl("script@cme@FIN1_CME_SHOT1_srl");
	_0xd9f2ff4af394d926();
	_0xae00387e53b1e9fc();
	return 1;
}
...
{
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key(&((*Global_1835011)[59]->f_3))) > 0)
	{
		end_srl();
		return true;
	}
...
void func_27(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_47(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_28(iParam0, 1, 0);
		}
	}
...
void func_28(int iParam0, int iParam1, bool bParam2)
{
	...
	func_48(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_51(iParam0), 137, true);
	}
}
...
void func_37(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_51(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_51(iParam0), 204, false);
	}
}
...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_51(iParam0);
	if (((does_entity_exist(iVar1) && func_53(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_52(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_51(iParam0)))
		{
...
int func_58(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_43(iParam0))
	{
		return 0;
	...
	if (func_32(iVar0, 0))
	{
		...
		if ((bParam1 || !func_55(iParam0)) || func_56(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_64(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_66(iParam0);
					_0x7b204f88f6c3d287(func_67(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_67(iParam0, 0));
					func_68(iParam0);
				}
			}
			else
...
float func_64(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_74(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_65(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_75(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_67(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_76(iParam0);
	}
