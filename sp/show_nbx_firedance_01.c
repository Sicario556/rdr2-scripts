...
void func_27(int iParam0)
{
	...
	iParam0->f_58[1] = 459594226;
	iParam0->f_58[3] = -1303647802;
	iParam0->f_58[2] = -1649218257;
	...
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@fire_performer@act1_p1@action", 2, 0, false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (11 - 1))
	{
		iVar1 = iVar0;
		vLocal_1141.f_2[iVar0] = get_hash_key(func_156(iVar1));
		iVar0++;
	}
...
void func_63(int iParam0)
{
	...
	switch (iVar1138)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (_is_anim_scene_started(iParam0->f_48, false) && _get_anim_scene_progress(iParam0->f_48) > 0.95f)
			{
	...
	switch (iParam0->f_3)
	{
		case 0:
			if (bVar0)
			{
				if (!does_cam_exist(iParam0->f_4))
				{
					iParam0->f_4 = create_camera_with_params(26379945, func_237(iParam0->f_1, 0), func_238(iParam0->f_1, 0), get_final_rendered_cam_fov(), false, 2);
				}
		...
		case 3:
			...
			if (is_control_just_pressed(2, -1496944061))
			{
				...
				set_cam_coord(iParam0->f_4, func_237(iParam0->f_1, iParam0->f_8));
				set_cam_rot(iParam0->f_4, func_238(iParam0->f_1, iParam0->f_8), 2);
			}
...
{
	func_255(func_254(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}
...
bool func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_260((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_260((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
void func_166(int iParam0)
{
	...
	{
		iParam0->f_66[0] = create_object(&(iParam0->f_58[0]), 2543.663f, -1308.578f, 49.0058f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[1])))
	{
		iParam0->f_66[1] = create_object(&(iParam0->f_58[1]), 2548.551f, -1308.547f, 48.2211f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[2])))
	{
		iParam0->f_66[2] = create_object(&(iParam0->f_58[2]), 2553.659f, -1313.054f, 48.2166f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[3])))
	{
		iParam0->f_66[3] = create_object(&(iParam0->f_58[3]), 2543.673f, -1308.602f, 48.2201f, true, true, false, false, true);
	}
...
void func_167(int iParam0)
{
	...
	set_anim_scene_entity(iParam0->f_48, "lantern", &(iParam0->f_66[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "BATON", &(iParam0->f_66[2]), 0);
...
void func_185(var uParam0, int iParam1)
{
	if (does_entity_exist(*uParam0))
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_274(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_274(), 2, 0, 0);
		}
	}
}
...
void func_212(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar5 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			{
				if (func_282(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 != 5)
				{
					(*uParam1)[iVar5]->f_1 = 5;
				}
			}
			else if (func_282(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 == 5)
			{
			...
			if ((!uParam0->f_19 && !func_282(*uParam0, iVar5)) && (*uParam1)[iVar5]->f_1 != 5)
			{
				if ((*uParam1)[iVar5]->f_9)
				{
					fVar6 = func_286(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 > 2f || !func_287((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_9 = 0;
						uParam0->f_21 = 0;
						(*uParam1)[iVar5]->f_5 = 2;
						func_288((*uParam1)[iVar5], iParam2);
					}
				}
				else if (!uParam0->f_21 && (*uParam1)[iVar5]->f_1 != 6)
				{
					fVar6 = func_286(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 < 1.5f && func_287((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_5 = func_289(iVar5);
						func_288((*uParam1)[iVar5], iParam2);
						(*uParam1)[iVar5]->f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch ((*uParam1)[iVar5]->f_1)
			{
				...
				case 1:
					...
					{
						func_292((*uParam1)[iVar5], func_291(iParam2), 500);
					}
					break;
				case 3:
				...
				case 5:
					if (!uParam0->f_19)
					{
						func_294(uParam0, (*uParam1)[iVar5]);
					}
					break;
				case 6:
				...
				case 9:
					...
					{
						task_follow_nav_mesh_to_coord(uParam1[iVar5], func_295(iParam2), 1f, -1, 0.25f, 5373953, 40000f);
						_0x2208438012482a1a(uParam1[iVar5], false, false);
						(*uParam1)[iVar5]->f_1 = 10;
					}
					break;
				case 10:
					...
					else if (!func_296(get_entity_coords(uParam1[iVar5], true, false)))
					{
					...
					else if (get_script_task_status(uParam1[iVar5], 713668775, true) != 1 && fVar2 > (func_285(iParam2, iVar5) + 3f))
					{
						(*uParam1)[iVar5]->f_1 = 9;
					}
					break;
...
int func_222(int iParam0, var uParam1)
{
	...
	_uiprompt_set_group((*Global_1945938)[func_297(&(iParam0->f_1053[1]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	if (!func_229(iParam0->f_1053[0], uParam1, "SHOW_NEG_RESPONSE", 648122183))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_297(&(iParam0->f_1053[0]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	return 1;
}
...
void func_227()
{
	...
	bVar0 = false;
	if (is_ped_active_in_scenario(Global_35, 1) || (func_306(36) && _0x3ab6c7b0bb0df4b1(Global_35, -1)))
	{
		bVar0 = true;
	}
	if (!bVar0)
	{
		task_play_anim(Global_35, func_157(), func_310(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_157(), func_310(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
void func_234(int iParam0)
{
	...
	{
		iVar1 = iVar0;
		if (has_anim_event_fired(&(iParam0->f_81[0]), &(vLocal_1141.f_2[iVar1])))
		{
			if (iVar1 == 1)
			{
...
void func_255(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = round(func_333(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_340(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_341(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_342(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_343(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_344(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_345(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_346(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_347(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_348(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_349(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_350(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_351(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_352(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_353(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_354(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_355(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 4:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_356(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_357(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_358(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_359(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 5:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_360(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_361(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_362(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_363(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 6:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_364(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_365(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_366(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_367(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 7:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_368(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_369(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_370(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_371(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 8:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_372(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_373(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_374(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_375(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 9:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_376(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_377(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_378(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_379(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 10:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_380(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_381(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_382(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_383(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 11:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_384(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_385(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_386(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_387(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 12:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_388(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_389(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_390(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_391(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 13:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_392(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_393(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_394(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_395(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 16:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_396(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_397(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_398(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_399(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 17:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_400(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_401(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_402(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_403(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 18:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_404(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_405(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_406(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_407(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 20:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_408(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_409(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_410(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_411(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 21:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_412(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_413(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_414(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_415(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 19:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_416(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_417(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_418(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_419(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 22:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_420(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_397(get_random_int_in_range(0, func_339(16, iParam1, iParam2)));
						case 2:
							return func_398(get_random_int_in_range(0, func_339(16, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_421(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 23:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_422(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_423(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_424(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_425(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 24:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_426(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_427(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_428(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_429(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 25:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_430(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_431(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_432(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_433(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		...
		case 27:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_434(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_435(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_436(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_437(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 28:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_438(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_435(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_436(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_439(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 29:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_440(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_435(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_436(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_441(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 30:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_442(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_435(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_436(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_443(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 31:
			break;
		case 32:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_444(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_445(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 33:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_446(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_447(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 34:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_448(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_449(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 14:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_450(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_451(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_452(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_453(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
		case 15:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_454(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 1:
							return func_451(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
						case 2:
							return func_452(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_455(get_random_int_in_range(0, func_339(iParam0, iParam1, iParam2)));
			}
			break;
	}
	return "FAIL";
...
int func_284(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return 1;
		case 0:
			if (func_456((*Global_1835011)[36]->f_1))
			{
				return 0;
			}
			else
...
void func_288(int* iParam0, int iParam1)
{
	if ((does_entity_exist(*iParam0) && !iParam0->f_9) && iParam0->f_5 != -1)
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_274(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_274(), 2, 0, 0);
		}
	}
	if (!iParam0->f_9)
	{
...
void func_320(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_318(iParam0))
	{
