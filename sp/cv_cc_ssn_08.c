...
{
	if (!_is_scenario_group_enabled_hash(iLocal_21))
	{
		_set_scenario_group_enabled_hash(iLocal_21, true);
	}
	return true;
}
...
{
	_set_scenario_group_enabled_hash(iLocal_21, false);
	return true;
}
...
bool func_95(var uParam0)
{
	...
	if (!is_sphere_visible(vLocal_18, 1f))
	{
		_set_scenario_group_enabled_hash(iLocal_21, true);
		return true;
	}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_249(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_249(uParam0, uParam0->f_1976.f_1), 1, func_250(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_263(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_249(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(747937920, 1) && !func_383((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
