...
{
	func_33(uParam0, 11167, 11226, 11793);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "RLA_ANIMAL", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), iVar0, 1, 0, 1, iLocal_11, 1);
}
...
int func_31(var uParam0)
{
	if (*uParam0 == 190)
	{
		if (!&uParam0->f_469[1])
		{
			if (func_63(uParam0, &uLocal_12, 0) || func_64(&(uParam0->f_20[0]), Global_35, 1) <= 9f)
			{
				func_65(uParam0);
				func_66(uParam0);
				uParam0->f_469[1] = 1;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_67(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				if ((*uParam0 == 129 || *uParam0 == 178) || *uParam0 == 190)
				{
					task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_40, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, true, true, 0, -1f, false);
				}
				else
				{
					task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_40, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
				}
		...
		case 1:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					_0xe8c296b75eacc357(&(uParam0->f_20[0]), 0f);
					...
					else
					{
						...
						{
							task_stand_still(&(uParam0->f_20[0]), floor((5f * 1000f)));
						}
						func_70(&uLocal_41);
						iLocal_10 = 3;
					}
		...
		case 2:
			...
			break;
		case 3:
			if (func_71(&uLocal_41, 5f) && !is_ped_using_any_scenario(&(uParam0->f_20[0])))
			{
				return 1;
			}
			break;
...
float func_64(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_101(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
