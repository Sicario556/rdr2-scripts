...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_156(uParam0, -447184114, 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	func_156(uParam0, -1006095118, 1.20486f, -1.61288f, 0.00105286f, "CHAIR", 1, 0, 1);
	iLocal_16 = func_156(uParam0, 1600083684, 0f, 0f, 0f, 0, 1, 0, 1);
	if (!func_151(14))
	{
	...
	func_162(uParam0, iLocal_14, 1, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_163(uParam0, iLocal_14, iLocal_17, "p_cigar02x_PH_R_HAND", 0, 0);
	func_164(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_161(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0);
	func_162(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0, -1073741824, 1065353216, 1);
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_254(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_286(var uParam0, int iParam1)
{
	...
	else if (!func_344(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_305(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_350(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_314(var uParam0, int iParam1)
{
	...
	{
		if (!func_344(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
int func_341(int iParam0, bool bParam1)
{
	...
	{
		func_244(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_232() == -1)
		{
...
void func_389(var uParam0, int iParam1)
{
	...
	func_420(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_390(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_423(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_397(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_430(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_428();
				}
			}
			...
			func_431((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_440((*Global_1360165)[iParam0]->f_4.f_2) || func_441((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_442((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_444(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_408(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_449(Global_35) && is_player_teleport_active())
	{
	}
	if (func_450(iParam0))
	{
		if (func_451(get_ped_index_from_entity_index(iParam0)))
		{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_400((*Global_1347702)[63]->f_15, 1) || func_441((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_400((*Global_1347702)[134]->f_15, 1) || func_441((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(747937920, 1) && !func_400((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
