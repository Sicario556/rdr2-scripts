void __EntryFunction__()
{
	...
	Var0 = Local_78;
	Var0.f_1 = Local_78.f_11;
	Var0.f_483 = { Local_78.f_1 };
	Var0.f_486 = { Local_78.f_4 };
	Var0.f_489 = Local_78.f_7;
	Var0.f_20[0] = Local_78.f_8;
	Var0.f_453 = Local_78.f_9;
	Var0.f_500 = Local_78.f_10;
	Var0.f_503 = Local_78.f_12;
	func_2(&Var0);
...
{
	func_34(uParam0, 11350, 11485, 12638);
}
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar0 = func_49(func_48(), 1, 1, 0, 1, 0, 0);
	iVar1 = 1;
	switch (*uParam0)
	{
		case 67:
	...
	func_51(uParam0, 0, "MPDHP_HORSE", iLocal_70, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MPDHP_MAN", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	if (*uParam0 != 71)
	{
		func_51(uParam0, 2, "WHCDP_ANIMAL", iLocal_69, _get_object_offset_from_coords(vParam1, vParam4.z, -3f, 0f, 0f), (10f + vParam4.z), iVar1, 1, 1, 1, iLocal_68, 1);
	}
}
...
int func_19(var uParam0)
{
	if (*uParam0 == 71)
	{
		if (_is_metaped_outfit_request_valid(iLocal_74))
		{
			if (!_0x610438375e5d1801(iLocal_74))
			{
				return 0;
			}
		}
...
int func_32(var uParam0)
{
	...
	{
		set_ped_reset_flag(&(uParam0->f_20[1]), 42, true);
	}
	if (!&uParam0->f_469[1])
	{
		if ((get_frame_count() % 2) == 0)
		{
			if (func_71(&(uParam0->f_20[1]), 0, &uLocal_11, &uVar0, 0, 0))
			{
				uParam0->f_469[1] = 1;
			}
		}
		else if (func_71(&(uParam0->f_20[0]), 0, &uLocal_39, &uVar1, 0, 0))
		{
			uParam0->f_469[1] = 1;
		}
		if (&uParam0->f_469[1])
	...
	switch (iLocal_9)
	{
		case 0:
			if (*uParam0 == 71)
			{
				if (!_0xa0bc8faed8cfeb3c(&(uParam0->f_20[0])))
				{
					return 0;
				}
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					...
					set_ped_config_flag(&(uParam0->f_20[0]), 442, true);
					func_73(uParam0->f_20[1], 0, 1);
					func_74(&uLocal_11, &(uParam0->f_20[1]), &(uParam0->f_20[0]), 0);
					if (*uParam0 == 71)
					{
						if (!is_entity_dead(&(uParam0->f_20[0])))
						{
							_set_ped_body_component(&(uParam0->f_20[0]), iLocal_67);
							_update_ped_variation(&(uParam0->f_20[0]), false, true, true, true, false);
							set_ped_config_flag(&(uParam0->f_20[0]), 388, true);
							set_ped_config_flag(&(uParam0->f_20[0]), 136, true);
							set_ped_config_flag(&(uParam0->f_20[0]), 209, true);
							set_ped_config_flag(&(uParam0->f_20[0]), 214, true);
							set_ped_config_flag(&(uParam0->f_20[0]), 419, true);
							_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[0]), 5, 0, 1);
							_0xa3db37edf9a74635(get_player_index(), &(uParam0->f_20[0]), 27, 0, 1);
							_0xae6004120c18df97(&(uParam0->f_20[0]), 0, 0);
						}
					}
					else if (!is_entity_dead(&(uParam0->f_20[2])))
					{
						func_73(uParam0->f_20[2], 1, 1);
						apply_ped_damage_pack(&(uParam0->f_20[2]), sLocal_71, 1f, 1f);
						task_carriable(&(uParam0->f_20[2]), iLocal_10, &(uParam0->f_20[0]), 0, 0);
						func_75(&(uParam0->f_20[0]), &(uParam0->f_20[2]));
						set_ped_config_flag(&(uParam0->f_20[2]), 517, true);
					}
					if (*uParam0 != 46 && *uParam0 != 53)
					{
						task_follow_and_converse_with_ped(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0, 0, 3f, 3f, 160, 2f, -2.5f, 1069547520, 1073741824);
					}
					set_ped_keep_task(&(uParam0->f_20[0]), true);
				}
				remove_all_ped_weapons(&(uParam0->f_20[1]), true, true);
				_give_weapon_to_ped_2(&(uParam0->f_20[1]), -183018591, 999, bLocal_72, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				if (*uParam0 == 53 || *uParam0 == 46)
				{
					set_current_ped_weapon(&(uParam0->f_20[1]), -1569615261, true, 0, false, false);
				}
				func_74(&uLocal_11, &(uParam0->f_20[1]), &(uParam0->f_20[0]), 0);
				func_76(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				if (*uParam0 == 46 || *uParam0 == 53)
				{
					func_77(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1, -1, 1);
				}
				func_78(&(uParam0->f_20[1]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 34, 1073741824);
				_task_move_in_traffic(&(uParam0->f_20[1]), 1f, 128, 0);
			}
			iLocal_9 = 1;
			break;
		case 1:
...
int func_33(var uParam0, var uParam1)
{
	...
	if (*uParam0 == 71)
	{
		if (_is_metaped_outfit_request_valid(iLocal_74))
		{
			_release_metaped_outfit_request(iLocal_74);
		}
	}
	return 1;
}
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, var uParam12, var uParam13)
{
...
void func_52(var uParam0)
{
	if (uParam0->f_489 == 0)
	{
		uParam0->f_489 = get_random_int_in_range(0, 5);
	}
	...
	iLocal_74 = _request_metaped_outfit(iLocal_70, iLocal_67);
}
...
bool func_71(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_115(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_78(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_148(Global_35) && is_player_teleport_active())
	{
	}
	if (func_149(iParam0))
	{
		if (func_150(get_ped_index_from_entity_index(iParam0)))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_156(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_82(var uParam0, float fParam1)
{
	if (!func_80(uParam0))
	{
		return false;
...
bool func_87(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_162(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_88(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_163(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_115(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
bool func_118(var uParam0, int iParam1, var uParam2)
{
...
bool func_119(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_162(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_217(int iParam0)
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_252(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_252(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_252(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_218(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_219(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4)
{
...
int func_221(int iParam0)
{
	...
	func_219(iParam0, &iVar1, &uVar2, &iVar0, &uVar3);
	func_220(&iVar4, iParam0, iVar0, iVar1);
	if (iVar4 != 0)
	{
		return iVar4;
	}
...
struct<4> func_223(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	if (!func_144(iParam1, 0))
	{
		return Var0;
...
bool func_226(int iParam0)
{
	...
	return func_251((*Global_1347702)[iParam0]->f_15, 1);
}
...
bool func_239(bool bParam0, int iParam1, int iParam2)
{
...
void func_252(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
bool func_263(int iParam0, int iParam1, int iParam2, bool bParam3)
{
