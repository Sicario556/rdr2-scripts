...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_155(uParam0, "script@vignette@bill_14@action", 0, 0, 1, 0);
...
{
	return _has_scenario_type_loaded(-1666245605, false);
}
...
{
	_0x669655ffb29ef1a9(func_195(uParam0, iLocal_22), 0, "Stew_Fill", 1f);
	_0x669655ffb29ef1a9(func_195(uParam0, iLocal_23), 0, "Stew_Fill", 1f);
	return true;
}
