void __EntryFunction__()
{
	...
	while (!func_5(&Local_60, 1))
	{
		...
		if (((((func_6(&Local_60) >= 5 && func_6(&Local_60) <= 7) && !func_5(&Local_60, 4096)) && _does_anim_scene_exist(Local_60.f_428.f_444)) && _is_anim_scene_started(Local_60.f_428.f_444, false)) && !_is_anim_scene_paused(Local_60.f_428.f_444))
		{
		...
		switch (func_6(&Local_60))
		{
			...
			case 3:
				...
				func_39(&Local_60);
				if (func_40(func_32((*Global_1835011)[Local_60]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_60.f_428)) == 4 && _does_anim_scene_exist(Local_60.f_428.f_444)) && _is_anim_scene_paused(Local_60.f_428.f_444))
				{
					func_37(Local_60);
					func_17(&Local_60, 7);
				}
...
{
	if (!has_model_loaded(574905658))
	{
		return false;
	}
	if (!has_model_loaded(-58075500))
	{
		return false;
	}
	...
	decor_set_int(&(iLocal_37[0]), func_140(), 0);
	decor_set_int(&(iLocal_37[1]), func_140(), 1);
	decor_set_int(&(iLocal_37[2]), func_140(), 2);
	decor_set_int(&(iLocal_37[3]), func_140(), 3);
	decor_set_int(&(iLocal_37[4]), func_140(), 4);
	decor_set_int(&(iLocal_37[5]), func_140(), 5);
	func_141(-1, 1);
	func_131(iParam0, Global_35, 0, 0, 0, 1);
	...
	while (iVar8 < 35)
	{
		if (does_entity_exist(&(iParam0->f_428.f_13[iVar8])))
		{
		}
		iVar8++;
	}
...
void func_36(int iParam0)
{
	...
	if (!is_entity_dead(&(iLocal_37[0])))
	{
		func_153(&(iLocal_37[0]), 0, 1, 0, 0);
	}
	if (!is_entity_dead(&(iLocal_37[1])))
	{
		func_153(&(iLocal_37[1]), 3, 1, 0, 0);
	}
	if (!is_entity_dead(&(iLocal_37[2])))
	{
		func_153(&(iLocal_37[2]), 2, 1, 0, 0);
	}
	if (!is_entity_dead(&(iLocal_37[3])))
	{
		func_153(&(iLocal_37[3]), 6, 1, 0, 0);
	}
	if (!is_entity_dead(&(iLocal_37[4])))
	{
		func_153(&(iLocal_37[4]), 7, 1, 0, 0);
	}
	if (!is_entity_dead(&(iLocal_37[5])))
	{
		func_153(&(iLocal_37[5]), 9, 1, 0, 0);
	}
	if (!is_entity_dead(iLocal_44))
	{
...
int func_39(int iParam0)
{
	if (!bLocal_47)
	{
		...
		{
			set_ped_cloth_package_index(&(uLocal_25[7]), 2);
			bLocal_47 = true;
		}
	}
	return 0;
...
{
	if (!is_entity_dead(&(uLocal_25[9])))
	{
		func_164(&(uLocal_25[9]), func_137(0, 7), 2, 1073741824);
		_task_use_nearest_scenario_to_coord(&(uLocal_25[9]), func_165(0, 7), 0.5f, 0, true, false, true, false);
		func_166(14, 0, 0, 0, -1082130432, 1, 1, 0, 0, 0, 0);
	}
	if (!is_entity_dead(&(uLocal_25[10])))
	{
		func_164(&(uLocal_25[10]), func_137(0, 8), 2, 1073741824);
		_task_use_nearest_scenario_to_coord(&(uLocal_25[10]), func_165(0, 8), 0.5f, 0, true, false, true, false);
		func_166(13, 0, 0, 0, -1082130432, 1, 1, 0, 0, 0, 0);
	}
	if (!is_entity_dead(&(uLocal_25[7])))
	{
		func_164(&(uLocal_25[7]), func_137(0, 6), 2, 1073741824);
		_task_use_nearest_scenario_to_coord(&(uLocal_25[7]), func_165(0, 6), 0.5f, 0, true, false, true, false);
...
bool func_128(int iParam0)
{
	...
	{
		iLocal_45 = _create_volume_box_with_custom_name(-1322.002f, 2438.58f, 310.0346f, 0f, 0f, 63.87532f, 5.37963f, 11.61077f, 3.068966f, "wnt4_intro_blocker");
	}
	if (!_does_volume_exist(iLocal_46))
	{
		iLocal_46 = _create_volume_box_with_custom_name(-1317.72f, 2436.48f, 309.8263f, 0f, 0f, 63.87532f, 4.75f, 2.25f, 2.75f, "wnt4_actual_blocker");
	...
	if (bVar0)
	{
		...
		func_275(11, 1, 1, 1, 0);
		func_275(22, 1, 1, 1, 0);
		request_model(574905658, false);
		request_model(-58075500, false);
...
void func_129(int iParam0)
{
	...
	{
		vLocal_14.x = create_itemset(true);
	}
}
...
void func_138(int iParam0, int iParam1, struct<4> Param2, int iParam6)
{
	...
	set_blocking_of_non_temporary_events(&(uLocal_25[iParam1]), false);
...
void func_139(int iParam0, int iParam1, struct<4> Param2, char* sParam6)
{
	...
	{
		if (_is_mount_seat_free(*iParam1, -1))
		{
...
void func_141(int iParam0, bool bParam1)
{
	...
	{
		vLocal_14.f_2[0] = create_object(574905658, -1360.125f, 2409.968f, 306.2463f, true, true, false, false, true);
		set_entity_rotation(&(vLocal_14.f_2[0]), 0f, 0f, 136.891f, 2, true);
...
bool func_160(int iParam0)
{
	...
	return func_319((*Global_1347702)[iParam0]->f_15);
}
...
void func_166(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (bParam3)
	{
		...
		func_332(iParam0, 1056964608, -1, 1061158912);
...
void func_234(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_410(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_324(iVar1, func_410(uParam0), func_411(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_324(iVar3, func_410(uParam0), func_411(uParam0), 2, 1073741824);
		}
	}
}
...
void func_235(var uParam0)
{
	if ((func_83(uParam0, 268435456) && !func_90(func_410(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		...
		if (!is_entity_dead(iVar0))
		{
			...
			func_324(iVar0, vVar1, func_412(vVar1, Global_36, 1), 2, 1073741824);
...
bool func_251(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_444(iParam2, 1024))) || func_444(iParam2, 8)) && !func_320(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_445(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_444(iParam2, 4096)) && !func_320(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_445(uParam1, 2048);
			func_445(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_444(iParam2, 32)) && !func_320(*uParam1, 5632))
		{
...
int func_263(var uParam0, int iParam1)
{
	...
	if (func_147())
	{
		...
		if (func_450(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_451(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_299(uParam0, 8) && _0xdd0b7c5ae58f721d(func_452()))
	{
		_0x798be43c9393632b(func_452());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_452())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
int func_271(var uParam0, int iParam1)
{
	...
	if (*iParam1)
	{
		if (bVar0 && !func_461((*Global_1835011)[4]->f_1, 1))
		{
			if (func_462(5))
			{
				func_463(5);
	...
	if ((bVar0 && func_461((*Global_1835011)[37]->f_1, 1)) && !func_461((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_461((*Global_1835011)[43]->f_1, 1)) && !func_461((*Global_1835011)[44]->f_1, 1))
	{
		if (iParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
{
	if ((((does_entity_exist(func_484(iParam2)) && _0x3ab6c7b0bb0df4b1(func_484(iParam2), -1)) && _does_anim_scene_exist(Global_43800)) && _is_anim_scene_started(Global_43800, false)) && !_0xef324e9550a394d5(Global_43800))
	{
		return false;
	}
...
void func_275(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((does_entity_exist(iVar1) && func_486(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_289(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_509(), true);
	}
}
...
int func_311(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_158(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_520(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_522(iParam0);
					_0x7b204f88f6c3d287(func_523(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_523(iParam0, 0));
					func_524(iParam0);
				}
			}
			else
...
void func_324(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_320(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_320(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_320(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_320(iParam5, 32), true);
	...
	else if (func_320(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_320(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_320(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_326(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_533(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_327(int iParam0, int iParam1, bool bParam2)
{
	...
	func_534(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_372(struct<4> Param0)
{
	...
	if (func_551(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_551(20))
			{
				return;
			}
			iVar0++;
...
void func_401()
{
	...
	if (func_414(iVar0))
	{
		...
		{
			func_566(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
bool func_432(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_586(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_586(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_588(iParam0, iParam2, iParam1, func_252() != -1);
	if (bParam4)
	{
...
void func_448(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_600(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_464(int iParam0)
{
	...
	func_610(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_611(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_612(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_613(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_614(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_615(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_616(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_617(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_618(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_619(_get_map_zone_at_coords(vParam0, 10));
}
...
struct<6> func_481()
{
	if (func_636(-997150586, &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_636(-1189569496, &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_636(325139909, &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_636(1310070322, &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_636(986998820, &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_636(-415648720, &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_324(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
void func_506(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_163() || !_0x6f1f0b17109309da(Global_43800, func_209(iParam0))))
	{
...
char* func_510(int iParam0)
{
	...
	{
		return func_658(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_659(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
int func_521(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_666(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_523(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_667(iParam0);
	}
...
{
	return func_438(1328661203, func_679(), -1591664384, bParam0);
}
...
int func_582(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_581(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_686(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_397(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_581(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_686(&(Global_1946804->f_1497.f_1[iVar1])) || func_581(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_397(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_397(&(uParam0->f_1[iVar1])) || func_581(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_589(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_690(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_590(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_692(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_252() == -1)
	{
...
int func_626(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_460())
	{
		...
		{
			bVar0 = false;
			if (!func_461((*Global_1835011)[15]->f_1, 1) && !func_680(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_461((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_720();
				*iParam1 = func_721();
				*uParam2 = func_722();
...
bool func_634(int iParam0, var uParam1)
{
	...
	*uParam1 = func_733(Var0, 1415981582, 0);
...
bool func_635(int iParam0, var uParam1)
{
	...
	*uParam1 = func_733(Var0, -2119169513, 0);
	if (!func_396(*uParam1, 0))
	{
		return false;
	}
...
int func_642(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_305(iParam1);
	if ((!does_entity_exist(iVar0) || !func_158(iVar0, 0)) || (bParam3 && !func_307(iParam1)))
	{
		if (bParam2)
		{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_456((*Global_1360165)[iParam0]->f_4.f_2) || func_319((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_743((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_745(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_308(iParam0, 44, 1);
			}
...
void func_652(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_566(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_566(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
char* func_665(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_765(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_668(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_766(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_768(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_772((*Global_1900383)[iParam0]->f_26);
		func_773((*Global_1900383)[iParam0]->f_26);
		...
		while (iVar28 < 4)
		{
			...
			if (func_575(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_776(0))
				{
					...
					func_777(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_678(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_780("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_779(iParam1, 512) && func_681(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_782(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_779(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_779(iParam1, 4))) && (!func_782(Var4.f_4) || func_779(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_779(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_779(iParam1, 1048576)))
				{
...
void func_682(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_786(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_786(uParam0->f_2[iVar0], 1))
				{
					func_787(uParam0->f_2[iVar0], 2, 6);
				}
...
float func_698()
{
	...
	func_803(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_699()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_803(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_700()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_803(1, round((to_float(iVar8) * fVar10)), 0);
...
bool func_705(int iParam0, int iParam1)
{
	...
	Var29 = { func_438(iParam1, Var0, 1415981582, 0) };
...
bool func_706(int iParam0, int iParam1)
{
	...
	Var29 = { func_438(iParam1, Var0, -2119169513, 0) };
	return func_808(Var29, 1);
}
...
bool func_710(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_440(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_712(int iParam0)
{
	...
	if (func_815(get_entity_model(iParam0)))
	{
		return true;
	}
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_521(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_824(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_822();
				}
			}
			if ((bParam2 && !func_90(vVar0)) && !func_537(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_324((*Global_1360165)[iParam0]->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_825((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_521(iParam0, 1), get_hash_key(sVar12));
			}
...
int func_742(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_461((*Global_1347702)[63]->f_15, 1) || func_319((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_461((*Global_1347702)[134]->f_15, 1) || func_319((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_461((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_830(747937920, 1) && !func_461((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_752(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_748(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_748(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_748(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_748(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_748(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_748(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_748(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_748(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_748(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_748(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_748(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_748(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_748(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_748(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_748(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_748(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_748(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_748(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_748(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_748(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_748(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_748(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_748(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_748(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_748(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_748(iParam1, 1544915253))
	{
...
void func_766(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_836(func_835(255), 109029619));
	}
	else if (func_258())
	{
...
bool func_808(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_440(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_811(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_440(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_818(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_440(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
bool func_823(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_521(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_850(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_824(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_852(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
char* func_836(char* sParam0, int iParam1)
{
	...
	return func_857(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
int func_845(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	else
	{
		Var61 = { func_847(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_848(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return _0x033ee4b89f3ac545(func_440(bParam2), uParam0, iParam1);
}
...
bool func_856(int iParam0, int iParam1)
{
	...
	{
		return func_865(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
struct<28> func_858(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_440(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_847(&Var28) };
...
struct<17> func_860(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_440(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_847(&Var17) };
