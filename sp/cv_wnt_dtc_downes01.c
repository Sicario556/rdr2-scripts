...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_231(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_233(iParam0);
					_0x7b204f88f6c3d287(func_234(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_234(iParam0, 0));
					func_235(iParam0);
				}
			}
			else
...
void func_127(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_245(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_128(int iParam0, int iParam1, bool bParam2)
{
	...
	func_246(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_249(iParam0), 137, true);
	}
}
...
void func_135(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_249(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_249(iParam0), 204, false);
	}
}
...
void func_137(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_249(iParam0);
	if (((does_entity_exist(iVar1) && func_251(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_154(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_264(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_33(uParam0) < 5)
			{
				if (func_133(uParam0->f_107[iVar0]->f_1, 29, 1) || func_265(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_163(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	...
	{
		if (&uParam0->f_2051[iVar0] >= 0)
		{
		}
		else
		{
			StringCopy(&cVar1, sParam2, 64);
			uParam0->f_2051[iVar0] = iParam1;
			MemCopy(&(uParam0->f_2051[iVar0]->f_1), {cVar1}, 4);
			uParam0->f_2051[iVar0]->f_5 = iParam3;
			uParam0->f_2049++;
			return iVar0;
		}
		iVar0++;
...
bool func_170(int iParam0)
{
	...
	return func_277((*Global_1347702)[iParam0]->f_15, 1);
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_232(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_229(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_182(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_229(uParam0->f_107[iVar0]->f_8.f_3))
			{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_298(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_187(var uParam0, int iParam1)
{
	...
	func_304(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_305(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_188(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_306(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_189(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_308(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_191(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_309(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_311(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_197(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_311(uParam0, uParam0->f_1976.f_1), 1, func_313(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_199(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_314(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_201(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_229(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
				iVar0 = func_315(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_315(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_202(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_123() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_307() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
{
	iVar0 = &uParam0->f_2051[iParam1];
	if (iVar0 < 0)
	{
		return 0;
	}
	Var1 = { uParam0->f_2051[iParam1]->f_1 };
	iVar5 = &uParam0->f_1984[iVar0];
	if (!_does_anim_scene_exist(iVar5))
	{
		return 0;
	}
	if (!_is_anim_scene_loaded(iVar5, true, false))
	{
		return 0;
	}
	if (!_0xa9016536015de29d(iVar5, &Var1))
	{
		return 0;
	}
	if (!_0x23e33cb9f4a3f547(iVar5, &Var1))
	{
		return 0;
	}
	uParam0->f_2050 = iParam1;
	_set_anim_scene_playback_list_bool(iVar5, &Var1, bParam2);
	return 1;
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_329(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_330(uParam0->f_107[iVar0]->f_1, fVar4);
				func_329(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_216(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_339(100f, 140f);
			}
		}
...
void func_222(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_336(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
float func_231(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_337(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_250(int iParam0)
{
	if (func_55(iParam0))
	{
		if (does_entity_exist(func_249(iParam0)))
		{
...
bool func_263(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_276(iVar0) && func_351((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
int func_279(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_362(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_55(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_363(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_55(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_364(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_364(uParam0, 1, 0);
							}
						}
						if (!func_55(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_365(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_283(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_366(iVar1)))
			{
				func_367(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_368(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_290(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_311(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
bool func_296(var uParam0, var uParam1, bool bParam2)
{
	iVar0 = 60;
	if (bParam2)
	{
	...
	if (vdist2(Global_36, func_370(uParam0)) > func_371(uParam0))
	{
	...
	if (!bVar1)
	{
		if (vdist2(Global_36, func_373(func_159(uParam0))) <= 4f)
		{
...
bool func_302(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_315(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_315(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_323(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_383(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_362(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
int func_363(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	if (!func_114(iParam0))
	{
		return 0;
	}
	iVar1 = func_424(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!does_entity_exist(iVar1))
	{
		return 0;
	}
...
int func_367(int iParam0, bool bParam1)
{
	...
	{
		func_255(iParam0, _create_persistent_character(func_143(iParam0)));
		if (func_243() == -1)
		{
...
int func_368(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_376(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_384(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_385(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	if (is_entity_dead(iParam0))
	{
	}
...
bool func_393(var uParam0, var uParam1)
{
	...
	if (!func_399(uParam1->f_47.f_3))
	{
		...
		func_449(uParam1->f_47.f_3, _uiprompt_get_group_id_for_target_entity(iVar0), 0, 1);
	}
	if (is_any_speech_playing(Global_35))
	{
...
int func_397(var uParam0)
{
	...
	return (func_456() - round((uParam0->f_1 * 1000f)));
}
...
void func_402(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_330(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_406(var uParam0, int iParam1)
{
	...
	func_460(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_407(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_463(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_424(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	if (!func_114(iParam1))
	{
		return 0;
	...
	if ((!does_entity_exist(iVar0) || !func_131(iVar0, 0)) || (bParam3 && !func_56(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_468(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
bool func_427(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_277((*Global_1835011)[iParam0]->f_1, 1);
	}
...
bool func_429(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_114(iParam0))
	{
		return false;
...
int func_434(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_55(iParam0))
	{
		return 0;
		...
		case 6:
			if (func_131(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_305(Global_1360165[iParam0], 1);
				}
			}
			func_475(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_304(Global_1360165[iParam0]))
				{
				}
			}
...
int func_468(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	if (!func_114(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_232(iParam0, 1), &uVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_503(iParam0, vVar0, iParam6, iParam10))
				{
					return func_502();
				}
				if (func_131((*Global_1360165)[iParam0]->f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_504(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_502();
				}
			}
			if ((bParam2 && !func_229(vVar0)) && !func_230(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_478((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_505((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_232(iParam0, 1), get_hash_key(sVar12));
			}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_513((*Global_1360165)[iParam0]->f_4.f_2) || func_514((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_515((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_517(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_113(iParam0, 44, 1);
			}
...
void func_478(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_522(Global_35) && is_player_teleport_active())
	{
	}
	if (func_523(iParam0))
	{
		if (func_524(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_247(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_247(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_247(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_247(iParam5, 32), true);
	...
	else if (func_247(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_247(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_247(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_479(int iParam0, int iParam1)
{
	...
	bVar0 = func_525(iParam0, iParam1);
	return bVar0;
}
...
bool func_484(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_253(iParam0)))
	{
		return false;
	}
...
void func_493(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_490(iParam0, 8))
		{
...
bool func_503(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_232(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_306(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_504(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_534(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_505(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_249(iParam1)))
	{
		_0x931b241409216c1f(func_249(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_249(iParam1), iParam0);
...
int func_512(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_277((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_277((*Global_1347702)[63]->f_15, 1) || func_514((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_277((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_277((*Global_1347702)[134]->f_15, 1) || func_514((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_277((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_358(747937920, 1) && !func_277((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		case 8:
			switch (iParam0)
			{
				...
				case 7:
					...
					iVar1[0] = -1341683964;
					if (bParam3 && does_entity_exist(func_249(iParam0)))
					{
						iVar10 = 0;
						while (iVar10 < iVar7)
						{
...
void func_528(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_485(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_485(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_485(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_485(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_485(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_485(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_485(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_485(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_485(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_485(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_485(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_485(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_485(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_485(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_485(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_485(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_485(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_485(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_485(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_485(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_485(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_485(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_485(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_485(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_485(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_485(iParam1, 1544915253))
	{
...
int func_531(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_547(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_547(iVar0))
		{
	...
	{
		func_549(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_550(iParam0, &iVar0, &fVar25);
...
struct<4> func_559(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_577(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_560(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_577(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_561(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_577(bParam0));
}
...
void func_563(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_580(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_568(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_559(923904168, func_566(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_559(923904168, func_566(bParam0), -740156546, 0) };
		}
...
struct<4> func_570(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_559(271701509, func_566(bParam0), 12999093, 0) };
		}
...
bool func_573(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_577(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_574(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_577(bParam6), &Var0, 0);
	return uVar4;
}

bool func_575(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_577(0);
