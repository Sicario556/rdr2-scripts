		...
		if (get_game_timer() > iLocal_75)
		{
			...
			switch (iLocal_74)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_76));
					...
					Global_1897950 = -1;
					iLocal_77 = (get_game_timer() + iLocal_73);
					iLocal_74 = 2;
					break;
				case 2:
					if (func_11() || iLocal_77 < get_game_timer())
					{
						func_12(iLocal_76);
						iLocal_77 = (get_game_timer() + iLocal_73);
						iLocal_74 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_76) || iLocal_77 < get_game_timer())
					{
						func_14(iLocal_76);
						iLocal_77 = (get_game_timer() + iLocal_73);
						iLocal_74 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_76) || iLocal_77 < get_game_timer())
					{
						func_16(iLocal_76);
						iLocal_77 = (iLocal_73 + get_game_timer());
						iLocal_74 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_76)))
					{
						if (func_17(func_6(iLocal_76), 4) && !iLocal_77 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_76) || iLocal_77 < get_game_timer())
							{
								func_19(iLocal_76, 4);
								iLocal_77 = (iLocal_73 + get_game_timer());
								iLocal_74 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_77 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_76);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_76]->f_10);
							if ((*Global_1888801)[iLocal_76]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_76]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_76]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_76]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_47(int iParam0, int iParam1)
{
	...
	{
		case 3:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[0];
		case 0:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[1];
		case 2:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[3];
		case 1:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[4];
		case 4:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[8];
		case 5:
			return func_84(iParam0, iParam1) >= &(*Global_1310750)[iParam0]->f_64[13];
	}
	return false;
}
...
bool func_49(int iParam0, int iParam1, float fParam2)
{
	if (!func_85(iVar0))
	{
...
int func_52(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!_does_volume_exist(func_91(iParam3)))
	{
		return 0;
	}
	if (!is_entity_in_volume(Global_35, func_91(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if (iParam7 && func_96(get_player_index(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
bool func_63(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_108(iParam0));
}
...
void func_81(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_141(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
bool func_89(int iParam0, float fParam1)
{
...
bool func_94(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_93(vParam0))
	{
		return false;
...
bool func_95(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_151(&(Global_1898164->f_1[0]));
		if (func_152(iVar0) && func_153((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
int func_106(int iParam0, bool bParam1)
{
	...
	{
		func_160(iParam0, _create_persistent_character(func_159(iParam0)));
		if (func_20() == -1)
		{
			if (func_142(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_161(iParam0));
				func_162(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_161(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_161(iParam0)))
	{
		func_162(iParam0, 128);
		return 1;
	}
	func_160(iParam0, _create_persistent_character(func_159(iParam0)));
	_0x4f81ead1de8fa19b(func_161(iParam0));
	if (func_142(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_161(iParam0));
		func_162(iParam0, 2048);
...
char* func_122(char* sParam0, int iParam1)
{
	...
	return func_171(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_125(int iParam0)
{
	...
	if (func_172())
	{
		if (!func_173((*Global_1835011)[3]->f_1, 1))
		{
...
void func_136(int iParam0)
{
	...
	if (!func_130(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_177(Global_1935369->f_5[iParam0]->f_6, 1);
	func_178(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_104(Global_1914319->f_3[iParam0]->f_21) && func_180(Global_1914319->f_3[iParam0]->f_21))
	{
		func_181(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_182(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_141(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
int func_143(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_0xfc77c5b44d5ff7c0(func_161(iParam0));
	func_160(iParam0, 0);
	return 1;
}
...
{
	func_211(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
bool func_207(vector3 vParam0, int iParam3)
{
