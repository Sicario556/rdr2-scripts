...
void func_8(var uParam0)
{
	...
	{
		if (!_does_volume_exist(&(Local_24.f_12[0])))
		{
			return;
		}
		if (!_does_volume_exist(&(Local_24.f_12[1])))
		{
			return;
		}
		if (_does_volume_exist(&(Local_24.f_12[2])))
		{
			if (is_entity_in_volume(Global_35, &(Local_24.f_12[2]), true, 0))
			{
		...
		{
			if (_does_volume_exist(&(Local_24.f_12[3])))
			{
				if (is_entity_in_volume(Global_35, &(Local_24.f_12[3]), true, 0))
				{
	...
	switch (Local_24)
	{
		case 0:
			...
			if (Local_24.f_1 == 2082228755)
			{
				Local_24.f_1 = 1632247697;
			}
			request_ptfx_asset();
		...
		case 2:
			...
			else if (is_entity_in_volume(Global_35, &(Local_24.f_12[1]), true, 0))
			{
				func_49(&Local_24, 8);
			}
			break;
		case 7:
			_set_weather_type(Local_24.f_1, false, false, true, 60f, false);
			if (func_39(Local_24.f_11, 1))
			{
				if (func_39(Local_24.f_11, 2))
				{
					_0x0f2a2175734926d8(func_54(1), func_54(0));
					func_43(&(Local_24.f_11), 2);
				}
				_0x531a78d6bf27014b(func_54(0));
		...
		case 8:
			...
			if (!is_entity_in_volume(Global_35, &(Local_24.f_12[1]), true, 0))
			{
			...
			else if (is_entity_in_volume(Global_35, &(Local_24.f_12[0]), true, 0))
			{
				if (func_55(&(Local_24.f_2)) > 10f)
				{
					func_49(&Local_24, 3);
		...
		case 4:
			...
			if (!func_39(Local_24.f_11, 1))
			{
				if (_0xd9130842d7226045(func_54(0), 0))
				{
			...
			else if (func_55(&(Local_24.f_8)) > 5f)
			{
				if (!func_39(Local_24.f_11, 2))
				{
					_play_sound_from_position(func_54(1), -2587.967f, -93.59087f, 167.5787f, func_54(0), false, 0, true, 0);
		...
		case 6:
			...
			if (!func_53(&Local_24))
			{
				if (func_55(&(Local_24.f_2)) > 10f)
				{
					if (is_entity_in_volume(Global_35, &(Local_24.f_12[0]), true, 0))
					{
						func_49(&Local_24, 3);
					}
					else
...
bool func_16(int iParam0)
{
	...
	{
		return func_64((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_26(var uParam0)
{
	...
	return (func_70() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_73(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_80(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_80(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_81(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_81(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_82(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_96(Global_35))
		{
			return true;
		}
...
bool func_50(int iParam0)
{
	...
	while (iVar0 <= 3)
	{
		iVar1 = iVar0;
		Var2 = { func_101(iVar1) };
		if (!_does_volume_exist(&(iParam0->f_12[iVar1])))
		{
			iParam0->f_12[iVar1] = _create_volume_by_hash_with_custom_name(Var2.f_10, Var2, Var2.f_3, Var2.f_6, Var2.f_9);
		}
		iVar0++;
	}
	return true;
...
{
	vVar0 = { func_101(1) };
	if (get_closest_fire_pos(&vVar11, vVar0))
	{
		if (_0xf256a75210c5c0eb(&(iParam0->f_12[1]), vVar11))
		{
			return true;
		}
	}
...
void func_56()
{
	use_particle_fx_asset("scr_dis_ligtn_trees");
	start_particle_fx_non_looped_at_coord("scr_crackpot_rc_lightening", vLocal_14, vLocal_17, 1f, false, false, false);
	start_particle_fx_non_looped_at_coord("scr_crackpot_rc_lightening_exp", vLocal_14, vLocal_17, 1f, false, false, false);
}
...
void func_66(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_108(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_108(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_72(var uParam0, int iParam1)
{
	...
	if (!func_112(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
void func_79(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_120(iParam0, 8))
		{
...
void func_82(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_122(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_122(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_90()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_119(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_127(0), iVar0, 0))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_141(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_141(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_141(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_141(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_111(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_149(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_117(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_112(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
{
	func_168((get_game_timer() + iParam2), !bParam1);
...
void func_136(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_170(iParam0));
...
int func_142(int iParam0, int iParam1)
{
	...
	if (!func_177(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
int func_162(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_127(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_127(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_198(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_127(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return func_202(1328661203, func_203(), -1591664384, bParam0);
}
...
struct<4> func_202(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_127(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
