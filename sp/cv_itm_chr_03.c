...
bool func_1(var uParam0)
{
	...
	_0xc67a4910425f11f1(player_id(), sLocal_32);
...
{
	if (does_entity_exist(func_197(uParam0, iLocal_18)))
	{
		set_entity_heading(func_197(uParam0, iLocal_18), 65.69f);
		set_entity_visible(func_197(uParam0, iLocal_18), false);
	}
	return true;
}
...
bool func_94(var uParam0)
{
	if (!is_entity_dead(func_9(uParam0, iLocal_14)))
	{
		_0x3946fc742ac305cd(player_id(), func_9(uParam0, iLocal_14), sLocal_32, 0f, 0f, 0f, func_197(uParam0, iLocal_18), sLocal_32);
		_0xe98d55c5983f2509(func_9(uParam0, iLocal_14));
	}
	func_8(&iLocal_30, 1, 1);
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_218(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_220(iParam0);
					_0x7b204f88f6c3d287(func_221(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_221(iParam0, 0));
					func_222(iParam0);
				}
			}
			else
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_236(iParam0), 137, true);
	}
}
...
void func_129(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_236(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_236(iParam0), 204, false);
	}
}
...
void func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_236(iParam0);
	if (((does_entity_exist(iVar1) && func_238(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_251(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_34(uParam0) < 5)
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_252(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_219(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_216(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_177(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_216(uParam0->f_107[iVar0]->f_8.f_3))
			{
...
void func_181(var uParam0, int iParam1)
{
	...
	func_287(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_288(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_182(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_289(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_183(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_291(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_185(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_292(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_261(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_294(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_294(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_191(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_261(uParam0, uParam0->f_1976.f_1), 1, func_262(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_195(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_216(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
...
int func_196(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_117() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_290() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_198(var uParam0)
{
	...
	iLocal_31 = 0;
	_0x3ee1f7a8c32f24e1(player_id(), &iLocal_31, 0, 0);
	if (iLocal_31 == 0)
	{
		func_8(&iLocal_30, 1, 1);
		return 0;
	}
	if (get_ped_index_from_entity_index(iLocal_31) != func_9(uParam0, iLocal_14))
	{
		func_8(&iLocal_30, 1, 1);
		return 0;
	}
	if (!func_48(iLocal_30))
	{
		...
		func_305(iLocal_30, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_312(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_313(uParam0->f_107[iVar0]->f_1, fVar4);
				func_312(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
int func_207(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			func_314(Global_40.f_6563[iVar0], iParam0);
			func_315(iParam0);
			if (bParam2)
			{
				func_316(Global_40.f_6563[iVar0]);
				if (!func_317(172))
				{
					func_318(172, 0);
				}
				func_319(Global_40.f_6563[iVar0], 0);
			}
			func_320(iVar0, 1);
			func_321();
...
void func_237(int iParam0)
{
	if (func_54(iParam0))
	{
		if (does_entity_exist(func_236(iParam0)))
		{
...
int func_264(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_348(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_54(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_349(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_350(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_350(uParam0, 1, 0);
							}
						}
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_351(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_268(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_352(iVar1)))
			{
				func_353(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_354(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_275(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_261(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_283(var uParam0, int iParam1)
{
	...
	else if (!func_356(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_325(var uParam0, int iParam1)
{
	...
	{
		if (!func_356(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_326(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_385(uParam0, iParam1);
	}
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_347(100f, 140f);
			}
		}
...
int func_348(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
int func_349(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	if (!func_108(iParam0))
	{
		return 0;
...
int func_353(int iParam0, bool bParam1)
{
	...
	{
		func_242(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_230() == -1)
		{
...
int func_354(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (_uilog_is_entry_registered(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489->f_361.f_194 = func_426("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, get_hash_key(func_373(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_382(char* sParam0, int iParam1)
{
	...
	return func_433(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_434((*Global_1835011)[59]->f_1, 1) || func_434((*Global_1347702)[1]->f_15, 1)) || func_435((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
...
int func_396(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!does_entity_exist(iVar0) || !func_125(iVar0, 0)) || (bParam3 && !func_55(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_448(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
bool func_399(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_434((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_406(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 1:
			...
			if (func_456(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_455(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_458(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_459(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_461(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_125(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_288(Global_1360165[iParam0], 1);
				}
			}
			func_455(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_287(Global_1360165[iParam0]))
				{
				}
			}
			func_463(iParam0, Global_1360165[iParam0]);
...
void func_417(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_215(iParam0, 8))
		{
...
void func_436(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_313(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_440(var uParam0, int iParam1)
{
	...
	func_478(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_441(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_481(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_448(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	if (!func_108(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_484(iParam0) && func_485(iParam0, &uVar4))
				{
					_0x187d65f3aec5d679(func_219(iParam0, 1), &uVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_487(iParam0, vVar0, iParam6, iParam10))
				{
					return func_486();
				}
				if (func_125((*Global_1360165)[iParam0]->f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_488(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_486();
				}
			}
			if ((bParam2 && !func_216(vVar0)) && !func_217(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_458((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_489((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_219(iParam0, 1), get_hash_key(sVar12));
			}
...
bool func_451(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_108(iParam0))
	{
		return false;
...
bool func_456(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_497((*Global_1360165)[iParam0]->f_4.f_2) || func_435((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_458(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_234(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_234(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_234(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_234(iParam5, 32), true);
	...
	else if (func_234(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_234(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_234(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_464(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_240(iParam0)))
	{
		return false;
	}
...
struct<4> func_472(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_516(923904168, func_515(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_516(923904168, func_515(bParam0), -740156546, 0) };
		}
...
bool func_485(int iParam0, char* sParam1)
{
...
bool func_487(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	if (!func_108(iParam0))
	{
		return false;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_219(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_289(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_488(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_521(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_489(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_236(iParam1)))
	{
		_0x931b241409216c1f(func_236(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_236(iParam1), iParam0);
...
void func_491(int iParam0, float fParam1, bool bParam2)
{
	if (!is_entity_dead(iParam0))
	{
...
int func_496(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_434((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_434((*Global_1347702)[63]->f_15, 1) || func_435((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_434((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_434((*Global_1347702)[134]->f_15, 1) || func_435((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_434((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_346(747937920, 1) && !func_434((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_236(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_511(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_465(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_465(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_465(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_465(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_465(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_465(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_465(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_465(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_465(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_465(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_465(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_465(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_465(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_465(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_465(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_465(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_465(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_465(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_465(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_465(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_465(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_465(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_465(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_465(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_465(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_465(iParam1, 1544915253))
	{
...
int func_514(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_534(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_534(iVar0))
		{
	...
	{
		func_536(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_537(iParam0, &iVar0, &fVar25);
...
struct<4> func_516(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_420(iParam0, 0))
	{
		return Var0;
...
struct<5> func_544(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_546(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_559(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_547(int iParam0, var uParam1, int iParam2)
{
...
void func_551(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_563(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_555(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_516(271701509, func_515(bParam0), 12999093, 0) };
		}
...
bool func_558(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_560(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_424(0);
