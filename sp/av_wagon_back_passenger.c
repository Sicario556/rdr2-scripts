void __EntryFunction__()
{
	...
	Var0 = Local_97;
	Var0.f_1 = Local_97.f_11;
	Var0.f_483 = { Local_97.f_1 };
	Var0.f_486 = { Local_97.f_4 };
	Var0.f_489 = Local_97.f_7;
	Var0.f_20[0] = Local_97.f_8;
	Var0.f_453 = Local_97.f_9;
	Var0.f_500 = Local_97.f_10;
	Var0.f_503 = Local_97.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 11013, 11229, 12240);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "WBPP_MAN_1", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -8f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "WBPP_MAN_2", iLocal_40, _get_object_offset_from_coords(vParam1, vParam4.z, 8f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 2, "WBPP_MAN_3", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, -2.5f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
...
{
	if (!_has_propset_loaded(iLocal_94))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	if (!is_entity_dead(uParam0->f_453))
	{
		_0xd80faf919a2e56ea(uParam0->f_453, iLocal_94);
	}
	return true;
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		...
		if (!is_entity_dead(uParam0->f_453) && !is_entity_dead(Global_35))
		{
			if (is_ped_on_specific_vehicle(Global_35, uParam0->f_453))
			{
				uParam0->f_469[1] = 1;
			}
		}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			while (iVar0 < 5)
			{
				if (does_entity_exist(&(uParam0->f_20[iVar0])))
				{
					if (!is_entity_dead(&(uParam0->f_20[iVar0])))
					{
						set_ped_config_flag(&(uParam0->f_20[iVar0]), 297, true);
						set_ped_config_flag(&(uParam0->f_20[iVar0]), 130, false);
						func_68(uParam0->f_20[iVar0], 0, 1);
					}
				}
				iVar0++;
			}
			...
			{
				func_69(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				iLocal_39 = create_group(0);
				set_ped_flee_attributes(&(uParam0->f_20[0]), 2560, true);
				Local_44.f_3 = &uParam0->f_20[2];
				Local_44.f_7 = 0;
				set_ped_as_group_leader(&(uParam0->f_20[0]), iLocal_39, false);
				set_ped_into_vehicle(&(uParam0->f_20[0]), uParam0->f_453, -1);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_69(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				set_ped_flee_attributes(&(uParam0->f_20[1]), 2048, true);
				set_ped_config_flag(&(uParam0->f_20[1]), 44, true);
				set_ped_as_group_member(&(uParam0->f_20[1]), iLocal_39);
				set_ped_into_vehicle(&(uParam0->f_20[1]), uParam0->f_453, 0);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[2])))
			{
				func_69(&(uParam0->f_20[2]->f_5), 50, 10, 0);
				set_ped_as_group_member(&(uParam0->f_20[2]), iLocal_39);
				task_start_scenario_at_position(&(uParam0->f_20[2]), iLocal_96, uParam0->f_20[2]->f_5, uParam0->f_20[2]->f_8, 0, false, true, 0, -1f, false);
				Local_69.f_3 = &uParam0->f_20[0];
				Local_69.f_7 = 0;
			...
			break;
		case 3:
			_0x66f9eb44342bb4c5(&(uParam0->f_20[0]), &Local_44);
			_0x66f9eb44342bb4c5(&(uParam0->f_20[2]), &Local_69);
			if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_72(&uLocal_41, 15f))
			{
				func_67(uParam0);
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					func_73(&(uParam0->f_20[0]), 869278708, 1971704925);
					set_ped_keep_task(&(uParam0->f_20[0]), true);
				}
				if (!is_entity_dead(&(uParam0->f_20[2])))
				{
					_0xa3a9299c4f2adb98(&(uParam0->f_20[2]));
					task_enter_vehicle(&(uParam0->f_20[2]), uParam0->f_453, 20000, 1, 1f, 1, 0);
				}
				func_70(&uLocal_41);
				iLocal_9 = 2;
			}
		...
		case 1:
			...
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				task_smart_flee_ped(&(uParam0->f_20[1]), Global_35, -1f, -1, 0, 1077936128, 0);
				set_ped_keep_task(&(uParam0->f_20[1]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[2])))
			{
				_0xf1c03a5352243a30(&(uParam0->f_20[2]));
			}
			iLocal_9 = 4;
			break;
		case 2:
			_0x66f9eb44342bb4c5(&(uParam0->f_20[0]), &Local_44);
			_0x66f9eb44342bb4c5(&(uParam0->f_20[2]), &Local_69);
			if (is_ped_in_vehicle(&(uParam0->f_20[2]), uParam0->f_453, false))
			{
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					task_vehicle_drive_wander(&(uParam0->f_20[0]), uParam0->f_453, 3f, 524311);
					set_ped_keep_task(&(uParam0->f_20[0]), true);
				}
				iLocal_9 = 4;
			}
...
int func_32(var uParam0, var uParam1)
{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				if (!&uParam0->f_469[1])
				{
					if (iVar0 == 0)
					{
						if (!is_entity_dead(&(uParam0->f_20[iVar0])))
						{
							if (!func_74(&(uParam0->f_20[iVar0]), -258271821))
							{
								task_vehicle_drive_wander(&(uParam0->f_20[iVar0]), uParam0->f_453, 3f, 524311);
					...
					if (iVar0 == 2)
					{
						if (!is_entity_dead(&(uParam0->f_20[iVar0])))
						{
							if (!func_74(&(uParam0->f_20[iVar0]), -1794415470))
							{
								task_enter_vehicle(&(uParam0->f_20[iVar0]), uParam0->f_453, 20000, 1, 3f, 1, 0);
								set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
							}
						}
					}
	...
	if (_does_propset_exist(iLocal_95))
	{
		_set_propset_as_no_longer_needed(iLocal_95);
	}
	return 1;
}
...
void func_51(var uParam0, char* sParam1, int iParam2, vector3 vParam3, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_111(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_78(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_116(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_79(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_116(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_117(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_137(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_161(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_213(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_213(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_213(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_162(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_116(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
