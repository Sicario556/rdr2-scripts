void __EntryFunction__()
{
	...
	Var0 = Local_96;
	Var0.f_1 = Local_96.f_11;
	Var0.f_483 = { Local_96.f_1 };
	Var0.f_486 = { Local_96.f_4 };
	Var0.f_489 = Local_96.f_7;
	Var0.f_20[0] = Local_96.f_8;
	Var0.f_453 = Local_96.f_9;
	Var0.f_500 = Local_96.f_10;
	Var0.f_503 = Local_96.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	bLocal_88 = true;
	iVar1 = func_47(997958153, 1);
	iVar0 = func_49(func_48(), 1, 0, 0, 1, 0, 1);
	iVar2 = 40345436;
	func_50(uParam0, 0, "RHP_RANCHER", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 2.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 2, "RHP_HORSE", iVar1, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "RHP_DOG", 1087552700, _get_object_offset_from_coords(vParam1, vParam4.z, -1f, 0.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 3, "RHP_ANIMAL_1", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, 7f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 4, "RHP_ANIMAL_2", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 1.65f, 7.75f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 5, "RHP_ANIMAL_3", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, -0.5f, 9.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 6, "RHP_ANIMAL_4", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, -1.75f, 8.15f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 7, "RHP_ANIMAL_5", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 1.15f, 10.1f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 8, "RHP_ANIMAL_6", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 2.75f, 9f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 9, "RHP_ANIMAL_7", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, -1.5f, 10.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 10, "RHP_ANIMAL_8", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 3.75f, 7f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 11, "RHP_ANIMAL_9", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, -0.85f, 6f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 12, "RHP_ANIMAL_10", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 4.15f, 10.75f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 13, "RHP_ANIMAL_11", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 2.25f, 11.75f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 14, "RHP_ANIMAL_12", iVar2, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 11.15f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
	...
	while (iVar12 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar12]->f_2 != 0)
		{
			...
			if (is_entity_dead(&(uParam0->f_20[iVar12])))
			{
				...
				{
					uParam0->f_20[iVar12] = func_56(uParam0->f_20[iVar12]->f_2, uParam0->f_20[iVar12]->f_5, uParam0->f_20[iVar12]->f_8, 1, 1, 0, 1, uParam0->f_20[iVar12]->f_11, uParam0->f_20[iVar12]->f_9, 0, 0, 0, 0);
				}
				...
				if (!is_ped_human(&(uParam0->f_20[iVar12])))
				{
					if (!func_57(&(uParam0->f_20[iVar12])))
					{
...
{
	if (!_does_volume_exist(iLocal_55))
	{
		vLocal_56 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 50f, 0f) };
		iLocal_55 = _create_volume_cylinder(vLocal_56, 0f, 0f, 0f, 15f, 15f, 10f);
	}
	return true;
}
...
int func_31(var uParam0)
{
	...
	{
		if (func_66(uParam0, 3f, 1116471296, 2, -91962372, 0))
		{
	...
	{
		iVar1 = _get_scenario_point_ped_is_using(&(uParam0->f_20[0]), false);
		if (_does_scenario_point_exist(iVar1))
		{
			if (_is_scenario_point_flag_set(iVar1, 37))
			{
				_set_scenario_point_flag(iVar1, 37, false);
			}
		}
		if (func_71(Global_35, &(uParam0->f_20[0]), 1) < 400f)
		{
			_0x66f9eb44342bb4c5(&(uParam0->f_20[0]), &Local_63);
		}
		if (bLocal_88)
		{
			set_ped_reset_flag(&(uParam0->f_20[0]), 215, true);
		}
	}
	switch (iLocal_25)
	{
		case 0:
			...
			func_73(uParam0);
			func_74(&(uParam0->f_20[0]), &(uParam0->f_20[2]), 1, -1, 1);
			func_75(vLocal_59, fLocal_62, 0, 0, 5);
			iLocal_92 = 1;
			set_ped_config_flag(&(uParam0->f_20[0]), 297, true);
			set_ped_config_flag(&(uParam0->f_20[0]), 130, false);
			func_76(uParam0->f_20[0], 0, 1);
			set_ambient_voice_name(&(uParam0->f_20[0]), "0959_A_M_M_Rancher_White_04");
			_0x24c82ef607105faa(&(uParam0->f_20[0]), -920810745);
			_give_weapon_to_ped_2(&(uParam0->f_20[0]), 379542007, 999, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
			set_current_ped_weapon(&(uParam0->f_20[0]), -1569615261, true, 0, false, false);
			iVar0 = 3;
			while (iVar0 <= 14)
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					func_77(&(uParam0->f_20[iVar0]->f_5), 50, 10, 0);
					task_start_scenario_at_position(&(uParam0->f_20[iVar0]), -830507952, uParam0->f_20[iVar0]->f_5, uParam0->f_20[iVar0]->f_8, 0, false, true, 0, -1f, false);
					func_76(uParam0->f_20[iVar0], 1, 1);
				}
				iVar0++;
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_76(uParam0->f_20[1], 0, 1);
		...
		case 3:
			...
			{
				if (!func_82(&(uParam0->f_20[0]), 242628503))
				{
					func_83(&uLocal_93);
					iLocal_25 = 6;
				}
		...
		case 6:
			...
			if (func_85(128))
			{
				if (!bLocal_89)
				{
					...
					if (is_ped_on_mount(&(uParam0->f_20[0])))
					{
						task_dismount_animal(0, 0, 0, 0, 0, 0);
					}
					task_start_scenario_at_position(0, -1776208257, get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), -1.5f, 2f, 0f), get_entity_heading(&(uParam0->f_20[0])), 0, true, false, "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_C", -1f, false);
					close_sequence_task(iVar2);
					_task_perform_sequence_2(&(uParam0->f_20[0]), iVar2, 2f, 2f);
				...
				{
					_task_start_scenario_in_place(&(uParam0->f_20[0]), -1776208257, 0, true, 0, -1f, false);
				}
				if (!bLocal_90)
				{
					task_start_scenario_at_position(&(uParam0->f_20[1]), -363194080, get_offset_from_entity_in_world_coords(&(uParam0->f_20[2]), -3.5f, 2f, 0f), (-45f + get_entity_heading(&(uParam0->f_20[0]))), 0, true, false, 0, -1f, false);
					bLocal_90 = true;
				}
				else
				{
					_task_start_scenario_in_place(&(uParam0->f_20[1]), -363194080, 0, true, 0, -1f, false);
				}
		...
		case 7:
			...
			{
				clear_ped_tasks(&(uParam0->f_20[0]), 1, 0);
				_task_start_scenario_in_place(&(uParam0->f_20[0]), 830847823, 0, true, 0, -1f, false);
				clear_ped_tasks(&(uParam0->f_20[1]), 1, 0);
				_task_start_scenario_in_place(&(uParam0->f_20[1]), 1951165908, 0, true, 0, -1f, false);
				func_86(uParam0);
				iLocal_25 = 6;
			}
			break;
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, var uParam12, var uParam13)
{
	...
	uParam0->f_20[iParam1]->f_3 = uParam12;
	uParam0->f_20[iParam1]->f_13 = uParam13;
	uParam0->f_19++;
}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_71(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
...
bool func_68(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_122(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
void func_69(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			func_76(uParam0->f_20[iVar0], 0, 1);
			_task_smart_flee_style_ped(&(uParam0->f_20[iVar0]), Global_35, 3, 256, -1082130432, -1, 0);
		}
		iVar0++;
	}
}
...
float func_71(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_124(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}

Vector3 func_72(var uParam0)
{
	get_closest_vehicle_node(uParam0->f_483, &vVar0, 1, 3f, 0f);
	return vVar0;
}
...
void func_73(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			_0x931b241409216c1f(&(uParam0->f_20[0]), &(uParam0->f_20[iVar0]), 0);
		}
		iVar0++;
	}
}
...
void func_76(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!bParam1 && bParam2)
	{
		set_ped_config_flag(*uParam0, 168, true);
	}
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_71(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
void func_79(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		vVar2 = { vLocal_56 + Vector(0f, get_random_float_in_range(-4f, 4f), get_random_float_in_range(-4f, 4f)) };
		fLocal_9[iVar0] = func_133(iVar0);
		open_sequence_task(&iVar1);
		task_set_blocking_of_non_temporary_events(0, true);
		task_follow_nav_mesh_to_coord(0, vVar2, &(fLocal_9[iVar0]), -1, 0.25f, 8193, 40000f);
		task_animal_unalerted(0, -1, iLocal_55, 0, 0);
		close_sequence_task(iVar1);
		_task_perform_sequence_2(&(uParam0->f_20[iVar0]), iVar1, 0f, 0f);
		clear_sequence_task(&iVar1);
		iVar0++;
	}
	open_sequence_task(&iVar1);
	task_pause(0, 3000);
	task_mount_animal(0, &(uParam0->f_20[2]), -1, -1, 1f, 1, 0, 0);
	task_follow_nav_mesh_to_coord(0, get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 45f, 0f), 0.55f, -1, 0.25f, 8192, 40000f);
	close_sequence_task(iVar1);
	clear_ped_tasks(&(uParam0->f_20[0]), 1, 0);
	task_perform_sequence(&(uParam0->f_20[0]), iVar1);
	clear_sequence_task(&iVar1);
	vVar2 = { vLocal_56 + Vector(0f, get_random_float_in_range(-4f, 4f), get_random_float_in_range(-4f, 4f)) };
	func_77(&vVar2, 50, 10, 0);
	open_sequence_task(&iVar1);
	task_follow_nav_mesh_to_coord(0, get_offset_from_entity_in_world_coords(&(uParam0->f_20[1]), 0f, 50f, 0f), 0.86f, -1, 0.25f, 8193, 40000f);
	task_follow_nav_mesh_to_coord(0, vVar2, 0.55f, -1, 0.25f, 8192, 40000f);
	task_wander_in_volume(0, iLocal_55, 1077936128, 1086324736, 1);
	close_sequence_task(iVar1);
	set_ped_using_action_mode(&(uParam0->f_20[1]), true, -1, 0);
	func_134(&(uParam0->f_20[1]), 1);
	clear_ped_tasks(&(uParam0->f_20[1]), 1, 0);
	_task_perform_sequence_2(&(uParam0->f_20[1]), iVar1, 4f, 4f);
	clear_sequence_task(&iVar1);
}

void func_80(var uParam0)
{
	if (is_entity_dead(&(uParam0->f_20[1])) || (func_82(&(uParam0->f_20[1]), 242628503) && get_sequence_progress(&(uParam0->f_20[1])) > 1))
	{
		return;
	}
	...
	if (!is_entity_dead(&(uParam0->f_20[iLocal_26])))
	{
		if (!func_82(&(uParam0->f_20[iLocal_26]), 1435919172))
		{
			task_animal_unalerted(&(uParam0->f_20[iLocal_26]), -1, iLocal_55, 0, 0);
		}
		else if (func_71(&(uParam0->f_20[iLocal_26]), &(uParam0->f_20[1]), 1) < 20.25f)
		{
			set_ped_desired_move_blend_ratio(&(uParam0->f_20[iLocal_26]), 1.25f);
			set_ped_min_move_blend_ratio(&(uParam0->f_20[iLocal_26]), 1.25f);
		}
		else
		{
			set_ped_min_move_blend_ratio(&(uParam0->f_20[iLocal_26]), &(fLocal_9[iLocal_26]));
			set_ped_desired_move_blend_ratio(&(uParam0->f_20[iLocal_26]), &(fLocal_9[iLocal_26]));
		}
	}
	iLocal_26++;
}
	...
	while (iVar0 <= 14)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (func_85(128))
			{
				...
				clear_ped_tasks(&(uParam0->f_20[iVar0]), 1, 0);
				open_sequence_task(&iVar3);
				_task_start_scenario_in_place(0, iVar2, 0, true, 0, -1f, false);
				close_sequence_task(iVar3);
				_task_perform_sequence_2(&(uParam0->f_20[iVar0]), iVar3, fVar1, fVar1);
				set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
				clear_sequence_task(&iVar3);
			}
			else
			{
				clear_ped_tasks(&(uParam0->f_20[iVar0]), 1, 0);
				task_animal_unalerted(&(uParam0->f_20[iVar0]), -1, iLocal_55, 0, 0);
			}
		}
		iVar0++;
	}
...
bool func_91(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_138(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_92(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_138(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_139(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_120(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_157(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_157(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_157(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_121(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_138(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_196(1) || *uParam0 & 8192 != 0))
				{
...
bool func_162(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_209(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_207(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_208(uParam2)
				{
					func_203(uParam2, 1);
					return true;
				}
...
bool func_163(int iParam0, var uParam1)
{
	...
	if (func_199(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_208(uParam1)
		{
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_222(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_239(iVar0, 0)))
		{
...
bool func_220(int iParam0, int iParam1)
{
	...
	if (func_245(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_228(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_222(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_231(int iParam0)
{
	...
	return func_247((*Global_1347702)[58]->f_15, 1);
}
