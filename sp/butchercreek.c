		...
		if (get_game_timer() > iLocal_102)
		{
			...
			switch (iLocal_101)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_103));
					...
					Global_1897950 = -1;
					iLocal_104 = (get_game_timer() + iLocal_100);
					iLocal_101 = 2;
					break;
				case 2:
					if (func_11() || iLocal_104 < get_game_timer())
					{
						func_12(iLocal_103);
						iLocal_104 = (get_game_timer() + iLocal_100);
						iLocal_101 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_103) || iLocal_104 < get_game_timer())
					{
						func_14(iLocal_103);
						iLocal_104 = (get_game_timer() + iLocal_100);
						iLocal_101 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_103) || iLocal_104 < get_game_timer())
					{
						func_16(iLocal_103);
						iLocal_104 = (iLocal_100 + get_game_timer());
						iLocal_101 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_103)))
					{
						if (func_17(func_6(iLocal_103), 4) && !iLocal_104 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_103) || iLocal_104 < get_game_timer())
							{
							...
							Jump @802; //curOff = 470
							if (iLocal_104 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_103);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_102 = (1000 + get_game_timer());
							}
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_103]->f_10);
							if ((*Global_1888801)[iLocal_103]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_103]->f_11);
							}
							Jump @802; //curOff = 783
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_103]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_103]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[82]->f_4;
	_0xb469cfd9e065eb99(iLocal_14, 22);
	iLocal_15 = _create_volume_aggregate_with_custom_name("Butcher - m_volGeneral Agg");
	_0x39816f6f94f385ad(iLocal_15, 2595.509f, 778.3701f, 87.90205f, 0f, 0f, 70f, 2.456799f, 2.667848f, 2.166918f);
	_0x39816f6f94f385ad(iLocal_15, 2593.104f, 779.3081f, 87.87495f, 0f, 0f, 70.00001f, 5.401831f, 2.666181f, 2.080325f);
	_0xb469cfd9e065eb99(iLocal_15, 10082);
	iLocal_16 = _create_popzone_from_volume(iLocal_14);
	set_popzone_population_set(iLocal_16, 19122132);
	_0x7e6bc0b94f5928f0(iLocal_16, 10, 10);
	_0x08892122769770d5(iLocal_16, true);
	_0x0f1861101c9a9944(iLocal_16, true);
	iLocal_16 = _create_popzone_from_volume(iLocal_14);
	set_popzone_population_set(iLocal_16, 1243953490);
	_0x7e6bc0b94f5928f0(iLocal_16, 2, 2);
	_0x08892122769770d5(iLocal_16, true);
	_0x0f1861101c9a9944(iLocal_16, true);
	iLocal_16 = _create_popzone_from_volume(iLocal_14);
	set_popzone_population_set(iLocal_16, 1943615289);
	_0x7e6bc0b94f5928f0(iLocal_16, 2, 2);
	_0x08892122769770d5(iLocal_16, true);
	_0x0f1861101c9a9944(iLocal_16, true);
	func_46();
...
void func_14(int iParam0)
{
	if (func_20() == -1)
	{
		...
		while (iVar0 < 5)
		{
			request_model(&(iLocal_49[iVar0]), false);
			iVar0++;
		}
	}
}
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_59(&Global_1935630, 16384)) || func_59(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_62((*uParam0)[iVar3], 1) && func_63(iParam1)) && !func_64(iParam1, 16))
							{
								func_66(iParam1, func_65(), -1, 0, -1, 0);
								func_67((*uParam0)[iVar3], 1);
							}
							func_68(iParam1, 0);
						}
						bVar0 = true;
...
void func_46()
{
	if (!network_is_game_in_progress())
	{
		iLocal_18 = _create_volume_cylinder_with_custom_name(2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 50.23434f, 27.58518f, 8.132094f, "Butcher Creek - m_volFarmerRegistration");
		iLocal_20 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerThreat Agg");
		_0x39816f6f94f385ad(iLocal_20, 2696.193f, 704.9335f, 76.68376f, 0f, 0f, 88.96565f, 4.466922f, 1.336465f, 4.423785f);
		_0x39816f6f94f385ad(iLocal_20, 2698.47f, 703.6447f, 76.68376f, 0f, 0f, -30.46352f, 4.936317f, 2.843117f, 4.423785f);
		_0x39816f6f94f385ad(iLocal_20, 2717.371f, 710.274f, 77.27374f, 0f, 0f, 178.9532f, 3.930448f, 4.35889f, 8.132094f);
		iLocal_19 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_19, iLocal_20);
		_0xbce668aaf83608be(iLocal_19, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 34.23434f, 22.58518f, 8.132094f);
		iLocal_21 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerWarning Agg");
		_0x6e0d3c3f828da773(iLocal_21, iLocal_19);
		_0xbce668aaf83608be(iLocal_21, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 46.23434f, 26.58518f, 8.132094f);
		sLocal_17 = "BUTCHER_CREEK";
		_create_guard_zone(sLocal_17);
		_0x8c598a930f471938(sLocal_17, iLocal_18);
		_0xa1b0e6301e2e02a6(sLocal_17, iLocal_20);
		_0x35815f372d43e1e5(sLocal_17, iLocal_19);
		_0xad3e07c37a7c1adc(sLocal_17, iLocal_21);
		_set_guard_zone_position(sLocal_17, 2717.486f, 709.7006f, 79.6157f);
		_0xa8a74aa79fb67159(sLocal_17, iLocal_18);
	}
}

void func_47()
{
	*vLocal_77[0] = { 2560.689f, 839.585f, 79.692f };
	*vLocal_77[1] = { 2559.719f, 839.916f, 79.91f };
	*vLocal_77[2] = { 2558.63f, 840.218f, 80.152f };
	*vLocal_77[3] = { 2557.29f, 840.682f, 80.418f };
	*vLocal_77[4] = { 2556.515f, 840.907f, 80.583f };
	*vLocal_61[0] = { 2560.689f, 839.58f, 78.982f };
	*vLocal_61[1] = { 2559.713f, 839.932f, 79.232f };
	*vLocal_61[2] = { 2558.51f, 840.135f, 79.377f };
	*vLocal_61[3] = { 2557.239f, 840.718f, 79.394f };
	*vLocal_61[4] = { 2556.603f, 840.876f, 79.74f };
	fLocal_93[0] = 0.3f;
	fLocal_93[1] = 0.4f;
	fLocal_93[2] = 0.4f;
	fLocal_93[3] = 0.6f;
...
int func_48()
{
	...
	switch (iLocal_22)
	{
		case 0:
			...
			while (iVar0 < 5)
			{
				if (!has_model_loaded(&(iLocal_49[iVar0])))
				{
					bVar1 = false;
				}
				iVar0++;
		...
		case 1:
			...
			while (iVar0 < 5)
			{
				if (!does_entity_exist(&(iLocal_37[iVar0])))
				{
					iLocal_37[iVar0] = create_object(iLocal_23, *vLocal_77[iVar0], true, true, false, false, false);
					set_entity_visible(&(iLocal_37[iVar0]), false);
					freeze_entity_position(&(iLocal_37[iVar0]), true);
					set_can_climb_on_entity(&(iLocal_37[iVar0]), false);
					set_entity_collision(&(iLocal_37[iVar0]), false, false);
					iLocal_43[iVar0] = create_object(iLocal_24, *vLocal_77[iVar0] - Vector(0.3f, 0f, 0f), true, true, false, false, false);
				}
				iVar0++;
			}
			iLocal_22 = 2;
		case 2:
			...
			while (iVar0 < 5)
			{
				if (!does_entity_exist(&(iLocal_25[iVar0])))
				{
					iLocal_25[iVar0] = func_84(&(iLocal_49[iVar0]), *vLocal_61[iVar0], 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
					_set_ped_scale(&(iLocal_25[iVar0]), 1f);
					set_entity_coords(&(iLocal_25[iVar0]), *vLocal_61[iVar0], false, false, true, true);
					freeze_entity_position(&(iLocal_25[iVar0]), true);
					return 0;
				}
				iVar0++;
			}
		...
		case 3:
			...
			while (iVar0 < 5)
			{
				if (!is_entity_dead(&(iLocal_25[iVar0])))
				{
					return 0;
				}
				iVar0++;
		...
		case 4:
			if ((get_frame_count() % 15) == 0)
			{
				if (iLocal_99 < 5)
				{
					set_model_as_no_longer_needed(&(iLocal_49[iLocal_99]));
					func_86(iLocal_99);
					iLocal_99++;
				}
			}
		...
		case 5:
			...
			while (iVar0 < 5)
			{
				if (does_entity_exist(&(iLocal_25[iVar0])) && !_0x5170dda6d63acaaa(&(iLocal_25[iVar0])))
				{
					if (is_entity_dead(&(iLocal_25[iVar0])))
					{
						apply_ped_damage_pack(&(iLocal_25[iVar0]), &(sLocal_55[iVar0]), 0f, 1f);
						_0x674b90be1115846d(&(iLocal_25[iVar0]), 1);
					}
					else
					{
						bVar2 = false;
...
void func_58()
{
	...
	iVar1 = func_96(680);
	iVar2 = func_96(681);
	if (func_97(iVar0, 0) && get_animal_tuning_float_param(iVar0, 73) != 0.15f)
	{
		set_animal_tuning_float_param(iVar0, 73, 0.15f);
	}
	if (func_97(iVar1, 0) && get_animal_tuning_float_param(iVar1, 73) != 0.15f)
	{
		set_animal_tuning_float_param(iVar1, 73, 0.15f);
	}
	if (func_97(iVar2, 0) && get_animal_tuning_float_param(iVar2, 73) != 0.15f)
	{
...
bool func_63(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_98(iParam0));
}
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_112(&cVar6, 109029619), sVar9, func_112(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_112(&cVar6, 109029619), func_112(&cVar10, 109029619));
		}
...
void func_78(int iParam0)
{
	if (func_20() == -1)
	{
		...
		while (iVar0 < 5)
		{
			if (does_entity_exist(&(iLocal_25[iVar0])))
			{
				delete_ped(iLocal_25[iVar0]);
			}
			if (does_entity_exist(&(iLocal_37[iVar0])))
			{
				delete_entity(iLocal_37[iVar0]);
			}
			if (does_entity_exist(&(iLocal_43[iVar0])))
			{
				delete_object(iLocal_43[iVar0]);
			}
			if (does_rope_exist(&(iLocal_31[iVar0])))
			{
				delete_rope(iLocal_31[iVar0]);
			}
			iVar0++;
		}
	}
	_remove_guard_zone(sLocal_17);
	if (_does_volume_exist(iLocal_19))
	{
		_0x6d5f9e69ba1be783(iLocal_19);
	}
	func_54(0.775f, 0.2f, 0.025f, 0f);
}
...
void func_81(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_130(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
{
	if (does_entity_exist(&(iLocal_37[iParam0])))
	{
		if (does_entity_have_physics(&(iLocal_43[iParam0])))
		{
			_0xb6cbd40f8ea69e8a(&(iLocal_43[iParam0]));
			iVar9 = 33646;
			...
			attach_entity_to_entity_physically(&(iLocal_43[iParam0]), &(iLocal_25[iParam0]), 4, get_ped_bone_index(&(iLocal_25[iParam0]), iVar9), vVar3, vVar6, vVar0, -1f, 0, 1, 0, 0, 0, 1, 1065353216, 1065353216);
			iLocal_31[iParam0] = _add_rope_2(*vLocal_77[iParam0], 0f, 0f, 0f, &(fLocal_93[iParam0]), 1, false, 1, -1f);
			freeze_entity_position(&(iLocal_25[iParam0]), false);
			_0x462ff2a432733a44(&(iLocal_31[iParam0]), &(iLocal_37[iParam0]), &(iLocal_43[iParam0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, "p_carcassHangMED_Bone2");
			_0x3c6490d940ff5d0b(&(iLocal_31[iParam0]), 0, 0, &(fLocal_93[iParam0]), 1);
			_0xf092b6030d6fd49c(&(iLocal_31[iParam0]), "ROPE_SETTINGS_DEFAULT");
			_0x7a54d82227a139db(iLocal_31[iParam0], 1);
			_0x76bad9d538bca1aa(&(iLocal_31[iParam0]), 0f);
			_0xb40ea9e0d2e2f7f3(&(iLocal_31[iParam0]), 1f);
			_0xdede679ed29dd4e7(&(iLocal_31[iParam0]), 1);
			_0xf1ea2a881eb7f2cd(&(iLocal_31[iParam0]), 1);
			_0x522fa3f490e2f7ac(&(iLocal_31[iParam0]), 1, 1);
			_0x2651ddc0ea269073(&(iLocal_31[iParam0]), 1f);
			set_ped_to_ragdoll(&(iLocal_25[iParam0]), 1000, 60000, 0, false, true, false);
			return 1;
		}
	}
	return 0;
...
int func_92(int iParam0, bool bParam1)
{
	...
	{
		func_135(iParam0, _create_persistent_character(func_134(iParam0)));
		if (func_20() == -1)
		{
...
char* func_112(char* sParam0, int iParam1)
{
	...
	return func_155(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_115(int iParam0)
{
	...
	if (func_156())
	{
		if (!func_157((*Global_1835011)[3]->f_1, 1))
		{
...
void func_126(int iParam0)
{
	...
	if (!func_120(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_161(Global_1935369->f_5[iParam0]->f_6, 1);
	func_162(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_90(Global_1914319->f_3[iParam0]->f_21) && func_164(Global_1914319->f_3[iParam0]->f_21))
	{
		func_165(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_166(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_130(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_149(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_182(iVar0) && func_183((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_189(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
{
	func_204(iParam3, &vVar0, &Var3, &uVar6);
	if (func_205(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
