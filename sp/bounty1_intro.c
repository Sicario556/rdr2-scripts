void __EntryFunction__()
{
	...
	while (!func_5(&Local_33, 1))
	{
		...
		if (((((func_6(&Local_33) >= 5 && func_6(&Local_33) <= 7) && !func_5(&Local_33, 4096)) && _does_anim_scene_exist(Local_33.f_428.f_444)) && _is_anim_scene_started(Local_33.f_428.f_444, false)) && !_is_anim_scene_paused(Local_33.f_428.f_444))
		{
		...
		switch (func_6(&Local_33))
		{
			...
			case 3:
				...
				func_39(&Local_33);
				if (func_40(func_32((*Global_1835011)[Local_33]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_33.f_428)) == 4 && _does_anim_scene_exist(Local_33.f_428.f_444)) && _is_anim_scene_paused(Local_33.f_428.f_444))
				{
					func_37(Local_33);
					func_17(&Local_33, 7);
				}
...
int func_39(int iParam0)
{
	...
	{
		iLocal_19 = _find_closest_active_scenario_point_of_type(get_entity_coords(iLocal_14, true, false), -2097328111, 1.5f, 0, false);
		return 0;
	}
	if (!does_entity_exist(iLocal_18))
	{
		...
		if (_does_anim_scene_exist(iVar0))
		{
			...
			{
				if (_0x6f1f0b17109309da(iVar0, "p_diningchairs01x"))
				{
					iLocal_18 = _get_anim_scene_object(iVar0, "p_diningchairs01x", false);
				}
			}
		}
		if (does_entity_exist(iLocal_18))
		{
			set_entity_no_collision_entity(iLocal_18, iLocal_14, false);
		}
		return 0;
	}
	return 0;
...
bool func_128(int iParam0)
{
	...
	func_277(1988748538, 0, 0f, 0, 0, 0, 1, 0);
	return true;
}
...
void func_137(int iParam0, int iParam1, char* sParam2)
{
	func_287(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
void func_139(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_289(), true);
	}
}
...
bool func_143()
{
	return func_291(get_id_of_this_thread());
}
...
void func_145(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_296(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_148(int iParam0)
{
	...
	return func_297((*Global_1835011)[iParam0]->f_1);
}
...
void func_151(int iParam0, vector3 vParam1, bool bParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if ((fVar3 <= fParam5 && fVar3 > fParam6) && fVar3 > fParam7)
	{
		...
		if ((func_299() && !is_entity_dead(iVar1)) && _is_draft_vehicle(iVar1))
		{
			iVar4 = 0;
			while (iVar4 < 6)
			{
	...
	if (bParam4)
	{
		if (fVar3 <= fParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_300(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_300(iParam0, -828834893))
			{
...
int func_154(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_301(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_296(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_296(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_308(uParam0, uParam0->f_1684))
				{
					...
					{
						func_310(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		if (func_295(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_296(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_304(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_310(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
{
	_request_scenario_type(-1426662425, 15, 0, 0);
	if (func_256(iLocal_14, 0))
	{
		if (!func_300(iLocal_14, -1098463898))
		{
			set_ped_config_flag(iLocal_14, 273, false);
			func_334();
		}
	}
}
...
{
	func_277(iParam0, 0, 0, 0, 1, 0, 0, 0);
}
...
int func_165(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_338(iParam0)))
	{
		return 0;
	}
	_0x4f81ead1de8fa19b(func_338(iParam0));
	return 1;
}
...
void func_201(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_298(uParam0->f_5, 0f, 0f, 0f))
	{
...
void func_225(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_404(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_388() };
...
void func_226(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_242(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_405(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
void func_234(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_422() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_236(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_423(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_425(iVar1, func_423(uParam0), func_424(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_425(iVar3, func_423(uParam0), func_424(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_423(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_423(uParam0) };
			func_425(iVar0, vVar1, func_426(vVar1, Global_36, 1), 2, 1073741824);
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_242(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_429(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_429(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
...
void func_241(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			func_431(iParam1, 29, bVar4, 1, 0);
			func_431(iParam1, 31, bVar4, 1, 0);
			func_431(iParam1, 30, bVar4, 1, 0);
			func_431(iParam1, 22, bVar4, 1, 0);
			func_431(iParam1, 37, bVar4, 1, 0);
		}
	}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_433(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
					if (!func_433(iVar3, 1) || bParam2)
					{
						...
						if (!bParam6)
						{
							func_431(iParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_431(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_246(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_441(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_251(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_447(1, (func_254() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_445(iParam3, 1)])
			{
				func_448(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_432(32768) && iParam1 != &Global_1946804->f_57[func_445(iParam3, 1)])
			{
				func_449();
...
void func_252(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_454(0), &Var5, iParam1);
}
...
bool func_253(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_459(iParam2, 1024))) || func_459(iParam2, 8)) && !func_455(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_460(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_459(iParam2, 4096)) && !func_455(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_460(iParam1, 2048);
			func_460(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_459(iParam2, 32)) && !func_455(*iParam1, 5632))
		{
...
int func_266(var uParam0, int iParam1)
{
	...
	if (func_143())
	{
		...
		if (func_466(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_467(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_295(uParam0, 8) && _0xdd0b7c5ae58f721d(func_468()))
	{
		_0x798be43c9393632b(func_468());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_468())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_269(int iParam0)
{
	...
	return func_470((*Global_1835011)[iParam0]->f_1);
}
...
bool func_271()
{
	...
	if (!func_256(iLocal_14, 0))
	{
		_0x59c7ad6fea2ac449(func_338(3), vLocal_27);
		iLocal_14 = func_472(3, 1, 0, 0, 1, 1);
		return false;
	}
	set_ped_as_cop(iLocal_14, true);
	func_425(iLocal_14, vLocal_27, 0f, 2, 1073741824);
	return true;
}

bool func_272()
{
	if (!func_256(iLocal_15, 0))
	{
		request_model(iLocal_21, false);
		if (has_model_loaded(iLocal_21))
		{
			iLocal_15 = func_473(iLocal_21, vLocal_30, 0, 1, 1, 0, 1, 1, 1, 0, 0, 1, 1);
		}
		remove_all_ped_weapons(iLocal_15, true, true);
		return false;
	}
	if (!func_474(4, 1))
	{
...
bool func_273()
{
	if (!does_entity_exist(iLocal_16))
	{
		...
		{
			iLocal_16 = create_object(iLocal_22, vLocal_30, true, true, false, false, true);
		}
		return false;
	}
	freeze_entity_position(iLocal_16, true);
	set_entity_no_collision_entity(iLocal_16, iLocal_15, false);
	create_model_hide_excluding_script_objects(vLocal_30, 0.5f, iLocal_22, false);
	return true;
}
...
bool func_274()
{
	...
	{
		request_model(iLocal_23, false);
		if (has_model_loaded(iLocal_23))
		{
			iLocal_17 = create_object(iLocal_23, vLocal_24, true, true, false, false, true);
			set_entity_heading(iLocal_17, 100f);
		}
		return false;
	}
	return true;
...
void func_275(var uParam0)
{
	...
	{
		func_475(&iLocal_20, -276.945f, 805.737f, 119.613f, 0f, 0f, 10.057f, 5.091f, 13.087f, 2.916f, "BOU1_INTRO_BLOCKING");
		func_476(uParam0, iLocal_20);
	}
}

void func_276(int iParam0, int iParam1)
{
	func_277(iParam0, 1, 0, 0, 0, 0, 0, 0);
}

void func_277(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
...
void func_287(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		...
		iVar0 = func_510(uParam0, sParam2);
		if (iVar0 == -1)
		{
...
void func_288(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_407(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_441(uParam0->f_13[iVar0], 2);
		}
	}
}
...
void func_303(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_296(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_193(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_426(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_310(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
...
void func_311(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_317(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_468(), 64);
			}
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_426(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
...
bool func_325(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_193(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_326(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_193(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
...
void func_334()
{
	if (func_256(iLocal_14, 0))
	{
		if (_does_scenario_point_exist(iLocal_19))
		{
			if (does_entity_exist(iLocal_18))
			{
				task_start_scenario_at_position(iLocal_14, -1426662425, _get_scenario_point_coords(iLocal_19, true), _get_scenario_point_heading(iLocal_19, true), 100, false, true, 0, -1f, false);
				set_entity_no_collision_entity(iLocal_18, iLocal_14, true);
			}
		}
	}
}
...
int func_343(int iParam0, bool bParam1)
{
	...
	func_342(iParam0);
	_0xfc77c5b44d5ff7c0(func_338(iParam0));
	func_561(iParam0, 0);
	return 1;
}
...
void func_413(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_428(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_414()
{
	...
	if (func_428(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_428(iVar0))
	{
		...
		{
			func_604(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_425(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_608(Global_35) && is_player_teleport_active())
	{
	}
	if (func_609(iParam0))
	{
		if (func_610(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_455(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_455(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_455(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_455(iParam5, 32), true);
	...
	else if (func_455(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_455(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_455(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_431(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
{
	return ((Global_1946804->f_57[func_445(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_435(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_433(1108822547, 6))
	{
		if (bParam2)
		{
			func_431(iParam0, iVar0, func_254() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_445(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_445(iParam0, 1)])->f_10 || iParam1);
}

void func_438(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_445(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_445(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_445(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_443(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_613(iParam0))
	{
		case -1037537535:
			...
			{
				Var0 = { func_452(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_616(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_616(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_617(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_452(-1838434463, Var0, 1084182731, bParam1) };
...
bool func_446(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_621();
	if (iParam2 == 39)
	{
	...
	if (func_622(iParam0, 866047851) && func_623(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_432(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_629(iParam0, iParam2, iParam1, func_254() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_438(func_436(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_449()
{
	func_633(&(Global_1946804->f_2776));
	func_634(32768);
...
bool func_458(int iParam0, vector3 vParam1)
{
	...
	return func_635(vVar0, vVar3, vParam1);
}
...
void func_464(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_638(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_639(1, bVar1, 1, uVar2);
		func_640(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_641(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
bool func_471(int iParam0, bool bParam1)
{
	...
	{
		func_561(iParam0, _create_persistent_character(func_336(iParam0)));
		if (func_254() == -1)
		{
			if (func_339(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_338(iParam0));
				func_341(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_338(iParam0));
		}
		return false;
	}
...
int func_472(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_166(iParam0)) && !is_entity_dead(iVar0))
	{
...
int func_473(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_647(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_474(int iParam0, bool bParam1)
{
	...
	func_341(iParam0, 129);
	func_342(iParam0);
	_0x7b204f88f6c3d287(func_338(iParam0));
	_0xfc77c5b44d5ff7c0(func_338(iParam0));
	func_561(iParam0, 0);
	return true;
}

void func_475(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
...
void func_479(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_478(iParam0))
	{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_425(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_653(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_655(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_256(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_657(Global_1360165[iParam0], 1);
				}
			}
			func_651(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_658(Global_1360165[iParam0]))
				{
				}
			}
			func_659(iParam0, Global_1360165[iParam0]);
...
void func_504(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_159() || !_0x6f1f0b17109309da(Global_43800, func_211(iParam0))))
	{
...
void func_521(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			vVar0 = { uParam0->f_1882 * FtoV(func_670(uParam0->f_1898)) };
...
void func_522(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			if (!is_entity_dead(iVar2))
			{
				if (!does_entity_exist(iVar1) || func_193(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_193(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_193(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_671(512) || func_672(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				if (func_673(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_310(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
				...
				else if (func_676(uParam0->f_1633[iVar2]) != 0)
				{
					func_675(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_517(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_193(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_673(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_525(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_677(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_526(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_680(uParam0, iVar0)) && !func_466(uParam0->f_1016[iVar0], 1))
			{
				if (!func_681(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_682(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_683(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_540(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_677(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_296(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (func_557(uParam0->f_475[iParam1], 64) && func_686(uParam0, iParam1, 0))
				{
					func_687(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_688(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					...
					{
						func_688(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_543(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_309(uParam0) != 11) && func_308(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_682(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_545(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_309(uParam0))
	{
		case 0:
			...
			if (((!func_296(uParam0->f_1016[iVar2], 32) && func_691()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_296(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 1:
			...
			if ((((!func_456(Global_35, 716706914) && !func_456(Global_35, 242628503)) && func_21(&(uParam0->f_1869)) >= 2.5f) || (!func_428(func_427(Global_35, 0, 1, 0)) && !func_428(func_427(Global_35, 1, 1, 0)))) || bVar0)
			{
				func_692(uParam0);
				if (bVar0)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_296(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_308(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			if (func_300(Global_35, 242628503) || bVar0)
			{
				func_554(uParam0, 3);
				if (bVar0)
				{
			...
			break;
		case 3:
			if (!func_296(uParam0->f_1016[iVar2], 256))
			{
				if (func_408(&(uParam0->f_1903)))
				{
					func_694(uParam0->f_1903, 0);
				}
			}
			func_26(&(uParam0->f_1869));
			func_554(uParam0, 4);
		...
		case 4:
			...
			if ((func_296(uParam0->f_1016[iVar2], 256) || !func_408(&uVar5)) || bVar0)
			{
				if (func_695())
				{
					func_696();
...
bool func_548(var uParam0, char* sParam1, int iParam2)
{
	...
	{
		iVar16 = -1;
		func_699(uParam0, iVar18);
		if (func_700(uParam0, 0))
		{
			if (func_701(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					uParam0->f_1016[iVar16]->f_27 = 0;
					func_702(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_702(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_702(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_702(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_702(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_702(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_702(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_702(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_702(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_702(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_702(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_702(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_702(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_702(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_702(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_701(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_702(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_702(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_702(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					if (func_703(uParam0, 21, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_19), {Var20}, 3);
					}
					if (func_703(uParam0, 22, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_22), {Var20}, 3);
					}
					func_701(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_704(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_703(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					if (func_701(uParam0, 39, &iVar17))
					{
					...
					if (func_702(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_683(uParam0->f_1016[iVar16], 2);
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_705(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				{
					if (func_701(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_706(uParam0->f_1522[iVar16], 2);
							func_703(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_707(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_706(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_701(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_706(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_706(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
			...
			while (iVar18 < 35)
			{
				...
				{
					if (func_701(uParam0, 51, &iVar17))
					{
						Var2.f_1 = iVar17;
					}
					func_701(uParam0, 43, &(Var2.f_3));
					if (func_703(uParam0, 52, &Var20))
					{
						MemCopy(&(Var2.f_4), {Var20}, 4);
					}
					func_702(uParam0, 53, &(Var2.f_8));
					if (func_701(uParam0, 54, &iVar17))
					{
						Var2.f_10 = iVar17;
					}
					func_707(uParam0, 55, &(Var2.f_11));
					func_707(uParam0, 56, &(Var2.f_12));
					iVar32 = -1;
					if (func_708(uParam0, Var2.f_1, &iVar32))
					{
				...
				if (func_700(uParam0, 57))
				{
					if (func_701(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_701(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_701(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_710(iVar17);
							}
							if (func_701(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_711(iVar17);
							}
							func_701(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_702(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_702(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_702(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_701(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_702(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_701(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_701(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							if (func_701(uParam0, 73, &iVar17))
							{
								uParam0->f_475[iVar16]->f_17 = iVar17;
							}
							if (func_701(uParam0, 75, &iVar17))
							{
								uParam0->f_475[iVar16]->f_4 = iVar17;
								bVar15 = true;
							}
							func_702(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
							if (func_707(uParam0, 63, &bVar19))
							{
								if (bVar19)
								{
			...
			while (iVar18 < 8)
			{
				...
				{
					func_701(uParam0, 86, &iVar16);
					if (iVar16 >= 0)
					{
						func_707(uParam0, 87, uParam0->f_1345[iVar18]);
						func_703(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_703(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_702(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_702(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_701(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_712(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_700(uParam0, 98))
				{
					if (func_701(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_713(uParam0, 99, uParam0->f_1633[iVar16]);
							func_713(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_713(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_701(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_704(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_549(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_332(uParam0->f_1522[iVar0], 2)) && !func_332(uParam0->f_1522[iVar0], 16)) && func_715(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_706(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_706(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_550(var uParam0)
{
	...
	StringCopy(&Var2, func_468(), 64);
	StringCopy(&(Var2.f_8), func_533(), 64);
	uParam0->f_1708 = { Var2 };
	uParam0->f_1731 = { Var2 };
	if (!func_295(uParam0, 8))
	{
		_0x6a4d224fc7643941(func_468());
		func_465(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_468()))
		{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_332(uParam0->f_1522[iVar0], 64))
			{
				...
				{
					func_716(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_706(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_552(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_609(uParam0->f_3[iVar0]->f_2)) && func_428(uParam0->f_3[iVar0]->f_10)) && !func_709(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_717(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_718(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_562(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_722(uParam0, iParam1);
	}
...
void func_563(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_723(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_564(int iParam0, int iParam1, bool bParam2)
{
	...
	func_724(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_572(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_255(iParam0);
	if (((does_entity_exist(iVar1) && func_727(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_575(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	func_731(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_731(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_731(iParam1, 512, 1);
...
{
	iVar0 = func_445(func_736(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	iVar1 = func_445(func_736(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_604(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_738(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_739(iParam0, &iVar0, &fVar25);
...
{
	return func_452(1328661203, func_742(), -1591664384, bParam0);
}
...
struct<4> func_614(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_452(923904168, func_612(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_452(923904168, func_612(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_452(923904168, func_612(bParam0), -740156546, 0);
}
...
bool func_616(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_453(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_617(int iParam0, var uParam1, int iParam2)
{
...
struct<4> func_618(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_452(271701509, func_612(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_452(271701509, func_612(bParam0), 12999093, 0);
}
...
int func_623(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_622(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = 12;
	iVar2 = func_410(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_434(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_410(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_749(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_410(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_622(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_749(&(Global_1946804->f_1497.f_1[iVar1])) || func_622(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_410(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_410(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_410(&(uParam0->f_1[iVar1])) || func_622(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
int func_629(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_752(iParam0, func_436(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_630(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_433(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_753(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_631(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_755(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_254() == -1)
	{
...
bool func_635(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
void func_639(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
bool func_645(int iParam0, bool bParam1)
{
	...
	if ((func_339(iParam0, 1) && !func_166(iParam0)) && func_340(iParam0))
	{
		return false;
	}
	if (!func_339(iParam0, 2))
...
void func_647(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
bool func_652(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_463(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_470((*Global_1360165)[iParam0]->f_4.f_2) || func_297((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_772((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_774(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_567(iParam0, 44, 1);
			}
...
void func_659(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_604(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_604(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_669(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_670(iParam1)) };
...
bool func_673(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
{
	switch (func_676(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_517(uParam0->f_1633[iParam1]->f_10, 256))
			{
				...
				{
					func_694(uParam0->f_1903, 0);
					func_795(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_517(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_796())
				{
					func_795(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
bool func_677(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vVar0 = { vParam4 - vParam1 };
	vVar3 = { vParam1 - vParam10 };
	fVar6 = func_798(vParam7, vVar0);
	fVar7 = -func_798(vParam7, vVar3);
...
void func_678(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_426(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_679(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_800(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_681(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_466(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_684(int iParam0, float fParam1)
{
	...
	if (!(func_803(17) && func_193(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
bool func_686(var uParam0, int iParam1, bool bParam2)
{
...
void func_689(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			{
				if ((func_8(uParam0) > 3 && !func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_804(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					func_706(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
			...
			if (func_557(uParam0->f_475[iParam2], 4))
			{
				...
				if (((((func_304(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_465(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_211(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_296(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
void func_692(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_296(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_296(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_428(func_427(Global_35, 0, 1, 0)) && !func_428(func_427(Global_35, 1, 1, 0))))
		{
			if (func_308(uParam0, uParam0->f_1684))
			{
				func_806(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_296(uParam0->f_1016[uParam0->f_1684], 16) && (func_428(func_427(Global_35, 0, 1, 0)) || func_428(func_427(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_296(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_308(uParam0, uParam0->f_1684) && !func_317(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_554(uParam0, 3);
	}
...
void func_693(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_807(uParam0, iParam1, &vVar1, &fVar0);
	func_805(uParam0, func_534(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_808(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_683(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_467(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_806(vVar1);
	...
	{
		func_809(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
		...
		func_810(uParam0, iParam1, bParam2, &vVar4);
	...
	{
		open_sequence_task(&iVar20);
		func_811(uParam0, iParam1, bParam2, vVar1);
		close_sequence_task(iVar20);
		task_perform_sequence(Global_35, iVar20);
		clear_sequence_task(&iVar20);
	}
...
void func_697(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_816(iVar0));
		iVar0++;
	}
}
...
bool func_705(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (bParam7)
	{
...
bool func_707(var uParam0, int iParam1, bool bParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_708(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_709(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_393(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_794(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_393(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_393(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_794(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_794(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_713(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_715(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_332(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_557(uParam0->f_475[iVar0], 512)) || func_557(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_709(uParam0->f_3[iVar0]->f_1))
				{
					if (func_581())
					{
						StringCopy(&cVar1, func_393(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_393(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
int func_718(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	iVar0 = -1569615261;
...
void func_720(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_162(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_722(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_817(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_732(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_463(iParam0))
	{
		return 0;
	...
	if (func_256(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_820(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_822(iParam0);
					_0x7b204f88f6c3d287(func_823(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_823(iParam0, 0));
					func_824(iParam0);
				}
			}
			else
...
int func_738(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (has_ped_got_weapon(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_826((386 + iVar28), 1);
			if (func_616(iParam0, &Var0, iVar5, 0))
			{
				if (func_617(iParam0, &Var6, iVar5))
				{
					Var29 = { func_452(iParam0, Var0, iVar5, 0) };
					func_827(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_828(0))
				{
					...
					func_829(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_739(int iParam0, int iParam1, float fParam2)
{
	bVar0 = true;
...
int func_741(var uParam0, int iParam1, int iParam2)
{
	iVar0 = 0;
	Var4.f_9 = -1591664384;
	bVar18 = func_831(iParam1, 128);
	if (func_832("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_833(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_831(iParam1, 512) && func_744(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_717(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_831(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_831(iParam1, 4))) && (!func_717(Var4.f_4) || func_831(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_831(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_831(iParam1, 1048576)))
				{
...
{
	iVar0 = func_454(0);
	*uParam1 = { func_452(iParam0, func_614(0), iParam3, 0) };
...
void func_745(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_837(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_837(uParam0->f_2[iVar0], 1))
				{
					func_838(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_747(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_445(iParam0, 1)] != &Global_1946804->f_57[func_445(iParam0, 1)];
}
...
{
	if (iParam0 == &Global_1946804->f_57[func_445(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_755(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_254() == -1)
	{
		func_842(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_843(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_844(&(Global_1946804->f_1378), iParam0);
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_638(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_638(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_761()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_853()));
	fVar7 = (func_848(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_854(3, round((to_float(iVar8) * fVar10)), 0);
	func_855(3, fVar9, fVar9 > 100f);
	return func_856(fVar7, -100f, 100f);
}
...
float func_762()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_853()));
	fVar7 = (func_848(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_854(2, round((to_float(iVar8) * fVar10)), 0);
	func_855(2, fVar9, fVar9 > 100f);
	return func_856(fVar7, -100f, 100f);
}
...
float func_763()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_853()));
	fVar7 = (func_848(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_854(1, round((to_float(iVar8) * fVar10)), 0);
	func_855(1, fVar9, fVar9 > 100f);
...
bool func_765(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_559(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_338(iParam0));
}
...
int func_771(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_859((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_859((*Global_1347702)[63]->f_15, 1) || func_297((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_859((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_859((*Global_1347702)[134]->f_15, 1) || func_297((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_859((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_861(747937920, 1) && !func_859((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_782(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_778(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_778(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_778(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_778(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_778(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_778(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_778(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_778(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_778(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_778(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_778(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_778(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_778(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_778(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_778(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_778(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_778(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_778(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_778(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_778(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_778(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_778(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_778(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_778(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_778(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_778(iParam1, 1544915253))
	{
...
void func_786(int iParam0)
{
	...
	if (func_821(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_574(iParam0);
	func_785(iVar0);
	func_731(iParam0, 8192, 1);
}
...
bool func_799(var uParam0, int iParam1)
{
	...
	if ((func_428(func_718(Global_35, 0, 0, 0)) && !func_296(uParam0->f_1016[iParam1], 16)) && !func_296(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_800(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	if (func_869(uParam0, iParam1, sParam2))
	{
...
void func_801(var uParam0, var uParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
...
void func_804(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		iVar0 = func_718(Global_35, 0, 0, 0);
		if (is_weapon_valid(iVar0))
		{
		...
		iVar0 = func_718(Global_35, 0, 1, 0);
		if (is_weapon_valid(iVar0))
		{
			if (_0x2c83212a7aa51d3d(iVar0))
			{
...
void func_805(var uParam0, bool bParam1)
{
	...
	if ((func_304(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_296(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_465(uParam0, 64);
	}
...
void func_807(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_557(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_516(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_466(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_426(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		else
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_516(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_466(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_426(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_872(uParam0) };
		...
		else if (!func_466(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_426(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
void func_809(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, var uParam7)
{
...
void func_810(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_426(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_466(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_811(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	vVar0 = { func_875(uParam0, iParam1) };
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_426(Global_36, vParam3, 1), 0);
		}
		fVar3 = func_426(vParam3, vVar0, 1);
		if (func_466(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
		...
		if (!func_466(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_466(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
int func_815(int iParam0, int iParam1)
{
	...
	if (func_622(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
...
var func_817(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}
...
float func_820(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
...
int func_823(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_885(iParam0);
	}
...
bool func_827(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
...
void func_830(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_888(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_832(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
bool func_833(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
void func_844(var uParam0, int iParam1)
{
	if (func_254() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_842(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_843(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_854(int iParam0, char* sParam1, bool bParam2)
{
...
void func_855(int iParam0, float fParam1, bool bParam2)
{
...
float func_856(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_869(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
{
	iVar0 = func_718(Global_35, 0, iParam0, 0);
	if (func_428(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
		...
		{
			if (func_428(func_718(Global_35, 0, 7, 0)) || func_428(func_718(Global_35, 0, 9, 0)))
			{
				if (func_428(func_718(Global_35, 0, 8, 0)))
				{
					func_895(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_428(func_718(Global_35, 0, 7, 0)) || func_428(func_718(Global_35, 0, 9, 0)))
			{
				if (func_428(func_718(Global_35, 0, 10, 0)))
				{
					func_895(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_428(func_718(Global_35, 0, 2, 0)))
				{
...
{
	vVar0 = { func_896(vParam0, vParam3, fParam9) };
	vVar3 = { func_896(vParam3, vParam6, fParam9) };
	return func_896(vVar0, vVar3, fParam9);
}
...
bool func_876(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_897(iParam0, 1))
		{
			return false;
		}
	}
	return func_898(iParam0, 0, bParam2) >= iParam1;
}
...
Vector3 func_896(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
bool func_897(int iParam0, int iParam1)
{
	...
	iVar0 = func_901(iParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_832("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
...
int func_898(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_409(iParam0, 0))
	{
		return 0;
	...
	uVar2 = _0xe787f05dfc977bde(func_454(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_899()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_717(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_717(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_901(int iParam0, int iParam1)
{
	...
	if (func_622(iParam0, 1399091007))
	{
		func_904(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_902(int iParam0, bool bParam1)
{
	...
	Var0 = { func_905(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_906(&Var0, func_614(0));
	}
	if (!func_907(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_834(iVar14);
...
void func_904(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
struct<14> func_905(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
...
void func_906(var uParam0, struct<4> Param1)
{
...
bool func_907(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_454(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
