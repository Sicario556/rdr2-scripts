...
void func_50(int iParam0)
{
	...
	set_tv_channel(0);
	if (load_stream("Audience", func_208(*iParam0)))
	{
		iParam0->f_1100 = _0x0556c784fa056628("Audience", func_208(*iParam0));
...
void func_57(var uParam0, var uParam1, int iParam2)
{
	...
	{
		request_waypoint_recording(func_211(iParam2));
		if (get_is_waypoint_recording_loaded(func_211(iParam2)))
		{
	...
	switch (iParam0->f_41)
	{
		...
		case 1:
			...
			if (_0x3ee1f7a8c32f24e1(get_player_index(), &iVar2, 0, 0) && iVar2 == iVar3)
			{
				...
				{
					if (!func_229(iParam0->f_1053[2], &Global_35, "INTERACT_DRAW", 129547951))
					{
						return;
					}
		...
		if (does_entity_exist(&(iParam0->f_81[iVar0])))
		{
			if (!is_entity_dead(&(iParam0->f_81[iVar0])) && !Global_1935630->f_12)
			{
				...
				if (fVar1 < 5f)
				{
					...
					fVar5 = func_216(func_215(vVar2), func_215(get_entity_forward_vector(&(iParam0->f_81[iVar0]))));
					if (fVar5 < 0f)
					{
	...
	switch (iParam0->f_3)
	{
		case 0:
			if (bVar0)
			{
				if (!does_cam_exist(iParam0->f_4))
				{
					iParam0->f_4 = create_camera_with_params(26379945, func_235(iParam0->f_1, 0), func_236(iParam0->f_1, 0), get_final_rendered_cam_fov(), false, 2);
				}
		...
		case 1:
			...
			if (!func_221(&(iParam0->f_1053[3])))
			{
				iParam0->f_1053[3] = func_238("INTERACT_LOOK", -416594956, 6, 570, 570, 10, 1073741824, 0, 1065353216, 0, 1, 1704213876, 0);
		...
		case 3:
			...
			if (is_control_just_pressed(2, -1496944061))
			{
				...
				set_cam_coord(iParam0->f_4, func_235(iParam0->f_1, iParam0->f_8));
				set_cam_rot(iParam0->f_4, func_236(iParam0->f_1, iParam0->f_8), 2);
			}
...
void func_81(int iParam0)
{
	if (func_248(iParam0))
	{
		remove_waypoint_recording(func_211(iParam0));
	}
}
...
{
	func_253(func_252(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}
...
bool func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_258((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_120(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_259((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_258((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_136(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_259((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
int func_156(int iParam0)
{
	switch (iParam0->f_1)
	{
		case 4:
			...
			iParam0->f_1086 = 161262996;
			iParam0->f_1087 = 1496945188;
			iParam0->f_1071 = 0;
			iParam0->f_1070 = 1;
			iParam0->f_1072 = 1;
			iParam0->f_1095 = 1.5f;
...
int func_179(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_267(iVar0, iParam0, bParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_185(var uParam0, int iParam1)
{
	if (does_entity_exist(*uParam0))
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_273(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_273(), 2, 0, 0);
		}
	}
}
...
void func_212(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar5 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			{
				if (func_281(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 != 5)
				{
					(*uParam1)[iVar5]->f_1 = 5;
				}
			}
			else if (func_281(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 == 5)
			{
			...
			if ((!uParam0->f_19 && !func_281(*uParam0, iVar5)) && (*uParam1)[iVar5]->f_1 != 5)
			{
				if ((*uParam1)[iVar5]->f_9)
				{
					fVar6 = func_285(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 > 2f || !func_286((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_9 = 0;
						uParam0->f_21 = 0;
						(*uParam1)[iVar5]->f_5 = 2;
						func_287((*uParam1)[iVar5], iParam2);
					}
				}
				else if (!uParam0->f_21 && (*uParam1)[iVar5]->f_1 != 6)
				{
					fVar6 = func_285(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 < 1.5f && func_286((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_5 = func_288(iVar5);
						func_287((*uParam1)[iVar5], iParam2);
						(*uParam1)[iVar5]->f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch ((*uParam1)[iVar5]->f_1)
			{
				...
				case 1:
					...
					{
						func_291((*uParam1)[iVar5], func_290(iParam2), 500);
					}
					break;
				case 3:
				...
				case 5:
					if (!uParam0->f_19)
					{
						func_293(uParam0, (*uParam1)[iVar5]);
					}
					break;
				case 6:
				...
				case 9:
					if (func_248(iParam2))
					{
						...
						{
							task_follow_waypoint_recording(uParam1[iVar5], func_211(iParam2), 0, 10, -1, 0, 0, -1);
							(*uParam1)[iVar5]->f_1 = 10;
						}
					}
					else
					{
						task_follow_nav_mesh_to_coord(uParam1[iVar5], func_294(iParam2), 1f, -1, 0.25f, 5373953, 40000f);
						_0x2208438012482a1a(uParam1[iVar5], false, false);
						(*uParam1)[iVar5]->f_1 = 10;
					}
					break;
				case 10:
					...
					else if (!func_295(get_entity_coords(uParam1[iVar5], true, false)))
					{
					...
					else if (get_script_task_status(uParam1[iVar5], 713668775, true) != 1 && fVar2 > (func_284(iParam2, iVar5) + 3f))
					{
						(*uParam1)[iVar5]->f_1 = 9;
					}
					break;
				case 11:
					...
					waypoint_recording_get_num_points(func_211(iParam2), &iVar3);
					waypoint_recording_get_closest_waypoint(func_211(iParam2), get_entity_coords(uParam1[iVar5], true, false), &iVar4);
...
int func_222(int iParam0, var uParam1)
{
	...
	if (!func_229(iParam0->f_1053[1], uParam1, "SHOW_POS_RESPONSE", -163964935))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_296(&(iParam0->f_1053[1]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	if (!func_229(iParam0->f_1053[0], uParam1, "SHOW_NEG_RESPONSE", 648122183))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_296(&(iParam0->f_1053[0]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	return 1;
}
...
void func_227()
{
	...
	bVar0 = false;
	if (is_ped_active_in_scenario(Global_35, 1) || (func_305(36) && _0x3ab6c7b0bb0df4b1(Global_35, -1)))
	{
		bVar0 = true;
	}
	if (!bVar0)
	{
		task_play_anim(Global_35, func_157(), func_309(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_157(), func_309(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
bool func_229(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	if (!func_221(*uParam0))
	{
		*uParam0 = func_311(sParam2, iParam3, *uParam1, 1, 0, 0, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
	}
	if (!func_221(*uParam0))
	{
		return false;
...
int func_238(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_313(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
void func_247(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_315(iParam0, 0, 0);
	if (func_316(iParam0))
	{
...
void func_253(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = round(func_331(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_262(int iParam0)
{
	...
	if (!load_stream("Audience", sVar0))
	{
	}
	if (!is_named_rendertarget_registered(iParam0->f_1075))
	{
		register_named_rendertarget(iParam0->f_1075, false);
		link_named_rendertarget(iParam0->f_1086);
		if (!is_named_rendertarget_linked(iParam0->f_1086))
		{
			release_named_rendertarget(iParam0->f_1075);
			return 0;
		}
	}
	iParam0->f_1074 = get_named_rendertarget_render_id(iParam0->f_1075);
	if (iParam0->f_1072)
	{
		if (iParam0->f_1090 == 0)
		{
			iParam0->f_1090 = _0x6f3068258a499e52(iParam0->f_1087, iParam0->f_1083, 7);
		}
		else if (_0x1ff441d7954f8709(iParam0->f_1090))
		{
			iParam0->f_1089 = get_object_index_from_entity_index(_0x4735e2a4bb83d9da(iParam0->f_1090));
		}
		if (!does_entity_exist(iParam0->f_1089))
		{
			return 0;
		...
		_0xf49574e2332a8f06(iParam0->f_1089, 0f);
		_0x04d1d4e411ce52d0(iParam0->f_1089, iParam0->f_1074);
	}
	set_text_render_id(iParam0->f_1074);
...
void func_264(int iParam0)
{
	if (!does_entity_exist(&(iParam0->f_66[0])))
	{
		iParam0->f_66[0] = create_object_no_offset(&(iParam0->f_58[0]), iParam0->f_1077, true, true, false, true);
		iParam0->f_1088 = &iParam0->f_66[0];
	}
	if (does_entity_exist(iParam0->f_1088))
	{
		set_entity_rotation(iParam0->f_1088, iParam0->f_1080, 2, true);
		set_entity_visible(iParam0->f_1088, false);
		set_entity_dynamic(iParam0->f_1088, false);
		set_entity_proofs(iParam0->f_1088, 31, false);
		freeze_entity_position(iParam0->f_1088, true);
	}
}
...
void func_267(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_338(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_339(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_340(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_341(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_342(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_343(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_344(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_345(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_346(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_347(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_348(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_349(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_350(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_351(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_352(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_353(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 4:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_354(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_355(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_356(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_357(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 5:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_358(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_359(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_360(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_361(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 6:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_362(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_363(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_364(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_365(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 7:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_366(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_367(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_368(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_369(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 8:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_370(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_371(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_372(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_373(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 9:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_374(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_375(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_376(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_377(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 10:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_378(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_379(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_380(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_381(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 11:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_382(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_383(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_384(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_385(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 12:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_386(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_387(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_388(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_389(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 13:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_390(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_391(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_392(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_393(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 16:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_394(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_395(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_396(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_397(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 17:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_398(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_399(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_400(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_401(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 18:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_402(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_403(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_404(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_405(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 20:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_406(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_407(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_408(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_409(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 21:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_410(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_411(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_412(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_413(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 19:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_414(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_415(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_416(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_417(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 22:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_418(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_395(get_random_int_in_range(0, func_337(16, iParam1, iParam2)));
						case 2:
							return func_396(get_random_int_in_range(0, func_337(16, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_419(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 23:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_420(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_421(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_422(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_423(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 24:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_424(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_425(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_426(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_427(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 25:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_428(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_429(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_430(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_431(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		...
		case 27:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_432(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_433(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_434(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_435(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 28:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_436(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_433(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_434(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_437(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 29:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_438(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_433(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_434(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_439(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 30:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_440(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_433(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_434(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_441(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 31:
			break;
		case 32:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_442(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_443(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 33:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_444(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_445(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 34:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_446(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_447(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 14:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_448(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_449(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_450(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_451(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
		case 15:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_452(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 1:
							return func_449(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
						case 2:
							return func_450(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_453(get_random_int_in_range(0, func_337(iParam0, iParam1, iParam2)));
			}
			break;
	}
	return "FAIL";
...
int func_283(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return 1;
		case 0:
			if (func_454((*Global_1835011)[36]->f_1))
			{
				return 0;
			}
			else
...
void func_287(int* iParam0, int iParam1)
{
	if ((does_entity_exist(*iParam0) && !iParam0->f_9) && iParam0->f_5 != -1)
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_273(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_273(), 2, 0, 0);
		}
	}
	if (!iParam0->f_9)
	{
...
void func_298(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_301(iParam0, 8))
		{
...
int func_311(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	if (is_string_null_or_empty(sParam0))
	{
		return 0;
	...
	while (iVar0 < 48)
	{
		if (func_301(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_313(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
