...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.04f, -0.08f, 0f, -1.44f, 2.56f, 2.2475f, 5f, -1612834106, -1495061186, 1, 1, 1);
	func_151(uParam0, -2.5686f, -10.618f, 0f, -11.5f, 1.41f, 1.325f, 5f, -1612834106, 2017216891, 1, 1, 1);
	iLocal_20 = func_152(uParam0, -548150401, 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_19 = func_152(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	func_153(uParam0, "script@vignette@john_7@base", 65, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@john_7@action_a", 66, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@john_7@action_b", 64, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@john_7@action_b_alt", 64, 0, 0, 1);
	func_154(uParam0, "CJHN7AU");
	func_155(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_156(uParam0, iLocal_15, 2, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_15, iLocal_19, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_14, 3, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	Local_21 = { func_158(uParam0, -1.59f, -1.9876f, 0.988f, -180f, 7.12f, 0.325f, 0.51f) };
	return true;
}
...
{
	func_190(func_189(uParam0, iLocal_20), 0);
	return true;
}
