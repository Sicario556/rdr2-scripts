...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5f, -9f, 0f, 9f, 3f, 2.5f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -0.25f, -1.25f, 0f, 0f, 1f, 1f, 5f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_50 = func_152(uParam0, -548150401, 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	func_152(uParam0, 2095602337, 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	func_152(uParam0, -1006095118, -0.258f, -1.197f, 0.032f, "CHAIR", 1, 0, 1);
	func_153(uParam0, "script@vignette@dutch_and_hosea_9@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@dutch_and_hosea_9@action_a", 2, 0, 1, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@dutch_and_hosea_9@action_b_int_front", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_and_hosea_9@action_b_int_left", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@dutch_and_hosea_9@action_b_int_right", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_and_hosea_9@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CCDH9");
	func_155(uParam0, 2118445311, -1847155907);
	func_156(uParam0, iLocal_19, -1, 0.9f);
	Local_20 = { func_157(uParam0, 4.5f, -9.5f, 1.3f, 10f, 8f, 0.5f, 0.5f) };
	Local_30 = { func_157(uParam0, 4.5f, -9.5f, 1.3f, 90f, 8f, 0.5f, 0.39f) };
	Local_40 = { func_157(uParam0, 4.5f, -9.5f, 1.3f, -57.5f, 8f, 0.25f, 0.25f) };
	func_158(uParam0, iLocal_14, 2, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1, -1073741824, 1065353216, 1);
...
{
	func_192(func_191(uParam0, iLocal_50), 0);
	return true;
}
...
bool func_93(var uParam0)
{
	if (func_200(uParam0, iLocal_15))
	{
		...
		else if (func_201(uParam0, Local_30, 1, 0))
		{
			func_190(uParam0, iLocal_17, 1);
		}
		else if (func_201(uParam0, Local_40, 1, 0))
		{
