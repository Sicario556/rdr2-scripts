...
bool func_42(var uParam0)
{
	*uParam0 = 14;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = -1247518231;
	uParam0->f_572[1] = 316681083;
	uParam0->f_572[2] = -1247518231;
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 4;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = 1755643085;
	uParam0->f_12.f_3 = 0.75f;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = -386220147;
	return true;
}
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_PR");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_PR");
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -3916.267f, -3657.765f, 47.1306f;
				case 1:
					return -3781.881f, -3653.053f, 39.5285f;
				case 2:
					return -3863.08f, -3672.154f, 41.0701f;
				case 3:
					return -3824.755f, -3527.483f, 53.7911f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 0:
					return -3791.538f, -3588.952f, 45.8875f;
				case 1:
					return -3931.341f, -3602.614f, 52.8594f;
				case 2:
					return -3863.263f, -3523.039f, 55.3003f;
				case 3:
					return -3861.089f, -3673.926f, 40.741f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 0:
					return -3846.066f, -3542.332f, 52.0003f;
				case 1:
					return -3886.203f, -3649.99f, 43.989f;
				case 2:
					return -3809.473f, -3562.397f, 49.9921f;
				case 3:
		...
		case 3:
			...
			{
				case 0:
					return -3889.806f, -3592.1f, 50.8374f;
				case 1:
					return -3859.016f, -3680.142f, 39.9526f;
				case 2:
					return -3836.116f, -3606.811f, 44.1589f;
				case 3:
					return -3799.886f, -3588.556f, 46.021f;
			}
			break;
	}
	return 0f, 0f, 0f;
