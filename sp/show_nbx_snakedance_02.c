...
void func_27(int iParam0)
{
	...
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@snake_dancer@act2_p1@action", 2, func_156(0), false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (11 - 1))
	{
		iVar1 = iVar0;
		Local_1141.f_5[iVar0] = get_hash_key(func_157(iVar1));
		iVar0++;
	}
	Local_1141.f_4 = 0;
...
void func_63(int iParam0)
{
	...
	switch (iVar1138)
	{
		...
		case 3:
			...
			break;
		case 4:
			if (_0x1f0e401031e20146(iParam0->f_48, func_156(1)) && fVar1 >= 0.8f)
			{
				func_237(0);
	...
	switch (iParam0->f_3)
	{
		case 0:
			if (bVar0)
			{
				if (!does_cam_exist(iParam0->f_4))
				{
					iParam0->f_4 = create_camera_with_params(26379945, func_239(iParam0->f_1, 0), func_240(iParam0->f_1, 0), get_final_rendered_cam_fov(), false, 2);
				}
		...
		case 3:
			...
			if (is_control_just_pressed(2, -1496944061))
			{
				...
				set_cam_coord(iParam0->f_4, func_239(iParam0->f_1, iParam0->f_8));
				set_cam_rot(iParam0->f_4, func_240(iParam0->f_1, iParam0->f_8), 2);
			}
...
void func_235(int iParam0, float fParam1)
{
	...
	switch (Local_1141.f_4)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_5[iVar1])))
				{
					if (iVar1 == 1)
					{
		...
		case 1:
			break;
		case 2:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_5[9])))
			{
				Global_1394141->f_1332 = func_315(9);
			}
			break;
		case 3:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_5[10])))
			{
