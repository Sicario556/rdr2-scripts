...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_241(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_254(func_149(uParam0), func_253(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_231(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_219() == -1)
		{
