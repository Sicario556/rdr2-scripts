...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, -50684386, "COW");
	...
	iLocal_18 = func_159(uParam0, -2.25f, 2.1f, 1.95f, 0f, 0f, -4f, 10.75f, 7.48f, 4f, "volTrigger", -1612834106);
	func_160(uParam0, 1);
...
{
	_set_ped_scale(uParam0->f_107[iLocal_17]->f_5, 1f);
	return true;
}
...
{
	if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_16]), "COW") && !func_108(&uLocal_19))
	{
		_task_start_scenario_in_place(func_48(uParam0, iLocal_17), -830507952, 0, false, 0, -1f, false);
		set_blocking_of_non_temporary_events(func_48(uParam0, iLocal_17), true);
...
bool func_95(var uParam0)
{
	...
	{
		set_ped_can_play_ambient_anims(func_48(uParam0, iLocal_17), false);
		set_ped_can_play_ambient_base_anims(func_48(uParam0, iLocal_17), false);
	}
	if (is_entity_occluded(func_48(uParam0, iLocal_17)) && func_208(func_48(uParam0, iLocal_17), Global_35, 1) >= 144f)
	{
...
bool func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	return func_295(Global_35, *iParam1, 1, 0);
}
