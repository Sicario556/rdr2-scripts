...
{
	uLocal_30 = _0xb223249b7798eeed(func_48(uParam0, iLocal_14), 587350641, 262145, -1991163866);
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(747937920, 1) && !func_395((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
