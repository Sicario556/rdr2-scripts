...
{
	if (!bLocal_20 && ped_has_use_scenario_task(func_48(uParam0, iLocal_14)))
	{
		_0xec6935ebe0847b90(func_48(uParam0, iLocal_14), get_offset_from_entity_in_world_coords(func_48(uParam0, iLocal_14), 1f, 0f, 0f));
		bLocal_20 = true;
	}
	return true;
}
