...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if ((bLocal_38 || is_entity_dead(&(uParam0->f_20[0]))) || is_entity_dead(&(uParam0->f_20[1])))
		{
