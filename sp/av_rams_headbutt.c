...
{
	func_33(uParam0, 10947, 11013, 11772);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if ((func_66(uParam0, &uLocal_11, 1) || func_67(Global_35, &(uParam0->f_20[0]), 1) <= 400f) || func_67(Global_35, &(uParam0->f_20[1]), 1) <= 400f)
			{
				bLocal_39 = true;
			}
		}
						...
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_is_anim_scene_finished(uParam0->f_3.f_1, false) || _is_anim_scene_active(uParam0->f_3.f_1))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									...
									set_ped_as_no_longer_needed(uParam0->f_20[0]);
								}
								if (!is_entity_dead(&(uParam0->f_20[1])))
								{
									func_57(uParam0->f_20[1], 0, 1);
									set_ped_as_no_longer_needed(uParam0->f_20[1]);
								}
								uParam0->f_469[3] = 1;
								return 1;
							}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_67(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_67(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_68(&(uParam0->f_490)))
							{
