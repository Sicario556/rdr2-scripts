...
int func_6(var uParam0)
{
	...
	switch (uParam0->f_17)
	{
		case 63:
			...
			{
				uParam0->f_20 = _0x57e798b57c45ee16(get_hash_key(&((*Global_1835011)[uParam0->f_22]->f_8)));
			}
			else
			{
		...
		case 64:
			...
			{
				uParam0->f_20 = _0x57e798b57c45ee16(get_hash_key(&((*Global_1347702)[uParam0->f_23]->f_3)));
			}
			else
			{
				uParam0->f_20 = -1;
		...
		case 62:
			switch (func_15(uParam0))
			{
				case 0:
					...
					if (!_does_streamed_txd_exist(uParam0->f_20))
					{
	...
	if (_does_streamed_txd_exist(uParam0->f_20))
	{
		_request_streamed_txd(uParam0->f_20, true);
		uParam0->f_21 = 1;
		return 1;
	}
	return 0;
...
void func_19(var uParam0)
{
	...
	if (!bVar0)
	{
		...
		{
			sVar2 = _create_var_string(2, "NO_WEAPON_REGION");
			bVar0 = true;
		}
	}
	_databinding_write_data_bool(uParam0->f_11, bVar0);
...
bool func_21(int iParam0, var uParam1)
{
	...
	while (iVar0 < &Global_1898330)
	{
		...
		else if ((*Global_1898346)[iVar0]->f_3 == 1)
		{
			*uParam1 = (*Global_1898346)[iVar0]->f_4;
			if ((func_51(*uParam1) && does_blip_exist((*Global_1835011)[*uParam1]->f_27)) && (*Global_1835011)[*uParam1]->f_27 == iParam0)
			{
				return true;
			}
		}
...
bool func_22(int iParam0, var uParam1)
{
	...
	{
		if (((func_52(&(Global_40.f_450[iVar0])) && does_blip_exist((*Global_1347702)[&Global_40.f_450[iVar0]]->f_37)) && (*Global_1347702)[&Global_40.f_450[iVar0]]->f_37 == iParam0) && !func_53((*Global_1347702)[&Global_40.f_450[iVar0]]->f_12, 16777216))
		{
...
bool func_29(var uParam0)
{
	...
	if (_does_streamed_txd_exist(uParam0->f_20) && _has_streamed_txd_loaded(uParam0->f_20))
	{
		uParam0->f_21 = 0;
		return true;
	}
...
void func_30(int iParam0, var uParam1)
{
	...
	_databinding_add_data_hash(uParam1->f_9, "name", (*Global_1835011)[uParam1->f_22]->f_26);
	MemCopy(&cVar0, {(*Global_1835011)[uParam1->f_22]->f_8}, 2);
	StringConCat(&cVar0, "_DESC_PM", 16);
	if (!does_text_label_exist(&cVar0))
	{
		StringCopy(&cVar0, "", 16);
	}
	iVar2 = get_hash_key(&((*Global_1835011)[uParam1->f_22]->f_8));
...
void func_31(int iParam0, var uParam1)
{
	...
	else if (func_53((*Global_1347702)[uParam1->f_23]->f_12, 16777216))
	{
		return;
	}
	func_26(uParam1);
	uParam1->f_9 = _databinding_add_data_container(uParam1->f_8, "BLIP");
	_databinding_add_data_hash(uParam1->f_9, "name", (*Global_1347702)[uParam1->f_23]->f_36);
	MemCopy(&cVar0, {(*Global_1347702)[uParam1->f_23]->f_3}, 2);
	StringConCat(&cVar0, "_DESC_PM", 16);
	if (!does_text_label_exist(&cVar0))
	{
		MemCopy(&cVar0, {(*Global_1347702)[uParam1->f_23]->f_3}, 2);
	...
	iVar2 = get_hash_key(&((*Global_1347702)[uParam1->f_23]->f_3));
	_databinding_add_data_hash(uParam1->f_9, "description", get_hash_key(&cVar0));
	_databinding_add_data_hash(uParam1->f_9, "description_title", iVar2);
	if (!func_53((*Global_1347702)[uParam1->f_23]->f_12, 1) && (func_53((*Global_1347702)[uParam1->f_23]->f_12, 2) || (*Global_1347702)[uParam1->f_23]->f_36 == -1822497728))
	{
		_databinding_add_data_hash(uParam1->f_9, "imageTXD", -1859668514);
		_databinding_add_data_hash(uParam1->f_9, "imageTX", -712210889);
	}
	else
	{
		_databinding_add_data_hash(uParam1->f_9, "imageTXD", _0x57e798b57c45ee16(iVar2));
...
void func_32(int iParam0, var uParam1)
{
	...
	_databinding_add_data_hash(uParam1->f_9, "name", func_64(iParam0));
	_databinding_add_data_hash(uParam1->f_9, "description_title", get_hash_key(func_61(iVar0)));
	_databinding_add_data_hash(uParam1->f_9, "description", func_65(iParam0));
	if (_does_streamed_txd_exist(uParam1->f_20))
	{
		_databinding_add_data_hash(uParam1->f_9, "imageTXD", func_23(iParam0));
		_databinding_add_data_hash(uParam1->f_9, "imageTX", func_23(iParam0));
	}
	else
	{
		uParam1->f_20 = func_24();
		_databinding_add_data_hash(uParam1->f_9, "imageTXD", uParam1->f_20);
	}
	iVar1 = func_42(iVar0);
	if (func_46(iVar1))
	{
...
void func_33(int iParam0, var uParam1)
{
	...
	func_26(uParam1);
	uParam1->f_9 = _databinding_add_data_container(uParam1->f_8, "BLIP");
	Var2 = { func_66(int_to_playerindex(iVar1)) };
	_databinding_add_data_string(uParam1->f_9, "name", func_67(get_player_name(int_to_playerindex(iVar1)), 109029619));
	_databinding_add_data_hash(uParam1->f_9, "description", -436556357);
	_databinding_add_data_hash(uParam1->f_9, "description_title", 0);
	_databinding_add_data_hash(uParam1->f_9, "imageTXD", get_hash_key(func_69(0, &Var2, func_68(0))));
	_databinding_add_data_hash(uParam1->f_9, "hint_name", -486609646);
	_databinding_add_data_int(uParam1->f_9, "hint_value", func_70(iVar1));
...
void func_34(int iParam0, var uParam1)
{
	...
	func_26(uParam1);
	uParam1->f_9 = _databinding_add_data_container(uParam1->f_8, "BLIP");
	_databinding_add_data_hash(uParam1->f_9, "name", get_hash_key(func_71(iVar1)));
	_databinding_add_data_hash(uParam1->f_9, "description", -436556357);
	_databinding_add_data_hash(uParam1->f_9, "description_title", 0);
	_databinding_add_data_hash(uParam1->f_9, "imageTXD", func_25(uParam1->f_17, uParam1->f_19));
	_databinding_add_data_hash(uParam1->f_9, "hint_name", 0);
	_databinding_add_data_string(uParam1->f_9, "hint_value", "");
	_databinding_insert_ui_item_to_list_from_context_string_alias(uParam1->f_8, -1, "map_card_mission", uParam1->f_9);
}
...
void func_35(int iParam0, var uParam1)
{
	...
	func_26(uParam1);
	uParam1->f_9 = _databinding_add_data_container(uParam1->f_8, "BLIP");
	_databinding_add_data_hash(uParam1->f_9, "name", &(Global_1058888->f_43923.f_283[iVar1]));
	_databinding_add_data_hash(uParam1->f_9, "description", -436556357);
	_databinding_add_data_hash(uParam1->f_9, "description_title", 0);
	_databinding_add_data_hash(uParam1->f_9, "imageTXD", func_25(uParam1->f_17, uParam1->f_19));
	_databinding_add_data_hash(uParam1->f_9, "hint_name", 0);
...
void func_36(int iParam0, var uParam1)
{
	...
	func_26(uParam1);
	uParam1->f_9 = _databinding_add_data_container(uParam1->f_8, "BLIP");
	_databinding_add_data_hash(uParam1->f_9, "name", func_72(iVar1));
	_databinding_add_data_hash(uParam1->f_9, "description", -436556357);
	_databinding_add_data_hash(uParam1->f_9, "description_title", 0);
	_databinding_add_data_hash(uParam1->f_9, "imageTXD", func_25(uParam1->f_17, uParam1->f_19));
	_databinding_add_data_hash(uParam1->f_9, "hint_name", 0);
...
void func_37(int iParam0, var uParam1)
{
	...
	switch (func_74(iParam0))
	{
		...
		case 2:
			StringCopy(&Var1, func_57(iParam0), 128);
			iVar0 = func_75(get_blip_coords(uParam1->f_19), 1);
			StringCopy(&cVar33, func_60(iVar0), 128);
		...
		case 3:
			...
			break;
		case 4:
			set_blip_flashes(uParam1->f_19, &uVar49, &iVar50);
	...
	_databinding_add_data_hash(uParam1->f_9, "imageTXD", func_25(iParam0, uParam1->f_19));
	_databinding_add_data_hash(uParam1->f_9, "hint_name", 0);
...
int func_40(int iParam0, bool bParam1, bool bParam2)
{
	switch (iParam0)
	{
		...
		case 22:
			...
			if (func_82((*Global_1835011)[59]->f_1, 1))
			{
				return 965626876;
			}
			else
		...
		case 37:
			...
			if (func_82((*Global_1347702)[9]->f_15, 1))
			{
				return -497792649;
			}
			else if (func_49(45))
...
bool func_48(int iParam0)
{
	...
	{
		return func_82((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_60(int iParam0)
{
	...
	return func_97((*Global_1888801)[iParam0]->f_22);
}
...
char* func_67(char* sParam0, int iParam1)
{
	...
	return func_99(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
char* func_69(int iParam0, var uParam1, var uParam2)
{
	...
	switch (iParam0)
	{
		...
		default:
			sVar0 = "Unknown Type";
			break;
			sVar0 = _0xb5c4b18b12a2af23(uParam1, 0);
			break;
		case 1:
			iVar1 = network_get_player_from_gamer_handle(uParam1);
			if (iVar1 < 0)
			{
				sVar0 = _0xcaf4ca2f87779f8f(uParam1, 0);
			}
			else
			{
...
var func_72(int iParam0)
{
	...
	return &((*Global_1116295)[iParam0]->f_11.f_7[func_106(iVar0, 1)]);
}
...
{
	return _0x356f9fb0698c1feb(iParam0, 0);
}

int func_104(int iParam0)
{
	return Global_1116295[iParam0];
}
...
int func_114(var uParam0, var uParam1)
{
	...
	else if (!stat_id_get_bool(&uParam0, &uVar0))
	{
		return 0;
	}
	return uVar0;
...
int func_115(vector3 vParam0)
{
	...
	return func_119(vParam0, (*Global_1894052)[iVar0]->f_1, (*Global_1894052)[iVar0]->f_2, Global_1894052[iVar0], 4);
}
