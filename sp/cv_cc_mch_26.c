...
void func_203(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_311(func_148(uParam0), func_310(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
...
void func_204(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4)
{
	...
	uParam0->f_107[iParam1]->f_32.f_51 = fParam4;
}
...
float func_216(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_322(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_217(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_323(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_219(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_324(iParam0);
	}
...
bool func_248(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_330(&(Global_1898164->f_1[0]));
		if (func_331(iVar0) && func_332((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_412(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_370(iParam0, 8))
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_339(747937920, 1) && !func_421((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
