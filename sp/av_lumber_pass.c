...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "Male01", -597362537, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "male", -597362537, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 0, "LUMBER", 1539235365, 0f, 0f, 0f, 0f, 1);
}
...
{
	if (!_has_scenario_type_loaded(1546182539, false))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	if (*uParam0 == 10)
	{
		...
		{
			_0xf7ea250b9a919e03(835253196, &(uParam0->f_20[0]));
			if (_0x854bc9b1a1ccd034(835253196, &(uParam0->f_20[0])))
			{
				return true;
			}
		}
...
{
	_request_scenario_type(1546182539, 5, 0, -2144819164);
	func_57(&uLocal_9, 0);
	func_58(&uLocal_9, 1);
	func_59(&uLocal_9, 1);
	func_60(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		else if ((_0xa96619fe85159ed2(uParam0->f_3.f_1) || _0xd70c7a30412f8fa0(uParam0->f_3.f_1)) || _0x9aae3c1148a09bca(uParam0->f_3.f_1))
		{
			uParam0->f_469[0] = 1;
		}
		if (&uParam0->f_469[0])
		...
		if (!is_entity_dead(Global_35) && !is_entity_dead(&(uParam0->f_20[0])))
		{
			if (func_68(uParam0, 0.5f, fLocal_37, 4, fLocal_38, 1112014848))
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					...
					{
						func_66(uParam0);
						set_anim_scene_bool(uParam0->f_3.f_1, "Loop", true, false);
						uParam0->f_469[1] = 1;
						uParam0->f_469[2] = 1;
					}
				}
	...
	if (uParam0->f_469[2] && !&uParam0->f_469[3])
	{
		if (!&uParam0->f_469[7])
		{
			if (func_69(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
			{
				func_67(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[7] = 1;
			}
		...
		if (_does_anim_scene_exist(uParam0->f_3.f_1))
		{
			if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
			{
				if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_372[0]->f_1))
				{
					if (!is_entity_dead(&(uParam0->f_372[0])))
					{
						if (*uParam0 == 10)
						{
							_0x3bbdd6143ff16f98(&(uParam0->f_20[0]), &(uParam0->f_372[0]), "p_lumber09_piece01x_PH_R_HAND", "WORLD_HUMAN_LUMBER_PUT_DOWN_1", 0, 1);
							bLocal_39 = true;
						}
						else
						{
				...
				if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
				{
					if (!is_entity_dead(&(uParam0->f_20[0])))
					{
						...
						if (*uParam0 == 10)
						{
							_task_use_nearest_scenario_to_coord(0, -297.13f, 816.86f, 117.82f, 0.5f, 1000, true, true, false, false);
						}
						_task_use_nearest_scenario_to_coord(0, -300.2f, 817.09f, 117.63f, 0.5f, 90000, true, true, false, false);
				...
				if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
				{
					...
					{
						_task_start_scenario_in_place(&(uParam0->f_20[1]), 1546182539, 5000, false, -2144819164, 0.3f, false);
	...
	if (bLocal_39)
	{
		set_ped_reset_flag(&(uParam0->f_20[0]), 202, true);
	}
...
int func_32(var uParam0, var uParam1)
{
	if (*uParam0 == 10)
	{
		...
		{
			_0xde7b2b4144906cdf(835253196, &(uParam0->f_20[0]));
		}
	}
	else if (does_entity_exist(&(uParam0->f_372[0])))
	{
		freeze_entity_position(&(uParam0->f_372[0]), false);
	}
...
bool func_50(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_85(&(Global_1898164->f_1[0]));
		if (func_86(iVar0) && func_87((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
void func_100(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_161(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_161(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_161(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
float func_106(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_162(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
