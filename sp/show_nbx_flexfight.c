void __EntryFunction__()
{
	...
	while (true)
	{
		bVar1 = func_4(Global_35, Global_1394141->f_7[Local_22]->f_4, 1, 0);
		bVar2 = func_4(Global_35, &(Local_22.f_35[3]), 1, 0);
		fVar3 = func_5(Global_35, Global_1394141->f_7[Local_22]->f_1, 1);
		...
		if (!Local_22.f_14)
		{
			...
			if ((func_14(get_player_index(), 1, 0, 1) || is_ped_in_combat(Global_35, 0)) || Global_1394141->f_1279[Local_22.f_1]->f_6)
			{
		...
		if (func_8(&Local_22) >= 8 && bVar1)
		{
			...
			while (iVar4 <= 5)
			{
				if ((func_20(&(Local_22.f_74[iVar4])) && does_entity_exist(&(Local_22.f_81[iVar4]))) && !is_entity_dead(&(Local_22.f_81[iVar4])))
				{
					set_ped_reset_flag(&(Local_22.f_81[iVar4]), 261, true);
				}
				iVar4++;
			}
		}
		if (_does_anim_scene_exist(Local_22.f_48) && _is_anim_scene_started(Local_22.f_48, false))
		{
			if (bVar1)
			{
				if (!get_anim_scene_bool(Local_22.f_48, "b_ShowCrowd"))
				{
					set_anim_scene_bool(Local_22.f_48, "b_ShowCrowd", true, false);
				}
			}
			else if (get_anim_scene_bool(Local_22.f_48, "b_ShowCrowd"))
			{
				set_anim_scene_bool(Local_22.f_48, "b_ShowCrowd", false, false);
			}
		}
		switch (func_8(&Local_22))
		{
			...
			case 2:
				...
				if (func_32(&Local_22))
				{
					...
					if (!Local_22.f_14)
					{
						if (!Local_22.f_1070)
						{
							start_anim_scene(Local_22.f_49);
						}
						else
						{
							func_34(&Local_22);
			...
			case 8:
				...
				{
					if (_does_anim_scene_exist(Local_22.f_48) && !func_2(Local_22.f_16, 128))
					{
						start_anim_scene(Local_22.f_48);
						func_7(&(Local_22.f_16), 128);
					}
					if (_does_anim_scene_exist(Local_22.f_49) && !func_2(Local_22.f_16, 512))
					{
					...
					if (func_2(Local_22.f_17, 1) && load_stream(func_55(Local_22), func_56(Local_22)))
					{
						iVar5 = _0x0556c784fa056628(func_55(Local_22), func_56(Local_22));
						if (iVar5 != -1)
						{
							play_stream_from_position(2548.749f, -1305.267f, 50.01453f, iVar5);
						}
					}
					if (_does_anim_scene_exist(Local_22.f_48))
					{
						if (_is_anim_scene_started(Local_22.f_48, false))
						{
							func_9(&Local_22, 9);
						}
					}
			...
			case 9:
				...
				{
					if (_is_anim_scene_started(Local_22.f_48, false) && _get_anim_scene_progress(Local_22.f_48) > func_64())
					{
				...
				else if (func_2(Local_22.f_16, 8388608))
				{
					...
					if (Local_22.f_14)
					{
						...
						{
							if (_get_anim_scene_progress(Local_22.f_48) > 0.99f)
							{
								func_9(&Local_22, 10);
							}
							if (Local_22 != 7)
			...
			case 10:
				...
				{
					iVar6 = get_interior_at_coords(func_76(Local_22.f_1));
				...
				if (!Local_22.f_14 && (func_2(Global_1394141->f_1326, -2147483648) || func_2(Local_22.f_16, 33554432)))
				{
					if (!bVar1)
					{
						...
						Global_1394141->f_1330 = 0;
						if (_does_anim_scene_exist(Local_22.f_49))
						{
							_delete_anim_scene(Local_22.f_49);
						}
			...
			case 11:
				...
				if (!Local_22.f_14)
				{
					if (!bVar1)
					{
						if (Local_22.f_2 == 0)
						{
							Global_1394141->f_1279[Local_22.f_1]->f_6 = 0;
							terminate_this_thread();
						}
					}
					else
...
{
	iParam0->f_74[0] = -1922688829;
	iParam0->f_58[0] = -2021274799;
	iParam0->f_58[1] = 330367347;
	iParam0->f_58[2] = 330367347;
	func_7(&(iParam0->f_16), 1024);
	func_7(&(iParam0->f_16), 512);
	...
	if (func_156())
	{
		func_157(&(iParam0->f_954), Global_35, "JOHN", 0);
	}
	else
	{
		func_157(&(iParam0->f_954), Global_35, "ARTHUR", 0);
	}
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@flex_fight@act2@action", 2, func_147(0), false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (17 - 1))
	{
		iVar1 = iVar0;
		Local_1155.f_33[iVar0] = get_hash_key(func_158(iVar1));
		iVar0++;
	}
	Local_1155.f_51 = 0;
...
bool func_30(int iParam0)
{
	...
	if (!has_anim_dict_loaded(func_159()))
	{
		return false;
	}
	if (!func_160(iParam0))
	...
	switch (iParam1)
	{
		case 0:
			...
			while (iVar0 <= (12 - 1))
			{
				...
				{
					request_anim_dict(func_172(iVar1));
				}
				iVar0++;
			}
...
bool func_36(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (func_171(iVar1, *uParam0) && !has_anim_dict_loaded(func_172(iVar1)))
				{
					bVar2 = false;
				}
				iVar0++;
			...
			if (!func_174(uParam0->f_12[1], func_173(1, uParam0->f_17), 0))
			{
				return false;
			}
			if (!func_174(uParam0->f_12[0], func_173(0, uParam0->f_17), 0))
			{
				return false;
			}
			break;
...
bool func_37(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar2 <= (iVar0 - 1))
	{
		...
		{
			iVar3 = get_random_model_from_population_set(func_176(iParam1), func_177(iParam1, iVar2), -156825994, false, true, func_178(iParam1, iVar2));
			bVar1 = false;
			...
			{
				(*uParam0)[iVar2] = func_181(iVar3, func_178(iParam1, iVar2), func_179(iParam1, iVar2), 1, 1, func_180(iParam1, iVar2), 1, 1, 1, 0, 0, 0, 0);
			}
			return false;
		}
		if (!does_entity_exist(uParam0[iVar2]))
...
bool func_38(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar1 <= (iVar0 - 1))
	{
		if ((func_183(iVar1, uParam1->f_17) && iParam2 == 0) && !uParam1->f_20)
		{
			...
			set_anim_scene_entity(&(uParam1->f_12[1]), func_184(1, iVar1, uParam1->f_17), uParam0[iVar1], 0);
		}
		else if (func_185(iParam2))
		{
			(*uParam0)[iVar1]->f_1 = 1;
			(*uParam0)[iVar1]->f_2 = iVar1;
			func_186((*uParam0)[iVar1], iParam2);
		}
		else
		{
			(*uParam0)[iVar1]->f_1 = 1;
			(*uParam0)[iVar1]->f_2 = iVar1;
			func_187((*uParam0)[iVar1], iParam2);
		}
		iVar1++;
	}
	return true;
...
void func_45(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 0:
			...
			_0xf008e0ba1fe1d644(1);
			request_model(func_195(), false);
			request_model(func_196(0), false);
			func_194(uParam0, 1);
			break;
		case 1:
			if (!_0x5e420ff293ee5472())
			...
			if (!has_model_loaded(func_195()) || !has_model_loaded(func_196(0)))
			{
				return;
			}
			...
			{
				iVar2 = iVar1;
				uParam0->f_3[iVar1] = create_object(func_196(iVar2), func_202(iVar2), true, true, false, false, true);
				iVar1++;
			}
			func_194(uParam0, 2);
			break;
		case 2:
			...
			{
				uParam0->f_9 = _create_anim_scene(func_203(iParam1), 0, func_204(iParam1, 0), false, true);
				load_anim_scene(uParam0->f_9);
				set_anim_scene_origin(uParam0->f_9, func_205(iParam1), func_206(iParam1), 2);
			}
		...
		case 3:
			if (_does_anim_scene_exist(uParam0->f_9))
			{
				set_anim_scene_entity(uParam0->f_9, func_207(iParam1), uParam0->f_2, 0);
				iVar3 = 0;
				while (iVar3 <= (5 - 1))
				{
					set_anim_scene_entity(uParam0->f_9, func_208(iParam1, iVar3), &(uParam0->f_3[iVar3]), 0);
					iVar3++;
				}
		...
		case 4:
			if (uParam0->f_10)
			{
				if (!_0x1f0e401031e20146(uParam0->f_9, func_204(iParam1, 1)))
				{
					if (!_0x23e33cb9f4a3f547(uParam0->f_9, func_204(iParam1, 1)))
					{
						_0xdf7b5144e25cd3fe(uParam0->f_9, func_204(iParam1, 1));
					}
					else
					{
						_set_anim_scene_playback_list_bool(uParam0->f_9, func_204(iParam1, 1), true);
					}
				}
			}
			break;
...
{
	if (!does_entity_exist(&(iParam0->f_81[1])))
	{
		uVar2 = 1;
		if (func_209(&uVar0, &uVar2, 1, 2547.733f, -1303.363f, 47.48392f, 0.5f, 0, 1, 1, -1, 1, 0, -1082130432, 0, 0) > 0)
		{
			if (does_entity_exist(&(uVar0[0])) && !is_entity_dead(&(uVar0[0])))
			{
				...
				add_entity_to_audio_mix_group(&(iParam0->f_81[1]), "Default_Show_Performers_Group", -1f);
				set_anim_scene_entity(iParam0->f_48, "CrowdMember", &(iParam0->f_81[1]), 0);
				return true;
			}
		}
		return false;
...
void func_50(int iParam0)
{
	...
	set_tv_channel(0);
	if (load_stream("Audience", func_211(*iParam0)))
	{
		iParam0->f_1100 = _0x0556c784fa056628("Audience", func_211(*iParam0));
...
void func_57(var uParam0, var uParam1, int iParam2)
{
	...
	{
		request_waypoint_recording(func_214(iParam2));
		if (get_is_waypoint_recording_loaded(func_214(iParam2)))
		{
	...
	switch (iParam0->f_41)
	{
		...
		case 1:
			...
			if (_0x3ee1f7a8c32f24e1(get_player_index(), &iVar2, 0, 0) && iVar2 == iVar3)
			{
				...
				{
					if (!func_232(iParam0->f_1053[2], &Global_35, "INTERACT_DRAW", 129547951))
					{
						return;
					}
		...
		if (does_entity_exist(&(iParam0->f_81[iVar0])))
		{
			if (!is_entity_dead(&(iParam0->f_81[iVar0])) && !Global_1935630->f_12)
			{
				...
				if (fVar1 < 5f)
				{
					...
					fVar5 = func_219(func_218(vVar2), func_218(get_entity_forward_vector(&(iParam0->f_81[iVar0]))));
					if (fVar5 < 0f)
					{
...
void func_63(int iParam0)
{
	...
	switch (iVar1152)
	{
		case 0:
			...
			{
				iVar3 = iVar2;
				if (!_does_volume_exist(&(Local_1155.f_2[iVar3])))
				{
					Var4 = { func_240(iVar3) };
					Local_1155.f_2[iVar3] = _create_volume_by_hash_with_custom_name(Var4.f_9, Var4, Var4.f_3, Var4.f_6, Var4.f_10);
				}
				iVar2++;
			}
			Global_1394141->f_1322 = 1;
			...
			break;
		case 1:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(0)))
			{
				if (!func_142(iParam0->f_48, func_147(1), "IDLE 01"))
				{
					return;
				}
				if (fVar0 > 0.99f)
				{
					func_145(iParam0->f_48, func_147(1), "IDLE 01");
					Local_1155.f_51 = 1;
			...
			break;
		case 2:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(1)))
			{
				func_7(&(Global_1394141->f_1326), 4);
				_0xae6ada8fe7e84acc(iParam0->f_48, func_147(0));
		...
		case 3:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(1)))
			{
				func_142(iParam0->f_48, func_147(2), "IDLE 02");
				if (func_242(&Local_1155) && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(5)))
				{
					func_145(iParam0->f_48, func_147(5), "Player Challange");
					Local_1155.f_51 = 5;
					func_241(&Local_1155, 8);
					return;
				}
				if (fVar0 > 0.99f && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(2)))
				{
					func_145(iParam0->f_48, func_147(2), "IDLE 02");
					Local_1155.f_51 = 2;
			...
			break;
		case 4:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(2)))
			{
				_0xae6ada8fe7e84acc(iParam0->f_48, func_147(1));
		...
		case 5:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(2)))
			{
				func_142(iParam0->f_48, func_147(3), "IDLE 03");
				if (func_242(&Local_1155) && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(5)))
				{
					func_145(iParam0->f_48, func_147(5), "Player Challange");
					Local_1155.f_51 = 5;
				...
				if (fVar0 > 0.99f && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(3)))
				{
					func_145(iParam0->f_48, func_147(3), "IDLE 03");
					Local_1155.f_51 = 3;
			...
			break;
		case 6:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(3)))
			{
				_0xae6ada8fe7e84acc(iParam0->f_48, func_147(2));
		...
		case 7:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(3)))
			{
				func_142(iParam0->f_48, func_147(6), "CROWDCHALLENGE 01");
				if (func_242(&Local_1155) && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(5)))
				{
				...
				if (fVar0 > 0.99f && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(6)))
				{
					Global_1394141->f_1334 = 1;
					set_anim_scene_entity(iParam0->f_48, "CrowdMember", &(iParam0->f_81[1]), 0);
					func_145(iParam0->f_48, func_147(6), "CROWDCHALLENGE 01");
			...
			break;
		case 9:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(6)))
			{
				_0xae6ada8fe7e84acc(iParam0->f_48, func_147(3));
		...
		case 18:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(6)))
			{
				func_142(iParam0->f_48, func_147(7), "CROWDCHALLENGE0 2");
				if (fVar0 > 0.99f && _0x23e33cb9f4a3f547(iParam0->f_48, func_147(7)))
				{
			...
			break;
		case 19:
			_0xae6ada8fe7e84acc(iParam0->f_48, func_147(5));
			func_7(&(Local_1155.f_32), 2);
			func_145(iParam0->f_48, func_147(7), "CROWDCHALLENGE 02");
			Local_1155.f_51 = 7;
			func_241(&Local_1155, 20);
			break;
		case 8:
			if (func_2(iParam0->f_16, 131072))
			{
				func_3(&(iParam0->f_16), 131072);
			}
			if (!func_2(iParam0->f_16, 262144))
			{
			...
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(5)))
			{
				func_7(&(Local_1155.f_32), 2);
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_147(1)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_147(1));
				}
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_147(2)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_147(2));
				}
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_147(3)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_147(3));
				}
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_147(6)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_147(6));
				}
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_147(7)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_147(7));
				}
				if (Local_1155.f_21 && !is_entity_dead(&(iParam0->f_81[1])))
				{
					Local_1155.f_21 = 0;
					clear_ped_tasks_immediately(&(iParam0->f_81[1]), false, true);
					func_244(&(iParam0->f_81[1]), -1426662425, 2547.751f, -1303.415f, 47.48392f, -175.57f, -1, 1, 0, 0, -1082130432);
				}
				if (fVar0 > 0.4f && !func_2(iParam0->f_16, 262144))
				{
					_0x3946fc742ac305cd(get_player_index(), &(iParam0->f_81[0]), "SHOW_FLEXFIGHT", 2546.317f, -1309.955f, 48.21665f, 0, 0);
					func_7(&(Global_1394141->f_1326), 4);
					func_7(&(iParam0->f_16), 262144);
					func_3(&(iParam0->f_16), 131072);
				}
				...
				{
					request_anim_dict(func_245());
					func_7(&(Local_1155.f_32), 4);
				}
				else if ((((!func_2(Local_1155.f_32, 8) && fVar0 > 0.2f) && fVar0 < 0.8f) && has_anim_dict_loaded(func_245())) && func_246(Global_35, &(iParam0->f_81[0]), 1, 1) < 4f)
				{
					task_play_anim(Global_35, func_245(), func_247(), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
					func_7(&(Local_1155.f_32), 8);
				}
				if (fVar0 > 0.99f)
				{
					Global_1394141->f_1331 = 1;
					clear_ped_tasks_immediately(&(iParam0->f_81[0]), false, true);
					task_put_ped_directly_into_melee(&(iParam0->f_81[0]), Global_35, 0, 0, 0, 1, 0);
					_0x57f35552e771be9d(&(iParam0->f_81[0]), 8);
					_0xfc3db99c8144cd81(&(iParam0->f_81[0]), &(Local_1155.f_2[3]), 0, 0, 0);
					_0xfc3db99c8144cd81(Global_35, &(Local_1155.f_2[3]), 0, 0, 0);
					_0x57f35552e771be9d(&(iParam0->f_81[0]), 12);
					set_ped_relationship_group_hash(&(iParam0->f_81[0]), 1269650476);
		...
		case 10:
			...
			if (func_4(Global_35, &(Local_1155.f_2[3]), 1, 0) && func_249(&(Local_22.f_954), cVar15, 0, -1, 0, 0))
			{
				...
				task_put_ped_directly_into_melee(Global_35, &(iParam0->f_81[0]), 0, 0, 0, 1, 0);
				set_entity_is_target_priority(&(iParam0->f_81[0]), true, 300f);
				_0xd77ae48611b7b10a(&(iParam0->f_81[0]), 2f);
				set_current_ped_weapon(Global_35, -1569615261, true, 0, false, false);
				set_ped_config_flag(Global_35, 249, true);
				func_251(&(iParam0->f_81[0]), 0);
				remove_all_ped_weapons(&(iParam0->f_81[0]), true, true);
				set_current_ped_weapon(&(iParam0->f_81[0]), -1569615261, true, 0, false, false);
				set_ped_relationship_group_hash(&(iParam0->f_81[0]), 1269650476);
				set_entity_invincible(&(iParam0->f_81[0]), true);
				set_ped_config_flag(&(iParam0->f_81[0]), 169, true);
				set_ped_config_flag(&(iParam0->f_81[0]), 258, true);
				set_ped_config_flag(&(iParam0->f_81[0]), 249, true);
				stop_ped_speaking(&(iParam0->f_81[0]), true);
		...
		case 17:
			...
			if (!func_2(Local_1155.f_32, 32) && load_stream(func_252(), func_253()))
			{
				play_stream_from_position(2546.4f, -1314.04f, 50.25f, _0x0556c784fa056628(func_252(), func_253()));
			...
			if ((((!func_254(1) && fVar18 > 2f) && func_4(Global_35, &(Local_1155.f_2[3]), 1, 0)) && !func_2(Local_1155.f_32, 16)) && func_255())
			{
				...
				{
					Var19 = { func_240(4) };
					_0x0eb78c2b156635b1(Var19.f_9, Var19, Var19.f_3, Var19.f_6);
					Var19 = { func_240(5) };
					_0x0eb78c2b156635b1(Var19.f_9, Var19, Var19.f_3, Var19.f_6);
					Var19 = { func_240(6) };
					_0x0eb78c2b156635b1(Var19.f_9, Var19, Var19.f_3, Var19.f_6);
			...
			iVar30 = get_entity_health(Global_35);
			disable_control_action(0, 578288361, false);
			if (!func_2(Local_1155.f_32, 256))
			{
				if (request_script_audio_bank("SCRIPT/SND_Show_Flex_Fight"))
				{
					func_41(&(Local_1155.f_16));
					func_7(&(Local_1155.f_32), 256);
				}
			}
			else if (is_ped_performing_melee_action(&(iParam0->f_81[0]), 128, 0))
			{
				if (func_42(&(Local_1155.f_16)) > 4f)
				{
					play_sound_frontend("Whistle", "Flex_Fight_Sounds", true, 0);
					func_41(&(Local_1155.f_16));
				}
			}
			else if (is_ped_performing_melee_action(&(iParam0->f_81[0]), 64, 0))
			{
				if (func_42(&(Local_1155.f_16)) > 4f)
				{
					play_sound_frontend("Horn", "Flex_Fight_Sounds", true, 0);
					func_41(&(Local_1155.f_16));
				}
			}
		...
		case 12:
			...
			{
				_0xc48af420371c7407(&(iParam0->f_81[0]), -1157694922);
				func_41(&(Local_1155.f_13));
			}
			set_ped_reset_flag(Global_35, 150, true);
			if (is_ped_running_ragdoll_task(Global_35))
			{
				reset_ped_ragdoll_timer(Global_35);
				if (func_2(Local_1155.f_32, 128))
				{
					if (_0x4ad019591e94c064("Knockout_Scream", &(iParam0->f_81[0]), "Flex_Fight_Sounds", -2))
					{
						_play_sound_from_entity("Knockout_Scream", &(iParam0->f_81[0]), "Flex_Fight_Sounds", false, 0, 0);
				...
				{
					func_41(&(Local_1155.f_10));
					task_turn_ped_to_face_entity(&(iParam0->f_81[0]), Global_35, -1, -1082130432, -1082130432, -1082130432);
			...
			if (func_40(&(Local_1155.f_10)) && func_42(&(Local_1155.f_10)) > 2.5f)
			{
				...
				remove_ped_defensive_area(&(iParam0->f_81[0]), false);
		...
		case 13:
			...
			{
				if (func_2(Local_1155.f_32, 32) && is_stream_playing(_0x0556c784fa056628(func_252(), func_253())))
				{
					stop_stream(_0x0556c784fa056628(func_252(), func_253()));
				...
				else
				{
					if (func_258(Local_1155.f_29[1], func_256(1), func_257()))
					{
						...
						if (Local_1155.f_20)
						{
							iVar31 = _0x1f714e7a9dadfc42(Global_35);
							if (does_entity_exist(iVar31))
							{
								set_entity_coords(iVar31, func_259(2), true, false, true, true);
							}
						}
					}
					if (func_42(&(Local_1155.f_10)) > 3f)
					{
						...
						{
							iVar34 = (20 - iVar33);
							add_to_clock_time(iVar34, 0, 0);
						}
						func_262();
						set_anim_scene_entity(&(Local_1155.f_29[1]), "player_zero", Global_35, 0);
						set_ped_config_flag(Global_35, 249, false);
						start_anim_scene(&(Local_1155.f_29[1]));
						release_named_script_audio_bank("SCRIPT/SND_Show_Flex_Fight");
		...
		case 15:
			...
			break;
		case 16:
			if (_does_anim_scene_exist(&(Local_1155.f_29[1])))
			{
				if (_0x005e6f28dd7ed58d(&(Local_1155.f_29[1]), "player_zero") || _is_anim_scene_finished(&(Local_1155.f_29[1]), false))
				{
			...
			break;
		case 20:
			if (_0x1f0e401031e20146(iParam0->f_48, func_147(7)))
			{
				if (!is_entity_dead(&(iParam0->f_81[1])))
				{
					set_ped_reset_flag(&(iParam0->f_81[1]), 261, true);
				}
				if (fVar0 > 0.87f)
				{
					Global_1394141->f_1321 = 1;
					...
					remove_entity_from_audio_mix_group(&(iParam0->f_81[1]), -1f);
					func_7(&(Local_22.f_16), 8388608);
					func_241(&Local_1155, 21);
				}
			}
	...
	switch (iParam0->f_3)
	{
		case 0:
			if (bVar0)
			{
				if (!does_cam_exist(iParam0->f_4))
				{
					iParam0->f_4 = create_camera_with_params(26379945, func_263(iParam0->f_1, 0), func_264(iParam0->f_1, 0), get_final_rendered_cam_fov(), false, 2);
				}
		...
		case 3:
			...
			if (is_control_just_pressed(2, -1496944061))
			{
				...
				set_cam_coord(iParam0->f_4, func_263(iParam0->f_1, iParam0->f_8));
				set_cam_rot(iParam0->f_4, func_264(iParam0->f_1, iParam0->f_8), 2);
			}
...
void func_81(int iParam0)
{
	if (func_276(iParam0))
	{
		remove_waypoint_recording(func_214(iParam0));
	}
}
...
{
	func_279();
	set_ped_config_flag(Global_35, 21, false);
	set_player_control(get_player_index(), true, 0, false);
	remove_ped_defensive_area(Global_35, false);
	release_named_script_audio_bank("SCRIPT/SND_Show_Flex_Fight");
	iVar0 = 0;
	...
	while (iVar0 <= 6)
	{
		if (_does_volume_exist(&(Local_1155.f_2[iVar0])))
		{
			_delete_volume(&(Local_1155.f_2[iVar0]));
		}
		iVar0++;
	}
	if (_0xb346c85d49cc998e(Global_35, 8))
	{
		_0x949b2f9ed2917f5d(Global_35, 8);
	}
	func_3(&(iParam0->f_16), 1024);
	func_262();
	...
	_0xc67a4910425f11f1(get_player_index(), 0);
	func_3(&(Global_1394141->f_1326), 1024);
	if (_does_anim_scene_exist(&(Local_1155.f_29[0])))
	{
		_delete_anim_scene(&(Local_1155.f_29[0]));
	}
...
{
	func_281(func_260(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}
...
bool func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_286((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_120(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_287((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_286((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_136(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_287((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
void func_154(int iParam0)
{
	...
	if (!func_150(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_168(int iParam0)
{
	...
	{
		iParam0->f_66[0] = create_object(&(iParam0->f_58[0]), 2546.098f, -1310.338f, 48.2087f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[1])))
	{
		iParam0->f_66[1] = create_object(&(iParam0->f_58[1]), 2541.685f, -1311.861f, 49.21665f, true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[2])))
	{
		iParam0->f_66[2] = create_object(&(iParam0->f_58[2]), 2541.685f, -1311.961f, 49.21665f, true, true, false, false, true);
	}
...
void func_169(int iParam0)
{
	if (does_entity_exist(&(iParam0->f_66[0])))
	{
		set_entity_heading(&(iParam0->f_66[0]), 3.76f);
	}
	set_anim_scene_entity(iParam0->f_48, "PERFORMER", &(iParam0->f_81[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "Stool", &(iParam0->f_66[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "Chair", &(iParam0->f_66[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "Chair^1", &(iParam0->f_66[2]), 0);
}
...
int func_181(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_294(iVar0, iParam0, bParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_186(var uParam0, int iParam1)
{
	...
	{
		task_start_scenario_at_position(*uParam0, -1426662425, func_178(iParam1, uParam0->f_2), func_179(iParam1, uParam0->f_2), -1, false, true, 0, 0.25f, false);
	}
}
...
void func_187(var uParam0, int iParam1)
{
	if (does_entity_exist(*uParam0))
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_300(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_300(), 2, 0, 0);
		}
	}
}
...
int func_209(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	...
	iVar1 = func_308(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_309(iVar0);
	return iVar1;
}
...
void func_215(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar5 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			{
				if (func_310(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 != 5)
				{
					(*uParam1)[iVar5]->f_1 = 5;
				}
			}
			else if (func_310(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 == 5)
			{
			...
			if ((!uParam0->f_19 && !func_310(*uParam0, iVar5)) && (*uParam1)[iVar5]->f_1 != 5)
			{
				if ((*uParam1)[iVar5]->f_9)
				{
					fVar6 = func_246(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 > 2f || !func_314((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_9 = 0;
						uParam0->f_21 = 0;
						(*uParam1)[iVar5]->f_5 = 2;
						func_315((*uParam1)[iVar5], iParam2);
					}
				}
				else if (!uParam0->f_21 && (*uParam1)[iVar5]->f_1 != 6)
				{
					fVar6 = func_246(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 < 1.5f && func_314((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_5 = func_316(iVar5);
						func_315((*uParam1)[iVar5], iParam2);
						(*uParam1)[iVar5]->f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch ((*uParam1)[iVar5]->f_1)
			{
				...
				case 1:
					...
					{
						func_319((*uParam1)[iVar5], func_318(iParam2), 500);
					}
					break;
				case 3:
					func_320((*uParam1)[iVar5], iParam2);
					(*uParam1)[iVar5]->f_1 = 4;
					break;
				case 4:
					bVar7 = false;
				...
				case 5:
					if (!uParam0->f_19)
					{
						func_321(uParam0, (*uParam1)[iVar5]);
					}
					break;
				case 6:
					if (_does_anim_scene_exist(&(uParam0->f_12[1])))
					{
						...
						if (_0x005e6f28dd7ed58d(&(uParam0->f_12[1]), func_184(1, iVar5, uParam0->f_17)) || _is_anim_scene_finished(&(uParam0->f_12[1]), false))
						{
							func_187((*uParam1)[iVar5], iParam2);
							(*uParam1)[iVar5]->f_1 = 1;
						}
					...
					break;
				case 2:
					task_start_scenario_at_position(uParam1[iVar5], -1426662425, func_178(iParam2, iVar5), func_179(iParam2, iVar5), -1, false, true, 0, 0.25f, false);
					(*uParam1)[iVar5]->f_1 = 1;
					break;
				case 7:
				...
				case 9:
					if (func_276(iParam2))
					{
						...
						{
							task_follow_waypoint_recording(uParam1[iVar5], func_214(iParam2), 0, 10, -1, 0, 0, -1);
							(*uParam1)[iVar5]->f_1 = 10;
						}
					}
					else
					{
						task_follow_nav_mesh_to_coord(uParam1[iVar5], func_322(iParam2), 1f, -1, 0.25f, 5373953, 40000f);
						_0x2208438012482a1a(uParam1[iVar5], false, false);
						(*uParam1)[iVar5]->f_1 = 10;
					}
					break;
				case 10:
					...
					else if (!func_323(get_entity_coords(uParam1[iVar5], true, false)))
					{
					...
					else if (get_script_task_status(uParam1[iVar5], 713668775, true) != 1 && fVar2 > (func_313(iParam2, iVar5) + 3f))
					{
						(*uParam1)[iVar5]->f_1 = 9;
					}
					break;
				case 11:
					...
					waypoint_recording_get_num_points(func_214(iParam2), &iVar3);
					waypoint_recording_get_closest_waypoint(func_214(iParam2), get_entity_coords(uParam1[iVar5], true, false), &iVar4);
...
void func_221(int iParam0)
{
	...
	{
		func_243(iParam0->f_1053[1], 1, 1);
	}
	if (func_224(&(iParam0->f_1053[0])))
	{
		func_243(iParam0->f_1053[0], 1, 1);
	}
	if (func_224(&(iParam0->f_1053[2])))
	{
		func_243(iParam0->f_1053[2], 1, 1);
	}
}
...
int func_225(int iParam0, var uParam1)
{
	...
	if (!func_232(iParam0->f_1053[1], uParam1, "SHOW_POS_RESPONSE", -163964935))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_324(&(iParam0->f_1053[1]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	if (!func_232(iParam0->f_1053[0], uParam1, "SHOW_NEG_RESPONSE", 648122183))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_324(&(iParam0->f_1053[0]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	return 1;
}
...
{
	bVar0 = false;
	if ((func_40(&(iParam0->f_950)) && iParam0->f_18 < func_330(*iParam0)) && func_47(&(iParam0->f_950)) > 35000)
	{
		iParam0->f_18++;
		vVar1 = { func_331(*iParam0, 0, 1) };
		bVar0 = true;
	}
	else if (func_332(*iParam0) && !func_333(36))
	{
		iVar4 = get_random_int_in_range(0, 10);
		if (iVar4 < 5)
		{
			vVar1 = { func_331(*iParam0, 2, 1) };
		}
		else
		{
			vVar1 = { func_331(*iParam0, 1, 1) };
		}
	}
	else
	{
	...
	if (func_334(iParam0))
	{
		vVar1 = { func_331(*iParam0, 3, 1) };
	}
	if (func_249(&(iParam0->f_954), vVar1, 1, -1, 0, 0))
	{
		iParam0->f_1052++;
		func_335(iParam0);
		if (bVar0)
...
void func_230()
{
	...
	bVar0 = false;
	if (is_ped_active_in_scenario(Global_35, 1) || (func_333(36) && _0x3ab6c7b0bb0df4b1(Global_35, -1)))
	{
		bVar0 = true;
	}
	if (!bVar0)
	{
		task_play_anim(Global_35, func_159(), func_336(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_159(), func_336(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
{
	bVar0 = false;
	if ((func_40(&(iParam0->f_950)) && iParam0->f_19 < func_330(*iParam0)) && func_47(&(iParam0->f_950)) > 35000)
	{
		iParam0->f_19++;
		vVar1 = { func_331(*iParam0, 0, 0) };
		bVar0 = true;
	}
	else if (func_332(*iParam0) && !func_333(36))
	{
		...
		if (iVar4 < 5)
		{
			vVar1 = { func_331(*iParam0, 2, 0) };
		}
		else
		{
			vVar1 = { func_331(*iParam0, 1, 0) };
		}
	}
	else
	{
...
{
	if (func_2(iParam0->f_16, 8388608) && uParam1->f_27 != 5)
	{
		remove_anim_scene_entity(&(uParam1->f_29[0]), "CS_GENSTORYMALE", uParam1->f_28);
	...
	{
		case 0:
			if (!does_entity_exist(uParam1->f_28))
			{
			...
			_set_entity_coords_and_heading(uParam1->f_28, func_259(3), -82.53f, true, false, true);
			task_turn_ped_to_face_entity(uParam1->f_28, &(iParam0->f_81[0]), -1, -1082130432, -1082130432, -1082130432);
			func_339(&(uParam1->f_27), 1);
			break;
		case 1:
			if (get_script_task_status(uParam1->f_28, -875674219, true) != 1)
			{
				task_turn_ped_to_face_entity(uParam1->f_28, &(iParam0->f_81[0]), -1, -1082130432, -1082130432, -1082130432);
			}
		...
		case 2:
			...
			break;
		case 3:
			if (does_entity_exist(uParam1->f_28) && _does_anim_scene_exist(&(uParam1->f_29[0])))
			{
				set_anim_scene_entity(&(uParam1->f_29[0]), "CS_GENSTORYMALE", uParam1->f_28, 0);
				start_anim_scene(&(uParam1->f_29[0]));
				func_339(&(uParam1->f_27), 4);
			}
			break;
		case 4:
			set_ped_reset_flag(uParam1->f_28, 261, true);
			if (!is_entity_dead(uParam1->f_28) && !is_entity_dead(&(iParam0->f_81[0])))
			{
				Var0.f_4 = -1;
				Var0.f_8 = 2;
				Var0.f_9 = 1;
				...
				Var0.f_13 = 3;
				Var0.f_7 = 500;
				_0x66f9eb44342bb4c5(uParam1->f_28, &Var0);
			}
			break;
		case 5:
			break;
...
void func_238(var uParam0)
{
	if (!func_242(uParam0))
	{
		if (func_4(Global_35, &(uParam0->f_2[1]), 1, 0) || func_4(Global_35, &(uParam0->f_2[2]), 1, 0))
		{
			if (!func_224(uParam0->f_23))
			{
				uParam0->f_23 = func_338("SHOW_CLIMB_STAGE", -640622144, Global_35, 3, 1, 0, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
			}
			else if (func_227(uParam0->f_23, 0))
			{
				if (func_235(uParam0->f_23, 1))
				{
					func_226(uParam0->f_23, 0, 1);
				}
			}
			...
			else if (func_47(&(uParam0->f_24)) > 1000)
			{
				...
				func_226(uParam0->f_23, 1, 1);
			}
		}
		else if (func_224(uParam0->f_23))
		{
			func_243(&(uParam0->f_23), 1, 1);
		}
	}
	else if (func_224(uParam0->f_23))
	{
...
void func_239(int iParam0)
{
	switch (Local_1155.f_51)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1155.f_33[iVar1])))
				{
					if (iVar1 == 1)
					{
		...
		case 4:
			break;
		case 5:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1155.f_33[16])))
			{
		...
		case 6:
			...
			{
				iVar2 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1155.f_33[iVar2])))
				{
		...
		case 7:
			...
			{
				iVar3 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1155.f_33[iVar3])))
				{
...
void func_244(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7, bool bParam8, char* sParam9, float fParam10)
{
...
float func_246(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_249(char[4] cParam0, char[12] cParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
bool func_255()
{
	...
	if (is_valid_interior(iVar0))
	{
		...
		{
			if (_is_interior_entity_set_valid(iVar0, "new_theater_stage_blocker"))
			{
				activate_interior_entity_set(iVar0, "new_theater_stage_blocker", 0);
				return true;
			}
		}
	}
...
void func_262()
{
	...
	if (is_valid_interior(iVar0))
	{
		if (is_interior_ready(iVar0))
		{
			if (_is_interior_entity_set_valid(iVar0, "new_theater_stage_blocker"))
			{
				deactivate_interior_entity_set(iVar0, "new_theater_stage_blocker", true);
			}
		}
	}
}
...
void func_281(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_294(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_373(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_374(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_375(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_376(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_377(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_378(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_379(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_380(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_381(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_382(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_383(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_384(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_385(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_386(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_387(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_388(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 4:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_389(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_390(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_391(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_392(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 5:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_393(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_394(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_395(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_396(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 6:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_397(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_398(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_399(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_400(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 7:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_401(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_402(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_403(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_404(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 8:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_405(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_406(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_407(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_408(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 9:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_409(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_410(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_411(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_412(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 10:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_413(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_414(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_415(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_416(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 11:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_417(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_418(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_419(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_420(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 12:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_421(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_422(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_423(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_424(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 13:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_425(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_426(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_427(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_428(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 16:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_429(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_430(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_431(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_432(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 17:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_433(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_434(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_435(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_436(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 18:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_437(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_438(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_439(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_440(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 20:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_441(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_442(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_443(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_444(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 21:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_445(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_446(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_447(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_448(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 19:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_449(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_450(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_451(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_452(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 22:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_453(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_430(get_random_int_in_range(0, func_372(16, iParam1, iParam2)));
						case 2:
							return func_431(get_random_int_in_range(0, func_372(16, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_454(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 23:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_455(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_456(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_457(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_458(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 24:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_459(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_460(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_461(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_462(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 25:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_463(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_464(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_465(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_466(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		...
		case 27:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_467(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_468(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_469(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_470(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 28:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_471(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_468(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_469(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_472(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 29:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_473(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_468(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_469(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_474(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 30:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_475(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_468(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_469(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_476(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 31:
			break;
		case 32:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_477(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_478(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 33:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_479(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_480(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 34:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_481(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_482(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 14:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_483(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_484(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_485(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_486(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
		case 15:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_487(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 1:
							return func_484(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
						case 2:
							return func_485(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_488(get_random_int_in_range(0, func_372(iParam0, iParam1, iParam2)));
			}
			break;
	}
	return "FAIL";
...
int func_308(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_489(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !decor_exist_on(iVar2, "bIgnoreThisPed"))
				{
...
int func_312(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return 1;
		case 0:
			if (func_491((*Global_1835011)[36]->f_1))
			{
				return 0;
			}
			else
...
void func_315(int* iParam0, int iParam1)
{
	if ((does_entity_exist(*iParam0) && !iParam0->f_9) && iParam0->f_5 != -1)
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_300(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_300(), 2, 0, 0);
		}
	}
	if (!iParam0->f_9)
	{
...
void func_326(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_329(iParam0, 8))
		{
...
bool func_333(int iParam0)
{
	...
	return func_491((*Global_1835011)[iParam0]->f_1);
}
...
int func_340(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (iVar8 > 0)
	{
		...
		while (iVar9 <= 2)
		{
			if (is_ped_model(&(uVar0[iVar9]), iParam0))
			{
				return &(uVar0[iVar9]);
			}
			iVar9++;
...
void func_354(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_352(iParam0))
	{
...
{
	return (shift_right(iParam0, 26) & 31 * func_499(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_489(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_509(int iParam0)
{
	...
	if (is_ped_group_member(iParam0, func_512(), 1))
	{
		return true;
	}
	return false;
...
int func_513(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_516(iParam1, &iVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_517(iParam0, iVar0, iVar1, bParam2);
}
...
bool func_516(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_283() != -1;
	switch (iParam0)
	{
...
int func_517(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_519(iVar2) != 0 && _0x800df3fc913355f3(func_520(iVar2)))
		{
