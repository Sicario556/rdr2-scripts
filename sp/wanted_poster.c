...
void func_6()
{
	...
	switch (func_14())
	{
		...
		case 3:
			...
			if ((!is_ped_using_any_scenario(Local_5) && _get_number_of_references_of_script_with_name_hash(493105444) == 0) && _get_number_of_references_of_script_with_name_hash(2124539575) == 0)
			{
				iLocal_0 = 0;
			}
			break;
...
{
	if ((Local_5.f_25 >= 3 && _get_number_of_references_of_script_with_name_hash(493105444) == 0) && _get_number_of_references_of_script_with_name_hash(2124539575) == 0)
	{
		iLocal_0 = 0;
	}
}
