...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[37]->f_4;
	_0xb469cfd9e065eb99(iLocal_14, 9);
	return true;
}
...
bool func_58(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_87(iParam0));
}
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_101(&cVar6, 109029619), sVar9, func_101(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_101(&cVar6, 109029619), func_101(&cVar10, 109029619));
		}
...
void func_76(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_119(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_117(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_119(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
