...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (func_61(uParam0, &uLocal_9, 1) || func_62(Global_35, &(uParam0->f_20[0]), 1) <= 100f)
			{
				bLocal_42 = true;
			}
		}
	...
	if (&uParam0->f_469[0])
	{
		if (!_0x3ab6c7b0bb0df4b1(&(uParam0->f_20[0]), -1))
		{
	...
	if (!&uParam0->f_469[0] && !bLocal_42)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 40f, 4, -91962372, 1))
				{
					func_66(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
						...
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), -1795669989))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									...
									func_72(uParam0->f_20[0], 0, 1);
									func_74(&(uParam0->f_20[0]), -75130390, vLocal_39, 0f, 60000, 1, 0, 0, -1082130432);
									set_ped_keep_task(&(uParam0->f_20[0]), true);
									if (is_ped_active_in_scenario(&(uParam0->f_20[0]), 1) && !_0x02ebbb3989b7e695(&(uParam0->f_20[0])))
									{
...
int func_32(var uParam0, bool bParam1)
{
	...
	{
		if (!bVar0 || has_bullet_impacted_in_area(get_entity_coords(&(uParam0->f_20[1]), false, false), 0.5f, true, true))
		{
			detach_entity(&(uParam0->f_20[1]), true, true);
			if (bVar1)
			{
				func_75(&(uParam0->f_20[1]), 0, 0);
			}
			uParam0->f_469[1] = 1;
		}
		else if (is_ped_active_in_scenario(&(uParam0->f_20[0]), 0) && _get_scenario_point_type_ped_is_using(&(uParam0->f_20[0])) == -75130390)
		{
			clear_ped_secondary_task(&(uParam0->f_20[0]));
			clear_ped_secondary_task(&(uParam0->f_20[1]));
			detach_entity(&(uParam0->f_20[1]), true, true);
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_62(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
bool func_61(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_104(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
float func_62(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_105(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_67(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		{
			if (!func_111(&(uParam0->f_20[0]), 518218985))
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[0]), Global_35, 3, 256, -1082130432, -1, 0);
				func_72(uParam0->f_20[0], 0, 1);
			}
		}
		else if (!func_111(&(uParam0->f_20[0]), 1139527981))
		{
			_0xa3a9299c4f2adb98(&(uParam0->f_20[0]));
			task_animal_unalerted(&(uParam0->f_20[0]), -1, 0, 0, 0);
			func_72(uParam0->f_20[0], 0, 1);
		}
	}
}
...
void func_68(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 1228204929))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_62(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_62(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_63(&(uParam0->f_490)))
							{
...
Vector3 func_73(var uParam0)
{
	vVar0 = { 0f, 0f, 0f };
	fVar3 = 1E+11f;
	*vVar4[0] = { 1459.462f, 301.6016f, 89.5523f };
	*vVar4[1] = { 1823.751f, -1248.367f, 41.491f };
	iVar14 = 0;
	while (iVar14 < vVar4.x)
	{
		if (!func_7(*vVar4[iVar14]))
		{
			fVar15 = vdist2(uParam0->f_483, *vVar4[iVar14]);
			if (fVar15 < fVar3)
			{
				fVar3 = fVar15;
				vVar0 = { *vVar4[iVar14] };
...
void func_109(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_171(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_171(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_171(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
bool func_142(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_191(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_189(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_190(uParam2)
				{
					func_185(uParam2, 1);
					return true;
				}
...
bool func_143(int iParam0, var uParam1)
{
	...
	if (func_181(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_190(uParam1)
		{
...
bool func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_223(iVar0, 0)))
		{
...
bool func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_223(iVar0, 0)))
		{
			if (func_225(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_213(int iParam0)
{
	...
	return func_231((*Global_1347702)[58]->f_15, 1);
}
...
bool func_224(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_225(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
