void __EntryFunction__()
{
	...
	while (!func_5(&Local_110, 1))
	{
		...
		if (((((func_6(&Local_110) >= 5 && func_6(&Local_110) <= 7) && !func_5(&Local_110, 4096)) && _does_anim_scene_exist(Local_110.f_428.f_444)) && _is_anim_scene_started(Local_110.f_428.f_444, false)) && !_is_anim_scene_paused(Local_110.f_428.f_444))
		{
		...
		switch (func_6(&Local_110))
		{
			...
			case 3:
				...
				func_39(&Local_110);
				if (func_40(func_32((*Global_1835011)[Local_110]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_110.f_428)) == 4 && _does_anim_scene_exist(Local_110.f_428.f_444)) && _is_anim_scene_paused(Local_110.f_428.f_444))
				{
					func_37(Local_110);
					func_17(&Local_110, 7);
				}
...
{
	iVar0 = 1;
	request_model(1445750337, false);
	request_model(-248746141, false);
	request_model(1071795929, false);
	request_model(1282171014, false);
	if (!func_137(iLocal_32, 1))
	{
		if (((has_model_loaded(1445750337) && has_model_loaded(-248746141)) && has_model_loaded(1071795929)) && has_model_loaded(1282171014))
		{
			if (!func_138())
			{
				return false;
...
int func_36(int iParam0)
{
	...
	set_ambient_zone_state_persistent("AZ_Fussar2_Corpse_Area", false, true);
	if (_0x3d10d7179d7034af(func_149(0), -1016714371, 0))
	{
		_0x6a564540fac12211(func_149(0), -1016714371);
	}
	if (_0x3d10d7179d7034af(func_149(0), -160924582, 0))
	{
		_0x6a564540fac12211(func_149(0), -160924582);
	}
	if (is_audio_scene_active("FUS2_Intro_Arthur_Drugged_Scene"))
	{
		stop_audio_scene("FUS2_Intro_Arthur_Drugged_Scene");
	}
	return 1;
}
...
bool func_128(int iParam0)
{
	...
	func_25(iParam0, 8);
	func_267(iParam0, 300f);
	func_268(iParam0, 350f);
	iVar1 = 0;
	while (iVar1 <= 1)
	{
		StringCopy(&(Local_34[iVar1]->f_1), "WORLD_HUMAN_STARE_STOIC", 64);
		Local_34[iVar1] = 830847823;
		if (!func_269(&(Local_34[iVar1]), 1, 0, 0))
		{
		}
		iVar1++;
	}
	set_ambient_zone_state_persistent("AZ_Fussar2_Corpse_Area", true, true);
	if (bVar0)
	{
		_0x9851de7aec10b4e1(1321.688f, -7223.703f, 62.1466f, 10f, 1, 0);
	}
	return bVar0;
}
...
bool func_138()
{
	if (func_280(-1, 1))
	{
		...
		Local_53.f_14 = 4f;
		set_ped_config_flag(&(Local_14.f_8[0]), 223, true);
		set_ped_config_flag(&(Local_14.f_8[0]), 186, false);
		_0x18ff3110cf47115d(&(Local_14.f_8[0]), 7, 0);
		set_ped_config_flag(&(Local_14.f_8[0]), 38, true);
		set_entity_load_collision_flag(&(Local_14.f_8[0]), 1);
		disable_ped_pain_audio(&(Local_14.f_8[0]), true);
		set_ped_config_flag(&(Local_14.f_8[0]), 297, false);
		set_ped_config_flag(&(Local_14.f_8[0]), 130, true);
		set_ped_config_flag(&(Local_14.f_8[0]), 315, true);
		set_ped_config_flag(&(Local_14.f_8[0]), 305, true);
		set_ped_can_be_targetted(&(Local_14.f_8[0]), false);
		set_ped_relationship_group_hash(&(Local_14.f_8[0]), 1030835986);
		set_facial_idle_anim_override(&(Local_14.f_8[0]), "mood_dead_1", "FACE_HUMAN@GEN_MALE@BASE");
		set_blocking_of_non_temporary_events(&(Local_14.f_8[0]), true);
		func_281(&(Local_14.f_8[0]), 0);
		_0x6569f31a01b4c097(&(Local_14.f_8[0]), 4, 0);
		func_282(&(Local_14.f_8[0]), 1, 0);
		activate_physics(&(Local_14.f_8[0]));
		if (!Local_53.f_25)
		{
			if (func_283(&Local_53))
			{
				_set_ped_body_component(&(Local_14.f_8[0]), -300122447);
...
bool func_154(int iParam0)
{
	...
	if (!_0x3d10d7179d7034af(func_149(0), -160924582, 0))
	{
		_0x766315a564594401(func_149(0), -160924582, 0);
	}
	switch (iLocal_24)
	{
		case 0:
		...
		case 2:
			if (func_301())
			{
				set_gameplay_entity_hint(&(Local_14.f_8[0]), 0f, 0f, 0f, true, 2000, 2000, 2000, 0);
		...
		case 5:
			...
			{
				if (start_audio_scene("FUS2_Intro_Arthur_Drugged_Scene"))
				{
			...
			if (!func_137(iLocal_32, 4))
			{
				...
				{
					shake_gameplay_cam("JOLT_SHAKE", 2f);
			...
			if (func_306())
			{
				animpostfx_play("PoisonDartPassOut");
				set_player_control(player_id(), true, 0, false);
				func_26(&uLocal_83);
				_0x406ccf555b04fad3(Global_35, 1, 1f);
				iLocal_24 = 6;
			}
			break;
		case 6:
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_308(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_309(uParam0->f_1522[iVar0], 128))
				{
					func_310(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_158(var uParam0)
{
	...
	{
		delete_object(&(uParam0->f_16));
	}
	if (does_entity_exist(uParam0->f_15))
	{
		delete_object(&(uParam0->f_15));
	}
	if (does_entity_exist(uParam0->f_17))
	{
		delete_object(&(uParam0->f_17));
	}
	if (uParam0->f_6 != 0)
	{
		delete_rope(&(uParam0->f_6));
	}
	if (does_entity_exist(uParam0->f_21))
	{
		delete_object(&(uParam0->f_21));
	}
}
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_314((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_314((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_315(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_163(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_317((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_319((*uParam1)[iVar0]))
		{
			if (func_317((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_320((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_321((*uParam2)[iVar0]))
		{
			if (func_317((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_322((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_323((*uParam3)[iVar0]))
		{
			if (func_317((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_324((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_326((*uParam5)[iVar0]))
		{
			if (func_317((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_327((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_326((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_328((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_317((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_329((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_330((*uParam6)[iVar0]))
		{
			if (func_317((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_331((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_332((*uParam7)[iVar0]))
		{
			if (func_317((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_333((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_334((*uParam8)[iVar0]))
		{
			if (func_317((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_335((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_336((*uParam9)[iVar0]))
		{
			if (func_317((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_337((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_338((*uParam10)[iVar0]))
		{
			if (func_317((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_339((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_340((*uParam11)[iVar0]))
		{
			if (func_317((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_341((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_183(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_352(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_193(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_356(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_206(bool bParam0, bool bParam1)
{
	if (!func_359(Global_43801))
	{
		Global_43801 = func_364("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
	...
	else
	{
		...
		if (func_368(Global_43801, 1) != 0f && bParam0)
		{
...
void func_217(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_372(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_355() };
...
void func_218(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_234(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_373(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_221()
{
	return func_362(_0xc17f69e1418cd11f(3));
}
...
void func_226(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_390() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_391(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_234(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_397(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_397(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_401(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_399(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_238(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_409(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_243(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_400(32768) && iParam1 != &Global_1946804->f_57[func_413(iParam3, 1)])
			{
				func_417();
...
void func_244(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_149(0), &Var5, iParam1);
}
...
bool func_245(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	{
		if (!func_422(iParam0, 1245594896))
		{
	...
	if (func_137(*iParam1, 2))
	{
		...
		else if ((func_425(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_425(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_425(iParam2, 1024))) || func_425(iParam2, 8)) && !func_137(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_139(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_425(iParam2, 4096)) && !func_137(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_139(iParam1, 2048);
			func_139(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_425(iParam2, 32)) && !func_137(*iParam1, 5632))
		{
...
int func_258(var uParam0, int iParam1)
{
	...
	if (func_291(uParam0, 8) && _0xdd0b7c5ae58f721d(func_433()))
	{
...
bool func_261(int iParam0)
{
	...
	return func_437((*Global_1835011)[iParam0]->f_1);
}
...
void func_263()
{
	if (!_does_volume_exist(&(iLocal_30[0])))
	{
		iLocal_30[0] = _create_volume_box_with_custom_name(1318.795f, -7225.081f, 55.60172f, 0f, 0f, -31.52841f, 10.44719f, 9.096654f, 6.580655f, "FUS2_INTRO_VOLUME_LEADIN_TRIGGER");
	}
}
...
int func_275(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_316((*uParam0)[iVar1]))
		{
			if (func_317((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_319((*uParam1)[iVar1]))
		{
			if (func_317((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_321((*uParam2)[iVar1]))
		{
			if (func_317((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		if (func_323((*uParam3)[iVar1]))
		{
			if (func_317((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_326((*uParam5)[iVar1]))
		{
			if (func_317((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_317((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_446((*uParam5)[iVar1]))
				{
					if (func_447((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_328((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_330((*uParam6)[iVar1]))
		{
			if (func_317((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_332((*uParam7)[iVar1]))
		{
			if (func_317((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_334((*uParam8)[iVar1]))
		{
			if (func_317((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_336((*uParam9)[iVar1]))
		{
			if (func_317((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_338((*uParam10)[iVar1]))
		{
			if (func_317((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_340((*uParam11)[iVar1]))
		{
			if (func_317((*uParam11)[iVar1]->f_2, iParam12))
			{
...
{
	if (!func_465(Local_14.f_6))
	{
		Local_14.f_6 = { func_466() };
	}
	if (func_467(&(Local_14.f_6), 1))
	{
		return true;
	}
	if (!does_entity_exist(&(Local_14.f_8[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_14.f_8[0] = func_468(1282171014, 1315.539f, -7274.301f, 70.1452f, 51.4672f, 1, 1, 0, 1, 1, 0, 1, 1, 0, 0);
		set_ped_name_debug(&(Local_14.f_8[0]), "HangPed01");
		func_469(Local_14.f_6, &(Local_14.f_8[0]));
		func_470(&(Local_14.f_8[0]), Local_14);
		if (bParam1)
		{
			if (iParam0 == 0)
			{
...
bool func_283(var uParam0)
{
	if (!does_entity_exist(uParam0->f_15))
	{
		uParam0->f_15 = create_object(1071795929, *uParam0, true, true, false, false, true);
		freeze_entity_position(uParam0->f_15, true);
		set_entity_visible(uParam0->f_15, false);
	}
	if (!does_entity_exist(uParam0->f_17))
	{
		uParam0->f_17 = create_object(-248746141, uParam0->f_3, true, true, false, false, true);
		set_entity_collision(uParam0->f_17, false, false);
	}
	if (!does_entity_exist(uParam0->f_21))
	{
		uParam0->f_21 = create_object(1445750337, uParam0->f_22, true, true, false, false, true);
		freeze_entity_position(uParam0->f_21, true);
		set_object_targettable(uParam0->f_21, true);
	}
	if (does_entity_exist(uParam0->f_15))
	{
		if (does_entity_have_physics(uParam0->f_17))
		{
			_0xb6cbd40f8ea69e8a(uParam0->f_17);
			attach_entity_to_entity_physically(uParam0->f_17, uParam0->f_7, -1, get_ped_bone_index(uParam0->f_7, 14284), 0.05f, -0.025f, 0f, 0f, 0f, 0f, 28.4f, 94.3f, 347.4f, -1f, 0, 1, 0, 0, 0, 1, 1065353216, 1065353216);
			if (!does_rope_exist(uParam0->f_6))
			{
				uParam0->f_6 = _add_rope_2(get_entity_coords(uParam0->f_15, true, false), 0f, 0f, 0f, uParam0->f_14, 6, true, -1, -1f);
			}
			if (does_entity_exist(uParam0->f_7))
			{
				set_entity_coords(uParam0->f_7, uParam0->f_3, false, false, true, true);
				rope_force_length(uParam0->f_6, uParam0->f_14);
				_0x522fa3f490e2f7ac(uParam0->f_6, 1, 1);
				_0x462ff2a432733a44(uParam0->f_6, uParam0->f_15, uParam0->f_17, 0f, 0f, 0f, 0f, 0f, 0f, 0, "ropeAttach");
				_0x3c6490d940ff5d0b(uParam0->f_6, 0, "ropeAttach", uParam0->f_14, 0);
				_0x76bad9d538bca1aa(uParam0->f_6, 0f);
				_0xb40ea9e0d2e2f7f3(uParam0->f_6, 1f);
				stop_rope_winding(uParam0->f_6);
				_0xf1ea2a881eb7f2cd(uParam0->f_6, 1);
				_0xf092b6030d6fd49c(uParam0->f_6, "ROPE_SETTINGS_DEFAULT");
				if (does_entity_exist(uParam0->f_7) && is_entity_dead(uParam0->f_7))
				{
					if (!is_ped_ragdoll(uParam0->f_7))
					{
						set_ped_to_ragdoll(uParam0->f_7, 0, 0, 0, true, true, false);
					}
				}
				set_ped_config_flag(uParam0->f_7, 324, true);
				_0x6569f31a01b4c097(uParam0->f_7, 1, 0);
				_0x6569f31a01b4c097(uParam0->f_7, 0, 0);
				return true;
			}
		}
	}
...
Vector3 func_288(var uParam0, int iParam1)
{
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			vVar10 = { func_473(vVar10) * Vector(2f, 2f, 2f) };
...
bool func_295()
{
	switch (iLocal_33)
	{
		case 0:
			...
			break;
		case 1:
			if (!_0xdd0b7c5ae58f721d(&Local_89))
			{
				_0x6a4d224fc7643941(&Local_89);
				iLocal_33 = 2;
			}
			break;
		case 2:
...
bool func_296()
{
	...
	{
		case 0:
			if (!_does_anim_scene_exist(&(iLocal_28[0])))
			{
				iLocal_28[0] = _create_anim_scene("script@story@FUS2@IG@fus2_ig15_Poison_Dart@fus2_ig15_Poison_Dart_Arthur", 0, "pbl_ACTION", false, true);
				bVar0 = false;
			}
			else if (!_is_anim_scene_loaded(&(iLocal_28[0]), true, false))
			{
				if (!_is_anim_scene_loading(&(iLocal_28[0]), true))
				{
					load_anim_scene(&(iLocal_28[0]));
				}
				bVar0 = false;
			}
		...
		case 1:
			...
			break;
		case 2:
			set_anim_scene_entity(&(iLocal_28[0]), "player_zero", Global_35, 0);
			iLocal_26 = 3;
			break;
		case 3:
			return true;
...
void func_298(var uParam0)
{
	if (uParam0->f_25)
	{
		if (does_entity_exist(uParam0->f_7))
		{
			if (is_ped_ragdoll(uParam0->f_7))
			{
				reset_ped_ragdoll_timer(uParam0->f_7);
			}
			else
			{
				set_ped_can_ragdoll(uParam0->f_7, true);
				set_ped_to_ragdoll(uParam0->f_7, 10000, 20000, 0, true, true, false);
			}
			set_ped_reset_flag(uParam0->f_7, 29, true);
		}
	}
}
...
bool func_301()
{
	switch (iLocal_27)
	{
		case 0:
			if (!is_ped_injured(Global_35))
			{
				...
				if (does_entity_exist(iVar0))
				{
					...
					{
						iLocal_109 = get_ped_index_from_entity_index(iVar0);
					}
					if (get_script_task_status(Global_35, -208384378, true) != 0 && get_script_task_status(Global_35, -208384378, true) != 1)
					{
						if (is_entity_a_ped(iVar0))
						{
							_0x6569f31a01b4c097(iLocal_109, 0, 0);
							_0x6569f31a01b4c097(iLocal_109, 1, 0);
							_0x6569f31a01b4c097(iLocal_109, 6, 0);
							task_place_carried_entity_at_coord(Global_35, iLocal_109, get_entity_coords(Global_35, true, false), 1f, 1);
						}
						else
						{
		...
		case 1:
			if (get_script_task_status(Global_35, -208384378, true) != 0 && get_script_task_status(Global_35, -208384378, true) != 1)
			{
				if (does_entity_exist(iLocal_109) && is_entity_a_ped(iLocal_109))
				{
					_0x18ff3110cf47115d(iLocal_109, 1, 0);
					_0x18ff3110cf47115d(iLocal_109, 2, 0);
					_0x18ff3110cf47115d(iLocal_109, 3, 0);
					_0x18ff3110cf47115d(iLocal_109, 7, 0);
					_0x18ff3110cf47115d(iLocal_109, 12, 0);
				}
				iLocal_27 = 0;
			}
			break;
...
int func_303(var uParam0)
{
	...
	return (func_479() - round((uParam0->f_1 * 1000f)));
}

void func_304()
{
	if (!_is_anim_scene_started(&(iLocal_28[0]), false))
	{
		start_anim_scene(&(iLocal_28[0]));
	}
}
...
void func_305()
{
	if (func_295())
	{
		...
		{
			if (_0xdd0b7c5ae58f721d(&Local_89) && !_0x927b810e43e99932(&Local_89))
			{
				_0xb8b207c34285e978(&Local_89);
			}
			if (_0x927b810e43e99932(&Local_89))
			{
				_0x7b0279170961a73f(&Local_89);
...
bool func_306()
{
	if (_0xb89fcff19dafff28(&(iLocal_28[0]), "player_zero") || _0x005e6f28dd7ed58d(&(iLocal_28[0]), "player_zero"))
	{
		return true;
	}
	return false;
...
struct<8> func_308(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_480(iParam1), 64);
...
void func_327(var uParam0)
{
	if (!func_498(uParam0->f_2, 1))
	{
		if (func_446(uParam0))
		{
			...
			{
				sVar0 = func_361(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_502())
				{
...
var func_349(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
...
void func_350(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_505(iVar0, 4096, 0);
			func_505(iVar0, 131072, 0);
			func_506(iVar0, 1);
		}
		iVar0++;
	}
...
int func_364(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_514(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
bool func_376(int iParam0)
{
	...
	else if (func_522(-525676072, iParam0))
	{
		if (func_521(iParam0))
		{
			return true;
...
void func_381(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_396(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_382()
{
	...
	if (func_396(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_396(iVar0))
	{
		...
		{
			func_525(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_393(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_137(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_137(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_137(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_137(iParam5, 32), true);
	...
	else if (func_137(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_137(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_137(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
float func_394(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
{
	(Global_1946804->f_57[func_413(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_413(iParam0, 1)])->f_10 || iParam1);
}
...
struct<5> func_411(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_414(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_543(iParam0, 866047851) && func_544(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_400(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_548(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_548(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_549(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_550(iParam0, iParam2, iParam1, func_246() != -1);
	if (bParam4)
	{
		func_551(&(Global_1946804->f_1378), 1, 3);
	}
	else
	{
		func_551(&(Global_1946804->f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_406(func_404(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
bool func_423(int iParam0)
{
	...
	if (func_422(iParam0, 1041577989))
	{
		return false;
	}
...
void func_429(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_558(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_559(1, bVar1, 1, uVar2);
		func_560(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_561(ceil(&(Global_40.f_11095.f_11[iParam0])));
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_255(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_315(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_393(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
void func_462(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_157() || !_0x6f1f0b17109309da(Global_43800, func_203(iParam0))))
	{
...
void func_469(struct<2> Param0, int iParam2)
{
	if (!func_465(Param0))
	{
		return;
...
char* func_480(int iParam0)
{
	...
	{
		return func_590(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_591(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_484(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_593(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_493(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_247(iParam0);
	if (((does_entity_exist(iVar1) && func_597(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
int func_507(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
{
	if (func_522(81053684, iParam0))
	{
		return true;
	}
	if (func_522(-525676072, iParam0))
	{
		return true;
	}
	return false;
...
int func_525(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_608(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
{
	return func_420(1328661203, func_612(), -1591664384, bParam0);
}
...
struct<4> func_535(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_420(923904168, func_533(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_420(923904168, func_533(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_420(923904168, func_533(bParam0), -740156546, 0);
}
...
struct<4> func_539(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_420(271701509, func_533(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_420(271701509, func_533(bParam0), 12999093, 0);
}
...
int func_544(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_543(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_549(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_402(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_619(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_378(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_543(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_619(&(Global_1946804->f_1497.f_1[iVar1])) || func_543(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_378(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_378(&(uParam0->f_1[iVar1])) || func_543(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_620(0);
	if (iParam2 != 0 && func_621(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_551(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_401(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_623(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_552(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_625(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_246() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_626(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_627(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_627(Global_40.f_7729);
				Global_1946804->f_1378 = func_627(Global_40.f_7729);
...
bool func_556(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_437((*Global_1360165)[iParam0]->f_4.f_2) || func_293((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_641((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_643(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_488(iParam0, 44, 1);
			}
...
bool func_588(struct<2> Param0, int iParam2)
{
	if (!func_465(Param0))
	{
		return false;
	...
	iVar0 = 0;
	while (iVar0 < func_668(Param0))
	{
		if (func_669(Param0, iVar0) == iParam2)
		{
			return true;
		}
		iVar0++;
...
char* func_592(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_671(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_602(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_248(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_674(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_676(iParam0);
					_0x7b204f88f6c3d287(func_677(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_677(iParam0, 0));
					func_678(iParam0);
				}
			}
			else
		...
		while (iVar28 < 4)
		{
			...
			if (func_537(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_682(0))
				{
					...
					func_683(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_611(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_686("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_685(iParam1, 512) && func_614(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_688(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_685(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_685(iParam1, 4))) && (!func_688(Var4.f_4) || func_685(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_685(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_685(iParam1, 1048576)))
				{
...
{
	iVar0 = func_149(0);
	*uParam1 = { func_420(iParam0, func_535(0), iParam3, 0) };
...
void func_615(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_692(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_692(uParam0->f_2[iVar0], 1))
				{
					func_693(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_625(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_246() == -1)
	{
		func_697(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_698(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_699(&(Global_1946804->f_1378), iParam0);
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_558(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_558(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_631()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_708()));
	fVar7 = (func_703(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_709(3, round((to_float(iVar8) * fVar10)), 0);
	func_710(3, fVar9, fVar9 > 100f);
	return func_711(fVar7, -100f, 100f);
}
...
float func_632()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_709(2, round((to_float(iVar8) * fVar10)), 0);
	func_710(2, fVar9, fVar9 > 100f);
	return func_711(fVar7, -100f, 100f);
}
...
float func_633()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_709(1, round((to_float(iVar8) * fVar10)), 0);
	func_710(1, fVar9, fVar9 > 100f);
...
int func_640(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_714((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_714((*Global_1347702)[63]->f_15, 1) || func_293((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_714((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_714((*Global_1347702)[134]->f_15, 1) || func_293((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_714((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_716(747937920, 1) && !func_714((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> func_643(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
void func_651(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_647(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_647(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_647(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_647(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_647(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_647(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_647(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_647(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_647(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_647(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_647(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_647(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_647(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_647(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_647(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_647(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_647(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_647(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_647(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_647(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_647(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_647(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_647(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_647(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_647(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_647(iParam1, 1544915253))
	{
...
int func_669(struct<2> Param0, int iParam2)
{
	if (!func_465(Param0))
	{
		return 0;
...
var func_671(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_675(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_723(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_677(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_724(iParam0);
	}
...
void func_684(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_727(_get_weapon_clip_size(iParam0), iParam1);
...
void func_699(var uParam0, int iParam1)
{
	if (func_246() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_697(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_698(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
