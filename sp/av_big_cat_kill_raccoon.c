void __EntryFunction__()
{
	...
	Var0 = Local_60;
	Var0.f_1 = Local_60.f_11;
	Var0.f_483 = { Local_60.f_1 };
	Var0.f_486 = { Local_60.f_4 };
	Var0.f_489 = Local_60.f_7;
	Var0.f_20[0] = Local_60.f_8;
	Var0.f_453 = Local_60.f_9;
	Var0.f_500 = Local_60.f_10;
	Var0.f_503 = Local_60.f_12;
	func_1(&Var0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
					...
					if (_does_anim_scene_exist(uParam0->f_3.f_1))
					{
						if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
						{
							if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								if (_get_anim_scene_entity_matrix(uParam0->f_3.f_1, uParam0->f_20[0]->f_1, &Local_48, true, "pbl_action", 2))
								{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[4])
			{
				if (func_73(uParam0, 1.5f, 80f, 4, -91962372, 1))
				{
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
							{
								...
								task_start_scenario_at_position(&(uParam0->f_20[0]), -963073294, Local_48.f_6, Local_48.f_9.f_2, 0, false, true, 0, -1f, false);
...
void func_67(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (func_108(&(uParam0->f_20[0]), Global_35, 1) <= 3600f)
		{
	...
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), -756517419))
		{
		...
		{
			if (has_anim_event_fired(&(uParam0->f_20[1]), 1149974517))
			{
				bLocal_47 = true;
			}
