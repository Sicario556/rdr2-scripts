...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (uParam0->f_489)
	{
		case 0:
			...
			break;
		case 1:
			iVar0 = func_51(func_50());
			break;
	}
	func_52(uParam0, 0, "IG_GenStoryMale", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_52(uParam0, 1, "IG_GenStoryMale^1", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (&uParam0->f_469[2])
	{
		...
		if (!is_entity_dead(&(uParam0->f_20[1])) && does_entity_exist(&(uParam0->f_20[1])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
			{
				if (!bLocal_37)
				{
					vVar0 = { get_offset_from_entity_in_world_coords(&(uParam0->f_20[1]), 0f, 3f, 0f) };
					open_sequence_task(&iVar3);
					task_follow_nav_mesh_to_coord(0, vVar0, 1f, -1, 0.25f, 1048577, 40000f);
					task_wander_standard(0, get_entity_heading(&(uParam0->f_20[1])), 1);
					close_sequence_task(iVar3);
					task_perform_sequence(&(uParam0->f_20[1]), iVar3);
				}
				else
				{
					func_74(&(uParam0->f_20[1]), -178592996, -227.1f, 668.65f, 112.31f, 137.565f, 48000, 1, 0, 0, -1082130432);
				}
				set_ped_keep_task(&(uParam0->f_20[1]), true);
				uParam0->f_469[4] = 1;
			}
		}
		if (!is_entity_dead(&(uParam0->f_20[0])) && does_entity_exist(&(uParam0->f_20[0])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
			{
				if (!bLocal_37)
				{
					...
					task_walk_away(0, &(uParam0->f_20[1]));
					task_wander_standard(0, get_entity_heading(&(uParam0->f_20[0])), 1);
					close_sequence_task(iVar4);
					task_perform_sequence(&(uParam0->f_20[0]), iVar4);
				}
				else
				{
					func_74(&(uParam0->f_20[0]), -22664287, -180.37f, 617.68f, 113.03f, -158.689f, 35000, 1, 0, 0, -1082130432);
				}
...
void func_69(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		if (does_entity_exist(&(uParam0->f_20[iVar0])) && !is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			...
			task_smart_flee_ped(&(uParam0->f_20[iVar0]), Global_35, -1f, -1, 0, 1077936128, 0);
		}
		iVar0++;
	}
}
