void __EntryFunction__()
{
	...
	Var0 = Local_56;
	Var0.f_1 = Local_56.f_11;
	Var0.f_483 = { Local_56.f_1 };
	Var0.f_486 = { Local_56.f_4 };
	Var0.f_489 = Local_56.f_7;
	Var0.f_20[0] = Local_56.f_8;
	Var0.f_453 = Local_56.f_9;
	Var0.f_500 = Local_56.f_10;
	Var0.f_503 = Local_56.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 10865, 10944, 11705);
}
...
{
	func_46(uParam0, "WOLF_AMBUSH_DEER", "script@ambient@animal@WOLF_AMBUSH_DEER@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "WOLF", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
...
{
	_request_scenario_type(1974927641, 1, 0, 0);
	func_57(&uLocal_28, 0);
	func_58(&uLocal_28, 1);
	func_59(&uLocal_28, 1);
	func_60(&uLocal_28, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_23 == 1)
		{
			if (func_65(uParam0, &uLocal_28, 1) || func_66(Global_35, &(uParam0->f_20[0]), 1) <= 625f)
			{
				bLocal_23 = true;
			}
		}
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
							{
								...
								task_start_scenario_at_position(&(uParam0->f_20[0]), 1974927641, Local_11.f_6, Local_11.f_9.f_2, 0, false, true, 0, -1f, false);
...
void func_71(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 830334344))
		{
			...
			func_110(&(uParam0->f_20[1]), 0, 0);
		}
		else if (!func_111(&(uParam0->f_20[1]), 518218985))
		{
	...
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (func_66(&(uParam0->f_20[0]), Global_35, 1) <= 3600f)
		{
			if (!func_111(&(uParam0->f_20[0]), 780511057))
			{
		...
		else if (!func_111(&(uParam0->f_20[0]), 518218985))
		{
...
bool func_73(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
