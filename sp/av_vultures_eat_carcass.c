...
int func_18(var uParam0)
{
	...
	return func_51(uParam0, uParam0->f_20[9]->f_5);
}
...
bool func_28(var uParam0)
{
	...
	while (iVar0 < iLocal_15)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			func_59(uParam0->f_20[iVar0], 1, 1);
			set_entity_no_collision_entity(&(uParam0->f_20[iVar0]), &(uParam0->f_20[9]), false);
			set_entity_no_collision_entity(&(uParam0->f_20[9]), &(uParam0->f_20[iVar0]), false);
		}
		iVar0++;
	}
	if (!is_entity_dead(&(uParam0->f_20[9])))
	{
		set_ped_config_flag(&(uParam0->f_20[9]), 186, true);
		_set_ped_quality(&(uParam0->f_20[9]), 0);
		task_play_anim(&(uParam0->f_20[9]), sLocal_13, sLocal_14, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		_0x674b90be1115846d(&(uParam0->f_20[9]), 1);
		_0x3ca5e58c9731a16b(&(uParam0->f_20[9]), iLocal_16);
		func_59(uParam0->f_20[9], 1, 1);
		set_ped_keep_task(&(uParam0->f_20[9]), true);
	}
	return true;
}
...
Vector3 func_48(vector3 vParam0, vector3 vParam3, vector3 vParam6)
{
	...
	{
		vVar0 = { _get_object_offset_from_coords(vVar0, vParam3.z, vParam6) };
	}
	return vVar0;
}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_110(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_68(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_115(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_110(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_111(&(uParam0->f_490)))
							{
...
void func_74(var uParam0, int iParam1)
{
	if (!is_entity_dead(&(uParam0->f_20[iParam1])))
	{
		if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[iParam1]->f_1))
		{
			...
			func_59(uParam0->f_20[iParam1], 0, 1);
...
void func_121(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_174(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_174(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_174(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
