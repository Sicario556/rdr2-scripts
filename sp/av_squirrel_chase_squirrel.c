void __EntryFunction__()
{
	...
	Var0 = Local_19;
	Var0.f_1 = Local_19.f_11;
	Var0.f_483 = { Local_19.f_1 };
	Var0.f_486 = { Local_19.f_4 };
	Var0.f_489 = Local_19.f_7;
	Var0.f_20[0] = Local_19.f_8;
	Var0.f_453 = Local_19.f_9;
	Var0.f_500 = Local_19.f_10;
	Var0.f_503 = Local_19.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "SQS_SQUIRREL_1", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "SQS_SQUIRREL_2", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_12)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				uLocal_13[0] = func_56(iLocal_11, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[0]), &(uLocal_13[0]), 0, 0, false, true, 0, false, -1f, false);
				func_57(uParam0->f_20[0], 1, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_55(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				uLocal_13[1] = func_56(iLocal_11, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[1]), &(uLocal_13[1]), 0, 0, false, true, 0, false, -1f, false);
		...
		case 1:
			if (func_58(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!is_entity_dead(&(uParam0->f_20[0])) && !is_entity_dead(&(uParam0->f_20[1])))
				{
					...
					task_smart_flee_ped(0, &(uParam0->f_20[1]), 1000f, -1, 8448, 1.75f, 0);
					...
					set_ped_config_flag(&(uParam0->f_20[0]), 168, true);
					set_ped_config_flag(&(uParam0->f_20[0]), 288, true);
					_0xa3a9299c4f2adb98(&(uParam0->f_20[1]));
					open_sequence_task(&iVar0);
					task_follow_to_offset_of_entity(0, &(uParam0->f_20[0]), 0f, -1f, 0f, fLocal_9, -1, 1036831949, 1, 1, 0, 0, 1);
					task_set_blocking_of_non_temporary_events(0, false);
					close_sequence_task(iVar0);
					func_57(uParam0->f_20[1], 1, 1);
					task_perform_sequence(&(uParam0->f_20[1]), iVar0);
					clear_sequence_task(&iVar0);
					set_ped_config_flag(&(uParam0->f_20[1]), 230, true);
