...
{
	remove_blip(&(Local_41[iParam0]->f_8));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (func_5(&(Local_41[iParam0]->f_1[iVar0]), 0))
		{
			func_6(&(Local_41[iParam0]->f_1[iVar0]));
			func_7(Local_41[iParam0]->f_1[iVar0], 1, 0, 1);
		}
		iVar0++;
	}
	if (does_group_exist(Local_41[iParam0]->f_7))
	{
		remove_group(Local_41[iParam0]->f_7);
	}
}
...
void func_4()
{
	switch (iLocal_73)
	{
		case 1:
			...
			break;
		case 2:
			request_model(iLocal_74, false);
			request_model(iLocal_75, false);
			if ((has_model_loaded(iLocal_74) && has_model_loaded(iLocal_75)) && _0x5e420ff293ee5472())
			{
				iLocal_73 = 4;
			}
			break;
		...
		case 5:
			...
			while (iVar0 < 3)
			{
				if (&Local_41[iVar0] == 1)
				{
					if (func_5(Local_41[iVar0]->f_6, 0))
					{
						if (func_12(Global_35, Local_41[iVar0]->f_9, 1, 0))
						{
							func_18(iVar0);
						}
					}
					else if (func_12(Global_35, Local_41[iVar0]->f_9, 1, 0))
					{
						func_18(iVar0);
					}
					else
				...
				else if (&Local_41[iVar0] == 2)
				{
					if (func_5(Local_41[iVar0]->f_6, 0))
					{
						if (!is_ped_in_combat(Local_41[iVar0]->f_6, 0) && !func_12(Global_35, Local_41[iVar0]->f_9, 1, 0))
						{
							func_17(iVar0);
						}
					}
				}
				else if (&Local_41[iVar0] == 3)
				{
					func_1(iVar0);
				}
				iVar0++;
...
int func_14(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, vector3 vParam5)
{
	...
	return get_random_model_from_population_set(func_24(iParam0), iParam1, iParam2, bParam3, bParam4, vParam5);
}
...
void func_16(int iParam0)
{
	if (!does_group_exist(Local_41[iParam0]->f_7))
	{
		Local_41[iParam0]->f_7 = create_group(1);
	}
	vVar0 = { func_26(vLocal_88, 3f, 1f) };
	Local_41[iParam0]->f_6 = func_27(iLocal_75, vVar0, get_random_float_in_range(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	set_ped_config_flag(Local_41[iParam0]->f_6, 279, true);
	set_ped_as_group_leader(Local_41[iParam0]->f_6, Local_41[iParam0]->f_7, false);
	task_police(Local_41[iParam0]->f_6, false);
	set_ped_config_flag(Local_41[iParam0]->f_6, 188, true);
	iVar3 = 0;
	while (iVar3 < 4)
	{
		Local_41[iParam0]->f_1[iVar3] = func_27(iLocal_74, vVar0, get_random_float_in_range(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		if (func_5(&(Local_41[iParam0]->f_1[iVar3]), 0))
		{
		}
		iVar3++;
	}
...
{
	if (!func_5(Local_41[iParam0]->f_6, 0))
	{
		return;
	}
	Local_41[iParam0] = 1;
	if (!_does_volume_exist(Local_41[iParam0]->f_9))
	{
		Local_41[iParam0]->f_9 = _create_volume_cylinder(get_entity_coords(Local_41[iParam0]->f_6, true, false), 0f, 0f, 0f, 35f, 35f, 10f);
		_0x7c00cfc48a782dc0(Local_41[iParam0]->f_9, Local_41[iParam0]->f_6, 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
	}
	if (!does_blip_exist(Local_41[iParam0]->f_8))
	{
		Local_41[iParam0]->f_8 = _0xa6ef0c54a3443e70(-1282792512, Local_41[iParam0]->f_9);
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (func_5(&(Local_41[iParam0]->f_1[iVar0]), 0))
		{
			vVar1 = { IntToFloat(iVar0 + 1), get_random_float_in_range(1f, 3f), 0f };
			func_6(&(Local_41[iParam0]->f_1[iVar0]));
			task_follow_to_offset_of_entity(&(Local_41[iParam0]->f_1[iVar0]), Local_41[iParam0]->f_6, vVar1, 2f, -1, 1036831949, 1, 1, 0, 0, 1);
		}
		iVar0++;
	}
}
...
void func_18(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_5(&(Local_41[iParam0]->f_1[iVar0]), 0))
		{
			remove_ped_from_group(&(Local_41[iParam0]->f_1[iVar0]));
			task_combat_ped(&(Local_41[iParam0]->f_1[iVar0]), Global_35, 0, 0);
			_blip_add_for_entity(831283580, &(Local_41[iParam0]->f_1[iVar0]));
			remove_blip(&(Local_41[iParam0]->f_8));
		}
		iVar0++;
	}
	...
	switch (*iParam3)
	{
		case 0:
			...
			else
			{
				...
				{
					_0xce4e669400e5f8aa(iParam3->f_1, func_33(iParam3->f_6));
				}
...
Vector3 func_26(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_34(vVar0, get_random_float_in_range(0f, fParam3)) };
...
void func_30(var uParam0, int iParam1, vector3 vParam2, int iParam5, float fParam6, int iParam7, float fParam8, float fParam9, float fParam10)
{
	if (!func_32(vParam2))
	{
	...
	if (fParam8 == -0.01f)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				_0x954451ea2d2120fb(*uParam0, func_36(10f, 40f, 5f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(30f, 60f, 5f, iParam1));
			...
			case 37:
				...
				_0x954451ea2d2120fb(*uParam0, func_36(40f, 80f, 5f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(50f, 90f, 5f, iParam1));
				_0x450080ddedb91258(*uParam0, 10f);
			...
			case 38:
				_0x2eb977293923c723(*uParam0, 30f);
				_0x954451ea2d2120fb(*uParam0, func_36(30f, 60f, 5f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(50f, 80f, 5f, iParam1));
			...
			case 39:
				_0x2eb977293923c723(*uParam0, 10f);
				_0x954451ea2d2120fb(*uParam0, func_36(0f, 10f, 1f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(5f, 15f, 1f, iParam1));
			...
			case 40:
				...
				_0x954451ea2d2120fb(*uParam0, func_36(60f, 120f, 10f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(100f, 130f, 5f, iParam1));
			...
			case 41:
				_0x2eb977293923c723(*uParam0, 10f);
				_0x954451ea2d2120fb(*uParam0, func_36(10f, 35f, 5f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(25f, 50f, 5f, iParam1));
			...
			case 45:
				_0x2eb977293923c723(*uParam0, 40f);
				_0x954451ea2d2120fb(*uParam0, func_36(50f, 80f, 10f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(75f, 95f, 5f, iParam1));
				_0x450080ddedb91258(*uParam0, 15f);
				_0x885d19ac2b6fbff4(*uParam0, 0);
				break;
			case 43:
				_0x2eb977293923c723(*uParam0, func_36(95f, 90f, 80f, iParam1));
				_0x954451ea2d2120fb(*uParam0, func_36(95f, 90f, 80f, iParam1));
				_0x0f4f6c4ce471259d(*uParam0, func_36(125f, 115f, 100f, iParam1));
				_0x450080ddedb91258(*uParam0, 5f);
				_0xbc3f847ae2c3dc65(*uParam0, 10f);
				_0x885d19ac2b6fbff4(*uParam0, 0);
				break;
