...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(787.8243f, 882.1937f, 119.7894f, 0f, 0f, 55f, 125.2023f, 100.3452f, 40f, "Carmody Dell - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("Carmody Dell - m_volRancherThreat Agg");
		_0x39816f6f94f385ad(iLocal_17, 806.7073f, 912.1846f, 117.3476f, 0f, 0f, -35.32174f, 53.76932f, 60.14007f, 23.00237f);
		_0x39816f6f94f385ad(iLocal_17, 780.8397f, 929.7451f, 119.7875f, 0f, 0f, 55.18388f, 26.30651f, 11.24122f, 11.33113f);
		_0x39816f6f94f385ad(iLocal_17, 771.6188f, 914.839f, 119.356f, 0f, 0f, -16.63371f, 8.920543f, 13.65767f, 15.37034f);
		_0x39816f6f94f385ad(iLocal_17, 795.0371f, 944.3275f, 119.356f, 0f, 0f, -64.24297f, 8.920543f, 19.18642f, 15.37034f);
		_0x39816f6f94f385ad(iLocal_17, 816.5428f, 873.1447f, 119.356f, 0f, 0f, -21.77554f, 8.920543f, 2.767935f, 15.37034f);
		_0x39816f6f94f385ad(iLocal_17, 829.7242f, 889.6086f, 119.7875f, 0f, 0f, 55.18388f, 41.18428f, 11.24122f, 11.33113f);
		_0xbce668aaf83608be(iLocal_17, 769.6929f, 907.6835f, 120.974f, 0f, 0f, 0f, 4.125297f, 4.231483f, 6.104111f);
		_0xbce668aaf83608be(iLocal_17, 839.9313f, 911.4315f, 119.4895f, 0f, 0f, 0f, 8.364783f, 12.69234f, 6.104111f);
		_0xbce668aaf83608be(iLocal_17, 832.4132f, 889.8692f, 119.4895f, 0f, 0f, 143.33f, 8.994324f, 22.29211f, 6.104111f);
		_0xbce668aaf83608be(iLocal_17, 822.2815f, 932.1641f, 119.4895f, 0f, 0f, -126.8662f, 8.994324f, 31.08295f, 6.104111f);
		_0x39816f6f94f385ad(iLocal_17, 819.2129f, 855.7402f, 118.2282f, 0f, 0f, -13.96608f, 5.387506f, 5.559112f, 8.634696f);
		_0x39816f6f94f385ad(iLocal_17, 820.7993f, 861.1673f, 118.2282f, 0f, 0f, -10.02887f, 5.561343f, 7.297987f, 8.634696f);
		_0x39816f6f94f385ad(iLocal_17, 769.4434f, 876.2131f, 120.0194f, 0f, 0f, -25.51114f, 10.21165f, 6.687877f, 8.634696f);
		_0x39816f6f94f385ad(iLocal_17, 766.2256f, 872.457f, 120.0194f, 0f, 0f, -25.51114f, 5.492983f, 4.760298f, 8.634696f);
		_0x39816f6f94f385ad(iLocal_17, 777.969f, 848.5886f, 120.9221f, 0f, 0f, -73.17738f, 11.36973f, 8.455206f, 8.634696f);
		_0x39816f6f94f385ad(iLocal_17, 772.6626f, 844.5665f, 118.6478f, 0f, 0f, -73.17738f, 6.30228f, 3.996295f, 8.634696f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Carmody Dell - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_17);
		_0x39816f6f94f385ad(iLocal_16, 797.8185f, 892.8757f, 117.3476f, 0f, 0f, -35.32174f, 90.11897f, 71.78452f, 23.00237f);
		_0xbce668aaf83608be(iLocal_16, 775.4374f, 864.7417f, 119.4895f, 0f, 0f, -125.795f, 37.58796f, 46.28559f, 7.161122f);
		_0xbce668aaf83608be(iLocal_16, 817.8414f, 923.5469f, 119.4895f, 0f, 0f, -125.795f, 37.58796f, 46.28559f, 7.161122f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("Carmody Dell - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_16);
		_0xbce668aaf83608be(iLocal_18, 797.2189f, 892.9724f, 119.4895f, 0f, 0f, -125.795f, 87.08194f, 67.53848f, 13.34678f);
		sLocal_15 = "CARMODY_DELL";
		_create_guard_zone(sLocal_15);
		_0x8c598a930f471938(sLocal_15, iLocal_14);
		_0x35815f372d43e1e5(sLocal_15, iLocal_16);
		_0xa1b0e6301e2e02a6(sLocal_15, iLocal_17);
		_0xad3e07c37a7c1adc(sLocal_15, iLocal_18);
		_set_guard_zone_position(sLocal_15, 775.9428f, 849.0016f, 121.7797f);
		_0xa8a74aa79fb67159(sLocal_15, iLocal_14);
	}
	return true;
}
...
void func_14(int iParam0)
{
	...
	_0x1bc47a9dedc8df5d(883522755, 0);
	_0x1bc47a9dedc8df5d(1038094132, 0);
	iVar0 = 869;
	iVar1 = func_47(iVar0);
	if (func_48(iVar1, 0))
	{
...
void func_28(int iParam0)
{
	...
	if (!func_48(iVar1, 0))
	{
		...
		_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_57(740));
		_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_57(737));
		_0x931b241409216c1f(func_47(iVar0), func_47(737), 0);
	}
}
...
void func_62()
{
	...
	iVar0 = get_interior_at_coords(func_110(1));
	bVar1 = false;
	...
	{
		if (func_109(1, 8) || ((!func_117(1, -2147483648) && get_clock_hours() >= 6) && get_clock_hours() < 21))
		{
	...
	else if (get_clock_hours() >= 6 && get_clock_hours() < 21)
	{
		func_112(269047710, 0, 0);
		func_114(&iVar0, "_car_house_int_after_ransack", &bVar1);
		func_113(&iVar0, "_car_house_int_before_ransack", &bVar1);
...
bool func_68(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_134(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_136(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
...
bool func_92(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_20() != -1;
	switch (iParam0)
	{
...
int func_95(int iParam0, bool bParam1)
{
	...
	if (func_168(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_57(iParam0));
				func_172(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_57(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_57(iParam0)))
	{
		func_172(iParam0, 128);
		return 1;
	}
	func_171(iParam0, _create_persistent_character(func_170(iParam0)));
	_0x4f81ead1de8fa19b(func_57(iParam0));
	if (func_168(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_57(iParam0));
		func_172(iParam0, 2048);
...
{
	func_174(iParam0, 4);
	func_176(Global_1392240->f_1[iParam0]->f_4, 58, *Global_1392240->f_1[iParam0], func_175(iParam0));
	if (does_blip_exist(Global_1392240->f_1[iParam0]->f_5))
	{
		set_blip_name_from_text_file(Global_1392240->f_1[iParam0]->f_5, func_175(iParam0));
	}
}
...
bool func_99(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_47(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_57(iParam0));
}
...
bool func_120(int iParam0)
{
	...
	return func_188((*Global_1347702)[iParam0]->f_15, 1);
}

bool func_121(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
...
char* func_136(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
...
char* func_148(char* sParam0, int iParam1)
{
	...
	return func_203(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_151(int iParam0)
{
	...
	if (func_204())
	{
		if (!func_188((*Global_1835011)[3]->f_1, 1))
		{
...
{
	if (func_93(Global_1914319->f_3[iParam0]->f_21) && func_211(Global_1914319->f_3[iParam0]->f_21))
	{
...
int func_169(int iParam0, bool bParam1)
{
	...
	func_220(iParam0);
	_0xfc77c5b44d5ff7c0(func_57(iParam0));
	func_171(iParam0, 0);
	return 1;
}
...
{
	return func_228(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}

bool func_190(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
...
bool func_197(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_230(&(Global_1898164->f_1[0]));
		if (func_179(iVar0) && func_231((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_236(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
bool func_233(vector3 vParam0, int iParam3)
{
	func_249(iParam3, &vVar0, &Var3, &uVar6);
	if (func_250(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
