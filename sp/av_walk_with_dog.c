void __EntryFunction__()
{
	...
	Var0 = Local_83;
	Var0.f_1 = Local_83.f_11;
	Var0.f_483 = { Local_83.f_1 };
	Var0.f_486 = { Local_83.f_4 };
	Var0.f_489 = Local_83.f_7;
	Var0.f_20[0] = Local_83.f_8;
	Var0.f_453 = Local_83.f_9;
	Var0.f_500 = Local_83.f_10;
	Var0.f_503 = Local_83.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 10939, 10997, 11873);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 72:
			...
			iLocal_50 = -830507952;
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 1f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 3f, 0f), (180f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
		case 73:
			iLocal_10 = func_48(func_47(), 1, 0, 1, 0, 0, 0);
			iLocal_11 = 556355544;
			...
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 1f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, 5f, 0f), (180f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
	}
}
...
int func_31(var uParam0)
{
	...
	{
		func_68(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1, 0, 1, 0, 1, 1, 0, 1, 1);
		func_69(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 1, 0, 1, 0, 1, 1, 0, 1, 1);
	}
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_70(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				bVar0 = true;
				if (*uParam0 == 72)
				{
					bVar0 = false;
					_0x45fea6d5539bd474(&(uParam0->f_20[0]), "DogVerbalReactionResponse");
					_0xe37acee15ac50c7e(&(uParam0->f_20[0]), "DogVerbalReactionResponse");
				}
				else
				{
					bVar0 = true;
					set_animal_tuning_float_param(&(uParam0->f_20[0]), 73, 0f);
				}
				task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_50, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
				func_66(uParam0->f_20[0], bVar0, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_70(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				...
				set_ped_combat_attributes(&(uParam0->f_20[1]), 93, true);
				_give_weapon_to_ped_2(&(uParam0->f_20[1]), 379542007, 5000, false, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				func_71(&(uParam0->f_20[1]), &(uParam0->f_20[0]), &uLocal_12, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1f, 1092616192, -1, 1, 0, 0, 0, 1);
				task_start_scenario_at_position(&(uParam0->f_20[1]), iLocal_51, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, false, true, 0, -1f, false);
				func_66(uParam0->f_20[1], 0, 1);
			}
			iLocal_9 = 1;
			break;
		case 1:
		...
		case 2:
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				_task_move_in_traffic(&(uParam0->f_20[1]), 1f, 0, 0);
		...
		case 3:
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				if (!_is_ped_using_scenario_hash(&(uParam0->f_20[1]), iLocal_51))
				{
					_0xa3a9299c4f2adb98(&(uParam0->f_20[1]));
					fVar1 = -2f;
					fVar2 = 0f;
					if (*uParam0 == 72)
					{
					...
					func_74(&(uParam0->f_20[0]), &(uParam0->f_20[1]), &uLocal_12, -1082130432, 0, 0, -1082130432, 1f, 1, 32, fVar1, fVar2, 1f, 1073741824, 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
					iLocal_9 = 5;
				}
			}
			break;
...
int func_32(var uParam0, var uParam1)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		func_75(&(uParam0->f_20[1]), 1);
	}
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		func_76(&(uParam0->f_20[0]), 1);
	}
...
void func_71(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_115(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
void func_74(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	if (is_entity_dead(iParam0))
	{
	}
	...
	{
		task_follow_and_converse_with_ped(iParam0, iParam1, iParam4, iParam5, iParam6, fParam7, iParam9, fParam10, fParam11, fParam12, iParam13);
	}
	if (bParam19)
	{
		_set_ped_crouch_movement(iParam0, false, 0, false);
...
bool func_81(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_120(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_82(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_121(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_105(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_141(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
float func_115(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_168(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_165(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_218(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_218(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_218(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_166(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_227(iVar0, 0)))
		{
			if (func_229(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_215(int iParam0)
{
	...
	return func_235((*Global_1347702)[58]->f_15, 1);
}
...
void func_218(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
bool func_228(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_229(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_229(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_231(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
