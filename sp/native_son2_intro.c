void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_15 = -1135378761;
	iLocal_16 = 830712509;
	iLocal_17 = 822759307;
	iLocal_18 = -1700686082;
	iLocal_19 = -197909103;
	iLocal_20 = 412658482;
	iLocal_21 = -1582519980;
	iLocal_22 = 1368237872;
	...
	while (!func_5(&Local_162, 1))
	{
		...
		if (((((func_6(&Local_162) >= 5 && func_6(&Local_162) <= 7) && !func_5(&Local_162, 4096)) && _does_anim_scene_exist(Local_162.f_428.f_444)) && _is_anim_scene_started(Local_162.f_428.f_444, false)) && !_is_anim_scene_paused(Local_162.f_428.f_444))
		{
		...
		switch (func_6(&Local_162))
		{
			...
			case 3:
				...
				func_39(&Local_162);
				if (func_40(func_32((*Global_1835011)[Local_162]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_162.f_428)) == 4 && _does_anim_scene_exist(Local_162.f_428.f_444)) && _is_anim_scene_paused(Local_162.f_428.f_444))
				{
					func_37(Local_162);
					func_17(&Local_162, 7);
				}
...
bool func_41(int iParam0)
{
	...
	else if (func_157(Global_35))
	{
		...
		if (!does_entity_exist(iLocal_52) || (does_entity_exist(iVar0) && iLocal_52 != iVar0))
		{
			iLocal_52 = iVar0;
		}
	}
	...
	{
		_0x5b23dff8e0948bb2(iLocal_56, 1);
		_0x3946fc742ac305cd(get_player_index(), iLocal_45, "NTS2_INTRO", get_entity_coords(iLocal_46, true, false), 0, 0);
		_hide_ped_weapons(Global_35, 2, false);
		_set_ped_crouch_movement(Global_35, false, 0, false);
		start_anim_scene(iLocal_38);
		return true;
	}
	return false;
}
...
bool func_44(int iParam0)
{
	...
	if (_is_anim_scene_finished(iLocal_38, false) || _is_anim_scene_active(iLocal_38))
	{
		_0xc67a4910425f11f1(get_player_index(), 0);
		_hide_ped_weapons(Global_35, 2, true);
		_0x9851de7aec10b4e1(vLocal_23, 15f, 1, 1);
		return true;
	}
	return false;
}
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_259(iVar0), func_260(), 1))
			{
...
bool func_128(int iParam0)
{
	...
	iLocal_55 = _0x0eb78c2b156635b1(665633627, vLocal_26, 0f, 0f, 0f, 1f, 1f, 2f);
	iLocal_56 = _0x0eb78c2b156635b1(-1612834106, 67.423f, 1070.24f, 195.479f, 0f, 0f, 23.603f, 8.827f, 0.45f, 4.899f);
	_0x5b23dff8e0948bb2(iLocal_56, 0);
	_0x5b23dff8e0948bb2(iLocal_55, 1);
	_0x19c7567d2f2287d6(iLocal_54, 7);
...
void func_140(var uParam0)
{
	...
	if (iVar0 >= 21 || iVar0 < 5)
	{
		set_anim_scene_bool(uParam0->f_444, "bNight", true, false);
	}
	else if (iVar0 == 20)
	{
		set_anim_scene_bool(uParam0->f_444, "bEvening", true, false);
	}
}
...
bool func_144()
{
	return func_305(get_id_of_this_thread());
}
...
void func_146(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_310(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_154(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	...
	{
		if (func_313(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_155(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	iParam3 = iParam3;
	iParam4 = iParam4;
	if (!is_entity_dead(iParam2) && (func_314(iParam2, iParam3, 1, 1) < 70f || bParam5))
	{
...
int func_156(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, int iParam11, float fParam12, float fParam13, bool bParam14)
{
	...
	if (func_18(fParam4))
	{
		...
		if (func_48(fParam4) >= fParam9)
		{
			...
			if (!is_entity_dead(iVar1) && !func_160(iParam0, 501393341))
			{
			...
			if (!is_entity_dead(iVar2) && !func_160(iParam0, -828834893))
			{
				if (is_ped_in_any_vehicle(iParam0, false))
				{
...
void func_172()
{
	...
	{
		if (does_entity_belong_to_this_script(iLocal_39, false))
		{
			set_vehicle_is_considered_by_player(iLocal_39, true);
			set_vehicle_handbrake(iLocal_39, false);
			set_vehicle_as_no_longer_needed(&iLocal_39);
		}
	}
}
...
void func_175(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_335((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_337((*uParam1)[iVar0]))
		{
			if (func_335((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_338((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_339((*uParam2)[iVar0]))
		{
			if (func_335((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_340((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_341((*uParam3)[iVar0]))
		{
			if (func_335((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_342((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_344((*uParam5)[iVar0]))
		{
			if (func_335((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_345((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_344((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_346((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_335((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_347((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_348((*uParam6)[iVar0]))
		{
			if (func_335((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_349((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_350((*uParam7)[iVar0]))
		{
			if (func_335((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_351((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_352((*uParam8)[iVar0]))
		{
			if (func_335((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_353((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_354((*uParam9)[iVar0]))
		{
			if (func_335((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_355((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_356((*uParam10)[iVar0]))
		{
			if (func_335((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_357((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_358((*uParam11)[iVar0]))
		{
			if (func_335((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_359((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_238(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_406() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_240(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_407(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_409(iVar1, func_407(uParam0), func_408(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_409(iVar3, func_407(uParam0), func_408(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_407(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_407(uParam0) };
			func_409(iVar0, vVar1, func_410(vVar1, Global_36, 1), 2, 1073741824);
...
bool func_257(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_442(iParam2, 1024))) || func_442(iParam2, 8)) && !func_319(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_443(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_442(iParam2, 4096)) && !func_319(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_443(iParam1, 2048);
			func_443(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_442(iParam2, 32)) && !func_319(*iParam1, 5632))
		{
...
int func_269(var uParam0, int iParam1)
{
	...
	if (func_144())
	{
		...
		if (func_449(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_450(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_309(uParam0, 8) && _0xdd0b7c5ae58f721d(func_451()))
	{
		_0x798be43c9393632b(func_451());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_451())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_275(int iParam0)
{
	if (!func_319(iLocal_34, 1))
	{
		...
		if (!_0xa0bc8faed8cfeb3c(iLocal_45))
		{
			return false;
		}
		func_457(iLocal_45, func_456(0, 2), 2, 1073741824);
		func_458(&iLocal_45);
		set_blocking_of_non_temporary_events(iLocal_45, true);
		_give_weapon_to_ped_2(iLocal_45, -95736505, -1, false, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
		_give_weapon_to_ped_2(iLocal_45, -733324796, -1, false, true, 1, false, 0.5f, 1f, 752097756, true, 0f, false);
		set_ped_drops_weapons_when_dead(iLocal_45, func_459(-95736505));
...
bool func_276(int iParam0)
{
	if (!func_319(iLocal_34, 2))
	{
		...
		if (!_0xa0bc8faed8cfeb3c(iLocal_46))
		{
			return false;
		}
		func_457(iLocal_46, func_456(0, 1), 2, 1073741824);
		func_458(&iLocal_46);
		set_blocking_of_non_temporary_events(iLocal_46, true);
		_0x899a04afcc725d04(iLocal_46, -101156244);
		set_ped_drops_weapons_when_dead(iLocal_46, func_459(-183018591));
...
bool func_277()
{
	if (!func_460(&iLocal_47, func_456(0, 3), iLocal_15, -2002235300, 4, 41788943))
	{
		return false;
	}
	if (!func_460(uLocal_48[0], func_456(1, 0), iLocal_16, -2002235300, 8, 630925281))
	{
		return false;
	}
	if (!func_460(uLocal_48[1], func_456(1, 1), iLocal_16, -2002235300, 16, -36775863))
	{
		return false;
	}
	if (!func_460(uLocal_48[2], func_456(1, 2), iLocal_16, -183018591, 32, 269778132))
	{
		return false;
	}
	return true;
...
bool func_278()
{
	if (!does_entity_exist(iLocal_39))
	{
		...
		{
			iLocal_39 = create_vehicle(iLocal_17, func_461(2, 0), func_462(2, 0), true, true, false, false);
			set_vehicle_is_considered_by_player(iLocal_39, false);
			set_vehicle_handbrake(iLocal_39, true);
		}
		return false;
	}
	_request_propset(-1891768214);
	if (!_has_propset_loaded(-1891768214))
	{
		return false;
	}
	else if (!_0x53784cea0159439b(iLocal_39))
	{
		_0xd80faf919a2e56ea(iLocal_39, -1891768214);
		return false;
	}
	return true;
}
...
bool func_279()
{
	...
	{
		request_model(iLocal_18, false);
		if (has_model_loaded(iLocal_18))
		{
			iLocal_40 = create_object(iLocal_18, func_461(2, 4), true, true, false, false, true);
			set_entity_no_collision_entity(iLocal_40, iLocal_39, false);
		}
		return false;
	}
	...
	{
		request_model(iLocal_19, false);
		if (has_model_loaded(iLocal_19))
		{
			iLocal_41 = create_object(iLocal_19, func_461(2, 3), true, true, false, false, true);
			set_entity_no_collision_entity(iLocal_41, iLocal_39, false);
		}
		return false;
	}
	if (!does_entity_exist(iLocal_42))
	{
		...
		{
			iLocal_42 = create_object(iLocal_20, func_461(2, 5), true, true, false, false, true);
			set_entity_no_collision_entity(iLocal_42, iLocal_39, false);
		}
		return false;
	}
	if (!does_entity_exist(iLocal_43))
	{
		...
		{
			iLocal_43 = create_object(iLocal_21, func_461(2, 1), true, true, false, false, true);
			set_entity_no_collision_entity(iLocal_43, iLocal_39, false);
		}
		return false;
	}
	if (!does_entity_exist(iLocal_44))
	{
		request_model(iLocal_22, false);
		if (has_model_loaded(iLocal_22))
		{
			iLocal_44 = create_object(iLocal_22, func_461(2, 2), true, true, false, false, true);
			set_entity_heading(iLocal_44, func_462(2, 2));
			if (does_entity_exist(iLocal_39))
			{
				vVar0 = { get_offset_from_entity_given_world_coords(iLocal_39, func_461(2, 2)) };
				attach_entity_to_entity(iLocal_44, iLocal_39, 0, vVar0, 0f, 0f, 0f, false, false, false, false, 2, true, false, false);
			}
		}
		return false;
	}
...
bool func_280()
{
	_text_database_request("NTS2AUD");
	return _text_database_has_loaded("NTS2AUD");
}
...
bool func_281(int iParam0, char* sParam1, int iParam2)
{
	if (!_does_anim_scene_exist(*iParam0))
	{
		*iParam0 = _create_anim_scene(sParam1, iParam2, 0, false, true);
	}
...
bool func_282()
{
	if ((_0xa0bc8faed8cfeb3c(iLocal_45) && _0xa0bc8faed8cfeb3c(iLocal_46)) && _0xa0bc8faed8cfeb3c(iLocal_47))
	{
		return true;
	}
	return false;
...
void func_283()
{
	func_463(0, 1073741824, 1);
	func_463(26, 262144, 1);
	_set_ped_body_component(iLocal_47, -972364774);
	_update_ped_variation(iLocal_47, false, true, true, true, false);
}

void func_284()
{
	set_anim_scene_entity(iLocal_35, "Dutch", iLocal_45, 0);
	set_anim_scene_entity(iLocal_35, "EagleFlies", iLocal_46, 0);
	set_anim_scene_entity(iLocal_35, "Paytah", iLocal_47, 0);
	set_anim_scene_entity(iLocal_36, "A_M_M_WAPWARRIORS_01", &(uLocal_48[0]), 0);
	set_anim_scene_entity(iLocal_36, "A_M_M_WAPWARRIORS_01^1", &(uLocal_48[1]), 0);
	set_anim_scene_entity(iLocal_36, "A_M_M_WAPWARRIORS_01^2", &(uLocal_48[2]), 0);
	set_anim_scene_entity(iLocal_36, "p_ladle02x", iLocal_40, 0);
	set_anim_scene_entity(iLocal_37, "UTILLIWAG", iLocal_39, 0);
	set_anim_scene_entity(iLocal_37, "p_cs_bucket01x", iLocal_41, 0);
	set_anim_scene_entity(iLocal_37, "p_cs_vegsack_up", iLocal_42, 0);
	set_anim_scene_entity(iLocal_37, "p_cs_detonator01x ", iLocal_43, 0);
}

void func_285()
{
	set_anim_scene_entity(iLocal_38, "ARTHUR", Global_35, 0);
	set_anim_scene_entity(iLocal_38, "A_M_M_WAPWARRIORS_01", &(uLocal_48[0]), 0);
	set_anim_scene_entity(iLocal_38, "A_M_M_WAPWARRIORS_01^1", &(uLocal_48[1]), 0);
	set_anim_scene_entity(iLocal_38, "A_M_M_WAPWARRIORS_01^2", &(uLocal_48[2]), 0);
	set_anim_scene_entity(iLocal_38, "Dutch", iLocal_45, 0);
	set_anim_scene_entity(iLocal_38, "EagleFlies", iLocal_46, 0);
	set_anim_scene_entity(iLocal_38, "PAYTAH", iLocal_47, 0);
	set_anim_scene_entity(iLocal_38, "p_ladle02x", iLocal_40, 0);
}
...
{
	*iParam0 = _create_volume_cylinder_with_custom_name(vParam1, vParam4, vParam7, uParam10);
}

void func_288(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, var uParam10)
{
	*iParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, uParam10);
}
...
int func_294(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		...
		{
			if (func_335((*uParam0)[iVar1]->f_2, iParam12))
			{
				if (!func_465((*uParam0)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam1)
	{
		if (func_337((*uParam1)[iVar1]))
		{
			if (func_335((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_466((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_339((*uParam2)[iVar1]))
		{
			if (func_335((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_467((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		...
		{
			if (func_335((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_344((*uParam5)[iVar1]))
		{
			if (func_335((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_468((*uParam5)[iVar1]))
				{
			...
			if (func_335((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_468((*uParam5)[iVar1]))
				{
					if (func_469((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_346((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_470((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_348((*uParam6)[iVar1]))
		{
			if (func_335((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_471((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_350((*uParam7)[iVar1]))
		{
			if (func_335((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_472((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		if (func_352((*uParam8)[iVar1]))
		{
			if (func_335((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_473((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_354((*uParam9)[iVar1]))
		{
			if (func_335((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_474((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_356((*uParam10)[iVar1]))
		{
			if (func_335((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_475((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_358((*uParam11)[iVar1]))
		{
			if (func_335((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_476((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
void func_317(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if ((bVar3 <= bParam5 && bVar3 > bParam6) && bVar3 > bParam7)
	{
		...
		if ((func_498() && !is_entity_dead(iVar1)) && _is_draft_vehicle(iVar1))
		{
			iVar4 = 0;
			while (iVar4 < 6)
			{
	...
	if (bParam4)
	{
		if (bVar3 <= bParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_160(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_160(iParam0, -828834893))
			{
...
void func_332(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_159(Global_1360165[iParam0], 0);
	...
	if (bParam3)
	{
		...
		func_517(iParam0, 1056964608, -1, 1061158912);
	...
	if (!func_526(uParam0->f_2, 1))
	{
		if (func_468(uParam0))
		{
			if (_is_anim_scene_metadata_loaded(uParam0->f_1, false))
			{
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_530())
				{
...
void func_371(struct<4> Param0)
{
	...
	if (func_538(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_538(20))
			{
				return;
			}
			iVar0++;
...
void func_398()
{
	...
	if (func_412(iVar0))
	{
		...
		{
			func_550(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_409(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_554(Global_35) && is_player_teleport_active())
	{
	}
	if (func_555(iParam0))
	{
		if (func_556(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_319(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_319(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_319(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_319(iParam5, 32), true);
	...
	else if (func_319(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_319(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_319(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
struct<5> func_427(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_559(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_562(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_562(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_563(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_430(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_572(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_572(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_574(iParam0, iParam2, iParam1, func_258() != -1);
	if (bParam4)
	{
...
void func_447(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_586(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
{
	if (get_ped_relationship_group_hash(*iParam0) != -1538724068)
	{
		set_ped_can_be_targetted(*iParam0, false);
		set_ped_config_flag(*iParam0, 278, true);
...
bool func_460(int iParam0, struct<4> Param1, int iParam5, int iParam6, int iParam7, int iParam8)
{
	if (!func_319(iLocal_34, iParam7))
	{
		...
		set_ped_config_flag(*iParam0, 504, true);
		set_blocking_of_non_temporary_events(*iParam0, true);
		if (iParam8 != 0)
		{
			_set_ped_body_component(*iParam0, iParam8);
			_update_ped_variation(*iParam0, false, true, true, true, false);
		}
		_give_weapon_to_ped_2(*iParam0, iParam6, -1, false, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
		set_ped_drops_weapons_when_dead(*iParam0, func_459(iParam6));
...
void func_463(int iParam0, int iParam1, bool bParam2)
{
	if (!bParam2)
	{
		...
		if (func_598(iParam1, &iVar0))
		{
			if (does_entity_exist(Global_1360165[iParam0]))
			{
				if (func_599(Global_1360165[iParam0], iVar0))
				{
	...
	else
	{
		...
		func_601(iParam0, Global_1360165[iParam0], 1);
	}
}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_266(iParam0, 16, 1))
			{
				...
				else if (func_159(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_159(Global_1360165[iParam0], 0))
			{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_409(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
void func_484(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_167() || !_0x6f1f0b17109309da(Global_43800, func_215(iParam0))))
	{
		if (is_ped_on_mount(iParam0))
		{
...
char* func_487(int iParam0)
{
	...
	{
		return func_618(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_619(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_511(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_630(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_512(int iParam0, int iParam1, bool bParam2)
{
	...
	func_631(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_520(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_259(iParam0);
	if (((does_entity_exist(iVar1) && func_634(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
{
	return func_436(1328661203, func_496(), -1591664384, bParam0);
}
...
{
	iVar1 = 12;
	iVar2 = func_394(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_394(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_653(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_394(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_653(&(Global_1946804->f_1497.f_1[iVar1])) || func_504(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_394(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_394(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_394(&(uParam0->f_1[iVar1])) || func_504(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_575(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_657(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_576(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_659(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_258() == -1)
	{
...
void func_601(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_599(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_599(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_599(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_599(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_599(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_599(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_599(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_599(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_599(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_599(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_599(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_599(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_599(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_599(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_599(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_599(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_599(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_599(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_599(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_599(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_599(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_599(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_599(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_599(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_599(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_599(iParam1, 1544915253))
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_455((*Global_1360165)[iParam0]->f_4.f_2) || func_311((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_612(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_550(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_550(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_628()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_695(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_695(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
char* func_629(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_696(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_639(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_159(iVar0, 0))
	{
		if (func_159(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_636(iParam0)) || func_637(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_699(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_701(iParam0);
					_0x7b204f88f6c3d287(func_702(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_702(iParam0, 0));
					func_703(iParam0);
				}
			}
			else
	...
	{
		if (func_159((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_266(iParam0, 32768, 1))
			{
		...
		while (iVar28 < 4)
		{
			...
			if (func_562(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_707(0))
				{
					...
					func_708(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_646(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_691("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_710(iParam1, 512) && func_648(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_695(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_710(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_710(iParam1, 4))) && (!func_695(Var4.f_4) || func_710(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_710(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_710(iParam1, 1048576)))
				{
...
void func_649(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_713(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_713(uParam0->f_2[iVar0], 1))
				{
					func_714(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_659(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_258() == -1)
	{
		func_718(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_719(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_665()
{
	...
	func_730(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_666()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_730(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_667()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_730(1, round((to_float(iVar8) * fVar10)), 0);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_740((*Global_1347702)[63]->f_15, 1) || func_311((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_740((*Global_1347702)[134]->f_15, 1) || func_311((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_742(747937920, 1) && !func_740((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_709(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_756(_get_weapon_clip_size(iParam0), iParam1);
...
void func_720(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_719(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
