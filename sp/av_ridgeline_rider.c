...
{
	func_34(uParam0, 10798, 10863, 11344);
}
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar1 = func_50(997958153, 1);
	func_51(uParam0, 0, "RR_HORSE", iVar1, vParam1, (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "RR_MAN", iVar0, vParam1, (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
{
	if (!has_anim_dict_loaded("AI_GESTURES@GEN_MALE@STANDING@SPEAKER"))
	{
		return 0;
	}
	return 1;
...
int func_32(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_68(&(uParam0->f_20[0]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
				func_69(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1, -1, 1);
		...
		case 1:
			if (func_72(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					task_look_at_entity(&(uParam0->f_20[1]), Global_35, -1, 0, 51, 0);
					open_sequence_task(&iVar0);
					task_stand_still(0, floor((5f * 1000f)));
					if (bLocal_15)
					{
						task_play_anim(0, "AI_GESTURES@GEN_MALE@STANDING@SPEAKER", "NEUTRAL_WAVE_FL_001", 4f, -4f, 1000, 8, 0f, false, 0, false, 0, false);
					}
					_task_move_in_traffic(0, 1f, 4, 0);
		...
		case 2:
			if (!bLocal_14)
			{
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					...
					if (get_sequence_progress(&(uParam0->f_20[1])) == iLocal_13)
					{
			...
			if ((get_sequence_progress(&(uParam0->f_20[1])) == iLocal_13 || uParam0->f_469[1]) // PointerArith)
			{
				return 1;
			}
			break;
...
float func_113(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_167(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
