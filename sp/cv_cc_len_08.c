...
bool func_72(var uParam0)
{
	...
	_request_scenario_type(-787460071, 1, 0, 0);
	return true;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_206(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_208(iParam0);
					_0x7b204f88f6c3d287(func_209(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_209(iParam0, 0));
					func_210(iParam0);
				}
			}
			else
...
void func_116(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_220(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	func_221(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_224(iParam0);
	if (((does_entity_exist(iVar1) && func_226(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_239(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_240(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_253(func_148(uParam0), func_252(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_207(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_204(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_170(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_204(uParam0->f_107[iVar0]->f_8.f_3))
			{
...
void func_188(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_204(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
...
int func_330(int iParam0, bool bParam1)
{
	...
	{
		func_230(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_218() == -1)
		{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_207(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_204(vVar0)) && !func_205(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
			...
			{
				_0x63aa2b8eb087886a(func_207(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_395(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_222(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_222(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_222(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_222(iParam5, 32), true);
	...
	else if (func_222(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_222(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_222(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_416(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_207(iParam0, 1));
				...
				case 16:
					...
					switch (iParam0)
					{
						...
						case 14:
							...
							break;
						case 4:
							if (func_322(747937920, 1) && !func_387((*Global_1347702)[1]->f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
