void __EntryFunction__()
{
	...
	Var0 = Local_12;
	Var0.f_1 = Local_12.f_11;
	Var0.f_483 = { Local_12.f_1 };
	Var0.f_486 = { Local_12.f_4 };
	Var0.f_489 = Local_12.f_7;
	Var0.f_20[0] = Local_12.f_8;
	Var0.f_453 = Local_12.f_9;
	Var0.f_500 = Local_12.f_10;
	Var0.f_503 = Local_12.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BS_BIRD_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "BS_BIRD_2", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -1f, 1f, 0f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "BS_BIRD_3", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 1f, 1f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "BS_BIRD_4", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 1f, 0f, 0f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "BS_BIRD_5", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, 0f, 0f), (-100f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 5, "BS_BIRD_6", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -2f, -1f, 0f), (-135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "BS_BIRD_7", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -2f, 0f), (-145f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 7, "BS_BIRD_8", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 1f, -2f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "BS_BIRD_9", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 2f, -1f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 9, "BS_BIRD_10", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 1f, -3f, 0f), (50f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	switch (iLocal_10)
	{
		case 0:
			...
			_0xf2cca7b68cfab2b9(904876610, vVar12, vVar6, vVar9, 9.5f, 50f, 1f, 6f);
			iLocal_10 = 1;
			break;
		case 1:
			if (does_entity_exist(&(uParam0->f_20[iLocal_11])))
			{
				if (!is_entity_dead(&(uParam0->f_20[iLocal_11])))
				{
					task_animal_unalerted(&(uParam0->f_20[iLocal_11]), -1, 0, 0, 0);
				}
			}
			iLocal_11++;
			if (iLocal_11 >= 10)
...
bool func_48(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_74(&(Global_1898164->f_1[0]));
		if (func_75(iVar0) && func_76((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_63(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_91(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_64(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_91(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_92(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
float func_83(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_90(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_88(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_109(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_109(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_109(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_89(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_91(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
