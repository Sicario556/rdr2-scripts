...
void func_18(int iParam0)
{
	...
	switch (iLocal_14)
	{
		...
		case 2:
			...
			if (func_44(iParam0))
			{
				...
				if (iParam0->f_65 <= 2)
				{
					...
					iParam0->f_6 = _create_anim_scene("script@proc@bountyhunting@lemoyneraider@lindsey_cell", 4, &cVar0, false, true);
					load_anim_scene(iParam0->f_6);
					set_anim_scene_entity(iParam0->f_6, "LINDSEY", iParam0->f_3, 0);
					iLocal_14 = 3;
				}
				else
				{
			...
			{
				iParam0->f_6 = _create_anim_scene("script@proc@bountyhunting@lemoyneraider@lindsey_cell", 4, "PBL_DIA_01", false, true);
				load_anim_scene(iParam0->f_6);
				set_anim_scene_entity(iParam0->f_6, "LINDSEY", iParam0->f_3, 0);
				iLocal_14 = 3;
			}
		...
		case 3:
			if (func_40(iParam0->f_3, 1))
			{
				set_anim_scene_bool(iParam0->f_6, "SEATED_BOOL", true, false);
				set_anim_scene_bool(iParam0->f_6, "STANDING_BOOL", true, false);
				iLocal_14 = 4;
			}
			break;
		case 4:
			...
			{
				if ((_0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_01") || _0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_03")) || _0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_04"))
				{
					if ((_0x8d81e7824b7753f7(iParam0->f_6, "dia_01", 1) || _0x8d81e7824b7753f7(iParam0->f_6, "dia_03", 1)) || _0x8d81e7824b7753f7(iParam0->f_6, "dia_04", 1))
					{
						if (get_anim_scene_bool(iParam0->f_6, "SEATED_BOOL") == 1)
						{
							set_anim_scene_bool(iParam0->f_6, "SEATED_BOOL", false, false);
						}
						if (get_anim_scene_bool(iParam0->f_6, "STANDING_BOOL") == 1)
						{
							set_anim_scene_bool(iParam0->f_6, "STANDING_BOOL", false, false);
						}
						iLocal_14 = 5;
					}
				}
		...
		case 5:
			if (_is_anim_scene_started(iParam0->f_6, false))
			{
				if ((_0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_01") || _0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_03")) || _0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_04"))
				{
					if (_0x8d81e7824b7753f7(iParam0->f_6, "seated_base", 1) || _0x8d81e7824b7753f7(iParam0->f_6, "standing_base", 1))
					{
						if (func_13(*iParam0, 4))
						{
							if (!func_13(*iParam0, 8))
...
bool func_23(int iParam0, bool bParam1)
{
	...
	if ((func_47(iParam0, 1) && !func_26(iParam0)) && func_48(iParam0))
	{
		return false;
	}
	if (!func_47(iParam0, 2))
...
{
	if (does_entity_exist(func_57(iParam0, 0)))
	{
		return get_entity_coords(func_57(iParam0, 0), false, false);
	}
	return 0f, 0f, 0f;
}
...
void func_38(int iParam0)
{
	if (iParam0->f_7 == 9)
	{
		iLocal_46 = _create_volume_box_with_custom_name(2504.735f, -1308.831f, 49.06328f, 0f, 0f, 0f, 22.43624f, 17.01578f, 3.468709f, "SD Sheriff Office");
		func_60(&uLocal_17);
		iLocal_14 = 2;
	}
	else
...
void func_39(int iParam0)
{
	if (_is_anim_scene_started(iParam0->f_6, false))
	{
		if (!_0x0df57f86fe71dbe5(iParam0->f_6, "PBL_BREAKOUT_SEATED") && !_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_SEATED"))
		{
			_0xdf7b5144e25cd3fe(iParam0->f_6, "PBL_BREAKOUT_SEATED");
		}
		if (!_0x0df57f86fe71dbe5(iParam0->f_6, "PBL_BREAKOUT_STAND") && !_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_STAND"))
		{
			_0xdf7b5144e25cd3fe(iParam0->f_6, "PBL_BREAKOUT_STAND");
		}
	}
	if (!bLocal_16)
	{
		if ((_0xf256a75210c5c0eb(iLocal_46, Global_36) && is_ped_shooting(Global_35)) || func_61(iParam0->f_3, 0, &uLocal_17, &uLocal_45, 0, 0))
		{
			bLocal_16 = true;
		}
	}
	...
	switch (iParam0->f_8)
	{
		case 0:
			if (func_63(iParam0))
			{
				...
				{
					_text_database_request(func_64(iParam0->f_7, 1));
			...
			break;
		case 1:
			if (_text_database_has_loaded(func_64(iParam0->f_7, 1)))
			{
				vVar0 = { func_65(iParam0->f_7, iParam0->f_65, 0) };
				func_66(Global_1396116, iParam0->f_3, func_64(iParam0->f_7, 0), 0);
				if (func_67())
				{
					func_66(Global_1396116, Global_35, "JOHN", 0);
				}
				else
				{
					func_66(Global_1396116, Global_35, "ARTHUR", 0);
				}
				if (func_68(iParam0->f_7, iParam0->f_65))
				{
					func_45(iParam0);
					iParam0->f_8 = 2;
				}
				else if (are_strings_equal(func_69(vVar0), ""))
				{
					iParam0->f_8 = 2;
				}
				else if (func_70(Global_1396116, vVar0, 0, -1, 0, 0))
				{
					func_45(iParam0);
					iParam0->f_8 = 2;
				}
		...
		case 2:
			if (!func_71(1))
			{
				func_72(iParam0->f_30[0], "INTERACT_GREET", " ", -163964935, 0, 0, 0, 1, 0);
				func_72(iParam0->f_30[1], "INTERACT_INSULT", " ", 648122183, 0, 0, 0, 1, 0);
				iParam0->f_66 = -1;
				iParam0->f_8 = 3;
			}
			break;
		case 3:
			if (iParam0->f_66 == -1)
			{
				iParam0->f_66 = func_73(&(iParam0->f_3), &(iParam0->f_9), 7f, &(iParam0->f_30), 0, 1, 1, 0, 2520, 0, 0, 2, -1082130432);
				if (iParam0->f_66 == 0)
				{
					func_74(iParam0->f_30[0], 0, 0);
					func_74(iParam0->f_30[1], 0, 0);
					func_73(&(iParam0->f_3), &(iParam0->f_9), 7f, &(iParam0->f_30), 0, 1, 1, 0, 2520, 0, 0, 2, -1082130432);
					func_45(iParam0);
				}
			...
			if (iParam0->f_66 == 0)
			{
				if (func_70(Global_1396116, func_65(iParam0->f_7, iParam0->f_65, 1), 0, -1, 0, 0))
				{
					iParam0->f_8 = 4;
				}
			}
			...
			{
				if (func_70(Global_1396116, func_65(iParam0->f_7, iParam0->f_65, 2), 0, -1, 0, 0))
				{
					iParam0->f_8 = 4;
				}
			}
		...
		case 4:
			if (!func_71(1))
			{
				if (iParam0->f_66 == 0)
				{
					vVar3 = { func_65(iParam0->f_7, iParam0->f_65, 3) };
					if (are_strings_equal(func_69(vVar3), ""))
					{
						if (func_75(iParam0))
						{
							iParam0->f_8 = 7;
						...
						func_76(&(iParam0->f_3));
						func_77(&(iParam0->f_30), 0, 0, 1, 0);
						iParam0->f_8 = 8;
					}
					else if (func_70(Global_1396116, vVar3, 0, -1, 0, 0))
					{
						iParam0->f_8 = 5;
					}
				}
				...
				{
					vVar6 = { func_65(iParam0->f_7, iParam0->f_65, 5) };
					if (are_strings_equal(func_69(vVar6), ""))
					{
						if (func_75(iParam0))
						{
							iParam0->f_8 = 7;
					...
					else if (func_70(Global_1396116, vVar6, 0, -1, 0, 0))
					{
						iParam0->f_8 = 5;
					}
				}
		...
		case 5:
			if (!func_71(1))
			{
				if (iParam0->f_66 == 0)
				{
					vVar9 = { func_65(iParam0->f_7, iParam0->f_65, 4) };
					if (are_strings_equal(func_69(vVar9), ""))
					{
						if (func_75(iParam0))
						{
							iParam0->f_8 = 7;
					...
					else if (func_70(Global_1396116, vVar9, 0, -1, 0, 0))
					{
						iParam0->f_8 = 6;
					}
				}
				...
				{
					vVar12 = { func_65(iParam0->f_7, iParam0->f_65, 6) };
					if (are_strings_equal(func_69(vVar12), ""))
					{
						if (func_75(iParam0))
						{
							iParam0->f_8 = 7;
					...
					else if (func_70(Global_1396116, vVar12, 0, -1, 0, 0))
					{
						iParam0->f_8 = 6;
					}
				}
		...
		case 7:
			if (func_78(iParam0))
			{
				vVar15 = { func_65(iParam0->f_7, iParam0->f_65, 7) };
				if (func_70(Global_1396116, vVar15, 0, -1, 0, 0))
				{
					iParam0->f_8 = 8;
				}
			}
...
bool func_43(int iParam0, int iParam1)
{
	...
	{
		case 1:
			func_79(iParam0->f_3, "NPE_PRIS_GREET", -1454469014, 0, 1, 0, 0, 1);
			return true;
	}
	return false;
}
...
bool func_61(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
...
void func_62(int iParam0)
{
	if (_is_anim_scene_started(iParam0->f_6, false))
	{
		if (_0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_01"))
		{
			if (_get_anim_scene_time(iParam0->f_6) > 28.9f && _get_anim_scene_time(iParam0->f_6) < 48f)
			{
				if (_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_STAND") && !_0x1f0e401031e20146(iParam0->f_6, "PBL_BREAKOUT_STAND"))
				{
					set_anim_scene_bool(iParam0->f_6, "STANDING_BOOL", true, false);
					_set_anim_scene_playback_list_bool(iParam0->f_6, "PBL_BREAKOUT_STAND", true);
					iLocal_14 = 7;
				}
			}
			else if (_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_SEATED"))
			{
				if (!_0x1f0e401031e20146(iParam0->f_6, "PBL_BREAKOUT_SEATED"))
				{
					set_anim_scene_bool(iParam0->f_6, "SEATED_BOOL", true, false);
					_set_anim_scene_playback_list_bool(iParam0->f_6, "PBL_BREAKOUT_SEATED", true);
					iLocal_14 = 7;
				}
			}
		}
		else if (_0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_03"))
		{
			if (_get_anim_scene_time(iParam0->f_6) > 13.67f && _get_anim_scene_time(iParam0->f_6) < 19.7f)
			{
				if (_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_STAND") && !_0x1f0e401031e20146(iParam0->f_6, "PBL_BREAKOUT_STAND"))
				{
					set_anim_scene_bool(iParam0->f_6, "STANDING_BOOL", true, false);
		...
		else if (_0x1f0e401031e20146(iParam0->f_6, "PBL_DIA_04"))
		{
			if (_0x23e33cb9f4a3f547(iParam0->f_6, "PBL_BREAKOUT_SEATED"))
			{
				set_anim_scene_bool(iParam0->f_6, "SEATED_BOOL", true, false);
				_set_anim_scene_playback_list_bool(iParam0->f_6, "PBL_BREAKOUT_SEATED", true);
				iLocal_14 = 7;
...
Vector3 func_65(int iParam0, int iParam1, int iParam2)
{
	sVar0 = "";
	switch (iParam0)
	{
...
void func_66(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
...
var func_69(var uParam0, var uParam1, var uParam2)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}

bool func_70(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_72(int* iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8)
{
	iParam0->f_5 = sParam1;
	iParam0->f_7 = iParam3;
	iParam0->f_8 = iParam6;
...
bool func_79(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Var0.f_5 = 1;
	Var0.f_6 = 1;
	Var0 = sParam1;
