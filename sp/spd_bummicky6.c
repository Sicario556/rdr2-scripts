	...
	while (true)
	{
		...
		switch (Local_14)
		{
			case 0:
				...
				if (_does_anim_scene_exist(Local_14.f_245) && func_15(Local_14.f_253, 32768))
				{
			...
			case 1:
				...
				if ((((((_is_anim_scene_loaded(Local_14.f_245, true, false) && _is_anim_scene_loaded(Local_14.f_246, true, false)) && has_anim_dict_loaded(func_33())) && _text_database_has_loaded("SPBM")) && _text_database_has_loaded("SPCWVAU")) && has_model_loaded(iVar518)) && _0x5c16855277819bbf() == 1)
				{
					func_20(&Local_14, 2);
				}
				break;
			...
			case 35:
				...
				if (((_does_volume_exist(Local_14.f_229) && _does_volume_exist(Local_14.f_226)) && !is_entity_dead(Global_35)) && !is_entity_dead(&(Local_14.f_218[0])))
				{
					if ((is_entity_in_volume(Global_35, Local_14.f_229, true, 0) && func_15(Local_14.f_253, 8192)) && !is_scripted_speech_playing(&(Local_14.f_218[0])))
					{
						func_20(&Local_14, 36);
					}
			...
			case 37:
				...
				if (_is_anim_scene_finished(Local_14.f_246, false) && func_15(Local_14.f_253, 8192))
				{
					func_77(Local_14.f_317[1], 0, 0);
					func_103(Local_14.f_317[1], 1);
					func_14(&Local_14, 0, 14, 1, 1, 0, 0);
					func_105(&Local_14, func_104(2, 0, 0), 1);
					reset_anim_scene(Local_14.f_246, func_106());
					set_anim_scene_entity(Local_14.f_246, "CS_MICKEY", &(Local_14.f_218[0]), 0);
					set_anim_scene_entity(Local_14.f_246, "ARTHUR", Global_35, 0);
					func_20(&Local_14, 51);
				}
			...
			case 57:
				if (!func_15(Local_14.f_253, 128))
				{
					...
					{
						func_119(19, 6);
						Global_40.f_11623[19]->f_3 = func_120();
...
{
	if ((func_133(19, &(iParam0->f_218[0]), 1, 1) && (*iParam0 > 2 && *iParam0 < 67)) || (get_interior_from_entity(Global_35) != 0 && (*iParam0 > 2 && *iParam0 < 67)))
	{
		if (*iParam0 > 30)
		{
	...
	{
		func_127(&(iParam0->f_253), 16777216);
	}
}
...
int func_3(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, float fParam6, bool bParam7)
{
	...
	{
		if (!func_138(Global_40.f_11623[iParam0]->f_2))
		{
			func_139(iParam0);
			*uParam4 = 1;
			func_74(uParam3);
...
void func_4(var uParam0)
{
	...
	{
		uParam0->f_239 = get_distance_between_coords(get_entity_coords(&(uParam0->f_218[0]), true, false), func_141(get_player_index()), false);
...
void func_8(int iParam0, int iParam1)
{
	if ((get_frame_count() % 30) == 0)
	{
		...
		else if (!is_entity_in_volume(Global_35, func_147(76), true, 0))
		{
...
bool func_11(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_155(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_14(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_182(iParam0->f_317[iParam1], Var0);
	func_77(iParam0->f_317[iParam1], bParam3, 0);
	func_103(iParam0->f_317[iParam1], bParam6);
	if (bParam4)
	{
		func_136(&(iParam0->f_145), 0f);
	}
	else if (bParam5)
	{
		fVar2 = func_125(&(iParam0->f_145));
		fVar2 = (fVar2 - 5f);
		if (fVar2 <= 0f)
		{
			fVar2 = 0f;
		}
		func_136(&(iParam0->f_145), fVar2);
	}
}
...
bool func_63(var uParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	if (!does_entity_exist(*uParam0))
	{
		...
		if (!bParam7)
		{
			*uParam0 = func_209(iParam1, vParam2, iParam5, 0, 1, bParam6, 1, 1, 1, 0, 0, 0, 0);
		}
		else
		{
			*uParam0 = func_209(iParam1, vParam2, iParam5, 0, 1, bParam6, 1, 1, bParam8, 1, 1, 0, 0);
		}
		return false;
	}
	if (!does_entity_exist(*uParam0))
...
bool func_76(int iParam0, var uParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	{
		func_127(&(iParam0->f_253), 2097152);
		func_127(&(iParam0->f_253), 4194304);
		func_127(&(iParam0->f_253), 8388608);
	}
	...
	else
	{
		...
		else if (bVar3)
		{
			...
			{
				if (func_216(uParam1, iParam0->f_236))
				{
...
void func_111(var uParam0, bool bParam1)
{
	if (*uParam0 > -1 && *uParam0 < 4)
	{
		if (*Global_1955500)[*uParam0]->f_3 == get_id_of_this_thread()
		{
			...
			if (bParam1)
			{
				func_227((*Global_1955500)[*uParam0]->f_1);
			}
...
void func_114(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_117(int iParam0, int iParam1, char* sParam2, float fParam3)
{
...
bool func_124(int iParam0, var uParam1, int iParam2)
{
...
void func_129(int iParam0)
{
	...
	if (func_15(iParam0->f_253, 536870912) && !func_15(iParam0->f_253, 1073741824))
	{
		...
		if (func_9(&(iParam0->f_218[0]), 0))
		{
			func_123(&(iParam0->f_218[0]), 1);
		}
		func_12(&(iParam0->f_253), 1073741824);
	}
	func_111(&(iParam0->f_233), 1);
	func_14(iParam0, 0, 0, 0, 0, 0, 0);
	func_14(iParam0, 1, 1, 0, 0, 0, 0);
	func_131(&(iParam0->f_232));
	if (func_38(func_37(19, 0, 9, func_36(19))))
	{
		func_238(func_37(19, 0, 9, func_36(19)), iParam0->f_244);
		func_239(func_37(19, 0, 9, func_36(19)), iParam0->f_255);
	}
	if (func_9(&(iParam0->f_218[0]), 0))
	{
...
bool func_133(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (bParam3)
	{
		if (func_244())
...
int func_140(var uParam0)
{
	...
	return (func_169() - round((uParam0->f_1 * 1000f)));
}
...
bool func_145(int iParam0, int iParam1, var uParam2, var uParam3)
{
...
bool func_156(var uParam0, float fParam1)
{
	if (uParam0->f_8 <= 0)
	{
		return true;
...
bool func_159(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_209(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
...
bool func_216(var uParam0, char* sParam1)
{
		...
		if (func_402(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_403(iParam12, (*uParam4)[iVar0]->f_6))
				{
					...
					{
						func_183(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
