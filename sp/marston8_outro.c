...
{
	return _is_anim_scene_loaded(uParam0->f_2, true, false);
}
...
void func_19(var uParam0)
{
	if (!_does_anim_scene_exist(uParam0->f_2))
	{
		uParam0->f_2 = _create_anim_scene("script@timelapse@mar8_timelapse", 2, 0, false, true);
...
{
	if (!_is_anim_scene_started(uParam0->f_2, false) && !_is_anim_scene_finished(uParam0->f_2, false))
	{
...
bool func_23(var uParam0)
{
	...
	{
		if (_get_anim_scene_time(uParam0->f_2) >= _get_anim_scene_duration(uParam0->f_2))
		{
...
void func_27(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_49(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_28(iParam0, 1, 0);
		}
	}
...
void func_28(int iParam0, int iParam1, bool bParam2)
{
	...
	func_50(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_53(iParam0), 137, true);
	}
}
...
void func_37(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_53(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_53(iParam0), 204, false);
	}
}
...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_53(iParam0);
	if (((does_entity_exist(iVar1) && func_55(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_54(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_53(iParam0)))
		{
...
int func_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_66(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_68(iParam0);
					_0x7b204f88f6c3d287(func_69(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_69(iParam0, 0));
					func_70(iParam0);
				}
			}
			else
...
int func_67(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_77(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_69(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_78(iParam0);
	}
