...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_53(uParam0, 0, "BARBER", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_53(uParam0, 1, "CUSTOMER", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
...
int func_18(var uParam0)
{
	...
	{
		if (!is_entity_dead(func_55(iLocal_38)))
		{
			uParam0->f_20[0] = func_56(iLocal_38, 0, 0, 1, 1, 1);
		}
		else
		{
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (func_73(&(uParam0->f_20[iVar1]), 0, &uLocal_9, &uVar0, 0, 0))
				{
					func_74(uParam0);
					if (!&uParam0->f_469[2])
					{
				...
				if (!&uParam0->f_469[1])
				{
					...
					{
						func_74(uParam0);
						set_anim_scene_bool(uParam0->f_3.f_1, "Base_Loop", true, false);
						uParam0->f_469[1] = 1;
					}
				}
				if (&uParam0->f_469[1])
				...
				if (&uParam0->f_469[1])
				{
					if (does_entity_exist(&(uParam0->f_20[0])))
					{
						if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
						{
							...
							_task_use_nearest_scenario_to_coord(&(uParam0->f_20[0]), -306.483f, 814.287f, 117.984f, 1f, 65000, false, true, false, false);
					...
					if (does_entity_exist(&(uParam0->f_20[1])))
					{
						if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
						{
							...
							task_follow_nav_mesh_to_coord(0, -308.2f, 801.8f, 119f, 1f, -1, 0.25f, 1, 40000f);
							task_wander_standard(0, 40000f, 0);
							close_sequence_task(iVar2);
							task_perform_sequence(&(uParam0->f_20[1]), iVar2);
...
int func_55(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_101(iParam0), 0);
}
...
int func_56(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_78(iParam0)) && !is_entity_dead(iVar0))
	{
...
bool func_58(int iParam0, int iParam1)
{
	...
	return func_62(Global_1914319->f_3[iParam0]->f_8, iParam1);
}
...
void func_59(int iParam0, int iParam1)
{
	...
	func_108(&(Global_1914319->f_3[iParam0]->f_8), iParam1);
}
...
bool func_60(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_110(&(Global_1898164->f_1[0]));
		if (func_111(iVar0) && func_112((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_113(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_73(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_128(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_159(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_159(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_160(&(uParam0->f_490)))
							{
...
bool func_84(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_173(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_85(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_174(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_105(int iParam0, bool bParam1)
{
	...
	{
		func_181(iParam0, _create_persistent_character(func_99(iParam0)));
		if (func_94() == -1)
		{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_192(1) || *uParam0 & 8192 != 0))
				{
...
bool func_126(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_205(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_203(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_204(uParam2)
				{
					func_199(uParam2, 1);
					return true;
				}
...
bool func_127(int iParam0, var uParam1)
{
	...
	if (func_195(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_204(uParam1)
		{
...
void func_154(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_201(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_247(iVar0, 0)))
		{
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_247(iVar0, 0)))
		{
			if (func_249(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_227(int iParam0)
{
	...
	return func_255((*Global_1347702)[58]->f_15, 1);
}
...
bool func_248(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_249(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
