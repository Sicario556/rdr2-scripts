void __EntryFunction__()
{
	...
	Var0 = Local_64;
	Var0.f_1 = Local_64.f_11;
	Var0.f_483 = { Local_64.f_1 };
	Var0.f_486 = { Local_64.f_4 };
	Var0.f_489 = Local_64.f_7;
	Var0.f_20[0] = Local_64.f_8;
	Var0.f_453 = Local_64.f_9;
	Var0.f_500 = Local_64.f_10;
	Var0.f_503 = Local_64.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 11022, 11535, 11901);
}
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	if (!is_thread_active(Global_1914319->f_3[3]->f_18, false))
	{
		uParam0->f_499 = 1;
		return;
	}
...
bool func_28(var uParam0)
{
	...
	switch (iLocal_10)
	{
		case 3:
			if (bLocal_9)
			{
				if (is_entity_dead(iLocal_57))
				{
					iLocal_57 = create_object(iLocal_49, uParam0->f_483, true, true, false, false, true);
					return false;
				}
			}
			if (is_entity_dead(iLocal_56))
			{
				iLocal_56 = create_object(iLocal_49, uParam0->f_483, true, true, false, false, true);
				return false;
			}
			iLocal_10 = 4;
			break;
		case 4:
			if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
			{
				...
				{
					clear_ped_tasks_immediately(&(uParam0->f_20[0]), false, true);
					set_anim_scene_entity(uParam0->f_3.f_1, "MALE_SKELETON", &(uParam0->f_20[0]), 0);
				}
				if (!is_entity_dead(iLocal_56))
				{
					set_anim_scene_entity(uParam0->f_3.f_1, "p_can01x", iLocal_56, 0);
				}
				if (!is_entity_dead(iLocal_57))
				{
					set_anim_scene_entity(uParam0->f_3.f_1, "p_can03x", iLocal_57, 0);
				}
				func_57(&uLocal_61, 0);
				return true;
			}
...
int func_30(var uParam0)
{
	...
	if (iLocal_10 == 0)
	{
		if (func_58(uParam0->f_20[0], uParam0->f_483))
		{
			func_59();
			iLocal_10 = 1;
		}
	...
	iVar0 = func_38(&(uParam0->f_20[0]), vLocal_50, 0.5f);
	if (*uParam0 == 16)
	{
		if (iVar0 == 1 || iVar0 == 0)
		{
	...
	if (is_string_null_or_empty(sLocal_53))
	{
		uParam0->f_499 = 1;
		return 0;
	}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		...
		{
			func_71(uParam0);
			set_anim_scene_bool(uParam0->f_3.f_1, "b_breakout", true, false);
			uParam0->f_469[1] = 1;
		}
	}
	if (&uParam0->f_469[1])
	{
		...
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, "MALE_SKELETON"))
			{
				task_persistent_character(&(uParam0->f_20[0]));
...
int func_32(var uParam0, var uParam1)
{
	...
	if (is_itemset_valid(iLocal_60))
	{
		destroy_itemset(iLocal_60);
	}
...
bool func_47(int iParam0, int iParam1)
{
	...
	{
		if (func_98(Global_1914319->f_3[iParam0]->f_21))
		{
			if (!func_99(Global_1914319->f_3[iParam0]->f_21, 0))
			{
				return false;
			}
		}
...
{
	if (_get_anim_scene_entity_matrix(uParam0->f_3.f_1, "p_can01x", &Var0, false, 0, 2))
	{
		if (!_does_volume_exist(iLocal_54))
		{
			iLocal_54 = _create_volume_sphere(Var0.f_6, 0f, 0f, 0f, 0.3f, 0.4f, 0.3f);
			iLocal_60 = create_itemset(false);
			return false;
		}
...
bool func_49(var uParam0)
{
	...
	iVar0 = get_indexed_item_in_itemset(iLocal_59, iLocal_60);
...
bool func_58(var uParam0, vector3 vParam1)
{
	...
	{
		if (is_entity_dead(*uParam0) || !does_entity_exist(*uParam0))
		{
			return false;
		}
		...
		*uParam0 = func_113(iLocal_40, 0, 0, 0, 1, 1);
		...
		iLocal_55 = _get_scenario_point_ped_is_using(*uParam0, false);
		if (!_does_scenario_point_exist(iLocal_55))
		{
			vLocal_50 = { get_entity_coords(*uParam0, true, false) };
		}
		else
		{
			vLocal_50 = { _get_scenario_point_coords(iLocal_55, true) };
		}
		return true;
	}
	return false;
...
bool func_70(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_123(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_133(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_75(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	if ((get_frame_count() % 8) == 0)
	{
		fParam2 = func_131(fParam2);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_133(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_107(&(uParam0->f_490)))
							{
...
bool func_81(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_147(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_82(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return func_52(Global_1914319->f_3[iParam0]->f_5, iParam1);
}
...
bool func_99(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_160(iParam0)))
	{
		return false;
	}
...
{
	iLocal_58 = _0x886171a12f400b89(iParam0, iLocal_60, 3);
	if (iLocal_58 > 0)
	{
		iVar1 = 0;
		while (iVar1 < iLocal_58)
		{
			iVar0 = get_indexed_item_in_itemset(iVar1, iLocal_60);
			if (_does_item_have_valid_base(iVar0))
			{
				_0x553d67295ddd2309(iVar0);
			}
			iVar1++;
		}
		return true;
...
int func_113(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_123(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
...
void func_125(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_206(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_206(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_206(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_126(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_133(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_207(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
{
	if (!_does_volume_exist(Global_1914319->f_3[iParam3]->f_25))
	{
		return false;
	}
	return _0xf256a75210c5c0eb(Global_1914319->f_3[iParam3]->f_25, vParam0);
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_223(1) || *uParam0 & 8192 != 0))
				{
...
bool func_180(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_236(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_234(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_235(uParam2)
				{
					func_230(uParam2, 1);
					return true;
				}
...
bool func_181(int iParam0, var uParam1)
{
	...
	if (func_226(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_235(uParam1)
		{
...
bool func_219(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_156() != -1;
	switch (iParam0)
	{
...
int func_220(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_143(iVar2) != 0 && _0x800df3fc913355f3(func_145(iVar2)))
		{
...
bool func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_249(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_269(iVar0, 0)))
		{
...
bool func_234(var uParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_236(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_269(iVar0, 0)))
		{
			if (func_271(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_241(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_244(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_245(var uParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_274(iParam1))
	{
...
float func_249(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_250(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_255(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_249(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_256(int iParam0, var uParam1, bool bParam2)
{
...
int func_258(int iParam0)
{
	...
	return func_277((*Global_1347702)[58]->f_15, 1);
}
...
bool func_266(bool bParam0, int iParam1, int iParam2)
{
...
bool func_270(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_271(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_271(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
