...
bool func_20()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(Local_15[iVar0]), 0, 0))
		{
			func_125(iVar0);
			func_126(iVar0);
			set_ped_hearing_range(&(Local_15[iVar0]), 20f);
			if (func_127(iVar0))
			{
...
void func_49()
{
	...
	if (_does_volume_exist(&(Local_274.f_25[3])))
	{
		_0x2c87c3e1c7b96ee2(&(Local_274.f_25[3]));
	}
	if (_does_volume_exist(&(Local_274.f_25[4])))
	{
		_0x2c87c3e1c7b96ee2(&(Local_274.f_25[4]));
	}
}
...
bool func_83()
{
	...
	*vVar0[2] = { func_84(Local_15.f_151, 2, Local_15.f_221) };
...
void func_126(int iParam0)
{
	...
	func_264(&(Local_15[iParam0]), -618550132, -1, 0, 0, 1056964608, 1065353216, 0);
...
bool func_135()
{
	...
	if (has_entity_been_damaged_by_entity(&(Local_15.f_40[Local_274.f_32]), Global_35, 1, 1))
	{
		return true;
	}
...
bool func_139()
{
	...
	if (_does_volume_exist(&(Local_274.f_25[1])))
	{
		if (_0xf256a75210c5c0eb(&(Local_274.f_25[1]), Global_36))
		{
	...
	switch (Local_274.f_6)
	{
		...
		case 2:
			if (func_275(-5f, 1, 0, 0))
			{
				...
				uVar5[1] = Global_35;
				iVar8 = func_276(&uVar1, &uVar5, 3, get_entity_coords(&(Local_15[iVar0]), false, true), 15f, 0, 1, 1, -1, 1, 0, -1082130432, 0, 0);
				iVar9 = 0;
				while (iVar9 < iVar8)
				{
...
void func_144(int iParam0, bool bParam1)
{
	...
	{
		if (!func_281(&(iParam0->f_182), 256))
		{
			if (func_281(&(iParam0->f_182), 64))
			{
				if (is_control_pressed(0, -513041747))
				{
					func_40(&(iParam0->f_182.f_10), 0);
					if (func_282(&(iParam0->f_182.f_10)))
					{
	...
	{
		if (bVar1 && (func_286(&(iParam0->f_182[3])) || func_281(&(iParam0->f_182), 16)))
		{
			if (func_281(&(iParam0->f_182), 32))
			{
				if (func_287(iParam0))
				{
			...
			if (!func_281(&(iParam0->f_182), 1))
			{
				set_player_control(player_id(), false, 0, false);
				func_284(&(iParam0->f_182), 1);
			}
		}
		else if (bVar1 && func_286(&(iParam0->f_182[2])))
		{
			if (func_287(iParam0))
			{
				if (does_entity_exist(iVar0) && !is_entity_dead(iVar0))
		...
		else if (bVar1 && func_286(&(iParam0->f_182[1])))
		{
			if (func_287(iParam0))
			{
				if (does_entity_exist(iVar0) && !is_entity_dead(iVar0))
		...
		else if (func_286(&(iParam0->f_182[0])))
		{
			if (!func_281(&(iParam0->f_182), 64))
			{
				func_284(&(iParam0->f_182), 64);
			}
			if (func_287(iParam0))
			{
				if (does_entity_exist(iVar0) && !is_entity_dead(iVar0))
	...
	if (bVar1 && iParam0->f_182.f_17 & 1 != 0)
	{
		if (!func_281(&(iParam0->f_182), 2))
		{
			...
			else
			{
				...
				{
					bVar4 = func_288(Global_35, &(iParam0->f_182.f_26), 1, 0, 256, 0);
				}
				else
				{
					bVar4 = func_289(Global_35, &(iParam0->f_182.f_6), iParam0->f_182.f_5, 0, 0, 1084227584, 100, 0, 0);
				}
				if (bVar4)
				{
		...
		else if (!func_281(&(iParam0->f_182), 4))
		{
...
void func_147()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(Local_15[iVar0]), 0, 1))
		{
			...
			{
				if (is_ped_shooting(&(Local_15[iVar0])) || func_217(&(Local_15[iVar0]), 40f, 12f, &(Local_15.f_9[iVar0]), -1082130432))
				{
					func_270(&Local_15, iVar0, 831283580, 0);
				}
			}
...
bool func_148()
{
	...
	switch (Local_274.f_7)
	{
		...
		case 3:
			...
			break;
		case 4:
			if ((func_47(Local_274.f_9[1], 2f) && func_134(&Local_274, 256)) && func_275(0f, 1, Local_274.f_38, 1))
			{
				iVar4 = -1;
...
void func_156(int iParam0)
{
	...
	while (iVar2 < iParam0->f_215)
	{
		if (func_61(iParam0[iVar2], 0, 0))
		{
			...
			func_310(iParam0[iVar2], &iVar0);
			func_311(iParam0[iVar2], (iVar0 + iVar1));
		}
		iVar2++;
	}
	switch (iParam0->f_181)
...
void func_165(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam3 == -1)
	{
...
int func_167()
{
	...
	{
		case 0:
			if (func_275(0, 1, 0, 0) && func_47(Local_274.f_9[0], 6f))
			{
		...
		if (func_47(uParam2, fParam4))
		{
			if (func_61(iParam0[*uParam1], 0, 1))
			{
				if (func_320(iParam0, *uParam1))
				{
					...
					func_321(iParam0[*uParam1], 0, 1);
					func_322(iParam0[*uParam1], Global_35, sParam3, 0, 100f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					return true;
				}
			}
			else
...
void func_169()
{
	if (func_61(Local_15.f_56, 0, 0))
	{
		set_entity_can_be_damaged_by_relationship_group(Local_15.f_56, true, func_323(Local_15.f_181));
	}
}
...
void func_179(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_337(Global_1310750[iVar0], iParam0))
		{
			if (!func_338(iVar0))
			{
				iVar1 = 1;
...
int func_190(int iParam0, int iParam1, float fParam2)
{
	iVar0 = 0;
	while (iVar0 <= (iParam0->f_215 - 1))
	{
		...
		else
		{
			...
			bVar1 = false;
			if (func_344(iParam0, iParam0[iVar0]) || !func_132(iParam0, iVar0, 8))
			{
				if ((func_318(iParam0, iVar0) && !func_344(iParam0, &(iParam0->f_40[iVar0]))) && !func_345(iParam0, iVar5))
				{
					bVar1 = true;
				}
			}
			...
			else
			{
				...
				if (func_347(func_346(iParam0[iVar0], 0)))
				{
				...
				if (func_61(&(iParam0->f_40[iVar0]), 0, 0))
				{
					...
					_task_move_in_traffic_2(0, func_348(iParam1, 1), 40f, fParam2, 0, 0);
				}
				else if (iVar5 == 0)
				{
					if (!func_69(vVar7))
					...
					_task_move_in_traffic_2(0, func_348(iParam1, 1), 40f, fParam2, 128, 0);
				}
				else if (_0x4e76cb57222a00e5(iParam0[iVar0]) == -1)
				{
					...
					_task_move_in_traffic_2(0, func_348(iParam1, 1), 40f, -1f, 0, 0);
				}
				func_195(iParam0[iVar0], &iVar3, 0f, 1.2f, 1, 1);
				if (!bVar2)
				{
					func_349(&uVar4, 0, 0, 1);
					func_350((*iParam0)[iVar0], &uVar4, 1, 1, 1, 1, 0);
					bVar2 = true;
				}
				else
				{
					func_350((*iParam0)[iVar0], &uVar4, 0, 1, 1, 1, 0);
				}
				set_ped_keep_task(iParam0[iVar0], true);
			}
		}
...
void func_203(int iParam0, float fParam1)
{
	...
	func_365(iParam0->f_209, fParam1, 5);
	func_366(iParam0);
}
...
int func_238(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (iVar0 <= iParam7)
	{
		...
		else if (!bParam5 || !func_69(*(*uParam0)[iVar0]))
		{
...
void func_242()
{
	...
	if (_does_volume_exist(&(Local_274.f_25[3])))
	{
		_0x19c7567d2f2287d6(&(Local_274.f_25[3]), 7);
	}
	if (_does_volume_exist(&(Local_274.f_25[4])))
	{
		_0x19c7567d2f2287d6(&(Local_274.f_25[4]), 7);
	}
}
...
void func_248(int iParam0, float fParam1)
{
	...
	{
		func_379(&(iParam0->f_237), iParam0->f_209, iParam0->f_151);
	}
	func_380(iParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432);
	vVar0 = { iParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { iParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_363(vVar0, vVar3, 0) };
	vVar9 = { func_364(vVar0, vVar3, 0) };
	if (func_381(iParam0->f_151))
	{
		iVar12 = func_382(iParam0);
		func_383(iParam0->f_209, fParam1, 0, 0, iVar12);
	}
	set_ped_non_creation_area(vVar6, vVar9);
	set_ped_paths_in_area(vVar6, vVar9, false, 1);
	stop_fire_in_range(iParam0->f_209, fParam1);
	func_384(iParam0->f_209, fParam1, 0);
}
...
{
	iVar0 = 0;
	iVar0 = func_398(iParam0->f_181, iParam2, bParam3);
	if (iVar0 != 0)
	{
...
bool func_267(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_400(iParam0[*uParam3], 0, iParam1, uParam2, 0, 0))
		{
			return true;
		}
		*uParam3++;
...
bool func_271(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_403(iParam0[*uParam3], iParam1, uParam2, 0))
		{
			return true;
		}
		*uParam3++;
...
{
	if (func_322(iParam1, iParam2, sParam3, "", fParam4, iParam7, 0, 1, 1, fParam4 >= 0f, bParam5, iParam6, 1, 0, 0))
	{
...
bool func_275(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
int func_276(var uParam0, int iParam1, int iParam2, vector3 vParam3, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	if (fParam13 <= 0f)
	{
	...
	iVar1 = func_406(uParam0, iParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_407(iVar0);
	return iVar1;
}
...
int func_288(int iParam0, var uParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!is_entity_dead(iParam0))
	{
...
int func_289(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	if (!does_entity_exist(iParam0))
	{
		return 0;
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_178(iParam2, 1024))) || func_178(iParam2, 8)) && !func_368(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_419(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_178(iParam2, 4096)) && !func_368(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_419(uParam1, 2048);
			func_419(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_178(iParam2, 32)) && !func_368(*uParam1, 5632))
		{
	...
	while (iVar5 <= 1)
	{
		...
		else
		{
			...
			if (fVar8 > 0f)
			{
				...
				{
					set_ped_combat_attributes(&(Local_15[iVar5]), 51, true);
				}
			}
			_set_ped_crouch_movement(&(Local_15[iVar5]), false, 0, false);
			open_sequence_task(&iVar0);
			task_set_sphere_defensive_area(0, get_entity_coords(&(Local_15[iVar5]), true, true), 1f);
			task_combat_ped_timed(0, Global_35, iVar7, 0);
			if (fVar8 > 0f)
			{
				task_set_sphere_defensive_area(0, vVar1, fVar8);
			}
			task_combat_ped(0, Global_35, 0, 0);
...
int func_300(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	while (iVar2 <= iParam2)
	{
		if (func_61(iParam0[iVar2], 0, 0))
		{
			...
			if (fVar1 < fVar0 && (!bParam3 || func_275(0f, 1, iParam0[iVar2], 1)))
			{
				fVar0 = fVar1;
				iVar3 = iVar2;
			}
...
void func_306(int iParam0)
{
	...
	if (!func_302(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
bool func_320(int iParam0, int iParam1)
{
	...
	fVar1 = get_distance_between_coords(func_290(iParam0[iParam1], 1065353216), func_290(Global_35, 1065353216), true);
	if (fVar0 < 10f)
	{
		return false;
	}
...
bool func_322(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_432(iParam0, iParam1, sParam2, sParam3, fParam4, iParam5, bParam6, bParam7, iParam8, bParam9, bParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
void func_341(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_342(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
{
	if (is_entity_on_screen(iParam0) && func_445(Global_35, iParam0, 0, fParam1, 0))
	{
		return true;
	}
	return false;
...
float func_362(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && is_entity_dead(iParam0))
	{
		return -1f;
...
{
	iParam0->f_238 = _create_volume_cylinder_with_custom_name(-3841.555f, -2964.077f, -17.3505f, 0f, 0f, 0f, 100f, 100f, 40f, "volAvoidance");
	if (func_134(iParam1, 1))
	{
		iParam1->f_25[2] = _create_volume_cylinder_with_custom_name(-3850.681f, -2933.947f, -5f, 0f, 0f, 0f, 50f, 50f, 20f, "volTrigger");
		iParam1->f_25[1] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -3850.681f, -2986.303f, -5f, 0f, 0f, 13.86233f, 44.82002f, 75f, 20f);
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -3850.681f, -2986.303f, -5f, 0f, 0f, -28.27146f, 44.82002f, 75f, 20f);
		iParam1->f_25[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2233.576f, 1584.006f, 108.394f, 0f, 0f, -68.90441f, 178.4207f, 310.3206f, 194.8402f);
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2456.139f, 1875.907f, 128.7063f, 0f, 0f, -11.02788f, 178.4207f, 446.6826f, 158.0314f);
		iParam0->f_182[0] = _create_volume_cylinder_with_custom_name(-3850.681f, -2933.947f, -15f, 0f, 0f, 0f, 96f, 96f, 20f, "volSlow");
		iParam0->f_182[1] = _create_volume_cylinder_with_custom_name(-3850.681f, -2933.947f, -8f, 0f, 0f, 0f, 75f, 75f, 30f, "volSlower");
		iParam0->f_182[2] = _create_volume_cylinder_with_custom_name(-3850.681f, -2933.947f, 0f, 0f, 0f, 0f, 55f, 55f, 40f, "volSlowest");
	}
	else if (func_134(iParam1, 2))
	{
		iParam1->f_25[2] = _create_volume_cylinder_with_custom_name(-3839.75f, -3086.341f, -5f, 0f, 0f, 0f, 60f, 60f, 20f, "volTrigger");
		iParam1->f_25[1] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -3841.549f, -3006.895f, -5f, 0f, 0f, -34.00759f, 37.35208f, 59.33092f, 20f);
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -3810.102f, -2974.74f, -5f, 0f, 0f, -34.0076f, 26.54462f, 32.56166f, 20f);
		iParam1->f_25[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2233.576f, 1584.006f, 108.394f, 0f, 0f, -68.90441f, 178.4207f, 310.3206f, 194.8402f);
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2456.139f, 1875.907f, 128.7063f, 0f, 0f, -11.02788f, 178.4207f, 446.6826f, 158.0314f);
		iParam0->f_182[0] = _create_volume_cylinder_with_custom_name(-3839.75f, -3086.341f, -15f, 0f, 0f, 0f, 96f, 96f, 20f, "volSlow");
		iParam0->f_182[1] = _create_volume_cylinder_with_custom_name(-3839.75f, -3086.341f, -8f, 0f, 0f, 0f, 75f, 75f, 30f, "volSlower");
		iParam0->f_182[2] = _create_volume_cylinder_with_custom_name(-3839.75f, -3086.341f, 0f, 0f, 0f, 0f, 55f, 55f, 40f, "volSlowest");
		iParam1->f_25[3] = _create_volume_box_with_custom_name(-3838.699f, -3043.845f, -6.133426f, 0f, 0f, -11f, 5.650144f, 20.05414f, 18.2278f, "volNavBlock1");
		iParam1->f_25[4] = _create_volume_box_with_custom_name(-3847.218f, -3056.331f, -6.133427f, 0f, 0f, -44f, 4.531132f, 14.98474f, 18.2278f, "volNavBlock2");
	}
	else
	{
		iParam1->f_25[2] = _create_volume_cylinder_with_custom_name(-3880.675f, -2951.745f, -5f, 0f, 0f, 39.05031f, 52f, 52f, 20f, "volTrigger");
		iParam1->f_25[1] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -3798.813f, -2928.401f, -5f, 0f, 0f, -39.61912f, 51.87413f, 99.28097f, 20f);
		iParam1->f_25[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2337.703f, 1567.208f, 108.394f, 0f, 0f, -1.675658f, 112.9127f, 225.4777f, 194.8402f);
		_0x39816f6f94f385ad(&(iParam1->f_25[0]), 2481.925f, 1712.873f, 128.7063f, 0f, 0f, -82.71819f, 108.5835f, 268.6344f, 158.0314f);
		iParam0->f_182[0] = _create_volume_cylinder_with_custom_name(-3880.675f, -2951.745f, -15f, 0f, 0f, 0f, 96f, 96f, 20f, "volSlow");
		iParam0->f_182[1] = _create_volume_cylinder_with_custom_name(-3880.675f, -2951.745f, -8f, 0f, 0f, 0f, 75f, 75f, 30f, "volSlower");
		iParam0->f_182[2] = _create_volume_cylinder_with_custom_name(-3880.675f, -2951.745f, 0f, 0f, 0f, 0f, 55f, 55f, 40f, "volSlowest");
	}
}
...
void func_377(int iParam0, int iParam1)
{
	...
	if (func_134(iParam1, 1))
	{
		iParam1->f_25[2] = _create_volume_cylinder_with_custom_name(-4132.221f, -2306.291f, 6.242087f, 0f, 0f, 0f, 50f, 50f, 20f, "volTrigger");
		iParam1->f_25[1] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -4224.361f, -2389.418f, 13.27712f, 0f, 0f, 13.86233f, 61.34361f, 66.20044f, 20f);
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -4200.079f, -2241.64f, 8.807465f, 0f, 0f, -51.43821f, 44.82002f, 75f, 20f);
		iParam0->f_182[0] = _create_volume_cylinder_with_custom_name(-4132.221f, -2306.291f, 10.27737f, 0f, 0f, 0f, 96f, 96f, 20f, "volSlow");
		iParam0->f_182[1] = _create_volume_cylinder_with_custom_name(-4132.221f, -2306.291f, 17.27737f, 0f, 0f, 0f, 75f, 75f, 30f, "volSlower");
		iParam0->f_182[2] = _create_volume_cylinder_with_custom_name(-4132.221f, -2306.291f, 25.27737f, 0f, 0f, 0f, 55f, 55f, 40f, "volSlowest");
	}
	else
	{
		iParam1->f_25[2] = _create_volume_cylinder_with_custom_name(-4205.504f, -2316.274f, 10.27737f, 0f, 0f, 0f, 50f, 50f, 20f, "volTrigger");
		iParam1->f_25[1] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -4040.657f, -2305.812f, -5f, 0f, 0f, -39.61911f, 51.87413f, 57.07259f, 20f);
		_0xbce668aaf83608be(&(iParam1->f_25[1]), -4177.187f, -2244.327f, 13.55995f, 0f, 0f, -39.61911f, 51.87413f, 57.07259f, 20f);
		iParam0->f_182[0] = _create_volume_cylinder_with_custom_name(-4205.504f, -2316.274f, 10.27737f, 0f, 0f, 0f, 96f, 96f, 20f, "volSlow");
		iParam0->f_182[1] = _create_volume_cylinder_with_custom_name(-4205.504f, -2316.274f, 17.27737f, 0f, 0f, 0f, 75f, 75f, 30f, "volSlower");
		iParam0->f_182[2] = _create_volume_cylinder_with_custom_name(-4205.504f, -2316.274f, 25.27737f, 0f, 0f, 0f, 55f, 55f, 40f, "volSlowest");
	}
}
...
int func_380(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
...
int func_397(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_454(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_455(iParam0, &iVar0, &fVar25);
...
bool func_400(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	iVar0 = get_frame_count();
	if (iVar0 > iParam2->f_5)
	{
		func_459(iParam2, 1, iVar0);
	}
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_461(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!iParam2->f_1 & 8 != 0)
			{
				...
				else if (func_463(iParam0, iParam1, iParam2))
				{
					*uParam3 = 8;
					func_461(iParam0, iParam2, *uParam3);
					return true;
		...
		{
			if (func_465(iParam2, 1065353216))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_467(Global_35, iParam0, iParam2))
					{
						*uParam3 = 256;
						func_461(iParam0, iParam2, *uParam3);
						return true;
		...
		if (!iParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_468(Global_35, iParam0, iParam2, 0))
				{
					*uParam3 = 16;
					func_461(iParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_468(Global_35, iParam0, iParam2, 1))
			{
				*uParam3 = 16;
				func_461(iParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!iParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_472(iParam0, Global_1935630->f_41, *iParam2 & 128 != 0, 0, *iParam2 & 256 != 0) && func_473(iParam2, iParam0)) && func_474(iParam2, iParam0))
					{
						*uParam3 = 2;
						func_461(iParam0, iParam2, *uParam3);
						return true;
		...
		if (!iParam2->f_1 & 2 != 0)
		{
			if (iParam2->f_12 < 4f)
			{
				if ((func_472(iParam0, Global_1935630->f_41, *iParam2 & 128 != 0, 1, *iParam2 & 256 != 0) && func_473(iParam2, iParam0)) && func_474(iParam2, iParam0))
				{
					*uParam3 = 2;
					func_461(iParam0, iParam2, *uParam3);
					return true;
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_477(iParam2, iParam0) || (iParam2->f_9 > 0 && (func_176() - iParam2->f_9) < 2000))
				{
					if (is_ped_ragdoll(iParam0))
					{
						func_476();
...
int func_401(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_446((*Global_1835011)[4]->f_1, 1))
		{
			if (func_487(5))
			{
				func_488(5);
	...
	if ((bVar0 && func_446((*Global_1835011)[37]->f_1, 1)) && !func_446((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_446((*Global_1835011)[43]->f_1, 1)) && !func_446((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
bool func_403(int iParam0, int iParam1, var uParam2, float fParam3)
{
	iVar0 = get_frame_count();
	if (iVar0 > iParam1->f_5)
	{
		func_459(iParam1, 0, iVar0);
	}
	if (fParam3 > 0f)
	{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!iParam1->f_1 & 2 != 0)
			{
				if (func_471(iParam1, 4000))
				{
					if ((func_472(iParam0, Global_1935630->f_41, *iParam1 & 128 != 0, 0, *iParam1 & 256 != 0) && func_473(iParam1, iParam0)) && func_474(iParam1, iParam0))
					{
						func_476();
						*uParam2 = 2;
						func_461(iParam0, iParam1, *uParam2);
						return true;
					}
				}
			}
		...
		if (!iParam1->f_1 & 2 != 0)
		{
			if (iParam1->f_12 < 4f)
			{
				if (func_471(iParam1, 4000))
				{
					if ((func_472(iParam0, Global_1935630->f_41, *iParam1 & 128 != 0, 1, *iParam1 & 256 != 0) && func_473(iParam1, iParam0)) && func_474(iParam1, iParam0))
					{
						func_476();
						*uParam2 = 2;
						func_461(iParam0, iParam1, *uParam2);
		...
		if (Global_1935630->f_25)
		{
			if (func_465(iParam1, 1065353216))
			{
				if (!iParam1->f_1 & 4 != 0)
				{
					if (func_466(Global_35, iParam0, iParam1))
					{
						func_476();
						*uParam2 = 4;
						func_461(iParam0, iParam1, *uParam2);
				...
				{
					if (func_467(Global_35, iParam0, iParam1))
					{
						func_476();
						*uParam2 = 256;
						func_461(iParam0, iParam1, *uParam2);
...
int func_406(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_517(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !decor_exist_on(iVar2, "bIgnoreThisPed"))
				{
...
bool func_410(int iParam0)
{
	if (func_518(50))
	{
		if (func_519(iParam0->f_209, 1, 8, 0))
		{
			return true;
		}
	}
...
bool func_411(int iParam0)
{
	if (!func_30(iParam0, 262144))
	{
		if (iParam0->f_20 < 60f)
		{
			if (func_522(iParam0, 60f, iParam0->f_239))
			{
				return true;
			}
		}
...
bool func_412(int iParam0)
{
	if (!func_30(iParam0, 524288))
	{
		if (iParam0->f_20 < 60f)
		{
			if (func_523(iParam0, 60f, iParam0->f_239))
			{
				return true;
			}
		}
...
bool func_413(int iParam0)
{
	if (!func_56(iParam0->f_151))
	{
		if (iParam0->f_20 < 60f)
		{
			if (func_524(iParam0->f_151, iParam0->f_221))
			{
				return true;
			}
		}
...
var func_431(int iParam0, int iParam1, int iParam2, int iParam3)
{
	Var0.f_1 = 10;
	Var0.f_12 = 10;
	Var0 = 1;
...
int func_432(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	iParam5 = iParam5;
	iParam1 = iParam1;
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_530(func_529(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_445(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
...
int func_447(vector3 vParam0, float fParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_552(1) || *iParam0 & 8192 != 0))
				{
...
bool func_460(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_555(iParam0, iParam1, iVar2))
			{
				return false;
			}
			if (func_556(iParam0, iVar2) <= func_557(iParam1))
			{
				return true;
			}
			break;
...
bool func_462(int iParam0, int iParam1)
{
	...
	if (!is_entity_dead(iParam0))
	{
		if (func_561(iParam0, !*iParam1 & 268435456 != 0, !*iParam1 & 536870912 != 0, !*iParam1 & 1073741824 != 0, 0, 0))
		{
			if (iParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_562(iParam1);
			if (func_563(iParam1, iParam0, fVar0, fVar1))
			{
				if (iParam1->f_2 == 0)
				{
...
bool func_463(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 85f;
	if (func_565(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		if (iParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_562(iParam2);
		if (func_563(iParam2, iParam0, fVar0, fVar1))
		{
			if (iParam2->f_2 == 0)
			{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_564(iParam2)
				{
					func_559(iParam2, 1);
					return true;
				}
...
bool func_464(int iParam0, int iParam1)
{
	...
	if (func_555(iParam0, iParam1, iVar1))
	{
		if (iParam1->f_3 == 0)
		{
			iParam1->f_3 = get_game_timer();
		}
		else if (get_game_timer() - iParam1->f_3) > func_564(iParam1)
		{
			fVar3 = func_562(iParam1);
...
{
	if (iParam2->f_12 < IntToFloat(func_567(iParam2)))
	{
...
bool func_469(int iParam0, int iParam1)
{
	...
	{
		if (!func_555(iParam0, iParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_572(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_573(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_574(iParam1, iParam0, fVar1, iVar0))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
...
int func_480(int iParam0, int iParam1, int iParam2)
{
	...
	return func_581(iParam0, iParam1, bVar0, bVar2, iParam2->f_12, bVar1);
}
...
int func_485(int iParam0, int iParam1)
{
	...
	else if (func_176() - iParam1->f_4) > func_585(iParam1)
	{
		return func_586(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_489(int iParam0)
{
	...
	func_592(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_593(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_594(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_595(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_596(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_597(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_598(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_599(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_600(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_601(_get_map_zone_at_coords(vParam0, 10));
}
...
bool func_513(int iParam0, int iParam1)
{
	...
	{
		fVar1 = -1f;
		fVar2 = func_625(_0x2ba9d7bf629f920c(iParam0), (fVar0 + 5f));
...
bool func_516(var uParam0, float fParam1)
{
...
bool func_517(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_519(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_69(vParam0))
	{
		return false;
...
int func_522(int iParam0, float fParam1, int iParam2)
{
	iVar4 = 0;
	...
	return func_630(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}

bool func_523(int iParam0, float fParam1, int iParam2)
{
	iVar16 = 0;
	...
	{
		iVar18 = func_632(&uVar0, &uVar6, 5, iParam0->f_209, fParam1);
	}
	iVar16 = 0;
	while (iVar16 < iVar18)
	{
		...
		if (iVar27 != 0 && iVar27 != Global_35)
		{
			...
			if (!func_69(vVar21))
			{
				...
				{
					if (func_367(vVar21, vVar24, 5f, 0) && is_ped_heading_towards_position(iVar27, iParam0->f_209, 40f))
					{
						iVar19 = 1;
						iVar20 = 1;
					}
...
bool func_524(var uParam0, var uParam1)
{
	...
	while (iVar0 < 27)
	{
		if (func_635(iVar0))
		{
			...
			if (fVar6 <= 10000f && fVar6 > 0f)
			{
				...
				if (func_371(get_entity_coords(iVar1, true, false), vVar2) > fVar5)
				{
...
bool func_529(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7)
{
	Var0.f_5 = 1;
	Var0.f_6 = 1;
	Var0 = sParam1;
...
void func_531(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_640(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_642(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_646((*Global_1900383)[iParam0]->f_26);
		func_647((*Global_1900383)[iParam0]->f_26);
...
{
	return func_649(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
void func_548(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_399(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_558(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_561(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
...
bool func_563(int iParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_565(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_346(iVar0, 0)))
		{
			if (func_671(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_569(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_572(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_573(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_574(int iParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_627(iParam1))
	{
...
bool func_578(int iParam0, int iParam1, vector3 vParam2)
{
...
bool func_582(int iParam0, int iParam1, bool bParam2)
{
	...
	if (does_entity_exist(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (_0x06087579e7aa85a9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (has_entity_clear_los_to_entity(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_583(iParam1, iVar0))
					{
						return true;
					}
				}
	...
	if (does_entity_exist(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_583(iParam1, iVar1))
				{
...
bool func_584(int iParam0)
{
	...
	return func_446((*Global_1347702)[58]->f_15, 1);
}
...
int func_586(int iParam0, int iParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (iParam1->f_4 == 0)
...
int func_608(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_314())
	{
		...
		{
			bVar0 = false;
			if (!func_446((*Global_1835011)[15]->f_1, 1) && !func_639(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_446((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_694();
				*iParam1 = func_695();
				*uParam2 = func_696();
...
bool func_628(int iParam0)
{
	...
	if (is_ped_group_member(iParam0, func_713(), 1))
	{
		return true;
	}
	return false;
...
int func_630(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, int iParam9)
{
	...
	while (iVar13 < iVar12)
	{
		...
		else if ((!bParam6 || get_ped_in_vehicle_seat(&(iVar0[iVar13]), -1) != 0) && (!bParam5 || get_entity_speed(&(iVar0[iVar13])) >= 1f))
		{
			...
			if (!func_69(vVar6))
			{
				...
				{
					if (func_367(vVar6, vVar9, iParam7, 0))
					{
						iVar14 = 1;
						iVar15 = 1;
					}
...
int func_631(var uParam0, int iParam1, int iParam2, int iParam3)
{
	iVar0 = create_itemset(true);
...
int func_632(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	iVar0 = _create_volume_cylinder(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	iVar1 = func_631(uParam0, iParam1, iParam2, iVar0);
	func_407(iVar0);
	return iVar1;
}
...
void func_640(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_724(func_723(255), 109029619));
	}
	else if (func_687())
	{
...
float func_645(int iParam0)
{
	...
	fVar10 = (fVar8 - fVar7);
	fVar11 = (fVar9 / fVar10);
	fVar12 = func_726(fVar3, fVar4, fVar11);
	return fVar12;
}
...
struct<4> func_653(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_544(923904168, func_651(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_544(923904168, func_651(bParam0), -740156546, 0) };
		}
...
struct<4> func_655(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_544(271701509, func_651(bParam0), 12999093, 0) };
		}
...
bool func_667(bool bParam0, int iParam1, int iParam2)
{
...
bool func_670(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_671(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_671(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_672(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (bParam3 || !is_entity_dead(iParam0))
	{
...
bool func_681(int iParam0, var uParam1)
{
	...
	Var1.f_9 = -1591664384;
	Var15 = { func_651(0) };
	if (!func_732(Var15, iVar0, &Var1, 0, 0))
	{
		return false;
	}
	if (!func_733(&Var1, uParam1))
	{
		return false;
	}
	return true;
...
bool func_683(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	{
		return func_734(Param0, Param4, iParam8, 1, bParam9, 1) != -1;
	}
	...
	if (func_735(&(Var0.f_5), &Param4) && Var0.f_9 == iParam8)
	{
		return true;
	}
	...
	if (!_0xdccaa7c3bfd88862(func_662(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_684(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	if (!func_546(bParam9))
	{
		return func_736(Param0, Param4, iParam8, 1) != -1;
	}
	if (!_0xb881ca836cc4b6d4(&Param0) || !_0xb881ca836cc4b6d4(&Param4))
	{
		return false;
	}
	if (func_735(&Param0, &Param4))
	{
		return false;
	}
	Var0.f_9 = -1591664384;
	...
	if (func_735(&(Var0.f_5), &(Var14.f_5)) && Var0.f_9 == Var14.f_9)
	{
		return false;
	}
...
bool func_685(int iParam0)
{
	...
	if (func_737(get_entity_model(iParam0)))
	{
		return true;
	}
...
{
	Var0.f_9 = -1591664384;
	if (func_740(Param0, iParam4, &Var0, iParam5))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_714(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_742(iParam1, &iVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_743(iParam0, iVar0, iVar1, bParam2);
}
...
bool func_730(struct<4> Param0, int iParam4)
{
	if (!func_546(0))
	{
		return func_747(Param0, iParam4, 1) != -1;
	}
...
bool func_732(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
...
bool func_733(var uParam0, var uParam1)
{
	if (!_0xb881ca836cc4b6d4(uParam0))
	{
		return false;
...
int func_734(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	if (!_0xb881ca836cc4b6d4(&Param0) || !_0xb881ca836cc4b6d4(&Param4))
	{
		return -1;
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar32 = func_750(1168099063, &Var16, bParam9);
	if (iVar32 == -1)
	{
		return -1;
	}
...
bool func_735(var uParam0, bool bParam1)
{
...
int func_736(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	if (!_0xb881ca836cc4b6d4(&Param0) || !_0xb881ca836cc4b6d4(&Param4))
	{
		return -1;
	...
	{
		iVar60 = func_750(1168099063, &Var28, 0);
		iVar60 = func_750(1168099063, &Var44, 0);
	}
	return iVar60;
}
...
bool func_740(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
...
bool func_742(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_315() != -1;
	switch (iParam0)
	{
...
int func_743(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_752(iVar2) != 0 && _0x800df3fc913355f3(func_753(iVar2)))
		{
			if (func_753(iVar2) == iVar0)
			{
				return iVar2;
			}
		}
...
bool func_745(int iParam0, int iParam1)
{
	...
	{
		return func_754(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
int func_747(struct<4> Param0, int iParam4, bool bParam5)
{
	iVar0 = -1;
	if (!_0xb881ca836cc4b6d4(&Param0))
	{
	...
	else
	{
		Var61 = { func_749(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_750(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_748(var uParam0, int iParam1, bool bParam2)
{
	return _0x033ee4b89f3ac545(func_662(bParam2), uParam0, iParam1);
}

struct<16> func_749(var uParam0)
{
	Var0.f_9 = 1;
