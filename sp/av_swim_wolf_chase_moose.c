...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "SWCMP_WOLF", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -18.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				uLocal_12[0] = func_63(-830507952, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[0]), &(uLocal_12[0]), 0, 0, false, true, 0, false, -1f, false);
				_set_scenario_point_flag(&(uLocal_12[0]), 20, true);
				_set_scenario_point_flag(&(uLocal_12[0]), 25, true);
				_set_scenario_point_flag(&(uLocal_12[0]), 23, true);
				set_ped_path_prefer_to_avoid_water(&(uParam0->f_20[0]), false, 1f);
				func_64(uParam0->f_20[0], 1, 1);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				_0x2e1d6d87346bb7d2(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 0, 0);
				uLocal_12[1] = func_63(-830507952, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[1]), &(uLocal_12[1]), 0, 0, false, true, 0, false, -1f, false);
				_set_scenario_point_flag(&(uLocal_12[1]), 20, true);
				func_64(uParam0->f_20[1], 1, 1);
		...
		case 1:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					...
					task_follow_nav_mesh_to_coord(0, get_offset_from_entity_in_world_coords(&(uParam0->f_20[1]), 0f, 20f, 0f), 3f, -1, 0.25f, 8193, 40000f);
					_task_smart_flee_style_ped(0, &(uParam0->f_20[0]), 3, 256, -1082130432, -1, 0);
				...
				if (!is_entity_dead(&(uParam0->f_20[0])))
				{
					func_64(uParam0->f_20[0], 1, 1);
					open_sequence_task(&iVar0);
					task_follow_to_offset_of_entity(0, &(uParam0->f_20[1]), 0f, 5f, 0f, 2f, 12000, 1036831949, 1, 1, 0, 1, 1);
					func_67(0, 1588806187, vLocal_15, uParam0->f_20[1]->f_8, 45000, 1, 0, 0, -1082130432);
					close_sequence_task(iVar0);
		...
		case 4:
			if (!bLocal_18)
			{
				if (func_69(&(uParam0->f_20[0]), Global_35, 1) < 225f)
				{
					func_64(uParam0->f_20[0], 0, 1);
					bLocal_18 = true;
				}
			}
			if (!func_70(&(uParam0->f_20[0]), 242628503))
			{
				return 1;
			}
			break;
...
Vector3 func_66(var uParam0)
{
	vVar0 = { 0f, 0f, 0f };
	fVar3 = 1E+11f;
	*vVar4[0] = { -2447.719f, -521.309f, 141.189f };
	*vVar4[1] = { 619.494f, 2197.675f, 221.987f };
	*vVar4[1] = { -1872.153f, 1824.989f, 234.83f };
	iVar11 = 0;
