...
{
	func_33(uParam0, 10732, 10776, 11734);
}
...
{
	func_46(uParam0, "OWL_CATCH_RAT", "script@ambient@animal@OWL_CATCH_RAT@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "OWL", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "RAT", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
{
	sVar0 = "script_amb@animal@OWL_CATCH_RAT";
	sVar1 = "owl_exit_a";
	sVar2 = "rat_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	if (!&uParam0->f_469[0])
	{
		...
		if (func_61(uParam0, &uLocal_11, 0) || func_62(&(uParam0->f_20[1]), Global_35, 1) < 100f)
		{
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (is_entity_on_screen(&(uParam0->f_20[iVar2])) || ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_62(&(uParam0->f_20[iVar2]), Global_35, 1) < 22500f))
				{
					return 0;
				}
			}
