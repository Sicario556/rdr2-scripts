...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1006095118, 0f, 0f, 0f, "Chair", 0, 0, 1);
	func_152(uParam0, 0.0501f, -2.8875f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, -1612834106, 2017216891, 1, 1, 1);
	func_153(uParam0, "script@vignette@dutch_31@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@dutch_31@action", 0, 0, 1, 1);
	func_154(uParam0, "CDT31AU");
	func_155(uParam0, iLocal_14, 3, 1904532698, 0, -1, 0, get_random_float_in_range(30f, 50f), 1065353216, 1);
	func_156(uParam0, iLocal_14, 3, 0);
	func_157(uParam0, iLocal_14, 1);
	func_158(uParam0, iLocal_14, 3, -1);
	Local_16 = { func_159(uParam0, 0.0775f, -2.3185f, 0.9877f, 169f, 6.5f, 0.705f, 0.4425f) };
	func_160(uParam0, 1);
...
bool func_93(var uParam0)
{
	if (!func_108(&uLocal_26))
	{
		...
		{
			func_202(&uLocal_26);
			task_follow_nav_mesh_to_coord(func_48(uParam0, iLocal_14), 2357.7f, 1396.42f, 104.98f, 1.2f, -1, 0.25f, 1, 40000f);
			force_ped_motion_state(func_48(uParam0, iLocal_14), -668482597, false, 0, false);
		}
	}
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_259(func_148(uParam0), func_258(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
