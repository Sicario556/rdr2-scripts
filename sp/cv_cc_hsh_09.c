...
bool func_72(var uParam0)
{
	...
	iLocal_22 = func_153(uParam0, -1618805595, -1.28888f, 0.763515f, 0f, "CRATE", 1, 0, 1);
	func_153(uParam0, 264425748, -0.584518f, -1.37169f, 0f, "BARREL", 1, 0, 1);
	iLocal_20 = func_153(uParam0, -1698780291, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_21 = func_153(uParam0, -1473388640, 0f, 0f, 0f, "PEN", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, 1271499410, "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_22, 0, -1073741824, 1065353216, 1);
...
{
	vLocal_44 = { get_entity_coords(func_190(uParam0, iLocal_20), true, false) };
	return true;
}
...
bool func_95(var uParam0)
{
	...
	if (!is_sphere_visible(vLocal_44, 1f))
	{
		return true;
	}
	return false;
