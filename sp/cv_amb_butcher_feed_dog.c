...
{
	uLocal_19 = _0xb223249b7798eeed(func_48(uParam0, iLocal_14), 1939042559, 262145, 577766380);
	return true;
}
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_255(func_148(uParam0), func_254(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
				...
				case 10:
					...
					switch (iParam0)
					{
						...
						case 14:
							...
							break;
						case 4:
							if (func_324(747937920, 1) && !func_389((*Global_1347702)[1]->f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
