...
{
	if (!has_model_loaded(iLocal_10))
	{
		return 0;
	}
	if (!does_entity_exist(iLocal_11))
	{
		iLocal_11 = _create_mission_train(1054492269, _0x6de03bcc15e81710(uParam0->f_483), true, false, true, true);
	}
	if (!_0xbd3c4a2ed509205e(iLocal_11))
	{
		return 0;
	}
	return 1;
	...
	while (iVar12 < uParam0->f_19)
	{
		if (uParam0->f_20[iVar12]->f_2 != 0)
		{
			...
			if (is_entity_dead(&(uParam0->f_20[iVar12])))
			{
				...
				{
					uParam0->f_20[iVar12] = func_52(uParam0->f_20[iVar12]->f_2, uParam0->f_20[iVar12]->f_5, uParam0->f_20[iVar12]->f_8, 1, 1, 0, 1, uParam0->f_20[iVar12]->f_11, uParam0->f_20[iVar12]->f_9, 0, 0, 0, 0);
				}
				...
				if (!is_ped_human(&(uParam0->f_20[iVar12])))
				{
					if (!func_53(&(uParam0->f_20[iVar12])))
					{
	...
	switch (iLocal_9)
	{
		case 0:
			if (does_entity_exist(iLocal_11))
			{
				...
				{
					set_vehicle_is_considered_by_player(iLocal_11, true);
				}
				set_horn_enabled(iLocal_11, false);
				set_train_speed(iLocal_11, 0f);
				set_train_cruise_speed(iLocal_11, 0f);
			}
			iLocal_9 = 1;
			break;
		case 1:
...
int func_32(var uParam0, var uParam1)
{
	if (does_entity_exist(iLocal_11))
	{
		set_mission_train_as_no_longer_needed(&iLocal_11, false);
	}
	return 1;
}
...
bool func_47(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_72(&(Global_1898164->f_1[0]));
		if (func_73(iVar0) && func_74((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_75(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_81(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_61(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_88(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_62(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_89(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_86(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_107(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_107(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_107(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_87(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
