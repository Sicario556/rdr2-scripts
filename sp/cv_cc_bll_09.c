...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1843407141, 0f, 0f, 0f, "BOTTLE_BILL", 0, 1, 1);
	func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE_PEARSON", 0, 1, 1);
	func_152(uParam0, 264425748, -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	if (!func_153(15))
	{
	...
	func_157(uParam0, iLocal_14, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0);
	func_158(uParam0, iLocal_14, 2, 3, 0, "Default_Angry", 0);
	func_159(uParam0, iLocal_14, 1, -1);
	if (!func_153(15))
	{
		func_157(uParam0, iLocal_15, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", -1, 0);
	}
	func_160(uParam0, iLocal_15, 1061142135);
	func_159(uParam0, iLocal_15, 1, -1);
	if (func_148(uParam0) == 1)
	{
		func_161(uParam0, iLocal_15, 3, -442037069, "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 0, 100f, 1065353216, 1);
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_265(func_148(uParam0), func_264(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
...
int func_199(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_293() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_208(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_214(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_311(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_316(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_336(100f, 140f);
			}
		}
...
bool func_324()
{
	if (_is_ped_carrying(Global_35) || func_362(Global_35))
	{
		return true;
	}
	return false;
...
void func_391(var uParam0, int iParam1)
{
	...
	func_422(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_392(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_425(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
bool func_432(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_464(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_402((*Global_1347702)[63]->f_15, 1) || func_443((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_402((*Global_1347702)[134]->f_15, 1) || func_443((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(747937920, 1) && !func_402((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_478(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
