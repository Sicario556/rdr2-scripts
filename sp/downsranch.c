...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[68]->f_4;
	if (!network_is_game_in_progress())
	{
		iLocal_19 = _create_volume_aggregate_with_custom_name("Down's Ranch - m_volThreat Agg");
		_0x39816f6f94f385ad(iLocal_19, -861.1559f, 337.3949f, 97.83562f, 0f, 0f, -10.52764f, 11.36256f, 15.17971f, 10.22759f);
		_0x39816f6f94f385ad(iLocal_19, -864.7891f, 321.0681f, 94.98614f, 0f, 0f, -10.52764f, 8.645713f, 12.50398f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -62.5439f, -392.4335f, 72.1382f, 0f, 0f, 29.04495f, 7.979648f, 6.063315f, 6.900121f);
		_0x39816f6f94f385ad(iLocal_19, -851.4187f, 361.481f, 97.83562f, 0f, 0f, -13.36656f, 0.863879f, 8.798125f, 5.594934f);
		_0x39816f6f94f385ad(iLocal_19, -846.2698f, 364.2993f, 96.90186f, 0f, 0f, -7.59012f, 9.607594f, 16.13778f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -854.8633f, 319.2234f, 94.98614f, 0f, 0f, -10.52763f, 11.77066f, 11.27451f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -790.8695f, 346.954f, 98.00078f, 0f, 0f, -8.615136f, 13.37762f, 8.146093f, 7.736006f);
		_0x39816f6f94f385ad(iLocal_19, -797.3005f, 347.9039f, 98.69241f, -178.9669f, -86.9581f, 158.5464f, 6.802914f, 7.671669f, 3.322031f);
		_0x39816f6f94f385ad(iLocal_19, -817.6839f, 353.5158f, 98.00078f, 0f, 0f, -9.719018f, 10.09804f, 10.20509f, 7.736006f);
		_0x39816f6f94f385ad(iLocal_19, -874.6434f, 323.2318f, 94.98614f, 0f, 0f, -10.52763f, 12.96012f, 12.50398f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -883.0225f, 334.1583f, 94.98614f, 0f, 0f, -23.19702f, 8.645713f, 14.33108f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -857.598f, 357.7791f, 94.98614f, 0f, 0f, -4.378916f, 9.184352f, 2.478699f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -868.0872f, 338.0298f, 94.98614f, 0f, 0f, -10.52763f, 22.80199f, 22.79938f, 4.525191f);
		_0x39816f6f94f385ad(iLocal_19, -859.0131f, 352.2604f, 94.98614f, 0f, 0f, -10.52763f, 9.726913f, 9.194143f, 4.525191f);
		_0xbce668aaf83608be(iLocal_19, -868.4409f, 352.2944f, 95.5f, 0f, 0f, 121.5158f, 4.6843f, 11.06676f, 5.382992f);
		_0xbce668aaf83608be(iLocal_19, -879.6567f, 344.2453f, 95.5f, 0f, 0f, -38.53438f, 2.935173f, 7.713624f, 5.382992f);
		_0xbce668aaf83608be(iLocal_19, -882.3352f, 327.0211f, 95.5f, 0f, 0f, 156.2253f, 7.625237f, 7.713624f, 5.382992f);
		_0x39816f6f94f385ad(iLocal_19, -810.5886f, 353.7103f, 98.00078f, 0f, 0f, -9.719017f, 3.779373f, 6.791281f, 7.736006f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("Down's Ranch - m_volRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_19);
		_0xbce668aaf83608be(iLocal_18, -858.1369f, 346.6224f, 95.5f, 0f, 0f, -0.107f, 36.56057f, 35.55415f, 44f);
		_0x39816f6f94f385ad(iLocal_18, -815.7545f, 352.5984f, 105.6908f, 0f, 0f, -12.06673f, 85.78142f, 37.62513f, 28.168f);
		iLocal_17 = _create_volume_aggregate_with_custom_name("Down's Ranch - m_volWarning Agg");
		_0x6e0d3c3f828da773(iLocal_17, iLocal_18);
		_0xbce668aaf83608be(iLocal_17, -834.0826f, 345.0585f, 95.5f, 0f, 0f, -0.107f, 73.14397f, 44.90614f, 45.70249f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Down's Ranch - m_volRegistration Agg");
		...
		_0x35815f372d43e1e5(sLocal_15, iLocal_18);
		_0xa1b0e6301e2e02a6(sLocal_15, iLocal_19);
		_0xad3e07c37a7c1adc(sLocal_15, iLocal_17);
		_set_guard_zone_position(sLocal_15, -818.1168f, 354.8587f, 98.5042f);
...
void func_28(int iParam0)
{
	...
	if (!func_54(iVar1, 0))
	{
		...
		_0x4a8fefc43fd8ac9b(iLocal_18, 3, 1);
		_0x53d05d60e5f5b40c(iLocal_18, 3, 1, func_56(564));
	}
}
...
bool func_58(int iParam0)
{
	...
	return func_89((*Global_1347702)[iParam0]->f_15, 1);
}
...
int func_59(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_56(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_56(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_56(iParam0));
	...
	_0x7b204f88f6c3d287(func_56(iParam0));
	return 1;
}
...
bool func_68(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_102(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_116(&cVar6, 109029619), sVar9, func_116(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_116(&cVar6, 109029619), func_116(&cVar10, 109029619));
		}
...
void func_83(int iParam0)
{
	...
	{
		_0x998202b206872672(iLocal_18);
		_0x6d5f9e69ba1be783(iLocal_18);
...
int func_95(int iParam0, bool bParam1)
{
	...
	{
		func_139(iParam0, _create_persistent_character(func_99(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_56(iParam0));
				func_140(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_56(iParam0));
		}
		return 0;
	}
	...
	func_139(iParam0, _create_persistent_character(func_99(iParam0)));
	_0x4f81ead1de8fa19b(func_56(iParam0));
	if (func_136(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_56(iParam0));
		func_140(iParam0, 2048);
...
bool func_96(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_53(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_56(iParam0));
}
...
bool func_118(int iParam0)
{
	...
	if (func_151())
	{
		if (!func_89((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_155(Global_1935369->f_5[iParam0]->f_6, 1);
	func_156(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_90(Global_1914319->f_3[iParam0]->f_21) && func_158(Global_1914319->f_3[iParam0]->f_21))
	{
		func_159(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_160(Global_1914319->f_3[iParam0]->f_10, 0);
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_167(iParam0);
	_0xfc77c5b44d5ff7c0(func_56(iParam0));
	func_139(iParam0, 0);
	return 1;
}
...
bool func_144(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_171(&(Global_1898164->f_1[0]));
		if (func_98(iVar0) && func_172((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_176(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
