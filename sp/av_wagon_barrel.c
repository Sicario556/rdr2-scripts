...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	switch (*uParam0)
	{
		...
		case 29:
			...
			func_48(uParam0, 2, "CIGARETTE_A", -967333571, 0f, 0f, 0f, 0f, 1);
			func_48(uParam0, 3, "CIGARETTE_B", -967333571, 0f, 0f, 0f, 0f, 1);
			break;
	}
	iVar0 = func_50(func_49());
	iVar1 = func_50(func_49());
	func_51(uParam0, 0, "MALE_A", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MALE_B", iVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 0, "BARREL", -1809418382, 0f, 0f, 0f, 0f, 1);
	func_48(uParam0, 1, "RAMP", 942176598, 0f, 0f, 0f, 0f, 1);
...
{
	if (!_does_scenario_point_exist(iLocal_39) || !_does_scenario_point_exist(iLocal_40))
	{
		return 0;
	}
	iLocal_41 = _create_volume_box_with_custom_name(_get_scenario_point_coords(iLocal_39, true), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED1_SCENARIO");
	iLocal_42 = _create_volume_box_with_custom_name(_get_scenario_point_coords(iLocal_40, true), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED2_SCENARIO");
	return 1;
}
...
bool func_28(var uParam0)
{
	...
	{
		_0xb56d41a694e42e86(iLocal_41, 10208, 0, 0, -1, -1, 0);
	}
	if (_does_volume_exist(iLocal_42))
	{
		_0xb56d41a694e42e86(iLocal_42, 10208, 0, 0, -1, -1, 0);
	}
	if (does_entity_exist(uParam0->f_453))
	{
		set_vehicle_on_ground_properly(uParam0->f_453, 0f);
		return true;
	}
	return false;
}
...
{
	iLocal_39 = _find_closest_active_scenario_point_of_type(-240.63f, 769.93f, 117.09f, 817658057, 1f, 0, false);
	iLocal_40 = _find_closest_active_scenario_point_of_type(-240.34f, 769.04f, 117.09f, 817658057, 1f, 0, false);
	func_60(&uLocal_9, 0);
	func_61(&uLocal_9, 1);
	func_62(&uLocal_9, 1);
	func_63(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (func_67(&(uParam0->f_20[iVar1]), 0, &uLocal_9, &uVar0, 0, 0))
				{
					task_smart_flee_ped(&(uParam0->f_20[iVar1]), Global_35, -1f, -1, 0, 1077936128, 0);
					func_68(uParam0);
					if (!&uParam0->f_469[6])
					{
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[6])
		{
			if (func_71(uParam0, fLocal_37, 1116471296, 4, -91962372, 1))
			{
				func_69(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
	...
	if (&uParam0->f_469[2])
	{
		if (does_entity_exist(&(uParam0->f_20[0])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
			{
				...
				_task_use_scenario_point(&(uParam0->f_20[0]), iLocal_39, 0, 0, true, false, 0, false, -1f, false);
		...
		if (does_entity_exist(&(uParam0->f_20[1])))
		{
			if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[1]->f_1))
			{
				...
				_task_use_scenario_point(&(uParam0->f_20[1]), iLocal_40, 0, 0, true, false, 0, false, -1f, false);
...
bool func_67(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_106(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_107(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_137(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_137(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_138(&(uParam0->f_490)))
							{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_164(1) || *uParam0 & 8192 != 0))
				{
...
bool func_104(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_177(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_175(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_176(uParam2)
				{
					func_171(uParam2, 1);
					return true;
				}
...
bool func_105(int iParam0, var uParam1)
{
	...
	if (func_167(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_176(uParam1)
		{
...
void func_131(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_202(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_202(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_202(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
float func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_203(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_190(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
int func_196(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_190(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
