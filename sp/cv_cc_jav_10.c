...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, -1006095118, 1.19747f, -1.86925f, -0.0285034f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, -1006095118, -11.5514f, 7.15822f, 0.346359f, 0, 1, 0, 1);
	iLocal_19 = func_152(uParam0, 1271647689, -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0);
	func_154(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824, 0f, 1);
	...
	func_154(uParam0, iLocal_16, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0, -1073741824, 1065353216, 1);
	...
	func_154(uParam0, iLocal_14, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824, 0f, 1);
...
bool func_93(var uParam0)
{
	...
	{
		fLocal_23 = (_get_anim_scene_duration(&(uParam0->f_1984[iLocal_22])) * 2f);
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_297(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_301(100f, 140f);
			}
		}
...
void func_343(var uParam0, int iParam1)
{
	...
	func_380(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_344(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_383(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_390((*Global_1347702)[63]->f_15, 1) || func_427((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_390((*Global_1347702)[134]->f_15, 1) || func_427((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_390((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
