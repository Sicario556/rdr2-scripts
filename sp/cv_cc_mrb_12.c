...
bool func_72(var uParam0)
{
	...
	iLocal_19 = func_154(uParam0, 587066646, 0f, 0f, 0f, "BOWL0", 0, 1, 1);
	iLocal_17 = func_154(uParam0, 587066646, 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_20 = func_154(uParam0, -755866836, 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_18 = func_154(uParam0, -755866836, 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	iLocal_16 = func_154(uParam0, 1504738597, 0f, 0f, 0f, 0, 1, 0, 1);
	func_155(uParam0, iLocal_14, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_FEMALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
...
{
	return _has_scenario_type_loaded(-38747227, false);
}
...
{
	freeze_entity_position(func_193(uParam0, iLocal_17), true);
	freeze_entity_position(func_193(uParam0, iLocal_18), true);
	_0x669655ffb29ef1a9(func_193(uParam0, iLocal_17), 0, "Stew_Fill", 1f);
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_307(100f, 140f);
			}
		}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_332(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_333(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_333(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_334(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_266(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_335(iVar1)))
			{
				func_336(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_337(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
void func_281(var uParam0, int iParam1)
{
	...
	else if (!func_339(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_301(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_345(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
bool func_309(var uParam0, int iParam1)
{
	...
	{
		if (!func_339(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
