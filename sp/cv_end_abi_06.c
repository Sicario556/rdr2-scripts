...
{
	set_anim_scene_origin(&(uParam0->f_1984[iLocal_19]), -1648.089f, -1384.529f, 83.019f, 0f, 0f, -131.675f, 2);
	return true;
}
...
bool func_97(var uParam0)
{
	switch (iLocal_110)
	{
		case 0:
			...
			{
				_task_start_scenario_in_place(func_52(uParam0, iLocal_14), 830847823, 0, false, 0, 0.6f, true);
				iLocal_110 = 1;
		...
		case 2:
			...
			if (_0x337f1cc8ee895601(&(uParam0->f_1984[iLocal_17]), "John"))
			{
				iLocal_110 = 3;
			}
			break;
		case 3:
			fLocal_108 = get_control_normal(0, 1301263553);
			fLocal_109 = get_control_normal(0, -39308912);
			if (!_0x8d81e7824b7753f7(&(uParam0->f_1984[iLocal_17]), "s_Action_Loop", 1))
			{
				return false;
			}
			if (func_214())
			...
			{
				if (absf(fLocal_108) > absf(fLocal_109))
				{
					if (fLocal_108 > 0.6f)
					{
						func_199(uParam0, iLocal_18, 0);
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_227(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_229(iParam0);
					_0x7b204f88f6c3d287(func_230(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_230(iParam0, 0));
					func_231(iParam0);
				}
			}
			else
...
void func_121(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_241(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_122(int iParam0, int iParam1, bool bParam2)
{
	...
	func_242(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_245(iParam0);
	if (((does_entity_exist(iVar1) && func_247(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_260(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_33(uParam0) < 5)
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_261(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_228(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_225(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_180(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_225(uParam0->f_107[iVar0]->f_8.f_3))
			{
...
void func_198(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_225(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_317(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_212(var uParam0)
{
	...
	if (get_ped_index_from_entity_index(iLocal_34) != func_52(uParam0, iLocal_14))
	{
		func_8(&iLocal_32, 1, 1);
		return false;
	}
	if (!func_47(iLocal_32))
	{
		...
		func_322(iLocal_32, _uiprompt_get_group_id_for_target_entity(func_52(uParam0, iLocal_14)), 0, 1);
	}
...
{
	task_enter_anim_scene(Global_35, &(uParam0->f_1984[iLocal_17]), "JOHN", func_324(uParam0, iLocal_27), 1069379748, 1, 0, 20000, -1082130432);
}
...
bool func_215(var uParam0, int iParam1)
{
	...
	{
		if (!func_327(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
int func_228(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_332(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_230(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_333(iParam0);
	}
...
void func_292(var uParam0, int iParam1)
{
	...
	else if (!func_327(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_312(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_362(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
var func_324(var uParam0, int iParam1)
{
	...
	return func_377(uParam0->f_2051[iParam1]->f_1);
}
...
bool func_337()
{
	if (_is_ped_carrying(Global_35) || func_382(Global_35))
	{
		return true;
	}
	return false;
...
int func_354(int iParam0, bool bParam1)
{
	...
	{
		func_251(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_239() == -1)
		{
...
void func_413(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_224(iParam0, 8))
		{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_228(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_225(vVar0)) && !func_226(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
			...
			{
				_0x63aa2b8eb087886a(func_228(iParam0, 1), get_hash_key(sVar12));
			}
...
void func_429(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_243(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_243(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_243(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_243(iParam5, 32), true);
	...
	else if (func_243(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_243(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_243(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_435(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_249(iParam0)))
	{
		return false;
	}
...
bool func_446(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_228(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_348(747937920, 1) && !func_421((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
