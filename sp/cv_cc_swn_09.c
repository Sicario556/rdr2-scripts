...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_153(uParam0, "script@vignette@swanson_9@action", 0, 0, 1, 0);
...
{
	return has_model_loaded(iLocal_19);
}
...
{
	iLocal_18 = _create_weapon_object(-618550132, 1, uParam0->f_23, true, 1f);
	_0x669655ffb29ef1a9(func_191(uParam0, iLocal_17), 0, "Stew_Fill", 1f);
	return true;
}

bool func_87(var uParam0)
{
	if (!bLocal_20 && does_entity_exist(iLocal_18))
	{
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_312(100f, 140f);
			}
		}
...
int func_213(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_317(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_215(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_318(iParam0);
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_335(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_336(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_336(uParam0, 1, 0);
							}
						}
						if (!func_50(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_337(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_263(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_338(iVar1)))
			{
				func_339(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_340(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
void func_278(var uParam0, int iParam1)
{
	...
	else if (!func_342(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_305(var uParam0, int iParam1)
{
	...
	{
		if (!func_342(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_307(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
bool func_310(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Var0.f_5 = 1;
	Var0.f_6 = 1;
	Var0 = uParam1;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(747937920, 1) && !func_412((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
