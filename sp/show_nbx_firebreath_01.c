...
{
	iParam0->f_74[0] = -354592894;
	iParam0->f_58[0] = -890087611;
	iParam0->f_58[1] = 1019569266;
	iParam0->f_58[2] = 1019569266;
	iParam0->f_58[3] = -1303647802;
	iParam0->f_58[4] = 459594226;
	...
	if (!_does_anim_scene_exist(iParam0->f_48))
	{
		iParam0->f_48 = _create_anim_scene("script@shows@fire_breather@act2_p1@action", 2, func_156(0), false, true);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= (14 - 1))
	{
		iVar1 = iVar0;
		Local_1141.f_9[iVar0] = get_hash_key(func_157(iVar1));
		iVar0++;
	}
	Local_1141.f_8 = 0;
...
bool func_30(int iParam0)
{
	...
	if (!has_anim_dict_loaded(func_158()))
	{
		return false;
	}
	if (!func_159(iParam0))
	...
	switch (iParam1)
	{
		case 0:
			...
			while (iVar0 <= (12 - 1))
			{
				...
				{
					request_anim_dict(func_171(iVar1));
				}
				iVar0++;
			}
...
bool func_36(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (func_170(iVar1, *uParam0) && !has_anim_dict_loaded(func_171(iVar1)))
				{
					bVar2 = false;
				}
				iVar0++;
			...
			if (!func_173(uParam0->f_12[1], func_172(1, uParam0->f_17), 0))
			{
				return false;
			}
			if (!func_173(uParam0->f_12[0], func_172(0, uParam0->f_17), 0))
			{
				return false;
			}
			break;
...
bool func_37(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar2 <= (iVar0 - 1))
	{
		...
		{
			iVar3 = get_random_model_from_population_set(func_175(iParam1), func_176(iParam1, iVar2), -156825994, false, true, func_177(iParam1, iVar2));
			bVar1 = false;
			...
			{
				(*uParam0)[iVar2] = func_180(iVar3, func_177(iParam1, iVar2), func_178(iParam1, iVar2), 1, 1, func_179(iParam1, iVar2), 1, 1, 1, 0, 0, 0, 0);
			}
			return false;
		}
		if (!does_entity_exist(uParam0[iVar2]))
...
bool func_38(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar1 <= (iVar0 - 1))
	{
		if ((func_182(iVar1, uParam1->f_17) && iParam2 == 0) && !uParam1->f_20)
		{
			...
			set_anim_scene_entity(&(uParam1->f_12[1]), func_183(1, iVar1, uParam1->f_17), uParam0[iVar1], 0);
		}
...
void func_45(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 0:
			...
			request_model(func_194(), false);
			request_model(func_195(0), false);
			func_193(uParam0, 1);
			break;
		case 1:
			if (!_0x5e420ff293ee5472())
			...
			if (!has_model_loaded(func_194()) || !has_model_loaded(func_195(0)))
			{
				return;
			}
			...
			{
				iVar2 = iVar1;
				uParam0->f_3[iVar1] = create_object(func_195(iVar2), func_201(iVar2), true, true, false, false, true);
				iVar1++;
			}
			func_193(uParam0, 2);
			break;
		case 2:
			...
			{
				uParam0->f_9 = _create_anim_scene(func_202(iParam1), 0, func_203(iParam1, 0), false, true);
				load_anim_scene(uParam0->f_9);
				set_anim_scene_origin(uParam0->f_9, func_204(iParam1), func_205(iParam1), 2);
			}
		...
		case 3:
			if (_does_anim_scene_exist(uParam0->f_9))
			{
				set_anim_scene_entity(uParam0->f_9, func_206(iParam1), uParam0->f_2, 0);
				iVar3 = 0;
				while (iVar3 <= (5 - 1))
				{
					set_anim_scene_entity(uParam0->f_9, func_207(iParam1, iVar3), &(uParam0->f_3[iVar3]), 0);
					iVar3++;
				}
		...
		case 4:
			if (uParam0->f_10)
			{
				if (!_0x1f0e401031e20146(uParam0->f_9, func_203(iParam1, 1)))
				{
					if (!_0x23e33cb9f4a3f547(uParam0->f_9, func_203(iParam1, 1)))
					{
						_0xdf7b5144e25cd3fe(uParam0->f_9, func_203(iParam1, 1));
					}
					else
					{
						_set_anim_scene_playback_list_bool(uParam0->f_9, func_203(iParam1, 1), true);
					}
				}
			}
			break;
...
bool func_46(int iParam0)
{
	...
	{
		uVar2 = 1;
		if (func_208(&uVar0, &uVar2, 1, 2548.364f, -1303.376f, 47.48392f, 0.5f, 0, 1, 1, -1, 1, 0, -1082130432, 0, 0) > 0)
		{
			if (does_entity_exist(&(uVar0[0])) && !is_entity_dead(&(uVar0[0])))
			{
				iParam0->f_81[1] = &uVar0[0];
				Global_1394141->f_1334 = 1;
				set_anim_scene_entity(iParam0->f_48, "male", &(iParam0->f_81[1]), 0);
				set_blocking_of_non_temporary_events(&(iParam0->f_81[1]), true);
				set_entity_invincible(&(iParam0->f_81[1]), true);
...
void func_63(int iParam0)
{
	...
	switch (iVar1138)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (_0x1f0e401031e20146(iParam0->f_48, func_156(2)))
			{
				if (_0x23e33cb9f4a3f547(iParam0->f_48, func_156(0)))
				{
					_0xae6ada8fe7e84acc(iParam0->f_48, func_156(0));
				}
			...
			break;
		case 4:
			if (_0x1f0e401031e20146(iParam0->f_48, func_156(1)))
			{
				func_238(0);
			...
			break;
		case 5:
			if (_0x1f0e401031e20146(iParam0->f_48, func_156(3)))
			{
				func_238(0);
			...
			break;
		case 6:
			if (is_entity_on_fire(&(iParam0->f_81[1])))
			{
				stop_entity_fire(&(iParam0->f_81[1]), 0);
			}
			if (fVar1 > 0.71f)
			{
...
void func_86(int iParam0)
{
	if (does_entity_exist(&(iParam0->f_81[1])))
	{
		set_entity_invincible(&(iParam0->f_81[1]), false);
	}
	func_238(0);
...
void func_167(int iParam0)
{
	...
	{
		iParam0->f_66[0] = create_object(&(iParam0->f_58[0]), func_269(0), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[1])))
	{
		iParam0->f_66[1] = create_object(&(iParam0->f_58[1]), func_269(1), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[2])))
	{
		iParam0->f_66[2] = create_object(&(iParam0->f_58[2]), func_269(2), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[3])))
	{
		iParam0->f_66[3] = create_object(&(iParam0->f_58[3]), func_269(3), true, true, false, false, true);
	}
	if (!does_entity_exist(&(iParam0->f_66[4])))
	{
		iParam0->f_66[4] = create_object(&(iParam0->f_58[4]), func_269(4), true, true, false, false, true);
	}
...
{
	set_anim_scene_entity(iParam0->f_48, "DANCER", &(iParam0->f_81[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "BOTTLE", &(iParam0->f_66[0]), 0);
	set_anim_scene_entity(iParam0->f_48, "STICK_0_", &(iParam0->f_66[1]), 0);
	set_anim_scene_entity(iParam0->f_48, "STICK_1_", &(iParam0->f_66[2]), 0);
	set_anim_scene_entity(iParam0->f_48, "TABLE", &(iParam0->f_66[3]), 0);
	set_anim_scene_entity(iParam0->f_48, "lantern", &(iParam0->f_66[4]), 0);
}
...
void func_185(var uParam0, int iParam1)
{
	...
	{
		task_start_scenario_at_position(*uParam0, -1426662425, func_177(iParam1, uParam0->f_2), func_178(iParam1, uParam0->f_2), -1, false, true, 0, 0.25f, false);
	}
}
...
void func_186(var uParam0, int iParam1)
{
	if (does_entity_exist(*uParam0))
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_278(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*uParam0, uParam0->f_7, uParam0->f_8, vVar1, vVar5, 1000f, -1000f, -1, 49153, func_278(), 2, 0, 0);
		}
	}
}
...
int func_208(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	if (fParam13 <= 0f)
	{
	...
	iVar1 = func_286(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_287(iVar0);
	return iVar1;
}
...
void func_214(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar5 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			{
				if (func_288(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 != 5)
				{
					(*uParam1)[iVar5]->f_1 = 5;
				}
			}
			else if (func_288(*uParam0, iVar5) && (*uParam1)[iVar5]->f_1 == 5)
			{
			...
			if ((!uParam0->f_19 && !func_288(*uParam0, iVar5)) && (*uParam1)[iVar5]->f_1 != 5)
			{
				if ((*uParam1)[iVar5]->f_9)
				{
					fVar6 = func_292(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 > 2f || !func_293((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_9 = 0;
						uParam0->f_21 = 0;
						(*uParam1)[iVar5]->f_5 = 2;
						func_294((*uParam1)[iVar5], iParam2);
					}
				}
				else if (!uParam0->f_21 && (*uParam1)[iVar5]->f_1 != 6)
				{
					fVar6 = func_292(Global_35, uParam1[iVar5], 1, 1);
					if (fVar6 < 1.5f && func_293((*uParam1)[iVar5]))
					{
						(*uParam1)[iVar5]->f_5 = func_295(iVar5);
						func_294((*uParam1)[iVar5], iParam2);
						(*uParam1)[iVar5]->f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch ((*uParam1)[iVar5]->f_1)
			{
				...
				case 1:
					...
					{
						func_298((*uParam1)[iVar5], func_297(iParam2), 500);
					}
					break;
				case 3:
					func_299((*uParam1)[iVar5], iParam2);
					(*uParam1)[iVar5]->f_1 = 4;
					break;
				case 4:
					bVar7 = false;
				...
				case 5:
					if (!uParam0->f_19)
					{
						func_300(uParam0, (*uParam1)[iVar5]);
					}
					break;
				case 6:
					if (_does_anim_scene_exist(&(uParam0->f_12[1])))
					{
						...
						if (_0x005e6f28dd7ed58d(&(uParam0->f_12[1]), func_183(1, iVar5, uParam0->f_17)) || _is_anim_scene_finished(&(uParam0->f_12[1]), false))
						{
							func_186((*uParam1)[iVar5], iParam2);
							(*uParam1)[iVar5]->f_1 = 1;
						}
					...
					break;
				case 2:
					task_start_scenario_at_position(uParam1[iVar5], -1426662425, func_177(iParam2, iVar5), func_178(iParam2, iVar5), -1, false, true, 0, 0.25f, false);
					(*uParam1)[iVar5]->f_1 = 1;
					break;
				case 7:
				...
				case 9:
					...
					{
						task_follow_nav_mesh_to_coord(uParam1[iVar5], func_301(iParam2), 1f, -1, 0.25f, 5373953, 40000f);
						_0x2208438012482a1a(uParam1[iVar5], false, false);
						(*uParam1)[iVar5]->f_1 = 10;
					}
					break;
				case 10:
					...
					else if (!func_302(get_entity_coords(uParam1[iVar5], true, false)))
					{
					...
					else if (get_script_task_status(uParam1[iVar5], 713668775, true) != 1 && fVar2 > (func_291(iParam2, iVar5) + 3f))
					{
						(*uParam1)[iVar5]->f_1 = 9;
					}
					break;
...
int func_224(int iParam0, var uParam1)
{
	...
	_uiprompt_set_group((*Global_1945938)[func_303(&(iParam0->f_1053[1]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	if (!func_231(iParam0->f_1053[0], uParam1, "SHOW_NEG_RESPONSE", 648122183))
	{
		return 0;
	}
	_uiprompt_set_group((*Global_1945938)[func_303(&(iParam0->f_1053[0]))]->f_3, _uiprompt_get_group_id_for_target_entity(iParam0->f_12), 0);
	return 1;
}
...
void func_229()
{
	...
	bVar0 = false;
	if (is_ped_active_in_scenario(Global_35, 1) || (func_312(36) && _0x3ab6c7b0bb0df4b1(Global_35, -1)))
	{
		bVar0 = true;
	}
	if (!bVar0)
	{
		task_play_anim(Global_35, func_158(), func_316(1), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
	}
	else
	{
		task_play_anim(Global_35, func_158(), func_316(0), 8f, -8f, -1, 67108880, 0f, false, 1114114, false, 0, false);
	}
}
...
bool func_231(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	if (!func_223(*uParam0))
	{
		*uParam0 = func_318(sParam2, iParam3, *uParam1, 1, 0, 0, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
	}
	if (!func_223(*uParam0))
	{
		return false;
...
void func_236(int iParam0)
{
	switch (Local_1141.f_8)
	{
		case 0:
			...
			{
				iVar1 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_9[iVar1])))
				{
					if (iVar1 == 1)
					{
			...
			break;
		case 1:
			if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_9[13])))
			{
		...
		case 3:
			...
			{
				iVar2 = iVar0;
				if (has_anim_event_fired(&(iParam0->f_81[0]), &(Local_1141.f_9[iVar2])))
				{
...
void func_258(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = round(func_339(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_346(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_347(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_348(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_349(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_350(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_351(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_352(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_353(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_354(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_355(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_356(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_357(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_358(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_359(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_360(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_361(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 4:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_362(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_363(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_364(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_365(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 5:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_366(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_367(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_368(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_369(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 6:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_370(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_371(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_372(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_373(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 7:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_374(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_375(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_376(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_377(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 8:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_378(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_379(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_380(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_381(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 9:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_382(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_383(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_384(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_385(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 10:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_386(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_387(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_388(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_389(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 11:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_390(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_391(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_392(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_393(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 12:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_394(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_395(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_396(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_397(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 13:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_398(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_399(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_400(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_401(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 16:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_402(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_403(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_404(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_405(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 17:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_406(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_407(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_408(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_409(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 18:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_410(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_411(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_412(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_413(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 20:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_414(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_415(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_416(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_417(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 21:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_418(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_419(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_420(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_421(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 19:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_422(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_423(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_424(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_425(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 22:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_426(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_403(get_random_int_in_range(0, func_345(16, iParam1, iParam2)));
						case 2:
							return func_404(get_random_int_in_range(0, func_345(16, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_427(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 23:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_428(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_429(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_430(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_431(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 24:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_432(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_433(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_434(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_435(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		case 25:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_436(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_437(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_438(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					switch (iParam2)
					{
						case 0:
							return func_439(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
			}
			break;
		...
		case 27:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_440(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_441(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_442(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_443(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 28:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_444(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_441(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_442(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_445(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 29:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_446(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_441(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_442(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_447(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 30:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_448(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_441(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_442(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_449(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 31:
			break;
		case 32:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_450(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_451(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 33:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_452(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_453(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 34:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_454(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_455(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 14:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_456(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_457(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_458(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					}
					break;
				case 2:
					return func_459(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
		case 15:
			switch (iParam1)
			{
				case 1:
					...
					{
						case 0:
							return func_460(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 1:
							return func_457(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
						case 2:
							return func_458(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
					...
					break;
				case 2:
					return func_461(get_random_int_in_range(0, func_345(iParam0, iParam1, iParam2)));
			}
			break;
	}
	return "FAIL";
...
int func_286(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_462(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !decor_exist_on(iVar2, "bIgnoreThisPed"))
				{
					if (!func_463(iVar2, uParam1))
					{
						bVar3 = false;
						if (iParam7 != -1)
						{
...
int func_290(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			return 1;
		case 0:
			if (func_464((*Global_1835011)[36]->f_1))
			{
				return 0;
			}
			else
...
void func_294(int* iParam0, int iParam1)
{
	if ((does_entity_exist(*iParam0) && !iParam0->f_9) && iParam0->f_5 != -1)
	{
		...
		if (iVar8 == 0)
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_278(), 2, 1, 0);
		}
		else
		{
			task_play_anim_advanced(*iParam0, iParam0->f_7, iParam0->f_8, vVar1, vVar5, 0.75f, -0.75f, -1, 49153, func_278(), 2, 0, 0);
		}
	}
	if (!iParam0->f_9)
	{
...
int func_318(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	if (is_string_null_or_empty(sParam0))
	{
		return 0;
...
{
	return (shift_right(iParam0, 26) & 31 * func_473(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_462(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_483(int iParam0)
{
	...
	if (is_ped_group_member(iParam0, func_486(), 1))
	{
		return true;
	}
	return false;
...
{
	return func_487(iParam0, Global_1894899->f_2, bParam1);
}
...
int func_487(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_490(iParam1, &iVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_491(iParam0, iVar0, iVar1, bParam2);
}
...
bool func_490(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_260() != -1;
	switch (iParam0)
	{
...
int func_491(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_493(iVar2) != 0 && _0x800df3fc913355f3(func_494(iVar2)))
		{
