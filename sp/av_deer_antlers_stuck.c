...
bool func_28(var uParam0)
{
	...
	_0x9851de7aec10b4e1(uParam0->f_483, 5f, 1, 0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[7])
	{
		if (!is_entity_dead(&(uParam0->f_20[1])))
		{
			iLocal_10 = _0xfa50f79257745e74(uParam0->f_20[1]->f_5, 1f, 1, 36, 0);
			iLocal_11 = _0xfa50f79257745e74(uParam0->f_20[1]->f_5, 1.5f, 2, -1, 0);
			set_ped_can_be_targetted(&(uParam0->f_20[1]), false);
			_0x18ff3110cf47115d(&(uParam0->f_20[1]), 7, 0);
			set_entity_invincible(&(uParam0->f_20[1]), true);
			uParam0->f_469[7] = 1;
		}
	}
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_43 == 1)
		{
			if ((func_63(uParam0, &uLocal_15, 1) || func_64(Global_35, uParam0->f_483, 1) <= 400f) || is_entity_dead(&(uParam0->f_20[0])))
			{
				bLocal_43 = true;
			}
		}
		if (bLocal_43)
		{
			if (((!has_anim_event_fired(&(uParam0->f_20[0]), 725039534) || is_ped_fleeing(&(uParam0->f_20[0]))) || func_65(&(uParam0->f_20[0]), 518218985)) || is_entity_dead(&(uParam0->f_20[0])))
			{
	...
	if (!&uParam0->f_469[0] && !bLocal_43)
	{
		if (!&uParam0->f_469[1])
		{
			if (!is_entity_dead(Global_35) && !is_entity_dead(&(uParam0->f_20[0])))
			{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_73(uParam0, 3f, 60f, 4, -91962372, 1))
				{
					func_69(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
			...
			if (!&uParam0->f_469[3])
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (has_anim_event_fired(&(uParam0->f_20[0]), 1935919182))
							{
								_0x2e1d6d87346bb7d2(&(uParam0->f_20[0]), Global_35, 0, 0);
							}
							if (!&uParam0->f_469[4])
							{
							...
							if (&uParam0->f_469[4])
							{
								_0x18ff3110cf47115d(&(uParam0->f_20[1]), 7, 1);
								uParam0->f_469[3] = 1;
								func_74(&uLocal_12, 0);
								return 1;
							}
...
int func_32(var uParam0, var uParam1)
{
	...
	{
		set_ped_config_flag(&(uParam0->f_20[1]), 186, true);
	}
	func_75(uParam0, 1, 0, 0);
	if (iLocal_10 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_10, 1);
	}
	if (iLocal_11 != -1)
	{
		_0x9cf1836c03fb67a2(&iLocal_11, 1);
	}
	return 1;
}
...
void func_70(var uParam0)
{
	...
	set_ped_to_ragdoll(&(uParam0->f_20[1]), 2000, 2000, 0, false, true, false);
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (!func_65(&(uParam0->f_20[0]), 518218985))
		{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_115(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_66(&(uParam0->f_490)))
							{
