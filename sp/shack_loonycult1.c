...
void func_20(var uParam0)
{
	if (!_does_volume_exist(uParam0->f_46))
	{
		if (!func_68(func_67(uParam0)))
		{
			...
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_67(uParam0), func_69(uParam0), func_70(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_67(uParam0), func_69(uParam0), func_70(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_41(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_76(func_75(uParam0->f_5), 2) && !func_45(128, 0, 1)) && !func_77(get_player_index(), 1, 1, 1)) && !func_78()) && !func_79(20)) && !func_76(func_75(uParam0->f_5), 4)) && !func_76(func_75(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_81(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_81(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_81(uParam0, iVar0, 0), iParam1, func_81(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_81(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
	...
	if (!&uParam0->f_6[iParam5] == 0)
	{
		if (!does_entity_exist(&(uParam0->f_13[iParam5])))
		{
			...
			if (uParam0->f_1 == 8192)
			{
				...
				{
					uParam0->f_13[iParam5] = func_86(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, iParam7, 1, 0, 0, 0, 0);
				}
			}
			else
			{
...
bool func_45(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 == 0 && func_56(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
void func_47(var uParam0)
{
	...
	{
		if (func_99(4, 23) && func_100(Global_35, &(Local_73.f_99[0]), 1, 0))
		{
			trigger_music_event("LOONY_CULT_SHACK_ENTERED");
...
bool func_50()
{
	...
	_0xd9130842d7226045("Ufos_Sounds", 0);
	request_model(Local_73.f_122, false);
	request_model(Local_73.f_121, false);
	if (_does_streamed_txd_exist(Local_73.f_124))
	{
		_request_streamed_txd(Local_73.f_124, false);
	}
	return true;
}
...
bool func_51()
{
	...
	{
		if (!prepare_music_event("LOONY_CULT_SHACK_ENTERED"))
		{
			return false;
		}
	}
	...
	if (!has_model_loaded(Local_73.f_122))
	{
		return false;
	}
	if (!has_model_loaded(Local_73.f_121))
	{
		return false;
	}
	if (_does_streamed_txd_exist(Local_73.f_124) && !_has_streamed_txd_loaded(Local_73.f_124))
	{
		return false;
	}
	return true;
...
bool func_52(var uParam0)
{
	...
	Var0 = { func_107(0) };
	if (!func_108(Local_73.f_99[0], Var0.f_1, Var0.f_2, Var0.f_5, Var0.f_8, Var0.f_11))
	{
		return false;
	}
...
{
	iVar0 = func_110();
	if ((does_entity_exist(uParam0->f_139[0]->f_8) && !func_41(Local_73.f_130, 16)) && !func_41(Local_73.f_130, 8))
	{
		if (!(func_111(iVar0) >= 0 && func_111(iVar0) <= 3))
		{
			func_112(uParam0, 6);
		}
		else if (!func_100(Global_35, &(Local_73.f_99[0]), 1, 0))
		{
			func_112(uParam0, 6);
		}
	}
	...
	{
		case 0:
			if ((func_111(iVar0) >= 0 && func_111(iVar0) <= 3) && func_100(Global_35, &(Local_73.f_99[0]), 1, 0))
			{
				func_112(uParam0, 1);
			}
			break;
		case 1:
			...
			_play_sound_from_position("Arrive", func_114(), "Ufos_Sounds", false, 0, false, 0);
			set_ambient_zone_state("AZ_Looney_Cult_Shack_UFOs", true, true);
		...
		case 2:
			...
			while (iVar1 < 1)
			{
				uParam0->f_139[iVar1]->f_3 = { &(uParam0->f_139[iVar1]), uParam0->f_139[iVar1]->f_1, 115f };
				uParam0->f_139[iVar1]->f_7 = 5f;
				iVar1++;
			}
			func_112(uParam0, 3);
			break;
		case 3:
			...
			while (iVar1 < 1)
			{
				if (uParam0->f_139[iVar1]->f_2 <= (115f + 15f))
				{
					uParam0->f_139[iVar1]->f_7 = 1f;
				}
				else if (uParam0->f_139[iVar1]->f_7 > 10f)
				{
					uParam0->f_139[iVar1]->f_7 = (uParam0->f_139[iVar1]->f_7 - 2f);
				}
				if (uParam0->f_139[iVar1]->f_2 <= 115f)
				{
					func_112(uParam0, 5);
				}
				iVar1++;
			...
			break;
		case 4:
			uParam0->f_139[iVar1]->f_3 = { func_115() };
			func_112(uParam0, 5);
			break;
		case 5:
			iVar1 = 0;
			while (iVar1 < 1)
			{
				if (get_distance_between_coords(*uParam0->f_139[iVar1], uParam0->f_139[iVar1]->f_3, true) <= 0.1f)
				{
					uParam0->f_139[iVar1]->f_3 = { func_115() };
				}
				iVar1++;
		...
		case 6:
			...
			while (iVar1 < 1)
			{
				uParam0->f_139[iVar1]->f_3 = { &(uParam0->f_139[iVar1]), uParam0->f_139[iVar1]->f_1, 999f };
				uParam0->f_139[iVar1]->f_7 = 5f;
				iVar1++;
			}
			...
			_0x0f2a2175734926d8("Loop_A", "Ufos_Sounds");
			_0x0f2a2175734926d8("Loop_B", "Ufos_Sounds");
			_play_sound_from_position("Leave", func_114(), "Ufos_Sounds", false, 0, false, 0);
			set_ambient_zone_state("AZ_Looney_Cult_Shack_UFOs", false, false);
		...
		case 7:
			...
			while (iVar1 < 1)
			{
				if (uParam0->f_139[0]->f_2 >= 300f)
				{
					uParam0->f_139[iVar1]->f_7 = (uParam0->f_139[iVar1]->f_7 + 10f);
				}
				else if (uParam0->f_139[0]->f_2 >= 150f)
				{
					if (!func_41(Local_73.f_130, 4))
					{
						func_42(&(Local_73.f_130), 4);
					}
					uParam0->f_139[iVar1]->f_7 = (uParam0->f_139[iVar1]->f_7 + 1f);
				}
				else
				{
					uParam0->f_139[iVar1]->f_7 = (uParam0->f_139[iVar1]->f_7 + 0.02f);
				}
				if (uParam0->f_139[iVar1]->f_2 >= 800f)
				{
					func_112(uParam0, 8);
				}
				iVar1++;
		...
		case 8:
			...
			_0x0f2a2175734926d8("Arrive", "Ufos_Sounds");
			_0x0f2a2175734926d8("Leave", "Ufos_Sounds");
			_0x0f2a2175734926d8("Loop_A", "Ufos_Sounds");
			_0x0f2a2175734926d8("Loop_B", "Ufos_Sounds");
			func_117(&Local_73);
			func_42(&(Local_73.f_130), 8);
	...
	while (iVar1 < 1)
	{
		if (func_41(Local_73.f_130, 2))
		{
			if (_0x714a0ea7de1167be("Loop_A", "Ufos_Sounds"))
			{
				_play_sound_from_position("Loop_A", func_114(), "Ufos_Sounds", false, 0, false, 0);
			}
			if (_0x714a0ea7de1167be("Loop_B", "Ufos_Sounds"))
			{
				_play_sound_from_position("Loop_B", func_114(), "Ufos_Sounds", false, 0, false, 0);
			}
		}
		if (does_entity_exist(uParam0->f_139[iVar1]->f_8))
		{
			fVar5 = (get_frame_time() * uParam0->f_139[iVar1]->f_7);
			vVar2 = { uParam0->f_139[iVar1]->f_3 - *uParam0->f_139[iVar1] };
			vVar2 = { func_118(vVar2, fVar5) };
			*uParam0->f_139[iVar1] = { *uParam0->f_139[iVar1] + vVar2 };
			func_119(uParam0->f_139[iVar1], iVar1);
		}
		iVar1++;
	}
}
...
bool func_54(var uParam0)
{
	if (!func_41(Local_73.f_131, 16777216))
	{
		if (func_120())
		{
			if (_get_scenario_point_type_ped_is_using(Global_35) == 1763725008)
			{
	...
	if (_does_scenario_point_exist(Local_73.f_112) && !func_41(Local_73.f_131, 134217728))
	{
		if (_0x9c54041bb66bcf9e(Global_35, Local_73.f_112))
		{
			func_42(&(Local_73.f_131), 134217728);
			func_101(&(uParam0->f_5), &(Local_73.f_131));
		}
	}
	if ((((func_41(Local_73.f_131, 16777216) && func_41(Local_73.f_131, 134217728)) && !is_ped_active_in_scenario(Global_35, 0)) && func_41(Local_73.f_131, 67108864)) && !Local_73.f_129)
	{
...
void func_59(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_122(iParam0) == 3 || (func_122(iParam0) == 1 && _0x01f4d242765c6b24(func_124(iParam0))))
	{
...
{
	if (!func_144(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_144(uParam0, iParam1), func_145(uParam0, iParam1), func_146(uParam0, iParam1), func_147(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
{
	return func_157(get_clock_hours(), iParam0, iParam1);
}
...
bool func_104(var uParam0, char* sParam1, vector3 vParam2, var uParam5, var uParam6, float fParam7)
{
	if (!_does_scenario_point_exist(*uParam0))
	{
		*uParam0 = func_159(get_hash_key(sParam1), vParam2, uParam5, uParam6, fParam7, 0);
		_0xe69fda40aac3efc0(*uParam0, 0);
		return false;
	}
	if (_does_scenario_point_exist(*uParam0))
	{
...
bool func_105()
{
	...
	if (_does_streamed_txd_exist(Local_73.f_124))
	{
		if (!_has_streamed_txd_loaded(Local_73.f_124))
		{
			return false;
		}
	}
	...
	iVar0 = get_object_index_from_entity_index(_get_scenario_point_entity(Local_73.f_112, "PrimaryItem"));
	if (does_entity_exist(iVar0))
	{
		_set_apply_object_txd(iVar0, Local_73.f_124, 0, 0);
		decor_set_int(iVar0, "letter_item", -997101708);
...
bool func_106()
{
	if (does_entity_exist(Local_73.f_123))
	{
		return true;
	}
	vVar0 = { 1458.7f, 815.033f, 101.3335f };
	Local_73.f_123 = create_object(Local_73.f_122, vVar0, true, true, false, false, true);
	return false;
}
...
bool func_108(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, char* sParam11)
{
...
void func_109(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		func_160(uParam0->f_139[iVar0], iVar0);
		iVar0++;
	}
}
...
void func_113(var uParam0, var uParam1)
{
	if (!Local_73.f_129)
	{
		...
		while (iVar0 < 1)
		{
			if (!does_entity_exist(uParam0->f_139[iVar0]->f_8))
			{
				uParam0->f_139[iVar0]->f_8 = create_object(uParam0->f_121, *uParam0->f_139[iVar0], true, true, false, false, true);
			}
			iVar0++;
		}
		Local_73.f_129 = 1;
...
Vector3 func_115()
{
	fVar0 = get_random_float_in_range(1458.9f, 1465.6f);
	fVar1 = get_random_float_in_range(807.1f, 814.2f);
...
void func_117(int iParam0)
{
	...
	while (iVar0 < 1)
	{
		if (does_entity_exist(iParam0->f_139[iVar0]->f_8))
		{
			delete_object(&(iParam0->f_139[iVar0]->f_8));
		}
		iVar0++;
	}
	Local_73.f_129 = 0;
...
{
	set_entity_coords(uParam0->f_8, *uParam0, true, false, true, true);
}
...
int func_127(int iParam0)
{
	switch (func_125(iParam0))
	{
		...
		case 8:
			...
			if (func_96((*Global_1347702)[iVar1]->f_12, 1))
			{
...
int func_129()
{
	if (!func_171((*Global_1835011)[4]->f_1, 1))
	{
		return 0;
	}
	else if (!func_171((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_171((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_171((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_171((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_171((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_171((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_137(var uParam0)
{
	...
	func_117(&Local_73);
	func_180(Local_73.f_99[0]);
	set_model_as_no_longer_needed(Local_73.f_122);
	set_model_as_no_longer_needed(Local_73.f_121);
}
...
bool func_152(int iParam0, float fParam1)
{
	iVar0 = func_185(iParam0);
	if (iVar0 != 0)
	{
		*fParam1 = func_186(iParam0);
		return true;
	}
	else
	{
...
var func_159(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
void func_200(int iParam0, int iParam1)
{
	...
	if (func_56(&(Global_1898164->f_1[0])))
	{
		func_130(&(Global_1898164->f_1[0]), 3);
	}
}
