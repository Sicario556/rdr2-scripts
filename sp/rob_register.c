...
void func_6()
{
	...
	if (!bLocal_19)
	{
		if ((has_anim_event_fired(Global_35, -1898385492) || has_anim_event_fired(Global_35, -834364808)) || has_anim_event_fired(Global_35, 15695821))
		{
			bLocal_19 = true;
			if (func_12(iLocal_20))
			{
...
int func_14()
{
	...
	while (iVar0 <= 25)
	{
		switch (iVar0)
		{
			...
			case 6:
			case 7:
				if (func_28(Global_1914319->f_3[iVar0]->f_25, Global_36))
				{
					return iVar0;
				}
				break;
...
int func_17(int iParam0, int iParam1)
{
	...
	iVar0 = func_31(iVar0, get_random_int_in_range(2000, 2200), get_random_int_in_range(2800, 3000));
	iVar1 = iVar0;
	iVar2 = floor((0.25f * IntToFloat(func_32(iParam0))));
...
void func_35(int iParam0, char* sParam1, int iParam2)
{
	...
	func_52(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
{
	func_86((get_game_timer() + iParam2), !bParam1);
...
void func_63(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_88(iParam0));
...
bool func_117(var uParam0, int iParam1, var uParam2, bool bParam3)
{
