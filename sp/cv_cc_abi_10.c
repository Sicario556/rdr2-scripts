...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1230724566, 0f, 0f, 0f, "CRATE 1", 0, 0, 1);
	iLocal_31 = func_152(uParam0, 1504738597, 0f, 0f, 0f, "CRATE 2", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_31, 0, 20f, 1065353216, 1);
	func_155(uParam0, iLocal_15, 1, 12, 0, 0, 0);
	func_156(uParam0, iLocal_15, 2, 343112864, "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_A", -1, 0, -1073741824, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	if ((func_198(uParam0, iLocal_19) && is_entity_occluded(func_48(uParam0, iLocal_15))) && func_199(Global_35, func_48(uParam0, iLocal_15), 0, 0) > 10f)
	{
...
bool func_294(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_199(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(747937920, 1) && !func_393((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
