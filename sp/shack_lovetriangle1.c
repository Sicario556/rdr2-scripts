...
bool func_12(var uParam0)
{
	if (!func_41(uParam0->f_3, 4))
	{
		if (func_42(uParam0))
		{
			...
			func_43(uParam0, 1, 0);
			func_43(uParam0, 2, 0);
			if (!is_entity_dead(&(uParam0->f_13[2])))
			{
				if (!_0x0e6846476906c9dd(get_player_index(), &(uParam0->f_13[2])))
				{
					_0x543dfe14be720027(get_player_index(), &(uParam0->f_13[2]), 0);
					_0x6ecfc621a168424c(&(uParam0->f_13[2]), &(uParam0->f_13[2]), 0, 0);
				}
			}
			if (!does_blip_exist(iLocal_195))
			{
				iLocal_195 = _blip_add_for_coord(-773443467, func_32(uParam0, 2));
			}
			if (!does_pickup_exist(iLocal_196))
			{
				func_44(&iLocal_197, 2);
				iLocal_196 = create_pickup_rotate(-70127024, func_36(uParam0, 0), func_37(uParam0, 0), iLocal_197, -1, 0, true, 0, 0, 0f, 0);
			}
	...
	else if (func_49(uParam0, 1126694912))
	{
		if (func_42(uParam0))
		{
			func_43(uParam0, 0, 0);
	...
	switch (Local_73)
	{
		...
		case 1:
			if (!func_41(uParam0->f_3, 4))
			{
				...
				if (does_entity_exist(&(uParam0->f_13[2])) && func_58(&(uParam0->f_13[2])))
				{
					func_59(&iLocal_195);
					_0x18ff3110cf47115d(&(uParam0->f_13[2]), 10, 1);
					_0x6569f31a01b4c097(&(uParam0->f_13[2]), 4, 1);
					func_54(&Local_73, 2, 1);
				}
			}
			break;
...
void func_20(var uParam0)
{
	if (!_does_volume_exist(uParam0->f_46))
	{
		if (!func_70(func_69(uParam0)))
		{
			...
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_69(uParam0), func_71(uParam0), func_72(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_69(uParam0), func_71(uParam0), func_72(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_41(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_78(func_77(uParam0->f_5), 2) && !func_79(128, 0, 1)) && !func_80(get_player_index(), 1, 1, 1)) && !func_81()) && !func_82(20)) && !func_78(func_77(uParam0->f_5), 4)) && !func_78(func_77(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_84(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_84(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_84(uParam0, iVar0, 0), iParam1, func_84(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_84(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
	...
	if (!&uParam0->f_6[iParam5] == 0)
	{
		if (!does_entity_exist(&(uParam0->f_13[iParam5])))
		{
			...
			if (uParam0->f_1 == 8192)
			{
				...
				{
					uParam0->f_13[iParam5] = func_91(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, 0, 1, 0, 0, 0, 0);
				}
				else
				{
					uParam0->f_13[iParam5] = func_91(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, iParam7, 1, 0, 0, 0, 0);
				}
			}
			else
			{
...
void func_43(var uParam0, int iParam1, int iParam2)
{
	if (does_entity_exist(&(uParam0->f_13[iParam1])))
	{
		...
		func_98(uParam0->f_13[iParam1], iParam2);
...
{
	if (!is_string_null_or_empty(func_84(uParam0, iParam2, 0)))
	{
...
void func_53(var uParam0)
{
			...
			case 2:
				if (func_110(Global_35, func_32(uParam0, 2), 1.6f, 1, 1))
				{
					if (does_entity_exist(&(uParam0->f_13[iVar0])))
					{
						...
						_0x18ff3110cf47115d(&(uParam0->f_13[iVar0]), 10, 0);
						_0x6569f31a01b4c097(&(uParam0->f_13[iVar0]), 4, 0);
	...
	func_115(Local_73.f_4[0], &(uParam0->f_13[3]), *Local_73.f_13[0], get_random_float_in_range(0f, 359f), -1f, 15f, *Local_73.f_13[0] + Vector(20f, 0f, 0f), 20f, 20f, 1084227584, 1f, 0, 0, 0);
	func_115(Local_73.f_4[1], &(uParam0->f_13[4]), *Local_73.f_13[1], get_random_float_in_range(0f, 359f), -1f, 15f, *Local_73.f_13[1] + Vector(20f, 0f, 0f), 20f, 20f, 1084227584, 1f, 0, 0, 0);
}
...
{
	if (!func_130(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_130(uParam0, iParam1), func_131(uParam0, iParam1), func_132(uParam0, iParam1), func_133(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
bool func_79(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_137(&(Global_1898164->f_1[0]));
		if (func_138(iVar0) && func_139((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_106(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_83(char* sParam0, vector3 vParam1, bool bParam4)
{
...
char* func_84(var uParam0, int iParam1, int iParam2)
{
	switch (uParam0->f_1)
	{
		...
		case 64:
			...
			break;
		case 4096:
			if (!func_41(uParam0->f_3, 4) || func_49(uParam0, 1126694912))
			{
				switch (iParam1)
				{
					case 0:
...
{
	if (_does_text_database_exist(func_141(uParam0)))
	{
		_text_database_request(func_141(uParam0));
	}
}
...
bool func_89(var uParam0)
{
	if (_does_text_database_exist(func_141(uParam0)))
	{
		if (!_text_database_has_loaded(func_141(uParam0)))
		{
			return false;
		}
	}
...
int func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_142(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
	...
	if (!is_string_null_or_empty(func_84(uParam0, iParam2, 0)))
	{
		if (_does_anim_scene_exist(*uParam1))
		{
			if (_is_anim_scene_loaded(*uParam1, true, false))
			{
				...
				if (!is_string_null_or_empty(func_84(uParam0, iParam2, 1)))
				{
					if (_0xa9016536015de29d(*uParam1, func_84(uParam0, iParam2, 1)))
					{
						_set_anim_scene_playback_list_bool(*uParam1, func_84(uParam0, iParam2, 1), true);
					}
				}
			}
		}
...
bool func_105(int iParam0, float fParam1)
{
	iVar0 = func_120(iParam0);
	if (iVar0 != 0)
	{
		*fParam1 = func_152(iParam0);
		return true;
	}
	else
	{
...
bool func_110(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
	...
	else if (func_154(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3)
{
	if (does_entity_exist(iParam0) && is_entity_a_ped(iParam0))
	{
		...
		func_157(iParam0, iParam1, iParam2, iVar0);
	}
...
void func_115(var uParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6, float fParam7, vector3 vParam8, int iParam11, int iParam12, float fParam13, var uParam14, bool bParam15, bool bParam16, bool bParam17)
{
	if (!func_158(iParam1, 0, 1))
	{
		return;
	}
	if (*uParam0 < 4)
	{
		if ((func_159(Global_35, iParam1, 1, 1) < fParam13 || is_player_free_aiming_at_entity(player_id(), iParam1)) || bParam16)
		{
			*uParam0 = 4;
		}
	}
	switch (*uParam0)
	{
		case 0:
			if (fParam6 != 0f)
			{
				func_160(iParam1, bParam17, &uVar0, &cVar8);
		...
		case 1:
			...
			else if (get_script_task_status(iParam1, -708058584, true) != 1 && func_163(iParam1, vParam2, 1) < 1f)
			{
				func_160(iParam1, bParam17, &uVar0, &cVar8);
				if (!is_string_null_or_empty(&uVar0))
				{
		...
		case 4:
			...
			else
			{
				...
				func_164(iParam1, &iVar16, 0.1f, 0.5f, 1, 1);
			}
			*uParam0 = 5;
			break;
		case 5:
...
void func_123(var uParam0)
{
	if (_does_text_database_exist(func_141(uParam0)))
	{
		if (_text_database_has_loaded(func_141(uParam0)))
		{
			_text_database_delete(func_141(uParam0));
		}
	}
}
...
void func_142(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
{
	return (shift_right(iParam0, 26) & 31 * func_176(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
var func_157(int iParam0, var uParam1, var uParam2, int iParam3)
{
	Var0.f_1 = 10;
	Var0.f_12 = 10;
	Var0 = 1;
...
float func_159(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_160(int iParam0, bool bParam1, char* sParam2, char* sParam3)
{
...
float func_163(int iParam0, vector3 vParam1, bool bParam4)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
