...
bool func_1(var uParam0)
{
	...
	_0xc67a4910425f11f1(player_id(), sLocal_66);
...
bool func_76(var uParam0)
{
	...
	iLocal_15 = func_157(uParam0, -1006095118, 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_160(uParam0, iLocal_14, 3, -1395525444, "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", iLocal_15, 0);
	func_161(uParam0, iLocal_14, 3, -1395525444, "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", iLocal_15, 0, -1073741824, 1065353216, 1);
...
bool func_97(var uParam0)
{
	...
	if (bLocal_62)
	{
		if (func_209(uParam0))
		{
			...
			{
				_0xe98d55c5983f2509(func_9(uParam0, iLocal_14));
				_0x3946fc742ac305cd(player_id(), func_9(uParam0, iLocal_14), sLocal_66, 0f, 0f, 0f, 0, sLocal_66);
			}
		...
		if ((bParam1 || !func_110(iParam0)) || func_55(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_220(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_222(iParam0);
					_0x7b204f88f6c3d287(func_223(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_223(iParam0, 0));
					func_224(iParam0);
				}
			}
			else
...
void func_121(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_234(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_238(iParam0), 137, true);
	}
}
...
void func_129(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_238(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_238(iParam0), 204, false);
	}
}
...
void func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_238(iParam0);
	if (((does_entity_exist(iVar1) && func_240(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_253(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_34(uParam0) < 5)
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_254(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_280(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_61(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_281(uParam0->f_107[iVar12]->f_2);
				}
				else if (func_54(uParam0->f_107[iVar12]->f_7))
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_221(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_218(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_176(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_218(uParam0->f_107[iVar0]->f_8.f_3))
			{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_282(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_283(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_180(var uParam0, int iParam1)
{
	...
	func_289(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_290(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_181(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_291(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_182(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_293(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_184(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_294(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_263(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_296(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_296(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_190(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_263(uParam0, uParam0->f_1976.f_1), 1, func_264(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_192(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_297(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_194(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_218(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
				iVar0 = func_298(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_298(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_195(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_117() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_292() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_310(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_311(uParam0->f_107[iVar0]->f_1, fVar4);
				func_310(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
int func_208(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			func_316(Global_40.f_6563[iVar0], iParam0);
			func_317(iParam0);
			if (bParam2)
			{
				func_318(Global_40.f_6563[iVar0]);
				if (!func_319(172))
				{
					func_320(172, 0);
				}
				func_321(Global_40.f_6563[iVar0], 0);
			}
			func_322(iVar0, 1);
			func_323();
...
bool func_209(var uParam0)
{
	...
	iLocal_65 = 0;
	_0x3ee1f7a8c32f24e1(player_id(), &iLocal_65, 0, 0);
	if (iLocal_65 == 0)
	{
		func_8(&iLocal_64, 1, 1);
		return false;
	}
	if (get_ped_index_from_entity_index(iLocal_65) != func_9(uParam0, iLocal_14))
	{
		func_8(&iLocal_64, 1, 1);
		return false;
	}
	if (!func_48(iLocal_64))
	{
		...
		func_327(iLocal_64, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
...
int func_221(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_333(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_223(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_334(iParam0);
	}
...
void func_239(int iParam0)
{
	if (func_54(iParam0))
	{
		if (does_entity_exist(func_238(iParam0)))
		{
...
bool func_277(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_263(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
bool func_287(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_298(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_298(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_305(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_364(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
void func_318(var uParam0)
{
	...
	iVar2 = get_hash_key(func_384(uParam0->f_3));
	if (!_uilog_is_entry_registered(8, iVar0))
	{
		_uilog_add_entry_hash(8, iVar0, func_385(func_24()), 1307979820, func_386(*uParam0), 0);
		...
		if (*uParam0 == 21)
		{
			...
			while (iVar3 < 6)
			{
				...
				{
					func_388(uParam0, iVar3, &(Global_1359489->f_361.f_258[iVar3]->f_2), 0, 1, 1);
				}
				iVar3++;
			}
		}
...
void func_321(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_393(&uVar4, 109029619);
		sVar2 = func_394(uParam0->f_3, 0);
		func_388(uParam0, 1896170705, _create_var_string(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_388(uParam0, 1896170705, _get_label_text_by_hash(iVar0), 0, bParam1, 0);
	}
}
...
bool func_338()
{
	if (_is_ped_carrying(Global_35) || func_401(Global_35))
	{
		return true;
	}
	return false;
...
int func_351(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_407(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!does_entity_exist(iVar1))
	{
		return 0;
	}
...
int func_354(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_281(iParam0), 0);
}
...
int func_355(int iParam0, bool bParam1)
{
	...
	{
		func_244(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_232() == -1)
		{
...
void func_368(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_311(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_372(var uParam0, int iParam1)
{
	...
	func_427(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_373(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_430(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_375(var uParam0, int iParam1)
{
	...
	{
		func_282(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_379(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_436(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_388(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	iVar0 = func_382(*uParam0);
	if (_uilog_is_entry_registered(8, iVar0))
	{
		_uilog_add_or_update_objective(8, func_382(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
			_uilog_set_pending_details_id(1, iVar0);
			Global_1359489->f_361.f_194 = func_438("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, get_hash_key(func_384(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_393(char* sParam0, int iParam1)
{
	...
	return func_445(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_394(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_446((*Global_1835011)[59]->f_1, 1) || func_446((*Global_1347702)[1]->f_15, 1)) || func_447((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
...
int func_407(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	if (!func_108(iParam1))
	{
		return 0;
...
bool func_410(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_446((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_417(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_54(iParam0))
	{
		return 0;
		...
		case 6:
			if (func_125(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_290(Global_1360165[iParam0], 1);
				}
			}
			func_460(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_289(Global_1360165[iParam0]))
				{
				}
			}
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_221(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_218(vVar0)) && !func_219(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
			...
			{
				_0x63aa2b8eb087886a(func_221(iParam0, 1), get_hash_key(sVar12));
			}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_498((*Global_1360165)[iParam0]->f_4.f_2) || func_447((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_463(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_236(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_236(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_236(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_236(iParam5, 32), true);
	...
	else if (func_236(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_236(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_236(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
bool func_469(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_242(iParam0)))
	{
		return false;
	}
...
bool func_481(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_488(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_221(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_291(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_489(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_520(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_490(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_238(iParam1)))
	{
		_0x931b241409216c1f(func_238(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_238(iParam1), iParam0);
...
int func_497(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_446((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_446((*Global_1347702)[63]->f_15, 1) || func_447((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_446((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_446((*Global_1347702)[134]->f_15, 1) || func_447((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_446((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_349(747937920, 1) && !func_446((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_238(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
bool func_547(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_436(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_548(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_436(bParam0));
}
...
bool func_557(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_436(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_558(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_436(bParam6), &Var0, 0);
	return uVar4;
}
