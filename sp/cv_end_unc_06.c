...
bool func_72(var uParam0)
{
	...
	iLocal_22 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_21 = func_152(uParam0, -1025740342, 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	func_153(uParam0, 0f, 0f, 0f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1877049591, 1, 1, 1);
	func_153(uParam0, 0f, 0f, 0f, 0f, 1.5f, 1.5f, 3f, -1612834106, -1749490051, 1, 1, 1);
	func_154(uParam0, "script@vignette@beecher@uncle_6@base", 1, 1, 0, 0);
	iLocal_14 = func_154(uParam0, "script@vignette@beecher@uncle_6@action_a", 2, 0, 1, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@beecher@uncle_6@action_b", 0, 0, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@uncle_6@action_b_alt_front", 0, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@uncle_6@action_b_alt_left", 0, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@beecher@uncle_6@action_b_alt_right", 0, 0, 0, 1);
	func_155(uParam0, -1912074901, 873025312);
	func_156(uParam0, iLocal_19, 3, 1051693614, "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 0);
	func_157(uParam0, iLocal_19, 3, 1051693614, "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", iLocal_21, 0, -1073741824, 1065353216, 1);
	...
	func_156(uParam0, iLocal_20, 3, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
	func_160(uParam0, iLocal_20, 1, -1);
	Local_23 = { func_161(uParam0, 1.7525f, -7.86f, 2.005f, 17.83f, 6.5f, 0.155f, 0.7225f) };
	Local_33 = { func_161(uParam0, 1.753f, -7.86f, 2.005f, 66.16f, 6.5f, 0.175f, 0.383f) };
	Local_43 = { func_161(uParam0, 1.753f, -7.86f, 2.005f, -51.41f, 6.5f, 0.048f, 0.428f) };
	return true;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_268(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_57(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_269(uParam0->f_107[iVar12]->f_2);
				}
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_270(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_271(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_176(var uParam0, int iParam1)
{
	...
	func_277(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_278(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_177(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_279(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_178(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_281(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_180(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_282(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_280() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_328(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_269(iParam0), 0);
}
		...
		case 6:
			if (func_120(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_278(Global_1360165[iParam0], 1);
				}
			}
			func_393(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_277(Global_1360165[iParam0]))
				{
				}
			}
...
int func_380(var uParam0, int iParam1)
{
	...
	{
		func_270(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
...
bool func_417(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_279(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
