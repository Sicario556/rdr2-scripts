...
{
	_0x6afda2264925bd11(iLocal_80);
	_0x18ff3110cf47115d(func_8(uParam0, iLocal_24), 7, 0);
	return true;
}
...
bool func_72(var uParam0)
{
	...
	iLocal_79 = _request_metaped_outfit(-541762431, -1153495004);
	_0xff745b0346e19e2c(iLocal_80);
	return true;
}
...
{
	if (_is_metaped_outfit_request_valid(iLocal_79))
	{
		if (!_0x610438375e5d1801(iLocal_79))
		{
			return false;
		}
	}
	...
	if (!_0xb8f52a3f84a7cc59(iLocal_80))
	{
		return false;
	}
	return true;
...
{
	if (does_entity_exist(func_8(uParam0, iLocal_24)))
	{
		func_190(func_8(uParam0, iLocal_24), 0);
		_0x18ff3110cf47115d(func_8(uParam0, iLocal_24), 7, 0);
		set_ped_config_flag(func_8(uParam0, iLocal_24), 243, true);
		_set_ped_body_component(func_8(uParam0, iLocal_24), -1153495004);
		_update_ped_variation(func_8(uParam0, iLocal_24), false, true, true, true, false);
		return true;
	}
	return false;
}
...
bool func_93(var uParam0)
{
	...
	{
		_0x18ff3110cf47115d(func_8(uParam0, iLocal_24), 7, 1);
		task_carriable(func_8(uParam0, iLocal_24), iLocal_80, func_8(uParam0, iLocal_14), 0, 0);
	}
	if (!bLocal_78)
	{
		if (func_201(uParam0, iLocal_14))
		{
			if (_0x61914209c36efddb(func_8(uParam0, iLocal_24)) == 5)
			{
				task_place_carried_entity_at_coord(func_8(uParam0, iLocal_14), func_8(uParam0, iLocal_24), vLocal_75, 1f, 0);
				bLocal_78 = true;
			}
		}
	}
	if (bLocal_78)
	{
		if (get_script_task_status(func_8(uParam0, iLocal_14), -208384378, true) == 8 && !_0x61914209c36efddb(func_8(uParam0, iLocal_24)) == 5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_395((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
