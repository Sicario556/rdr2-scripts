...
int func_55(bool bParam0)
{
	...
	get_group_size(func_79(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_79(), iVar3);
		if (func_80(iVar4))
		{
			iVar0++;
		}
...
bool func_57(bool bParam0, vector3 vParam1, int iParam4, int iParam5)
{
	if (bParam0)
	{
		...
		if (!bVar0)
		{
			if (Global_1393237->f_1 != 0 && (get_game_timer() - Global_1393237->f_1) < func_81(iParam5))
			{
				return false;
			}
		}
		...
		{
			if (get_game_timer() - Global_1393237->f_2) < func_82()
			{
				return false;
			}
		}
	...
	{
		if (&Global_1393237 != 0 && (&Global_1393237 - get_game_timer()) < func_83())
		{
			return false;
		}
		if (Global_1393237->f_2 != 0)
