...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_152(uParam0, -967333571, 0f, 0f, 0f, "p_cigarette01x", 0, 0, 1);
	if ((func_153(0) || func_153(1)) || func_153(2))
	{
		iLocal_16 = func_152(uParam0, -1025740342, -3.58517f, -0.34693f, -0.001983f, 0, 1, 0, 1);
		iLocal_17 = func_152(uParam0, -1025740342, -1.360719f, -1.095244f, -0.002578f, 0, 1, 0, 1);
	}
	else
	{
		iLocal_16 = func_152(uParam0, -1025740342, -3.58517f, -0.34693f, -0.001983f, "chair02x", 1, 0, 1);
		iLocal_17 = func_152(uParam0, -1025740342, -1.360719f, -1.095244f, -0.002578f, "p_chair02x^1", 1, 0, 1);
	}
	...
	func_157(uParam0, iLocal_14, 3, 201363338, "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_16, 0);
	func_158(uParam0, iLocal_14, 2, 201363338, "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_16, 0, -1f, 1065353216, 1);
	func_159(uParam0, iLocal_14, iLocal_18, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_160(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_17, 0);
	func_158(uParam0, iLocal_15, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_17, 0, -1f, 1065353216, 1);
...
bool func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_122(uParam0->f_107[iVar0]->f_1, 29, 1) || func_253(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_295(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_295(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_195(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_296(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_197(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_297(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_297(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_198(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_291() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_215(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_309(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
bool func_286(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_297(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_297(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
void func_314(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_264(100f, 140f);
			}
		}
...
bool func_322()
{
	if (_is_ped_carrying(Global_35) || func_358(Global_35))
	{
		return true;
	}
	return false;
...
int func_339(int iParam0, bool bParam1)
{
	...
	{
		func_243(iParam0, _create_persistent_character(func_132(iParam0)));
		if (func_231() == -1)
		{
...
void func_387(var uParam0, int iParam1)
{
	...
	func_418(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_388(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_421(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
bool func_428(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_460(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_398((*Global_1347702)[63]->f_15, 1) || func_439((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_398((*Global_1347702)[134]->f_15, 1) || func_439((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(747937920, 1) && !func_398((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		while (iVar28 < 4)
		{
			...
			if (func_485(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_489(0))
				{
					...
					func_490(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
struct<5> func_483(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_486(int iParam0, var uParam1, int iParam2)
{
...
bool func_488(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
...
void func_491(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_508(_get_weapon_clip_size(iParam0), iParam1);
...
struct<4> func_496(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_487(923904168, func_494(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_487(923904168, func_494(bParam0), -740156546, 0) };
		}
...
struct<4> func_498(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_487(271701509, func_494(bParam0), 12999093, 0) };
		}
...
bool func_501(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
