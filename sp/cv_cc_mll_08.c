...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -10.695f, 2.2941f, 1.1367f, -29f, 5f, 5f, 4f, -1612834106, -727195357, 1, 1, 1);
	func_151(uParam0, -14.0653f, -8.1077f, 1.3223f, -29f, 1.5f, 1.5f, 3f, -1612834106, -695792551, 1, 1, 1);
	func_152(uParam0, -1671495534, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, -1671495534, 0f, 0f, 0f, "CIGARETTE^1", 0, 1, 1);
	func_152(uParam0, 617552302, 0f, 0f, 0f, "MATCHSTICK", 0, 1, 1);
	func_153(uParam0, "script@vignette@molly_8@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@molly_8@action", 0, 0, 1, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@molly_8@idle", 2, 0, 0, 0);
	...
	func_156(uParam0, -213778173, -1525075102);
	func_157(uParam0, iLocal_17, -1, 0.87f);
	func_158(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
...
{
	uParam0->f_107[iLocal_14]->f_96 = { 1908.732f, -1818.967f, 41.9121f };
	return true;
}
...
{
	iVar0 = get_random_int_in_range(iLocal_18, iLocal_19 + 1);
	func_193(uParam0, iVar0, 1);
	func_194(uParam0, iVar0);
	func_192(uParam0, iLocal_16, 0);
	return true;
}
...
void func_161(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_195(uParam0, iVar1))
			{
...
void func_209(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_294(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
