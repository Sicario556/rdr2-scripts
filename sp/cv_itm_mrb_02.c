...
{
	_0xc67a4910425f11f1(player_id(), sLocal_33);
...
bool func_76(var uParam0)
{
	...
	iLocal_19 = func_156(uParam0, -862949069, 0f, 0f, 0f, "Ledger", 0, 0, 1);
	iLocal_18 = func_156(uParam0, -1167561544, 0f, 0f, 0f, "PENCIL", 0, 0, 1);
	...
	func_161(uParam0, iLocal_14, 2, -1273821262, "WORLD_HUMAN_WRITE_NOTEBOOK_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
...
bool func_94(var uParam0)
{
	if (!is_entity_dead(func_9(uParam0, iLocal_14)))
	{
		_0x3946fc742ac305cd(player_id(), func_9(uParam0, iLocal_14), sLocal_33, 0f, 0f, 0f, 0, sLocal_33);
		_0xe98d55c5983f2509(func_9(uParam0, iLocal_14));
	}
	func_8(&iLocal_31, 1, 1);
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_219(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_221(iParam0);
					_0x7b204f88f6c3d287(func_222(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_222(iParam0, 0));
					func_223(iParam0);
				}
			}
			else
...
void func_121(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_233(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_122(int iParam0, int iParam1, bool bParam2)
{
	...
	func_234(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_237(iParam0), 137, true);
	}
}
...
void func_129(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_237(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_237(iParam0), 204, false);
	}
}
...
void func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_237(iParam0);
	if (((does_entity_exist(iVar1) && func_239(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_252(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_34(uParam0) < 5)
			{
				if (func_127(uParam0->f_107[iVar0]->f_1, 29, 1) || func_253(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!is_model_valid(uParam0->f_107[iVar12]->f_3))
			{
				...
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_277(uParam0->f_107[iVar12]->f_1));
				}
				else if (func_61(uParam0->f_107[iVar12]->f_2))
				{
					uParam0->f_107[iVar12]->f_3 = func_278(uParam0->f_107[iVar12]->f_2);
				}
				else if (func_54(uParam0->f_107[iVar12]->f_7))
				{
					uParam0->f_107[iVar12]->f_3 = _0xa00df706c60173d1(func_220(uParam0->f_107[iVar12]->f_7, 1));
				}
			}
			if (!func_217(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_178(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_217(uParam0->f_107[iVar0]->f_8.f_3))
			{
			...
			else if (!uParam0->f_107[iVar0]->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_279(&(uParam0->f_107[iVar0]->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_280(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_182(var uParam0, int iParam1)
{
	...
	func_286(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_287(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_183(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_288(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_184(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_290(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_186(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_291(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_260(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_293(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_293(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_192(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_260(uParam0, uParam0->f_1976.f_1), 1, func_261(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_194(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_294(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_196(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_217(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
				iVar0 = func_295(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_295(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_197(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_117() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_289() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_198(var uParam0)
{
	...
	iLocal_32 = 0;
	_0x3ee1f7a8c32f24e1(player_id(), &iLocal_32, 0, 0);
	if (iLocal_32 == 0)
	{
		func_8(&iLocal_31, 1, 1);
		return 0;
	}
	if (get_ped_index_from_entity_index(iLocal_32) != func_9(uParam0, iLocal_14))
	{
		func_8(&iLocal_31, 1, 1);
		return 0;
	}
	...
	{
		iLocal_31 = func_302("INTERACT_GREET", -163964935, func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
		func_303(iLocal_31, _uiprompt_get_group_id_for_target_entity(func_9(uParam0, iLocal_14)), 0, 1);
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_310(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
...
int func_207(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			func_312(Global_40.f_6563[iVar0], iParam0);
			func_313(iParam0);
			if (bParam2)
			{
				func_314(Global_40.f_6563[iVar0]);
				if (!func_315(172))
				{
					func_316(172, 0);
				}
				func_317(Global_40.f_6563[iVar0], 0);
			}
			func_318(iVar0, 1);
			func_319();
...
void func_214(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_322(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
float func_219(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_327(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_220(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_328(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_222(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_329(iParam0);
	}
...
void func_238(int iParam0)
{
	if (func_54(iParam0))
	{
		if (does_entity_exist(func_237(iParam0)))
		{
...
bool func_251(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_335(&(Global_1898164->f_1[0]));
		if (func_336(iVar0) && func_337((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_338(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_54(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_347(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_348(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_348(uParam0, 1, 0);
							}
						}
						if (!func_54(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_349(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_267(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_350(iVar1)))
			{
				func_351(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_352(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_274(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_260(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
void func_282(var uParam0, int iParam1)
{
	...
	else if (!func_354(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
bool func_284(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_295(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_295(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
int func_302(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_216(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_360(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_306(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_363(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_365(-1780177928);
		...
		case 2:
			...
			uParam0->f_22 = func_365(1627068364);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_365(-1635450397);
		...
		case 7:
			...
			uParam0->f_22 = func_365(-755485480);
		...
		case 8:
			...
			uParam0->f_22 = func_365(-951828978);
		...
		case 11:
			...
			uParam0->f_22 = func_365(-2076104686);
		...
		case 13:
			...
			uParam0->f_22 = func_365(1478239863);
			break;
		case 14:
			...
			uParam0->f_22 = func_365(338147422);
		...
		case 16:
			...
			uParam0->f_22 = func_365(1483206625);
		...
		case 17:
			...
			uParam0->f_22 = func_365(-898386032);
		...
		case 19:
			...
			uParam0->f_22 = func_365(730856618);
		...
		case 20:
			...
			uParam0->f_22 = func_365(230530039);
...
void func_314(var uParam0)
{
	...
	iVar2 = get_hash_key(func_371(uParam0->f_3));
	if (!_uilog_is_entry_registered(8, iVar0))
	{
		_uilog_add_entry_hash(8, iVar0, func_372(func_24()), 1307979820, func_373(*uParam0), 0);
		_uilog_set_entry_icon_texture(8, iVar0, iVar2, 1997120069);
		_uilog_set_entry_brief_texture(8, iVar0, iVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_374(1, 688258043, 0);
			func_374(2, -1477273558, 0);
			func_374(3, 128702355, 0);
			func_374(4, 1613651027, 0);
			func_374(5, 0, -998653403);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
				...
				{
					func_375(uParam0, iVar3, &(Global_1359489->f_361.f_258[iVar3]->f_2), 0, 1, 1);
				}
				iVar3++;
			}
		}
...
void func_317(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_380(&uVar4, 109029619);
		sVar2 = func_381(uParam0->f_3, 0);
		func_375(uParam0, 1896170705, _create_var_string(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_375(uParam0, 1896170705, _get_label_text_by_hash(iVar0), 0, bParam1, 0);
	}
}
...
bool func_324(var uParam0, int iParam1)
{
	...
	{
		if (!func_354(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_325(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_345(100f, 140f);
			}
		}
...
bool func_333()
{
	if (_is_ped_carrying(Global_35) || func_388(Global_35))
	{
		return true;
	}
	return false;
...
int func_350(int iParam0)
{
	...
	return _0xe76687023d8c8505(func_278(iParam0), 0);
}
...
int func_351(int iParam0, bool bParam1)
{
	...
	{
		func_243(iParam0, _create_persistent_character(func_137(iParam0)));
		if (func_231() == -1)
		{
...
int func_366(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_422(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_375(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (_uilog_is_entry_registered(8, iVar0))
	{
		_uilog_add_or_update_objective(8, func_369(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
			_uilog_set_pending_details_id(1, iVar0);
			Global_1359489->f_361.f_194 = func_424("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, get_hash_key(func_371(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_380(char* sParam0, int iParam1)
{
	...
	return func_431(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_381(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_432((*Global_1835011)[59]->f_1, 1) || func_432((*Global_1347702)[1]->f_15, 1)) || func_433((*Global_1347702)[1]->f_15))
			{
				return "COMP_RUFUS";
			}
...
bool func_397(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_432((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_456(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_457(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_459(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_125(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_287(Global_1360165[iParam0], 1);
				}
			}
			func_453(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_286(Global_1360165[iParam0]))
				{
				}
			}
			func_461(iParam0, Global_1360165[iParam0]);
...
void func_438(var uParam0, int iParam1)
{
	...
	func_476(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_439(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_479(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_441(var uParam0, int iParam1)
{
	...
	{
		func_279(&(uParam0->f_107[iParam1]->f_32.f_21), 1, uParam0->f_107[iParam1]->f_32.f_13);
		bVar71 = Var1.f_10;
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_220(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_217(vVar0)) && !func_218(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_456((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			{
				_0x63aa2b8eb087886a(func_220(iParam0, 1), get_hash_key(sVar12));
			}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_495((*Global_1360165)[iParam0]->f_4.f_2) || func_433((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_496((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_498(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_107(iParam0, 44, 1);
			}
...
void func_456(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_503(Global_35) && is_player_teleport_active())
	{
	}
	if (func_504(iParam0))
	{
		if (func_505(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_235(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_235(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_235(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_235(iParam5, 32), true);
	...
	else if (func_235(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_235(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_235(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_461(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_512(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_512(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_462(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_241(iParam0)))
	{
		return false;
	}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_422(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_485(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_220(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_288(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_487(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_237(iParam1)))
	{
		_0x931b241409216c1f(func_237(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_237(iParam1), iParam0);
...
int func_494(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_432((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_432((*Global_1347702)[63]->f_15, 1) || func_433((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_432((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_432((*Global_1347702)[134]->f_15, 1) || func_433((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_432((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_344(747937920, 1) && !func_432((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_237(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_509(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_463(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_463(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_463(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_463(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_463(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_463(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_463(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_463(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_463(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_463(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_463(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_463(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_463(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_463(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_463(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_463(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_463(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_463(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_463(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_463(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_463(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_463(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_463(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_463(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_463(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_463(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_532(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_514(1328661203, func_537(), -1591664384, bParam0);
}
...
struct<4> func_514(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_422(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_544(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_547(0))
				{
					...
					func_548(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
bool func_546(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_422(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_547(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_422(bParam0));
}
...
void func_549(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_561(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_556(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_422(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_557(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_422(bParam6), &Var0, 0);
	return uVar4;
}
