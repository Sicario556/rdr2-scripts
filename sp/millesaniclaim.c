		...
		if (get_game_timer() > iLocal_26)
		{
			...
			switch (iLocal_25)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_27));
					...
					break;
				case 2:
					if (func_11() || iLocal_28 < get_game_timer())
					{
						func_12(iLocal_27);
						iLocal_28 = (get_game_timer() + iLocal_24);
						iLocal_25 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_27) || iLocal_28 < get_game_timer())
					{
						func_14(iLocal_27);
						iLocal_28 = (get_game_timer() + iLocal_24);
						iLocal_25 = 4;
				...
				case 6:
					if (func_7(func_6(iLocal_27)))
					{
						if (func_17(func_6(iLocal_27), 4) && !iLocal_28 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_27) || iLocal_28 < get_game_timer())
							{
								func_19(iLocal_27, 4);
								iLocal_28 = (iLocal_24 + get_game_timer());
								iLocal_25 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_28 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_27);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_27]->f_10);
							if ((*Global_1888801)[iLocal_27]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_27]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_27]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_27]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_14(int iParam0)
{
	...
	iLocal_0[0] = get_interior_at_coords(-1420.278f, 1171.593f, 226.7f);
	iLocal_0[1] = get_interior_at_coords(-1440.127f, 1189.548f, 226.4f);
	iLocal_0[2] = get_interior_at_coords(-1418.762f, 1197.32f, 225.4f);
	iLocal_0[3] = get_interior_at_coords(-1393.259f, 1181.42f, 222.2f);
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_53(&Global_1935630, 16384)) || func_53(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_56((*uParam0)[iVar3], 1) && func_57(iParam1)) && !func_58(iParam1, 16))
							{
								func_60(iParam1, func_59(), -1, 0, -1, 0);
								func_61((*uParam0)[iVar3], 1);
							}
							func_62(iParam1, 0);
						}
						bVar0 = true;
...
bool func_57(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_85(iParam0));
}
...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!func_86())
	{
		return;
	}
	sVar1 = func_87(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_99(&cVar6, 109029619), sVar9, func_99(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_99(&cVar6, 109029619), func_99(&cVar10, 109029619));
		}
...
void func_75(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_117(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
bool func_80(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_20() != -1;
	switch (iParam0)
	{
...
char* func_87(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
...
char* func_99(char* sParam0, int iParam1)
{
	...
	return func_133(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_102(int iParam0)
{
	...
	if (func_134())
	{
		if (!func_135((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_139(Global_1935369->f_5[iParam0]->f_6, 1);
	func_140(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_81(Global_1914319->f_3[iParam0]->f_21) && func_142(Global_1914319->f_3[iParam0]->f_21))
	{
		func_143(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_144(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_117(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_127(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_154(&(Global_1898164->f_1[0]));
		if (func_155(iVar0) && func_156((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_162(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
bool func_158(vector3 vParam0, int iParam3)
{
	func_175(iParam3, &vVar0, &Var3, &uVar6);
	if (func_176(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
