...
{
	func_44(Global_35);
	set_entity_coords(Global_35, (*Global_1835011)[4]->f_18, true, false, true, true);
	start_player_teleport(get_player_index(), (*Global_1835011)[4]->f_18, 0f, false, true, true, false);
	func_25(&uLocal_3, 0);
	set_bit(&(Global_1956580->f_1), 5);
	return 1;
}
...
bool func_23(var uParam0)
{
	...
	if (_has_player_teleport_finished(get_player_index()) && !func_46(&uLocal_6))
	{
		func_25(&uLocal_6, 0);
	}
	...
	if (func_45(&uLocal_3) >= 22.5f)
	{
		...
		else if (!is_player_teleport_active())
		{
			return true;
		}
	}
...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_69(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_71(iParam0);
					_0x7b204f88f6c3d287(func_72(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_72(iParam0, 0));
					func_73(iParam0);
				}
			}
			else
...
int func_70(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_79(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_72(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_80(iParam0);
	}
