...
bool func_72(var uParam0)
{
	...
	iLocal_22 = func_153(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_23 = func_153(uParam0, -1006095118, 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_23, 0, -1073741824, 1065353216, 1);
...
{
	set_anim_scene_origin(&(uParam0->f_1984[iParam1]), uParam0->f_23, uParam0->f_26, 2);
...
bool func_303(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_208(Global_35, uParam0->f_107[iVar1]->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
void func_428(int iParam0, int iParam1)
{
	...
	func_379(iParam0, func_460(iParam1));
