...
void func_20(var uParam0)
{
	if (!_does_volume_exist(uParam0->f_46))
	{
		if (!func_63(func_62(uParam0)))
		{
			...
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_62(uParam0), func_64(uParam0), func_65(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_62(uParam0), func_64(uParam0), func_65(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_45(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_71(func_70(uParam0->f_5), 2) && !func_72(128, 0, 1)) && !func_73(get_player_index(), 1, 1, 1)) && !func_74()) && !func_75(20)) && !func_71(func_70(uParam0->f_5), 4)) && !func_71(func_70(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_76(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_76(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_76(uParam0, iVar0, 0), iParam1, func_76(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_76(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
...
{
	if (!is_string_null_or_empty(func_76(uParam0, iParam2, 0)))
	{
...
bool func_87(int iParam0, float fParam1)
{
	iVar0 = func_99(iParam0);
	if (iVar0 != 0)
	{
		*fParam1 = func_128(iParam0);
		return true;
	}
	else
	{
	...
	if (!is_string_null_or_empty(func_76(uParam0, iParam2, 0)))
	{
		if (_does_anim_scene_exist(*uParam1))
		{
			if (_is_anim_scene_loaded(*uParam1, true, false))
			{
				...
				if (!is_string_null_or_empty(func_76(uParam0, iParam2, 1)))
				{
					if (_0xa9016536015de29d(*uParam1, func_76(uParam0, iParam2, 1)))
					{
						_set_anim_scene_playback_list_bool(*uParam1, func_76(uParam0, iParam2, 1), true);
					}
				}
			}
		}
