...
bool func_1(var uParam0)
{
	...
	{
		set_blocking_of_non_temporary_events(func_8(uParam0, iLocal_14), false);
	}
	return true;
}
...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1732833419, 0f, 0f, 0f, "SHEERS", 0, 1, 1);
	iLocal_14 = func_153(uParam0, 40345436, "SHEEP");
...
bool func_93(var uParam0)
{
	...
	if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_18]), "SHEEP"))
	{
		func_111(&uLocal_23, 0f);
		set_blocking_of_non_temporary_events(func_8(uParam0, iLocal_14), true);
		open_sequence_task(&iVar0);
		task_follow_nav_mesh_to_coord(0, -1584.05f, -1433.536f, 80.3732f, fLocal_21, -1, 0.25f, 4194305, 40000f);
		task_start_scenario_at_position(0, 1923438725, -1608.52f, -1419.41f, 80.95f, 44.308f, 30000, true, false, 0, -1f, false);
		close_sequence_task(iVar0);
		task_perform_sequence(func_8(uParam0, iLocal_14), iVar0);
		clear_sequence_task(&iVar0);
		func_115(&uLocal_26, 0);
		_0x2208438012482a1a(func_8(uParam0, iLocal_14), true, false);
	}
	return true;
}
...
bool func_95(var uParam0)
{
	...
	{
		set_ped_desired_move_blend_ratio(func_8(uParam0, iLocal_14), func_207());
	}
	if (_is_ped_using_scenario_hash(func_8(uParam0, iLocal_14), 1923438725) && is_ped_active_in_scenario(func_8(uParam0, iLocal_14), 0))
	{
		set_ped_keep_task(func_8(uParam0, iLocal_14), true);
		return true;
	}
