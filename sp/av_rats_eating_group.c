void __EntryFunction__()
{
	...
	Var0 = Local_43;
	Var0.f_1 = Local_43.f_11;
	Var0.f_483 = { Local_43.f_1 };
	Var0.f_486 = { Local_43.f_4 };
	Var0.f_489 = Local_43.f_7;
	Var0.f_20[0] = Local_43.f_8;
	Var0.f_453 = Local_43.f_9;
	Var0.f_500 = Local_43.f_10;
	Var0.f_503 = Local_43.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "REG_RAT_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "REG_RAT_2", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.25f, 0.25f, 0f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "REG_RAT_3", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, 0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "REG_RAT_4", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, 0f, 0f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "REG_RAT_5", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.5f, 0f, 0f), (-100f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 5, "REG_RAT_6", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, -0.5f, -0.25f, 0f), (-135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "REG_RAT_7", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -0.5f, 0f), (-145f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 7, "REG_RAT_8", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, -0.5f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "REG_RAT_9", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.5f, -0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 9, "REG_RAT_10", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, -0.75f, 0f), (50f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_10)
	{
		case 0:
			...
			while (iVar1 < 10)
			{
				...
				{
					func_61(&(uParam0->f_20[iVar1]->f_5), 1, 5, 0);
					task_start_scenario_at_position(&(uParam0->f_20[iVar1]), -1756372705, uParam0->f_20[iVar1]->f_5, uParam0->f_20[iVar1]->f_8, 0, false, true, 0, -1f, false);
					func_62(uParam0->f_20[iVar1], 1, 1);
				}
				iVar1++;
			}
			iLocal_10 = 1;
		...
		case 1:
			...
			else
			{
				...
				while (iVar1 < 10)
				{
					if (!is_entity_dead(&(uParam0->f_20[iVar1])))
					{
						if (func_64(&(uParam0->f_20[iVar1]), 0, &uLocal_11, &uVar0, 0, 0))
						{
							bVar2 = true;
						}
						else
						...
						Jump @450; //curOff = 289
						if (does_entity_exist(&(uParam0->f_20[iLocal_42])))
						{
							if (!is_entity_dead(&(uParam0->f_20[iLocal_42])) && !is_entity_dead(Global_35))
							{
								func_62(uParam0->f_20[iLocal_42], 0, 1);
								_task_smart_flee_style_ped(&(uParam0->f_20[iLocal_42]), Global_35, 3, 0, -1082130432, -1, 0);
								set_ped_config_flag(&(uParam0->f_20[iLocal_42]), 230, true);
							}
							set_ped_as_no_longer_needed(uParam0->f_20[iLocal_42]);
						}
						iLocal_42++;
						if (iLocal_42 >= 10)
						{
...
bool func_48(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_84(&(Global_1898164->f_1[0]));
		if (func_85(iVar0) && func_86((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_87(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_63(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_102(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_64(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_112(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
bool func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_140(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_140(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
float func_102(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_155(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_159(1) || *uParam0 & 8192 != 0))
				{
...
bool func_110(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_172(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_170(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_171(uParam2)
				{
					func_166(uParam2, 1);
					return true;
				}
...
bool func_111(int iParam0, var uParam1)
{
	...
	if (func_162(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_171(uParam1)
		{
...
bool func_114(var uParam0, int iParam1, var uParam2)
{
	if (!is_entity_dead(iParam1))
	{
...
bool func_115(var uParam0, int iParam1, var uParam2)
{
...
bool func_116(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_134(int iParam0, var uParam1)
{
	...
	{
		return func_196(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_136(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_197(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_197(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_197(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_137(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_140(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_162(int iParam0, var uParam1, int iParam2)
{
...
bool func_165(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_185(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_212(iVar0, 0)))
		{
...
bool func_170(var uParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_172(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_212(iVar0, 0)))
		{
			if (func_214(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_177(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_181(var uParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_217(iParam1))
	{
...
bool func_183(int iParam0, int iParam1)
{
	...
	if (func_218(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
bool func_186(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_191(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_185(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_192(int iParam0, var uParam1, bool bParam2)
{
...
int func_194(int iParam0)
{
	...
	return func_220((*Global_1347702)[58]->f_15, 1);
}
...
bool func_208(bool bParam0, int iParam1, int iParam2)
{
...
bool func_213(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_214(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_214(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_216(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
