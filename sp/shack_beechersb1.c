...
bool func_18(var uParam0)
{
	...
	if (Local_73 >= 1)
	{
		...
		{
			if (_does_volume_exist(Local_73.f_141) && is_entity_in_volume(Global_35, Local_73.f_141, true, 0))
			{
				func_48(uParam0);
			}
		}
...
{
	Local_73.f_141 = _create_volume_cylinder_with_custom_name(1438.785f, -1598.566f, 70.11337f, 0f, 0f, -26.22593f, 57.5746f, 59.20185f, 36.47224f, "BeechersB_Discovery");
	return true;
}
