		...
		if (get_game_timer() > iLocal_16)
		{
			...
			switch (iLocal_15)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_17));
					...
					Global_1897950 = -1;
					iLocal_18 = (get_game_timer() + iLocal_14);
					iLocal_15 = 2;
					break;
				case 2:
					if (func_11() || iLocal_18 < get_game_timer())
					{
						func_12(iLocal_17);
						iLocal_18 = (get_game_timer() + iLocal_14);
						iLocal_15 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_17) || iLocal_18 < get_game_timer())
					{
						func_14(iLocal_17);
						iLocal_18 = (get_game_timer() + iLocal_14);
						iLocal_15 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_17) || iLocal_18 < get_game_timer())
					{
						func_16(iLocal_17);
						iLocal_18 = (iLocal_14 + get_game_timer());
						iLocal_15 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_17)))
					{
						if (func_17(func_6(iLocal_17), 4) && !iLocal_18 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_17) || iLocal_18 < get_game_timer())
							{
								func_19(iLocal_17, 4);
								iLocal_18 = (iLocal_14 + get_game_timer());
								iLocal_15 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_18 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_17);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_17]->f_10);
							if ((*Global_1888801)[iLocal_17]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_17]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_17]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_17]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_57(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_86(iParam0));
}
...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_88(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_100(&cVar6, 109029619), sVar9, func_100(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_100(&cVar6, 109029619), func_100(&cVar10, 109029619));
		}
...
void func_75(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_118(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
char* func_88(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
...
bool func_103(int iParam0)
{
	...
	if (func_136())
	{
		if (!func_137((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_141(Global_1935369->f_5[iParam0]->f_6, 1);
	func_142(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_82(Global_1914319->f_3[iParam0]->f_21) && func_144(Global_1914319->f_3[iParam0]->f_21))
	{
		func_145(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_146(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_118(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_129(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_156(&(Global_1898164->f_1[0]));
		if (func_157(iVar0) && func_158((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_159(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
{
	func_164(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
