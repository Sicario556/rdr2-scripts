...
bool func_11()
{
	if (func_20() == -1)
	{
		iLocal_9 = _create_volume_box_with_custom_name(2076.216f, 1001.187f, 112.332f, 0f, 0f, 13.199f, 14.446f, 11.798f, 3.385f, "Roanoke Trapper - m_volTrapper");
		iLocal_10 = _create_volume_box_with_custom_name(2076.577f, 1000.768f, 113.832f, 0f, 0f, 14.334f, 1.507f, 2.813f, 4.877f, "Roanoke Trapper - m_volTrapperPrompt");
		iLocal_11 = _create_volume_box_with_custom_name(2073.717f, 1000.015f, 113.832f, 0f, 0f, 14.334f, 3.821f, 4.158f, 4.877f, "Roanoke Trapper - m_volTrapperOfflimits");
	}
	return true;
}
