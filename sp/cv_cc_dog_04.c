...
bool func_93(var uParam0)
{
	if (!bLocal_17)
	{
		...
		{
			_0x2e1d6d87346bb7d2(func_48(uParam0, iLocal_14), func_48(uParam0, iLocal_15), 0, 0);
			bLocal_17 = true;
		}
	}
	if (func_202(uParam0, iLocal_14) && !bLocal_18)
	{
		set_ped_config_flag(func_48(uParam0, iLocal_14), 447, true);
		open_sequence_task(&iVar0);
		task_force_motion_state(0, -1415276238, true);
		task_smart_flee_ped(0, func_48(uParam0, iLocal_15), 15f, 2000, 65792, 1.6001f, 0);
	...
	if (bLocal_18)
	{
		if (!is_entity_dead(func_48(uParam0, iLocal_14)))
		{
			if (func_203(func_48(uParam0, iLocal_14), 258748395))
			{
				set_ped_config_flag(func_48(uParam0, iLocal_14), 447, false);
				func_204(uParam0, iLocal_14, 1, 1);
			}
			if (!bLocal_19 && !func_203(func_48(uParam0, iLocal_14), 242628503))
			{
				task_persistent_character(func_48(uParam0, iLocal_14));
				bLocal_19 = true;
			}
		}
	}
...
bool func_202(var uParam0, int iParam1)
{
	...
	{
		if (!func_203(uParam0->f_107[iParam1]->f_5, 1435919172))
		{
			return true;
		}
	}
...
void func_204(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_309(100f, 140f);
			}
		}
...
void func_212(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_201(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_282(var uParam0, int iParam1)
{
	...
	else if (!func_203(uParam0->f_107[iParam1]->f_5, -76381094))
	{
...
void func_403(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_361(iParam0, 8))
		{
