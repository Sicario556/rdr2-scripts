...
bool func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_19, 3, 2095565963, "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0);
	func_157(uParam0, iLocal_19, 3, 2095565963, "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0, -1073741824, 1065353216, 1);
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_296(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
