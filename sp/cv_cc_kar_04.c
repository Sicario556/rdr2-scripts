...
{
	_0xde7b2b4144906cdf(585448480, func_8(uParam0, iLocal_14));
	return true;
}
...
bool func_72(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 3, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824, 1065353216, 1);
...
bool func_77(var uParam0)
{
	...
	if (does_entity_exist(iVar0))
	{
		_0xf7ea250b9a919e03(585448480, iVar0);
		if (_0x854bc9b1a1ccd034(585448480, iVar0))
		{
			return true;
		}
	}
...
bool func_93(var uParam0)
{
	...
	{
		_0x3bbdd6143ff16f98(func_8(uParam0, iLocal_14), func_202(uParam0, iLocal_17), "p_bottleJD01x_ph_r_hand", "WORLD_HUMAN_LEAN_BACK_WALL", 0, 1);
		bLocal_18 = true;
	}
	if (bLocal_18)
	{
		set_ped_reset_flag(func_8(uParam0, iLocal_14), 202, true);
	}
	return true;
}
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_257(func_148(uParam0), func_256(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
