...
bool func_1(var uParam0)
{
	...
	if (is_door_registered_with_system(867489680))
	{
		func_9(867489680);
	}
	func_10(iLocal_53);
...
bool func_78(var uParam0)
{
	...
	iLocal_15 = func_158(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_16 = func_158(uParam0, 1159859573, 3.388f, -3.688f, 0f, "CHAIR", 1, 0, 1);
	...
	func_164(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
...
bool func_90(var uParam0)
{
	...
	if (is_door_registered_with_system(867489680))
	{
		iLocal_54 = get_object_index_from_entity_index(func_181(867489680, 1, 0));
	}
...
bool func_99(var uParam0)
{
	...
	{
		if (_0x005e6f28dd7ed58d(&(uParam0->f_1984[iLocal_17]), "DOOR"))
		{
			if (is_door_registered_with_system(867489680))
			{
				func_9(867489680);
...
bool func_150(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_129(uParam0->f_107[iVar0]->f_1, 29, 1) || func_255(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0]->f_5 && !does_entity_exist(uParam0->f_1711[iVar0]->f_10))
			{
				...
				{
					vVar3 = { func_264(uParam0, uParam0->f_1711[iVar0]->f_1) };
				}
				else
				{
...
void func_194(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_264(uParam0, uParam0->f_1976.f_1), 1, func_265(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_199(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_119() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_295() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
bool func_279(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1]->f_5)
		{
			...
			{
				vVar2 = { func_264(uParam0, uParam0->f_1711[iVar1]->f_1) };
			}
			else
			{
...
int func_341(int iParam0, bool bParam1)
{
	...
	{
		func_245(iParam0, _create_persistent_character(func_139(iParam0)));
		if (func_233() == -1)
		{
