...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			func_149(uParam0, -1360.106f, 2438.302f, 307.8079f, 0f, 0f, -20f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 1.2356f, 0.9457f, 0.9668f, 4.75f, 4.2f, 2f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, 1.0625f, 1.0873f, 1.15f, 38.56f, 1f, 1f, 2.685f, 665633627, 1);
	func_153(uParam0, -940999254, 0f, 0f, 0f, "BIBLE", 0, 0, 1);
	func_153(uParam0, 998759471, 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	func_153(uParam0, -1588007813, 0f, 0f, 0f, "p_crate14x", 0, 0, 1);
	func_154(uParam0, "script@vignette@dutch_and_hosea_1@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@dutch_and_hosea_1@action", 0, 0, 1, 0);
	func_155(uParam0, "CDH1AUD");
	func_156(uParam0, -891354566, 1330421250);
...
bool func_190(int iParam0, bool bParam1)
{
	if (does_entity_exist(iParam0))
	{
		if (!is_ped_injured(iParam0) || !bParam1)
		{
			...
			{
				if (func_289(iVar0) || func_290(iVar0))
				{
					return false;
				}
				return true;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(747937920, 1) && !func_380((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
