...
bool func_87(var uParam0)
{
	...
	if (does_entity_exist(iVar0))
	{
		set_entity_coords(iVar0, -149.32f, -14.34f, 95.26f, true, false, true, true);
	}
	return true;
}
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_250(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_335(int iParam0, bool bParam1)
{
	...
	{
		func_240(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_228() == -1)
		{
