...
bool func_1(var uParam0)
{
	...
	set_ped_config_flag(iVar0, 441, false);
	...
	set_ped_config_flag(iVar0, 419, false);
	set_ped_config_flag(iVar0, 471, false);
	func_9(iVar0, 0);
	if (does_entity_exist(func_8(uParam0, iLocal_15)))
	{
		delete_ped(&(uParam0->f_107[iLocal_15]->f_5));
		delete_ped(&(uParam0->f_107[iLocal_16]->f_5));
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	iLocal_17 = func_155(uParam0, -1006095118, -0.274352f, -1.19492f, -0.00502014f, "p_chairfolding02x", 1, 0, 1);
	...
	func_159(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824, 1065353216, 1);
...
bool func_87(var uParam0)
{
	...
	set_ped_config_flag(iVar0, 441, true);
	...
	set_ped_config_flag(iVar0, 419, true);
	set_ped_config_flag(iVar0, 471, true);
	set_ped_relationship_group_hash(func_8(uParam0, iLocal_15), -1538724068);
	func_9(iVar0, 1);
	task_start_scenario_at_position(iVar0, 696740378, -104.9883f, -18.30921f, 94.85979f, -48.94f, 0, false, true, 0, -1f, false);
	return true;
}
...
{
	if (is_ped_injured(func_8(uParam0, iLocal_15)) || is_ped_dead_or_dying(func_8(uParam0, iLocal_15), true))
	{
		return true;
	}
	if (bLocal_19)
	{
		...
		if (does_entity_exist(func_8(uParam0, iLocal_15)))
		{
			if (func_207(uParam0->f_107[iLocal_15]->f_5))
			{
				if (is_entity_occluded(func_8(uParam0, iLocal_15)))
				{
	...
	if (!bLocal_19)
	{
		...
		task_mount_animal(0, func_8(uParam0, iLocal_16), 20000, -1, 1f, 1, 0, 0);
		_task_move_in_traffic_4(0, 3f, -22.18789f, 57.58458f, 90.87619f, 1);
		_task_move_in_traffic(0, 3f, 256, 0);
		close_sequence_task(iVar7);
		task_perform_sequence(func_8(uParam0, iLocal_15), iVar7);
...
bool func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123(uParam0->f_107[iVar0]->f_1, 29, 1) || func_243(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_281() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_329(int iParam0, bool bParam1)
{
	...
	{
		func_233(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_221() == -1)
		{
