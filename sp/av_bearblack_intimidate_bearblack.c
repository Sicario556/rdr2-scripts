void __EntryFunction__()
{
	...
	sLocal_39 = "dead_left";
	iLocal_40 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 11170, 11259, 12125);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 2, "carcass", 1110710183, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 0f), (vParam4.z - 90f), 1, 0, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	...
	if (!_has_scenario_type_loaded(-1814089768, false))
	{
		return 0;
	}
	return func_49(uParam0, uParam0->f_20[2]->f_5);
}
...
bool func_28(var uParam0)
{
	...
	if (!_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[0])) || !_0x854bc9b1a1ccd034(-1918659017, &(uParam0->f_20[1])))
	{
		return false;
	}
	...
	if (!is_entity_dead(&(uParam0->f_20[2])))
	{
		...
		task_play_anim(&(uParam0->f_20[2]), sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		_0x3ca5e58c9731a16b(&(uParam0->f_20[2]), iLocal_40);
		_0x674b90be1115846d(&(uParam0->f_20[2]), 1);
		set_ped_keep_task(&(uParam0->f_20[2]), true);
		set_entity_no_collision_entity(&(uParam0->f_20[2]), &(uParam0->f_20[0]), true);
		set_entity_no_collision_entity(&(uParam0->f_20[0]), &(uParam0->f_20[2]), true);
	}
	return true;
}
...
int func_30(var uParam0)
{
	...
	_request_scenario_type(-1814089768, 1, 730092646, 0);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (bLocal_44)
		{
			if ((!has_anim_event_fired(&(uParam0->f_20[1]), 725039534) || is_entity_dead(&(uParam0->f_20[0]))) || is_entity_dead(&(uParam0->f_20[1])))
			{
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!&uParam0->f_469[3])
							{
								...
								{
									_task_start_scenario_in_place(&(uParam0->f_20[0]), -1814089768, 35000, false, 0, -1f, false);
							...
							if (!&uParam0->f_469[4])
							{
								...
								{
									_task_smart_flee_style_ped(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 3, 256, -1082130432, -1, 0);
...
void func_72(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		if (!func_110(&(uParam0->f_20[0]), 518218985))
		{
	...
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (!func_110(&(uParam0->f_20[1]), 518218985))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_116(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_116(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_68(&(uParam0->f_490)))
							{
