...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 264425748, -0.584518f, -1.37169f, -0.000602722f, "SEAT_JAVIER", 1, 0, 1);
	func_152(uParam0, 1230724566, 1.42059f, -0.462698f, 0.000679016f, "SEAT_MICAH", 1, 0, 1);
	func_152(uParam0, 986312695, 0f, 0f, 0f, "GLASS_MICAH", 0, 0, 1);
	func_152(uParam0, 986312695, 0f, 0f, 0f, "GLASS_JAVIER", 0, 0, 1);
	func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 2, 1152090473, "PROP_HUMAN_PASSED_OUT_TABLE_MALE_C", -1, 0, get_random_float_in_range(70f, 120f), 1065353216, 1);
	func_156(uParam0, iLocal_14, 4, 5, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, 2042728829, 0, -1, 0, -1073741824, 1065353216, 1);
...
{
	set_current_ped_weapon(func_48(uParam0, iLocal_14), -1569615261, true, 0, false, false);
	set_current_ped_weapon(func_48(uParam0, iLocal_15), -1569615261, true, 0, false, false);
	if (func_148(uParam0) == 3)
	{
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1]->f_32.f_5 = { func_256(func_148(uParam0), func_255(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(747937920, 1) && !func_393((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
