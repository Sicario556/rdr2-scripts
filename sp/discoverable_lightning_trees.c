...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		case 0:
			...
			if ((func_51() && func_52()) && !_is_ped_getting_into_a_mount_seat(Global_35, true))
			{
				func_50(&Local_14, 1);
			}
			break;
		case 1:
			...
			break;
		case 2:
			if ((!func_51() || !func_52()) || is_ped_on_mount(Global_35))
			{
				func_50(&Local_14, 0);
			}
			if (_does_volume_exist(&(Local_14.f_2[0])) && is_entity_in_volume(Global_35, &(Local_14.f_2[0]), true, 0))
			{
				if (!func_39(Local_14.f_7, 2) && _0xe368e8422c860ba7("LIGHTENING_STRIKE", "DSLIT_Sounds", -2))
				{
				...
				if (!func_24(&(Local_14.f_4)))
				{
					...
					request_anim_dict(func_55(func_15()));
				}
				if (func_26(&(Local_14.f_4)) > 3000 && has_anim_dict_loaded(func_55(func_15())))
				{
					func_50(&Local_14, 3);
				}
			}
		...
		case 4:
			...
			{
				_play_sound_from_position("LIGHTENING_STRIKE", get_entity_coords(Global_35, true, false), "DSLIT_Sounds", false, 0, true, 0);
				func_40(&(Local_14.f_7), 4);
			}
			if (func_39(Local_14.f_7, 1) && func_26(&(Local_14.f_4)) > 500)
			{
				vVar11 = { get_entity_coords(Global_35, true, false) };
				vVar11.f_2 = (vVar11.z - 1f);
				use_particle_fx_asset("scr_dis_ligtn_trees");
				start_particle_fx_non_looped_at_coord("scr_crackpot_rc_lightening", vVar11, 0f, 0f, 0f, 1f, false, false, false);
				start_particle_fx_non_looped_at_coord("scr_crackpot_rc_lightening_exp", vVar11, 0f, 0f, 0f, 1f, false, false, false);
				func_43(&(Local_14.f_7), 1);
				task_play_anim(Global_35, func_55(func_15()), func_56(0), 8f, -8f, -1, 2, 0f, false, 0, false, 0, false);
				_set_entity_health(Global_35, 1, 0);
			}
...
{
	if (_does_volume_exist(&(Local_14.f_2[0])))
	{
		_delete_volume(&(Local_14.f_2[0]));
	}
}
...
int func_26(var uParam0)
{
	...
	return (func_71() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_74(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_81(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_81(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_82(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_82(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_83(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_97(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	...
	{
		func_100(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
...
bool func_54(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, char* sParam11)
{
	if (!_does_volume_exist(*uParam0))
	{
...
void func_67(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_109(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_109(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_73(var uParam0, int iParam1)
{
	...
	if (!func_114(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
void func_80(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_122(iParam0, 8))
		{
...
void func_83(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_124(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_124(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_91()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_121(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_129(0), iVar0, 0))
	{
		return false;
	}
...
void func_100(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = func_131();
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_143(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_143(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_143(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_143(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
{
	return func_145(get_clock_hours(), iParam0, iParam1);
}
...
bool func_113(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_152(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_119(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_114(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_132(int iParam0)
{
	...
	fVar1 = func_168(absf(fVar1) < 1f, func_168(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_171((get_game_timer() + iParam2), !bParam1);
...
void func_138(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_173(iParam0));
...
bool func_157(int iParam0)
{
	...
	if (!func_114(iParam0, 16) && !func_186(iVar0, 0))
	{
		return false;
	}
	return true;
...
int func_165(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_129(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_129(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_129(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_205(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_129(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
