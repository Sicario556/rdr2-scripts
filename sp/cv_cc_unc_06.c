...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.375f, -2.275f, 0.807f, 89f, 1f, 1f, 3.1425f, -1612834106, 1877049591, 1, 1, 1);
	func_151(uParam0, -0.8625f, -3.225f, 0.807f, 89f, 2.13f, 2.1625f, 3.1425f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, 1789147356, 0f, 0f, 0f, "SOCK", 0, 1, 1);
	func_153(uParam0, "script@vignette@uncle_6@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@uncle_6@action", 0, 0, 1, 0);
	func_154(uParam0, "CUNC6AU");
	func_155(uParam0, -1109002052, 313171039);
	func_156(uParam0, iLocal_16, -1, 0.91f);
	func_157(uParam0, iLocal_15, 3, 1455795772, "WORLD_HUMAN_PEE_MALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_14, 2, -2118813809, "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
