void __EntryFunction__()
{
	...
	func_4(&uScriptParam_0, &Local_51);
	while (!func_5(&Local_51, 1))
	{
		if (func_6(&Local_51) != 10)
		{
			if ((func_6(&Local_51) == 3 || func_6(&Local_51) == 4) && (!func_7(&Local_51) || func_8(&(Local_51.f_958)) > 0))
			{
				func_9(&Local_51, func_5(&Local_51, 67108864));
				bVar0 = true;
			}
			if ((!bVar0 && func_10(&Local_51)) && func_5(&Local_51, 65536))
			{
				func_9(&Local_51, 1);
			}
		}
		if (func_6(&Local_51) >= 3 && func_6(&Local_51) <= 7)
		{
			func_11(&Local_51);
		}
		if (((((func_6(&Local_51) >= 5 && func_6(&Local_51) <= 7) && !func_5(&Local_51, 4096)) && _does_anim_scene_exist(Local_51.f_428.f_444)) && _is_anim_scene_started(Local_51.f_428.f_444, false)) && !_is_anim_scene_paused(Local_51.f_428.f_444))
		{
			MemCopy(&Var1, {func_12(Local_51)}, 4);
			func_13(Var1, &(Local_51.f_428));
			disable_control_action(0, -842734359, false);
		}
		switch (func_6(&Local_51))
		{
			case 8:
				if (func_14(&Local_51))
				{
				...
				else if (!func_10(&Local_51))
				{
					if (!func_18(&(Local_51.f_2899)))
					{
						func_19(&(Local_51.f_2899), 0);
					}
					if (!func_20(&Local_51))
					{
						if (func_21(&(Local_51.f_2899)) >= 1f)
						{
							func_22(Local_51.f_2889, 2097152);
							func_23(&Local_51);
							func_24(&Local_51);
							func_17(&Local_51, 10);
						}
					...
					{
						if (!func_5(&Local_51, 536870912))
						{
							pause_clock(true, 0);
							func_25(&Local_51, 536870912);
						}
						func_26(&(Local_51.f_2899));
					}
				}
				break;
			case 0:
				...
				if (!func_10(&Local_51) || func_5(&Local_51, 65536))
				{
					if (func_27(&Local_51))
					{
						func_17(&Local_51, 1);
			...
			case 2:
				...
				if (func_29(&Local_51))
				{
					if (!func_7(&Local_51) || func_10(&Local_51))
					{
						if (!func_30(Local_51.f_2889))
						{
							Local_51.f_2889 = func_32(func_31(Local_51));
						}
						func_22(Local_51.f_2889, 4);
						func_25(&Local_51, 8192);
					}
					if (func_10(&Local_51))
					{
						func_33(&Local_51);
			...
			case 9:
				...
				break;
			case 3:
				if (!func_5(&Local_51, 8192))
				{
					if (func_8(&(Local_51.f_958)) == 3)
					{
						func_22(Local_51.f_2889, 4);
						func_25(&Local_51, 8192);
					}
				...
				func_39(&Local_51);
				if (func_40(func_32((*Global_1835011)[Local_51]->f_1), 512))
				{
				}
				else if (func_41(&Local_51) || func_42(&Local_51, 32768))
				{
					func_34(&Local_51);
					func_15(&Local_51);
					func_17(&Local_51, 4);
					func_19(&(Local_51.f_2890), 0);
				}
				else if (func_10(&Local_51) && !func_1(Local_51))
				{
					if (!func_18(&(Local_51.f_2899)))
					{
						func_19(&(Local_51.f_2899), 0);
			...
			case 4:
				...
				if (func_44(&Local_51) || (func_42(&Local_51, 32768) && !func_5(&Local_51, 268435456)))
				{
					func_35(&Local_51);
					if (!func_5(&Local_51, 256))
					{
						func_36(&Local_51);
						func_38(&Local_51);
						if (!func_45(&Global_1935630, 524288) || func_42(&Local_51, 524288))
						{
							func_37(Local_51);
							func_17(&Local_51, 7);
						}
			...
			case 5:
				func_46(&Local_51);
				func_47(&Local_51);
				if (func_48(&(Local_51.f_2884)) >= func_49(&Local_51))
				{
					func_36(&Local_51);
					func_38(&Local_51);
					func_26(&(Local_51.f_2884));
					if (!func_42(&Local_51, 524288))
					{
						func_37(Local_51);
						func_17(&Local_51, 7);
					}
				...
				break;
			case 6:
				if (!func_18(&(Local_51.f_2906)))
				{
					func_19(&(Local_51.f_2906), 0);
				}
				if ((func_50(&(Local_51.f_428)) == 4 && _does_anim_scene_exist(Local_51.f_428.f_444)) && _is_anim_scene_paused(Local_51.f_428.f_444))
				{
					func_37(Local_51);
					func_17(&Local_51, 7);
				}
				else if (func_48(&(Local_51.f_2906)) >= 5f)
				{
					func_37(Local_51);
					func_17(&Local_51, 7);
				}
...
{
	if (func_137(Global_35, iLocal_23, 1, 0))
	{
		set_ped_max_move_blend_ratio(Global_35, 1.48f);
	}
	func_138();
	if (!has_model_loaded(1162162580))
	{
		return false;
	}
	if (!has_model_loaded(-246883338))
	{
		return false;
	}
	if (!has_model_loaded(264503396))
	{
		return false;
	}
	if (!has_model_loaded(1761016051))
	{
		return false;
	}
	if (!has_model_loaded(-636146522))
	{
		return false;
	}
	if (!_0xff07cf465f48b830(-95736505))
	{
		return false;
	}
	if (!has_model_loaded(_get_weapontype_model(-95736505)))
	{
		return false;
	}
	if (!func_139(-1, 1))
	...
	{
		iLocal_14 = func_141(iParam0);
		func_142(iLocal_14, 2630.356f, -1227.134f, 70.83501f, 39f, 2, 1073741824);
		return false;
	}
	if (!does_entity_exist(iLocal_19))
	{
		iLocal_19 = _create_weapon_object(-95736505, 100, func_143(0, 0), true, 1f);
		return false;
	}
	func_144(Local_37.f_3[0], 306468371);
	func_144(Local_37.f_3[1], -325418141);
	func_144(Local_37.f_3[2], 622741433);
	func_144(Local_37.f_3[3], -995559330);
	func_131(iParam0, &(Local_37.f_3[0]), "A_F_M_NBXTOWNFOLK_01", 0, 0, 1);
	func_131(iParam0, &(Local_37.f_3[1]), "A_M_M_MiddleSDTownfolk_01", 0, 0, 1);
	func_131(iParam0, &(Local_37.f_3[2]), "A_M_M_NBXTOWNFOLK_01", 0, 0, 1);
	func_131(iParam0, &(Local_37.f_3[3]), "A_M_M_NBXTownfolk_01^1", 0, 0, 1);
	func_131(iParam0, &(Local_37.f_3[4]), "A_M_Y_NBXSTREETKIDS_01", 0, 0, 1);
	func_131(iParam0, &(Local_37.f_3[5]), "A_M_Y_NbxStreetKids_01^1", 0, 0, 1);
	func_145(iParam0, &(Local_37.f_12[0]), "COACH2", 0, 0, 1, 0);
	func_131(iParam0, iLocal_14, 0, 0, 0, 1);
	func_145(iParam0, iLocal_19, "w_revolver_schofield01", 0, 0, 1, 0);
	iVar0 = func_146(&(iParam0->f_428), iLocal_14);
	if (iVar0 == -1)
	{
		return false;
	}
	func_147(iParam0->f_428.f_13[iVar0], 8);
	task_stand_still(iLocal_14, -1);
	set_blocking_of_non_temporary_events(iLocal_14, true);
	set_entity_visible(iLocal_14, false);
	iVar1 = 0;
	while (iVar1 < 6)
	{
		set_entity_visible(&(Local_37.f_3[iVar1]), false);
		iVar1++;
	}
	set_entity_visible(&(Local_37.f_12[0]), false);
	func_148(-923901632, 1, 0, 0, 0, 0, 0, 0);
	func_148(-438789356, 1, 0, 0, 0, 0, 0, 0);
	func_148(-399528504, 1, 0, 0, 0, 0, 0, 0);
	func_148(804086151, 1, 0, 0, 0, 0, 0, 0);
	func_149(27, 1);
	func_150(2);
	func_151(iParam0, iLocal_14);
	return true;
}
...
int func_39(int iParam0)
{
	...
	else if (_does_volume_exist(iLocal_25))
	{
		_delete_volume(iLocal_25);
	}
	if (!bLocal_26)
	{
		if (func_91(Global_35, 2631.73f, -1232.17f, 53.67f, 35f, 1, 1))
		{
			if (!func_162(iLocal_15, 0))
			{
				if (func_163(5) && func_164(250, 1))
				{
					iLocal_15 = func_165(250, 1, 0, 0, 1, 1);
				}
			}
			else
			{
				iVar0 = _find_closest_active_scenario_point_of_type(2631.73f, -1232.17f, 53.67f, 1595886358, 1f, 0, false);
				if (_does_scenario_point_exist(iVar0))
				{
					_task_use_scenario_point(iLocal_15, iVar0, 0, -1, false, true, 0, false, -1f, false);
					set_ped_keep_task(iLocal_15, true);
					func_26(&uLocal_34);
					bLocal_26 = true;
				}
				else if (does_scenario_exist_in_area(2631.73f, -1232.17f, 53.67f, 1f, false, 0, false))
				{
					task_use_nearest_scenario_to_coord_warp(iLocal_15, 2631.73f, -1232.17f, 53.67f, 1f, -1, false, false, true, false);
					set_ped_keep_task(iLocal_15, true);
					func_26(&uLocal_34);
					bLocal_26 = true;
				}
	...
	else if (!bLocal_27 && func_162(iLocal_15, 0))
	{
		if (_0xbe28db99556ff8d9(iLocal_15) != 0)
		{
			_0x8e901b65206c2d3e(iLocal_15);
			_0xb93a769b8b726950(iLocal_15, -1542215752);
			_0xc4cfce4c656ef480(iLocal_15);
			_0xe891504b2f0e2dba(iLocal_15, 7.5f);
			bLocal_27 = true;
		}
	}
	if (func_166(&uLocal_34, 5f) && func_162(iLocal_15, 0))
	{
		if (func_167(iLocal_15, -76381094) || func_167(iLocal_15, 1647992574))
		{
			func_26(&uLocal_34);
		}
		else
	...
	if (func_91(Global_35, func_143(0, 3), 10f, 1, 1))
	{
		iVar1 = get_mount(Global_35);
		if (!func_162(iLocal_16, 0))
		{
			if (func_162(iVar1, 0))
			{
				iLocal_16 = iVar1;
		...
		else if (does_entity_exist(iVar1) && iLocal_16 != iVar1)
		{
			iLocal_16 = iVar1;
		}
		iVar2 = get_vehicle_ped_is_using(Global_35);
		...
		else if (does_entity_exist(iVar2) && iLocal_17 != iVar2)
		{
			iLocal_17 = iVar2;
		}
	}
...
bool func_41(int iParam0)
{
	if (func_7(iParam0))
	{
		func_170(&(iParam0->f_958), func_169(iParam0), iParam0->f_958, 0);
...
void func_43(int iParam0)
{
	...
	{
		iLocal_18 = _create_mission_train(-1083616881, 2631.914f, -1281.219f, 51.20428f, true, false, true, true);
	}
	func_145(iParam0, iLocal_18, "trolley01x", 0, 0, 1, 0);
	set_train_speed(iLocal_18, 0f);
	if (func_162(iLocal_14, 0) && !is_entity_visible(iLocal_14))
	{
		set_entity_visible(iLocal_14, true);
	}
	iVar0 = 0;
	while (iVar0 < 6)
	{
		if (func_162(&(Local_37.f_3[iVar0]), 0) && !is_entity_visible(&(Local_37.f_3[iVar0])))
		{
			set_entity_visible(&(Local_37.f_3[iVar0]), true);
		}
		iVar0++;
	}
	if (!is_entity_dead(&(Local_37.f_12[0])) && !is_entity_visible(&(Local_37.f_12[0])))
	{
		set_entity_visible(&(Local_37.f_12[0]), true);
	}
	if (!bLocal_29)
	{
		uLocal_33 = func_173(iLocal_22, 0, 0, 0);
		bLocal_29 = true;
	}
}
...
bool func_44(int iParam0)
{
	if (func_7(iParam0))
	{
		return func_170(&(iParam0->f_958), func_169(iParam0), iParam0->f_958, 0);
	}
...
void func_51(int iParam0)
{
	...
	if (!bLocal_30)
	{
		if (func_162(iLocal_16, 0))
		{
			func_179(iLocal_16, func_178(0, 1), 2, 1073741824);
		}
		if (does_entity_exist(iLocal_17))
		{
			func_179(iLocal_17, func_178(0, 2), 2, 1073741824);
		}
...
{
	func_183(&uLocal_32, iLocal_20, 0);
	func_183(&uLocal_31, iLocal_21, 0);
	if (bLocal_29)
	{
		func_183(&uLocal_33, iLocal_22, 0);
	}
	...
	func_181(-399528504);
	func_181(804086151);
	func_184(&iLocal_19, 0, 1, 1);
	func_185(&iLocal_18, 0);
	func_185(Local_37.f_12[0], 0);
	func_186(&(Local_37.f_3), 0);
	if (!func_171(iParam0))
	{
		if (func_176(250, 1))
		{
			func_177(250, 0, 0, 0, 0);
			func_187(&iLocal_15, 1);
		}
		vVar0 = -1;
		vVar0.f_1 = -1;
		vVar0.f_2 = -1;
...
void func_55(int iParam0)
{
	if (_does_volume_exist(iParam0->f_425))
	{
		func_183(&(iParam0->f_427), iParam0->f_425, 0);
...
void func_56(int iParam0)
{
	...
	while (iVar2 < 27)
	{
		...
		else
		{
			...
			{
				func_191(iParam0, iVar3, iVar4, 0, bVar0, !bVar1, 0);
			}
		}
		iVar2++;
	}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_203(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_203(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	fVar3 = func_214(Global_35, func_89(uParam0), 1);
	if (func_83(uParam0, 128) || func_83(uParam0, 256))
	{
		if ((fVar3 >= func_215(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_216();
	...
	else if (fVar3 <= func_219(uParam0) || bParam2)
	{
		if (!func_83(uParam0, 128))
		{
			if (!_does_anim_scene_exist(uParam0->f_444))
			{
				if (func_219(uParam0) >= func_215(uParam0))
				{
				}
				Var4 = { func_220(uParam0) };
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_229("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
	{
		MemCopy(&(uParam0->f_440), {func_229("cutscene@", sParam1, 1, 63)}, 4);
	}
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_232(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_232(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_230(uParam0->f_501, 128))
		{
			func_231();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_244(uParam0, cVar8);
	func_93(1, 0);
	func_217(uParam0);
	if (func_245() && _0x6f1f0b17109309da(uParam0->f_444, func_232(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_249(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
void func_94(var uParam0)
{
	if (!func_83(uParam0, 4))
	{
		...
		vVar0 = { func_253(uParam0) };
		if (!func_236(uParam0->f_500, 524288))
		{
			func_254(&(uParam0->f_512));
		}
		func_255(&(uParam0->f_500), 0, 2, vVar0.x, vVar0.y, vVar0.z, 0);
		func_256(uParam0, 0f, 0f, 0f);
		func_257(uParam0);
		func_258(uParam0);
		func_259(uParam0, 0f, 0f, 0f, 0, 0);
		func_260(uParam0);
		func_96(uParam0, 4);
		func_261(uParam0, 0);
		func_262(&(Global_1946804->f_1497), Global_35, 1, 64, 1, 1, 1);
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_263(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_270();
	set_entity_invincible(Global_35, func_230(*uParam0, 8));
	...
	{
		func_271(Global_35, -383172193, 0, 1742327865, 0, 1, 0, 0, 1, 0);
		func_272(-1623728698, 0);
	}
	func_262(&(Global_1946804->f_1497), Global_35, 1, 49217, 1, 1, 1);
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_203(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_203(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_203(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_203(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		if (func_162(func_275(iVar0), 0))
		{
			if (is_ped_group_member(func_275(iVar0), func_276(), 1))
			{
...
bool func_117(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	...
	{
		fVar0 = func_214(iParam0, Global_36, 1);
	}
	if (fParam2 > 0f)
	{
		if (fVar0 < fParam2)
...
Vector3 func_125(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_232(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
{
	func_290();
	if (is_entity_in_volume(Global_35, iLocal_20, true, 0))
	{
	...
	uParam0->f_425 = _create_volume_box_with_custom_name(2625.714f, -1219.21f, 51f, 0f, 0f, 0f, 7.616596f, 6.770072f, 10f, "amb restriction mob1 intro");
	uLocal_32 = func_173(iLocal_20, 0, 0, 0);
	uLocal_31 = func_173(iLocal_21, 0, 0, 0);
	func_149(27, 1);
	request_model(1162162580, false);
	request_model(-246883338, false);
	request_model(264503396, false);
	request_model(1761016051, false);
	request_model(-636146522, false);
	_0x72d4cb5db927009c(-95736505, -1, 0);
	request_model(_get_weapontype_model(-95736505), false);
	_request_scenario_type(1595886358, 15, 0, 0);
	func_291(uParam0, 2630.356f, -1227.134f, 70.83501f);
	func_256(&(uParam0->f_428), 2633.766f, -1218.87f, 52.1701f);
	return true;
}

void func_129(var uParam0)
{
	if (!is_itemset_valid(Local_37))
	{
		Local_37 = create_itemset(true);
	}
}
...
{
	func_145(iParam0, iParam1, sParam2, iParam3, iParam4, bParam5, 0);
}
...
{
	if (func_219(&(iParam0->f_428)) != 15f || func_215(&(iParam0->f_428)) != 20f)
	{
		return;
	}
	switch (*iParam0)
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_275(iVar0));
...
bool func_137(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_138()
{
	if (func_137(Global_35, iLocal_24, 1, 0) && is_ped_on_mount(Global_35))
	{
...
{
	if (!func_301(Local_37.f_10))
	{
		Local_37.f_10 = { func_302() };
	}
	if (func_303(&(Local_37.f_10), 1))
	{
		return true;
	}
	if (!does_entity_exist(&(Local_37.f_12[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_37.f_12[0] = create_vehicle(1761016051, 2634.143f, -1223.776f, 71.7505f, 180f, true, true, false, false);
		func_304(Local_37.f_10, &(Local_37.f_12[0]));
		func_305(&(Local_37.f_12[0]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 0)
			{
	...
	func_306(&(Local_37.f_10), 1);
	return true;
}

bool func_140(int iParam0, bool bParam1)
{
	if (!func_301(Local_37.f_1))
	{
		Local_37.f_1 = { func_302() };
	}
	if (func_303(&(Local_37.f_1), 1))
	{
		return true;
	}
	if (!does_entity_exist(&(Local_37.f_3[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_37.f_3[0] = func_307(-246883338, 2639.372f, -1223.535f, 71.835f, 180f, 1, 1, 0, 1, 1, 0, 0, 1, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[0]), "Woman");
		func_304(Local_37.f_1, &(Local_37.f_3[0]));
		func_305(&(Local_37.f_3[0]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 0)
			{
	...
	if (!does_entity_exist(&(Local_37.f_3[1])) && (iParam0 == -1 || iParam0 == 1))
	{
		Local_37.f_3[1] = func_307(1162162580, 2639.478f, -1224.996f, 71.835f, 180f, 1, 1, 0, 1, 1, 0, 0, 1, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[1]), "Man1");
		func_304(Local_37.f_1, &(Local_37.f_3[1]));
		func_305(&(Local_37.f_3[1]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 1)
			{
	...
	if (!does_entity_exist(&(Local_37.f_3[2])) && (iParam0 == -1 || iParam0 == 2))
	{
		Local_37.f_3[2] = func_307(1162162580, 2639.283f, -1226.486f, 71.835f, 180f, 1, 1, 0, 1, 1, 0, 0, 1, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[2]), "Man2");
		func_304(Local_37.f_1, &(Local_37.f_3[2]));
		func_305(&(Local_37.f_3[2]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 2)
			{
	...
	if (!does_entity_exist(&(Local_37.f_3[3])) && (iParam0 == -1 || iParam0 == 3))
	{
		Local_37.f_3[3] = func_307(1162162580, 2639.382f, -1227.897f, 71.835f, 180f, 1, 1, 0, 1, 1, 0, 0, 1, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[3]), "Man3");
		func_304(Local_37.f_1, &(Local_37.f_3[3]));
		func_305(&(Local_37.f_3[3]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 3)
			{
	...
	if (!does_entity_exist(&(Local_37.f_3[4])) && (iParam0 == -1 || iParam0 == 4))
	{
		Local_37.f_3[4] = func_307(264503396, 2639.343f, -1228.993f, 71.835f, 180f, 1, 1, 0, 1, 1, 1, 1, 0, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[4]), "Kid1");
		func_304(Local_37.f_1, &(Local_37.f_3[4]));
		func_305(&(Local_37.f_3[4]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 4)
			{
	...
	if (!does_entity_exist(&(Local_37.f_3[5])) && (iParam0 == -1 || iParam0 == 5))
	{
		Local_37.f_3[5] = func_307(264503396, 2639.402f, -1230.201f, 71.835f, 180f, 1, 1, 0, 1, 1, 1, 1, 0, 0, 0);
		set_ped_name_debug(&(Local_37.f_3[5]), "Kid2");
		func_304(Local_37.f_1, &(Local_37.f_3[5]));
		func_305(&(Local_37.f_3[5]), Local_37);
		if (bParam1)
		{
			if (iParam0 == 5)
			{
...
void func_142(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_308(Global_35) && is_player_teleport_active())
	{
	}
	if (func_309(iParam0))
	{
		if (func_310(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_311(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_311(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_311(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_311(iParam5, 32), true);
	...
	else if (func_311(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_311(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_311(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
{
	if (_does_metaped_outfit_exist_for_ped_model(iParam1, get_entity_model(*uParam0)))
	{
...
void func_145(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	func_313(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_314(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
void func_148(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_317(iParam0))
	{
		...
		if (bParam3)
		{
			func_318(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_151(int iParam0, int iParam1)
{
	...
	{
		remove_from_itemset(iParam1, iParam0->f_7);
	}
}
...
bool func_154()
{
	return func_330(get_id_of_this_thread());
}
...
void func_156(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_335(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_159(int iParam0)
{
	...
	return func_336((*Global_1835011)[iParam0]->f_1);
}
...
int func_161(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_237(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
bool func_164(int iParam0, bool bParam1)
{
	...
	if ((func_176(iParam0, 1) && !func_340(iParam0)) && func_341(iParam0))
	{
		return false;
	}
...
int func_165(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_340(iParam0)) && !is_entity_dead(iVar0))
	{
...
int func_170(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_348(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_335(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_335(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_355(uParam0, uParam0->f_1684))
				{
					...
					{
						func_357(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	bVar0 = func_359(uParam0, iParam5, bParam6);
	...
	if (bVar0)
	{
		...
		if (func_334(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_335(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_351(uParam0) == 0)
			{
	...
	{
		case 0:
			func_367(uParam0, Param1, iParam5);
			break;
		case 1:
			func_368(uParam0);
			break;
		...
		case 3:
			...
			{
				func_110(2);
				func_357(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_172(int iParam0)
{
	...
	{
		if (func_137(Global_35, iVar1, 1, 0))
		{
			func_25(iParam0, 8388608);
			return 1;
		}
	}
	if (vdist2(func_203(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
...
var func_173(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
	}
	func_377(iParam0, bParam2);
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_378(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_379(uParam0->f_1522[iVar0], 128))
				{
					func_380(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_339(iParam0))
	{
		return;
...
struct<4> func_178(int iParam0, int iParam1)
{
	return func_384(iParam0, iParam1);
}

void func_179(int iParam0, struct<4> Param1, int iParam5, float fParam6)
{
	func_142(iParam0, Param1, Param1.f_3, iParam5, fParam6);
}

void func_180(int iParam0, int iParam1)
{
	func_148(iParam0, 0, 0, 0, 1, 0, 0, 0);
}

void func_181(int iParam0)
{
	if (func_317(iParam0) && func_385())
	{
...
void func_184(int* iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (bParam1)
	{
		func_386(iParam0, bParam2, bParam3);
	}
	else
	{
		func_387(iParam0);
...
void func_186(var uParam0, bool bParam1)
{
	...
	{
		func_187((*uParam0)[iVar0], bParam1);
		iVar0++;
	}
}
...
int func_189(var uParam0, bool bParam1, int iParam2)
{
	...
	func_393(*uParam0, iVar2);
	bVar1 = func_394(uParam0->f_1, 131072);
	func_395(uParam0->f_1);
	iVar3 = func_396(uParam0->f_1, *uParam0);
	...
	if (func_398(iVar3) || (!func_399(iVar3) && func_400(0) != iVar3))
	{
		iVar0 = func_32(iVar3);
		if (iVar0 == -1)
		{
...
void func_191(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (bParam4)
	{
		func_404(iParam0, iParam2, 0);
	}
	if (!bParam6)
	{
		if (!func_5(iParam0, 4194304))
		{
			bParam6 = func_405((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_405((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_406(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_192(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_407((*uParam0)[iVar0]))
		{
			if (func_408((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		...
		{
			if (func_408((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_411((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_412((*uParam2)[iVar0]))
		{
			if (func_408((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_413((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_414((*uParam3)[iVar0]))
		{
			if (func_408((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_415((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_417((*uParam5)[iVar0]))
		{
			if (func_408((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_418((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_417((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_419((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_408((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_420((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_421((*uParam6)[iVar0]))
		{
			if (func_408((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_422((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_423((*uParam7)[iVar0]))
		{
			if (func_408((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_424((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_425((*uParam8)[iVar0]))
		{
			if (func_408((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_426((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_427((*uParam9)[iVar0]))
		{
			if (func_408((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_428((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_429((*uParam10)[iVar0]))
		{
			if (func_408((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_430((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_431((*uParam11)[iVar0]))
		{
			if (func_408((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_432((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_204(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_173(iParam1, 0, 0, 0);
}
...
void func_206(int iParam0, int iParam1)
{
	...
	func_440(iParam1);
	StringCopy(&cVar0, func_202(), 64);
	func_441(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_212(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_442(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_222(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_446(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_202());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
		...
		func_447(uParam0, uParam0->f_4, 0, 1);
...
struct<8> func_229(char* sParam0, char* sParam1, bool bParam2, int iParam3)
{
...
bool func_235(bool bParam0, bool bParam1)
{
	if (!func_449(Global_43801))
	{
		Global_43801 = func_454("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_455(Global_43801, 0, 1);
		func_456(Global_43801, 6, 1);
		if (bParam1)
		{
			func_456(Global_43801, 14, 1);
		}
	}
	else
	{
		...
		if (func_458(Global_43801, 1) != 0f && bParam0)
		{
			func_455(Global_43801, 1, 1);
		}
		else
		{
			func_455(Global_43801, 0, 1);
		}
		return func_459(Global_43801, 1);
	}
	return false;
}
...
void func_244(var uParam0, char[16] cParam1)
{
...
void func_246(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_462(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_445() };
	func_462(uParam0, &Var1);
...
void func_247(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_263(uParam0->f_13[iVar0], 2))
		{
			if (func_263(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				func_463(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					iVar1 = get_ped_index_from_entity_index(&(uParam0->f_13[iVar0]));
					if (iVar1 != Global_35 && !func_263(uParam0->f_13[iVar0], 16))
					{
						func_464(iVar1);
					}
				}
...
bool func_250()
{
	return func_452(_0xc17f69e1418cd11f(3));
}
	...
	if (func_465(&iVar0))
	{
		if (func_466(iVar0, 0))
		{
			if (func_467(iVar0) == -525676072)
			{
				...
				func_271(Global_35, -2065815962, 0, 1108822547, 0, 1, 0, 0, 0, 0);
			}
			else
			{
...
void func_255(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	if (Global_1935630->f_12)
	{
		return;
	...
	{
		if (func_479() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if (func_83(uParam0, 2048) && !func_90(func_480(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_142(iVar1, func_480(uParam0), func_481(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_142(iVar3, func_480(uParam0), func_481(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_480(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_480(uParam0) };
			func_142(iVar0, vVar1, func_482(vVar1, Global_36, 1), 2, 1073741824);
...
void func_259(var uParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_263(uParam0->f_13[iVar0], 8))
					{
						if (func_484(func_483(iVar1, 0, 1, 0)))
						{
							if (!func_485(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
								set_current_ped_weapon(iVar1, -1569615261, true, 0, false, false);
							}
						}
						if (func_484(func_483(iVar1, 1, 1, 0)))
						{
							if (!func_485(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
...
void func_262(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			func_487(iParam1, 29, bVar4, 1, 0);
			func_487(iParam1, 31, bVar4, 1, 0);
			func_487(iParam1, 30, bVar4, 1, 0);
			func_487(iParam1, 22, bVar4, 1, 0);
			func_487(iParam1, 37, bVar4, 1, 0);
		}
	}
	if ((func_488(32768) && func_489(1108822547, 8)) && func_490(10, iParam3))
	{
		func_491(iParam1, 0, 1);
	}
	iVar0 = 0;
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				if (!func_490(iVar1, iParam3))
				{
				}
				else if ((func_489(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
					if (!func_489(iVar3, 1) || bParam2)
					{
						Global_1946804->f_857++;
						if (!bParam6)
						{
							func_487(iParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_487(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_267(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_497(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_271(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	{
		Var0 = { func_499(iParam1, 1, 0) };
		iParam3 = func_500(Var0.f_4);
		if (iParam3 == -358215195)
		{
			return 0;
		}
	}
	if (!func_502(iParam1, iParam2, func_501(iParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	func_503(1, (func_274() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_501(iParam3, 1)])
			{
				func_504(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_488(32768) && iParam1 != &Global_1946804->f_57[func_501(iParam3, 1)])
			{
				func_505();
				func_504(22, iParam3, 256, 0, 0);
			}
	...
	if (!bParam6)
	{
		if (bParam7)
		{
			func_504(22, iParam3, 0, 0, 0);
		}
		return 1;
	}
	iVar5 = func_506(iParam3);
	if (is_ped_a_player(iParam0))
	{
		func_504(19, 0, iVar5, 0, 0);
...
{
	Var0 = { func_499(iParam0, 0, 0) };
	Var5 = { func_508(iParam0, Var0, Var0.f_4, 0) };
	if (func_509(iParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return;
	}
	_0x65a5f70f4a292ebe(func_510(0), &Var5, iParam1);
}
...
bool func_273(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_311(*iParam1, 128))
	{
		if (!func_167(iParam0, 1245594896))
		{
	...
	if (func_311(*iParam1, 2))
	{
		...
		else if ((func_513(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
			task_pickup_carriable_entity(iParam0, _get_first_entity_ped_is_carrying(_get_last_mount(iParam0)));
			func_514(iParam1, 128);
			return false;
		}
		else
		{
	...
	{
		if (!func_513(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		if (func_311(*iParam1, 2336))
		{
			if (!func_511(iVar2))
			{
			}
			if (func_515(iVar2, *iParam1))
			{
				func_516(iParam1, 32);
				func_516(iParam1, 256);
				func_516(iParam1, 2048);
				func_514(iParam1, 512);
				func_514(iParam1, 1024);
				func_514(iParam1, 4096);
			}
			else
			{
				return false;
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_513(iParam2, 1024))) || func_513(iParam2, 8)) && !func_311(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_514(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_513(iParam2, 4096)) && !func_311(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_514(iParam1, 2048);
			func_514(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_513(iParam2, 32)) && !func_311(*iParam1, 5632))
		{
			task_horse_action(iVar2, 3, 0, 0);
			func_514(iParam1, 256);
			func_514(iParam1, 1024);
		}
...
int func_285(var uParam0, int iParam1)
{
	...
	if (func_154())
	{
		...
		if (func_520(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_521(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_334(uParam0, 8) && _0xdd0b7c5ae58f721d(func_522()))
	{
		_0x798be43c9393632b(func_522());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_522())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_288(int iParam0)
{
	...
	return func_399((*Global_1835011)[iParam0]->f_1);
}
...
void func_290()
{
	if (!_does_volume_exist(iLocal_20))
	{
		func_524(&iLocal_20, 2634.297f, -1227.129f, 60.17411f, 0f, 0f, 0f, 15.58959f, 15.43288f, 21.08183f, "SALOON BLOCKING");
	}
	if (!_does_volume_exist(iLocal_21))
	{
		func_524(&iLocal_21, 2625.989f, -1219.434f, 51f, 0f, 0f, 0f, 9.138547f, 7.041876f, 10f, "DOOR BLOCKING");
	}
	if (!_does_volume_exist(iLocal_22))
	{
		func_524(&iLocal_22, 2616.894f, -1220.026f, 52.75589f, 0f, 0f, 0f, 9.365048f, 74.52102f, 14.31593f, "Road BLOCKING");
	}
	if (!_does_volume_exist(iLocal_23))
	{
		func_525(&iLocal_23, 2628.293f, -1220.816f, 52.256f, 0f, 0f, 0f, 6f, 5.3f, 3f, "Stream Failsafe");
	}
	if (!_does_volume_exist(iLocal_24))
	{
		func_525(&iLocal_24, 2628.293f, -1220.816f, 52.256f, 0f, 0f, 0f, 12f, 10.3f, 4f, "Soft Limiter");
	}
	if (!_does_volume_exist(iLocal_25))
	{
		iLocal_25 = _0x0eb78c2b156635b1(665633627, 2628.293f, -1220.816f, 52.256f, 0f, 0f, 0f, 1.5f, 1.5f, 3f);
	}
}
...
void func_293(int iParam0, vector3 vParam1, int iParam4)
{
	...
	func_526(&(iParam0->f_958), iParam4);
}
...
int func_296(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_407((*uParam0)[iVar1]))
		{
			if (func_408((*uParam0)[iVar1]->f_2, iParam12))
			{
				if (!func_527((*uParam0)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam1)
	{
		if (func_410((*uParam1)[iVar1]))
		{
			if (func_408((*uParam1)[iVar1]->f_4, iParam12))
			{
				if (!func_528((*uParam1)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam2)
	{
		if (func_412((*uParam2)[iVar1]))
		{
			if (func_408((*uParam2)[iVar1]->f_2, iParam12))
			{
				if (!func_529((*uParam2)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam3)
	{
		if (func_414((*uParam3)[iVar1]))
		{
			if (func_408((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_415((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_417((*uParam5)[iVar1]))
		{
			if (func_408((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_530((*uParam5)[iVar1]))
				{
					if (!func_531((*uParam5)[iVar1]))
					{
						iVar0 = 0;
					}
				}
			...
			if (func_408((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_530((*uParam5)[iVar1]))
				{
					if (func_531((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_419((*uParam5)[iVar1]->f_4[iVar2]))
							{
								if (!func_532((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
	...
	while (iVar1 < *uParam6)
	{
		if (func_421((*uParam6)[iVar1]))
		{
			if (func_408((*uParam6)[iVar1]->f_3, iParam12))
			{
				if (!func_533((*uParam6)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam7)
	{
		if (func_423((*uParam7)[iVar1]))
		{
			if (func_408((*uParam7)[iVar1]->f_4, iParam12))
			{
				if (!func_534((*uParam7)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam8)
	{
		...
		{
			if (func_408((*uParam8)[iVar1]->f_2, iParam12))
			{
				if (!func_535((*uParam8)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam9)
	{
		if (func_427((*uParam9)[iVar1]))
		{
			if (func_408((*uParam9)[iVar1]->f_2, iParam12))
			{
				if (!func_536((*uParam9)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_429((*uParam10)[iVar1]))
		{
			if (func_408((*uParam10)[iVar1]->f_3, iParam12))
			{
				if (!func_537((*uParam10)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	{
		if (func_431((*uParam11)[iVar1]))
		{
			if (func_408((*uParam11)[iVar1]->f_2, iParam12))
			{
				if (!func_538((*uParam11)[iVar1]))
				{
					iVar0 = 0;
				}
			}
...
int func_298(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	if (!func_114(iParam1))
	{
		return 0;
	...
	if (!func_542(iParam1, 28, 1))
	{
		func_543(iParam1, 28, 1);
	}
	*uParam2 = func_544(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_545(iParam0, *uParam2);
		func_546(*uParam2, bParam3, bParam4, 0);
		if (bParam4)
		{
			set_blocking_of_non_temporary_events(*uParam2, true);
			if (!func_167(*uParam2, -982327190))
			{
				task_stand_still(*uParam2, -1);
			}
		}
		func_145(iParam0, *uParam2, 0, 0, 0, 1, 0);
		func_547(iParam1, 0, 0, 1);
		func_548(iParam1);
		return 1;
	}
	return 0;
...
void func_304(struct<2> Param0, int iParam2)
{
	if (!func_301(Param0))
	{
		return;
...
int func_307(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_550(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
Vector3 func_312(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2630.343f, -1232.262f, 58.5845f;
				case 1:
					return 2619.334f, -1222.531f, 52.2435f;
				case 2:
					return 2619.434f, -1235.353f, 52.2803f;
				case 3:
					return 2626.482f, -1219.122f, 52.2406f;
			}
			break;
	}
	return 0f, 0f, 0f;
...
void func_313(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	iVar0 = func_146(uParam0, iParam1);
	if (iVar0 != -1)
	{
	...
	{
		iVar1 = func_552(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_553(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_147(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_497(uParam0->f_13[iVar0], 2);
		}
	}
}
...
{
	func_555(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
int func_324(int iParam0, int iParam1)
{
	...
	if (iVar2 != -1)
	{
		if (iParam1 == 1)
		{
			func_561((*Global_1392915)[iVar0]->f_4);
		}
...
void func_325(int iParam0)
{
	...
	if (func_197((*Global_1392915)[iParam0]->f_4))
	{
		func_563((*Global_1392915)[iParam0]->f_4, 1, 2);
	}
...
{
	func_567((*Global_1392915)[iParam0]);
	func_568(Global_1392915->f_121[iParam0]);
}
...
bool func_342(int iParam0, bool bParam1)
{
	...
	if (!_0x800df3fc913355f3(func_345(iParam0)))
	{
		return false;
	}
	if (bParam1 && !does_entity_exist(func_573(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_345(iParam0));
}
...
void func_349(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_575(1));
		if (!has_anim_dict_loaded(func_575(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_350(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		{
			fVar0 = func_580(uParam0, uParam0->f_1690);
		...
		if (func_335(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_214(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_482(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_357(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_580(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_360(uParam0, 4);
			...
			if (func_273(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_333(uParam0, 4);
...
void func_357(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_571(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
	func_583(&iVar1, uParam2);
	func_584(&(uParam0->f_1904), iVar0, iVar1, fParam3);
	if (!Global_1935630->f_12)
	{
		if (!func_63(uParam0, 67108864))
		{
...
void func_358(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_364(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_587(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692), func_522(), 64);
			}
			if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_10)))
			{
				StringCopy(&(uParam0->f_1692.f_8), func_587(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
				StringCopy(&(uParam0->f_1692.f_8), func_588(), 64);
			}
			disable_control_action(0, -1722177808, false);
		}
		...
		{
			if (!func_589(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_589(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_583(&iVar19, uParam0->f_1345[iVar0]->f_1);
					func_590(&(uParam0->f_1904), iVar19);
				}
			}
			else
			{
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_589(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_591(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_482(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_589(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_589(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_589(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_593(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_593(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
int func_359(var uParam0, int iParam1, bool bParam2)
{
...
void func_362(var uParam0, int iParam1)
{
	...
	if (func_8(uParam0) > 3)
	{
		...
		while (iVar0 < uParam0->f_1894)
		{
			...
			{
				bVar1 = func_598(uParam0, iVar0);
				if (bVar1)
				{
					func_599(uParam0, iVar0, iParam1);
				}
			}
			iVar0++;
		}
...
void func_367(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5)
{
	func_602(uParam0, 4);
...
bool func_372(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_214(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_373(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_214(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_611(uParam0)) && _is_anim_scene_started(func_611(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_611(uParam0));
				bVar1 = _is_anim_scene_finished(func_611(uParam0), false);
				bVar2 = _is_anim_scene_active(func_611(uParam0));
...
int func_376(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_612(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
struct<8> func_378(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_551(iParam1), 64);
		if (!is_string_null_or_empty(&cVar0))
		{
			iVar8 = func_613(uParam0, iParam1);
			if (iVar8 > 0)
			{
...
int func_383(int iParam0, bool bParam1)
{
	...
	func_382(iParam0);
	_0xfc77c5b44d5ff7c0(func_345(iParam0));
	func_614(iParam0, 0);
	return 1;
}
...
{
	Var0 = { func_312(iParam0, iParam1) };
	Var0.f_3 = func_615(iParam0, iParam1);
	return Var0;
}
		...
		if (is_vehicle_driveable(*iParam0, false, false))
		{
			if (!is_vehicle_seat_free(*iParam0, iVar12))
			{
				...
				if (!is_entity_dead(&(iVar1[iVar0])))
				{
					...
					func_142(&(iVar1[iVar0]), get_offset_from_entity_in_world_coords(*iParam0, 3f, 3f, 0f), get_entity_heading(*iParam0), 2, 1073741824);
				}
			}
		}
		iVar0++;
...
bool func_390(int iParam0)
{
	...
	return (!func_617() || is_bit_set(Global_40.f_7854, iParam0));
}
...
{
	return func_619(iParam0, iParam1, 4, get_hash_key(func_618(iParam1)));
}
...
int func_401(int iParam0)
{
	...
	else
	{
		...
		else
		{
			...
			{
				if (!func_197(Global_1898330[iVar0]))
				{
...
void func_402(vector3 vParam0, int iParam3)
{
	if (func_90(vParam0))
	{
		return;
...
void func_404(int iParam0, int iParam1, char* sParam2)
{
	func_623(&(iParam0->f_428), iParam1, sParam2);
}
...
void func_406(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (!func_114(iParam0))
	{
		return;
	...
	if (bParam10)
	{
		func_543(iParam0, 56, 1);
		func_19(&(Global_1359489->f_40), 1);
	}
	func_624(iParam0, 0);
	func_625(iParam0, 4, 0);
	func_626(iParam0);
	func_627(iParam0);
	func_628(iParam0, 37, 1);
	bVar0 = func_162(Global_1360165[iParam0], 0);
	iVar1 = func_629(iParam0, 0);
	...
	{
		func_628(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_628(iParam0, 33, 1);
		func_628(iParam0, 34, 1);
		func_630(iParam0, 1056964608, -1, 1061158912);
		func_631(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_543(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_543(iParam0, 35, 1);
			if (bParam8)
			{
				func_543(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		func_543(iParam0, 33, 1);
		func_631(iParam0, 0, 1, 0);
		if (fParam4 > 0f)
		{
		...
		{
			func_168(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
			func_543(iParam0, 34, 1);
		}
	}
	if (bParam1 || bParam2)
	{
		if (does_entity_exist(Global_1360165[iParam0]))
		{
			func_633(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	{
		func_628(iParam0, 45, 1);
	}
	func_634(iParam0, 16, 1);
	func_628(iParam0, 44, 1);
	(*Global_1360165)[iParam0]->f_129 = 0;
	Global_40.f_4942[iParam0]->f_4 = 0;
	if (bParam5)
	{
		if (func_162(func_635(iParam0), 0))
		{
			func_636(0, iParam0, bParam3, 0, bParam2);
		}
	}
}
...
void func_418(var uParam0)
{
	if (!func_638(uParam0->f_2, 1))
	{
		if (func_530(uParam0))
		{
			...
			{
				sVar0 = func_451(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_642())
				{
...
void func_440(int iParam0)
{
	...
	while (iVar0 < Global_1393237->f_11)
	{
		...
		{
			func_644(iVar0, 4096, 0);
			func_644(iVar0, 131072, 0);
			func_645(iVar0, 1);
		}
		iVar0++;
	}
...
int func_441(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_646(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}

void func_442(var uParam0, char* sParam1, bool bParam2)
{
	if (is_string_null_or_empty(sParam1))
	{
		return;
...
void func_443(struct<4> Param0)
{
	...
	if (func_649(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_649(20))
			{
				return;
			}
			iVar0++;
...
void func_447(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (_0x91a5f9cbebb9d936(uParam0->f_9))
	{
		remove_scenario_blocking_area(uParam0->f_9, false);
...
int func_454(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	if (iVar1 != 0)
	{
		func_653(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
float func_458(int iParam0, bool bParam1)
{
	if (bParam1 && !func_449(iParam0))
	{
		return 0f;
...
void func_463(var uParam0, char* sParam1, int iParam2, int iParam3)
{
	if (!does_entity_exist(iParam2))
	{
		return;
...
bool func_465(int iParam0)
{
	...
	else if (func_661(-525676072, iParam0))
	{
		if (func_660(iParam0))
		{
			return true;
...
void func_470(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_484(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_471()
{
	iVar0 = func_483(Global_35, 9, 1, 0);
	if (func_484(iVar0))
	{
		return;
	}
	iVar0 = func_483(Global_35, 7, 1, 0);
	if (func_484(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 8, false, false);
	}
	iVar0 = func_483(Global_35, 0, 1, 0);
	if (func_484(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	}
	iVar0 = func_483(Global_35, 1, 1, 0);
	if (func_484(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	}
	iVar0 = func_483(Global_35, 18, 1, 0);
	if (func_484(iVar0) && _is_weapon_two_handed(iVar0))
	{
		set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
		return;
	...
	if (func_484(iVar0))
	{
		...
		{
			func_664(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
int func_473(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
float func_481(var uParam0)
{
	return uParam0->f_508;
}

float func_482(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
void func_487(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	iVar2 = func_492(iParam1, 1);
...
{
	return ((Global_1946804->f_57[func_501(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_491(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_489(1108822547, 6))
	{
		if (bParam2)
		{
			func_487(iParam0, iVar0, func_274() != -1, 0, 0);
...
{
	(Global_1946804->f_57[func_501(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_501(iParam0, 1)])->f_10 || iParam1);
}

void func_494(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_501(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_501(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_501(iParam0, 1)])->f_10 && iParam1));
}
...
struct<5> func_499(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_670(iParam0))
	{
		...
		case -427144552:
			...
			if (bParam2 && func_672(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_673(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_673(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_674(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_502(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_678();
	if (iParam2 == 39)
	{
		Var0 = { func_499(iParam0, 1, 0) };
		iParam2 = func_501(func_500(Var0.f_4), 1);
	}
	if (iParam2 < 0 || iParam2 >= 39)
	{
		return false;
	}
	if (func_679(iParam0, 866047851) && func_680(&(Global_1946804->f_1378)) >= 2)
	{
		return false;
	}
	if ((func_488(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	func_682(iParam2);
	func_683(iParam2, iVar5);
	if (&Global_1946804->f_1378.f_1[iParam2] != &Global_1946804->f_57[iParam2] && Global_1946804->f_57[iParam2]->f_1 > 1)
	{
		func_684(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_684(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_685(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_686(iParam0, iParam2, iParam1, func_274() != -1);
	if (bParam4)
	{
		func_687(&(Global_1946804->f_1378), 1, 3);
	}
	else
	{
		func_687(&(Global_1946804->f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_494(func_492(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_688(&(Global_1946804->f_2589), bParam0, bParam1, bParam2);
}

void func_504(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam4)
	{
		func_486(16384);
...
void func_505()
{
	func_690(&(Global_1946804->f_2776));
	func_691(32768);
...
struct<4> func_508(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_466(iParam0, 0))
	{
		return Var0;
	}
	_0x886dfd3e185c8a89(func_510(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_509(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_510(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_511(int iParam0)
{
	...
	if (func_167(iParam0, 1041577989))
	{
		return false;
	}
...
bool func_512(int iParam0, vector3 vParam1)
{
	...
	return func_692(vVar0, vVar3, vParam1);
}
...
void func_518(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_695(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_696(1, bVar1, 1, uVar2);
		func_697(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_698(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_523()
{
	...
	remove_anim_dict(func_575(1));
}

void func_524(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
	*iParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, sParam10);
}

void func_525(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
...
int func_544(int iParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_114(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_282(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_406(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
				else if (func_162(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_162(Global_1360165[iParam0], 0))
			{
		...
		case 2:
			...
			func_628(iParam0, 18, 1);
			set_entity_visible(Global_1360165[iParam0], true);
			set_ped_relationship_group_hash(Global_1360165[iParam0], 1030835986);
			_0xf74e134f40192884(Global_1360165[iParam0], 0);
			_0x6759bee6762e140b((*Global_1360165)[iParam0]->f_1);
			set_ped_config_flag(Global_1360165[iParam0], 130, false);
			func_631(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
				func_547(iParam0, 0, 0, 1);
			}
			func_628(iParam0, 33, 1);
			func_628(iParam0, 34, 1);
			func_628(iParam0, 29, 1);
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_142(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_704(iParam0, iParam13))
				{
					...
					{
						func_705(iParam0, iParam13, 0);
						func_706(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_542(iParam0, 25, 0))
						{
							func_628(iParam0, 25, 0);
						}
						func_543(iParam0, 66, 0);
						func_702(iParam0, 5);
		...
		case 6:
			if (func_162(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_708(Global_1360165[iParam0], 1);
				}
			}
			func_702(iParam0, 7);
		case 7:
			func_631(iParam0, bParam9, bParam15, 0);
			func_625(iParam0, 4, bParam11);
			func_627(iParam0);
			if (bParam20)
			{
				if (func_709(Global_1360165[iParam0]))
				{
				}
			}
			func_710(iParam0, Global_1360165[iParam0]);
...
void func_546(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_182() || !_0x6f1f0b17109309da(Global_43800, func_232(iParam0))))
	{
...
void func_547(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		func_714(iParam0, bParam3);
	}
	else
	{
		func_715(iParam0, bParam3);
	}
}
...
bool func_549(struct<2> Param0, int iParam2)
{
	if (!func_301(Param0))
	{
		return false;
	...
	iVar0 = 0;
	while (iVar0 < func_716(Param0))
	{
		if (func_717(Param0, iVar0) == iParam2)
		{
			return true;
		}
		iVar0++;
...
void func_550(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
char* func_551(int iParam0)
{
	...
	if (is_entity_a_ped(iParam0))
	{
		return func_232(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_723(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_724(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_555(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	func_725(uParam0);
	iVar0 = func_726(uParam0, iParam1);
	if (bParam3)
	{
		if (is_string_null_or_empty(sParam2))
		{
		...
		iVar0 = func_727(uParam0, sParam2);
		if (iVar0 == -1)
		{
			iVar0 = func_728(uParam0);
		}
		else
		{
...
{
	if (func_449(Global_1392915->f_121[iParam0]->f_3))
	{
		_display_hud_component(-1744263063);
		func_450(&(Global_1392915->f_121[iParam0]->f_3), 1, 0);
...
void func_563(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_620(iParam0) == 3 || (func_620(iParam0) == 1 && _0x01f4d242765c6b24(func_730(iParam0))))
	{
		func_731(func_198(iParam0), func_730(iParam0), iParam2);
		if ((!func_197(Global_1572864->f_8) && !func_74(0, 1, 0)) && !func_45(&Global_1935630, 32768))
		{
...
{
	if (func_449(uParam0->f_3))
	{
		func_450(&(uParam0->f_3), 1, 0);
	}
	uParam0->f_2 = 0;
	uParam0->f_3 = 0;
	uParam0->f_4 = 0;
...
void func_576(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			vVar0 = { uParam0->f_1882 * FtoV(func_746(uParam0->f_1898)) };
			if (!func_593(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_577(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_214(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_214(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_214(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_747(512) || func_748(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_571(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_749(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_357(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					...
					func_751(uParam0, iVar2, iVar0, bVar3);
				}
				else if (func_752(uParam0->f_1633[iVar2]) != 0)
				{
					func_751(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_571(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_214(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_749(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
						if (func_273(Global_35, &(uParam0->f_1687), iVar4, 0, 0, 1084227584, 100, 0, 0))
						{
							set_player_control(get_player_index(), true, 0, false);
							uParam0->f_1687 = 0;
							func_333(uParam0, 33554432);
...
float func_580(var uParam0, int iParam1)
{
	fVar16 = 10000f;
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_753(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
		...
		case 1:
			...
			{
				func_754(uParam0, iParam1, &uVar6, vVar9, &fVar12, &fVar13, &fVar14, &fVar15);
				if (fVar14 < fVar15)
				{
...
void func_581(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_756(uParam0, iVar0)) && !func_520(uParam0->f_1016[iVar0], 1))
			{
				if (!func_757(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_758(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_759(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
{
	*iParam0 = 0;
	if (!func_589(uParam1, 8))
	{
		if (func_589(uParam1, 1))
		{
			*iParam0 = 1;
		}
		else if (func_589(uParam1, 4))
		{
			*iParam0 = 4;
		}
		else if (func_589(uParam1, 2))
		{
			*iParam0 = 2;
		}
	}
...
void func_584(char* sParam0, int iParam1, int iParam2, float fParam3)
{
	func_590(sParam0, iParam2);
	func_760(iParam1, fParam3);
}
...
char* func_587(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_591(int iParam0, int iParam1, int iParam2)
{
	vVar0 = { get_entity_coords(iParam0, false, false) };
	vVar3 = { get_entity_coords(iParam1, false, false) };
	return func_482(vVar0, vVar3, iParam2);
}

void func_592(float fParam0, float fParam1)
{
	set_gameplay_cam_relative_heading(fParam0, 1f);
	set_gameplay_cam_relative_pitch(fParam1, 1f);
}

bool func_593(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_595(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_753(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_335(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_612(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_612(uParam0->f_475[iParam1], 64) && func_762(uParam0, iParam1, 0))
				{
					func_763(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_764(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_612(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_764(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
		case 4:
			func_600(uParam0, iParam1, 0, 0);
			break;
	}
}
...
int func_598(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_356(uParam0) != 11) && func_355(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_232(Global_35)))
		{
			if (func_379(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_379(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_758(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_600(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_356(uParam0))
	{
		case 0:
			if (!bParam3)
			{
				if (!func_766(uParam0, iVar2))
				{
					uParam0->f_1685 = iParam1;
				}
				uParam0->f_475[iParam1]->f_7 = 1;
			}
			if (((!func_335(uParam0->f_1016[iVar2], 32) && func_767()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_335(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 1:
			...
			if ((((!func_167(Global_35, 716706914) && !func_167(Global_35, 242628503)) && func_21(&(uParam0->f_1869)) >= 2.5f) || (!func_484(func_483(Global_35, 0, 1, 0)) && !func_484(func_483(Global_35, 1, 1, 0)))) || bVar0)
			{
				func_768(uParam0);
				if (bVar0)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_335(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_355(uParam0, uParam0->f_1688))
			...
			if (func_273(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4))
			{
				func_768(uParam0);
			}
		...
		case 7:
			...
			if (func_770(Global_35, 242628503) || bVar0)
			{
				func_609(uParam0, 3);
				if (bVar0)
				{
			...
			break;
		case 3:
			if (!func_335(uParam0->f_1016[iVar2], 256))
			{
				if (func_465(&(uParam0->f_1903)))
				{
					func_771(uParam0->f_1903, 0);
				}
			}
			func_26(&(uParam0->f_1869));
			func_609(uParam0, 4);
		...
		case 4:
			...
			if ((func_335(uParam0->f_1016[iVar2], 256) || !func_465(&uVar5)) || bVar0)
			{
				if (func_772())
				{
					func_773();
		...
		case 8:
			...
			if (func_273(Global_35, &(uParam0->f_1686), iVar1, 0, 0, 1084227584, 100, fVar3, fVar4) || bVar0)
			{
				uParam0->f_1686 = 0;
...
bool func_603(var uParam0, char* sParam1, int iParam2)
{
	...
	{
		iVar16 = -1;
		func_776(uParam0, iVar18);
		if (func_777(uParam0, 0))
		{
			if (func_778(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					uParam0->f_1016[iVar16]->f_27 = 0;
					func_779(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_779(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_779(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_779(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_779(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_779(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_779(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_779(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_779(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_779(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_779(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_779(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_779(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_779(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_779(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_778(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_779(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_779(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_779(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					if (func_780(uParam0, 21, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_19), {Var20}, 3);
					}
					if (func_780(uParam0, 22, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_22), {Var20}, 3);
					}
					func_778(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_781(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_780(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					if (func_778(uParam0, 39, &iVar17))
					{
					...
					if (func_779(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_759(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_445() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_782(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				{
					if (func_778(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_783(uParam0->f_1522[iVar16], 2);
							func_780(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_784(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_783(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_778(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_783(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_783(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
			...
			while (iVar18 < 35)
			{
				...
				{
					if (func_778(uParam0, 51, &iVar17))
					{
						Var2.f_1 = iVar17;
					}
					func_778(uParam0, 43, &(Var2.f_3));
					if (func_780(uParam0, 52, &Var20))
					{
						MemCopy(&(Var2.f_4), {Var20}, 4);
					}
					func_779(uParam0, 53, &(Var2.f_8));
					if (func_778(uParam0, 54, &iVar17))
					{
						Var2.f_10 = iVar17;
					}
					func_784(uParam0, 55, &(Var2.f_11));
					func_784(uParam0, 56, &(Var2.f_12));
					iVar32 = -1;
					if (func_785(uParam0, Var2.f_1, &iVar32))
					{
				...
				if (func_777(uParam0, 57))
				{
					if (func_778(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_778(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_778(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_787(iVar17);
							}
							if (func_778(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_788(iVar17);
							}
							func_778(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_779(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_779(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_779(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_778(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_779(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_778(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_778(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							if (func_778(uParam0, 73, &iVar17))
							{
								uParam0->f_475[iVar16]->f_17 = iVar17;
							}
							if (func_778(uParam0, 75, &iVar17))
							{
								uParam0->f_475[iVar16]->f_4 = iVar17;
								bVar15 = true;
							}
							func_779(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
							if (func_784(uParam0, 63, &bVar19))
							{
								if (bVar19)
								{
			...
			while (iVar18 < 8)
			{
				...
				{
					func_778(uParam0, 86, &iVar16);
					if (iVar16 >= 0)
					{
						func_784(uParam0, 87, uParam0->f_1345[iVar18]);
						func_780(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_780(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_779(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_779(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_778(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_789(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_777(uParam0, 98))
				{
					if (func_778(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_790(uParam0, 99, uParam0->f_1633[iVar16]);
							func_790(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_790(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_778(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_781(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_604(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_379(uParam0->f_1522[iVar0], 2)) && !func_379(uParam0->f_1522[iVar0], 16)) && func_792(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_783(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_783(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_605(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_379(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	StringCopy(&Var2, func_522(), 64);
	StringCopy(&(Var2.f_8), func_588(), 64);
	uParam0->f_1708 = { Var2 };
	uParam0->f_1731 = { Var2 };
	if (!func_334(uParam0, 8))
	{
		_0x6a4d224fc7643941(func_522());
		func_519(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_522()))
		{
...
bool func_606(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_379(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_793(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_783(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_607(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_309(uParam0->f_3[iVar0]->f_2)) && func_484(uParam0->f_3[iVar0]->f_10)) && !func_786(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_794(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_795(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
int func_619(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar5 = func_800(iVar3, iVar4, iParam2);
	if (Global_1572887->f_12 == -1)
	{
		iVar0 = iVar1;
		iVar0 = iVar1;
		...
		{
			iVar6 = iVar0;
			if (func_433(iVar6) == iVar5)
			{
				return iVar6;
			}
			if (func_433(iVar6) == 0)
			{
				return func_801(iVar3, iVar4, iParam2, iVar0, iParam3);
			}
			iVar0++;
		}
		iVar1 = 751;
	...
	else
	{
		...
		while (iVar0 <= iVar2)
		{
			...
			{
				return func_801(iVar3, iVar4, iParam2, iVar0, 0);
			}
			iVar0++;
		}
	}
...
void func_621(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!_0x01f4d242765c6b24(func_730(iParam0)))
		{
			_0xca41e86545413b5b(func_198(iParam0), func_199(iParam0), func_803(iParam0), func_730(iParam0), Global_36);
		}
	}
	func_735(iParam0, 1);
	bParam1 = bParam1;
...
void func_622(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1898346)[iParam0]->f_2 = func_433(Global_1898330[iParam0]);
		func_804((*Global_1898346)[iParam0]->f_2, &((*Global_1898346)[iParam0]->f_4), &((*Global_1898346)[iParam0]->f_5), &((*Global_1898346)[iParam0]->f_3));
	}
}

void func_623(var uParam0, int iParam1, char* sParam2)
{
	if (!_does_anim_scene_exist(uParam0->f_444))
	{
		return;
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_805(uParam0, iParam1);
	}
...
void func_624(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_806(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_625(iParam0, 1, 0);
		}
	}
	func_625(iParam0, 16, bParam1);
}
...
void func_625(int iParam0, int iParam1, bool bParam2)
{
	...
	func_807(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}

void func_626(int iParam0)
{
	func_625(iParam0, 8, 0);
}

void func_627(int iParam0)
{
	func_543(iParam0, 36, 1);
}
...
void func_630(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_275(iParam0), 137, true);
	}
}

void func_631(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!func_517(iParam0))
	{
		return;
	...
	if (bParam1)
	{
		func_628(iParam0, 50, 1);
		func_628(iParam0, 48, 1);
		func_628(iParam0, 49, 1);
		func_628(iParam0, 51, 1);
		func_628(iParam0, 52, 1);
		func_628(iParam0, 54, 1);
		func_628(iParam0, 55, 1);
	}
	else
	{
		func_543(iParam0, 50, 1);
		func_543(iParam0, 48, 1);
		func_543(iParam0, 49, 1);
		func_543(iParam0, 51, 1);
		if (bParam3)
		{
			func_543(iParam0, 54, 1);
		}
		else
		{
			func_628(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_543(iParam0, 52, 1);
			if (bParam3)
			{
				func_543(iParam0, 55, 1);
			}
		}
		else
		{
...
void func_632(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_275(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_275(iParam0), 204, false);
	}
}
...
void func_633(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_275(iParam0);
	if (((does_entity_exist(iVar1) && func_810(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
	...
	if (bParam4)
	{
		func_543(iParam0, 2, 1);
	}
	else
	{
		func_811(iParam0);
		func_543(iParam0, 1, 1);
	}
}
...
void func_636(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (!func_517(iParam1))
	{
		return;
	...
	func_628(iParam1, 39, 1);
	func_814(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_814(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_814(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_543(iParam1, 43, 1);
		}
		if (bParam4)
		{
			func_815(iParam1, 0, 1, 1, 1);
		}
	}
}
...
int func_646(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	...
	func_817(iVar0, bParam8);
	return iVar0;
}

bool func_647(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return true;
...
bool func_648(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
...
void func_653(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
...
{
	iVar0 = func_501(func_819(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	if (func_661(81053684, iParam0))
	{
		return true;
	}
	if (func_661(-525676072, iParam0))
	{
		return true;
	}
	return false;
...
{
	iVar1 = func_501(func_819(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_664(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_484(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam0 == Global_35)
	{
		func_821(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_822(iParam0, &iVar0, &fVar25);
...
{
	return func_824(&uVar0, iParam0, iParam1);
}
...
{
	return func_508(1328661203, func_825(), -1591664384, bParam0);
}
...
struct<4> func_671(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_508(923904168, func_669(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_508(923904168, func_669(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_508(923904168, func_669(bParam0), -740156546, 0);
}
...
bool func_673(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
{
	if (func_827(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_675(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_508(271701509, func_669(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_508(271701509, func_669(bParam0), 12999093, 0);
}
...
bool func_677(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_510(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_680(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_679(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	func_828(&(Global_1946804->f_2589), iParam0);
}

void func_683(int iParam0, int iParam1)
{
	func_829(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
void func_685(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	iVar1 = 12;
	iVar2 = func_467(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_490(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
		if (bParam4)
		{
			func_683(iVar1, iVar3);
		}
	}
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_831(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_831(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_831(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_831(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_467(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_832(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_467(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_679(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_832(&(Global_1946804->f_1497.f_1[iVar1])) || func_679(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_467(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_467(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_467(&(uParam0->f_1[iVar1])) || func_679(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_833(0);
	if (iParam2 != 0 && func_834(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_835(iParam0, func_492(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_687(var uParam0, bool bParam1, int iParam2)
{
	bVar6 = func_274() != -1;
	iVar7 = func_833(0);
	if (func_488(32768))
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_489(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_836(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_688(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (*uParam0 <= 0)
	{
		return;
	...
	while (iVar0 < *uParam0)
	{
		func_838(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_274() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_839(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_840(0))
		{
...
void func_689(struct<4> Param0)
{
	switch (Param0)
	{
		...
		case 35:
		case 36:
			func_507(Param0, Param0.f_1, Param0.f_2);
			break;
	}
}
...
bool func_692(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
void func_696(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
{
	sVar0 = func_843(0, 1, bParam0, bParam1);
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_847(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_399((*Global_1360165)[iParam0]->f_4.f_2) || func_336((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_847(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_848((*Global_1360165)[iParam0]->f_63))
				{
					if (!func_849(iParam0, 0))
					{
						func_543(iParam0, 25, 0);
					}
				}
			}
			(*Global_1360165)[iParam0]->f_4 = { func_850(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_628(iParam0, 44, 1);
			}
		...
		case 2:
			if (!func_162(func_275(iParam0), 0))
			{
				return false;
			}
			if (iParam5 && iParam10)
...
bool func_704(int iParam0, int iParam1)
{
	...
	bVar0 = func_851(iParam0, iParam1);
	return bVar0;
}
...
void func_705(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_543(iParam0, 25, 1);
	}
}

void func_706(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (!is_entity_dead(iParam1))
	{
		if (func_852(iParam2))
		{
			iVar0 = func_853(iParam2, -1);
			if (func_854(iParam1, iVar0))
			{
				if (func_855(iParam1, iVar0))
				{
					if (func_856(iParam1, iVar0))
					{
...
void func_710(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_664(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_664(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_717(struct<2> Param0, int iParam2)
{
	if (!func_301(Param0))
	{
		return 0;
...
int func_727(var uParam0, char* sParam1)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
...
void func_733(bool bParam0)
{
	...
	if ((Global_1898077->f_2 == 4 && Global_1898077->f_12 != Global_1898077->f_13) && !bParam0)
	{
		...
		func_873(iVar0, Global_1898077->f_12);
	}
	else
	{
...
int func_734()
{
	...
	else if (!func_877((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_877((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_877((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_877((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_877((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_877((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_745(var uParam0, int iParam1)
{
	...
	vVar7 = { uParam0->f_1882 * FtoV(func_746(iParam1)) };
...
bool func_749(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_751(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (func_752(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_571(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_465(&(uParam0->f_1903)))
				{
					func_771(uParam0->f_1903, 0);
					func_886(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_571(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_887())
				{
					func_886(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
bool func_753(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vVar0 = { vParam4 - vParam1 };
	vVar3 = { vParam1 - vParam10 };
	fVar6 = func_889(vParam7, vVar0);
	fVar7 = -func_889(vParam7, vVar3);
...
void func_754(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_482(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_755(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_891(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_757(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_520(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
bool func_758(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_760(int iParam0, float fParam1)
{
	...
	if (!(func_894(17) && func_214(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
bool func_762(var uParam0, int iParam1, bool bParam2)
{
...
void func_763(var uParam0, int iParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_378(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
			if (!is_string_null_or_empty(&cVar1) && _0x6f1f0b17109309da(iParam1, &cVar1))
			{
				...
				{
					func_764(iVar9, Global_35, uParam2, uParam3);
				}
			}
		}
		iVar0++;
...
void func_764(int iParam0, var uParam1, var uParam2, var uParam3)
{
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
...
void func_765(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_379(uParam0->f_1522[iVar0], 1))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_232(Global_35), &vVar7, false, 0, 2))
				{
					fVar19 = (func_482(vVar1, Global_36, 1) - func_482(vVar1, vVar7, 1));
					vVar4.f_2 = (vVar4.z + fVar19);
					set_anim_scene_origin(uParam0->f_1522[iVar0]->f_8, vVar1, vVar4, 2);
				}
			}
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_232(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
				if ((func_8(uParam0) > 3 && !func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_895(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_642(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_783(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_380(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_612(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_351(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_519(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_232(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_335(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_232(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_896(uParam0, 0);
				}
			}
...
bool func_766(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_612(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_768(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_335(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_335(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_484(func_483(Global_35, 0, 1, 0)) && !func_484(func_483(Global_35, 1, 1, 0))))
		{
			if (func_355(uParam0, uParam0->f_1684))
			{
				func_897(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_335(uParam0->f_1016[uParam0->f_1684], 16) && (func_484(func_483(Global_35, 0, 1, 0)) || func_484(func_483(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_335(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_355(uParam0, uParam0->f_1684) && !func_364(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_609(uParam0, 3);
	}
...
void func_769(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_898(uParam0, iParam1, &vVar1, &fVar0);
	func_896(uParam0, func_589(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_899(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_759(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_521(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_897(vVar1);
	...
	if (func_612(uParam0->f_475[iParam1], 16))
	{
		func_900(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
		...
		func_901(uParam0, iParam1, bParam2, &vVar4);
	...
	{
		open_sequence_task(&iVar20);
		func_902(uParam0, iParam1, bParam2, vVar1);
		close_sequence_task(iVar20);
		task_perform_sequence(Global_35, iVar20);
		clear_sequence_task(&iVar20);
	}
...
void func_774(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_907(iVar0));
		iVar0++;
	}
}
...
bool func_778(var uParam0, int iParam1, int iParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_779(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_780(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_784(var uParam0, int iParam1, bool bParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_785(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_786(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_451(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_870(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_451(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_451(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_870(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_870(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_790(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_792(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_379(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_612(uParam0->f_475[iVar0], 512)) || func_612(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_786(uParam0->f_3[iVar0]->f_1))
				{
					if (func_642())
					{
						StringCopy(&cVar1, func_451(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_451(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_797(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_885(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
int func_801(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (!func_908(iParam2))
	{
		return -1;
	...
	iVar0 = func_800(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_878(iVar1, 0);
	func_909(iVar1, 0);
	func_910(iVar1, 0);
...
void func_804(int iParam0, var uParam1, var uParam2, var uParam3)
{
	*uParam3 = func_434(iParam0);
	*uParam1 = func_435(iParam0);
	*uParam2 = func_914(iParam0);
}

char* func_805(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_915(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_809(int iParam0)
{
	if (func_114(iParam0))
	{
		if (does_entity_exist(func_275(iParam0)))
		{
			func_711(iParam0, 67108864, 1);
			func_628(iParam0, 19, 1);
		}
	}
}
...
int func_815(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_517(iParam0))
	{
		return 0;
	...
	if (func_162(iVar0, 0))
	{
		if (func_162(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_812(iParam0)) || func_813(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_918(player_ped_id(), iVar0, 1) < 10000f))
			{
				iVar1 = func_919(iParam0, 1);
				if (iVar1 != 0)
				{
					if (!_0x88ad6cc10d8d35b2(iVar0))
					{
					...
					func_920(iParam0);
					_0x7b204f88f6c3d287(func_921(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_921(iParam0, 0));
					func_922(iParam0);
				}
			}
			else
	...
	{
		if (func_162((*Global_1360165)[iParam0]->f_124, 0))
		{
			if (func_282(iParam0, 32768, 1))
			{
...
int func_821(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	{
		Var0 = { func_499(iParam0, 0, 1) };
		iVar5 = 1728382685;
		Var6.f_9 = -1591664384;
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_924((386 + iVar28), 1);
			if (func_673(iParam0, &Var0, iVar5, 0))
			{
				if (func_674(iParam0, &Var6, iVar5))
				{
					Var29 = { func_508(iParam0, Var0, iVar5, 0) };
					func_925(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_926(0))
				{
					...
					func_927(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_822(int iParam0, int iParam1, float fParam2)
{
	bVar0 = true;
...
int func_824(var uParam0, int iParam1, int iParam2)
{
	iVar0 = 0;
	Var4.f_9 = -1591664384;
	bVar18 = func_929(iParam1, 128);
	if (func_930("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_931(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_929(iParam1, 512) && func_827(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_794(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_929(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_929(iParam1, 4))) && (!func_794(Var4.f_4) || func_929(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_929(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_929(iParam1, 1048576)))
				{
	...
	{
		iParam1 |= 512;
		return func_824(uParam0, iParam1, iParam2);
	}
...
bool func_827(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_510(0);
	*uParam1 = { func_508(iParam0, func_671(0), iParam3, 0) };
...
void func_828(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_935(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_935(uParam0->f_2[iVar0], 1))
				{
					func_936(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_830(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_501(iParam0, 1)] != &Global_1946804->f_57[func_501(iParam0, 1)];
}

void func_831(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
	...
	if (uParam0->f_1[iVar3]->f_1 == 1216705912 || uParam0->f_1[iVar3]->f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_683(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_683(iVar3, iVar0);
		}
	}
...
{
	if (iParam0 == &Global_1946804->f_57[func_501(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_838(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_274() == -1)
	{
		func_940(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_941(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
char* func_843(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
float func_844()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_951()));
	fVar7 = (func_946(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_952(3, round((to_float(iVar8) * fVar10)), 0);
	func_953(3, fVar9, fVar9 > 100f);
	return func_954(fVar7, -100f, 100f);
}
...
float func_845()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_951()));
	fVar7 = (func_946(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_952(2, round((to_float(iVar8) * fVar10)), 0);
	func_953(2, fVar9, fVar9 > 100f);
	return func_954(fVar7, -100f, 100f);
}
...
float func_846()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_951()));
	fVar7 = (func_946(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_952(1, round((to_float(iVar8) * fVar10)), 0);
	func_953(1, fVar9, fVar9 > 100f);
...
int func_847(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_877((*Global_1347702)[63]->f_15, 1) || func_336((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_877((*Global_1347702)[134]->f_15, 1) || func_336((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_877((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_958(747937920, 1) && !func_877((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_275(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
bool func_849(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_542(iParam0, 44, 1))
		{
			return false;
		}
	}
...
struct<7> func_850(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
int func_853(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_960(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_960(1237718549, iParam1);
			return func_961(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_858(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_854(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_854(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_854(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_854(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_854(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_854(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_854(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_854(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_854(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_854(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_854(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_854(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_854(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_854(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_854(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_854(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_854(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_854(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_854(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_854(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_854(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_854(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_854(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_854(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_854(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_854(iParam1, 1544915253))
	{
...
{
	func_962(iParam0, 1);
	func_962(iParam0, 128);
	func_962(iParam0, 256);
	func_962(iParam0, 512);
	func_962(iParam0, 1024);
	func_962(iParam0, 2048);
	func_962(iParam0, 4096);
	func_962(iParam0, 65536);
	func_962(iParam0, 16384);
	func_962(iParam0, 262144);
	func_962(iParam0, 524288);
	func_962(iParam0, 1048576);
	func_962(iParam0, 2097152);
	func_962(iParam0, 32768);
	func_962(iParam0, 131072);
	func_962(iParam0, 134217728);
	func_962(iParam0, 1073741824);
}
...
void func_862(int iParam0)
{
	...
	if (func_919(iParam0, 0) == 0)
	{
		return;
	}
	iVar0 = func_635(iParam0);
	func_861(iVar0);
	func_814(iParam0, 8192, 1);
}
...
bool func_890(var uParam0, int iParam1)
{
	...
	if ((func_484(func_795(Global_35, 0, 0, 0)) && !func_335(uParam0->f_1016[iParam1], 16)) && !func_335(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_891(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
	...
	if (func_974(uParam0, iParam1, sParam2))
	{
...
void func_892(var uParam0, var uParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
...
void func_895(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		iVar0 = func_795(Global_35, 0, 0, 0);
		if (is_weapon_valid(iVar0))
		{
		...
		iVar0 = func_795(Global_35, 0, 1, 0);
		if (is_weapon_valid(iVar0))
		{
			if (_0x2c83212a7aa51d3d(iVar0))
			{
...
void func_896(var uParam0, bool bParam1)
{
	...
	if ((func_351(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_335(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_519(uParam0, 64);
	}
...
void func_897(vector3 vParam0)
{
	iVar0 = 250;
	if (func_484(func_483(Global_35, 0, 1, 0)) || func_484(func_483(Global_35, 1, 1, 0)))
	{
		iVar0 = 2000;
	}
	...
	if (!func_90(vParam0))
	{
		fVar1 = func_482(Global_36, vParam0, 1);
...
void func_898(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_612(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_570(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_520(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_482(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_570(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_520(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_482(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_977(uParam0) };
		...
		else if (!func_520(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_482(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
bool func_899(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_232(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_232(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
void func_900(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, var uParam7)
{
	func_978(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_978(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_979(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}

void func_901(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_482(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_520(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
		task_achieve_heading(0, uParam0->f_1016[&uParam0->f_475[iParam1]]->f_40, 0);
	}
	else
	{
		vVar0 = { func_980(uParam0, iParam1) };
		if (!func_90(vVar0))
		{
...
void func_902(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	vVar0 = { func_980(uParam0, iParam1) };
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_482(Global_36, vParam3, 1), 0);
		}
		fVar3 = func_482(vParam3, vVar0, 1);
		if (func_520(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			fVar3 = uParam0->f_1016[&uParam0->f_475[iParam1]]->f_40;
		}
		if (func_612(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_520(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_520(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
{
	bVar3 = func_983(iParam0);
	if (func_679(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
	...
	else if (func_660(&iVar2))
	{
		if (func_679(iVar2, -1303648999))
		{
			iVar0 = func_984();
		}
		else
...
var func_915(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}
...
float func_918(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
	...
	return func_249(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_919(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_989(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_921(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_990(iParam0);
	}
...
bool func_925(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
	...
	if (!_0x3e4e811480b3ae79(func_510(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_926(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_510(bParam0));
}
...
void func_928(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_993(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_930(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = _0x80d78bdc9d88ef07(func_510(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_942(var uParam0, int iParam1)
{
	if (func_274() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_940(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
...
void func_952(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_843(iParam0, 1, 0, 0);
	sVar0 = _create_var_string(2, sVar0, sParam1);
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[iParam0]->f_12[1]), sVar0);
	_databinding_write_data_bool(&(Global_1955569->f_5.f_2[iParam0]->f_16[1]), bParam2);
}

void func_953(int iParam0, float fParam1, bool bParam2)
{
	sVar0 = func_843(iParam0, 2, 0, 0);
...
float func_954(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_957(int iParam0, int iParam1, int iParam2)
{
	if (iParam1 == 24)
	{
		iParam1 = 0;
...
void func_971(int iParam0, int iParam1)
{
	...
	{
		func_735(&(Global_1898164->f_1[0]), 3);
	}
}
...
bool func_974(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
{
	iVar0 = func_795(Global_35, 0, iParam0, 0);
	if (func_484(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
		...
		else if (func_794(iVar0))
		{
			if (func_484(func_795(Global_35, 0, 7, 0)) || func_484(func_795(Global_35, 0, 9, 0)))
			{
				if (func_484(func_795(Global_35, 0, 8, 0)))
				{
					func_1003(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_484(func_795(Global_35, 0, 7, 0)) || func_484(func_795(Global_35, 0, 9, 0)))
			{
				if (func_484(func_795(Global_35, 0, 10, 0)))
				{
					func_1003(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_484(func_795(Global_35, 0, 2, 0)))
				{
...
void func_978(var uParam0, float fParam1, vector3 vParam2, vector3 vParam5)
{
	*uParam0 = fParam1;
	uParam0->f_4 = { vParam2 };
	uParam0->f_1 = { vParam5 };
...
Vector3 func_979(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
...
Vector3 func_980(var uParam0, int iParam1)
{
...
bool func_981(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_1006(iParam0, 0, bParam2) >= iParam1;
}
...
int func_1006(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_466(iParam0, 0))
	{
		return 0;
	...
	uVar2 = _0xe787f05dfc977bde(func_510(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_1007()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_794(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_794(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_1009(int iParam0, int iParam1)
{
	...
	if (func_679(iParam0, 1399091007))
	{
		func_1012(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_1010(int iParam0, bool bParam1)
{
	...
	Var0 = { func_1013(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_1014(&Var0, func_671(0));
	}
...
void func_1012(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
struct<14> func_1013(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
...
bool func_1015(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_510(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
