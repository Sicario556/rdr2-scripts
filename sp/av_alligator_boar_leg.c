void __EntryFunction__()
{
	...
	Var0 = Local_45;
	Var0.f_1 = Local_45.f_11;
	Var0.f_483 = { Local_45.f_1 };
	Var0.f_486 = { Local_45.f_4 };
	Var0.f_489 = Local_45.f_7;
	Var0.f_20[0] = Local_45.f_8;
	Var0.f_453 = Local_45.f_9;
	Var0.f_500 = Local_45.f_10;
	Var0.f_503 = Local_45.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 10828, 10886, 11532);
}
...
{
	func_46(uParam0, "GATOR_BOAR_LEG", "script@ambient@animal@alligator_ambush_boar_leg@action", vParam1, vParam4);
...
{
	bLocal_15 = is_entity_dead(&(uParam0->f_20[0]));
	bLocal_16 = is_entity_dead(&(uParam0->f_20[1]));
	if (!bLocal_15)
	{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_14 == 1)
		{
			if (func_64(uParam0, &uLocal_17, 1) || func_65(Global_35, uParam0->f_483, 1) < 225f)
			{
				bLocal_14 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_14)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_73(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (_is_anim_scene_finished(uParam0->f_3.f_1, false) || _is_anim_scene_active(uParam0->f_3.f_1))
							{
								if (!is_entity_dead(&(uParam0->f_20[0])))
								{
									func_74(uParam0->f_20[1]);
									func_74(uParam0->f_20[0]);
									uParam0->f_469[3] = 1;
									return 1;
								}
							}
...
void func_70(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[1])))
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 1899357633))
		{
			set_ped_to_ragdoll(&(uParam0->f_20[1]), 10000, 10000, 0, false, false, false);
			func_109(&(uParam0->f_20[1]), 0, 0);
		}
		else if (!func_110(&(uParam0->f_20[1]), 518218985))
		{
...
void func_106(int iParam0, vector3 vParam1)
{
	iVar1 = -1;
	iVar0 = 0;
	while (iVar0 < 10)
