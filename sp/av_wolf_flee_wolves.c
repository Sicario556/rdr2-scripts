void __EntryFunction__()
{
	...
	sLocal_39 = "dead_left";
	iLocal_46 = get_random_int_in_range(60, 71);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
	...
	Var0 = Local_53;
	Var0.f_1 = Local_53.f_11;
	Var0.f_483 = { Local_53.f_1 };
	Var0.f_486 = { Local_53.f_4 };
	Var0.f_489 = Local_53.f_7;
	Var0.f_20[0] = Local_53.f_8;
	Var0.f_453 = Local_53.f_9;
	Var0.f_500 = Local_53.f_10;
	Var0.f_503 = Local_53.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 11129, 11218, 12306);
}
...
{
	func_46(uParam0, "WOLF_FLEE_WOLVES", "script@ambient@animal@wolf_flee_from_wolves@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "wolf_01", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "wolf_02", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 2, "wolf_03", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 3, "wolf_04", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 4, "carcass", 1110710183, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0.3f, 0f), (vParam4.z - 270f), 1, 0, 1, 1, 41788943, 1);
}
...
{
	if (!has_anim_dict_loaded(sLocal_38))
	{
		return 0;
	}
	if (!_has_scenario_type_loaded(1974927641, false))
	{
		return 0;
	}
...
bool func_28(var uParam0)
{
	...
	while (iVar0 <= 3)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			_0x9520175b35e2268d(&(uParam0->f_20[iVar0]), 1);
	...
	if (!is_entity_dead(&(uParam0->f_20[4])))
	{
		...
		task_play_anim(&(uParam0->f_20[4]), sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		_0x3ca5e58c9731a16b(&(uParam0->f_20[4]), iLocal_46);
		_0x674b90be1115846d(&(uParam0->f_20[4]), 1);
		set_ped_keep_task(&(uParam0->f_20[4]), true);
		func_57(uParam0->f_20[4], 1, 1);
		set_entity_no_collision_entity(&(uParam0->f_20[4]), &(uParam0->f_20[0]), true);
		set_entity_no_collision_entity(&(uParam0->f_20[0]), &(uParam0->f_20[4]), true);
	}
	return true;
}
...
{
	request_anim_dict(sLocal_38);
	_request_scenario_type(1974927641, 1, -885451903, 0);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_52 == 1)
		{
			if (func_67(uParam0, &uLocal_10, 1) || func_68(Global_35, &(uParam0->f_20[0]), 1) <= 625f)
			{
				bLocal_52 = true;
			}
		}
		if (bLocal_52)
		{
			...
			if (!&uParam0->f_469[8])
			{
				func_72(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[8] = 1;
			}
			func_73(uParam0);
			uParam0->f_469[0] = 1;
					...
					if (_is_anim_scene_loaded(uParam0->f_3.f_1, true, false))
					{
						if (_0x1f0e401031e20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!&uParam0->f_469[3])
							{
								...
								{
									if (has_anim_event_fired(&(uParam0->f_20[0]), 811542464))
									{
										remove_anim_scene_entity(uParam0->f_3.f_1, uParam0->f_20[0]->f_1, &(uParam0->f_20[0]));
										force_ped_motion_state(&(uParam0->f_20[0]), -530524, false, 0, false);
										if (!is_entity_dead(Global_35))
										{
											_task_smart_flee_style_ped(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 3, 256, -1082130432, -1, 0);
											set_ped_keep_task(&(uParam0->f_20[0]), true);
										}
										set_ped_desired_move_blend_ratio(&(uParam0->f_20[0]), 2f);
							...
							if (!&uParam0->f_469[4])
							{
								...
								{
									task_eat(&(uParam0->f_20[1]), &(uParam0->f_20[4]), 0);
									set_ped_keep_task(&(uParam0->f_20[1]), true);
									func_57(uParam0->f_20[1], 1, 1);
									uParam0->f_469[4] = 1;
								}
							}
							if (!&uParam0->f_469[5])
							{
								...
								{
									_task_start_scenario_in_place(&(uParam0->f_20[2]), 1974927641, 70000, false, 0, -1f, false);
									_0x2208438012482a1a(&(uParam0->f_20[2]), false, false);
									set_ped_keep_task(&(uParam0->f_20[2]), true);
									func_57(uParam0->f_20[2], 1, 1);
									uParam0->f_469[5] = 1;
								}
							}
							if (!&uParam0->f_469[6])
							{
								...
								{
									_task_start_scenario_in_place(&(uParam0->f_20[3]), 1974927641, 70000, false, 0, -1f, false);
									_0x2208438012482a1a(&(uParam0->f_20[3]), false, false);
									set_ped_keep_task(&(uParam0->f_20[3]), true);
									func_57(uParam0->f_20[3], 1, 1);
									uParam0->f_469[6] = 1;
								}
							}
	...
	while (iVar0 <= 3)
	{
		if (!is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			if (iVar0 == 0)
			{
				...
				{
					_task_smart_flee_style_ped(&(uParam0->f_20[iVar0]), Global_35, 4, 256, -1082130432, -1, 0);
					func_57(uParam0->f_20[iVar0], 0, 1);
					set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
				}
			}
			else if (func_91(Global_35, uParam0->f_483, 1) <= 2500f)
			{
				if (!func_112(&(uParam0->f_20[iVar0]), 780511057))
				{
					task_combat_ped(&(uParam0->f_20[iVar0]), Global_35, 0, 0);
					func_57(uParam0->f_20[iVar0], 0, 1);
					set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
				}
			}
			else if (!func_112(&(uParam0->f_20[iVar0]), 518218985))
			{
				_task_smart_flee_style_ped(&(uParam0->f_20[iVar0]), Global_35, 4, 256, -1082130432, -1, 0);
				func_57(uParam0->f_20[iVar0], 0, 1);
				set_ped_keep_task(&(uParam0->f_20[iVar0]), true);
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_68(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_68(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_69(&(uParam0->f_490)))
							{
...
bool func_81(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_124(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_82(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_124(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_125(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
float func_91(int iParam0, vector3 vParam1, bool bParam4)
{
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_124(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_111(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_172(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_172(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_172(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
