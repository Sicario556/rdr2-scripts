...
bool func_72(var uParam0)
{
	...
	vVar0 = { _get_object_offset_from_coords(vLocal_59, vLocal_62.z, -0.584518f, -1.37169f, -0.000602722f) };
	vVar3 = { _get_object_offset_from_coords(vLocal_59, vLocal_62.z, 1.42059f, -0.462698f, 0.000679016f) };
...
{
	iLocal_65 = create_scenario_point_attached_to_entity(func_172(uParam0, iLocal_17), 139049053, 0f, 0f, 0.5f, -180f, 0, 0, 0);
	iLocal_66 = create_scenario_point_attached_to_entity(func_172(uParam0, iLocal_18), 50699433, 0f, 0f, 0.5f, -180f, 0, 0, 0);
	_set_scenario_point_flag(iLocal_65, 23, true);
	_set_scenario_point_flag(iLocal_65, 25, true);
	_set_scenario_point_flag(iLocal_66, 23, true);
	_set_scenario_point_flag(iLocal_66, 25, true);
	return true;
}
...
{
	if (does_entity_exist(func_172(uParam0, iLocal_19)))
	{
		freeze_entity_position(func_172(uParam0, iLocal_19), true);
	}
	if (_does_scenario_point_exist(iLocal_65) && _does_scenario_point_exist(iLocal_66))
	{
		return true;
	}
	return false;
...
{
	set_ped_reset_flag(func_48(uParam0, iLocal_14), 53, true);
	set_ped_reset_flag(func_48(uParam0, iLocal_15), 53, true);
	if (func_202(uParam0, iLocal_20))
	{
		if (_does_scenario_point_exist(iLocal_65))
		{
			_task_use_scenario_point(func_48(uParam0, iLocal_14), iLocal_65, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1f, false);
		}
		if (_does_scenario_point_exist(iLocal_66))
		{
			_task_use_scenario_point(func_48(uParam0, iLocal_15), iLocal_66, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1f, false);
		}
	...
	{
		if (is_ped_active_in_scenario(func_48(uParam0, iLocal_14), 0) && is_ped_active_in_scenario(func_48(uParam0, iLocal_15), 0))
		{
			...
			if (iLocal_25 >= 0)
			{
				set_anim_scene_origin(&(uParam0->f_1984[iLocal_25]), vLocal_59, vLocal_62, 2);
...
bool func_96(var uParam0)
{
	...
	if (_does_scenario_point_exist(iLocal_65))
	{
		if (!_0x9c54041bb66bcf9e(func_213(3), iLocal_65))
		{
			_delete_scenario_point(iLocal_65);
		}
		iVar0 = 0;
	}
	if (_does_scenario_point_exist(iLocal_66))
	{
		if (!_0x9c54041bb66bcf9e(func_213(9), iLocal_66))
		{
			_delete_scenario_point(iLocal_66);
		}
		iVar0 = 0;
	}
	return iVar0;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_213(iParam0), 137, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_213(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_213(iParam0), 204, false);
	}
}
...
Vector3 func_155(var uParam0, vector3 vParam1)
{
	...
	fVar4 = (((vParam1.x - vVar0.x) * cos(fVar3)) + ((vParam1.y - vVar0.y) * sin(fVar3)));
	fVar5 = ((-(vParam1.x - vVar0.x) * sin(fVar3)) + ((vParam1.y - vVar0.y) * cos(fVar3)));
...
void func_189(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = _create_propset_2(uParam0->f_1976, func_259(uParam0, uParam0->f_1976.f_1), 1, func_258(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_304(uParam0->f_107[iVar0]->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_305(uParam0->f_107[iVar0]->f_1, fVar4);
				func_304(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_211(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0]->f_32.f_60 > 0f && !uParam0->f_107[iVar0]->f_32.f_62) && func_306(uParam0, uParam0->f_107[iVar0]->f_32.f_61, uParam0->f_107[iVar0]->f_32.f_60))
		{
...
void func_234(int iParam0)
{
	if (func_50(iParam0))
	{
		if (does_entity_exist(func_213(iParam0)))
		{
...
void func_255(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
...
void func_351(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_305(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_355(var uParam0, int iParam1)
{
	...
	func_392(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_356(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_395(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
bool func_375(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_402((*Global_1835011)[iParam0]->f_1, 1);
	}
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_410(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_411(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_413(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 7:
			...
			func_415(iParam0, Global_1360165[iParam0]);
...
int func_399(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_428(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_426();
				}
			}
			if ((bParam2 && !func_214(vVar0)) && !func_215(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				...
				func_410((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
			...
			func_429((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_438((*Global_1360165)[iParam0]->f_4.f_2) || func_439((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_440((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_442(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_410(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_447(Global_35) && is_player_teleport_active())
	{
	}
	if (func_448(iParam0))
	{
...
bool func_428(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_458(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_429(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_213(iParam1)))
	{
		_0x931b241409216c1f(func_213(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_213(iParam1), iParam0);
...
int func_437(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_402((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_402((*Global_1347702)[63]->f_15, 1) || func_439((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_402((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_402((*Global_1347702)[134]->f_15, 1) || func_439((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_402((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(747937920, 1) && !func_402((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_213(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_453(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_417(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_417(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_417(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_417(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_417(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_417(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_417(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_417(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_417(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_417(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_417(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_417(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_417(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_417(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_417(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_417(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_417(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_417(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_417(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_417(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_417(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_417(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_417(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_417(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_417(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_417(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_472(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_483(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_487(0))
				{
					...
					func_488(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_489(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_506(_get_weapon_clip_size(iParam0), iParam1);
