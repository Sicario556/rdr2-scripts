...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[35]->f_4;
	_0xb469cfd9e065eb99(iLocal_14, 8);
	iLocal_15 = _create_popzone_from_volume(iLocal_14);
	set_popzone_population_set(iLocal_15, -1173148476);
	_0x7e6bc0b94f5928f0(iLocal_15, 19, 19);
	_0x08892122769770d5(iLocal_15, true);
	_0x0f1861101c9a9944(iLocal_15, true);
	return true;
}
...
bool func_63(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_95(iParam0));
}
...
{
	func_51(0.775f, 0.2f, 0.025f, 0f);
	if (_is_popzone_valid(iLocal_15))
	{
		_delete_script_popzone(iLocal_15);
	}
	iParam0 = iParam0;
}
...
void func_81(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_127(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_84(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
...
char* func_109(char* sParam0, int iParam1)
{
	...
	return func_152(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_112(int iParam0)
{
	...
	if (func_153())
	{
		if (!func_154((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_158(Global_1935369->f_5[iParam0]->f_6, 1);
	func_159(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_87(Global_1914319->f_3[iParam0]->f_21) && func_161(Global_1914319->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_127(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
var func_147(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_181(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
