...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, 1210783447, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	if (func_148(uParam0) == 6)
	{
		iLocal_18 = func_152(uParam0, -1006095118, 0.766328f, 0.213268f, -0.0161057f, 0, 1, 0, 1);
	}
	if (func_148(uParam0) == 6)
	{
	...
	else if (func_148(uParam0) == 6)
	{
		...
		func_156(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	if (func_148(uParam0) != 6)
	{
		func_155(uParam0, iLocal_15, 4, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_15, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	}
	if (!func_158() && func_148(uParam0) != 6)
	{
		...
		func_156(uParam0, iLocal_16, 3, 1002153075, "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0, -1073741824, 1.2f, 1);
	}
	if (func_158())
	{
		func_159(uParam0);
...
{
	if (_0x54b187f111d9c6f8(func_48(uParam0, iLocal_14), 0))
	{
		return false;
	}
	if (is_any_speech_playing(func_48(uParam0, iLocal_14)))
	{
		return false;
	}
	return true;
...
void func_162(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_254(1101004800, 1123024896);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_302(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_254(100f, 140f);
			}
		}
