...
{
	func_33(uParam0, 10920, 10986, 11855);
}
...
{
	bLocal_41 = is_entity_dead(&(uParam0->f_20[0]));
	bLocal_42 = is_entity_dead(&(uParam0->f_20[1]));
	if (!bLocal_41)
	{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (bLocal_40)
		{
			if ((bLocal_41 || bLocal_42) || !has_anim_event_fired(&(uParam0->f_20[0]), 725039534))
			{
...
void func_71(var uParam0)
{
	if (func_66(Global_35, uParam0->f_483, 1) <= 2500f)
	{
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			if (!func_110(&(uParam0->f_20[0]), 780511057))
			{
		...
		if (!is_entity_dead(&(uParam0->f_20[1])))
		{
			if (!func_110(&(uParam0->f_20[1]), 780511057))
			{
