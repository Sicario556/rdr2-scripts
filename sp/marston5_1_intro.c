void __EntryFunction__()
{
	...
	while (!func_5(&Local_29, 1))
	{
		...
		if (((((func_6(&Local_29) >= 5 && func_6(&Local_29) <= 7) && !func_5(&Local_29, 4096)) && _does_anim_scene_exist(Local_29.f_428.f_444)) && _is_anim_scene_started(Local_29.f_428.f_444, false)) && !_is_anim_scene_paused(Local_29.f_428.f_444))
		{
		...
		switch (func_6(&Local_29))
		{
			...
			case 3:
				...
				func_39(&Local_29);
				if (func_40(func_32((*Global_1835011)[Local_29]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_29.f_428)) == 4 && _does_anim_scene_exist(Local_29.f_428.f_444)) && _is_anim_scene_paused(Local_29.f_428.f_444))
				{
					func_37(Local_29);
					func_17(&Local_29, 7);
				}
...
bool func_41(int iParam0)
{
	...
	{
		disable_control_action(2, -640622144, false);
	}
	if (func_7(iParam0))
	{
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		if (func_137(func_255(iVar0), 0))
		{
			if (is_ped_group_member(func_255(iVar0), func_256(), 1))
			{
...
bool func_128(int iParam0)
{
	...
	set_entity_coords(&(uLocal_14[2]), -2565.943f, 341.3659f, 153.721f, true, false, true, true);
	if (!func_272(&(uLocal_14[2]), -982327190))
	{
		task_stand_still(&(uLocal_14[2]), -1);
	}
	if (!func_273(uLocal_18[0], 1058703817, -2593.709f, 409.9878f, 147.9886f, 270f, 1))
	{
		return false;
	}
	if (!func_273(uLocal_18[1], -238593141, -2593.888f, 410.3419f, 147.9886f, 132.5941f, 1))
	{
		return false;
	}
	...
	if (!_0xa0bc8faed8cfeb3c(&(uLocal_14[0])) || !_0xa0bc8faed8cfeb3c(&(uLocal_14[1])))
	{
		return false;
	}
	if (!_does_volume_exist(iLocal_22))
	{
		iLocal_22 = _create_volume_box(-2584.737f, 412.299f, 148.2046f, 0f, 0f, 58.25f, 8f, 8f, 8f);
	}
...
char* func_138(int iParam0)
{
	...
	{
		return func_286(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_287(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_140(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_291(), true);
	}
}
...
void func_152(int iParam0, vector3 vParam1, bool bParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if ((fVar3 <= fParam5 && fVar3 > fParam6) && fVar3 > fParam7)
	{
		...
		if ((func_311() && !is_entity_dead(iVar1)) && _is_draft_vehicle(iVar1))
		{
			iVar4 = 0;
			while (iVar4 < 6)
			{
	...
	if (bParam4)
	{
		if (fVar3 <= fParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_272(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_272(iParam0, -828834893))
			{
...
bool func_153(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
int func_155(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_312(get_player_index(), 0, 0, 1);
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_319(uParam0, uParam0->f_1684))
				{
					...
					{
						func_321(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_315(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_321(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_156(var uParam0)
{
	...
	return (func_341() - round((uParam0->f_1 * 1000f)));
}
...
void func_161(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (func_344(uParam0, iParam1, sParam2))
	{
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_349(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_350(uParam0->f_1522[iVar0], 128))
				{
					func_351(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
int func_166(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_307(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_307(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_307(iParam0));
	...
	_0x7b204f88f6c3d287(func_307(iParam0));
	return 1;
}
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_355((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_355((*Global_1835011)[*iParam0], 65536);
		}
	}
...
void func_171(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_358((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_360((*uParam1)[iVar0]))
		{
			if (func_358((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_361((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_362((*uParam2)[iVar0]))
		{
			if (func_358((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_363((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_364((*uParam3)[iVar0]))
		{
			if (func_358((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_365((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_367((*uParam5)[iVar0]))
		{
			if (func_358((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_368((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_367((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_369((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_358((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_370((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_371((*uParam6)[iVar0]))
		{
			if (func_358((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_372((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_373((*uParam7)[iVar0]))
		{
			if (func_358((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_374((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_375((*uParam8)[iVar0]))
		{
			if (func_358((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_376((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_377((*uParam9)[iVar0]))
		{
			if (func_358((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_378((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_379((*uParam10)[iVar0]))
		{
			if (func_358((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_380((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_381((*uParam11)[iVar0]))
		{
			if (func_358((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_382((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_201(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_310(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_214(bool bParam0, bool bParam1)
{
	if (!func_399(Global_43801))
	{
		Global_43801 = func_404("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_405(Global_43801, 0, 1);
		func_406(Global_43801, 6, 1);
		if (bParam1)
		{
			func_406(Global_43801, 14, 1);
		}
	}
	else
	{
		...
		if (func_408(Global_43801, 1) != 0f && bParam0)
		{
			func_405(Global_43801, 1, 1);
		}
		else
		{
			func_405(Global_43801, 0, 1);
		}
		return func_409(Global_43801, 1);
	}
	return false;
}
...
void func_225(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_412(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_396() };
...
void func_226(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_242(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_413(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_229()
{
	return func_402(_0xc17f69e1418cd11f(3));
}
...
void func_234(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_430() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_431(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_242(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_437(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_437(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_441(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_439(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_246(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_449(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_251(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_455(1, (func_254() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_440(32768) && iParam1 != &Global_1946804->f_57[func_453(iParam3, 1)])
			{
				func_457();
...
bool func_253(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_285(*iParam1, 2))
	{
		...
		else if ((func_466(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_466(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_466(iParam2, 1024))) || func_466(iParam2, 8)) && !func_285(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_467(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_466(iParam2, 4096)) && !func_285(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_467(iParam1, 2048);
			func_467(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_466(iParam2, 32)) && !func_285(*iParam1, 5632))
		{
...
int func_265(var uParam0, int iParam1)
{
	...
	if (func_143())
	{
		...
		if (func_473(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_474(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_297(uParam0, 8) && _0xdd0b7c5ae58f721d(func_475()))
	{
		_0x798be43c9393632b(func_475());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_475())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_268(int iParam0)
{
	...
	return func_477((*Global_1835011)[iParam0]->f_1);
}
...
bool func_271(var uParam0, int iParam1)
{
	...
	{
		func_480(iParam1, 1);
		*uParam0 = func_481(iParam1, 1, 0, 0, 1, 1);
	}
	if (!does_entity_exist(*uParam0))
	{
		return false;
...
bool func_273(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
...
{
	*uParam1 = get_object_index_from_entity_index(func_483(iParam0, 0));
...
int func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		...
		{
			if (func_358((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_360((*uParam1)[iVar1]))
		{
			if (func_358((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_362((*uParam2)[iVar1]))
		{
			if (func_358((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		if (func_364((*uParam3)[iVar1]))
		{
			if (func_358((*uParam3)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam5)
	{
		if (func_367((*uParam5)[iVar1]))
		{
			if (func_358((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_358((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_488((*uParam5)[iVar1]))
				{
					if (func_489((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_369((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_371((*uParam6)[iVar1]))
		{
			if (func_358((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_373((*uParam7)[iVar1]))
		{
			if (func_358((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_375((*uParam8)[iVar1]))
		{
			if (func_358((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_377((*uParam9)[iVar1]))
		{
			if (func_358((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_379((*uParam10)[iVar1]))
		{
			if (func_358((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_381((*uParam11)[iVar1]))
		{
			if (func_358((*uParam11)[iVar1]->f_2, iParam12))
			{
...
int func_308(int iParam0, bool bParam1)
{
	...
	func_304(iParam0);
	_0xfc77c5b44d5ff7c0(func_307(iParam0));
	func_517(iParam0, 0);
	return 1;
}
...
bool func_310(vector3 vParam0, vector3 vParam3)
{
...
void func_314(var uParam0, int iParam1, bool bParam2)
{
	...
	if (func_63(uParam0, 16))
	{
		...
		fVar5 = func_434(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_321(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
...
void func_321(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_514(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_434(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
...
bool func_344(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
void func_368(var uParam0)
{
	if (!func_574(uParam0->f_2, 1))
	{
		if (func_488(uParam0))
		{
			...
			{
				sVar0 = func_401(get_entity_model(Global_35));
...
void func_394(struct<4> Param0)
{
	...
	if (func_586(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_586(20))
			{
				return;
			}
			iVar0++;
...
void func_421(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_436(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_422()
{
	...
	if (func_436(iVar0) && _is_weapon_two_handed(iVar0))
	{
...
int func_424(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_433(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_285(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_285(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_285(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_285(iParam5, 32), true);
	...
	else if (func_285(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_285(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_285(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
void func_443(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_441(1108822547, 6))
	{
		if (bParam2)
		{
			func_439(iParam0, iVar0, func_254() != -1, 0, 0);
...
bool func_454(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_440(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_626(iParam0, iParam2, iParam1, func_254() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_446(func_444(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
int func_480(int iParam0, bool bParam1)
{
	...
	{
		func_517(iParam0, _create_persistent_character(func_305(iParam0)));
		if (func_254() == -1)
		{
			if (func_300(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_307(iParam0));
				func_303(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_307(iParam0));
		}
		return 0;
	}
	...
	func_517(iParam0, _create_persistent_character(func_305(iParam0)));
	_0x4f81ead1de8fa19b(func_307(iParam0));
	if (func_300(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_307(iParam0));
		func_303(iParam0, 2048);
...
int func_481(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_301(iParam0)) && !is_entity_dead(iVar0))
	{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_433(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_650(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_652(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_137(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_654(Global_1360165[iParam0], 1);
				}
			}
			func_648(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_655(Global_1360165[iParam0]))
				{
				}
			}
			func_656(iParam0, Global_1360165[iParam0]);
...
void func_504(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_165() || !_0x6f1f0b17109309da(Global_43800, func_211(iParam0))))
	{
...
void func_522(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
		{
			...
			else if ((!func_670(512) || func_671(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_514(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_153(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_321(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					...
					func_673(uParam0, iVar2, iVar0, bVar3);
				}
				else if (func_674(uParam0->f_1633[iVar2]) != 0)
				{
					func_673(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_514(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_193(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_153(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_525(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_675(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
		...
		case 1:
			...
			{
				func_676(uParam0, iParam1, &uVar6, vVar9, &fVar12, &fVar13, &fVar14, &fVar15);
				if (fVar14 < fVar15)
				{
...
void func_526(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_678(uParam0, iVar0)) && !func_473(uParam0->f_1016[iVar0], 1))
			{
				if (!func_679(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_158(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_680(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_540(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_675(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (func_557(uParam0->f_475[iParam1], 64) && func_683(uParam0, iParam1, 0))
				{
					func_684(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_685(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					...
					{
						func_685(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_543(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_320(uParam0) != 11) && func_319(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_350(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_350(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_158(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_545(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_320(uParam0))
	{
		case 0:
			if (!bParam3)
			{
				if (!func_687(uParam0, iVar2))
				{
					uParam0->f_1685 = iParam1;
				}
				uParam0->f_475[iParam1]->f_7 = 1;
			}
			if (((!func_298(uParam0->f_1016[iVar2], 32) && func_688()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_298(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 7:
			...
			if (func_272(Global_35, 242628503) || bVar0)
			{
				func_554(uParam0, 3);
				if (bVar0)
				{
		...
		case 4:
			...
			if ((func_298(uParam0->f_1016[iVar2], 256) || !func_416(&uVar5)) || bVar0)
			{
				if (func_692())
				{
					func_693();
...
bool func_548(var uParam0, char* sParam1, int iParam2)
{
	...
	{
		iVar16 = -1;
		func_696(uParam0, iVar18);
		if (func_697(uParam0, 0))
		{
			if (func_698(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					uParam0->f_1016[iVar16]->f_27 = 0;
					func_699(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_699(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_699(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_699(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_699(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_699(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_699(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_699(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_699(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_699(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_699(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_699(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_699(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_699(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_699(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_698(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_699(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_699(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_699(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					if (func_700(uParam0, 21, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_19), {Var20}, 3);
					}
					if (func_700(uParam0, 22, &Var20))
					{
						MemCopy(&(uParam0->f_1016[iVar16]->f_22), {Var20}, 3);
					}
					func_698(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_701(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_700(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					if (func_698(uParam0, 39, &iVar17))
					{
					...
					if (func_699(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_680(uParam0->f_1016[iVar16], 2);
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_702(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				{
					if (func_698(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_703(uParam0->f_1522[iVar16], 2);
							func_700(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_704(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_703(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_698(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_703(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_703(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
			...
			while (iVar18 < 35)
			{
				...
				{
					if (func_698(uParam0, 51, &iVar17))
					{
						Var2.f_1 = iVar17;
					}
					func_698(uParam0, 43, &(Var2.f_3));
					if (func_700(uParam0, 52, &Var20))
					{
						MemCopy(&(Var2.f_4), {Var20}, 4);
					}
					func_699(uParam0, 53, &(Var2.f_8));
					if (func_698(uParam0, 54, &iVar17))
					{
						Var2.f_10 = iVar17;
					}
					func_704(uParam0, 55, &(Var2.f_11));
					func_704(uParam0, 56, &(Var2.f_12));
					iVar32 = -1;
					if (func_705(uParam0, Var2.f_1, &iVar32))
					{
				...
				if (func_697(uParam0, 57))
				{
					if (func_698(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_698(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_698(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_707(iVar17);
							}
							if (func_698(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_708(iVar17);
							}
							func_698(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_699(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_699(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_699(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_698(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_699(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_698(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_698(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							if (func_698(uParam0, 73, &iVar17))
							{
								uParam0->f_475[iVar16]->f_17 = iVar17;
							}
							if (func_698(uParam0, 75, &iVar17))
							{
								uParam0->f_475[iVar16]->f_4 = iVar17;
								bVar15 = true;
							}
							func_699(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
							if (func_704(uParam0, 63, &bVar19))
							{
								if (bVar19)
								{
			...
			while (iVar18 < 8)
			{
				...
				{
					func_698(uParam0, 86, &iVar16);
					if (iVar16 >= 0)
					{
						func_704(uParam0, 87, uParam0->f_1345[iVar18]);
						func_700(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_700(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_699(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_699(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_698(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_709(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_697(uParam0, 98))
				{
					if (func_698(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_710(uParam0, 99, uParam0->f_1633[iVar16]);
							func_710(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_710(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_698(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_701(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_549(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_350(uParam0->f_1522[iVar0], 2)) && !func_350(uParam0->f_1522[iVar0], 16)) && func_712(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_703(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_703(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_550(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_350(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_475());
		func_472(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_475()))
		{
...
bool func_551(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_350(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_713(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_703(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_552(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_606(uParam0->f_3[iVar0]->f_2)) && func_436(uParam0->f_3[iVar0]->f_10)) && !func_706(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_714(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_715(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_559(var uParam0, int iParam1, char* sParam2)
{
	...
	if (is_string_null_or_empty(sParam2))
	{
		sParam2 = func_719(uParam0, iParam1);
	}
...
void func_560(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_720(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_561(int iParam0, int iParam1, bool bParam2)
{
	...
	func_721(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_569(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_255(iParam0);
	if (((does_entity_exist(iVar1) && func_724(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_572(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	func_728(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_728(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_728(iParam1, 512, 1);
...
void func_591(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_403(iParam0, 8))
		{
...
{
	iVar0 = func_453(func_733(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	iVar1 = func_453(func_733(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_601(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_436(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam0 == Global_35)
	{
		func_735(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_736(iParam0, &iVar0, &fVar25);
...
{
	return func_738(&uVar0, iParam0, iParam1);
}
...
{
	return func_460(1328661203, func_739(), -1591664384, bParam0);
}
...
struct<4> func_611(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_460(923904168, func_609(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_460(923904168, func_609(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_460(923904168, func_609(bParam0), -740156546, 0);
}
...
bool func_613(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
{
	if (func_741(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_615(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_460(271701509, func_609(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_460(271701509, func_609(bParam0), 12999093, 0);
}
...
{
	func_742(&(Global_1946804->f_2589), iParam0);
}

void func_623(int iParam0, int iParam1)
{
	func_743(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
{
	iVar1 = 12;
	iVar2 = func_418(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_442(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_745(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_745(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_745(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_745(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_418(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_746(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_418(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_746(&(Global_1946804->f_1497.f_1[iVar1])) || func_619(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_418(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_418(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_418(&(uParam0->f_1[iVar1])) || func_619(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_747(0);
	if (iParam2 != 0 && func_748(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_749(iParam0, func_444(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_627(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_441(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_750(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_628(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_752(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_254() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_753(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_754(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_754(Global_40.f_7729);
				Global_1946804->f_1378 = func_754(Global_40.f_7729);
...
{
	sVar0 = func_757(0, 1, bParam0, bParam1);
...
bool func_642(int iParam0, bool bParam1)
{
	...
	if ((func_300(iParam0, 1) && !func_301(iParam0)) && func_302(iParam0))
	{
		return false;
	}
	if (!func_300(iParam0, 2))
...
bool func_649(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_470(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_764(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_477((*Global_1360165)[iParam0]->f_4.f_2) || func_309((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_764(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_765((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_767(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_564(iParam0, 44, 1);
			}
		...
		case 2:
			if (!func_137(func_255(iParam0), 0))
			{
				return false;
			}
			if (iParam5 && iParam10)
...
bool func_650(int iParam0, int iParam1)
{
	...
	bVar0 = func_768(iParam0, iParam1);
	return bVar0;
}
...
void func_673(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (func_674(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_514(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_416(&(uParam0->f_1903)))
				{
					func_691(uParam0->f_1903, 0);
...
bool func_675(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
...
void func_676(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_434(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_677(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_161(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_679(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_473(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_681(int iParam0, float fParam1)
{
	...
	if (!(func_789(17) && func_193(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
bool func_683(var uParam0, int iParam1, bool bParam2)
{
...
void func_684(var uParam0, int iParam1, var uParam2, var uParam3)
{
	iVar0 = 0;
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_349(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
			if (!is_string_null_or_empty(&cVar1) && _0x6f1f0b17109309da(iParam1, &cVar1))
			{
				...
				{
					func_685(iVar9, Global_35, uParam2, uParam3);
				}
			}
		}
		iVar0++;
...
void func_685(int iParam0, var uParam1, var uParam2, var uParam3)
{
	Var0.f_4 = -1;
	Var0.f_8 = 2;
	Var0.f_9 = 1;
...
void func_686(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_350(uParam0->f_1522[iVar0], 1))
			{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					func_703(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_351(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_557(uParam0->f_475[iParam2], 4))
			{
				...
				if (((((func_315(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_298(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_298(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_472(uParam0, 64);
				}
...
void func_689(var uParam0)
{
	if (!uParam0->f_1897)
	{
		...
		if (!func_298(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_436(func_435(Global_35, 0, 1, 0)) && !func_436(func_435(Global_35, 1, 1, 0))))
		{
			if (func_319(uParam0, uParam0->f_1684))
			{
	...
	if (!func_298(uParam0->f_1016[uParam0->f_1684], 16) && (func_436(func_435(Global_35, 0, 1, 0)) || func_436(func_435(Global_35, 1, 1, 0))))
	{
	...
	else if ((!func_319(uParam0, uParam0->f_1684) && !func_328(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_554(uParam0, 3);
	}
...
void func_690(var uParam0, int iParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	func_793(uParam0, iParam1, &vVar1, &fVar0);
	func_791(uParam0, func_534(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	...
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		...
		{
			func_680(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_474(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_792(vVar1);
...
bool func_700(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_702(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (bParam7)
	{
...
bool func_704(var uParam0, int iParam1, bool bParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_705(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_706(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_401(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_507(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_401(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_401(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_507(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_507(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
var func_710(var uParam0, int iParam1, var uParam2)
{
	uParam0->f_1889.f_2 = iParam1;
...
bool func_712(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_350(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_557(uParam0->f_475[iVar0], 512)) || func_557(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_706(uParam0->f_3[iVar0]->f_1))
				{
					if (func_578())
					{
						StringCopy(&cVar1, func_401(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
int func_715(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	iVar0 = -1569615261;
...
char* func_719(var uParam0, int iParam1)
{
	if (!does_entity_exist(iParam1))
	{
		return "";
...
int func_729(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_137(iVar0, 0))
	{
		...
		if ((bParam1 || !func_726(iParam0)) || func_727(iParam0))
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_613(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_814(0))
				{
					...
					func_815(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
void func_736(int iParam0, int iParam1, float fParam2)
{
	bVar0 = true;
...
int func_738(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_818("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_817(iParam1, 512) && func_741(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_714(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_817(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_817(iParam1, 4))) && (!func_714(Var4.f_4) || func_817(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_817(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_817(iParam1, 1048576)))
				{
	...
	{
		iParam1 |= 512;
		return func_738(uParam0, iParam1, iParam2);
	}
...
bool func_741(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_462(0);
	*uParam1 = { func_460(iParam0, func_611(0), iParam3, 0) };
...
void func_742(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_823(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_823(uParam0->f_2[iVar0], 1))
				{
					func_824(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_745(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
...
bool func_749(int iParam0, int iParam1, int iParam2)
{
	*iParam2 = 1155669136;
	return true;
}
...
void func_752(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_254() == -1)
	{
		func_828(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_829(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_758()
{
	...
	func_840(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_759()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_840(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_760()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_840(1, round((to_float(iVar8) * fVar10)), 0);
...
bool func_762(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_515(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_307(iParam0));
}
...
int func_764(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_845((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_845((*Global_1347702)[63]->f_15, 1) || func_309((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_845((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_845((*Global_1347702)[134]->f_15, 1) || func_309((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_845((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_847(747937920, 1) && !func_845((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> func_767(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
void func_771(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_345(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_345(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_345(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_345(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_345(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_345(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_345(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_345(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_345(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_345(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_345(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_345(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_345(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_345(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_345(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_345(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_345(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_345(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_345(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_345(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_345(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_345(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_345(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_345(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_345(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_345(iParam1, 1544915253))
	{
...
bool func_787(var uParam0, int iParam1)
{
	...
	if ((func_436(func_715(Global_35, 0, 0, 0)) && !func_298(uParam0->f_1016[iParam1], 16)) && !func_298(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_790(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		iVar0 = func_715(Global_35, 0, 0, 0);
		if (is_weapon_valid(iVar0))
		{
		...
		iVar0 = func_715(Global_35, 0, 1, 0);
		if (is_weapon_valid(iVar0))
		{
			if (_0x2c83212a7aa51d3d(iVar0))
			{
...
void func_791(var uParam0, bool bParam1)
{
	...
	if ((func_315(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_298(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_472(uParam0, 64);
	}
...
void func_793(var uParam0, int iParam1, var uParam2, float fParam3)
{
	if (func_557(uParam0->f_475[iParam1], 32))
	{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_513(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_473(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_434(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_513(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_473(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_434(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_857(uParam0) };
		...
		else if (!func_473(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_434(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
{
	func_858(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_858(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_859(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_796(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_434(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_473(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_797(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_434(Global_36, vParam3, 1), 0);
		}
		...
		if (!func_473(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_473(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
int func_801(int iParam0, int iParam1)
{
	...
	if (func_619(iParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
...
int func_807(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_869(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_809(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_870(iParam0);
	}
...
bool func_813(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(uParam1))
	{
		return false;
...
void func_816(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_873(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_819(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
void func_830(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_829(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
{
	iVar0 = func_715(Global_35, 0, iParam0, 0);
	if (func_436(iVar0))
	{
		if (_0x2c83212a7aa51d3d(iVar0))
		{
		...
		else if (func_714(iVar0))
		{
			if (func_436(func_715(Global_35, 0, 7, 0)) || func_436(func_715(Global_35, 0, 9, 0)))
			{
				if (func_436(func_715(Global_35, 0, 8, 0)))
				{
					func_880(iVar0);
				}
				else
		...
		else if (_is_weapon_two_handed(iVar0) && iVar0 != -1415022764)
		{
			if (func_436(func_715(Global_35, 0, 7, 0)) || func_436(func_715(Global_35, 0, 9, 0)))
			{
				if (func_436(func_715(Global_35, 0, 10, 0)))
				{
					func_880(iVar0);
				}
				else
		...
		else if (_is_weapon_one_handed(iVar0))
		{
			if (iParam0 == 0)
			{
				if (!func_436(func_715(Global_35, 0, 2, 0)))
				{
...
{
	vVar0 = { func_881(vParam0, vParam3, fParam9) };
	vVar3 = { func_881(vParam3, vParam6, fParam9) };
	return func_881(vVar0, vVar3, fParam9);
}
...
bool func_861(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_883(iParam0, 0, bParam2) >= iParam1;
}
...
Vector3 func_881(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
int func_884()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_714(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_714(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
...
int func_886(int iParam0, int iParam1)
{
	...
	if (func_619(iParam0, 1399091007))
	{
		func_889(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_887(int iParam0, bool bParam1)
{
	...
	Var0 = { func_890(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_891(&Var0, func_611(0));
	}
	if (!func_892(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_820(iVar14);
...
void func_889(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
bool func_892(var uParam0, int iParam1, var uParam2, bool bParam3)
{
