	...
	while (iVar0 <= 3)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			...
			else
			{
				...
				{
					func_129(&(iLocal_15.f_40[iVar0]), 197929875, -1, 0, 0, -1082130432);
				}
				if (func_130(iVar0))
				{
...
bool func_23()
{
	...
	switch (Local_274.f_3)
	{
		...
		case 1:
			func_139();
			func_153(&iLocal_15, &(Local_274.f_40[6]), func_152(&Local_274), 1067450368, 1097859072, 3f, 0);
			if (func_154())
			{
...
bool func_31()
{
	...
	switch (Local_274.f_4)
	{
		...
		case 1:
			func_176();
			if (func_177(&iLocal_15, &(Local_274.f_54), &(iLocal_15.f_241), "COMBAT_FLEE", 1092616192))
			{
		...
		if (does_entity_exist(&(iLocal_15[iVar0])))
		{
			...
			else
			{
				if (func_61(&(iLocal_15[iVar0]), 0, 0))
				{
					...
					if ((is_ped_in_combat(&(iLocal_15[iVar0]), Global_35) || is_ped_fleeing(&(iLocal_15[iVar0]))) || func_133(&iLocal_15, iVar0, 256))
					{
				...
				else if ((!is_ped_fleeing(&(iLocal_15[iVar0])) && !is_ped_in_combat(&(iLocal_15[iVar0]), Global_35)) && !func_133(&iLocal_15, iVar0, 128))
				{
...
bool func_83()
{
	...
	while (iVar6 < fVar0)
	{
		...
		if (!func_69(vVar7))
		{
			fVar0[iVar6] = get_distance_between_coords(Global_36, vVar7, true);
...
{
	cVar0 = func_271(iParam0, iParam1);
	func_272(&(iLocal_15[iParam1]), cVar0, 0);
}

void func_126(int iParam0)
{
	remove_all_ped_weapons(&(iLocal_15[iParam0]), true, true);
	func_273(&(iLocal_15[iParam0]), -618550132, -1, 0, 0, 1056964608, 1065353216, 0);
...
void func_141()
{
	...
	while (iVar0 <= 3)
	{
		...
		else
		{
			...
			func_283(&iLocal_15, iVar0, 831283580, 0);
			if (!bVar2)
			{
...
void func_145(int iParam0, bool bParam1)
{
	...
	{
		iVar1 = _0x1e7384ab5d4f4581(uVar0);
		Global_40.f_9632[iParam0]->f_3 = (iVar1 + func_287(iParam0, 1));
	}
	func_164(0, 13);
}
...
bool func_149()
{
	...
	{
		if (get_entity_speed(Global_35) > 7f || func_136(&(Local_274.f_40[3]), Global_36))
		{
			return true;
		}
	}
...
bool func_154()
{
	...
	if (Local_274.f_5 > 2)
	{
		...
		if (iVar10 == -1)
		{
			...
			{
				if (func_309(Local_274.f_9[5], 3f))
				{
	...
	switch (Local_274.f_5)
	{
		...
		case 5:
			...
			{
				func_284(&Local_274, &(iLocal_15[1]), Global_35, "TAUNT_GEN_MALE", -1073741824, 1, 1744022339, 2);
		...
		if (iVar0 < *uParam1)
		{
			if (!&iParam0->f_228[iVar0])
			{
				if (does_entity_exist(iParam0[iVar0]))
				{
					...
					{
						func_344((*iParam0)[iVar0], (*uParam1)[iVar0], uParam2, 1, 1);
...
void func_256(int iParam0, float fParam1)
{
	...
	func_399(iParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432);
	vVar0 = { iParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { iParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_384(vVar0, vVar3, 0) };
	vVar9 = { func_385(vVar0, vVar3, 0) };
...
int func_299(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_187(iParam2, 1024))) || func_187(iParam2, 8)) && !func_389(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_441(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_187(iParam2, 4096)) && !func_389(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_441(uParam1, 2048);
			func_441(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_187(iParam2, 32)) && !func_389(*uParam1, 5632))
		{
...
int func_308(var uParam0)
{
	...
	while (iVar1 <= 1)
	{
		...
		{
			iVar0 = func_446(iLocal_15[iVar1], (*uParam0)[iVar1], 50f, &(uParam0->f_43), &iVar5, 4f, 3, 0, 0, iVar4, 0, 0, 2, 1, -1082130432, 0);
			if (func_447((*uParam0)[iVar1]))
			{
				...
				{
					case 0:
						if (!func_448(uParam0->f_43[0], 0))
						{
							func_449(uParam0->f_43[0], 1, 1);
						}
						break;
					case 1:
						if (!func_448(uParam0->f_43[1], 0))
						{
							func_140(&(Local_274.f_198), &(iLocal_15[1]), 0, 50f);
							func_449(uParam0->f_43[1], 1, 1);
						}
						break;
				}
				switch (iVar3)
...
void func_310(int iParam0, var uParam1)
{
	...
	func_451(uParam1->f_43[0], &(sVar0[0]), &(sVar3[0]), -163964935, 0, 0, 0, 0, 0);
	func_451(uParam1->f_43[1], &(sVar0[1]), &(sVar3[1]), 648122183, 0, 0, 0, 0, 0);
	func_449(uParam1->f_43[0], 1, 1);
}
...
void func_315()
{
	...
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, vVar1, 2f, 20000, 5.5f, 1, 40000f);
	...
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, vVar1, 2f, 20000, 5f, 1, 40000f);
	task_go_to_coord_while_aiming_at_entity(0, vVar1, Global_35, 2f, 0, 1056964608, 1082130432, 1, 0, 0, -687903391, 20000, 0);
	task_aim_at_entity(0, Global_35, -1, 1, 1);
	func_203(&(iLocal_15[1]), &iVar0, 0, 0, 1, 1);
	func_283(&iLocal_15, 0, 831283580, 0);
	func_283(&iLocal_15, 1, 831283580, 0);
...
void func_316()
{
	...
	while (iVar5 <= 3)
	{
		...
		_0x8acc0506743a8a5c(&(iLocal_15[iVar5]), 166028666, 1, -1082130432);
		open_sequence_task(&iVar0);
		task_set_crouch_movement(0, false, 0, false);
		task_go_to_coord_while_aiming_at_entity(0, vVar1, Global_35, 2f, 0, 0.5f, 3f, 1, 0, 0, -687903391, 20000, 0);
...
bool func_319()
{
	...
	switch (Local_274.f_7)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_466(&iLocal_15, 1, 1) || !_0x621d1b289caf5978(player_id()))
			{
				if (!func_135(&Local_274, 65536) && func_47(Local_274.f_9[7], 2f))
				{
		...
		case 6:
			...
			if (func_69(Local_274.f_200))
			{
				...
				Local_274.f_200 = { Global_36 };
				Local_274.f_40[6] = _create_volume_cylinder_with_custom_name(Local_274.f_200, 0f, 0f, 0f, 3f, 3f, 5f, "volRobArea");
			}
			if (func_474())
			{
...
void func_325(int iParam0)
{
	...
	if (!func_321(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
bool func_348(int iParam0, int iParam1)
{
	...
	fVar1 = get_distance_between_coords(func_300(iParam0[iParam1], 1065353216), func_300(Global_35, 1065353216), true);
	if (fVar0 < 10f)
	{
		return false;
	}
...
void func_367(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_368(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
{
	if (is_entity_on_screen(iParam0) && func_500(Global_35, iParam0, 0, fParam1, 0))
	{
		return true;
	}
	return false;
...
bool func_393(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_501((*Global_1835011)[iParam0]->f_1, 1);
	}
...
{
	iParam0->f_239 = _create_volume_aggregate_with_custom_name("volAmbientKillArea");
	_0x39816f6f94f385ad(iParam0->f_239, -472.3117f, -328.8468f, 75.0726f, 0f, 0f, -85.39629f, 39.46958f, 69.39269f, 48.05282f);
	_0x39816f6f94f385ad(iParam0->f_239, -522.3907f, -323.4702f, 75.0726f, 0f, 0f, 54.34013f, 39.46958f, 69.39269f, 48.05282f);
	if (func_135(iParam1, 1))
	{
		iParam1->f_40[6] = _create_volume_cylinder_with_custom_name(-525.2192f, -319.7985f, 63.89073f, 0f, 0f, -10.18612f, 14f, 14f, 10.60939f, "volBridgeRobArea");
		iParam1->f_40[2] = _create_volume_box_with_custom_name(-536.0466f, -322.8382f, 75.07261f, 0f, 0f, 79.34012f, 54.77785f, 69.39269f, 34.11169f, "volTrigger");
		iParam1->f_40[3] = _create_volume_box_with_custom_name(-547.9333f, -320.5719f, 75.07261f, 0f, 0f, 79.34012f, 54.778f, 69.39269f, 34.11169f, "volTriggerSlow");
		iParam1->f_40[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -614.3592f, -206.4135f, 115.7361f, 0f, 0f, -86.43658f, 220.5375f, 335.8115f, 240.5904f);
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -645.3174f, -314.7065f, 77.17728f, 0f, 0f, 147.4868f, 355.7617f, 90.74519f, 107.3552f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(-508.5792f, -326.271f, 66.54327f, 0f, 0f, -104.5226f, 78.46297f, 66.52126f, 43.34432f, "volSlow");
		iParam0->f_182[1] = _create_volume_box_with_custom_name(-536.8395f, -321.0542f, 64.33386f, 0f, 0f, -104.5226f, 78.46297f, 66.52126f, 43.34432f, "volSlower");
		iParam0->f_182[2] = _create_volume_box_with_custom_name(-549.4008f, -317.8009f, 64.33386f, 0f, 0f, -104.5226f, 78.46297f, 66.52126f, 43.34432f, "volSlowest");
		iParam1->f_40[4] = _create_volume_box_with_custom_name(-1748.319f, 76.6726f, 155.1157f, 0f, 0f, 33.59163f, 5.17899f, 24.2928f, 10f, "volBridgeFront");
		iParam1->f_40[5] = _create_volume_box_with_custom_name(-1731.654f, 37.99594f, 155.1157f, 0f, 0f, 19.89062f, 5.17899f, 24.2928f, 10f, "volBridgeBack");
	}
	else
	{
		iParam1->f_40[6] = _create_volume_cylinder_with_custom_name(-515.6293f, -324.5672f, 61.78128f, 0f, 0f, 0f, 20f, 20f, 19.79306f, "volBridgeRobArea");
		iParam1->f_40[2] = _create_volume_box_with_custom_name(-501.651f, -343.331f, 75.07261f, 0f, 0f, 79.3401f, 73.72193f, 69.39269f, 34.11169f, "volTrigger");
		iParam1->f_40[3] = _create_volume_box_with_custom_name(-501.651f, -343.331f, 75.07261f, 0f, 0f, 79.3401f, 73.72193f, 69.39269f, 34.11169f, "volTriggerSlow");
		iParam1->f_40[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -435.8815f, -453.0908f, 59.82618f, 0f, 0f, 4.6707f, 178.4207f, 242.0585f, 305.9797f);
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -383.7283f, -349.3771f, 90.93168f, 0f, 0f, -38.65809f, 296.4414f, 105.0418f, 107.3552f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(-525.5081f, -321.8875f, 72.00636f, 0f, 0f, -108.602f, 52.86029f, 40.69379f, 40.43703f, "volSlow");
		iParam0->f_182[1] = _create_volume_box_with_custom_name(-503.6722f, -328.9248f, 76.33801f, 0f, 0f, -108.6972f, 52.74099f, 38.03329f, 29.5835f, "volSlower");
		iParam0->f_182[2] = _create_volume_box_with_custom_name(-489.2079f, -333.8198f, 75.95811f, 0f, 0f, -108.6972f, 50.74282f, 45.5983f, 36.02916f, "volSlowest");
		iParam1->f_40[4] = _create_volume_box_with_custom_name(-1731.654f, 37.99594f, 159.2157f, 0f, 0f, 19.89062f, 5.17899f, 24.2928f, 10f, "volBridgeFront");
		iParam1->f_40[5] = _create_volume_box_with_custom_name(-1748.319f, 76.6726f, 155.1157f, 0f, 0f, 33.59163f, 5.17899f, 24.2928f, 10f, "volBridgeBack");
	}
}
...
void func_396(int iParam0, int iParam1)
{
	...
	{
		iParam1->f_40[6] = _create_volume_cylinder_with_custom_name(-525.2192f, -319.7985f, 63.89073f, 0f, 0f, -10.18612f, 14f, 14f, 10.60939f, "volBridgeRobArea");
		iParam1->f_40[2] = _create_volume_box_with_custom_name(-520.018f, -323.06f, 68.0339f, 0f, 0f, 75.25701f, 86.63735f, 50f, 61.25628f, "volTrigger");
		iParam1->f_40[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -614.3592f, -206.4135f, 115.7361f, 0f, 0f, -86.43658f, 220.5375f, 335.8115f, 240.5904f);
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -645.3174f, -314.7065f, 77.17728f, 0f, 0f, 147.4868f, 355.7617f, 90.74519f, 107.3552f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(-508.5792f, -326.271f, 66.54327f, 0f, 0f, -104.5226f, 78.46297f, 66.52126f, 43.34432f, "volSlow");
	...
	else
	{
		...
		iParam1->f_40[2] = _create_volume_box_with_custom_name(-501.651f, -343.331f, 75.07261f, 0f, 0f, 79.3401f, 73.72193f, 69.39269f, 34.11169f, "volTrigger");
		iParam1->f_40[0] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -492.8926f, -467.4217f, 59.82618f, 0f, 0f, -12.3293f, 178.4207f, 242.0585f, 305.9797f);
		_0x39816f6f94f385ad(&(iParam1->f_40[0]), -383.7283f, -349.3771f, 90.93168f, 0f, 0f, -38.65809f, 296.4414f, 105.0418f, 107.3552f);
		iParam0->f_182[0] = _create_volume_box_with_custom_name(-525.5081f, -321.8875f, 72.00636f, 0f, 0f, -108.602f, 52.86029f, 40.69379f, 40.43703f, "volSlow");
		iParam0->f_182[1] = _create_volume_box_with_custom_name(-503.6722f, -328.9248f, 76.33801f, 0f, 0f, -108.6972f, 52.74099f, 38.03329f, 29.5835f, "volSlower");
		iParam0->f_182[2] = _create_volume_box_with_custom_name(-489.2079f, -333.8198f, 75.95811f, 0f, 0f, -108.6972f, 50.74282f, 45.5983f, 36.02916f, "volSlowest");
...
int func_420(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_501((*Global_1835011)[4]->f_1, 1))
		{
			if (func_540(5))
			{
				func_541(5);
	...
	if ((bVar0 && func_501((*Global_1835011)[37]->f_1, 1)) && !func_501((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_501((*Global_1835011)[43]->f_1, 1)) && !func_501((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
{
	if ((func_597(uParam0->f_43[iParam1], 1, 0) && !func_588(uParam0->f_43[iParam1], 4)) && !func_588(uParam0->f_43[iParam1], 13))
	{
		return true;
	}
	return false;
...
{
	func_589(uParam0->f_43[iParam1], bParam2, 0);
}
...
float func_456()
{
	return get_distance_between_coords(Global_36, func_598(&Local_274, 1), true);
}
...
int func_469(float fParam0)
{
	...
	return func_602(&iLocal_15, *Local_274.f_9[9], fParam0);
}
...
void func_472(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_449((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
bool func_475(int iParam0, var uParam1, float fParam2, bool bParam3, float fParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
	...
	switch (*uParam1)
	{
		case 0:
			...
			if ((((((!is_ped_ragdoll(Global_35) && !is_ped_falling(Global_35)) && !_0x3e592d0486dec0f6(Global_35)) && !is_entity_in_air(Global_35, 1)) && !func_439(Global_35, 501393341)) && !func_439(Global_35, 1553520516)) && !func_439(Global_35, 451360105))
			{
		...
		case 2:
			...
			bVar2 = false;
			if (func_609() && is_player_free_aiming(player_id()))
			{
				bVar2 = true;
			}
			...
			else if (is_ped_in_combat(iParam0, 0) && func_439(iParam0, 780511057))
			{
				bVar2 = true;
			}
			...
			else if ((func_187(iParam5, 16) && !func_439(iParam0, 1435919172)) && !has_anim_event_fired(iParam0, -1898385492))
			{
				bVar2 = true;
			}
			if (!uParam1->f_15)
			...
			if (has_anim_event_fired(iParam0, -1898385492))
			{
				...
				iVar3 = floor((to_float(func_614(1)) * fParam2));
				if (iVar3 > 0)
				{
...
void func_476()
{
	...
	while (iVar0 <= 1)
	{
		...
		else
		{
			...
			if (func_61(&(iLocal_15.f_40[iVar0]), 0, 0))
			{
				vVar20 = { get_entity_coords(&(iLocal_15.f_40[iVar0]), true, false) };
				task_follow_nav_mesh_to_coord(0, vVar20, 2f, -1, 8f, 1, 40000f);
	...
	while (iVar0 <= 3)
	{
		...
		else
		{
			...
			{
				_task_smart_flee_style_ped_via(0, Global_35, 4, vVar2, 29568, -1082130432, -1, 0);
			}
			func_203(&(iLocal_15[iVar0]), &iVar1, fVar9, 0, 1, 1);
		}
		iVar0++;
...
int func_489(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_626(func_625(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_491(int iParam0, bool bParam1)
{
	...
	if (stat_id_get_int(&Var2, &uVar0))
	{
		...
		{
			Global_40.f_9632[iParam0]->f_3 = (Global_40.f_9632[iParam0]->f_3 + func_287(iParam0, 0));
		}
	}
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_647(1) || *iParam0 & 8192 != 0))
				{
...
bool func_516(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_659(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_657(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_658(iParam2)
				{
					func_419(iParam2, 1);
					return true;
				}
...
bool func_517(int iParam0, int iParam1)
{
	...
	if (func_650(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_658(iParam1)
		{
...
void func_542(int iParam0)
{
	...
	func_686(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_687(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_688(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_689(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_690(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_691(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_692(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_693(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_694(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_695(_get_map_zone_at_coords(vParam0, 10));
}
...
int func_578(int iParam0, float fParam1, int iParam2)
{
	...
	return func_725(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}
	...
	while (iVar16 < iVar18)
	{
		...
		if (iVar27 != 0 && iVar27 != Global_35)
		{
			...
			if (!func_69(vVar21))
			{
				...
				{
					if (func_388(vVar21, vVar24, 5f, 0) && is_ped_heading_towards_position(iVar27, iParam0->f_209, 40f))
					{
						iVar19 = 1;
						iVar20 = 1;
					}
...
int func_585(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_733(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
...
void func_586(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		if (!is_string_null_or_empty(sVar1))
		{
			func_350(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
bool func_601()
{
	...
	while (iVar0 <= 1)
	{
		if (func_447(Local_274.f_115[iVar0]))
		{
			return true;
		}
		iVar0++;
...
bool func_608(var uParam0, char* sParam1, vector3 vParam2, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15, bool bParam16, bool bParam17, int iParam18, bool bParam19)
{
	if (!func_338(*uParam0))
	{
		...
		if (fParam8 != 0f)
		{
			func_593(*uParam0, sParam1, ceil(absf(fParam8)), 1);
			if (ceil(absf(fParam8)) > func_614(1))
			{
	...
	if ((!bParam17 && func_764(*uParam0, 1)) || (bParam17 && func_765(*uParam0, 1)))
	{
		if (!bParam14)
		{
			if (fParam8 < 0f)
			{
				func_615(ceil(absf(fParam8)), 0, 0, 1, 1);
			}
			else if (fParam8 > 0f)
			{
...
void func_627(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == _get_saddle_horse_for_player(player_id()) && bVar3)
		{
			if (!does_blip_exist((*Global_1900383)[iParam0]->f_27))
			{
				...
				func_790(&((*Global_1900383)[iParam0]->f_27));
			}
		}
	...
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		...
		(*Global_1900383)[iParam0]->f_25 = 0;
		func_792(&((*Global_1900383)[iParam0]->f_26), bVar6);
	}
	if (!does_blip_exist((*Global_1900383)[iParam0]->f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_796((*Global_1900383)[iParam0]->f_26);
		func_797((*Global_1900383)[iParam0]->f_26);
...
{
	return func_799(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
struct<4> func_640(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_810(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_641(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_810(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_642(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_810(bParam0));
}
...
void func_644(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_417(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_655(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_394(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_817(iVar0, 0)))
		{
...
bool func_659(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_817(iVar0, 0)))
		{
			if (func_819(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_675(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_394(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_678(int iParam0)
{
	...
	return func_501((*Global_1347702)[58]->f_15, 1);
}
...
int func_702(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_333())
	{
		...
		{
			bVar0 = false;
			if (!func_501((*Global_1835011)[15]->f_1, 1) && !func_789(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_501((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_842();
				*iParam1 = func_843();
				*uParam2 = func_844();
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_187(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_870(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_741(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_873(Global_35)) || func_874(Global_35)) || func_875(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_876(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_877(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_878(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_622(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_746(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_876(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
void func_750(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_786(iParam0, 8))
		{
...
int func_759(char* sParam0, int iParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_786(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_887(iVar1, iParam1, sParam0, 5, iParam3, fParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, bParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_761(char* sParam0, int iParam1, int iParam2, int iParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13)
{
	...
	if (iVar1 != 0)
	{
		func_887(iVar1, iParam1, sParam0, 2, iParam3, fParam4, 0f, 0f, 0f, 0f, iParam2, 0, 1, iParam5, iParam6, iParam7, iParam8, iParam9, iParam10, iParam11, 1065353216, 0, 0, 0, iParam12, bParam13);
		return iVar1;
	}
	return 0;
}
...
int func_762(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_786(iVar0, 2))
		{
			if (func_388(vParam2, (*Global_1945938)[iVar0]->f_6, 0.01f, 1) && iParam1 == (*Global_1945938)[iVar0]->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
...
void func_771(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	sVar15 = func_899(_create_var_string(10, &cVar2, _create_var_string(0, func_898(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_891(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
		sVar15 = _create_var_string(0, func_898(iParam0));
	}
	func_900(sVar15, Var7.f_1, get_hash_key(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
int func_774(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_810(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_780(int iParam0, char* sParam1, int iParam2)
{
	...
	func_900(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, 859817522, 0, 0, 0, 1);
}
...
void func_790(var uParam0)
{
	if (network_is_game_in_progress())
	{
		_set_blip_name_from_player_string(*uParam0, func_914(func_913(255), 109029619));
	}
	else if (func_835())
	{
...
bool func_807(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!_0x9700e8efc4ab9089(func_810(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_808(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_810(bParam6), &Var0, 0);
	return uVar4;
}
...
bool func_818(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_819(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_831(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_810(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_833(int iParam0)
{
	...
	if (func_926(get_entity_model(iParam0)))
	{
		return true;
	}
...
bool func_865(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_932((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_867(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_933(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_338((*uParam2)[iVar0]->f_6))
		{
			func_590((*uParam2)[iVar0], 11);
...
void func_872(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_933(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
void func_879(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_589((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
bool func_886()
{
	if (((func_439(Global_35, 501393341) || func_439(Global_35, 1553520516)) || func_439(Global_35, 1920417248)) || is_control_just_pressed(0, -874806616))
	{
		return true;
	}
	return false;
...
void func_888(int iParam0, char* sParam1, int iParam2)
{
	...
	func_900(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_889(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_900(_create_var_string(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		...
		func_900(_create_var_string(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_810(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_908(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!_0xb4158c8c9a3b5dce(func_810(bParam4), iParam0, iParam1, iParam2))
	{
		return false;
	}
	return true;
			...
			if (func_891(iParam0, 412399755))
			{
				...
				if (func_948() == 0)
				{
					...
					if (((iParam0 == 281887510 || iParam0 == -164081697) || iParam0 == -1161319399) || iParam0 == 728781265)
					{
						...
						{
							func_952(43, iParam0, iParam1, -1791518714, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_891(iParam0, 709057512))
			{
				...
				if (func_948() == 1)
				{
					...
					if ((iParam0 == -222563712 || iParam0 == 1794857344) || iParam0 == 1952409553)
					{
						if (func_950(iParam0) < func_951(iParam0))
						{
							func_952(43, iParam0, iParam1, -2087881550, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_891(iParam0, -1478961327))
			{
				...
				if (func_948() == 2)
				{
					...
					if (((iParam0 == 2116770557 || iParam0 == -651064726) || iParam0 == -404270094) || iParam0 == 2093126853)
					{
						if (func_950(iParam0) < func_951(iParam0))
						{
							func_952(43, iParam0, iParam1, 1908068621, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_891(iParam0, -1238404098))
			{
				...
				if (func_948() == 3)
				{
					...
					if (((iParam0 == 2085530337 || iParam0 == -150591160) || iParam0 == -323969289) || iParam0 == 1504361882)
					{
						if (func_950(iParam0) < func_951(iParam0))
						{
							func_952(43, iParam0, iParam1, 1611247019, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_891(iParam0, 1160548794))
			{
				...
				if (func_948() == 4)
				{
					...
					if (((iParam0 == -1521783510 || iParam0 == 1714875242) || iParam0 == 927763737) || iParam0 == 1019229063)
					{
						if (func_950(iParam0) < func_951(iParam0))
						{
							func_952(43, iParam0, iParam1, 1319635688, iVar0, 1, -1, 0);
						}
					}
				}
			}
...
char* func_914(char* sParam0, int iParam1)
{
	...
	return func_899(_create_var_string(10, "PLAYER_STRING", sParam0), iParam1);
}
...
bool func_919(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_810(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_922(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_810(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_929(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_810(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
void func_943(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_941())
	{
		func_900(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, -585750914, 0, 0, 0, 1);
	}
	else
	{
		func_900(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, -585750914, 0, 0, 0, 1);
	}
}
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_810(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_946(int iParam0)
{
	...
	return func_501((*Global_1347702)[iParam0]->f_15, 1);
}
...
int func_948()
{
	...
	while (iVar1 < 5)
	{
		if (func_966(_0x126cbebba46693cf(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_956(int iParam0, int iParam1)
{
	...
	{
		return func_981(&((*Global_1108178)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
int func_957(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == -1784221369)
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_984(-1230526146, &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == -1037537535)
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_986(-1230526146, &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_959(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_960(-1230526146, &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return _0x033ee4b89f3ac545(func_810(bParam2), uParam0, iParam1);
}
...
bool func_969(int iParam0)
{
	...
	return func_988((*Global_1347702)[iParam0]->f_15);
}
...
char* func_971(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case -2076669067:
			...
			{
				sParam3 = _create_var_string(2, "COL_CC_CARD_POSTED_OBJ", func_990(), 12);
			}
			else
			{
				sParam3 = _create_var_string(2, "COL_CC_CARD_FOUND_OBJ", func_991(), 12);
			}
			break;
		case -440187297:
			if (iParam2 == 0)
			...
			{
				sParam3 = _create_var_string(2, "COL_DB_POSTED_OBJ", func_993(), 30);
			}
			else
			{
		...
		case 1995362678:
			...
			{
				sParam3 = _create_var_string(2, "COL_LF_CAUGHT_OBJ", func_994(), 13);
			}
			break;
		case 2103522376:
			if (iParam2 == 0)
			...
			{
				sParam3 = _create_var_string(2, "COL_RC_POSTED_OBJ", func_996(), 10);
			}
			else
			{
				sParam3 = _create_var_string(2, "COL_RC_FOUND_OBJ", func_995(), 10);
			}
			break;
		case 678508515:
			if (iParam2 == 3)
			...
			{
				sParam3 = _create_var_string(2, "COL_TX_CARCASS_COLLECTED_OBJ", sParam4, func_970(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_975(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_1000(func_997(iVar0))), func_1000(func_997(iVar0)), bVar1, true, false);
		}
		if (iParam2 == -440187297)
		{
			if (iVar0 == 0)
			{
				...
				_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_1001(iVar0)), func_1001(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		{
			if (func_1005(_0x126cbebba46693cf(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_1006(_0x126cbebba46693cf(iVar0, iParam2, 0))), func_1006(_0x126cbebba46693cf(iVar0, iParam2, 0)), bVar1, true, false);
		}
		if (iParam2 == 2103522376)
		{
			if (iVar0 == 0)
			{
				...
				_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_1007(iVar0)), func_1007(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == 678508515)
		{
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_1009(iVar2)), func_1009(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_980(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1013(_create_var_string(2, sVar0), _create_var_string(2, sVar1), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1013(_create_var_string(2, sVar0), _create_var_string(2, sVar3, iParam3, iParam4), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_1015(_create_var_string(2, sVar0), _create_var_string(2, func_1000(func_1014(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1013(_create_var_string(2, sVar0), _create_var_string(2, sVar3, iParam3, iParam4), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
struct<28> func_983(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_810(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_959(&Var28) };
...
struct<17> func_985(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_810(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_959(&Var17) };
...
int func_992()
{
	...
	while (iVar1 < 30)
	{
		if (func_1018(_0x126cbebba46693cf(iVar1, -440187297, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_993()
{
	...
	while (iVar1 < 30)
	{
		if (func_1019(_0x126cbebba46693cf(iVar1, -440187297, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_994()
{
	...
	while (iVar1 < 14)
	{
		if (func_1005(_0x126cbebba46693cf(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
char* func_1009(int iParam0)
{
	...
	return _get_label_text_by_hash(func_898(iParam0));
}
