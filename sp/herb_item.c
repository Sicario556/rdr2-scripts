void __EntryFunction__()
{
	...
	{
		if (func_3(Global_35, 0) != -1569615261)
		{
...
bool func_29(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_46(&(Global_1898164->f_1[0]));
		if (func_47(iVar0) && func_48((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_49(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
{
	if ((bParam2 && func_39() == 0) && !_unlock_is_visible(iParam0))
	{
		return false;
	}
