		...
		else
		{
			switch (iVar696)
			{
				...
				case 1:
					...
					{
						func_14(&Local_389, &uLocal_700, &(Local_389.f_51.f_4));
						func_16(&Local_389, uVar698, 2698);
						Local_584 = _create_anim_scene(Local_584.f_4, 0, "PBL_IDLE", false, true);
						set_anim_scene_origin(iVar582, Local_389.f_51, 0f, 0f, Local_389.f_51.f_3, 2);
						iLocal_698 = 3;
					}
				...
				case 3:
					if (func_17())
					{
						func_18();
						func_19();
						func_20(&uLocal_688, 1);
						func_21(&uLocal_688, Local_389.f_51, 3f);
						func_22();
						func_23();
						func_24();
						iLocal_698 = 4;
					...
					break;
				case 4:
					if (!func_25(&Local_389, &uLocal_689, iVar581, 1, 1, 0, 0, 0))
					{
						func_10();
					}
					if (!Local_389.f_46)
					{
						if (func_26(get_player_index(), 1, 0, 1))
						{
							func_27(&uLocal_790);
						}
						if (func_28(&uLocal_689, &(Local_389.f_5), &iLocal_699, &uLocal_721, 0, 0, 1) || func_29())
						{
							if (iVar697 == 8192 && !func_26(get_player_index(), 1, 0, 1))
							{
							}
							else
							{
...
void func_10()
{
	...
	{
		func_30(uLocal_689[0]);
		set_blocking_of_non_temporary_events(&(uLocal_689[0]), false);
		func_46(&(uLocal_689[0]), 1088421888, 0, 0);
		func_47(uLocal_689[0], Local_792[0], &Local_814, 1, 1);
		_0x24c82ef607105faa(&(uLocal_689[0]), 1789063806);
		_0xe737d5f14304a2ec(&(uLocal_689[0]), get_player_index(), 120000);
		_0xa3db37edf9a74635(player_id(), &(uLocal_689[0]), 7, 0, 1);
	}
	set_ped_config_flag(&(uLocal_689[0]), 6, false);
	if (iVar771 == 0)
	{
	...
	{
		_0xffebe5aa96bc2e4e(&(uLocal_689[0]), 1352191066, 1);
	}
	func_48(&uLocal_787, &uLocal_791);
	func_27(&uLocal_790);
	if (_does_scenario_point_exist(iVar700))
	{
		set_scenario_type_enabled(sVar725, true);
		func_49(uVar715);
	}
	if (func_45(&(uLocal_689[0]), 0, 1) && !func_50(iVar716, 16384))
	{
		clear_sequence_task(&iLocal_693);
		open_sequence_task(&iLocal_693);
		task_play_anim(0, &(Local_264[0]), Local_264[0]->f_1, 2f, -2f, -1, 16384, 0f, false, 0, false, 0, false);
		_task_smart_flee_style_ped(0, Global_35, 6, 257, -1082130432, -1, 0);
		close_sequence_task(iVar691);
		task_perform_sequence(&(uLocal_689[0]), iVar691);
		set_ped_keep_task(&(uLocal_689[0]), true);
		_0x39a2fc5af55a52b1(&(uLocal_689[0]), -1);
		set_ped_as_no_longer_needed(uLocal_689[0]);
	}
	if (iVar776 == 0)
	{
		Local_389.f_45 = 0;
	...
	func_54();
	func_20(&uLocal_688, 1);
	if (does_entity_exist(Local_271[0]->f_8))
	{
	}
	if (_does_volume_exist(iVar701))
	{
		_delete_volume(iVar701);
	}
	if (_does_volume_exist(iVar702))
	{
		_delete_volume(iVar702);
	}
	if (_0xde0ea444735c1368(iVar786))
	{
		_0x2c87c3e1c7b96ee2(iVar786);
		func_55(iVar701);
	}
	display_radar(true);
	func_56(&Local_271);
	func_58(&Local_389, &uLocal_689, &uLocal_691, iVar581, iVar698, func_57(&Local_389), 0, 1, 0, 1);
	if ((func_59(85, 8192) == 2 && Local_389.f_44 == 1) && iVar698 == 0)
	{
	...
	switch (iVar693)
	{
		case 0:
			if (func_61(&Local_389))
			{
				...
				_0xd9130842d7226045(func_67(), 0);
				if (iVar581 == 0)
				{
					request_clip_set("SCRIPT_RE@DARK_ALLEY_BUM@DESP@GIVE@ENTER");
					request_clip_set("SCRIPT_RE@DARK_ALLEY_BUM@DESP@STEAL@ENTER");
				}
				else
				{
					request_clip_set("SCRIPT_RE@DARK_ALLEY_BUM@DRUNK@GIVE@ENTER");
					request_clip_set("SCRIPT_RE@DARK_ALLEY_BUM@DRUNK@STEAL@ENTER");
				}
				iLocal_695 = 1;
			}
			break;
		case 1:
			if (!func_68(&uLocal_694, uVar628))
			{
				return false;
			}
			iVar0 = 0;
			while (iVar0 < 1)
			{
				if (!has_model_loaded(Local_356[iVar0]->f_1))
				{
					return false;
				}
				iVar0++;
			...
			if (iVar581 == 0)
			{
				if (!has_clip_set_loaded("SCRIPT_RE@DARK_ALLEY_BUM@DESP@GIVE@ENTER"))
				{
					return false;
				}
				if (!has_clip_set_loaded("SCRIPT_RE@DARK_ALLEY_BUM@DESP@STEAL@ENTER"))
				{
					return false;
				}
			}
			...
			{
				if (!has_clip_set_loaded("SCRIPT_RE@DARK_ALLEY_BUM@DRUNK@GIVE@ENTER"))
				{
					return false;
				}
				if (!has_clip_set_loaded("SCRIPT_RE@DARK_ALLEY_BUM@DRUNK@STEAL@ENTER"))
				{
					return false;
				}
			}
			...
			if (!_0xd9130842d7226045("REDAB_Sounds", 0))
			{
				return false;
			}
			_0x91fe941f9fcfb702(-252998940, 0);
...
void func_18()
{
	...
	remove_all_ped_weapons(&(uLocal_689[0]), true, true);
	_0x946d46cd6dfb9742(get_player_index(), 0, -440666838);
	if (iVar581 == 0)
	{
		vVar0 = { _get_object_offset_from_coords(Local_389.f_51, Local_389.f_51.f_3, 0.5f, -0.55f, 1f) };
	}
	else
	{
		vVar0 = { _get_object_offset_from_coords(Local_389.f_51, Local_389.f_51.f_3, -0.1f, -0.5f, 1f) };
	}
	task_play_anim_advanced(&(uLocal_689[0]), &(Local_264[2]), Local_264[2]->f_1, vVar0, 0f, 0f, Local_389.f_51.f_3, 1000f, -8f, -1, 1, 0f, 2, 0, 0);
	func_83(&(uLocal_689[0]), &Local_389, 0);
	func_84(&(uLocal_689[0]), 3);
	set_ped_config_flag(&(uLocal_689[0]), 6, true);
	_0xffebe5aa96bc2e4e(&(uLocal_689[0]), 1352191066, 1);
}
...
{
	Local_14[0]->f_8 = 0;
	Local_14[0]->f_10.f_17 = "MECH_PICKUP@OBJECT";
	Local_14[0]->f_10.f_15 = "pickup_low";
	Local_14[0]->f_10.f_11 = 38.5f;
	Local_14[0]->f_10.f_8 = { -1.3068f, 2.3037f, 0.8581f };
	Local_14[0]->f_10.f_12 = { 0.2382f, -0.1453f, 0.0733f };
	Local_14[0]->f_10.f_2 = { 0f, 1.1f, 0f };
	Local_14[0]->f_10.f_22 = 3.5f;
	Local_14[0]->f_10.f_23 = -25f;
	Local_14[1]->f_8 = 0;
	Local_14[1]->f_10.f_17 = "MECH_PICKUP@OBJECT";
	Local_14[1]->f_10.f_15 = "pickup_low";
	Local_14[1]->f_10.f_11 = 38.5f;
	Local_14[1]->f_10.f_8 = { -1.3068f, 2.3037f, 0.8581f };
	Local_14[1]->f_10.f_12 = { 0.2382f, -0.1453f, 0.0733f };
	Local_14[1]->f_10.f_2 = { 0f, 1.1f, 0f };
	Local_14[1]->f_10.f_22 = 3.5f;
	Local_14[1]->f_10.f_23 = -25f;
	func_85(Local_14[0]->f_10.f_17, &uLocal_239);
	func_85(Local_14[1]->f_10.f_17, &uLocal_239);
}
...
{
	iVar0 = 258;
	func_87(uParam0, vParam1, fParam4, 2, iVar0, 0);
}

void func_22()
{
	Local_584.f_1 = _create_anim_scene(Local_584.f_5, 0, "PBL_MTH_NORMAL", false, true);
	Local_584.f_2 = _create_anim_scene(Local_584.f_6, 0, "PBL_MTH_NORMAL", false, true);
	vVar0 = { 0f, 180f, 0f };
	Local_271[0]->f_8 = _0x9641a9a20310f6b8(-252998940, Local_389.f_51 + Vector(0f, 0f, 0f), vVar0, 0, 0, 0);
	if (bVar625)
	{
		Local_271[2]->f_8 = create_object(Local_271[2]->f_7, Local_389.f_51 + Vector(0f, -0.25f, -0.25f), true, true, false, false, true);
	}
	if (iVar581 == 1)
	{
		Local_271[1]->f_8 = create_object(Local_271[1]->f_7, Local_389.f_51 + Vector(0f, -0.25f, -0.25f), true, true, false, false, true);
		if (does_entity_exist(Local_271[1]->f_8))
		{
			_0x67bfced22909834d(Local_271[1]->f_8);
		}
	}
	Local_271[3]->f_8 = create_object(Local_271[3]->f_7, Local_389.f_51 + Vector(0f, 0.25f, 0.25f), true, true, false, false, true);
	Local_271[4]->f_8 = create_object(Local_271[4]->f_7, Local_389.f_51 + Vector(-1f, 0f, 0f), true, true, false, false, true);
	set_entity_visible(Local_271[4]->f_8, false);
	set_entity_no_collision_entity(Local_271[0]->f_8, Local_271[3]->f_8, false);
	set_anim_scene_origin(iVar582, Local_389.f_51, 0f, 0f, Local_389.f_51.f_3, 2);
	set_anim_scene_entity(iVar582, "PED_BUM", &(uLocal_689[0]), 0);
	set_anim_scene_entity(iVar582, "HAT", Local_271[0]->f_8, 0);
	if (!is_string_null_or_empty(Local_584.f_4))
	{
		if (!_is_anim_scene_loaded(iVar582, true, false))
		{
			load_anim_scene(iVar582);
		}
	}
	if (!is_string_null_or_empty(Local_584.f_5))
	{
		if (!_is_anim_scene_loaded(Local_584.f_1, true, false))
		{
			load_anim_scene(Local_584.f_1);
		}
	}
	if (!is_string_null_or_empty(Local_584.f_6))
	{
		if (!_is_anim_scene_loaded(Local_584.f_2, true, false))
		{
			load_anim_scene(Local_584.f_2);
		}
	}
	set_anim_scene_bool(iVar582, "ACTION_1", false, false);
	set_anim_scene_bool(iVar582, "ACTION_2", false, false);
	set_anim_scene_bool(iVar582, "ACTION_3", false, false);
	set_anim_scene_origin(iVar582, Local_389.f_51, 0f, 0f, Local_389.f_51.f_3, 2);
	set_anim_scene_entity(iVar582, "PED_BUM", &(uLocal_689[0]), 0);
	set_anim_scene_entity(iVar582, "HAT", Local_271[0]->f_8, 0);
	set_anim_scene_entity(iVar582, "Reward", Local_271[2]->f_8, 0);
	set_anim_scene_entity(iVar582, "COIN01", Local_271[3]->f_8, 0);
	set_anim_scene_entity(iVar582, "COIN02", Local_271[4]->f_8, 0);
	if (iVar581 == 1)
	{
		set_anim_scene_entity(iVar582, "BOTTLE", Local_271[1]->f_8, 0);
	}
	set_anim_scene_origin(Local_584.f_1, Local_389.f_51, 0f, 0f, Local_389.f_51.f_3, 2);
	set_anim_scene_entity(Local_584.f_1, "PED_BUM", &(uLocal_689[0]), 0);
	set_anim_scene_entity(Local_584.f_1, "HAT", Local_271[0]->f_8, 0);
	set_anim_scene_entity(Local_584.f_1, "COIN01", Local_271[3]->f_8, 0);
	set_anim_scene_entity(Local_584.f_1, "COIN02", Local_271[4]->f_8, 0);
	set_anim_scene_entity(Local_584.f_1, "player", Global_35, 0);
	if (iVar581 == 1)
	{
		set_anim_scene_entity(Local_584.f_1, "BOTTLE", Local_271[1]->f_8, 0);
	}
	set_anim_scene_origin(Local_584.f_2, Local_389.f_51, 0f, 0f, Local_389.f_51.f_3, 2);
	set_anim_scene_entity(Local_584.f_2, "PED_BUM", &(uLocal_689[0]), 0);
	set_anim_scene_entity(Local_584.f_2, "HAT", Local_271[0]->f_8, 0);
	set_anim_scene_entity(Local_584.f_2, "Reward", Local_271[2]->f_8, 0);
	set_anim_scene_entity(Local_584.f_2, "player", Global_35, 0);
	if (iVar581 == 1)
	{
		set_anim_scene_entity(Local_584.f_2, "BOTTLE", Local_271[1]->f_8, 0);
		set_anim_scene_entity(Local_584.f_2, "COIN_GIVE_2", Local_271[4]->f_8, 0);
		set_anim_scene_entity(Local_584.f_2, "COIN_GIVE_1", Local_271[3]->f_8, 0);
	}
	else
	{
		set_anim_scene_entity(Local_584.f_2, "COIN_GIVE_2", Local_271[4]->f_8, 0);
		set_anim_scene_entity(Local_584.f_2, "COIN01", Local_271[3]->f_8, 0);
	}
}
...
void func_23()
{
	if (iVar581 == 0)
	{
		func_88(&uLocal_703, Local_389.f_51, 0f, 0f, Local_356[0]->f_9, vLocal_705);
	}
	else if (iVar581 == 1)
	{
		func_88(&uLocal_703, Local_389.f_51, 0f, 0f, Local_356[0]->f_9, vLocal_708);
	}
	if (_does_volume_exist(iVar701))
	{
		_0x7c00cfc48a782dc0(iVar701, &(uLocal_689[0]), 0f, 0.25f, -0.1f, 0f, 0f, 0f, 2, 1);
	}
	func_89(&uLocal_788, Local_389.f_51, 0f, 0f, 0f, 2f, 2f, 5f, "NAV_BLOCKER");
	if (_does_volume_exist(iVar786))
	{
		if (_0x19c7567d2f2287d6(iVar786, 7))
		{
		}
	}
	vVar0 = { get_offset_from_entity_in_world_coords(&(uLocal_689[0]), 0f, 2f, 0f) };
	func_90(&uLocal_789, vVar0, vLocal_236, 8f, 5f, 5f, "INTERACT_AREA");
	if (iVar581 == 0)
	{
		uLocal_703 = _0x0eb78c2b156635b1(665633627, Local_389.f_51, 0f, 0f, Local_356[0]->f_9, vLocal_705);
	}
	else if (iVar581 == 1)
	{
		uLocal_703 = _0x0eb78c2b156635b1(665633627, Local_389.f_51, 0f, 0f, Local_356[0]->f_9, vLocal_708);
	}
	if (_does_volume_exist(iVar701))
	{
		_0x7c00cfc48a782dc0(iVar701, &(uLocal_689[0]), 0f, 0f, -0.1f, 0f, 0f, 0f, 2, 1);
	}
	uLocal_704 = _0x0eb78c2b156635b1(665633627, Local_389.f_51, 0f, 0f, 0f, 2.5f, 2.5f, 5f);
	_0x7c00cfc48a782dc0(iVar702, &(uLocal_689[0]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
	_0x5b23dff8e0948bb2(iVar702, 0);
	_0xbe551c2cc421185d(iVar702, 1);
	func_91(&uLocal_787, &uLocal_791, Local_389.f_51, 0f, 0f, Local_356[0]->f_9, vLocal_711, 1, 534496, 1, 2, "AmbientBlocker");
	func_92(uVar785, 0);
...
void func_24()
{
	func_94(Local_814[0], "RE_DAB_GIVE", 25, 0, -163964935, 0, 0, 0, 1);
	func_95(Local_814[1], "RE_DAB_STEAL_COIN", 0, 648122183, 0, 0, 0, 1, 0);
	func_96(Local_814[0], 1, 0);
	func_96(Local_814[1], 1, 0);
}
...
bool func_26(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (iParam0 == player_id())
	{
		return func_107(bParam1, bParam2, bParam3);
	}
...
int func_28(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_109(uParam0[*uParam3], 0, iParam1, iParam2, 0, 0))
		{
			return 1;
		}
		*uParam3++;
...
int func_29()
{
	if (Local_389.f_48 == 1)
	{
		if (is_ped_ragdoll(&(uLocal_689[0])))
		{
			iLocal_699 = 2;
			return 1;
		}
		...
		if (_does_anim_scene_exist(Local_584.f_1))
		{
			if (_is_anim_scene_started(Local_584.f_1, false) && _0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_1))
			{
				return 0;
			}
		}
		else if (_does_anim_scene_exist(Local_584.f_2))
		{
			if (_is_anim_scene_started(Local_584.f_2, false) && _0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_2))
			{
				return 0;
			}
		}
		if ((iVar769 == 1 && !func_50(iVar716, 16384)) && !func_50(iVar716, 512))
		{
			return 0;
		}
		if ((func_50(iVar716, 268435456) && _0x8d81e7824b7753f7(Local_584.f_2, "idle", 1)) || _0x3ab6c7b0bb0df4b1(&(uLocal_689[0]), iVar582))
		{
			if (!func_50(iVar716, 32768))
			{
				...
				if ((is_entity_touching_entity(Global_35, &(uLocal_689[0])) || func_111(Global_35, iVar701, 1, 0)) && has_anim_event_fired(&(uLocal_689[0]), 663533857))
				{
					if (func_50(iVar716, 268435456))
					{
						if (func_112(Local_584.f_2, sVar1))
						{
							_set_anim_scene_playback_list_bool(Local_584.f_2, sVar1, true);
							func_113(&uLocal_718, 32768);
							set_anim_scene_bool(iVar582, "bool_idle_b", false, false);
							set_anim_scene_bool(iVar582, "bool_idle", false, false);
						}
						else
						{
							return 0;
					...
					else if (func_112(iVar582, sVar1))
					{
						_set_anim_scene_playback_list_bool(iVar582, sVar1, true);
						func_113(&uLocal_718, 32768);
						set_anim_scene_bool(iVar582, "ACTION_3", false, false);
					}
					else
			...
			else if (is_entity_touching_entity(Global_35, &(uLocal_689[0])) || func_111(Global_35, iVar701, 1, 0))
			{
				if (func_50(iVar716, 268435456))
				{
					if (_0x8d81e7824b7753f7(Local_584.f_2, "idle", 1) || has_anim_event_fired(&(uLocal_689[0]), 663533857))
					{
						return 1;
					}
				}
				else if (_0x8d81e7824b7753f7(iVar582, "IDLES_REDUX", 1) || has_anim_event_fired(&(uLocal_689[0]), 663533857))
				{
					return 1;
				}
			}
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_115((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_116(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
void func_32(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_117(iParam0) == 1 && bParam7)
	{
		return;
	}
	if (bParam6)
...
bool func_33()
{
	...
	if (iVar771 == 0)
	{
		if (((!_0x3ab6c7b0bb0df4b1(Global_35, iVar582) && !_0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_1)) && !_0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_2)) && iVar781 == 1)
		{
			set_player_control(get_player_index(), true, 0, false);
			iLocal_773 = 1;
			iLocal_783 = 0;
	...
	if (Local_389.f_46 == 0)
	{
		if (!does_entity_exist(Local_602.f_3))
		{
			Local_602.f_3 = Global_35;
		}
		_0x66f9eb44342bb4c5(&(uLocal_689[0]), &Local_602);
	}
	switch (iVar695)
	{
		case 0:
			...
			if ((_does_anim_scene_exist(iVar582) && !_is_anim_scene_started(iVar582, false)) && _is_anim_scene_loaded(iVar582, true, false))
			{
				set_anim_scene_entity(iVar582, "PED_BUM", &(uLocal_689[0]), 0);
				set_anim_scene_entity(iVar582, "HAT", Local_271[0]->f_8, 0);
				start_anim_scene(iVar582);
				func_127(&(Local_389.f_5), 0);
				func_128(&(Local_389.f_5), 1097859072);
				iLocal_774 = 1;
				func_112(iVar582, "PBL_LEFT");
				func_112(iVar582, "PBL_FRONT");
				func_112(iVar582, "PBL_RIGHT");
				func_112(iVar582, "PBL_IDLE");
				func_112(iVar582, "PBL_IDLES_B");
				func_112(iVar582, "PBL_IDLE_LOOP_A");
				func_112(iVar582, "PBL_IDLE_LOOP_B");
				func_112(iVar582, "PBL_IDLE_LOOP_C");
				func_112(iVar582, "PBL_ANYTHING");
				func_112(iVar582, "PBL_COIN_OR_TWO");
				func_112(iVar582, "PBL_DOWN_ON_LUCK");
				func_112(iVar582, "PBL_PLEASE");
				func_112(iVar582, "PBL_SPARE_CHANGE");
				func_112(iVar582, "PBL_WHATEVER");
				iLocal_774 = 1;
				if (iVar772 == 1)
				{
					iLocal_697 = 1;
			...
			else if (_does_anim_scene_exist(iVar582) && !_is_anim_scene_loaded(iVar582, true, false))
			{
				if (!_is_anim_scene_loading(iVar582, true))
				{
					load_anim_scene(iVar582);
				}
			}
		...
		case 1:
			...
			{
				func_130();
				func_131(iVar582, "PBL_IDLE_LOOP_A", "PBL_IDLE", "IDLES_REDUX", "ACTION_1", "ACTION_3");
			}
			fVar0 = 10f;
		...
		case 2:
			if (!func_126(&uLocal_753) && !func_126(&uLocal_756))
			{
				...
				if ((iVar699 != 1 && !is_any_speech_playing(&(uLocal_689[0]))) && func_112(iVar582, "PBL_DOWN_ON_LUCK"))
				{
					_set_anim_scene_playback_list_bool(iVar582, "PBL_DOWN_ON_LUCK", true);
					iLocal_778 = 1;
					func_133(iVar582, 1);
					if (!func_50(iVar716, 524288))
					{
						func_134(&(uLocal_689[0]), uLocal_691[0], -89429847, 1679075994, 0, "RE_INTER_STRANGER");
						func_113(&uLocal_718, 524288);
					}
					iLocal_697 = 4;
				}
			}
			break;
		case 4:
			if (!func_50(iVar716, 262144) && (_does_anim_scene_exist(iVar582) && _0x8d81e7824b7753f7(iVar582, "IDLES_2", 1)))
			{
				func_113(&uLocal_718, 262144);
			}
			if ((func_50(iVar716, 262144) && !func_126(&uLocal_753)) && !func_126(&uLocal_756))
			{
				func_135();
			}
			func_136();
			func_137();
			func_130();
			if ((func_138() && func_139(-3f, 1, 0, 0)) && func_50(iVar716, 1))
			{
				iLocal_697 = 8;
			}
			break;
		...
		case 7:
			func_142();
			func_54();
			if (!func_50(iVar716, 512))
			{
				if (_0x5affa9ddc87846f8(Local_271[2]->f_7))
				{
					_0x78b4567e18b54480(Local_271[2]->f_8);
				}
			}
			if (_does_anim_scene_exist(iVar582))
			{
				_delete_anim_scene(iVar582);
			}
			if (_0xde0ea444735c1368(iVar786))
			{
				_0x2c87c3e1c7b96ee2(iVar786);
			...
			if (_does_anim_scene_exist(Local_584.f_2))
			{
				if (does_entity_exist(Local_271[1]->f_8))
				{
					if (_0x5affa9ddc87846f8(Local_271[1]->f_7))
					{
						_0x78b4567e18b54480(Local_271[1]->f_8);
					}
					if (_does_anim_scene_exist(Local_584.f_1))
					{
						remove_anim_scene_entity(Local_584.f_1, "BOTTLE", Local_271[1]->f_8);
						_delete_anim_scene(Local_584.f_1);
					}
					if (_does_anim_scene_exist(Local_584.f_2))
					{
						remove_anim_scene_entity(Local_584.f_2, "BOTTLE", Local_271[1]->f_8);
						_delete_anim_scene(Local_584.f_2);
					}
					func_143(Local_271[1]->f_8, 1, 1);
					activate_physics(Local_271[1]->f_8);
				}
				func_113(&uLocal_718, 8192);
				_delete_anim_scene(Local_584.f_2);
			}
			if (_does_scenario_point_exist(iVar700))
			{
				set_scenario_type_enabled(sVar725, false);
			}
			if (_does_volume_exist(iVar701))
			{
				_delete_volume(iVar701);
			...
			if (!func_50(iVar716, 1024))
			{
				if (func_45(&(uLocal_689[0]), 0, 1))
				{
					_0x2e1d6d87346bb7d2(&(uLocal_689[0]), Global_35, 0, 0);
					clear_sequence_task(&iLocal_693);
					open_sequence_task(&iLocal_693);
					if (!is_ped_ragdoll(&(uLocal_689[0])) && !func_50(iVar716, 16384))
					{
						task_play_anim(0, &(Local_264[0]), Local_264[0]->f_1, 2f, -2f, -1, 16384, 0f, false, 0, false, 0, false);
					}
					...
					func_147(0);
					if (((((iVar697 == 8 && iVar1 != 2055893578) && !_is_weapon_throwable(iVar1)) && !_is_weapon_melee(iVar1)) || iVar697 == 4) || iVar697 == 256)
					{
			...
			{
				activate_physics(Local_271[1]->f_8);
				apply_force_to_entity(Local_271[1]->f_8, 1, 0f, 0.2f, 0f, 0f, 0f, 0f, 1, true, true, true, false, true);
				force_entity_ai_and_animation_update(Local_271[1]->f_8, true);
			}
			_0x2e1d6d87346bb7d2(&(uLocal_689[0]), Global_35, 0, 0);
			iLocal_697 = 10;
			break;
		case 10:
			if (iVar784 == 0 && does_entity_exist(Local_271[1]->f_8))
			{
				if (iVar724 >= 2)
				{
					if (func_45(&(uLocal_689[0]), 0, 1))
					{
						set_entity_no_collision_entity(Local_271[1]->f_8, &(uLocal_689[0]), false);
					}
					apply_force_to_entity(Local_271[1]->f_8, 1, 0f, 0f, 0.1f, 0f, 0f, 0f, 1, true, true, true, false, true);
					force_entity_ai_and_animation_update(Local_271[1]->f_8, true);
					iLocal_786 = 1;
				}
				else
			...
			if (func_45(&(uLocal_689[0]), 0, 0))
			{
				if (_is_ped_hogtied(&(uLocal_689[0])) || (_is_ped_lassoed(&(uLocal_689[0])) && !is_any_speech_playing(&(uLocal_689[0]))))
				{
					if (!func_50(iVar717, 512))
					{
						if (!func_126(&uLocal_750))
						{
							func_114(&uLocal_750, 0);
							_task_smart_flee_style_ped(&(uLocal_689[0]), Global_35, 4, 1, -1082130432, -1, 0);
							set_ped_keep_task(&(uLocal_689[0]), true);
						}
						else if (func_150(&uLocal_750) > 5f && func_151(&(uLocal_689[0])) != 1)
						{
							...
							func_113(&uLocal_719, 512);
						}
					}
					func_145(&(uLocal_689[0]));
					_task_smart_flee_style_ped(&(uLocal_689[0]), Global_35, 4, 257, -1082130432, -1, 0);
					func_31(&Local_814, 0, 1, 1, 0);
					set_ped_keep_task(&(uLocal_689[0]), true);
				}
			}
...
void func_42(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_100(iParam0, 256);
	}
	else
	{
		func_160(iParam0, 256);
	}
}
...
void func_43(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!bParam1)
	{
		func_100(iParam0, 268435456);
	}
	else
	{
		func_160(iParam0, 268435456);
	}
	if (!bParam2)
	{
		func_100(iParam0, 1073741824);
	}
	else
	{
		func_160(iParam0, 1073741824);
	}
	if (!bParam3)
	{
		func_100(iParam0, 536870912);
	}
	else
	{
		func_160(iParam0, 536870912);
	}
}
...
void func_54()
{
	if (iVar770 == 0)
	{
		...
		{
			if (_0x5affa9ddc87846f8(Local_271[3]->f_7))
			{
				_0x78b4567e18b54480(Local_271[3]->f_8);
				start_particle_fx_looped_on_entity("scr_gen_shiny_bling", Local_271[3]->f_8, 0f, 0f, 0f, 0f, 0f, 0f, 1f, true, false, false);
				set_object_as_no_longer_needed(&(Local_271[3]->f_8));
			}
		}
		if (does_entity_exist(Local_271[4]->f_8) && func_50(iVar716, 4))
		{
			if (_0x5affa9ddc87846f8(Local_271[4]->f_7))
			{
				_0x78b4567e18b54480(Local_271[4]->f_8);
				start_particle_fx_looped_on_entity("scr_gen_shiny_bling", Local_271[4]->f_8, 0f, 0f, 0f, 0f, 0f, 0f, 1f, true, false, false);
				set_object_as_no_longer_needed(&(Local_271[4]->f_8));
			}
		}
		iLocal_772 = 1;
	}
...
void func_62()
{
	switch (func_3())
	{
		case 5:
			if (iVar581 == 0)
			{
				Local_356[0]->f_1 = 812237684;
				Local_356[0] = 4;
				Local_356[0]->f_3 = -1905408471;
				StringCopy(&(Local_356[0]->f_23), "0838_S_M_M_MarketVendor_01_WHITE_01", 64);
			}
			else if (iVar581 == 1)
			{
				Local_356[0]->f_1 = 812237684;
				Local_356[0] = 4;
				Local_356[0]->f_3 = 884347675;
				StringCopy(&(Local_356[0]->f_23), "0779_A_M_M_SDLaborers_02_BLACK_01", 64);
			}
			func_184(&(Local_356[0]->f_22));
			break;
		case 38:
			if (iVar581 == 0)
			{
				Local_356[0]->f_1 = 812237684;
				Local_356[0] = 4;
				Local_356[0]->f_3 = -1273957148;
				StringCopy(&(Local_356[0]->f_23), "0914_A_M_M_Civ_Poor_White_AGGRESSIVE_14", 64);
			}
			else if (iVar581 == 1)
			{
				Local_356[0]->f_1 = 812237684;
				Local_356[0] = 4;
				Local_356[0]->f_3 = -549369016;
				StringCopy(&(Local_356[0]->f_23), "0045_A_M_M_BynRoughTravellers_01_BLACK_01", 64);
			}
			func_184(&(Local_356[0]->f_22));
			break;
	}
...
void func_64()
{
	if (iVar581 == 0)
	{
		Local_264[0] = "script_re@dark_alley_bum@desp";
		Local_264[0]->f_1 = "breakout_bum";
		Local_264[1] = "script_re@dark_alley_bum@desp";
		Local_264[1]->f_1 = "breakout_hat";
		Local_264[2] = "script_re@dark_alley_bum@desp";
		Local_264[2]->f_1 = "idle_bum";
	}
	else if (iVar581 == 1)
	{
		Local_264[0] = "script_re@dark_alley_bum@drunk";
		Local_264[0]->f_1 = "breakout_bum";
		Local_264[1] = "script_re@dark_alley_bum@drunk";
		Local_264[1]->f_1 = "breakout_hat";
		Local_264[2] = "script_re@dark_alley_bum@drunk";
		Local_264[2]->f_1 = "idle_bum";
	}
	func_85(&(Local_264[0]), &uLocal_239);
}

void func_65()
{
	Local_271[0]->f_7 = 1141233817;
	Local_271[1]->f_7 = 1727249588;
	Local_271[3]->f_7 = -615159064;
	Local_271[4]->f_7 = -615159064;
	if (iVar581 == 0)
	{
		Local_271[2]->f_7 = 600267224;
	}
	else if (iVar581 == 1)
	{
		Local_271[2]->f_7 = 1959411711;
	}
	request_ptfx_asset();
}
...
int func_72(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_197(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
		...
		case 2:
			...
			*uParam3 = 0;
			break;
		case 3:
			if (func_199(iParam0, Param4.f_1, uParam1, Param4, iParam14))
			{
				func_188(iParam0, uParam1, bParam2, bParam12, 0);
				*uParam3 = 0;
				return 1;
...
bool func_73(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_200(iParam1, func_57(uParam0), &(uParam0->f_172)))
		{
...
void func_75(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_74(uParam0->f_3, 1))
	{
		func_89(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
bool func_79(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	if (*iParam4 != *iParam5)
	{
		return false;
	...
	while (iVar0 <= iParam8)
	{
		if (func_204() || !func_205((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
void func_82(int iParam0, bool bParam1, int iParam2)
{
	...
	else if (_0x9a100f1cf4546629(iParam0))
	{
		...
		func_211(iVar0, _0xc346a546612c49a9(iParam0));
	}
	if (bParam1)
	{
		func_212(iParam0, 0);
...
void func_87(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!func_86(uParam0))
	{
...
void func_88(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_cylinder_with_custom_name(vParam1, vParam4, vParam7, func_215());
	}
}
...
bool func_105(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	fVar0 = 30f;
	fVar1 = 150f;
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_26(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_236(uParam2, fVar1))
		{
			if (!func_237((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
void func_106(var uParam0, int iParam1)
{
	if (func_251(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_215());
		bVar1 = func_172(!func_74(uParam0->f_3, 1), 20f, -1f);
...
bool func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_26(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	return func_285(iParam0, vVar0, iParam2);
}
...
float func_119(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_121()
{
	...
	if (func_45(&(uLocal_689[0]), 0, 1))
	{
		...
		if (Local_389.f_46 == 0)
		{
			if (iVar769 == 0 || iVar777 == 1)
			{
				fVar1 = (Global_36.f_2 - (Local_389.f_51.f_2 + 1f));
				fVar1 = absf(fVar1);
				if ((((((fVar0 > fVar729 || is_ped_on_mount(Global_35)) || is_ped_in_any_vehicle(Global_35, true)) || func_244(Global_35, 1)) || func_110(&(uLocal_689[0]), Global_35, 1060437492) == 1) || fVar1 >= 1f) || !func_111(Global_35, iVar787, 1, 0))
				{
					if (iVar775 == 0)
					{
						func_290(Local_814[0], 0, 0);
						func_290(Local_814[1], 0, 0);
						func_291(Local_792[0], 0);
						iLocal_777 = 1;
					}
				}
				else if (iVar775 == 1)
				{
					if (!func_50(iVar716, 268435456))
					{
						func_290(Local_814[0], 1, 0);
					}
					func_290(Local_814[1], 1, 0);
					func_291(Local_792[0], 0);
					iLocal_777 = 0;
				}
			}
	...
	if (Local_389.f_48 == 1)
	{
		...
		iVar2 = 0;
		iVar3 = -1;
		iVar3 = func_293(uLocal_689[0], Local_792[0], 10f, &Local_814, &(Local_389.f_192), 0f, 1, 0, 0, func_120(), 0, 0, 2, 1, -1082130432, 0);
		if (iVar627 == 0)
		{
			if (iVar3 == 0)
			{
				iVar2 = 1;
				iLocal_771 = 1;
				func_113(&uLocal_718, 268435456);
				if (!_is_anim_scene_loaded(Local_584.f_2, true, false))
				{
					load_anim_scene(Local_584.f_2);
				}
				else if (!_0x23e33cb9f4a3f547(Local_584.f_2, "PBL_MTH_NORMAL"))
				{
					_0xdf7b5144e25cd3fe(Local_584.f_2, "PBL_MTH_NORMAL");
				}
				func_290(Local_814[0], 0, 0);
				func_290(Local_814[1], 0, 0);
				func_291(Local_792[0], 0);
			...
			else if (iVar3 == 1)
			{
				...
				else if (!_0x23e33cb9f4a3f547(Local_584.f_1, "PBL_MTH_NORMAL"))
				{
					_0xdf7b5144e25cd3fe(Local_584.f_1, "PBL_MTH_NORMAL");
				}
				iLocal_772 = 1;
				func_113(&uLocal_718, 536870912);
				func_290(Local_814[0], 0, 0);
				func_290(Local_814[1], 0, 0);
				iLocal_628 = 0;
				func_291(Local_792[0], 0);
			...
			if (((func_139(-6f, 1, 0, 0) && func_292(&uLocal_756, 3f)) && func_50(iVar716, 268435456)) && func_119(Global_35, &(uLocal_689[0]), 1, 1) <= 4f)
			{
			}
		}
	}
...
void func_122()
{
	if (Local_389.f_48 == 1)
	{
		if (has_anim_event_fired(Global_35, 566901322))
		{
			set_entity_visible(Local_271[4]->f_8, true);
			if (!func_50(iVar716, 4))
			{
				func_149(Global_35, &(uLocal_689[0]), func_148("PLY_GIVE"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 4);
			}
		}
		if (func_45(&(uLocal_689[0]), 0, 1))
		{
			...
			if (has_anim_event_fired(Global_35, -968032324))
			{
				if (func_297())
				{
					if (iVar581 == 0)
					{
						if (func_298() == 0)
						{
							func_299(&(uLocal_689[0]), "PLAYER_LOITERING", 291934926, Global_35, 1, &(Local_356[0]->f_23), 1, 1);
						}
						else
						{
					...
					else if (iVar581 == 1)
					{
						if (func_298() == 0)
						{
							func_299(&(uLocal_689[0]), func_148("STARE"), 291934926, Global_35, 1, &(Local_356[0]->f_23), 1, 1);
						}
						else
						{
							func_299(&(uLocal_689[0]), func_148("STARE"), 291934926, Global_35, 1, &(Local_356[0]->f_23), 2, 1);
						}
					}
				}
			}
		}
		if (!func_50(iVar716, 256))
		{
			if (has_anim_event_fired(Global_35, 119677702))
			{
				iVar0 = 25;
				func_300(iVar0, 0, 0, 1, 1);
				func_301(12, 0, 0, "RE_HONOR_CHARITY", &(uLocal_689[0]), 0, 1065353216, 0);
				func_302(13, 3);
				func_113(&uLocal_718, 256);
			}
		}
		if (((!func_50(iVar716, 512) && func_50(iVar716, 256)) && _does_anim_scene_exist(Local_584.f_2)) && _0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_2))
		{
			if (has_anim_event_fired(Global_35, -1898385492))
			{
				func_303(iLocal_232, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				_0x67bfced22909834d(Local_271[3]->f_8);
				display_radar(true);
				func_113(&uLocal_718, 512);
			}
		}
		if (has_anim_event_fired(Global_35, -1037210774))
		{
			if (does_entity_exist(Local_271[2]->f_8))
			{
				delete_object(&(Local_271[2]->f_8));
			}
		}
		if (!func_50(iVar716, 16384))
		{
			if (has_anim_event_fired(Global_35, 1745322408))
			{
				func_302(13, 1);
				func_113(&uLocal_718, 16384);
		...
		if (has_anim_event_fired(Global_35, -425661854))
		{
			iLocal_627 = 0;
			func_114(&uLocal_735, 0);
			if (does_entity_exist(Local_271[3]->f_8))
			{
				delete_object(&(Local_271[3]->f_8));
			}
			if (does_entity_exist(Local_271[4]->f_8))
			{
				delete_object(&(Local_271[4]->f_8));
			}
			if (func_50(iVar716, 256))
			{
...
void func_123()
{
	if (Local_389.f_48 == 1)
	{
		...
		{
			set_entity_no_collision_entity(Local_271[1]->f_8, &(uLocal_689[0]), false);
			set_entity_no_collision_entity(&(uLocal_689[0]), Local_271[1]->f_8, false);
		}
		if (_does_anim_scene_exist(Local_584.f_1))
		{
			if (_is_anim_scene_started(Local_584.f_1, false))
			{
				fLocal_729 = _get_anim_scene_progress(Local_584.f_1);
				if ((iVar581 == 1 && func_45(&(uLocal_689[0]), 0, 1)) && !func_50(iVar716, 8192))
				{
					if (fVar727 > 0.98f)
					{
						if (does_entity_exist(Local_271[1]->f_8))
		...
		{
			iVar0 = 0;
			if (is_entity_playing_anim(&(uLocal_689[0]), &(Local_264[0]), Local_264[0]->f_1, 1))
			{
				iVar0 = 1;
			}
			if ((((fVar727 > 0.99f || !get_is_task_active(&(uLocal_689[0]), 3)) || _is_anim_scene_active(Local_584.f_1)) && iVar0 == 0) && func_50(iVar716, 16384))
			{
				if (_does_anim_scene_exist(Local_584.f_1))
				{
					_delete_anim_scene(Local_584.f_1);
				...
				set_ped_combat_ability(&(uLocal_689[0]), 0);
				func_305(&(uLocal_689[0]), 1);
				set_combat_float(&(uLocal_689[0]), 7, 0f);
				set_ped_using_action_mode(&(uLocal_689[0]), true, -1, 0);
				open_sequence_task(&iLocal_693);
				task_stand_still(0, 100);
				task_turn_ped_to_face_entity(0, Global_35, 400, -1082130432, -1082130432, 0.52f);
...
void func_124()
{
	if (Local_389.f_48 == 1)
	{
		if (!func_50(iVar716, 4))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -810980703)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -351422439)))
			{
				func_147(0);
				func_149(Global_35, &(uLocal_689[0]), func_148("PLY_GIVE"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 4);
		...
		if (!func_50(iVar716, 8))
		{
			if (((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -1534042890)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -201751642))) && func_297())
			{
				func_147(0);
				func_149(&(uLocal_689[0]), Global_35, func_148("THANKS"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 8);
			}
		}
		if (!func_50(iVar716, 16))
		{
			if (((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -1992440724)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -880545320))) && func_297())
			{
				func_113(&uLocal_718, 16);
			}
		}
		if (!func_50(iVar716, 32))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -388538119)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), 1159035066)))
			{
				func_147(0);
				func_149(Global_35, &(uLocal_689[0]), func_148("PLY_THANKS"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 32);
			}
		}
		if (!func_50(iVar716, 64))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -949284496)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -1514322287)))
			{
				if (iVar698 == 0 && iVar581 == 1)
				{
					func_147(0);
					if (func_307())
					{
				...
				if (iVar698 == 0 && iVar581 == 0)
				{
					func_149(&(uLocal_689[0]), Global_35, func_148("JUDGE"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				}
				func_113(&uLocal_718, 64);
			}
		}
		if (!func_50(iVar716, 128))
		{
			if (((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -1009643791)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), 835310037))) && !func_244(Global_35, 1))
			{
				if (iVar698 == 0 && iVar581 == 1)
				{
					func_147(0);
				...
				func_113(&uLocal_718, 128);
			}
		}
		if (has_anim_event_fired(&(uLocal_689[0]), 1963997353))
		{
			if (iVar581 == 0)
			{
				iLocal_777 = 1;
		...
		if (has_anim_event_fired(&(uLocal_689[0]), 1271397199) && iVar698 != 0)
		{
			iLocal_777 = 1;
			iLocal_779 = 1;
			func_114(&uLocal_765, 0);
		}
		if (has_anim_event_fired(&(uLocal_689[0]), 1522384656) && iVar698 == 0)
		{
			iLocal_777 = 1;
			iLocal_779 = 1;
			func_114(&uLocal_765, 0);
		}
		if (!func_50(iVar716, 4096))
		{
			if (((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -287137215)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -234871529))) && func_119(Global_35, &(uLocal_689[0]), 1, 1) < 12f)
			{
				if (func_307())
				{
					func_309(43);
					func_113(&uLocal_718, 4096);
				}
			}
		}
		if (((((func_50(iVar716, 4096) && !func_50(iVar717, 262144)) && !is_any_speech_playing(Global_35)) && !is_any_speech_playing(&(uLocal_689[0]))) && Local_389.f_46 == 0) && !func_50(iVar716, 536870912))
		{
			...
			func_113(&uLocal_719, 262144);
		}
		if ((((func_150(&uLocal_765) > 10f && Local_389.f_46 == 0) && !func_50(iVar716, 536870912)) && !is_any_speech_playing(Global_35)) && !is_any_speech_playing(&(uLocal_689[0])))
		{
			func_310(&uLocal_765);
			func_113(&uLocal_719, 524288);
		}
	}
}
...
bool func_125()
{
	if (Local_389.f_48 == 1)
	{
		if (!func_45(&(uLocal_689[0]), 0, 0))
		{
			if (get_ped_config_flag(&(uLocal_689[0]), 11, true))
			{
				iLocal_775 = 1;
				if (func_119(&(uLocal_689[0]), Global_35, 1, 0) > 25f && is_entity_occluded(&(uLocal_689[0])))
				{
					_0x39a2fc5af55a52b1(&(uLocal_689[0]), -1);
					set_ped_as_no_longer_needed(uLocal_689[0]);
					return true;
		...
		if (iVar773 == 1)
		{
			vVar0 = { get_entity_coords(&(uLocal_689[0]), false, false) };
			_remove_all_shocking_events_of_type_in_area(vVar0, 2f, 7.328661E+18f, false);
		}
	}
	return false;
}
...
void func_129()
{
	...
	{
		if (!is_any_speech_playing(&(uLocal_689[0])) && !func_126(&uLocal_597))
		{
			func_287(&uLocal_597);
			return;
		}
		if ((!func_126(&uLocal_753) && !func_126(&uLocal_756)) && !is_any_speech_playing(&(uLocal_689[0])))
		{
			if (func_313(&uLocal_597, fLocal_231))
			{
				if (func_45(&(uLocal_689[0]), 0, 1))
				{
					...
					add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
					fLocal_231 = 10f;
				}
				if (get_closest_ped(get_entity_coords(&(uLocal_689[0]), true, false), 15f, 1, 0, &uVar0, 0, 1, 1, -1))
				{
					Local_602.f_3 = uVar0;
				}
			}
...
void func_130()
{
	if (Local_389.f_48 == 1)
	{
		if (!func_50(iVar716, 67108864))
		{
			if (_does_anim_scene_exist(Local_584.f_1))
			{
				_0xdf7b5144e25cd3fe(Local_584.f_1, "PBL_MTH_NORMAL");
				if (_get_anim_scene_entity_matrix(Local_584.f_1, "player", &Local_643, false, 0, 2))
				{
					if (!func_192(Local_643) && !func_192(Local_643.f_3))
					{
						func_113(&uLocal_718, 67108864);
					}
				}
			}
		}
		if (!func_50(iVar716, 134217728))
		{
			if (_does_anim_scene_exist(Local_584.f_2))
			{
				_0xdf7b5144e25cd3fe(Local_584.f_2, "PBL_MTH_NORMAL");
				if (_get_anim_scene_entity_matrix(Local_584.f_2, "player", &Local_631, false, 0, 2))
				{
					if (!func_192(Local_631) && !func_192(Local_631.f_3))
					{
						func_113(&uLocal_718, 134217728);
					}
				}
			}
		}
		...
		switch (iVar584)
		{
			case 0:
				if (iVar712 > 3)
				{
					...
					{
						if (_0xa9016536015de29d(iParam0, sParam2))
						{
					...
					set_anim_scene_bool(iParam0, sParam4, false, false);
					set_anim_scene_bool(iParam0, sParam5, false, false);
					iLocal_592 = 1;
				}
				else
				{
					iLocal_720 = iVar712 + 1;
				}
				break;
			case 1:
				if (!_0x23e33cb9f4a3f547(iParam0, sParam1))
				...
				else if (!_0x1f0e401031e20146(iParam0, sParam1))
				{
					...
					func_287(&uLocal_594);
					fLocal_600 = get_random_float_in_range(4.5f, 9f);
					iLocal_592 = 2;
					return 1;
				}
				else
				...
				break;
			case 2:
				if (func_292(&uLocal_594, fVar592))
				{
				...
				break;
			case 3:
				if (_0x8d81e7824b7753f7(iParam0, sParam3, 1) || fVar0 > 0.975f)
				{
					set_anim_scene_bool(iParam0, sParam4, false, false);
					set_anim_scene_bool(iParam0, sParam5, false, false);
					if (_0x23e33cb9f4a3f547(iParam0, sParam2))
					...
					else if (_0xa9016536015de29d(iParam0, sParam2))
					{
						_0xdf7b5144e25cd3fe(iParam0, sParam2);
						return 0;
					}
...
bool func_132(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	bVar1 = false;
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		...
		if (func_234(&(uParam0->f_121), iParam4, fParam1))
		{
			...
			if (uParam0->f_186)
			{
				_0xb2a38826e5886e83(func_176(uParam0->f_3, uParam0->f_185), 0);
			}
			return true;
		}
	}
...
{
	set_anim_scene_bool(iParam0, "ACTION_1", bParam1, false);
	set_anim_scene_bool(iParam0, "ACTION_2", bParam1, false);
	set_anim_scene_bool(iParam0, "ACTION_3", bParam1, false);
}
...
void func_135()
{
	if (((iVar769 == 1 || func_126(&uLocal_753)) || func_126(&uLocal_756)) || (func_50(iVar716, 32768) && func_150(&uLocal_762) < 10f))
	{
		return;
	}
	switch (iVar591)
	{
		case 0:
			if (((func_50(iVar717, 1) && has_anim_event_fired(&(uLocal_689[0]), 663533857)) && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728) && func_150(&uLocal_741) > fVar726)
			{
				if (func_112(iVar582, "PBL_WHATEVER"))
				{
					_set_anim_scene_playback_list_bool(iVar582, "PBL_WHATEVER", true);
					func_133(iVar582, 1);
					if (iVar581 == 0)
					{
						fLocal_728 = 2f;
			...
			break;
		case 1:
			if (((func_50(iVar717, 4) && has_anim_event_fired(&(uLocal_689[0]), 663533857)) && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728) && func_150(&uLocal_741) > fVar726)
			{
				if (func_112(iVar582, "PBL_COIN_OR_TWO"))
				{
					_set_anim_scene_playback_list_bool(iVar582, "PBL_COIN_OR_TWO", true);
					func_133(iVar582, 1);
					if (iVar581 == 0)
					{
						fLocal_728 = 2f;
			...
			break;
		case 2:
			if (((func_50(iVar717, 2) && has_anim_event_fired(&(uLocal_689[0]), 663533857)) && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728) && func_150(&uLocal_741) > fVar726)
			{
				if (func_112(iVar582, "PBL_ANYTHING"))
				{
					_set_anim_scene_playback_list_bool(iVar582, "PBL_ANYTHING", true);
					func_133(iVar582, 1);
					if (iVar581 == 0)
					{
						fLocal_728 = 2f;
			...
			break;
		case 3:
			if (((func_50(iVar717, 8) && has_anim_event_fired(&(uLocal_689[0]), 663533857)) && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728) && func_150(&uLocal_741) > fVar726)
			{
				if (func_112(iVar582, "PBL_PLEASE"))
				{
					_set_anim_scene_playback_list_bool(iVar582, "PBL_PLEASE", true);
					func_133(iVar582, 1);
					if (iVar581 == 0)
					{
						fLocal_728 = 4f;
			...
			break;
		case 4:
			if ((func_50(iVar717, 16) && has_anim_event_fired(&(uLocal_689[0]), 663533857)) && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728)
			{
				iLocal_593 = 5;
			}
			break;
		case 5:
			if (has_anim_event_fired(&(uLocal_689[0]), 663533857))
			{
				if (!func_126(&uLocal_738))
				{
					func_114(&uLocal_738, 0);
				}
				else if (func_150(&uLocal_738) > 6f && func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728)
				{
					func_147(0);
			...
			break;
		case 6:
			if (has_anim_event_fired(&(uLocal_689[0]), 663533857) && !is_any_speech_playing(&(uLocal_689[0])))
			{
				if (func_150(&uLocal_738) > 9f)
				{
					if (func_119(&(uLocal_689[0]), Global_35, 1, 1) < fVar728)
					{
						if (!func_50(iVar717, 128) && func_50(iVar717, 64))
						{
							func_147(0);
							func_149(&(uLocal_689[0]), Global_35, func_148("GIVE_UP"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
							add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
							func_113(&uLocal_719, 128);
						}
						if (!func_50(iVar717, 64))
						{
							func_147(0);
							func_149(&(uLocal_689[0]), Global_35, func_148("FINAL_BEG"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
							add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
							func_113(&uLocal_719, 64);
							func_287(&uLocal_738);
						}
					}
					else if (func_50(iVar717, 128))
					{
						if (func_112(iVar582, "PBL_SPARE_CHANGE") && func_139(0, 1, 0, 0))
						{
							if (!func_50(iVar717, 256))
							{
								_set_anim_scene_playback_list_bool(iVar582, "PBL_SPARE_CHANGE", true);
							}
							iLocal_593 = 7;
						}
					}
			...
			break;
		case 7:
			if (func_50(iVar717, 256) && has_anim_event_fired(&(uLocal_689[0]), 663533857))
			{
				iLocal_593 = 8;
			}
			break;
...
void func_136()
{
	if (Local_389.f_48 == 1)
	{
		...
		if (!func_50(iVar716, 1048576))
		{
			if (func_315(&(uLocal_689[0]), 1, 1) < 6f)
			{
				func_113(&uLocal_718, 1048576);
			}
		}
		else if (!func_50(iVar716, 2097152) && !func_50(iVar716, 256))
		{
			if (func_315(&(uLocal_689[0]), 1, 1) > fVar728 && !func_50(iVar716, 2))
			{
				if (!func_50(iVar717, 256))
				{
					if (has_anim_event_fired(&(uLocal_689[0]), 663533857) && func_112(iVar582, "PBL_SPARE_CHANGE"))
					{
						_set_anim_scene_playback_list_bool(iVar582, "PBL_SPARE_CHANGE", true);
					}
					else
...
void func_137()
{
	if (func_45(&(uLocal_689[0]), 0, 1))
	{
		if (!func_50(iVar717, 1))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -843416894)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), 15321140)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(1891783641, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 1);
				func_133(iVar582, 0);
				func_114(&uLocal_741, 0);
				func_114(&uLocal_747, 0);
			}
		}
		if (!func_50(iVar717, 2))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -335040700)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), 2009822318)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(249295937, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 2);
				func_133(iVar582, 0);
			}
		}
		if (!func_50(iVar717, 8))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -1142896989)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -1139386619)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(249295937, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 8);
				func_133(iVar582, 0);
			}
		}
		if (!func_50(iVar717, 16))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -2101883506)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), 1529335315)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(249295937, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 16);
				func_133(iVar582, 0);
			}
		}
		if (!func_50(iVar717, 256))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -1682902257)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -1422641698)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(249295937, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 256);
				func_133(iVar582, 0);
			}
		}
		if (!func_50(iVar717, 4))
		{
			if ((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), -168145339)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -94050732)))
			{
				if (func_297())
				{
					func_147(0);
				...
				func_314(1891783641, &(uLocal_689[0]), 1);
				add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
				func_113(&uLocal_719, 4);
				func_133(iVar582, 0);
			}
		}
		if (Local_389.f_48 == 1)
		{
			if (((iVar698 == 0 && has_anim_event_fired(&(uLocal_689[0]), 1678776164)) || (iVar698 == 4 && has_anim_event_fired(&(uLocal_689[0]), -801582249))) && func_297())
			{
				func_147(0);
		...
		{
			if (!func_50(iVar716, 1))
			{
				func_113(&uLocal_718, 1);
			}
		}
		if (has_anim_event_fired(&(uLocal_689[0]), -907806954) && func_126(&uLocal_741))
		{
			if (!func_50(iVar716, 1))
			{
				func_113(&uLocal_718, 1);
...
bool func_139(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_140()
{
	if (((func_50(iVar716, 1073741824) && !func_50(iVar716, -2147483648)) && !func_318(Global_35, -875674219)) && !func_50(iVar716, 1024))
	{
		if (_0xde0ea444735c1368(iVar786))
		{
			_0x2c87c3e1c7b96ee2(iVar786);
		...
		if (_is_ped_carrying(Global_35))
		{
			...
			{
				vVar0 = { get_offset_from_entity_in_world_coords(Global_35, 0f, -5f, 0f) };
				open_sequence_task(&iLocal_693);
				if (func_296(Local_389.f_51, Global_35) && func_119(Global_35, &(uLocal_689[0]), 0, 1) < 4.5f)
				{
					task_turn_ped_to_face_coord(0, vVar0, 0);
				}
				task_place_carried_entity_at_coord(0, _get_first_entity_ped_is_carrying(Global_35), Global_36, 1f, 1);
		...
		{
			iLocal_723 = 15;
			vLocal_714 = { get_entity_coords(Global_35, true, false) };
			iLocal_724 = 0;
		}
		if (iVar783 == 1)
		{
			if ((iVar626 == 2 && !_0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_1)) && !_0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_2))
			{
				if (iVar721 <= 0)
				{
					vVar4 = { get_entity_coords(Global_35, true, false) };
					fVar7 = get_distance_between_coords(vVar4, vLocal_714, true);
					if (fVar7 < 0.2f)
					{
						iLocal_724 = iVar722 + 1;
					}
					vLocal_714 = { get_entity_coords(Global_35, true, false) };
					iLocal_723 = 15;
					if (iVar722 >= 3)
					{
						...
						clear_ped_tasks(Global_35, 1, 0);
						iLocal_628 = 0;
						iLocal_725 = iVar723 + 1;
					}
					if (iVar723 >= 3)
					{
						func_319(&uLocal_718, 1073741824);
						func_319(&uLocal_718, -2147483648);
						if (func_50(iVar716, 536870912))
						{
							func_319(&uLocal_718, 536870912);
						}
						else if (func_50(iVar716, 268435456))
						{
							func_319(&uLocal_718, 268435456);
						}
						set_player_control(get_player_index(), true, 0, false);
						display_radar(true);
						iLocal_725 = 0;
		...
		if (!func_50(iVar716, 16777216))
		{
			if (func_50(iVar716, 536870912) && _0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_1))
			{
				func_149(Global_35, &(uLocal_689[0]), func_148("PLY_STEAL"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 16777216);
			}
		}
		if (!func_50(iVar716, 4))
		{
			if (!func_50(iVar716, 536870912) && _0x3ab6c7b0bb0df4b1(Global_35, Local_584.f_2))
			{
				func_149(Global_35, &(uLocal_689[0]), func_148("PLY_GIVE"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				func_113(&uLocal_718, 4);
			}
		}
		if (iVar3 == 1 && ((func_50(iVar716, 536870912) && _is_anim_scene_started(Local_584.f_1, false)) || (!func_50(iVar716, 536870912) && _is_anim_scene_started(Local_584.f_2, false))))
		{
			add_shocking_event_for_entity(161068336, &(uLocal_689[0]), -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
			...
			if (func_50(iVar716, 536870912))
			{
				if (_does_anim_scene_exist(Local_584.f_1))
				{
					if (_is_anim_scene_loaded(Local_584.f_1, true, false))
					{
						...
						if (!_is_anim_scene_started(Local_584.f_1, false))
						{
							start_anim_scene(Local_584.f_1);
						}
						func_113(&uLocal_718, -2147483648);
						if (_does_volume_exist(iVar786))
						{
							if (_0x19c7567d2f2287d6(iVar786, 7))
							{
			...
			else if (func_50(iVar716, 268435456))
			{
				if (_does_anim_scene_exist(Local_584.f_2))
				{
					if (_is_anim_scene_loaded(Local_584.f_2, true, false))
					{
						...
						set_anim_scene_entity(Local_584.f_2, "HAT", Local_271[0]->f_8, 0);
						set_anim_scene_entity(Local_584.f_2, "player", Global_35, 0);
						if (!_is_anim_scene_started(Local_584.f_2, false))
						{
							start_anim_scene(Local_584.f_2);
						}
						func_113(&uLocal_718, -2147483648);
						if (_does_volume_exist(iVar786))
						{
...
void func_141()
{
	set_ped_can_play_gesture_anims(&(uLocal_689[0]), 0, 1);
	if ((Local_389.f_46 == 0 && !func_50(iVar716, 536870912)) && !is_any_speech_playing(&(uLocal_689[0])))
	{
		if (has_anim_event_fired(&(uLocal_689[0]), 663533857))
		{
			switch (iVar720)
...
void func_142()
{
	if ((func_45(&(uLocal_689[0]), 0, 1) && is_ped_fleeing(&(uLocal_689[0]))) && !func_50(iVar716, 4194304))
	{
		if (iVar581 == 1)
		{
			_0x89f5e7adecccb49c(&(uLocal_689[0]), "very_drunk");
		}
		else
		{
			_0x89f5e7adecccb49c(&(uLocal_689[0]), "scared");
		}
		func_113(&uLocal_718, 4194304);
	}
	if (iVar581 != 1 || func_50(iVar716, 8192))
	{
		return;
	}
	if (does_entity_exist(Local_271[1]->f_8))
	{
		if (_is_anim_scene_started(iVar582, false))
		{
			remove_anim_scene_entity(iVar582, "BOTTLE", Local_271[1]->f_8);
		}
		if (_is_anim_scene_started(Local_584.f_1, false))
		{
			remove_anim_scene_entity(Local_584.f_1, "BOTTLE", Local_271[1]->f_8);
...
void func_144()
{
	if (_is_anim_scene_started(iVar582, false))
	{
		remove_anim_scene_entity(iVar582, "HAT", Local_271[0]->f_8);
		remove_anim_scene_entity(Local_584.f_1, "COIN01", Local_271[3]->f_8);
		remove_anim_scene_entity(Local_584.f_1, "COIN02", Local_271[4]->f_8);
	}
	if (_is_anim_scene_started(Local_584.f_1, false))
	{
		remove_anim_scene_entity(Local_584.f_1, "HAT", Local_271[0]->f_8);
		remove_anim_scene_entity(Local_584.f_1, "COIN01", Local_271[3]->f_8);
		remove_anim_scene_entity(Local_584.f_2, "COIN02", Local_271[4]->f_8);
	}
	if (_is_anim_scene_started(Local_584.f_2, false))
	{
		remove_anim_scene_entity(Local_584.f_2, "HAT", Local_271[0]->f_8);
		remove_anim_scene_entity(Local_584.f_1, "COIN01", Local_271[3]->f_8);
		remove_anim_scene_entity(Local_584.f_1, "COIN_GIVE_1", Local_271[3]->f_8);
		remove_anim_scene_entity(Local_584.f_2, "COIN_GIVE_2", Local_271[4]->f_8);
	}
	if (does_entity_exist(Local_271[0]->f_8))
	{
		activate_physics(Local_271[0]->f_8);
	}
	if (does_entity_exist(Local_271[3]->f_8))
	{
		activate_physics(Local_271[3]->f_8);
	}
	if (does_entity_exist(Local_271[4]->f_8))
	{
		activate_physics(Local_271[4]->f_8);
	}
	func_142();
}
...
bool func_149(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
...
void func_152()
{
	if (func_45(&(uLocal_689[0]), 0, 0) && !func_50(iVar716, 65536))
	{
		if ((iVar581 == 0 && has_anim_event_fired(&(uLocal_689[0]), 369679343)) || (iVar581 == 1 && has_anim_event_fired(&(uLocal_689[0]), 1198751374)))
		{
			func_144();
			_task_smart_flee_style_ped(&(uLocal_689[0]), Global_35, 4, 1, -1082130432, -1, 0);
			set_ped_keep_task(&(uLocal_689[0]), true);
			func_113(&uLocal_718, 65536);
			func_31(&Local_814, 0, 1, 1, 0);
		}
	...
	if ((func_50(iVar716, 65536) || bVar625) || !func_45(&(uLocal_689[0]), 0, 1))
	{
		return;
	}
	if (get_script_task_status(&(uLocal_689[0]), 780511057, true) == 1 || ((func_50(iVar716, 1024) && func_318(&(uLocal_689[0]), 242628503)) && get_sequence_progress(&(uLocal_689[0])) >= 2))
	{
		iVar1 = 0;
		...
		if (get_current_ped_weapon(Global_35, &iVar0, true, 0, false) || iVar1 == 1)
		{
			if (((iVar0 != -1569615261 && iVar0 != 2055893578) && func_327(&(uLocal_689[0]), 1, 1, 0, 0, 0)) || iVar1 == 1)
			{
				if (iVar1 == 1)
				{
					open_sequence_task(&iLocal_693);
					task_react(0, Global_35, 0f, 0f, 0f, "DEFAULT_ANGRY", 3f, 0, 4);
					_task_smart_flee_style_ped(0, Global_35, 2, 257, -1082130432, -1, 0);
					func_306(&(uLocal_689[0]), &iLocal_693, 0, 0, 1, 1);
				}
				else
				{
...
var func_158(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var0 = -2;
	Var0 = iParam1;
	Var0.f_1 = iParam2;
...
char* func_159(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_330(sParam1));
}
...
bool func_170(var uParam0, var uParam1)
{
	...
	{
		if (func_333(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
void func_173(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_45(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			fVar2 = func_172(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
void func_185(int iParam0)
{
	...
	while (iVar0 < *iParam0)
	{
		func_344(&((*iParam0)[iVar0]->f_1));
		func_344(&((*iParam0)[iVar0]->f_12));
		iVar0++;
	}
}
...
void func_188(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_215());
...
int func_196(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (func_363(&(uParam0->f_37), 500))
	{
		...
		while (iVar0 < 8)
		{
			if (!func_192(*uParam0->f_12[iVar0]))
			{
...
bool func_197(float fParam0, int iParam1)
{
...
bool func_199(int iParam0, var uParam1, var uParam2, struct<7> Param3, bool bParam10)
{
	...
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_372(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
void func_206()
{
	...
	{
		case 0:
			Local_356[0]->f_6 = { 0f, 0f, 0f };
			Local_356[0]->f_9 = 94.513f;
...
void func_216(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_215());
	}
}
...
void func_217(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_215());
	}
}
...
void func_220(int iParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (bParam3 && !func_115(iParam0))
	{
		return;
	}
...
{
	if (func_115(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
void func_227(int iParam0, int iParam1)
{
	...
	func_392(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_393(iParam0, 0);
	func_394(iParam0);
	func_395(1);
	...
	if (uParam0->f_177 != -1 || func_351(Global_1310750[uParam0->f_3], 16777216))
	{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_403(uParam0->f_177));
			}
		}
	}
...
bool func_242(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_419(&(Global_1898164->f_1[0]));
		if (func_420(iVar0) && func_421((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_422(&(Global_1898164->f_1[0])))
	{
		return true;
	}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_240(1) || *iParam0 & 8192 != 0))
				{
					func_160(iParam0, 33554432);
				}
			}
			break;
		case 1:
...
bool func_257(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_433(iParam0, iParam1, iVar2))
			{
				return false;
			}
			if (func_434(iParam0, iVar2) <= func_435(iParam1))
			{
				return true;
			}
			break;
...
bool func_259(int iParam0, int iParam1)
{
	...
	if (!is_entity_dead(iParam0))
	{
		if (func_327(iParam0, !*iParam1 & 268435456 != 0, !*iParam1 & 536870912 != 0, !*iParam1 & 1073741824 != 0, 0, 0))
		{
			if (iParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_438(iParam1);
			if (func_439(iParam1, iParam0, fVar0, fVar1))
			{
				if (iParam1->f_2 == 0)
				{
...
bool func_260(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 85f;
	if (func_441(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		if (iParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_438(iParam2);
		if (func_439(iParam2, iParam0, fVar0, fVar1))
		{
			if (iParam2->f_2 == 0)
			{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_440(iParam2)
				{
					func_437(iParam2, 1);
					return true;
				}
...
bool func_261(int iParam0, int iParam1)
{
	...
	if (func_433(iParam0, iParam1, iVar1))
	{
		if (iParam1->f_3 == 0)
		{
			iParam1->f_3 = get_game_timer();
		}
		else if (get_game_timer() - iParam1->f_3) > func_440(iParam1)
		{
			fVar3 = func_438(iParam1);
...
{
	if (iParam2->f_12 < IntToFloat(func_443(iParam2)))
	{
...
bool func_266(int iParam0, int iParam1)
{
	...
	{
		if (!func_433(iParam0, iParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_448(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_449(iParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
			...
			else if (func_450(iParam1, iParam0, fVar1, iVar0))
			{
				*vVar2[0] = { get_entity_coords(&(Global_1935630->f_34[iVar0]), false, false) };
				*vVar2[1] = { vVar9 };
				iParam1->f_10 = iParam0;
...
bool func_277(int iParam0, int iParam1)
{
	...
	if (iParam0->f_12 > func_455(iParam0) && iParam0->f_12 > fVar0)
	{
		return false;
	}
	iVar2 = func_456(iParam1);
	iVar1 = func_457(iParam0->f_14);
...
int func_278(int iParam0, int iParam1, int iParam2)
{
	...
	return func_458(iParam0, iParam1, bVar0, bVar2, iParam2->f_12, bVar1);
}
...
int func_283(int iParam0, int iParam1)
{
	...
	else if (func_275() - iParam1->f_4) > func_462(iParam1)
	{
		return func_463(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
{
	if (bParam1 && !func_468(iParam0, 13))
	{
		func_219(iParam0, 0);
	}
	else
...
void func_294()
{
	...
	func_319(&uLocal_718, -2147483648);
	func_113(&uLocal_718, 1073741824);
	uVar4 = 1;
	...
	while (iVar6 <= 2)
	{
		...
		{
			_task_smart_flee_style_coord(&(uVar0[iVar6]), Local_389.f_51, 6, 0, 4f, -1, 0);
		}
		iVar6++;
	}
	display_radar(false);
...
void func_301(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	...
	if ((Global_36616 && func_480(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_481(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
		...
		if (func_488(iParam0))
		{
			...
			if (func_496() && func_497(4))
			{
				if (!Global_1914319->f_17376)
				{
					if (func_496() && (func_498(38) || func_493(38)))
					{
						func_502(38, _0x13aaecda43318bfe(-2076669067, iVar6), _0xd52d20b0c76bb26d(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_502(38, get_hash_key("toast_log_blips"), get_hash_key("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	...
	if (!bVar3)
	{
		...
		switch (iParam0)
		{
			...
			case -1185145312:
				...
				{
					func_539(player_ped_id(), -1185145312, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_540(&iVar9, 0))
				{
				...
				break;
			case 1171350303:
				if (func_118() == -1 && &Global_1946804->f_1497.f_1[25] == &Global_1946804->f_57[25])
				{
					func_539(player_ped_id(), 1171350303, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			case -160924582:
				break;
...
bool func_307()
{
	if (iVar698 == 0 && iVar581 == 1)
	{
		if ((func_569(2) == 0 && !func_570()) || iVar780 == 1)
		{
			return true;
		}
	}
...
void func_308(var uParam0, float fParam1, bool bParam2)
{
	if (bParam2 || !func_126(uParam0))
	{
...
float func_315(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_119(Global_35, iParam0, bParam1, bParam2);
}
...
bool func_320(int iParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	iVar5 = 0;
	if (!is_entity_dead(iParam0))
	{
		switch (*iParam4)
		{
			case 0:
				if (bParam8 && is_ped_on_mount(iParam0))
				{
					...
					if (!func_192(vVar0))
					{
						if (func_465(get_entity_coords(iParam0, true, false), get_entity_coords(iParam0, true, false) + get_entity_forward_vector(iParam0), vVar0))
						{
							iVar5 = 131072;
						}
						else
...
int func_324(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_581(func_299(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_327(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_119(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_146(iVar0, 0)))
		{
...
void func_331(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_116(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_291(iParam0, 0);
		}
...
{
	fVar0 = func_172(bParam6, iParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_296(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_275();
			iParam4->f_2 = func_312(iParam0, vParam1, 1);
			iParam4->f_1 = 1;
		}
	}
	else if (fVar0 > iParam4->f_2 || (!func_296(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_275();
		iParam4->f_2 = func_312(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
int func_372(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (!bParam7 && func_596(uParam1))
	{
		...
		if (!does_entity_exist(iVar0))
		{
			iVar0 = func_597(iParam0, vParam2, bParam5, 1, 1, 0, 1, iParam8, 1, 0, 0, 0, 0);
		}
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_598(iVar0))
		{
		...
		if (func_599(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_600(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_606(&(uParam1->f_22)));
		...
		if (!func_598(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_609(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_610(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_610(&(uParam1->f_22)));
...
{
	if (bParam2 || func_45(iParam0, 0, 0))
	{
...
void func_385(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_618(iParam0, 8))
		{
...
void func_392(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	fVar0 = 0f;
	fVar1 = 0f;
	fVar2 = 0f;
	...
	func_32(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_398(int iParam0)
{
	...
	if (!func_201(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_399(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_630(to_float(iVar0), 1, 0);
	}
	else
	{
		func_630((to_float(200) / 3f), 1, 0);
	}
}
...
bool func_407(var uParam0, float fParam1, float fParam2, int iParam3)
{
	if (func_406(uParam0, fParam1, fParam2, iParam3))
	{
		if (uParam0->f_8 == 0f)
		{
...
bool func_439(int iParam0, int iParam1, float fParam2, float fParam3)
{
...
bool func_441(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	if (is_entity_dead(iParam0))
	{
		return false;
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_146(iVar0, 0)))
		{
			if (func_637(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_445(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_449(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3)
	{
		return false;
...
bool func_450(int iParam0, int iParam1, float fParam2, int iParam3)
{
	fVar0 = 40f;
	if (func_241(iParam1))
	{
...
bool func_454(int iParam0, int iParam1, vector3 vParam2)
{
...
int func_458(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_119(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_459(int iParam0, int iParam1, bool bParam2)
{
	...
	if (does_entity_exist(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (_0x06087579e7aa85a9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (has_entity_clear_los_to_entity(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_460(iParam1, iVar0))
					{
						return true;
					}
				}
	...
	if (does_entity_exist(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_460(iParam1, iVar1))
				{
...
int func_463(int iParam0, int iParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (iParam1->f_4 == 0)
...
bool func_465(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_470(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_172(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_648(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_471(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_149(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
int func_475(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6)
{
	iVar0 = _create_volume_cylinder(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	iVar1 = func_659(uParam0, uParam1, iParam2, iVar0);
	func_55(iVar0);
	return iVar1;
}
...
void func_479(int iParam0, char* sParam1, int iParam2)
{
	...
	func_662(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, 859817522, 0, 0, 0, 1);
}
...
void func_481(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = func_663();
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_662(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_662(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_662(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_662(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_484(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_118() == -1)
	{
		...
		{
			func_675(iParam0, iParam1, 1, &bParam2, iParam3);
			return false;
		}
	}
...
int func_487(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = _0xe787f05dfc977bde(func_685(bParam2), iParam0, 0);
	return iVar2;
}
...
bool func_498(int iParam0)
{
	...
	return func_689((*Global_1347702)[iParam0]->f_15);
}
...
void func_502(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_699(_create_var_string(2, sVar0), _create_var_string(2, sVar1), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_699(_create_var_string(2, sVar0), _create_var_string(2, sVar3, iParam3, iParam4), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_701(_create_var_string(2, sVar0), _create_var_string(2, func_700(func_495(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_699(_create_var_string(2, sVar0), _create_var_string(2, sVar3, iParam3, iParam4), iVar5, iVar4, 1433015236, _create_var_string(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_709(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_512(0))
				{
					...
					func_514(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
bool func_514(int iParam0, int iParam1, int iParam2)
{
	if (iParam1 < 1)
	{
		return true;
	...
	if (is_weapon_valid(iVar0))
	{
		...
		if (!func_681(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (_is_weapon_melee(iVar0))
			{
				...
				{
					func_513(iVar0, _get_weapon_clip_size(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (_is_weapon_one_handed(iVar0))
			{
				iVar7 = func_717(Global_35, 2, 0, 1);
				if ((((func_404(iVar7) && !Global_43891) && iVar7 != iVar0) && !func_506(24)) && bParam4)
				{
					_0xe9bd19f8121ade3e(Global_35, iVar7);
				}
				bVar8 = true;
				if (func_404(iVar7) && func_506(24))
				{
...
void func_518(int iParam0)
{
	if ((iParam0 == -615217896 && !func_719()) || iParam0 != -615217896)
	{
		...
		{
			func_539(player_ped_id(), iParam0, 0, -358215195, 1, 1, 1, 0, 1, 1);
		}
	}
	switch (iParam0)
	{
...
void func_530(int iParam0)
{
	switch (iParam0)
	{
		case 1369162587:
			...
			func_500(51, 0, 0, -949689219, sVar0, 0, -1, 0);
			func_502(51, 0, 0, sVar0, func_691(-949689219, 20), 1, 0);
			func_730(1);
		...
		case 1610047510:
			...
			func_500(51, 0, 0, -1248968496, sVar0, 0, -1, 0);
			func_502(51, 0, 0, sVar0, func_691(-1248968496, 20), 1, 0);
			func_730(8);
			break;
		case 1317879106:
			_0x3ea62e56f386c997(1706369307, 1);
			func_738(1706369307, -832850511, &sVar0, 1, 0, 0);
			func_500(51, 0, 0, 1706369307, sVar0, 0, -1, 0);
			func_502(51, 0, 0, sVar0, func_691(1706369307, 20), 1, 0);
			func_730(64);
			break;
		case 1062444751:
			_0x3ea62e56f386c997(1520110311, 1);
			func_738(1520110311, -100913452, &sVar0, 1, 0, 0);
			func_500(51, 0, 0, 1520110311, sVar0, 0, -1, 0);
			func_502(51, 0, 0, sVar0, func_691(1520110311, 20), 1, 0);
			func_730(512);
			break;
		case 754186760:
			...
			func_500(51, 0, 0, -1992824800, sVar0, 0, -1, 0);
			func_502(51, 0, 0, sVar0, func_691(-1992824800, 20), 1, 0);
			func_730(32768);
			break;
		default:
			func_473(439, 0);
...
int func_539(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	func_759(1, (func_118() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_757(iParam3, 1)])
			{
				func_760(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_761(32768) && iParam1 != &Global_1946804->f_57[func_757(iParam3, 1)])
			{
				func_762();
...
void func_547(int iParam0, bool bParam1)
{
	...
	func_699(_create_var_string(2, sVar1), _create_var_string(2, sVar2), get_hash_key("toast_log_blips"), get_hash_key("BLIP_RC_TREASURE_HUNTER"), 1433015236, _create_var_string(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_557()
{
	iVar0 = get_random_int_in_range(0, func_686());
	return func_687(_0x126cbebba46693cf(iVar0, -2076669067, 0));
}
...
void func_565(int iParam0, char* sParam1)
{
	...
	func_662(_create_var_string(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_787(iParam0), 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}

void func_566(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_788())
	{
		func_789(iParam0, iParam1, bParam2, bParam4);
		return;
	}
	bVar0 = false;
	iVar1 = absi(iParam1);
	...
	sVar15 = func_792(_create_var_string(10, &cVar2, _create_var_string(0, func_554(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_504(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
		sVar15 = _create_var_string(0, func_554(iParam0));
	}
	func_662(sVar15, Var7.f_1, get_hash_key(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
void func_567(int iParam0, char* sParam1, int iParam2)
{
	...
	func_662(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_568(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_662(_create_var_string(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		...
		func_662(_create_var_string(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
void func_574(int iParam0, bool bParam1)
{
	...
	_uilog_add_entry_hash(4, func_799(iParam0), func_800(iParam0), iVar3, iVar5, 0);
	_uilog_set_entry_brief_texture(4, func_799(iParam0), iVar8, -445557482);
	_uilog_set_entry_icon_texture(4, func_799(iParam0), iVar6, iVar7);
	_uilog_add_or_update_objective(4, func_799(iParam0), iVar1, sVar0, false, false, false);
	if (bParam1)
	{
		return;
	}
...
bool func_582(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_637(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
void func_586(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_392(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_393(iParam0, 1);
	if (!bParam2)
	{
		func_164(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_811(iParam0))
		{
...
bool func_590(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_192(vParam0))
	{
		return false;
...
bool func_592(vector3 vParam0)
{
	iVar0 = 0;
	while (iVar0 < Global_1310750->f_16043)
	{
		if (!func_192(*Global_1310750->f_16043[iVar0]))
		{
			if (func_155(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
int func_597(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
...
bool func_615(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
bool func_637(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
...
bool func_644(int iParam0, int* iParam1, var uParam2)
{
	if (iParam1->f_11 != 0)
	{
		...
		else if (func_2(iParam1->f_10, 1))
		{
			...
			func_160(&(iParam1->f_10), 1);
		}
	}
	return false;
}

bool func_645(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_2(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_838(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_648(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
bool func_651(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_841(Global_35)) || func_842(Global_35)) || func_843(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_115((*uParam4)[iVar0]->f_6);
		func_844(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_845(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_846(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_331(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
bool func_655(var uParam0, int* iParam1, float fParam2, bool bParam3)
{
	if (iParam1->f_9)
	{
...
void func_656(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_844(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
{
	func_857((get_game_timer() + iParam2), !bParam1);
...
void func_669(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_859(iParam0));
...
void func_675(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (bParam2 || !func_707(iVar0))
	{
		...
		if (bParam2 || (!has_ped_got_weapon(Global_35, iVar0, 0, false) && func_487(iParam0, 0, 0) == 0))
		{
...
int func_678(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	return _0xaddd1e7c0ecf7d95(func_685(bParam3), iParam0);
}
...
int func_679(int iParam0, bool bParam1)
{
	...
	return _0xe787f05dfc977bde(func_685(bParam1), iParam0, 0);
}
...
bool func_681(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_673(iParam0) && _0x705be297eebdb95d(iParam0))
	{
	...
	{
		iVar28 = _0xe787f05dfc977bde(func_685(bParam4), iParam0, 0);
	}
...
void func_688(int iParam0)
{
	...
	func_662(_create_var_string(6, func_884(iParam0), fVar1), "itemtype_textures", func_885(iVar0), 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
char* func_692(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case -2076669067:
			...
			{
				sParam3 = _create_var_string(2, "COL_CC_CARD_POSTED_OBJ", func_887(), 12);
			}
			else
			{
				sParam3 = _create_var_string(2, "COL_CC_CARD_FOUND_OBJ", func_888(), 12);
			}
			break;
		case -440187297:
			if (iParam2 == 0)
			...
			{
				sParam3 = _create_var_string(2, "COL_DB_POSTED_OBJ", func_889(), 30);
			}
			else
			{
		...
		case 1995362678:
			...
			{
				sParam3 = _create_var_string(2, "COL_LF_CAUGHT_OBJ", func_890(), 13);
			}
			break;
		case 2103522376:
			if (iParam2 == 0)
			...
			{
				sParam3 = _create_var_string(2, "COL_RC_POSTED_OBJ", func_891(), 10);
			}
			else
			{
...
bool func_696(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_700(func_892(iVar0))), func_700(func_892(iVar0)), bVar1, true, false);
		}
		if (iParam2 == -440187297)
		{
			if (iVar0 == 0)
			{
				...
				_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_895(iVar0)), func_895(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == -1531394072)
		{
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_898(iVar2)), func_898(iVar2), bVar1, true, false);
		}
		if (iParam2 == 1995362678)
		{
			if (func_899(_0x126cbebba46693cf(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_900(_0x126cbebba46693cf(iVar0, iParam2, 0))), func_900(_0x126cbebba46693cf(iVar0, iParam2, 0)), bVar1, true, false);
		}
		...
		if (iParam2 == 678508515)
		{
			...
			_uilog_add_or_update_objective(3, iParam1, get_hash_key(func_903(iVar2)), func_903(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_705(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if ((!&Global_1879534 && func_496()) && _is_deadeye_ability_locked(get_player_index(), 2))
			{
			...
			break;
		case 3:
			if ((!&Global_1879534 && func_496()) && _is_deadeye_ability_locked(get_player_index(), 3))
			{
			...
			break;
		case 4:
			if ((!&Global_1879534 && func_496()) && _is_deadeye_ability_locked(get_player_index(), 4))
			{
			...
			break;
		case 5:
			if ((!&Global_1879534 && func_496()) && _is_deadeye_ability_locked(get_player_index(), 5))
			{
...
bool func_712(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
...
void func_713(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_108(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_720(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_504(iParam1, 866047851))
	{
		...
		if (func_921(&(Global_1946804->f_1497)) >= 2 && &Global_1946804->f_1497.f_1[iVar5] != iVar8)
		{
			*uParam2 = -265166256;
			return false;
		}
	...
	switch (iVar4)
	{
		case 1742327865:
			...
			iVar5 = 10;
			iVar3 = func_508(&(Global_1946804->f_1497.f_1[iVar5]));
		...
		case -1944638739:
			iVar5 = 35;
			if (&Global_1946804->f_1497.f_1[iVar5] != &Global_1946804->f_57[iVar5] && func_504(iParam1, -1638171711))
			{
				*uParam2 = 187275271;
				return false;
			}
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_923(&(Global_1946804->f_1497.f_1[iVar5]), iVar4, iVar2, bVar1);
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != &Global_1946804->f_57[iVar6] && func_504(&(Global_1946804->f_1497.f_1[iVar5]), -1638171711))
				{
					*uParam2 = -357399012;
					return false;
				}
				...
				{
					if (iParam1 != &Global_1946804->f_57[iVar6] && func_924(&(Global_1946804->f_1497.f_1[iVar5])))
					{
						*uParam2 = -357399012;
						return false;
					}
...
int func_724()
{
	...
	while (iVar1 < 26)
	{
		if (func_536(func_926(iVar1), 1, 0))
		{
			iVar0++;
		}
		iVar1++;
...
int func_729(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_536(1811977508, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
int func_736()
{
	...
	while (iVar1 < 30)
	{
		if (func_929(_0x126cbebba46693cf(iVar1, -440187297, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_741()
{
	...
	while (iVar1 < 5)
	{
		if (func_934(_0x126cbebba46693cf(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_750()
{
	if (func_689((*Global_1347702)[37]->f_15) && Global_1392388->f_7)
	{
		return true;
	}
	return false;
...
void func_755(int iParam0, int iParam1, var uParam2)
{
	*iParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
bool func_758(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_761(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
		func_940(func_938(iParam2, 1));
	}
	iVar5 = 0;
	if (bParam4)
	{
	...
	func_941(iParam2);
	func_942(iParam2, iVar5);
	if (&Global_1946804->f_1378.f_1[iParam2] != &Global_1946804->f_57[iParam2] && Global_1946804->f_57[iParam2]->f_1 > 1)
	{
		func_943(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_943(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	func_944(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804->f_1378.f_1[iParam2]->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2] = iParam0;
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_945(iParam0, iParam2, iParam1, func_118() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_947(func_938(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_762()
{
	func_951(&(Global_1946804->f_2776));
	func_952(32768);
...
bool func_766(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
bool func_767(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
float func_769()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_961()));
	fVar7 = (func_956(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_962(3, round((to_float(iVar8) * fVar10)), 0);
	func_963(3, fVar9, fVar9 > 100f);
	return func_964(fVar7, -100f, 100f);
}
...
float func_770()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_961()));
	fVar7 = (func_956(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_962(2, round((to_float(iVar8) * fVar10)), 0);
	func_963(2, fVar9, fVar9 > 100f);
	return func_964(fVar7, -100f, 100f);
}
...
float func_771()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_961()));
	fVar7 = (func_956(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_962(1, round((to_float(iVar8) * fVar10)), 0);
	func_963(1, fVar9, fVar9 > 100f);
...
int func_773(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!_0xcb5d11f9508a928d(func_685(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_777(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		if (func_972(iParam0, 512))
		{
			func_760(30, iVar0, 0, 0, 0);
		}
	}
	if ((!func_973() && !bParam1) && !func_242(0, 0, 1))
	{
...
{
	return func_774(iParam0, 0) < func_976(iParam0, bParam1);
}
...
bool func_781(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_757(iParam0, 1)] != &Global_1946804->f_57[func_757(iParam0, 1)];
}
...
int func_784(int iParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam0 == 0)
	{
		return 0;
...
{
	if (!func_981(iParam0, &uVar0, 805880880, 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
void func_789(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_794(int iParam0)
{
	...
	func_982((Global_40.f_4283.f_325 + iParam0));
}
...
void func_795(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_793())
	{
		func_662(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, -585750914, 0, 0, 0, 1);
	}
	else
	{
		func_662(_create_var_string(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, -585750914, 0, 0, 0, 1);
	}
}
...
var func_801(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14)
{
	...
	return func_984(sParam0, sParam1, iParam2, iParam3, iParam4, sParam5, iParam6, iParam7, sParam8, sParam9, iParam10, iParam11, iParam12, iParam13);
}
...
void func_803(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		if (func_161(func_985(iVar0), 0))
		{
			if (is_ped_group_member(func_985(iVar0), func_342(), 1))
			{
				func_986(iVar0, iParam0);
			}
		}
		iVar0++;
	}
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_987() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_987();
					}
					func_918(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_160(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
bool func_833(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_995((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_835(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_996(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_115((*uParam2)[iVar0]->f_6))
		{
...
bool func_839(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	iVar0 = 0;
	if (func_998(16))
	{
...
void func_840(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	iVar0 = 0;
	while (iVar0 < *uParam1)
	{
		func_996(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
{
	return (func_1000(iParam0, 4) || func_1000(iParam0, 5));
}

int func_842(int iParam0)
{
	return func_1000(iParam0, 7);
}

int func_843(int iParam0)
{
	return func_1000(iParam0, 6);
}
...
void func_844(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (is_bit_set(*iParam1, 14))
	{
		if (func_850(iParam1))
		{
			...
			func_996(iParam0, iParam1, fParam2, iParam3, iParam4, iParam5, bParam6, 0);
		}
	}
}

bool func_845(int iParam0, int* iParam1, int* iParam2, bool bParam3, float fParam4, float fParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, float fParam14, bool bParam15, int iParam16)
{
	bVar0 = bParam3;
	if (bParam3)
	{
		bVar1 = false;
		if (func_1001(iParam1, iParam2, iParam0, bParam9, bParam10, fParam5, bParam11, bParam12, bParam13, fParam14, bParam15, iParam16))
		{
			bVar1 = true;
		}
		if (func_1002(iParam2->f_6, 0))
		{
			if (bVar1)
			{
		...
		if (bParam8)
		{
			func_1003(iParam2->f_6, iParam0, 0, 1, -1);
		}
	}
	return bVar0;
}
...
bool func_846(int iParam0, int iParam1)
{
	...
	{
		if (func_1004(iParam1, 1))
		{
			return true;
		}
	}
	else if (func_1005(iParam1, 1))
	{
		func_1006(iParam1, 1);
		return true;
	}
...
void func_847(var uParam0, bool bParam1, bool bParam2)
{
	iVar0 = 0;
	while (iVar0 < *uParam0)
	{
		func_290((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}

bool func_848(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
...
bool func_865(int iParam0, int iParam1, var uParam2)
{
	if (!func_864(iParam0))
	{
		return false;
...
int func_866(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (!func_483(iParam0, 0))
	{
		return 0;
...
{
	return func_711(1328661203, func_1008(), -1591664384, bParam0);
}
...
struct<4> func_868(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_711(923904168, func_867(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_711(923904168, func_867(bParam0), -740156546, 0) };
		}
...
struct<4> func_870(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_711(271701509, func_867(bParam0), 12999093, 0) };
		}
...
bool func_872(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_878(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = _0x640f890c3e5a3ffd(func_685(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return func_1010(&(Global_40.f_11095.f_11[iParam0]));
}
...
void func_883(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_1011(iParam0) && func_1012(iParam0))
	{
		if (!bParam2)
		{
			iVar3 = func_1013(fVar1, fParam1);
			if (fParam1 > IntToFloat(func_1014(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
				if (!is_radar_hidden() && !Global_16)
				{
					if (iVar2 > iVar0)
					{
						func_473(func_1015(iParam0), 0);
					}
					func_1016(iParam0, iVar2, iVar3);
					func_1017(iParam0, 7000);
				}
...
int func_887()
{
	return func_1019(Global_40.f_12019);
}
...
int func_889()
{
	...
	while (iVar1 < 30)
	{
		if (func_1020(_0x126cbebba46693cf(iVar1, -440187297, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_890()
{
	...
	while (iVar1 < 14)
	{
		if (func_899(_0x126cbebba46693cf(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_1021(iParam0) && func_536(iParam0, 1, 0))
	{
		return true;
	}
...
char* func_903(int iParam0)
{
	...
	return _get_label_text_by_hash(func_554(iParam0));
}
...
int func_914(int iParam0)
{
	...
	return &(Global_1946804->f_1497.f_1[func_757(iParam0, 1)]);
}
...
bool func_916(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_685(0);
...
void func_918(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar4 = func_1028(*iParam0);
	iVar5 = func_1029(*iParam0);
	...
	func_1031(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_921(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_504(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = func_757(func_1032(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
{
	if (iParam0 == &Global_1946804->f_57[func_757(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
{
	return func_1035(func_408(), iParam0, bParam1);
}
...
{
	func_1036(&(Global_1946804->f_2589), iParam0);
}

void func_942(int iParam0, int iParam1)
{
	func_1037(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
void func_944(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	iVar1 = 12;
	iVar2 = func_508(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_1038(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
		if (bParam4)
		{
			func_942(iVar1, iVar3);
		}
	}
	if (func_781(-1586649372) && func_1038(iParam2, 524288))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
		uParam0->f_1[iVar1]->f_1 = 0;
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_1039(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_1039(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_1039(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_1039(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_508(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_924(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_508(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_504(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_924(&(Global_1946804->f_1497.f_1[iVar1])) || func_504(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_508(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_508(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_508(&(uParam0->f_1[iVar1])) || func_504(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_1040(0);
	if (iParam2 != 0 && func_1041(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_1042(iParam0, func_938(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_946(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		{
			iVar5 = func_938(iVar0, 1);
			if (func_1043(iVar5, 8))
			{
			}
			else if (&Global_1946804->f_57[iVar0]->f_2[0] == -1802376732 || &uParam0->f_1[iVar0] == 0)
			{
			}
			else if (func_1043(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_923(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
{
	(Global_1946804->f_57[func_757(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_757(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_757(iParam0, 1)])->f_10 && iParam1));
}
...
void func_948(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_118() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_1046(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_971(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_971(Global_40.f_7729);
				Global_1946804->f_1378 = func_971(Global_40.f_7729);
...
void func_954(struct<4> Param0)
{
	...
	if (func_1049(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_1049(20))
			{
				return;
			}
			iVar0++;
...
void func_962(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_1053(iParam0, 1, 0, 0);
	sVar0 = _create_var_string(2, sVar0, sParam1);
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[iParam0]->f_12[1]), sVar0);
	_databinding_write_data_bool(&(Global_1955569->f_5.f_2[iParam0]->f_16[1]), bParam2);
}

void func_963(int iParam0, float fParam1, bool bParam2)
{
	sVar0 = func_1053(iParam0, 2, 0, 0);
...
float func_964(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_970(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_969(iParam0))
	{
		...
		if ((!func_973() && !bParam1) && !func_242(0, 0, 1))
		{
			func_974(_create_var_string(10, "OUT_JOURN_ADD", func_1055(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_980(var uParam0, int iParam1, struct<14> Param2)
{
...
bool func_981(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Var3.f_2 = 5;
	Var3.f_18 = 8;
	if (_item_database_fillout_ui_data(iParam0, &Var3))
...
var func_984(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	Var0 = -2;
	Var0 = iParam7;
	Var0.f_1 = sParam8;
...
bool func_988(vector3 vParam0, vector3 vParam3)
{
	return ((vParam0.x == vParam3.x && vParam0.y == vParam3.y) && vParam0.z == vParam3.z);
}
...
int func_995(bool bParam0, var uParam1, int iParam2)
{
	if (bParam0)
	{
		return uParam1;
...
void func_996(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_115(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_850(iParam1))
		{
			...
			iParam1->f_6 = func_1071(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824, 0, 1704213876, iParam1->f_10, 0);
			if (func_115(iParam1->f_6))
			{
				if (!bParam6)
				{
					iVar1 = -1;
					func_1003(iParam1->f_6, iParam0, 0, 1, iVar1);
				}
				else
				{
					func_1072(iParam1->f_6, 17, 1, 1);
				}
				if (is_bit_set(*iParam1, 1))
				{
					if (is_bit_set(*iParam1, 3))
					{
						func_1073(iParam1->f_6, sVar0, iParam1->f_16, iParam1->f_14, 1);
					}
					else
					{
...
bool func_1001(int* iParam0, int* iParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, bool bParam8, float fParam9, bool bParam10, int iParam11)
{
...
void func_1003(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	if (bParam3 && !func_115(iParam0))
	{
		return;
	...
	iVar0 = func_288(iParam0);
	func_1072(iParam0, 18, 0, 1);
	func_1072(iParam0, 17, 0, 1);
	if (iParam4 == -1)
	{
...
bool func_1004(int iParam0, bool bParam1)
{
	if (bParam1 && !func_115(iParam0))
	{
		return false;
...
float func_1009(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50:
			...
			iVar5 = func_1010(fVar3);
			iVar0 = iVar5;
			iVar6 = iVar0 + 1;
			iVar1 = (func_1075(iVar6) - func_1075(iVar5));
...
int func_1013(float fParam0, float fParam1)
{
	iVar0 = func_1010(fParam0);
	fVar1 = to_float(func_1075(iVar0));
	fVar2 = to_float(func_1075(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_1016(int iParam0, int iParam1, int iParam2)
{
	...
	iVar3 = (iVar3 + func_1078(iParam0));
	sVar4 = func_1080(func_1079(iVar3, iParam2));
	sVar6 = func_1081(iParam0);
	if (!is_string_null_or_empty(sVar6))
	{
		sVar5 = "HUD_Toast_Soundset";
	}
	sVar7 = _create_var_string(10, sVar0, func_1082(iParam0));
	iVar8 = func_1083(iParam0);
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_1084(iParam0);
		_uilog_post_notification(&Var10);
	}
	func_699(sVar7, sVar1, iVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_1085(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_1023(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_1086(&iVar0, 0, iVar95, &Var1) && !func_1086(&iVar0, 1, iVar95, &Var1))
		{
		}
		else if (is_model_a_ped(Var1))
		{
			func_1087(iVar0, &Var1);
...
void func_1024()
{
	...
	func_1089(0);
	func_1090(7);
	func_1091(-1623728698, 1, 1, 0);
	if (func_778() == 1160113249)
	{
		func_1091(-763730846, 1, 1, 1);
		func_1091(-361635024, 1, 1, 1);
	}
	func_1092(Global_35, &uVar0);
}

int func_1025(int iParam0)
{
	return (shift_right(iParam0, 26) & 31 * func_581(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_1031(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_1093(iParam0, iParam6);
	func_1094(iParam0, iParam5);
	func_1095(iParam0, iParam4);
	func_1096(iParam0, iParam3);
	func_1097(iParam0, iParam2);
...
int func_1034(int iParam0, int iParam1)
{
	...
	func_1093(&uVar6, iVar0);
	func_1094(&uVar6, iVar1);
	func_1095(&uVar6, iVar2);
	func_1096(&uVar6, iVar3);
	func_1097(&uVar6, iVar4);
	func_1098(&uVar6, iVar5);
	return uVar6;
}
...
bool func_1035(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_1099(iParam1) || !func_1099(iParam0))
		{
			return true;
		}
	}
...
void func_1036(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1100(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_1100(uParam0->f_2[iVar0], 1))
				{
					func_1101(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_1039(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
	...
	if (uParam0->f_1[iVar3]->f_1 == 1216705912 || uParam0->f_1[iVar3]->f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_942(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_942(iVar3, iVar0);
		}
	}
...
int func_1041(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (iParam2 == 0)
	{
		return -1;
...
{
	return ((Global_1946804->f_57[func_757(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
void func_1045(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_118() == -1)
	{
		func_1104(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_1105(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_1106(&(Global_1946804->f_1378), iParam0);
	func_1107(2, iParam0, 6);
	if (bParam1)
	{
		func_1048(0, 1);
	}
...
char* func_1053(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_1058(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_536(func_1114(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
int func_1071(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	if (is_string_null_or_empty(sParam0))
	{
		return 0;
	...
	while (iVar0 < 48)
	{
		if (func_618(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_1115(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_1073(int iParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4)
{
	if (bParam4 && !func_115(iParam0))
	{
		return;
	}
	iVar0 = func_288(iParam0);
...
int func_1078(int iParam0)
{
	...
	{
		case 0:
			return _0xe787f05dfc977bde(func_685(0), -1845241476, 0);
		case 1:
			return _0xe787f05dfc977bde(func_685(0), 1654063339, 0);
		case 2:
			return _0xe787f05dfc977bde(func_685(0), 1623931083, 0);
	}
	return 0;
}

struct<4> func_1079(int iParam0, int iParam1)
{
	if (iParam0 >= 10)
	{
		iParam1 = 0;
...
char* func_1080(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_1086(int iParam0, int iParam1, int iParam2, var uParam3)
{
	if (func_1116(iParam1) && !func_1117(iParam1))
	{
		iVar0 = func_1118(iParam1);
	}
	else
	{
		return false;
...
void func_1087(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(iVar0))
	{
		func_1121(iVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
		if (func_1122(&(iParam1->f_1), iVar0, iParam1->f_7, iParam1->f_5))
		{
		}
	}
}
...
void func_1090(int iParam0)
{
	...
	while (iVar0 < Global_1946804->f_2657.f_19)
	{
		...
		{
			func_1127(iVar2, &Global_1946804->f_1497.f_1[iVar1] == &Global_1946804->f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_1091(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (iParam0 == func_1130(0))
	{
		func_1131(iParam0, 1);
		if (func_778() == 1160113249)
		{
			func_1131(func_1130(-2125499975), 0);
		}
		else
		{
			func_1131(func_1130(1160113249), 0);
		}
	}
	func_1132();
	if (func_1133(iVar0))
	{
		_0x766315a564594401(func_685(0), iParam0, 0);
	}
...
void func_1095(int iParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_1030(iVar0, iVar1))
	{
		return;
	}
...
bool func_1099(int iParam0)
{
	...
	iVar3 = func_1025(iParam0);
	if ((iVar3 <= 0 || iVar3 > 1930) || iVar3 < 1866)
	{
		return false;
	}
	iVar4 = func_1026(iParam0);
	if (iVar4 < 0 || iVar4 > 11)
	{
		return false;
	}
	iVar5 = func_1027(iParam0);
	if (iVar5 < 1 || iVar5 > func_1030(iVar4, iVar3))
	{
		return false;
	}
	return true;
...
bool func_1102(var uParam0, int iParam1)
{
	return (uParam0->f_1 && iParam1) != 0;
}
...
void func_1106(var uParam0, int iParam1)
{
	if (func_118() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_1104(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_1105(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}

void func_1107(int iParam0, int iParam1, int iParam2)
{
	if (func_118() == -1)
	{
		if (iParam1 == -1)
...
void func_1115(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, var uParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
...
void func_1121(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
bool func_1122(var uParam0, int iParam1, int iParam2, int iParam3)
{
	iVar0 = iParam3;
	iVar1 = iParam2;
	if (iVar0 < iVar1)
...
void func_1125(var uParam0, int iParam1, int iParam2)
{
	...
	func_1149(iParam2, *uParam0);
	func_1150(uParam0->f_1[*uParam0], iParam1, -1, 1, 0);
	*uParam0++;
}
...
bool func_1126(int iParam0, int iParam1)
{
	...
	_0x9a113c660aea3832(func_685(0), &Var5, iParam1);
	return true;
}
...
void func_1127(int iParam0, bool bParam1)
{
	...
	_0x65a5f70f4a292ebe(func_685(0), &Var5, bParam1);
}
...
int func_1131(int iParam0, int iParam1)
{
	...
	_0x0349404a22736740(iParam1, func_685(0), &Var5);
	return 1;
}
...
{
	return func_1153(func_1152(iParam0));
}
...
void func_1149(int iParam0, var uParam1)
{
...
{
	iVar1 = func_1157(iParam1);
	func_1158(iParam1, iParam2);
	if (iVar1 >= 0 && uParam0->f_26 > 0)
	{
		func_1159(&(uParam0->f_26), iVar1);
		if (func_1160(uParam0->f_26, &iVar0))
		{
			func_1161(iVar0, iVar1);
		}
	}
}
...
void func_1156(var uParam0)
{
	...
	func_1163(&(uParam0->f_3), *uParam0, uParam0->f_2);
}
...
void func_1163(var uParam0, var uParam1, var uParam2)
{
	iVar0 = func_1164(func_778());
	if (*uParam0)
	{
		func_1162(uParam0);
	}
	uParam0->f_1 = _0xf6d9e1f3560cbf8e(iVar0, uParam1, 0, func_118() != -1, uParam2);
	*uParam0 = 1;
}
