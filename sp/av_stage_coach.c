void __EntryFunction__()
{
	...
	Var0 = Local_39;
	Var0.f_1 = Local_39.f_11;
	Var0.f_483 = { Local_39.f_1 };
	Var0.f_486 = { Local_39.f_4 };
	Var0.f_489 = Local_39.f_7;
	Var0.f_20[0] = Local_39.f_8;
	Var0.f_453 = Local_39.f_9;
	Var0.f_500 = Local_39.f_10;
	Var0.f_503 = Local_39.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "PASSENGER", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -4.5f, 1.5f, 0f), (vParam4.z - 75f), 1, 0, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "WAGON_DRIVER", 1995969965, _get_object_offset_from_coords(vParam1, vParam4.z, -1f, 1.5f, 0f), (vParam4.z + 110f), 1, 0, 1, 1, 41788943, 1);
...
bool func_28(var uParam0)
{
	...
	{
		iLocal_37 = create_group(0);
		set_ped_as_group_leader(&(uParam0->f_20[1]), iLocal_37, false);
		func_58(&(uParam0->f_20[1]), -22664287, 0, 0, 1317331863, -1082130432);
	}
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		set_ped_as_group_member(&(uParam0->f_20[0]), iLocal_37);
		func_58(&(uParam0->f_20[0]), 830847823, 0, 0, 0, -1082130432);
	}
	return true;
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_72(uParam0, 1065353216, 80f, 4, 60f, 1112014848))
		{
			...
			task_enter_vehicle(0, uParam0->f_453, -1, -1, 1f, 0, 0);
			close_sequence_task(iVar0);
			_task_perform_sequence_2(&(uParam0->f_20[1]), iVar0, 3f, 6f);
			clear_sequence_task(&iVar0);
			task_enter_vehicle(&(uParam0->f_20[0]), uParam0->f_453, -1, 1, 1f, 1, 0);
	...
	if (&uParam0->f_469[2])
	{
		if (is_ped_in_vehicle(&(uParam0->f_20[1]), uParam0->f_453, false) && !func_74(&(uParam0->f_20[0]), -1794415470))
		{
			task_vehicle_drive_wander(&(uParam0->f_20[1]), uParam0->f_453, 3f, 524419);
...
void func_69(var uParam0)
{
	...
	while (iVar0 < 6)
	{
		if (does_entity_exist(&(uParam0->f_20[iVar0])) && !is_entity_dead(&(uParam0->f_20[iVar0])))
		{
			clear_ped_tasks_immediately(&(uParam0->f_20[iVar0]), false, true);
			if (is_ped_in_vehicle(&(uParam0->f_20[iVar0]), uParam0->f_453, false))
			{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_112(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_113(&(uParam0->f_490)))
							{
...
{
	if (is_vehicle_seat_free(uParam0->f_453, -1))
	{
		open_sequence_task(&iVar0);
		task_leave_vehicle(0, uParam0->f_453, 4096, 0);
		task_smart_flee_ped(0, Global_35, -1f, -1, 0, 1077936128, 0);
		close_sequence_task(iVar0);
		task_perform_sequence(&(uParam0->f_20[iParam1]), iVar0);
		clear_sequence_task(&iVar0);
		set_ped_keep_task(&(uParam0->f_20[iParam1]), true);
	}
	else
	{
		task_smart_flee_ped(&(uParam0->f_20[iParam1]), Global_35, -1f, -1, 0, 1077936128, 0);
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_181(1) || *uParam0 & 8192 != 0))
				{
...
bool func_141(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_194(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_192(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (get_game_timer() - uParam2->f_2) > func_193(uParam2)
				{
					func_188(uParam2, 1);
					return true;
				}
...
bool func_142(int iParam0, var uParam1)
{
	...
	if (func_184(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_3) > func_193(uParam1)
		{
...
bool func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_207(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_226(iVar0, 0)))
		{
...
bool func_194(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_226(iVar0, 0)))
		{
			if (func_228(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_213(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_207(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_227(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_228(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
