...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, 927991752, 0f, 0f, 0f, "p_cigarette_cs02x", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, -439112356, "WORLD_HUMAN_INSPECT_FEMALE_D", -1, 0, 40f, 1065353216, 1);
	...
	func_157(uParam0, iLocal_15, 2, -22664287, "WORLD_HUMAN_SMOKE_MALE_D", -1, 0, 20f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	if (func_108(&uLocal_17) && !is_entity_dead(func_48(uParam0, iLocal_14)))
	{
		set_ped_min_move_blend_ratio(func_48(uParam0, iLocal_14), 1.4f);
		if (func_109(&uLocal_17) > 5f)
		{
			func_56(uParam0->f_107[iLocal_14]->f_1, 0, 0, 0, uParam0->f_107[iLocal_14]->f_32.f_4, 1, 1, 0, 0, 0, 0);
		}
	}
	return true;
}
...
void func_201(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_306(100f, 140f);
			}
		}
...
bool func_243(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_319(&(Global_1898164->f_1[0]));
		if (func_320(iVar0) && func_321((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_322(&(Global_1898164->f_1[0])))
	{
		return true;
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(747937920, 1) && !func_396((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
