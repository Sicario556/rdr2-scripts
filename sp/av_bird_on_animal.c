...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 1, "BOA_BIRD_1", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 0, "BOA_ANIMAL_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 0f, 1f), (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		...
		while (iVar1 < 2)
		{
			if (is_entity_dead(&(uParam0->f_20[iVar1])) || func_63(&(uParam0->f_20[iVar1]), 0, &uLocal_17, &uVar0, 0, 0))
			{
				iLocal_13 = 1;
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_13)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_11, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, false, true, 0, -1f, false);
				func_65(uParam0->f_20[0], 1, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				attach_entity_to_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), func_66(uParam0), func_67(uParam0), func_68(uParam0), true, true, false, true, 2, true, false, false);
		...
		case 1:
			if (uParam0->f_469[1] || func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				func_71(&(uParam0->f_20[1]), 1, 1);
				if (!is_entity_dead(&(uParam0->f_20[1])) && !is_entity_dead(&(uParam0->f_20[0])))
				{
					task_fly_away(&(uParam0->f_20[1]), &(uParam0->f_20[0]));
			...
			break;
		case 2:
			if (func_73(&(uParam0->f_20[0]), 0))
			{
				if (*uParam0 != 119)
				{
					_task_smart_flee_style_ped(&(uParam0->f_20[0]), Global_35, 3, 0, -1082130432, -1, 0);
				}
				else
				{
...
bool func_63(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_109(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
int func_66(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 119:
		case 120:
			return get_ped_bone_index(&(uParam0->f_20[0]), 14413);
		case 118:
			return get_ped_bone_index(&(uParam0->f_20[0]), 14410);
		case 121:
			return get_ped_bone_index(&(uParam0->f_20[0]), 14412);
		case 116:
			return get_ped_bone_index(&(uParam0->f_20[0]), 14412);
	}
	return 0;
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_138(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
float func_138(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_202(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_204(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_229(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_229(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_229(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
