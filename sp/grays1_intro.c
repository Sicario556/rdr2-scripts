void __EntryFunction__()
{
	...
	while (!func_5(&Local_30, 1))
	{
		...
		if (((((func_6(&Local_30) >= 5 && func_6(&Local_30) <= 7) && !func_5(&Local_30, 4096)) && _does_anim_scene_exist(Local_30.f_428.f_444)) && _is_anim_scene_started(Local_30.f_428.f_444, false)) && !_is_anim_scene_paused(Local_30.f_428.f_444))
		{
		...
		switch (func_6(&Local_30))
		{
			...
			case 3:
				...
				func_39(&Local_30);
				if (func_40(func_32((*Global_1835011)[Local_30]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_30.f_428)) == 4 && _does_anim_scene_exist(Local_30.f_428.f_444)) && _is_anim_scene_paused(Local_30.f_428.f_444))
				{
					func_37(Local_30);
					func_17(&Local_30, 7);
				}
...
bool func_29(int iParam0)
{
	...
	iLocal_24[0] = create_object(iLocal_14, 1362.018f, -1302.546f, 76.766f, true, true, false, false, true);
	if (!is_entity_a_mission_entity(&(iLocal_22[0])))
	{
		set_entity_as_mission_entity(&(iLocal_22[0]), true, true);
	}
	set_blocking_of_non_temporary_events(&(iLocal_22[0]), true);
	set_ped_relationship_group_hash(&(iLocal_22[0]), -1538724068);
	set_current_ped_weapon(&(iLocal_22[0]), -1569615261, true, 0, false, false);
	func_131(iParam0, Global_35, 0, 0, 0, 1);
...
{
	if (does_entity_exist(&(iLocal_22[0])))
	{
		func_167(iLocal_22[0]);
	}
	if (does_entity_exist(&(iLocal_24[0])))
	{
		delete_object(iLocal_24[0]);
	}
	if (does_entity_exist(&(iLocal_24[0])))
	{
		delete_object(iLocal_24[0]);
	...
	_0x7b204f88f6c3d287(_0x112ddf56300bc6e5(-2057585848));
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_259(iVar0), func_261(), 1))
			{
...
bool func_128(int iParam0)
{
	...
	request_model(-1745321414, false);
	func_279(0, -922193456, 1);
	func_279(3, -922193456, 1);
	if (!does_entity_exist(&(iLocal_22[0])) && has_model_loaded(-1745321414))
	{
		iLocal_22[0] = func_280(-1745321414, 1360.845f, -1300.704f, 76.7635f, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	}
	iVar0 = 1;
	...
	{
		clear_ped_tasks_immediately(&(iLocal_22[0]), true, true);
		func_283(&(iLocal_22[0]), 1360.56f, -1301.852f, 76.7635f, 0f, 2, 1073741824);
		task_stand_still(&(iLocal_22[0]), -1);
		set_blocking_of_non_temporary_events(&(iLocal_22[0]), true);
		set_current_ped_weapon(&(iLocal_22[0]), -1569615261, true, 0, false, false);
	...
	func_283(&(iLocal_19[0]), 1347.742f, -1307.9f, 76.49629f, 345.6495f, 2, 1073741824);
	task_stand_still(&(iLocal_19[0]), -1);
	func_283(&(iLocal_19[1]), 1345.455f, -1307.474f, 76.6391f, 345.6495f, 2, 1073741824);
	task_stand_still(&(iLocal_19[1]), -1);
...
bool func_135(int iParam0, bool bParam1)
{
	...
	iParam0->f_4 = does_entity_exist(func_259(iVar0));
...
void func_140(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_300(iParam0))
	{
		...
		if (bParam3)
		{
			func_301(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_141(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_306(), true);
	}
}
...
int func_142(int iParam0)
{
	...
	if (!_0x800df3fc913355f3(func_310(iParam0)))
	{
		return 0;
	}
	if (network_is_in_session())
	{
		if (!network_has_control_of_entity(_0x31c70a716cae1fee(func_310(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = _0x31c70a716cae1fee(func_310(iParam0));
	...
	_0x7b204f88f6c3d287(func_310(iParam0));
	return 1;
}
...
bool func_147()
{
	return func_312(get_id_of_this_thread());
}
...
void func_149(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_317(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
bool func_152(int iParam0)
{
	...
	return func_318((*Global_1835011)[iParam0]->f_1);
}
...
int func_161(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_327(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_317(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_317(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
	...
	if (bVar0)
	{
		...
		if (func_316(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_317(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
...
int func_163(int iParam0)
{
	...
	if (vdist2(func_186(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_357(uParam0->f_1522[iVar0], 128))
				{
					func_358(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
int func_169(int iParam0)
{
	...
	_0x4f81ead1de8fa19b(func_310(iParam0));
	return 1;
}
...
bool func_218(bool bParam0, bool bParam1)
{
	if (!func_408(Global_43801))
	{
		Global_43801 = func_413("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_229(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_421(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_404() };
...
void func_230(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_246(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_422(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_233()
{
	return func_411(_0xc17f69e1418cd11f(3));
}
...
void func_238(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_439() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
void func_240(var uParam0)
{
	if (func_83(uParam0, 2048) && !func_90(func_440(uParam0)))
	{
		...
		if ((!is_entity_dead(iVar1) && ((bVar0 && is_entity_in_volume(iVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && get_mount(Global_35) != iVar1)
		{
			...
			func_283(iVar1, func_440(uParam0), func_441(uParam0), iVar2, 1073741824);
		}
		...
		{
			func_283(iVar3, func_440(uParam0), func_441(uParam0), 2, 1073741824);
		}
	}
}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_440(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
		iVar0 = get_vehicle_ped_is_using(Global_35);
		if (!is_entity_dead(iVar0))
		{
			vVar1 = { func_440(uParam0) };
			func_283(iVar0, vVar1, func_442(vVar1, Global_36, 1), 2, 1073741824);
...
int func_270(var uParam0, int iParam1)
{
	...
	if (func_147())
	{
		...
		if (func_481(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_482(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_316(uParam0, 8) && _0xdd0b7c5ae58f721d(func_483()))
	{
		_0x798be43c9393632b(func_483());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_483())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_273(int iParam0)
{
	...
	return func_485((*Global_1835011)[iParam0]->f_1);
}
...
void func_281(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	...
	{
		clear_ped_tasks_immediately(&(uLocal_16[iParam1]), true, true);
		func_283(&(uLocal_16[iParam1]), vParam2, fParam5, 2, 1073741824);
		task_stand_still(&(uLocal_16[iParam1]), -1);
		set_blocking_of_non_temporary_events(&(uLocal_16[iParam1]), true);
		set_current_ped_weapon(&(uLocal_16[iParam1]), -1569615261, true, 0, false, false);
...
void func_282(int iParam0, int iParam1, int iParam2)
{
	...
	func_424(iParam0->f_428.f_13[iVar0], iParam2);
}
...
void func_283(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_502(Global_35) && is_player_teleport_active())
	{
	}
	if (func_503(iParam0))
	{
		if (func_504(get_ped_index_from_entity_index(iParam0)))
		{
...
void func_301(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_300(iParam0))
	{
...
void func_328(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_539(1));
		if (!has_anim_dict_loaded(func_539(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_329(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_317(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_197(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_442(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_544(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_326(uParam0, 4);
			...
			if (func_257(Global_35, &(uParam0->f_1686), iVar7, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688]->f_7, uParam0->f_1016[uParam0->f_1688]->f_7.f_1))
			{
				set_player_control(get_player_index(), true, 0, false);
				uParam0->f_1686 = 0;
				func_315(uParam0, 4);
...
void func_337(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_342(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_551(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_551(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_553(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_553(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_547(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_553(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_555(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_442(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_553(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_553(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_553(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_557(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_557(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
bool func_350(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_197(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_351(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_197(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_575(uParam0)) && _is_anim_scene_started(func_575(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_575(uParam0));
				bVar1 = _is_anim_scene_finished(func_575(uParam0), false);
				bVar2 = _is_anim_scene_active(func_575(uParam0));
...
int func_354(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_576(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
void func_364(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_260(Global_1360165[iParam0], 0);
	...
	else
	{
		...
		{
			func_251(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
void func_376(var uParam0)
{
	if (!func_593(uParam0->f_2, 1))
	{
		if (func_509(uParam0))
		{
			...
			{
				sVar0 = func_410(get_entity_model(Global_35));
...
void func_430(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_444(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_431()
{
	...
	if (func_444(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_444(iVar0))
	{
		...
		{
			func_618(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
bool func_462(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_637(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_637(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_639(iParam0, iParam2, iParam1, func_258() != -1);
	if (bParam4)
	{
...
float func_487()
{
	return (func_653(150f, to_float(Global_1934765->f_286)) / to_float(300));
}
...
int func_489(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!does_entity_exist(iVar0) || !func_260(iVar0, 0)) || (bParam3 && !func_654(iParam1)))
	{
		if (bParam2)
		{
	...
	if (does_entity_exist(iVar0) && func_260(iVar0, 0))
	{
		*uParam0 = 2;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_267(iParam0, 16, 1))
			{
				...
				else if (func_260(Global_1360165[iParam0], 0))
				{
					return Global_1360165[iParam0];
				}
			}
			if (func_260(Global_1360165[iParam0], 0))
			{
...
void func_496(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_166() || !_0x6f1f0b17109309da(Global_43800, func_215(iParam0))))
	{
...
void func_540(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_557(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_541(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_197(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_197(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_197(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_694(512) || func_695(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_526(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_696(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
				...
				else if (func_699(uParam0->f_1633[iVar2]) != 0)
				{
					func_698(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_526(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_197(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_696(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_544(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_700(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_545(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_703(uParam0, iVar0)) && !func_481(uParam0->f_1016[iVar0], 1))
			{
				if (!func_704(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_705(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
...
bool func_559(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_700(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_317(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_576(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_576(uParam0->f_475[iParam1], 64) && func_709(uParam0, iParam1, 0))
				{
			...
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					if ((func_576(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
...
int func_562(var uParam0, int iParam1)
{
	...
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_215(Global_35)))
		{
			if (func_357(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_357(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_705(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_564(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_335(uParam0))
	{
		case 0:
			...
			if (((!func_317(uParam0->f_1016[iVar2], 32) && func_714()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_317(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_317(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_334(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_317(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_317(uParam0->f_1016[iVar2], 256) || !func_425(&uVar5)) || bVar0)
			{
				if (func_719())
				{
					func_720();
...
bool func_568(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_357(uParam0->f_1522[iVar0], 2)) && !func_357(uParam0->f_1522[iVar0], 16)) && func_739(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
...
void func_569(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_357(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_483());
		func_480(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_483()))
		{
...
bool func_570(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_357(uParam0->f_1522[iVar0], 64))
			{
...
void func_571(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_503(uParam0->f_3[iVar0]->f_2)) && func_444(uParam0->f_3[iVar0]->f_10)) && !func_733(uParam0->f_3[iVar0]->f_1))
		{
...
void func_585(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_259(iParam0), 137, true);
	}
}
...
void func_587(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_259(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_259(iParam0), 204, false);
	}
}
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_444(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_468(1328661203, func_319(), -1591664384, bParam0);
}
...
int func_633(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_533(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = 12;
	iVar2 = func_427(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_427(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_770(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_427(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_533(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_770(&(Global_1946804->f_1497.f_1[iVar1])) || func_533(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_427(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_427(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_427(&(uParam0->f_1[iVar1])) || func_533(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
int func_655(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_786(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_656(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		case 0:
			...
			if (func_260((*Global_1360165)[iParam0]->f_124, 0))
			{
				func_788(iParam0, 3);
			}
			else
			{
				...
				{
					_0x187d65f3aec5d679(func_655(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_793(iParam0, (*Global_1360165)[iParam0]->f_124, 1))
				{
					return func_791();
				}
			}
			if ((bParam2 && !func_90(vVar0)) && !func_557(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_283((*Global_1360165)[iParam0]->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
			...
			func_794((*Global_1360165)[iParam0]->f_124, iParam0);
			if (bParam8)
			{
			...
			{
				_0x63aa2b8eb087886a(func_655(iParam0, 1), get_hash_key(sVar12));
			}
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_485((*Global_1360165)[iParam0]->f_4.f_2) || func_318((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_802((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_804(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_583(iParam0, 44, 1);
			}
...
void func_667(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_618(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_618(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
{
	switch (func_699(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_526(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_425(&(uParam0->f_1903)))
				{
					func_718(uParam0->f_1903, 0);
					func_827(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_526(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_828())
				{
					func_827(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_701(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_442(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
bool func_704(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_481(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_707(int iParam0, float fParam1)
{
	...
	if (!(func_834(17) && func_197(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_712(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_357(uParam0->f_1522[iVar0], 1))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_215(Global_35), &vVar7, false, 0, 2))
				{
			...
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_215(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
				if ((func_8(uParam0) > 3 && !func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_835(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					...
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_358(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_576(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_330(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_480(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_215(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_317(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_215(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_836(uParam0, 0);
				}
			}
...
bool func_713(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_576(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_715(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_317(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_317(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_444(func_443(Global_35, 0, 1, 0)) && !func_444(func_443(Global_35, 1, 1, 0))))
		{
			if (func_334(uParam0, uParam0->f_1684))
			{
				func_837(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_317(uParam0->f_1016[uParam0->f_1684], 16) && (func_444(func_443(Global_35, 0, 1, 0)) || func_444(func_443(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_317(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
...
void func_716(var uParam0, int iParam1, bool bParam2)
{
	...
	func_836(uParam0, func_553(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_839(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_706(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_482(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_837(vVar1);
	...
	if (func_576(uParam0->f_475[iParam1], 16))
	{
		func_840(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_721(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_844(iVar0));
		iVar0++;
	}
}
...
bool func_732(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_410(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_820(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_410(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_410(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_820(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_820(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_739(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_357(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_576(uParam0->f_475[iVar0], 512)) || func_576(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
		...
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_733(uParam0->f_3[iVar0]->f_1))
				{
					if (func_597())
					{
						StringCopy(&cVar1, func_410(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_744(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_826(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_746(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_845(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_750(int iParam0)
{
	if (func_114(iParam0))
	{
		if (does_entity_exist(func_259(iParam0)))
		{
...
int func_755(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_260(iVar0, 0))
	{
		if (func_260(_get_rider_of_mount(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_753(iParam0)) || func_654(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_848(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_849(iParam0);
					_0x7b204f88f6c3d287(func_787(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_787(iParam0, 0));
					func_850(iParam0);
				}
			}
			else
		...
		while (iVar28 < 4)
		{
			...
			if (func_627(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_853(0))
				{
					...
					func_854(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_763(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_822("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_856(iParam1, 512) && func_765(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_741(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_856(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_856(iParam1, 4))) && (!func_741(Var4.f_4) || func_856(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_856(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_856(iParam1, 1048576)))
				{
...
void func_766(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_859(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_859(uParam0->f_2[iVar0], 1))
				{
					func_860(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_776(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_258() == -1)
	{
		func_864(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_865(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_782()
{
	...
	func_876(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_783()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_876(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_784()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_876(1, round((to_float(iVar8) * fVar10)), 0);
...
int func_787(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_881(iParam0);
	}
...
bool func_792(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _0xa00df706c60173d1(func_655(iParam0, 1));
			request_model(iVar0, false);
			if (has_model_loaded(iVar0))
			{
				(*Global_1360165)[iParam0]->f_124 = func_280(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_793(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_883(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_794(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(func_259(iParam1)))
	{
		_0x931b241409216c1f(func_259(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_259(iParam1), iParam0);
...
int func_801(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_885((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_885((*Global_1347702)[63]->f_15, 1) || func_318((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_885((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_885((*Global_1347702)[134]->f_15, 1) || func_318((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_885((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_887(747937920, 1) && !func_885((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_259(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_811(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_807(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_807(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_807(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_807(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_807(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_807(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_807(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_807(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_807(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_807(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_807(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_807(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_807(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_807(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_807(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_807(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_807(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_807(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_807(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_807(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_807(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_807(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_807(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_807(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_807(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_807(iParam1, 1544915253))
	{
...
bool func_831(var uParam0, int iParam1)
{
	...
	if ((func_444(func_742(Global_35, 0, 0, 0)) && !func_317(uParam0->f_1016[iParam1], 16)) && !func_317(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_836(var uParam0, bool bParam1)
{
	...
	if ((func_330(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_317(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_480(uParam0, 64);
	}
...
{
	if (func_576(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_525(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_481(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_442(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_525(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_481(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_442(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
	...
	else
	{
		*uParam2 = { func_900(uParam0) };
		...
		else if (!func_481(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_442(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
bool func_839(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_215(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_215(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
{
	func_901(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_901(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_902(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_841(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_442(Global_36, *(*uParam3)[0], 1), 0);
	}
	task_follow_point_route(0, 1f, 0, 1056964608, 1084227584, 1193033728);
	if (func_481(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_842(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_442(Global_36, vParam3, 1), 0);
		}
		...
		if (func_576(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_481(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_481(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
void func_855(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_908(_get_weapon_clip_size(iParam0), iParam1);
...
void func_866(var uParam0, int iParam1)
{
	if (func_258() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_864(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_865(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
