...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "Ped", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, -6f, 0f), vParam4.z, 1, 0, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		...
		if (!&uParam0->f_469[2])
		{
			if (func_68(uParam0, 0.1f, 60f, 4, 33f, 1112014848))
			{
				...
				if (does_entity_exist(&(uParam0->f_20[0])))
				{
					if (_does_scenario_point_exist(iLocal_37))
					{
						_task_use_scenario_point(&(uParam0->f_20[0]), iLocal_37, 0, 1000, true, false, 0, true, -1f, false);
						uParam0->f_469[2] = 1;
					}
				}
			}
		...
		if (&uParam0->f_469[2])
		{
			if (func_69(&(uParam0->f_20[0]), -76381094))
			{
				if (!&uParam0->f_469[4])
				{
					if (func_70(uParam0, 1065353216, 1116471296, 4, -91962372, 0))
					{
						func_67(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[4] = 1;
					}
			...
			else if (!is_ped_active_in_scenario(&(uParam0->f_20[0]), 1))
			{
