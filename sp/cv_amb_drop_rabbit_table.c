...
bool func_94(var uParam0)
{
	...
	{
		set_ped_to_ragdoll(func_49(uParam0, iLocal_14), 1000, 5000, 0, false, true, false);
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_283() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
