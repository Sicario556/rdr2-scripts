void __EntryFunction__()
{
	...
	Var0 = Local_52;
	Var0.f_1 = Local_52.f_11;
	Var0.f_483 = { Local_52.f_1 };
	Var0.f_486 = { Local_52.f_4 };
	Var0.f_489 = Local_52.f_7;
	Var0.f_20[0] = Local_52.f_8;
	Var0.f_453 = Local_52.f_9;
	Var0.f_500 = Local_52.f_10;
	Var0.f_503 = Local_52.f_12;
	func_1(&Var0);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			if (*uParam0 == 177)
			{
				if (!has_anim_event_fired(&(uParam0->f_20[0]), -912283728))
				{
		...
		if (!bLocal_51 == 1)
		{
			if ((func_60(uParam0, &uLocal_9, 0) || func_61(&(uParam0->f_20[0]), Global_35, 1) < 225f) || func_62(Global_35, uParam0->f_483, 1) < 100f)
			{
				bLocal_51 = true;
			}
		}
			...
			if (!&uParam0->f_469[4])
			{
				if (_does_anim_scene_exist(uParam0->f_3.f_1))
				{
					if (_0x005e6f28dd7ed58d(uParam0->f_3.f_1, uParam0->f_20[0]->f_1))
					{
						...
						attach_entity_to_entity(&(uParam0->f_20[1]), &(uParam0->f_20[0]), get_ped_bone_index(&(uParam0->f_20[0]), 38142), vLocal_40, vLocal_43, true, false, false, false, 2, true, true, false);
						task_play_anim(&(uParam0->f_20[1]), sLocal_37, sLocal_39, 8f, -8f, -1, 1, 0f, false, 0, false, 0, false);
						task_play_anim(&(uParam0->f_20[0]), sLocal_37, sLocal_38, 8f, -8f, -1, 65553, 0f, false, 0, false, "LegsOnlyBird_filter", false);
						uParam0->f_469[4] = 1;
						return 1;
					}
				}
...
void func_68(var uParam0)
{
	...
	{
		if (has_anim_event_fired(&(uParam0->f_20[1]), 279791244))
		{
		...
		else
		{
			...
			force_ped_motion_state(&(uParam0->f_20[1]), iVar0, true, 0, false);
