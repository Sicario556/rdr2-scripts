...
bool func_12(var uParam0)
{
	if (func_41(uParam0))
	{
		...
		{
			if (func_44(-1473290304))
			{
				func_45(-1473290304, 1, 0f, 0, 1, 0, 0, 0);
			}
			if (func_44(1510914117))
			{
				func_45(1510914117, 1, 0f, 0, 1, 0, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 <= (4 - 1))
			{
				if (!does_particle_fx_looped_exist(&(iLocal_83[iVar0])))
				{
					if (iVar0 == 0)
					{
						iLocal_83[iVar0] = start_particle_fx_looped_at_coord("scr_happyfam_pipe_smk", 1889.04f, 305.17f, 78.45f, 0f, 0f, 0f, 1f, false, false, false, false);
					}
					else if (iVar0 == 1)
					{
						iLocal_83[iVar0] = start_particle_fx_looped_at_coord("scr_happyfam_room_smk", 1888.37f, 301.95f, 78f, 0f, 0f, 0f, 1f, false, false, false, false);
					}
					else if (iVar0 == 2)
					{
						iLocal_83[iVar0] = start_particle_fx_looped_at_coord("scr_happyfam_door_smk", 1891.05f, 302.1f, 78.06f, 0f, 0f, 90f, 1f, false, false, false, false);
					}
					else if (iVar0 == 3)
					{
						iLocal_83[iVar0] = start_particle_fx_looped_at_coord("scr_happyfam_door_smk", 1887.7f, 298.1f, 78.1f, 0f, 0f, 0f, 1f, false, false, false, false);
					}
				}
				iVar0++;
			}
...
void func_20(var uParam0)
{
	...
	{
		if (!func_62(func_61(uParam0)))
		{
			if ((uParam0->f_1 == 2 || uParam0->f_1 == 4) || uParam0->f_1 == 8)
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_61(uParam0), func_63(uParam0), func_64(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_61(uParam0), func_63(uParam0), func_64(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_43(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_70(func_69(uParam0->f_5), 2) && !func_71(128, 0, 1)) && !func_72(get_player_index(), 1, 1, 1)) && !func_73()) && !func_74(20)) && !func_70(func_69(uParam0->f_5), 4)) && !func_70(func_69(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
{
	if (!func_76("hf_murder_after01", func_32(uParam0, 0), 1))
	{
		return false;
	}
	return true;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_77(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_77(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_77(uParam0, iVar0, 0), iParam1, func_77(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_77(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
	...
	if (!&uParam0->f_6[iParam5] == 0)
	{
		if (!does_entity_exist(&(uParam0->f_13[iParam5])))
		{
			...
			if (uParam0->f_1 == 8192)
			{
				...
				{
					uParam0->f_13[iParam5] = func_82(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, 0, 1, 0, 0, 0, 0);
				}
				else
				{
					uParam0->f_13[iParam5] = func_82(&(uParam0->f_6[iParam5]), vParam1, fParam4, 1, 1, 0, 1, iParam7, 1, 0, 0, 0, 0);
				}
			}
			else
			{
...
{
	if (!&uParam0->f_22[iParam7] == 0 && !func_62(vParam1))
	{
...
void func_45(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_90(iParam0, 0, 0);
	if (func_91(iParam0))
	{
		...
		if (bParam3)
		{
			func_92(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
{
	if (!is_string_null_or_empty(func_77(uParam0, iParam2, 0)))
	{
...
void func_52(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (6 - 1))
	{
		...
		{
			func_104(uParam0->f_13[iVar0], iParam1, iVar0);
		}
		iVar0++;
	}
}
...
void func_54(var uParam0)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (does_particle_fx_looped_exist(&(iLocal_83[iVar0])))
		{
			stop_particle_fx_looped(&(iLocal_83[iVar0]), false);
		}
		iVar0++;
	}
}
...
void func_56(var uParam0, bool bParam1)
{
	...
	while (iVar0 <= (6 - 1))
	{
		func_107(uParam0->f_29[iVar0], bParam1, iVar0);
		iVar0++;
	}
}
...
void func_57(var uParam0, bool bParam1)
{
	...
	while (iVar0 <= (6 - 1))
	{
		func_108(uParam0->f_13[iVar0], bParam1, iVar0);
		iVar0++;
	}
}
...
void func_59(var uParam0)
{
	if (_does_volume_exist(uParam0->f_46))
	{
		func_109(&(uParam0->f_45), uParam0->f_46, 0);
...
{
	if (!func_113(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_113(uParam0, iParam1), func_114(uParam0, iParam1), func_115(uParam0, iParam1), func_116(uParam0, iParam1), 0, 0);
	}
	return true;
}
...
bool func_71(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_121(iVar0) && func_122((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_76(char* sParam0, vector3 vParam1, bool bParam4)
{
...
char* func_77(var uParam0, int iParam1, int iParam2)
{
	switch (uParam0->f_1)
	{
		case 32768:
...
int func_82(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_126(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_89(var uParam0, int iParam1, int iParam2)
{
	if (does_entity_exist(&(uParam0->f_13[iParam1])))
	{
		...
		func_129(uParam0->f_13[iParam1], iParam2);
		func_130(uParam0->f_13[iParam1], 0);
...
void func_92(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_91(iParam0))
	{
	...
	if (!is_string_null_or_empty(func_77(uParam0, iParam2, 0)))
	{
		if (_does_anim_scene_exist(*uParam1))
		{
			if (_is_anim_scene_loaded(*uParam1, true, false))
			{
				...
				if (!is_string_null_or_empty(func_77(uParam0, iParam2, 1)))
				{
					if (_0xa9016536015de29d(*uParam1, func_77(uParam0, iParam2, 1)))
					{
						_set_anim_scene_playback_list_bool(*uParam1, func_77(uParam0, iParam2, 1), true);
					}
				}
			}
		}
...
Vector3 func_114(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		case 16:
...
float func_115(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		case 16:
...
{
	iVar6 = func_136();
	iVar4 = func_137(iVar6);
	iVar5 = func_138(iVar6);
	iVar3 = func_139(iVar5, iVar4);
	iVar2 = func_140(iVar6);
	iVar1 = func_141(iVar6);
...
void func_126(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
{
	return (shift_right(iParam0, 26) & 31 * func_155(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
void func_149(var uParam0, var uParam1, char* sParam2, int iParam3)
{
...
void func_151(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	if (_does_anim_scene_exist(*uParam0))
	{
		if (_is_anim_scene_loaded(*uParam0, true, false))
