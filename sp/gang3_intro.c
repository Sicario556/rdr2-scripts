void __EntryFunction__()
{
	...
	while (!func_5(&Local_26, 1))
	{
		...
		if (((((func_6(&Local_26) >= 5 && func_6(&Local_26) <= 7) && !func_5(&Local_26, 4096)) && _does_anim_scene_exist(Local_26.f_428.f_444)) && _is_anim_scene_started(Local_26.f_428.f_444, false)) && !_is_anim_scene_paused(Local_26.f_428.f_444))
		{
		...
		switch (func_6(&Local_26))
		{
			...
			case 3:
				...
				func_39(&Local_26);
				if (func_40(func_32((*Global_1835011)[Local_26]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_26.f_428)) == 4 && _does_anim_scene_exist(Local_26.f_428.f_444)) && _is_anim_scene_paused(Local_26.f_428.f_444))
				{
					func_37(Local_26);
					func_17(&Local_26, 7);
				}
...
bool func_29(int iParam0)
{
	...
	func_144(iParam0->f_428.f_13[iVar3], 8);
...
bool func_53(int iParam0)
{
	...
	{
		_0x7a49d40de437bc8d(iLocal_20, 0);
	}
	return true;
}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_189(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_189(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_189(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_189(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_189(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_189(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
{
	request_model(-258491284, false);
	request_model(377451415, false);
	request_model(-44675836, false);
	if ((!has_model_loaded(-258491284) || !has_model_loaded(377451415)) || !has_model_loaded(-44675836))
	{
		return false;
	}
	return true;
...
bool func_137(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(&(uLocal_16[iParam1])))
	{
		if (_0xa0bc8faed8cfeb3c(&(uLocal_16[iParam1])))
		{
			func_160(iVar0, 1);
			return true;
		}
	...
	if (iParam1 == 0)
	{
		...
		if (does_entity_exist(&(uLocal_16[iParam1])))
		{
			...
			remove_all_ped_weapons(&(uLocal_16[0]), true, true);
			_give_weapon_to_ped_2(&(uLocal_16[0]), 1240907314, 10, false, true, 3, false, 0.5f, 1f, 752097756, false, 0f, false);
			_give_weapon_to_ped_2(&(uLocal_16[0]), -2088446466, 10, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
			func_288(&(uLocal_16[0]), 2077870112, 0, 0, 9, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
...
bool func_138()
{
	...
	iLocal_20 = create_vehicle(-258491284, func_158(0, 2), func_290(0, 2), true, true, false, false);
	if (does_entity_exist(iLocal_20))
	{
		vVar0 = { func_158(0, 2) };
		if (get_water_height_no_waves(vVar0, &uVar3))
		{
			vVar0.f_2 = uVar3;
		}
		set_entity_coords_no_offset(iLocal_20, vVar0, false, true, true);
		set_vehicle_extra(iLocal_20, 1, true);
		set_vehicle_extra(iLocal_20, 2, false);
		set_vehicle_extra(iLocal_20, 5, true);
		_0x7a49d40de437bc8d(iLocal_20, 0);
		_0x978aa2323ed32209(iLocal_20, 0f);
...
bool func_142(var uParam0)
{
	...
	_get_rowing_oars(iLocal_20, (*uParam0)[0], (*uParam0)[1]);
	return (does_entity_exist(uParam0[0]) && does_entity_exist(uParam0[1]));
}
...
void func_145(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_295(), true);
	}
}
...
bool func_149()
{
	return func_297(get_id_of_this_thread());
}
...
bool func_154(int iParam0)
{
	...
	return func_302((*Global_1835011)[iParam0]->f_1);
}
...
int func_167(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_307(get_player_index(), 0, 0, 1);
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_314(uParam0, uParam0->f_1684))
				{
					...
					{
						func_316(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_310(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_316(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
...
int func_170(int iParam0)
{
	...
	if (vdist2(func_189(*iParam0), Global_36) < (fVar0 * fVar0))
	{
		func_25(iParam0, 8388608);
		return 1;
	}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_336(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_337(uParam0->f_1522[iVar0], 128))
				{
					func_338(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_178(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_345((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_347((*uParam1)[iVar0]))
		{
			if (func_345((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_348((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_349((*uParam2)[iVar0]))
		{
			if (func_345((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_350((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_351((*uParam3)[iVar0]))
		{
			if (func_345((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_352((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_354((*uParam5)[iVar0]))
		{
			if (func_345((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_355((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_354((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_356((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_345((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_357((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_358((*uParam6)[iVar0]))
		{
			if (func_345((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_359((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_360((*uParam7)[iVar0]))
		{
			if (func_345((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_361((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_362((*uParam8)[iVar0]))
		{
			if (func_345((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_363((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_364((*uParam9)[iVar0]))
		{
			if (func_345((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_365((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_366((*uParam10)[iVar0]))
		{
			if (func_345((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_367((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_368((*uParam11)[iVar0]))
		{
			if (func_345((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_369((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_192(int iParam0, int iParam1)
{
	...
	func_378(iParam1);
	StringCopy(&cVar0, func_188(), 64);
	func_379(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_198(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_380(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_207(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_384(uParam0->f_5, 0f, 0f, 0f))
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_188());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
...
bool func_220(bool bParam0, bool bParam1)
{
	if (!func_387(Global_43801))
	{
		Global_43801 = func_392("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_231(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_400(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_383() };
...
void func_232(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_248(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_401(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_235()
{
	return func_390(_0xc17f69e1418cd11f(3));
}
...
int func_272(var uParam0, int iParam1)
{
	...
	if (func_300(uParam0, 8) && _0xdd0b7c5ae58f721d(func_463()))
	{
...
int func_281(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_344((*uParam0)[iVar1]))
		{
			if (func_345((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_347((*uParam1)[iVar1]))
		{
			if (func_345((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_349((*uParam2)[iVar1]))
		{
			if (func_345((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		...
		{
			if (func_345((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_352((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_354((*uParam5)[iVar1]))
		{
			if (func_345((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_345((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_470((*uParam5)[iVar1]))
				{
					if (func_471((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_356((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_358((*uParam6)[iVar1]))
		{
			if (func_345((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_360((*uParam7)[iVar1]))
		{
			if (func_345((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_362((*uParam8)[iVar1]))
		{
			if (func_345((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_364((*uParam9)[iVar1]))
		{
			if (func_345((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_366((*uParam10)[iVar1]))
		{
			if (func_345((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_368((*uParam11)[iVar1]))
		{
			if (func_345((*uParam11)[iVar1]->f_2, iParam12))
			{
...
void func_308(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_505(1));
		if (!has_anim_dict_loaded(func_505(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_309(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		fVar4 = func_162(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_316(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_510(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_319(uParam0, 4);
...
void func_316(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_502(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
...
void func_317(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_323(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_517(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_517(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_519(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_519(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_513(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_519(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_521(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							...
							bVar29 = func_519(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_519(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_519(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_523(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_523(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
bool func_330(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_162(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_331(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_162(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_541(uParam0)) && _is_anim_scene_started(func_541(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_541(uParam0));
				bVar1 = _is_anim_scene_finished(func_541(uParam0), false);
				bVar2 = _is_anim_scene_active(func_541(uParam0));
...
int func_334(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_542(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
void func_355(var uParam0)
{
	if (!func_559(uParam0->f_2, 1))
	{
		if (func_470(uParam0))
		{
			...
			{
				sVar0 = func_389(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_563())
				{
...
void func_381(struct<4> Param0)
{
	...
	if (func_571(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_571(20))
			{
				return;
			}
			iVar0++;
...
void func_409()
{
	...
	if (func_423(iVar0))
	{
		...
		{
			func_288(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_420(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_589(Global_35) && is_player_teleport_active())
	{
	}
	if (func_590(iParam0))
	{
		if (func_591(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_441(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_610(iParam0, iParam2, iParam1, func_260() != -1);
	if (bParam4)
	{
...
void func_486(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_173() || !_0x6f1f0b17109309da(Global_43800, func_217(iParam0))))
	{
...
char* func_496(int iParam0)
{
	...
	{
		return func_645(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_646(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_506(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_523(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_507(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			{
				if (!does_entity_exist(iVar1) || func_162(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_162(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_162(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_655(512) || func_656(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_502(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_657(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_316(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
				...
				else if (func_660(uParam0->f_1633[iVar2]) != 0)
				{
					func_659(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_502(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_162(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_657(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_510(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_661(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_511(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_664(uParam0, iVar0)) && !func_461(uParam0->f_1016[iVar0], 1))
			{
				if (!func_665(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_163(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_666(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_525(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_661(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_542(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_542(uParam0->f_475[iParam1], 64) && func_669(uParam0, iParam1, 0))
				{
					func_670(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_671(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_542(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_671(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_528(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_315(uParam0) != 11) && func_314(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		{
			if (func_337(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_337(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_163(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_530(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_315(uParam0))
	{
		case 0:
			...
			if (((!func_301(uParam0->f_1016[iVar2], 32) && func_674()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_301(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 4:
			...
			if ((func_301(uParam0->f_1016[iVar2], 256) || !func_403(&uVar5)) || bVar0)
			{
				if (func_679())
				{
					func_680();
...
bool func_533(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_684(uParam0, 0))
		{
			if (func_685(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_686(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_686(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_686(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_686(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_686(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_686(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_686(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_686(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_686(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_686(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_686(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_686(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_686(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_686(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_686(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_685(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_686(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_686(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_686(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_685(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_688(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_687(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_686(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_666(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_383() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_689(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_684(uParam0, 45))
				{
					if (func_685(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_690(uParam0->f_1522[iVar16], 2);
							func_687(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_691(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_690(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_685(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_690(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_690(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_684(uParam0, 57))
				{
					if (func_685(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_685(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_685(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_694(iVar17);
							}
							if (func_685(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_695(iVar17);
							}
							func_685(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_686(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_686(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_686(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_685(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_686(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_685(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_685(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_686(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_684(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_691(uParam0, 87, uParam0->f_1345[iVar18]);
						func_687(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_687(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_686(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_686(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_685(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_696(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_684(uParam0, 98))
				{
					if (func_685(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_697(uParam0, 99, uParam0->f_1633[iVar16]);
							func_697(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_697(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_685(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_688(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_534(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_337(uParam0->f_1522[iVar0], 2)) && !func_337(uParam0->f_1522[iVar0], 16)) && func_699(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_690(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_690(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_535(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_337(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
	...
	{
		_0x6a4d224fc7643941(func_463());
		func_460(uParam0, 8);
	}
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if (!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_463()))
		{
...
bool func_536(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_337(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_700(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_690(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_537(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_590(uParam0->f_3[iVar0]->f_2)) && func_423(uParam0->f_3[iVar0]->f_10)) && !func_693(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_701(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_702(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_545(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_707(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_546(int iParam0, int iParam1, bool bParam2)
{
	...
	func_708(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_554(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_261(iParam0);
	if (((does_entity_exist(iVar1) && func_711(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_576(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_391(iParam0, 8))
		{
...
{
	return func_447(1328661203, func_304(), -1591664384, bParam0);
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_728(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_405(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_728(&(Global_1946804->f_1497.f_1[iVar1])) || func_603(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_405(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_405(&(uParam0->f_1[iVar1])) || func_603(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_611(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_732(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_612(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_734(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_260() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_465((*Global_1360165)[iParam0]->f_4.f_2) || func_302((*Global_1360165)[iParam0]->f_4.f_2)))
				{
...
void func_633(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_288(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_288(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_644(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_769(_get_weapon_clip_size(iParam0), iParam1);
...
{
	switch (func_660(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_502(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_403(&(uParam0->f_1903)))
				{
					func_678(uParam0->f_1903, 0);
					func_772(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_502(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_773())
				{
					func_772(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_663(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_289(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
bool func_665(var uParam0, char* sParam1)
{
	...
	while (iVar0 < 8)
	{
		if (uParam0->f_1016[iVar0]->f_29)
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && are_strings_equal(&(uParam0->f_1016[iVar0]->f_22), sParam1)) && func_461(uParam0->f_1016[iVar0], 1))
			{
				return true;
			}
		}
...
void func_667(int iParam0, float fParam1)
{
	...
	if (!(func_778(17) && func_162(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_670(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_336(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
...
void func_672(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_337(uParam0->f_1522[iVar0], 1))
			{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_563(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_690(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_338(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_542(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_310(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_460(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_217(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_301(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
...
bool func_673(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_542(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_675(var uParam0)
{
	if (!uParam0->f_1897)
	{
		...
		if (!func_301(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_423(func_422(Global_35, 0, 1, 0)) && !func_423(func_422(Global_35, 1, 1, 0))))
		{
			if (func_314(uParam0, uParam0->f_1684))
			{
				func_781(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_301(uParam0->f_1016[uParam0->f_1684], 16) && (func_423(func_422(Global_35, 0, 1, 0)) || func_423(func_422(Global_35, 1, 1, 0))))
	{
	...
	else if ((!func_314(uParam0, uParam0->f_1684) && !func_323(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_539(uParam0, 3);
	}
...
void func_676(var uParam0, int iParam1, bool bParam2)
{
	...
	func_780(uParam0, func_519(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_783(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_666(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
			_0xcb9401f918cb0f75(Global_35, func_462(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39), 1, -1);
		}
	}
	func_781(vVar1);
	...
	if (func_542(uParam0->f_475[iParam1], 16))
	{
		func_784(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_681(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_791(iVar0));
		iVar0++;
	}
}
...
bool func_692(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_693(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_389(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_770(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_389(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_389(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_770(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_770(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_699(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_337(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_542(uParam0->f_475[iVar0], 512)) || func_542(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_693(uParam0->f_3[iVar0]->f_1))
				{
					if (func_563())
					{
						StringCopy(&cVar1, func_389(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_389(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_704(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_771(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_706(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_792(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_716(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_262(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_795(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_797(iParam0);
					_0x7b204f88f6c3d287(func_798(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_798(iParam0, 0));
					func_799(iParam0);
				}
			}
			else
...
int func_721(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_802("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_801(iParam1, 512) && func_723(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_701(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_801(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_801(iParam1, 4))) && (!func_701(Var4.f_4) || func_801(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_801(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_801(iParam1, 1048576)))
				{
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_829((*Global_1347702)[63]->f_15, 1) || func_302((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_829((*Global_1347702)[134]->f_15, 1) || func_302((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
...
void func_754(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_750(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_750(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_750(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_750(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_750(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_750(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_750(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_750(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_750(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_750(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_750(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_750(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_750(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_750(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_750(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_750(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_750(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_750(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_750(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_750(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_750(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_750(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_750(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_750(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_750(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_750(iParam1, 1544915253))
	{
...
bool func_776(var uParam0, int iParam1)
{
	...
	if ((func_423(func_702(Global_35, 0, 0, 0)) && !func_301(uParam0->f_1016[iParam1], 16)) && !func_301(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_780(var uParam0, bool bParam1)
{
	...
	if ((func_310(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_301(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_460(uParam0, 64);
	}
...
{
	if (func_542(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_501(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_461(uParam0->f_1016[uParam0->f_1684], 2))
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_501(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_461(uParam0->f_1016[uParam0->f_1688], 2))
			{
	...
	else
	{
		*uParam2 = { func_841(uParam0) };
		...
		else if (!func_461(uParam0->f_1016[uParam0->f_1688], 2))
		{
			*fParam3 = func_421(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		}
		else
...
void func_785(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if (func_461(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
	{
...
void func_786(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		...
		if (func_542(uParam0->f_475[iParam1], 256))
		{
		...
		if (!func_461(uParam0->f_1016[&uParam0->f_475[iParam1]], 4) && !func_461(uParam0->f_1016[&uParam0->f_475[iParam1]], 2))
		{
			task_turn_ped_to_face_coord(0, vVar0, -1);
		}
		else
...
int func_864()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_701(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_701(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
