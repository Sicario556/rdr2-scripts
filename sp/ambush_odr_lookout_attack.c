		...
		if (func_61(&(Local_15[iVar0]), 0, 0))
		{
			if (iVar0 == 3)
			{
				...
				else
				{
					...
					{
						set_ped_config_flag(&(Local_15.f_40[iVar0]), 136, false);
						_0x06d26a96ca1bca75(&(Local_15.f_40[iVar0]), 3, 0f, 0);
						_0x06d26a96ca1bca75(&(Local_15.f_40[iVar0]), 1, 0f, 0);
						_0x2eb75fb86c41f026(&(Local_15.f_40[iVar0]), 3, 0);
						_0x2eb75fb86c41f026(&(Local_15.f_40[iVar0]), 1, 0);
					}
					switch (iVar0)
					{
						case 0:
	...
	switch (Local_274.f_4)
	{
		case 0:
			...
			else if (func_144())
			{
				...
				task_go_straight_to_coord(0, vVar0, 1f, 20000, 1193033728, 1056964608, 0);
...
bool func_31()
{
	...
	func_148();
	func_164();
	if (!is_ped_injured(&(Local_15[2])))
	{
		if (get_script_task_status(&(Local_15[2]), 242628503, true) == 1)
		{
			if (func_165(&(Local_15[2]), Global_35, 1, 1) < 18f)
			{
				if (get_script_task_status(&(Local_15[2]), 780511057, true) == 8)
				{
	...
	switch (Local_274.f_5)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_168(&Local_15, &(Local_274.f_32), Local_274.f_8[4], "COMBAT_FLEE", 8f))
			{
				func_169();
...
bool func_57(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			if (&Global_40.f_9632[iParam0] >= func_203(iParam0))
			{
				return true;
			}
...
bool func_66(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164->f_1[0]->f_2 == 8)
	{
		...
		if (func_211(iVar0) && func_212((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_213(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
bool func_67(int iParam0)
{
	...
	while (iVar0 < iParam0->f_215)
	{
		if (does_entity_exist(iParam0[iVar0]))
		{
			...
			{
				if (func_214(iParam0[iVar0], Global_36, 1) < (70f * 70f) || func_215(iParam0[iVar0], 70f, -1082130432, -1082130432, -1082130432))
				{
					return true;
				}
			}
...
bool func_135()
{
	...
	if (does_entity_exist(&(Local_15.f_40[Local_274.f_33])))
	{
		if (has_entity_been_damaged_by_entity(&(Local_15.f_40[Local_274.f_33]), Global_35, 1, 1))
		{
			return true;
		}
	}
...
void func_141(int iParam0, bool bParam1)
{
	...
	{
		iVar1 = _0x1e7384ab5d4f4581(uVar0);
		Global_40.f_9632[iParam0]->f_3 = (iVar1 + func_275(iParam0, 1));
	}
	func_158(0, 13);
}
...
void func_148()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(Local_15[iVar0]), 0, 1))
		{
			...
			{
				if (is_ped_shooting(&(Local_15[iVar0])) || (func_215(&(Local_15[iVar0]), 1116471296, 10f, -1082130432, -1082130432) && iVar0 != 0))
				{
					func_273(&(Local_15[iVar0]), Local_15.f_22[iVar0], 831283580, 0, 0, 0);
				}
			}
	...
	switch (Local_274.f_6)
	{
		...
		case 1:
			if (!func_286(&(Local_15[0]), 242628503))
			{
				...
				task_combat_ped_timed(0, Global_35, 10000, 0);
				task_mount_animal(0, &(Local_15.f_40[0]), 20000, -1, 1073741824, 1, 0, 0);
				task_go_to_entity_while_aiming_at_entity(0, Global_35, Global_35, 2.5f, 1, 10f, 10f, 1, 0, -687903391, 0);
				task_combat_ped(0, Global_35, 0, 0);
				func_146(&(Local_15[0]), &iVar0, 0, 0, 1, 1);
				set_combat_float(&(Local_15[0]), 32, 10f);
				func_285(&Local_274, 2);
			}
			break;
		case 2:
			if (func_47(Local_274.f_8[1], 1.25f))
			{
				if (!func_126(&Local_274))
				{
		...
		case 3:
			...
			if (func_47(Local_274.f_8[2], 0.25f))
			{
				func_287();
				func_184(Local_274.f_8[2]);
				func_285(&Local_274, 4);
			}
			break;
		case 4:
			if (func_47(Local_274.f_8[2], 0.5f))
			{
				func_288();
				func_184(Local_274.f_8[2]);
...
int func_164()
{
	...
	switch (Local_274.f_7)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_47(Local_274.f_8[3], 12f))
			{
				iVar0 = func_309(0, 4);
				if (func_307(iVar0))
				{
...
void func_169()
{
	if (func_61(Local_15.f_56, 0, 0))
	{
		set_entity_can_be_damaged_by_relationship_group(Local_15.f_56, true, func_313(Local_15.f_181));
	}
}
...
void func_248(int iParam0, float fParam1)
{
	...
	func_363(iParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432);
	vVar0 = { iParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { iParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_349(vVar0, vVar3, 0) };
	vVar9 = { func_350(vVar0, vVar3, 0) };
...
void func_284()
{
	...
	_trigger_sonar_blip_2(1891783641, &(Local_15[0]));
	func_184(Local_274.f_8[1]);
}
...
void func_287()
{
	...
	while (iVar3 <= 2)
	{
		...
		else if (func_61(&(Local_15[iVar3]), 0, 0))
		{
			...
			{
				set_ped_sphere_defensive_area(&(Local_15[iVar3]), vVar0, 6f, 0, 0, 0);
			...
			else
			{
				...
				{
					if (_0x33fa048675821da7(&(Local_15.f_40[iVar3]), 1))
					{
						_0x06d26a96ca1bca75(&(Local_15.f_40[iVar3]), 1, 0f, 0);
					}
					if (_0x33fa048675821da7(&(Local_15.f_40[iVar3]), 3))
					{
						_0x06d26a96ca1bca75(&(Local_15.f_40[iVar3]), 3, 0f, 0);
					}
				}
				set_ped_combat_range(&(Local_15[iVar3]), 0);
			}
			switch (iVar3)
			{
				case 0:
					...
					switch (iVar3)
					{
						...
						case 2:
							...
							task_go_to_coord_while_aiming_at_entity(0, vVar0, Global_35, 3f, 1, 5f, 1082130432, 1, 1, 1, -687903391, 20000, 0);
							break;
					}
					task_combat_ped(0, Global_35, 0, 0);
...
void func_288()
{
	...
	while (iVar3 <= 4)
	{
		if (func_61(&(Local_15[iVar3]), 0, 0))
		{
			...
			{
				func_159(&Local_15, iVar3, 64);
				task_mount_animal(0, &(Local_15.f_40[iVar3]), -1, -1, 3f, 1, 0, 0);
			}
			task_combat_ped(0, Global_35, 0, 0);
			func_146(&(Local_15[iVar3]), &iVar4, fVar5, 0, 1, 1);
			set_ped_sphere_defensive_area(&(Local_15[iVar3]), vVar0, 8f, 0, 0, 0);
			set_ped_combat_attributes(&(Local_15[iVar3]), 51, true);
		}
		iVar3++;
	}
...
bool func_299(int iParam0, int iParam1)
{
	if (does_entity_exist(iParam0) && is_entity_a_ped(iParam0))
	{
		...
		return func_398(iParam0, 2084597891, iParam1, iVar0);
	}
...
bool func_310(int iParam0, int iParam1)
{
	...
	fVar1 = get_distance_between_coords(func_278(iParam0[iParam1], 1065353216), func_278(Global_35, 1065353216), true);
	if (fVar0 < 10f)
	{
		return false;
	}
...
{
	if (is_entity_on_screen(iParam0) && func_413(Global_35, iParam0, 0, fParam1, 0))
	{
		return true;
	}
	return false;
...
void func_359()
{
	...
	{
		Local_15.f_239 = _create_volume_box_with_custom_name(35.50145f, 576.9532f, 139.06f, 0f, 0f, -17.34077f, 121.0195f, 54.21328f, 40f, "volAmbientKillArea");
		Local_274.f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 116.7431f, 708.0041f, 142.806f, 0f, 0f, 77.4386f, 240f, 30f, 100f);
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 54.49036f, 428.6175f, 142.806f, 0f, 0f, 77.4386f, 240f, 30f, 100f);
		Local_274.f_27[3] = _create_volume_aggregate_with_custom_name("volTrigger");
		_0xbce668aaf83608be(&(Local_274.f_27[3]), 70.25137f, 572.1392f, 139.0669f, 0f, 0f, -90f, 35f, 35f, 20f);
		_0x39816f6f94f385ad(&(Local_274.f_27[3]), 27.9469f, 584.1371f, 139.06f, 0f, 0f, -17.34077f, 65.532f, 55.77899f, 40f);
		Local_274.f_27[2] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(Local_274.f_27[2]), 56.0282f, 534.1464f, 141.1838f, 0f, 0f, -90f, 28f, 28f, 20f);
		_0xbce668aaf83608be(&(Local_274.f_27[2]), 40.61783f, 539.5875f, 141.1838f, 0f, 0f, -90f, 28f, 28f, 20f);
	}
	else if (func_134(&Local_274, 2))
	{
		Local_15.f_239 = _create_volume_box_with_custom_name(41.44586f, 575.0972f, 139.06f, 0f, 0f, -17.34077f, 102.4975f, 54.21328f, 40f, "volAmbientKillArea");
		Local_274.f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 66.32392f, 712.1138f, 142.806f, 0f, 0f, 77.43861f, 240f, 30f, 100f);
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 4.071136f, 432.7272f, 142.806f, 0f, 0f, 77.43861f, 240f, 30f, 100f);
		Local_274.f_27[3] = _create_volume_aggregate_with_custom_name("volTrigger");
		_0x39816f6f94f385ad(&(Local_274.f_27[3]), 30.98099f, 577.4937f, 139.0669f, 0f, 0f, -90f, 35f, 27.025f, 20f);
		_0x39816f6f94f385ad(&(Local_274.f_27[3]), 63.23982f, 568.0176f, 140.2841f, 0f, 0f, -9.999998f, 35f, 73f, 40f);
		Local_274.f_27[2] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(Local_274.f_27[2]), -33.86342f, 560.1264f, 129.0215f, 0f, 0f, -90f, 28f, 28f, 20f);
	}
}
...
void func_360()
{
	if (func_134(&Local_274, 1))
	{
		Local_15.f_239 = _create_volume_aggregate_with_custom_name("volAmbientKillArea");
		_0x39816f6f94f385ad(Local_15.f_239, 72.78621f, 402.6582f, 139.06f, 0f, 0f, 79.91003f, 25.46639f, 23.49125f, 40f);
		_0x39816f6f94f385ad(Local_15.f_239, 162.7676f, 458.5815f, 139.06f, 0f, 0f, 79.91003f, 16.3691f, 23.49125f, 40f);
		_0x39816f6f94f385ad(Local_15.f_239, 113.9245f, 431.0109f, 139.06f, 0f, 0f, 31.64108f, 105.4348f, 23.49125f, 40f);
		Local_274.f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 28.17996f, 568.3807f, 142.806f, 0f, 0f, 141.1481f, 240f, 252.7323f, 100f);
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 212.7044f, 454.1687f, 142.806f, 0f, 0f, 172.1582f, 240f, 190.2177f, 100f);
		Local_274.f_27[3] = _create_volume_aggregate_with_custom_name("volTrigger");
		_0xbce668aaf83608be(&(Local_274.f_27[3]), 115.9221f, 432.0923f, 130.5853f, 0f, 0f, -39.66824f, 35f, 35f, 20f);
		_0x39816f6f94f385ad(&(Local_274.f_27[3]), 90.45341f, 423.4971f, 130.5784f, 0f, 0f, 32.991f, 47.79399f, 31.67282f, 40f);
		Local_274.f_27[2] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(Local_274.f_27[2]), 146.2964f, 432.9907f, 134.0572f, 0f, 0f, -90f, 46f, 46f, 20f);
	}
	else if (func_134(&Local_274, 2))
	{
		Local_15.f_239 = _create_volume_aggregate_with_custom_name("volAmbientKillArea");
		...
		_0x39816f6f94f385ad(Local_15.f_239, 113.9245f, 431.0109f, 139.06f, 0f, 0f, 31.64108f, 105.4348f, 23.49125f, 40f);
		Local_274.f_27[1] = _create_volume_aggregate_with_custom_name("volKill");
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), -15.8843f, 469.0493f, 156.2623f, 0f, 0f, 34.12152f, 237.5718f, 157.5148f, 100f);
		_0x39816f6f94f385ad(&(Local_274.f_27[1]), 84.87366f, 308.1975f, 156.2623f, 0f, 0f, 26.88331f, 232.0337f, 157.5148f, 100f);
		Local_274.f_27[3] = _create_volume_cylinder_with_custom_name(114.9353f, 431.5237f, 139.0669f, 0f, 0f, -149.297f, 53.693f, 43.36223f, 20f, "volTrigger");
		Local_274.f_27[2] = _create_volume_aggregate_with_custom_name("volBypass");
		_0xbce668aaf83608be(&(Local_274.f_27[2]), 112.7248f, 415.2516f, 135.0042f, 0f, 0f, -90f, 38f, 38f, 20f);
	}
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_424(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_428(0))
				{
					...
					func_429(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_385(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_414((*Global_1835011)[4]->f_1, 1))
		{
			if (func_459(5))
			{
				func_460(5);
	...
	if ((bVar0 && func_414((*Global_1835011)[37]->f_1, 1)) && !func_414((*Global_1835011)[43]->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_414((*Global_1835011)[43]->f_1, 1)) && !func_414((*Global_1835011)[44]->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
int func_399(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_494(func_493(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_401(int iParam0, bool bParam1)
{
	...
	if (stat_id_get_int(&Var2, &uVar0))
	{
		...
		{
			Global_40.f_9632[iParam0]->f_3 = (Global_40.f_9632[iParam0]->f_3 + func_275(iParam0, 0));
		}
	}
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_519(1) || *iParam0 & 8192 != 0))
				{
...
void func_461(int iParam0)
{
	...
	func_559(&(Global_40.f_1095.f_1[iParam0]->f_15));
	func_560(&(Global_40.f_1095.f_1[iParam0]->f_298));
	func_561(&(Global_40.f_1095.f_1[iParam0]->f_356));
	func_562(&(Global_40.f_1095.f_1[iParam0]->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_563(iVar2, Global_40.f_1095.f_1[iParam0]->f_398[iVar2]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_564(iVar3, Global_40.f_1095.f_1[iParam0]->f_407[iVar3]);
		iVar3++;
	}
	func_565(&(Global_40.f_1095.f_1[iParam0]->f_420));
	func_566(&(Global_40.f_1095.f_1[iParam0]->f_422));
	func_567(&(Global_40.f_1095.f_1[iParam0]->f_425));
...
{
	return func_568(_get_map_zone_at_coords(vParam0, 10));
}
...
int func_489(int iParam0, float fParam1, int iParam2)
{
	...
	return func_591(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}
...
bool func_551(int iParam0)
{
	...
	return func_414((*Global_1347702)[58]->f_15, 1);
}
...
int func_575(var uParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = 0;
	if (func_302())
	{
		...
		{
			bVar0 = false;
			if (!func_414((*Global_1835011)[15]->f_1, 1) && !func_600(42))
			{
				bVar0 = true;
			}
			if (bVar0)
		...
		{
			if (!func_414((*Global_1835011)[60]->f_1, 1))
			{
				*uParam0 = func_644();
				*iParam1 = func_645();
				*uParam2 = func_646();
...
bool func_596(int iParam0)
{
	if (func_666(iParam0))
	{
		if (func_206(Global_1360165[iParam0], 0))
		{
			return true;
		}
	}
...
bool func_633(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	if (!_0xdccaa7c3bfd88862(func_514(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return false;
	}
	if (bParam9)
...
bool func_676(struct<4> Param0, int iParam4)
{
	...
	if (!_0x734311e2852760d0(func_514(0), &Param0, iParam4))
	{
		return false;
	}
	return true;
...
bool func_679(var uParam0, var uParam1)
{
	...
	if (!_0x025a1b1fb03fbf61(func_514(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_686(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!_0x22e590f108289a9d(func_514(bParam6), &uParam0, iParam4, &Var0))
	{
		return false;
	}
...
{
	return _0x033ee4b89f3ac545(func_514(bParam2), uParam0, iParam1);
}
...
struct<28> func_698(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_514(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_693(&Var28) };
...
struct<17> func_700(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!_0x025a1b1fb03fbf61(func_514(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_693(&Var17) };
