...
bool func_11()
{
	iLocal_0 = _create_volume_aggregate_with_custom_name("Beaver Hollow - m_volTown Agg");
	_0xbce668aaf83608be(iLocal_0, 2345.187f, 1352.787f, 107.6561f, 0.036552f, 0f, 0f, 40.20085f, 40.78676f, 12.88943f);
	_0xbce668aaf83608be(iLocal_0, 2357.265f, 1391.395f, 109.9775f, 2.692848f, 0f, 0f, 17.41357f, 20.79141f, 16.64382f);
	_0xbce668aaf83608be(iLocal_0, 2318.457f, 1444.692f, 87.40137f, 179.4571f, 0f, 0f, 51.88874f, 33.18848f, 11.92861f);
	_0xbce668aaf83608be(iLocal_0, 2347.961f, 1414.832f, 96.40656f, 0.534309f, -14.06188f, -34.73259f, 31.42639f, 14.92058f, 9.380316f);
	_0xbce668aaf83608be(iLocal_0, 2255.09f, 1458.163f, 93.38544f, 0f, 0f, 0f, 21.93718f, 27.58467f, 4.980723f);
	_0xbce668aaf83608be(iLocal_0, 2272.888f, 1487.881f, 103.2379f, 11.51613f, 0f, 0f, 19.99748f, 13.49523f, 3.545758f);
	return true;
}
...
bool func_15(int iParam0)
{
	...
	{
		iLocal_1 = _0x0556c784fa056628("beaver_hollow", "es_camp_memory_sounds");
		iLocal_2 = get_game_timer() + 30000;
		return true;
	}
	return false;
}
...
{
	if (((func_52(Global_35, iLocal_0, 1, 0) && iLocal_2 < get_game_timer()) && func_54(func_53())) && func_55(6, 18))
	{
		play_stream_frontend(iLocal_1);
...
{
	return func_88(get_clock_hours(), iParam0, iParam1);
}
...
{
	if (func_84(Global_1914319->f_3[iParam0]->f_21) && func_146(Global_1914319->f_3[iParam0]->f_21))
	{
