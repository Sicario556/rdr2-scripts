void __EntryFunction__()
{
	...
	while (!func_5(&Local_191, 1))
	{
		...
		if (((((func_6(&Local_191) >= 5 && func_6(&Local_191) <= 7) && !func_5(&Local_191, 4096)) && _does_anim_scene_exist(Local_191.f_428.f_444)) && _is_anim_scene_started(Local_191.f_428.f_444, false)) && !_is_anim_scene_paused(Local_191.f_428.f_444))
		{
		...
		switch (func_6(&Local_191))
		{
			...
			case 3:
				...
				func_39(&Local_191);
				if (func_40(func_32((*Global_1835011)[Local_191]->f_1), 512))
				{
				}
			...
			case 6:
				...
				if ((func_50(&(Local_191.f_428)) == 4 && _does_anim_scene_exist(Local_191.f_428.f_444)) && _is_anim_scene_paused(Local_191.f_428.f_444))
				{
					func_37(Local_191);
					func_17(&Local_191, 7);
				}
...
bool func_29(int iParam0)
{
	...
	if (!does_entity_exist(iLocal_43))
	{
		iLocal_43 = create_object(-1811911736, 1013.47f, -1764.25f, 47.61f, true, true, false, false, true);
		set_entity_rotation(iLocal_43, 85.85f, 5.67f, -36.89f, 2, true);
		freeze_entity_position(iLocal_43, true);
	}
	if (!_0x53784cea0159439b(&(Local_14.f_3[0])))
	{
		_0xd80faf919a2e56ea(&(Local_14.f_3[0]), iLocal_57);
	}
	_0x8268b098f6fca4e2(&(Local_14.f_3[0]), 0);
	if (!func_139(-1, 1))
	{
		return false;
	}
	set_anim_scene_entity(&(iLocal_177[0]), "S_M_M_BwmWorker_01", &(Local_14.f_7[0]), 0);
	func_131(iParam0, Global_35, 0, 0, 0, 1);
	...
	decor_set_int(&(Local_14.f_3[0]), func_145(), 0);
	set_vehicle_extra(&(Local_14.f_3[0]), 2, false);
	set_ped_can_be_targetted(&(Local_14.f_7[0]), false);
	set_ped_relationship_group_hash(&(Local_14.f_7[0]), -1538724068);
	decor_set_int(&(Local_14.f_7[1]), func_145(), 0);
	decor_set_int(&(Local_14.f_7[2]), func_145(), 1);
	decor_set_int(&(Local_14.f_7[0]), func_145(), 2);
	func_146();
	if (_0xa0bc8faed8cfeb3c(&(uLocal_181[0])))
	{
	...
	if (_0xa0bc8faed8cfeb3c(&(uLocal_181[1])))
	{
	...
	if (_0xa0bc8faed8cfeb3c(&(Local_14.f_7[1])))
	{
...
void func_39(int iParam0)
{
	...
	if (((func_166(Global_35, &(iLocal_54[0]), 1, 0) || func_166(Global_35, &(iLocal_54[1]), 1, 0)) || (is_ped_in_combat(Global_35, 0) && func_166(Global_35, &(iLocal_45[1]), 1, 0))) || (is_ped_in_combat(Global_35, 0) && func_166(Global_35, &(iLocal_45[2]), 1, 0)))
	{
		func_167((*Global_1835011)[20], 1024);
	}
	func_168();
	func_169();
	if (func_170(&(Local_14.f_7[0]), 0) && !is_ped_injured(&(Local_14.f_7[0])))
	{
		if (_0xa24c1d341c6e0d53(1, 0, 0))
		{
			if (!are_strings_equal(func_171(cLocal_169), "NormalStart"))
			{
				StringCopy(&cLocal_169, "NormalStart", 64);
				func_172(iParam0, cLocal_169);
			}
		}
		else if (!are_strings_equal(func_171(cLocal_169), "MultiStart"))
		{
	...
	if (!bLocal_163)
	{
		iVar0 = _get_ped_in_draft_seat(&(Local_14.f_3[0]), 0);
		if (!is_entity_dead(iVar0))
		{
	...
	if (!bLocal_164)
	{
		iVar1 = _get_ped_in_draft_seat(&(Local_14.f_3[0]), 1);
	...
	if (!bLocal_165)
	{
		if (!is_entity_dead(&(Local_14.f_7[0])))
		{
			func_150(iParam0, &(Local_14.f_7[0]));
			bLocal_165 = true;
		}
	}
	if (!is_entity_dead(Global_35) && func_91(Global_35, 1011.08f, -1761.99f, 46.6f, 50f, 1, 1))
	{
		if (!bLocal_187 && is_ped_on_mount(Global_35))
		{
	...
	if (!bLocal_180)
	{
		if (!_does_anim_scene_exist(&(iLocal_177[0])))
		{
			iLocal_177[0] = _create_anim_scene("script@story@brt2@leadin@int@enter", 0, "pblLoop", false, true);
			load_anim_scene(&(iLocal_177[0]));
		}
	...
	else
	{
		if (func_174(Global_35, 1011.08f, -1761.99f, 46.6f, 1) > 30f)
		{
			...
			{
				bLocal_180 = false;
				_delete_anim_scene(&(iLocal_177[0]));
			}
		}
		func_177();
	}
...
{
	if (does_entity_exist(&(uLocal_181[0])) && does_entity_belong_to_this_script(&(uLocal_181[0]), true))
	{
		task_look_at_entity(0, Global_35, -1, 0, 51, 0);
		open_sequence_task(&iVar0);
		task_follow_nav_mesh_to_coord(0, 1015.792f, -1763.483f, 46.5904f, 2f, 20000, 0.25f, 512, 40000f);
		task_cower(0, -1, Global_35, 0);
		close_sequence_task(iVar0);
		task_perform_sequence(&(uLocal_181[0]), iVar0);
		clear_sequence_task(&iVar0);
		func_185(iParam0, 8, &(uLocal_181[0]), 0, 0, 0, 0);
	}
	if (does_entity_exist(&(uLocal_181[1])) && does_entity_belong_to_this_script(&(uLocal_181[1]), true))
	{
		task_look_at_entity(0, Global_35, -1, 0, 51, 0);
		_0x89f5e7adecccb49c(&(uLocal_181[1]), "shocked");
		open_sequence_task(&iVar1);
		task_follow_nav_mesh_to_coord(0, 1015.438f, -1768.102f, 46.5809f, 1.5f, 20000, 0.25f, 512, 40000f);
		task_cower(0, -1, Global_35, 0);
		close_sequence_task(iVar1);
		task_perform_sequence(&(uLocal_181[1]), iVar1);
		clear_sequence_task(&iVar1);
		func_185(iParam0, 5, &(uLocal_181[1]), 0, 0, 0, 0);
	}
	if (does_entity_exist(&(Local_14.f_7[0])) && does_entity_belong_to_this_script(&(Local_14.f_7[0]), true))
	{
		task_follow_nav_mesh_to_coord(&(Local_14.f_7[0]), 1001.686f, -1767.964f, 50.9998f, 2f, 20000, 0.25f, 10240, 40000f);
		func_186(Local_14.f_7[0], 1, 0, 1);
	}
	if (does_entity_exist(&(Local_14.f_7[2])) && does_entity_belong_to_this_script(&(Local_14.f_7[2]), true))
	{
		open_sequence_task(&iVar2);
		task_follow_nav_mesh_to_coord(0, 1020.253f, -1768.787f, 46.5945f, 2f, 20000, 0.25f, 512, 40000f);
		task_cower(0, -1, Global_35, 0);
		close_sequence_task(iVar2);
		task_perform_sequence(&(Local_14.f_7[2]), iVar2);
		clear_sequence_task(&iVar2);
		func_186(Local_14.f_7[2], 1, 0, 1);
	}
	if (does_entity_exist(&(Local_14.f_7[1])) && does_entity_belong_to_this_script(&(Local_14.f_7[1]), true))
	{
		open_sequence_task(&iVar3);
		task_follow_nav_mesh_to_coord(0, 1018.017f, -1766.355f, 46.5947f, 2f, 20000, 0.25f, 2560, 40000f);
		task_cower(0, -1, Global_35, 0);
		close_sequence_task(iVar3);
		task_perform_sequence(&(Local_14.f_7[1]), iVar3);
	...
	if (!func_162(20))
	{
		set_vehicle_as_no_longer_needed(Local_14.f_3[0]);
		func_161(-54440625, 1, 0f, 0, 0, 0, 1, 0);
		func_161(1202250529, 1, 0f, 0, 0, 0, 1, 0);
	}
	set_model_as_no_longer_needed(-1758092337);
	set_model_as_no_longer_needed(iLocal_25);
	set_model_as_no_longer_needed(1382164045);
	set_model_as_no_longer_needed(-77509825);
	set_model_as_no_longer_needed(-1600328361);
	set_model_as_no_longer_needed(1695133799);
	func_187(1018.391f, -1767.119f, 46.59343f, 1f, 0);
	if (_does_anim_scene_exist(&(iLocal_177[0])))
	{
		_delete_anim_scene(&(iLocal_177[0]));
	}
	if (_does_anim_scene_exist(&(iLocal_177[1])))
	{
		_delete_anim_scene(&(iLocal_177[1]));
	}
	func_161(1595076728, 0, 0f, 0, 0, 0, 0, 0);
	func_161(1439227364, 0, 0f, 0, 0, 0, 0, 0);
	func_161(248030525, 1, 0f, 0, 0, 0, 0, 0);
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	{
		if ((fVar3 >= func_214(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_215();
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_228("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_231(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_231(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_229(uParam0->f_501, 128))
		{
			func_230();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_93(1, 0);
	func_216(uParam0);
	if (func_244() && _0x6f1f0b17109309da(uParam0->f_444, func_231(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_248(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_99(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 35)
	{
		if ((does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1) && func_262(uParam0->f_13[iVar0], iParam2))
		{
			return true;
		}
		iVar0++;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_270();
	set_entity_invincible(Global_35, func_229(*uParam0, 8));
...
Vector3 func_125(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_231(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
{
	if (!does_entity_exist(&(uLocal_181[0])))
	{
		...
		set_blocking_of_non_temporary_events(&(uLocal_181[0]), true);
	}
	func_307(&(uLocal_181[0]), func_306(0, 0), 2, 1073741824);
	if (!does_entity_exist(&(uLocal_181[1])))
	{
		if (!func_303(iParam0, 5, uLocal_181[1], 0, 1, 0, 0, 0, 0, 0, 1, 0, 0))
		{
			return false;
		}
		set_blocking_of_non_temporary_events(&(uLocal_181[1]), true);
	}
...
int func_138(int iParam0, bool bParam1)
{
	...
	{
		Local_14.f_3[0] = create_vehicle(-1758092337, 1002.859f, -1734.764f, 46.3179f, 3.9916f, true, true, false, false);
...
bool func_139(int iParam0, bool bParam1)
{
	...
	if (!does_entity_exist(&(Local_14.f_7[0])) && (iParam0 == -1 || iParam0 == 0))
	{
		Local_14.f_7[0] = func_314(-538512200, 1011.081f, -1764.039f, 47.4902f, 2.7437f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		set_ped_name_debug(&(Local_14.f_7[0]), "Servant");
	...
	if (!does_entity_exist(&(Local_14.f_7[1])) && (iParam0 == -1 || iParam0 == 1))
	{
		Local_14.f_7[1] = func_314(-77509825, 1019.993f, -1765.721f, 47.5808f, 140.1415f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		set_ped_name_debug(&(Local_14.f_7[1]), "Bart");
	...
	if (!does_entity_exist(&(Local_14.f_7[2])) && (iParam0 == -1 || iParam0 == 2))
	{
		Local_14.f_7[2] = func_314(1382164045, 1019.614f, -1766.855f, 47.5808f, 54.1418f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		set_ped_name_debug(&(Local_14.f_7[2]), "Catherine");
...
void func_142(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_321(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_322(uParam0->f_13[iVar0], 2);
		}
	}
}
...
bool func_144()
{
	...
	if (!has_model_loaded(1382164045))
	{
		return false;
	}
	if (!has_model_loaded(-77509825))
	{
		return false;
	}
	if (!_is_anim_scene_loaded(&(iLocal_177[0]), true, false))
	{
		return false;
	}
	if (!_is_anim_scene_loaded(&(iLocal_177[1]), true, false))
	{
		return false;
	}
	if (!_text_database_has_loaded("BRT2AUD"))
	{
		return false;
	}
	...
	if (!has_model_loaded(-1734239985))
	{
		return false;
	}
	...
	if (!has_model_loaded(-1696613521))
	{
		return false;
	}
	if (!has_model_loaded(-1811911736))
	{
		return false;
	}
	if (!_has_propset_loaded(iLocal_57))
	{
		return false;
	}
	return true;
...
void func_149(int iParam0)
{
	...
	{
		iLocal_26 = create_object(1695133799, 1017.18f, -1768f, 47.2f, true, true, false, false, true);
	}
	if (!does_entity_exist(iLocal_27))
	{
		iLocal_27 = create_object(-1600328361, 1017.18f, -1768f, 47.2f, true, true, false, false, true);
	}
	if ((!does_entity_exist(&(iLocal_28[0])) && !does_entity_exist(&(iLocal_28[1]))) && !does_entity_exist(&(iLocal_28[2])))
	{
		iLocal_28[0] = create_object(108854062, 1017.18f, -1766.2f, 47.2f, true, true, false, false, true);
		iLocal_28[1] = create_object(108854062, 1017.18f, -1765.91f, 47.2f, true, true, false, false, true);
		iLocal_28[2] = create_object(108854062, 1017.48f, -1765.742f, 47.2f, true, true, false, false, true);
	}
	if ((!does_entity_exist(&(iLocal_35[0])) && !does_entity_exist(&(iLocal_35[1]))) && !does_entity_exist(&(iLocal_35[2])))
	{
		iLocal_35[0] = create_object(2114379160, 1017.521f, -1765.502f, 47.2f, true, true, false, false, true);
		iLocal_35[1] = create_object(2114379160, 1017.537f, -1765.795f, 47.2f, true, true, false, false, true);
		iLocal_35[2] = create_object(2114379160, 1017.533f, -1766.003f, 47.2f, true, true, false, false, true);
	}
	if ((!does_entity_exist(&(iLocal_39[0])) && !does_entity_exist(&(iLocal_39[1]))) && !does_entity_exist(&(iLocal_39[2])))
	{
		iLocal_39[0] = create_object(-1368683894, 1016.71f, -1767.603f, 47.2f, true, true, false, false, true);
		iLocal_39[1] = create_object(-1368683894, 1016.694f, -1767.879f, 47.2f, true, true, false, false, true);
		iLocal_39[2] = create_object(-1368683894, 1016.687f, -1768.123f, 47.2f, true, true, false, false, true);
	}
	set_anim_scene_entity(&(iLocal_177[1]), "P_CRIBBAGE01X", iLocal_26, 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_CARDS02X", iLocal_27, 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_CRD_2_C01X", &(iLocal_28[0]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_CRD_2_C01X^1", &(iLocal_28[1]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_CRD_2_C01X^2", &(iLocal_28[2]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_TEACUP01X", &(iLocal_35[0]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_TEACUP01X^1", &(iLocal_35[1]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_TEACUP01X^3", &(iLocal_35[2]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_SAUCER01X", &(iLocal_39[0]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_SAUCER01X^1", &(iLocal_39[1]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), "P_SAUCER01X^3", &(iLocal_39[2]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), func_231(&(uLocal_181[0])), &(uLocal_181[0]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), func_231(&(uLocal_181[1])), &(uLocal_181[1]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), func_231(&(Local_14.f_7[2])), &(Local_14.f_7[2]), 0);
	set_anim_scene_entity(&(iLocal_177[1]), func_231(&(Local_14.f_7[1])), &(Local_14.f_7[1]), 0);
	set_anim_scene_bool(&(iLocal_177[1]), "bLoopCribbage", false, false);
	if (!_is_anim_scene_started(&(iLocal_177[1]), false))
	{
		start_anim_scene(&(iLocal_177[1]));
	}
}
...
bool func_154()
{
	return func_325(get_id_of_this_thread());
}
...
void func_156(var uParam0, var uParam1)
{
	...
	if (uParam1->f_1903 != 0)
	{
		...
		if (uParam1->f_1684 >= 0 && func_330(uParam1->f_1016[uParam1->f_1684], 256))
		{
...
void func_159(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		decor_set_bool(iParam1, func_331(), true);
	}
}

void func_160()
{
	if (does_entity_exist(iLocal_26) && does_entity_belong_to_this_script(iLocal_26, true))
	{
		delete_object(&iLocal_26);
	}
	if (does_entity_exist(iLocal_27) && does_entity_belong_to_this_script(iLocal_27, true))
	{
	...
	while (iVar0 < 2)
	{
		if (does_entity_exist(&(iLocal_28[iVar0])) && does_entity_belong_to_this_script(&(iLocal_28[iVar0]), true))
		{
			delete_object(iLocal_28[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (does_entity_exist(&(uLocal_32[iVar0])) && does_entity_belong_to_this_script(&(uLocal_32[iVar0]), true))
		{
			delete_object(uLocal_32[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (does_entity_exist(&(iLocal_35[iVar0])) && does_entity_belong_to_this_script(&(iLocal_35[iVar0]), true))
		{
			delete_object(iLocal_35[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (does_entity_exist(&(iLocal_39[iVar0])) && does_entity_belong_to_this_script(&(iLocal_39[iVar0]), true))
		{
			delete_object(iLocal_39[iVar0]);
		}
		iVar0++;
	}
}
...
void func_161(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_333(iParam0))
	{
		...
		if (bParam3)
		{
			func_334(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_162(int iParam0)
{
	...
	return func_339((*Global_1835011)[iParam0]->f_1);
}
...
int func_164(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_236(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
void func_168()
{
	...
	{
		case 0:
			task_look_at_entity(&(iLocal_184[0]), Global_35, -1, 0, 51, 1);
			task_look_at_entity(&(iLocal_184[1]), Global_35, -1, 0, 51, 1);
			set_ambient_voice_name(&(iLocal_184[1]), "0812_G_M_M_UniBraithwaites_01_WHITE_01");
			request_anim_dict("script_story@brt1@ig@ig14_manor_guards");
			iLocal_168++;
			break;
		case 1:
			func_341(Global_35, 1011.48f, -1658.89f, 45.94f, 0, 1112014848, 15f, 10f, 2f, 1, 1, 1, 0);
			if (func_166(Global_35, &(iLocal_49[1]), 1, 0) && !is_ped_in_combat(Global_35, 0))
			{
				if (func_342(&(iLocal_184[1]), "GREET_SHOUTED", -69597692, Global_35, 1, "0812_G_M_M_UniBraithwaites_01_WHITE_01", 1, 1))
				{
					if (func_166(Global_35, &(iLocal_49[2]), 1, 0))
					{
						task_play_anim(&(iLocal_184[1]), "script_story@brt1@ig@ig14_manor_guards", "guard_stop_wagon_main_guard", 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
					}
					iLocal_168++;
				}
			}
		...
		case 2:
			func_341(Global_35, 1011.48f, -1658.89f, 45.94f, 0, 1112014848, 15f, 10f, 2f, 1, 1, 1, 0);
			if (func_166(Global_35, &(iLocal_49[0]), 1, 0) && !is_ped_in_combat(Global_35, 0))
			{
				func_343(0, 2f, 3, 1056964608);
		...
		case 3:
			...
			else if (((!is_ambient_speech_playing(&(iLocal_184[1])) && !is_ped_in_combat(Global_35, 0)) && func_21(&uLocal_61) > 2f) && func_348(&uLocal_64, func_347("BRT2_INTRO_GATE"), 0, -1, 0, 0))
			{
				task_look_at_entity(Global_35, &(iLocal_184[1]), -1, 0, 51, 0);
				func_26(&uLocal_61);
				iLocal_168++;
			}
			break;
		case 4:
			...
			else if (((!is_ambient_speech_playing(Global_35) && !func_349(1)) && func_21(&uLocal_61) > 3f) && func_342(&(iLocal_184[1]), "TIME_TO_GO", -69597692, Global_35, 1, "0812_G_M_M_UniBraithwaites_01_WHITE_01", 2, 0))
			{
				func_350();
				func_267(&uLocal_61);
				set_blocking_of_non_temporary_events(&(iLocal_184[0]), false);
				set_blocking_of_non_temporary_events(&(iLocal_184[1]), false);
				iLocal_168++;
			}
			break;
		case 5:
...
void func_169()
{
	if (func_166(Global_35, iLocal_53, 1, 0) && is_ped_in_any_vehicle(Global_35, false))
	{
		func_343(1, 2f, 3, 1056964608);
	}
	else if ((is_entity_in_volume(get_players_last_vehicle(), iLocal_53, true, 0) && !is_ped_in_vehicle(Global_35, get_players_last_vehicle(), false)) && get_active_vehicle_mission_type(get_players_last_vehicle()) != 4)
	{
		if (get_entity_heading(get_players_last_vehicle()) < 35f || get_entity_heading(get_players_last_vehicle()) >= 330f)
		{
			_task_vehicle_drive_to_coord_2(get_players_last_vehicle(), 1010.9f, -1740.62f, 45.58f, 2f, 0, 0, 8.5f, 8.5f);
		}
		else if (get_entity_heading(get_players_last_vehicle()) < 330f && get_entity_heading(get_players_last_vehicle()) >= 220f)
		{
			_task_vehicle_drive_to_coord_2(get_players_last_vehicle(), 1027.09f, -1751.24f, 45.49f, 2f, 0, 0, 8.5f, 8.5f);
		}
		else if (get_entity_heading(get_players_last_vehicle()) < 210f && get_entity_heading(get_players_last_vehicle()) >= 150f)
		{
			_task_vehicle_drive_to_coord_2(get_players_last_vehicle(), 1010.9f, -1740.62f, 45.58f, 2f, 2, 0, 8.5f, 8.5f);
		}
		else if (get_entity_heading(get_players_last_vehicle()) < 150f && get_entity_heading(get_players_last_vehicle()) >= 35f)
		{
			_task_vehicle_drive_to_coord_2(get_players_last_vehicle(), 993.71f, -1748.09f, 45.66f, 2f, 0, 0, 8.5f, 8.5f);
		}
	}
	else if ((get_active_vehicle_mission_type(get_players_last_vehicle()) == 4 && !is_entity_in_volume(get_players_last_vehicle(), iLocal_53, true, 0)) && !is_ped_in_vehicle(Global_35, get_players_last_vehicle(), false))
	{
		bring_vehicle_to_halt(get_players_last_vehicle(), 1f, 1, false);
	}
}
...
bool func_173(int iParam0, vector3 vParam1, var uParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, int iParam11, float fParam12, float fParam13, bool bParam14)
{
	...
	if (func_18(uParam4))
	{
		...
		if (func_48(uParam4) >= fParam9)
		{
			...
			if (!is_entity_dead(iVar1) && !func_353(iParam0, 501393341))
			{
			...
			if (!is_entity_dead(iVar2) && !func_353(iParam0, -828834893))
			{
				if (is_ped_in_any_vehicle(iParam0, false))
				{
...
void func_177()
{
	if (iLocal_167 <= 6)
	{
		...
		if (iLocal_162 == 0)
		{
			_0xdf7b5144e25cd3fe(&(iLocal_177[0]), &cVar0);
			if (func_354(&(iLocal_177[0]), 100) && _0x23e33cb9f4a3f547(&(iLocal_177[0]), &cVar0))
			{
				_set_anim_scene_playback_list_bool(&(iLocal_177[0]), &cVar0, true);
				iLocal_162 = 1;
			}
		}
		else
		{
			_0xdf7b5144e25cd3fe(&(iLocal_177[0]), "pblWaitLoop");
			if (func_354(&(iLocal_177[0]), 100) && _0x23e33cb9f4a3f547(&(iLocal_177[0]), "pblWaitLoop"))
			{
				_set_anim_scene_playback_list_bool(&(iLocal_177[0]), "pblWaitLoop", true);
				iLocal_162 = 0;
				iLocal_167++;
				func_26(&uLocal_58);
			}
...
int func_179(var uParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	if (func_8(uParam0) >= 3)
	{
		uParam0->f_1896 = func_355(get_player_index(), 0, 0, 1);
	...
	if (func_8(uParam0) < 10)
	{
		...
		else if (func_8(uParam0) > 3)
		{
			...
			if (!func_330(uParam0->f_1016[uParam0->f_1684], 16))
			{
			...
			if (uParam0->f_1684 >= 0)
			{
				if (!func_330(uParam0->f_1016[uParam0->f_1688], 32768))
				{
					_uiprompt_enable_prompt_type_this_frame(6);
				}
				if (func_362(uParam0, uParam0->f_1684))
				{
					...
					{
						func_364(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
					}
				}
	...
	if (bVar0)
	{
		...
		if (func_329(uParam0, 64) || (uParam0->f_1684 >= 0 && !func_330(uParam0->f_1016[uParam0->f_1684], 524288)))
		{
			if (_0xa2b1c7ef759a63ce() > 0f || func_358(uParam0) == 0)
			{
	...
	switch (func_8(uParam0))
	{
		...
		case 3:
			...
			{
				func_110(2);
				func_364(uParam0, uParam0->f_1016[uParam0->f_1684]->f_27, uParam0->f_1345[uParam0->f_1684]->f_1, 1065353216);
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_384(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_385(uParam0->f_1522[iVar0], 128))
				{
					func_386(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_185(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			bParam6 = func_389((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_389((*Global_1835011)[*iParam0], 65536);
		}
	}
...
{
	func_391(ceil((to_float(300) - (to_float(300) * fParam0))));
}
...
void func_206(int iParam0, int iParam1)
{
	...
	func_426(iParam1);
	StringCopy(&cVar0, func_202(), 64);
	func_427(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_212(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_428(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_221(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!_does_volume_exist(uParam0->f_4) && !func_432(uParam0->f_5, 0f, 0f, 0f))
	{
...
bool func_234(bool bParam0, bool bParam1)
{
	if (!func_435(Global_43801))
	{
		Global_43801 = func_440("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
...
void func_245(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_448(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_431() };
...
void func_246(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_262(uParam0->f_13[iVar0], 2))
		{
			if (func_262(uParam0->f_13[iVar0], 1) || _0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
			{
				func_449(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
				if (bParam1 && is_entity_a_ped(&(uParam0->f_13[iVar0])))
				{
					iVar1 = get_ped_index_from_entity_index(&(uParam0->f_13[iVar0]));
					if (iVar1 != Global_35 && !func_262(uParam0->f_13[iVar0], 16))
					{
						func_450(iVar1);
					}
				}
...
bool func_249()
{
	return func_438(_0xc17f69e1418cd11f(3));
}
	...
	while (iVar0 < 35)
	{
		if ((!is_entity_dead(&(uParam0->f_13[iVar0])) && is_entity_a_ped(&(uParam0->f_13[iVar0]))) && get_ped_index_from_entity_index(&(uParam0->f_13[iVar0])) != Global_35)
		{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_262(uParam0->f_13[iVar0], 8))
					{
						if (func_471(func_470(iVar1, 0, 1, 0)))
						{
							if (!func_472(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_472(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_476(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_474(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_266(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_322(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_271(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_475(32768) && iParam1 != &Global_1946804->f_57[func_487(iParam3, 1)])
			{
				func_491();
...
bool func_273(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_500(iParam2, 1024))) || func_500(iParam2, 8)) && !func_351(*iParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_501(iParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_500(iParam2, 4096)) && !func_351(*iParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_501(iParam1, 2048);
			func_501(iParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_500(iParam2, 32)) && !func_351(*iParam1, 5632))
		{
...
int func_285(var uParam0, int iParam1)
{
	...
	if (func_329(uParam0, 8) && _0xdd0b7c5ae58f721d(func_509()))
	{
...
bool func_288(int iParam0)
{
	...
	return func_511((*Global_1835011)[iParam0]->f_1);
}
...
{
	if (!_does_volume_exist(&(iLocal_45[0])))
	{
		iLocal_45[0] = _create_volume_box_with_custom_name(1014.835f, -1767.281f, 47.47104f, 0f, 0f, 0f, 15.31912f, 9.318451f, 2.826856f, "volManor[0]");
	}
	if (!_does_volume_exist(&(iLocal_45[1])))
	{
		iLocal_45[1] = _create_volume_box_with_custom_name(1011.21f, -1723.56f, 47.6f, 0f, 0f, 0f, 65f, 130f, 25f, "volManor[1]");
	}
	if (!_does_volume_exist(&(iLocal_45[2])))
	{
		iLocal_45[2] = _create_volume_box_with_custom_name(1011.268f, -1612.818f, 46.92247f, 0f, 0f, 0f, 90f, 110f, 9f, "volManor[2]");
	}
	if (!_does_volume_exist(iLocal_53))
	{
		iLocal_53 = _create_volume_cylinder_with_custom_name(1010.991f, -1755.437f, 46.011f, 0f, 0f, 0f, 5.839943f, 7.515967f, 2.889563f, "mVolHorseClearArea");
		_0xb56d41a694e42e86(iLocal_53, 2048, 0, 0, -1, -1, 0);
	}
	if (!_does_volume_exist(&(iLocal_54[0])))
	{
		iLocal_54[0] = _create_volume_box_with_custom_name(1011f, -1777.57f, 52.54898f, 0f, 0f, 0f, 21f, 3f, 3f, "Window check Level 1");
	}
	if (!_does_volume_exist(&(iLocal_54[1])))
	{
		iLocal_54[1] = _create_volume_box_with_custom_name(1011f, -1777.57f, 48.08995f, 0f, 0f, 0f, 21f, 3f, 3f, "Window check Level 2");
	}
	if (!_does_volume_exist(&(iLocal_49[0])))
	{
		iLocal_49[0] = _create_volume_cylinder_with_custom_name(1011.268f, -1662.212f, 46.92247f, 0f, 0f, 0f, 9f, 9f, 3f, "Gate guards (near)");
	}
	if (!_does_volume_exist(&(iLocal_49[1])))
	{
		iLocal_49[1] = _create_volume_box_with_custom_name(1012.361f, -1654.151f, 46.58562f, 0f, 0f, 0f, 21f, 25f, 7f, "Gate guards (far)");
	}
	if (!_does_volume_exist(&(iLocal_49[2])))
	{
		iLocal_49[2] = _create_volume_box_with_custom_name(1011.964f, -1641.009f, 46.5303f, 0f, 0f, 0f, 12f, 38f, 8f, "Gate guards (Play anim)");
	}
}
...
void func_291()
{
	...
	if (!_does_anim_scene_exist(&(iLocal_177[1])))
	{
		iLocal_177[1] = _create_anim_scene("script@story@BRT2@leadin@int@livingRoom", 0, 0, false, true);
		load_anim_scene(&(iLocal_177[1]));
	}
	request_model(-1758092337, false);
	request_model(iLocal_25, false);
	request_model(1382164045, false);
	request_model(-77509825, false);
	request_model(-1600328361, false);
	request_model(-1734239985, false);
	request_model(108854062, false);
	request_model(1695133799, false);
	request_model(-1368683894, false);
	request_model(2114379160, false);
	request_model(-1696613521, false);
	request_model(-1811911736, false);
	_request_propset(iLocal_57);
	_text_database_request("BRT2AUD");
}

bool func_292(var uParam0)
{
	if (!does_entity_exist(&(iLocal_184[0])))
	{
		if (!func_512(617, 1))
		{
			return false;
		...
		set_blocking_of_non_temporary_events(&(iLocal_184[0]), true);
		func_468(&(iLocal_184[0]), 1011.14f, -1665.689f, 45.8387f, 22.9771f, 2, 1073741824);
	}
	if (!does_entity_exist(&(iLocal_184[1])))
	{
		if (!func_512(618, 1))
		{
			return false;
		...
		set_blocking_of_non_temporary_events(&(iLocal_184[1]), true);
		func_468(&(iLocal_184[1]), 1008.248f, -1662.47f, 45.8976f, 336.1776f, 2, 1073741824);
	}
				...
				if (func_519((*uParam5)[iVar1]))
				{
					if (func_520((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							...
							{
								if (!func_521((*uParam5)[iVar1]->f_4[iVar2], (*uParam5)[iVar1]->f_1))
								{
									iVar0 = 0;
								}
							}
...
char* func_316(int iParam0)
{
	...
	{
		return func_231(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_545(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_546(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_334(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_333(iParam0))
	{
...
void func_341(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if ((bVar3 <= bParam5 && bVar3 > bParam6) && bVar3 > bParam7)
	{
		...
		if ((func_551() && !is_entity_dead(iVar1)) && _is_draft_vehicle(iVar1))
		{
			iVar4 = 0;
			while (iVar4 < 6)
			{
	...
	if (bParam4)
	{
		if (bVar3 <= bParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_353(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_353(iParam0, -828834893))
			{
...
{
	open_sequence_task(&iVar0);
	task_go_to_entity(0, get_vehicle_ped_is_in(Global_35, false), 20000, 4f, 1.5f, 2f, 0);
	task_turn_ped_to_face_entity(0, Global_35, 0, -1082130432, -1082130432, -1082130432);
	close_sequence_task(iVar0);
	task_perform_sequence(&(iLocal_184[1]), iVar0);
	clear_sequence_task(&iVar0);
}
...
{
	open_sequence_task(&iVar0);
	task_go_to_entity(0, Global_35, 20000, 5f, 1.5f, 2f, 0);
	task_turn_ped_to_face_entity(0, Global_35, 0, -1082130432, -1082130432, -1082130432);
	close_sequence_task(iVar0);
	task_perform_sequence(&(iLocal_184[1]), iVar0);
	clear_sequence_task(&iVar0);
...
void func_346()
{
	...
	task_follow_nav_mesh_to_coord(0, 1006.68f, -1659.11f, 46f, 1f, 20000, 0.25f, 0, 40000f);
	task_stand_still(0, 4000);
	task_follow_nav_mesh_to_coord(0, 1008.248f, -1662.47f, 45.8976f, 1f, 20000, 0.25f, 0, 40000f);
	task_stand_still(0, 4000);
	close_sequence_task(iVar0);
	task_perform_sequence(&(iLocal_184[1]), iVar0);
	clear_sequence_task(&iVar0);
...
{
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, 1014.453f, -1665.889f, 45.8356f, 1.5f, 20000, 0.25f, 0, 40000f);
	task_turn_ped_to_face_entity(0, Global_35, 0, -1082130432, -1082130432, -1082130432);
	close_sequence_task(iVar0);
	task_perform_sequence(&(iLocal_184[0]), iVar0);
	clear_sequence_task(&iVar0);
	open_sequence_task(&iVar0);
	task_follow_nav_mesh_to_coord(0, 1005.039f, -1659.484f, 45.9784f, 1.5f, 20000, 0.25f, 0, 40000f);
	task_turn_ped_to_face_entity(0, Global_35, 0, -1082130432, -1082130432, -1082130432);
	close_sequence_task(iVar0);
	task_perform_sequence(&(iLocal_184[1]), iVar0);
	clear_sequence_task(&iVar0);
...
{
	return (func_556(iParam0) || (_get_anim_scene_duration(iParam0) - _get_anim_scene_time(iParam0)) <= (to_float(iParam1) * 0.001f));
}
...
void func_356(var uParam0)
{
	if (!func_63(uParam0, 134217728))
	{
		...
		request_anim_dict(func_558(1));
		if (!has_anim_dict_loaded(func_558(1)))
		{
			bVar0 = false;
		}
		if (bVar0)
...
void func_357(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!func_63(uParam0, 4))
	{
		...
		if (func_330(uParam0->f_1016[uParam0->f_1688], 2) && uParam0->f_1897)
		{
			return;
		}
	}
	...
	{
		fVar4 = func_174(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		if (uParam0->f_1897 && fVar4 <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f))
		{
			disable_control_action(0, -640622144, false);
		}
		fVar5 = func_469(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
		fVar6 = 2f;
		...
		if (fVar4 <= uParam0->f_1016[uParam0->f_1688]->f_17 || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
		{
			...
			{
				func_364(uParam0, uParam0->f_1016[uParam0->f_1688]->f_27, uParam0->f_1345[uParam0->f_1688]->f_1, fVar6);
			}
	...
	{
		if (((_0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879) && func_563(uParam0, uParam0->f_1688) < 10000f) && func_63(uParam0, 16)) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
			{
				func_367(uParam0, 4);
...
void func_364(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (func_548(uParam1, 262144) && Global_1935630->f_44 == 2055893578)
	{
		iVar0 |= 16;
	}
...
void func_365(var uParam0)
{
	...
	if (iVar0 >= 0 && !func_371(uParam0, 2))
	{
		...
		if (bVar1)
		{
			...
			{
				StringCopy(&(uParam0->f_1692), func_570(uParam0->f_1345[iVar0]->f_2), 64);
			}
			else
			{
			...
			{
				StringCopy(&(uParam0->f_1692.f_8), func_570(uParam0->f_1345[iVar0]->f_10), 64);
			}
			else
			{
		...
		{
			if (!func_572(uParam0->f_1345[iVar0]->f_1, 8))
			{
				if (!func_572(uParam0->f_1345[iVar0]->f_1, 8))
				{
					func_566(&iVar19, uParam0->f_1345[iVar0]->f_1);
				...
				if (uParam0->f_1345[iVar0]->f_20 >= 0)
				{
					...
					while (iVar25 < 35)
					{
						if (uParam0->f_3[iVar25] && does_entity_exist(uParam0->f_3[iVar25]->f_2))
						{
							...
							if (func_572(uParam0->f_1345[iVar0]->f_1, 16) && iVar24 >= 0)
							{
								...
								{
									vVar20 = { _get_object_offset_from_coords(vVar20, func_574(Global_35, iVar23, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
								}
							}
							else if (uParam0->f_1345[iVar0]->f_18 != 0f || uParam0->f_1345[iVar0]->f_19 != 0f)
							{
								vVar20 = { _get_object_offset_from_coords(vVar20, func_469(Global_36, uParam0->f_1016[iVar0]->f_1, 1), uParam0->f_1345[iVar0]->f_18, 0f, uParam0->f_1345[iVar0]->f_19) };
							}
							fVar27 = uParam0->f_1016[iVar0]->f_16;
							fVar28 = uParam0->f_1016[iVar0]->f_14;
							bVar29 = func_572(uParam0->f_1345[iVar0]->f_1, 2);
							bVar30 = (func_572(uParam0->f_1345[iVar0]->f_1, 1) && !bVar29);
							bVar31 = func_572(uParam0->f_1345[iVar0]->f_1, 4);
							bVar32 = false;
							if (!_0x927b810e43e99932(&(uParam0->f_1692)))
							{
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 4))
							{
								...
								bVar32 = (bVar32 || !func_576(uParam0->f_1708.f_17, vVar20, 1056964608, 1));
							...
							if (_0x4138ee36bc3dc0a7(&(uParam0->f_1692), 9))
							{
								...
								bVar32 = (bVar32 || !func_576(uParam0->f_1731.f_17, vVar20, 1056964608, 1));
...
bool func_379(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_174(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_14)
		{
			return true;
		}
...
bool func_380(var uParam0)
{
	if (uParam0->f_1684 >= 0)
	{
		if (func_174(Global_35, uParam0->f_1016[uParam0->f_1684]->f_1, 0) < uParam0->f_1016[uParam0->f_1684]->f_15)
		{
			return true;
		}
	...
	switch (uParam0->f_475[uParam0->f_1685]->f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (_does_anim_scene_exist(func_594(uParam0)) && _is_anim_scene_started(func_594(uParam0), false))
				{
					uParam0->f_1768 = 1;
				}
			}
			...
			{
				fVar0 = _get_anim_scene_progress(func_594(uParam0));
				bVar1 = _is_anim_scene_finished(func_594(uParam0), false);
				bVar2 = _is_anim_scene_active(func_594(uParam0));
...
int func_383(var uParam0)
{
	...
	while (iVar0 < 30)
	{
		if (uParam0->f_475[iVar0]->f_17 == 2 && func_595(uParam0->f_475[iVar0], 4))
		{
			return iVar0;
		}
		iVar0++;
...
void func_390(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	else
	{
		...
		{
			func_267(&((*Global_1360165)[iParam0]->f_130));
		}
		if (bParam9)
		{
...
void func_404(var uParam0)
{
	if (!func_615(uParam0->f_2, 1))
	{
		if (func_519(uParam0))
		{
			...
			{
				sVar0 = func_437(get_entity_model(Global_35));
...
void func_429(struct<4> Param0)
{
	...
	if (func_626(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_626(20))
			{
				return;
			}
			iVar0++;
...
void func_457()
{
	...
	if (func_471(iVar0))
	{
		...
		{
			func_641(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
void func_468(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_645(Global_35) && is_player_teleport_active())
	{
	}
	if (func_646(iParam0))
	{
	...
	if (func_351(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_351(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_351(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_351(iParam5, 32), true);
	...
	else if (func_351(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_351(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_351(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
struct<5> func_485(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_650(iParam0))
	{
		...
		case -427144552:
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_653(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_653(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_654(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
...
bool func_488(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_475(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_664(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_664(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_666(iParam0, iParam2, iParam1, func_274() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_481(func_479(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_505(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_678(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
bool func_512(int iParam0, bool bParam1)
{
	...
	{
		func_684(iParam0, _create_persistent_character(func_683(iParam0)));
		if (func_274() == -1)
		{
			if (func_682(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_685(iParam0));
				func_686(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_685(iParam0));
		}
		return false;
	}
	...
	if (_0x800df3fc913355f3(func_685(iParam0)))
	{
		func_686(iParam0, 128);
		return true;
	}
	func_684(iParam0, _create_persistent_character(func_683(iParam0)));
	_0x4f81ead1de8fa19b(func_685(iParam0));
	if (func_682(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_685(iParam0));
		func_686(iParam0, 2048);
...
int func_513(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_690(iParam0)) && !is_entity_dead(iVar0))
	{
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_468(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_697(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_699(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_170(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_701(Global_1360165[iParam0], 1);
				}
			}
			func_695(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_702(Global_1360165[iParam0]))
				{
				}
			}
			func_703(iParam0, Global_1360165[iParam0]);
...
void func_535(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2 && (!func_184() || !_0x6f1f0b17109309da(Global_43800, func_231(iParam0))))
	{
		if (is_ped_on_mount(iParam0))
		{
...
void func_559(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (bParam1)
		{
			...
			if (!func_576(vVar0, _0x3e2a25b2416dd67e(uParam0->f_1875), 1056964608, 1) && !func_90(vVar0))
			{
...
void func_560(var uParam0)
{
	...
	if ((uParam0->f_1899 && does_entity_exist(uParam0->f_1901)) && _is_draft_vehicle(uParam0->f_1901))
	{
		...
		while (iVar0 < 6)
		{
			...
			if (!is_entity_dead(iVar2))
			{
				if (!does_entity_exist(iVar1) || func_174(iVar2, uParam0->f_1016[uParam0->f_1688]->f_1, 1) < func_174(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1))
				{
					iVar1 = iVar2;
				}
			}
		...
		if (!func_63(uParam0, 8192))
		{
			if (func_174(iVar1, uParam0->f_1016[uParam0->f_1688]->f_1, 1) <= (uParam0->f_1016[uParam0->f_1688]->f_17 + 5f) || _0xf256a75210c5c0eb(uParam0->f_1875, uParam0->f_1879))
			{
			...
			else if ((!func_722(512) || func_723(2)) && _0xc6d7ddc843176701(uParam0->f_1901) != 50f)
			{
				_0x0c3f0f7f92ca847c(uParam0->f_1901, 50f);
			}
		}
	...
	while (iVar2 < 2)
	{
		if (uParam0->f_1633[iVar2]->f_11 && _does_volume_exist(uParam0->f_1633[iVar2]->f_12))
		{
			...
			if (!bParam1)
			{
				...
				bVar3 = func_548(uParam0->f_1633[iVar2]->f_10, 131072);
				if (func_724(Global_35, uParam0->f_1633[iVar2]->f_12, 0, 1))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_364(uParam0, uParam0->f_1633[iVar2]->f_10, uParam0->f_1345[uParam0->f_1688]->f_1, 1065353216);
						disable_control_action(0, -822242784, false);
					}
					if (bVar3)
					{
				...
				else if (func_727(uParam0->f_1633[iVar2]) != 0)
				{
					func_726(uParam0, iVar2, iVar0, bVar3);
				}
			}
			else if (func_548(uParam0->f_1633[iVar2]->f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (((func_174(Global_35, uParam0->f_1016[uParam0->f_1688]->f_1, 1) > uParam0->f_1016[uParam0->f_1688]->f_17 && func_724(uParam0->f_1898, uParam0->f_1633[iVar2]->f_12, 0, 1)) || uParam0->f_1687 != 0) || func_63(uParam0, 33554432))
					{
						iVar4 = 5152;
...
float func_563(var uParam0, int iParam1)
{
	...
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			if (func_728(&vVar3, uParam0->f_1016[iParam1]->f_1, uParam0->f_1016[iParam1]->f_4, vVar0, Global_36))
			{
...
void func_564(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if ((!is_string_null_or_empty(&(uParam0->f_1016[iVar0]->f_22)) && func_731(uParam0, iVar0)) && !func_507(uParam0->f_1016[iVar0], 1))
			{
				if (!func_732(uParam0, &(uParam0->f_1016[iVar0]->f_22)))
				{
					func_348(&(uParam0->f_1771), uParam0->f_1016[iVar0]->f_22, 0, -1, 1, 0);
				}
				func_733(uParam0->f_1016[iVar0], 1);
			}
		}
		iVar0++;
	}
...
bool func_578(var uParam0, int iParam1)
{
	...
	if (uParam0->f_1016[uParam0->f_1688]->f_29)
	{
		if (&uParam0->f_1016[uParam0->f_1688] == 0)
		{
			...
			if (func_728(&vVar0, uParam0->f_1765, Global_36, vVar6, uParam0->f_1016[uParam0->f_1688]->f_1))
			{
				iVar9 = 1;
				...
				if (iVar9 == 1)
				{
					if ((vVar0.z < (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 - 0.1f) || vVar0.z > (uParam0->f_1016[uParam0->f_1688]->f_1.f_2 + uParam0->f_1016[uParam0->f_1688]->f_10)) || (func_330(uParam0->f_1016[uParam0->f_1688], 2) && (uParam0->f_1897 || uParam0->f_1899)))
					{
						iVar9 = 0;
					}
				}
	...
	switch (uParam0->f_475[iParam1]->f_2)
	{
		case 9:
			if (_does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8) && _is_anim_scene_started(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, false))
			{
				...
				if (((func_595(uParam0->f_475[iParam1], 4) && uParam0->f_475[iParam1]->f_12 < 1f) && fVar1 >= uParam0->f_475[iParam1]->f_12) && !is_player_script_control_on(get_player_index()))
				{
					clear_ped_tasks(Global_35, 1, 0);
					set_player_control(get_player_index(), true, 0, false);
				}
				if (func_595(uParam0->f_475[iParam1], 64) && func_736(uParam0, iParam1, 0))
				{
					func_737(uParam0, uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
				}
			}
			break;
		case 10:
			if ((uParam0->f_475[iParam1]->f_3 >= 0 && uParam0->f_475[iParam1]->f_5 >= 0) && uParam0->f_475[iParam1]->f_3 != uParam0->f_475[iParam1]->f_5)
			{
				if (!is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2) && !is_entity_dead(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2))
				{
					...
					{
						func_738(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
					if ((func_595(uParam0->f_475[iParam1], 128) && is_entity_a_ped(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)) && is_ped_human(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2)))
					{
						func_738(get_ped_index_from_entity_index(uParam0->f_3[uParam0->f_475[iParam1]->f_5]->f_2), uParam0->f_3[uParam0->f_475[iParam1]->f_3]->f_2, uParam0->f_475[iParam1]->f_13, uParam0->f_475[iParam1]->f_14);
					}
				}
			}
			break;
...
int func_581(var uParam0, int iParam1)
{
	...
	if ((((func_8(uParam0) > 3 && uParam0->f_475[iParam1]->f_17 == 1) && func_363(uParam0) != 11) && func_362(uParam0, uParam0->f_1684)) && uParam0->f_475[iParam1]->f_2 != 4)
	{
		return 0;
	}
	if ((uParam0->f_475[iParam1]->f_2 == 9 && uParam0->f_475[iParam1]->f_4 >= 0) && _does_anim_scene_exist(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8))
	{
		...
		else if (_0x6f1f0b17109309da(uParam0->f_1522[uParam0->f_475[iParam1]->f_4]->f_8, func_231(Global_35)))
		{
			if (func_385(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 4))
			{
			...
			else if (func_385(uParam0->f_1522[uParam0->f_475[iParam1]->f_4], 8))
			{
		...
		case 8:
			if (!is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_19)) && !is_string_null_or_empty(&(uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= IntToFloat((uParam0->f_1016[&uParam0->f_475[iParam1]]->f_25 / 1000)))
				{
					...
					{
						func_348(&(uParam0->f_1771), uParam0->f_1016[&uParam0->f_475[iParam1]]->f_22, 0, -1, 0, 0);
					}
					else
					{
...
int func_583(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (func_363(uParam0))
	{
		case 0:
			...
			if (((!func_330(uParam0->f_1016[iVar2], 32) && func_741()) && !is_string_null_or_empty(&(uParam0->f_459))) || (!func_330(uParam0->f_1016[iVar2], 128) && uParam0->f_1899))
			{
				if (uParam0->f_1899)
				{
		...
		case 6:
			...
			iVar1 = 5664;
			if (func_330(uParam0->f_1016[uParam0->f_1688], 512))
			{
				iVar1 |= 128;
			}
			if (!func_362(uParam0, uParam0->f_1688))
		...
		case 7:
			...
			break;
		case 3:
			if (!func_330(uParam0->f_1016[iVar2], 256))
			{
		...
		case 4:
			...
			if ((func_330(uParam0->f_1016[iVar2], 256) || !func_451(&uVar5)) || bVar0)
			{
				if (func_745())
				{
					func_746();
...
bool func_586(var uParam0, char* sParam1, int iParam2)
{
		...
		if (func_750(uParam0, 0))
		{
			if (func_751(uParam0, 43, &iVar16))
			{
				if (iVar16 >= 0)
				{
					...
					func_752(uParam0, 1, &(uParam0->f_1016[iVar16]->f_1));
					func_752(uParam0, 2, &(uParam0->f_1016[iVar16]->f_1.f_1));
					func_752(uParam0, 3, &(uParam0->f_1016[iVar16]->f_1.f_2));
					func_752(uParam0, 4, &(uParam0->f_1016[iVar16]->f_11));
					func_752(uParam0, 5, &(uParam0->f_1016[iVar16]->f_12));
					func_752(uParam0, 6, &(uParam0->f_1016[iVar16]->f_13));
					func_752(uParam0, 7, &(uParam0->f_1016[iVar16]->f_4));
					func_752(uParam0, 8, &(uParam0->f_1016[iVar16]->f_4.f_1));
					func_752(uParam0, 9, &(uParam0->f_1016[iVar16]->f_4.f_2));
					func_752(uParam0, 10, &(uParam0->f_1016[iVar16]->f_7));
					func_752(uParam0, 11, &(uParam0->f_1016[iVar16]->f_7.f_1));
					func_752(uParam0, 12, &(uParam0->f_1016[iVar16]->f_7.f_2));
					func_752(uParam0, 13, &(uParam0->f_1016[iVar16]->f_10));
					func_752(uParam0, 14, &(uParam0->f_1016[iVar16]->f_14));
					func_752(uParam0, 15, &(uParam0->f_1016[iVar16]->f_15));
					if (func_751(uParam0, 16, &iVar17))
					{
						uParam0->f_1016[iVar16] = iVar17;
					}
					func_752(uParam0, 19, &(uParam0->f_1016[iVar16]->f_16));
					func_752(uParam0, 20, &(uParam0->f_1016[iVar16]->f_17));
					func_752(uParam0, 31, &(uParam0->f_1016[iVar16]->f_18));
					...
					func_751(uParam0, 23, &(uParam0->f_1016[iVar16]->f_25));
					func_754(uParam0, &(uParam0->f_1016[iVar16]->f_27));
					if (func_753(uParam0, 35, &(uParam0->f_1016[iVar16]->f_30)))
					{
					}
					...
					if (func_752(uParam0, 40, &(uParam0->f_1016[iVar16]->f_40)))
					{
						func_733(uParam0->f_1016[iVar16], 2);
					}
					if (is_string_null_or_empty(&(uParam0->f_1016[iVar16]->f_30)))
					{
						uParam0->f_1016[iVar16]->f_30 = { func_431() };
					}
	...
	while (iVar18 < 8)
	{
		if (uParam0->f_1016[iVar18]->f_29)
		{
			if (!func_755(vVar29, uParam0->f_1016[iVar18]->f_1, 5f, 1))
			{
				uParam0->f_1900 = 0;
			}
			else
			...
			while (iVar18 < 11)
			{
				...
				if (func_750(uParam0, 45))
				{
					if (func_751(uParam0, 47, &iVar16))
					{
						if (iVar16 >= 0)
						{
							func_756(uParam0->f_1522[iVar16], 2);
							func_753(uParam0, 46, uParam0->f_1522[iVar16]);
							if (func_757(uParam0, 48, &bVar19))
							{
								if (bVar19)
								{
									func_756(uParam0->f_1522[iVar16], 1);
								}
							}
							if (func_751(uParam0, 49, &iVar17))
							{
								if (iVar17 == 1)
								{
									func_756(uParam0->f_1522[iVar16], 8);
								}
								else if (iVar17 == 2)
								{
									func_756(uParam0->f_1522[iVar16], 4);
								}
							}
						}
					}
				...
				if (func_750(uParam0, 57))
				{
					if (func_751(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_751(uParam0, 58, uParam0->f_475[iVar16]);
							if (func_751(uParam0, 59, &iVar17))
							{
								uParam0->f_475[iVar16]->f_1 = func_760(iVar17);
							}
							if (func_751(uParam0, 60, &iVar17))
							{
								uParam0->f_475[iVar16]->f_2 = func_761(iVar17);
							}
							func_751(uParam0, 61, &(uParam0->f_475[iVar16]->f_3));
							func_752(uParam0, 67, &(uParam0->f_475[iVar16]->f_10));
							func_752(uParam0, 70, &(uParam0->f_475[iVar16]->f_11));
							func_752(uParam0, 68, &(uParam0->f_475[iVar16]->f_9));
							func_751(uParam0, 72, &(uParam0->f_475[iVar16]->f_5));
							func_752(uParam0, 77, &(uParam0->f_475[iVar16]->f_12));
							func_751(uParam0, 78, &(uParam0->f_475[iVar16]->f_13));
							func_751(uParam0, 79, &(uParam0->f_475[iVar16]->f_14));
							...
							func_752(uParam0, 80, &(uParam0->f_475[iVar16]->f_15));
			...
			while (iVar18 < 8)
			{
				...
				if (func_750(uParam0, 85))
				{
					...
					if (iVar16 >= 0)
					{
						func_757(uParam0, 87, uParam0->f_1345[iVar18]);
						func_753(uParam0, 96, &(uParam0->f_1345[iVar18]->f_2));
						func_753(uParam0, 97, &(uParam0->f_1345[iVar18]->f_10));
						func_752(uParam0, 93, &(uParam0->f_1345[iVar18]->f_18));
						func_752(uParam0, 94, &(uParam0->f_1345[iVar18]->f_19));
						func_751(uParam0, 95, &(uParam0->f_1345[iVar18]->f_20));
						uParam0->f_1345[iVar18]->f_1 = 0;
						func_762(uParam0, &(uParam0->f_1345[iVar18]->f_1));
					}
				}
				iVar18++;
			}
				...
				if (func_750(uParam0, 98))
				{
					if (func_751(uParam0, 43, &iVar16))
					{
						if (iVar16 >= 0)
						{
							...
							func_763(uParam0, 99, uParam0->f_1633[iVar16]);
							func_763(uParam0, 100, &(uParam0->f_1633[iVar16]->f_6));
							func_763(uParam0, 101, &(uParam0->f_1633[iVar16]->f_3));
							if (func_751(uParam0, 102, &iVar17))
							{
								uParam0->f_1633[iVar16]->f_9 = iVar17;
							}
							func_754(uParam0, &(uParam0->f_1633[iVar16]->f_10));
...
bool func_587(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (((!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_385(uParam0->f_1522[iVar0], 2)) && !func_385(uParam0->f_1522[iVar0], 16)) && func_765(uParam0, iVar0))
		{
			if (!_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
			{
			...
			{
				func_756(uParam0->f_1522[iVar0], 32);
			}
			_delete_anim_scene(uParam0->f_1522[iVar0]->f_8);
			func_756(uParam0->f_1522[iVar0], 16);
		}
		iVar0++;
	}
	return true;
...
void func_588(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (!is_string_null_or_empty(uParam0->f_1522[iVar0]) && func_385(uParam0->f_1522[iVar0], 2))
		{
			iVar1 = 0;
...
bool func_589(var uParam0)
{
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (!func_385(uParam0->f_1522[iVar0], 64))
			{
				if (_is_anim_scene_metadata_loaded(uParam0->f_1522[iVar0]->f_8, false))
				{
					func_766(uParam0, uParam0->f_1522[iVar0]->f_8);
					load_anim_scene(uParam0->f_1522[iVar0]->f_8);
					bVar1 = false;
					func_756(uParam0->f_1522[iVar0], 64);
				}
				else
				{
					bVar1 = false;
...
void func_590(var uParam0)
{
	...
	while (iVar0 < 35)
	{
		if ((((!is_entity_dead(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && !func_646(uParam0->f_3[iVar0]->f_2)) && func_471(uParam0->f_3[iVar0]->f_10)) && !func_759(uParam0->f_3[iVar0]->f_1))
		{
			...
			if (!is_entity_dead(iVar1))
			{
				...
				{
					if (func_767(uParam0->f_3[iVar0]->f_10))
					{
				...
				{
					if (func_768(iVar1, 0, 0, 0) != uParam0->f_3[iVar0]->f_10)
					{
...
void func_598(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_773(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_599(int iParam0, int iParam1, bool bParam2)
{
	...
	func_774(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_607(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_275(iParam0);
	if (((does_entity_exist(iVar1) && func_777(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
float func_612()
{
	return (func_783(150f, to_float(Global_1934765->f_286)) / to_float(300));
}
...
{
	return func_494(1328661203, func_340(), -1591664384, bParam0);
}
...
int func_660(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_659(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_665(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_477(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_799(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_453(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_659(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_799(&(Global_1946804->f_1497.f_1[iVar1])) || func_659(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_453(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_453(&(uParam0->f_1[iVar1])) || func_659(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_667(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_476(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_803(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_668(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_805(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_274() == -1)
	{
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_511((*Global_1360165)[iParam0]->f_4.f_2) || func_339((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_818((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_820(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_602(iParam0, 44, 1);
			}
...
void func_703(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_641(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_641(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
{
	switch (func_727(uParam0->f_1633[iParam1]))
	{
		case 0:
			if (!bParam3)
			{
			...
			if (!func_548(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (func_451(&(uParam0->f_1903)))
				{
					func_744(uParam0->f_1903, 0);
					func_840(uParam0->f_1633[iParam1], 2);
				}
			}
			break;
		case 1:
			if (!func_548(uParam0->f_1633[iParam1]->f_10, 256))
			{
				if (!func_841())
				{
					func_840(uParam0->f_1633[iParam1], 0);
				}
			}
			else
			{
...
void func_729(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6, float fParam7, var uParam8, var uParam9)
{
	...
	*uParam8 = func_469(uParam0->f_1016[iParam1]->f_1, vVar0, 0);
...
void func_730(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (uParam0->f_3[iVar0]->f_1 != 0)
		{
			...
			{
				func_143(&(uParam0->f_1771), get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2), &(uParam0->f_3[iVar0]->f_4), 0);
			}
		}
		iVar0++;
	}
...
void func_734(int iParam0, float fParam1)
{
	...
	if (!(func_846(17) && func_174(Global_35, (*Global_1835011)[17]->f_18, 0) < 10f))
	{
...
void func_737(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2))
		{
			...
			{
				cVar1 = { func_384(uParam0, uParam0->f_3[iVar0]->f_2) };
			}
...
void func_739(var uParam0, int iParam1, int iParam2)
{
	...
	if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
	{
		if (_is_anim_scene_loaded(uParam0->f_1522[iVar0]->f_8, true, false))
		{
			...
			if (func_385(uParam0->f_1522[iVar0], 1))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_231(Global_35), &vVar7, false, 0, 2))
				{
			...
			if (_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_231(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0)
			{
				if ((func_8(uParam0) > 3 && !func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 16)) && !func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
				{
					func_847(uParam0, 1);
				}
				if (uParam0->f_1899)
				{
					if (func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 128))
					{
					}
					else
					{
			...
			if (!_is_anim_scene_started(uParam0->f_1522[iVar0]->f_8, false))
			{
				...
				{
					set_anim_scene_bool(uParam0->f_1522[iVar0]->f_8, "b_PlayerArthur", !func_619(), false);
				}
				start_anim_scene(uParam0->f_1522[iVar0]->f_8);
				if (uParam0->f_475[iParam2]->f_17 == 0)
				{
					func_756(uParam0->f_1522[iVar0], 128);
					if (_0xa9016536015de29d(uParam0->f_1522[iVar0]->f_8, "pl_breakout"))
					{
						func_386(uParam0->f_1522[iVar0]->f_8, 10000, 0, -1, 0);
					}
				}
			}
			...
			if (func_595(uParam0->f_475[iParam2], 4))
			{
				uParam0->f_1685 = iParam2;
				if (((((func_358(uParam0) == 0 && !_0x81dcfd13cf39920e()) && uParam0->f_475[iParam2]->f_17 == 1) && &uParam0->f_475[iParam2] < 8) && !func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768)) && !func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 524288))
				{
					_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
					func_506(uParam0, 64);
				}
			...
			if ((_0x6f1f0b17109309da(uParam0->f_1522[iVar0]->f_8, func_231(Global_35)) && uParam0->f_475[iParam2]->f_17 != 0) && !func_330(uParam0->f_1016[&uParam0->f_475[iParam2]], 32768))
			{
				if (_get_anim_scene_entity_matrix(uParam0->f_1522[iVar0]->f_8, func_231(Global_35), &vVar21, false, 0, 2) && !func_90(vVar21))
				{
					func_848(uParam0, 0);
				}
			}
...
bool func_740(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		...
		{
			if (func_595(uParam0->f_475[iVar0], 4))
			{
				return true;
			}
...
void func_742(var uParam0)
{
	if (!uParam0->f_1897)
	{
		if (func_330(uParam0->f_1016[uParam0->f_1684], 8192) && _get_ped_crouch_movement(Global_35))
		{
			force_ped_motion_state(Global_35, 147004056, false, 0, false);
		}
		if (!func_330(uParam0->f_1016[uParam0->f_1684], 65536) || (!func_471(func_470(Global_35, 0, 1, 0)) && !func_471(func_470(Global_35, 1, 1, 0))))
		{
			if (func_362(uParam0, uParam0->f_1684))
			{
				func_849(uParam0->f_1016[uParam0->f_1684]->f_7);
			}
		}
	}
	if (!func_330(uParam0->f_1016[uParam0->f_1684], 16) && (func_471(func_470(Global_35, 0, 1, 0)) || func_471(func_470(Global_35, 1, 1, 0))))
	{
		_0x94a3c1b804d291ec(Global_35, 1, 0, 1, 0);
		if (func_330(uParam0->f_1016[uParam0->f_1684], 65536))
		{
			open_sequence_task(&iVar0);
			task_stand_still(0, 250);
	...
	else if ((!func_362(uParam0, uParam0->f_1684) && !func_371(uParam0, 4)) && !_0x3ab6c7b0bb0df4b1(Global_35, -1))
	{
		set_player_control(get_player_index(), true, 0, false);
		func_592(uParam0, 3);
	}
...
void func_743(var uParam0, int iParam1, bool bParam2)
{
	...
	func_848(uParam0, func_572(uParam0->f_1345[&uParam0->f_475[iParam1]]->f_1, 8));
	func_26(&(uParam0->f_1869));
	_0xcb9401f918cb0f75(Global_35, "PlayLeadin", 1, -1);
	if (uParam0->f_1016[&uParam0->f_475[iParam1]]->f_39 != 0)
	{
		if (!func_851(uParam0, &(uParam0->f_475[iParam1])))
		{
			func_733(uParam0->f_1016[&uParam0->f_475[iParam1]], 4);
	...
	if (func_595(uParam0->f_475[iParam1], 16))
	{
		func_852(uParam0, &(uParam0->f_475[iParam1]), &vVar4, vVar1, fVar0, &uVar21);
		task_flush_route();
		iVar24 = 0;
		while (iVar24 < 5)
		{
...
void func_747(var uParam0)
{
	...
	while (iVar0 < 103)
	{
		_datafile_register_query(uParam0->f_1889, iVar0, func_859(iVar0));
		iVar0++;
	}
}
...
bool func_758(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			if (((func_759(iParam1) && !&uParam0->f_3[iVar0]) && is_entity_a_ped(uParam0->f_3[iVar0]->f_2)) && get_ped_index_from_entity_index(uParam0->f_3[iVar0]->f_2) == Global_35)
			{
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_437(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			{
				if (are_strings_equal(uParam0->f_3[iVar0]->f_9, func_717(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			if ((is_entity_a_ped(uParam0->f_3[iVar0]->f_2) && is_model_a_ped(iParam1)) && !is_string_null_or_empty(func_437(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_437(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
			...
			if ((is_entity_an_object(uParam0->f_3[iVar0]->f_2) && _0x274ee1b90cfa669e(iParam1)) && !is_string_null_or_empty(func_717(iParam1)))
			{
				if (_does_string_exist_in_string(uParam0->f_3[iVar0]->f_9, func_717(iParam1)))
				{
					if (!&uParam0->f_3[iVar0])
					{
						uParam0->f_3[iVar0]->f_1 = get_entity_model(uParam0->f_3[iVar0]->f_2);
...
bool func_765(var uParam0, int iParam1)
{
	...
	while (iVar0 < 30)
	{
		if (((uParam0->f_475[iVar0]->f_2 == 9 && uParam0->f_475[iVar0]->f_4 == iParam1) && !func_385(uParam0->f_1522[iParam1], 32)) && ((uParam0->f_475[iVar0]->f_1 == 0 && !func_595(uParam0->f_475[iVar0], 512)) || func_595(uParam0->f_475[iVar0], 1)))
		{
			return true;
		}
		iVar0++;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (does_entity_exist(uParam0->f_3[iVar0]->f_2))
		{
			...
			if (!is_string_null_or_empty(&cVar1))
			{
				...
				else if (func_759(uParam0->f_3[iVar0]->f_1))
				{
					if (func_619())
					{
						StringCopy(&cVar1, func_437(225514697), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
					...
					{
						StringCopy(&cVar1, func_437(11966224), 64);
						if (_0x6f1f0b17109309da(iParam1, &cVar1))
						{
							set_anim_scene_entity(iParam1, &cVar1, uParam0->f_3[iVar0]->f_2, 0);
						}
...
void func_770(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_189(uParam0->f_1633[iVar0]->f_12);
		iVar0++;
	}
}
...
char* func_772(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_860(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
int func_782(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_170(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_863(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_865(iParam0);
					_0x7b204f88f6c3d287(func_866(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_866(iParam0, 0));
					func_867(iParam0);
				}
			}
			else
		...
		while (iVar28 < 4)
		{
			...
			if (func_653(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_871(0))
				{
					...
					func_872(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_792(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_875("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_874(iParam1, 512) && func_794(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_767(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_874(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_874(iParam1, 4))) && (!func_767(Var4.f_4) || func_874(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_874(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_874(iParam1, 1048576)))
				{
...
void func_795(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_880(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_880(uParam0->f_2[iVar0], 1))
				{
					func_881(uParam0->f_2[iVar0], 2, 6);
				}
...
void func_805(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_274() == -1)
	{
		func_885(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_886(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
float func_811()
{
	...
	func_897(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_812()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_897(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_813()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_897(1, round((to_float(iVar8) * fVar10)), 0);
...
bool func_816(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_902(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_685(iParam0));
}
...
int func_817(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_903((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_903((*Global_1347702)[63]->f_15, 1) || func_339((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_903((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_903((*Global_1347702)[134]->f_15, 1) || func_339((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_903((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_905(747937920, 1) && !func_903((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_828(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_824(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_824(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_824(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_824(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_824(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_824(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_824(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_824(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_824(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_824(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_824(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_824(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_824(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_824(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_824(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_824(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_824(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_824(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_824(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_824(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_824(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_824(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_824(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_824(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_824(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_824(iParam1, 1544915253))
	{
...
bool func_844(var uParam0, int iParam1)
{
	...
	if ((func_471(func_768(Global_35, 0, 0, 0)) && !func_330(uParam0->f_1016[iParam1], 16)) && !func_330(uParam0->f_1016[iParam1], 64))
	{
		return true;
	}
	return false;
...
void func_848(var uParam0, bool bParam1)
{
	...
	if ((func_358(uParam0) == 0 && uParam0->f_1684 >= 0) && !func_330(uParam0->f_1016[uParam0->f_1684], 524288))
	{
		_0xe296208c273bd7f0(-1, -1, 0, 17, 1, 0);
		func_506(uParam0, 64);
	}
...
{
	if (func_595(uParam0->f_475[iParam1], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684]->f_1 + func_547(Global_36 - uParam0->f_1016[uParam0->f_1684]->f_1) };
			if (!func_507(uParam0->f_1016[uParam0->f_1684], 2))
			{
				*fParam3 = func_469(Global_36, uParam0->f_1016[uParam0->f_1684]->f_1, 1);
			}
			else
			{
		...
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688]->f_1 + func_547(Global_36 - uParam0->f_1016[uParam0->f_1688]->f_1) };
			if (!func_507(uParam0->f_1016[uParam0->f_1688], 2))
			{
				*fParam3 = func_469(Global_36, uParam0->f_1016[uParam0->f_1688]->f_1, 1);
			}
			else
			{
...
bool func_851(var uParam0, int iParam1)
{
	...
	while (iVar12 < 30)
	{
		if (((uParam0->f_475[iVar12]->f_17 == 1 && uParam0->f_475[iVar12]->f_2 == 9) && uParam0->f_475[iVar12]->f_4 >= 0) && &uParam0->f_475[iVar12] == iParam1)
		{
			...
			if ((_does_anim_scene_exist(iVar13) && _is_anim_scene_loaded(iVar13, true, false)) && _0x6f1f0b17109309da(iVar13, func_231(Global_35)))
			{
				if (_get_anim_scene_entity_matrix(iVar13, func_231(Global_35), &vVar0, false, 0, 2))
				{
					if (!func_90(vVar0))
					{
						return true;
...
{
	func_916(&uVar0, 0f, Global_36 - Vector(1f, 0f, 0f), (-2f * sin(get_entity_heading(Global_35))), (2f * cos(get_entity_heading(Global_35))), 0f);
	func_916(&uVar7, 1f, vParam3, (-2f * sin(fParam6)), (2f * cos(fParam6)), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1]->f_1 + Vector(0f, (cos(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f)), (sin(fVar15) * (uParam0->f_1016[iParam1]->f_11 / 2f))) };
	...
	while (iVar14 < 5)
	{
		*(*uParam2)[iVar14] = { func_917(Global_36, *uParam7, vParam3, (IntToFloat(iVar14 + 1) / to_float(5))) };
		iVar14++;
	}
}
...
void func_853(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	if (bParam2)
	{
		task_achieve_heading(0, func_469(Global_36, *(*uParam3)[0], 1), 0);
	}
...
void func_854(var uParam0, int iParam1, bool bParam2, vector3 vParam3)
{
	...
	if (!func_90(vVar0))
	{
		if (bParam2)
		{
			task_achieve_heading(0, func_469(Global_36, vParam3, 1), 0);
		}
		...
		if (func_595(uParam0->f_475[iParam1], 256))
		{
...
int func_864(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_927(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_866(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_928(iParam0);
	}
...
void func_873(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_931(_get_weapon_clip_size(iParam0), iParam1);
...
void func_887(var uParam0, int iParam1)
{
	if (func_274() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_885(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_886(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
int func_942()
{
	...
	if (iVar1 == -1569615261)
	{
		...
		else if ((((is_weapon_valid(iVar0) && _is_weapon_two_handed(iVar0)) && !func_767(iVar0)) && !_is_ped_getting_into_a_mount_seat(Global_35, true)) && !(is_ped_in_any_vehicle(Global_35, false) && !_0xa24c1d341c6e0d53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((is_weapon_valid(iVar0) && func_767(iVar0)) || iVar0 == 2055893578)
		{
			return 1;
		}
		else
