...
bool func_77(var uParam0)
{
	...
	func_164(uParam0, iLocal_93, 3, 696740378, "WORLD_ANIMAL_HORSE_GRAZING", -1, 0);
...
bool func_98(var uParam0)
{
	if (bLocal_94)
	{
		if (!func_108(func_53(uParam0, iLocal_92), 242628503) || (is_entity_occluded(func_53(uParam0, iLocal_92)) && (func_214(func_53(uParam0, iLocal_92), 2360.11f, 1335.66f, 104.56f, 1) > 2401f || func_215(Global_35, func_53(uParam0, iLocal_92), 1) > 484f)))
		{
			func_61(18, 0, 1, 0, -1082130432, 1, 1, 0, 0, 0, 0);
			func_216(18);
		}
	}
	if (!bLocal_94)
	{
		...
		if (func_218(uParam0, iLocal_92))
		{
			...
			task_follow_pavement_to_coord(0, &vVar0);
			task_mount_animal(0, func_53(uParam0, iLocal_93), 20000, -1, 1.2f, 1, 0, 0);
			_task_move_in_traffic_4(0, 2f, 2433.969f, 843.4677f, 73.4796f, 1);
			close_sequence_task(iVar7);
			task_perform_sequence(func_53(uParam0, iLocal_92), iVar7);
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_215(player_ped_id(), iVar0, 1) < 10000f))
			{
...
void func_127(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_246(&((*Global_1360165)[iParam0]->f_12), 1))
		{
...
void func_128(int iParam0, int iParam1, bool bParam2)
{
	...
	func_247(&((*Global_1360165)[iParam0]->f_13), iParam1, bParam2);
}
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_250(iParam0), 137, true);
	}
}
...
void func_135(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_250(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_250(iParam0), 204, false);
	}
}
...
void func_137(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_250(iParam0);
	if (((does_entity_exist(iVar1) && func_252(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
bool func_154(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_265(uParam0->f_107[iVar0]->f_1, 2048))
			{
				return true;
			}
			if (func_33(uParam0) < 5)
			{
				if (func_133(uParam0->f_107[iVar0]->f_1, 29, 1) || func_266(uParam0->f_107[iVar0]->f_1))
				{
					return true;
				}
				if (!uParam0->f_3)
...
int func_163(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	...
	while (iVar0 < uParam0->f_107)
	{
		...
		{
			uParam0->f_107[iVar0] = 1;
			uParam0->f_107[iVar0]->f_7 = iParam1;
			uParam0->f_107[iVar0]->f_4 = sParam2;
			uParam0->f_107[iVar0]->f_6 = iParam3;
			uParam0->f_106++;
			return iVar0;
		}
		iVar0++;
...
void func_182(var uParam0)
{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			...
			if (!func_231(uParam0->f_107[iVar12]->f_96))
			{
			}
			else
			{
...
bool func_183(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_231(uParam0->f_107[iVar0]->f_8.f_3))
			{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_299(uParam0->f_36[iVar0]->f_1))
				{
				}
...
void func_188(var uParam0, int iParam1)
{
	...
	func_305(uParam0->f_107[iParam1]->f_5);
	clear_ped_secondary_task(uParam0->f_107[iParam1]->f_5);
	func_306(uParam0->f_107[iParam1]->f_5, 1);
}
...
void func_189(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			uParam0->f_107[iVar0]->f_5 = func_307(uParam0->f_107[iVar0]->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_190(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			...
			while (iVar1 < uParam0->f_106)
			{
				func_309(uParam0->f_107[iVar1]->f_5, &(uParam0->f_1984[iVar0]), uParam0->f_107[iVar1]->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_192(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_310(uParam0->f_107[iVar0]->f_5);
		iVar0++;
	}
}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_312(uParam0->f_1711[iVar0]->f_10, &(uParam0->f_1984[iVar6]), uParam0->f_1711[iVar0]->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_312(uParam0->f_1967[iVar1]->f_3, &(uParam0->f_1984[iVar2]), uParam0->f_1967[iVar1]->f_2);
						}
						iVar2++;
					}
				}
...
void func_200(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_313(uParam0->f_107[iVar0]->f_1, uParam0->f_107[iVar0]->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_202(var uParam0)
{
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_231(uParam0->f_107[iVar2]->f_96))
			{
			}
			else
			{
				iVar0 = func_314(get_entity_coords(uParam0->f_107[iVar2]->f_5, true, false));
				iVar1 = func_314(uParam0->f_107[iVar2]->f_96);
				if (iVar0 || iVar1)
				{
...
int func_203(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_123() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_308() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0]->f_32.f_32 > -1)
			{
				...
				func_330(uParam0->f_107[iVar0]->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = uParam0->f_107[iVar0]->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_331(uParam0->f_107[iVar0]->f_1, fVar4);
				func_330(uParam0->f_107[iVar0]->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
bool func_232(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_233(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_343(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_235(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_344(iParam0);
	}
...
void func_251(int iParam0)
{
	if (func_55(iParam0))
	{
		if (does_entity_exist(func_250(iParam0)))
		{
...
bool func_264(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_350(&(Global_1898164->f_1[0]));
		if (func_351(iVar0) && func_352((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_353(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
int func_280(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_363(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_55(uParam0->f_107[iVar1]->f_7))
			{
				...
				{
					uParam0->f_107[iVar1]->f_5 = func_364(uParam0->f_107[iVar1]->f_7, 1, 1, 0, 0, 1, 1, uParam0->f_107[iVar1]->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return false;
					if (uParam0->f_107[iVar1]->f_102 || uParam0->f_107[iVar1]->f_103)
					{
						if (!func_55(uParam0->f_107[iVar1]->f_1))
						{
							...
							{
								uParam0->f_107[iVar1]->f_1 = func_365(uParam0, 1, 1);
							}
							else
							{
								uParam0->f_107[iVar1]->f_1 = func_365(uParam0, 1, 0);
							}
						}
						if (!func_55(uParam0->f_107[iVar1]->f_1))
						{
					...
					if (!func_366(uParam0, iVar1, uParam0->f_107[iVar1]->f_1))
					{
						if (!uParam0->f_21)
						{
							return false;
...
bool func_284(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (is_entity_dead(func_367(iVar1)))
			{
				func_368(iVar1, 1);
				return false;
			}
			uParam0->f_107[iVar0]->f_5 = func_369(iVar1, 0, 0, 1, 1, 1);
			if (!does_entity_exist(uParam0->f_107[iVar0]->f_5))
			{
				return false;
			}
...
bool func_297(var uParam0, var uParam1, bool bParam2)
{
	iVar0 = 60;
	if (bParam2)
	{
	...
	if (vdist2(Global_36, func_371(uParam0)) > func_372(uParam0))
	{
	...
	if (!bVar1)
	{
		if (vdist2(Global_36, func_374(func_159(uParam0))) <= 4f)
		{
			func_51(uParam0, "Walk and talk - Player is near the tithing box / ledger", iVar0, -1);
			return false;
		}
		if (vdist2(Global_36, func_375(func_159(uParam0))) <= 4f)
		{
...
bool func_298(var uParam0, var uParam1, bool bParam2)
{
	iVar0 = 60;
	if (bParam2)
	{
...
bool func_302(var uParam0, int iParam1, vector3 vParam2)
{
...
bool func_303(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_314(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false));
		iVar6 = func_314(uParam0->f_107[iParam1]->f_96);
		if (iVar5 != iVar6)
		{
...
bool func_323(var uParam0, float fParam1, float fParam2)
{
	iVar1 = 0;
	while (iVar1 < uParam0->f_106)
	{
...
void func_324(var uParam0, var uParam1)
{
	...
	func_385(Global_35, iVar0, &Var1, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1056964608, 1092616192, -1, 1, 0, 0, 0, 1);
	func_226(1);
}
...
void func_325(var uParam0, var uParam1)
{
	...
	Var1.f_19 = -1;
	Var1.f_26 = -1082130432;
	func_386(iVar0, Global_35, &Var1, -1082130432, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520, 1073741824, 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
}
...
void func_333(var uParam0, var uParam1)
{
	...
	func_389(Global_35, iVar0, 1, 1, 1, 0, 0, 1, 0, 1, 1);
	if (uParam1->f_6 > 0f)
	{
...
void func_334(var uParam0, var uParam1)
{
	...
	func_390(iVar0, Global_35, 1, 1, 1, 0, 1, 1, 0, 1, 1);
	set_ped_reset_flag(iVar0, 202, true);
}
	...
	switch (uParam1->f_47.f_1)
	{
		case 0:
			if (func_394(uParam0, uParam1))
			{
				...
				if (uParam0->f_2 == 456)
				{
					func_395(Global_35, "WNT_INTERRUPT_NAGGED", -417894478, iVar0, 1, 0, 5, 1);
					func_396(uParam1, 2);
					return;
				}
				func_395(Global_35, func_397(uParam0, uParam1), -417894478, iVar0, 1, 0, 0, 1);
		...
		case 2:
			if (!is_any_speech_playing(Global_35))
			{
				...
				func_395(iVar0, func_401(uParam0, uParam1), -417894478, Global_35, 1, 0, 0, 1);
...
void func_340(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_403(100f, 140f);
			}
		}
...
bool func_348()
{
	if (_is_ped_carrying(Global_35) || func_408(Global_35))
	{
		return true;
	}
	return false;
...
int func_363(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
int func_364(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_414(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!does_entity_exist(iVar1))
	{
		return 0;
	}
...
bool func_366(var uParam0, int iParam1, int iParam2)
{
	if (!func_55(iParam2))
	{
		return true;
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_256(iParam0, _create_persistent_character(func_143(iParam0)));
		if (func_244() == -1)
		{
...
bool func_377(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_385(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	if (is_entity_dead(iParam0))
	{
	}
...
void func_386(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	if (is_entity_dead(iParam0))
	{
	}
...
bool func_394(var uParam0, var uParam1)
{
	if (uParam1->f_47 == 0)
	{
		return false;
	...
	if (!func_399(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_438("INTERACT_WNT_DISMISS", 648122183, iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
		func_439(uParam1->f_47.f_3, _uiprompt_get_group_id_for_target_entity(iVar0), 0, 1);
	}
	if (is_any_speech_playing(Global_35))
	{
...
bool func_395(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Var0.f_5 = 1;
	Var0.f_6 = 1;
	Var0 = sParam1;
...
int func_398(var uParam0)
{
	...
	return (func_446() - round((uParam0->f_1 * 1000f)));
}
...
int func_414(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!does_entity_exist(iVar0) || !func_131(iVar0, 0)) || (bParam3 && !func_56(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_461(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
bool func_417(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_464((*Global_1835011)[iParam0]->f_1, 1);
	}
...
bool func_423(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_55(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				...
				func_472(Global_1360165[iParam0], vVar0, iParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_473(iParam0, iParam13))
				{
					if (_0xa0bc8faed8cfeb3c(Global_1360165[iParam0]))
					{
						...
						func_475(iParam0, Global_1360165[iParam0], iParam13, 1);
		...
		case 6:
			if (func_131(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_306(Global_1360165[iParam0], 1);
				}
			}
			func_469(iParam0, 7);
		case 7:
			...
			if (bParam20)
			{
				if (func_305(Global_1360165[iParam0]))
				{
				}
			}
			func_477(iParam0, Global_1360165[iParam0]);
...
void func_449(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_331(uParam0->f_107[iParam1]->f_1, fVar0);
	}
}
...
void func_453(var uParam0, int iParam1)
{
	...
	func_492(uParam0->f_107[iParam1]->f_1, uParam0->f_107[iParam1]->f_32.f_39);
}
...
int func_454(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_495(get_entity_coords(uParam0->f_107[iParam1]->f_5, true, false), vVar3, 1065353216) };
...
int func_461(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch ((*Global_1360165)[iParam0]->f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_231(vVar0)) && !func_232(vVar0, get_entity_coords((*Global_1360165)[iParam0]->f_124, true, false), 1056964608, 1))
			{
				if (is_entity_attached((*Global_1360165)[iParam0]->f_124))
				{
					detach_entity((*Global_1360165)[iParam0]->f_124, true, true);
				}
				func_472((*Global_1360165)[iParam0]->f_124, vVar0, iParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!_0x88ad6cc10d8d35b2((*Global_1360165)[iParam0]->f_124))
...
bool func_465(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_114(iParam0))
	{
		return false;
...
bool func_470(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_114(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_512((*Global_1360165)[iParam0]->f_4.f_2) || func_513((*Global_1360165)[iParam0]->f_4.f_2)))
				{
				...
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_514((*Global_1360165)[iParam0]->f_63))
				{
			...
			(*Global_1360165)[iParam0]->f_4 = { func_516(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_113(iParam0, 44, 1);
			}
...
void func_472(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_521(Global_35) && is_player_teleport_active())
	{
	}
	if (func_522(iParam0))
	{
		if (func_523(get_ped_index_from_entity_index(iParam0)))
		{
...
bool func_473(int iParam0, int iParam1)
{
	...
	bVar0 = func_524(iParam0, iParam1);
	return bVar0;
}
...
void func_477(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_530(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_530(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_478(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_254(iParam0)))
	{
		return false;
	}
...
void func_487(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_484(iParam0, 8))
		{
...
bool func_501(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				(*Global_1360165)[iParam0]->f_124 = func_307(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_502(int iParam0, int iParam1, bool bParam2)
{
	...
	_set_ped_body_component(iParam1, func_535(iParam0));
	_update_ped_variation(iParam1, false, true, true, true, false);
...
void func_503(int iParam0, int iParam1)
{
	...
	func_434(iParam0, func_536(iParam1));
	...
	if (does_entity_exist(func_250(iParam1)))
	{
		_0x931b241409216c1f(func_250(iParam1), iParam0, 0);
		_0xed1c764997a86d5a(func_250(iParam1), iParam0);
...
int func_511(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_464((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_464((*Global_1347702)[63]->f_15, 1) || func_513((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_464((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_464((*Global_1347702)[134]->f_15, 1) || func_513((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_464((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_359(747937920, 1) && !func_464((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && does_entity_exist(func_250(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_527(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 1 > 0 && func_479(iParam1, 860729266))
	{
		_set_ped_body_component(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4096 > 0 && func_479(iParam1, 879715242))
	{
		_set_ped_body_component(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 128 > 0 && func_479(iParam1, 1606325429))
	{
		_set_ped_body_component(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 256 > 0 && func_479(iParam1, 1743550585))
	{
		_set_ped_body_component(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 512 > 0 && func_479(iParam1, 1064646155))
	{
		_set_ped_body_component(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1024 > 0 && func_479(iParam1, -536694793))
	{
		_set_ped_body_component(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2048 > 0 && func_479(iParam1, -1304053509))
	{
		_set_ped_body_component(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0]->f_5 & -2147483648 > 0 && func_479(iParam1, 718939204))
	{
		_set_ped_body_component(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 65536 > 0 && func_479(iParam1, -972364774))
	{
		_set_ped_body_component(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16384 > 0 && func_479(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0]->f_5 & 262144 > 0 && func_479(iParam1, 1153596794))
	{
		_set_ped_body_component(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 524288 > 0 && func_479(iParam1, 1016389820))
	{
		_set_ped_body_component(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1048576 > 0 && func_479(iParam1, -726966617))
	{
		_set_ped_body_component(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 2097152 > 0 && func_479(iParam1, 1365901568))
	{
		_set_ped_body_component(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 32768 > 0 && func_479(iParam1, -1658942149))
	{
		_set_ped_body_component(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 131072 > 0 && func_479(iParam1, -1980913856))
	{
		_set_ped_body_component(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 4194304 > 0 && func_479(iParam1, 491764525))
	{
		_set_ped_body_component(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8388608 > 0 && func_479(iParam1, -76015264))
	{
		_set_ped_body_component(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 16777216 > 0 && func_479(iParam1, 622113465))
	{
		_set_ped_body_component(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 33554432 > 0 && func_479(iParam1, 781533162))
	{
		_set_ped_body_component(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 67108864 > 0 && func_479(iParam1, -271415321))
	{
		_set_ped_body_component(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 134217728 > 0 && func_479(iParam1, -1683207356))
	{
		_set_ped_body_component(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 268435456 > 0 && func_479(iParam1, -254794762))
	{
		_set_ped_body_component(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 536870912 > 0 && func_479(iParam1, 609066278))
	{
		_set_ped_body_component(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 1073741824 > 0 && func_479(iParam1, -1712783565))
	{
		_set_ped_body_component(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0]->f_5 & 8192 > 0 && func_479(iParam1, 1544915253))
	{
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_549(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
struct<4> func_562(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_580(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_563(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!_0x3e4e811480b3ae79(func_580(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_564(bool bParam0)
{
	...
	return _inventory_are_local_changes_allowed(func_580(bParam0));
}
...
void func_566(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_583(_get_weapon_clip_size(iParam0), iParam1);
...
{
	return func_562(1328661203, func_584(), -1591664384, bParam0);
}
...
struct<4> func_571(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_562(923904168, func_569(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_562(923904168, func_569(bParam0), -740156546, 0) };
		}
...
struct<4> func_573(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_562(271701509, func_569(bParam0), 12999093, 0) };
		}
...
bool func_576(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!_0xb881ca836cc4b6d4(&uParam0))
	{
		return false;
	}
	if (!_0x9700e8efc4ab9089(func_580(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_577(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = _0xc97e0d2302382211(func_580(bParam6), &Var0, 0);
	return uVar4;
}

bool func_578(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_580(0);
