...
bool func_11()
{
	iLocal_14 = (*Global_1888801)[93]->f_4;
	...
	else if (_does_scenario_group_exist_hash(-679384918))
	{
	...
	if (func_46(0) == func_47(22))
	{
		...
		{
			_set_scenario_group_enabled_hash(472704883, false);
		}
	}
	else if (_does_scenario_group_exist_hash(472704883))
	{
...
void func_14(int iParam0)
{
	if (func_20() == -1)
	{
		if (func_46(0) == (*Global_1835011)[26]->f_1)
		{
			return;
		}
	}
	...
	iVar1 = _create_volume_box(1010.465f, -1772.747f, 54.474f, 0f, 0f, 0f, 46.182f, 45.55f, 29.43f);
	iVar2 = create_itemset(true);
	iVar3 = _0x84ccf9a12942c83d(iVar1, iVar2, 3, 1, 1871313379, 0);
	iVar4 = 0;
	while (iVar4 < iVar3)
	{
		iVar5 = get_indexed_item_in_itemset(iVar4, iVar2);
		set_disable_frag_damage(iVar5, true);
		set_disable_breaking(iVar5, true);
		iVar4++;
	}
...
bool func_38(int iParam0)
{
	if (iLocal_15 != -1)
	{
		if (func_58(473295046) && !func_59(45))
		{
			...
			{
				if (_0x84848e1c0fc67dbb(iLocal_15))
				{
					_0xdcf5ba95bbf0faba(iLocal_15, "MAIN_LOOP", 1011.224f, -1766.506f, 46.5833f, "FIRE_SMOLDER_LARGE_SOUNDSET", 0, 0, 0);
				}
			}
			else if (!_0x84848e1c0fc67dbb(iLocal_15))
			{
				_0x3210bcb36af7621b(iLocal_15);
			}
		}
	}
	return false;
...
bool func_48(int iParam0, int iParam1)
{
	...
	iVar0 = func_86(&((*Global_1146941)[iParam1]->f_4), iParam0, 30, 1, 7);
	if (iVar0 == 1)
	{
		return true;
	}
...
void func_49(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_87(iParam0, 0, 0);
	if (func_88(iParam0))
	{
		...
		if (bParam3)
		{
			func_89(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_83(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_137(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_89(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_88(iParam0))
	{
...
char* func_119(char* sParam0, int iParam1)
{
	...
	return func_153(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_122(int iParam0)
{
	...
	if (func_154())
	{
		if (!func_155((*Global_1835011)[3]->f_1, 1))
		{
...
{
	func_159(Global_1935369->f_5[iParam0]->f_6, 1);
	func_160(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_97(Global_1914319->f_3[iParam0]->f_21) && func_162(Global_1914319->f_3[iParam0]->f_21))
	{
		func_163(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_164(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_137(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_148(int iParam0, bool bParam1, bool bParam2)
{
	if (Global_1572887->f_12 != -1)
	{
...
{
	func_179(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
...
void func_163(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_97(iParam0))
	{
		return;
