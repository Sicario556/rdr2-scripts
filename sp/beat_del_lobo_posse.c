		...
		else
		{
			switch (iVar596)
			{
				case 1:
					...
					{
						request_collision_at_coord(Local_17.f_51);
...
void func_5()
{
	...
	while (iVar0 < 5)
	{
		if (does_entity_exist(&(uLocal_372[iVar0])))
		{
			set_ped_keep_task(&(uLocal_372[iVar0]), true);
		}
		iVar0++;
	}
	func_20(&uLocal_679, 1);
	trigger_music_event("REDLP_END");
	func_21(&Local_17, &uLocal_372, &iLocal_378, iLocal_14, uVar676, uVar675, 0, 1, 0, 1);
	if (is_shocking_event_in_sphere(1498498500, get_entity_coords(&(uLocal_372[0]), true, false), 5f))
	{
		remove_shocking_event(iVar699);
	}
	func_22(Local_421[0], &Local_527);
	func_22(Local_421[1], &Local_527);
	func_22(Local_421[2], &Local_527);
	func_22(Local_421[3], &Local_527);
	func_22(Local_421[4], &Local_527);
	...
	switch (iVar597)
	{
		...
		case 1:
			...
			switch (Local_17.f_51.f_4)
			{
				...
				case 19:
				case 20:
					if (!get_is_waypoint_recording_loaded(sLocal_16))
					{
						return false;
					}
					break;
...
bool func_12()
{
	switch (iLocal_14)
	{
		case 0:
			...
			{
				case 0:
					iLocal_697 = create_group(0);
					set_ped_as_group_leader(&(uLocal_372[0]), iVar695, false);
					iLocal_594 = 1;
					break;
				case 1:
					if (does_group_exist(iVar695) && _0x0455546f23ff08e4(iVar695))
					{
						set_group_formation(iVar695, 5);
						add_custom_formation_location(iVar695, -2f, -2f, 0f, 0);
						add_custom_formation_location(iVar695, 1.5f, -1.5f, 0f, 1);
						add_custom_formation_location(iVar695, -3f, -5f, 0f, 2);
						add_custom_formation_location(iVar695, 3f, -4f, 0f, 3);
						set_ped_as_group_member(&(uLocal_372[1]), iVar695);
						set_ped_as_group_member(&(uLocal_372[2]), iVar695);
						set_ped_as_group_member(&(uLocal_372[3]), iVar695);
						set_ped_config_flag(&(uLocal_372[0]), 279, true);
						set_ped_config_flag(&(uLocal_372[1]), 279, true);
						set_ped_config_flag(&(uLocal_372[2]), 279, true);
						set_ped_config_flag(&(uLocal_372[3]), 279, true);
						iLocal_594 = 2;
					}
					break;
				case 2:
					iLocal_594 = 3;
					task_follow_waypoint_recording(&(uLocal_372[0]), sLocal_16, 0, 30218, -1, 0, 0, -1);
					switch (Local_17.f_51.f_4)
					{
						case 15:
						case 16:
						case 20:
							uLocal_691[1] = create_scenario_point(-22664287, -2309.443f, -3079.082f, -4.1759f, 51.59f, 0, 60000f, 1);
							uLocal_691[2] = create_scenario_point(-22664287, -2310.804f, -3079.311f, -4.2636f, 10.92f, 0, 60000f, 1);
							uLocal_691[3] = create_scenario_point(-22664287, -2307.301f, -3083.707f, -4.5794f, -42.94f, 0, 60000f, 1);
							break;
						case 14:
						case 18:
						case 19:
							uLocal_691[1] = create_scenario_point(-22664287, -2743.48f, -2364.23f, 44.11f, -99.83f, 0, 60000f, 1);
							uLocal_691[2] = create_scenario_point(-22664287, -2742.52f, -2363.83f, 44.11f, 177.09f, 0, 60000f, 1);
							uLocal_691[3] = create_scenario_point(-22664287, -2741.64f, -2364.27f, 44.11f, 147.28f, 0, 60000f, 1);
							break;
					}
					break;
				case 3:
		...
		case 1:
			switch (iVar592)
			{
				case 0:
					...
					if (_0xca27a86caa4e98ed(get_entity_coords(Global_35, true, false), &vLocal_698, 1, 1077936128, 0) && !func_45(vLocal_698))
					{
						bVar0 = true;
					}
				...
				case 1:
					if (does_group_exist(iVar695) && _0x0455546f23ff08e4(iVar695))
					{
						...
						set_ped_as_group_member(&(uLocal_372[2]), iVar695);
						set_ped_as_group_member(&(uLocal_372[3]), iVar695);
						set_ped_as_group_member(&(uLocal_372[4]), iVar695);
						set_ped_config_flag(&(uLocal_372[0]), 279, true);
						set_ped_config_flag(&(uLocal_372[1]), 279, true);
						set_ped_config_flag(&(uLocal_372[2]), 279, true);
						set_ped_config_flag(&(uLocal_372[3]), 279, true);
						set_ped_config_flag(&(uLocal_372[4]), 279, true);
						iLocal_594 = 2;
					}
					break;
				case 2:
					iLocal_594 = 3;
					clear_sequence_task(uLocal_685[0]);
					open_sequence_task(uLocal_685[0]);
					if (!func_45(vLocal_698))
					{
						_task_move_in_traffic_2(0, vLocal_698, 5f, 1.75f, 8208, 0);
					}
					_task_move_in_traffic(0, 1.75f, 8208, 0);
					close_sequence_task(&(uLocal_685[0]));
					task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
					clear_sequence_task(uLocal_685[0]);
					break;
				case 3:
					return true;
	...
	switch (iLocal_14)
	{
		case 0:
			switch (iVar577)
			{
				...
				case 5:
					Local_17.f_50 = 1;
					set_ped_keep_task(&(uLocal_372[0]), true);
					set_ped_keep_task(&(uLocal_372[1]), true);
					set_ped_keep_task(&(uLocal_372[2]), true);
					set_ped_keep_task(&(uLocal_372[3]), true);
					set_ped_keep_task(&(uLocal_372[4]), true);
					return true;
				case 4:
					Local_17.f_50 = 1;
					set_ped_keep_task(&(uLocal_372[0]), true);
...
void func_16()
{
	switch (iLocal_14)
	{
		...
		case 2:
			...
			set_force_object_this_frame(-4310.89f, -2428.42f, 9.08f, 5f);
			break;
	}
	func_77();
	func_78();
...
int func_25(int iParam0, var uParam1, bool bParam2, var uParam3, struct<7> Param4, var uParam11, bool bParam12, bool bParam13, int iParam14)
{
	...
	switch (uParam1->f_9)
	{
		...
		case 1:
			...
			{
				if (!bParam13 && func_118(vdist(Global_36, *uParam1), iParam0))
				{
					uParam1->f_9 = 2;
				}
				else
...
bool func_26(var uParam0, int iParam1)
{
	...
	{
		if (_does_volume_exist(uParam0->f_172) || func_122(iParam1, func_121(uParam0), &(uParam0->f_172)))
		{
...
void func_28(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_27(uParam0->f_3, 1))
	{
		func_124(&(uParam0->f_174), uParam0->f_51, 0f, 0f, 0f, _0x3e2a25b2416dd67e(uParam0->f_171) * Vector(3.5f, 3.5f, 3.5f), "Predator Stay Out");
...
void func_33()
{
	...
	if (!is_string_null_or_empty(sLocal_16))
	{
		request_waypoint_recording(sLocal_16);
	}
}

void func_34()
{
	Local_211[0]->f_6 = { Local_17.f_51 };
	switch (Local_17.f_51.f_4)
	{
		case 2:
			Local_211[0]->f_9 = 66.09f;
			break;
		case 4:
			Local_211[0]->f_9 = -115f;
			break;
		case 0:
			Local_211[0]->f_9 = 149f;
			break;
		case 1:
			Local_211[0]->f_9 = 144.85f;
			break;
		case 3:
			Local_211[0]->f_9 = 173f;
			break;
		case 5:
			Local_211[0]->f_9 = -95.48f;
			break;
		case 6:
			Local_211[0]->f_9 = -6.89f;
			break;
		case 7:
			Local_211[0]->f_9 = -74.82f;
			break;
		case 10:
			Local_211[0]->f_9 = -141f;
			break;
		case 11:
			Local_211[0]->f_9 = -141f;
			break;
		case 13:
			Local_211[0]->f_9 = 44.34f;
			break;
		case 8:
			Local_211[0]->f_9 = 129.32f;
			break;
		case 9:
			Local_211[0]->f_9 = -134.47f;
			break;
		case 12:
			Local_211[0]->f_9 = 68.83f;
			break;
		case 14:
			Local_211[0]->f_9 = 145.7f;
			break;
		case 15:
			Local_211[0]->f_9 = 145.7f;
			break;
	...
	func_130(&(Local_211[0]->f_6), 1, 10, 0);
	Local_211[0]->f_15 = { Local_211[0]->f_6 };
	iVar0 = 1;
	while (iVar0 <= 4)
	{
		Local_211[iVar0]->f_9 = Local_211[0]->f_9;
		switch (iVar0)
		{
			case 1:
				Local_211[iVar0]->f_6 = { _get_object_offset_from_coords(Local_211[0]->f_6, Local_211[0]->f_9, -2f, -2f, 0f) };
				break;
			case 2:
				Local_211[iVar0]->f_6 = { _get_object_offset_from_coords(Local_211[0]->f_6, Local_211[0]->f_9, 1.5f, -1.5f, 0f) };
				break;
			case 3:
				Local_211[iVar0]->f_6 = { _get_object_offset_from_coords(Local_211[0]->f_6, Local_211[0]->f_9, -3f, -5f, 0f) };
				break;
			case 4:
				Local_211[iVar0]->f_6 = { _get_object_offset_from_coords(Local_211[0]->f_6, Local_211[0]->f_9, 3f, -4f, 0f) };
				break;
		}
		func_130(&(Local_211[iVar0]->f_6), 1, 10, 0);
		Local_211[iVar0]->f_15 = { Local_211[iVar0]->f_6 };
		Local_211[iVar0]->f_18 = Local_211[iVar0]->f_9;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 4)
...
void func_35()
{
	...
	{
		case 0:
			StringCopy(&(Local_211[0]->f_23), "1019_G_M_M_UniBanditos_01_HISPANIC_01", 64);
			Local_211[0]->f_3 = 470765111;
			StringCopy(&(Local_211[1]->f_23), "1023_G_M_M_UniBanditos_01_WHITE_01", 64);
			Local_211[1]->f_3 = 708700820;
			StringCopy(&(Local_211[2]->f_23), "0135_G_M_M_UniCriminals_01_HISPANIC_02", 64);
			Local_211[2]->f_3 = 1275244069;
			StringCopy(&(Local_211[3]->f_23), "1067_G_M_M_UniCriminals_01_HISPANIC_04", 64);
			Local_211[3]->f_3 = 1513704082;
			break;
		case 1:
			switch (iLocal_15)
			{
				case 0:
					...
					Local_211[0]->f_3 = 229452171;
					StringCopy(&(Local_211[1]->f_23), "1022_G_M_M_UniBanditos_01_HISPANIC_04", 64);
					Local_211[1]->f_3 = 451429377;
					StringCopy(&(Local_211[2]->f_23), "1067_G_M_M_UniCriminals_01_HISPANIC_04", 64);
					Local_211[2]->f_3 = 125607214;
					StringCopy(&(Local_211[3]->f_23), "1069_G_M_M_UniCriminals_01_HISPANIC_06", 64);
					Local_211[3]->f_3 = 369572419;
					StringCopy(&(Local_211[4]->f_23), "1020_G_M_M_UniBanditos_01_HISPANIC_02", 64);
					Local_211[4]->f_3 = -628473014;
					break;
				case 1:
					StringCopy(&(Local_211[0]->f_23), "1024_G_M_M_UniBanditos_01_WHITE_02", 64);
					Local_211[0]->f_3 = 691921068;
					StringCopy(&(Local_211[1]->f_23), "1069_G_M_M_UniCriminals_01_HISPANIC_06", 64);
					Local_211[1]->f_3 = 451429377;
					StringCopy(&(Local_211[2]->f_23), "1066_G_M_M_UniCriminals_01_HISPANIC_03", 64);
					Local_211[2]->f_3 = 229452171;
					StringCopy(&(Local_211[3]->f_23), "1020_G_M_M_UniBanditos_01_HISPANIC_02", 64);
					Local_211[3]->f_3 = 369572419;
					StringCopy(&(Local_211[4]->f_23), "1068_G_M_M_UniCriminals_01_HISPANIC_05", 64);
					Local_211[4]->f_3 = -628473014;
					break;
				case 2:
					StringCopy(&(Local_211[0]->f_23), "1068_G_M_M_UniCriminals_01_HISPANIC_05", 64);
					Local_211[0]->f_3 = 229452171;
					StringCopy(&(Local_211[1]->f_23), "RBH_TARGET22", 64);
					Local_211[1]->f_3 = 451429377;
					StringCopy(&(Local_211[2]->f_23), "1067_G_M_M_UniCriminals_01_HISPANIC_04", 64);
					Local_211[2]->f_3 = 125607214;
					StringCopy(&(Local_211[3]->f_23), "1066_G_M_M_UniCriminals_01_HISPANIC_03", 64);
					Local_211[3]->f_3 = 369572419;
					StringCopy(&(Local_211[4]->f_23), "1024_G_M_M_UniBanditos_01_WHITE_02", 64);
					Local_211[4]->f_3 = -1855770375;
					break;
			}
			break;
		case 2:
			StringCopy(&(Local_211[0]->f_23), "1019_G_M_M_UniBanditos_01_HISPANIC_01", 64);
			Local_211[0]->f_3 = 125607214;
			StringCopy(&(Local_211[1]->f_23), "1066_G_M_M_UniCriminals_01_HISPANIC_03", 64);
			Local_211[1]->f_3 = 369572419;
			StringCopy(&(Local_211[2]->f_23), "1023_G_M_M_UniBanditos_01_WHITE_01", 64);
			Local_211[2]->f_3 = -1855770375;
			StringCopy(&(Local_211[3]->f_23), "1068_G_M_M_UniCriminals_01_HISPANIC_05", 64);
			Local_211[3]->f_3 = -1617539745;
			break;
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		if (Local_211[iVar0]->f_3 != 41788943)
		{
			Local_211[iVar0]->f_1 = 424175505;
			Local_211[iVar0]->f_13 = 1;
			Local_211[iVar0]->f_19 = 1;
			Local_211[iVar0]->f_12 = func_131(5, iVar0, 0);
		}
		iVar0++;
	}
	func_132(&Local_211);
...
void func_36()
{
	Local_409[0] = "AMB_WORK@WORLD_HUMAN_LAWMAN_IDLES@MALE_B@BASE";
	Local_409[0]->f_1 = "base";
	func_133(&(Local_409[0]), &uLocal_412);
}

void func_37()
{
	func_135(Local_527[0], "RE_INTER_POS", func_134(47), -163964935, 0, 0, 0, 1, 0);
	func_135(Local_527[1], "RE_INTER_ANTAGONIZE", func_134(49), 648122183, 0, 0, 0, 1, 0);
	func_136(Local_527[0], 1, 0);
	func_136(Local_527[1], 1, 0);
}
...
bool func_40(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, float fParam9)
{
	...
	while (iVar0 <= iParam8)
	{
		if (func_138() || !func_139((*iParam4)[iVar0], (*iParam5)[iVar0], vParam0, uParam3, iParam6, fParam9))
		{
			return false;
		}
		iVar0++;
...
void func_41()
{
	...
	while (iVar0 <= 4)
	{
		if (func_95(Local_211[iVar0]->f_11, 0, 1))
		{
			set_entity_only_damaged_by_relationship_group(Local_211[iVar0]->f_11, true, 1862763509);
		}
		if (func_95(&(uLocal_372[iVar0]), 0, 1))
		{
			set_ped_relationship_group_hash(&(uLocal_372[iVar0]), -401180987);
			_0x89f5e7adecccb49c(&(uLocal_372[iVar0]), "Default_Brave");
			set_ped_config_flag(&(uLocal_372[iVar0]), 146, true);
			set_ped_config_flag(&(uLocal_372[iVar0]), 6, true);
			remove_all_ped_weapons(&(uLocal_372[iVar0]), true, true);
			set_ped_combat_movement(&(uLocal_372[iVar0]), 2);
			set_ped_combat_attributes(&(uLocal_372[iVar0]), 5, true);
			set_ped_combat_attributes(&(uLocal_372[iVar0]), 17, false);
			set_ped_combat_attributes(&(uLocal_372[iVar0]), 42, true);
			set_ped_combat_attributes(&(uLocal_372[iVar0]), 50, true);
			set_ped_combat_attributes(&(uLocal_372[iVar0]), 0, true);
		}
		iVar0++;
	}
	switch (iLocal_14)
	{
		case 0:
			func_142(&(uLocal_372[0]), func_141(268435456, 1056964608, 1065353216), 100, 0, 0, 1056964608, 1065353216, 0);
			func_142(&(uLocal_372[1]), func_143(0, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_142(&(uLocal_372[2]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
		...
		case 1:
			...
			func_142(&(uLocal_372[1]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_142(&(uLocal_372[2]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_142(&(uLocal_372[3]), func_143(0, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
		...
		case 2:
			func_142(&(uLocal_372[0]), func_141(268435456, 1056964608, 1065353216), 100, 0, 0, 1056964608, 1065353216, 0);
			func_142(&(uLocal_372[1]), func_141(268435456, 1056964608, 1065353216), 100, 0, 0, 1056964608, 1065353216, 0);
...
void func_54(var uParam0, int iParam1, float fParam2)
{
	...
	if (!uParam0->f_48 && !func_51(uParam0->f_3, 262144))
	{
		...
		func_165(uParam0->f_121[iParam1], fVar1, 1082130432, 0, 90f, 0, &(uParam0->f_98[iParam1]));
...
bool func_55(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_169(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_168(uParam2, fVar1))
		{
			if (!func_170((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
void func_56(var uParam0, int iParam1)
{
	if (func_185(uParam0->f_51))
	{
		...
		iVar2 = _create_volume_cylinder_with_custom_name(uParam0->f_51, 0f, 0f, 0f, fVar0, fVar0, fVar0, func_188());
...
void func_58()
{
	...
	{
		case 0:
			waypoint_recording_get_num_points(sLocal_16, &uLocal_643);
			waypoint_recording_get_coord(sLocal_16, (iVar641 - 1), &vLocal_674);
			func_199();
			iLocal_584 = 1;
			break;
		case 1:
			if (iVar652 == 0 && iVar658 == 0)
			{
				func_200();
				func_201();
				if (func_202(-4f, 1, 0, 0))
				{
					waypoint_playback_stop_aiming_or_shooting(&(uLocal_372[1]));
				}
			}
			else if (iVar658 == 0 && !func_195())
			{
				func_203();
			}
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 50f, 50f, 5f, false, true, 0) && iVar663 == 0)
			{
				iLocal_665 = 1;
				func_204(&(uLocal_372[0]), &(uLocal_372[1]), func_134(31), 0, -1082130432, 0, 0, 0, 1, 0, 1, 1744022339, 1, 0, 0);
			}
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 15f, 15f, 2f, false, true, 0) && iVar658 == 0)
			{
				func_191(2);
			}
			break;
...
void func_59()
{
	...
	{
		case 0:
			remove_ped_from_group(&(uLocal_372[1]));
			remove_ped_from_group(&(uLocal_372[2]));
			remove_ped_from_group(&(uLocal_372[3]));
			func_205();
			iLocal_585 = 1;
			func_136(Local_527[0], 0, 0);
			func_206(Local_527[1], 0);
			func_136(Local_527[1], 1, 0);
			Local_527[1]->f_13 = func_134(55);
			iLocal_582 = 4;
			iLocal_583 = 0;
			break;
		case 1:
			func_207();
			if (!func_208() && iVar658 == 0)
			{
				if ((is_ped_using_any_scenario(&(uLocal_372[1])) && is_ped_using_any_scenario(&(uLocal_372[2]))) && is_ped_using_any_scenario(&(uLocal_372[3])))
				{
					func_209();
				}
			}
			if (func_208() || iVar658 == 1)
			{
				func_210();
				func_211();
			}
			if (get_sequence_progress(&(uLocal_372[0])) >= 4)
			{
			...
			break;
		case 2:
			if (((is_ped_on_mount(&(uLocal_372[0])) && is_ped_on_mount(&(uLocal_372[1]))) && is_ped_on_mount(&(uLocal_372[2]))) && is_ped_on_mount(&(uLocal_372[3])))
			{
				_task_move_in_traffic(&(uLocal_372[0]), 2f, 8208, 0);
				set_ped_as_group_member(&(uLocal_372[1]), iVar695);
				set_ped_as_group_member(&(uLocal_372[2]), iVar695);
				set_ped_as_group_member(&(uLocal_372[3]), iVar695);
				set_group_formation(iVar695, 0);
				set_group_formation_spacing(iVar695, 2f, -1f, -1f);
				iLocal_585 = 3;
			}
			if (func_208() || iVar658 == 1)
			{
...
void func_60()
{
	...
	switch (iVar584)
	{
		case 0:
			...
			remove_ped_from_group(&(uLocal_372[2]));
			remove_ped_from_group(&(uLocal_372[3]));
			_0x802092b07e3b1eea(&(uLocal_372[0]), get_entity_coords(Global_35, true, false), 3);
			_0x802092b07e3b1eea(&(uLocal_372[1]), get_entity_coords(Global_35, true, false), 3);
			_0x802092b07e3b1eea(&(uLocal_372[2]), get_entity_coords(Global_35, true, false), 3);
			_0x802092b07e3b1eea(&(uLocal_372[3]), get_entity_coords(Global_35, true, false), 3);
			if (!does_blip_exist(&(iLocal_378[0])))
			{
				iLocal_378[0] = _blip_add_for_entity(831283580, &(uLocal_372[0]));
			}
			if (!does_blip_exist(&(iLocal_378[1])))
			{
				iLocal_378[1] = _blip_add_for_entity(831283580, &(uLocal_372[1]));
			}
			if (!does_blip_exist(&(iLocal_378[2])))
			{
				iLocal_378[2] = _blip_add_for_entity(831283580, &(uLocal_372[2]));
			}
			if (!does_blip_exist(&(iLocal_378[3])))
			{
				iLocal_378[3] = _blip_add_for_entity(831283580, &(uLocal_372[3]));
			}
			trigger_music_event("REDLP_FIGHT");
			iLocal_586 = 1;
			break;
		case 1:
			if ((((iVar599 == 4 || iVar599 == 256) || iVar599 == 1) || iVar599 == 16) || iVar599 == 2)
			{
				fVar0 = 0.3f;
				fVar1 = 0.6f;
				fVar2 = 1f;
			...
			task_horse_action(0, 1, Global_35, 0);
			close_sequence_task(iVar3);
			task_perform_sequence(Local_211[0]->f_11, iVar3);
			clear_sequence_task(&iVar3);
			clear_sequence_task(&iVar4);
			open_sequence_task(&iVar4);
			task_horse_action(0, 1, Global_35, 0);
			close_sequence_task(iVar4);
			_task_perform_sequence_2(Local_211[3]->f_11, iVar4, 0.5f, 0.5f);
			clear_sequence_task(&iVar4);
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			if ((((iVar599 == 4 || iVar599 == 256) || iVar599 == 1) || iVar599 == 16) || iVar599 == 2)
			...
			task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			if ((((iVar599 == 4 || iVar599 == 256) || iVar599 == 1) || iVar599 == 16) || iVar599 == 2)
			{
				task_combat_ped(0, Global_35, 16793600, 16);
			}
			...
			close_sequence_task(&(uLocal_685[1]));
			_task_perform_sequence_2(&(uLocal_372[1]), &(uLocal_685[1]), fVar0, fVar0);
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			if ((((iVar599 == 4 || iVar599 == 256) || iVar599 == 1) || iVar599 == 16) || iVar599 == 2)
			{
				task_combat_ped(0, Global_35, 16793600, 16);
			}
			...
			close_sequence_task(&(uLocal_685[2]));
			_task_perform_sequence_2(&(uLocal_372[2]), &(uLocal_685[2]), fVar1, fVar1);
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			if ((((iVar599 == 4 || iVar599 == 256) || iVar599 == 1) || iVar599 == 16) || iVar599 == 2)
			{
				task_combat_ped(0, Global_35, 16793600, 16);
			}
			...
			close_sequence_task(&(uLocal_685[3]));
			_task_perform_sequence_2(&(uLocal_372[3]), &(uLocal_685[3]), fVar2, fVar2);
			clear_sequence_task(uLocal_685[3]);
			_0x712b2c2b2471b493(&(uLocal_372[0]), -1722884127);
			_0x712b2c2b2471b493(&(uLocal_372[1]), -1722884127);
			_0x712b2c2b2471b493(&(uLocal_372[2]), -1722884127);
			_0x712b2c2b2471b493(&(uLocal_372[3]), -1722884127);
			_0x712b2c2b2471b493(&(uLocal_372[4]), -1722884127);
			if (!func_217(Local_211[0]->f_11, 518218985))
			{
				if (_is_mount_seat_free(Local_211[0]->f_11, -1))
				{
					_task_smart_flee_style_ped(Local_211[0]->f_11, Global_35, 3, 0, -1082130432, -1, 0);
				}
			}
			if (!func_217(Local_211[1]->f_11, 518218985))
			{
				if (_is_mount_seat_free(Local_211[1]->f_11, -1))
				{
					_task_smart_flee_style_ped(Local_211[1]->f_11, Global_35, 3, 0, -1082130432, -1, 0);
				}
			}
			if (!func_217(Local_211[2]->f_11, 518218985))
			{
				if (_is_mount_seat_free(Local_211[2]->f_11, -1))
				{
					_task_smart_flee_style_ped(Local_211[2]->f_11, Global_35, 3, 0, -1082130432, -1, 0);
				}
			}
			if (!func_217(Local_211[3]->f_11, 518218985))
			{
				if (_is_mount_seat_free(Local_211[3]->f_11, -1))
				{
					_task_smart_flee_style_ped(Local_211[3]->f_11, Global_35, 3, 0, -1082130432, -1, 0);
				}
			}
			if (!func_217(Local_211[4]->f_11, 518218985))
			{
				if (_is_mount_seat_free(Local_211[4]->f_11, -1))
				{
					_task_smart_flee_style_ped(Local_211[4]->f_11, Global_35, 3, 0, -1082130432, -1, 0);
				}
			}
			iLocal_586 = 2;
			break;
...
void func_62()
{
	...
	{
		case 0:
			fLocal_653 = (get_distance_between_coords(Local_17.f_51, vLocal_674, true) / 2f);
			iLocal_584 = 1;
			break;
		case 1:
			if (iVar652 == 0 && iVar658 == 0)
			...
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 80f, 80f, 40f, false, true, 0))
			{
				func_219(2);
			}
			break;
...
void func_63()
{
	...
	switch (iVar583)
	{
		case 0:
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			_task_move_in_traffic(0, 2f, 8208, 0);
			close_sequence_task(&(uLocal_685[0]));
			task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_follow_to_offset_of_entity(0, &(uLocal_372[0]), -2f, -2f, 0f, 2f, -1, 1036831949, 1, 1, 1, 1, 1);
			close_sequence_task(&(uLocal_685[1]));
			task_perform_sequence(&(uLocal_372[1]), &(uLocal_685[1]));
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_follow_to_offset_of_entity(0, &(uLocal_372[0]), 2f, -2f, 0f, 2f, -1, 1036831949, 1, 1, 1, 1, 1);
			close_sequence_task(&(uLocal_685[2]));
			task_perform_sequence(&(uLocal_372[2]), &(uLocal_685[2]));
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			task_follow_to_offset_of_entity(0, &(uLocal_372[0]), -3f, -4f, 0f, 2f, -1, 1036831949, 1, 1, 1, 1, 1);
			close_sequence_task(&(uLocal_685[3]));
			task_perform_sequence(&(uLocal_372[3]), &(uLocal_685[3]));
			clear_sequence_task(uLocal_685[3]);
			clear_sequence_task(uLocal_685[4]);
			open_sequence_task(uLocal_685[4]);
			task_follow_to_offset_of_entity(0, &(uLocal_372[0]), 3f, -4f, 0f, 2f, -1, 1036831949, 1, 1, 1, 1, 1);
			close_sequence_task(&(uLocal_685[4]));
			task_perform_sequence(&(uLocal_372[4]), &(uLocal_685[4]));
			clear_sequence_task(uLocal_685[4]);
			iLocal_585 = 3;
			break;
		case 3:
...
void func_64()
{
	...
	switch (iVar584)
	{
		case 0:
			...
			remove_ped_from_group(&(uLocal_372[2]));
			remove_ped_from_group(&(uLocal_372[3]));
			remove_ped_from_group(&(uLocal_372[4]));
			if (!does_blip_exist(&(iLocal_378[0])))
			{
				iLocal_378[0] = _blip_add_for_entity(831283580, &(uLocal_372[0]));
			}
			...
			if (!does_blip_exist(&(iLocal_378[4])))
			{
				iLocal_378[4] = _blip_add_for_entity(831283580, &(uLocal_372[4]));
			}
			trigger_music_event("REDLP_FIGHT");
			iLocal_586 = 1;
			break;
		case 1:
			...
			task_horse_action(0, 1, Global_35, 0);
			close_sequence_task(iVar4);
			task_perform_sequence(Local_211[0]->f_11, iVar4);
			clear_sequence_task(&iVar4);
			clear_sequence_task(&iVar5);
			open_sequence_task(&iVar5);
			task_horse_action(0, 1, Global_35, 0);
			close_sequence_task(iVar5);
			_task_perform_sequence_2(Local_211[3]->f_11, iVar5, 0.5f, 0.5f);
			clear_sequence_task(&iVar5);
			...
			break;
		case 2:
			if (!is_ped_dead_or_dying(&(uLocal_372[0]), true))
			{
			...
			if (!is_ped_dead_or_dying(&(uLocal_372[1]), true))
			{
			...
			if (!is_ped_dead_or_dying(&(uLocal_372[2]), true))
			{
			...
			if (!is_ped_dead_or_dying(&(uLocal_372[3]), true))
			{
			...
			if (!is_ped_dead_or_dying(&(uLocal_372[4]), true))
			{
	...
	switch (iVar582)
	{
		...
		case 1:
			if (iVar652 == 0 && iVar658 == 0)
			{
				...
				if (func_202(-4f, 1, 0, 0))
				{
					waypoint_playback_stop_aiming_or_shooting(&(uLocal_372[3]));
				}
			}
			else
			{
				if (iVar658 == 0 && !func_195())
				{
					func_232();
				}
				if (iVar665 == 1)
				{
					...
					{
						clear_ped_tasks(&(uLocal_372[2]), 1, 0);
						clear_ped_tasks(&(uLocal_372[3]), 1, 0);
						iLocal_667 = 0;
					}
				}
			}
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 100f, 100f, 60f, false, true, 0))
			{
				set_ped_waypoint_route_offset(&(uLocal_372[1]), -2f, -4f, 0f);
				set_ped_waypoint_route_offset(&(uLocal_372[2]), 1.5f, -8f, 0f);
				set_ped_waypoint_route_offset(&(uLocal_372[3]), -3f, -12f, 0f);
			}
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 80f, 80f, 60f, false, true, 0))
			{
				waypoint_playback_override_speed(&(uLocal_372[0]), 2f, 1, -1f, 0);
				waypoint_playback_override_speed(&(uLocal_372[1]), 1.5f, 1, -1f, 0);
				waypoint_playback_override_speed(&(uLocal_372[2]), 1.5f, 1, -1f, 0);
				waypoint_playback_override_speed(&(uLocal_372[3]), 1f, 1, -1f, 0);
			}
			if (is_entity_at_coord(&(uLocal_372[0]), vLocal_674, 20f, 20f, 20f, false, true, 0) && iVar658 == 0)
			{
				func_228(2);
			}
			break;
...
void func_67()
{
	...
	switch (iVar583)
	{
		case 0:
			...
			remove_ped_from_group(&(uLocal_372[2]));
			remove_ped_from_group(&(uLocal_372[3]));
			set_current_ped_weapon(&(uLocal_372[3]), -1569615261, false, 0, false, false);
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			task_follow_nav_mesh_to_coord(0, -4368.33f, -2405.58f, 18.79f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_start_scenario_at_position(0, -1426662425, -4365.08f, -2417.43f, 19.85f, -73.97f, -1, true, false, 0, -1f, false);
			close_sequence_task(&(uLocal_685[0]));
			task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_follow_nav_mesh_to_coord(0, -4368.91f, -2425.94f, 18.8f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_start_scenario_at_position(0, -1569277059, -4368.03f, -2420.39f, 18.86f, -86.79f, -1, true, false, 0, -1f, false);
			close_sequence_task(&(uLocal_685[1]));
			task_perform_sequence(&(uLocal_372[1]), &(uLocal_685[1]));
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_follow_nav_mesh_to_coord(0, -4369.76f, -2423.44f, 18.82f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_start_scenario_at_position(0, -22664287, -4366.67f, -2420.06f, 18.88f, 155.34f, -1, true, false, 0, -1f, false);
			task_mount_animal(0, Local_211[2]->f_11, 20000, -1, 1f, 1, 0, 0);
			task_follow_to_offset_of_entity(0, &(uLocal_372[0]), 2f, -2f, 0f, 2f, -1, 1036831949, 1, 1, 1, 1, 1);
			close_sequence_task(&(uLocal_685[2]));
			task_perform_sequence(&(uLocal_372[2]), &(uLocal_685[2]));
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			task_follow_nav_mesh_to_coord(0, -4363.36f, -2433.84f, 18.87f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_swap_weapon(0, 1, 0, 0, 0);
			task_start_scenario_at_position(0, -1119935472, -4368.68f, -2417.14f, 19.4f, 117.93f, -1, true, false, 0, -1f, false);
			close_sequence_task(&(uLocal_685[3]));
			task_perform_sequence(&(uLocal_372[3]), &(uLocal_685[3]));
			clear_sequence_task(uLocal_685[3]);
			iLocal_585 = 2;
		...
		case 2:
			if (!func_208() && iVar658 == 0)
			{
				if (get_sequence_progress(&(uLocal_372[1])) >= 2 && get_sequence_progress(&(uLocal_372[2])) >= 2)
				{
					func_234();
				}
			}
...
void func_72()
{
	...
	iVar2 = -1;
	iVar3 = -1;
	iVar0 = func_242(uLocal_372[1], Local_421[1], 50f, &Local_527, &(Local_17.f_192), 0, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar1 = func_242(uLocal_372[0], Local_421[0], 50f, &Local_527, &(Local_17.f_192), 0, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar2 = func_242(uLocal_372[2], Local_421[2], 50f, &Local_527, &(Local_17.f_192), 0, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar3 = func_242(uLocal_372[3], Local_421[3], 50f, &Local_527, &(Local_17.f_192), 0, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	switch (iVar580)
	{
		case 0:
			switch (iVar581)
			...
			switch (iVar581)
			{
				case 0:
					switch (iVar0)
					{
						case 0:
							iLocal_663 = 1;
							func_245(Local_527[0], "RE_INTER_POS");
							func_136(Local_527[0], 0, 0);
							func_136(Local_527[1], 0, 0);
							iLocal_583 = 1;
							break;
						case 1:
							iLocal_583 = 2;
		...
		case 4:
			...
			break;
		case 6:
			func_206(Local_527[0], 1);
			func_206(Local_527[1], 1);
			func_206(Local_527[2], 1);
			break;
		case 5:
			func_136(Local_527[0], 0, 0);
			func_136(Local_527[1], 0, 0);
			func_136(Local_527[2], 0, 0);
			break;
	}
}
...
void func_74()
{
	iVar0 = get_ped_nearby_peds(&(uLocal_372[0]), &uVar2, -1, -1);
	if (iVar0 > 0)
	{
		iVar1 = 0;
		while (iVar1 < 10)
		{
			if (((!is_entity_dead(&(uVar2[iVar1])) && is_ped_human(&(uVar2[iVar1]))) && does_entity_exist(&(uVar2[iVar1]))) && func_247(&(uVar2[iVar1])))
			{
				if (func_248(&(uVar2[iVar1])) && func_249(&(uVar2[iVar1])))
				{
					iLocal_661 = 1;
					if (&uVar2[iVar1] == Global_35 && iVar660 == 1)
					{
						iLocal_661 = 0;
					}
					if (iVar660 == 0)
...
void func_75()
{
	...
	iVar3 = -1;
	iVar4 = -1;
	iVar0 = func_242(uLocal_372[3], Local_421[3], 50f, &Local_527, &(Local_17.f_192), 0f, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar1 = func_242(uLocal_372[0], Local_421[0], 50f, &Local_527, &(Local_17.f_192), 0f, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar2 = func_242(uLocal_372[1], Local_421[1], 50f, &Local_527, &(Local_17.f_192), 0f, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar3 = func_242(uLocal_372[2], Local_421[2], 50f, &Local_527, &(Local_17.f_192), 0f, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	iVar4 = func_242(uLocal_372[4], Local_421[4], 50f, &Local_527, &(Local_17.f_192), 0f, 1, 0, 0, func_241(3, 0, 0) | 524288, 0, 0, 2, 1, -1082130432, 0);
	switch (iVar580)
	{
		case 0:
			switch (iVar581)
			{
				...
				case 4:
					if (func_202(-4f, 1, &(uLocal_372[3]), 1))
					{
						...
						func_136(Local_527[0], 1, 0);
						func_136(Local_527[1], 1, 0);
						Local_527[0]->f_13 = func_134(48);
						Local_527[1]->f_13 = func_134(50);
						iLocal_582 = 1;
						iLocal_583 = 0;
					}
					break;
...
void func_77()
{
	if (iVar699 != 0)
	{
		iLocal_701 = add_shocking_event_for_entity(1498498500, &(uLocal_372[0]), 0f, 50f, 50f, 15f, -1f, 180f, false, false, -1, -1);
	}
}
...
char* func_87(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_253(sParam1));
}
...
void func_105(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_270(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_271(iParam0, 0);
		}
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_272((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_270(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
void func_110(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		iVar0 = _create_volume_cylinder_with_custom_name(*uParam1, 0f, 0f, 0f, fVar4, fVar4, fVar4, func_188());
		if (func_278(Global_1310750[iParam0], 33554432))
		{
...
bool func_111(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_281(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_51(iParam0, 16))
	{
		...
		fVar2 = to_float(func_282(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
int func_128(bool bParam0)
{
	...
	get_group_size(func_299(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_299(), iVar3);
		if (func_300(iVar4))
		{
			iVar0++;
		}
...
void func_132(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		func_306(&((*uParam0)[iVar0]->f_1));
		func_306(&((*uParam0)[iVar0]->f_12));
		iVar0++;
	}
}
	...
	if (!does_entity_exist(*uParam1) && uParam0->f_1 != 0)
	{
		...
		else
		{
			if (has_model_loaded(uParam0->f_1))
			{
				...
				*uParam1 = func_316(uParam0->f_1, uParam0, Var2, Var2.f_3, iParam7, _is_this_model_a_horse(uParam0->f_1), uParam0->f_14, 0, 1);
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_324(iVar3) || _0xf2f585411e748b9c(iVar0, 0) > _0xf2f585411e748b9c(iVar3, 0))
		{
			iVar3 = iVar0;
		}
	}
	...
	{
		if (!func_324(iVar3) || _0xf2f585411e748b9c(iVar2, 0) > _0xf2f585411e748b9c(iVar3, 0))
		{
			iVar3 = iVar2;
		}
	}
...
int func_143(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_324(iVar5) || _0xf2f585411e748b9c(iVar1, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar1;
		}
	}
	...
	{
		if (!func_324(iVar5) || _0xf2f585411e748b9c(iVar3, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar3;
		}
	}
	...
	{
		if (!func_324(iVar5) || _0xf2f585411e748b9c(iVar2, 0) > _0xf2f585411e748b9c(iVar5, 0))
		{
			iVar5 = iVar2;
		}
	}
...
void func_150(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!func_92(uParam0))
	{
...
void func_158(int iParam0, int iParam1)
{
	...
	func_339(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_340(iParam0, 0);
	func_341(iParam0);
	func_342(1);
...
{
	if (uParam0->f_177 != -1 || func_278(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_350(uParam0->f_177));
			}
		}
	}
...
bool func_175(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_366(&(Global_1898164->f_1[0]));
		if (func_367(iVar0) && func_368((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
	if (iParam0 == 0 && func_369(&(Global_1898164->f_1[0])))
	{
		return true;
	}
...
int func_192()
{
	if ((func_377(&uLocal_372, &(Local_17.f_5), &uLocal_601, &uLocal_642, 0, 4, 1) || func_378()) || func_379())
	{
		Local_17.f_46 = 1;
		func_191(3);
		return 1;
...
void func_193(int iParam0)
{
	...
	if (!func_151(&uLocal_605) && ((((is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[0]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[1]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[2]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[3]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[4]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)))
	{
		func_152(&uLocal_605);
		iLocal_659 = 1;
	}
	...
	{
		if ((((((is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[0]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[1]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[2]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[3]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[4]), true, false), IntToFloat(iParam0), IntToFloat(iParam0), 2f, false, true, 0)) && iVar656 == 1) && func_380())
		{
			if (iVar651 == 0)
			{
			}
...
void func_194()
{
	...
	{
		case 0:
			if (is_waypoint_playback_going_on_for_ped(&(uLocal_372[0]), 0))
			{
				waypoint_playback_override_speed(&(uLocal_372[0]), 1.75f, 1, -1f, 0);
			}
			else
			{
				_0xbaab791aa72c2821(&(uLocal_372[0]), 1.75f);
			}
		...
		case 1:
			if (is_waypoint_playback_going_on_for_ped(&(uLocal_372[0]), 0))
			{
				waypoint_playback_override_speed(&(uLocal_372[0]), 2.001f, 1, -1f, 0);
			}
			else
			{
				_0xbaab791aa72c2821(&(uLocal_372[0]), 2.001f);
			}
			break;
	}
}
...
bool func_195()
{
	switch (iVar585)
	{
		case 0:
			if (iVar664 == 0)
			{
				if (get_distance_between_coords(get_entity_coords(&(uLocal_372[0]), true, false), vLocal_674, true) <= fVar651)
				{
					iLocal_587 = 1;
				}
			}
			break;
		case 1:
			if ((is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[0]), true, false), 30f, 30f, 2f, false, true, 0) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[4]), true, false), 30f, 30f, 2f, false, true, 0)) || is_entity_at_coord(Global_35, get_entity_coords(&(uLocal_372[2]), true, false), 30f, 30f, 2f, false, true, 0))
			{
...
{
	func_225(70);
	set_ped_max_move_blend_ratio(&(uLocal_372[0]), 1.5f);
	waypoint_playback_override_speed(&(uLocal_372[0]), 1.5f, 1, -1f, 0);
	switch (iVar642)
	{
		case 0:
			if (func_202(-4f, 1, 0, 0))
			{
				trigger_music_event("REDLP_START");
				Local_17.f_44 = 1;
				iLocal_660 = 1;
				iLocal_582 = 5;
				func_245(Local_527[0], "RE_INTER_POS");
				func_245(Local_527[1], "RE_INTER_ANTAGONIZE");
...
bool func_198(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		if (iParam4 > 1)
		{
			...
			{
				func_165(uParam0->f_121[iVar0], fVar3, 1082130432, 1, 90f, 0, 0);
				iVar0++;
			}
		}
		else
		{
			func_165(uParam0->f_121[0], fVar3, 1082130432, 1, 90f, 0, 0);
		}
				...
				case 2:
					if (iVar668 == 0)
					{
						if (bVar660)
						{
							trigger_music_event("REDLP_START");
							Local_17.f_44 = 1;
							func_206(Local_527[0], 0);
							func_206(Local_527[1], 0);
							func_136(Local_527[0], 1, 0);
							func_136(Local_527[1], 1, 0);
							func_245(Local_527[0], "INTERACT_DEFUSE");
							func_245(Local_527[1], "INTERACT_INSULT");
							Local_527[0]->f_13 = func_134(69);
							Local_527[1]->f_13 = func_134(70);
							iLocal_582 = 3;
							iLocal_583 = 0;
							iLocal_670 = 1;
						}
...
void func_203()
{
	...
	switch (iVar645)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_388(player_id(), &(uLocal_372[3]), Local_421[3]) || func_202(0f, 1, 0, 0))
			{
				if (func_202(-3f, 1, 0, 0))
				{
					func_152(&uLocal_633);
					func_387(&(uLocal_372[0]));
					waypoint_playback_start_aiming_at_ped(&(uLocal_372[3]), Global_35, 1, -1082130432);
					...
					if (iVar661 == 0)
					{
						...
						func_136(Local_527[0], 1, 0);
						func_136(Local_527[1], 1, 0);
						Local_527[0]->f_13 = func_134(52);
						Local_527[1]->f_13 = func_134(54);
						iLocal_582 = 3;
					}
					uLocal_647 = iVar645 + 1;
				}
...
void func_205()
{
	switch (Local_17.f_51.f_4)
	{
		...
		case 20:
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			task_follow_nav_mesh_to_coord(0, -2320.43f, -3089.87f, -6.34f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_start_scenario_at_position(0, 1455795772, -2321.85f, -3096.19f, -7.97f, -145f, 20000, true, false, 0, -1f, false);
			task_start_scenario_at_position(0, -1124614608, -2319.07f, -3093.44f, -7.21f, -27.89f, 30000, true, false, 0, -1f, false);
			task_pause(0, 200);
			close_sequence_task(&(uLocal_685[0]));
			task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_follow_nav_mesh_to_coord(0, -2310.82f, -3084.48f, -4.9f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[1]));
			task_perform_sequence(&(uLocal_372[1]), &(uLocal_685[1]));
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_follow_nav_mesh_to_coord(0, -2312.19f, -3086.96f, -5.38f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[2]));
			task_perform_sequence(&(uLocal_372[2]), &(uLocal_685[2]));
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			task_follow_nav_mesh_to_coord(0, -2314.98f, -3084.3f, -5.1f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[3]));
			task_perform_sequence(&(uLocal_372[3]), &(uLocal_685[3]));
			clear_sequence_task(uLocal_685[3]);
		...
		case 19:
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			task_follow_nav_mesh_to_coord(0, -2754.68f, -2366.8f, 43.12f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			task_start_scenario_at_position(0, 1455795772, -2752.66f, -2361.89f, 43.38f, 24.65f, 20000, true, false, 0, -1f, false);
			task_start_scenario_at_position(0, -1124614608, -2753.99f, -2364.96f, 43.13f, -112.44f, 30000, true, false, 0, -1f, false);
			task_pause(0, 200);
			close_sequence_task(&(uLocal_685[0]));
			task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_follow_nav_mesh_to_coord(0, -2739.35f, -2360.13f, 44.11f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[1]));
			task_perform_sequence(&(uLocal_372[1]), &(uLocal_685[1]));
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_follow_nav_mesh_to_coord(0, -2737.8f, -2361.36f, 44.11f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[2]));
			task_perform_sequence(&(uLocal_372[2]), &(uLocal_685[2]));
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			task_follow_nav_mesh_to_coord(0, -2735.92f, -2362.86f, 44.11f, 1.5f, -1, 0.25f, 1048580, 40000f);
			task_dismount_animal(0, 0, 0, 0, 0, 0);
			close_sequence_task(&(uLocal_685[3]));
			task_perform_sequence(&(uLocal_372[3]), &(uLocal_685[3]));
			clear_sequence_task(uLocal_685[3]);
...
void func_207()
{
	...
	while (iVar4 < 3)
	{
		if (iVar650 < 4)
		{
			if (!is_ped_on_mount(&(uVar0[iVar4])))
			{
				if (!func_217(&(uVar0[iVar4]), -76381094))
				{
					_task_use_scenario_point(&(uVar0[iVar4]), &(uLocal_691[iVar650]), 0, 58000, true, false, 0, false, -1f, false);
					iLocal_652 = iVar650 + 1;
				}
			}
		}
		iVar4++;
...
bool func_208()
{
	...
	while (iVar0 <= 4)
	{
		if (does_entity_exist(&(uLocal_372[iVar0])))
		{
			vVar1 = { get_entity_coords(&(uLocal_372[iVar0]), true, false) };
			if (get_distance_between_coords(vVar1, Global_36, true) <= 15f && has_entity_clear_los_to_entity_in_front(&(uLocal_372[iVar0]), Global_35, 17))
			{
				return true;
			}
			if (is_entity_at_coord(Global_35, vVar1, vLocal_671, false, true, 0))
			{
				return true;
			}
		}
...
void func_211()
{
	switch (&iLocal_588[0])
	{
		case 0:
			func_22(Local_421[0], &Local_527);
			func_215(uLocal_372[0]);
			func_152(vLocal_617[0]);
			func_142(&(uLocal_372[0]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			iLocal_588[0] = 1;
			break;
		case 1:
			if (func_244(vLocal_617[0]) >= 0.8f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[0]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[0]), Global_35, 3, 2, 1000f, 1, 0, 0, 0);
				}
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[0]), 0) || func_244(vLocal_617[0]) >= 1f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[0]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[0] = 3;
			}
	...
	switch (&iLocal_588[1])
	{
		case 0:
			func_22(Local_421[1], &Local_527);
			func_215(uLocal_372[1]);
			func_152(vLocal_617[1]);
			func_142(&(uLocal_372[1]), func_143(0, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			iLocal_588[1] = 1;
			break;
		case 1:
			if (func_244(vLocal_617[1]) >= 0.3f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[1]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[1]), Global_35, 3, 2, 1500f, 1, 0, 0, 0);
				}
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[1]), 0) || func_244(vLocal_617[1]) >= 1.5f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[1]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[1] = 3;
			}
	...
	switch (&iLocal_588[2])
	{
		case 0:
			func_22(Local_421[2], &Local_527);
			func_215(uLocal_372[2]);
			_0x8acc0506743a8a5c(&(uLocal_372[2]), 166028666, 1, -1082130432);
			func_142(&(uLocal_372[2]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_152(vLocal_617[2]);
			iLocal_588[2] = 1;
			break;
		case 1:
			if (func_244(vLocal_617[2]) >= 0.5f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[2]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[2]), Global_35, 3, 2, 2000f, 1, 0, 0, 0);
				}
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[2]), 0) || func_244(vLocal_617[2]) >= 2f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[2]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[2] = 3;
			}
		...
		case 3:
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_aim_gun_at_entity(0, Global_35, 2000, 0, 3);
	...
	switch (&iLocal_588[3])
	{
		case 0:
			func_22(Local_421[3], &Local_527);
			func_215(uLocal_372[3]);
			_0x8acc0506743a8a5c(&(uLocal_372[3]), 166028666, 1, -1082130432);
			func_142(&(uLocal_372[3]), func_143(0, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_152(vLocal_617[3]);
			iLocal_588[3] = 1;
			break;
		case 1:
			if (func_244(vLocal_617[3]) >= 0f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[3]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[3]), Global_35, 3, 2, 2500f, 1, 0, 0, 0);
				}
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[3]), 0) || func_244(vLocal_617[3]) >= 2.5f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[3]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[3] = 3;
			}
...
void func_212()
{
	clear_sequence_task(uLocal_685[0]);
	open_sequence_task(uLocal_685[0]);
	task_mount_animal(0, Local_211[0]->f_11, 20000, -1, 1f, 1, 0, 0);
	close_sequence_task(&(uLocal_685[0]));
	task_perform_sequence(&(uLocal_372[0]), &(uLocal_685[0]));
	clear_sequence_task(uLocal_685[0]);
	clear_sequence_task(uLocal_685[1]);
	open_sequence_task(uLocal_685[1]);
	task_mount_animal(0, Local_211[1]->f_11, 20000, -1, 1f, 1, 0, 0);
	close_sequence_task(&(uLocal_685[1]));
	_task_perform_sequence_2(&(uLocal_372[1]), &(uLocal_685[1]), 0.4f, 0.4f);
	clear_sequence_task(uLocal_685[1]);
	clear_sequence_task(uLocal_685[2]);
	open_sequence_task(uLocal_685[2]);
	task_mount_animal(0, Local_211[2]->f_11, 20000, -1, 1f, 1, 0, 0);
	close_sequence_task(&(uLocal_685[2]));
	_task_perform_sequence_2(&(uLocal_372[2]), &(uLocal_685[2]), 0.8f, 0.8f);
	clear_sequence_task(uLocal_685[2]);
	clear_sequence_task(uLocal_685[3]);
	open_sequence_task(uLocal_685[3]);
	task_mount_animal(0, Local_211[3]->f_11, 20000, -1, 1f, 1, 0, 0);
	close_sequence_task(&(uLocal_685[3]));
	_task_perform_sequence_2(&(uLocal_372[3]), &(uLocal_685[3]), 1.2f, 1.2f);
	clear_sequence_task(uLocal_685[3]);
}
...
void func_213()
{
	if (iVar662 == 0)
	{
		...
		while (iVar0 < 5)
		{
			if (!is_entity_dead(&(uLocal_372[iVar0])) && does_entity_exist(&(uLocal_372[iVar0])))
			{
				func_391(&(uLocal_372[iVar0]), 0, &(Local_17.f_5), &uLocal_601, 0, 0);
				if (_is_ped_hogtied(&(uLocal_372[iVar0])) || _is_ped_lassoed(&(uLocal_372[iVar0])))
				{
					if (iVar653 == 0)
					{
						iLocal_655 = 1;
				...
				if ((((((((iVar599 == 4 || iVar599 == 256) || iVar599 == 0) || iVar599 == 1) || iVar599 == 2) || iVar599 == 2048) || iVar599 == 1024) || iVar599 == 16) || has_entity_been_damaged_by_entity(&(uLocal_372[iVar0]), Global_35, 1, 1))
				{
					if (iVar655 == 0)
					{
						iLocal_657 = 1;
				...
				if (_0x29fce825613fefca(&(uLocal_372[iVar0]), 500) || _0xd0b7aeb56229d317(Global_35) == &uLocal_372[iVar0])
				{
					if (iVar656 == 0)
					{
						iLocal_658 = 1;
...
void func_214()
{
	if (is_ped_on_mount(Global_35))
	{
		if (get_ped_desired_move_blend_ratio(get_mount(Global_35)) < 2f)
		{
			return;
		}
	}
	...
	switch (iVar678)
	{
		case 0:
			if (func_202(0f, 1, &(uLocal_372[iVar0]), 1))
			{
				...
				uLocal_680 = iVar678 + 1;
				func_152(&uLocal_681);
				iLocal_684 = get_random_int_in_range(8, 15);
			}
			break;
		case 1:
			if (func_244(&uLocal_681) > IntToFloat(iVar682))
			{
				uLocal_680 = iVar678 + 1;
			}
			break;
...
void func_216()
{
	if (is_entity_playing_anim(&(uLocal_372[0]), &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		stop_anim_task(&(uLocal_372[0]), &(Local_409[0]), Local_409[0]->f_1, -1.5f);
	}
	if (is_entity_playing_anim(&(uLocal_372[1]), &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		stop_anim_task(&(uLocal_372[1]), &(Local_409[0]), Local_409[0]->f_1, -1.5f);
	}
	if (is_entity_playing_anim(&(uLocal_372[2]), &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		stop_anim_task(&(uLocal_372[2]), &(Local_409[0]), Local_409[0]->f_1, -1.5f);
	}
	if (is_entity_playing_anim(&(uLocal_372[3]), &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		stop_anim_task(&(uLocal_372[3]), &(Local_409[0]), Local_409[0]->f_1, -1.5f);
	}
	if (is_entity_playing_anim(&(uLocal_372[4]), &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		stop_anim_task(&(uLocal_372[4]), &(Local_409[0]), Local_409[0]->f_1, -1.5f);
	}
}
...
bool func_218()
{
	if (((((is_ped_dead_or_dying(&(uLocal_372[0]), true) || _is_ped_hogtied(&(uLocal_372[0]))) && (is_ped_dead_or_dying(&(uLocal_372[1]), true) || _is_ped_hogtied(&(uLocal_372[1])))) && (is_ped_dead_or_dying(&(uLocal_372[2]), true) || _is_ped_hogtied(&(uLocal_372[2])))) && (is_ped_dead_or_dying(&(uLocal_372[3]), true) || _is_ped_hogtied(&(uLocal_372[3])))) && (is_ped_dead_or_dying(&(uLocal_372[4]), true) || _is_ped_hogtied(&(uLocal_372[4]))))
	{
		return true;
	}
	return false;
...
void func_224()
{
	func_225(60);
	waypoint_playback_override_speed(&(uLocal_372[0]), 1.5f, 1, -1f, 0);
	set_ped_reset_flag(&(uLocal_372[0]), 27, true);
	set_ped_reset_flag(&(uLocal_372[1]), 27, true);
	set_ped_reset_flag(&(uLocal_372[2]), 27, true);
	set_ped_reset_flag(&(uLocal_372[3]), 27, true);
	set_ped_reset_flag(&(uLocal_372[4]), 27, true);
	switch (iVar645)
	{
		case 0:
			trigger_music_event("REDLP_START");
		...
		case 4:
			...
			if ((((func_233(&(uLocal_372[1]), 1, 1) <= 20f || func_233(&(uLocal_372[0]), 1, 1) <= 20f) || func_233(&(uLocal_372[2]), 1, 1) <= 20f) || func_233(&(uLocal_372[3]), 1, 1) <= 20f) || func_233(&(uLocal_372[4]), 1, 1) <= 20f)
			{
				...
				{
					if (func_153(&uLocal_614) >= 7f || (bVar664 && func_153(&uLocal_614) >= 2f))
					{
...
void func_227(int iParam0, int iParam1, float fParam2)
{
	...
	if ((((iVar596 == 4 || iVar596 == 256) || iVar596 == 1) || iVar596 == 16) || iVar596 == 2)
	{
		task_combat_ped(0, Global_35, 16793600, 16);
	}
	else
	...
	_task_perform_sequence_2(iParam0, iParam1, fParam2, fParam2);
	clear_sequence_task(&iParam1);
	_0x712b2c2b2471b493(iParam0, -1722884127);
}
		...
		case 1:
			if (!func_388(player_id(), &(uLocal_372[3]), Local_421[3]) || func_202(0f, 1, 0, 0))
			{
				if ((func_202(-4f, 1, &(uLocal_372[3]), 1) && func_202(-4f, 1, Global_35, 1)) && func_202(-2f, 1, 0, 0))
				{
					func_387(&(uLocal_372[0]));
					func_387(&(uLocal_372[1]));
					task_follow_entity_while_aiming_at_entity(&(uLocal_372[3]), &(uLocal_372[0]), Global_35, 0, -1, 0.5f, 2f, 0);
					task_follow_entity_while_aiming_at_entity(&(uLocal_372[2]), &(uLocal_372[0]), Global_35, 0, -1, 0.5f, 2f, 0);
					iLocal_667 = 1;
					func_152(&uLocal_633);
					func_204(&(uLocal_372[3]), Global_35, func_134(40), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					if (iVar661 == 0)
...
void func_236()
{
	switch (&iLocal_588[0])
	{
		case 0:
			...
			break;
		case 1:
			if (func_244(vLocal_617[0]) >= 0f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[0]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[0]), Global_35, 3, 2, 500f, 1, 0, 0, 0);
				}
				func_390(&(uLocal_372[0]), Global_35, &uLocal_384, -1, 30);
				func_152(vLocal_617[0]);
				iLocal_588[0] = 2;
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[0]), 0) || func_244(vLocal_617[0]) >= 0.5f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[0]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[0] = 3;
			}
	...
	switch (&iLocal_588[1])
	{
		...
		case 1:
			if (func_244(vLocal_617[1]) >= 0.3f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[1]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[1]), Global_35, 3, 2, 1000f, 1, 0, 0, 0);
				}
				func_390(&(uLocal_372[1]), Global_35, &uLocal_384, -1, 30);
				func_152(vLocal_617[1]);
				iLocal_588[1] = 2;
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[1]), 0) || func_244(vLocal_617[1]) >= 1f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[1]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[1] = 3;
			}
	...
	switch (&iLocal_588[2])
	{
		...
		case 1:
			if (func_244(vLocal_617[2]) >= 0.5f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[2]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[2]), Global_35, 3, 2, 1500f, 1, 0, 0, 0);
				}
				func_390(&(uLocal_372[2]), Global_35, &uLocal_384, -1, 30);
				func_152(vLocal_617[2]);
				iLocal_588[2] = 2;
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[2]), 0) || func_244(vLocal_617[2]) >= 1.5f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[2]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[2] = 3;
			}
	...
	switch (&iLocal_588[3])
	{
		case 0:
			...
			func_215(uLocal_372[3]);
			_0x8acc0506743a8a5c(&(uLocal_372[3]), 166028666, 1, -1082130432);
			func_142(&(uLocal_372[3]), func_141(268435456, 1056964608, 1065353216), 100, 1, 0, 1056964608, 1065353216, 0);
			func_152(vLocal_617[3]);
			iLocal_588[3] = 1;
			break;
		case 1:
			if (func_244(vLocal_617[3]) >= 0.5f)
			{
				if (is_ped_active_in_scenario(&(uLocal_372[3]), 0))
				{
					_0xe7fa07624574b79a(&(uLocal_372[3]), Global_35, 3, 2, 2000f, 1, 0, 0, 0);
				}
				func_390(&(uLocal_372[3]), Global_35, &uLocal_384, -1, 30);
				func_152(vLocal_617[3]);
				iLocal_588[3] = 2;
			...
			break;
		case 2:
			if (!_0x916b8e075abc8b4e(&(uLocal_372[3]), 0) || func_244(vLocal_617[3]) >= 2f)
			{
				_0x802092b07e3b1eea(&(uLocal_372[2]), get_entity_coords(Global_35, true, false), 3);
				iLocal_588[3] = 3;
			}
...
{
	if (func_272(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
int func_249(int iParam0)
{
	...
	{
		case 0:
			if ((is_ped_facing_ped(&(uLocal_372[0]), iParam0, 80f) || is_ped_facing_ped(&(uLocal_372[1]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[2]), iParam0, 80f))
			{
				return 1;
			}
			break;
		case 1:
			if ((((is_ped_facing_ped(&(uLocal_372[0]), iParam0, 80f) || is_ped_facing_ped(&(uLocal_372[1]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[2]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[3]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[4]), iParam0, 80f))
			{
				return 1;
			}
			break;
		case 2:
			if (((is_ped_facing_ped(&(uLocal_372[0]), iParam0, 80f) || is_ped_facing_ped(&(uLocal_372[1]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[2]), iParam0, 80f)) || is_ped_facing_ped(&(uLocal_372[3]), iParam0, 80f))
			{
				return 1;
			}
			break;
...
void func_250()
{
	...
	task_horse_action(0, 1, Global_35, 0);
	close_sequence_task(iVar3);
	task_perform_sequence(Local_211[3]->f_11, iVar3);
	clear_sequence_task(&iVar3);
	clear_sequence_task(&iVar0);
	open_sequence_task(&iVar0);
	task_horse_action(0, 3, Global_35, 0);
	close_sequence_task(iVar0);
	_task_perform_sequence_2(Local_211[0]->f_11, iVar0, 0.5f, 0.5f);
	clear_sequence_task(&iVar0);
	clear_sequence_task(&iVar1);
	open_sequence_task(&iVar1);
	task_horse_action(0, 5, Global_35, 0);
	close_sequence_task(iVar1);
	_task_perform_sequence_2(Local_211[1]->f_11, iVar1, 1f, 1f);
	clear_sequence_task(&iVar1);
	clear_sequence_task(&iVar2);
	open_sequence_task(&iVar2);
	task_horse_action(0, 7, Global_35, 0);
	close_sequence_task(iVar2);
	_task_perform_sequence_2(Local_211[2]->f_11, iVar2, 1.5f, 1.5f);
	clear_sequence_task(&iVar2);
	clear_sequence_task(&iVar4);
	open_sequence_task(&iVar4);
	task_horse_action(0, 1, Global_35, 0);
	close_sequence_task(iVar4);
	_task_perform_sequence_2(Local_211[4]->f_11, iVar4, 2.5f, 2.5f);
	clear_sequence_task(&iVar4);
}
...
void func_289(int iParam0, vector3 vParam1, int iParam4, float fParam5, bool bParam6, int iParam7)
{
	...
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_295(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_414();
	...
	else if (fVar0 > iParam4->f_2 || (!func_295(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_414();
		iParam4->f_2 = func_382(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_295(vector3 vParam0, int iParam3)
{
	...
	return func_419(vVar0, vParam0) > func_419(vVar0, get_entity_coords(iParam3, true, false));
}
...
int func_316(int iParam0, var uParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9, int iParam10)
{
	...
	else
	{
		...
		if (!is_string_null_or_empty(&(uParam1->f_23)) && !func_429(iVar0))
		{
		...
		if (func_430(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(iVar0, 186, !func_431(&(uParam1->f_22)));
		...
		set_ped_config_flag(iVar0, 6, func_437(&(uParam1->f_22)));
		...
		if (!func_429(iVar0))
		{
			...
			set_ped_config_flag(iVar0, 4, func_440(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 297, !func_441(&(uParam1->f_22)));
			set_ped_config_flag(iVar0, 317, !func_441(&(uParam1->f_22)));
...
void func_339(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_267(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_345(int iParam0)
{
	...
	if (!func_123(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_346(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_462(to_float(iVar0), 1, 0);
	}
	else
	{
		func_462((to_float(200) / 3f), 1, 0);
	}
}
...
int func_377(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_378()
{
	if ((((func_466(Global_35, Local_211[0]->f_11, 0) || func_466(Global_35, Local_211[1]->f_11, 0)) || func_466(Global_35, Local_211[2]->f_11, 0)) || func_466(Global_35, Local_211[3]->f_11, 0)) || func_466(Global_35, Local_211[4]->f_11, 0))
	{
		func_225(15);
		func_251();
		return 1;
...
int func_379()
{
	if (((((does_entity_exist(Local_211[0]->f_11) && _is_ped_lassoed(Local_211[0]->f_11)) || (does_entity_exist(Local_211[1]->f_11) && _is_ped_lassoed(Local_211[1]->f_11))) || (does_entity_exist(Local_211[2]->f_11) && _is_ped_lassoed(Local_211[2]->f_11))) || (does_entity_exist(Local_211[3]->f_11) && _is_ped_lassoed(Local_211[3]->f_11))) || (does_entity_exist(Local_211[4]->f_11) && _is_ped_lassoed(Local_211[4]->f_11)))
	{
		func_225(15);
		func_251();
		return 1;
...
bool func_380()
{
	if ((((has_entity_clear_los_to_entity_in_front(&(uLocal_372[0]), Global_35, 17) || has_entity_clear_los_to_entity_in_front(&(uLocal_372[1]), Global_35, 17)) || has_entity_clear_los_to_entity_in_front(&(uLocal_372[2]), Global_35, 17)) || has_entity_clear_los_to_entity_in_front(&(uLocal_372[3]), Global_35, 17)) || has_entity_clear_los_to_entity_in_front(&(uLocal_372[4]), Global_35, 17))
	{
		return true;
	}
	return false;
...
bool func_381()
{
	if (((((!is_ped_facing_ped(player_ped_id(), &(uLocal_372[0]), 80f) && !is_ped_facing_ped(player_ped_id(), &(uLocal_372[1]), 80f)) && !is_ped_facing_ped(player_ped_id(), &(uLocal_372[2]), 80f)) && !is_ped_facing_ped(player_ped_id(), &(uLocal_372[3]), 80f)) && !is_ped_facing_ped(player_ped_id(), &(uLocal_372[4]), 80f)) && get_ped_desired_move_blend_ratio(Global_35) >= 1f)
	{
		return true;
	}
	return false;
...
void func_383()
{
	if (bVar666)
	{
		if (get_distance_between_coords(get_entity_coords(Global_35, true, false), get_entity_coords(&(uLocal_372[0]), true, false), true) >= 60f)
		{
			func_467(1891783641, get_entity_coords(&(uLocal_372[0]), true, false), 1);
		}
		else
		{
			iLocal_668 = 0;
...
{
	if (!is_entity_playing_anim(iParam0, &(Local_409[0]), Local_409[0]->f_1, 1))
	{
		task_play_anim(iParam0, &(Local_409[0]), Local_409[0]->f_1, 1.5f, -1.5f, -1, 16, 0f, false, 0, false, "RightArmOnly_Filter", false);
	}
}
...
int func_389(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_475(func_474(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_391(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_478(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630->f_26 && func_169(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_482(iParam2, 1065353216))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
void func_393()
{
	...
	switch (iVar594)
	{
		...
		case 1:
			...
			close_sequence_task(&(uLocal_685[0]));
			_task_perform_sequence_2(&(uLocal_372[0]), &(uLocal_685[0]), fVar0, fVar0);
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_confront(0, Global_35, 128);
			close_sequence_task(&(uLocal_685[1]));
			_task_perform_sequence_2(&(uLocal_372[1]), &(uLocal_685[1]), fVar1, fVar1);
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
			open_sequence_task(uLocal_685[2]);
			task_confront(0, Global_35, 2);
			close_sequence_task(&(uLocal_685[2]));
			_task_perform_sequence_2(&(uLocal_372[2]), &(uLocal_685[2]), fVar2, fVar2);
			clear_sequence_task(uLocal_685[2]);
			clear_sequence_task(uLocal_685[3]);
			open_sequence_task(uLocal_685[3]);
			task_confront(0, Global_35, 128);
			close_sequence_task(&(uLocal_685[3]));
			_task_perform_sequence_2(&(uLocal_372[3]), &(uLocal_685[3]), fVar3, fVar3);
			clear_sequence_task(uLocal_685[3]);
			clear_sequence_task(uLocal_685[4]);
			open_sequence_task(uLocal_685[4]);
			task_confront(0, Global_35, 128);
			close_sequence_task(&(uLocal_685[4]));
			_task_perform_sequence_2(&(uLocal_372[4]), &(uLocal_685[4]), fVar4, fVar4);
			clear_sequence_task(uLocal_685[4]);
			iLocal_596 = 3;
			break;
		case 3:
		...
		case 2:
			clear_sequence_task(uLocal_685[0]);
			open_sequence_task(uLocal_685[0]);
			task_follow_and_converse_with_ped(0, Global_35, 0, 0, -1082130432, -1082130432, 8, 0, 0, 5f, 15f);
			close_sequence_task(&(uLocal_685[0]));
			_task_perform_sequence_2(&(uLocal_372[0]), &(uLocal_685[0]), fVar0, fVar0);
			clear_sequence_task(uLocal_685[0]);
			clear_sequence_task(uLocal_685[1]);
			open_sequence_task(uLocal_685[1]);
			task_follow_entity_while_aiming_at_entity(0, Global_35, Global_35, 0, -1, 15f, 2f, 8);
			close_sequence_task(&(uLocal_685[1]));
			_task_perform_sequence_2(&(uLocal_372[1]), &(uLocal_685[1]), fVar1, fVar1);
			clear_sequence_task(uLocal_685[1]);
			clear_sequence_task(uLocal_685[2]);
...
int func_397(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_99(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_509(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
float func_401(int iParam0)
{
	if (is_ped_on_mount(Global_35))
	{
		fVar0 = get_ped_desired_move_blend_ratio(get_mount(iParam0));
		if (fVar0 == 0f)
		{
			fVar1 = 8f;
		}
	...
	{
		fVar0 = get_ped_desired_move_blend_ratio(iParam0);
		if (fVar0 == 0f)
		{
			fVar1 = 5f;
		}
...
void func_408(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_339(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_340(iParam0, 1);
	if (!bParam2)
	{
		func_405(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_533(iParam0))
		{
...
bool func_417(vector3 vParam0)
{
	...
	{
		if (!func_45(*Global_1310750->f_16043[iVar0]))
		{
			if (func_71(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
void func_422(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_540(iParam0, 8))
		{
...
void func_453(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_278(Global_1310750[iVar0], iParam0))
		{
			if (!func_266(iVar0))
			{
				iVar1 = 1;
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_173(1) || *iParam0 & 8192 != 0))
				{
...
bool func_480(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_576(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_574(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_575(iParam2)
				{
					func_571(iParam2, 1);
					return true;
				}
...
bool func_481(int iParam0, int iParam1)
{
	...
	if (func_567(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_575(iParam1)
		{
...
int func_502(int iParam0, int iParam1)
{
	...
	{
		return func_598(iParam0, iParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_504(int iParam0, int iParam1, bool bParam2)
{
	...
	if (absf(fVar12) > fVar13)
	{
		...
		else if (func_600(vVar0, vVar0 + vVar6, get_entity_coords(iParam1, true, false)))
		{
			iLocal_595 = 1;
		}
		else
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_2(iParam4, 268435456))
			{
				...
				if (iVar8 > -1)
				{
					func_606(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_512(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((_is_ped_carrying(Global_35) || func_610(Global_35)) || func_611(Global_35)) || func_612(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_272((*uParam4)[iVar0]->f_6);
		func_613(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_614(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_615(iParam12, (*uParam4)[iVar0]->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_105(iParam1, uParam4, is_bit_set(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_517(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_613(iParam0, (*uParam2)[iVar0], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
void func_523(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_629(iVar0), func_299(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_631() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_631();
					}
					func_632(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_252(&(Global_1415419->f_19[iVar0]->f_11), 2);
				}
			}
			iVar0++;
		}
...
void func_551(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_465(_get_weapon_clip_size(iParam0), iParam1);
...
bool func_572(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_395(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_657(iVar0, 0)))
		{
...
bool func_576(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_657(iVar0, 0)))
		{
			if (func_659(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_593(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_395(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
bool func_601(int iParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (is_ped_in_combat(iParam0, func_665((bVar1 && !bVar0), Global_35, 0)))
		{
			return true;
		}
	}
...
int func_603(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_666(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_272((*uParam2)[iVar0]->f_6))
		{
...
void func_608(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_666(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
void func_616(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_136((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
bool func_658(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_659(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
void func_666(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_272(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_619(iParam1))
		{
...
int func_694(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_540(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_706(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
