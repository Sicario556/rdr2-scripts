...
void func_20(var uParam0)
{
	if (!_does_volume_exist(uParam0->f_46))
	{
		if (!func_55(func_54(uParam0)))
		{
			...
			{
				uParam0->f_46 = _create_volume_cylinder_with_custom_name(func_54(uParam0), func_56(uParam0), func_57(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
			else
			{
				uParam0->f_46 = _create_volume_box_with_custom_name(func_54(uParam0), func_56(uParam0), func_57(uParam0), "SHACK_VOLUME_RESTRICTION");
			}
		}
		if (_does_volume_exist(uParam0->f_46))
		{
		...
		case 8192:
			if (!func_41(uParam0->f_3, 4))
			{
				if (uParam0->f_48)
				{
					...
					{
						uParam0->f_4 = 0;
						if ((((((!func_63(func_62(uParam0->f_5), 2) && !func_64(128, 0, 1)) && !func_65(get_player_index(), 1, 1, 1)) && !func_66()) && !func_67(20)) && !func_63(func_62(uParam0->f_5), 4)) && !func_63(func_62(uParam0->f_5), 8))
						{
							uParam0->f_4 += 2;
...
void func_26(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!is_string_null_or_empty(func_69(uParam0, iVar0, 0)))
		{
			if (!_does_anim_scene_exist(&(uParam0->f_36[iVar0])))
			{
				...
				if (!is_string_null_or_empty(func_69(uParam0, iVar0, 1)))
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_69(uParam0, iVar0, 0), iParam1, func_69(uParam0, iVar0, 1), false, true);
				}
				else
				{
					uParam0->f_36[iVar0] = _create_anim_scene(func_69(uParam0, iVar0, 0), iParam1, 0, false, true);
				}
...
{
	if (!func_91(uParam0, iParam1) == 0 && !_does_scenario_point_exist(&(uParam0->f_41[iParam1])))
	{
		uParam0->f_41[iParam1] = create_scenario_point(func_91(uParam0, iParam1), func_92(uParam0, iParam1), func_93(uParam0, iParam1), func_94(uParam0, iParam1), 0, 0);
	}
	return true;
}
