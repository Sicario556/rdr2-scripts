...
{
	if (_get_number_of_references_of_script_with_name_hash(-443368600) > 0 || _get_number_of_references_of_script_with_name_hash(1488447571) > 0)
	{
		return;
	}
	...
	if (!bLocal_29)
	{
		if (_get_anim_scene_progress(&(Local_21[0])) > 0.434298f)
		{
			bLocal_29 = true;
		}
	}
	if (&iLocal_31[0] < 3)
	{
		func_151(iParam0, iLocal_14[2], 0, 1, 30f, 1120403456);
	}
	else
	{
		fVar0 = func_152(Global_35, &(iLocal_14[2]), 1, 1);
		if (bLocal_29)
		{
			if (bLocal_30)
			{
			...
			else
			{
				if (fVar0 < 20f)
				{
					...
					{
						iVar1 = func_157(Global_35, &(iLocal_14[2]), 1060437492);
						if (!bLocal_27)
						{
							if (!bLocal_28)
							{
							...
							{
								if (func_151(iParam0, iLocal_14[2], 1, 0, 35f, 1120403456))
								{
									task_look_at_entity(&(iLocal_14[2]), Global_35, 10000, 4, 51, 0);
									task_look_at_entity(&(iLocal_14[3]), Global_35, 10000, 0, 51, 0);
								}
								if (&iLocal_31[1] == 3)
								{
									bLocal_27 = true;
				...
				else if (fVar0 > 25f)
				{
					if (bLocal_27)
					{
						func_151(iParam0, iLocal_14[2], 2, 0, 35f, 1120403456);
						iLocal_31[1] = 0;
					}
				}
				if (func_152(Global_35, &(iLocal_14[2]), 1, 1) < 4f && Global_36.f_2 < 150.8f)
				{
					if (func_158())
					{
						bLocal_30 = true;
...
bool func_44(int iParam0)
{
	...
	enable_control_action(0, -1450761377, true);
	enable_control_action(0, -771458680, true);
	if (!func_163(iParam0, 13, iLocal_14[0], 1, 0, -2594.088f, 457.2237f, 145.9973f, 0, -1341683964, 0, 0, 0))
	{
		return false;
	}
	if (!func_163(iParam0, 14, iLocal_14[1], 1, 0, -2594.088f, 457.2237f, 145.9973f, 0, 0, 0, 0, 0))
	{
		return false;
	}
...
void func_71(int iParam0)
{
	if (!_does_volume_exist(iParam0->f_425))
	{
		...
		iParam0->f_425 = _create_volume_box_with_custom_name(func_186(*iParam0), 0f, 0f, 0f, 5f, 5f, 5f, &cVar0);
	...
	if (!_does_volume_exist(iParam0->f_426))
	{
		...
		iParam0->f_426 = _create_volume_box_with_custom_name(func_186(*iParam0), 0f, 0f, 0f, 25f, 25f, 25f, &cVar8);
...
bool func_77(var uParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	{
		if ((fVar3 >= func_198(uParam0) && !bParam2) || !_does_anim_scene_exist(uParam0->f_444))
		{
			if (uParam0->f_529)
			{
				func_199();
...
void func_82(var uParam0, char* sParam1)
{
	...
	if (_does_string_exist_in_string(sParam1, "cutscene@"))
	{
		...
		{
			MemCopy(&(uParam0->f_440), {func_212("cutscene@", _0x5b4a8121a47d844d((iVar0 - 1)), 1, 63)}, 4);
		}
		_0x3c3c7b1b5ec08764();
	}
	else
...
void func_84(var uParam0)
{
	...
	if ((func_99(uParam0, Global_35, 4) || (_0x6f1f0b17109309da(uParam0->f_444, func_215(Global_35)) && _0xb89fcff19dafff28(uParam0->f_444, func_215(Global_35)))) || !_0x4b85b3cf91972222(uParam0->f_444))
	{
		if (!func_213(uParam0->f_501, 128))
		{
			func_214();
...
void func_85(var uParam0, char* sParam1)
{
	...
	func_93(1, 0);
	func_200(uParam0);
	if (func_228() && _0x6f1f0b17109309da(uParam0->f_444, func_215(Global_35)))
	{
...
bool func_91(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_232(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
void func_104(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_253();
	set_entity_invincible(Global_35, func_213(*uParam0, 8));
...
bool func_106(int iParam0)
{
	...
	{
		if (vdist2(func_186(*iParam0), Global_36) < (10f * 10f))
		{
	...
	if (!func_5(iParam0, 1048576))
	{
		...
		{
			iVar1 = 131072;
			vVar2 = { get_offset_from_entity_given_world_coords(Global_35, func_186(*iParam0)) };
			if (vVar2.x > 0f)
			{
				iVar1 = 262144;
			}
	...
	else if (vdist2(func_186(*iParam0), Global_36) < (2.5f * 2.5f))
	{
		return true;
	}
	else if (!func_5(iParam0, 2097152))
	{
		task_follow_nav_mesh_to_coord(Global_35, func_186(*iParam0), 1f, 20000, 0.25f, 0, 40000f);
		_hide_hud_component(-1679307491);
...
Vector3 func_125(var uParam0)
{
	...
	{
		if (_get_anim_scene_entity_matrix(uParam0->f_445, func_215(Global_35), &vVar14, false, 0, 2))
		{
			vVar8 = { vVar14 };
		}
		else
...
{
	if (!does_entity_exist(&(iLocal_14[2])))
	{
		func_274(709, 1);
		iLocal_14[2] = func_275(709, 1, 0, 1, 1, 1);
		return false;
	}
	else
	{
		if (!func_276(&(iLocal_14[2]), 1435668143))
		{
			return false;
		}
		if (!func_277(&(iLocal_14[2])))
		{
			return false;
		}
	}
	if (!does_entity_exist(&(iLocal_14[3])))
	{
		func_274(711, 1);
		iLocal_14[3] = func_275(711, 1, 0, 1, 1, 1);
	}
	func_278();
	if (!_does_volume_exist(iLocal_19))
	{
		iLocal_19 = _0x0eb78c2b156635b1(665633627, -2560.409f, 399.518f, 147.123f, 0f, 0f, 0f, 1.5f, 1.5f, 2.110557f);
	}
	if (!_does_volume_exist(iLocal_20))
	{
		iLocal_20 = _create_volume_box_with_custom_name(-2570.543f, 399.4257f, 148.957f, 0f, 0f, 0f, 18.82484f, 20.12027f, 4.206023f, "Callover");
	}
	if (!is_entity_dead(&(iLocal_14[2])) && !is_entity_dead(&(iLocal_14[3])))
	{
		func_279(uParam0, 3, -2558.653f, 398.7318f, 147.124f, 81.6504f);
		func_279(uParam0, 2, -2558.21f, 399.9269f, 147.123f, 113.099f);
		func_280(&(uParam0->f_958.f_1771), &(iLocal_14[3]), "PHR_OWNERWIFE", 0);
		func_280(&(uParam0->f_958.f_1771), &(iLocal_14[2]), "RRCH1_Geddes", 0);
		if (func_155(0, 2, 0))
		{
			_set_ped_body_component(&(iLocal_14[2]), 1435668143);
			_update_ped_variation(&(iLocal_14[2]), false, true, true, true, false);
			_set_ped_component_disabled(&(iLocal_14[2]), -1725579161, 1);
			return true;
		}
	}
	return false;
...
{
	func_281(uParam0, iParam1, sParam2, iParam3, iParam4, bParam5, 0);
}
...
int func_149(var uParam0, var uParam1)
{
	...
	if (!is_string_null_or_empty(&(uParam1->f_1016[uParam1->f_1684]->f_30)))
	{
		if (_0xa9016536015de29d(uParam0->f_444, &(uParam1->f_1016[uParam1->f_1684]->f_30)))
		{
			...
			{
				func_220(uParam0, &(uParam1->f_1016[uParam1->f_1684]->f_30));
...
int func_150(int iParam0, vector3 vParam1, var uParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, int iParam11, float fParam12, float fParam13, bool bParam14)
{
	func_298(iParam0, vParam1, 0, fParam5, bParam6, fParam7, bParam8, fParam12, fParam13, bParam14, 0);
	...
	if (func_18(uParam4))
	{
		...
		if (func_48(uParam4) >= fParam9)
		{
			...
			if (!is_entity_dead(iVar1) && !func_299(iParam0, 501393341))
			{
			...
			if (!is_entity_dead(iVar2) && !func_299(iParam0, -828834893))
			{
				if (is_ped_in_any_vehicle(iParam0, false))
				{
...
bool func_151(int iParam0, var uParam1, int iParam2, bool bParam3, float fParam4, float fParam5)
{
	switch (&iLocal_31[iParam2])
	{
		case 0:
			if (!is_entity_dead(*uParam1) && (func_91(*uParam1, Global_36, fParam4, 1, 1) || fParam4 == -1f))
			{
				if (bParam3)
				{
					if (!func_233() && !func_300(1))
					{
						if (func_303(&(iParam0->f_958.f_1771), func_302(func_301(iParam2)), 0, -1, 0, 0))
						{
							iLocal_31[iParam2] = 1;
						}
					}
		...
		case 2:
			...
			{
				if ((fParam5 > -1f && !func_91(*uParam1, Global_36, fParam5, 1, 1)) || is_entity_dead(*uParam1))
				{
					func_67(1, 0, 0);
					iLocal_31[iParam2] = 3;
				}
...
{
	if (_is_anim_scene_started(&(Local_21[iParam0]), false) && _0x1f0e401031e20146(&(Local_21[iParam0]), func_154(iParam1)))
	{
		return true;
	}
	return false;
...
bool func_155(int iParam0, int iParam1, char* sParam2)
{
	if (!Local_21[iParam0]->f_3)
	{
		if (func_307(iParam0, iParam1, sParam2))
		{
			func_308(iParam0);
			Local_21[iParam0]->f_3 = 1;
		}
	}
	if (is_string_null(sParam2))
	{
		sVar0 = Local_21[iParam0]->f_2;
	}
	else
	{
		sVar0 = sParam2;
	...
	if (Local_21[iParam0]->f_3)
	{
		if (!_0x23e33cb9f4a3f547(&(Local_21[iParam0]), sVar0))
		{
			func_308(iParam0);
			_0xdf7b5144e25cd3fe(&(Local_21[iParam0]), sVar0);
		}
		if (_0x23e33cb9f4a3f547(&(Local_21[iParam0]), sVar0))
		{
			_set_anim_scene_playback_list_bool(&(Local_21[iParam0]), sVar0, true);
			func_308(iParam0);
			if (!_is_anim_scene_started(&(Local_21[iParam0]), false))
			{
				start_anim_scene(&(Local_21[iParam0]));
			}
		}
		if (is_string_null_or_empty(sVar0) && !_is_anim_scene_started(&(Local_21[iParam0]), false))
		{
			start_anim_scene(&(Local_21[iParam0]));
			if (_is_anim_scene_started(&(Local_21[iParam0]), false))
			{
				Local_21[iParam0]->f_4 = 1;
				return true;
			}
		}
		if ((_does_anim_scene_exist(&(Local_21[iParam0])) && _is_anim_scene_started(&(Local_21[iParam0]), false)) && _0x1f0e401031e20146(&(Local_21[iParam0]), sVar0))
		{
			Local_21[iParam0]->f_4 = 1;
			return true;
		}
...
int func_157(int iParam0, int iParam1, int iParam2)
{
	...
	return func_309(iParam0, vVar0, iParam2);
}
...
bool func_158()
{
	...
	{
		iLocal_35 = get_interior_at_coords(-2593.082f, 455.1119f, 145.9973f);
		return false;
	}
	else if (is_interior_ready(iLocal_35))
	{
		if (_is_interior_entity_set_valid(iLocal_35, "pro_worker_bedmade"))
		{
			deactivate_interior_entity_set(iLocal_35, "pro_worker_bedmade", true);
		}
		if (_is_interior_entity_set_valid(iLocal_35, "pro_worker_bedunmade"))
		{
			activate_interior_entity_set(iLocal_35, "pro_worker_bedunmade", 0);
		}
	}
	return true;
}
...
bool func_162(int iParam0, int iParam1, float fParam2)
{
	if (Local_21[0]->f_3 && _does_anim_scene_exist(&(Local_21[iParam0])))
	{
		if (((_get_anim_scene_progress(&(Local_21[iParam0])) >= fParam2 && _0x1f0e401031e20146(&(Local_21[iParam0]), func_154(iParam1))) || _0xf94692eb9dc15d74(&(Local_21[iParam0]), 0)) || _is_anim_scene_finished(&(Local_21[iParam0]), false))
		{
			return true;
		}
	}
...
bool func_163(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	if (!func_114(iParam1))
	{
		return false;
	...
	if (!func_312(iParam1, 28, 1))
	{
		func_313(iParam1, 28, 1);
	}
	*uParam2 = func_314(iParam1, 1, 0, vVar0.x, vVar0.y, vVar0.z, fParam8, bParam4, 1, bParam11, 0, 0, 0, iParam9, 1, bParam12, 0, 0, 1, 1, bParam10, 0, 1, 0, 1);
	if (!is_entity_dead(*uParam2))
	{
		...
		func_317(*uParam2, bParam3, bParam4, 0);
		if (bParam4)
		{
...
{
	func_321(iParam0, &(iLocal_14[3]), 0);
	func_321(iParam0, &(iLocal_14[2]), 0);
	func_321(iParam0, &(iLocal_14[0]), 0);
	func_321(iParam0, &(iLocal_14[1]), 0);
	decor_set_int(&(iLocal_14[3]), func_322(), 0);
	decor_set_int(&(iLocal_14[2]), func_322(), 1);
	decor_set_int(&(iLocal_14[0]), func_322(), 14);
	decor_set_int(&(iLocal_14[1]), func_322(), 15);
}

void func_165(int iParam0)
{
	func_131(iParam0, Global_35, "John", 0, 0, 1);
	func_131(iParam0, &(iLocal_14[3]), "CS_MRSGEDDES", 0, 0, 1);
	func_131(iParam0, &(iLocal_14[2]), 0, 0, 0, 1);
	if (does_entity_exist(&(iLocal_14[0])))
	{
		func_131(iParam0, &(iLocal_14[0]), "AbigailRoberts", 0, 0, 1);
	}
	if (does_entity_exist(&(iLocal_14[1])))
	{
		func_131(iParam0, &(iLocal_14[1]), 0, 0, 0, 1);
	}
	func_139(iParam0, "MultiStart");
}
		...
		if ((uParam0->f_475[iVar0]->f_17 == 0 && uParam0->f_475[iVar0]->f_2 == 9) && uParam0->f_475[iVar0]->f_4 >= 0)
		{
			...
			if (_does_anim_scene_exist(iVar1) && _is_anim_scene_loaded(iVar1, true, false))
			{
				...
				while (iVar2 < 35)
				{
					...
					{
						Var3 = { func_323(uParam0, uParam0->f_3[iVar2]->f_2) };
	...
	while (iVar0 < 11)
	{
		if (_does_anim_scene_exist(uParam0->f_1522[iVar0]->f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_324(uParam0->f_1522[iVar0], 128))
				{
					func_325(uParam0->f_1522[iVar0]->f_8, 10000, 1, -1, 0);
				}
				else
				{
					if (bParam2)
...
void func_174(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (bParam4)
	{
		func_328(iParam0, iParam2, 0);
	}
	if (!bParam6)
	{
		if (!func_5(iParam0, 4194304))
		{
			bParam6 = func_329((*Global_1835011)[*iParam0], 1024);
			bVar0 = func_329((*Global_1835011)[*iParam0], 65536);
		}
	}
	func_330(iParam1, iParam3, bParam4, bParam5, -1082130432, 1, 1, bParam6, bVar0, 0, 0);
}
...
void func_175(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_332((*uParam0)[iVar0]->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_334((*uParam1)[iVar0]))
		{
			if (func_332((*uParam1)[iVar0]->f_4, iParam12))
			{
				func_335((*uParam1)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_336((*uParam2)[iVar0]))
		{
			if (func_332((*uParam2)[iVar0]->f_2, iParam12))
			{
				func_337((*uParam2)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_338((*uParam3)[iVar0]))
		{
			if (func_332((*uParam3)[iVar0]->f_2, iParam12))
			{
				func_339((*uParam3)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_341((*uParam5)[iVar0]))
		{
			if (func_332((*uParam5)[iVar0]->f_3, iParam12))
			{
				func_342((*uParam5)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_341((*uParam5)[iVar0]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_343((*uParam5)[iVar0]->f_4[iVar1]))
				{
					if (func_332((*uParam5)[iVar0]->f_4[iVar1]->f_2, iParam12))
					{
						func_344((*uParam5)[iVar0]->f_4[iVar1], (*uParam5)[iVar0]->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_345((*uParam6)[iVar0]))
		{
			if (func_332((*uParam6)[iVar0]->f_3, iParam12))
			{
				func_346((*uParam6)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_347((*uParam7)[iVar0]))
		{
			if (func_332((*uParam7)[iVar0]->f_4, iParam12))
			{
				func_348((*uParam7)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_349((*uParam8)[iVar0]))
		{
			if (func_332((*uParam8)[iVar0]->f_2, iParam12))
			{
				func_350((*uParam8)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_351((*uParam9)[iVar0]))
		{
			if (func_332((*uParam9)[iVar0]->f_2, iParam12))
			{
				func_352((*uParam9)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_353((*uParam10)[iVar0]))
		{
			if (func_332((*uParam10)[iVar0]->f_3, iParam12))
			{
				func_354((*uParam10)[iVar0]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_355((*uParam11)[iVar0]))
		{
			if (func_332((*uParam11)[iVar0]->f_2, iParam12))
			{
				func_356((*uParam11)[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_187(int iParam0, int iParam1, int iParam2)
{
	...
	func_66(iParam0, 512);
	iParam0->f_427 = func_364(iParam1, 0, 0, 0);
}
...
void func_189(int iParam0, int iParam1)
{
	...
	func_365(iParam1);
	StringCopy(&cVar0, func_185(), 64);
	func_366(iParam1, &cVar0, 1, 0, 0, 0, -1082130432);
}
...
void func_195(var uParam0, var uParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		{
			func_367(uParam0, &(uParam1->f_1016[iVar0]->f_30), 1);
		}
		iVar0++;
	}
}
...
void func_205(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		uParam0->f_4 = _create_volume_box_with_custom_name(uParam0->f_5, 0f, 0f, 0f, 5f, 5f, 5f, func_185());
		func_96(uParam0, 8);
	}
	if (_does_volume_exist(uParam0->f_4))
	{
		...
		func_372(uParam0, uParam0->f_4, 0, 1);
...
bool func_218(bool bParam0, bool bParam1)
{
	if (!func_374(Global_43801))
	{
		Global_43801 = func_379("CUTSCENE_SKIP", -842734359, 5, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, -2018976333, 0);
		(*Global_1945938)[Global_43801]->f_16 = &Global_23[3];
		func_380(Global_43801, 0, 1);
		func_381(Global_43801, 6, 1);
		if (bParam1)
		{
			func_381(Global_43801, 14, 1);
		}
	}
	else
	{
		...
		if (func_383(Global_43801, 1) != 0f && bParam0)
		{
			func_380(Global_43801, 1, 1);
		}
		else
		{
			func_380(Global_43801, 0, 1);
		}
		return func_384(Global_43801, 1);
	}
	return false;
}
...
void func_229(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			func_387(uParam0, uParam0->f_462[iVar0]);
		}
		iVar0++;
	}
	Var1 = { func_370() };
...
void func_230(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!is_entity_dead(&(uParam0->f_13[iVar0])) || func_245(uParam0->f_13[iVar0], 2))
		{
			...
			{
				func_388(uParam0, &(uParam0->f_13[iVar0]->f_1), &(uParam0->f_13[iVar0]), uParam0->f_13[iVar0]->f_9);
...
bool func_233()
{
	return func_377(_0xc17f69e1418cd11f(3));
}
...
void func_238(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	...
	{
		if (func_405() || _0x50f124e6ef188b22(Global_35))
		{
			func_112(1);
		}
	}
...
{
	if ((func_83(uParam0, 268435456) && !func_90(func_406(uParam0))) && is_ped_in_any_vehicle(Global_35, false))
	{
			...
			if (is_ped_human(iVar1))
			{
				if (_0x6f1f0b17109309da(uParam0->f_444, &(uParam0->f_13[iVar0]->f_1)))
				{
					if (!func_245(uParam0->f_13[iVar0], 8))
					{
						...
						{
							if (!func_412(uParam0, get_current_ped_weapon_entity_index(iVar1, 0)))
							{
						...
						{
							if (!func_412(uParam0, get_current_ped_weapon_entity_index(iVar1, 1)))
							{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_416(iVar3, 6) || &uParam0->f_1[iVar1] == &Global_1946804->f_57[iVar1]) || uParam0->f_1[iVar1]->f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_414(iParam1, iVar1, bVar4, 1, &(uParam0->f_1[iVar1]));
							}
...
void func_249(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		func_424(uParam0->f_13[iVar0], iParam1);
		iVar0++;
	}
}
...
int func_254(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_428(iParam3, 1)])
			{
				func_431(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_415(32768) && iParam1 != &Global_1946804->f_57[func_428(iParam3, 1)])
			{
				func_432();
...
void func_255(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_437(0), &Var5, iParam1);
}

bool func_256(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	if (!does_entity_exist(iParam0))
	{
		return false;
	...
	if (func_438(*uParam1, 2))
	{
		...
		else if ((func_441(iParam2, 128) && does_entity_exist(_get_last_mount(iParam0))) && does_entity_exist(_get_first_entity_ped_is_carrying(_get_last_mount(iParam0))))
		{
	...
	{
		if (!func_441(iParam2, 2) && _0xb16223cb7da965f0(get_player_index()))
		{
	...
	if (bVar3)
	{
		...
		disable_control_action(0, 1520437207, false);
		if (((is_ped_sprinting(iVar2) || (is_ped_running(iVar2) && func_441(iParam2, 1024))) || func_441(iParam2, 8)) && !func_438(*uParam1, 5632))
		{
			task_horse_action(iVar2, 1, 0, 0);
			func_442(uParam1, 32);
		}
		else if ((is_ped_running(iVar2) && func_441(iParam2, 4096)) && !func_438(*uParam1, 5632))
		{
			task_horse_action(iVar2, 8, 0, 0);
			func_442(uParam1, 2048);
			func_442(uParam1, 4096);
		}
		else if (((get_ped_desired_move_blend_ratio(iVar2) <= 1.5f && get_ped_desired_move_blend_ratio(iVar2) >= 1.001f) && func_441(iParam2, 32)) && !func_438(*uParam1, 5632))
		{
...
int func_269(var uParam0, int iParam1)
{
	...
	if (func_142())
	{
		...
		if (func_448(uParam0->f_1016[uParam0->f_1684], 4))
		{
			_0xcb9401f918cb0f75(Global_35, func_449(uParam0->f_1016[uParam0->f_1684]->f_39), 0, -1);
		}
	...
	if (func_295(uParam0, 8) && _0xdd0b7c5ae58f721d(func_450()))
	{
		_0x798be43c9393632b(func_450());
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		if ((!is_string_null_or_empty(&(uParam0->f_1345[iVar0]->f_2)) && !are_strings_equal(&(uParam0->f_1345[iVar0]->f_2), func_450())) && _0xdd0b7c5ae58f721d(&(uParam0->f_1345[iVar0]->f_2)))
		{
...
bool func_272(int iParam0)
{
	...
	return func_454((*Global_1835011)[iParam0]->f_1);
}
...
int func_274(int iParam0, bool bParam1)
{
	...
	{
		func_458(iParam0, _create_persistent_character(func_457(iParam0)));
		if (func_257() == -1)
		{
			if (func_456(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_459(iParam0));
				func_460(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_459(iParam0));
		}
		return 0;
	}
...
int func_275(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_464(iParam0)) && !is_entity_dead(iVar0))
	{
...
void func_278()
{
	Local_21[0]->f_1 = "script@story@mar4@leadin@int@leadin";
	Local_21[0]->f_2 = func_154(0);
}

void func_279(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	set_blocking_of_non_temporary_events(&(iLocal_14[iParam1]), true);
	set_current_ped_weapon(&(iLocal_14[iParam1]), -1569615261, true, 0, false, false);
}

void func_280(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (func_469(uParam0, iParam1, sParam2))
	{
...
{
	func_470(&(iParam0->f_428), iParam1, sParam2, iParam3, iParam4, bParam6);
	func_471(iParam0, iParam1, sParam2);
	if (bParam5)
	{
...
int func_286(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar1 < *uParam0)
	{
		if (func_331((*uParam0)[iVar1]))
		{
			if (func_332((*uParam0)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam1)
	{
		if (func_334((*uParam1)[iVar1]))
		{
			if (func_332((*uParam1)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam2)
	{
		if (func_336((*uParam2)[iVar1]))
		{
			if (func_332((*uParam2)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam3)
	{
		if (func_338((*uParam3)[iVar1]))
		{
			if (func_332((*uParam3)[iVar1]->f_2, iParam12))
			{
				if (!func_339((*uParam3)[iVar1]))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < *uParam5)
	{
		if (func_341((*uParam5)[iVar1]))
		{
			if (func_332((*uParam5)[iVar1]->f_3, iParam12))
			{
			...
			if (func_332((*uParam5)[iVar1]->f_3, iParam12))
			{
				if (func_476((*uParam5)[iVar1]))
				{
					if (func_477((*uParam5)[iVar1]))
					{
						...
						while (iVar2 < 20)
						{
							if (func_343((*uParam5)[iVar1]->f_4[iVar2]))
							{
	...
	while (iVar1 < *uParam6)
	{
		if (func_345((*uParam6)[iVar1]))
		{
			if (func_332((*uParam6)[iVar1]->f_3, iParam12))
			{
	...
	while (iVar1 < *uParam7)
	{
		if (func_347((*uParam7)[iVar1]))
		{
			if (func_332((*uParam7)[iVar1]->f_4, iParam12))
			{
	...
	while (iVar1 < *uParam8)
	{
		if (func_349((*uParam8)[iVar1]))
		{
			if (func_332((*uParam8)[iVar1]->f_2, iParam12))
			{
	...
	while (iVar1 < *uParam9)
	{
		if (func_351((*uParam9)[iVar1]))
		{
			if (func_332((*uParam9)[iVar1]->f_2, iParam12))
			{
	...
	{
		if (func_353((*uParam10)[iVar1]))
		{
			if (func_332((*uParam10)[iVar1]->f_3, iParam12))
			{
	...
	{
		if (func_355((*uParam11)[iVar1]))
		{
			if (func_332((*uParam11)[iVar1]->f_2, iParam12))
			{
...
Vector3 func_292(var uParam0, int iParam1)
{
	switch (&uParam0->f_1016[iParam1])
	{
		case 0:
			...
			vVar10 = { func_486(vVar10) * Vector(2f, 2f, 2f) };
...
void func_298(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, int iParam12)
{
	if (bParam4)
	{
	}
	...
	if ((bVar3 <= bParam5 && bVar3 > bParam6) && bVar3 > bParam7)
	{
		...
		if ((func_489() && !is_entity_dead(iVar1)) && _is_draft_vehicle(iVar1))
		{
			iVar4 = 0;
			while (iVar4 < 6)
			{
	...
	if (bParam4)
	{
		if (bVar3 <= bParam8)
		{
			...
			if (!is_entity_dead(iVar0) && !func_299(iParam0, 501393341))
			{
				task_dismount_animal(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!is_entity_dead(iVar1) && !func_299(iParam0, -828834893))
			{
...
Vector3 func_302(char* sParam0)
{
	StringCopy(&cVar0, sParam0, 24);
	return cVar0;
}

bool func_303(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
...
bool func_307(int iParam0, int iParam1, char* sParam2)
{
	if (!Local_21[iParam0]->f_3)
	{
		if (_does_anim_scene_exist(&(Local_21[iParam0])))
		{
			if (_is_anim_scene_loaded(&(Local_21[iParam0]), true, false))
			{
				Local_21[iParam0]->f_3 = 1;
				return Local_21[iParam0]->f_3;
			}
		}
		else
		{
			if (is_string_null(sParam2))
			{
				Local_21[iParam0] = _create_anim_scene(Local_21[iParam0]->f_1, iParam1, Local_21[iParam0]->f_2, false, true);
			}
			else
			{
				Local_21[iParam0]->f_2 = sParam2;
				Local_21[iParam0] = _create_anim_scene(Local_21[iParam0]->f_1, iParam1, sParam2, false, true);
			}
			if (_does_anim_scene_exist(&(Local_21[iParam0])))
			{
				load_anim_scene(&(Local_21[iParam0]));
			}
		}
	}
	return Local_21[iParam0]->f_3;
...
void func_308(int iParam0)
{
	...
	{
		case 0:
			set_anim_scene_entity(&(Local_21[0]), "DavidGeddes", &(iLocal_14[2]), 0);
			set_anim_scene_entity(&(Local_21[0]), "MrsGeddes", &(iLocal_14[3]), 0);
			set_anim_scene_entity(&(Local_21[0]), "JOHN", Global_35, 0);
			break;
	}
}

int func_309(int iParam0, vector3 vParam1, float fParam4)
{
...
int func_314(int iParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	if (!func_114(iParam0))
	{
		return 0;
	...
	switch ((*Global_1360165)[iParam0]->f_11)
	{
		case 0:
			...
			if (func_266(iParam0, 16, 1))
			{
				if (*Global_1360165)[iParam0]->f_129 != get_id_of_this_thread()
				{
					...
					{
						func_330(iParam0, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
			...
			if (func_259(Global_1360165[iParam0], 0))
			{
				...
				if (is_ped_ragdoll(Global_1360165[iParam0]))
				{
					if (bParam1)
					{
						func_495(iParam0, 1, "Stealing, but companion is a ragdoll");
					}
					else
					{
						return 0;
		...
		case 1:
			...
			if (!func_312(iParam0, 44, 0))
			{
				func_313(iParam0, 44, 0);
			}
			if (func_497(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_496(iParam0, 2);
			}
			break;
		case 2:
			...
			func_494(iParam0, 18, 1);
			set_entity_visible(Global_1360165[iParam0], true);
			set_ped_relationship_group_hash(Global_1360165[iParam0], 1030835986);
			_0xf74e134f40192884(Global_1360165[iParam0], 0);
			_0x6759bee6762e140b((*Global_1360165)[iParam0]->f_1);
			set_ped_config_flag(Global_1360165[iParam0], 130, false);
			func_498(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
				func_319(iParam0, 0, 0, 1);
			}
		...
		case 3:
			if (!is_entity_dead(Global_1360165[iParam0]) && !_0x3ab6c7b0bb0df4b1(Global_1360165[iParam0], -1))
			{
				if (is_entity_attached(Global_1360165[iParam0]))
				{
					...
					{
						func_495(iParam0, 1, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_408(Global_1360165[iParam0], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_499(iParam0, iParam13))
				{
					...
					{
						func_500(iParam0, iParam13, 0);
						func_501(iParam0, Global_1360165[iParam0], iParam13, 1);
						if (func_312(iParam0, 25, 0))
						{
							func_494(iParam0, 25, 0);
						}
						func_313(iParam0, 66, 0);
						func_496(iParam0, 5);
		...
		case 6:
			if (func_259(Global_1360165[iParam0], 0))
			{
				...
				if (bParam21)
				{
					...
					func_503(Global_1360165[iParam0], 1);
				}
			}
			func_496(iParam0, 7);
		case 7:
			func_498(iParam0, bParam9, bParam15, 0);
			func_504(iParam0, 4, bParam11);
			func_505(iParam0);
			if (bParam20)
			{
				if (func_506(Global_1360165[iParam0]))
				{
				}
			}
			func_507(iParam0, Global_1360165[iParam0]);
...
void func_317(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (is_entity_dead(iParam0))
	{
		return;
	...
	if (bParam2 && (!func_169() || !_0x6f1f0b17109309da(Global_43800, func_215(iParam0))))
	{
		if (is_ped_on_mount(iParam0))
		{
...
void func_319(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!func_114(iParam0))
	{
		return;
...
struct<8> func_323(var uParam0, int iParam1)
{
	if (does_entity_exist(iParam1))
	{
		StringCopy(&cVar0, func_514(iParam1), 64);
...
void func_328(int iParam0, int iParam1, char* sParam2)
{
...
void func_330(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (!func_114(iParam0))
	{
		return;
	...
	if (bParam10)
	{
		func_313(iParam0, 56, 1);
		func_19(&(Global_1359489->f_40), 1);
	}
	func_518(iParam0, 0);
	func_504(iParam0, 4, 0);
	func_519(iParam0);
	func_505(iParam0);
	func_494(iParam0, 37, 1);
	...
	if (func_312(iParam0, 64, 1))
	{
		func_494(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_494(iParam0, 33, 1);
		...
		func_498(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_313(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_313(iParam0, 35, 1);
			if (bParam8)
			{
				func_313(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		func_313(iParam0, 33, 1);
		func_498(iParam0, 0, 1, 0);
		if (fParam4 > 0f)
		{
	...
	if (func_312(iParam0, 45, 1))
	{
		func_494(iParam0, 45, 1);
	}
	...
	if (bParam5)
	{
		if (func_259(func_525(iParam0), 0))
		{
...
void func_342(var uParam0)
{
	if (!func_528(uParam0->f_2, 1))
	{
		if (func_476(uParam0))
		{
			...
			{
				sVar0 = func_376(get_entity_model(Global_35));
				...
				else if (_0x6f1f0b17109309da(uParam0->f_1, "player_three") && func_532())
				{
...
var func_364(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!_does_volume_exist(iParam0))
	{
		return uVar0;
	}
	func_534(iParam0, bParam2);
...
int func_366(int iParam0, char[4] cParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	if (!_does_volume_exist(iParam0))
	{
		return 0;
	...
	iVar6 = func_537(vVar0, vVar3.x, cParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}

void func_367(var uParam0, char* sParam1, bool bParam2)
{
	if (is_string_null_or_empty(sParam1))
	{
		return;
...
void func_368(struct<4> Param0)
{
	...
	if (func_540(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_540(20))
			{
				return;
			}
			iVar0++;
...
void func_372(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (_0x91a5f9cbebb9d936(uParam0->f_9))
	{
		remove_scenario_blocking_area(uParam0->f_9, false);
...
void func_397()
{
	...
	if (func_411(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_411(iVar0))
	{
		...
		{
			func_555(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
		}
		else
		{
			set_current_ped_weapon(Global_35, iVar0, true, 9, false, false);
...
int func_399(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_408(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_559(Global_35) && is_player_teleport_active())
	{
	}
	if (func_560(iParam0))
	{
		if (func_561(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_438(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_438(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_438(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_438(iParam5, 32), true);
	...
	else if (func_438(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_438(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_438(iParam5, 64))
		{
			if (!is_screen_faded_out())
			{
			}
...
{
	return ((Global_1946804->f_57[func_428(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
{
	(Global_1946804->f_57[func_428(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_428(iParam0, 1)])->f_10 || iParam1);
}

void func_421(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_428(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_428(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_428(iParam0, 1)])->f_10 && iParam1));
}
...
bool func_429(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	func_572();
	if (iParam2 == 39)
	{
	...
	if ((func_415(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_578(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_578(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_580(iParam0, iParam2, iParam1, func_257() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_421(func_419(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
struct<4> func_435(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	if (!func_392(iParam0, 0))
	{
		return Var0;
...
bool func_440(int iParam0, vector3 vParam1)
{
	...
	return func_492(vVar0, vVar3, vParam1);
}
...
void func_446(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_588(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_589(1, bVar1, 1, uVar2);
		func_590(!bVar1, fParam1 < 0f, bVar1);
		iVar0 = func_591(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
bool func_462(int iParam0, bool bParam1)
{
	...
	if ((func_456(iParam0, 1) && !func_464(iParam0)) && func_596(iParam0))
	{
		return false;
	}
	if (!func_456(iParam0, 2))
...
bool func_469(var uParam0, int iParam1, char* sParam2)
{
	bVar0 = false;
	iVar1 = 0;
...
void func_470(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	{
		iVar1 = func_599(uParam0, sParam2);
		if (does_entity_exist(iVar1) && iVar1 != iParam1)
		{
			func_600(uParam0, iVar1);
		}
	}
	if (iVar0 == -1)
	{
	...
	if (iVar0 != -1)
	{
		...
		if (bParam5)
		{
			func_390(uParam0->f_13[iVar0], 2);
		}
		else
		{
			func_424(uParam0->f_13[iVar0], 2);
		}
	}
}

void func_471(int iParam0, int iParam1, char* sParam2)
{
	func_602(&(iParam0->f_958), iParam1, sParam2, 0);
}
...
void func_495(int iParam0, bool bParam1, char* sParam2)
{
	iVar0 = func_258(iParam0);
...
bool func_497(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_445(iParam0))
	{
		return false;
	...
	switch ((*Global_1360165)[iParam0]->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_603(iParam0, iParam9, bParam7, 1);
				}
				else if (((*Global_1360165)[iParam0]->f_4.f_2 != 0 && (*Global_1360165)[iParam0]->f_4.f_2 == Global_40.f_4942[iParam0]->f_59) && (func_454((*Global_1360165)[iParam0]->f_4.f_2) || func_297((*Global_1360165)[iParam0]->f_4.f_2)))
				{
					iParam4 = (*Global_1360165)[iParam0]->f_4.f_1;
				}
				else
				{
					iParam4 = func_603(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if ((*Global_1360165)[iParam0]->f_63 != iParam4 && func_604((*Global_1360165)[iParam0]->f_63))
				{
					if (!func_605(iParam0, 0))
					{
						func_313(iParam0, 25, 0);
					}
				}
			}
			(*Global_1360165)[iParam0]->f_4 = { func_606(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0]->f_59, bParam11) };
			if (!bParam6)
			{
				func_494(iParam0, 44, 1);
			}
...
void func_498(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_313(iParam0, 50, 1);
		func_313(iParam0, 48, 1);
		func_313(iParam0, 49, 1);
		func_313(iParam0, 51, 1);
		if (bParam3)
		{
			func_313(iParam0, 54, 1);
		}
		else
		{
			func_494(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_313(iParam0, 52, 1);
			if (bParam3)
			{
				func_313(iParam0, 55, 1);
			}
		}
		else
		{
...
bool func_499(int iParam0, int iParam1)
{
	...
	bVar0 = func_607(iParam0, iParam1);
	return bVar0;
}
...
void func_507(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_555(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_555(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
char* func_514(int iParam0)
{
	...
	{
		return func_215(get_ped_index_from_entity_index(iParam0));
	}
	else if (is_entity_an_object(iParam0))
	{
		return func_626(get_object_index_from_entity_index(iParam0));
	}
	else if (is_entity_a_vehicle(iParam0))
	{
		return func_627(get_vehicle_index_from_entity_index(iParam0));
	}
	return "";
}
...
void func_518(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_629(&((*Global_1360165)[iParam0]->f_12), 1))
		{
			func_504(iParam0, 1, 0);
		}
	}
	func_504(iParam0, 16, bParam1);
}

void func_519(int iParam0)
{
	func_504(iParam0, 8, 0);
}
...
void func_523(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_258(iParam0);
	if (((does_entity_exist(iVar1) && func_632(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
...
void func_526(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	func_494(iParam1, 39, 1);
	func_636(iParam1, 64, 0);
	(*Global_1360165)[iParam1]->f_70.f_11 = 0;
	func_636(iParam1, 8, 0);
	if (does_entity_exist(iVar0))
	{
		if (!bParam2)
		{
			func_636(iParam1, 512, 1);
			set_ped_keep_task(iVar0, true);
		}
		else
		{
			set_blocking_of_non_temporary_events(iVar0, false);
			func_313(iParam1, 43, 1);
		}
		if (bParam4)
		{
			func_637(iParam1, 0, 1, 1, 1);
		}
	}
}
...
int func_537(vector3 vParam0, float fParam3, char[4] cParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
void func_545(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1945938)[iParam0]->f_3))
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_378(iParam0, 8))
		{
...
{
	iVar0 = func_428(func_641(iParam0), 1);
	if (iVar0 != 39)
	{
...
{
	iVar1 = func_428(func_641(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_555(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
...
{
	return func_435(1328661203, func_647(), -1591664384, bParam0);
}
...
struct<4> func_565(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_435(923904168, func_563(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_435(923904168, func_563(bParam0), -740156546, 0) };
		}
		return *Global_1224223;
	}
	return func_435(923904168, func_563(bParam0), -740156546, 0);
}
...
{
	return func_436(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_568(int iParam0, var uParam1, int iParam2)
{
	if (func_649(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_569(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224219 = { func_435(271701509, func_563(bParam0), 12999093, 0) };
		}
		return *Global_1224219;
	}
	return func_435(271701509, func_563(bParam0), 12999093, 0);
}
...
{
	func_650(&(Global_1946804->f_2589), iParam0);
}

void func_577(int iParam0, int iParam1)
{
	func_651(&(Global_1946804->f_2589), iParam0, iParam1);
}
...
{
	iVar1 = 12;
	iVar2 = func_393(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
	}
	if (func_417(iParam2, 65536) && &uParam0->f_1[iVar1] == -452402570)
	{
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_653(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_653(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_653(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1])
				{
					uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
				...
				func_653(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_393(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_654(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_393(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_654(&(Global_1946804->f_1497.f_1[iVar1])) || func_573(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_393(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_393(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_393(&(uParam0->f_1[iVar1])) || func_573(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
{
	iVar0 = func_655(0);
	if (iParam2 != 0 && func_656(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_657(iParam0, func_419(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_581(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_416(iVar5, 6) || &uParam0->f_1[iVar0] == &Global_1946804->f_57[iVar0])
			{
			}
			else
			{
				iVar4 = func_658(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_582(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_660(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_257() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_661(2, Global_26796.f_776)) || Global_1946804->f_1497 != func_662(0))
		{
			if (Global_40.f_7157[Global_40.f_7729] & 512 != 0)
			{
				...
				Global_1946804->f_1497 = func_662(Global_40.f_7729);
				Global_1946804->f_1378 = func_662(Global_40.f_7729);
...
void func_589(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
void func_590(bool bParam0, bool bParam1, bool bParam2)
{
	sVar0 = func_665(0, 1, bParam0, bParam1);
...
bool func_597(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_459(iParam0));
}
...
void func_602(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	if (!does_entity_exist(iParam1))
	{
		return;
...
int func_603(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_676((*Global_1835011)[4]->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_676((*Global_1347702)[63]->f_15, 1) || func_297((*Global_1347702)[63]->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_676((*Global_1835011)[14]->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_676((*Global_1347702)[134]->f_15, 1) || func_297((*Global_1347702)[134]->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_676((*Global_1835011)[38]->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_678(747937920, 1) && !func_676((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
bool func_605(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_312(iParam0, 44, 1))
		{
			return false;
		}
	}
...
struct<7> func_606(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	Var0 = iParam0;
	Var0.f_1 = iParam1;
	Var0.f_3 = { vParam2 };
...
int func_609(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_680(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_680(1237718549, iParam1);
			return func_681(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
{
	func_682(iParam0, 1);
	func_682(iParam0, 128);
	func_682(iParam0, 256);
	func_682(iParam0, 512);
	func_682(iParam0, 1024);
	func_682(iParam0, 2048);
	func_682(iParam0, 4096);
	func_682(iParam0, 65536);
	func_682(iParam0, 16384);
	func_682(iParam0, 262144);
	func_682(iParam0, 524288);
	func_682(iParam0, 1048576);
	func_682(iParam0, 2097152);
	func_682(iParam0, 32768);
	func_682(iParam0, 131072);
	func_682(iParam0, 134217728);
	func_682(iParam0, 1073741824);
}
...
char* func_628(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (does_entity_exist(&(uParam0->f_13[iVar0])) && &uParam0->f_13[iVar0] == iParam1)
		{
			return func_686(uParam0->f_13[iVar0]->f_1);
		}
		iVar0++;
	}
	return "";
...
void func_631(int iParam0)
{
	if (func_114(iParam0))
	{
		...
		{
			func_508(iParam0, 67108864, 1);
			func_494(iParam0, 19, 1);
		}
	}
}
...
int func_637(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_445(iParam0))
	{
		return 0;
	...
	if (func_259(iVar0, 0))
	{
		...
		if ((bParam1 || !func_634(iParam0)) || func_635(iParam0))
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_689(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_690(iParam0);
					_0x7b204f88f6c3d287(func_691(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_691(iParam0, 0));
					func_692(iParam0);
				}
			}
			else
...
int func_646(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_700("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		Var23.f_9 = -1591664384;
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_701(&Var4, iVar3, iVar1, iVar2))
			{
			}
			...
			else if ((!func_699(iParam1, 512) && func_649(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_702(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_699(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_699(iParam1, 4))) && (!func_702(Var4.f_4) || func_699(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_699(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_699(iParam1, 1048576)))
				{
...
bool func_649(int iParam0, var uParam1, var uParam2, int iParam3)
{
	iVar0 = func_437(0);
	*uParam1 = { func_435(iParam0, func_565(0), iParam3, 0) };
...
void func_650(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_706(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_706(uParam0->f_2[iVar0], 1))
				{
					func_707(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_652(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_428(iParam0, 1)] != &Global_1946804->f_57[func_428(iParam0, 1)];
}

void func_653(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	iVar0 = 0;
	if (bParam4)
	{
...
int func_658(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (iParam0 == &Global_1946804->f_57[func_428(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_660(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_257() == -1)
	{
		func_711(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_712(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_713(&(Global_1946804->f_1378), iParam0);
	func_714(2, iParam0, 6);
	if (bParam1)
	{
		func_664(0, 1);
	}
...
char* func_665(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_588(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD", "PMPLAYER_CONDITION_TEMPERATURE_HOT");
					}
					break;
				case 2:
					return func_588(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD", "PMPLAYER_CONDITION_HONOR_BAD");
			}
			break;
		case 1:
		case 2:
...
float func_666()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_722()));
	fVar7 = (func_717(2) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_723(3, round((to_float(iVar8) * fVar10)), 0);
	func_724(3, fVar9, fVar9 > 100f);
	return func_725(fVar7, -100f, 100f);
}
...
float func_667()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_722()));
	fVar7 = (func_717(1) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_723(2, round((to_float(iVar8) * fVar10)), 0);
	func_724(2, fVar9, fVar9 > 100f);
	return func_725(fVar7, -100f, 100f);
}
...
float func_668()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_722()));
	fVar7 = (func_717(0) - fVar6);
	iVar8 = round(((fVar0 / 60f) * to_float(7)));
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_723(1, round((to_float(iVar8) * fVar10)), 0);
	func_724(1, fVar9, fVar9 > 100f);
...
int func_684(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_730(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
var func_686(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_689(int iParam0, int iParam1, bool bParam2)
{
	if (!does_entity_exist(iParam0))
	{
		return 0f;
	...
	return func_232(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
int func_691(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_731(iParam0);
	}
...
bool func_700(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_713(var uParam0, int iParam1)
{
	if (func_257() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_711(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_712(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
void func_723(int iParam0, char* sParam1, bool bParam2)
{
	sVar0 = func_665(iParam0, 1, 0, 0);
	sVar0 = _create_var_string(2, sVar0, sParam1);
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[iParam0]->f_12[1]), sVar0);
	_databinding_write_data_bool(&(Global_1955569->f_5.f_2[iParam0]->f_16[1]), bParam2);
}

void func_724(int iParam0, float fParam1, bool bParam2)
{
	sVar0 = func_665(iParam0, 2, 0, 0);
