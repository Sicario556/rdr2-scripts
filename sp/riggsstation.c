void __EntryFunction__()
{
	...
	func_1();
	func_2();
	iLocal_168 = get_game_timer();
	iVar0 = 0;
	while (func_3())
	{
		if (get_game_timer() > iLocal_168)
		{
			iLocal_168 = 0;
			...
			switch (iLocal_167)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_169));
					...
					Global_1897950 = -1;
					iLocal_170 = (get_game_timer() + iLocal_166);
					iLocal_167 = 2;
					break;
				case 2:
					if (func_11() || iLocal_170 < get_game_timer())
					{
						func_12(iLocal_169);
						iLocal_170 = (get_game_timer() + iLocal_166);
						iLocal_167 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_169) || iLocal_170 < get_game_timer())
					{
						func_14(iLocal_169);
						iLocal_170 = (get_game_timer() + iLocal_166);
						iLocal_167 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_169) || iLocal_170 < get_game_timer())
					{
						func_16(iLocal_169);
						iLocal_170 = (iLocal_166 + get_game_timer());
						iLocal_167 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_169)))
					{
						if (func_17(func_6(iLocal_169), 4) && !iLocal_170 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_169) || iLocal_170 < get_game_timer())
							{
							...
							Jump @788; //curOff = 456
							if (iLocal_170 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_169);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_168 = (1000 + get_game_timer());
							}
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_169]->f_10);
							if ((*Global_1888801)[iLocal_169]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_169]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_169]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_169]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_164 = _create_volume_aggregate_with_custom_name("Riggs Stn - m_volPostOfficePrompt Agg");
	_0x39816f6f94f385ad(iLocal_164, -1095.52f, -576.564f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	_0x39816f6f94f385ad(iLocal_164, -1094.093f, -574.7371f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	iLocal_163 = _create_volume_box_with_custom_name(-1094.383f, -575.865f, 82.807f, 0f, 0f, 52.00422f, 4.73f, 5.502f, 2.821f, "Riggs Stn - m_volPostOfficeOwner");
	iLocal_165 = _create_volume_box_with_custom_name(-1093.137f, -576.9941f, 82.84734f, 0f, 0f, 52.00422f, 4.470828f, 2.119287f, 2.820909f, "Riggs Stn - m_volPostOfficeOfflimits");
	_0xb469cfd9e065eb99(iLocal_163, 10025);
	return true;
}
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	if (func_97(iVar0) || func_98(iVar0, iParam0))
	{
		...
		Global_1914319->f_3[iParam0]->f_20 = func_99(5, Global_1914319->f_3[iParam0]->f_10, 2, iVar7);
	}
	*Global_1393529->f_114[iParam0] = { 0f, 0f, 0f };
	...
	func_107(Global_1914319->f_3[iParam0]->f_10);
	func_108(iParam0, 16);
	func_109(iParam0, 4);
...
bool func_63(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_116(iParam0));
}
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_130(&cVar6, 109029619), sVar9, func_130(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_130(&cVar6, 109029619), func_130(&cVar10, 109029619));
		}
...
void func_81(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_148(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
void func_84()
{
	...
	Local_117[0]->f_43 = 25399;
	Local_117[0]->f_44 = 25575;
	func_154(Local_117[0], 512);
}
...
int func_90(int iParam0, bool bParam1)
{
	...
	{
		func_156(iParam0, _create_persistent_character(func_155(iParam0)));
		if (func_20() == -1)
		{
			if (func_149(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_112(iParam0));
				func_157(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_112(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_112(iParam0)))
	{
		func_157(iParam0, 128);
		return 1;
	}
	func_156(iParam0, _create_persistent_character(func_155(iParam0)));
	_0x4f81ead1de8fa19b(func_112(iParam0));
	if (func_149(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_112(iParam0));
		func_157(iParam0, 2048);
...
{
	return func_160(Global_1914319->f_3[iParam0]->f_5, iParam1);
}

void func_96(int iParam0)
{
	if (func_88(Global_1914319->f_3[iParam0]->f_21) && func_161(Global_1914319->f_3[iParam0]->f_21))
	{
		func_162(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_163(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_148(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_101(int iParam0, int iParam1)
{
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_25))
	{
		...
		func_53(iParam1, Global_1914319->f_3[iParam0]->f_25, 1);
	...
	if (_does_volume_exist(Global_1914319->f_3[iParam0]->f_28))
	{
		...
		func_53(iParam1, Global_1914319->f_3[iParam0]->f_28, 1);
...
bool func_111(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_172(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_112(iParam0));
}
...
{
	iLocal_116 = 0;
	if (Global_1914319->f_3[2]->f_7 & 512 == 0)
	{
		return;
	}
	if ((*uParam0)[iLocal_116]->f_29 == 1)
	{
		if (func_187((*uParam0)[iLocal_116], 1, 1))
		{
			func_188((*uParam0)[iLocal_116]);
		}
	}
}
...
char* func_130(char* sParam0, int iParam1)
{
	...
	return func_197(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_133(int iParam0)
{
	...
	if (func_198())
	{
		if (!func_199((*Global_1835011)[3]->f_1, 1))
		{
...
void func_144(int iParam0)
{
	...
	if (!func_138(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
void func_145()
{
	...
	while (iVar0 < 1)
	{
		if (func_203(&(Local_117[iVar0]->f_34)))
		{
			func_204(&(Local_117[iVar0]->f_34));
		}
		func_205(Local_117[iVar0]->f_38);
		func_205(Local_117[iVar0]->f_39);
		iVar0++;
	}
}
...
int func_150(int iParam0, bool bParam1)
{
	...
	func_211(iParam0);
	_0xfc77c5b44d5ff7c0(func_112(iParam0));
	func_156(iParam0, 0);
	return 1;
}
...
void func_151(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		func_154((*uParam0)[iParam3], 128);
	}
	if (!func_203(&((*uParam0)[iParam3]->f_34)))
	{
		func_213(&((*uParam0)[iParam3]->f_34), 1);
	}
	func_154((*uParam0)[iParam3], 32768);
	func_154((*uParam0)[iParam3], 1024);
...
Vector3 func_152(var uParam0)
{
	...
	{
		sVar1 = func_216(*Global_1393529->f_288[1]);
...
{
	return func_160(Global_1914319->f_3[iParam0]->f_6, iParam1);
}
...
bool func_174(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_199((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_175()
{
	if (!func_199((*Global_1835011)[4]->f_1, 1))
	{
		return 0;
	}
	else if (!func_199((*Global_1347702)[66]->f_15, 1))
	{
		return 1;
	}
	else if (!func_199((*Global_1347702)[67]->f_15, 1))
	{
		return 2;
	}
	else if (!func_199((*Global_1835011)[38]->f_1, 1))
	{
		return 3;
	}
	else if (!func_199((*Global_1347702)[68]->f_15, 1))
	{
		return 4;
	}
	else if (!func_199((*Global_1835011)[59]->f_1, 1))
	{
		return 5;
	}
	else if (!func_199((*Global_1835011)[67]->f_1, 1))
	{
		return 7;
	}
	else
...
void func_182(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_181(iParam0))
	{
...
void func_188(var uParam0)
{
	...
	if (!func_231(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			iVar5 = func_172(&(uParam0->f_3[iVar4]));
			if (!func_242(iVar5, 0))
			{
				return;
			}
...
var func_192(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
var func_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return _0xd8402b858f4ddd88(&uParam0, get_length_of_literal_string(&uParam0));
}
...
float func_232(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_269(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_234(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319->f_17371 || func_276(func_172(*uParam0), 1, 1, 1, 0)) || _is_ped_hogtied(func_172(*uParam0)))
	{
		func_272(uParam0);
		return uParam0->f_30;
	}
	if ((((func_277(player_id(), 1, 0, 1) || func_278()) || _0xf46108c50a22b029()) || _0x69e181772886f48b(player_id())) || _0xd1f6b912785bfd35(player_id()))
	{
		return false;
	}
...
void func_238(var uParam0)
{
	...
	if (uParam0->f_2)
	{
		...
		while (iVar1 < 5)
		{
			if (func_88(&(uParam0->f_3[iVar1])) && uParam0->f_3[iVar1]->f_2)
			{
				iVar2 = func_172(&(uParam0->f_3[iVar1]));
				if (does_entity_exist(iVar2))
				{
...
bool func_239(var uParam0, int iParam1)
{
	if (func_231(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			iVar1 = func_172(&(uParam0->f_3[iVar0]));
...
bool func_245(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	...
	else if (func_292(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		iVar0 = uParam0[0];
		iVar1 = uParam0[1];
		if ((does_entity_exist(iVar0) && !func_293(iVar0, 0)) && (does_entity_exist(iVar1) && !func_293(iVar1, 0)))
		{
			if (!func_94(vParam4))
			{
...
bool func_262(int iParam0)
{
	...
	return func_199((*Global_1347702)[58]->f_15, 1);
}
...
int func_276(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		...
		{
			if (func_310(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_278()
{
	if (_is_ped_carrying(Global_35) || func_312(Global_35))
	{
		return 1;
	}
	return 0;
...
{
	if (!does_entity_exist(iParam0) || func_293(iParam0, 0))
	{
		return false;
	}
	if (func_313(iParam0))
...
bool func_289(int iParam0, int iParam1)
{
	...
	return func_177(Global_1914319->f_3[iParam0]->f_10, 1024);
}
...
{
	if (((func_306(1) || _0x2b101ad9f651243a()) || is_scripted_speech_playing(iParam0)) || is_any_speech_playing(iParam0))
	{
		return true;
	}
	return false;
