...
{
	func_9(uParam0);
	_0xe7282390542f570d(uLocal_128);
...
void func_8(var uParam0)
{
	...
	{
		case 0:
			if (_does_text_database_exist(func_51(0)))
			{
				_text_database_request(func_51(0));
			}
			_0xf008e0ba1fe1d644(1);
			request_model(func_52(0), false);
			func_49(&Local_14, 1);
			break;
		case 1:
			...
			if (!is_entity_dead(&(Local_14.f_103[0])))
			{
				func_61(&(Local_14.f_2), &(Local_14.f_103[0]), func_51(2), 0);
				set_blocking_of_non_temporary_events(&(Local_14.f_103[0]), true);
				func_62(&(Local_14.f_103[0]), 2131255687);
			}
			if (_does_anim_scene_exist(&(Local_14.f_107[0])))
			{
				set_anim_scene_entity(&(Local_14.f_107[0]), "Cougarman", &(Local_14.f_103[0]), 0);
				start_anim_scene(&(Local_14.f_107[0]));
			...
			break;
		case 2:
			if (!_does_volume_exist(&(Local_14.f_105[0])))
			{
				return;
			}
			else if (is_entity_in_volume(Global_35, &(Local_14.f_105[0]), true, 0))
			{
		...
		case 3:
			...
			{
				if (_does_volume_exist(&(Local_14.f_105[0])) && is_entity_in_volume(Global_35, &(Local_14.f_105[0]), true, 0))
				{
					func_66(*uParam0);
				}
			}
		...
		case 4:
			if (!is_entity_dead(&(Local_14.f_103[0])))
			{
				delete_ped(Local_14.f_103[0]);
			}
			else
			{
				set_ped_as_no_longer_needed(Local_14.f_103[0]);
			}
			func_49(&Local_14, 5);
			break;
		case 5:
...
bool func_16(int iParam0)
{
	...
	{
		return func_75((*Global_1835011)[iParam0]->f_1, 1);
	}
...
int func_26(var uParam0)
{
	...
	return (func_81() - round((uParam0->f_1 * 1000f)));
}
...
bool func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if ((((*uParam0 == -1761578407 || *uParam0 == 404434344) || *uParam0 == -1243267511) || *uParam0 == -607940493) || *uParam0 == 1535254161)
		{
			...
			if (!is_entity_in_volume(Global_35, uParam0->f_6.f_9, true, 0) || !func_84(Global_35, uParam0->f_6.f_2, 0))
			{
				return true;
			}
		}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_91(uParam0->f_4) != 0)
		{
			...
			{
				_0xd8c7162ab2e2af45(func_91(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!_map_is_discovery_active(func_92(*uParam0, uParam0->f_4)))
			{
				_0xd8c7162ab2e2af45(func_92(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_93(uParam0);
...
bool func_46(var uParam0)
{
	if (_does_volume_exist(*uParam0))
	{
		...
		if (_get_entity_inside_explosion_area(-1, Var0, Var0.f_3, Var0.f_6) == func_107(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	...
	if ((Global_36616 && func_108(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_110(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
...
bool func_55(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
...
bool func_57(var uParam0, struct<10> Param1, var uParam11)
{
	if (!_does_volume_exist(*uParam0))
	{
...
bool func_60(var uParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5)
{
...
bool func_67(int iParam0)
{
	...
	if (iParam0->f_1 < 5)
	{
		if (func_127())
		{
			if (does_entity_exist(&(iParam0->f_103[0])))
			{
				set_ped_config_flag(&(iParam0->f_103[0]), 88, true);
				set_entity_proofs(&(iParam0->f_103[0]), 4, false);
			}
			add_explosion(func_53(2), 12, 2f, false, true, 0f);
			func_63(iParam0->f_107[0], func_59(1));
			func_65(&(iParam0->f_1), 5);
		}
	}
	switch (iParam0->f_1)
	{
		case 0:
			break;
		case 1:
			if (!func_24(&(iParam0->f_100)))
			{
				func_25(&(iParam0->f_100));
			}
			else if (func_128(iParam0, 3))
			{
				if (iParam0->f_109 < 1)
				{
					force_sonar_blips_this_frame();
					allow_sonar_blips(true);
					_trigger_sonar_blip_2(1715123483, &(iParam0->f_103[0]));
				}
				iParam0->f_111 = 0;
				func_65(&(iParam0->f_1), 2);
			}
			break;
		case 2:
			if (func_129(&(iParam0->f_100), 8f))
			{
				if (func_128(iParam0, 4))
				{
					...
					if (iParam0->f_111 > 3)
					{
						func_23(&(iParam0->f_100));
						iParam0->f_111 = 0;
						func_65(&(iParam0->f_1), 0);
					}
				}
			}
			break;
		case 3:
			if (iParam0->f_111 == 0)
			{
				func_65(&(iParam0->f_1), 4);
			}
			else if (func_126())
			{
				if (func_24(&(iParam0->f_100)))
				{
					if (func_129(&(iParam0->f_100), 5f))
					{
						func_65(&(iParam0->f_1), 4);
					}
				}
		...
		case 4:
			...
			break;
		case 5:
			if (does_entity_exist(&(iParam0->f_103[0])) && is_entity_dead(&(iParam0->f_103[0])))
			{
				if (_does_anim_scene_exist(&(iParam0->f_107[0])))
				{
					_delete_anim_scene(&(iParam0->f_107[0]));
				}
				func_65(&(iParam0->f_1), 6);
			}
			break;
		case 6:
			func_131(iParam0->f_103[0], 0);
			set_ped_config_flag(&(iParam0->f_103[0]), 26, true);
			_0xae6004120c18df97(&(iParam0->f_103[0]), 1, 0);
			func_132(iParam0->f_103[0], 0);
			func_65(&(iParam0->f_1), 7);
			break;
		case 7:
			return true;
	}
...
void func_77(var uParam0)
{
	if (*uParam0 == 404434344)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, func_138(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!_does_volume_exist(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = _create_volume_cylinder_with_custom_name(vVar0, vVar3, vVar6, func_138(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
bool func_83(var uParam0, int iParam1)
{
	...
	if (!func_143(iParam1, 256) && is_cinematic_cam_rendering())
	{
		return false;
	}
...
void func_90(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_151(iParam0, 8))
		{
...
void func_93(var uParam0)
{
	...
	{
		if (!_map_is_discovery_active(func_153(*uParam0)))
		{
			_0xd8c7162ab2e2af45(func_153(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
bool func_101()
{
	...
	if (_0x3ab6c7b0bb0df4b1(Global_35, -1) || func_150(Global_35, 1369124074))
	{
		return false;
	}
	...
	iVar0 = -569063887;
	if (_0x3d10d7179d7034af(func_158(0), iVar0, 0))
	{
		return false;
	}
...
void func_110(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	iVar0 = func_160();
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_170(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_170(_create_var_string(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (is_string_null_or_empty(sParam4))
				{
					func_170(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_170(_create_var_string(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", get_hash_key("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_126()
{
	return has_bullet_impacted_in_box(func_53(7), func_53(8), true, true);
}

bool func_127()
{
	return is_bullet_in_area(func_53(2), 0.5f, true);
}

bool func_128(int iParam0, int iParam1)
{
	return func_176(&(iParam0->f_2), func_175(func_51(iParam1)), 1, -1, 0, 0);
}
...
bool func_142(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_182(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
bool func_148(int iParam0)
{
	...
	else if (is_ped_in_any_vehicle(Global_35, true))
	{
		...
		if ((!func_143(iParam0, 16) && !is_ped_on_mount(Global_35)) && _0x2963b5c1637e8a27(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_161(int iParam0)
{
	...
	fVar1 = func_198(absf(fVar1) < 1f, func_198(fVar1 < 0f, -1f, 1f), fVar1);
	return ceil(fVar1);
}
...
{
	func_201((get_game_timer() + iParam2), !bParam1);
...
void func_167(int iParam0)
{
	...
	_databinding_write_data_string(&(Global_1955569->f_5.f_2[0]->f_20[2]), func_203(iParam0));
...
int func_171(int iParam0, int iParam1)
{
	...
	if (!func_210(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
bool func_187(int iParam0)
{
	...
	if (!func_143(iParam0, 16) && !func_220(iVar0, 0))
	{
		return false;
	}
	return true;
...
int func_195(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = _0xe787f05dfc977bde(func_158(bParam2), iParam0, 0);
	return uVar2;
}
...
bool func_223(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
struct<4> func_233(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224215 = { func_239(923904168, func_238(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224223 = { func_239(923904168, func_238(bParam0), -740156546, 0) };
		}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_158(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
