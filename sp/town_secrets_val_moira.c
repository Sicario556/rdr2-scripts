...
void func_4(int iParam0)
{
	...
	if (Local_0 < 5)
	{
		if (fVar0 < 20f)
		{
			...
			if ((is_ped_shooting(Global_35) || func_17(get_player_index(), 1, 0, 1)) || _0xf46108c50a22b029())
			{
	...
	switch (Local_0)
	{
		case 0:
			...
			if (fVar0 < 20f && !_is_ped_getting_into_a_mount_seat(Global_35, true))
			{
				func_18(&Local_0, 1);
			}
			break;
...
void func_7(var uParam0)
{
	...
	{
		iVar0 = iVar2;
		if (does_entity_exist(&(Local_0.f_2[iVar0])))
		{
			delete_ped(Local_0.f_2[iVar0]);
		}
		iVar2++;
	}
	iVar2 = 0;
	...
	{
		iVar1 = iVar2;
		if (_does_volume_exist(&(Local_0.f_5[iVar1])))
		{
			_delete_volume(&(Local_0.f_5[iVar1]));
		}
		iVar2++;
	}
	if (_does_text_database_exist(func_35()))
	{
		if (_text_database_has_loaded(func_35()))
		{
			_text_database_delete(func_35());
		}
	}
}
...
bool func_19()
{
	...
	{
		iVar1 = iVar0;
		request_model(func_39(iVar1), false);
		iVar0++;
	}
	_0xed9582b3da8f02b4(2);
	if (_does_text_database_exist(func_35()))
	{
		_text_database_request(func_35());
	}
	return true;
}
...
bool func_20()
{
	...
	{
		iVar2 = iVar1;
		if (!has_model_loaded(func_39(iVar2)))
		{
			iVar0 = 0;
		}
		iVar1++;
...
bool func_21(int iParam0)
{
	...
	{
		iVar1 = iVar0;
		if (!does_entity_exist(&(iParam0->f_2[iVar1])))
		{
	...
	while (iVar0 <= (1 - 1))
	{
		if (!_does_volume_exist(&(iParam0->f_5[iVar0])))
		{
			iVar2 = iVar0;
			Var3 = { func_42(iVar2) };
			iParam0->f_5[iVar0] = _create_volume_by_hash_with_custom_name(Var3.f_10, Var3, Var3.f_3, Var3.f_6, Var3.f_9);
		}
		iVar0++;
	}
	func_43(&(iParam0->f_7), &(iParam0->f_2[0]), "VAL_Sheriff", 0);
	func_43(&(iParam0->f_7), &(iParam0->f_2[1]), "MOIRA", 0);
	stop_ped_speaking(&(iParam0->f_2[0]), true);
	stop_ped_speaking(&(iParam0->f_2[1]), true);
	return true;
}
		...
		if (&Global_40.f_4283.f_6[iVar0] == 176656832)
		{
			...
			if (func_51(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_52(Global_40.f_4283.f_6[iVar4], 1, 0);
					}
					iVar4++;
				}
			}
...
int func_33(int iParam0)
{
	...
	while (iVar0 <= (2 - 1))
	{
		...
		if (does_entity_exist(&(iParam0->f_2[iVar1])))
		{
			delete_ped(iParam0->f_2[iVar1]);
		}
		if (is_model_valid(func_39(iVar1)))
		{
			set_model_as_no_longer_needed(func_39(iVar1));
		}
		if (_text_database_has_loaded(func_35()))
		{
			_text_database_delete(func_35());
	...
	while (iVar0 <= (1 - 1))
	{
		if (_does_volume_exist(&(iParam0->f_5[iVar0])))
		{
			_delete_volume(&(iParam0->f_5[iVar0]));
		}
		iVar0++;
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_81(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
