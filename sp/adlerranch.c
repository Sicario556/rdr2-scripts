...
void func_53()
{
	...
	if (bVar0 != bLocal_0)
	{
		if (bVar0)
		{
			if (!_is_imap_active(-739334986))
			{
				_request_imap(-739334986);
			}
		}
		else if (_is_imap_active(-739334986))
		{
			_remove_imap(-739334986);
		}
		bLocal_0 = bVar0;
	}
}
...
{
	if (func_84(Global_1914319->f_3[iParam0]->f_21) && func_148(Global_1914319->f_3[iParam0]->f_21))
	{
