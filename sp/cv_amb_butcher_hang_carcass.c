...
{
	if (does_entity_exist(func_22(uParam0, iLocal_15)))
	{
		_0xcaaf2bccfef37f77(func_22(uParam0, iLocal_15), 32);
	}
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && _0x6f1f0b17109309da(uParam0->f_2046, "ARTHUR")) || (func_280() && _0x6f1f0b17109309da(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
{
	freeze_entity_position(func_22(uParam0, iLocal_15), true);
	iVar0 = get_ped_bone_index(func_49(uParam0, iLocal_14), 53081);
	iVar1 = get_ped_bone_index(func_49(uParam0, iLocal_14), 41273);
	iVar2 = get_entity_bone_index_by_name(func_22(uParam0, iLocal_15), "bottomHookInd02");
	iVar3 = get_entity_bone_index_by_name(func_22(uParam0, iLocal_15), "bottomHookInd01");
	vVar4 = { get_world_position_of_entity_bone(func_22(uParam0, iLocal_15), iVar2) };
	vVar7 = { get_world_position_of_entity_bone(func_22(uParam0, iLocal_15), iVar3) };
	set_ped_to_ragdoll(func_49(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	_0xe1aadd0055d76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_15), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	_0xe1aadd0055d76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_15), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
