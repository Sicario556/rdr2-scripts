			...
			switch (iVar544)
			{
				...
				case 1:
					if (func_20(&Local_84, &vScriptParam_0, 0, 0, 0, 1, 0, 1))
					{
						...
						if (_does_volume_exist(Local_84.f_173))
						{
				...
				case 4:
					func_34();
					if (!func_36(&Local_84, &uLocal_37, iLocal_35, !func_35(iVar684, 1024), 1, 0, 1, 0))
					{
						func_17();
					}
					if (!Local_84.f_46)
					...
					if (_does_anim_scene_exist(iVar376) && _is_anim_scene_started(iVar376, false))
					{
						fLocal_691 = _get_anim_scene_progress(iVar376);
						fLocal_691 = fVar689;
					}
					if (func_41())
					{
...
void func_17()
{
	if (_does_volume_exist(iVar697))
	{
		_delete_volume(iVar697);
	}
	if (_does_volume_exist(iVar698))
	{
		_delete_volume(iVar698);
	}
	if (_does_volume_exist(iLocal_26))
	{
		_delete_volume(iLocal_26);
	}
	...
	{
		_task_start_scenario_in_place(&(uLocal_37[0]), -332343734, -1, true, 0, -1f, false);
		set_ped_keep_task(&(uLocal_37[0]), true);
		func_53(&(uLocal_37[0]), 1088421888, 1, 1);
		_0x39a2fc5af55a52b1(&(uLocal_37[0]), -1);
		set_ped_as_no_longer_needed(uLocal_37[0]);
		if (func_52(&(uLocal_37[1]), 0, 1))
		{
			_task_smart_flee_style_ped(&(uLocal_37[1]), Global_35, 6, 256, -1082130432, -1, 0);
			set_ped_keep_task(&(uLocal_37[1]), true);
			func_53(&(uLocal_37[1]), 1088421888, 1, 1);
			_0x39a2fc5af55a52b1(&(uLocal_37[1]), -1);
			set_ped_as_no_longer_needed(uLocal_37[1]);
		}
		if (func_52(&(uLocal_37[2]), 0, 1))
		{
			_task_smart_flee_style_ped(&(uLocal_37[2]), Global_35, 6, 256, -1082130432, -1, 0);
			set_ped_keep_task(&(uLocal_37[2]), true);
			func_53(&(uLocal_37[2]), 1088421888, 1, 1);
			_0x39a2fc5af55a52b1(&(uLocal_37[2]), -1);
			set_ped_as_no_longer_needed(uLocal_37[2]);
		}
		Local_84.f_50 = 1;
	}
	func_54(&Local_84, &uLocal_37, &uLocal_41, iLocal_35, uVar704, uVar702, 0, 1, 0, 1);
	func_55();
	func_56(&uLocal_695, &uLocal_697);
	func_56(&uLocal_696, &uLocal_698);
	set_object_as_no_longer_needed(&(Local_71[0]->f_8));
	if (iVar685 != 0)
	{
		remove_shocking_event(iVar685);
	}
...
void func_18(bool bParam0, int iParam1, bool bParam2)
{
	if (bParam0)
	{
		if (!func_57(bParam2) || is_screen_faded_out())
		{
			Call_Loc(iParam1);
		}
	}
	...
	switch (iVar542)
	{
		case 0:
			if (func_58(&Local_84))
			{
				...
				func_62();
				func_63(&Local_71);
				Local_378 = _create_anim_scene(Local_378.f_4, 0, "PBL_NORMAL", false, true);
				Local_378.f_1 = _create_anim_scene(Local_378.f_5, 0, "PBL_NORMAL", false, true);
				load_anim_scene(iVar376);
				load_anim_scene(Local_378.f_1);
				iLocal_544 = 1;
			}
			break;
		case 1:
			if (!func_64(&uLocal_543, uVar688))
			{
				return false;
			}
			if (!func_65(&Local_71))
			...
			iVar0 = 1;
			if (!is_string_null_or_empty(Local_378.f_4))
			{
			...
			if (!is_string_null_or_empty(Local_378.f_5))
			{
				if (!_is_anim_scene_loaded(Local_378.f_1, true, false))
				{
					iVar0 = 0;
				}
			}
			if (!_is_anim_scene_metadata_loaded(iVar376, false))
			{
				iVar0 = 0;
			}
			if (!_is_anim_scene_metadata_loaded(Local_378.f_1, false))
			{
				iVar0 = 0;
			}
			if (iVar0 == 0)
		...
		case 0:
			switch (*uParam2)
			{
				case 0:
					...
					_0x39816f6f94f385ad(uParam0->f_173, 2663.13f, -1213.915f, 53.3178f, 0f, 0f, 0f, 83.7422f, 13.0435f, 6.4911f);
					_0x39816f6f94f385ad(uParam0->f_173, 2665.778f, -1178.708f, 52.8252f, 0f, 0f, 0f, 11.4248f, 60.5283f, 7.5828f);
					break;
				case 1:
					uParam0->f_173 = _create_volume_aggregate();
					_0x39816f6f94f385ad(uParam0->f_173, 2514.995f, -1252.154f, 51.1361f, 0f, 0f, 0f, 53.7495f, 43.0997f, 8.0363f);
					_0x39816f6f94f385ad(uParam0->f_173, 2466.635f, -1254.307f, 47.8598f, 0f, 0f, -15.0381f, 54.4846f, 26.8234f, 14.8605f);
					_0x39816f6f94f385ad(uParam0->f_173, 2548.249f, -1261.118f, 52.2334f, 0f, 0f, 0f, 14.0436f, 24.2246f, 8.8268f);
					_0x39816f6f94f385ad(uParam0->f_173, 2498.64f, -1221.029f, 50.3406f, 0f, 0f, 0f, 21.0024f, 20.4929f, 6.4938f);
					break;
				case 2:
					uParam0->f_173 = _create_volume_aggregate();
					_0x39816f6f94f385ad(uParam0->f_173, 2869.837f, -1198.849f, 47.0872f, 0f, 0f, 5.0134f, 13.3964f, 66.7883f, 4.7158f);
					_0x39816f6f94f385ad(uParam0->f_173, 2880.193f, -1243.177f, 47.985f, 0f, 0f, -19.2557f, 42.4481f, 39.6014f, 7.6006f);
					_0x39816f6f94f385ad(uParam0->f_173, 2889.204f, -1225.71f, 47.4091f, 0f, 0f, 5.3433f, 25.7292f, 9.3016f, 5.2172f);
					break;
			}
			break;
	}
			...
			switch (Local_84.f_51.f_4)
			{
				case 0:
					if (iLocal_35 == 0)
					{
						...
						Local_281[0]->f_6 = { 2663.406f, -1218.514f, 56.735f };
						Local_281[0]->f_9 = 0.912f;
						...
						func_73(iLocal_27, 1);
						func_73(iLocal_28, 1);
						iLocal_26 = _create_volume_box_with_custom_name(vLocal_20, vLocal_23, vLocal_17, "REPS - volClearBalcony");
						*vLocal_45[2] = { 2661.37f, -1209.022f, 52.33669f };
						*vLocal_55[2] = { 2660.332f, -1149.55f, 49.85461f };
						Local_281[2]->f_6 = { Local_84.f_51 };
					}
					else if (iLocal_35 == 1)
					{
						Local_84.f_51.f_3 = -69.02f;
						Local_281[0]->f_6 = { 2662.974f, -1218.56f, 56.735f };
						Local_281[0]->f_9 = 6.544f;
						vLocal_65 = { 2658.072f, -1219.6f, 56.66819f };
						vLocal_68 = { 2658.116f, -1225.227f, 56.71788f };
						vLocal_14 = { 5f, 5f, 9f };
						vLocal_17 = { 10.948f, 2.102f, 4.703f };
						...
						iLocal_26 = _create_volume_box_with_custom_name(vLocal_20, vLocal_23, vLocal_17, "REPS - volClearBalcony");
						Local_281[2]->f_6 = { Local_84.f_51 };
						Local_281[1]->f_6 = { Local_281[2]->f_6 + Vector(0f, 0f, 1f) };
						*vLocal_45[1] = { 2676.668f, -1217.01f, 52.18956f };
						*vLocal_45[2] = { 2672.237f, -1218.652f, 52.30123f };
						*vLocal_55[1] = { 2713.988f, -1205.209f, 50.74175f };
						*vLocal_55[2] = { 2756.561f, -1247.488f, 48.49338f };
					}
					else if (iLocal_35 == 2)
					{
						Local_84.f_51.f_3 = -47.714f;
						Local_281[0]->f_6 = { 2663.258f, -1218.545f, 56.735f };
						Local_281[0]->f_9 = 0.406f;
						vLocal_65 = { 2658.072f, -1219.6f, 56.66819f };
						vLocal_68 = { 2658.116f, -1225.227f, 56.71788f };
						vLocal_14 = { 5f, 5f, 9f };
						vLocal_17 = { 10.948f, 2.102f, 4.703f };
						...
						Local_281[2]->f_6 = { Local_84.f_51 };
						Local_281[1]->f_6 = { Local_281[2]->f_6 + Vector(0f, 0f, 1f) };
						*vLocal_45[2] = { 2654.091f, -1217.198f, 52.30483f };
						*vLocal_45[1] = { 2678.891f, -1217.977f, 52.10874f };
						*vLocal_55[2] = { 2592.1f, -1175.982f, 52.3105f };
						*vLocal_55[1] = { 2738.177f, -1247.727f, 48.83985f };
					}
					break;
				case 1:
					if (iLocal_35 == 0)
					{
						...
						Local_281[0]->f_6 = { 2497.502f, -1270.647f, 53.234f };
						Local_281[0]->f_9 = 7.738f;
						...
						iLocal_26 = _create_volume_box_with_custom_name(vLocal_20, vLocal_23, vLocal_17, "REPS - volClearBalcony");
						Local_281[2]->f_6 = { Local_84.f_51 };
						*vLocal_45[2] = { 2488.745f, -1256.881f, 48.20708f };
						*vLocal_55[2] = { 2421.722f, -1239.377f, 44.7325f };
					}
					else if (iLocal_35 == 1)
					{
						Local_84.f_51.f_3 = -67.839f;
						Local_281[0]->f_6 = { 2497.154f, -1270.702f, 53.234f };
						Local_281[0]->f_9 = 6.142f;
						...
						Local_281[2]->f_6 = { Local_84.f_51 };
						Local_281[1]->f_6 = { Local_281[2]->f_6 + Vector(0f, 0f, 1f) };
						*vLocal_45[1] = { 2597.994f, -1270.784f, 51.46727f };
						*vLocal_45[2] = { 2595.68f, -1255.716f, 51.66747f };
						*vLocal_55[2] = { 2417.642f, -1248.713f, 44.56108f };
						*vLocal_55[1] = { 2597.095f, -1270.554f, 51.41447f };
					}
					else if (iLocal_35 == 2)
					{
						Local_84.f_51.f_3 = -50.887f;
						Local_281[0]->f_6 = { 2497.154f, -1270.702f, 53.234f };
						Local_281[0]->f_9 = 6.46f;
						vLocal_65 = { 2492.751f, -1272.804f, 53.41405f };
						vLocal_68 = { 2493.313f, -1272.858f, 54.409f };
						vLocal_14 = { 5f, 5f, 9f };
						vLocal_17 = { 13.869f, 1.489f, 3.65f };
						...
						Local_281[2]->f_6 = { Local_84.f_51 };
						Local_281[1]->f_6 = { Local_281[2]->f_6 + Vector(0f, 0f, 1f) };
						*vLocal_45[2] = { 2486.505f, -1269.98f, 48.16777f };
						*vLocal_45[1] = { 2510.891f, -1270.31f, 48.18351f };
						*vLocal_55[2] = { 2417.642f, -1248.713f, 44.56108f };
						*vLocal_55[1] = { 2597.095f, -1270.554f, 51.41447f };
					}
					break;
				case 2:
					if (iLocal_35 == 0)
					{
						...
						Local_281[0]->f_6 = { 2865.503f, -1211.614f, 49.518f };
						Local_281[0]->f_9 = -84.269f;
						...
						iLocal_26 = _create_volume_box_with_custom_name(vLocal_20, vLocal_23, vLocal_17, "REPS - volClearBalcony");
						Local_281[2]->f_6 = { Local_84.f_51 };
						*vLocal_45[2] = { 2873.815f, -1210.418f, 45.04704f };
						*vLocal_55[2] = { 2872.546f, -1181.935f, 44.92761f };
					}
					else if (iLocal_35 == 1)
					{
						Local_84.f_51.f_3 = -153.216f;
						Local_281[0]->f_6 = { 2865.534f, -1211.583f, 49.518f };
						Local_281[0]->f_9 = -76.422f;
						...
						Local_281[2]->f_6 = { Local_84.f_51 };
						Local_281[1]->f_6 = { Local_281[2]->f_6 + Vector(0f, 0f, 1f) };
						*vLocal_45[2] = { 2865.652f, -1227.812f, 45.34529f };
						*vLocal_45[1] = { 2860.442f, -1222.509f, 46.62189f };
						*vLocal_55[2] = { 2830.709f, -1283.015f, 45.8672f };
						*vLocal_55[1] = { 2815.199f, -1226.221f, 46.52655f };
					}
					else if (iLocal_35 == 2)
					{
						Local_84.f_51.f_3 = -137.648f;
						Local_281[0]->f_6 = { 2865.522f, -1211.691f, 49.518f };
						Local_281[0]->f_9 = -76.422f;
						vLocal_65 = { 2864.197f, -1209.512f, 49.62901f };
						vLocal_68 = { 2861.269f, -1209.808f, 49.61028f };
						vLocal_14 = { 5f, 5f, 9f };
						...
						*vLocal_45[2] = { 2654.091f, -1217.198f, 52.30483f };
						*vLocal_45[1] = { 2678.891f, -1217.977f, 52.10874f };
						*vLocal_55[2] = { 2849.686f, -1079.653f, 44.31217f };
						*vLocal_55[1] = { 2830.709f, -1283.015f, 45.8672f };
					}
					break;
			}
			break;
...
void func_24()
{
	request_collision_at_coord(Local_281[0]->f_6);
	request_collision_for_model(Local_281[0]->f_1);
}
...
void func_25()
{
	...
	Local_281[0]->f_3 = uVar2;
	iVar3 = func_75(0, iVar0);
	if (iVar3 != -1)
	{
		Local_281[0]->f_5 = &uLocal_536[iVar3];
	}
	func_74(1, iVar0, &uVar1, &uVar2);
	Local_281[1]->f_3 = uVar2;
	iVar3 = func_75(1, iVar0);
	if (iVar3 != -1)
	{
		Local_281[1]->f_5 = &uLocal_536[iVar3];
	}
	func_74(2, iVar0, &uVar1, &uVar2);
	Local_281[2]->f_3 = uVar2;
	iVar3 = func_75(2, iVar0);
	if (iVar3 != -1)
	{
		Local_281[2]->f_5 = &uLocal_536[iVar3];
	}
}
...
bool func_31()
{
	if (!func_35(iVar684, 2048) && func_52(&(uLocal_37[0]), 0, 1))
	{
		func_79(&(uLocal_37[0]), 1);
		func_80(&(uLocal_37[0]), Local_281[0]->f_6, Local_281[0]->f_9, 2, 1073741824);
		if (!is_string_null_or_empty(&(Local_281[0]->f_23)))
		{
			func_81(&(uLocal_37[0]), &(Local_281[0]->f_23), 0);
		}
		set_ped_config_flag(&(uLocal_37[0]), 178, false);
		if (func_52(&(uLocal_37[2]), 0, 1))
		{
			_0xaab050da48b57978(&(uLocal_37[0]), func_82(), &(uLocal_37[2]), -1, 4);
		}
		Local_84.f_98[0] = func_83(&(uLocal_37[0]), 1, 1);
		func_84(&uLocal_686, 2048);
	...
	if (!func_35(iVar684, 8192) && func_52(&(uLocal_37[2]), 0, 1))
	{
		set_entity_heading(&(uLocal_37[2]), Local_84.f_51.f_3);
		if (!is_string_null_or_empty(&(Local_281[2]->f_23)))
		{
			func_81(&(uLocal_37[2]), &(Local_281[2]->f_23), 0);
		}
		set_ped_config_flag(&(uLocal_37[2]), 178, false);
		Local_84.f_98[2] = func_83(&(uLocal_37[2]), 1, 1);
		func_84(&uLocal_686, 8192);
	}
	if (!func_35(iVar684, 4096) && (func_52(&(uLocal_37[1]), 0, 1) || iLocal_35 == 0))
	{
		if (iLocal_35 == 1 || iLocal_35 == 2)
		{
			set_entity_heading(&(uLocal_37[1]), Local_84.f_51.f_3);
			if (!is_string_null_or_empty(&(Local_281[1]->f_23)))
			{
				func_81(&(uLocal_37[1]), &(Local_281[1]->f_23), 0);
			}
			set_ped_config_flag(&(uLocal_37[1]), 178, false);
			Local_84.f_98[1] = func_83(&(uLocal_37[1]), 1, 1);
			func_84(&uLocal_686, 4096);
		}
		else
		{
			delete_ped(uLocal_37[1]);
			func_84(&uLocal_686, 4096);
		}
	}
	if ((func_35(iVar684, 2048) && func_35(iVar684, 4096)) && func_35(iVar684, 8192))
	{
		uLocal_699 = _0x0eb78c2b156635b1(665633627, Local_84.f_51, 0f, 0f, 0f, vLocal_701);
		uLocal_700 = _0x0eb78c2b156635b1(665633627, Local_84.f_51, 0f, 0f, 0f, vLocal_701);
		if (_does_volume_exist(iVar697) && func_52(&(uLocal_37[1]), 0, 1))
		{
			_0x7c00cfc48a782dc0(iVar697, &(uLocal_37[1]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
		}
		if (_does_volume_exist(iVar698) && func_52(&(uLocal_37[2]), 0, 1))
		{
			_0x7c00cfc48a782dc0(iVar698, &(uLocal_37[2]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
		}
...
void func_32()
{
	set_anim_scene_origin(iVar376, Local_84.f_51, 0f, 0f, Local_84.f_51.f_3, 2);
	if (iLocal_35 == 0)
	{
		set_anim_scene_entity(iVar376, "PED_MALE_B", &(uLocal_37[2]), 0);
	}
	else
	{
		set_anim_scene_entity(iVar376, "PED_MALE_A", &(uLocal_37[1]), 0);
		set_anim_scene_entity(iVar376, "PED_MALE_B", &(uLocal_37[2]), 0);
	}
	Local_71[0]->f_8 = create_object(Local_71[0]->f_7, Local_281[0]->f_6 + Vector(0f, 0.25f, 0.25f), true, true, false, false, true);
	set_anim_scene_origin(Local_378.f_1, Local_281[0]->f_6, 0f, 0f, Local_281[0]->f_9, 2);
	set_anim_scene_entity(Local_378.f_1, "PED_WOMAN", &(uLocal_37[0]), 0);
	set_anim_scene_entity(Local_378.f_1, "CHAMBER_POT", Local_71[0]->f_8, 0);
	if (!is_string_null_or_empty(Local_378.f_4))
	{
		if (!_is_anim_scene_loaded(iVar376, true, false))
		{
	...
	set_anim_scene_bool(iVar376, "ACTION", false, false);
	set_anim_scene_bool(Local_378.f_1, "ACTION", false, false);
}
...
void func_33(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, bool bParam11, int iParam12, bool bParam13, int iParam14, char* sParam15)
{
	...
	if (_does_volume_exist(*uParam0))
	{
		...
		if (bParam13)
		{
			*uParam1 = _0x4c39c95ae5db1329(*uParam0, false, 15);
		}
	}
}
...
void func_34()
{
	if (!Local_84.f_48 && func_91(get_player_index(), 1, 0, 1))
	{
		func_17();
	}
}
...
void func_37()
{
	if (func_101(&uLocal_37, &(Local_84.f_5), &uLocal_685, &uLocal_688, 0, (3 - 1), 1))
	{
		if (iVar683 == 8)
		{
			iVar0 = func_102(Global_35, 0, 1, 0);
			if (iVar0 == 2055893578 || iVar0 == -1569615261)
			{
				func_103(&(Local_84.f_5), &uLocal_685);
				return;
			}
		}
		if (Local_84.f_5.f_10 == &uLocal_37[1])
		{
			...
			{
				func_40(0);
				func_105(&(uLocal_37[1]), Global_35, func_104("MALE_B_AGGRO"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			}
			Local_84.f_46 = 1;
		}
		if (Local_84.f_5.f_10 == &uLocal_37[2])
		{
			...
			{
				func_40(0);
				func_105(&(uLocal_37[2]), Global_35, func_104("MALE_A_AGGRO"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			}
			Local_84.f_46 = 1;
		}
		if (Local_84.f_5.f_10 == &uLocal_37[0])
		{
			...
			{
				func_40(0);
				func_105(&(uLocal_37[0]), Global_35, func_104("WOMAN_AGGRO"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			}
			Local_84.f_46 = 1;
		}
	}
	if (does_entity_exist(&(uLocal_37[1])))
	{
		if (is_ped_ragdoll(&(uLocal_37[1])) && func_106(&(uLocal_37[1]), Global_35, 1, 1) < 5f)
		{
			Local_84.f_46 = 1;
		}
	}
	if (does_entity_exist(&(uLocal_37[2])))
	{
		if (is_ped_ragdoll(&(uLocal_37[2])) && func_106(&(uLocal_37[1]), Global_35, 1, 1) < 5f)
		{
			Local_84.f_46 = 1;
		}
	}
...
int func_38()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			_0x21213b833ef4dae7(get_player_index(), &(uLocal_37[iVar0]), &iVar1);
			if (iVar1 != 0)
			{
				return 1;
			}
...
bool func_41()
{
	...
	{
		case 0:
			if (_is_anim_scene_loaded(iVar376, true, false) && _is_anim_scene_loaded(Local_378.f_1, true, false))
			{
				start_anim_scene(iVar376);
				start_anim_scene(Local_378.f_1);
				if (iLocal_35 != 0)
				{
					func_119(0);
					func_120(0, 1);
		...
		case 1:
			...
			{
				if (func_122(&Local_84, &uLocal_278, 3f, 1114636288, fVar691, 1350, 2.5f, 1065353216, 1, 0, 1, -1082130432, 0, 0, 1))
				{
					if (iLocal_35 != 0)
					{
						func_119(0);
					...
					func_119(1);
					func_120(1, 1);
					set_anim_scene_bool(iVar376, "ACTION", true, false);
					set_anim_scene_bool(Local_378.f_1, "ACTION", true, false);
					iLocal_545 = 3;
				}
				Jump @476; //curOff = 291
				func_123();
				...
				Jump @476; //curOff = 321
				if (!func_35(iVar684, 32768))
				{
					func_84(&uLocal_686, 32768);
					if (!func_35(iVar684, 1024))
					{
						func_126(&uLocal_686, 1);
					}
				}
				_0xdd1232b332cbb9e7(3, 1, 0);
				func_127();
...
bool func_42(int iParam0)
{
	...
	return func_129((*Global_1835011)[iParam0]->f_1);
}
...
{
	if (are_strings_equal(_0xf81c53561d15f330(), func_138(uParam0->f_3)))
	{
		_0x1096603b519c905f("");
	}
	if (uParam0->f_48)
			...
			if (!uParam0->f_50)
			{
				if (func_52(uParam1[iVar0], 0, 1))
				{
					...
					if (!bVar3)
					{
						if (!bParam6)
						{
							func_144(uParam1[iVar0], 1073741824, func_143(iVar0 < iVar2, &(uParam0->f_98[iVar0]), -1f), iVar1, 0);
						}
						else
						{
...
void func_55()
{
	...
	{
		_delete_anim_scene(iVar376);
	}
	if (_does_anim_scene_exist(Local_378.f_1))
	{
		_delete_anim_scene(Local_378.f_1);
	}
}
...
void func_59()
{
	switch (func_3())
	{
		case 5:
			if (iLocal_35 == 0)
			{
				Local_281[0]->f_1 = -269152223;
				Local_281[0] = 5;
				Local_281[2]->f_1 = -684673946;
				Local_281[2] = 4;
				StringCopy(&(Local_281[2]->f_23), "0923_A_M_M_Civ_Poor_White_AVOID_06", 64);
			}
			else if (iLocal_35 == 1)
			{
				Local_281[0]->f_1 = -269152223;
				Local_281[0] = 5;
				StringCopy(&(Local_281[0]->f_23), "0864_A_F_M_Civ_Poor_White_AVOID_02", 64);
				Local_281[1]->f_1 = -684673946;
				Local_281[1] = 4;
				StringCopy(&(Local_281[1]->f_23), "0901_A_M_M_Civ_Poor_White_AGGRESSIVE_01", 64);
				Local_281[2]->f_1 = -684673946;
				Local_281[2] = 4;
				StringCopy(&(Local_281[2]->f_23), "0904_A_M_M_Civ_Poor_White_AGGRESSIVE_04", 64);
			}
			else if (iLocal_35 == 2)
			{
				Local_281[0]->f_1 = -269152223;
				Local_281[0] = 5;
				StringCopy(&(Local_281[0]->f_23), "0873_A_F_M_Civ_White_TIMID_02", 64);
				Local_281[1]->f_1 = -684673946;
				Local_281[1] = 4;
				StringCopy(&(Local_281[1]->f_23), "0418_A_M_M_SclRoughTravellers_01_WHITE_01", 64);
				Local_281[2]->f_1 = -684673946;
				Local_281[2] = 4;
				StringCopy(&(Local_281[2]->f_23), "0050_A_M_M_BiVRoughTravellers_01_WHITE_01", 64);
			}
			break;
		case 38:
			break;
...
bool func_77(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, float fParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= iParam7)
	{
		...
		{
			if (bParam3 && !func_176(&((*iParam2)[iVar0]->f_22)))
			{
				vVar3 = { _get_object_offset_from_coords(uParam0->f_51, uParam0->f_51.f_3, (*iParam2)[iVar0]->f_6) };
				fVar1 = func_177((uParam0->f_51.f_3 + (*iParam2)[iVar0]->f_9));
			}
			else
			{
				vVar3 = { (*iParam2)[iVar0]->f_6 };
				fVar1 = func_177((*iParam2)[iVar0]->f_9);
			}
			if (!func_178(&((*iParam2)[iVar0]->f_22)))
			{
				func_179(&vVar3, 1, 10, 0);
			}
			if ((*iParam2)[iVar0]->f_12 != 0)
			{
				if (!(*iParam2)[iVar0]->f_19 && !func_176(&((*iParam2)[iVar0]->f_22)))
				{
					vVar6 = { _get_object_offset_from_coords(uParam0->f_51, uParam0->f_51.f_3, (*iParam2)[iVar0]->f_15) };
					fVar2 = func_177((uParam0->f_51.f_3 + (*iParam2)[iVar0]->f_18));
					func_179(&vVar6, 1, 10, 0);
				}
				else
				{
					vVar6 = { (*iParam2)[iVar0]->f_15 };
					fVar2 = func_177((*iParam2)[iVar0]->f_18);
				}
				func_180(uParam1, iVar0 + 15, (*iParam2)[iVar0]->f_12, vVar6, fVar2, iParam4, fParam5, 0, 1, 0);
			}
			func_180(uParam1, iVar0, (*iParam2)[iVar0]->f_1, vVar3, fVar1, iParam4, fParam5, (*iParam2)[iVar0]->f_2, 1, (*iParam2)[iVar0]->f_5);
		}
		iVar0++;
	}
	return true;
		...
		while (iVar0 <= iParam6)
		{
			if (!does_entity_exist(uParam2[iVar0]) && (*iParam1)[iVar0]->f_1 != 0)
			{
				...
				if (!is_entity_dead(uParam2[iVar0]))
				{
					...
					{
						(*iParam1)[iVar0]->f_11 = func_182(uParam0, iVar0 + 15);
						func_183(&((*iParam1)[iVar0]->f_11), (*iParam1)[iVar0], bParam3, 1);
					...
					if (bParam4)
					{
						...
						{
							func_81(uParam2[iVar0], &((*iParam1)[iVar0]->f_23), 0);
						}
					}
					if (func_184(&((*iParam1)[iVar0]->f_22)))
					{
						_0xdfce8ce9f3ebe93f(uParam2[iVar0]);
					}
					func_183((*uParam2)[iVar0], (*iParam1)[iVar0], bParam3, 0);
				}
			}
			iVar0++;
		}
...
void func_80(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_35(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_35(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_35(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_35(iParam5, 32), true);
	...
	else if (func_35(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_35(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_35(iParam5, 64))
		{
...
void func_87(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_box_with_custom_name(vParam1, vParam4, vParam7, func_198());
	}
}
...
void func_89(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(*uParam0))
	{
		*uParam0 = _create_volume_sphere_with_custom_name(vParam1, vParam4, vParam7, func_198());
	}
}
...
void func_96(var uParam0, var uParam1, int iParam2, int* iParam3)
{
	...
	_0x1096603b519c905f(func_138(uParam0->f_3));
...
void func_98(var uParam0, int iParam1, float fParam2)
{
	...
	if (!uParam0->f_48 && !func_95(uParam0->f_3, 262144))
	{
		...
		func_211(uParam0->f_121[iParam1], fVar1, 1082130432, 0, 90f, 0, &(uParam0->f_98[iParam1]));
...
bool func_99(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!uParam2->f_48)
	{
		if (!bParam3 && func_91(player_id(), 1, 0, 1))
		{
			return false;
		}
		if (!func_214(uParam2, fVar1))
		{
			if (!func_215((*Global_1310750)[uParam2->f_3]->f_38))
			{
				return false;
			}
		}
...
bool func_101(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar1 < iVar0)
	{
		if (func_235(uParam0[*uParam3], 0, iParam1, uParam2, 0, 0))
		{
			return true;
		}
		*uParam3++;
...
void func_110()
{
	...
	while (iVar0 < 2)
	{
		...
		{
			iVar1 = func_244(uLocal_37[iVar2], Local_386[iVar0], 8f, Local_429[iVar0], &(Local_84.f_192), 0, 1, 0, 0, func_243(1, 0, 0) | 64, 0, 0, 2, 1, -1082130432, 0);
			if (iVar1 == -1)
			{
			}
			else if (iVar532 <= -1)
...
void func_111()
{
	...
	{
		case 0:
			if (has_anim_event_fired(&(uLocal_37[2]), -526417022))
			{
				func_40(0);
				func_105(&(uLocal_37[2]), &(uLocal_37[2]), func_104("DUMP_REACT_C"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			}
			break;
		case 1:
		case 2:
			if (has_anim_event_fired(&(uLocal_37[1]), 1285642699))
			{
				if (is_any_speech_playing(&(uLocal_37[1])) || is_any_speech_playing(&(uLocal_37[2])))
				{
					set_ped_reset_flag(&(uLocal_37[1]), 290, true);
				}
			}
			break;
	}
...
void func_112()
{
	if (func_52(&(uLocal_37[2]), 0, 1) && has_anim_event_fired(&(uLocal_37[2]), -685797094))
	{
		func_246(uLocal_37[2]);
		func_84(&uLocal_686, 524288);
		if (func_52(&(uLocal_37[1]), 0, 1))
		{
...
void func_113()
{
	if (!func_35(iVar684, 8))
	{
		if (func_52(&(uLocal_37[2]), 0, 1) && has_anim_event_fired(&(uLocal_37[2]), -2130482718))
		{
			func_84(&uLocal_686, 65536);
			iLocal_687 = add_shocking_event_for_entity(-180122789, &(uLocal_37[2]), -1f, 15f, 15f, -1f, -1f, 180f, false, false, -1, -1);
			if ((!func_247(&(uLocal_37[0]), floor(20f)) && !func_247(&(uLocal_37[2]), floor(20f))) && (iLocal_35 == 0 || !func_247(&(uLocal_37[1]), floor(20f))))
			{
				Local_84.f_45 = 0;
			}
			func_84(&uLocal_686, 8);
		}
	}
}
...
void func_114()
{
	if (func_35(iVar684, 8) || func_35(iVar684, 32))
	{
		return;
	}
	...
	fVar0 = get_distance_between_coords(vVar1, Local_84.f_51, true);
	if (fVar0 < fVar690 && func_249(&(uLocal_37[2]), 1116471296, -1082130432, -1082130432, -1082130432))
	{
		func_84(&uLocal_686, 32);
		_set_anim_scene_playback_list_bool(iVar376, "PBL_QUICK_DUMP", true);
		_set_anim_scene_playback_list_bool(Local_378.f_1, "PBL_QUICK_DUMP", true);
	}
}

void func_115()
{
	if (func_35(iVar684, 256) || iLocal_35 == 0)
	{
		return;
	}
	if (_does_anim_scene_exist(iVar376) && _is_anim_scene_started(iVar376, false))
	{
		_0xdf7b5144e25cd3fe(iVar376, "PBL_QUICK_DUMP");
		if (!_0x23e33cb9f4a3f547(iVar376, "PBL_QUICK_DUMP"))
		{
			func_126(&uLocal_686, 64);
		}
		func_84(&uLocal_686, 64);
	}
	if (_does_anim_scene_exist(Local_378.f_1) && _is_anim_scene_started(Local_378.f_1, false))
	{
		_0xdf7b5144e25cd3fe(Local_378.f_1, "PBL_QUICK_DUMP");
		if (!_0x23e33cb9f4a3f547(Local_378.f_1, "PBL_QUICK_DUMP"))
		{
			func_126(&uLocal_686, 128);
		}
		func_84(&uLocal_686, 128);
	}
	if (func_35(iVar684, 64) && func_35(iVar684, 128))
	{
		func_84(&uLocal_686, 256);
	}
}

void func_116()
{
	if (func_35(iVar684, 65536))
	{
...
void func_117()
{
	if (!is_entity_dead(&(uLocal_37[2])) && has_anim_event_fired(&(uLocal_37[2]), 1384389773))
	{
		func_251(2001176446, &(uLocal_37[2]), 1);
	}
	if (!is_entity_dead(&(uLocal_37[1])) && has_anim_event_fired(&(uLocal_37[1]), 1384389773))
	{
		func_251(2001176446, &(uLocal_37[1]), 1);
	}
	if (!is_entity_dead(&(uLocal_37[0])) && has_anim_event_fired(&(uLocal_37[0]), 1384389773))
	{
...
void func_118()
{
	if (!Local_84.f_45 && func_35(iVar684, 524288))
	{
		if (func_35(iVar684, 512) || (!func_125() && func_252()))
		{
			Local_84.f_44 = 1;
			Local_84.f_45 = 1;
		}
...
{
	func_254((*Local_429[iParam0])[0], func_253(7), "", -163964935, 0, 0, 0, 0, 0);
	func_254((*Local_429[iParam0])[1], func_253(10), "", 648122183, 0, 0, 0, 0, 0);
	func_254((*Local_429[iParam0])[2], func_253(12), "", -1616532217, 0, 0, 0, 0, 0);
}
...
bool func_121()
{
	if (func_249(&(uLocal_37[2]), 50f, -1082130432, -1082130432, -1082130432))
	{
		return true;
	}
	return false;
...
void func_123()
{
	if (!func_35(iVar684, 1))
	{
		if (Local_84.f_46 || has_anim_event_fired(&(uLocal_37[0]), 584569423))
		{
			if (_does_anim_scene_exist(Local_378.f_1) && _is_anim_scene_started(Local_378.f_1, false))
			{
				remove_anim_scene_entity(Local_378.f_1, "PED_WOMAN", &(uLocal_37[0]));
				remove_anim_scene_entity(Local_378.f_1, "CHAMBER_POT", Local_71[0]->f_8);
			}
			if (_does_anim_scene_exist(Local_378.f_1))
			{
				_delete_anim_scene(Local_378.f_1);
			}
			if (!Local_84.f_46 || iVar683 == 2048)
			{
				force_ped_motion_state(&(uLocal_37[0]), -668482597, false, 0, false);
			}
			set_ped_keep_task(&(uLocal_37[0]), true);
			if (Local_84.f_46 && iVar683 != 2048)
			{
			...
			if (Local_84.f_51.f_4 == 1)
			{
				open_sequence_task(&iLocal_694);
				task_go_straight_to_coord(0, 2492.681f, -1270.89f, 53.3694f, fVar0, 20000, 1193033728, 1056964608, 0);
				task_go_straight_to_coord(0, vLocal_65, fVar0, 20000, 1193033728, 1056964608, 0);
				func_259(&(uLocal_37[0]), &iLocal_694, 0, 0, 1, 1);
			}
			else
			{
				task_follow_nav_mesh_to_coord(&(uLocal_37[0]), vLocal_65, fVar0, 20000, 0.25f, 1, 40000f);
			}
			func_84(&uLocal_686, 1);
		}
	}
	else if (!func_35(iVar684, 1024))
	{
		if (func_260(vLocal_65, get_entity_coords(&(uLocal_37[0]), true, false), 0.25f, 0))
		{
			func_84(&uLocal_686, 1024);
			if (!func_161(vLocal_68))
			{
				...
				task_go_straight_to_coord(&(uLocal_37[0]), vLocal_68, fVar1, 20000, 1193033728, 1056964608, 0);
			}
		}
	}
	else if (!func_35(iVar684, 16384))
	{
		if (func_260(vLocal_68, get_entity_coords(&(uLocal_37[0]), true, false), 0.2f, 0))
		{
			func_84(&uLocal_686, 16384);
			if (func_50(iLocal_27))
			{
				door_system_set_open_ratio(iLocal_27, 0f, 0);
				door_system_set_automatic_distance(iLocal_27, 25f);
				door_system_set_automatic_rate(iLocal_27, 5f);
				_0x1bc47a9dedc8df5d(iLocal_27, 0);
			}
			if (func_50(iLocal_28))
			{
				door_system_set_open_ratio(iLocal_28, 0f, 0);
				door_system_set_automatic_distance(iLocal_28, 25f);
				door_system_set_automatic_rate(iLocal_28, 5f);
				_0x1bc47a9dedc8df5d(iLocal_28, 0);
			}
			if (func_50(iLocal_27))
			{
...
void func_124()
{
	...
	{
		case 0:
			if (!func_35(iVar684, 4))
			{
				if (has_anim_event_fired(&(uLocal_37[1]), 584569423) || (!_does_anim_scene_exist(iVar376) || _0xb89fcff19dafff28(iVar376, "PED_MALE_B")))
				{
					if (!func_261(&uLocal_29))
					{
						func_262(&uLocal_29);
					}
					force_ped_motion_state(&(uLocal_37[2]), -668482597, false, 0, false);
					Var0.f_3 = 1065353216;
					Var0.f_4 = -1;
					Var0.f_5 = 1048576000;
					Var0.f_6 = 1193033728;
					...
					Var0.f_4 = -1;
					Var0.f_3 = 1f;
					clear_sequence_task(&iLocal_694);
					open_sequence_task(&iLocal_694);
					task_follow_nav_mesh_to_coord(0, *vLocal_45[2], 1f, -1, 0.25f, 0, 40000f);
					task_follow_pavement_to_coord(0, &Var0);
					_task_smart_flee_style_ped(0, Global_35, 0, 1, 500f, -1, 0);
					close_sequence_task(iVar692);
					task_perform_sequence(&(uLocal_37[2]), iVar692);
					clear_sequence_task(&iLocal_694);
					set_ped_keep_task(&(uLocal_37[2]), true);
					func_263(iVar697);
					func_263(iVar698);
					if (func_35(iVar684, 8))
					{
						_0x923583741dc87bce(&(uLocal_37[2]), "DEFAULT");
						_0x89f5e7adecccb49c(&(uLocal_37[2]), "piss_pot_b");
					}
					bLocal_34 = true;
					func_84(&uLocal_686, 4);
				}
			}
			break;
		case 1:
...
bool func_125()
{
	if (iLocal_35 == 0)
	{
		if (func_35(iVar684, 1) && func_35(iVar684, 4))
		{
			return true;
		}
	}
	else if ((func_35(iVar684, 1) && func_35(iVar684, 4)) && func_35(iVar684, 2))
	{
		return true;
	}
	return false;
...
void func_127()
{
	...
	while (iVar0 < 3)
	{
		if (func_52(&(uLocal_37[iVar0]), 0, 1))
		{
			...
			{
				if (func_35(iVar684, 16) && !does_entity_exist(Local_84.f_5.f_10))
				{
					_task_smart_flee_style_ped(&(uLocal_37[iVar0]), Global_35, 0, 0, 500f, -1, 0);
				}
				else
				{
					_task_smart_flee_style_ped(&(uLocal_37[iVar0]), Global_35, 4, 0, 500f, -1, 0);
				}
				set_ped_keep_task(&(uLocal_37[iVar0]), true);
			}
		}
		iVar0++;
	}
	...
	if (func_35(iVar684, 8))
	{
		if (func_52(&(uLocal_37[1]), 0, 1))
		{
			_0x923583741dc87bce(&(uLocal_37[1]), "DEFAULT");
			_0x89f5e7adecccb49c(&(uLocal_37[1]), "piss_pot_a");
		}
		if (func_52(&(uLocal_37[2]), 0, 1))
		{
			_0x923583741dc87bce(&(uLocal_37[2]), "DEFAULT");
...
bool func_128()
{
	...
	while (iVar0 < 3)
	{
		if (func_52(&(uLocal_37[iVar0]), 0, 1))
		{
			if (&Local_84.f_98[iVar0] < 20f || func_249(&(uLocal_37[iVar0]), 1116471296, -1082130432, -1082130432, -1082130432))
			{
				return false;
			}
			else if (!func_249(&(uLocal_37[iVar0]), 1116471296, -1082130432, -1082130432, -1082130432))
			{
				delete_ped(uLocal_37[iVar0]);
			}
		}
		iVar0++;
	}
...
char* func_134(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return _create_var_string(2, func_270(sParam1));
}
...
bool func_141(var uParam0, var uParam1)
{
	...
	{
		if (func_271(*uParam1) != -1 || get_entity_model(*uParam1) == 1478983280)
		{
			return true;
		}
	}
...
void func_144(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4)
{
	if (!Global_1935630->f_12 && (!bParam4 || func_52(iParam0, 0, 1)))
	{
		...
		if (iParam3 != iParam0)
		{
			...
			fVar2 = func_143(fParam2 >= 0f, fParam2, vdist(get_entity_coords(iParam0, true, false), Global_36));
...
int func_152(bool bParam0)
{
	...
	get_group_size(func_283(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = get_ped_as_group_member(func_283(), iVar3);
		if (func_284(iVar4))
		{
			iVar0++;
		}
...
void func_157(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		...
		if (func_292(Global_1310750[iParam0], 33554432))
		{
...
bool func_158(int iParam0, var uParam1)
{
	*uParam1 = _0x74f0209674864cbd();
	...
	while (iVar0 < 8)
	{
		...
		{
			func_295(uParam1, *(*Global_1310750)[iParam0]->f_4.f_4[iVar0]);
		}
		iVar0++;
	}
	if (func_95(iParam0, 16))
	{
		...
		fVar2 = to_float(func_296(iParam0));
		fVar1 = 60f;
	}
	else
	{
...
void func_180(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)
{
	...
	if (bParam7)
	{
		func_49(&((*uParam0)[uParam0->f_136]->f_6), 4);
	}
	if (bParam8)
	{
		func_49(&((*uParam0)[uParam0->f_136]->f_6), 8);
	}
	if (iParam9 == 1)
	{
		func_49(&((*uParam0)[uParam0->f_136]->f_6), 1);
	}
	else if (iParam9 == 2)
	{
		func_49(&((*uParam0)[uParam0->f_136]->f_6), 2);
	}
	if (bParam10)
	{
		func_49(&((*uParam0)[uParam0->f_136]->f_6), 16);
	}
	uParam0->f_136++;
}
...
bool func_181(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_136)
	{
		if (!does_entity_exist(uParam0[iVar0]) && (*uParam0)[iVar0]->f_1 != 0)
		{
			...
			{
				bVar1 = func_2((*uParam0)[iVar0]->f_6, 4);
				bVar2 = func_2((*uParam0)[iVar0]->f_6, 8);
				bVar3 = func_2((*uParam0)[iVar0]->f_6, 16);
				if (func_2((*uParam0)[iVar0]->f_6, 1))
				{
					bVar4 = true;
				}
				else if (func_2((*uParam0)[iVar0]->f_6, 2))
				{
					bVar4 = 2;
				}
				else
				...
				{
					(*uParam0)[iVar0] = func_310((*uParam0)[iVar0]->f_1, (*uParam0)[iVar0]->f_2, (*uParam0)[iVar0]->f_5, bVar1, bVar2, bVar4, bVar3, 1, 1, 0, 0, 0, 0);
				}
				if (bParam1)
				{
...
void func_183(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		if (!bParam3 && func_312(&(uParam1->f_22)))
		{
			...
			set_ped_config_flag(*uParam0, 186, !func_313(&(uParam1->f_22)));
		...
		set_ped_config_flag(*uParam0, 4, func_319(&(uParam1->f_22)));
		set_ped_config_flag(*uParam0, 6, func_320(&(uParam1->f_22)));
...
void func_204(int iParam0, int iParam1)
{
	...
	func_326(iParam0, (*Global_1310750)[iParam0]->f_36, fVar0, 1, 0);
	func_327(iParam0, 0);
	func_328(iParam0);
	func_329(1);
...
{
	if (uParam0->f_177 != -1 || func_292(Global_1310750[uParam0->f_3], 16777216))
	{
		if (bParam2)
		{
		...
		if (uParam0->f_177 != -1)
		{
			if (bParam2)
			{
				...
				compendium_gang_encountered(func_337(uParam0->f_177));
			}
		}
	}
...
bool func_235(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (!iParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_367(iParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630->f_26 && func_91(player_id(), 0, 1, iParam2->f_1 & 524288 == 0))
		{
...
int func_240(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_396(func_395(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_245()
{
	...
	if (func_404())
	{
		...
		func_84(&uLocal_686, 512);
		func_126(&uLocal_686, 65536);
	}
	if (bLocal_34)
	{
		if (iLocal_35 != 0)
	...
	if ((func_35(iVar684, 65536) && func_52(&(uLocal_37[2]), 0, 1)) && &Local_84.f_98[2] > 30f)
	{
		func_126(&uLocal_686, 65536);
	}
}
...
void func_246(var uParam0)
{
	if (func_406())
	{
		_0x58d32261ae0f0843(*uParam0, 30226, 0.20517f, 0.046563f, 0.507389f, 0.241037f, 0.105917f, 0.964716f, "Pissing");
	}
	else
	{
		_0x58d32261ae0f0843(*uParam0, 54802, -0.13956f, 0.026992f, 0.522096f, -0.17646f, 0.034832f, 0.983688f, "Pissing");
	}
	if (func_406())
	{
		_0x58d32261ae0f0843(*uParam0, 14414, 0.087967f, 0.117107f, 0.48965f, 0.035033f, 0.843737f, 0.535608f, "Pissing");
	}
	else
	{
		_0x58d32261ae0f0843(*uParam0, 54802, -0.238967f, -0.009972f, 0.453114f, -0.700396f, -0.680935f, 0.213934f, "Pissing");
	}
	if (func_406())
	{
		_0x58d32261ae0f0843(*uParam0, 14414, 0.125488f, -0.053184f, 0.485976f, 0.391717f, -0.771753f, 0.50095f, "Vomit");
	}
	else
	{
		_0x58d32261ae0f0843(*uParam0, 14283, -0.055569f, 0.019992f, 0.565456f, -0.998232f, 0.057524f, 0.014761f, "Vomit");
	}
	apply_ped_damage_pack(*uParam0, "PD_ANM_piss_pot", 0f, 1f);
}
...
bool func_247(int iParam0, int iParam1)
{
	if (!is_entity_dead(iParam0))
	{
		...
		{
			if (func_407(player_ped_id(), iParam0, 1) < IntToFloat(iParam1))
			{
				return true;
			}
		}
...
bool func_252()
{
	if (does_entity_exist(&(uLocal_37[iVar703])) && !is_entity_dead(&(uLocal_37[iVar703])))
	{
		func_211(Local_84.f_121[iVar703], 20f, 1082130432, 0, 90f, 1, &(Local_84.f_98[iVar703]));
...
{
	fVar0 = func_143(bParam6, iParam7, vdist(vParam1, get_entity_coords(iParam0, true, false)));
	if (!iParam4->f_1)
	{
		if (fVar0 < iParam4->f_2 || (func_306(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
		{
			*iParam4 = func_236();
	...
	else if (fVar0 > iParam4->f_2 || (!func_306(vParam1, iParam0) && get_entity_speed(iParam0) > fParam5))
	{
		*iParam4 = func_236();
		iParam4->f_2 = func_409(iParam0, vParam1, 1);
		iParam4->f_1 = 0;
...
bool func_258(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11)
{
	...
	if (uParam0->f_48 && (!bParam10 || (!_does_volume_exist(uParam0->f_173) || is_entity_in_volume(Global_35, uParam0->f_173, true, 0))))
	{
		if (iParam4 > 1)
		{
			...
			{
				func_211(uParam0->f_121[iVar0], fVar3, 1082130432, 1, 90f, 0, 0);
				iVar0++;
			}
		}
		else
		{
			func_211(uParam0->f_121[0], fVar3, 1082130432, 1, 90f, 0, 0);
		}
...
void func_264()
{
	if (!func_35(iVar684, 4))
	{
		if (has_anim_event_fired(&(uLocal_37[2]), 584569423) || (!_does_anim_scene_exist(iVar376) || _0xb89fcff19dafff28(iVar376, "PED_MALE_B")))
		{
			if (_does_anim_scene_exist(iVar376) && _is_anim_scene_started(iVar376, false))
			{
				remove_anim_scene_entity(iVar376, "PED_MALE_B", &(uLocal_37[2]));
			}
			if (!func_261(&uLocal_29))
			{
				func_262(&uLocal_29);
			...
			task_follow_nav_mesh_to_coord(0, *vLocal_45[2], 1f, -1, 0.25f, 0, 40000f);
			task_follow_pavement_to_coord(0, &Var0);
			_task_smart_flee_style_ped(0, Global_35, 0, 0, 500f, -1, 0);
	...
	if (!func_35(iVar684, 2))
	{
		if (has_anim_event_fired(&(uLocal_37[1]), 584569423) || (!_does_anim_scene_exist(iVar376) || _0xb89fcff19dafff28(iVar376, "PED_MALE_A")))
		{
			if (_does_anim_scene_exist(iVar376) && _is_anim_scene_started(iVar376, false))
			{
				remove_anim_scene_entity(iVar376, "PED_MALE_A", &(uLocal_37[1]));
			}
			if (!func_261(&uLocal_29))
			{
				func_262(&uLocal_29);
			}
			force_ped_motion_state(&(uLocal_37[1]), -668482597, false, 0, false);
			Var7.f_3 = 1065353216;
			Var7.f_4 = -1;
			Var7.f_5 = 1048576000;
			Var7.f_6 = 1193033728;
			...
			clear_sequence_task(&iLocal_694);
			open_sequence_task(&iLocal_694);
			task_follow_nav_mesh_to_coord(0, *vLocal_45[1], 1f, -1, 0.25f, 0, 40000f);
			task_follow_pavement_to_coord(0, &Var7);
			_task_smart_flee_style_ped(0, Global_35, 0, 0, 500f, -1, 0);
			close_sequence_task(iVar692);
			task_perform_sequence(&(uLocal_37[1]), iVar692);
			clear_sequence_task(&iLocal_694);
			if (func_35(iVar684, 8))
			{
				func_263(iVar697);
...
bool func_306(vector3 vParam0, int iParam3)
{
	...
	return func_433(vVar0, vParam0) > func_433(vVar0, get_entity_coords(iParam3, true, false));
}
...
void func_326(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_280(iParam0, bParam3, round((fVar0 * fParam2)), round((fVar1 * fParam2)), round((fVar2 * fParam2)), round((fVar3 * fParam2)), bParam4, 1);
}
...
void func_333(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam0 != 8)
	{
		...
		func_448(to_float(iVar0), 1, 0);
	}
	else
	{
		func_448((to_float(200) / 3f), 1, 0);
	}
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_35) && (!func_218(1) || *iParam0 & 8192 != 0))
				{
...
bool func_369(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_464(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_462(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (get_game_timer() - iParam2->f_2) > func_463(iParam2)
				{
					func_237(iParam2, 1);
					return true;
				}
...
bool func_370(int iParam0, int iParam1)
{
	...
	if (func_456(iParam0, iParam1, iVar1))
	{
		...
		else if (get_game_timer() - iParam1->f_3) > func_463(iParam1)
		{
...
int func_399(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if (!is_entity_dead(*uParam0))
	{
		...
		fVar8 = func_143(fParam12 >= 0f, fParam12, vdist(Global_36, get_entity_coords(*uParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_493(uParam0, iParam8, iParam9, is_bit_set(*iParam1, 4)))
				{
...
void func_400(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_105(Global_35, *uParam2, sVar1, "", -1082130432, iVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
void func_403()
{
		...
		if (!func_509(Global_35, 0))
		{
			if (iVar533 != -1)
			{
				if (!func_510())
				{
					...
					{
						case 0:
							func_511(func_241(iVar533));
							func_120(iVar533, 1);
							func_126(&uLocal_686, 131072);
							func_84(&uLocal_686, 262144);
							break;
						case 1:
							func_512(func_241(iVar533));
							func_120(iVar533, 1);
							func_126(&uLocal_686, 131072);
							func_84(&uLocal_686, 262144);
							break;
	...
	else if (iVar532 > -1)
	{
		if (iVar533 != -1)
		{
			...
			{
				case 0:
					func_105(Global_35, &(uLocal_37[func_241(iVar533)]), func_513("GREET"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_84(&uLocal_686, 131072);
					bLocal_32 = true;
					break;
				case 1:
					func_105(Global_35, &(uLocal_37[func_241(iVar533)]), func_513("ANT"), 0, -1082130432, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_84(&uLocal_686, 131072);
					bLocal_32 = true;
					bLocal_33 = true;
					break;
...
bool func_404()
{
	...
	if (!func_514(&(uLocal_37[2]), iVar376, "PED_MALE_B", 0, 0, 1, 0))
	{
		return false;
	}
...
float func_407(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_132(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
{
	if (func_411(iParam0->f_6) && !is_string_null_or_empty(sParam1))
	{
...
{
	func_522((*Local_429[iParam0])[iParam1], bParam2, 0);
}
...
void func_425(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	func_326(iParam0, (*Global_1310750)[iParam0]->f_37, 1065353216, 0, 0);
	func_327(iParam0, 1);
	if (!bParam2)
	{
		func_422(16);
	...
	{
		if (&Global_17504.f_42[iParam0] >= func_537(iParam0))
		{
...
bool func_431(vector3 vParam0)
{
	...
	while (iVar0 < Global_1310750->f_16043)
	{
		...
		{
			if (func_132(vParam0, *Global_1310750->f_16043[iVar0]) < 2500f)
			{
				return true;
			}
		}
...
void func_439(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_292(Global_1310750[iVar0], iParam0))
		{
			if (!func_279(iVar0))
			{
				iVar1 = 1;
...
bool func_460(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (_is_weapon_sniper(func_561(iVar0, 0)))
		{
...
bool func_464(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_561(iVar0, 0)))
		{
			if (func_563(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_475(int iParam0, int iParam1)
{
	...
	if (func_566(iParam0, 1, 0, 0) != 2055893578)
	{
		return false;
	}
...
int func_484(int iParam0)
{
	...
	return func_568((*Global_1347702)[58]->f_15, 1);
}
...
bool func_489(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!is_entity_dead(*uParam0))
	{
		...
		if (_0x870708a6e147a9ad(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_2(iParam4, 268435456))
			{
				iVar8 = func_574(uParam2, 648122183);
				if (iVar8 > -1)
				{
					func_575(iParam1, (*uParam2)[iVar8]);
				}
			}
...
bool func_496(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_411((*uParam4)[iVar0]->f_6);
		func_582(*uParam0, (*uParam4)[iVar0], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (is_bit_set(uParam4[iVar0], 20))
		{
			bVar3 = true;
		}
		if (func_583(*uParam0, iParam1, (*uParam4)[iVar0], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_411((*uParam0)[iVar0]->f_6))
			{
				...
				{
					func_420(&((*uParam0)[iVar0]->f_6), 1, 1);
					if (bParam2)
					{
						(*uParam0)[iVar0]->f_7 = 0;
						(*uParam0)[iVar0] = 0;
...
char* func_511(int iParam0)
{
	...
	{
		case 0:
			func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "VICTIMIZED_REACT", 0, -1082130432, 0, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
			break;
		case 1:
			switch (iParam0)
			{
				case 1:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "DEFUSE_RESPONSE", 0, -1082130432, 2, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
				case 2:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "VICTIMIZED_REACT", 0, -1082130432, 2, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
			}
			break;
		case 2:
			...
			{
				case 1:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "GENERIC_INSULT_MED_NEUTRAL", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
				case 2:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "SORRY_TO_HEAR_THAT", 0, -1082130432, 2, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
			}
			break;
	}
...
char* func_512(int iParam0)
{
	...
	{
		case 0:
			func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "SHAME_ON_YOU", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
			break;
		case 1:
			switch (iParam0)
			{
				case 1:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "GENERIC_INSULT_MED_MALE", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
				case 2:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "GENERIC_CURSE_MED", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
			}
			break;
		case 2:
			...
			{
				case 1:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "TEASE_RESPONSE", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
				case 2:
					func_105(&(uLocal_37[func_241(iVar532)]), Global_35, "PLAYER_STARING", 0, -1082130432, 1, 0, 0, 1, 1, 1, 1506116031, 1, 0, 0);
					break;
			}
			break;
	}
...
void func_518(int iParam0, bool bParam1)
{
	...
	{
		if ((*Global_1945938)[iParam0]->f_5 == 5 && !func_602(iParam0, 8))
		{
...
void func_527(int iParam0)
{
	...
	while (iVar0 < 27)
	{
		...
		{
			if (is_ped_group_member(func_606(iVar0), func_283(), 1))
			{
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419->f_19[iVar0]->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_608() > Global_32074.f_2697.f_6[iVar0]->f_5)
					{
						Global_32074.f_2697.f_6[iVar0]->f_5 = func_608();
					}
					func_609(&(Global_32074.f_2697.f_6[iVar0]->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
...
bool func_562(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_563(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
void func_571(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_420(&((*uParam1)[iParam0->f_3]->f_6), 1, 1);
		if (bParam2)
		{
			func_617(iParam0, 0);
		}
...
int func_572(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		iVar0 = iParam1->f_3;
		(*uParam2)[iVar0]->f_8 = 6;
		func_618(iParam0, (*uParam2)[iVar0], fParam3, 3, 0, 6, bParam4, 0);
		if (func_411((*uParam2)[iVar0]->f_6))
		{
...
void func_577(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_618(iParam0, (*uParam1)[iVar0], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
void func_585(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_522((*uParam0)[iVar0], bParam1, bParam2);
		iVar0++;
	}
}
...
{
	return func_564(iParam0, get_entity_coords(iParam1, false, false), fParam2);
}
...
void func_618(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_411(iParam1->f_6) && !is_bit_set(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_588(iParam1))
		{
			...
			iParam1->f_6 = func_638(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824, 0, 1704213876, iParam1->f_10, 0);
			if (func_411(iParam1->f_6))
			{
				if (!bParam6)
				{
...
{
	return (shift_right(iParam0, 26) & 31 * func_396(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_638(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_602(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_647(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
