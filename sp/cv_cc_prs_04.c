...
{
	set_entity_collision(func_193(uParam0, iLocal_16), false, false);
	return true;
}
...
{
	_0x3946fc742ac305cd(get_player_index(), func_48(uParam0, iLocal_14), "CCPRS_CNV_4", 0f, 0f, 0f, 0, 0);
	return true;
}
...
{
	if (_0x569f1e1237508deb(func_48(uParam0, iLocal_14)) == -349980427)
	{
		if (!bLocal_21)
		{
			bLocal_21 = true;
			set_entity_as_mission_entity(func_193(uParam0, iLocal_18), true, false);
			func_209(uParam0, iLocal_18);
		}
	}
	if (!is_sphere_visible(vLocal_32, 1f))
	{
		switch (func_148(uParam0))
		{
			case 1:
		...
		iLocal_19 = func_193(uParam0, iLocal_15);
		iLocal_20 = func_193(uParam0, iLocal_16);
		delete_object(&iLocal_19);
...
void func_308(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1]->f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1]->f_32.f_4 = func_329(100f, 140f);
			}
		}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(747937920, 1) && !func_394((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
