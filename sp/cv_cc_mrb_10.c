...
{
	if (!_is_scenario_group_enabled_hash(iLocal_58))
	{
		_set_scenario_group_enabled_hash(iLocal_58, true);
	}
	return true;
}
...
{
	_set_scenario_group_enabled_hash(iLocal_58, false);
	return true;
}
...
{
	iVar0 = uParam0->f_107[iLocal_20]->f_32.f_21;
