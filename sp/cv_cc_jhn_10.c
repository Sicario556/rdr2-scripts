...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_151(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_151(uParam0, -967333571, 0f, 0f, 0f, "cigarette", 0, 1, 1);
	iLocal_17 = func_151(uParam0, 1230724566, 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, 1.2529f, -0.4228f, 0.5011f, -23.76f, 1.5f, 1.5f, 3f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, 2.8772f, -5.432f, 0.8f, -6.84f, 1.5f, 1.5f, 3f, -1612834106, -695792551, 1, 1, 1);
	func_153(uParam0, "script@vignette@john_10@base", 1, 1, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@john_10@action_a", 2, 1, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@john_10@action_b", 0, 0, 0, 0);
	iLocal_20 = func_153(uParam0, "script@vignette@john_10@action_b_alt_front", 0, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@john_10@action_b_alt_left", 0, 0, 0, 1);
	iLocal_22 = func_153(uParam0, "script@vignette@john_10@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "CJH10AU");
	func_155(uParam0, iLocal_14, 3, -1539374245, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_C", iLocal_17, 0);
	func_156(uParam0, iLocal_14, 1061142135);
	func_157(uParam0, iLocal_14, 3, -1539374245, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_C", iLocal_17, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_155(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 1);
	Local_23 = { func_159(uParam0, 1.2529f, -0.4228f, 0.5011f, -93.96f, 8f, 0.47f, 0.42f) };
	Local_33 = { func_159(uParam0, 1.2529f, -0.4228f, 0.5011f, -16.2f, 8f, 0.47f, 0.42f) };
	Local_43 = { func_159(uParam0, 1.2529f, -0.4228f, 0.5011f, 180f, 8f, 0.582f, 0.42f) };
	return true;
}
