...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "BL_BIRD_1", iLocal_9, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 5f, -20f), (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_10, 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_39)
	{
		case 0:
			...
			{
				freeze_entity_position(&(uParam0->f_20[0]), true);
				set_entity_invincible(&(uParam0->f_20[0]), true);
				set_entity_visible(&(uParam0->f_20[0]), false);
				func_66(uParam0->f_20[0], 1, 1);
				iLocal_39 = 2;
			}
			break;
		case 2:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				if (func_63(Global_35, uParam0->f_483, 1) < func_67(is_ped_on_mount(Global_35), 1600f, 400f))
				{
					if (is_sphere_visible(uParam0->f_483, 1f))
					{
						if (!would_entity_be_occluded(uParam0->f_20[0]->f_2, uParam0->f_483, true))
						{
							vVar0 = { _get_object_offset_from_coords(uParam0->f_483, uParam0->f_486.f_2, 0f, -35f, 1f) };
							if (!is_sphere_visible(vVar0, 0.25f))
							{
								freeze_entity_position(&(uParam0->f_20[0]), false);
								set_entity_invincible(&(uParam0->f_20[0]), false);
								set_entity_visible(&(uParam0->f_20[0]), true);
								func_64(uParam0);
								func_69(&(uParam0->f_20[0]), vVar0, func_68(vVar0, uParam0->f_483), 0, 1073741824);
								force_ped_motion_state(&(uParam0->f_20[0]), -1299979036, false, 0, false);
								task_start_scenario_at_position(&(uParam0->f_20[0]), iLocal_40, uParam0->f_483, uParam0->f_20[0]->f_8, 0, true, false, 0, -1f, false);
		...
		case 4:
			if (!&uParam0->f_469[0])
			{
				if (func_63(&(uParam0->f_20[0]), uParam0->f_483, 1) < 1f)
				{
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_104(Global_35) && is_player_teleport_active())
	{
	}
	if (func_105(iParam0))
	{
		if (func_106(get_ped_index_from_entity_index(iParam0)))
		{
			_0x0348469daa17576c(iParam0);
		}
	}
	if (func_107(iParam5, 4) && is_entity_a_ped(iParam0))
	{
		iVar1 = get_ped_index_from_entity_index(iParam0);
	...
	if (func_107(iParam5, 2))
	{
		...
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
		}
		else
		{
			_set_entity_coords_and_heading(iParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
	...
	else if (func_107(iParam5, 129))
	{
		...
		set_entity_coords_no_offset(iParam0, vParam1, func_107(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (get_ped_index_from_entity_index(iParam0) == Global_35 && !func_107(iParam5, 64))
		{
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_112(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
