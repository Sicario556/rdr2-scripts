void __EntryFunction__()
{
	...
	func_1();
	func_2();
	iLocal_20 = get_game_timer();
	iVar0 = 0;
	while (func_3())
	{
		if (get_game_timer() > iLocal_20)
		{
			iLocal_20 = 0;
			...
			switch (iLocal_19)
			{
				...
				case 1:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_9(iLocal_21));
					...
					Global_1897950 = -1;
					iLocal_22 = (get_game_timer() + iLocal_18);
					iLocal_19 = 2;
					break;
				case 2:
					if (func_11() || iLocal_22 < get_game_timer())
					{
						func_12(iLocal_21);
						iLocal_22 = (get_game_timer() + iLocal_18);
						iLocal_19 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_21) || iLocal_22 < get_game_timer())
					{
						func_14(iLocal_21);
						iLocal_22 = (get_game_timer() + iLocal_18);
						iLocal_19 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_21) || iLocal_22 < get_game_timer())
					{
						func_16(iLocal_21);
						iLocal_22 = (iLocal_18 + get_game_timer());
						iLocal_19 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_21)))
					{
						if (func_17(func_6(iLocal_21), 4) && !iLocal_22 < get_game_timer())
						{
						}
						else
						{
							if (func_18(iLocal_21) || iLocal_22 < get_game_timer())
							{
								func_19(iLocal_21, 4);
								iLocal_22 = (iLocal_18 + get_game_timer());
								iLocal_19 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_22 < get_game_timer() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_21);
								func_22();
								if (!func_23(2057, 0))
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1888801)[iLocal_21]->f_10);
							if ((*Global_1888801)[iLocal_21]->f_11 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1888801)[iLocal_21]->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if ((*Global_1888801)[iLocal_21]->f_12 == 0)
						{
						}
						else
						{
							_0x95423627a9ca598e((*Global_1888801)[iLocal_21]->f_12);
						}
						wait(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_14 = _create_volume_cylinder_with_custom_name(-5201.7f, -2134.3f, -13.7f, 0f, 0f, 0f, 116.361f, 111.159f, 70f, "m_volRathskellerFork");
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("Rathskeller Fork - m_volRancherInner Agg");
		_0x39816f6f94f385ad(iLocal_17, -5193.958f, -2150.221f, 14.60039f, 0f, 0f, 43.94339f, 30.9764f, 20.35678f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_17, -5183.694f, -2097.742f, 14.60039f, 0f, 0f, 44.16594f, 20.21152f, 34.85038f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_17, -5158.286f, -2115.092f, 14.60039f, 0f, 0f, 47.64177f, 8.714133f, 1.633199f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_17, -5230.49f, -2124.006f, 14.60039f, 0f, 0f, 44.16594f, 15.32629f, 8.306676f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_17, -5157.303f, -2119.695f, 14.60039f, 0f, 0f, 44.16594f, 12.39145f, 8.306676f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_17, -5213.393f, -2110.535f, 14.60039f, 0f, 0f, 44.16594f, 34.53635f, 13.98279f, 20.57744f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Rathskeller Fork - m_volRancherWarn Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_17);
		_0x39816f6f94f385ad(iLocal_16, -67.73256f, -399.212f, 72.24845f, 0f, 0f, 52.56716f, 42.4006f, 47.27523f, 14.85572f);
		_0x39816f6f94f385ad(iLocal_16, -5186.615f, -2154.339f, 14.60039f, 0f, 0f, 46.12168f, 36.16204f, 4.894577f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5194.527f, -2122.047f, 14.60039f, 0f, 0f, 43.94178f, 70.70334f, 56.27375f, 20.57744f);
		...
		_0xad3e07c37a7c1adc(sLocal_15, iLocal_16);
		_set_guard_zone_position(sLocal_15, -5194.81f, -2107.68f, 11.39f);
...
void func_28(int iParam0)
{
	...
	func_50(783, iLocal_16, 1);
	func_50(784, iLocal_16, 0);
	_0x4a8fefc43fd8ac9b(iLocal_16, 2, 1);
	_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_51(784));
}
...
{
	if ((vdist(Global_36, 0f, 0f, 0f) <= 5f || func_55(&Global_1935630, 16384)) || func_55(&Global_1935630, 8388608))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_58((*uParam0)[iVar3], 1) && func_59(iParam1)) && !func_60(iParam1, 16))
							{
								func_62(iParam1, func_61(), -1, 0, -1, 0);
								func_63((*uParam0)[iVar3], 1);
							}
							func_64(iParam1, 0);
						}
						bVar0 = true;
...
bool func_59(int iParam0)
{
	...
	return (((*Global_1888801)[iParam0]->f_20 == 1 || (*Global_1888801)[iParam0]->f_20 == 2) && !func_89(iParam0));
}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_103(&cVar6, 109029619), sVar9, func_103(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_103(&cVar6, 109029619), func_103(&cVar10, 109029619));
		}
...
void func_77(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_121(&(Global_1392240->f_1[iVar0]->f_6[iVar1]));
...
bool func_82(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bVar0 = func_20() != -1;
	switch (iParam0)
	{
...
bool func_86(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_128(iParam0)))
	{
		return false;
	}
...
bool func_106(int iParam0)
{
	...
	if (func_138())
	{
		if (!func_139((*Global_1835011)[3]->f_1, 1))
		{
...
void func_117(int iParam0)
{
	...
	if (!func_111(&(Global_1310750->f_13321[iParam0])))
	{
		return;
	}
...
{
	func_143(Global_1935369->f_5[iParam0]->f_6, 1);
	func_144(Global_1935369->f_5[iParam0]->f_6, 0);
...
{
	if (func_83(Global_1914319->f_3[iParam0]->f_21) && func_146(Global_1914319->f_3[iParam0]->f_21))
	{
		func_147(Global_1914319->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_148(Global_1914319->f_3[iParam0]->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_121(&(Global_1914319->f_3[iParam0]->f_317[iVar0]));
...
bool func_131(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_158(&(Global_1898164->f_1[0]));
		if (func_159(iVar0) && func_160((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_166(&(Global_1935369->f_5[iParam0]->f_7), iParam1);
}
