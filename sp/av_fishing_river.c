void __EntryFunction__()
{
	...
	Var0 = Local_91;
	Var0.f_1 = Local_91.f_11;
	Var0.f_483 = { Local_91.f_1 };
	Var0.f_486 = { Local_91.f_4 };
	Var0.f_489 = Local_91.f_7;
	Var0.f_20[0] = Local_91.f_8;
	Var0.f_453 = Local_91.f_9;
	Var0.f_500 = Local_91.f_10;
	Var0.f_503 = Local_91.f_12;
	func_1(&Var0);
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 43:
			...
			func_50(uParam0, 1, "FRP_HORSE", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -5f, -2f, 0f), (35f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			if (uParam0->f_489 == 1)
			{
		...
		case 44:
			iVar0 = -389790005;
			func_50(uParam0, 1, "FRP_DOG", iVar0, _get_object_offset_from_coords(vParam1, vParam4.z, -1f, -1.35f, 0f), (-18f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
	}
	func_50(uParam0, 0, "FRP_FISHERMAN", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	if (uParam0->f_20[0]->f_8 < 0f)
	{
		uParam0->f_20[0]->f_8 = (uParam0->f_20[0]->f_8 + 360f);
	}
	func_50(uParam0, 2, "FRP_FISH", -2116748615, _get_object_offset_from_coords(vParam1, vParam4.z, 0f, 33f, -0.5f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
bool func_28(var uParam0)
{
	if (*uParam0 == 44)
	{
		...
		{
			iLocal_12 = _create_volume_cylinder(uParam0->f_20[1]->f_5 + Vector(0f, 3f, 2f), 0f, 0f, -54f, 7f, 4f, 10f);
		}
		if (!_does_volume_exist(iLocal_13))
		{
			iLocal_13 = _create_volume_cylinder(uParam0->f_483, 0f, 0f, 0f, 15f, 15f, 10f);
		}
	}
	return true;
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_14, 0) || _0x947e43f544b6ab34(&(uParam0->f_20[0]), get_player_index(), 25, 10000))
		{
			func_67(uParam0);
			if (!&uParam0->f_469[0])
			{
	...
	if (!bLocal_82)
	{
		if (func_70(&(uParam0->f_20[0]), Global_35, 1) < 144f)
		{
			func_71(&(uParam0->f_20[0]), Global_35, "GREET_MALE", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
			bLocal_82 = true;
		}
	}
	if (!bLocal_83)
	{
		if (!&uParam0->f_469[1])
		{
			if (!func_72(&(uParam0->f_20[0]), uParam0->f_20[0]->f_8, 30f))
			{
				if (!_0x331550b212014b92(&(uParam0->f_20[0]), 0))
				{
					iLocal_10 = 2;
					bLocal_83 = true;
				}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				...
				func_74(&(uParam0->f_20[0]), uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 2, 1073741824);
				remove_all_ped_weapons(&(uParam0->f_20[0]), true, true);
				_give_weapon_to_ped_2(&(uParam0->f_20[0]), -1415022764, 1, true, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				_give_weapon_to_ped_2(&(uParam0->f_20[0]), 379542007, 999, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				set_current_ped_weapon(&(uParam0->f_20[0]), -1415022764, true, 0, false, false);
				_0x870708a6e147a9ad(&(uParam0->f_20[0]), "", 35f, 35f, 8, 0, 0, 0, 0, -1);
				if (!is_entity_dead(&(uParam0->f_20[1])))
				{
					_0x931b241409216c1f(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0);
					if (*uParam0 != 44)
					{
						_0xed1c764997a86d5a(&(uParam0->f_20[0]), &(uParam0->f_20[1]));
					}
				}
				func_75(uParam0->f_20[0], 0, 1);
				set_ped_config_flag(&(uParam0->f_20[0]), 297, true);
				set_ped_config_flag(&(uParam0->f_20[0]), 130, false);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_73(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				if (*uParam0 == 43)
				{
					func_74(&(uParam0->f_20[1]), uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 2, 1073741824);
					_task_start_scenario_in_place(&(uParam0->f_20[1]), iLocal_11, 0, false, 0, -1f, false);
				}
				if (*uParam0 == 44)
				{
					_0xb8b6430ead2d2437(&(uParam0->f_20[1]), 1378588234);
					_0x24c82ef607105faa(&(uParam0->f_20[1]), -1909898637);
					_0xd52df30355ea7c8e(iLocal_13, &(uParam0->f_20[1]), 1);
					_0x4a8fefc43fd8ac9b(iLocal_13, 0, 1);
					set_ped_config_flag(&(uParam0->f_20[1]), 297, true);
					set_ped_config_flag(&(uParam0->f_20[1]), 130, false);
					_0x931b241409216c1f(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0);
					_0x870708a6e147a9ad(&(uParam0->f_20[1]), "", 2f, 2f, 8, 0, 0, 0, 0, -1);
					task_animal_unalerted(&(uParam0->f_20[1]), -1, iLocal_12, 0, 0);
					set_ped_keep_task(&(uParam0->f_20[1]), true);
				}
				func_75(uParam0->f_20[1], 0, 1);
			}
			if (!is_entity_dead(&(uParam0->f_20[2])))
			{
				func_75(uParam0->f_20[2], 1, 1);
			}
			iLocal_10 = 1;
			break;
		case 1:
			if (!is_entity_dead(&(uParam0->f_20[0])))
			{
				if (!bLocal_81)
				{
					if (func_76(&(uParam0->f_20[0]), Global_35, 1, 1) <= 25f)
					{
				...
				if (_0x77525bbf433f2cd6(&(uParam0->f_20[0])))
				{
					return 1;
				}
			}
			if (!_0xf3735acd11acd500(&(uParam0->f_20[0]), &Local_42))
			{
			...
			if (func_79(uParam0))
			{
				_0xf3735acd11acd501(&(uParam0->f_20[0]), &Local_42);
			}
			if (!&uParam0->f_469[0])
			{
			...
			{
				if (func_81(uParam0, 8f, 1116471296, 4, -91962372, 0))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
			...
			break;
		case 2:
			if (!is_entity_dead(&(uParam0->f_20[0])) && !is_entity_dead(&(uParam0->f_20[1])))
			{
				clear_ped_tasks(&(uParam0->f_20[0]), 1, 0);
				clear_ped_tasks(&(uParam0->f_20[1]), 1, 0);
				set_current_ped_weapon(&(uParam0->f_20[0]), -1569615261, false, 0, false, false);
				open_sequence_task(&iVar0);
				task_swap_weapon(0, 1, 0, 0, 0);
				if (*uParam0 == 43)
				{
					task_mount_animal(0, &(uParam0->f_20[1]), -1, -1, 1f, 1, 0, 0);
				}
				...
				if (*uParam0 == 44)
				{
					if (!is_entity_dead(&(uParam0->f_20[1])))
					{
						task_follow_and_converse_with_ped(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 0, 0, 2f, 0f, 32, 2f, 0, 1069547520, 1073741824);
					}
				}
				iLocal_10 = 4;
			}
			break;
		case 4:
			if (!is_ped_using_any_scenario(&(uParam0->f_20[1])))
			{
				return 1;
			}
			break;
...
int func_32(var uParam0, var uParam1)
{
	...
	if (*uParam0 == 44)
	{
		if (!is_entity_dead(&(uParam0->f_20[0])))
		{
			_0xe98d55c5983f2509(&(uParam0->f_20[0]));
		}
		if (!is_entity_dead(&(uParam0->f_20[1])))
		{
			_0xe98d55c5983f2509(&(uParam0->f_20[1]));
		}
	}
	if (_does_volume_exist(iLocal_12))
	{
		_delete_volume(iLocal_12);
	}
	if (_does_volume_exist(iLocal_13))
	{
		_delete_volume(iLocal_13);
	}
	return 1;
}
...
bool func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_97(&(Global_1898164->f_1[0]));
		if (func_98(iVar0) && func_99((*Global_1347702)[iVar0]->f_12, 131072))
		{
			return false;
		}
	}
...
bool func_66(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_110(&(uParam0->f_20[uParam0->f_501]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
...
void func_67(var uParam0)
{
	if (!is_entity_dead(&(uParam0->f_20[0])))
	{
		set_current_ped_weapon(&(uParam0->f_20[0]), 379542007, true, 0, true, false);
	}
}
...
float func_70(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_113(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
bool func_79(var uParam0)
{
	switch (Local_42)
	{
		case 1:
			...
			Local_42.f_1 = 30f;
			func_77(&uLocal_72);
			if (!func_123(&(uParam0->f_20[0]), 425310094))
			{
				task_weapon(&(uParam0->f_20[0]));
			}
			return true;
		case 2:
			if (func_78(&uLocal_72, 2f))
			{
				bLocal_90 = false;
				func_124(&uLocal_78);
				Local_42.f_1 = get_random_float_in_range(25f, 30f);
				Local_42.f_15 = get_random_float_in_range(0.9f, 1f);
				Local_42.f_14 = 0f;
		...
		case 6:
			if (((func_78(&uLocal_75, 80f) && !bLocal_87) && Local_42.f_2 > 15f) && *uParam0 != 44)
			{
				if (!is_entity_dead(&(uParam0->f_20[2])))
				{
					if (does_entity_exist(Local_42.f_12))
					{
						if (func_76(Local_42.f_12, &(uParam0->f_20[2]), 1, 1) < 1f)
						{
							Local_42.f_7 = &uParam0->f_20[2];
							clear_ped_tasks_immediately(&(uParam0->f_20[2]), false, true);
							_0x1a52076d26e09004(&(uParam0->f_20[0]), &(uParam0->f_20[2]));
							func_126(&(Local_42.f_6), 8196);
							bLocal_87 = true;
						}
						else if (!func_123(&(uParam0->f_20[2]), 1227113341))
						{
							task_go_to_entity(&(uParam0->f_20[2]), Local_42.f_12, 20000, 0.5f, 2f, 2f, 0);
						}
					}
				}
			}
			...
			{
				if (does_entity_exist(Local_42.f_11))
				{
					_0x978aa2323ed32209(Local_42.f_11, 0f);
				}
				if (does_entity_exist(Local_42.f_12))
				{
					_0x978aa2323ed32209(Local_42.f_12, 0f);
				}
				if (bLocal_90)
				{
					if (!func_121(&uLocal_78))
					{
						func_120(&uLocal_78, (-1f * get_random_float_in_range(2f, 4f)));
					}
				...
				else
				{
					if (!func_121(&uLocal_78))
					{
						func_120(&uLocal_78, (-1f * get_random_float_in_range(7f, 12f)));
					}
		...
		case 12:
			...
			{
				func_128(uParam0->f_20[2]);
			}
			return true;
		case 7:
			if (func_119(Local_42.f_5, 2))
			{
				set_ped_reset_flag(&(uParam0->f_20[2]), 167, true);
			}
			Local_42.f_14 = 1f;
			func_126(&(Local_42.f_6), 2048);
			return true;
	...
	if ((get_frame_count() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!is_entity_dead(&(uParam0->f_20[iVar0])))
			{
				...
				fVar8 = func_70(Global_35, &(uParam0->f_20[iVar0]), 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!is_entity_dead(&(uParam0->f_20[iVar0])))
				{
					...
					{
						if ((func_70(Global_35, &(uParam0->f_20[iVar0]), 1) < fParam2 && _0x5102307ce88798eb(&(uParam0->f_20[iVar0]))) && is_tracked_ped_visible(&(uParam0->f_20[iVar0])))
						{
							if (!func_121(&(uParam0->f_490)))
							{
...
bool func_86(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_137(vParam0, Global_1415419->f_9721[iVar0]->f_4, fParam3, 0))
			{
				return true;
			}
		}
...
bool func_87(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137(vParam0, Global_32074.f_2697.f_1495[iVar0]->f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_110(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1935630->f_26 && func_158(player_id(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
...
void func_111(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_182(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_182(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_182(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_112(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137(Global_32074.f_2697.f_1495[iVar0]->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_114(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!is_entity_dead(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_138(func_185(iParam0, sParam2, iParam11, iParam1, network_is_game_in_progress(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
int func_180(int iParam0, var uParam1)
{
	...
	{
		return func_234(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
bool func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_76(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_243(iVar0, 0)))
		{
...
int func_229(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_76(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_232(int iParam0)
{
	...
	return func_251((*Global_1347702)[58]->f_15, 1);
}
...
bool func_244(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_245(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
