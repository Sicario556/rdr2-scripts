	...
	while (!_0x9e4ef615e307fbbe())
	{
		...
		switch (Var0)
		{
			case 0:
				...
				break;
			case 1:
				if (is_ped_active_in_scenario(Global_35, 0) && (_0x569f1e1237508deb(Global_35) == 254049387 || _0x569f1e1237508deb(Global_35) == 1135271674))
				{
					_0xcb9401f918cb0f75(Global_35, "BLOCK_COFFEE_DISCARD_PROMPT", 1, 1);
					_0xcb9401f918cb0f75(Global_35, "SHOW_COFFEE_KNEEL_DISCARD_PROMPT", 1, 1);
				}
				...
				if (IntToFloat(Var0.f_1.f_1) >= Var0.f_1.f_2 || ((get_frame_count() % 10) == 0 && get_entity_submerged_level(Global_35) > 0.2f))
				{
					func_4(&Var0, 2);
				}
				break;
			case 2:
				_0xcb9401f918cb0f75(Global_35, "BLOCK_COFFEE_DRINK_PROMPT", 1, 1);
				_0xcb9401f918cb0f75(Global_35, "BLOCK_COFFEE_DISCARD_PROMPT", 1, 1);
				if (_get_item_interaction_from_ped(Global_35) != -2123939384)
				{
				}
				else
				{
					if (is_ped_active_in_scenario(Global_35, 0) && (_0x569f1e1237508deb(Global_35) == 254049387 || _0x569f1e1237508deb(Global_35) == 1135271674))
					{
						_0xb35370d5353995cb(Global_35, 2140481581, 1048576000);
					}
					else
					{
						_0xb35370d5353995cb(Global_35, -541529715, 1048576000);
					}
					func_4(&Var0, 3);
				}
				break;
...
void func_8(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_11)
	{
		if (-943921969 == uParam0->f_33[iVar0]->f_1)
		{
			...
			func_11((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), 1);
			func_12(0, 7000);
			bVar10 = true;
		}
		...
		else if (381158954 == uParam0->f_33[iVar0]->f_1)
		{
			...
			func_14((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
			func_12(1, 7000);
		}
		else if (-416929031 == uParam0->f_33[iVar0]->f_1)
		{
			fVar4 = func_15((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
		...
		{
			fVar5 = func_15((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
		...
		{
			fVar6 = func_15((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
...
int func_26(int iParam0)
{
	...
	return func_57((*Global_1347702)[58]->f_15, 1);
}
