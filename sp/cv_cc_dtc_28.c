...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, 531527393, 0.821147f, -0.15355f, 0.243698f, 0, 1, 0, 1);
	iLocal_17 = func_152(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_19 = func_152(uParam0, -548150401, 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_18 = func_152(uParam0, 1568801463, 0f, 0f, 0f, "PEPPERSHAKER", 0, 1, 1);
	func_153(uParam0, "script@vignette@dutch_28@base", 1, 1, 0, 0);
	iLocal_20 = func_153(uParam0, "script@vignette@dutch_28@action", 0, 0, 1, 0);
	func_154(uParam0, "CDT28AU");
	func_155(uParam0, -733175640, 1154898325);
	func_156(uParam0, iLocal_20, -1, 0.88f);
	func_157(uParam0, iLocal_14, 3, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", iLocal_16, 0);
	func_158(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	...
	func_158(uParam0, iLocal_15, 4, -717884433, "PROP_HUMAN_FOODPREP_STEW_SEASONING_MALE_B", -1, 1, -1073741824, 1065353216, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(747937920, 1) && !func_388((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
