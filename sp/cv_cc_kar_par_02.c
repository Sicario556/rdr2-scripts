...
bool func_93(var uParam0)
{
	if (!bLocal_19)
	{
		...
		{
			if (_0x91a5f9cbebb9d936(uParam0->f_36[iLocal_18]->f_4))
			{
				remove_scenario_blocking_area(uParam0->f_36[iLocal_18]->f_4, false);
			}
			bLocal_19 = true;
		}
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_390((*Global_1347702)[1]->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
