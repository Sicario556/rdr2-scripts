void __EntryFunction__()
{
	...
	Var0 = Local_49;
	Var0.f_1 = Local_49.f_11;
	Var0.f_483 = { Local_49.f_1 };
	Var0.f_486 = { Local_49.f_4 };
	Var0.f_489 = Local_49.f_7;
	Var0.f_20[0] = Local_49.f_8;
	Var0.f_453 = Local_49.f_9;
	Var0.f_500 = Local_49.f_10;
	Var0.f_503 = Local_49.f_12;
	func_1(&Var0);
...
{
	func_33(uParam0, 10766, 10824, 11722);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "DCCP_CAT", iLocal_10, _get_object_offset_from_coords(vParam1, vParam4.z, 4f, 3.5f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
...
int func_31(var uParam0)
{
	...
	if (is_ped_active_in_scenario(&(uParam0->f_20[1]), 1))
	{
		if (!_0x916b8e075abc8b4e(&(uParam0->f_20[1]), 1))
		{
			_0xe7fa07624574b79a(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1, 1, 25f, 1, 0, 0, 0);
		}
	}
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_65(&(uParam0->f_20[0]->f_5), 50, 10, 0);
				uLocal_15[0] = func_66(iLocal_12, uParam0->f_20[0]->f_5, uParam0->f_20[0]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[0]), &(uLocal_15[0]), 0, 0, false, true, 0, false, -1f, false);
				func_67(uParam0->f_20[0], 1, 1);
				set_ped_keep_task(&(uParam0->f_20[0]), true);
			}
			if (!is_entity_dead(&(uParam0->f_20[1])))
			{
				func_65(&(uParam0->f_20[1]->f_5), 50, 10, 0);
				uLocal_15[1] = func_66(iLocal_13, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 0, 0);
				_task_use_scenario_point(&(uParam0->f_20[1]), &(uLocal_15[1]), 0, 0, false, true, 0, false, -1f, false);
		...
		case 1:
			...
			{
				func_63(uParam0);
				task_look_at_entity(&(uParam0->f_20[0]), &(uParam0->f_20[1]), -1, 0, 51, 0);
				task_follow_nav_mesh_to_coord(&(uParam0->f_20[0]), get_offset_from_entity_in_world_coords(&(uParam0->f_20[0]), 0f, 3.5f, 0f), 1f, -1, 0.25f, 8192, 40000f);
				func_69(&uLocal_18);
				iLocal_9 = 2;
			}
			break;
		case 2:
			if (!func_70(&(uParam0->f_20[0]), 713668775))
			{
				task_stand_still(&(uParam0->f_20[0]), 3);
				_0x2e1d6d87346bb7d2(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0, 0);
				func_69(&uLocal_18);
				iLocal_9 = 3;
			}
			break;
		case 3:
			if (func_71(&(uParam0->f_20[1]), &(uParam0->f_20[0]), 1) < 16f && func_72(&uLocal_18, 2f))
			{
				if (!is_entity_dead(&(uParam0->f_20[1])) && !is_entity_dead(&(uParam0->f_20[0])))
				{
					_0x802092b07e3b1eea(&(uParam0->f_20[1]), uParam0->f_20[0]->f_5, 0);
					func_73(&(uParam0->f_20[0]));
					_task_smart_flee_style_ped(&(uParam0->f_20[0]), &(uParam0->f_20[1]), 0, 256, -1082130432, -1, 0);
					open_sequence_task(&iVar0);
					task_follow_to_offset_of_entity(0, &(uParam0->f_20[0]), 0f, 3.5f, 0f, 1.2f, iLocal_14, 1036831949, 1, 1, 1, 1, 1);
					func_74(0, iLocal_13, uParam0->f_20[1]->f_5, uParam0->f_20[1]->f_8, 0, 1, 0, 0, -1082130432);
					close_sequence_task(iVar0);
					_task_perform_sequence_2(&(uParam0->f_20[1]), iVar0, 0.55f, 0.55f);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (_does_scenario_point_exist(&(uLocal_15[iVar0])))
		{
			_delete_scenario_point(&(uLocal_15[iVar0]));
		}
		iVar0++;
	}
	return 1;
...
int func_65(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
var func_66(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
float func_71(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_114(get_entity_coords(iParam0, false, false), get_entity_coords(iParam1, false, false));
}
...
void func_161(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_212(0, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				func_212(1, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_212(60, 1, 0, 0, (Global_1415419->f_19[iParam0]->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
