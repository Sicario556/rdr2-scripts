...
bool func_6(var uParam0)
{
	...
	if (((_0xcf45df50c7775f2a() && _0x0909f71b5c070797()) && _is_anim_scene_loaded(iLocal_4, true, false)) || func_23(&uLocal_8) > 15f)
	{
		func_22(&uLocal_5, 0);
		return true;
	}
...
int func_11(var uParam0)
{
	func_28(74);
	func_29();
	if (_does_anim_scene_exist(iLocal_4))
	{
		_delete_anim_scene(iLocal_4);
	}
	set_player_control(get_player_index(), true, 0, false);
	_display_hud_component(-1679307491);
	func_30(&uVar0, 0);
	_0xeb48ce48eec41fd4(func_31(iLocal_3, 16));
	_0x5a8b01199c3e79c3();
	bVar1 = (is_dlc_present(-751383868) || is_dlc_present(-1499823613));
	if (is_dlc_present(-2112896652))
	{
		if (!bVar1)
		{
			if (is_dlc_present(33819255))
			{
				func_32(626, 0);
			}
		}
	...
	else if (is_dlc_present(33819255))
	{
		if (!bVar1)
		{
			func_32(625, 0);
...
void func_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	else
	{
		...
		if (fParam4 > 0f)
		{
			...
			func_22(&((*Global_1360165)[iParam0]->f_130), 1);
		}
		else
		{
...
void func_19(var uParam0)
{
	...
	if (!_does_anim_scene_exist(iLocal_4))
	{
		iLocal_4 = _create_anim_scene("script@story@wnt2@seated_journal", 0, "pbl_1", false, true);
		load_anim_scene(iLocal_4);
	}
	func_50(-2082302444, 195285667, -1212621019, 8, 1, 1, 0);
	_0x4161648394262fdf(-1357.515f, 2443.633f, 307.4195f, 2f);
	_0x387ad749e3b69b70(-1351.26f, 2441.85f, 307.71f, -0.91f, 0.4f, 0.12f, 15f, 0);
	if (!is_ped_injured(Global_35))
	{
		...
		_set_entity_coords_and_heading(Global_35, -1357.369f, 2443.642f, 307.4198f, 281.8427f, true, false, true);
	}
}
...
int func_24(var uParam0)
{
	...
	{
		if (_does_anim_scene_exist(iLocal_4) && _is_anim_scene_loaded(iLocal_4, true, false))
		{
			clear_ped_tasks_immediately(Global_35, true, true);
			_hide_ped_weapons(Global_35, 2, true);
			clear_ped_tasks_immediately(Global_35, true, true);
			_hide_ped_weapons(Global_35, 2, true);
			set_anim_scene_entity(iLocal_4, "player_zero", Global_35, 0);
			start_anim_scene(iLocal_4);
			iVar0 = 4;
			func_56(&iVar0, 0, 2, 0, 0, 0, 0);
			if (_0xc28f62ac9774fc1b())
			{
				func_57(&iLocal_3, 16);
			}
			else
...
bool func_26(var uParam0)
{
	...
	if (_does_anim_scene_exist(iLocal_4))
	{
		if (_is_anim_scene_started(iLocal_4, false))
		{
			if (!is_ped_injured(Global_35))
			{
			...
			if (!func_31(iLocal_3, 2))
			{
				if (_0x005e6f28dd7ed58d(iLocal_4, "player_zero"))
				{
					func_57(&iLocal_3, 2);
				}
			}
		...
		{
			if (_0xf94692eb9dc15d74(iLocal_4, 0) || _is_anim_scene_finished(iLocal_4, false))
			{
				func_62(1);
...
void func_30(var uParam0, int iParam1)
{
	...
	Global_16 = 0;
	func_67();
	set_entity_invincible(Global_35, func_68(*uParam0, 8));
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		set_ped_config_flag(func_79(iParam0), 137, true);
	}
}
...
void func_44(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_ped_config_flag(func_79(iParam0), 204, true);
	}
	else
	{
		set_ped_config_flag(func_79(iParam0), 204, false);
	}
}
...
void func_46(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_79(iParam0);
	if (((does_entity_exist(iVar1) && func_81(iParam0) < 10000f) && !bParam3) && !is_screen_faded_out())
	{
		return;
	}
		...
		if (&Global_40.f_4283.f_6[iVar0] == 176656832)
		{
			...
			if (func_92(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_93(Global_40.f_4283.f_6[iVar4], 1, 0);
					}
					iVar4++;
				}
			}
...
void func_56(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	{
		if (func_112() || _0x50f124e6ef188b22(Global_35))
		{
			func_113(1);
		}
	}
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_121(iParam3, 1)])
			{
				func_125(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_126(32768) && iParam1 != &Global_1946804->f_57[func_121(iParam3, 1)])
			{
				func_127();
...
void func_71(int iParam0, int iParam1)
{
	...
	_0x65a5f70f4a292ebe(func_133(0), &Var5, iParam1);
}
...
void func_80(int iParam0)
{
	if (func_12(iParam0))
	{
		if (does_entity_exist(func_79(iParam0)))
		{
...
int func_86(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_39(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(is_entity_on_screen(iVar0) && func_151(player_ped_id(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_153(iParam0);
					_0x7b204f88f6c3d287(func_154(iParam0, 0));
					_0xfcc6db8dbe709bc8(func_154(iParam0, 0));
					func_155(iParam0);
				}
			}
			else
...
void func_101(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_172(iVar3) && _0x705be297eebdb95d(iVar3))
			{
				if (bParam0)
				{
...
void func_102()
{
	...
	if (func_172(iVar0) && _is_weapon_two_handed(iVar0))
	{
	...
	if (func_184(iParam0, 1, 0))
	{
		if (func_185(iParam0))
		{
			...
			if (_0x800df3fc913355f3(iVar0))
			{
				...
				if (bParam3 && !_0xa0bc8faed8cfeb3c(func_79(iParam0)))
				{
					return false;
				}
				if ((bParam1 || !func_186(func_79(iParam0), 1116471296, -1082130432, -1082130432, -1082130432)) || is_screen_faded_out())
				{
					_0xd4b614179bcd0654(iVar0);
					func_187(iParam0, 0);
					if (iParam2 && func_188((*Global_1360165)[iParam0]->f_63))
					{
...
bool func_122(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_126(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2])
	{
	...
	{
		func_205(Global_1946804->f_1378.f_1[iParam2], 4, 6);
		func_205(Global_1946804->f_1497.f_1[iParam2], 4, 6);
	}
	...
	Global_1946804->f_1378.f_1[iParam2]->f_1 = func_207(iParam0, iParam2, iParam1, func_123() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804->f_2589)
		{
			if (&Global_1946804->f_2589.f_2[iVar6] >= 0 && &Global_1946804->f_2589.f_2[iVar6] < 39)
			{
				...
				func_141(func_139(&(Global_1946804->f_2589.f_2[iVar6]), 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	return ((Global_1946804->f_57[func_121(iParam0, 1)])->f_10 && iParam1) != 0;
}
...
{
	(Global_1946804->f_57[func_121(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_121(iParam0, 1)])->f_10 || iParam1);
}

void func_141(int iParam0, int iParam1, int iParam2)
{
	(Global_1946804->f_57[func_121(iParam0, 1)])->f_10 = ((Global_1946804->f_57[func_121(iParam0, 1)])->f_10 - ((Global_1946804->f_57[func_121(iParam0, 1)])->f_10 && iParam1));
}
...
int func_152(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		(*Global_1360165)[iParam0]->f_127 = func_219(iParam0);
		return (*Global_1360165)[iParam0]->f_127;
	}
	return 0;
}
...
int func_154(int iParam0, bool bParam1)
{
	...
	{
		(*Global_1360165)[iParam0]->f_126 = func_220(iParam0);
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_221(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
		...
		default:
			...
			if ((_0x705be297eebdb95d(iVar0) || _is_weapon_melee(iVar0)) && get_ped_relationship_group_hash(iParam0) == 1030835986)
			{
				...
				if (!Global_43891 && _does_string_exist_in_string(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_172(iVar3) && _0xf252a85b8f3f8c58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
...
bool func_185(int iParam0)
{
	if (func_12(iParam0))
	{
		if (func_39(Global_1360165[iParam0], 0))
		{
			return true;
		}
	}
...
{
	if (_0xa8120ebeaf290c7a(func_40(iParam0, 0)))
	{
		iVar0 = _0x69786495c92a3044(func_40(iParam0, 0));
		if (iVar0 != (*Global_1360165)[iParam0]->f_47 || bParam1)
		{
			(*Global_1360165)[iParam0]->f_47 = iVar0;
			StringCopy(&((*Global_1360165)[iParam0]->f_48), _0x9c7f95946e304778(func_40(iParam0, 0), (*Global_1360165)[iParam0]->f_47), 64);
...
int func_201(var uParam0)
{
	iVar0 = 0;
	iVar1 = 22;
	if (&uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1] && func_200(&(uParam0->f_1[iVar1]), 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
{
	iVar1 = 12;
	iVar2 = func_196(&(uParam0->f_1[iParam2]));
	iVar3 = 0;
	if (bParam3)
	{
		iVar3 = 3;
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == &Global_1946804->f_57[iParam2])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_196(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_244(iParam1) && &uParam0->f_1[iVar1] != &Global_1946804->f_57[iVar1]) && -923693316 == func_196(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && func_200(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711))
				{
				...
				if (&uParam0->f_1[iParam2] != &Global_1946804->f_57[iParam2] && (func_244(&(Global_1946804->f_1497.f_1[iVar1])) || func_200(&(Global_1946804->f_1497.f_1[iVar1]), -1638171711)))
				{
					uParam0->f_1[iParam2] = &Global_1946804->f_57[iParam2];
					uParam0->f_1[iParam2]->f_1 = 0;
					if (bParam4)
			...
			switch (func_196(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_196(&(uParam0->f_1[iVar1])))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_196(&(uParam0->f_1[iVar1])) || func_200(&(uParam0->f_1[iVar1]), 866047851))
					{
						uParam0->f_1[iVar1] = &Global_1946804->f_57[iVar1];
						uParam0->f_1[iVar1]->f_1 = 0;
						if (bParam4)
...
void func_208(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_248(&(uParam0->f_1[iVar0]), iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_209(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_250(&(uParam0->f_2[iVar0]), bParam1, bParam2);
		iVar0++;
	}
	if (func_123() == -1)
	{
...
void func_214(struct<4> Param0)
{
	...
	if (func_255(Param0))
	{
		...
		while (iVar0 < Global_1946804->f_852)
		{
			...
			if (&Global_1946804->f_769[iVar1] == 34 && func_255(20))
			{
				return;
			}
			iVar0++;
		...
		while (iVar28 < 4)
		{
			...
			if (func_193(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_259(0))
				{
					...
					func_260(_get_ammo_type_for_weapon(iParam0), iParam1, iParam6);
...
int func_233(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_263("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_262(iParam1, 512) && func_239(Var4.f_4, &uVar19, &Var23, 1728382685)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || _0xf29a186ed428b552(Global_35, Var4.f_4))
			{
				if ((((((_is_weapon_two_handed(Var4.f_4) || func_265(Var4.f_4)) && (!_is_weapon_shotgun(Var4.f_4) || func_262(iParam1, 16))) && (!_is_weapon_sniper(Var4.f_4) || func_262(iParam1, 4))) && (!func_265(Var4.f_4) || func_262(iParam1, 8))) && (!_is_weapon_repeater(Var4.f_4) || !func_262(iParam1, 8388608))) && (!_is_weapon_rifle(Var4.f_4) || !func_262(iParam1, 1048576)))
				{
...
void func_234(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_270(ceil(&(Global_40.f_11095.f_11[iParam0])));
...
void func_240(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_274(uParam0->f_2[iVar0], 2) || &uParam0->f_2[iVar0] == iParam1) || &uParam0->f_2[iVar0] == 39)
			{
				*uParam0->f_2[iVar0] = { Var2 };
			}
			else
			{
				if (func_274(uParam0->f_2[iVar0], 1))
				{
					func_275(uParam0->f_2[iVar0], 2, 6);
				}
...
bool func_242(int iParam0)
{
	...
	return &Global_1946804->f_1497.f_1[func_121(iParam0, 1)] != &Global_1946804->f_57[func_121(iParam0, 1)];
}
...
{
	if (iParam0 == &Global_1946804->f_57[func_121(iParam1, 1)])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_250(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_123() == -1)
	{
		func_279(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_26796.f_776);
	}
	else
	{
		func_280(Global_1946804->f_1497.f_1[iParam0], iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_281(var uParam0, int iParam1)
{
	if (func_123() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_279(uParam0->f_1[iVar0], iVar0, iParam1);
			iVar0++;
		}
		return;
	}
	...
	while (iVar0 < 39)
	{
		func_280(uParam0->f_1[iVar0], iVar0, iParam1);
		iVar0++;
	}
}
...
float func_288()
{
	...
	func_298(3, round((to_float(iVar8) * fVar10)), 0);
...
float func_289()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_298(2, round((to_float(iVar8) * fVar10)), 0);
...
float func_290()
{
	...
	fVar9 = (100f * (to_float(90) / to_float(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_298(1, round((to_float(iVar8) * fVar10)), 0);
