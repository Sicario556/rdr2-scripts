...
bool func_96(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Stool", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Chair", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Chair^1", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
