		...
		if (get_game_timer() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_34 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_31 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_34 < get_game_timer())
					{
						bLocal_35 = false;
						iLocal_31 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_33));
					Global_1896620 = -1;
					iLocal_34 = (iLocal_30 + get_game_timer());
					iLocal_31 = 3;
					break;
				case 3:
					if (func_13() || iLocal_34 < get_game_timer())
					{
						func_14(iLocal_33);
						iLocal_34 = (iLocal_30 + get_game_timer());
						iLocal_31 = 4;
				...
				case 4:
					...
					break;
				case 5:
					if (func_17(iLocal_33) || iLocal_34 < get_game_timer())
					{
						func_18(iLocal_33);
						iLocal_34 = (iLocal_30 + get_game_timer());
						iLocal_31 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_33)))
					{
						if (func_19(func_9(iLocal_33), 4) && !iLocal_34 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_33) || iLocal_34 < get_game_timer())
							{
								func_21(iLocal_33, 4);
								iLocal_34 = (iLocal_30 + get_game_timer());
								iLocal_31 = 8;
							...
							func_36(iLocal_33, Global_1896674);
							iLocal_31 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_33);
							func_21(iLocal_33, 8);
							...
							{
								iLocal_32 = get_game_timer() + 1000;
							}
							func_41(Global_1896674, iLocal_33);
							func_42(iLocal_33);
							func_21(iLocal_33, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_33]->f_11);
							if ((*Global_1887339)[iLocal_33]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_33]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_33]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_33]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
{
	iParam0 = iParam0;
	iLocal_16[0] = get_interior_at_coords(-1420.278f, 1171.593f, 226.7f);
	iLocal_16[1] = get_interior_at_coords(-1440.127f, 1189.548f, 226.4f);
	iLocal_16[2] = get_interior_at_coords(-1418.762f, 1197.32f, 225.4f);
	iLocal_16[3] = get_interior_at_coords(-1393.259f, 1181.42f, 222.2f);
	sLocal_21[0] = "mil_cave_lights_01";
	sLocal_21[1] = "mil_cave_lights_02";
	sLocal_21[2] = "mil_cave_lights_03";
	sLocal_21[3] = "mil_cave_lights_04";
}
...
bool func_40(int iParam0)
{
	...
	if (func_61(&bLocal_26))
	{
		if (bLocal_26)
		{
			func_62(-1382959706, 0, 0);
			func_62(-76557983, 0, 0);
			_0x1bc47a9dedc8df5d(-1382959706, 0);
			_0x1bc47a9dedc8df5d(-76557983, 0);
		}
	}
	return false;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_33)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_76(iLocal_33, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_60()
{
	...
	while (iVar0 <= 3)
	{
		if (is_valid_interior(&(iLocal_16[iVar0])))
		{
			if (is_interior_ready(&(iLocal_16[iVar0])) && (get_interior_from_entity(Global_34) != &iLocal_16[iVar0] || is_screen_faded_out()))
			{
				if (!is_interior_entity_set_active(&(iLocal_16[iVar0]), &(sLocal_21[iVar0])))
				{
					activate_interior_entity_set(&(iLocal_16[iVar0]), &(sLocal_21[iVar0]), 0);
				}
			}
		}
		iVar0++;
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_84(iParam0, 16777216)) && !Global_1893587->f_9)
	{
...
int func_90(int iParam0, bool bParam1)
{
	...
	{
		func_123(iParam0, _create_persistent_character(func_122(iParam0)));
		if (func_45() == -1)
		{
			if (func_115(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_124(iParam0));
				func_125(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_124(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_124(iParam0)))
	{
		func_125(iParam0, 128);
		return 1;
	}
	func_123(iParam0, _create_persistent_character(func_122(iParam0)));
	_0x4f81ead1de8fa19b(func_124(iParam0));
	if (func_115(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_124(iParam0));
		func_125(iParam0, 2048);
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_136(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_137(Global_1940018->f_5[iParam0]->f_6, 1);
	func_138(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_88(Global_1915715->f_3[iParam0]->f_21) && func_140(Global_1915715->f_3[iParam0]->f_21))
	{
		func_141(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_142(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_145(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
int func_116(int iParam0, bool bParam1)
{
	...
	func_148(iParam0);
	_0xfc77c5b44d5ff7c0(func_124(iParam0));
	func_123(iParam0, 0);
	return 1;
}
...
void func_121(int iParam0, bool bParam1)
{
	...
	else if (func_155(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_145(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
...
{
	func_167(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
