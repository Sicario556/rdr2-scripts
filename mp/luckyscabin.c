void __EntryFunction__()
{
	...
	fLocal_14 = 1f;
	iLocal_17 = 822933632;
	vLocal_19 = { -613.3514f, 529.5198f, 94.413f };
	vLocal_22 = { 0f, 0f, -50f };
	iLocal_31 = 20000;
	iLocal_34 = vScriptParam_0.x;
	iLocal_32 = vScriptParam_0.z;
	bLocal_36 = false;
		...
		if (get_game_timer() > iLocal_33)
		{
			...
			switch (iLocal_32)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_35 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_32 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_35 < get_game_timer())
					{
						bLocal_36 = false;
						iLocal_32 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_34));
					Global_1896620 = -1;
					iLocal_35 = (iLocal_31 + get_game_timer());
					iLocal_32 = 3;
					break;
				case 3:
					if (func_13() || iLocal_35 < get_game_timer())
					{
						func_14(iLocal_34);
						iLocal_35 = (iLocal_31 + get_game_timer());
						iLocal_32 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_34) || iLocal_35 < get_game_timer())
					{
						func_16(iLocal_34);
						iLocal_35 = (get_game_timer() + iLocal_31);
						iLocal_32 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_34) || iLocal_35 < get_game_timer())
					{
						func_18(iLocal_34);
						iLocal_35 = (iLocal_31 + get_game_timer());
						iLocal_32 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_34)))
					{
						if (func_19(func_9(iLocal_34), 4) && !iLocal_35 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_34) || iLocal_35 < get_game_timer())
							{
								func_21(iLocal_34, 4);
								iLocal_35 = (iLocal_31 + get_game_timer());
								iLocal_32 = 8;
							...
							func_36(iLocal_34, Global_1896674);
							iLocal_32 = 11;
							Jump @850; //curOff = 676
							func_37(iLocal_34);
							func_21(iLocal_34, 8);
							...
							{
								iLocal_33 = get_game_timer() + 1000;
							}
							func_41(Global_1896674, iLocal_34);
							func_42(iLocal_34);
							func_21(iLocal_34, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_34]->f_11);
							if ((*Global_1887339)[iLocal_34]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_34]->f_12);
							}
							Jump @850; //curOff = 827
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_34]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_34]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_34)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_34, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_60()
{
	switch (iLocal_26)
	{
		case 0:
			...
			request_anim_dict("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A");
			if (has_model_loaded(iLocal_17) && has_anim_dict_loaded("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				func_91();
				if (_0xfbe782b3165ac8ec(-448258490))
				{
					iLocal_18 = create_object(822933632, vLocal_19, false, false, false, true, true);
				}
				else if (!_unlock_is_unlocked(-1513415814))
				{
					iLocal_18 = create_object(822933632, vLocal_19, false, false, false, true, true);
				}
				else
				{
					iLocal_18 = create_object(822933632, vLocal_19, false, false, false, false, true);
				}
				decor_set_bool(iLocal_18, "chest_local_only", true);
				set_entity_rotation(iLocal_18, vLocal_22, 2, true);
				freeze_entity_position(iLocal_18, true);
				if (_0xfbe782b3165ac8ec(-448258490))
				{
					_0x188f8071f244b9b8(iLocal_18, 1);
					play_entity_anim(iLocal_18, "base_lockbox", "MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A", 1f, false, true, false, 0f, 0);
					iLocal_26 = 2;
				}
				else if (!_unlock_is_unlocked(-1513415814))
				{
...
void func_61()
{
	if (!is_valid_interior(iLocal_25))
	{
		iLocal_25 = get_interior_at_coords(vLocal_19);
	}
	switch (iLocal_27)
	{
		case 0:
			if (is_valid_interior(iLocal_25) && iLocal_25 == get_interior_from_entity(Global_34))
			{
			...
			break;
		case 1:
			if (!is_valid_interior(get_interior_from_entity(Global_34)) || iLocal_25 != get_interior_from_entity(Global_34))
			{
				if (network_is_in_mp_cutscene())
				{
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_83(iParam0, 16777216)) && !Global_1893587->f_9)
	{
...
void func_78(int iParam0)
{
	...
	if (decor_exist_on(iLocal_18, "chest_local_only"))
	{
		decor_remove(iLocal_18, "chest_local_only");
	}
...
void func_91()
{
	if (!_does_volume_exist(iLocal_16))
	{
		...
		vVar6 = { 7f, 8f, 5f };
		iLocal_16 = _create_volume_box_with_custom_name(vVar0, vVar3, vVar6, "LuckysCabin");
		_0xeeb7818b1d307212(iLocal_16);
	}
}
...
{
	iVar4 = 0;
	while (iVar4 < get_number_of_events(0))
	{
		if (get_event_at_index(0, iVar4) == 1352063587)
		{
			if (get_event_data(0, iVar4, &Var0, 4))
			{
				if (Var0.f_1 == iParam0)
				{
					if (Var0 == Global_34)
