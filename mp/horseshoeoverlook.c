...
bool func_13()
{
	iLocal_21 = _create_volume_aggregate_with_custom_name("Horseshoe - m_volTown");
	_0xbce668aaf83608be(iLocal_21, -131.6045f, -34.30135f, 102.2093f, 0f, 0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	_0xbce668aaf83608be(iLocal_21, -117.99f, -66.781f, 100f, 0f, 0f, 94f, 16.719f, 19.52f, 13.16044f);
	iLocal_19 = _create_volume_box_with_custom_name(-380.148f, -19.541f, 42.09f, 0f, 0f, -110f, 14.456f, 10.148f, 8.8f, "HRT W TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = _create_volume_cylinder_with_custom_name(-381.779f, -21.29f, 42.09f, 0f, 0f, -110f, 3.7f, 3.7f, 4.2f, "HRT W TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
