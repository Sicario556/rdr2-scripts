...
bool func_13()
{
	iLocal_21 = (*Global_1887339)[39]->f_5;
	_0xb469cfd9e065eb99(iLocal_21, 9);
	iLocal_19 = _create_volume_box_with_custom_name(-1859.829f, -1332.492f, 97.368f, 0f, 0f, -140f, 14.456f, 10.148f, 8.8f, "Tall Trees TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = _create_volume_cylinder_with_custom_name(-1862.152f, -1335.058f, 97.368f, 0f, 0f, -140f, 3.7f, 3.7f, 4.2f, "Tall Trees TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
...
{
	func_58(38, iLocal_19, iParam0, iLocal_20, 0, 12, 1, 0, -1082130432, 0);
	func_59(38, 0);
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_77(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
