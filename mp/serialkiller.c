		...
		if (get_game_timer() > iLocal_21)
		{
			...
			switch (iLocal_20)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_23 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_20 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_23 < get_game_timer())
					{
						bLocal_24 = false;
						iLocal_20 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_22));
					Global_1896620 = -1;
					iLocal_23 = (iLocal_19 + get_game_timer());
					iLocal_20 = 3;
					break;
				case 3:
					if (func_13() || iLocal_23 < get_game_timer())
					{
						func_14(iLocal_22);
						iLocal_23 = (iLocal_19 + get_game_timer());
						iLocal_20 = 4;
				...
				case 4:
					...
					break;
				case 5:
					if (func_17(iLocal_22) || iLocal_23 < get_game_timer())
					{
						func_18(iLocal_22);
						iLocal_23 = (iLocal_19 + get_game_timer());
						iLocal_20 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_22)))
					{
						if (func_19(func_9(iLocal_22), 4) && !iLocal_23 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_22) || iLocal_23 < get_game_timer())
							{
								func_21(iLocal_22, 4);
								iLocal_23 = (iLocal_19 + get_game_timer());
								iLocal_20 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_22]->f_11);
							if ((*Global_1887339)[iLocal_22]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_22]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_22]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_22]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_60(&Global_1940258, 32768)) || func_60(&Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_22)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_73(iLocal_22, 0), 1);
					break;
			}
		}
		if (func_10(func_66()))
...
bool func_64(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_89(iParam0));
}
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_119(iParam0, _create_persistent_character(func_118(iParam0)));
		if (func_45() == -1)
		{
			if (func_111(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_120(iParam0));
				func_121(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_120(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_120(iParam0)))
	{
		func_121(iParam0, 128);
		return 1;
	}
	func_119(iParam0, _create_persistent_character(func_118(iParam0)));
	_0x4f81ead1de8fa19b(func_120(iParam0));
	if (func_111(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_120(iParam0));
		func_121(iParam0, 2048);
...
{
	func_133(Global_1940018->f_5[iParam0]->f_6, 1);
	func_134(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_85(Global_1915715->f_3[iParam0]->f_21) && func_136(Global_1915715->f_3[iParam0]->f_21))
	{
		func_137(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_138(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_141(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
int func_112(int iParam0, bool bParam1)
{
	...
	func_144(iParam0);
	_0xfc77c5b44d5ff7c0(func_120(iParam0));
	func_119(iParam0, 0);
	return 1;
}
...
void func_117(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_141(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_155(iParam0, 2))
	{
...
{
	func_163(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_175(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
