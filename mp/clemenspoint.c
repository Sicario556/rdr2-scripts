...
bool func_13()
{
	iLocal_13 = _create_volume_cylinder_with_custom_name(668.9086f, -1260.756f, 45.237f, 0f, 0f, -15.99999f, 58.82726f, 39.94f, 50f, "Clemens - m_volTown");
	return true;
}
...
{
	if (load_stream("clemens_point", "es_camp_memory_sounds"))
	{
		iLocal_14 = _0x0556c784fa056628("clemens_point", "es_camp_memory_sounds");
...
bool func_40(int iParam0)
{
	if (((func_60(Global_34, iLocal_13, 1, 0) && iLocal_15 < get_game_timer()) && func_62(func_61())) && func_63(6, 18))
	{
		...
		set_ambient_zone_state("AZ_camp_clemens_point_Endless_Summer", true, true);
		bLocal_16 = true;
		iLocal_15 = get_game_timer() + 30000;
	}
	if (bLocal_16)
	{
		...
		{
			set_ambient_zone_state("AZ_camp_clemens_point_Endless_Summer", false, true);
			bLocal_16 = false;
		}
	}
	return true;
