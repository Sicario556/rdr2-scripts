...
void func_1(int iParam0)
{
	...
	func_8();
	func_9();
	network_register_host_broadcast_variables(&Local_0, 10, 42);
	func_10(_0xba24095ea96dfe17(&Local_0), 10, "m_hostData");
	network_register_player_broadcast_variables(&vLocal_10, 97, 43);
	func_11(_0x690806bc83bc8ca2(vLocal_10[0]), 97, "m_clientData");
	func_12(0);
...
{
	iVar0 = 255;
	_copy_memory(&Local_107, iParam0, 5);
...
void func_41()
{
	iVar0 = Global_1198046->f_231.f_1066[Local_107.f_12]->f_5;
	...
	Local_0.f_6 = func_107(_0x4be6c13a45cca8ec(_0x901e0dc25080c8b9(iVar0)));
	func_108(256);
...
void func_42()
{
	...
	{
		clear_area(Local_107.f_15, Var0.f_10, 2442122);
		func_106(2);
	}
	else if (bVar31)
	{
...
void func_47()
{
	...
	if (func_116(512))
	{
		if (func_60(64) && func_107(player_id()) == Local_0.f_6)
		{
			func_61(Local_0.f_6);
			func_128(64);
		}
	...
	{
		if (func_107(player_id()) == Local_0.f_6)
		{
			func_129(Local_0.f_6, 1, 1);
			func_130(64);
		}
	}
	else if (func_107(player_id()) != Local_0.f_6)
	{
		func_61(Local_0.f_6);
		func_128(64);
	}
...
bool func_56()
{
	return (func_116(4) || (network_is_game_in_progress() && network_get_num_participants() <= 1));
}
...
void func_62()
{
	...
	if (bVar0)
	{
		if (_does_scenario_point_exist(Local_107.f_19.f_4))
		{
			_delete_scenario_point(Local_107.f_19.f_4);
		}
		if (does_entity_exist(Local_107.f_19.f_5))
		{
			delete_entity(&(Local_107.f_19.f_5));
		}
	}
}
...
bool func_109(int iParam0)
{
	...
	return (func_192(iParam0) && (*Global_1131196)[iParam0]->f_18.f_1 != 0);
}
...
bool func_111(struct<31> Param0, var uParam31)
{
	...
	{
		if (_0x397769175a7dbb30(Local_107.f_15, Param0.f_10, 0, 0, 0))
		{
			_0xfa15c9a320e707b0();
			*uParam31 = 1;
			return false;
...
bool func_115(int iParam0, int iParam1)
{
	...
	return func_159(&(vLocal_10[iParam1]), iParam0);
}
...
bool func_119()
{
	...
	while (iVar2 <= 0)
	{
		if (!network_does_network_id_exist(&(Local_0.f_7.f_1[iVar2])))
		{
			...
			else
			{
				if (iVar2 == 0)
				{
					_0x9587913b9e772d29(net_to_ent(&(Local_0.f_7.f_1[iVar2])), 0);
					freeze_entity_position(net_to_ent(&(Local_0.f_7.f_1[iVar2])), true);
				}
				iVar2++;
			}
			if (bVar1)
...
int func_129(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_207(&((*Global_1134390)[iVar1]->f_70.f_1), 1);
	}
	else
	{
		func_208(&((*Global_1134390)[iVar1]->f_70.f_1), 1);
	}
	return 1;
}
...
{
	if (func_159(&(vLocal_10[participant_id_to_int()]), iParam0))
	{
		func_205(vLocal_10[participant_id_to_int()], iParam0);
	}
}
...
void func_132(int iParam0)
{
	...
	{
		func_191(vLocal_10[participant_id_to_int()], iParam0);
	}
}
...
bool func_135()
{
	...
	_request_scenario_type(1545192181, 15, 0, 0);
	if (!_has_scenario_type_loaded(1545192181, false))
	{
		iVar1 = 0;
	}
	iVar2 = 0;
...
bool func_139()
{
	if (!_does_scenario_point_exist(Local_107.f_19.f_4))
	{
		Local_107.f_19.f_4 = create_scenario_point(1545192181, Local_107.f_15, func_214(), 0, 0, 0);
	}
	return _does_scenario_point_exist(Local_107.f_19.f_4);
}
...
void func_147()
{
	...
	{
		fVar0 = vdist(get_entity_coords(player_ped_id(), false, false), Local_107.f_15);
		if (fVar0 < 200f)
		{
			func_132(4096);
		}
...
void func_152()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_107.f_5 = (Local_107.f_5 || vLocal_10[iVar0]) // PointerArith;
			Local_107.f_6 = (Local_107.f_6 && vLocal_10[iVar0]) // PointerArith;
		}
		iVar0++;
	}
}
...
void func_215(struct<2> Param0)
{
	...
	else if (!_0x01f4d242765c6b24(func_228(Param0)))
	{
		_0x99230691875fc218(func_226(Param0), func_228(Param0), Global_35);
	}
}
...
bool func_217(int iParam0, int iParam1)
{
	...
	Var0 = { func_261(iParam0, 1178968787) };
...
{
	bVar0 = true;
	if (bVar0 && !_unlock_is_unlocked(Local_107.f_14))
	{
		return false;
	}
	if (func_262())
...
void func_221()
{
	...
	while (iVar0 < 32)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_107.f_19.f_6 = (Local_107.f_19.f_6 && vLocal_10[iVar0]->f_1.f_1);
			Local_107.f_19.f_7 = (Local_107.f_19.f_7 || vLocal_10[iVar0]->f_1.f_1);
		}
		iVar0++;
	}
}
...
void func_224()
{
	if (!does_entity_exist(Local_107.f_19.f_5))
	{
		Local_107.f_19.f_5 = _get_scenario_point_entity(Local_107.f_19.f_4, "PrimaryItem");
		if (does_entity_exist(Local_107.f_19.f_5))
		{
			_0x543dfe14be720027(player_id(), Local_107.f_19.f_5, 0);
			_0x6ecfc621a168424c(Local_107.f_19.f_5, Local_107.f_19.f_5, 0, 0);
			set_entity_proofs(Local_107.f_19.f_5, 2, false);
			set_entity_proofs(Local_107.f_19.f_5, 4, false);
		}
	}
	if (_is_ped_using_scenario_hash(get_player_ped(player_id()), 1545192181) && has_anim_event_fired(get_player_ped(player_id()), -693272019))
	{
		func_266(1);
		func_267(1);
	}
...
void func_225()
{
	if (func_268(1))
	{
		if (!_is_ped_using_scenario_hash(get_player_ped(player_id()), 1545192181) && !func_269())
		{
	...
	if (func_274(get_player_ped(player_id()), Local_107.f_15, 1) > 40f)
	{
		func_267(2);
	}
	else
	{
		if (does_entity_exist(Local_107.f_19.f_5) && !is_entity_occluded(Local_107.f_19.f_5))
		{
			func_265();
			func_275();
		}
...
Vector3 func_252()
{
	...
	{
		case 0:
			vVar0 = { _get_object_offset_from_coords(Local_107.f_15, func_214(), 1f, -0.5f, 0f) };
			break;
		case 2:
			vVar0 = { _get_object_offset_from_coords(Local_107.f_15, func_214(), -1f, -0.5f, 0f) };
			break;
...
void func_260(int iParam0)
{
	...
	switch (iParam0->f_9)
	{
		case -773758976:
			func_285();
			iVar1 = _0x901e0dc25080c8b9(iParam0->f_10);
			iVar2 = _0x901e0dc25080c8b9(player_id());
			if (((_0xd6f6acf4392187fb(iVar1) && _0x93a91a351a07360e(iVar1)) && _0xd6f6acf4392187fb(iVar2)) && _0x93a91a351a07360e(iVar2))
			{
				if (iVar1 == iVar2)
				{
					bVar0 = true;
			...
			if (iParam0->f_10 == player_id() || bVar0)
			{
				func_265();
				func_275();
				func_286(1);
...
{
	if (fParam4 + fParam3) < get_distance_between_coords(vParam0, func_290(get_player_index()), true)
	{
		return false;
	}
...
void func_267(int iParam0)
{
	...
	func_191(&(vLocal_10[iVar0]->f_1.f_1), iParam0);
}
...
bool func_269()
{
	if (has_anim_event_fired(get_player_ped(player_id()), -610890012))
	{
		return true;
	}
	return false;
...
{
	Var0.f_10 = 255;
	_copy_memory(&(Var0.f_4), &Local_107, 5);
	Var0.f_9 = iParam0;
	Var0 = 182;
	Var0.f_1 = player_id();
...
void func_276(int iParam0)
{
	...
	func_205(&(vLocal_10[iVar0]->f_1.f_1), iParam0);
}
...
int func_279(int iParam0)
{
	...
	{
		iVar0 = ((func_303() - _0xe13634bb6baf0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
void func_285()
{
	if (does_entity_exist(Local_107.f_19.f_5))
	{
		if (is_entity_attached(Local_107.f_19.f_5))
		{
			detach_entity(Local_107.f_19.f_5, true, true);
		}
		set_entity_visible(Local_107.f_19.f_5, false);
		set_entity_collision(Local_107.f_19.f_5, false, false);
		vVar0 = { get_entity_coords(Local_107.f_19.f_5, true, false) };
		vVar0 = { vVar0.x, vVar0.y, (vVar0.z - 10f) };
		set_entity_coords(Local_107.f_19.f_5, vVar0, false, false, true, true);
		set_entity_as_no_longer_needed(&(Local_107.f_19.f_5));
	}
}
...
void func_291(int iParam0, int iParam1)
{
	...
	Var31 = { func_261(iParam0, 1346578557) };
...
{
	if (func_112(Global_1272030[iParam0]))
	{
		return;
	}
	...
	func_113((*Global_1272030)[iParam0]);
	iVar33 = Var2.f_5;
	if (iVar33 != 0)
	{
		Var34 = { func_308(153786159) };
		stat_id_set_int(&Var34, iVar33, true);
		Var34 = { func_308(217123284) };
		stat_id_set_int(&Var34, Global_1296859->f_21, true);
	}
	iVar36 = Var2.f_9;
	if (iVar36 != 0)
	{
		Var37 = { func_308(945205875) };
		stat_id_set_int(&Var37, iVar36, true);
		Var37 = { func_308(890183498) };
...
void func_295(struct<2> Param0)
{
	...
	{
		_0xb2a38826e5886e83(func_228(Param0), Global_265377->f_124517.f_71.f_17);
...
{
	Var0 = { func_261(iParam0, -1797584255) };
...
{
	return func_310(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
void func_306(int iParam0)
{
	...
	Var1 = { func_261(iParam0, 1178968787) };
...
var func_310(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_317());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_317());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_317());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_318(get_player_team(iVar5)));
	}
...
{
	return func_322(_get_map_zone_at_coords(vParam0, 10));
}
...
{
	func_312(uParam0, 143479330);
	if (func_331() == 2026485318)
	{
		func_312(uParam0, 617531372);
	}
	else
	{
		func_312(uParam0, 291123060);
	}
}
...
bool func_328(int iParam0, int iParam1)
{
	...
	{
		return func_340(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
