...
bool func_13()
{
	if (func_45() != -1)
	{
		iLocal_19 = _create_volume_box_with_custom_name(-1250.937f, -607.247f, 101.083f, 0f, 0f, 34.99998f, 4.887809f, 3.929512f, 3.710694f, "m_volBGV_OldManJones");
		iLocal_20 = _create_volume_box_with_custom_name(-1250.937f, -607.247f, 101.083f, 0f, 0f, 34.99998f, 4.887809f, 3.929512f, 3.710694f, "m_volBGV_OldManJonesPrompt");
	}
	return true;
}
...
{
	if ((vParam0.x == 0f && vParam0.f_1 == 0f) && vParam0.z == 0f)
	{
		return true;
	}
	return false;
