...
bool func_13()
{
	iLocal_19 = _create_volume_box_with_custom_name(-2112.93f, 477.087f, 117.116f, 0f, 0f, 170f, 14.456f, 10.148f, 8.8f, "BGV TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = _create_volume_cylinder_with_custom_name(-2110.533f, 476.639f, 117.116f, 0f, 0f, 170f, 3.7f, 3.7f, 4.2f, "BGV TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
