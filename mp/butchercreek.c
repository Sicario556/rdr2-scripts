void __EntryFunction__()
{
	...
	func_2();
	func_3();
	iLocal_107 = get_game_timer();
	iVar0 = 0;
	while (func_4())
	{
		if (get_game_timer() > iLocal_107)
		{
			iLocal_107 = 0;
			...
			switch (iLocal_106)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_109 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_106 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_109 < get_game_timer())
					{
						bLocal_110 = false;
						iLocal_106 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_108));
					Global_1896620 = -1;
					iLocal_109 = (iLocal_105 + get_game_timer());
					iLocal_106 = 3;
					break;
				case 3:
					if (func_13() || iLocal_109 < get_game_timer())
					{
						func_14(iLocal_108);
						iLocal_109 = (iLocal_105 + get_game_timer());
						iLocal_106 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_108) || iLocal_109 < get_game_timer())
					{
						func_16(iLocal_108);
						iLocal_109 = (get_game_timer() + iLocal_105);
						iLocal_106 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_108) || iLocal_109 < get_game_timer())
					{
						func_18(iLocal_108);
						iLocal_109 = (iLocal_105 + get_game_timer());
						iLocal_106 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_108)))
					{
						if (func_19(func_9(iLocal_108), 4) && !iLocal_109 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_108) || iLocal_109 < get_game_timer())
							{
							...
							func_36(iLocal_108, Global_1896674);
							iLocal_106 = 11;
							Jump @827; //curOff = 653
							func_37(iLocal_108);
							...
							{
								iLocal_107 = get_game_timer() + 1000;
							}
							func_41(Global_1896674, iLocal_108);
							func_42(iLocal_108);
							func_21(iLocal_108, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_108]->f_11);
							if ((*Global_1887339)[iLocal_108]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_108]->f_12);
							}
							Jump @827; //curOff = 804
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_108]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_108]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[87]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 22);
	iLocal_20 = _create_volume_aggregate_with_custom_name("Butcher - m_volGeneral Agg");
	_0x39816f6f94f385ad(iLocal_20, 2595.509f, 778.3701f, 87.90205f, 0f, 0f, 70f, 2.456799f, 2.667848f, 2.166918f);
	_0x39816f6f94f385ad(iLocal_20, 2593.104f, 779.3081f, 87.87495f, 0f, 0f, 70.00001f, 5.401831f, 2.666181f, 2.080325f);
	_0xb469cfd9e065eb99(iLocal_20, 10082);
	func_53();
	if (func_45() != -1)
	{
	}
...
void func_16(int iParam0)
{
	if (func_45() == -1)
	{
		...
		while (iVar0 < 5)
		{
			request_model(&(iLocal_53[iVar0]), false);
			iVar0++;
		}
	}
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_108)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_82(iLocal_108, 0), 1);
					break;
			}
		}
		if (func_10(func_75()))
...
void func_53()
{
	if (!network_is_game_in_progress())
	{
		iLocal_22 = _create_volume_cylinder_with_custom_name(2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 50.23434f, 27.58518f, 8.132094f, "Butcher Creek - m_volFarmerRegistration");
		iLocal_24 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerThreat Agg");
		_0x39816f6f94f385ad(iLocal_24, 2696.193f, 704.9335f, 76.68376f, 0f, 0f, 88.96565f, 4.466922f, 1.336465f, 4.423785f);
		_0x39816f6f94f385ad(iLocal_24, 2698.47f, 703.6447f, 76.68376f, 0f, 0f, -30.46352f, 4.936317f, 2.843117f, 4.423785f);
		_0x39816f6f94f385ad(iLocal_24, 2717.371f, 710.274f, 77.27374f, 0f, 0f, 178.9532f, 3.930448f, 4.35889f, 8.132094f);
		iLocal_23 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_23, iLocal_24);
		_0xbce668aaf83608be(iLocal_23, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 34.23434f, 22.58518f, 8.132094f);
		iLocal_25 = _create_volume_aggregate_with_custom_name("Butcher Creek - m_volFarmerWarning Agg");
		_0x6e0d3c3f828da773(iLocal_25, iLocal_23);
		_0xbce668aaf83608be(iLocal_25, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 46.23434f, 26.58518f, 8.132094f);
		sLocal_21 = "BUTCHER_CREEK";
		_create_guard_zone(sLocal_21);
		_0x8c598a930f471938(sLocal_21, iLocal_22);
		_0xa1b0e6301e2e02a6(sLocal_21, iLocal_24);
		_0x35815f372d43e1e5(sLocal_21, iLocal_23);
		_0xad3e07c37a7c1adc(sLocal_21, iLocal_25);
		_set_guard_zone_position(sLocal_21, 2717.486f, 709.7006f, 79.6157f);
		_0xa8a74aa79fb67159(sLocal_21, iLocal_22);
	}
}

void func_54()
{
	*vLocal_81[0] = { 2560.689f, 839.585f, 79.692f };
	*vLocal_81[1] = { 2559.719f, 839.916f, 79.91f };
	*vLocal_81[2] = { 2558.63f, 840.218f, 80.152f };
	*vLocal_81[3] = { 2557.29f, 840.682f, 80.418f };
	*vLocal_81[4] = { 2556.515f, 840.907f, 80.583f };
	*vLocal_65[0] = { 2560.689f, 839.58f, 78.982f };
	*vLocal_65[1] = { 2559.713f, 839.932f, 79.232f };
	*vLocal_65[2] = { 2558.51f, 840.135f, 79.377f };
	*vLocal_65[3] = { 2557.239f, 840.718f, 79.394f };
	*vLocal_65[4] = { 2556.603f, 840.876f, 79.74f };
	fLocal_97[0] = 0.3f;
	fLocal_97[1] = 0.4f;
	fLocal_97[2] = 0.4f;
	fLocal_97[3] = 0.6f;
	fLocal_97[4] = 0.8f;
	iLocal_53[0] = -541762431;
	iLocal_53[1] = 480688259;
	iLocal_53[2] = 480688259;
	iLocal_53[3] = -541762431;
	iLocal_53[4] = -541762431;
...
int func_55()
{
	...
	switch (iLocal_26)
	{
		case 0:
			...
			while (iVar0 < 5)
			{
				if (!has_model_loaded(&(iLocal_53[iVar0])))
				{
					bVar1 = false;
				}
				iVar0++;
		...
		case 1:
			...
			while (iVar0 < 5)
			{
				...
				{
					iLocal_41[iVar0] = create_object(iLocal_27, *vLocal_81[iVar0], true, true, false, false, false);
					set_entity_visible(&(iLocal_41[iVar0]), false);
					freeze_entity_position(&(iLocal_41[iVar0]), true);
					iLocal_47[iVar0] = create_object(iLocal_28, *vLocal_81[iVar0] - Vector(0.3f, 0f, 0f), true, true, false, false, false);
				}
				iVar0++;
			}
			iLocal_26 = 2;
		case 2:
			...
			while (iVar0 < 5)
			{
				...
				{
					iLocal_29[iVar0] = func_91(&(iLocal_53[iVar0]), *vLocal_65[iVar0], 0, 1, 1, 0, 1, 1, 1, 0, 0);
					_set_ped_scale(&(iLocal_29[iVar0]), 1f);
					set_entity_coords(&(iLocal_29[iVar0]), *vLocal_65[iVar0], false, false, true, true);
					freeze_entity_position(&(iLocal_29[iVar0]), true);
					return 0;
				}
				iVar0++;
			}
		...
		case 3:
			...
			while (iVar0 < 5)
			{
				if (!is_entity_dead(&(iLocal_29[iVar0])))
				{
					return 0;
				}
				iVar0++;
		...
		case 4:
			if ((get_frame_count() % 15) == 0)
			{
				if (iLocal_103 < 5)
				{
					set_model_as_no_longer_needed(&(iLocal_53[iLocal_103]));
					func_93(iLocal_103);
					iLocal_103++;
				}
			}
		...
		case 5:
			...
			while (iVar0 < 5)
			{
				if (does_entity_exist(&(iLocal_29[iVar0])) && !_0x5170dda6d63acaaa(&(iLocal_29[iVar0])))
				{
					if (is_entity_dead(&(iLocal_29[iVar0])))
					{
						apply_ped_damage_pack(&(iLocal_29[iVar0]), &(sLocal_59[iVar0]), 0f, 1f);
						_0x674b90be1115846d(&(iLocal_29[iVar0]), 1);
					}
					else
					{
						bVar2 = false;
...
int func_56(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_96(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_94(iParam0) || func_95(iParam0)) || func_98(&Global_1896620))
			{
				func_99(&Global_1896620, 0);
			}
...
void func_66()
{
	...
	iVar1 = func_105(674);
	iVar2 = func_105(675);
	if (func_106(iVar0, 0) && get_animal_tuning_float_param(iVar0, 73) != 0.15f)
	{
		set_animal_tuning_float_param(iVar0, 73, 0.15f);
	}
	if (func_106(iVar1, 0) && get_animal_tuning_float_param(iVar1, 73) != 0.15f)
	{
		set_animal_tuning_float_param(iVar1, 73, 0.15f);
	}
	if (func_106(iVar2, 0) && get_animal_tuning_float_param(iVar2, 73) != 0.15f)
	{
		set_animal_tuning_float_param(iVar2, 73, 0.15f);
	}
}
...
bool func_73(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_109(iParam0));
}
...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_64(iParam0) && func_90(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_123(&cVar6, 109029619), sVar9, func_123(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_123(&cVar6, 109029619), func_123(&cVar10, 109029619));
		}
...
void func_78(int iParam0, bool bParam1)
{
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_128(func_127(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_128(func_127(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_128(func_127(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_128(func_127(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_128(func_127(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_128(func_127(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_85(int iParam0)
{
	if (func_45() == -1)
	{
		...
		while (iVar0 < 5)
		{
			if (does_entity_exist(&(iLocal_29[iVar0])))
			{
				delete_ped(iLocal_29[iVar0]);
			}
			if (does_entity_exist(&(iLocal_41[iVar0])))
			{
				delete_entity(iLocal_41[iVar0]);
			}
			if (does_entity_exist(&(iLocal_47[iVar0])))
			{
				delete_object(iLocal_47[iVar0]);
			}
			if (does_rope_exist(&(iLocal_35[iVar0])))
			{
				delete_rope(iLocal_35[iVar0]);
			}
			iVar0++;
		}
	}
...
{
	if (does_entity_exist(&(iLocal_41[iParam0])))
	{
		if (does_entity_have_physics(&(iLocal_47[iParam0])))
		{
			_0xb6cbd40f8ea69e8a(&(iLocal_47[iParam0]));
			iVar9 = 33646;
			switch (&iLocal_53[iParam0])
			{
				case 480688259:
			...
			attach_entity_to_entity_physically(&(iLocal_47[iParam0]), &(iLocal_29[iParam0]), 4, get_ped_bone_index(&(iLocal_29[iParam0]), iVar9), vVar3, vVar6, vVar0, -1f, 0, 1, 0, 0, 0, 1, 1065353216, 1065353216);
			iLocal_35[iParam0] = _add_rope_2(*vLocal_81[iParam0], 0f, 0f, 0f, &(fLocal_97[iParam0]), 1, true, -1, -1f);
			freeze_entity_position(&(iLocal_29[iParam0]), false);
			_0x462ff2a432733a44(&(iLocal_35[iParam0]), &(iLocal_41[iParam0]), &(iLocal_47[iParam0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, "p_carcassHangMED_Bone2");
			_0x3c6490d940ff5d0b(&(iLocal_35[iParam0]), 0, 0, &(fLocal_97[iParam0]), 1);
			_0xf092b6030d6fd49c(&(iLocal_35[iParam0]), "ROPE_SETTINGS_DEFAULT");
			_0x7a54d82227a139db(iLocal_35[iParam0], 1);
			_0x76bad9d538bca1aa(&(iLocal_35[iParam0]), 0f);
			_0xb40ea9e0d2e2f7f3(&(iLocal_35[iParam0]), 0.5f);
			_0xdede679ed29dd4e7(&(iLocal_35[iParam0]), 1);
			_0xf1ea2a881eb7f2cd(&(iLocal_35[iParam0]), 1);
			_0x522fa3f490e2f7ac(&(iLocal_35[iParam0]), 1, 1);
			_0x2651ddc0ea269073(&(iLocal_35[iParam0]), 1f);
			set_ped_to_ragdoll(&(iLocal_29[iParam0]), 1000, 60000, 0, false, true, false);
			return 1;
		}
	}
	return 0;
...
int func_99(int iParam0, bool bParam1)
{
	...
	{
		func_140(iParam0, _create_persistent_character(func_139(iParam0)));
		if (func_45() == -1)
		{
...
{
	vVar2 = { 0f, 0f, 0f };
	if (!func_144(iParam0, &uVar0, &uVar1, &vVar2) || func_145(vVar2))
	{
		return 0;
	}
	iVar6 = 4;
	...
	Global_1051439->f_4427[iVar6]->f_6 = func_146(uVar0, vVar2, uVar1, 0, 0, 0);
...
void func_108(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
...
char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_160(Global_1893587->f_162);
	}
...
char* func_123(char* sParam0, int iParam1)
{
	...
	return func_166(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_167(Global_1940018->f_5[iParam0]->f_6, 1);
	func_168(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_97(Global_1915715->f_3[iParam0]->f_21) && func_170(Global_1915715->f_3[iParam0]->f_21))
	{
		func_171(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_172(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_175(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_137(int iParam0, bool bParam1)
{
	...
	else if (func_148(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_175(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_188(iParam0, 2))
	{
...
bool func_144(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
var func_146(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
{
	func_203(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_213(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
bool func_196()
{
	...
	if (!func_198(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
