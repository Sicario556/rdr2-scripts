void __EntryFunction__()
{
	...
	while (func_2())
	{
		func_3(&uLocal_18, &iLocal_19, 3018.27f, 558.1332f, 44.5092f, 2136683606);
		wait(0);
		uLocal_17 = uLocal_17;
	}
...
void func_4(int iParam0)
{
	if (chal_is_goal_active(-663946200, 1055032020))
	{
		...
		{
			case 45:
				chal_add_goal_progress_int_by_score_id(func_8(iParam0, 0), 1);
				break;
		}
	}
	if (is_itemset_valid(iLocal_19))
	{
		destroy_itemset(iLocal_19);
	}
	func_9(iParam0, 4);
	func_9(iParam0, 8);
	if (network_is_game_in_progress())
