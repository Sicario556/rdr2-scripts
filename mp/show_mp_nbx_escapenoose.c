void __EntryFunction__()
{
	...
	Local_2179.f_1 = participant_id_to_int();
	while (!func_3(Local_1602[Local_2179.f_1]))
	{
		if (network_is_host_of_this_script())
		{
...
void func_1(int iParam0)
{
	func_8(32, iParam0);
	func_9();
	network_register_host_broadcast_variables(&uLocal_18, 1584, 8);
	func_10(_0xba24095ea96dfe17(&uLocal_18), 1584, "sHostData");
	network_register_player_broadcast_variables(&Local_1602, 577, 9);
	func_11(_0x690806bc83bc8ca2(Local_1602[0]), 577, "m_showClientStruct");
	func_12(0);
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((4 - get_num_reserved_mission_objects(0)));
				return;
			}
...
bool func_96(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "NOOSE_STAND", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "JACKET", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "DIVIDER", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[3])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Noose", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(iLocal_17))
	{
		...
		{
			iLocal_16 = _add_rope_2(2546.724f, -1309.638f, 50.76665f, 0f, 0f, 0f, 0.3f, 1, false, -1, -1f);
			_0x462ff2a432733a44(iLocal_16, iLocal_17, &(uParam0->f_1393[3]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0);
			_0x522fa3f490e2f7ac(iLocal_16, 1, 1);
		}
		else
		{
			return false;
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > func_162())
			{
...
void func_120(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_164(&((*uParam1)[uParam2->f_1]->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_164(&((*uParam1)[uParam2->f_1]->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_164(&((*uParam1)[uParam2->f_1]->f_17), 34);
			}
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > func_162())
			{
				func_164(&((*uParam1)[uParam2->f_1]->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_164(&((*uParam1)[uParam2->f_1]->f_17), 40);
			break;
		case 40:
			break;
	}
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_176((*uParam0)[iVar0], func_174(iParam2), func_175(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_176(uParam0->f_31[iVar0], func_178(iParam2), func_179(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_176(uParam0->f_107[iVar0], func_181(iParam2), func_182(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_176(uParam0->f_118[0], func_183(iParam2, 0), func_184(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_176(uParam0->f_118[1], func_183(iParam2, 1), func_184(iParam2, 1), 1065353216)) && func_176(uParam0->f_118[2], func_183(iParam2, 2), func_184(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_176(uParam0->f_118[iVar0], func_183(iParam2, 0), func_184(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_200(uParam1->f_118[0], func_198(uParam1), &(uParam1->f_238), func_199(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_202(uParam1->f_118[0], func_201(uParam1), &(uParam1->f_238), func_199(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_200(uParam1->f_118[0], func_198(uParam1), &(uParam1->f_238), 0.5f, func_188(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_202(uParam1->f_118[0], func_201(uParam1), &(uParam1->f_238), 0.5f, func_188(uParam1)))
			{
...
bool func_154(int iParam0, int iParam1, vector3 vParam2)
{
	if (!has_model_loaded(iParam1))
	{
		return false;
	}
	if (!does_entity_exist(*iParam0) && can_register_mission_objects(1))
	{
...
bool func_191(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_224((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_207(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_224((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_213(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_227());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_227());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_227());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_228(get_player_team(iVar5)));
	}
