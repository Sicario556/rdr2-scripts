...
bool func_13()
{
	iLocal_13 = _create_volume_cylinder_with_custom_name(-337.0264f, -358.9087f, 88.0646f, 0f, 0f, 0f, 94.2006f, 77.56374f, 227f, "m_volSwansonStation");
	return true;
}
...
bool func_66(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_98(iParam0));
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_117(func_116(-1532769513, -36357794), 1);
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_150(Global_1915715->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_95(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_126(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_95(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_168(iParam0, 2))
	{
