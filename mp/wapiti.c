void __EntryFunction__()
{
	...
	fLocal_15 = 1f;
	iLocal_53 = 20000;
	iLocal_56 = vScriptParam_0.x;
	iLocal_54 = vScriptParam_0.z;
	bLocal_58 = false;
		...
		if (get_game_timer() > iLocal_55)
		{
			...
			switch (iLocal_54)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_57 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_54 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_57 < get_game_timer())
					{
						bLocal_58 = false;
						iLocal_54 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_56));
					Global_1896620 = -1;
					iLocal_57 = (iLocal_53 + get_game_timer());
					iLocal_54 = 3;
					break;
				case 3:
					if (func_13() || iLocal_57 < get_game_timer())
					{
						func_14(iLocal_56);
						iLocal_57 = (iLocal_53 + get_game_timer());
						iLocal_54 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_56) || iLocal_57 < get_game_timer())
					{
						func_16(iLocal_56);
						iLocal_57 = (get_game_timer() + iLocal_53);
						iLocal_54 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_56) || iLocal_57 < get_game_timer())
					{
						func_18(iLocal_56);
						iLocal_57 = (iLocal_53 + get_game_timer());
						iLocal_54 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_56)))
					{
						if (func_19(func_9(iLocal_56), 4) && !iLocal_57 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_56) || iLocal_57 < get_game_timer())
							{
								func_21(iLocal_56, 4);
								iLocal_57 = (iLocal_53 + get_game_timer());
								iLocal_54 = 8;
							...
							func_36(iLocal_56, Global_1896674);
							iLocal_54 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_56);
							func_21(iLocal_56, 8);
							...
							{
								iLocal_55 = get_game_timer() + 1000;
							}
							func_41(Global_1896674, iLocal_56);
							func_42(iLocal_56);
							func_21(iLocal_56, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_56]->f_11);
							if ((*Global_1887339)[iLocal_56]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_56]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_56]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_56]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[60]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 14);
	_0xb56d41a694e42e86(iLocal_19, 12519, 18432, 0, -1, -1, 2);
	_0x18262cafebb5fbe1(iLocal_19, 12775, 18432, 0, -1, -1, 0);
	_0x2161278c6322f740(12775, 18432, 0, -1, -1, iLocal_19);
	func_53(iLocal_19, 0);
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_56)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_78(iLocal_56, 0), 1);
					break;
			}
		}
		if (func_10(func_71()))
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_63(iParam0) && func_85(iParam0, 16777216)) && !Global_1893587->f_9)
	{
...
void func_116(bool bParam0)
{
	if (bParam0)
	{
		...
		func_140(Global_1940258, 8388608);
	}
	else
	{
		set_wanted_level_multiplier(0f);
		func_111(Global_1940258, 8388608);
	}
...
{
	if (func_89(Global_1915715->f_3[iParam0]->f_21) && func_144(Global_1915715->f_3[iParam0]->f_21))
	{
