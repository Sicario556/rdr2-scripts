...
bool func_13()
{
	iLocal_16 = (*Global_1887339)[62]->f_5;
	iLocal_17 = _create_volume_cylinder(1411.869f, -7032.472f, 71.50774f, 0f, 0f, -25.35288f, 142.4495f, 133.1683f, 45.87774f);
	return true;
}
...
bool func_40(int iParam0)
{
	if (_does_volume_exist(iLocal_17))
	{
		if (func_62(62, 33554432))
		{
			if (!bLocal_18)
			{
				_0xf2a2177ac848b3a8(iLocal_17, 0, 1);
				bLocal_18 = true;
			}
		}
		else if (bLocal_18)
		{
			_0xf2a2177ac848b3a8(iLocal_17, 1, 1);
			bLocal_18 = false;
		}
	}
	return false;
...
bool func_67(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_92(iParam0));
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_100(iParam1, 2) || func_101(iParam4, 2)) && !Global_1893587->f_9)
	{
	...
	else if ((func_60(iParam0) && func_62(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_106(&cVar6, 109029619), sVar9, func_106(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_106(&cVar6, 109029619), func_106(&cVar10, 109029619));
		}
		Global_1893587->f_9 = 0;
	}
	Global_1939161->f_145 = func_107(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_86(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_114(Global_1896620->f_1, 16))
			{
				func_115(Global_1896620->f_1, 0);
			}
			Global_1896620->f_1++;
			iVar2++;
...
char* func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_129(Global_1893587->f_162);
	}
...
char* func_106(char* sParam0, int iParam1)
{
	...
	return func_135(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_136(Global_1940018->f_5[iParam0]->f_6, 1);
	func_137(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_139(Global_1915715->f_3[iParam0]->f_21))
	{
		func_140(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_141(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_144(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_120(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_144(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_158(iParam0, 2))
	{
...
{
	func_166(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_159()
{
	...
	if (!func_161(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
