void __EntryFunction__()
{
	...
	fLocal_84 = 1f;
	iLocal_88 = 20000;
	iLocal_91 = vScriptParam_0.x;
	iLocal_89 = vScriptParam_0.z;
	bLocal_93 = false;
		...
		if (get_game_timer() > iLocal_90)
		{
			...
			switch (iLocal_89)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_92 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_89 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_92 < get_game_timer())
					{
						bLocal_93 = false;
						iLocal_89 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_91));
					Global_1896620 = -1;
					iLocal_92 = (iLocal_88 + get_game_timer());
					iLocal_89 = 3;
					break;
				case 3:
					if (func_13() || iLocal_92 < get_game_timer())
					{
						func_14(iLocal_91);
						iLocal_92 = (iLocal_88 + get_game_timer());
						iLocal_89 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_91) || iLocal_92 < get_game_timer())
					{
						func_16(iLocal_91);
						iLocal_92 = (get_game_timer() + iLocal_88);
						iLocal_89 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_91) || iLocal_92 < get_game_timer())
					{
						func_18(iLocal_91);
						iLocal_92 = (iLocal_88 + get_game_timer());
						iLocal_89 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_91)))
					{
						if (func_19(func_9(iLocal_91), 4) && !iLocal_92 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_91) || iLocal_92 < get_game_timer())
							{
								func_21(iLocal_91, 4);
								iLocal_92 = (iLocal_88 + get_game_timer());
								iLocal_89 = 8;
							...
							func_36(iLocal_91, Global_1896674);
							iLocal_89 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_91);
							func_21(iLocal_91, 8);
							...
							{
								iLocal_90 = get_game_timer() + 1000;
							}
							func_41(Global_1896674, iLocal_91);
							func_42(iLocal_91);
							func_21(iLocal_91, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_91]->f_11);
							if ((*Global_1887339)[iLocal_91]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_91]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_91]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_91]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	...
	{
		iLocal_13 = _create_volume_box(737.3499f, -1127.433f, 46.63308f, 0f, 0f, 26.05479f, 73.07784f, 115.7075f, 16.72532f);
		func_53(iLocal_13);
	}
	if (!_does_volume_exist(Local_15.f_64))
	{
		Local_15.f_64 = _create_volume_cylinder(718.817f, -827.245f, 50.334f, 0f, 0f, 0f, 12f, 12f, 3f);
	}
	if (!_does_volume_exist(iLocal_14) && func_54(0))
	{
		iLocal_14 = _create_volume_box(711.732f, -828.585f, 50.703f, 0f, 0f, 0f, 4.161f, 2.683f, 3.852f);
		if (_does_volume_exist(iLocal_14))
		{
			_0x19c7567d2f2287d6(iLocal_14, 7);
		}
	}
	if (!_does_volume_exist(Local_15.f_65))
	{
		Local_15.f_65 = _create_volume_cylinder(721.465f, -827.139f, 50.334f, 0f, 0f, 0f, 3f, 3f, 3f);
	}
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_91)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_91, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
bool func_66(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_91(iParam0));
}
...
char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_128(Global_1893587->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_130(func_129(Global_35));
	}
...
char* func_105(char* sParam0, int iParam1)
{
	...
	return func_134(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_135(Global_1940018->f_5[iParam0]->f_6, 1);
	func_136(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_138(Global_1915715->f_3[iParam0]->f_21))
	{
		func_139(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_140(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_143(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	bVar0 = (func_151(iParam0) && !bParam1);
	if (!bVar0 && !func_152(iParam0, 65536))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_143(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
...
var func_128(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_165(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
void func_139(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (!func_87(iParam0))
	{
		return;
...
{
	return func_177(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
