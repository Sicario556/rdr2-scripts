void __EntryFunction__()
{
	...
	func_2();
	func_3();
	iLocal_39 = get_game_timer();
	iVar0 = 0;
	while (func_4())
	{
		if (get_game_timer() > iLocal_39)
		{
			iLocal_39 = 0;
			...
			switch (iLocal_38)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_41 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_38 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_41 < get_game_timer())
					{
						bLocal_42 = false;
						iLocal_38 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_40));
					Global_1896620 = -1;
					iLocal_41 = (iLocal_37 + get_game_timer());
					iLocal_38 = 3;
					break;
				case 3:
					if (func_13() || iLocal_41 < get_game_timer())
					{
						func_14(iLocal_40);
						iLocal_41 = (iLocal_37 + get_game_timer());
						iLocal_38 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_40) || iLocal_41 < get_game_timer())
					{
						func_16(iLocal_40);
						iLocal_41 = (get_game_timer() + iLocal_37);
						iLocal_38 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_40) || iLocal_41 < get_game_timer())
					{
						func_18(iLocal_40);
						iLocal_41 = (iLocal_37 + get_game_timer());
						iLocal_38 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_40)))
					{
						if (func_19(func_9(iLocal_40), 4) && !iLocal_41 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_40) || iLocal_41 < get_game_timer())
							{
								func_21(iLocal_40, 4);
								iLocal_41 = (iLocal_37 + get_game_timer());
								iLocal_38 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_40]->f_11);
							if ((*Global_1887339)[iLocal_40]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_40]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_40]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_40]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[98]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 23);
	iLocal_20 = _create_volume_box_with_custom_name(3023.974f, 562.0062f, 46.82927f, 0f, 0f, 79.71242f, 12.599f, 9.960065f, 6.735788f, "Van Horn - m_volFence");
	iLocal_21 = _create_volume_box_with_custom_name(3027.401f, 562.4042f, 44.687f, 0f, 0f, 80f, 1.736885f, 1f, 2f, "Van Horn - m_volFencePrompt");
	_0xb469cfd9e065eb99(iLocal_20, 10087);
	iLocal_22 = _create_volume_aggregate_with_custom_name("Van Horn - m_volPostOfficeOwner");
	_0x39816f6f94f385ad(iLocal_22, 2986.668f, 572.391f, 44.68746f, 0f, 0f, 80f, 6.513f, 5.709f, 2.553f);
	_0x39816f6f94f385ad(iLocal_22, 2985.922f, 568.154f, 44.68746f, 0f, 0f, 80f, 2.17f, 2.622f, 2.553f);
	_0x39816f6f94f385ad(iLocal_22, 2987.423f, 576.661f, 44.68746f, 0f, 0f, 80f, 2.509f, 2.264f, 2.553f);
	_0x39816f6f94f385ad(iLocal_22, 2982.536f, 570.44f, 44.68746f, 0f, 0f, 80f, 2.957f, 1.909f, 2.553f);
	iLocal_23 = _create_volume_aggregate_with_custom_name("Van Horn - m_volPostOfficePrompt Agg");
	_0x39816f6f94f385ad(iLocal_23, 2985.951f, 568.536f, 44.902f, 0f, 0f, 80f, 1.441f, 1.703f, 2.553f);
	_0x39816f6f94f385ad(iLocal_23, 2987.352f, 576.3314f, 44.90187f, 0f, 0f, -99.75122f, 1.441f, 1.921f, 2.55285f);
	iLocal_24 = _create_volume_box_with_custom_name(2986.637f, 572.4257f, 44.90187f, 0f, 0f, 80f, 6.131599f, 5.291456f, 2.55285f, "Van Horn - m_volPostOfficeOfflimits");
	_0xb469cfd9e065eb99(iLocal_22, 10090);
	iLocal_25 = _create_volume_box_with_custom_name(2982.608f, 570.333f, 44.68746f, 0f, 0f, 80f, 3.388f, 2.263f, 2.553f, "Van Horn - m_volPostOfficeMute");
	func_53();
	iLocal_28 = _create_volume_box_with_custom_name(2986.621f, 572.416f, 45.094f, 0f, 0f, 80f, 6.05f, 5.4f, 3f, "Van horn - m_volStationTheft");
	iLocal_29 = _create_volume_box_with_custom_name(2947.408f, 545.9362f, 50.72883f, 0f, 0f, 0f, 17.35913f, 18.45897f, 4.232503f, "Van Horn- Resident Toughts Guard Volume");
	iLocal_32 = _create_volume_aggregate_with_custom_name("Van Horn - m_volHorseShopPen Agg");
	_0x39816f6f94f385ad(iLocal_32, 2979.276f, 779.6296f, 52.62945f, 0f, 0f, 0f, 40.47127f, 19.50671f, 7.453903f);
	_0x39816f6f94f385ad(iLocal_32, 2985.944f, 797.0881f, 52.62945f, 0f, 0f, 0f, 23.67008f, 19.46324f, 7.453903f);
	func_54(259147332, 1);
	if (func_45() != -1)
	{
		iLocal_30 = _create_volume_box_with_custom_name(2966.958f, 798.031f, 51.94672f, 0f, 0f, 0f, 13.5283f, 8.991134f, 3.747737f, "VanHorn Horse Shop - m_volHorseShop");
	}
	else
	{
		iLocal_30 = _create_volume_aggregate_with_custom_name("Vanhorn Horse Shop - m_volHorseShop Agg");
		_0x39816f6f94f385ad(iLocal_30, 2967.159f, 798.5253f, 51.745f, 0f, 0f, 0f, 14.3611f, 10.48136f, 4.225f);
		_0x39816f6f94f385ad(iLocal_30, 2970.102f, 792.5105f, 51.65219f, 0f, 0f, 0f, 8.344481f, 5.59843f, 2.959558f);
		iLocal_31 = _create_volume_box_with_custom_name(2959.127f, 795.8362f, 51.00545f, 0f, 0f, 0f, 4.348893f, 4.095809f, 6.315661f, "Vanhorn Horse Shop - m_volHorseShopOutsideDoor");
		func_55(9, iLocal_31);
	}
	return true;
}
...
{
	func_63(4, iLocal_20, iParam0, iLocal_21, 0, 44, 0, 0, -1082130432, 0);
	func_64(4, -919742804, 0, 0, 0);
	func_64(4, -1653762302, 0, 0, 0);
	func_64(4, 877945562, 0, 0, 0);
	func_65(4, 8192);
	func_66(4, 0);
	func_63(9, iLocal_30, iParam0, 0, 0, 2, 1, 0, -1082130432, 0);
	if (!func_67() && func_68())
	{
	...
	func_65(9, 16777216);
	func_65(9, 67108864);
	func_63(2, iLocal_22, iParam0, iLocal_23, iLocal_24, 1277952, 0, 0, -1082130432, 0);
	func_66(2, 0);
	func_69();
	func_70(94);
}
...
{
	func_77();
	func_78(&uLocal_35, &iLocal_36, 3018.27f, 558.1332f, 44.5092f, 2136683606);
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_81(&Global_1940258, 32768)) || func_81(&Global_1940258, 16777216))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_35))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_84((*uParam0)[iVar3], 1) && func_85(iParam1)) && !func_86(iParam1, 16))
							{
								func_88(iParam1, func_87(), -1, 0, -1, 0);
								func_89((*uParam0)[iVar3], 1);
							}
							func_90(iParam1, 0);
						}
						bVar0 = true;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_40)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_94(iLocal_40, 0), 1);
					break;
			}
		}
		if (func_10(func_87()))
...
void func_53()
{
	iLocal_26 = _create_volume_aggregate_with_custom_name("m_volSaloonInterior");
	_0x39816f6f94f385ad(iLocal_26, 2946.662f, 523.323f, 46.02f, 0f, 0f, 180f, 9.627f, 13.43f, 3.143f);
	_0x39816f6f94f385ad(iLocal_26, 2939.048f, 523.346f, 45.61858f, 0f, 0f, -180f, 6.016271f, 9.883f, 3.143f);
	iLocal_27 = _create_volume_aggregate_with_custom_name("Van horn - m_volSaloonTheft");
	_0x39816f6f94f385ad(iLocal_27, 2946.748f, 523.316f, 45.072f, 0f, 0f, 80f, 10.1f, 14f, 3.347f);
	_0x39816f6f94f385ad(iLocal_27, 2939.048f, 523.346f, 45.61858f, 0f, 0f, -180f, 6.016271f, 9.883f, 3.143f);
}
...
void func_62(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1940018->f_5[iParam0]->f_6 = func_117(iParam5, iParam0);
}
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_122(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_123(Global_1051439->f_72[iParam0]->f_18);
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	Global_1051439->f_72[iParam0]->f_31[iVar0] = func_128(iParam1, 0, 0);
	if (func_129(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
	{
		if (!func_130(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
		{
			func_80(&(Global_1051439->f_72[iParam0]->f_31[iVar0]), 0, iParam2, bParam3, 1, 0, iParam4, 0);
		}
	}
...
{
	func_131(&(Global_1051439->f_72[iParam0]->f_49), iParam1);
}

int func_66(int iParam0, bool bParam1)
{
	if ((func_132(iParam0, 16384) || func_132(iParam0, 32768)) || func_115(Global_1051439->f_72[iParam0]->f_3))
	{
...
void func_70(int iParam0)
{
	...
	if (func_134(&(Global_1051439->f_3634[iVar0]), &uVar1, &uVar2, &vVar3))
	{
		Global_1051439->f_3634[iVar0]->f_6 = func_142(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	iVar6 = func_143(&(Global_1051439->f_3634[iVar0]));
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		...
		{
			Global_1051439->f_3634[iVar0]->f_13 = func_142(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	Global_1051439->f_3634[iVar0]->f_5 = func_123(&(Global_1051439->f_3634[iVar0]));
	if (!func_144(30, 4))
	{
		func_125(30, 4);
		func_126(30);
...
void func_77()
{
	...
	if (is_entity_dead(_0x7fd78dfd0c5d7b9b(iLocal_29)))
	{
		func_150();
	}
}
...
void func_78(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (!*uParam0)
	{
		if (vdist(Global_35, vParam2) > 100f)
		{
			return;
		}
		if (!is_itemset_valid(*iParam1))
		{
			*iParam1 = create_itemset(true);
		}
		_0x20a4bf0e09bee146(*iParam1);
		iVar0 = _0x59b57c4b06531e1e(vParam2, 1f, *iParam1, 3);
		iVar1 = 0;
		while (iVar1 < iVar0)
		{
			iVar2 = _get_entity_from_item(get_indexed_item_in_itemset(iVar1, *iParam1));
			if (does_entity_exist(iVar2))
			{
				if (get_entity_model(iVar2) == iParam5)
				{
					_0xaaacb74442c1bed3(iVar2);
...
void func_80(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
...
bool func_85(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_157(iParam0));
}
...
void func_88(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_171(&cVar6, 109029619), sVar9, func_171(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_171(&cVar6, 109029619), func_171(&cVar10, 109029619));
		}
...
void func_97(int iParam0)
{
	...
	if (_does_volume_exist(iLocal_29))
	{
		_0x998202b206872672(iLocal_29);
		_0x6d5f9e69ba1be783(iLocal_29);
		_delete_volume(iLocal_29);
	}
	...
	if (is_itemset_valid(iLocal_36))
	{
		destroy_itemset(iLocal_36);
	}
	iParam0 = iParam0;
}
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		func_188(iParam0, _create_persistent_character(func_187(iParam0)));
		if (func_45() == -1)
		{
...
{
	func_191(Global_1940018->f_5[iParam0]->f_6, 1);
	func_192(Global_1940018->f_5[iParam0]->f_6, 0);
...
void func_120(bool bParam0, bool bParam1)
{
	...
	if (func_115(get_entity_coords(get_player_ped(player_id()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
void func_121(int iParam0, bool bParam1)
{
	...
	else if (func_144(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_108(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_207(iParam0, 2))
	{
...
void func_136(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_142(uParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_145(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_213(iParam0)))
	{
		return false;
	}
...
void func_150()
{
	...
	_0x4a8fefc43fd8ac9b(iLocal_29, 0, 1);
	_0x53d05d60e5f5b40c(iLocal_29, 0, 1, func_146(440));
	_0x53d05d60e5f5b40c(iLocal_29, 0, 1, func_146(441));
	_0x53d05d60e5f5b40c(iLocal_29, 0, 1, func_146(443));
}
...
char* func_159(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
char* func_171(char* sParam0, int iParam1)
{
	...
	return func_223(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	if (func_112(Global_1915715->f_3[iParam0]->f_21) && func_224(Global_1915715->f_3[iParam0]->f_21))
	{
		func_225(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_226(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_108(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	func_233(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_243(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_245(12, func_244(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
bool func_234(int iParam0, int iParam1)
{
	...
	{
		return func_263(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
