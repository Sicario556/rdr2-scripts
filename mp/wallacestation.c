...
bool func_13()
{
	iLocal_20 = _create_volume_aggregate_with_custom_name("WalStn-m_volPostOfficePrompt Agg");
	_0x39816f6f94f385ad(iLocal_20, -1301.158f, 398.81f, 95.65845f, 0f, 0f, 61.99999f, 1.32f, 1.421f, 3f);
	_0x39816f6f94f385ad(iLocal_20, -1299.192f, 402.038f, 95.658f, 0f, 0f, 61.99999f, 1.537f, 2.022f, 3f);
	iLocal_19 = _create_volume_aggregate_with_custom_name("WalStn-m_volPostOfficeOwner");
	_0x39816f6f94f385ad(iLocal_19, -1301.045f, 400.748f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 5f, 3f);
	_0x39816f6f94f385ad(iLocal_19, -1301.309f, 398.458f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 2.006f, 3f);
	_0x39816f6f94f385ad(iLocal_19, -1298.877f, 402.661f, 95.8015f, 0f, 0f, 61.99999f, 3.035f, 2.644f, 3f);
	_0xb469cfd9e065eb99(iLocal_19, 10047);
	iLocal_21 = _create_volume_aggregate_with_custom_name("WalStn-m_volGeneralShop Agg");
	_0x39816f6f94f385ad(iLocal_21, -1303.001f, 395.221f, 95.824f, 0f, 0f, 62f, 13.808f, 6.791f, 3f);
	_0x39816f6f94f385ad(iLocal_21, -1296.65f, 397.28f, 95.553f, 0f, 0f, 62f, 3.882f, 2.263f, 2.603f);
	iLocal_22 = _create_volume_box_with_custom_name(-1303.289f, 394.199f, 95.824f, 0f, 0f, 62f, 2.042f, 1.5f, 3f, "WalStn-m_volGeneralShopPrompt");
	iLocal_23 = _create_volume_box_with_custom_name(-1301.095f, 393.546f, 95.824f, 0f, 0f, 60f, 3.235947f, 2.050864f, 3f, "WalStn-m_volGeneralShopOff");
	_0xb469cfd9e065eb99(iLocal_21, 10112);
	return true;
}
...
{
	func_58(3, iLocal_21, iParam0, iLocal_22, iLocal_23, 4, 0, 0, -1082130432, 0);
	func_59(3, 96424206, 0, 0, 0);
	func_59(3, 381066979, 0, 0, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_58(2, iLocal_19, iParam0, iLocal_20, 0, 1277952, 0, 0, -1082130432, 0);
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_80(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_73()))
...
void func_59(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	Global_1051439->f_72[iParam0]->f_31[iVar0] = func_106(iParam1, 0, 0);
	if (func_107(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
	{
		if (!func_108(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
		{
			func_109(&(Global_1051439->f_72[iParam0]->f_31[iVar0]), 0, iParam2, bParam3, 1, 0, iParam4, 0);
		}
	}
...
{
	func_110(&(Global_1051439->f_72[iParam0]->f_49), iParam1);
}

int func_61(int iParam0, bool bParam1)
{
	if ((func_111(iParam0, 16384) || func_111(iParam0, 32768)) || func_112(Global_1051439->f_72[iParam0]->f_3))
	{
...
bool func_71(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_124(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_138(&cVar6, 109029619), sVar9, func_138(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_138(&cVar6, 109029619), func_138(&cVar10, 109029619));
		}
...
void func_98(bool bParam0, bool bParam1)
{
	...
	if (func_112(get_entity_coords(get_player_ped(player_id()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
void func_99(int iParam0, bool bParam1)
{
	...
	else if (func_166(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_168(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_171(iParam0, 2))
	{
...
void func_116(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_183(uParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_117(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_184(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_118(iParam0));
}
...
char* func_138(char* sParam0, int iParam1)
{
	...
	return func_195(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_196(Global_1940018->f_5[iParam0]->f_6, 1);
	func_197(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_92(Global_1915715->f_3[iParam0]->f_21) && func_199(Global_1915715->f_3[iParam0]->f_21))
	{
		func_200(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_201(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_168(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	return func_219(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_221(12, func_220(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
{
	func_230(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_209(int iParam0, int iParam1)
{
	...
	{
		return func_239(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
