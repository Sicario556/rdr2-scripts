void __EntryFunction__()
{
	...
	switch (func_1(Var0.f_2, -949239683))
	{
		case -1919515848:
			...
			break;
		case 1443104131:
			iVar190 = _get_item_interaction_from_ped(Global_34);
			switch (iVar190)
			{
				case 1648161053:
	...
	while (!_0x9e4ef615e307fbbe())
	{
		if (!ScriptParam_0.f_3)
		{
			...
			{
				if (has_anim_event_fired(Global_34, 1019710152))
				{
					detach_entity(Var0.f_180, false, true);
					func_2(&Var0, 7966, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (has_anim_event_fired(Global_34, -1188360335))
				{
					detach_entity(Var0.f_180, false, true);
					func_2(&Var0, 37709, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (has_anim_event_fired(Global_34, 1377726152))
				{
					func_2(&Var0, 9650, vVar187, vVar181);
					bVar192 = true;
				}
				else if (has_anim_event_fired(Global_34, -3856156))
				{
			...
			{
				Var0.f_180 = _0x05a0100ea714db68(Global_34, 2120637577);
			}
		}
		if (!ScriptParam_0.f_3)
		{
				...
				else if (!bVar191)
				{
					if (func_8() == -1 && func_9(0))
					{
						if (has_anim_event_fired(Global_34, 108107462))
						{
							...
							{
								if (func_10(Global_34, "Player_Sick_Smoking_Cough", -128067431, 0, 1, 0, 0, 1))
								{
									bVar191 = true;
								}
							}
	...
	if (Var0.f_1 <= 1 && !is_entity_dead(player_ped_id()))
	{
		func_7(&(Var0.f_2), 1);
	}
}
...
void func_2(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5)
{
	...
	attach_entity_to_entity(uParam0->f_180, Global_34, get_ped_bone_index(Global_34, iParam1), vParam2, vParam5, true, true, false, false, 2, true, false, false);
}
...
void func_7(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_11)
	{
		...
		{
			case -943921969:
				fVar1 = func_14(0, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				func_15((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				iVar9 = 1;
				break;
			case -1104847406:
				fVar2 = func_14(2, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				func_16((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), 0);
				bVar8 = true;
				break;
			case 381158954:
				fVar3 = func_14(1, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
			...
			case 1681823811:
				...
				break;
			case -816334026:
				func_20((to_float(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), 1 == uParam0->f_1);
				break;
			default:
				if (bParam1)
				{
					...
					{
						case 2062242710:
							fVar7 = func_21(to_float(uParam0->f_33[iVar0]->f_3), uParam0->f_33[iVar0]->f_4);
...
void func_23(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1879593571:
		case 1934214136:
			func_41(-1196069774, -179343615, 8100);
			break;
	}
}
...
void func_24(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		func_43(func_46(1368284188, -939665347), 1);
	}
	...
	switch (iParam0)
	{
		...
		case -635441454:
		case 1448771675:
			func_43(func_46(1368284188, -2049431929), 1);
			break;
	}
	switch (iParam0)
	{
		case -611782825:
			func_43(func_46(1368284188, -1875859641), 1);
			break;
		case 299161628:
			func_43(func_46(1368284188, 304473406), 1);
			break;
		case -1907044919:
		case 688258043:
			func_43(func_46(1368284188, 894597474), 1);
			break;
		case -541584777:
		case 206762213:
			func_43(func_46(1368284188, 2119695263), 1);
			break;
		case -653299524:
		case -486559882:
		case 376981280:
			func_43(func_46(1368284188, -1791969490), 1);
			break;
		case -324053813:
		case 998010398:
			func_43(func_46(1368284188, -155567636), 1);
			break;
		case -2042563684:
		case -1871448371:
		case -834705084:
		case -623409049:
			func_43(func_46(1368284188, 497247514), 1);
			break;
		case 1929383243:
		case 2036955137:
			func_43(func_46(1368284188, -868741806), 1);
			break;
		case -1635450397:
		case 1831763320:
			func_43(func_46(1368284188, -208442209), 1);
			break;
	}
	if (func_8() == -1)
	{
		...
		{
			func_43(func_46(1368284188, 595572217), 1);
		}
	}
	if (bParam1)
	{
...
{
	Var0 = { func_46(-372368982, func_86(iParam0)) };
	_0x6a0184e904cdf25e(&Var0, iParam1);
	func_43(func_87(106002964), iParam1);
}
...
{
	fVar0 = (func_90(iParam0) - _0xdf66a37936d5f3d9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_58(int iParam0, int iParam1, float fParam2)
{
	...
	_set_attribute_core_value(iParam0, func_100(iParam1), ceil(fParam2));
	return true;
}
...
void func_60(int iParam0, int iParam1, float fParam2)
{
	...
	{
		_0x437c08db4febe2bd(iParam0, func_102(iParam1), fParam2, -1);
	}
}
...
void func_73(int iParam0)
{
	...
	iVar1 = func_28(2);
	func_29(to_float((iParam0 * iVar1)), 0);
}
...
void func_75(int iParam0)
{
	...
	iVar1 = func_32(2);
	func_33(to_float((iParam0 * iVar1)), 0);
}
...
void func_76(int iParam0, bool bParam1)
{
	...
	iVar0 = func_30(2);
	func_31(to_float((iParam0 * iVar0)), 0, bParam1);
}
...
bool func_82(int iParam0)
{
	...
	return &Global_1146212->f_35859.f_919[func_113(iParam0, 1)] == -1;
}
...
int func_83(int iParam0)
{
	...
	iVar0 = func_113(iParam0, 1);
	if (!func_79(&(Global_1146212->f_35859.f_919[iVar0])))
	{
		return 1;
	}
	iVar3 = func_114(&(Global_1146212->f_35859.f_919[iVar0]), 1);
	iVar4 = 0;
		...
		switch (func_115(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212->f_35859.f_11700)
				{
					...
					{
						func_116(iVar1, iParam0, iVar4);
						func_117(Global_1146212->f_35859.f_9503[iVar5]);
						...
						*Global_1146212->f_35859.f_9503[iVar5] = { *Global_1146212->f_35859.f_9503[Global_1146212->f_35859.f_11700] };
						func_117(Global_1146212->f_35859.f_9503[Global_1146212->f_35859.f_11700]);
					}
					else
					{
						iVar5++;
			...
			func_121(Global_1146212->f_35859.f_919[iVar0]);
			return 1;
		}
...
{
	return (_0x592f58bc4d2a2cf3(iParam0, 0) - IntToFloat(func_131(2)));
}

int func_91(int iParam0)
{
	return (shift_right(iParam0, 26) & 31 * func_132(is_bit_set(iParam0, 31), -1, 1)) + 1898;
}
...
int func_116(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_144(*Global_1146212->f_35859.f_3116[iVar0]) && func_145(iParam0, Global_1146212->f_35859.f_3116[iVar0]->f_4))
	{
		vVar1 = { func_146(Global_1146212->f_35859.f_3116[iVar0]->f_4) };
		if (func_147(vVar1))
		{
			if (func_148(vVar1.x, vVar1.y, vVar1.z))
			{
				func_149(Global_1146212->f_35859.f_3116[iVar0]->f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_150(Global_1146212->f_35859.f_3116[iVar0]->f_4);
			}
		}
		else
		{
...
int func_123(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_144(*Global_1146212->f_35859.f_3116[iVar0]);
	if (bVar1 && func_152(Global_1146212->f_35859.f_3116[iVar0]->f_4))
	{
		vVar2 = { func_153(Global_1146212->f_35859.f_3116[iVar0]->f_4) };
	...
	if (func_148(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_149(Global_1146212->f_35859.f_3116[iVar0]->f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_143(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_114(&(Global_1146212->f_35859.f_919[iVar0]), 1);
	...
	while (iVar4 < Global_1146212->f_35859.f_3116[iVar1]->f_16)
	{
		...
		else
		{
			...
			Global_1146212->f_2169[iVar5]->f_201 = (Global_1146212->f_2169[iVar5]->f_201 - func_156(Global_1146212->f_35859.f_3116[iVar1]->f_6[iVar4]));
			func_157(iVar3);
		}
		iVar4++;
	}
...
bool func_148(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212->f_35859.f_3116[iVar1]->f_28)
	{
		...
		else if (!func_165(Global_1146212->f_35859.f_3116[iVar1]->f_17[iVar7]))
		{
		}
		else
		{
	...
	func_167(Global_1146212->f_35859.f_3116[iVar1]->f_2);
	return true;
}
...
void func_157(int iParam0)
{
	...
	iVar0 = func_154(iParam0, 1);
	if (!func_170(&(Global_1146212->f_2169[iVar0])))
	{
		return;
	}
	...
	if (!func_171(Global_1146212->f_2169[iVar0]->f_203))
	{
		return;
	}
	iVar1 = func_172(Global_1146212->f_2169[iVar0]->f_203, 1);
...
void func_160(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50982971:
			...
			_0xc5cb91d65852ed7e(func_175(iParam0));
			break;
		case 1870637439:
			_0xc5cb91d65852ed7e(func_175(iParam0));
			break;
...
int func_163(int iParam0)
{
	...
	{
		iVar64 = func_118(&(Global_1146212->f_35859.f_9503[iVar65]), 1);
		...
		else if (!func_179(&(Global_1146212->f_35859.f_9503[iVar65]), Global_1146212->f_35859.f_9503[iVar65]->f_1))
		{
		}
		else
		{
			Var1 = { func_180(&(Global_1146212->f_35859.f_9503[iVar65])) };
...
void func_166(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50982971:
			...
			animpostfx_play(func_175(iParam0));
			break;
		case 1870637439:
			animpostfx_play(func_175(iParam0));
			break;
		...
		case 482459685:
			...
			iVar3 = get_entity_bone_index_by_name(iVar0, func_182(iParam0, 0));
			func_183(iVar2, 0, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_182(iParam0, 1));
			func_183(iVar2, 1, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_182(iParam0, 2));
			func_183(iVar2, 2, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_182(iParam0, 3));
			func_183(iVar2, 2, 1, iVar3, 0);
			break;
		case -1655894020:
			iVar2 = func_176(iParam0);
...
void func_173()
{
	...
	{
		if (!func_188((*Global_1298536)[&Global_1296859]->f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_179(int iParam0, int iParam1)
{
	...
	if (func_144(*Global_1146212->f_35859.f_3116[iVar0]))
	{
		iVar3 = &Global_1146212->f_35859.f_9286[func_162(iVar2, 1)];
		Var4 = { func_180(iVar3) };
