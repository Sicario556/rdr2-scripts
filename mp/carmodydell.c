...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_61(&Global_1940258, 32768)) || func_61(&Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_74(iLocal_23, 0), 1);
					break;
			}
		}
		if (func_10(func_67()))
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_85(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_83(iParam0) || func_84(iParam0)) || func_87(&Global_1896620))
			{
				func_88(&Global_1896620, 0);
			}
...
void func_60()
{
	...
	iVar0 = get_interior_at_coords(777.0469f, 848.3318f, 117.9097f);
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_82(iParam0, 16777216)) && !Global_1893587->f_9)
	{
...
{
	if (func_86(Global_1915715->f_3[iParam0]->f_21) && func_140(Global_1915715->f_3[iParam0]->f_21))
	{
