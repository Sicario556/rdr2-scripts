...
void func_3()
{
	...
	func_8(iLocal_21);
	iLocal_22 = _create_volume_cylinder_with_custom_name(2930f, 1360f, 75f, 0f, 0f, 0f, 170f, 170f, 75f, "m_volAnnesburg_Restriction");
	func_9(iLocal_22);
	iLocal_23 = _create_volume_cylinder_with_custom_name(2350f, 1370f, 105f, 0f, 0f, 0f, 35f, 35f, 15f, "m_volBeaverHollow_Restriction");
	func_9(iLocal_23);
	iLocal_24 = _create_volume_cylinder_with_custom_name(2590f, 827.5f, 85f, 0f, 0f, 0f, 80f, 80f, 20f, "m_volButchersCreek_Restriction");
	func_9(iLocal_24);
	iLocal_25 = _create_volume_cylinder_with_custom_name(2270f, -95f, 45f, 0f, 0f, 0f, 65f, 65f, 15f, "m_volMacleansHouse_Restriction");
	func_8(iLocal_25);
	iLocal_26 = _create_volume_cylinder_with_custom_name(3085f, 2232.5f, 210f, 0f, 0f, 7f, 130f, 150f, 75f, "m_volRockySeven_Restriction");
	func_10(iLocal_26, 0, 0);
	iLocal_27 = _create_volume_cylinder_with_custom_name(2965f, 475f, 45f, 0f, 0f, 0f, 75f, 75f, 15f, "m_volTallulahJetty_Restriction");
	func_10(iLocal_27, 0, 0);
	iLocal_28 = _create_volume_cylinder_with_custom_name(2518.25f, 2293f, 185.25f, 0f, 0f, 0f, 40f, 40f, 25f, "m_volTeslaLab_Restriction");
	func_10(iLocal_28, 0, 0);
	iLocal_29 = _create_volume_cylinder_with_custom_name(2964f, 780f, 52f, 0f, 0f, 0f, 45f, 35f, 25f, "m_volVanHornHorseShop_Restriction");
...
void func_5()
{
	...
	if (_0xeb98b38ca60742d7(uVar0) && _0xeb98b38ca60742d7(uVar1))
	{
		...
		{
			if (!_is_position_inside_imap_streaming_extents(516817794, Global_35))
			{
				func_12(2024769126);
			}
		}
...
bool func_11(int iParam0)
{
	...
	if (func_17(iVar1))
	{
		if (Global_1071686->f_19648.f_24 && !func_18(iParam0))
		{
			return false;
		}
...
void func_14()
{
	...
	{
		_0x2c87c3e1c7b96ee2(iLocal_30);
		_delete_volume(iLocal_30);
	}
}
