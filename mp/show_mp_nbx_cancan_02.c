...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_peds((5 - get_num_reserved_mission_peds(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
bool func_21(var uParam0)
{
	if (network_is_host_of_this_script())
	{
		...
		if (!_does_anim_scene_exist(_net_to_anim_scene(uParam0->f_1374)))
		{
			uParam0->f_1373 = _create_anim_scene(func_87(), 2, 0, true, true);
...
bool func_25(var uParam0)
{
	if (!uParam0->f_1357 && !uParam0->f_1559)
	{
		...
		if (!func_79(_net_to_anim_scene(uParam0->f_1376), func_92(1), func_82()))
		{
			return false;
		}
	}
...
void func_32(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 0:
			...
			break;
		case 1:
			if (!has_model_loaded(func_103()) || !has_model_loaded(func_104(0)))
			{
				return;
			}
			...
			{
				iVar1 = iVar0;
				uParam0->f_3[iVar0] = create_object(func_104(iVar1), func_108(iVar1), true, true, false, false, true);
				iVar0++;
			}
			func_102(uParam0, 2);
			break;
		case 2:
			...
			{
				uParam0->f_9 = _create_anim_scene(func_109(iParam1), 0, func_110(iParam1, 0), true, true);
				load_anim_scene(uParam0->f_9);
				set_anim_scene_origin(uParam0->f_9, func_111(iParam1), func_112(iParam1), 2);
			}
		...
		case 3:
			...
			break;
		case 4:
			if (!_0x1f0e401031e20146(uParam0->f_9, func_110(iParam1, 1)) || !_0x23e33cb9f4a3f547(uParam0->f_9, func_110(iParam1, 1)))
			{
				return;
			}
			func_102(uParam0, 5);
...
void func_48(var uParam0, var uParam1, var uParam2)
{
	...
	{
		func_129((*uParam1)[uParam2->f_1], 1);
	}
	...
	{
		func_129((*uParam1)[uParam2->f_1], 2);
	}
}
...
void func_49(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_130(uParam0->f_12[iVar0], uParam1->f_3[iVar0]))
			{
				func_131(uParam0->f_12[iVar0], uParam1->f_3[iVar0]);
			}
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	...
	{
		case 0:
			request_model(func_103(), false);
			request_model(func_104(0), false);
			func_135(uParam1, 1);
			break;
		case 1:
			if (*uParam0 > 1)
		...
		case 3:
			...
			{
				set_anim_scene_entity(uParam0->f_9, func_136(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					set_anim_scene_entity(uParam0->f_9, func_137(iParam2, iVar0), &(uParam0->f_3[iVar0]), 0);
					iVar0++;
				}
		...
		case 4:
			...
			{
				if (!_0x1f0e401031e20146(uParam0->f_9, func_110(iParam2, 1)))
				{
					if (!_0x23e33cb9f4a3f547(uParam0->f_9, func_110(iParam2, 1)))
					{
						_0xdf7b5144e25cd3fe(uParam0->f_9, func_110(iParam2, 1));
					}
					else
					{
						_set_anim_scene_playback_list_bool(uParam0->f_9, func_110(iParam2, 1), true);
					}
				}
			}
			if (!_0x1f0e401031e20146(uParam0->f_9, func_110(iParam2, 1)) || !_0x23e33cb9f4a3f547(uParam0->f_9, func_110(iParam2, 1)))
			{
				return;
			}
			func_135(uParam1, 5);
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_160(&((*uParam1)[uParam2->f_1]->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_160(&((*uParam1)[uParam2->f_1]->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_160(&((*uParam1)[uParam2->f_1]->f_17), 34);
			}
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > 0.978f)
			{
				func_160(&((*uParam1)[uParam2->f_1]->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_160(&((*uParam1)[uParam2->f_1]->f_17), 40);
			break;
		case 40:
			break;
	}
...
void func_126(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_156(iParam0))
	{
		...
		if (bParam3)
		{
			func_163(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_132(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_172((*uParam0)[iVar0], func_170(iParam2), func_171(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_172(uParam0->f_31[iVar0], func_174(iParam2), func_175(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_172(uParam0->f_107[iVar0], func_177(iParam2), func_178(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_172(uParam0->f_118[0], func_179(iParam2, 0), func_180(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_172(uParam0->f_118[1], func_179(iParam2, 1), func_180(iParam2, 1), 1065353216)) && func_172(uParam0->f_118[2], func_179(iParam2, 2), func_180(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_172(uParam0->f_118[iVar0], func_179(iParam2, 0), func_180(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_196(uParam1->f_118[0], func_194(uParam1), &(uParam1->f_238), func_195(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_198(uParam1->f_118[0], func_197(uParam1), &(uParam1->f_238), func_195(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_196(uParam1->f_118[0], func_194(uParam1), &(uParam1->f_238), 0.5f, func_184(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_198(uParam1->f_118[0], func_197(uParam1), &(uParam1->f_238), 0.5f, func_184(uParam1)))
			{
...
bool func_152(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
bool func_172(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_185(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	if (!func_34(uParam2))
	{
		func_27(uParam2);
...
bool func_196(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	if (!func_34(uParam2))
	{
		func_27(uParam2);
...
bool func_201(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	iVar0 = iParam0;
	iVar1 = iParam1;
	if (iVar0 > iVar1)
...
var func_209(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_223());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_223());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_223());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_224(get_player_team(iVar5)));
	}
...
bool func_230(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_233(&(Global_1102219->f_4), iVar0, 5);
	}
	if (iParam1 == func_234())
	{
		return func_233(&(Global_1102219->f_4), iVar0, 5);
	...
	{
		return func_233(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
