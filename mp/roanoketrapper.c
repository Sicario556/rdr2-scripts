...
bool func_13()
{
	iLocal_19 = _create_volume_box_with_custom_name(2074.399f, 1001.74f, 112.332f, 0f, 0f, 13.199f, 8.162f, 13.879f, 3.385f, "Roanoke Trapper - m_volTrapper");
	iLocal_20 = _create_volume_cylinder_with_custom_name(2074.658f, 1004.108f, 111.7034f, 0f, 0f, 14.334f, 3.232f, 3.193f, 4.877f, "Roanoke Trapper - m_volTrapperPrompt");
	iLocal_21 = _create_volume_box_with_custom_name(2075.421f, 1000.45f, 113.832f, 0f, 0f, 14.334f, 2.2f, 2.5f, 4.877f, "Roanoke Trapper - m_volTrapperOfflimits");
	return true;
}
