void __EntryFunction__()
{
	...
	func_2();
	func_3();
	iLocal_25 = get_game_timer();
	iVar0 = 0;
	while (func_4())
	{
		if (get_game_timer() > iLocal_25)
		{
			iLocal_25 = 0;
			...
			switch (iLocal_24)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_27 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_24 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_27 < get_game_timer())
					{
						bLocal_28 = false;
						iLocal_24 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_26));
					Global_1896620 = -1;
					iLocal_27 = (iLocal_23 + get_game_timer());
					iLocal_24 = 3;
					break;
				case 3:
					if (func_13() || iLocal_27 < get_game_timer())
					{
						func_14(iLocal_26);
						iLocal_27 = (iLocal_23 + get_game_timer());
						iLocal_24 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_26) || iLocal_27 < get_game_timer())
					{
						func_16(iLocal_26);
						iLocal_27 = (get_game_timer() + iLocal_23);
						iLocal_24 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_26) || iLocal_27 < get_game_timer())
					{
						func_18(iLocal_26);
						iLocal_27 = (iLocal_23 + get_game_timer());
						iLocal_24 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_26)))
					{
						if (func_19(func_9(iLocal_26), 4) && !iLocal_27 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_26) || iLocal_27 < get_game_timer())
							{
								func_21(iLocal_26, 4);
								iLocal_27 = (iLocal_23 + get_game_timer());
								iLocal_24 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_26]->f_11);
							if ((*Global_1887339)[iLocal_26]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_26]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_26]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_26]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_20 = _create_volume_aggregate_with_custom_name("Riggs Stn - m_volPostOfficePrompt Agg");
	_0x39816f6f94f385ad(iLocal_20, -1095.52f, -576.564f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	_0x39816f6f94f385ad(iLocal_20, -1094.093f, -574.7371f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	iLocal_19 = _create_volume_box_with_custom_name(-1094.383f, -575.865f, 82.807f, 0f, 0f, 52.00422f, 4.73f, 5.502f, 2.821f, "Riggs Stn - m_volPostOfficeOwner");
	iLocal_21 = _create_volume_box_with_custom_name(-1093.137f, -576.9941f, 82.84734f, 0f, 0f, 52.00422f, 4.470828f, 2.119287f, 2.820909f, "Riggs Stn - m_volPostOfficeOfflimits");
	_0xb469cfd9e065eb99(iLocal_19, 10025);
	return true;
}
...
{
	func_58(2, iLocal_19, iParam0, iLocal_20, iLocal_21, 1277952, 0, 0, -1082130432, 0);
	func_59(2, 1217836331, 0, 0, 0);
	func_60(2, 0);
}

void func_30(int iParam0)
{
	func_61(795, iLocal_19, 1);
}
...
{
	func_65(28, iLocal_19, &uLocal_22);
	return true;
}

void func_41(var uParam0, int iParam1)
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_66(&Global_1940258, 32768)) || func_66(&Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_79(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_72()))
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_90(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_88(iParam0) || func_89(iParam0)) || func_92(&Global_1896620))
			{
				func_93(&Global_1896620, 0);
			}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_99(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_100(Global_1051439->f_72[iParam0]->f_18);
...
void func_59(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	Global_1051439->f_72[iParam0]->f_31[iVar0] = func_105(iParam1, 0, 0);
	if (func_106(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
	{
		if (!func_107(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
		{
			func_108(&(Global_1051439->f_72[iParam0]->f_31[iVar0]), 0, iParam2, bParam3, 1, 0, iParam4, 0);
		}
	}
...
{
	if ((func_109(iParam0, 16384) || func_109(iParam0, 32768)) || func_110(Global_1051439->f_72[iParam0]->f_3))
	{
	...
	if ((!bParam1 && func_112(iVar0, &uVar1, &uVar2, &vVar3)) || (bParam1 && func_113(iVar0, &uVar1, &uVar2, &vVar3)))
	{
		func_114(iParam0, uVar1, vVar3, uVar2, 0);
...
bool func_68()
{
	return func_66(&Global_1940258, 8192);
}
...
bool func_70(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_122(iParam0));
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_130(iParam1, 2) || func_131(iParam4, 2)) && !Global_1893587->f_9)
	{
	...
	else if ((func_63(iParam0) && func_87(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_136(&cVar6, 109029619), sVar9, func_136(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_136(&cVar6, 109029619), func_136(&cVar10, 109029619));
		}
		Global_1893587->f_9 = 0;
	}
	Global_1939161->f_145 = func_137(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_139(Global_1940258, 16384);
	func_121(func_140(-1532769513, -36357794), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_121(func_140(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_121(func_140(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_121(func_140(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_121(func_140(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_121(func_140(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_121(func_140(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_85(int iParam0, bool bParam1)
{
	...
	if (func_90(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_143(Global_1896620->f_1, 16))
			{
				func_144(Global_1896620->f_1, 0);
			}
			Global_1896620->f_1++;
			iVar2++;
...
int func_93(int iParam0, bool bParam1)
{
	...
	{
		func_150(iParam0, _create_persistent_character(func_149(iParam0)));
		if (func_45() == -1)
		{
...
void func_97(bool bParam0, bool bParam1)
{
	...
	if (func_110(get_entity_coords(get_player_ped(player_id()), false, false)))
	{
		return;
	}
	if (!bParam0)
	...
	else
	{
		...
		func_158(0);
		func_159(&(Global_1102219->f_3849));
		...
		func_160(&(Global_1102219->f_3888));
	...
	func_161(Global_1102219->f_3849, 36);
	func_162(Global_1102219->f_3888, 36);
}

void func_98(int iParam0, bool bParam1)
{
	bVar0 = (func_163(iParam0) && !bParam1);
	if (!bVar0 && !func_109(iParam0, 65536))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_166(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_169(iParam0, 2))
	{
...
int func_100(int iParam0)
{
	...
	{
		Global_1051439->f_4472[iParam0] = func_173(iParam0);
	}
...
bool func_112(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_180(iParam0, "sHash", uParam1, "fHeading", uParam2, "vPos", uParam3);
}

bool func_113(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_180(iParam0, "sClosedHash", uParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}

void func_114(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		get_ground_z_for_3d_coord(vParam2, &(vParam2.f_2), false);
	}
	Global_1051439->f_72[iParam0]->f_6 = func_181(uParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_115(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_182(iParam0)))
	{
		return false;
	}
...
struct<2> func_120(int iParam0)
{
	...
	return func_140(-277276100, iVar0);
}
...
char* func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (!is_string_null_or_empty(&(Global_1893587->f_162)))
	{
		sVar0 = func_187(Global_1893587->f_162);
	}
...
char* func_136(char* sParam0, int iParam1)
{
	...
	return func_193(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_194(Global_1940018->f_5[iParam0]->f_6, 1);
	func_195(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_91(Global_1915715->f_3[iParam0]->f_21) && func_197(Global_1915715->f_3[iParam0]->f_21))
	{
		func_198(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_199(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_166(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	if (func_208(&(Global_1102219->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_215(&(Global_1102219->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_217(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_219(12, func_218(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_175(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_106(iParam0))
	{
...
int func_180(int iParam0, char* sParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	Var0 = func_220();
	Var0.f_2 = -738708473;
...
var func_181(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
{
	func_228(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_207(int iParam0, int iParam1)
{
	...
	{
		return func_237(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_221()
{
	...
	if (!func_223(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
void func_241(var uParam0, int iParam1, var uParam2)
{
	*uParam2 = iParam1;
...
bool func_250(struct<2> Param0, var uParam2)
{
	if (!func_223(Param0))
	{
		return false;
