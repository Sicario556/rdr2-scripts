...
bool func_13()
{
	iLocal_16 = (*Global_1887339)[37]->f_5;
	_0xb469cfd9e065eb99(iLocal_16, 8);
	iLocal_17 = _create_popzone_from_volume(iLocal_16);
	set_popzone_population_set(iLocal_17, -1173148476);
	_0x7e6bc0b94f5928f0(iLocal_17, 19, 19);
	_0x08892122769770d5(iLocal_17, true);
	_0x0f1861101c9a9944(iLocal_17, true);
	return true;
}
...
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
	if (_is_popzone_valid(iLocal_17))
	{
		_delete_script_popzone(iLocal_17);
	}
}
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_146(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_147(Global_1940018->f_5[iParam0]->f_6, 1);
	func_148(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_89(Global_1915715->f_3[iParam0]->f_21) && func_150(Global_1915715->f_3[iParam0]->f_21))
	{
		func_151(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_152(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_155(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_124(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_155(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
...
{
	func_178(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_189(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
