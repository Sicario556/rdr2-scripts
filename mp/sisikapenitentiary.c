		...
		if (get_game_timer() > iLocal_24)
		{
			...
			switch (iLocal_23)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_26 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_23 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_26 < get_game_timer())
					{
						bLocal_27 = false;
						iLocal_23 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_25));
					Global_1896620 = -1;
					iLocal_26 = (iLocal_22 + get_game_timer());
					iLocal_23 = 3;
					break;
				case 3:
					if (func_13() || iLocal_26 < get_game_timer())
					{
						func_14(iLocal_25);
						iLocal_26 = (iLocal_22 + get_game_timer());
						iLocal_23 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_25) || iLocal_26 < get_game_timer())
					{
						func_16(iLocal_25);
						iLocal_26 = (get_game_timer() + iLocal_22);
						iLocal_23 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_25) || iLocal_26 < get_game_timer())
					{
						func_18(iLocal_25);
						iLocal_26 = (iLocal_22 + get_game_timer());
						iLocal_23 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_25)))
					{
						if (func_19(func_9(iLocal_25), 4) && !iLocal_26 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_25) || iLocal_26 < get_game_timer())
							{
								func_21(iLocal_25, 4);
								iLocal_26 = (iLocal_22 + get_game_timer());
								iLocal_23 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_25]->f_11);
							if ((*Global_1887339)[iLocal_25]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_25]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_25]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_25]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_16 = (*Global_1887339)[33]->f_5;
...
bool func_40(int iParam0)
{
	...
	if (bVar0 && func_65(255))
	{
		if (bVar1)
		{
			func_66(player_ped_id(), -10959621, 0, 0);
		}
		else
		{
			func_67(5, 0);
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_68(&Global_1940258, 32768)) || func_68(&Global_1940258, 16777216))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_35))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_71((*uParam0)[iVar3], 1) && func_72(iParam1)) && !func_73(iParam1, 16))
							{
								func_75(iParam1, func_74(), -1, 0, -1, 0);
								func_76((*uParam0)[iVar3], 1);
							}
							func_77(iParam1, 0);
						}
						bVar0 = true;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_81(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_74()))
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_92(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_90(iParam0) || func_91(iParam0)) || func_94(&Global_1896620))
			{
				func_95(&Global_1896620, 0);
			}
...
void func_66(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!is_entity_dead(Global_1296859->f_8))
	{
		...
		func_101(&Var0, &(Global_1102219->f_3599));
...
bool func_70()
{
	return func_68(&Global_1940258, 8192);
}
...
bool func_72(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_108(iParam0));
}
...
void func_75(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_116(iParam1, 2) || func_117(iParam4, 2)) && !Global_1893587->f_9)
	{
	...
	else if ((func_59(iParam0) && func_89(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_122(&cVar6, 109029619), sVar9, func_122(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_122(&cVar6, 109029619), func_122(&cVar10, 109029619));
		}
		Global_1893587->f_9 = 0;
	}
	Global_1939161->f_145 = func_123(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_87(int iParam0, bool bParam1)
{
	...
	if (func_92(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_130(Global_1896620->f_1, 16))
			{
				func_131(Global_1896620->f_1, 0);
			}
			Global_1896620->f_1++;
			iVar2++;
...
bool func_102(var uParam0, var uParam1)
{
	...
	else
	{
		...
		if (func_146(uVar0, iVar2, uParam0, uParam1))
		{
			return true;
		}
	}
...
{
	if (func_147(&(Global_1102219->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_154(&(Global_1102219->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_107(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8)
{
	vVar0 = { get_entity_coords(player_ped_id(), false, false) };
	iVar3 = iParam3;
	if (!func_155(Global_1296859->f_17, &vVar0, &iVar3))
	{
		vVar0 = { get_entity_coords(player_ped_id(), false, false) };
		iVar3 = iParam3;
	}
	func_156(vParam0, iParam3, vVar0, iVar3, iParam4, iParam5, iParam6, iParam7, fParam8, 1);
}
...
{
	if (func_93(Global_1915715->f_3[iParam0]->f_21) && func_170(Global_1915715->f_3[iParam0]->f_21))
	{
...
void func_136(int iParam0, bool bParam1)
{
	...
	else if (func_185(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	if (func_185(iParam0, 16384) && !bVar0)
	{
...
bool func_142(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_190(&(Global_1102219->f_4), iVar0, 5);
	}
	if (iParam1 == func_191())
	{
		return func_190(&(Global_1102219->f_4), iVar0, 5);
	...
	{
		return func_190(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_143(var uParam0, var uParam1)
{
	...
	else if (!func_195(&(uParam1->f_18), &(uParam1->f_24)))
	{
	}
	...
	else if (!func_195(&(uParam1->f_6), &(uParam1->f_12)))
	{
	}
	if (bVar0)
	{
...
bool func_146(var uParam0, int iParam1, var uParam2, int iParam3)
{
	Var0 = Global_1071686->f_23887.f_366.f_4085;
	Var0.f_2 = 160165798;
	Var0.f_3 = uParam0;
...
bool func_155(vector3 vParam0, var uParam3, int iParam4)
{
	uVar0 = &Global_1071686->f_23887.f_366[func_199(vParam0)];
	iVar1 = func_145(uVar0);
	if (iVar1 <= 0)
	{
		return false;
	...
	{
		iVar2 = get_random_int_in_range(0, iVar1);
		if (func_146(uVar0, iVar2, uParam3, iParam4))
		{
			return true;
		}
	}
...
void func_156(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, float fParam9, bool bParam10, int iParam11, float fParam12, int iParam13)
{
	if (func_148(255) == 4)
	{
		return;
...
{
	func_208(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_98(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
bool func_195(var uParam0, var uParam1)
{
	...
	{
		case 3:
			return func_194(_get_rider_of_mount(uParam0->f_2, false), uParam1);
		case 4:
			return func_194(get_ped_in_vehicle_seat(uParam0->f_1, -1), uParam1);
		default:
			break;
	}
	return false;
...
bool func_201()
{
	...
	if (!func_203(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_205(vector3 vParam0, int iParam3)
{
