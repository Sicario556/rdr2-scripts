...
void func_6(int iParam0)
{
	...
	iLocal_20 = _create_anim_scene(func_53(), 8, func_54(), false, true);
...
bool func_40(int iParam0)
{
	...
	{
		case 0:
			if ((((has_model_loaded(1282171014) && _0x5e420ff293ee5472()) && _does_anim_scene_exist(iLocal_20)) && _is_anim_scene_loaded(iLocal_20, true, false)) && !func_62())
			{
				iLocal_21 = 1;
			}
			break;
		...
		case 4:
			func_69();
			_0xdf7b5144e25cd3fe(iLocal_20, func_54());
			iLocal_21 = 5;
			break;
		case 5:
			if ((_does_anim_scene_exist(iLocal_20) && _is_anim_scene_loaded(iLocal_20, true, false)) && _0x23e33cb9f4a3f547(iLocal_20, func_54()))
			{
				_set_anim_scene_playback_list_bool(iLocal_20, func_54(), true);
				start_anim_scene(iLocal_20);
				iLocal_21 = 6;
			}
			break;
		case 6:
			if (_is_anim_scene_finished(iLocal_20, false))
			{
				func_70();
				func_71();
				iLocal_21 = 7;
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_72(&Global_1940258, 32768)) || func_72(&Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_84(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
...
int func_63()
{
	if (((((func_102(uLocal_13[0], 1282171014, &uVar0, func_100(0), func_101(0)) && func_102(uLocal_13[1], 1282171014, &uVar0, func_100(1), func_101(1))) && func_102(uLocal_13[2], 1282171014, &uVar0, func_100(2), func_101(2))) && func_102(uLocal_13[3], 1282171014, &uVar0, func_100(3), func_101(3))) && func_102(uLocal_13[4], 1282171014, &uVar0, func_100(4), func_101(4))) && func_102(uLocal_13[5], 1282171014, &uVar0, func_100(5), func_101(5)))
	{
		return 1;
	}
	return 0;
...
void func_69()
{
	if (!_does_anim_scene_exist(iLocal_20))
	{
		return;
	}
	if (!_is_anim_scene_loaded(iLocal_20, true, false))
	{
		return;
	}
	iVar0 = 0;
	while (iVar0 < 6)
	{
		if (does_entity_exist(&(uLocal_13[iVar0])) && !is_entity_dead(&(uLocal_13[iVar0])))
		{
			sVar1 = func_108(iVar0);
			if (!is_string_null_or_empty(sVar1) && _0x6f1f0b17109309da(iLocal_20, sVar1))
			{
				set_anim_scene_entity(iLocal_20, sVar1, &(uLocal_13[iVar0]), 0);
			}
		}
		iVar0++;
	}
...
void func_71()
{
	set_entity_visible(&(uLocal_13[0]), true);
	set_entity_visible(&(uLocal_13[1]), true);
	set_entity_visible(&(uLocal_13[2]), true);
	set_entity_visible(&(uLocal_13[3]), true);
	set_entity_visible(&(uLocal_13[4]), true);
	set_entity_visible(&(uLocal_13[5]), true);
}
...
{
	iParam0 = iParam0;
	delete_ped(uLocal_13[0]);
	delete_ped(uLocal_13[1]);
	delete_ped(uLocal_13[2]);
	delete_ped(uLocal_13[3]);
	delete_ped(uLocal_13[4]);
	delete_ped(uLocal_13[5]);
	set_model_as_no_longer_needed(1282171014);
	_0x7d4e70a67a651c71(6);
	_delete_anim_scene(iLocal_20);
}
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_160(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_161(Global_1940018->f_5[iParam0]->f_6, 1);
	func_162(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_96(Global_1915715->f_3[iParam0]->f_21) && func_164(Global_1915715->f_3[iParam0]->f_21))
	{
		func_165(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_166(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_169(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_138(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_169(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_183(iParam0, 2))
	{
...
{
	func_192(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_204(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
