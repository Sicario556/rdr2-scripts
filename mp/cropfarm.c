...
bool func_13()
{
	iLocal_13 = _create_volume_cylinder_with_custom_name(1134.233f, 447.732f, 77.166f, 0f, 0f, 0f, 75f, 75f, 75f, "Guthrie Farm - m_volTown");
	if (!network_is_game_in_progress())
	{
		iLocal_17 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherThreat Agg");
		_0x39816f6f94f385ad(iLocal_17, 1119.103f, 491.625f, 94.789f, 0f, 0f, 40.29281f, 4.983408f, 12.47093f, 20f);
		_0x39816f6f94f385ad(iLocal_17, 1116.402f, 489.3356f, 94.789f, 0f, 0f, 40.29281f, 11.85608f, 5.358582f, 20f);
		_0x39816f6f94f385ad(iLocal_17, 1178.083f, 428.8635f, 93.85277f, 0f, 0f, 53.30451f, 6.700057f, 7.386477f, 11.96838f);
		_0x39816f6f94f385ad(iLocal_17, 1122.726f, 433.0324f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		_0x39816f6f94f385ad(iLocal_17, 1117.072f, 440.526f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		_0x39816f6f94f385ad(iLocal_17, 1111.182f, 447.2959f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		iLocal_16 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_16, iLocal_17);
		_0x39816f6f94f385ad(iLocal_16, 1158.519f, 410.6769f, 92.74591f, 0f, 0f, -42.87345f, 53.38902f, 36.78405f, 32.92925f);
		_0x39816f6f94f385ad(iLocal_16, 1183.084f, 409.2454f, 94.789f, 0f, 0f, 62.77261f, 47.98455f, 17.14376f, 15.40531f);
		_0x39816f6f94f385ad(iLocal_16, 1155.914f, 449.3743f, 96.1861f, 0f, 0f, 47.14103f, 50.95671f, 69.55695f, 12.92893f);
		_0xbce668aaf83608be(iLocal_16, 1195.093f, 434.533f, 81.04297f, 0f, 0f, 0f, 7.797928f, 12.21736f, 21.62953f);
		_0x39816f6f94f385ad(iLocal_16, 1170.392f, 385.8856f, 94.80865f, 0f, 0f, 21.33961f, 15.42121f, 9.785769f, 12.92893f);
		_0xbce668aaf83608be(iLocal_16, 1125.095f, 489.7792f, 81.04297f, 0f, 0f, 0f, 22.93393f, 22.40263f, 21.62953f);
		_0x39816f6f94f385ad(iLocal_16, 1116.016f, 455.3546f, 94.789f, 0f, 0f, 39.8431f, 36.45f, 74.7347f, 15.40531f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_16);
		_0xbce668aaf83608be(iLocal_18, 1125.095f, 466.7386f, 81.04297f, 0f, 0f, 31.95184f, 48.08396f, 52.23304f, 21.62953f);
		_0xbce668aaf83608be(iLocal_18, 1151.546f, 440.5756f, 81.04297f, 0f, 0f, -44.24499f, 55.60196f, 50.99452f, 21.62953f);
		_0xbce668aaf83608be(iLocal_18, 1158.093f, 392.0394f, 81.04297f, 0f, 0f, -24.17386f, 18.53472f, 13.09556f, 21.62953f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Guthrie Farm - m_volRancherRegistration Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_18);
		sLocal_14 = "GUTHRIE_FARM";
		_create_guard_zone(sLocal_14);
		_0x8c598a930f471938(sLocal_14, iLocal_15);
		_0x35815f372d43e1e5(sLocal_14, iLocal_16);
		_0xa1b0e6301e2e02a6(sLocal_14, iLocal_17);
		_0xad3e07c37a7c1adc(sLocal_14, iLocal_18);
		_set_guard_zone_position(sLocal_14, 1117.13f, 490.0274f, 97.598f);
		_0xa8a74aa79fb67159(sLocal_14, iLocal_15);
	}
	return true;
}
...
void func_30(int iParam0)
{
	...
	func_58(739, iLocal_16, 1);
	func_58(740, iLocal_16, 0);
	func_58(742, iLocal_16, 0);
	_0x4a8fefc43fd8ac9b(iLocal_16, 3, 1);
	_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_59(740));
	_0x53d05d60e5f5b40c(iLocal_16, 3, 1, func_59(742));
	_0x931b241409216c1f(func_60(739), func_60(742), 0);
}
...
{
	if (func_90(Global_1915715->f_3[iParam0]->f_21) && func_143(Global_1915715->f_3[iParam0]->f_21))
	{
