...
void func_1(int iParam0)
{
	...
	func_8();
	func_9();
	network_register_host_broadcast_variables(&Local_0, 13, 42);
	func_10(_0xba24095ea96dfe17(&Local_0), 13, "m_hostData");
	network_register_player_broadcast_variables(&vLocal_13, 97, 43);
	func_11(_0x690806bc83bc8ca2(vLocal_13[0]), 97, "m_clientData");
	func_12(0);
...
{
	iVar0 = 255;
	_copy_memory(&Local_110, iParam0, 5);
...
void func_41()
{
	iVar0 = Global_1198046->f_231.f_1066[Local_110.f_12]->f_5;
	...
	Local_0.f_6 = func_109(_0x4be6c13a45cca8ec(_0x901e0dc25080c8b9(iVar0)));
	func_110(256);
...
void func_42()
{
	...
	{
		clear_area(Local_110.f_15, Var0.f_10, 2442122);
		func_108(2);
	}
	else if (bVar31)
	{
...
void func_47()
{
	...
	if (func_118(512))
	{
		if (func_61(64) && func_109(player_id()) == Local_0.f_6)
		{
			func_62(Local_0.f_6);
			func_130(64);
		}
	...
	{
		if (func_109(player_id()) == Local_0.f_6)
		{
			func_131(Local_0.f_6, 1, 1);
			func_132(64);
		}
	}
	else if (func_109(player_id()) != Local_0.f_6)
	{
		func_62(Local_0.f_6);
		func_130(64);
	}
...
bool func_56()
{
	return (func_118(4) || (network_is_game_in_progress() && network_get_num_participants() <= 1));
}
...
void func_58()
{
	...
	if (_does_volume_exist(Local_110.f_32.f_11))
	{
		_delete_volume(Local_110.f_32.f_11);
	}
}
...
void func_63()
{
	...
	while (iVar1 <= 0)
	{
		if ((bVar0 && network_does_network_id_exist(&(Local_0.f_7.f_1[iVar1]))) && network_has_control_of_network_id(&(Local_0.f_7.f_1[iVar1])))
		{
			iVar2 = net_to_ent(&(Local_0.f_7.f_1[iVar1]));
	...
	{
		func_164(iVar3);
		if ((bVar0 && network_does_network_id_exist(&(Local_0.f_7.f_3[iVar3]))) && network_has_control_of_network_id(&(Local_0.f_7.f_3[iVar3])))
		{
			if (Local_110.f_19 == 0)
			{
				if (func_165() == 0)
				{
					func_166(net_to_ped(&(Local_0.f_7.f_3[iVar3])), 0, 0);
				}
				else
				{
					_task_smart_flee_style_ped(net_to_ped(&(Local_0.f_7.f_3[iVar3])), get_player_ped(player_id()), 4, 0, -1082130432, -1, 0);
					set_ped_keep_task(net_to_ped(&(Local_0.f_7.f_3[iVar3])), true);
				}
			}
			if (is_ped_in_writhe(net_to_ped(&(Local_0.f_7.f_3[iVar3]))) && _0x12eb4e31f092c9b3(net_to_ped(&(Local_0.f_7.f_3[iVar3]))))
			{
				_0x925a160133003ac6(net_to_ped(&(Local_0.f_7.f_3[iVar3])), 0);
			}
			iVar4 = net_to_ent(&(Local_0.f_7.f_3[iVar3]));
...
bool func_111(int iParam0)
{
	...
	return (func_198(iParam0) && (*Global_1131196)[iParam0]->f_18.f_1 != 0);
}
...
bool func_113(struct<31> Param0, var uParam31)
{
	...
	{
		if (_0x397769175a7dbb30(Local_110.f_15, Param0.f_10, 0, 0, 0))
		{
			_0xfa15c9a320e707b0();
			*uParam31 = 1;
			return false;
...
bool func_117(int iParam0, int iParam1)
{
	...
	return func_162(&(vLocal_13[iParam1]), iParam0);
}
...
bool func_121()
{
	...
	while (iVar2 <= 0)
	{
		if (!network_does_network_id_exist(&(Local_0.f_7.f_3[iVar2])))
		{
...
{
	if (func_162(&(vLocal_13[participant_id_to_int()]), iParam0))
	{
		func_213(vLocal_13[participant_id_to_int()], iParam0);
	}
}
...
void func_134(int iParam0)
{
	...
	{
		func_197(vLocal_13[participant_id_to_int()], iParam0);
	}
}
...
void func_146()
{
	func_223(50f, 20f, 1, 1077936128, 0);
	func_224(1065353216, 1065353216);
	iVar0 = 0;
	while (iVar0 <= 0)
	{
		if (network_does_network_id_exist(&(Local_0.f_7.f_3[iVar0])))
		{
			Local_110.f_19.f_4[iVar0]->f_1 = net_to_ped(&(Local_0.f_7.f_3[iVar0]));
			if (!is_entity_dead(Local_110.f_19.f_4[iVar0]->f_1))
			{
				...
				if (network_has_control_of_entity(iVar1))
				{
					switch (iVar0)
					{
						case 0:
							...
							_set_ped_damage(iVar1, 1);
							_set_ped_damaged(iVar1, true);
							_set_ped_quality(iVar1, 2);
							set_ped_config_flag(iVar1, 297, true);
							if (func_165() == 0)
							{
								_0xdfce8ce9f3ebe93f(iVar1);
							}
							_set_ped_body_component(iVar1, func_226());
							_set_ped_body_component(iVar1, func_227());
...
void func_149()
{
	...
	{
		fVar0 = vdist(get_entity_coords(player_ped_id(), false, false), Local_110.f_15);
		if (fVar0 < 200f)
		{
			func_134(4096);
		}
...
void func_154()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_110.f_5 = (Local_110.f_5 || vLocal_13[iVar0]) // PointerArith;
			Local_110.f_6 = (Local_110.f_6 && vLocal_13[iVar0]) // PointerArith;
		}
		iVar0++;
	}
}
...
{
	if (!does_blip_exist(&(Local_110.f_19.f_4[iParam0])))
	{
		return;
	}
	remove_blip(Local_110.f_19.f_4[iParam0]);
}
...
void func_222(struct<2> Param0)
{
	...
	else if (!_0x01f4d242765c6b24(func_244(Param0)))
	{
		_0x99230691875fc218(func_242(Param0), func_244(Param0), Global_35);
	}
}
...
{
	return Local_110.f_19.f_4[iParam0]->f_1;
}
...
bool func_229(int iParam0, int iParam1)
{
	...
	Var0 = { func_280(iParam0, 1178968787) };
...
void func_232()
{
	...
	if (func_162(vLocal_13[iVar1]->f_2, 1))
	{
	...
	fVar3 = vdist(get_entity_coords(iVar2, true, false), Local_110.f_15);
	...
	if (fVar3 <= fVar4)
	{
		func_197(&(vLocal_13[iVar1]->f_2), 1);
	}
	else if (_does_volume_exist(Local_110.f_32.f_11) && is_entity_in_volume(iVar2, Local_110.f_32.f_11, false, 0))
	{
		func_197(&(vLocal_13[iVar1]->f_2), 1);
	}
	else if (Local_110.f_32 > 0)
	{
		...
		while (iVar10 < 1)
		{
			func_285(Local_110.f_32.f_13[iVar10], fVar5, 1082130432, 0, 0, 0, 0, 1);
			iVar10++;
		}
...
{
	bVar0 = true;
	if (bVar0 && !_unlock_is_unlocked(Local_110.f_14))
	{
		return false;
	}
	if (func_287())
...
void func_234()
{
	...
	while (iVar0 < 32)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_110.f_19.f_11 = (Local_110.f_19.f_11 && vLocal_13[iVar0]->f_1);
			Local_110.f_19.f_12 = (Local_110.f_19.f_12 || vLocal_13[iVar0]->f_1);
		}
		if (network_is_host_of_this_script())
		{
			if (func_289(512, iVar0) && !func_290(1))
			{
				...
				Var1.f_10 = network_get_player_index(int_to_participantindex(iVar0));
				Var1.f_11 = get_random_int_in_range(0, 6);
				func_292(&Var1);
				func_293(1, 1);
			}
		}
...
void func_236()
{
	...
	if (!func_272(512))
	{
		iVar0 = Local_110.f_19.f_4[0]->f_1;
		if (does_entity_exist(iVar0) && is_entity_dead(iVar0))
		{
			if (func_294(iVar0, get_player_ped(player_id()), 0, 1) < 1.25f)
			{
				func_295(512);
			}
		}
...
void func_237()
{
	if (!func_272(1) && has_collision_loaded_around_entity(Local_110.f_19.f_4[0]->f_1))
	{
		if (func_296())
		{
			if (network_has_control_of_entity(Local_110.f_19.f_4[0]->f_1))
			{
				if (func_165() == 1)
				{
					task_follow_nav_mesh_to_coord(Local_110.f_19.f_4[0]->f_1, func_297(), 2f, 20000, 0.25f, 0, 40000f);
					_0x735662994e60a710(Local_110.f_19.f_4[0]->f_1, 1);
				}
				else if (!func_298(Local_110.f_19.f_4[0]->f_1, -916659666))
				{
					task_animal_writhe(Local_110.f_19.f_4[0]->f_1, 0, 0);
				}
				func_295(1);
				Var0 = { func_291(651783971) };
				func_292(&Var0);
			}
		}
		else if (network_has_control_of_entity(Local_110.f_19.f_4[0]->f_1))
		{
			if (is_ped_in_writhe(Local_110.f_19.f_4[0]->f_1))
			{
				if (!_0x12eb4e31f092c9b3(Local_110.f_19.f_4[0]->f_1))
				{
					_0x925a160133003ac6(Local_110.f_19.f_4[0]->f_1, 1);
				}
			}
			else if (func_165() == 0 && !func_298(Local_110.f_19.f_4[0]->f_1, -916659666))
			{
				task_animal_writhe(Local_110.f_19.f_4[0]->f_1, 0, 1);
			}
		}
	}
}
...
void func_238()
{
	...
	iVar1 = Local_110.f_19.f_4[0]->f_1;
	...
	if (_0x4642182a298187d0(iVar0, 9, &iVar2, 4, 2) == 3)
	{
	...
	else if (!func_303(iVar1))
	{
		if (func_272(4))
		{
			...
			{
				if (_get_ped_remaining_revival_time(iVar1, false) <= 0f && is_entity_dead(iVar1))
				{
					if (func_294(iVar1, get_player_ped(player_id()), 1, 0) < 10f && !func_304(2))
					{
						if (!func_287())
						{
							func_305(457103096, 1, 0);
						}
						func_306();
						func_307(2);
					}
		...
		else
		{
			if (func_165() != 0)
			{
				if (network_has_control_of_entity(iVar1))
				{
					if (!func_272(8))
					{
						_0x735662994e60a710(iVar1, 0);
						_0x30a768c30d385ec5(iVar1, 0, 1, -2002235300, 0, 0);
						func_295(8);
					}
					set_ped_max_move_blend_ratio(iVar1, func_308());
				}
			}
...
void func_239()
{
	...
	if (func_299(&(Local_110.f_19.f_8), 10f))
	{
		if (func_294(get_player_ped(player_id()), iVar0, 1, 1) < 125f)
		{
	...
	if (!func_272(2))
	{
		if (func_165() == 1 && !func_272(256))
		{
			if (network_has_control_of_entity(iVar0))
			{
				...
				{
					task_animal_writhe(iVar0, 0, 0);
					func_295(256);
				}
			}
		}
		if ((!is_entity_occluded(iVar0) && func_294(get_player_ped(player_id()), iVar0, 1, 1) < 30f) || func_303(iVar0))
		{
			func_310();
		}
		if (func_228())
		{
			if (network_has_control_of_entity(iVar0))
			{
				if ((func_165() == 1 && !func_272(256)) && get_script_task_status(iVar0, 713668775, true) != 1)
				{
					task_animal_writhe(iVar0, 0, 0);
					func_295(256);
				}
				_0x925a160133003ac6(iVar0, 0);
				func_295(2);
			}
		}
		else if (network_has_control_of_entity(iVar0))
		{
			...
			{
				if (!_0x12eb4e31f092c9b3(iVar0))
				{
					_0x925a160133003ac6(iVar0, 1);
				}
			}
		}
	}
...
void func_240()
{
	if ((!func_304(8) && func_299(&(Local_110.f_19.f_8), 5f)) && func_294(get_player_ped(player_id()), Local_110.f_19.f_4[0]->f_1, 1, 1) < 20f)
	{
		if (!func_311(2, 1))
		{
			sVar0 = func_312();
...
void func_241()
{
	if (func_304(1))
	{
		if (!func_304(4))
		{
			if (!_0x98082246107a6acf(Local_110.f_19.f_4[0]->f_1, func_227()))
			{
				func_307(4);
			}
		}
		if (!func_314(get_player_ped(player_id())) && func_315(Local_110.f_19.f_4[0]->f_1))
		{
			func_316(1);
			func_295(128);
		}
...
void func_278(int iParam0)
{
	...
	{
		case 1667262090:
			if (func_294(Local_110.f_19.f_4[0]->f_1, get_player_ped(player_id()), 1, 0) < 25f)
			{
				func_306();
				func_325(1);
				func_326(2, 1);
			}
			iVar2 = _0x901e0dc25080c8b9(iParam0->f_10);
			iVar3 = _0x901e0dc25080c8b9(player_id());
			if ((((_0xd6f6acf4392187fb(iVar2) && _0x93a91a351a07360e(iVar2)) && _0xd6f6acf4392187fb(iVar3)) && _0x93a91a351a07360e(iVar3)) && !func_287())
			{
				if (iVar2 == iVar3)
				{
					bVar1 = true;
			...
			if (iParam0->f_10 == player_id() || bVar1)
			{
			...
			if (does_entity_exist(iVar0))
			{
				if (network_has_control_of_entity(iVar0))
				{
					_0xa2f8b3b5fedfc100(iVar0, func_227());
		...
		case 651783971:
			...
			Var4.f_13 = -1;
			Var4 = 1498498500;
			Var4.f_1 = Local_110.f_19.f_4[0]->f_1;
			Local_110.f_19.f_7 = _0xca1315c33b9a2847(&Var4);
			if (func_294(get_player_ped(player_id()), Local_110.f_19.f_4[0]->f_1, 1, 1) < 125f)
			{
				func_300(1891783641, Local_110.f_19.f_4[0]->f_1, 1);
			}
			func_301(&(Local_110.f_19.f_8));
			break;
	}
...
void func_281(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		vLocal_13[iParam2]->f_2 = (vLocal_13[iParam2]->f_2 || vLocal_13[iParam0]->f_2);
	}
}
...
float func_282()
{
	...
	{
		Local_110.f_32.f_3 = get_game_timer();
		return 0.03125f;
	}
	iVar0 = get_game_timer();
	fVar1 = (to_float((iVar0 - Local_110.f_32.f_3)) * 0.001f);
...
bool func_284(vector3 vParam0, int iParam3)
{
	...
	return func_331(vVar0, vParam0) > func_331(vVar0, get_entity_coords(iParam3, true, false));
}
...
bool func_289(int iParam0, int iParam1)
{
	...
	if (func_162(vLocal_13[iParam1]->f_1, iParam0))
	{
		return true;
	}
	return false;
...
{
	Var0.f_10 = 255;
	_copy_memory(&(Var0.f_4), &Local_110, 5);
	Var0.f_9 = iParam0;
	Var0 = 182;
	Var0.f_1 = player_id();
...
void func_295(int iParam0)
{
	...
	func_197(&(vLocal_13[iVar0]->f_1), iParam0);
}
...
void func_305(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!bParam1)
	{
		if (!&Global_1139381->f_3876.f_2[func_342(iParam0, 1)])
		{
			return;
		}
	}
	(Global_1139381->f_3876.f_2[func_342(iParam0, 1)])->f_2++;
	if (!bParam2)
	{
		return;
	}
...
float func_308()
{
	...
	vVar3 = { func_297() };
	fVar6 = get_distance_between_coords(vVar0, vVar3, true);
	fVar7 = func_309(Local_110.f_19.f_4[0]->f_1, vVar3, 1);
...
void func_327(int iParam0)
{
	...
	{
		iParam0 = get_random_int_in_range(0, 6);
	}
	switch (iParam0)
	{
		case 0:
...
{
	return func_359(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
void func_345(int iParam0, int iParam1)
{
	...
	Var31 = { func_280(iParam0, 1346578557) };
...
{
	if (func_114(Global_1272030[iParam0]))
	{
		return;
	}
	...
	func_115((*Global_1272030)[iParam0]);
	iVar33 = Var2.f_5;
	if (iVar33 != 0)
	{
		Var34 = { func_367(153786159) };
		stat_id_set_int(&Var34, iVar33, true);
		Var34 = { func_367(217123284) };
		stat_id_set_int(&Var34, Global_1296859->f_21, true);
	}
	iVar36 = Var2.f_9;
	if (iVar36 != 0)
	{
		Var37 = { func_367(945205875) };
		stat_id_set_int(&Var37, iVar36, true);
		Var37 = { func_367(890183498) };
...
void func_349(struct<2> Param0)
{
	...
	{
		_0xb2a38826e5886e83(func_244(Param0), Global_265377->f_124517.f_71.f_17);
...
{
	Var0 = { func_280(iParam0, -1797584255) };
...
{
	Var0 = { func_280(iParam1, 896190569) };
	if (!stat_id_get_int(&Var0, &iVar2))
	{
		return false;
	}
...
var func_359(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_373());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_373());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_373());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_374(get_player_team(iVar5)));
	}
...
void func_365(int iParam0)
{
	...
	Var1 = { func_280(iParam0, 1178968787) };
...
bool func_381(int iParam0, int iParam1)
{
	...
	{
		return func_388(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
