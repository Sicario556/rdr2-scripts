	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_23, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_92(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_128(iParam0))
	{
		...
		if (bParam3)
		{
			func_129(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_137(Global_1893587->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_139(func_138(Global_35));
	}
...
{
	func_144(Global_1940018->f_5[iParam0]->f_6, 1);
	func_145(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_147(Global_1915715->f_3[iParam0]->f_21))
	{
		func_148(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_149(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_152(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	bVar0 = (func_160(iParam0) && !bParam1);
	if (!bVar0 && !func_161(iParam0, 65536))
	{
	...
	else if (func_162(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_152(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
...
void func_129(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_128(iParam0))
	{
...
bool func_136(int iParam0, bool bParam1, bool bParam2)
{
	if (Global_1572887->f_13 != -1)
	{
...
var func_137(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_175(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_186(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
bool func_168()
{
	...
	if (!func_170(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_172(vector3 vParam0, int iParam3)
{
