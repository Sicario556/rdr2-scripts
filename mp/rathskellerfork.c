...
bool func_13()
{
	iLocal_13 = _create_volume_cylinder_with_custom_name(-5201.7f, -2134.3f, -13.7f, 0f, 0f, 0f, 116.361f, 111.159f, 70f, "m_volRathskellerFork");
	if (!network_is_game_in_progress())
	{
		iLocal_16 = _create_volume_aggregate_with_custom_name("Rathskeller Fork - m_volRancherInner Agg");
		_0x39816f6f94f385ad(iLocal_16, -5193.958f, -2150.221f, 14.60039f, 0f, 0f, 43.94339f, 30.9764f, 20.35678f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5183.694f, -2097.742f, 14.60039f, 0f, 0f, 44.16594f, 20.21152f, 34.85038f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5158.286f, -2115.092f, 14.60039f, 0f, 0f, 47.64177f, 8.714133f, 1.633199f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5230.49f, -2124.006f, 14.60039f, 0f, 0f, 44.16594f, 15.32629f, 8.306676f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5157.303f, -2119.695f, 14.60039f, 0f, 0f, 44.16594f, 12.39145f, 8.306676f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_16, -5213.393f, -2110.535f, 14.60039f, 0f, 0f, 44.16594f, 34.53635f, 13.98279f, 20.57744f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Rathskeller Fork - m_volRancherWarn Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_16);
		_0x39816f6f94f385ad(iLocal_15, -67.73256f, -399.212f, 72.24845f, 0f, 0f, 52.56716f, 42.4006f, 47.27523f, 14.85572f);
		_0x39816f6f94f385ad(iLocal_15, -5186.615f, -2154.339f, 14.60039f, 0f, 0f, 46.12168f, 36.16204f, 4.894577f, 20.57744f);
		_0x39816f6f94f385ad(iLocal_15, -5194.527f, -2122.047f, 14.60039f, 0f, 0f, 43.94178f, 70.70334f, 56.27375f, 20.57744f);
		...
		_0xad3e07c37a7c1adc(sLocal_14, iLocal_15);
		_set_guard_zone_position(sLocal_14, -5194.81f, -2107.68f, 11.39f);
...
void func_30(int iParam0)
{
	...
	_0x4a8fefc43fd8ac9b(iLocal_15, 2, 1);
	_0x53d05d60e5f5b40c(iLocal_15, 3, 1, func_59(778));
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_76(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
bool func_67(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_94(iParam0));
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_108(&cVar6, 109029619), sVar9, func_108(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_108(&cVar6, 109029619), func_108(&cVar10, 109029619));
		}
...
int func_90(int iParam0, bool bParam1)
{
	...
	{
		func_124(iParam0, _create_persistent_character(func_123(iParam0)));
		if (func_45() == -1)
		{
...
bool func_91(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_127(iParam0)))
	{
		return false;
	}
...
{
	func_138(Global_1940018->f_5[iParam0]->f_6, 1);
	func_139(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_88(Global_1915715->f_3[iParam0]->f_21) && func_141(Global_1915715->f_3[iParam0]->f_21))
	{
		func_142(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_143(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_146(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_122(int iParam0, bool bParam1)
{
	...
	else if (func_156(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_146(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
...
{
	func_168(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_179(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
