...
{
	if (_does_thread_exist(iParam0->f_7) && is_thread_active(iParam0->f_7, false))
	{
		_0x7de4643157ad646c(iParam0->f_7);
	}
	if (_does_volume_exist(iParam0->f_6))
	{
		_delete_volume(iParam0->f_6);
	}
	if (!func_11(iParam0->f_1))
	{
		if (func_12(iParam0->f_15))
		{
			_0x2f901291ef177b02(iParam0->f_15, 0);
		}
	}
	if (func_13(iParam0, 2))
	{
		_0x78335e12db0bf961(func_14());
	}
	func_15(iParam0, 0);
	func_16(iParam0);
	func_17(iParam0->f_2);
...
void func_9(int iParam0)
{
	...
	add_relationship_group(&cVar0, &(iParam0->f_14));
...
{
	if (_0x3eecaadab0d9fe29() == func_63(iParam0))
	{
		_0x18a0d48df9211c07();
	}
}
...
void func_18(int iParam0, int iParam1)
{
	if (iParam0->f_79 != iParam1)
	{
		...
		if (iParam0->f_79 == -1)
		{
			if (decor_exist_on(iVar0, "iMinigameHash"))
			{
				decor_remove(iVar0, "iMinigameHash");
			}
			if (decor_exist_on(iVar0, "iMinigameSeat"))
			{
				decor_remove(iVar0, "iMinigameSeat");
			}
		}
		else
		{
			if (!decor_is_registered_as_type("iMinigameHash", 3))
			{
				return;
			}
			if (!decor_is_registered_as_type("iMinigameSeat", 3))
			{
				return;
			}
			decor_set_int(iVar0, "iMinigameHash", iParam0->f_1);
			decor_set_int(iVar0, "iMinigameSeat", iParam1);
		}
	}
}
...
{
	return Global_1138962->f_1[iParam0]->f_4;
}
...
void func_31(struct<2> Param0, bool bParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if ((func_71(Param0) == 3 || func_71(Param0) == 1) || ((bParam5 && func_71(Param0) == 4) && _0x01f4d242765c6b24(func_72(Param0))))
	{
		if (iParam3 != -1)
		{
...
bool func_34(int iParam0)
{
	...
	else if (!does_entity_exist(Global_34))
	{
		return true;
	}
	else if (vdist(Global_35, iParam0->f_3) > 100f)
	{
		if (func_92(255))
		{
			return false;
		...
		if (_0x0b7803f6f7bb43e0())
		{
			return false;
		}
		return true;
	}
	else if (is_player_dead(player_id()) && !func_13(iParam0, 1))
	{
		return true;
	}
...
void func_35(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam0 = iParam1;
	if (bParam2)
	{
		iParam0->f_80 = get_game_timer();
	}
	if (bParam3)
	{
		iParam0->f_81 = get_game_timer();
	}
}
...
void func_36(int iParam0)
{
	...
	{
		fVar0 = vdist(Global_35, iParam0->f_3);
		if (fVar0 < 3f)
		{
		...
		if (fVar0 < 6f)
		{
			set_ped_reset_flag(Global_34, 219, true);
			set_ped_reset_flag(Global_34, 220, true);
			set_ped_reset_flag(Global_34, 187, true);
...
void func_37(int iParam0)
{
	...
	if (_does_text_database_exist(func_96(iParam0->f_2)))
	{
		_text_database_request(func_96(iParam0->f_2));
	}
...
{
	bVar0 = true;
	if (iParam0->f_81 == -1 || (get_game_timer() - iParam0->f_81) > 120000)
	{
		if (iParam0->f_81 == -1)
		{
		}
	...
	else if (_does_text_database_exist(func_96(iParam0->f_2)) && !_text_database_has_loaded(func_96(iParam0->f_2)))
	{
		bVar0 = false;
	}
	if (bVar0)
...
void func_39(int iParam0)
{
	...
	if ((_0x0b7803f6f7bb43e0() && _0xc74eb3f2ec169f6b(-955807603) == 356437857) && _0xc74eb3f2ec169f6b(-769668011) == 3)
	{
		func_35(iParam0, 6, 1, 1);
		return;
	}
	if (!func_93())
	{
		...
		if (((vdist(Global_35, iParam0->f_3) < fVar0 && does_entity_exist(Global_34)) && !is_entity_dead(Global_34)) && !is_ped_dead_or_dying(Global_34, true))
		{
			if (iParam0->f_77 == 0f)
			{
				get_ground_z_for_3d_coord(Global_35, &(iParam0->f_77), false);
			}
			if (func_99(iParam0))
			{
...
void func_40(int iParam0)
{
	...
	{
		fVar0 = func_98(iParam0->f_1);
		if ((((vdist(Global_35, iParam0->f_3) < fVar0 && does_entity_exist(Global_34)) && !is_entity_dead(Global_34)) && !is_ped_dead_or_dying(Global_34, true)) && !func_102())
		{
			if (iParam0->f_77 == 0f)
			{
				get_ground_z_for_3d_coord(Global_35, &(iParam0->f_77), false);
			...
			if (func_105(Global_34, 0, 0, 1) == -1016714371 || func_105(Global_34, 0, 0, 1) == 332793555)
			{
				func_106(0);
			}
			if (func_20(256))
			{
				...
				else
				{
					...
					iParam0->f_16.f_43 = 2;
					iParam0->f_16.f_44[0] = 717564616;
					iParam0->f_16.f_44[1] = 433487458;
			...
			else if (func_20(128))
			{
				...
				else if (_0x424b17a7dc5c90bc(player_id()))
				{
					...
					iVar113 = _0xd1bf325c8252a982(_0x901e0dc25080c8b9(player_id()), &Var62);
					iVar112 = 0;
					while (iVar112 <= (iVar113 - 1))
					{
						iVar115 = network_get_player_from_gamer_handle(Var62[iVar112]);
						if (!_network_is_player_index_valid(iVar115) || is_player_dead(iVar115))
						{
						}
						else
						{
					...
					if (iVar114 > 0)
					{
						...
						iParam0->f_16.f_43 = 1;
						iParam0->f_16.f_44[0] = -767935747;
						func_107(&(iParam0->f_16), 0);
						func_35(iParam0, 4, 1, 1);
					}
					else if (_0x149a2751ab66ac02(_0x901e0dc25080c8b9(player_id())) > func_111(iParam0->f_2))
					{
...
{
	if (_0x07954320d77f6a3d(iParam0->f_16) >= 3)
	{
		...
		if (func_13(iParam0, 4096) || func_13(iParam0, 32768))
		{
			...
			{
				func_114(1);
				_0x00a15b94cba4f76f(iParam0->f_16);
				iParam0->f_16 = 0;
...
void func_44(int iParam0)
{
	...
	{
		if (!_does_thread_exist(iParam0->f_7))
		{
			request_script(func_130(iParam0->f_2));
		}
		if (!func_20(2))
		{
			_0xe546bda1b3e288ee(func_14());
			if (network_is_host() && !func_131(_0x51f33dbc1a41cbfd(), 8))
			{
				return;
			}
		}
...
void func_46(int iParam0)
{
	...
	{
		_minigame_request_seat_at_table(&(iParam0->f_9));
		func_58(iParam0, 8);
	}
	...
	{
		iVar2 = _minigame_get_next_event_type();
		if (iVar2 == -1553724839)
		{
			Var3.f_10 = 6;
			if (_minigame_get_next_event(&Var3, 72))
			{
...
void func_47(int iParam0)
{
	...
	{
		if (!has_script_loaded(func_130(iParam0->f_2)))
		{
			return;
		}
		Var0 = -1;
		...
		Var0.f_32 = -1;
		Var0.f_33 = 255;
		Var0 = { *Global_1138962->f_1[iParam0->f_1] };
		...
		Global_1138962->f_1[iParam0->f_1]->f_12 = iParam0->f_79;
		...
		else
		{
			...
			{
				_0x29fe035d35b8589c(0);
			}
		}
		iParam0->f_7 = start_new_script_with_args(func_130(iParam0->f_2), &Var0, 36, 6500);
		set_script_as_no_longer_needed(func_130(iParam0->f_2));
		func_145(iParam0->f_1);
		func_146(iParam0->f_1, 1);
		clear_area(iParam0->f_3, 2f, 65536);
		if (_does_thread_exist(iParam0->f_7))
		{
			if (func_20(8))
			{
...
void func_48(int iParam0)
{
	...
	{
		if (iParam0->f_80 == -1 || (get_game_timer() - iParam0->f_80) > 1000)
		{
		}
		else
		{
	...
	else if (iParam0->f_81 == -1 || (get_game_timer() - iParam0->f_81) > 120000)
	{
	}
	else
	{
...
void func_49(int iParam0)
{
	...
	else if (!_does_thread_exist(iParam0->f_7))
	{
		func_128(func_127(iParam0->f_1), 10000, 0, 0, 0, 1);
		func_35(iParam0, 16, 1, 1);
	}
	if (func_13(iParam0, 256))
	{
		...
		if (_does_text_database_exist(func_96(iParam0->f_2)) && !_text_database_has_loaded(func_96(iParam0->f_2)))
		{
			bVar0 = false;
		}
		if (!bVar0)
...
void func_50(int iParam0)
{
	...
	{
		if (iParam0->f_80 == -1 || (get_game_timer() - iParam0->f_80) > 333)
		{
			func_15(iParam0, 0);
		}
		else
	...
	if (iVar0 == 0)
	{
		func_157(iParam0->f_1, get_frame_count() + 1);
	}
	else if (get_frame_count() >= iVar0)
	{
...
void func_51(int iParam0)
{
	...
	else if (func_155(iParam0->f_1, 4) && get_frame_count() >= func_158(iParam0->f_1))
	{
		bVar0 = true;
	}
	else if (func_159() == 1)
	...
	if (bVar0)
	{
		if (func_93())
		{
			if (!is_player_control_on(Global_1296859->f_10))
			{
			}
		...
		if (func_160() == iParam0->f_1)
		{
			if (func_144(iParam0->f_1))
			{
				if (_0x273e04a3a7ad1f2d() == 0)
				{
					_0x29fe035d35b8589c(1);
				}
			}
...
void func_54(int iParam0)
{
	...
	else
	{
		if (func_92(255))
		{
			if (func_20(64))
			{
				...
				{
					Var0.f_5 = 2;
					Var0.f_1 = { Global_1138962->f_1[iParam0->f_1]->f_7 };
					Var0.f_16 = 1;
					...
					_0xeb6027fd1b4600d5(5, 1, 0.9f);
					iVar39 = 0;
					while (iVar39 <= 5)
					{
						vVar40 = { func_165(iParam0->f_1, Global_1138962->f_1[iParam0->f_1]->f_12, iVar39, &uVar43) };
						if (!func_119(vVar40))
						{
							_0xfd1ac0b3858f224c(vVar40, uVar43);
						}
						iVar39++;
					}
		...
		if ((func_20(8) && func_20(4)) && vdist(Global_35, iParam0->f_3) <= 100f)
		{
		}
		else
		{
	...
	while (iVar44 < 32)
	{
		if (network_is_player_active(int_to_playerindex(iVar44)))
		{
		}
		func_167(iVar44);
		func_168(iVar44, 0);
...
{
	if (func_57(Global_1071686->f_21416.f_1[network_player_id_to_int()]->f_7, iParam0))
	{
		func_66(&(Global_1071686->f_21416.f_1[network_player_id_to_int()]->f_7), iParam0);
	}
}
...
{
	if (_minigame_is_connected_to_server(func_63(iParam0)))
	{
		return true;
	}
	else if (_0x39654e1f68b78287())
	{
		*bParam1 = 1;
		return false;
	}
...
{
	return Global_1138962->f_1[iParam0]->f_6;
}
...
bool func_99(int iParam0)
{
	...
	if (!func_61(iParam0->f_8) && func_200(iParam0))
	{
		if (!func_12(iParam0->f_15))
		{
			iParam0->f_8 = func_201(_create_var_string(2, "NET_MG_CONTEXT_POKER"), -719620017, iParam0->f_3, fVar0, 1, 0, 0, 4, 570, 4000, 10, 1073741824, 0, 1704213876, 0);
		}
	}
	else
	{
...
{
	*uParam0 = _create_volume_cylinder_with_custom_name(vParam1, vParam4, vParam7, uParam10);
}
	...
	*uParam0 = 0;
	...
	if (!is_string_null_or_empty(&(uParam0->f_7)))
	{
		if (!is_string_null_or_empty(&(uParam0->f_23)))
		{
			if (uParam0->f_39)
			{
				cVar35 = _create_var_string(42, cVar35, func_212(&(uParam0->f_7), 109029619), func_212(&(uParam0->f_23), 109029619), uParam0->f_40);
			}
			else
			{
				cVar35 = _create_var_string(42, cVar35, func_212(&(uParam0->f_7), 109029619), func_212(&(uParam0->f_23), 109029619));
			}
		}
		else if (uParam0->f_39)
		{
			cVar35 = _create_var_string(10, cVar35, func_212(&(uParam0->f_7), 109029619), uParam0->f_40);
		}
		else
		{
			cVar35 = _create_var_string(10, cVar35, func_212(&(uParam0->f_7), 109029619));
		}
	}
	else if (uParam0->f_39)
	{
...
int func_110(int iParam0, int iParam1)
{
	...
	return &((*Global_1056141)[iVar1]->f_466[iVar0]);
}
...
bool func_126(int iParam0, int iParam1, int iParam2, int iParam3, struct<2> Param4, int iParam6, int iParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	else
	{
		if (iParam2 == 2)
		{
			...
			StringCopy(&cVar57, func_212(&(Var65.f_37), 109029619), 64);
		}
		else if (iParam2 == 1)
		{
			StringCopy(&cVar57, _create_var_string(2, func_241(iParam3)), 64);
		}
		else
		{
			StringCopy(&cVar57, _create_var_string(2, func_243(func_242(), iParam3)), 64);
		}
	...
	if ((!_0x424b17a7dc5c90bc(player_id()) && func_244(255, 0)) && !bParam8)
	{
...
char* func_127(int iParam0)
{
	...
	{
		case 2:
			return _create_var_string(10, "MG_FAILED_LAUNCH", "MG_POKER");
		default:
			break;
	}
	return "";
...
bool func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (_0x3ffe60dd8a936551(func_63(iParam0), uVar0))
	{
		return true;
	}
	return false;
...
bool func_139(int iParam0, bool bParam1, int iParam2)
{
	iVar7 = 0;
	iVar7 = 0;
	while (iVar7 <= (get_number_of_events(1) - 1))
	{
		iVar0 = get_event_at_index(1, iVar7);
		switch (iVar0)
		{
			case -1126217932:
				if (get_event_data(1, iVar7, &Var1, 6))
				{
...
{
	return Global_1138962->f_1[iParam0]->f_10;
}
...
{
	uVar0 = &Global_1071686->f_23887.f_366[func_256(vParam0)];
...
int func_178(struct<2> Param0)
{
	...
	while (iVar6 <= iVar7)
	{
		...
		func_268(*Global_1071686->f_19550.f_1[iVar8], &vVar3);
		if (vVar3.x > vVar0.x)
		{
			iVar7 = (iVar8 - 1);
		}
...
int func_186(struct<2> Param0, int iParam2)
{
	...
	{
		func_268(*Global_1071686->f_19550.f_1[iVar9], &vVar3);
		if (vVar0.x == vVar3.x)
		{
...
void func_187()
{
	...
	{
		if (func_268(*Global_1071686->f_19550.f_1[iVar0], &vVar1))
		{
		}
		iVar0++;
	}
...
int func_194(struct<2> Param0)
{
	...
	while (iVar0 <= 31)
	{
		if (func_27(*Global_1900736->f_1[iVar0], Param0))
		{
			return iVar0;
		}
		iVar0++;
...
int func_195(int iParam0)
{
	...
	if (Global_1900736->f_66 == 1)
	{
		...
		func_70(Global_1900736->f_1[0]);
		return 1;
	}
	func_70(Global_1900736->f_1[iParam0]);
...
bool func_200(int iParam0)
{
	...
	else if (_0x61914209c36efddb(Global_34) != 0)
	{
		return false;
	}
	else if (func_282(1106247680, 0))
	{
		return false;
	}
	else if (is_player_targetting_anything(player_id()))
	{
		return false;
	}
	else if (is_player_free_aiming(player_id()))
	{
		return false;
	}
	else if (_is_ped_lassoed(Global_34))
	{
		return false;
	}
	else if (_is_ped_hogtied(Global_34))
	{
		return false;
	}
	else if (is_ped_shooting(Global_34))
	{
		return false;
	}
	else if (is_ped_jumping(Global_34))
	{
		return false;
	}
	else if (_0x3e592d0486dec0f6(Global_34))
	{
		return false;
	}
	else if (is_ped_falling(Global_34))
	{
		return false;
	}
	else if (is_ped_getting_up(Global_34))
	{
		return false;
	}
	else if (is_ped_ragdoll(Global_34))
	{
		return false;
	}
	else if (_0x0e99e3bf11bb6367(Global_34))
	{
		return false;
	}
	else if (_0x3bdfcf25b58b0415(Global_34))
	{
		return false;
	}
	else if (is_ped_performing_melee_action(Global_34, 512, 0))
	{
		return false;
	}
	...
	else if (_0x038b1f1674f0e242(Global_34))
	{
		return false;
	}
	else if (_get_number_of_references_of_script_with_name_hash(1077801405) > 0)
	{
		return false;
	}
	return true;
...
bool func_202(int iParam0)
{
	...
	{
		iParam0->f_15 = func_128(_create_var_string(10, "NET_MG_HELP_MAINTENANCE", func_291(iParam0->f_2)), 10000, 0, 0, 0, 1);
		return false;
	}
	else if (func_292(player_id(), 1, 0, 1))
	{
		iParam0->f_15 = func_128(_create_var_string(10, "MISSION_WANTED_REGION", func_291(iParam0->f_2)), 10000, 0, 0, 0, 1);
		return false;
	}
	else if (func_293())
	{
	...
	else if (func_102() || _get_number_of_references_of_script_with_name_hash(1077801405) > 0)
	{
		return false;
	}
	...
	{
		iParam0->f_15 = func_128(_create_var_string(2, "MGPKR_BROKE_MP", iVar12), 10000, 0, 0, 0, 1);
		return false;
	}
	return true;
}
...
char* func_212(char* sParam0, int iParam1)
{
	...
	return func_303(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_221(struct<2> Param0)
{
	...
	else if (!_0x01f4d242765c6b24(func_72(Param0)))
	{
		_0x99230691875fc218(func_82(Param0), func_72(Param0), Global_35);
	}
}
...
int func_240(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	func_317(Global_265377->f_4[iVar0]);
	if (iParam2 != -1)
	{
	...
	iVar1 = func_320(&(Global_265377->f_63755[iVar0]));
...
{
	return &(Global_1138962->f_1[iParam0]->f_15[iParam1]);
}
...
void func_248(struct<2> Param0)
{
	...
	{
		_0xb2a38826e5886e83(func_72(Param0), Global_265377->f_124517.f_71.f_17);
...
void func_253(int iParam0)
{
	if (!func_57(Global_1071686->f_21416.f_1[network_player_id_to_int()]->f_7, iParam0))
	{
		func_172(&(Global_1071686->f_21416.f_1[network_player_id_to_int()]->f_7), iParam0);
	}
}
...
bool func_258(var uParam0, int iParam1, var uParam2, var uParam3)
{
	...
	if (_datafile_get_data_node_index(&(Var0.f_1), &Var0))
	{
		...
		Var0.f_2 = -55481687;
		_datafile_get_float(uParam3, &Var0);
		return true;
	}
	return false;
}
...
char* func_265(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 0:
			return "";
		case -1695230319:
			return _create_var_string(10, "NET_MG_HELP_PLAYER_CLEAN", func_291(iParam0));
		case -1300909614:
			if (iVar0 == 0)
			{
				return "NET_MG_HELP_DAILY_PROFIT_CAP";
			}
			return _create_var_string(42, "NET_MG_HELP_COMPOSITE", "NET_MG_HELP_DAILY_PROFIT_CAP", func_339(iVar0, 0, 0));
		case -1589038658:
			if (iVar0 == 0)
			{
				return "NET_MG_HELP_DAILY_BUYIN_CAP";
			}
			return _create_var_string(42, "NET_MG_HELP_COMPOSITE", "NET_MG_HELP_DAILY_BUYIN_CAP", func_339(iVar0, 0, 0));
		case 1671747787:
			if (iVar0 == 0)
			{
				return _create_var_string(2, "NET_MG_HELP_PRIV_HOUR_BUYIN_CAP");
			}
			return _create_var_string(42, "NET_MG_HELP_COMPOSITE", "NET_MG_HELP_PRIV_HOUR_BUYIN_CAP", func_339(iVar0, 1, 0));
		case 1053423395:
		...
		case 579389526:
			...
			return _create_var_string(42, "NET_MG_HELP_COMPOSITE", "NET_MG_HELP_OVERALL_CAP", func_339(iVar0, 0, 0));
		case -1878199881:
			return _create_var_string(10, "NET_MG_HELP_GEO_TOGGLE", func_291(iParam0));
		case -592991683:
			return "NET_MG_HELP_NO_PARTY_CHAT";
		case -1517426354:
			return _create_var_string(10, "NET_MG_HELP_MAINTENANCE", func_291(iParam0));
		case -1720361368:
		...
		case -1700673948:
			return _create_var_string(10, "MG_FAILED_LAUNCH", func_291(iParam0));
		case 1736016924:
			return _create_var_string(10, "NET_MG_HELP_DISCONNECTED", func_291(iParam0));
		case -835571454:
			return _create_var_string(10, "NET_MG_HELP_NETWORK_ERROR", func_291(iParam0));
		case -301240451:
			return _create_var_string(10, "NET_MG_HELP_SCRIPT_ERROR", func_291(iParam0));
		case 2124908670:
...
int func_270(int iParam0)
{
	...
	{
		iVar0 = ((func_342() - _0xe13634bb6baf0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
void func_278(int iParam0, int iParam1)
{
	...
	if (func_69(*Global_1900736->f_1[0]))
	{
		func_75(*Global_1900736->f_1[0], 3);
	}
}
...
{
	if (((is_ped_in_combat(Global_34, 0) || is_ped_in_melee_combat(Global_34)) || func_131(iParam1, 1024)) && _0x336b3d200ab007cb(Global_34, Global_35, iParam0, iParam1) > 0)
	{
		return true;
	}
	return false;
...
{
	if (!get_ground_z_for_3d_coord(Global_35, &fVar0, false))
	{
		return false;
	}
	if (iParam0->f_2 == 0 && absf((fVar0 - iParam0->f_77)) > 0.5f)
	{
		return false;
	}
	if (vdist(Global_35, Global_35, Global_35.f_1, fVar0) > 1.2f)
	{
		return false;
	}
	return true;
...
void func_297(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1951255)[iParam0]->f_3))
	{
		if ((*Global_1951255)[iParam0]->f_5 == 5 && !func_284(iParam0, 8))
		{
...
void func_310()
{
	...
	{
		func_215(&((*Global_1056141)[iVar0]->f_187.f_10), 4);
	}
	else
	{
		func_219(&((*Global_1056141)[iVar0]->f_187.f_10), 4);
	}
	...
	if (func_150(1024))
	{
		func_215(&((*Global_1056141)[iVar0]->f_187.f_10), 2);
	}
	else
	{
		func_219(&((*Global_1056141)[iVar0]->f_187.f_10), 2);
	}
}
...
int func_311(struct<2> Param0)
{
	...
	while (iVar0 <= 7)
	{
		if (func_27(Global_1196898->f_78[iVar0]->f_7, Param0))
		{
			return iVar0;
		}
		iVar0++;
...
void func_333(struct<2> Param0, int iParam2)
{
	if (!func_69(Param0))
	{
		func_70(Global_1900736->f_1[iParam2]);
	}
	else
	{
...
char* func_339(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam1 == 0)
	{
		if (bParam2)
		{
			if (iParam0 > 86400)
			{
				return _create_var_string(2, "NET_MG_HELP_GAMBLING_AVAILABLE_D", Var0.f_2, Var0.f_3, Var0.f_4);
			}
			else if (iParam0 > 3600)
			{
				return _create_var_string(2, "NET_MG_HELP_GAMBLING_AVAILABLE_H", Var0.f_3, Var0.f_4);
			}
			return _create_var_string(2, "NET_MG_HELP_GAMBLING_AVAILABLE_M", Var0.f_4);
		}
		return _create_var_string(2, "NET_MG_HELP_GAMBLING_AVAILABLE_D", Var0.f_2, Var0.f_3, Var0.f_4);
	}
	if (bParam2)
	{
		if (iParam0 > 86400)
		{
			return _create_var_string(2, "NET_MG_HELP_PRIVATE_AVAILABLE_D", Var0.f_2, Var0.f_3, Var0.f_4);
		}
		else if (iParam0 > 3600)
		{
			return _create_var_string(2, "NET_MG_HELP_PRIVATE_AVAILABLE_H", Var0.f_3, Var0.f_4);
		}
		return _create_var_string(2, "NET_MG_HELP_PRIVATE_AVAILABLE_M", Var0.f_4);
	}
	return _create_var_string(2, "NET_MG_HELP_PRIVATE_AVAILABLE_D", Var0.f_2, Var0.f_3, Var0.f_4);
}
...
int func_392(struct<2> Param0)
{
	...
	{
		if (func_27((*Global_1196205)[iVar0]->f_1, Param0))
		{
			return iVar0;
		}
		iVar0++;
