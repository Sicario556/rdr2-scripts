		...
		if (get_game_timer() > iLocal_59)
		{
			...
			switch (iLocal_58)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_61 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_58 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_61 < get_game_timer())
					{
						bLocal_62 = false;
						iLocal_58 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_60));
					Global_1896620 = -1;
					iLocal_61 = (iLocal_57 + get_game_timer());
					iLocal_58 = 3;
					break;
				case 3:
					if (func_13() || iLocal_61 < get_game_timer())
					{
						func_14(iLocal_60);
						iLocal_61 = (iLocal_57 + get_game_timer());
						iLocal_58 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_60) || iLocal_61 < get_game_timer())
					{
						func_16(iLocal_60);
						iLocal_61 = (get_game_timer() + iLocal_57);
						iLocal_58 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_60) || iLocal_61 < get_game_timer())
					{
						func_18(iLocal_60);
						iLocal_61 = (iLocal_57 + get_game_timer());
						iLocal_58 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_60)))
					{
						if (func_19(func_9(iLocal_60), 4) && !iLocal_61 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_60) || iLocal_61 < get_game_timer())
							{
								func_21(iLocal_60, 4);
								iLocal_61 = (iLocal_57 + get_game_timer());
								iLocal_58 = 8;
							...
							func_36(iLocal_60, Global_1896674);
							iLocal_58 = 11;
							Jump @816; //curOff = 642
							func_37(iLocal_60);
							func_21(iLocal_60, 8);
							...
							func_41(Global_1896674, iLocal_60);
							func_42(iLocal_60);
							func_21(iLocal_60, 8);
							if (func_43())
							{
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_60]->f_11);
							if ((*Global_1887339)[iLocal_60]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_60]->f_12);
							}
							Jump @816; //curOff = 793
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_60]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_60]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_16 = (*Global_1887339)[99]->f_5;
	if (_does_scenario_group_exist_hash(-679384918))
	{
		_set_scenario_group_enabled_hash(-679384918, true);
	}
	if (_does_scenario_group_exist_hash(472704883))
	{
		_set_scenario_group_enabled_hash(472704883, true);
	}
	return true;
}
...
void func_16(int iParam0)
{
	...
	iLocal_17 = get_sound_id();
	if (iLocal_17 == -1)
	{
	}
	iVar0 = _create_volume_box(1010.465f, -1772.747f, 54.474f, 0f, 0f, 0f, 46.182f, 45.55f, 29.43f);
	iVar1 = create_itemset(true);
	iVar2 = _0x84ccf9a12942c83d(iVar0, iVar1, 3, 1, 1871313379, 0);
	iVar3 = 0;
	while (iVar3 < iVar2)
	{
		iVar4 = get_indexed_item_in_itemset(iVar3, iVar1);
		set_disable_frag_damage(iVar4, true);
		set_disable_breaking(iVar4, true);
		iVar3++;
	}
...
bool func_40(int iParam0)
{
	...
	if (iLocal_17 != -1)
	{
		...
		{
			if (func_67(Global_34, iLocal_16, 0, 0))
			{
				if (_0x84848e1c0fc67dbb(iLocal_17))
				{
					_0xdcf5ba95bbf0faba(iLocal_17, "MAIN_LOOP", 1011.224f, -1766.506f, 46.5833f, "FIRE_SMOLDER_LARGE_SOUNDSET", 0, 0, 0);
				}
			}
			else if (!_0x84848e1c0fc67dbb(iLocal_17))
			{
				_0x3210bcb36af7621b(iLocal_17);
			}
		}
	}
	return false;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_60)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_81(iLocal_60, 0), 1);
					break;
			}
		}
		if (func_10(func_74()))
...
bool func_53(int iParam0, int iParam1)
{
	...
	iVar0 = func_90(&((*Global_1197355)[iParam1]->f_4), iParam0, 30, 1, 7);
	if (iVar0 == 1)
	{
		return true;
	}
...
bool func_65(int iParam0)
{
	...
	if (func_108(iVar1))
	{
		if (Global_1071686->f_19648.f_24 && !func_109(iParam0))
		{
			return false;
		}
...
bool func_72(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_112(iParam0));
}
...
void func_75(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_120(iParam1, 2) || func_121(iParam4, 2)) && !Global_1893587->f_9)
	{
	...
	else if ((func_61(iParam0) && func_89(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_126(&cVar6, 109029619), sVar9, func_126(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_126(&cVar6, 109029619), func_126(&cVar10, 109029619));
		}
		Global_1893587->f_9 = 0;
	}
	Global_1939161->f_145 = func_127(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_84(int iParam0)
{
	...
	{
		_0x74c2b3dc0b294102(iLocal_16);
		_0xa1cfb35069d23c23(iLocal_16);
	}
	if (iLocal_17 != -1)
	{
		if (!_0x84848e1c0fc67dbb(iLocal_17))
		...
		release_sound_id(iLocal_17);
	}
	if (_does_scenario_group_exist_hash(-679384918))
	{
		_set_scenario_group_enabled_hash(-679384918, false);
	}
	iParam0 = iParam0;
}
...
bool func_87(int iParam0, bool bParam1)
{
	...
	if (func_93(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_134(Global_1896620->f_1, 16))
			{
				func_135(Global_1896620->f_1, 0);
			}
			Global_1896620->f_1++;
			iVar2++;
...
int func_96(int iParam0, bool bParam1)
{
	...
	{
		func_142(iParam0, _create_persistent_character(func_141(iParam0)));
		if (func_45() == -1)
		{
			if (func_134(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_143(iParam0));
				func_144(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_143(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_143(iParam0)))
	{
		func_144(iParam0, 128);
		return 1;
	}
	func_142(iParam0, _create_persistent_character(func_141(iParam0)));
	_0x4f81ead1de8fa19b(func_143(iParam0));
	if (func_134(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_143(iParam0));
		func_144(iParam0, 2048);
...
char* func_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_151(Global_1893587->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_153(func_152(Global_35));
	}
...
{
	func_157(Global_1940018->f_5[iParam0]->f_6, 1);
	func_158(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_94(Global_1915715->f_3[iParam0]->f_21) && func_160(Global_1915715->f_3[iParam0]->f_21))
	{
		func_161(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_162(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_165(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
int func_135(int iParam0, bool bParam1)
{
	...
	func_168(iParam0);
	_0xfc77c5b44d5ff7c0(func_143(iParam0));
	func_142(iParam0, 0);
	return 1;
}
...
void func_140(int iParam0, bool bParam1)
{
	...
	else if (func_175(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_165(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_179(iParam0, 2))
	{
...
{
	func_186(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_181()
{
	...
	if (!func_183(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
