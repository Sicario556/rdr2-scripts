...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[74]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 17);
	iLocal_20 = _create_volume_aggregate_with_custom_name("Emerald - m_volPostOfficeOwner");
	_0x39816f6f94f385ad(iLocal_20, 1522f, 442.664f, 91.328f, 0f, 0f, 89.95493f, 5.041f, 4.081f, 3.9f);
	_0x39816f6f94f385ad(iLocal_20, 1521.951f, 438.992f, 91.328f, 0f, 0f, 89.95493f, 2.586f, 2.534f, 3.9f);
	_0x39816f6f94f385ad(iLocal_20, 1525.561f, 442.571f, 91.328f, 0f, 0f, 89.95493f, 2.417f, 2.096f, 3.9f);
	iLocal_22 = _create_volume_aggregate_with_custom_name("Emerald - m_volPostOfficeOfflimits");
	_0x39816f6f94f385ad(iLocal_22, 1522.286f, 442.6286f, 91.09468f, 0f, 0f, 0.127711f, 3.924281f, 4.586129f, 2.884516f);
	_0x39816f6f94f385ad(iLocal_22, 1524.154f, 443.6188f, 91.33035f, 0f, 0f, -40.52857f, 0.901248f, 0.812041f, 3.364722f);
	_0x39816f6f94f385ad(iLocal_22, 1524.148f, 441.6273f, 91.32803f, 0f, 0f, 41.59158f, 0.901248f, 0.812041f, 3.361498f);
	_0x39816f6f94f385ad(iLocal_22, 1524.171f, 442.5686f, 91.33483f, 0f, 0f, 89.87004f, 2.182719f, 0.812041f, 3.355471f);
	iLocal_21 = _create_volume_aggregate_with_custom_name("Emerald - m_volPostOfficePrompt Agg");
	_0x39816f6f94f385ad(iLocal_21, 1521.928f, 439.418f, 91.598f, 0f, 0f, 89.87004f, 1.421f, 1.98f, 3.9f);
	_0x39816f6f94f385ad(iLocal_21, 1525.299f, 442.591f, 91.598f, 0f, 0f, 0.50203f, 1.421f, 1.902f, 3.9f);
	_0xb469cfd9e065eb99(iLocal_20, 10052);
	iLocal_25 = _create_volume_box_with_custom_name(1416.919f, 275.628f, 89.84f, 0f, 0f, 13.744f, 4.796f, 10.102f, 3.23f, "Emerald - Fence Shop Volume");
	_0xb469cfd9e065eb99(iLocal_25, 10050);
	iLocal_28 = _create_volume_aggregate_with_custom_name("Emerald - m_volHorsePen Agg");
	_0x39816f6f94f385ad(iLocal_28, 1392.317f, 341.5652f, 89.24782f, 0f, 0f, 12.46095f, 34.19419f, 40.64669f, 5.552397f);
	_0x39816f6f94f385ad(iLocal_28, 1406.395f, 342.4568f, 89.58327f, 0f, 0f, 39.45417f, 18.04731f, 26.06224f, 4.902727f);
	_0x39816f6f94f385ad(iLocal_28, 1416.681f, 332.729f, 89.86327f, 0f, 0f, 85.96169f, 12.0553f, 10.04752f, 5.028452f);
	iLocal_24 = _create_volume_box_with_custom_name(1521.955f, 437.362f, 91.328f, 0f, 0f, 89.955f, 18.275f, 7.419f, 3.9f, "Emerald - m_volTrainStation");
	if (func_45() == 0)
	{
	}
	iLocal_26 = _create_volume_box_with_custom_name(1246.785f, 170.357f, 87.12f, 0f, 0f, -80f, 14.456f, 10.148f, 8.8f, "HRT E TravellingSalesman - m_volTravellingSalesman");
	iLocal_27 = _create_volume_cylinder_with_custom_name(1245.177f, 174.244f, 87.12f, 0f, 0f, -80f, 3.7f, 3.7f, 4.2f, "HRT E TravellingSalesman - m_volTravellingSalesmanPrompt");
	func_53();
	return true;
}
...
{
	iParam0 = iParam0;
	create_model_hide(1446.648f, 371.4435f, 89.77228f, 0.25f, 1843407141, true);
	create_model_hide(1446.594f, 371.3564f, 89.84016f, 0.25f, 654026816, true);
	create_model_hide(1446.431f, 371.1044f, 89.73589f, 0.25f, 954963420, true);
	_0x6c269f673c47031e(-736104133);
}

bool func_17(int iParam0)
{
	if (!_0xf97f462779b31786(-736104133))
	{
		return false;
	}
	if (!func_54("EMRHAU"))
...
{
	func_60(2, iLocal_20, iParam0, iLocal_21, iLocal_22, 1277952, 0, 0, -1082130432, 0);
	func_61(2, 2057841001, 0, 0, 0);
	func_62(2, 0);
	func_60(4, iLocal_25, iParam0, iLocal_25, 0, 12, 0, 0, -1082130432, 0);
	func_62(4, 0);
	func_60(38, iLocal_26, iParam0, iLocal_27, 0, 12, 1, 0, -1082130432, 0);
	func_62(38, 0);
}
...
bool func_40(int iParam0)
{
	...
	func_70(&uLocal_31, &iLocal_32, 1422.583f, 377.0824f, 89.0055f, -2080420985);
	func_71(25, iLocal_24, &uLocal_23);
	if ((func_72(6) && !func_73(6)) && func_74(1397875340, 1))
	{
		if (!_does_volume_exist(iLocal_29))
		{
			iLocal_29 = _0x0eb78c2b156635b1(-1612834106, 1448.551f, 374.271f, 90.332f, 0f, 0f, -0.353f, 11.5f, 12.211f, 2.918f);
			_0x5b23dff8e0948bb2(iLocal_29, 1);
			_0xbe551c2cc421185d(iLocal_29, 1);
		}
	}
	else if (_does_volume_exist(iLocal_29))
	{
		_0x5b23dff8e0948bb2(iLocal_29, 0);
		_0xbe551c2cc421185d(iLocal_29, 0);
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_36)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_88(iLocal_36, 0), 1);
					break;
			}
		}
		if (func_10(func_81()))
...
void func_60(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_108(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_109(Global_1051439->f_72[iParam0]->f_18);
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	Global_1051439->f_72[iParam0]->f_31[iVar0] = func_114(iParam1, 0, 0);
	if (func_115(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
	{
		if (!func_116(&(Global_1051439->f_72[iParam0]->f_31[iVar0])))
		{
			func_117(&(Global_1051439->f_72[iParam0]->f_31[iVar0]), 0, iParam2, bParam3, 1, 0, iParam4, 0);
		}
	}
...
{
	if ((func_118(iParam0, 16384) || func_118(iParam0, 32768)) || func_119(Global_1051439->f_72[iParam0]->f_3))
	{
...
void func_84(int iParam0, bool bParam1)
{
	...
	func_131(func_157(-1532769513, -36357794), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_131(func_157(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_131(func_157(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_131(func_157(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_131(func_157(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_131(func_157(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_131(func_157(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_91(int iParam0)
{
	...
	if (is_itemset_valid(iLocal_32))
	{
		destroy_itemset(iLocal_32);
	}
	iParam0 = iParam0;
}
...
int func_102(int iParam0, bool bParam1)
{
	...
	{
		func_168(iParam0, _create_persistent_character(func_167(iParam0)));
		if (func_45() == -1)
		{
			if (func_161(iParam0, 2048))
			{
				_0x49a8c2cd97815215(func_125(iParam0));
				func_169(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_125(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_125(iParam0)))
	{
		func_169(iParam0, 128);
		return 1;
	}
	func_168(iParam0, _create_persistent_character(func_167(iParam0)));
	_0x4f81ead1de8fa19b(func_125(iParam0));
	if (func_161(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_125(iParam0));
		func_169(iParam0, 2048);
...
void func_107(int iParam0, bool bParam1)
{
	...
	else if (func_182(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_187(iParam0, 2))
	{
...
void func_117(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_114(iParam0, 0, 0);
	if (func_115(iParam0))
	{
		...
		if (bParam3)
		{
			func_193(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_123(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_199(uParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_200(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_125(iParam0));
}
...
struct<2> func_130(int iParam0)
{
	...
	return func_157(-277276100, iVar0);
}
...
int func_138(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = _0xe787f05dfc977bde(func_213(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = _0xc97e0d2302382211(func_213(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
char* func_153(char* sParam0, int iParam1)
{
	...
	return func_224(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_225(Global_1940018->f_5[iParam0]->f_6, 1);
	func_226(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_100(Global_1915715->f_3[iParam0]->f_21) && func_228(Global_1915715->f_3[iParam0]->f_21))
	{
		func_229(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_230(Global_1915715->f_3[iParam0]->f_9, 0);
...
int func_162(int iParam0, bool bParam1)
{
	...
	func_235(iParam0);
	_0xfc77c5b44d5ff7c0(func_125(iParam0));
	func_168(iParam0, 0);
	return 1;
}
...
{
	return func_248(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_250(12, func_249(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_193(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_115(iParam0))
	{
...
char* func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_267(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_238(int iParam0, int iParam1)
{
	...
	{
		return func_276(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_213(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<5> func_258(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -1037537535:
			Var0 = { func_259(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_285(iParam0, &Var0, 1728382685, 0, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_285(iParam0, &Var0, -649335959, 0, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_286(iParam0, &Var6, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -1962314949:
			...
			{
				Var0 = { func_259(-1838434463, Var0, 1084182731, bParam1) };
...
struct<4> func_283(bool bParam0)
{
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1293346 = { func_259(1328661203, func_299(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346->f_12 = { func_259(1328661203, func_299(), -1591664384, 0) };
			}
			return Global_1293346->f_12;
		}
	}
	return func_259(1328661203, func_299(), -1591664384, bParam0);
}
...
bool func_300()
{
	return (func_306(-1185145312, 0, 0, 0) > 0 && func_307(func_259(889965687, func_283(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_301(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam7)
	{
		...
		iVar0 = _0xc97e0d2302382211(func_213(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = _0xe787f05dfc977bde(func_213(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_306(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return _0xe787f05dfc977bde(func_213(bParam1), iParam0, iParam3);
}
