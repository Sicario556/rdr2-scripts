...
bool func_13()
{
	iLocal_16 = (*Global_1887339)[101]->f_5;
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_112(bool bParam0)
{
	if (bParam0)
	{
		...
		func_138(Global_1940258, 8388608);
	}
	else
	{
		set_wanted_level_multiplier(0f);
		func_109(Global_1940258, 8388608);
	}
