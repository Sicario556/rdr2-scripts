...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((0 - get_num_reserved_mission_objects(0)));
				return;
			}
			if (get_num_reserved_mission_peds(0) < uParam0->f_23)
			{
				reserve_network_mission_peds((0 - get_num_reserved_mission_peds(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
{
	uParam0->f_1564 = "PL_TOON_DIRECT_CURRENT_DAMNATION";
	uParam0->f_1563 = "bla_theater";
	uParam0->f_1574 = -349278483;
	uParam0->f_1575 = 1496945188;
	uParam0->f_1560 = 0;
	uParam0->f_1559 = 1;
	uParam0->f_1561 = 1;
	uParam0->f_1565 = { 2702.49f, -1348.78f, 49.61f };
	uParam0->f_1568 = { 0f, 0f, 130.1f };
	uParam0->f_1571 = { 2687.582f, -1362.665f, 55.639f };
	uParam0->f_1581 = 0.5f;
	uParam0->f_1582 = 0.48f;
	uParam0->f_1579 = 0.7f;
	uParam0->f_1580 = 0.49f;
	uParam0->f_1385[0] = uParam0->f_1574;
	uParam0->f_1385[1] = uParam0->f_1575;
	return true;
}
...
bool func_25(var uParam0)
{
	if (!uParam0->f_1357 && !uParam0->f_1559)
	{
		...
		if (!func_79(_net_to_anim_scene(uParam0->f_1376), func_91(1), func_82()))
		{
			return false;
		}
	}
...
void func_32(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 0:
			...
			break;
		case 1:
			if (!has_model_loaded(func_102()) || !has_model_loaded(func_103(0)))
			{
				return;
			}
			...
			{
				iVar1 = iVar0;
				uParam0->f_3[iVar0] = create_object(func_103(iVar1), func_107(iVar1), true, true, false, false, true);
				iVar0++;
			}
			func_101(uParam0, 2);
			break;
		case 2:
			...
			{
				uParam0->f_9 = _create_anim_scene(func_108(iParam1), 0, func_109(iParam1, 0), true, true);
				load_anim_scene(uParam0->f_9);
				set_anim_scene_origin(uParam0->f_9, func_110(iParam1), func_111(iParam1), 2);
			}
		...
		case 3:
			...
			break;
		case 4:
			if (!_0x1f0e401031e20146(uParam0->f_9, func_109(iParam1, 1)) || !_0x23e33cb9f4a3f547(uParam0->f_9, func_109(iParam1, 1)))
			{
				return;
			}
			func_101(uParam0, 5);
...
{
	if (!_does_anim_scene_exist(uParam0->f_1373))
	{
		return;
	}
}
...
{
	if (func_125(Global_34, uParam0->f_9, 1, 0))
	{
		func_52((*uParam1)[uParam2->f_1], 1);
	}
	else if (func_68((*uParam1)[uParam2->f_1], 1))
	{
		func_126((*uParam1)[uParam2->f_1], 1);
	}
	if (func_125(Global_34, uParam0->f_10, 1, 0))
	{
		func_52((*uParam1)[uParam2->f_1], 2);
	}
	else if (func_68((*uParam1)[uParam2->f_1], 2))
	{
		func_126((*uParam1)[uParam2->f_1], 2);
	}
}
...
void func_49(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_127(uParam0->f_12[iVar0], uParam1->f_3[iVar0]))
			{
				func_128(uParam0->f_12[iVar0], uParam1->f_3[iVar0]);
			}
...
{
	func_129(&(uParam1->f_2), &(uParam1->f_247), uParam0->f_2);
	func_130(&(uParam1->f_247), &(uParam1->f_2), uParam0->f_2);
}
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	...
	{
		case 0:
			request_model(func_102(), false);
			request_model(func_103(0), false);
			func_132(uParam1, 1);
			break;
		case 1:
			if (*uParam0 > 1)
		...
		case 3:
			...
			{
				set_anim_scene_entity(uParam0->f_9, func_133(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					set_anim_scene_entity(uParam0->f_9, func_134(iParam2, iVar0), &(uParam0->f_3[iVar0]), 0);
					iVar0++;
				}
		...
		case 4:
			...
			{
				if (!_0x1f0e401031e20146(uParam0->f_9, func_109(iParam2, 1)))
				{
					if (!_0x23e33cb9f4a3f547(uParam0->f_9, func_109(iParam2, 1)))
					{
						_0xdf7b5144e25cd3fe(uParam0->f_9, func_109(iParam2, 1));
					}
					else
					{
						_set_anim_scene_playback_list_bool(uParam0->f_9, func_109(iParam2, 1), true);
					}
				}
			}
			if (!_0x1f0e401031e20146(uParam0->f_9, func_109(iParam2, 1)) || !_0x23e33cb9f4a3f547(uParam0->f_9, func_109(iParam2, 1)))
			{
				return;
			}
			func_132(uParam1, 5);
...
void func_70(var uParam0, var uParam1)
{
	...
	if (!uParam0->f_1357)
	{
		func_142(&(uParam1->f_2), &(uParam1->f_247));
	}
	if (!uParam0->f_4)
	{
		func_46(uParam0->f_1350);
...
bool func_89(var uParam0)
{
	...
	else if (func_146(&(uParam0->f_1363)) > 10f)
	{
		bVar0 = true;
	}
	if (func_13(uParam0->f_1359, 1))
...
int func_106(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_155(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
{
	return func_157(iParam0, 23);
}

void func_123(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_153(iParam0, 0, 0);
	if (func_154(iParam0))
	{
		...
		if (bParam3)
		{
			func_158(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_129(var uParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_164(iParam2);
		iVar0 = 0;
		while (iVar0 <= (iVar1 - 1))
		{
			iVar3 = iVar0;
			if (func_167((*uParam0)[iVar0], func_165(iParam2), func_166(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_167(uParam0->f_31[iVar0], func_169(iParam2), func_170(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_167(uParam0->f_107[iVar0], func_172(iParam2), func_173(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_167(uParam0->f_118[0], func_174(iParam2, 0), func_175(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_167(uParam0->f_118[1], func_174(iParam2, 1), func_175(iParam2, 1), 1065353216)) && func_167(uParam0->f_118[2], func_174(iParam2, 2), func_175(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_167(uParam0->f_118[iVar0], func_174(iParam2, 0), func_175(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_130(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_180(uParam1, func_177(uParam1), &(uParam1->f_229), func_178(uParam1), func_179(uParam1)))
		{
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_182(uParam1, func_181(uParam1), &(uParam1->f_229), func_178(uParam1), func_179(uParam1)))
		{
			func_14(uParam0, 4);
		}
	}
	...
	{
		if (func_13(*uParam0, 16) && func_180(&(uParam1->f_31), func_183(uParam1), &(uParam1->f_232), func_184(uParam1), func_179(uParam1)))
		{
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_182(&(uParam1->f_31), func_185(uParam1), &(uParam1->f_232), func_184(uParam1), func_179(uParam1)))
		{
			func_14(uParam0, 32);
		}
	}
	...
	{
		if (func_13(*uParam0, 4096) && func_180(&(uParam1->f_107), func_186(uParam1), &(uParam1->f_235), func_187(uParam1), func_179(uParam1)))
		{
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_182(&(uParam1->f_107), func_188(uParam1), &(uParam1->f_235), func_187(uParam1), func_179(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_191(uParam1->f_118[0], func_189(uParam1), &(uParam1->f_238), func_190(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_193(uParam1->f_118[0], func_192(uParam1), &(uParam1->f_238), func_190(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_191(uParam1->f_118[0], func_189(uParam1), &(uParam1->f_238), 0.5f, func_179(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_193(uParam1->f_118[0], func_192(uParam1), &(uParam1->f_238), 0.5f, func_179(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_196(1, 2, &(uParam1->f_118), func_194(uParam1), &(uParam1->f_241), func_195(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_198(1, 2, &(uParam1->f_118), func_197(uParam1), &(uParam1->f_241), func_195(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_196(1, 2, &(uParam1->f_118), func_194(uParam1), &(uParam1->f_241), 0.5f, func_179(uParam1)))
			{
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_198(1, 2, &(uParam1->f_118), func_197(uParam1), &(uParam1->f_241), 0.5f, func_179(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_180(&(uParam1->f_31), func_183(uParam1), &(uParam1->f_232), 0.1f, func_179(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_182(&(uParam1->f_31), func_185(uParam1), &(uParam1->f_232), 0.1f, func_179(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_180(&(uParam1->f_118), func_199(uParam1), &(uParam1->f_238), func_200(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_182(&(uParam1->f_118), func_201(uParam1), &(uParam1->f_238), func_200(uParam1), func_179(uParam1)))
			{
...
{
	func_203(uParam0);
	func_203(&(uParam0->f_31));
	func_203(&(uParam0->f_107));
	func_203(&(uParam0->f_118));
	*uParam1 = 0;
}

var func_143(int iParam0, int iParam1)
{
	return func_204(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
int func_145(var uParam0)
{
	if (!is_named_rendertarget_registered(uParam0->f_1563))
	{
		register_named_rendertarget(uParam0->f_1563, false);
		link_named_rendertarget(uParam0->f_1574);
		if (!is_named_rendertarget_linked(uParam0->f_1574))
		{
			release_named_rendertarget(uParam0->f_1563);
			return 0;
		}
	}
	uParam0->f_1562 = get_named_rendertarget_render_id(uParam0->f_1563);
	if (uParam0->f_1561)
	{
		if (uParam0->f_1578 == 0)
		{
			uParam0->f_1578 = _0x6f3068258a499e52(uParam0->f_1575, uParam0->f_1571, 7);
		}
		else if (_0x1ff441d7954f8709(uParam0->f_1578))
		{
			uParam0->f_1577 = get_object_index_from_entity_index(_0x4735e2a4bb83d9da(uParam0->f_1578));
		}
		if (!does_entity_exist(uParam0->f_1577))
		{
			return 0;
		...
		_0xf49574e2332a8f06(uParam0->f_1577, 0f);
		_0x04d1d4e411ce52d0(uParam0->f_1577, uParam0->f_1562);
	}
	set_text_render_id(uParam0->f_1562);
...
void func_150(var uParam0)
{
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		uParam0->f_1393[0] = create_object_no_offset(&(uParam0->f_1385[0]), uParam0->f_1565, true, true, false, true);
		uParam0->f_1576 = &uParam0->f_1393[0];
	}
	if (does_entity_exist(uParam0->f_1576))
	{
		set_entity_rotation(uParam0->f_1576, uParam0->f_1568, 2, true);
		set_entity_visible(uParam0->f_1576, false);
		set_entity_dynamic(uParam0->f_1576, false);
		set_entity_proofs(uParam0->f_1576, 31, false);
		freeze_entity_position(uParam0->f_1576, true);
	}
}
...
void func_155(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
...
bool func_167(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_180(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	if (!func_34(uParam2))
	{
		func_27(uParam2);
	}
	fVar1 = func_146(uParam2);
	iVar0 = 0;
	while (iVar0 <= (*uParam0 - 1))
	{
		func_213((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_182(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	if (!func_34(uParam2))
	{
		func_27(uParam2);
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_214((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_191(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar0 = func_146(uParam2);
	func_213(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_147(uParam2);
		return true;
...
bool func_193(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	if (!func_34(uParam2))
	{
		func_27(uParam2);
	...
	fVar0 = func_146(uParam2);
	func_214(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_147(uParam2);
		return true;
...
bool func_196(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	iVar0 = iParam0;
	iVar1 = iParam1;
	if (iVar0 > iVar1)
	...
	fVar2 = func_146(uParam4);
	iVar3 = iVar0;
	while (iVar3 <= iVar1)
	{
		func_213((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_198(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	iVar0 = iParam0;
	iVar1 = iParam1;
	if (iVar0 > iVar1)
	...
	while (iVar3 <= iVar1)
	{
		func_214((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_204(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_217());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_217());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_217());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_218(get_player_team(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (network_is_player_active(&(Global_1296859->f_154[iVar2])))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_220(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
void func_213(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	if (does_entity_exist(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_222(fParam1, uParam0->f_4, fVar0);
...
void func_214(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	if (does_entity_exist(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_222(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
bool func_223(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_226(&(Global_1102219->f_4), iVar0, 5);
	}
	if (iParam1 == func_227())
	{
		return func_226(&(Global_1102219->f_4), iVar0, 5);
	...
	{
		return func_226(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_226(var uParam0, int iParam1, int iParam2)
{
