void __EntryFunction__()
{
	...
	Local_2178.f_1 = participant_id_to_int();
	while (!func_3(Local_1601[Local_2178.f_1]))
	{
		if (network_is_host_of_this_script())
		{
...
void func_1(int iParam0)
{
	func_8(32, iParam0);
	func_9();
	network_register_host_broadcast_variables(&uLocal_17, 1584, 8);
	func_10(_0xba24095ea96dfe17(&uLocal_17), 1584, "sHostData");
	network_register_player_broadcast_variables(&Local_1601, 577, 9);
	func_11(_0x690806bc83bc8ca2(Local_1601[0]), 577, "m_showClientStruct");
	func_12(0);
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((5 - get_num_reserved_mission_objects(0)));
				return;
			}
...
bool func_21(var uParam0)
{
	if (network_is_host_of_this_script())
	{
		...
		if (!_does_anim_scene_exist(_net_to_anim_scene(uParam0->f_1374)))
		{
			uParam0->f_1373 = _create_anim_scene(func_87(), 2, func_88(iLocal_16), true, true);
...
bool func_96(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "STICK_0_", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "STICK_1_", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[4])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "lantern", &(uParam0->f_1393[4]), 0);
		}
		else
		{
			return false;
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > func_162(iLocal_16))
			{
