...
bool func_40(int iParam0)
{
	...
	{
		case 0:
			if (has_model_loaded(func_53()) && !func_61())
			{
				iLocal_14 = 1;
			}
			break;
...
bool func_62()
{
	if (!does_entity_exist(iLocal_13))
	{
		iLocal_13 = create_object(func_53(), func_91(), false, false, false, false, true);
		if (!is_entity_dead(iLocal_13))
		{
			set_entity_coords(iLocal_13, func_91(), true, false, true, true);
			set_entity_rotation(iLocal_13, func_92(), 2, true);
		}
		else
		{
			return false;
...
{
	iParam0 = iParam0;
	delete_object(&iLocal_13);
	set_model_as_no_longer_needed(func_53());
}
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_140(Global_1915715->f_3[iParam0]->f_21))
	{
