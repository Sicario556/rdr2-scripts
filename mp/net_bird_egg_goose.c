void __EntryFunction__()
{
	...
	func_5(&uLocal_42, -1390165137, -158375659, -1443632175, 4, 3, 0);
...
{
	_0x73f0d0327bfa0812(iLocal_40);
}

bool func_49(var uParam0)
{
	if (_0x5e5d96be25e9df68(iLocal_40))
	{
		return true;
	}
	return false;
...
bool func_50(var uParam0)
{
	if (!is_entity_dead(Global_34))
	{
		if (bLocal_41)
		{
			iLocal_39 = _0x5b4bbe80ad5972dc(iLocal_40, vLocal_16, 0f, 0, &uVar0, -1);
		}
		else
		{
			iLocal_39 = _0x5b4bbe80ad5972dc(iLocal_40, vLocal_16, 0f, 1, &uVar0, -1);
		}
		return true;
	}
	return false;
