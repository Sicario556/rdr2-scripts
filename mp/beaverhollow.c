...
bool func_13()
{
	iLocal_13 = _create_volume_aggregate_with_custom_name("Beaver Hollow - m_volTown Agg");
	_0xbce668aaf83608be(iLocal_13, 2345.187f, 1352.787f, 107.6561f, 0.036552f, 0f, 0f, 40.20085f, 40.78676f, 12.88943f);
	_0xbce668aaf83608be(iLocal_13, 2357.265f, 1391.395f, 109.9775f, 2.692848f, 0f, 0f, 17.41357f, 20.79141f, 16.64382f);
	_0xbce668aaf83608be(iLocal_13, 2318.457f, 1444.692f, 87.40137f, 179.4571f, 0f, 0f, 51.88874f, 33.18848f, 11.92861f);
	_0xbce668aaf83608be(iLocal_13, 2347.961f, 1414.832f, 96.40656f, 0.534309f, -14.06188f, -34.73259f, 31.42639f, 14.92058f, 9.380316f);
	_0xbce668aaf83608be(iLocal_13, 2255.09f, 1458.163f, 93.38544f, 0f, 0f, 0f, 21.93718f, 27.58467f, 4.980723f);
	_0xbce668aaf83608be(iLocal_13, 2272.888f, 1487.881f, 103.2379f, 11.51613f, 0f, 0f, 19.99748f, 13.49523f, 3.545758f);
	return true;
}
...
{
	if (load_stream("beaver_hollow", "es_camp_memory_sounds"))
	{
		iLocal_14 = _0x0556c784fa056628("beaver_hollow", "es_camp_memory_sounds");
		iLocal_15 = get_game_timer() + 30000;
		return true;
	}
	return false;
}
...
{
	if (((func_60(Global_34, iLocal_13, 1, 0) && iLocal_15 < get_game_timer()) && func_62(func_61())) && func_63(6, 18))
	{
		play_stream_frontend(iLocal_14);
		set_ambient_zone_state("AZ_camp_beaver_hollow_Endless_Summer", true, true);
		bLocal_16 = true;
		iLocal_15 = get_game_timer() + 30000;
	}
	if (bLocal_16)
	{
		if (!is_stream_playing(iLocal_14))
		{
			set_ambient_zone_state("AZ_camp_beaver_hollow_Endless_Summer", false, true);
			bLocal_16 = false;
		}
	}
	return true;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_77(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
{
	return func_93(get_clock_hours(), iParam0, iParam1);
}
...
{
	if (func_89(Global_1915715->f_3[iParam0]->f_21) && func_141(Global_1915715->f_3[iParam0]->f_21))
	{
