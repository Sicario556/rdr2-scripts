...
bool func_13()
{
	iLocal_16 = _create_volume_cylinder_with_custom_name(-2395.549f, -2409.981f, 35f, 0f, 0f, -2f, 115f, 87f, 50f, "m_volMacFarlanesRanch");
	if (!network_is_game_in_progress())
	{
		iLocal_21 = _create_volume_box_with_custom_name(-2366.904f, -2392.304f, 63.54964f, 0f, 0f, 80.66905f, 8.038614f, 4.266712f, 16.92971f, "MacFarlanes' Ranch - m_volRancherThreat");
		iLocal_20 = _create_volume_aggregate_with_custom_name("MacFarlanes' Ranch - m_volRancherRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_20, iLocal_21);
		_0x39816f6f94f385ad(iLocal_21, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		_0xbce668aaf83608be(iLocal_20, -2455.174f, -2384.14f, 35f, 0f, 0f, 25.5349f, 24.66208f, 30.76534f, 39.15789f);
		_0xbce668aaf83608be(iLocal_20, -2412.317f, -2374.972f, 63.25839f, 0f, 0f, -32.90815f, 13.07416f, 14.51878f, 9.688599f);
		_0x39816f6f94f385ad(iLocal_20, -2432.721f, -2360.609f, 66.342f, 0f, 0f, -59.51217f, 44.12811f, 56.53022f, 19.75536f);
		_0x39816f6f94f385ad(iLocal_20, -2428.935f, -2393.028f, 64.86296f, 0f, 0f, 30.36721f, 35.19614f, 20.94381f, 14.33946f);
		_0xbce668aaf83608be(iLocal_20, -2405.119f, -2471.914f, 63.25839f, 0f, 0f, 16.82132f, 13.84418f, 7.762568f, 9.688599f);
		_0x39816f6f94f385ad(iLocal_20, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 15.31493f, 15.94952f, 16.92971f);
		_0x39816f6f94f385ad(iLocal_20, -2407.512f, -2449.14f, 64.5022f, 0f, 0f, 48.91291f, 13.99343f, 21.49771f, 12.90299f);
		_0x39816f6f94f385ad(iLocal_20, -2416.311f, -2452.443f, 64.20742f, 0f, 0f, 3.371748f, 14.65324f, 19.53584f, 12.77374f);
		_0x39816f6f94f385ad(iLocal_20, -2399.068f, -2464.15f, 64.86296f, 0f, 0f, 18.69488f, 16.30252f, 23.22957f, 14.33946f);
		_0x39816f6f94f385ad(iLocal_20, -2414.51f, -2467.064f, 61.83258f, 0f, 0f, -78.00346f, 14.14975f, 15.2253f, 17.07607f);
		_0x39816f6f94f385ad(iLocal_20, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		iLocal_18 = _create_volume_aggregate_with_custom_name("MacFarlanes' Ranch - m_volRancherWarning Agg");
		_0x6e0d3c3f828da773(iLocal_18, iLocal_20);
		_0xbce668aaf83608be(iLocal_18, -2407.745f, -2461.009f, 63.25839f, 0f, 0f, 21.61882f, 21.58509f, 25.8055f, 9.688599f);
		_0x39816f6f94f385ad(iLocal_18, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 19.83966f, 22.38591f, 16.92971f);
		_0xbce668aaf83608be(iLocal_18, -2395.625f, -2381.142f, 35f, 0f, 0f, 29.59317f, 9.273087f, 11.13545f, 39.15789f);
		_0xbce668aaf83608be(iLocal_18, -2424.377f, -2394.976f, 35f, 0f, 0f, 122.1515f, 8.7505f, 40.19938f, 39.15789f);
		_0xbce668aaf83608be(iLocal_18, -2409.492f, -2351.147f, 35f, 0f, 0f, 29.59317f, 9.273087f, 29.27413f, 39.15789f);
		_0xbce668aaf83608be(iLocal_18, -2466.104f, -2392.814f, 35f, 0f, 0f, 29.59317f, 12.03543f, 28.7101f, 39.15789f);
		_0xbce668aaf83608be(iLocal_18, -2450.099f, -2347.51f, 35f, 0f, 0f, 122.1515f, 8.311909f, 37.10839f, 39.15789f);
		iLocal_19 = _create_volume_aggregate_with_custom_name("MacFarlanes' Ranch - m_volRancherRegistration Agg");
		_0x6e0d3c3f828da773(iLocal_19, iLocal_18);
		_0xbce668aaf83608be(iLocal_19, -2395.549f, -2409.981f, 35f, 0f, 0f, -2f, 115f, 87f, 50f);
		sLocal_17 = "MACFARLANES_RANCH";
		_create_guard_zone(sLocal_17);
		_0xa8a74aa79fb67159(sLocal_17, iLocal_16);
		_0x8c598a930f471938(sLocal_17, iLocal_19);
		_0xa1b0e6301e2e02a6(sLocal_17, iLocal_21);
		_0x35815f372d43e1e5(sLocal_17, iLocal_20);
		_0xad3e07c37a7c1adc(sLocal_17, iLocal_18);
		_set_guard_zone_position(sLocal_17, -2421f, -2358.5f, 64.1f);
		_set_guard_zone_position_2(sLocal_17, -2408.5f, -2470.6f, 62.8f);
	}
	return true;
}
...
void func_30(int iParam0)
{
	...
	_0x4a8fefc43fd8ac9b(iLocal_20, 3, 1);
	_0x53d05d60e5f5b40c(iLocal_20, 3, 1, func_59(893));
	_0x53d05d60e5f5b40c(iLocal_20, 3, 1, func_59(889));
	_0x53d05d60e5f5b40c(iLocal_20, 3, 1, func_59(890));
	_0x53d05d60e5f5b40c(iLocal_20, 3, 1, func_59(891));
	_0x53d05d60e5f5b40c(iLocal_20, 3, 1, func_59(892));
}
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_65(&Global_1940258, 32768)) || func_65(&Global_1940258, 16777216))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_35))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_68((*uParam0)[iVar3], 1) && func_69(iParam1)) && !func_70(iParam1, 16))
							{
								func_72(iParam1, func_71(), -1, 0, -1, 0);
								func_73((*uParam0)[iVar3], 1);
							}
							func_74(iParam1, 0);
						}
						bVar0 = true;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_78(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_71()))
...
void func_64()
{
	iVar0 = _0x112ddf56300bc6e5(363792844);
	iVar1 = _0x112ddf56300bc6e5(886569692);
	iVar2 = _0x112ddf56300bc6e5(1292930074);
	iVar3 = _0x112ddf56300bc6e5(-677310285);
	iVar4 = _0x112ddf56300bc6e5(-310363023);
	iVar5 = _0x112ddf56300bc6e5(-66463356);
	...
	{
		if (!_0xeb98b38ca60742d7(iVar2) && _is_scenario_group_enabled_hash(-1625875143))
		{
			_set_scenario_group_enabled_hash(-1625875143, false);
			return;
		}
	...
	{
		if (!_0xeb98b38ca60742d7(iVar3) && _is_scenario_group_enabled_hash(-1625875143))
		{
			_set_scenario_group_enabled_hash(-1625875143, false);
			return;
		}
	}
	if (_0x800df3fc913355f3(iVar4))
	{
		if (!_0xeb98b38ca60742d7(iVar4) && _is_scenario_group_enabled_hash(-1625875143))
		{
			_set_scenario_group_enabled_hash(-1625875143, false);
			return;
		}
	}
	if (_0x800df3fc913355f3(iVar5))
	{
		if (!_0xeb98b38ca60742d7(iVar5) && _is_scenario_group_enabled_hash(-1625875143))
		{
			_set_scenario_group_enabled_hash(-1625875143, false);
		}
		else if (_0xeb98b38ca60742d7(iVar5) && !_is_scenario_group_enabled_hash(-1625875143))
		{
...
bool func_69(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_96(iParam0));
}
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_110(&cVar6, 109029619), sVar9, func_110(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_110(&cVar6, 109029619), func_110(&cVar10, 109029619));
		}
...
void func_81(int iParam0)
{
	...
	{
		_0x998202b206872672(iLocal_20);
		_0x6d5f9e69ba1be783(iLocal_20);
		_delete_volume(iLocal_20);
	}
...
int func_92(int iParam0, bool bParam1)
{
	...
	if (func_119(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_59(iParam0));
				func_128(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_59(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_59(iParam0)))
	{
		func_128(iParam0, 128);
		return 1;
	}
	func_127(iParam0, _create_persistent_character(func_126(iParam0)));
	_0x4f81ead1de8fa19b(func_59(iParam0));
	if (func_119(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_59(iParam0));
		func_128(iParam0, 2048);
...
bool func_93(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !does_entity_exist(func_130(iParam0)))
	{
		return false;
	}
	return !_0xeb98b38ca60742d7(func_59(iParam0));
}
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_140(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_141(Global_1940018->f_5[iParam0]->f_6, 1);
	func_142(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_90(Global_1915715->f_3[iParam0]->f_21) && func_144(Global_1915715->f_3[iParam0]->f_21))
	{
		func_145(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_146(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_149(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
int func_120(int iParam0, bool bParam1)
{
	...
	func_152(iParam0);
	_0xfc77c5b44d5ff7c0(func_59(iParam0));
	func_127(iParam0, 0);
	return 1;
}
...
void func_125(int iParam0, bool bParam1)
{
	...
	else if (func_159(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_149(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_163(iParam0, 2))
	{
...
{
	func_171(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
