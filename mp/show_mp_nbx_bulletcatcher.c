...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_peds((3 - get_num_reserved_mission_peds(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
bool func_96(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "BUCKET", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Stool", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "BOTTLE", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	set_anim_scene_entity(iVar0, "Gun", &(uParam0->f_1423[0]), 0);
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > func_165())
			{
...
void func_120(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_167(&((*uParam1)[uParam2->f_1]->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_167(&((*uParam1)[uParam2->f_1]->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_167(&((*uParam1)[uParam2->f_1]->f_17), 34);
			}
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > func_165())
			{
				func_167(&((*uParam1)[uParam2->f_1]->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_167(&((*uParam1)[uParam2->f_1]->f_17), 40);
			break;
		case 40:
			break;
	}
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_179((*uParam0)[iVar0], func_177(iParam2), func_178(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_179(uParam0->f_31[iVar0], func_181(iParam2), func_182(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_179(uParam0->f_107[iVar0], func_184(iParam2), func_185(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_179(uParam0->f_118[0], func_186(iParam2, 0), func_187(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_179(uParam0->f_118[1], func_186(iParam2, 1), func_187(iParam2, 1), 1065353216)) && func_179(uParam0->f_118[2], func_186(iParam2, 2), func_187(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_179(uParam0->f_118[iVar0], func_186(iParam2, 0), func_187(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_203(uParam1->f_118[0], func_201(uParam1), &(uParam1->f_238), func_202(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_205(uParam1->f_118[0], func_204(uParam1), &(uParam1->f_238), func_202(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_203(uParam1->f_118[0], func_201(uParam1), &(uParam1->f_238), 0.5f, func_191(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_205(uParam1->f_118[0], func_204(uParam1), &(uParam1->f_238), 0.5f, func_191(uParam1)))
			{
...
bool func_156(var uParam0, int iParam1, vector3 vParam2)
{
	if (!does_entity_exist(*uParam0))
	{
		*uParam0 = _create_weapon_object(iParam1, 0, vParam2, true, 1f);
	}
	if (!does_entity_exist(*uParam0))
	{
		return false;
...
{
	set_ped_config_flag(*uParam0, 263, true);
	set_ped_config_flag(*uParam0, 16, true);
	set_ped_config_flag(*uParam0, 245, true);
	set_ped_config_flag(*uParam0, 16, true);
	set_ped_config_flag(*uParam0, 17, true);
	set_ped_config_flag(*uParam0, 18, true);
	set_ped_config_flag(*uParam0, 19, true);
	set_ped_config_flag(*uParam0, 6, true);
	set_ped_can_ragdoll(*uParam0, false);
	set_ragdoll_blocking_flags(*uParam0, 524369);
}
...
bool func_192(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_226((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_194(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_227((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_208(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_226((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_210(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_227((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_216(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_230());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_230());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_230());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_231(get_player_team(iVar5)));
	}
