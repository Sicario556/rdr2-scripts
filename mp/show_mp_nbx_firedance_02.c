...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((3 - get_num_reserved_mission_objects(0)));
				return;
			}
...
bool func_21(var uParam0)
{
	if (network_is_host_of_this_script())
	{
		...
		if (!_does_anim_scene_exist(_net_to_anim_scene(uParam0->f_1374)))
		{
			uParam0->f_1373 = _create_anim_scene("script@shows@fire_dancer@act3_p1@action", 2, 0, true, true);
...
bool func_94(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "LOTUS_0", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "LANTERN", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "LOTUS_1", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (network_has_control_of_entity(&(uParam0->f_1408[0])) && !is_entity_dead(&(uParam0->f_1408[0])))
	{
		...
		set_anim_scene_entity(iVar0, "DANCER", &(uParam0->f_1408[0]), 0);
	}
	else
	{
		return false;
...
int func_131(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_171((*uParam0)[iVar0], func_169(iParam2), func_170(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_171(uParam0->f_31[iVar0], func_173(iParam2), func_174(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_171(uParam0->f_107[iVar0], func_176(iParam2), func_177(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_171(uParam0->f_118[0], func_178(iParam2, 0), func_179(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_171(uParam0->f_118[1], func_178(iParam2, 1), func_179(iParam2, 1), 1065353216)) && func_171(uParam0->f_118[2], func_178(iParam2, 2), func_179(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_171(uParam0->f_118[iVar0], func_178(iParam2, 0), func_179(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_132(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_195(uParam1->f_118[0], func_193(uParam1), &(uParam1->f_238), func_194(uParam1), func_183(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_197(uParam1->f_118[0], func_196(uParam1), &(uParam1->f_238), func_194(uParam1), func_183(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_195(uParam1->f_118[0], func_193(uParam1), &(uParam1->f_238), 0.5f, func_183(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_197(uParam1->f_118[0], func_196(uParam1), &(uParam1->f_238), 0.5f, func_183(uParam1)))
			{
...
bool func_184(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_218((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_186(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_219((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_200(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_218((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_202(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_219((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_208(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_222());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_222());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_222());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_223(get_player_team(iVar5)));
	}
...
bool func_229(int iParam0, int iParam1)
{
	...
	{
		return func_232(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
