...
bool func_96(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "BAR", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "CHEST", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "HAMMER", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[3])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "Block", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[4])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "BOOK", &(uParam0->f_1393[4]), 0);
		}
		else
		{
			return false;
