...
bool func_13()
{
	iLocal_13 = (*Global_1887339)[131]->f_5;
	iLocal_14 = _create_volume_aggregate_with_custom_name("Ridgewood - m_volHorsePens");
	_0xbce668aaf83608be(iLocal_14, -4793.275f, -2684.797f, -12.52667f, 0f, 0f, 2.828959f, 21.53875f, 14.61882f, 2.730403f);
	_0x39816f6f94f385ad(iLocal_14, -4827.138f, -2733.15f, -13.91682f, 0f, 0f, 53.75946f, 20.16043f, 53.09112f, 4.69964f);
	return true;
}
...
int func_89(int iParam0, bool bParam1)
{
	...
	if (func_116(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				_0x49a8c2cd97815215(func_91(iParam0));
				func_125(iParam0, 2048);
			}
			_0xfcc6db8dbe709bc8(func_91(iParam0));
		}
		return 0;
	}
	...
	if (_0x800df3fc913355f3(func_91(iParam0)))
	{
		func_125(iParam0, 128);
		return 1;
	}
	func_124(iParam0, _create_persistent_character(func_123(iParam0)));
	_0x4f81ead1de8fa19b(func_91(iParam0));
	if (func_116(iParam0, 2048))
	{
		_0x49a8c2cd97815215(func_91(iParam0));
		func_125(iParam0, 2048);
...
bool func_90(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_91(iParam0));
}
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_141(Global_1915715->f_3[iParam0]->f_21))
	{
...
int func_117(int iParam0, bool bParam1)
{
	...
	func_149(iParam0);
	_0xfc77c5b44d5ff7c0(func_91(iParam0));
	func_124(iParam0, 0);
	return 1;
}
