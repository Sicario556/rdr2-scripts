...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[116]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 26);
	iLocal_20 = _create_volume_aggregate_with_custom_name("Manzanita - m_volGeneralStore Agg");
	_0x39816f6f94f385ad(iLocal_20, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	_0x39816f6f94f385ad(iLocal_20, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	_0x39816f6f94f385ad(iLocal_20, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	_0x39816f6f94f385ad(iLocal_20, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	iLocal_21 = _create_volume_aggregate_with_custom_name("Manzanita - m_volArtistOwner Agg");
	_0x39816f6f94f385ad(iLocal_21, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	_0x39816f6f94f385ad(iLocal_21, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
	_0xb469cfd9e065eb99(iLocal_20, 10106);
	if (func_45() != -1)
	{
	}
	return true;
...
{
	if (func_88(Global_1915715->f_3[iParam0]->f_21) && func_142(Global_1915715->f_3[iParam0]->f_21))
	{
