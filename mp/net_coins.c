...
bool func_8(var uParam0)
{
	...
	{
		if ((get_frame_count() % 5) == 0 && func_28(Global_34, uParam0->f_6, 3f, 1, 1))
		{
			if (!func_29(uParam0))
			{
				func_15(*uParam0, uParam0->f_1);
	...
	switch (func_30(uParam0))
	{
		case 0:
			...
			{
				request_model(uParam0->f_22, false);
			}
		...
		case 1:
			if (has_model_loaded(-1456904552))
			{
				if (func_27(uParam0, 1))
				{
					if (!has_model_loaded(uParam0->f_22))
					{
						return false;
					}
					if (!does_entity_exist(uParam0->f_21))
					{
						uParam0->f_21 = create_object_no_offset(uParam0->f_22, uParam0->f_6, true, true, false, true);
					}
					if (!does_entity_exist(uParam0->f_21))
					{
						return false;
					}
					if (!get_ground_z_and_normal_for_3d_coord(uParam0->f_6 + Vector(1f, 0f, 0f), &(uParam0->f_27), &(uParam0->f_24)))
					{
						return false;
					}
					if (does_entity_exist(uParam0->f_21))
					{
						set_entity_rotation(uParam0->f_21, func_42(uParam0->f_24, 0), 2, true);
					}
				}
				func_32(uParam0, 2);
			}
		...
		case 3:
			if (_is_anim_scene_loaded(uParam0->f_11, true, false))
			{
				...
				if (func_27(uParam0, 1))
				{
					if (does_entity_exist(uParam0->f_21))
					{
						set_anim_scene_entity(uParam0->f_11, "MOUND", uParam0->f_21, 0);
					}
				}
				func_32(uParam0, 4);
			}
		...
		case 5:
			if (func_44(uParam0, 1097859072))
			{
				if (!func_33(uParam0->f_14))
				{
					uParam0->f_14 = func_45("UC_CLT_DIG", -473983589, uParam0->f_6, 1070386381, 3, 1, 0, 4, 570, 4000, 10, 1073741824, 0, 1704213876, 0);
				}
				func_32(uParam0, 6);
			}
			break;
...
{
	func_74((*(*Global_1212893)[iParam0])[iParam1], iParam2);
}
...
bool func_28(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_79(get_entity_coords(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return true;
	}
	return false;
...
void func_37(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (!func_81(*Global_1212889) && get_distance_between_coords(*Global_1212889, vParam1, true) <= 5f)
	{
		bVar0 = true;
	}
...
void func_38(int iParam0)
{
	if (func_33(iParam0))
	{
		...
		if ((((((((_is_ped_carrying(Global_1296859->f_8) || is_ped_getting_up(Global_1296859->f_8)) || is_ped_ragdoll(Global_1296859->f_8)) || !func_90()) || Global_1102219->f_3664) || does_entity_exist(iVar0)) || is_ped_jumping(Global_1296859->f_8)) || is_ped_climbing(Global_1296859->f_8)) || is_ped_falling(Global_1296859->f_8))
		{
...
Vector3 func_42(vector3 vParam0, float fParam3)
{
	...
	fVar14 = (atan2((func_97(vVar8, vVar0) / vmag(vVar8)), (func_97(vVar11, vVar0) / vmag(vVar11))) + 180f);
...
bool func_44(var uParam0, float fParam1)
{
	if (func_80(85134332, 1))
	{
		...
		{
			if ((func_27(uParam0, 2) && func_27(uParam0, 1)) && func_52(get_player_ped(player_id()), uParam0->f_6, 1) <= 1.6f)
			{
				return true;
			}
		}
		if (func_27(uParam0, 2))
		{
			if (func_54(get_player_ped(player_id()), 0, 1, 0) == -862059856 && func_52(get_player_ped(player_id()), uParam0->f_6, 1) <= 1.6f)
			{
				return true;
			}
		}
...
int func_45(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 60)
	{
		if (func_99(iVar0, 2))
		{
			if (func_100(vParam2, (*Global_1951255)[iVar0]->f_6, 0.01f, 1) && iParam1 == (*Global_1951255)[iVar0]->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	if (iVar1 != 0)
	{
		func_101(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
var func_71(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_109());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_109());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_109());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_110(get_player_team(iVar5)));
	}
...
{
	if (func_116(iParam0, iParam1) && (!bParam2 || &Global_1071686->f_22538.f_385[iParam0]->f_1[iParam1] == get_id_of_this_thread()))
	{
...
bool func_90()
{
	if (((((!_0x3ab6c7b0bb0df4b1(Global_34, -1) && !is_ped_using_any_scenario(Global_34)) && !func_127(Global_34, 1369124074)) && !func_127(Global_34, 713668775)) && !_0xec7e480ff8bd0bed(Global_34)) && !is_ped_in_any_vehicle(Global_34, false))
	{
		return true;
	}
	return false;
...
bool func_98(int iParam0)
{
	...
	if (!_0x603ac35fd4602c76(func_132()))
	{
		return false;
	}
	Var0 = func_132();
...
int func_121(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_150(iParam0, -455129387) != 0)
	{
		iVar0 = _0xe787f05dfc977bde(func_151(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = _0xc97e0d2302382211(func_151(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
void func_129(int iParam0, bool bParam1)
{
	if (_uiprompt_is_valid((*Global_1951255)[iParam0]->f_3))
	{
		if ((*Global_1951255)[iParam0]->f_5 == 5 && !func_99(iParam0, 8))
		{
...
{
	*iParam1 = _0x80d78bdc9d88ef07(func_151(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	func_133(uParam0, 143479330);
	if (func_172() == 2026485318)
	{
		func_133(uParam0, 617531372);
	}
	else
	{
		func_133(uParam0, 291123060);
	}
}
...
{
	*iParam1 = _0x640f890c3e5a3ffd(func_151(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<5> func_170(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -1037537535:
			Var0 = { func_171(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_178(iParam0, &Var0, 1728382685, 0, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_178(iParam0, &Var0, -649335959, 0, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_179(iParam0, &Var6, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -1962314949:
			...
			{
				Var0 = { func_171(-1838434463, Var0, 1084182731, bParam1) };
...
struct<4> func_171(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	_0x886dfd3e185c8a89(func_151(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_176(bool bParam0)
{
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1293346 = { func_171(1328661203, func_184(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346->f_12 = { func_171(1328661203, func_184(), -1591664384, 0) };
			}
			return Global_1293346->f_12;
		}
	}
	return func_171(1328661203, func_184(), -1591664384, bParam0);
}
...
bool func_185()
{
	return (func_190(-1185145312, 0, 0, 0) > 0 && func_191(func_171(889965687, func_176(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_186(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_150(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = _0xc97e0d2302382211(func_151(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = _0xe787f05dfc977bde(func_151(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_190(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return _0xe787f05dfc977bde(func_151(bParam1), iParam0, iParam3);
}
