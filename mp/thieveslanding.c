...
bool func_13()
{
	iLocal_19 = _create_volume_box_with_custom_name(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 5.574f, 3.58f, 2.824f, "ThievesLanding - m_volFence");
	iLocal_20 = _create_volume_box_with_custom_name(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 3.27f, 2.497f, 2.824f, "ThievesLanding - m_volFencePrompt");
	func_53(&Local_21, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	Local_21.f_1 = 0;
	Local_21.f_2 = 0;
	return true;
}
...
void func_29(int iParam0)
{
	...
	{
		func_59(4, iLocal_19, iParam0, iLocal_20, 0, 44, 0, 0, -1082130432, 0);
		func_60(4, 0);
	}
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_77(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_97(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_98(Global_1051439->f_72[iParam0]->f_18);
...
void func_63()
{
	if (!Local_21.f_1)
	{
		...
		{
			Local_21.f_3 = _0x66b2b83b94b22458(-1139445608);
			if (does_entity_exist(Local_21.f_3))
			{
				set_entity_visible(Local_21.f_3, false);
				Local_21.f_1 = 1;
			}
		}
	}
	if (!_does_volume_exist(Local_21))
	{
		func_53(&Local_21, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	}
	if (Local_21.f_2)
	{
		if (!func_109(player_ped_id(), Local_21, 0, 1))
		{
	...
	else if (func_109(player_ped_id(), Local_21, 0, 1))
	{
		_disable_water_collision();
		Local_21.f_2 = 1;
	}
...
bool func_68(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_110(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_61(iParam0) && func_85(iParam0, 16777216)) && !Global_1893587->f_9)
	{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_124(&cVar6, 109029619), sVar9, func_124(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_124(&cVar6, 109029619), func_124(&cVar10, 109029619));
		}
...
void func_95(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_148(0);
		func_149(&(Global_1102219->f_3849));
		...
		func_150(&(Global_1102219->f_3888));
	...
	func_151(Global_1102219->f_3849, 36);
	func_152(Global_1102219->f_3888, 36);
}
...
void func_96(int iParam0, bool bParam1)
{
	...
	else if (func_154(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_160(iParam0, 2))
	{
...
int func_98(int iParam0)
{
	...
	{
		Global_1051439->f_4472[iParam0] = func_164(iParam0);
	}
...
void func_107(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_166(uParam1, vParam2, uParam5, 0, 0, 0);
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (!is_string_null_or_empty(&(Global_1893587->f_162)))
	{
		sVar0 = func_170(Global_1893587->f_162);
	}
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_176(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_177(Global_1940018->f_5[iParam0]->f_6, 1);
	func_178(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_89(Global_1915715->f_3[iParam0]->f_21) && func_180(Global_1915715->f_3[iParam0]->f_21))
	{
		func_181(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_182(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	if (func_191(&(Global_1102219->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_201(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_203(12, func_202(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
var func_166(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
{
	func_212(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_190(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_222(&(Global_1102219->f_4), iVar0, 5);
	}
	if (iParam1 == func_223())
	{
		return func_222(&(Global_1102219->f_4), iVar0, 5);
	...
	{
		return func_222(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_205()
{
	...
	if (!func_207(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_209(vector3 vParam0, int iParam3)
{
...
bool func_236(struct<2> Param0, var uParam2)
{
	if (!func_207(Param0))
	{
		return false;
