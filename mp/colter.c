...
bool func_13()
{
	iLocal_13 = _create_volume_cylinder_with_custom_name(-1336.415f, 2442.417f, 307.4014f, 0f, 3.96856f, 32.68665f, 68.62094f, 45.669f, 16.22106f, "Colter - volTown");
	return true;
}
...
{
	if (load_stream("colter", "es_camp_memory_sounds"))
	{
		iLocal_14 = _0x0556c784fa056628("colter", "es_camp_memory_sounds");
...
bool func_40(int iParam0)
{
	if (((func_60(Global_34, iLocal_13, 1, 0) && iLocal_15 < get_game_timer()) && func_62(func_61())) && func_63(6, 18))
	{
		...
		set_ambient_zone_state("AZ_camp_colter_Endless_Summer", true, true);
		bLocal_16 = true;
		iLocal_15 = get_game_timer() + 30000;
	}
	if (bLocal_16)
	{
		...
		{
			set_ambient_zone_state("AZ_camp_colter_Endless_Summer", false, true);
			bLocal_16 = false;
		}
	}
	return true;
