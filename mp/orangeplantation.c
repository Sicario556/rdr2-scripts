		...
		if (get_game_timer() > iLocal_30)
		{
			...
			switch (iLocal_29)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_32 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_29 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_32 < get_game_timer())
					{
						bLocal_33 = false;
						iLocal_29 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_31));
					Global_1896620 = -1;
					iLocal_32 = (iLocal_28 + get_game_timer());
					iLocal_29 = 3;
					break;
				case 3:
					if (func_13() || iLocal_32 < get_game_timer())
					{
						func_14(iLocal_31);
						iLocal_32 = (iLocal_28 + get_game_timer());
						iLocal_29 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_31) || iLocal_32 < get_game_timer())
					{
						func_16(iLocal_31);
						iLocal_32 = (get_game_timer() + iLocal_28);
						iLocal_29 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_31) || iLocal_32 < get_game_timer())
					{
						func_18(iLocal_31);
						iLocal_32 = (iLocal_28 + get_game_timer());
						iLocal_29 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_31)))
					{
						if (func_19(func_9(iLocal_31), 4) && !iLocal_32 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_31) || iLocal_32 < get_game_timer())
							{
								func_21(iLocal_31, 4);
								iLocal_32 = (iLocal_28 + get_game_timer());
								iLocal_29 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_31]->f_11);
							if ((*Global_1887339)[iLocal_31]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_31]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_31]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_31]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_13 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volTown Agg");
	_0xbce668aaf83608be(iLocal_13, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 69.6883f, 50.95198f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 49.04269f, 28.47917f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583631f, 30.73095f, 51.93652f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76538f, 38.38671f, 59.01843f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 38.38671f, 37.38729f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 11.55689f, 14.41201f, 15.9332f);
	_0x39816f6f94f385ad(iLocal_13, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644386f, 138.1747f, 21.08713f, 16.54283f);
	_0xbce668aaf83608be(iLocal_13, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 8.372574f, 17.93935f, 18.54283f);
	_0x39816f6f94f385ad(iLocal_13, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 15.22373f, 31.89837f, 18.54283f);
	if (!network_is_game_in_progress())
	{
		iLocal_16 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volThreat Agg");
		_0x39816f6f94f385ad(iLocal_16, 2065.472f, -851.4658f, 42.55719f, 0f, 0f, 0f, 19.02366f, 13.64085f, 16.67954f);
		_0x39816f6f94f385ad(iLocal_16, 2019.272f, -774.1213f, 41.40026f, 0f, 0f, 37.13808f, 9.83179f, 10.20259f, 16.67954f);
		_0x39816f6f94f385ad(iLocal_16, 2013.173f, -774.8469f, 41.40026f, 0f, 0f, 37.13808f, 4.350712f, 4.302257f, 16.67954f);
		iLocal_14 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_14, iLocal_16);
		_0xbce668aaf83608be(iLocal_14, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 36.89741f, 35.70032f, 15.9332f);
		_0xbce668aaf83608be(iLocal_14, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76539f, 36.89741f, 57.33146f, 15.9332f);
		_0xbce668aaf83608be(iLocal_14, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 10.22549f, 13.5511f, 15.9332f);
		_0xbce668aaf83608be(iLocal_14, 1998.531f, -853.2407f, 44.706f, 0f, 0f, 0f, 45.40543f, 35.23671f, 15.9332f);
		_0xbce668aaf83608be(iLocal_14, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 6.372574f, 15.93935f, 16.54283f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Orange Plantation - m_volWarning Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_14);
		_0xbce668aaf83608be(iLocal_15, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 68.19901f, 49.26501f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583632f, 29.24165f, 50.24955f, 15.9332f);
		_0xbce668aaf83608be(iLocal_15, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 47.55339f, 26.7922f, 15.9332f);
		_0x39816f6f94f385ad(iLocal_15, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644384f, 136.6854f, 19.40016f, 15.9332f);
		_0x39816f6f94f385ad(iLocal_15, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 13.22373f, 29.89837f, 16.54283f);
		sLocal_17 = "ORANGE_PLANTATION";
		_create_guard_zone(sLocal_17);
		_0x8c598a930f471938(sLocal_17, iLocal_13);
		_0x35815f372d43e1e5(sLocal_17, iLocal_14);
		_0xad3e07c37a7c1adc(sLocal_17, iLocal_15);
		_0xa1b0e6301e2e02a6(sLocal_17, iLocal_16);
		_set_guard_zone_position(sLocal_17, 2066.902f, -851.1766f, 43.3946f);
		_0xa8a74aa79fb67159(sLocal_17, iLocal_13);
	}
	return true;
}
...
bool func_40(int iParam0)
{
	if (!bLocal_21)
	{
		if (does_entity_exist(iLocal_19))
		{
			...
			{
				if (!decor_exist_on(iLocal_19, "HAS_VOICE") || !decor_get_bool(iLocal_19, "HAS_VOICE"))
				{
					decor_set_bool(iLocal_19, "HAS_VOICE", true);
					set_ambient_voice_name(iLocal_19, "0941_A_M_M_Foreman_White_AVOID_01");
					bLocal_21 = true;
				}
			}
		}
	...
	if (!bLocal_20)
	{
		if (does_entity_exist(iLocal_18))
		{
			...
			{
				if (!decor_exist_on(iLocal_18, "HAS_VOICE") || !decor_get_bool(iLocal_18, "HAS_VOICE"))
				{
					decor_set_bool(iLocal_18, "HAS_VOICE", true);
					set_ambient_voice_name(iLocal_18, "0946_A_M_M_Guard_White_AGGRESSIVE_01");
					bLocal_20 = true;
				}
			}
		}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
bool func_66(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_93(iParam0));
}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_107(&cVar6, 109029619), sVar9, func_107(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_107(&cVar6, 109029619), func_107(&cVar10, 109029619));
		}
...
void func_78(int iParam0)
{
	...
	{
		decor_set_bool(iLocal_19, "HAS_VOICE", false);
	}
	if (func_113(iLocal_18, 0))
	{
		decor_set_bool(iLocal_18, "HAS_VOICE", false);
	}
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_137(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_139(Global_1940018->f_5[iParam0]->f_6, 1);
	func_140(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_142(Global_1915715->f_3[iParam0]->f_21))
	{
		func_143(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_144(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_147(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_123(int iParam0, bool bParam1)
{
	...
	else if (func_157(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_147(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_161(iParam0, 2))
	{
...
{
	func_169(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_180(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
