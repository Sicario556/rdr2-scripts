...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((8 - get_num_reserved_mission_objects(0)));
				return;
			}
			if (get_num_reserved_mission_peds(0) < uParam0->f_23)
			{
				reserve_network_mission_peds((4 - get_num_reserved_mission_peds(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
bool func_21(var uParam0)
{
	if (network_is_host_of_this_script())
	{
		...
		if (!_does_anim_scene_exist(_net_to_anim_scene(uParam0->f_1374)))
		{
			uParam0->f_1373 = _create_anim_scene("script@shows@band_play@p1_and_p2", 2, func_87(0), true, true);
...
bool func_95(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "p_benchpiano02x", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "p_benchPiano02x^1", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "p_cs_contrabass01x", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[3])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "p_cs_drumkit01x", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[4])))
	{
		if (func_153(uParam0->f_1393[4], &(uParam0->f_1385[3]), func_152(4)))
		{
			set_anim_scene_entity(iVar0, "p_drumstick01x", &(uParam0->f_1393[4]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[5])))
	{
		if (func_153(uParam0->f_1393[5], &(uParam0->f_1385[3]), func_152(5)))
		{
			set_anim_scene_entity(iVar0, "p_drumstick01x^1", &(uParam0->f_1393[5]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[6])))
	{
		if (func_153(uParam0->f_1393[6], &(uParam0->f_1385[4]), func_152(6)))
		{
			set_anim_scene_entity(iVar0, "p_piano01x", &(uParam0->f_1393[6]), 0);
		}
		else
		{
			return false;
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_162(&((*uParam1)[uParam2->f_1]->f_17), 32);
			break;
		case 32:
			if (uParam0->f_1 > 32)
			{
				func_162(&((*uParam1)[uParam2->f_1]->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_162(&((*uParam1)[uParam2->f_1]->f_17), 34);
			}
			break;
		case 34:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > 0.978f)
			{
				func_162(&((*uParam1)[uParam2->f_1]->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_162(&((*uParam1)[uParam2->f_1]->f_17), 40);
			break;
		case 40:
			break;
	}
...
int func_132(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_174((*uParam0)[iVar0], func_172(iParam2), func_173(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_174(uParam0->f_31[iVar0], func_176(iParam2), func_177(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_174(uParam0->f_107[iVar0], func_179(iParam2), func_180(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_174(uParam0->f_118[0], func_181(iParam2, 0), func_182(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_174(uParam0->f_118[1], func_181(iParam2, 1), func_182(iParam2, 1), 1065353216)) && func_174(uParam0->f_118[2], func_181(iParam2, 2), func_182(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_174(uParam0->f_118[iVar0], func_181(iParam2, 0), func_182(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_198(uParam1->f_118[0], func_196(uParam1), &(uParam1->f_238), func_197(uParam1), func_186(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_200(uParam1->f_118[0], func_199(uParam1), &(uParam1->f_238), func_197(uParam1), func_186(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_198(uParam1->f_118[0], func_196(uParam1), &(uParam1->f_238), 0.5f, func_186(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_200(uParam1->f_118[0], func_199(uParam1), &(uParam1->f_238), 0.5f, func_186(uParam1)))
			{
...
bool func_232(int iParam0, int iParam1)
{
	...
	{
		return func_235(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
