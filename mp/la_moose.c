...
void func_1(int iParam0)
{
	...
	func_8();
	func_9();
	network_register_host_broadcast_variables(&Local_13, 36, 56);
	func_10(_0xba24095ea96dfe17(&Local_13), 36, "m_hostData");
	network_register_player_broadcast_variables(&Local_49, 449, 57);
	func_11(_0x690806bc83bc8ca2(Local_49[0]), 449, "m_clientData");
	func_12(0);
...
{
	iVar0 = 255;
	_copy_memory(&Local_498, uParam0, 5);
...
void func_34()
{
	if (func_109())
	{
		switch (func_110())
		{
			case 2:
				...
				func_112(0, iVar0, iVar0 != -333019452, -1082130432);
				break;
			case 3:
	...
	func_116();
	func_117();
	Local_498.f_161.f_12[0] = _create_volume_box(-997.78f, 1720.82f, 257.49f, 0f, 0f, 0f, 60f, 63.5f, 73.75f);
	Local_498.f_161.f_12[1] = _create_volume_box(-1125.47f, 1604.94f, 257.49f, 0f, 0f, -20f, 83f, 62f, 95.75f);
	Local_498.f_161.f_12[2] = _create_volume_box(-918.85f, 1689.64f, 257.49f, 0f, 0f, -49.75f, 83f, 62f, 97.5f);
	_0x19c7567d2f2287d6(&(Local_498.f_161.f_12[0]), 7);
	_0x19c7567d2f2287d6(&(Local_498.f_161.f_12[1]), 7);
	_0x19c7567d2f2287d6(&(Local_498.f_161.f_12[2]), 7);
	Local_498.f_161.f_1 = participant_id_to_int();
}
...
void func_42()
{
	iVar0 = Global_1198046->f_231.f_1066[Local_498.f_12]->f_5;
...
void func_43()
{
	...
	{
		clear_area(Local_498.f_15, Var0.f_10, 2442122);
		func_121(2);
	}
	else if (bVar31)
	{
...
void func_48()
{
	...
	if (func_131(512))
	{
		if (func_64(64) && func_122(player_id()) == Local_13.f_6)
		{
			func_65(Local_13.f_6);
			func_143(64);
		}
...
void func_108()
{
	...
	while (iVar1 < 32)
	{
		...
		while (iVar0 < 4)
		{
			Local_49[iVar1]->f_7.f_2[iVar0] = -1f;
			iVar0++;
		}
		iVar1++;
	}
...
void func_116()
{
	...
	if (!func_109())
	{
		...
		{
			iVar0 = 3;
			func_213(iVar0, 1784941179);
			func_217(iVar0, func_215(), func_216(), 1);
		}
		if (func_110() == 0)
		{
			iVar0 = 1;
			func_213(iVar0, -1098441944);
			func_217(iVar0, func_215(), func_216(), 1);
		}
		iVar0 = 2;
		while (iVar0 <= 2)
...
void func_117()
{
	...
	func_231(&(Local_498.f_106), 1106247680);
...
bool func_124(int iParam0)
{
	...
	return (func_238(iParam0) && (*Global_1131196)[iParam0]->f_18.f_1 != 0);
}
...
bool func_126(struct<31> Param0, var uParam31)
{
	...
	{
		if (_0x397769175a7dbb30(Local_498.f_15, Param0.f_10, 0, 0, 0))
		{
			_0xfa15c9a320e707b0();
			*uParam31 = 1;
			return false;
...
bool func_130(int iParam0, int iParam1)
{
	...
	return func_177(&(Local_49[iParam1]), iParam0);
}
...
bool func_140()
{
	if (does_entity_exist(func_248(0)))
	{
		func_249(get_entity_coords(func_248(0), true, false));
	}
	if (func_109())
	{
		return false;
...
int func_144(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_212(&((*Global_1134390)[iVar1]->f_70.f_1), 1);
	}
	else
	{
...
{
	if (func_177(&(Local_49[participant_id_to_int()]), iParam0))
	{
		func_251(Local_49[participant_id_to_int()], iParam0);
	}
}
...
void func_147(int iParam0)
{
	...
	{
		func_237(Local_49[participant_id_to_int()], iParam0);
	}
}
...
{
	func_265();
	func_266(&(Local_498.f_53), 0, func_215(), 1112014848);
...
void func_162()
{
	...
	{
		fVar0 = vdist(get_entity_coords(player_ped_id(), false, false), Local_498.f_15);
		if (fVar0 < 200f)
		{
			func_147(4096);
		}
...
void func_167()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_498.f_5 = (Local_498.f_5 || Local_49[iVar0]) // PointerArith;
			Local_498.f_6 = (Local_498.f_6 && Local_49[iVar0]) // PointerArith;
		}
		iVar0++;
	}
}
...
{
	if (does_blip_exist(Local_498.f_177.f_7[iParam0]->f_1))
	{
		remove_blip(&(Local_498.f_177.f_7[iParam0]->f_1));
	}
}

bool func_171(int iParam0, int iParam1)
{
	return func_177(Local_498.f_177.f_7[iParam0]->f_2, iParam1);
}
...
void func_172()
{
	...
	if ((does_entity_exist(Local_498.f_53) && is_entity_dead(Local_498.f_53)) || Local_498.f_53.f_2 == 12)
	{
		return;
	}
	if (func_283(16))
...
void func_179()
{
	clear_sequence_task(&(Local_498.f_161.f_9));
	if (network_is_host_of_this_script())
	{
	}
}
...
{
	Local_498.f_177.f_7[iParam0]->f_3 = iParam1;
}

void func_214(int iParam0, int iParam1)
{
	Local_498.f_177.f_7[iParam0]->f_4 = iParam1;
}
...
{
	Local_498.f_177.f_7[iParam0]->f_6 = { vParam1 };
	Local_498.f_177.f_7[iParam0]->f_5 = fParam4;
	if (bParam5)
	{
		func_237(&(Local_498.f_177.f_7[iParam0]->f_2), 2);
	}
	else
	{
		func_251(&(Local_498.f_177.f_7[iParam0]->f_2), 2);
	}
}

void func_218(int iParam0)
{
	set_bit(&(Local_498.f_19), iParam0);
}
...
{
	return &(Local_498.f_177.f_7[iParam0]);
}
...
bool func_261()
{
	...
	while (iVar0 < 4)
	{
		if (is_bit_set(Local_498.f_177.f_3, iVar0))
		{
		}
		else
		{
			...
			{
				if (!is_bit_set(Local_498.f_177.f_4, iVar0))
				{
					request_model(iVar2, false);
					set_bit(&(Local_498.f_177.f_4), iVar0);
				}
				...
				{
					set_bit(&(Local_498.f_177.f_3), iVar0);
				}
			}
		}
		iVar0++;
...
void func_263(struct<2> Param0)
{
	...
	else if (!_0x01f4d242765c6b24(func_288(Param0)))
	{
		_0x99230691875fc218(func_286(Param0), func_288(Param0), Global_35);
	}
}
...
{
	iVar0 = iParam0;
	set_bit(&(Local_498.f_53.f_50), iVar0);
}
...
void func_273()
{
	...
	bVar7 = false;
	bVar8 = false;
	if (network_is_in_mp_cutscene() != Local_498.f_177.f_68)
	{
		bVar8 = true;
	...
	while (iVar0 < 1)
	{
		...
		iVar1 = &Local_498.f_177.f_7[iVar0];
		...
		if (bVar4)
		{
			if (&Local_49[iVar3]->f_7.f_2[iVar0] > -1f)
			{
				Local_49[iVar3]->f_7.f_2[iVar0] = -1f;
			}
			if (is_bit_set(Local_498.f_177.f_5, iVar0))
			{
				clear_bit(&(Local_498.f_177.f_5), iVar0);
				clear_bit(&(Local_498.f_177.f_6), iVar0);
				clear_bit(&(Local_498.f_177.f_53), iVar0);
			}
		}
		else
		{
		...
		if (is_bit_set(Local_498.f_177.f_53, iVar0))
		{
			if (bVar4 || !bVar7)
			{
				clear_bit(&(Local_498.f_177.f_53), iVar0);
		...
		else if (!bVar4)
		{
			if (bVar7)
			{
				set_bit(&(Local_498.f_177.f_53), iVar0);
			}
		}
		if (!bVar4)
		{
			...
			{
				if (!is_bit_set(Local_49[iVar3]->f_7.f_1, iVar0))
				{
					set_bit(&(Local_49[iVar3]->f_7.f_1), iVar0);
				}
				func_341(Local_498.f_177.f_54[iVar0]);
			}
		}
		if (is_bit_set(Local_49[iVar3]->f_7.f_1, iVar0))
		{
			if (bVar4 || (!is_any_speech_playing(iVar1) && (!func_342(Local_498.f_177.f_54[iVar0]) || func_343(Local_498.f_177.f_54[iVar0], 0.5f))))
			{
				func_344(Local_498.f_177.f_54[iVar0]);
				clear_bit(&(Local_49[iVar3]->f_7.f_1), iVar0);
			}
		}
		if ((!bVar4 && bVar8) && func_171(iVar9, 256))
		{
			set_entity_visible_in_cutscene(iVar1, Local_498.f_177.f_68, 0, 256);
		}
		if (func_171(iVar9, 4))
		{
			if (bVar4)
...
{
	bVar0 = true;
	if (bVar0 && !_unlock_is_unlocked(Local_498.f_14))
	{
		return false;
	}
	if (func_362())
...
void func_278(int iParam0, int iParam1)
{
	...
	if (!func_364(&(Local_498.f_53), 128))
	{
		...
		{
			func_367(iParam0, func_366(get_entity_model(iParam0)), iParam1, &(Local_498.f_53));
...
bool func_282(int iParam0, int iParam1)
{
	...
	return func_236(Local_49[iParam1]->f_4, iParam0);
}
...
bool func_317(int iParam0, bool bParam1, bool bParam2)
{
	fVar0 = 0f;
	vVar1 = { 0f, 0f, 0f };
	...
	*bParam2 = 0;
	if (iVar8 != 0)
	{
		if (!network_does_network_id_exist(&(Local_13.f_31[iParam0])))
		{
			...
			if (!func_177(Local_498.f_177.f_7[iParam0]->f_2, 2))
			{
				vVar1 = { _get_object_offset_from_coords(vVar4, 0f, func_385(iParam0)) };
			}
			else
			{
				vVar1 = { func_385(iParam0) };
			}
			if (!func_386(Local_13.f_31[iParam0], iVar8, vVar1, fVar0, 1, 0, (iVar9 == 0 || _is_this_model_a_horse(iVar8)), 1, 1))
			{
				*bParam1 = 1;
			}
			else
...
int func_319(var uParam0, var uParam1)
{
	...
	switch (uParam0->f_2)
	{
		...
		case 7:
			break;
		case 1:
			if (is_ped_using_any_scenario(func_390(uParam1->f_1)))
			{
				func_392(uParam0, 2);
			}
			break;
		...
		case 11:
			...
			if ((func_399(uParam1, 32) && is_ped_fleeing(iVar0)) && func_400(&(uParam0->f_6)) > 10f)
			{
				iVar1 = func_401(iVar0);
				if (does_entity_exist(iVar1))
				{
					if ((func_365(iVar1, iVar0, 15f, 1, 1) || (func_365(iVar1, iVar0, 40f, 1, 1) && is_ped_shooting(iVar1))) || func_402(64))
					{
						func_403(uParam0, 1);
						func_392(uParam0, 8);
					}
...
{
	return Local_498.f_177.f_7[iParam0]->f_3;
}
...
void func_326(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!is_bit_set(Local_498.f_177.f_5, iParam0))
	{
		if (network_does_network_id_exist(&(Local_13.f_31[iParam0])))
		{
			...
			Local_498.f_177.f_7[iParam0] = iVar1;
			if (bVar3)
			{
				if (is_entity_dead(iVar1) || is_entity_dead(player_ped_id()))
				{
					Local_49[iParam1]->f_7.f_2[iParam0] = -1f;
				}
				else
				{
					Local_49[iParam1]->f_7.f_2[iParam0] = vdist(get_entity_coords(iVar1, true, false), get_entity_coords(player_ped_id(), true, false));
				}
			}
			if (network_is_host_of_this_script())
			{
			...
			if (does_entity_exist(iVar1))
			{
				...
				set_bit(&(Local_498.f_177.f_5), iParam0);
				if (bParam2)
				{
					func_417(iParam0);
				}
...
{
	Local_498.f_151.f_5 = func_366(get_entity_model(iParam0));
...
void func_328(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_421(*iParam0);
		set_entity_coords(*iParam0, get_entity_coords(*iParam0, true, false) - Vector(60f, 0f, 0f), true, false, true, true);
	}
}
...
void func_330()
{
	iVar0 = func_248(0);
	iVar1 = func_248(3);
	attach_entity_to_entity(iVar1, iVar0, get_ped_bone_index(iVar0, 14412), 0f, -0.25f, 0f, 0f, 90f, -90f, true, true, false, true, 2, true, false, false);
}

void func_331(int iParam0, int iParam1)
{
	func_237(&(Local_498.f_177.f_7[iParam0]->f_2), iParam1);
}

char* func_332(int iParam0)
{
	iVar0 = func_366(get_entity_model(iParam0));
	switch (iVar0)
	{
		case 0:
...
void func_338(int iParam0, bool bParam1, int iParam2)
{
	if (bParam1)
	{
		Local_498.f_177.f_2 = (Local_498.f_177.f_2 || Local_49[iParam0]->f_7);
		Local_498.f_177.f_1 = (Local_498.f_177.f_1 && Local_49[iParam0]->f_7);
		Local_498.f_177.f_6 = (Local_498.f_177.f_6 || Local_49[iParam0]->f_7.f_1);
	}
}
...
int func_340(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	Local_49[iParam3]->f_7.f_2[iParam2] = fVar0;
	if (fVar0 > Local_498.f_177.f_7[iParam2]->f_9)
	{
		return 0;
	}
	return 1;
...
{
	func_251(&(Local_498.f_177.f_7[iParam0]->f_2), iParam1);
}
...
bool func_347(int iParam0, int iParam1)
{
	...
	return func_177(Local_49[iParam1]->f_7, iParam0);
}
...
void func_348(int iParam0)
{
	...
	func_237(&(Local_49[iVar0]->f_7), iParam0);
}
...
void func_349(int iParam0)
{
	...
	func_251(&(Local_49[iVar0]->f_7), iParam0);
}
...
void func_350()
{
	...
	while (iVar0 <= (network_get_max_num_participants() - 1))
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_498.f_151.f_1 = (Local_498.f_151.f_1 || Local_49[iVar0]->f_4);
			Local_498.f_151.f_2 = (Local_498.f_151.f_2 && Local_49[iVar0]->f_4);
			Local_498.f_25.f_22 = (Local_498.f_25.f_22 || Local_49[iVar0]->f_5);
			Local_498.f_25.f_23 = (Local_498.f_25.f_23 && Local_49[iVar0]->f_5);
			Local_498.f_53.f_52 = (Local_498.f_53.f_52 || Local_49[iVar0]->f_1);
			Local_498.f_53.f_51 = (Local_498.f_53.f_51 && Local_49[iVar0]->f_1);
		}
		iVar0++;
	}
}
...
void func_351()
{
	...
	if (is_bit_set(Local_498.f_151.f_3, Local_498.f_151.f_4))
	{
		return;
	}
	if (!does_entity_exist(iVar0))
...
void func_353(var uParam0)
{
	...
	else if (!func_236(uParam0->f_2, 4))
	{
		...
		if (func_236(uParam0->f_2, 1) && does_entity_exist(*uParam0))
		{
			Var3 = { func_424(1368284188, -1530824760) };
...
void func_354(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_437() && func_438(uParam1->f_1, 40f, 60f, 100f, 1065353216, 5, 0, 1))
	{
		func_439();
	}
	if (!func_393())
	...
	if (!func_399(uParam1, 8) && func_393())
	{
		...
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)) && func_444(4, -1))
			{
	...
	switch (uParam0->f_2)
	{
		case 0:
			if (!func_444(1, -1))
			{
				...
				while (iVar1 <= 3)
				{
					iVar2 = &Local_498.f_177.f_7[iVar1];
		...
		case 7:
			...
			{
				if (func_455(uParam1->f_16) || _0xb89fcff19dafff28(uParam1->f_16, &(uParam1->f_14)))
				{
		...
		case 1:
			if (bVar3 && !is_ped_using_any_scenario(iVar0))
			{
				if (func_399(uParam1, 1))
				{
					...
					{
						task_start_scenario_at_position(iVar0, uParam1->f_3, Local_498.f_177.f_7[uParam1->f_1]->f_6, Local_498.f_177.f_7[uParam1->f_1]->f_5, 0, false, true, 0, -1f, false);
					}
				}
				else
				{
		...
		case 3:
			...
			{
				task_wander_in_area(iVar0, Local_498.f_177.f_7[uParam1->f_1]->f_6, uParam1->f_26, 1077936128, 1086324736, 0);
			}
			break;
		case 4:
			break;
		...
		case 9:
			...
			break;
		case 11:
			if ((!is_entity_dead(iVar0) && !get_ped_config_flag(iVar0, 580, true)) && !func_444(64, -1))
			{
				if (func_365(Global_34, iVar0, 15f, 1, 1) || (func_365(Global_34, iVar0, 40f, 1, 1) && is_ped_shooting(Global_34)))
				{
					func_454(64);
				}
			}
			...
			{
				if (!func_365(Global_34, iVar0, 40f, 1, 1) || get_ped_config_flag(iVar0, 580, true))
				{
					func_459(64);
				}
			}
			...
			if ((!func_402(32) && bVar3) && is_ped_in_combat(iVar0, 0))
			{
				if (is_entity_dead(get_player_ped(uParam1->f_20)) || !func_365(get_player_ped(uParam1->f_20), iVar0, 100f, 1, 1))
				{
...
void func_355()
{
	...
	if (!does_entity_exist(Local_498.f_53))
	{
		return;
	}
	if (is_entity_dead(Local_498.f_53))
	{
		return;
	}
		...
		case 1:
			...
			else if (uParam0->f_16 == -1 || uParam0->f_43 < uParam0->f_16)
			{
				if (!func_342(&(uParam0->f_46)) || func_427(&(uParam0->f_46)) > uParam0->f_17)
				{
					...
					{
						vVar3 = { func_472(get_entity_coords(*uParam0, true, false), uParam0->f_20, 0f) };
...
int func_357(var uParam0)
{
	...
	{
		if ((!func_460(2, -1) && !is_entity_dead(*uParam0)) && is_ped_fleeing(*uParam0))
		{
			func_465(2);
		}
	...
	if (func_364(uParam0, 64) && does_blip_exist(uParam0->f_42))
	{
	...
	if (((uParam0->f_2 < 3 && Local_13.f_18.f_1) && does_entity_exist(*uParam0)) && !func_484(*uParam0))
	{
		func_479(uParam0, 3);
		func_448(uParam0);
		func_449(uParam0);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			...
			{
				uParam0->f_42 = _blip_add_for_coord(func_486(), uParam0->f_39);
		...
		case 2:
			...
			while (iVar1 <= 3)
			{
				...
				if ((does_entity_exist(iVar0) && is_bit_set(uParam0->f_50, iVar1)) && func_438(iVar1, uParam0->f_22, uParam0->f_23, uParam0->f_24, 1065353216, 5, 0, 1))
				{
					func_448(uParam0);
				}
				else
			...
			iVar0 = *uParam0;
			if (does_entity_exist(iVar0) && func_438(uParam0->f_49, uParam0->f_22, uParam0->f_23, uParam0->f_24, 1065353216, 5, 0, 1))
			{
				func_448(uParam0);
			}
		...
		case 7:
			...
			else if (func_427(&(uParam0->f_46)) > (uParam0->f_29 + ((vdist(Global_35, get_entity_coords(*uParam0, true, false)) / 25f) * uParam0->f_30)) || ((func_342(&(Local_498.f_19.f_3)) && func_427(&(Local_498.f_19.f_3)) < Global_1901947->f_852.f_4) && func_427(&(uParam0->f_46)) > 2f))
			{
...
void func_358(int iParam0)
{
	...
	if ((Local_13.f_18 == 255 && !func_391(2)) || (Local_13.f_18 != 255 && Local_13.f_18 != player_id()))
	{
...
void func_360(int iParam0)
{
	...
	if (!func_391(16))
	{
		if (is_entity_dead(iParam0) && get_ped_index_from_entity_index(func_497(Global_34)) == iParam0)
		{
			func_498();
			func_494(16);
		}
...
void func_361(int iParam0, float fParam1)
{
	...
	if (((!func_391(4) && (get_frame_count() % 10) == 0) && does_entity_exist(Local_498.f_53)) && _0x920684be432875b1(Local_498.f_53))
	{
		func_494(4);
	}
	...
	if (!func_391(128))
	{
		if (((((func_391(8) || func_391(16)) || func_391(4)) || func_283(8)) || (func_283(2) && is_entity_dead(iParam0))) || (is_entity_dead(iParam0) && !_0xa4b6432e3880f2f9(iParam0)))
		{
			func_494(128);
		}
	}
...
bool func_365(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	else if (func_503(get_entity_coords(iParam0, bParam3, false), get_entity_coords(iParam1, bParam3, false)) <= (fParam2 * fParam2))
	{
		return true;
	}
	return false;
...
void func_367(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		set_blip_name_from_text_file(uParam3->f_1, func_505(iParam1, iParam2));
	}
}
...
bool func_369()
{
	...
	if (Local_49[iVar1]->f_2.f_1 != 0)
	{
	}
	Local_49[iVar1]->f_2.f_1 = get_network_time_accurate();
	return true;
}
...
void func_371(int iParam0)
{
	...
	switch (Local_498.f_19.f_2)
	{
		case 0:
			if (Local_49[iVar1]->f_2.f_1 != 0)
			{
				Local_498.f_19.f_1 = player_ped_id();
				if (func_506())
				{
...
int func_378(int iParam0)
{
	...
	{
		iVar0 = ((func_510() - _0xe13634bb6baf0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
{
	return Local_498.f_177.f_7[iParam0]->f_4;
}

float func_384(int iParam0)
{
	return Local_498.f_177.f_7[iParam0]->f_5;
}

Vector3 func_385(int iParam0)
{
	return Local_498.f_177.f_7[iParam0]->f_6;
}
...
bool func_395(var uParam0, var uParam1)
{
	...
	set_anim_scene_entity(uParam1->f_16, &(uParam1->f_14), func_390(uParam1->f_1), 0);
	func_514(uParam1->f_16);
	set_anim_scene_origin(uParam1->f_16, Local_498.f_177.f_7[uParam1->f_1]->f_6, 0f, 0f, Local_498.f_177.f_7[uParam1->f_1]->f_5, 2);
...
{
	return (to_float(func_516(uParam0)) * 0.001f);
}

int func_401(int iParam0)
{
	return get_player_ped(func_517(iParam0));
}
...
{
	return func_518(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
{
	iVar0 = func_248(0);
	if (get_ped_config_flag(iVar0, 580, true) && Local_13.f_24.f_1 < 9)
	{
		func_519(9);
	}
	if (is_entity_dead(iVar0) && Local_13.f_24.f_1 < 8)
	{
		func_519(8);
	}
	switch (Local_13.f_24.f_1)
	{
		...
		case 3:
			break;
		case 4:
			if (func_520(4) || is_entity_dead(func_248(1)))
			{
...
{
	func_370(1);
	if (_network_has_control_of_anim_scene(Local_498.f_161.f_7))
	{
		set_anim_scene_bool(Local_498.f_161.f_7, "bStopLoop", true, false);
	}
	if (network_is_host_of_this_script() && Local_13.f_24.f_1 == 3)
	{
		func_519(4);
	}
	if (func_110() == 0)
...
void func_408(int iParam0)
{
	...
	iVar0 = func_248(0);
	iVar1 = func_248(2);
	iVar3 = get_player_ped(Local_498.f_161.f_11);
	if (func_110() == 0)
	{
		iVar2 = func_248(0);
	}
	...
	if (network_has_control_of_entity(iVar2) && is_ped_using_any_scenario(iVar2))
	{
		_0x463803429297117c(iVar2, get_entity_coords(iVar3, true, false), 3, 0);
	}
	if (network_has_control_of_entity(iVar1))
	{
		if (is_ped_using_any_scenario(iVar1))
		{
			_0x463803429297117c(iVar1, get_entity_coords(iVar3, true, false), 3, 0);
		}
		_task_smart_flee_style_ped(func_248(2), iVar3, 3, 67117056, -1082130432, -1, 0);
	}
	if (func_110() == 0)
	{
		if (func_520(4))
		...
		else if (_network_has_control_of_anim_scene(Local_498.f_161.f_7) && _is_anim_scene_started(Local_498.f_161.f_7, false))
		{
			set_anim_scene_rate(Local_498.f_161.f_7, 1.25f);
		}
	}
	else
	{
		if (network_has_control_of_entity(iVar2))
		{
			_task_smart_flee_style_ped(iVar2, iVar3, 3, 67117568, 250f, -1, 0);
		}
		if (network_is_host_of_this_script())
		{
			func_519(8);
	...
	iVar4 = func_248(3);
	if ((does_entity_exist(iVar4) && !is_entity_dead(iVar4)) && network_has_control_of_entity(iVar4))
	{
		if (is_entity_attached(iVar4))
		{
			detach_entity(iVar4, true, true);
		}
		task_fly_away(iVar4, iVar2);
		force_ped_motion_state(iVar4, -1299979036, false, 0, false);
	}
	if (func_110() != 0)
	{
	}
...
void func_409(int iParam0)
{
	...
	if (network_has_control_of_entity(iVar1) && is_ped_using_any_scenario(iVar1))
	{
		_0x463803429297117c(iVar1, get_entity_coords(get_player_ped(Local_498.f_161.f_11), true, false), 3, 0);
	}
	if (network_has_control_of_entity(iVar2))
	{
		if (is_ped_using_any_scenario(iVar2))
		{
			_0x463803429297117c(iVar2, get_entity_coords(get_player_ped(Local_498.f_161.f_11), true, false), 3, 0);
		}
		_task_smart_flee_style_ped(func_248(2), iVar3, 3, 67117056, -1082130432, -1, 0);
	}
	if (func_110() == 0)
	{
		if (_network_has_control_of_anim_scene(Local_498.f_161.f_7) && _is_anim_scene_started(Local_498.f_161.f_7, false))
		{
			set_anim_scene_rate(Local_498.f_161.f_7, 1.5f);
		}
	}
	else
	{
		if (network_has_control_of_entity(iVar1))
		{
			if (func_110() == 0 || is_ped_in_any_vehicle(iVar3, false))
			{
				_task_smart_flee_style_ped(iVar1, iVar3, 3, 67117568, 250f, -1, 0);
			}
			else if (is_ped_on_mount(iVar3))
			{
				task_combat_ped(iVar1, iVar3, 0, 0);
			}
			else if (!func_365(iVar1, iVar3, 50f, 1, 1))
			{
				task_follow_to_offset_of_entity(iVar1, iVar3, 0f, 0f, 0f, 2f, -1, 1036831949, 1, 1, 0, 0, 1);
			}
			else
			{
				task_combat_animal_charge(iVar1, iVar3, 1, 1, 1, 0, 0);
			}
		}
		if (network_is_host_of_this_script())
		{
...
void func_410(int iParam0)
{
	...
	if (does_entity_exist(iVar0) && network_has_control_of_entity(iVar0))
	{
		_task_smart_flee_style_ped(iVar0, get_player_ped(Local_498.f_161.f_11), 3, 67117568, 250f, -1, 0);
	}
	if (network_is_host_of_this_script())
	{
		func_519(7);
...
void func_411(int iParam0)
{
	...
	if (_0x3f59fe6f37869576(iParam0->f_1, get_player_index()) && func_374(255))
	{
		if (!func_481())
		{
			func_482();
...
{
	return Local_498.f_177.f_7[iParam0]->f_10;
}
...
{
	if (does_entity_exist(&(Local_498.f_177.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_498.f_177.f_7[iParam0])))
		{
			uVar0 = &Local_498.f_177.f_7[iParam0];
...
bool func_438(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (bParam7)
	{
		if (func_540(player_id(), iVar0) || is_player_free_aiming_at_entity(player_id(), iVar0))
		{
			return true;
		}
	}
	...
	else if (func_365(Global_34, iVar0, fParam2, 1, 1) && is_tracked_ped_visible(iVar0))
	{
		bVar1 = true;
	}
	else if ((func_365(Global_34, iVar0, fParam3, 1, 1) && func_541()) && is_tracked_ped_visible(iVar0))
	{
		bVar1 = true;
	}
	if (bVar1)
	{
		if (!func_342(Local_498.f_53.f_3[iParam0]))
		{
			func_464(Local_498.f_53.f_3[iParam0], 0);
		}
		else if (func_427(Local_498.f_53.f_3[iParam0]) > fParam4)
		{
			return true;
		}
	}
	else if (func_342(Local_498.f_53.f_3[iParam0]))
	{
		func_344(Local_498.f_53.f_3[iParam0]);
	}
	return false;
}
...
bool func_441(int iParam0, var uParam1, bool bParam2)
{
	...
	{
		if (((func_365(Global_34, iParam0, _0x79b1a6e780266db0(Global_34), 1, 1) && _0x285d36c5c72b0569(Global_34) <= 0.5f) && func_545(iParam0, 0.45f, 0.55f, 0.45f, 0.55f)) && !is_entity_occluded(iParam0))
		{
			uParam1->f_33 = 4;
			return true;
		}
...
void func_443(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (bVar2)
	{
		if ((!is_ped_fleeing(iVar0) || !func_458(iVar0, 518218985)) || bParam3)
		{
	...
	{
		case 1:
			if ((!is_ped_in_combat(iVar0, 0) || !func_458(iVar0, 780511057)) || bParam3)
			{
...
bool func_444(int iParam0, int iParam1)
{
	...
	return func_236(Local_49[iParam1]->f_5, iParam0);
}
...
bool func_445(var uParam0, int iParam1)
{
	...
	{
		case 1:
			return (func_458(iParam1, 780511057) || is_ped_in_combat(iParam1, 0));
		case 0:
			return (func_458(iParam1, 518218985) || is_ped_fleeing(iParam1));
	}
	return false;
}
...
void func_450(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar2 <= 3)
	{
		iVar0 = &Local_498.f_177.f_7[iVar2];
...
void func_451(var uParam0, var uParam1)
{
	...
	{
		iVar0 = &Local_498.f_177.f_7[iVar2];
		if ((((((iVar2 != uParam1->f_1 && iVar2 != uParam1->f_2) && does_entity_exist(iVar0)) && network_has_control_of_entity(iVar0)) && !is_entity_dead(iVar0)) && !get_ped_config_flag(iVar0, 580, true)) && !func_445(uParam0, iVar0))
		{
			switch (uParam0->f_1)
			{
				case 1:
...
void func_452(var uParam0)
{
	...
	while (iVar1 <= 3)
	{
		iVar0 = &Local_498.f_177.f_7[iVar1];
		...
		{
			task_wander_in_area(iVar0, Local_498.f_177.f_7[uParam0->f_1]->f_6, uParam0->f_27, 1077936128, 1086324736, 0);
			set_ped_keep_task(iVar0, true);
			if (Local_13.f_7.f_1 == 1)
			{
...
{
	set_bit(&(Local_498.f_53.f_50), iParam0);
}

void func_454(int iParam0)
{
	if (!func_373(participant_id_to_int(), 0, 1))
	{
		return;
	}
	func_212(&(Local_49[participant_id_to_int()]->f_5), iParam0);
}
...
void func_459(int iParam0)
{
	...
	func_253(&(Local_49[participant_id_to_int()]->f_5), iParam0);
}
...
bool func_460(int iParam0, int iParam1)
{
	...
	return func_236(Local_49[iParam1]->f_1, iParam0);
}
...
void func_462(int iParam0)
{
	...
	func_253(&(Local_49[participant_id_to_int()]->f_1), iParam0);
}
...
void func_465(int iParam0)
{
	...
	func_212(&(Local_49[participant_id_to_int()]->f_1), iParam0);
}
...
bool func_470(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_503(get_entity_coords(iParam0, bParam5, false), vParam1) <= (bParam4 * bParam4))
	{
		return true;
	}
	return false;
...
void func_478(int iParam0, var uParam1, bool bParam2)
{
	...
	if ((((!is_entity_dead(iParam0) && func_477(uParam1)) && !get_ped_config_flag(iParam0, 580, true)) && network_has_control_of_entity(iParam0)) && (get_frame_count() % 10) == 0)
	{
...
void func_487(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		*uParam1 = _blip_add_for_entity(func_562(), iParam0);
		...
		set_blip_name_from_text_file(*uParam1, func_563(func_366(get_entity_model(iParam0))));
	}
}
...
void func_496(int iParam0)
{
	...
	func_212(&(Local_49[participant_id_to_int()]->f_4), iParam0);
}
...
bool func_500(int iParam0)
{
	if (does_entity_exist(&(Local_498.f_177.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_498.f_177.f_7[iParam0])))
		{
			delete_ped(Local_498.f_177.f_7[iParam0]);
			Local_498.f_177.f_7[iParam0] = 0;
			return true;
		}
	}
	return false;
...
void func_501(int iParam0)
{
	...
	func_253(&(Local_49[participant_id_to_int()]->f_4), iParam0);
}
...
{
	if (!does_entity_exist(Local_498.f_19.f_1))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < *iParam0)
	{
		if (is_bit_set(Local_498.f_19, iVar0))
		{
	...
	switch (Local_13.f_24.f_1)
	{
		...
		case 4:
			...
			else if (network_has_control_of_entity(iVar1))
			{
				if (func_368(4) || func_368(2))
				{
					set_ped_min_move_blend_ratio(iVar1, 2f);
				}
			}
			if (((!func_368(2) && does_entity_exist(iVar2)) && network_has_control_of_entity(iVar2)) && !func_458(iVar2, -875674219))
			{
				task_turn_ped_to_face_entity(iVar2, iVar1, -1, -1082130432, -1082130432, -1082130432);
				_0x06d26a96ca1bca75(iVar2, 3, 1f, iVar1);
			}
			break;
		case 5:
			if ((!func_573(1, -1) && network_has_control_of_entity(iVar0)) && !func_458(iVar0, 993674639))
			{
				_task_start_scenario_in_place(iVar0, -333019452, -1, false, 0, -1f, false);
			}
			if ((does_entity_exist(iVar2) && network_has_control_of_entity(iVar2)) && !func_458(iVar2, 993674639))
			{
				_task_start_scenario_in_place(iVar2, -333019452, -1, false, 0, -1f, false);
			}
			if (_is_ped_using_scenario_hash(iVar0, -333019452) && _is_ped_using_scenario_hash(iVar2, -333019452))
			{
				func_574(1);
			}
			break;
		case 6:
			if ((does_entity_exist(iVar2) && network_has_control_of_entity(iVar2)) && !func_458(iVar2, 1682639051))
			{
				task_follow_and_converse_with_ped(iVar2, iVar1, 0, 0, -1082130432, -1082130432, 8, 0, 0, 1069547520, 1073741824);
		...
		case 8:
			...
			if (((func_110() == 0 && network_has_control_of_entity(iVar1)) && func_520(4)) && func_400(&(Local_13.f_24.f_2)) < 2f)
			{
				set_ped_min_move_blend_ratio(iVar1, 2f);
			}
			func_575();
...
{
	return func_581(get_entity_coords(iParam0, true, false), 1203982208, 1, 1);
}
...
var func_518(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_583());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_583());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_583());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_584(get_player_team(iVar5)));
	}
...
bool func_520(int iParam0)
{
	...
	while (iVar0 <= (network_get_max_num_participants() - 1))
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)) && func_573(iParam0, iVar0))
		{
			return true;
		}
		iVar0++;
...
int func_521()
{
	...
	iVar0 = func_248(0);
	iVar1 = get_player_ped(Local_498.f_161.f_10);
	if (!does_entity_exist(iVar0))
	{
		return 0;
	}
	...
	if (func_589(get_entity_coords(iVar1, true, false), &vVar2, &fVar5))
	{
		_set_entity_coords_and_heading(iVar0, vVar2, fVar5, true, false, true);
		func_590(iVar0);
		if (is_ped_on_mount(iVar1))
		{
			task_combat_ped(iVar0, iVar1, 0, 0);
		}
		else if (!func_365(iVar0, iVar1, 30f, 1, 1) || is_ped_in_any_vehicle(iVar1, false))
		{
			task_follow_to_offset_of_entity(iVar0, iVar1, 0f, 0f, 0f, 2f, -1, 1036831949, 1, 1, 0, 0, 1);
		}
		else
		{
			task_combat_animal_charge(iVar0, iVar1, 1, 1, 1, 0, 0);
		}
		func_118(2);
		return 1;
	}
...
{
	_0xd9130842d7226045(func_591(iParam0), 0);
}
...
void func_538(var uParam0, var uParam1)
{
	...
	bVar0 = false;
	if (does_entity_exist(*uParam1) && func_593(*uParam1, Global_35, 1) < 300f)
	{
		bVar0 = true;
	}
	bVar1 = false;
...
{
	switch (func_530(func_366(get_entity_model(iParam0))))
	{
		case -1630294353:
			return 5f;
		case -1754709769:
...
bool func_543(int iParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (!Global_1940258->f_6 && !is_entity_dead(iParam0))
	{
		...
		{
			if (func_608(uParam1, 1065353216))
			{
				if (!uParam1->f_2 & 4 != 0)
				{
...
bool func_544(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1940258->f_6 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1940258->f_20 && func_617(player_id(), 0, 1, uParam2->f_2 & 524288 == 0))
		{
		...
		if (Global_1940258->f_19)
		{
			if (func_608(uParam2, 1065353216))
			{
				if (!uParam2->f_2 & 4 != 0)
				{
...
bool func_545(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_632(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
Vector3 func_551(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_634(vVar0, get_random_float_in_range(0f, fParam3)) };
...
void func_558(struct<2> Param0)
{
	...
	{
		_0xb2a38826e5886e83(func_288(Param0), Global_265377->f_124517.f_71.f_17);
...
{
	Var0.f_10 = 255;
	_copy_memory(&(Var0.f_4), &Local_498, 5);
	Var0.f_9 = iParam0;
	Var0 = 182;
	Var0.f_1 = player_id();
	Var0.f_2 = get_network_time_accurate();
...
void func_568()
{
	...
	{
		iVar0 = 1;
		if ((!func_480(&(Local_498.f_53)) && !func_484(iVar1)) && func_438(0, 35f, 50f, 110f, 1065353216, 5, 0, 1))
		{
			if (func_365(Global_34, iVar1, 17.5f, 1, 1))
			{
				_play_sound_from_entity("CALL", iVar1, "LEGENDARY_MOOSE_CALL_SOUNDS", false, 0, 0);
			}
		}
	}
	else
	...
	if (!func_368(1) && func_438(iVar0, 15f, 50f, 110f, 1065353216, 5, 0, 1))
	{
		func_643();
	}
}
...
void func_569()
{
	if ((Local_13.f_24.f_6 == 255 && !func_368(32)) || (Local_13.f_24.f_6 != 255 && Local_13.f_24.f_6 != player_id()))
	{
		if (is_entity_dead(func_248(0)) && _0xef2d9ed7ce684f08(func_248(0)) == Global_34)
		{
			func_644();
			func_370(32);
		}
...
{
	if ((_is_anim_scene_started(Local_498.f_161.f_7, false) || !network_has_control_of_network_id(Local_13.f_24.f_5)) || func_520(2))
	{
		return;
	}
	if (func_110() == 0)
	{
		set_anim_scene_entity(Local_498.f_161.f_7, "MOOSE", func_248(1), 0);
	}
	else
	{
		set_anim_scene_entity(Local_498.f_161.f_7, "MOOSE", func_248(0), 0);
	}
	set_anim_scene_origin(Local_498.f_161.f_7, vParam0, vParam3, 2);
	start_anim_scene(Local_498.f_161.f_7);
	func_574(2);
}

void func_572()
{
	if (!_0xb89fcff19dafff28(Local_498.f_161.f_7, "MOOSE"))
	{
		return;
	}
	if (func_110() == 0)
	...
	if (network_has_control_of_entity(iVar0))
	{
		...
		if (func_368(4) || func_368(2))
		{
			_task_smart_flee_style_ped_via(iVar0, get_player_ped(Local_498.f_161.f_10), 3, func_645(), 67117056, -1082130432, -1, 0);
		}
		func_574(4);
	}
	if (!func_368(4) && !func_368(2))
	{
		clear_sequence_task(&(Local_498.f_161.f_9));
		_0x23767d80c7eed7c6(&(Local_498.f_161.f_9), -1491263573);
		task_follow_nav_mesh_to_coord(0, func_313(), 2f, -1, 0.25f, 4194304, func_314());
		_task_start_scenario_in_place(0, -333019452, -1, true, 0, -1f, false);
		close_sequence_task(Local_498.f_161.f_9);
		if (network_has_control_of_entity(iVar0))
		{
			task_perform_sequence(iVar0, Local_498.f_161.f_9);
		}
	}
}
...
bool func_573(int iParam0, int iParam1)
{
	...
	return func_236(Local_49[iParam1]->f_6, iParam0);
}

void func_574(int iParam0)
{
	func_212(&(Local_49[Local_498.f_161.f_1]->f_6), iParam0);
}
...
void func_575()
{
	...
	iVar1 = func_248(1);
	iVar3 = get_player_ped(Local_498.f_161.f_11);
	iVar4 = get_ped_index_from_entity_index(_0xcd66fea29400a0b5(iVar0));
	...
	if (bVar6)
	{
		...
		{
			bVar7 = false;
			if (has_entity_been_damaged_by_entity(Global_34, iVar0, 1, 1))
			{
				bVar7 = true;
			}
			if (!bVar7)
			{
				if (((func_400(&(Local_13.f_24.f_2)) > 12f && get_script_task_status(iVar0, -1578598439, true) != 1) && func_365(iVar0, Global_34, 10f, 1, 1)) || func_400(&(Local_13.f_24.f_2)) > 25f)
				{
					bVar7 = true;
				}
			}
	...
	if (((does_entity_exist(iVar1) && network_has_control_of_entity(iVar1)) && !func_458(iVar1, 518218985)) && func_520(4))
	{
		_task_smart_flee_style_ped(iVar1, get_player_ped(Local_498.f_161.f_11), 3, 67117056, -1082130432, -1, 0);
	}
	iVar5 = 2;
	while (iVar5 <= 2)
	{
		iVar2 = func_248(iVar5);
		if ((does_entity_exist(iVar2) && network_has_control_of_entity(iVar2)) && !func_458(iVar2, 518218985))
		{
			_task_smart_flee_style_ped(iVar2, get_player_ped(Local_498.f_161.f_11), 3, 67108864, -1082130432, -1, 0);
		}
		iVar5++;
	}
}
...
void func_576()
{
	...
	while (iVar1 <= 2)
	{
		...
		if (does_entity_exist(iVar0) && network_has_control_of_entity(iVar0))
		{
			if (!func_458(iVar0, 518218985) && !is_ped_fleeing(iVar0))
			{
				_task_smart_flee_style_ped(iVar0, get_player_ped(Local_498.f_161.f_11), 3, 67108864, -1082130432, -1, 0);
			}
...
{
	if ((!func_648(1) && bParam1) && get_animal_tuning_float_param(iParam0, 74) > 0f)
	{
	...
	if (network_has_control_of_entity(iParam0))
	{
		if (!func_648(1))
		{
			...
			{
				_task_smart_flee_style_ped(iParam0, func_649(iParam0), 3, 67117056, 9999f, -1, 0);
	...
	while (iVar0 <= 31)
	{
		...
		else
		{
			...
			else
			{
				...
				if (bParam5)
				{
					if (((_is_ped_hogtied(iVar6) || _0x833f0053340ef413(iVar6)) || func_460(4, iVar1)) || is_ped_in_any_vehicle(iVar6, false))
					{
					}
					else
					{
...
bool func_589(vector3 vParam0, var uParam3, var uParam4)
{
	...
	func_656(&Var0, 16);
	Var0 = { vParam0 };
	Var0.f_3 = { get_entity_forward_vector(get_player_ped(Local_498.f_161.f_11)) };
	Var0.f_6 = 70f;
	Var0.f_7 = 110f;
	Var0.f_8 = 50f;
	Var0.f_9 = 180f;
	Var0.f_10 = 250f;
	*vVar20[0] = { -906.6959f, 1521.721f, 242.4235f };
	*vVar20[1] = { -970.6801f, 1500.362f, 251.1769f };
	*vVar20[2] = { -994.4455f, 1495.046f, 256.406f };
	*vVar20[3] = { -991.7213f, 1524.531f, 244.016f };
	*vVar20[4] = { -1001.425f, 1538.491f, 238.7452f };
	*vVar20[5] = { -1057.48f, 1553.911f, 242.1596f };
	*vVar20[6] = { -1046.289f, 1600.905f, 237.4295f };
	*vVar20[7] = { -958.8572f, 1642.805f, 237.4295f };
	*vVar20[8] = { -901.5298f, 1583.21f, 242.8425f };
	*vVar20[9] = { -911.8878f, 1562.587f, 238.5065f };
	*vVar20[10] = { -1041.376f, 1513.044f, 256.1945f };
	*vVar20[11] = { -1057.922f, 1571.371f, 239.5f };
	*vVar20[12] = { -849.7615f, 1557.595f, 256.8193f };
	*vVar20[13] = { -865.725f, 1539.638f, 250.8556f };
	*vVar20[14] = { -867.4099f, 1484.755f, 244.2419f };
	*vVar20[15] = { -935.258f, 1478.421f, 248.5042f };
	*vVar20[16] = { -995.2644f, 1479.701f, 263.0155f };
	*vVar20[17] = { -1039.709f, 1508.777f, 257.4061f };
	*vVar20[18] = { -987.8085f, 1658.252f, 237.4295f };
	fVar78[0] = 56.468f;
	fVar78[1] = 347.4965f;
	fVar78[2] = 309.4489f;
	fVar78[3] = 347.3965f;
...
{
	switch (func_366(get_entity_model(iParam0)))
	{
		case 0:
			return "LEGENDARY_ALLIGATOR_CALL_SOUNDS";
		case 1:
...
void func_597(int iParam0)
{
	...
	_play_sound_from_position(func_663(iParam0), vVar0, func_591(iParam0), false, 0, true, 0);
}
	...
	switch (uParam0->f_7)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_34) && (!func_666(1, 1) || *uParam0 & 8192 != 0))
				{
...
bool func_611(int iParam0, var uParam1)
{
	...
	{
		fVar1 = -1f;
		fVar2 = func_678(_0x2ba9d7bf629f920c(iParam0), (fVar0 + 5f));
...
bool func_615(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_689(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_686(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_3 != 0)
			{
				if (get_game_timer() - uParam2->f_3) > func_687(uParam2)
				{
					func_673(uParam2, 1);
					return true;
				}
...
bool func_616(int iParam0, var uParam1)
{
	...
	if (func_681(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_4) > func_687(uParam1)
		{
...
bool func_624(var uParam0, int iParam1)
{
	...
	if (func_702(iVar0, iParam1, 1060437492) != 0)
	{
		return false;
	}
...
int func_630(int iParam0, var uParam1)
{
	...
	{
		return func_711(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
{
	iVar0 = func_248(iParam0);
	iVar1 = get_player_ped(Local_498.f_161.f_11);
	...
	if ((get_frame_count() % 5) == 0)
	{
		if (func_460(4, iVar3) && _0x42688e94e96fd9b4(iVar0, 3, 0) > 0f)
		{
		...
		if ((func_460(32, iVar3) || func_460(128, iVar3)) || func_520(16))
		{
			...
			{
				_task_smart_flee_style_ped(iVar0, iVar1, 3, 67108864, -1082130432, -1, 0);
			}
		}
		else if (!func_365(iVar0, iVar1, 30f, 1, 1))
		{
			...
			{
				task_follow_nav_mesh_to_coord(iVar0, get_entity_coords(iVar1, true, false), 2f, -1, 0.25f, 0, 40000f);
			}
		}
...
{
	return get_player_ped(func_713(iParam0));
}
...
bool func_651(int iParam0, int iParam1)
{
	...
	{
		return func_714(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
bool func_657(var uParam0, var uParam1)
{
	...
	while (iVar0 <= (iVar2 - 1))
	{
		...
		{
			if (func_720(*uParam0, *(*uParam1)[iVar0], uParam0->f_8, 1) || !func_720(*uParam0, *(*uParam1)[iVar0], uParam0->f_9, 1))
			{
				iVar3[iVar0] = (uParam0->f_11 - 1);
			}
			else if (func_719(uParam0, 2))
			{
				if (!func_721(*(*uParam1)[iVar0], 1f, uParam0->f_10))
				{
				...
				else
				{
					if (func_719(uParam0, 1))
					{
						if (!func_720(*uParam0, *(*uParam1)[iVar0], uParam0->f_6, 1))
						{
							iVar3[iVar0] = (&iVar3[iVar0] + uParam0->f_13);
						}
						if (func_720(*uParam0, *(*uParam1)[iVar0], uParam0->f_7, 1))
						{
					...
					{
						if (func_723(uParam0->f_3, 0f, 0f, 0f, 1056964608, 1))
						{
						}
...
{
	return does_entity_exist(&(Local_498.f_177.f_7[iParam0]));
}
...
bool func_670(int iParam0, int iParam1)
{
	...
	if (!_is_weapon_lasso(func_736(iParam0, 1, 0, 0)) && !func_736(iParam0, 1, 0, 0) == 1151374672)
	{
		return false;
	}
...
bool func_684(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_431(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_689(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_741(iVar0, 0)))
		{
			if (func_632(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_704(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_431(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
{
	return func_581(get_entity_coords(iParam0, true, false), 1203982208, 1, 0);
}
...
{
	if (func_470(Global_34, vParam0, fParam4, 1, 1) && is_sphere_visible(vParam0, fParam3))
	{
		return true;
	}
	iVar0 = 0;
...
{
	return get_player_ped(func_581(vParam0, 1203982208, 1, 0));
}
