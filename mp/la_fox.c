...
void func_1(int iParam0)
{
	...
	func_8();
	func_9();
	network_register_host_broadcast_variables(&Local_13, 73, 43);
	func_10(_0xba24095ea96dfe17(&Local_13), 73, "m_hostData");
	network_register_player_broadcast_variables(&Local_86, 769, 44);
	func_11(_0x690806bc83bc8ca2(Local_86[0]), 769, "m_clientData");
	func_12(0);
...
{
	iVar0 = 255;
	_copy_memory(&Local_855, uParam0, 5);
...
void func_43()
{
	iVar0 = Global_1198046->f_231.f_1066[Local_855.f_12]->f_5;
...
void func_44()
{
	...
	{
		clear_area(Local_855.f_15, Var0.f_10, 2442122);
		func_121(2);
	}
	else if (bVar31)
	{
...
void func_49()
{
	...
	if (func_131(512))
	{
		if (func_67(64) && func_122(player_id()) == Local_13.f_6)
		{
			func_68(Local_13.f_6);
			func_143(64);
		}
...
void func_61()
{
	if (func_59())
	{
		...
		while (iVar1 < 13)
		{
			if (network_does_network_id_exist(&(Local_13.f_56[iVar1])))
			{
				iVar0 = net_to_ped(&(Local_13.f_56[iVar1]));
				func_170(iVar1);
	...
	if (func_59())
	{
		...
		while (iVar1 < 1)
		{
			...
			while (iVar2 < 1)
			{
				...
				{
					iVar0 = &Local_855.f_480[iVar1]->f_5[iVar2];
				...
				else if (network_does_network_id_exist(Local_13.f_70[iVar1][iVar2]))
				{
					iVar0 = net_to_obj(Local_13.f_70[iVar1][iVar2]);
					if (network_has_control_of_entity(iVar0))
					{
						if (func_174(iVar1, iVar2))
						{
...
void func_63()
{
	...
	if (_does_volume_exist(Local_855.f_501.f_11))
	{
		_delete_volume(Local_855.f_501.f_11);
	}
}
...
void func_111()
{
	reserve_network_mission_peds(13);
	iVar1 = 0;
	while (iVar1 < 32)
	{
		iVar0 = 0;
		while (iVar0 < 13)
		{
			Local_86[iVar1]->f_7.f_2[iVar0] = -1f;
			iVar0++;
		}
		iVar1++;
	}
...
void func_114()
{
	...
	if (func_116() != 3)
	{
		switch (func_218())
		{
			...
			case 18:
			case 19:
				func_212(9, -1143398950);
				Local_13.f_24.f_18[9] = 0;
				func_215(9, func_220(5), func_217(2), 1);
				func_212(10, -1143398950);
				Local_13.f_24.f_18[10] = 0;
				func_215(10, func_220(5), func_217(2), 1);
				func_212(11, -1143398950);
				Local_13.f_24.f_18[11] = 0;
				func_215(11, func_220(1), func_217(2), 1);
				func_212(12, -1143398950);
				Local_13.f_24.f_18[12] = 0;
				func_215(12, func_220(1), func_217(2), 1);
				func_212(5, -1568716381);
				Local_13.f_24.f_18[5] = 0;
				func_215(5, func_220(0), func_217(0), 1);
				func_212(6, -1568716381);
				Local_13.f_24.f_18[6] = 0;
				func_215(6, func_220(3), func_217(1), 1);
				func_212(7, -1568716381);
				Local_13.f_24.f_18[7] = 0;
				func_215(7, func_220(6), func_217(0), 1);
				func_212(8, -1568716381);
				Local_13.f_24.f_18[8] = 0;
				func_215(8, func_220(7), func_217(1), 1);
				break;
		}
...
bool func_124(int iParam0)
{
	...
	return (func_225(iParam0) && (*Global_1131196)[iParam0]->f_18.f_1 != 0);
}
...
bool func_126(struct<31> Param0, var uParam31)
{
	...
	{
		if (_0x397769175a7dbb30(Local_855.f_15, Param0.f_10, 0, 0, 0))
		{
			_0xfa15c9a320e707b0();
			*uParam31 = 1;
			return false;
...
bool func_130(int iParam0, int iParam1)
{
	...
	return func_181(&(Local_86[iParam1]), iParam0);
}
...
bool func_140()
{
	...
	{
		func_237(get_entity_coords(func_236(0), true, false));
	}
	if (func_238())
	{
		return true;
...
{
	if (func_181(&(Local_86[participant_id_to_int()]), iParam0))
	{
		func_250(Local_86[participant_id_to_int()], iParam0);
	}
}
...
void func_147(int iParam0)
{
	...
	{
		func_224(Local_86[participant_id_to_int()], iParam0);
	}
}
...
void func_159()
{
	...
	if (does_entity_exist(iVar0))
	{
		...
		if (network_has_control_of_entity(iVar0))
		{
			...
			_0x9f158a49b0d84c3c(iVar0);
			set_blocking_of_non_temporary_events(iVar0, true);
			set_ped_combat_attributes(iVar0, 5, false);
	...
	{
		if (does_entity_exist(func_280(0)) && network_has_control_of_entity(func_280(0)))
		{
			_0x9587913b9e772d29(func_280(0), 0);
			freeze_entity_position(func_280(0), true);
			if (get_clock_hours() >= 21 || get_clock_hours() < 6)
			{
				_0xebdc12861d079aba(func_280(0), 1);
				_set_lights_intensity_for_entity(func_280(0), 10f);
			}
		}
	}
	func_281(&(Local_855.f_25), func_213(), 30f, 0);
	func_282(80f);
	func_283(35f, 75f, 1, 1077936128, 0);
	func_284(1065353216, 5f);
	func_285(-432403087, func_213(), 0f, 0f, 0f, 10f, 10f, 10f);
	func_285(-1612834106, func_213() + Vector(0f, 10f, 10f), 0f, 0f, 0f, 10f, 10f, 10f);
	func_286(func_236(0));
...
void func_162()
{
	...
	{
		fVar0 = vdist(get_entity_coords(player_ped_id(), false, false), Local_855.f_15);
		if (fVar0 < 200f)
		{
			func_147(4096);
		}
...
void func_167()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_855.f_5 = (Local_855.f_5 || Local_86[iVar0]) // PointerArith;
			Local_855.f_6 = (Local_855.f_6 && Local_86[iVar0]) // PointerArith;
		}
		iVar0++;
	}
}
...
{
	if (does_blip_exist(Local_855.f_285.f_7[iParam0]->f_1))
	{
		remove_blip(&(Local_855.f_285.f_7[iParam0]->f_1));
	}
}

bool func_171(int iParam0, int iParam1)
{
	return func_181(Local_855.f_285.f_7[iParam0]->f_2, iParam1);
}

bool func_172(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 1024);
}

bool func_173(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 8);
}

bool func_174(int iParam0, int iParam1)
{
	return is_bit_set(Local_855.f_480[iParam0]->f_4, iParam1);
}
...
void func_176()
{
	...
	if ((does_entity_exist(Local_855.f_53) && is_entity_dead(Local_855.f_53)) || Local_855.f_53.f_2 == 12)
	{
		return;
	}
	if (func_316(16))
...
{
	Local_855.f_285.f_7[iParam0]->f_3 = iParam1;
}
...
{
	Local_855.f_285.f_7[iParam0]->f_6 = { vParam1 };
	Local_855.f_285.f_7[iParam0]->f_5 = fParam4;
	if (bParam5)
	{
		func_224(&(Local_855.f_285.f_7[iParam0]->f_2), 2);
	}
	else
	{
		func_250(&(Local_855.f_285.f_7[iParam0]->f_2), 2);
	}
}
...
Vector3 func_216(int iParam0)
{
	...
	{
		case 0:
			return _get_object_offset_from_coords(func_213(), 0f, 0.9f, 1.3f, 0f);
		case 1:
			return _get_object_offset_from_coords(func_213(), 0f, 0f, 1f, 0f);
		case 2:
			return _get_object_offset_from_coords(func_213(), 0f, -0.85f, 1.6f, 0f);
		default:
			break;
	}
	return 0f, 0f, 0f;
...
{
	Local_855.f_285.f_7[iParam0]->f_4 = iParam1;
}
...
bool func_230(var uParam0)
{
	...
	while (iVar2 < 13)
	{
		...
		else
		{
			...
			if (func_346(iVar2))
			{
				if (network_does_network_id_exist(&(Local_13.f_56[iVar2])))
				{
					if (network_request_control_of_network_id(&(Local_13.f_56[iVar2])))
					{
						_0x7182edda1ee7db5a(&(Local_13.f_56[iVar2]));
					}
				}
			}
		}
...
bool func_232(bool bParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			...
			else if (is_bit_set(Local_855.f_480[iVar0]->f_2, iVar1))
			{
				if (func_348(iVar0, iVar1))
				{
					if (network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
					{
						if (network_request_control_of_network_id(Local_13.f_70[iVar0][iVar1]))
						{
							_0x7182edda1ee7db5a(Local_13.f_70[iVar0][iVar1]);
						}
					}
				}
			}
			else
			{
				if (!network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
				{
					...
					{
						vVar7 = { _get_object_offset_from_coords(vVar10, 0f, func_350(iVar0, iVar1)) };
					}
					else
					{
					...
					if (func_351(iVar0, iVar1))
					{
						...
						else
						{
							...
							{
								iVar13 = _0x9641a9a20310f6b8(Local_855.f_480[iVar0]->f_5[iVar1]->f_3, vVar7, 0f, 0f, 0f, 1, 0, 0);
								...
								{
									(*Local_13.f_70[iVar0])[iVar1] = obj_to_net(iVar13);
									if (!network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
									{
										*bParam0 = 1;
										return false;
							...
							{
								iVar13 = _create_weapon_object(Local_855.f_480[iVar0]->f_5[iVar1]->f_5, Local_855.f_480[iVar0]->f_5[iVar1]->f_4, func_350(iVar0, iVar1), true, 1f);
								if (!does_entity_exist(iVar13))
								{
									*bParam0 = 1;
								}
								else
								{
									...
									{
										set_network_id_exists_on_all_machines(Local_13.f_70[iVar0][iVar1], true);
									}
								}
							}
							else if (iVar2 == 0)
							...
							else if (!func_355((*Local_13.f_70[iVar0])[iVar1], iVar2, vVar7, 1, 0))
							{
								*bParam0 = 1;
								return false;
							}
							if (network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
							{
								iVar13 = net_to_obj(Local_13.f_70[iVar0][iVar1]);
								if (func_348(iVar0, iVar1))
								{
									if (network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
									{
								...
								set_bit(&(Local_855.f_480[iVar0]->f_2), iVar1);
								...
								if (!func_226(vVar4))
								{
									...
									else
									{
										...
										if (!func_360(iVar0, iVar1, 32))
										{
											...
											vVar24 = { Vector(fVar14, fVar14, fVar14) * Vector(0f, absf(func_361(vVar4.x)), absf(func_361(vVar4.y))) };
...
{
	return &(Local_855.f_285.f_7[iParam0]);
}
...
void func_241()
{
	...
	else if (is_entity_dead(func_236(0)))
	{
		func_371(8);
	}
	if (get_ped_config_flag(func_236(0), 580, true))
	{
		func_371(7);
	}
}
...
{
	func_250(&(Local_855.f_285.f_7[iParam0]->f_2), iParam1);
}
...
void func_255(int iParam0)
{
	...
	{
		if ((func_376(iVar34) && Var0.f_6 == 1657716792) && !func_370(256, 0))
		{
			func_264(256);
		}
		Local_13.f_24.f_7++;
...
bool func_258(int iParam0, int iParam1, int iParam2)
{
	...
	return func_181(Local_86[iParam1]->f_6, iParam0);
}
...
{
	if (!is_string_null_or_empty(func_378()))
	{
...
bool func_263(var uParam0)
{
	if (!is_string_null_or_empty(func_378()))
	{
		...
		if (!_0x23e33cb9f4a3f547(*uParam0, func_379()))
		{
			if (!_0x0df57f86fe71dbe5(*uParam0, func_379()))
			{
				_0xdf7b5144e25cd3fe(*uParam0, func_379());
			}
			return false;
		}
	}
...
void func_264(int iParam0)
{
	...
	func_224(&(Local_86[iVar0]->f_6), iParam0);
}
...
bool func_265()
{
	...
	while (iVar0 < 13)
	{
		if (is_bit_set(Local_855.f_285.f_3, iVar0))
		{
		}
		else
		{
			...
			{
				if (!is_bit_set(Local_855.f_285.f_4, iVar0))
				{
					request_model(iVar2, false);
					set_bit(&(Local_855.f_285.f_4), iVar0);
				}
				...
				{
					set_bit(&(Local_855.f_285.f_3), iVar0);
				}
			}
		}
		iVar0++;
...
bool func_266()
{
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			if (is_bit_set(Local_855.f_480[iVar0]->f_1, iVar1))
			{
			}
			else
			{
				...
				if (func_382(iVar1))
				{
					if (Local_855.f_480[iVar0]->f_5[iVar1]->f_6 == 0 || !_0x93ffd92f05ec32fd(Local_855.f_480[iVar0]->f_5[iVar1]->f_6))
					{
						Local_855.f_480[iVar0]->f_5[iVar1]->f_6 = _0x91fe941f9fcfb702(Local_855.f_480[iVar0]->f_5[iVar1]->f_3, 0);
						bVar2 = true;
					}
					else if (!_0xb0b2c6d170b0e8e5(Local_855.f_480[iVar0]->f_5[iVar1]->f_6))
					{
						bVar2 = true;
					}
					else if (!is_bit_set(Local_855.f_480[iVar0]->f_1, iVar1))
					{
						set_bit(&(Local_855.f_480[iVar0]->f_1), iVar1);
					}
				}
				else if (func_383(iVar1))
				{
					_0x72d4cb5db927009c(Local_855.f_480[iVar0]->f_5[iVar1]->f_5, -1, 0);
					if (!_0xff07cf465f48b830(Local_855.f_480[iVar0]->f_5[iVar1]->f_5))
					{
						bVar2 = true;
					}
					else if (!is_bit_set(Local_855.f_480[iVar0]->f_1, iVar1))
				...
				{
					if (!is_bit_set(&(Local_855.f_480[iVar0]), iVar1))
					{
						request_model(iVar3, false);
						set_bit(Local_855.f_480[iVar0], iVar1);
					}
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			...
			else if (!func_173(iVar0, iVar1))
			{
				if (network_is_host_of_this_script())
				{
					if (is_bit_set(Local_855.f_480[iVar0]->f_2, iVar1))
					{
						if (func_348(iVar0, iVar1))
						{
							if (network_does_network_id_exist(Local_13.f_70[iVar0][iVar1]))
			...
			else
			{
				...
				if (func_351(iVar0, iVar1))
				{
					...
					else
					{
						if (func_353(iVar0, iVar1))
						{
							iVar13 = _0x9641a9a20310f6b8(Local_855.f_480[iVar0]->f_5[iVar1]->f_3, vVar7, 0f, 0f, 0f, 0, 0, 0);
							if (!does_entity_exist(iVar13))
							{
								return false;
							}
						...
						Local_855.f_480[iVar0]->f_5[iVar1] = iVar13;
						if (func_363(iVar0, iVar1))
						{
							func_364(iVar0, iVar1, 1);
						}
...
void func_269(struct<2> Param0)
{
	...
	else if (!_0x01f4d242765c6b24(func_321(Param0)))
	{
		_0x99230691875fc218(func_319(Param0), func_321(Param0), Global_35);
	}
}
...
void func_271()
{
	...
	while (iVar1 < 1)
	{
		...
		while (iVar2 < 1)
		{
			...
			{
				iVar0 = net_to_obj(Local_13.f_70[iVar1][iVar2]);
				Local_855.f_480[iVar1]->f_5[iVar2] = iVar0;
				if (func_348(iVar1, iVar2))
				{
					if (network_does_network_id_exist(Local_13.f_70[iVar1][iVar2]))
					{
						if (network_request_control_of_network_id(Local_13.f_70[iVar1][iVar2]))
						{
							_0x7182edda1ee7db5a(Local_13.f_70[iVar1][iVar2]);
						}
					}
				}
...
{
	Local_855.f_178.f_5 = func_385(get_entity_model(iParam0));
...
void func_274(int iParam0, int iParam1)
{
	...
	iVar0 = func_385(get_entity_model(iParam0));
...
void func_275()
{
	...
	func_278(&(Local_855.f_133), 1106247680);
...
int func_285(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7)
{
	if (!_does_volume_exist(Local_855.f_501.f_11))
	{
		Local_855.f_501.f_11 = _create_volume_aggregate_with_custom_name("NB_Trigger");
	}
	if (_does_volume_exist(Local_855.f_501.f_11))
	{
		switch (iParam0)
		{
			case -1612834106:
				_0x39816f6f94f385ad(Local_855.f_501.f_11, vParam1, vParam4, vParam7);
				break;
			case -432403087:
				_0x5b7d7bf36d2de18b(Local_855.f_501.f_11, vParam1, vParam4, vParam7);
				break;
			case 665633627:
				_0xbce668aaf83608be(Local_855.f_501.f_11, vParam1, vParam4, vParam7);
				break;
		}
		return 1;
	}
...
void func_292()
{
	...
	bVar7 = false;
	bVar8 = false;
	if (network_is_in_mp_cutscene() != Local_855.f_285.f_194)
	{
		bVar8 = true;
	...
	while (iVar0 < 1)
	{
		...
		iVar1 = &Local_855.f_285.f_7[iVar0];
		...
		if (bVar4)
		{
			if (&Local_86[iVar3]->f_7.f_2[iVar0] > -1f)
			{
				Local_86[iVar3]->f_7.f_2[iVar0] = -1f;
			}
			if (is_bit_set(Local_855.f_285.f_5, iVar0))
			{
				clear_bit(&(Local_855.f_285.f_5), iVar0);
				clear_bit(&(Local_855.f_285.f_6), iVar0);
				clear_bit(&(Local_855.f_285.f_152), iVar0);
			}
		}
		else
		{
		...
		if (is_bit_set(Local_855.f_285.f_152, iVar0))
		{
			if (bVar4 || !bVar7)
			{
				clear_bit(&(Local_855.f_285.f_152), iVar0);
		...
		else if (!bVar4)
		{
			if (bVar7)
			{
				set_bit(&(Local_855.f_285.f_152), iVar0);
			}
		}
		if (!bVar4)
		{
			...
			{
				if (!is_bit_set(Local_86[iVar3]->f_7.f_1, iVar0))
				{
					set_bit(&(Local_86[iVar3]->f_7.f_1), iVar0);
				}
				func_421(Local_855.f_285.f_153[iVar0]);
			}
		}
		if (is_bit_set(Local_86[iVar3]->f_7.f_1, iVar0))
		{
			if (bVar4 || (!is_any_speech_playing(iVar1) && (!func_422(Local_855.f_285.f_153[iVar0]) || func_423(Local_855.f_285.f_153[iVar0], 0.5f))))
			{
				func_424(Local_855.f_285.f_153[iVar0]);
				clear_bit(&(Local_86[iVar3]->f_7.f_1), iVar0);
			}
		}
		if ((!bVar4 && bVar8) && func_171(iVar9, 256))
		{
			set_entity_visible_in_cutscene(iVar1, Local_855.f_285.f_194, 0, 256);
		}
		if (func_171(iVar9, 4))
		{
			if (bVar4)
...
void func_293()
{
	...
	if (func_181(Local_86[iVar1]->f_23, 1))
	{
	...
	fVar3 = vdist(get_entity_coords(iVar2, true, false), Local_855.f_15);
	...
	if (fVar3 <= fVar4)
	{
		func_224(&(Local_86[iVar1]->f_23), 1);
	}
	else if (_does_volume_exist(Local_855.f_501.f_11) && is_entity_in_volume(iVar2, Local_855.f_501.f_11, false, 0))
	{
		func_224(&(Local_86[iVar1]->f_23), 1);
	}
	else if (Local_855.f_501 > 0)
	{
		...
		while (iVar10 < 3)
		{
			func_432(Local_855.f_501.f_13[iVar10], fVar5, 1082130432, 0, 0, 0, 0, 1);
			iVar10++;
		}
...
{
	bVar0 = true;
	if (bVar0 && !_unlock_is_unlocked(Local_855.f_14))
	{
		return false;
	}
	if (func_446())
...
void func_296()
{
	...
	while (iVar0 <= 31)
	{
		if (func_377(iVar0, 1))
		{
			Local_855.f_188.f_4 = (Local_855.f_188.f_4 || Local_86[iVar0]->f_6);
			Local_855.f_188.f_3 = (Local_855.f_188.f_3 && Local_86[iVar0]->f_6);
		}
		iVar0++;
	}
}
...
void func_298()
{
	...
	while (iVar0 <= 7)
	{
		...
		else
		{
			...
			if (is_sphere_visible_to_player(get_player_index(), vVar1, 3f, 60f) || func_451(get_player_ped(get_player_index()), vVar1, 30f, 1, 1))
			{
...
void func_300(int iParam0, int iParam1)
{
	...
	if (!func_453(&(Local_855.f_53), 128))
	{
		...
		{
			func_455(iParam0, func_385(get_entity_model(iParam0)), iParam1, &(Local_855.f_53));
		...
		while (iVar3 < 13)
		{
			...
			if (iVar3 != 0 && func_458(iVar4, 0))
			{
				if (iVar3 >= 5)
				{
					...
					{
						func_460(iVar3, vVar0, 20f, 831283580, 580546400, 0, 0, 0, 1);
					}
...
{
	iVar0 = func_236(0);
	if (func_462() && !can_ped_ragdoll(iVar0))
	{
...
{
	iVar0 = func_236(0);
	if ((func_463(0, 300f, 0) && !func_370(2, 0)) && network_has_control_of_entity(iVar0))
	{
		if (func_258(1, -1, 1))
		{
			if (func_116() == 1 || func_116() == 2)
			{
				if (!_does_anim_scene_exist(Local_855.f_188.f_5) || !_network_has_control_of_anim_scene(Local_855.f_188.f_5))
				{
					return;
				}
				if (!_is_anim_scene_started(Local_855.f_188.f_5, false))
				{
...
void func_307()
{
	...
	iVar0 = func_236(0);
	if ((((((func_463(0, 8f, 0) || func_423(&(Local_13.f_24.f_3), 40f)) || func_472(iVar0, &(Local_855.f_133), 0)) || func_370(func_450(Local_13.f_24.f_8), 0)) && func_370(131072, 0)) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
	{
		if (!network_has_control_of_entity(iVar0))
		{
			return;
...
void func_308()
{
	...
	if (!is_ped_dead_or_dying(iVar0, true))
	{
		...
		{
			func_471(&(Local_13.f_24.f_3), 0);
			if (((((func_423(&(Local_13.f_24.f_3), 4.5f) && func_463(0, 8f, 0)) || func_472(iVar0, &(Local_855.f_133), 0)) && !func_258(262144, -1, 1)) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
			{
				if (!network_has_control_of_entity(iVar0))
				{
					return;
		...
		else if (((!func_476(iVar0, 242628503) && !func_258(131072, -1, 1)) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
		{
			...
			iVar8 = get_player_ped(func_478(0, 0, 1, 0));
			clear_sequence_task(Local_855.f_188.f_68[0]);
			_0x23767d80c7eed7c6(Local_855.f_188.f_68[0], 774142053);
			_task_smart_flee_style_ped_via(0, iVar8, 4, vVar5, 0, 45f, 1200, 0);
			task_follow_nav_mesh_to_coord(0, vVar5, 3f, -1, 0.25f, 1048581, 40000f);
			task_wander_in_area(0, vVar5, 3.5f, 4.3f, 7f, 0);
			close_sequence_task(&(Local_855.f_188.f_68[0]));
			if (!network_has_control_of_entity(iVar0))
			{
				return;
			}
			clear_ped_tasks(iVar0, 1, 0);
			play_animal_vocalization(iVar0, "GROWL", false);
			task_perform_sequence(iVar0, &(Local_855.f_188.f_68[0]));
			func_424(&(Local_13.f_24.f_3));
		}
	}
}
...
void func_309()
{
	...
	{
		if (((!func_476(iVar0, 518218985) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0)) && !is_ped_dead_or_dying(iVar0, true))
		{
			...
			else
			{
				...
				if (bVar1 == 1)
				{
					task_smart_flee_coord(iVar0, get_entity_coords(iVar0, true, false), (40f / 2f), -1, 2097152, 1077936128);
				}
				else
				{
					task_smart_flee_ped(iVar0, get_player_ped(iVar2), 40f, -1, 2097152, 1077936128, 0);
				}
				func_479(iVar0, 1, -1);
			}
		}
...
bool func_315(int iParam0, int iParam1)
{
	...
	return func_223(Local_86[iParam1]->f_4, iParam0);
}
...
bool func_345(int iParam0, bool bParam1, bool bParam2)
{
	...
	*bParam2 = 0;
	if (iVar8 != 0)
	{
		if (!network_does_network_id_exist(&(Local_13.f_56[iParam0])))
		{
			iVar9 = func_493(iParam0);
			fVar0 = func_494(iParam0);
			if (!func_181(Local_855.f_285.f_7[iParam0]->f_2, 2))
			{
				vVar1 = { _get_object_offset_from_coords(vVar4, 0f, func_495(iParam0)) };
			}
			else
			{
				vVar1 = { func_495(iParam0) };
			}
			if (!func_496(Local_13.f_56[iParam0], iVar8, vVar1, fVar0, 1, 0, (iVar9 == 0 || _is_this_model_a_horse(iVar8)), 1, 1))
			{
				*bParam1 = 1;
			}
			else
			{
				iVar7 = net_to_ped(&(Local_13.f_56[iParam0]));
				if (does_entity_exist(iVar7))
				{
					...
					if (func_346(iParam0))
					{
						if (network_request_control_of_network_id(&(Local_13.f_56[iParam0])))
						{
							_0x7182edda1ee7db5a(&(Local_13.f_56[iParam0]));
						}
					}
					*bParam2 = 1;
					return false;
		...
		else if (_0xa0bc8faed8cfeb3c(net_to_ped(&(Local_13.f_56[iParam0]))))
		{
			return true;
		}
	}
...
{
	return Local_855.f_480[iParam0]->f_5[iParam1]->f_2;
}

bool func_348(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 64);
}

bool func_349(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 16);
}

Vector3 func_350(int iParam0, int iParam1)
{
	return Local_855.f_480[iParam0]->f_5[iParam1]->f_7;
}

bool func_351(int iParam0, int iParam1)
{
	return Local_855.f_480[iParam0]->f_5[iParam1]->f_13;
}
...
{
	return is_bit_set(Local_855.f_480[iParam0]->f_3, iParam1);
}

bool func_354(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 1);
}
...
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 2);
}

bool func_357(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 4);
}

bool func_358(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 128);
}

Vector3 func_359(int iParam0, int iParam1)
{
	return Local_855.f_480[iParam0]->f_5[iParam1]->f_10;
}

bool func_360(int iParam0, int iParam1, int iParam2)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, iParam2);
}
...
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 256);
}

void func_364(int iParam0, int iParam1, bool bParam2)
{
	freeze_entity_position(&(Local_855.f_480[iParam0]->f_5[iParam1]), bParam2);
}

bool func_365(int iParam0, int iParam1)
{
	return func_181(Local_855.f_480[iParam0]->f_5[iParam1]->f_1, 512);
}
...
int func_366(var uParam0, var uParam1)
{
	...
	switch (uParam0->f_2)
	{
		...
		case 7:
			break;
		case 1:
			if (is_ped_using_any_scenario(func_502(uParam1->f_1)))
			{
				func_503(uParam0, 2);
			}
			break;
		...
		case 11:
			...
			if ((func_508(uParam1, 32) && is_ped_fleeing(iVar0)) && func_509(&(uParam0->f_6)) > 10f)
			{
				...
				{
					if ((func_454(iVar1, iVar0, 15f, 1, 1) || (func_454(iVar1, iVar0, 40f, 1, 1) && is_ped_shooting(iVar1))) || func_511(64))
					{
						func_512(uParam0, 1);
						func_503(uParam0, 8);
					}
...
bool func_368()
{
	...
	while (iVar0 < 13)
	{
		...
		else
		{
			...
			if (((does_entity_exist(iVar1) && !is_entity_dead(iVar1)) && func_454(iVar1, func_515(iVar1), 100f, 1, 1)) && is_ped_in_combat(iVar1, 0))
			{
				return true;
			}
		}
...
bool func_369(int iParam0, bool bParam1)
{
	...
	if (bVar1 && !func_181(Local_86[iVar0]->f_6, iParam0))
	{
		func_224(&(Local_86[iVar0]->f_6), iParam0);
		Local_855.f_188.f_3 = (Local_855.f_188.f_3 && Local_86[iVar0]->f_6);
	}
...
{
	return Local_855.f_285.f_7[iParam0]->f_3;
}
...
void func_384(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!is_bit_set(Local_855.f_285.f_5, iParam0))
	{
		if (network_does_network_id_exist(&(Local_13.f_56[iParam0])))
		{
			iVar1 = net_to_ped(&(Local_13.f_56[iParam0]));
			if (!does_entity_exist(iVar1))
			{
				return;
			}
			Local_855.f_285.f_7[iParam0] = iVar1;
			if (bVar3)
			{
				if (is_entity_dead(iVar1) || is_entity_dead(player_ped_id()))
				{
					Local_86[iParam1]->f_7.f_2[iParam0] = -1f;
				}
				else
				{
					Local_86[iParam1]->f_7.f_2[iParam0] = vdist(get_entity_coords(iVar1, true, false), get_entity_coords(player_ped_id(), true, false));
				}
			}
			if (network_is_host_of_this_script())
			{
			...
			if (does_entity_exist(iVar1))
			{
				...
				set_bit(&(Local_855.f_285.f_5), iParam0);
				if (bParam2)
				{
					func_522(iParam0);
				}
...
{
	return &(Local_855.f_480[iParam0]->f_5[iParam1]);
}
...
{
	Local_855.f_285.f_7[iParam0]->f_9 = fParam1;
}
...
{
	func_224(&(Local_855.f_285.f_7[iParam0]->f_2), iParam1);
}
...
void func_418(int iParam0, bool bParam1, int iParam2)
{
	if (bParam1)
	{
		Local_855.f_285.f_2 = (Local_855.f_285.f_2 || Local_86[iParam0]->f_7);
		Local_855.f_285.f_1 = (Local_855.f_285.f_1 && Local_86[iParam0]->f_7);
		Local_855.f_285.f_6 = (Local_855.f_285.f_6 || Local_86[iParam0]->f_7.f_1);
	}
}
...
void func_419(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		Local_86[iParam2]->f_23 = (Local_86[iParam2]->f_23 || Local_86[iParam0]->f_23);
	}
}
...
int func_420(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	Local_86[iParam3]->f_7.f_2[iParam2] = fVar0;
	if (fVar0 > Local_855.f_285.f_7[iParam2]->f_9)
	{
		return 0;
	}
	return 1;
...
bool func_426(int iParam0, int iParam1)
{
	...
	return func_181(Local_86[iParam1]->f_7, iParam0);
}
...
void func_427(int iParam0)
{
	...
	func_224(&(Local_86[iVar0]->f_7), iParam0);
}
...
void func_428(int iParam0)
{
	...
	func_250(&(Local_86[iVar0]->f_7), iParam0);
}
...
float func_429()
{
	...
	{
		Local_855.f_501.f_3 = get_game_timer();
		return 0.03125f;
	}
	iVar0 = get_game_timer();
	fVar1 = (to_float((iVar0 - Local_855.f_501.f_3)) * 0.001f);
...
void func_434()
{
	...
	while (iVar0 <= (network_get_max_num_participants() - 1))
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_855.f_178.f_1 = (Local_855.f_178.f_1 || Local_86[iVar0]->f_4);
			Local_855.f_178.f_2 = (Local_855.f_178.f_2 && Local_86[iVar0]->f_4);
			Local_855.f_25.f_22 = (Local_855.f_25.f_22 || Local_86[iVar0]->f_5);
			Local_855.f_25.f_23 = (Local_855.f_25.f_23 && Local_86[iVar0]->f_5);
			Local_855.f_53.f_79 = (Local_855.f_53.f_79 || Local_86[iVar0]->f_1);
			Local_855.f_53.f_78 = (Local_855.f_53.f_78 && Local_86[iVar0]->f_1);
		}
		iVar0++;
	}
}
...
void func_435()
{
	...
	if (is_bit_set(Local_855.f_178.f_3, Local_855.f_178.f_4))
	{
		return;
	}
	if (!does_entity_exist(iVar0))
...
void func_437(var uParam0)
{
	...
	else if (!func_223(uParam0->f_2, 4))
	{
		...
		if (func_223(uParam0->f_2, 1) && does_entity_exist(*uParam0))
		{
			Var3 = { func_530(1368284188, -1530824760) };
...
void func_438(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_547() && func_548(uParam1->f_1, 40f, 60f, 100f, 1065353216, 5, 0, 1))
	{
		func_549();
	}
	if (!func_462())
	...
	if (!func_508(uParam1, 8) && func_462())
	{
		...
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)) && func_553(4, -1))
			{
	...
	switch (uParam0->f_2)
	{
		case 0:
			if (!func_553(1, -1))
			{
				...
				while (iVar1 <= 12)
				{
					iVar2 = &Local_855.f_285.f_7[iVar1];
		...
		case 7:
			...
			{
				if (func_564(uParam1->f_16) || _0xb89fcff19dafff28(uParam1->f_16, &(uParam1->f_14)))
				{
		...
		case 1:
			if (bVar3 && !is_ped_using_any_scenario(iVar0))
			{
				if (func_508(uParam1, 1))
				{
					...
					{
						task_start_scenario_at_position(iVar0, uParam1->f_3, Local_855.f_285.f_7[uParam1->f_1]->f_6, Local_855.f_285.f_7[uParam1->f_1]->f_5, 0, false, true, 0, -1f, false);
					}
				}
				else
				{
		...
		case 3:
			...
			{
				task_wander_in_area(iVar0, Local_855.f_285.f_7[uParam1->f_1]->f_6, uParam1->f_26, 1077936128, 1086324736, 0);
			}
			break;
		case 4:
			break;
		...
		case 9:
			...
			break;
		case 11:
			if ((!is_entity_dead(iVar0) && !get_ped_config_flag(iVar0, 580, true)) && !func_553(64, -1))
			{
...
void func_439()
{
	...
	if (!does_entity_exist(Local_855.f_53))
	{
		return;
	}
	if (is_entity_dead(Local_855.f_53))
	{
		return;
	}
		...
		case 0:
			...
			if (func_451(Global_34, uParam0->f_66, uParam0->f_46, 1, 1))
			{
				if ((get_frame_count() % 5) == 0)
				{
					...
					iVar2 = (iVar1 % round(uParam0->f_44));
					if (iVar2 < 5)
					{
						func_578(uParam0, 1);
					}
		...
		case 1:
			...
			else if (uParam0->f_43 == -1 || uParam0->f_70 < uParam0->f_43)
			{
				if (!func_422(&(uParam0->f_73)) || func_533(&(uParam0->f_73)) > uParam0->f_44)
				{
					...
					{
						vVar3 = { func_579(get_entity_coords(*uParam0, true, false), uParam0->f_47, 0f) };
...
int func_441(var uParam0)
{
	...
	{
		if ((!func_569(2, -1) && !is_entity_dead(*uParam0)) && is_ped_fleeing(*uParam0))
		{
			func_573(2);
		}
	...
	if (func_453(uParam0, 64) && does_blip_exist(uParam0->f_69))
	{
		remove_blip(&(uParam0->f_69));
	}
	...
	if (((uParam0->f_2 < 3 && Local_13.f_18.f_1) && does_entity_exist(*uParam0)) && !func_590(*uParam0))
	{
		func_468(uParam0, 3);
		func_557(uParam0);
		func_558(uParam0);
	...
	switch (uParam0->f_2)
	{
		case 0:
			...
			break;
		case 1:
			if (!does_blip_exist(uParam0->f_69))
			{
				uParam0->f_69 = _blip_add_for_coord(func_592(), uParam0->f_66);
				_blip_set_modifier(uParam0->f_69, -528849255);
				set_blip_name_from_text_file(uParam0->f_69, "LA_CLUE");
				func_588();
				func_468(uParam0, 2);
			}
			break;
		case 2:
			...
			while (iVar1 <= 12)
			{
				...
				if ((does_entity_exist(iVar0) && is_bit_set(uParam0->f_77, iVar1)) && func_548(iVar1, uParam0->f_49, uParam0->f_50, uParam0->f_51, 1065353216, 5, 0, 1))
				{
					func_557(uParam0);
				}
				else
			...
			iVar0 = *uParam0;
			if (does_entity_exist(iVar0) && func_548(uParam0->f_76, uParam0->f_49, uParam0->f_50, uParam0->f_51, 1065353216, 5, 0, 1))
			{
				func_557(uParam0);
			}
		...
		case 7:
			...
			else if (func_533(&(uParam0->f_73)) > (uParam0->f_56 + ((vdist(Global_35, get_entity_coords(*uParam0, true, false)) / 25f) * uParam0->f_57)) || ((func_422(&(Local_855.f_19.f_3)) && func_533(&(Local_855.f_19.f_3)) < Global_1901947->f_852.f_4) && func_533(&(uParam0->f_73)) > 2f))
			{
...
void func_442(int iParam0)
{
	...
	if ((Local_13.f_18 == 255 && !func_301(2)) || (Local_13.f_18 != 255 && Local_13.f_18 != player_id()))
	{
...
void func_444(int iParam0)
{
	...
	if (!func_301(16))
	{
		if (is_entity_dead(iParam0) && get_ped_index_from_entity_index(func_603(Global_34)) == iParam0)
		{
			func_604();
			func_600(16);
		}
...
void func_445(int iParam0, float fParam1)
{
	...
	if (((!func_301(4) && (get_frame_count() % 10) == 0) && does_entity_exist(Local_855.f_53)) && _0x920684be432875b1(Local_855.f_53))
	{
		func_600(4);
	}
	...
	if (!func_301(128))
	{
		if (((((func_301(8) || func_301(16)) || func_301(4)) || func_316(8)) || (func_316(2) && is_entity_dead(iParam0))) || (is_entity_dead(iParam0) && !_0xa4b6432e3880f2f9(iParam0)))
		{
			func_600(128);
		}
	}
...
bool func_451(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_609(get_entity_coords(iParam0, bParam5, false), vParam1) <= (bParam4 * bParam4))
	{
		return true;
	}
	return false;
...
void func_452(int iParam0)
{
	...
	func_250(&(Local_86[iVar0]->f_6), iParam0);
}
...
bool func_454(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	else if (func_609(get_entity_coords(iParam0, bParam3, false), get_entity_coords(iParam1, bParam3, false)) <= (fParam2 * fParam2))
	{
		return true;
	}
	return false;
...
void func_455(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		set_blip_name_from_text_file(uParam3->f_1, func_611(iParam1, iParam2));
	}
}
...
void func_457()
{
	...
	else if (is_ped_facing_ped(player_ped_id(), iVar0, 135f) && func_459(0, 45f, 255, 0))
	{
		Local_855.f_53.f_56 = 2.75f;
	}
	else if (is_ped_facing_ped(player_ped_id(), iVar0, 135f) && func_459(0, 28f, 255, 0))
	{
...
bool func_459(int iParam0, float fParam1, int iParam2, bool bParam3)
{
	...
	fVar0 = &Local_86[iParam2]->f_7.f_2[iParam0];
	if (fVar0 <= 0f)
	{
		if (bParam3)
		{
			...
			if (does_entity_exist(iVar1))
			{
				...
				{
					fVar0 = vdist(get_entity_coords(iVar1, true, false), func_456(iVar2));
					if (fVar0 < 0f)
					{
						return false;
					}
					Local_86[iParam2]->f_7.f_2[iParam0] = fVar0;
				}
			}
		}
		return false;
...
void func_460(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, char* sParam8, bool bParam9, int iParam10)
{
	...
	if (!func_612(iParam0))
	{
		if ((!bParam9 && vdist(get_entity_coords(iVar0, true, false), vParam1) <= fParam4) || (bParam9 && func_613(get_entity_coords(iVar0, true, false), vParam1) <= fParam4))
		{
			func_614(iParam0, iParam5, iParam6, iParam7, sParam8);
		}
	}
	else if ((!bParam9 && vdist(get_entity_coords(iVar0, true, false), vParam1) > fParam4) || (bParam9 && func_613(get_entity_coords(iVar0, true, false), vParam1) > fParam4))
	{
		func_170(iParam0);
	}
}
...
void func_461()
{
	...
	{
		if (func_548(0, 45f, 60f, 1123024896, 6f, 5, 0, 1))
		{
			func_264(16);
			func_424(&(Local_13.f_24.f_10));
			func_264(4);
...
void func_464(var uParam0)
{
	...
	while (iVar0 < uParam0->f_1)
	{
		...
		{
			if (!is_string_null_or_empty(func_615(&(uParam0->f_2[iVar0]))))
			{
				set_blocking_of_non_temporary_events(uParam0->f_2[iVar0]->f_1, true);
				set_anim_scene_entity(*uParam0, func_615(&(uParam0->f_2[iVar0])), uParam0->f_2[iVar0]->f_1, 0);
			}
...
void func_465(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!is_string_null_or_empty(func_615(iParam2)))
		{
			set_anim_scene_entity(*uParam0, func_615(iParam2), iParam1, 0);
		}
...
void func_466(var uParam0)
{
	if (!is_string_null_or_empty(func_378()))
	{
		_set_anim_scene_playback_list_bool(*uParam0, func_379(), true);
...
bool func_467()
{
	...
	if (!func_476(iVar4, -1098463898))
	{
		...
		task_start_scenario_at_position(iVar4, 83057, vVar1, fVar0, 0, false, true, 0, -1f, false);
		_0x9520175b35e2268d(iVar4, 1);
	...
	if (!func_476(iVar5, -1098463898))
	{
		...
		vVar1 = { func_216(0) };
		func_352(&vVar1, 50, 10, 0, 0);
		task_start_scenario_at_position(iVar5, 83057, vVar1, fVar0, 0, false, true, 0, -1f, false);
	...
	if (!func_476(iVar6, -1098463898))
	{
		...
		vVar1 = { func_216(1) };
		func_352(&vVar1, 50, 10, 0, 0);
		task_start_scenario_at_position(iVar6, 83057, vVar1, fVar0, 0, false, true, 0, -1f, false);
	...
	if (!func_476(iVar7, -1098463898))
	{
		...
		vVar1 = { func_216(2) };
		func_352(&vVar1, 50, 10, 0, 0);
		task_start_scenario_at_position(iVar7, 83057, vVar1, fVar0, 0, false, true, 0, -1f, false);
		set_ped_keep_task(iVar7, true);
		_0x9520175b35e2268d(iVar7, 1);
	}
	Local_13.f_24.f_15 = _0xfa50f79257745e74(func_213(), 1f, 1, -1, 0);
	Local_13.f_24.f_16 = _0xfa50f79257745e74(func_213(), 1.5f, 2, -1, 0);
	Local_13.f_24.f_17 = _0xfa50f79257745e74(func_213(), 1.5f, 4, -1, 0);
	return true;
}
...
{
	iVar0 = func_236(0);
	if (((func_463(0, 12.5f, 0) || (_does_anim_scene_exist(Local_855.f_188.f_5) && _is_anim_scene_finished(Local_855.f_188.f_5, false))) || func_472(iVar0, &(Local_855.f_133), 0)) || func_370(8, 0))
	{
		if (func_463(0, 12.5f, 0) || func_472(iVar0, &(Local_855.f_133), 0))
		{
			if ((!func_476(iVar0, 518218985) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
			{
				if (!network_has_control_of_entity(iVar0))
				{
					return;
				...
				set_entity_invincible(iVar0, false);
				clear_ped_tasks(iVar0, 1, 0);
				task_smart_flee_ped(iVar0, get_player_ped(iVar1), 40f, -1, 2097152, 1077936128, 0);
				func_479(iVar0, 1, -1);
			}
		}
		else if ((!func_476(iVar0, -875674219) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
		{
			if (!network_has_control_of_entity(iVar0))
			{
				return;
	...
	if (func_548(0, 28f, 60f, 1123024896, func_617((func_616(player_ped_id()) || is_ped_in_any_vehicle(player_ped_id(), false)), 1.5f, 3f), 5, 0, 1) && !func_370(8, 0))
	{
		if ((!_does_anim_scene_exist(Local_855.f_188.f_5) || !_is_anim_scene_started(Local_855.f_188.f_5, false)) || !_network_has_control_of_anim_scene(Local_855.f_188.f_5))
		{
			return;
		}
		if (get_anim_scene_bool(Local_855.f_188.f_5, "bStopLoop") == 0)
		{
			func_264(16);
			Local_855.f_53.f_45 = -111342534;
			set_anim_scene_bool(Local_855.f_188.f_5, "bStopLoop", true, false);
		}
	}
}
...
void func_470()
{
	...
	{
		if ((!func_476(iVar0, 242628503) && !get_ped_config_flag(iVar0, 580, true)) && !is_entity_on_fire(iVar0))
		{
			iVar4 = func_478(0, 0, 1, 0);
			set_ped_can_ragdoll(iVar0, false);
			clear_sequence_task(Local_855.f_188.f_68[0]);
			play_animal_vocalization(iVar0, "GROWL", false);
			_0x23767d80c7eed7c6(Local_855.f_188.f_68[0], -1057784427);
			...
			{
				task_turn_ped_to_face_entity(0, player_ped_id(), 300, -1082130432, -1082130432, -1082130432);
			}
			task_smart_flee_ped(0, get_player_ped(iVar4), 60f, -1, 2097152, 1077936128, 0);
			close_sequence_task(&(Local_855.f_188.f_68[0]));
			if (!network_has_control_of_entity(iVar0))
			{
				return;
	...
	if ((func_548(0, 45f, 60f, 1123024896, func_617((func_616(player_ped_id()) || is_ped_in_any_vehicle(player_ped_id(), false)), 1f, 1.75f), 5, 0, 1) || func_463(0, 45f, 0)) && !func_370(8, 0))
	{
		func_264(16);
		Local_855.f_53.f_45 = -111342534;
		func_264(16);
...
bool func_472(int iParam0, var uParam1, bool bParam2)
{
	...
	{
		if (((func_454(Global_34, iParam0, _0x79b1a6e780266db0(Global_34), 1, 1) && _0x285d36c5c72b0569(Global_34) <= 0.5f) && func_620(iParam0, 0.45f, 0.55f, 0.45f, 0.55f)) && !is_entity_occluded(iParam0))
		{
			uParam1->f_33 = 4;
			return true;
		}
...
int func_478(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (bParam2)
	{
		if (!does_entity_exist(&(Local_855.f_285.f_7[iParam0])))
		{
			return 255;
		}
	}
	...
	while (iVar0 < 32)
	{
		...
		else if (&Local_86[iVar0]->f_7.f_2[iParam0] <= 0f)
		{
		}
		else if (bParam3 && !func_484(iVar0))
		{
		}
		else if (iVar1 != -1 && &Local_86[iVar0]->f_7.f_2[iParam0] > &Local_86[iVar1]->f_7.f_2[iParam0])
		{
		}
		else if (bVar2 && &Local_86[iVar0]->f_7.f_2[iParam0] > fParam1)
		{
		}
		else
		{
...
{
	if ((!func_623(1) && bParam1) && get_animal_tuning_float_param(iParam0, 74) > 0f)
	{
	...
	if (network_has_control_of_entity(iParam0))
	{
		if (!func_623(1))
		{
			...
			{
				_task_smart_flee_style_ped(iParam0, func_515(iParam0), 3, 67117056, 9999f, -1, 0);
...
void func_481(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	switch (&Local_855.f_188.f_82[iParam1])
	{
		case 0:
			...
			clear_sequence_task(Local_855.f_188.f_68[iParam1]);
			_0x23767d80c7eed7c6(Local_855.f_188.f_68[iParam1], -1957518815);
			task_wander_in_area(0, get_entity_coords(iParam0, true, false), 8f, 1077936128, 1086324736, 0);
			close_sequence_task(&(Local_855.f_188.f_68[iParam1]));
			if (network_has_control_of_entity(iParam0))
			{
				clear_ped_tasks(iParam0, 1, 0);
				task_perform_sequence(iParam0, &(Local_855.f_188.f_68[iParam1]));
				*uParam2 = 2;
			}
			break;
		case 2:
		...
		case 6:
			...
			iVar1 = get_player_ped(iVar0);
			clear_sequence_task(Local_855.f_188.f_68[iParam1]);
			_0x23767d80c7eed7c6(Local_855.f_188.f_68[iParam1], -1341261490);
		...
		case 4:
			iVar0 = func_478(iParam1, 0, 1, 0);
			iVar1 = get_player_ped(iVar0);
			if ((has_entity_been_damaged_by_entity(iVar1, iParam0, 1, 1) || has_entity_been_damaged_by_entity(iParam0, iVar1, 1, 1)) || &Local_13.f_24.f_18[iParam1] == 3)
			{
				clear_sequence_task(Local_855.f_188.f_68[iParam1]);
				_0x23767d80c7eed7c6(Local_855.f_188.f_68[iParam1], -2073766901);
				task_smart_flee_ped(0, iVar1, 35f, 40000, 0, 1077936128, 0);
				task_set_blocking_of_non_temporary_events(0, false);
				close_sequence_task(&(Local_855.f_188.f_68[iParam1]));
				if (network_has_control_of_entity(iParam0))
				{
...
int func_488(int iParam0)
{
	...
	{
		iVar0 = ((func_628() - _0xe13634bb6baf0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
{
	return Local_855.f_285.f_7[iParam0]->f_4;
}

float func_494(int iParam0)
{
	return Local_855.f_285.f_7[iParam0]->f_5;
}

Vector3 func_495(int iParam0)
{
	return Local_855.f_285.f_7[iParam0]->f_6;
}
...
bool func_505(var uParam0, var uParam1)
{
	...
	set_anim_scene_entity(uParam1->f_16, &(uParam1->f_14), func_502(uParam1->f_1), 0);
	func_631(uParam1->f_16);
	set_anim_scene_origin(uParam1->f_16, Local_855.f_285.f_7[uParam1->f_1]->f_6, 0f, 0f, Local_855.f_285.f_7[uParam1->f_1]->f_5, 2);
...
{
	return (to_float(func_633(uParam0)) * 0.001f);
}

int func_510(int iParam0)
{
	return get_player_ped(func_634(iParam0));
}
...
{
	return func_635(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
{
	return get_player_ped(func_636(iParam0));
}
...
void func_516(int iParam0)
{
	...
	if (_0x3f59fe6f37869576(iParam0->f_1, get_player_index()) && func_484(255))
	{
		if (!func_587())
		{
			func_588();
...
{
	return Local_855.f_285.f_7[iParam0]->f_10;
}
...
{
	_0xd9130842d7226045(func_642(iParam0), 0);
}
...
bool func_539(int iParam0)
{
	if (does_entity_exist(&(Local_855.f_285.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_855.f_285.f_7[iParam0])))
		{
			uVar0 = &Local_855.f_285.f_7[iParam0];
...
bool func_548(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (bParam7)
	{
		if (func_649(player_id(), iVar0) || is_player_free_aiming_at_entity(player_id(), iVar0))
		{
			return true;
		}
	}
	...
	else if ((func_454(Global_34, iVar0, fParam3, 1, 1) && func_650()) && is_tracked_ped_visible(iVar0))
	{
		bVar1 = true;
	}
	if (bVar1)
	{
		if (!func_422(Local_855.f_53.f_3[iParam0]))
		{
			func_471(Local_855.f_53.f_3[iParam0], 0);
		}
		else if (func_533(Local_855.f_53.f_3[iParam0]) > fParam4)
		{
			return true;
		}
	}
	else if (func_422(Local_855.f_53.f_3[iParam0]))
	{
		func_424(Local_855.f_53.f_3[iParam0]);
	}
	return false;
}
...
void func_552(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (bVar2)
	{
		if ((!is_ped_fleeing(iVar0) || !func_567(iVar0, 518218985)) || bParam3)
		{
	...
	{
		case 1:
			if ((!is_ped_in_combat(iVar0, 0) || !func_567(iVar0, 780511057)) || bParam3)
			{
...
bool func_553(int iParam0, int iParam1)
{
	...
	return func_223(Local_86[iParam1]->f_5, iParam0);
}
...
bool func_554(var uParam0, int iParam1)
{
	...
	{
		case 1:
			return (func_567(iParam1, 780511057) || is_ped_in_combat(iParam1, 0));
		case 0:
			return (func_567(iParam1, 518218985) || is_ped_fleeing(iParam1));
	}
	return false;
}
...
void func_559(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar2 <= 12)
	{
		iVar0 = &Local_855.f_285.f_7[iVar2];
...
void func_560(var uParam0, var uParam1)
{
	...
	{
		iVar0 = &Local_855.f_285.f_7[iVar2];
		if ((((((iVar2 != uParam1->f_1 && iVar2 != uParam1->f_2) && does_entity_exist(iVar0)) && network_has_control_of_entity(iVar0)) && !is_entity_dead(iVar0)) && !get_ped_config_flag(iVar0, 580, true)) && !func_554(uParam0, iVar0))
		{
			switch (uParam0->f_1)
			{
				case 1:
...
void func_561(var uParam0)
{
	...
	while (iVar1 <= 12)
	{
		iVar0 = &Local_855.f_285.f_7[iVar1];
		...
		{
			task_wander_in_area(iVar0, Local_855.f_285.f_7[uParam0->f_1]->f_6, uParam0->f_27, 1077936128, 1086324736, 0);
			set_ped_keep_task(iVar0, true);
			if (Local_13.f_7.f_1 == 1)
			{
...
{
	set_bit(&(Local_855.f_53.f_77), iParam0);
}

void func_563(int iParam0)
{
	if (!func_483(participant_id_to_int(), 0, 1))
	{
		return;
	}
	func_252(&(Local_86[participant_id_to_int()]->f_5), iParam0);
}
...
void func_568(int iParam0)
{
	...
	func_253(&(Local_86[participant_id_to_int()]->f_5), iParam0);
}
...
bool func_569(int iParam0, int iParam1)
{
	...
	return func_223(Local_86[iParam1]->f_1, iParam0);
}
...
void func_571(int iParam0)
{
	...
	func_253(&(Local_86[participant_id_to_int()]->f_1), iParam0);
}
...
void func_573(int iParam0)
{
	...
	func_252(&(Local_86[participant_id_to_int()]->f_1), iParam0);
}
...
{
	return _0xd9130842d7226045(&(uParam0->f_58), 0);
}
...
{
	if (is_string_null_or_empty(&(uParam0->f_58)))
	{
		return;
	}
	_play_sound_from_position("CALL", vParam1, &(uParam0->f_58), false, 0, true, 0);
}
...
void func_585(int iParam0, var uParam1, bool bParam2)
{
	...
	if ((((!is_entity_dead(iParam0) && func_584(uParam1)) && !get_ped_config_flag(iParam0, 580, true)) && network_has_control_of_entity(iParam0)) && (get_frame_count() % 10) == 0)
	{
...
void func_593(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		*uParam1 = _blip_add_for_entity(func_669(), iParam0);
		...
		set_blip_name_from_text_file(*uParam1, func_670(func_385(get_entity_model(iParam0))));
	}
}
...
void func_602(int iParam0)
{
	...
	func_252(&(Local_86[participant_id_to_int()]->f_4), iParam0);
}
...
bool func_606(int iParam0)
{
	if (does_entity_exist(&(Local_855.f_285.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_855.f_285.f_7[iParam0])))
		{
			delete_ped(Local_855.f_285.f_7[iParam0]);
			Local_855.f_285.f_7[iParam0] = 0;
			return true;
		}
	}
	return false;
...
void func_607(int iParam0)
{
	...
	func_253(&(Local_86[participant_id_to_int()]->f_4), iParam0);
}
...
{
	return does_blip_exist(Local_855.f_285.f_7[iParam0]->f_1);
}
...
void func_614(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4)
{
	...
	iVar0 = _blip_add_for_entity(iParam1, &(Local_855.f_285.f_7[iParam0]));
	if (iParam2 != 0)
	{
	...
	Local_855.f_285.f_7[iParam0]->f_1 = iVar0;
}
...
bool func_618(int iParam0)
{
	...
	if (get_ped_config_flag(iVar3, 580, true) || is_entity_on_fire(iVar3))
	{
		return true;
	}
	clear_sequence_task(Local_855.f_188.f_68[iParam0]);
	_0x23767d80c7eed7c6(Local_855.f_188.f_68[iParam0], -884912130);
	if ((!func_463(iParam0, 12.5f, 0) && !func_472(iVar2, &(Local_855.f_133), 0)) && !func_472(iVar3, &(Local_855.f_133), 0))
	{
		task_turn_ped_to_face_entity(0, player_ped_id(), get_random_int_in_range(50, 300), -1082130432, -1082130432, -1082130432);
	}
	task_smart_flee_ped(0, iVar1, 60f, -1, 2097152, 1077936128, 0);
	task_set_blocking_of_non_temporary_events(0, false);
	task_wander_standard(0, 40000f, 0);
	close_sequence_task(&(Local_855.f_188.f_68[iParam0]));
	...
	play_animal_vocalization(iVar3, "GROWL", false);
	task_perform_sequence(iVar3, &(Local_855.f_188.f_68[iParam0]));
	_0x2208438012482a1a(iVar3, true, false);
	return true;
}
...
bool func_619(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1940258->f_6 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1940258->f_20 && func_679(player_id(), 0, 1, uParam2->f_2 & 524288 == 0))
		{
		...
		{
			if (func_680(uParam2, 1065353216))
			{
				if (!uParam2->f_2 & 4 != 0)
				{
...
{
	return func_709(get_entity_coords(iParam0, true, false), 1203982208, 1, 1);
}
...
var func_635(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_711());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_711());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_711());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_712(get_player_team(iVar5)));
	}
...
{
	return func_709(get_entity_coords(iParam0, true, false), 1203982208, 1, 0);
}
...
{
	switch (func_385(get_entity_model(iParam0)))
	{
		case 0:
			return "LEGENDARY_ALLIGATOR_CALL_SOUNDS";
		case 1:
...
void func_647(var uParam0, var uParam1)
{
	...
	bVar0 = false;
	if (does_entity_exist(*uParam1) && func_622(*uParam1, Global_35, 1) < 300f)
	{
		bVar0 = true;
	}
	bVar1 = false;
...
{
	switch (func_388(func_385(get_entity_model(iParam0))))
	{
		case -1630294353:
			return 5f;
		case -1754709769:
...
bool func_652(int iParam0, var uParam1, var uParam2, float fParam3)
{
	...
	if (!Global_1940258->f_6 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1940258->f_19)
		{
			if (func_680(uParam1, 1065353216))
			{
				if (!uParam1->f_2 & 4 != 0)
				{
...
Vector3 func_658(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_724(vVar0, get_random_float_in_range(0f, fParam3)) };
...
void func_665(struct<2> Param0)
{
	...
	{
		_0xb2a38826e5886e83(func_321(Param0), Global_265377->f_124517.f_71.f_17);
...
{
	Var0.f_10 = 255;
	_copy_memory(&(Var0.f_4), &Local_855, 5);
	Var0.f_9 = iParam0;
	Var0 = 182;
	Var0.f_1 = player_id();
	Var0.f_2 = get_network_time_accurate();
	...
	switch (uParam0->f_7)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!is_ped_planting_bomb(Global_34) && (!func_733(1, 1) || *uParam0 & 8192 != 0))
				{
	...
	while (iVar0 <= 31)
	{
		...
		else
		{
			...
			else
			{
				...
				if (bParam5)
				{
					if (((_is_ped_hogtied(iVar6) || _0x833f0053340ef413(iVar6)) || func_569(4, iVar1)) || is_ped_in_any_vehicle(iVar6, false))
					{
					}
					else
					{
...
void func_719(int iParam0)
{
	...
	_play_sound_from_position(func_779(iParam0), vVar0, func_642(iParam0), false, 0, true, 0);
}
...
bool func_721(int iParam0, var uParam1)
{
	...
	{
		fVar1 = -1f;
		fVar2 = func_781(_0x2ba9d7bf629f920c(iParam0), (fVar0 + 5f));
...
bool func_758(int iParam0, int iParam1)
{
	...
	if (!_is_weapon_lasso(func_793(iParam0, 1, 0, 0)) && !func_793(iParam0, 1, 0, 0) == 1151374672)
	{
		return false;
	}
...
bool func_773(int iParam0, int iParam1)
{
	...
	{
		return func_795(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
