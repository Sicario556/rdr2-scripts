...
bool func_13()
{
	iLocal_13 = _create_volume_aggregate_with_custom_name("Dairy Farm - m_volTown");
	_0xbce668aaf83608be(iLocal_13, 1446.658f, -888.688f, 61.14607f, 0f, 0f, -30.46523f, 38.831f, 28.399f, 35.021f);
	_0x39816f6f94f385ad(iLocal_13, 1407.375f, -859.71f, 59.085f, 0f, 0f, -90.621f, 63.166f, 105.945f, 86.732f);
	if (!network_is_game_in_progress())
	{
		iLocal_16 = _create_volume_aggregate_with_custom_name("Dairy Farm - m_volThreat Agg");
		_0x39816f6f94f385ad(iLocal_16, 1372.365f, -874.1071f, 60.63414f, 0f, 0f, 105.3542f, 13.90285f, 14.67721f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1379.527f, -839.9418f, 70.09288f, 0f, 0f, 28.55685f, 26.50747f, 16.5324f, 20.06959f);
		_0x39816f6f94f385ad(iLocal_16, 1389.031f, -831.3408f, 67.95767f, 0f, 0f, 17.35302f, 5.587527f, 9.447437f, 11.73771f);
		_0x39816f6f94f385ad(iLocal_16, 1366.106f, -845.9993f, 67.95767f, 0f, 0f, 17.35302f, 4.930151f, 14.78831f, 11.73771f);
		_0xbce668aaf83608be(iLocal_16, 1368.879f, -851.3331f, 70.96919f, 0f, 0f, 0f, 3.971671f, 2.768736f, 7.919377f);
		_0x39816f6f94f385ad(iLocal_16, 1448.137f, -909.5335f, 58.70924f, 0f, 0f, 52.91796f, 9.811359f, 48.19019f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1464.168f, -883.314f, 59.08516f, 0f, 0f, 106.2223f, 38.17617f, 16.57248f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1451.656f, -880.889f, 59.08516f, 0f, 0f, 0f, 30.79945f, 37.44294f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1459.521f, -904.4871f, 58.70924f, 0f, 0f, 75.93813f, 23.5689f, 29.93386f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1414.417f, -868.4174f, 60.63414f, 0f, 0f, -160.2662f, 13.42301f, 10.60738f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1406.751f, -874.8239f, 60.63414f, 0f, 0f, 100.2132f, 11.28151f, 7.901964f, 37.7322f);
		_0xbce668aaf83608be(iLocal_16, 1427.325f, -884.8317f, 49.45563f, 0f, 0f, 1.967795f, 16.6387f, 14.40915f, 35.02085f);
		_0xbce668aaf83608be(iLocal_16, 1426.821f, -870.1688f, 49.45563f, 0f, 0f, 1.967794f, 16.6387f, 8.68586f, 35.02085f);
		_0x39816f6f94f385ad(iLocal_16, 1446.194f, -836.771f, 59.08516f, 0f, 0f, -74.26128f, 27.16599f, 24.853f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1428.484f, -833.5745f, 59.08516f, 0f, 0f, -90.62106f, 27.16599f, 39.94446f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1450.635f, -849.8392f, 59.08516f, 0f, 0f, -87.62164f, 4.481297f, 24.853f, 37.7322f);
		_0x39816f6f94f385ad(iLocal_16, 1423.217f, -846.8712f, 59.08516f, 0f, 0f, -90.62106f, 10.00643f, 39.94446f, 37.7322f);
		_0xbce668aaf83608be(iLocal_16, 1408.666f, -831.0827f, 49.45563f, 0f, 0f, 1.967795f, 9.140027f, 9.551268f, 35.02085f);
		_0xbce668aaf83608be(iLocal_16, 1405.983f, -843.9208f, 70.19928f, 0f, 0f, 0f, 5.74873f, 11.05348f, 20.80677f);
		iLocal_15 = _create_volume_aggregate_with_custom_name("Dairy Farm - m_volRestricted Agg");
		_0x6e0d3c3f828da773(iLocal_15, iLocal_16);
		_0xbce668aaf83608be(iLocal_15, 1374.823f, -866.7698f, 49.45563f, 0f, 0f, -89.62331f, 28.03277f, 26.98123f, 35.02085f);
		iLocal_14 = _create_volume_aggregate_with_custom_name("Dairy Farm - m_volWarning Agg");
		_0x6e0d3c3f828da773(iLocal_14, iLocal_15);
		_0xbce668aaf83608be(iLocal_14, 1445.876f, -840.8851f, 61.14609f, 0f, 0f, -94.3453f, 25.51381f, 23.81601f, 17.87893f);
		_0xbce668aaf83608be(iLocal_14, 1461.857f, -868.7903f, 61.14607f, 0f, 0f, -82.23228f, 39.60072f, 15.04517f, 35.021f);
		_0xbce668aaf83608be(iLocal_14, 1458.823f, -903.0386f, 61.14607f, 0f, 0f, -94.3453f, 29.6741f, 23.81601f, 35.021f);
		_0xbce668aaf83608be(iLocal_14, 1410.49f, -862.8301f, 61.14607f, 0f, 0f, -84.98452f, 45.42525f, 64.49104f, 35.021f);
		...
		_0x8c598a930f471938(sLocal_17, iLocal_14);
		_0x35815f372d43e1e5(sLocal_17, iLocal_15);
		_0xad3e07c37a7c1adc(sLocal_17, iLocal_14);
		_0xa1b0e6301e2e02a6(sLocal_17, iLocal_16);
		_set_guard_zone_position(sLocal_17, 1372.172f, -874.3451f, 70.298f);
		_0xa8a74aa79fb67159(sLocal_17, iLocal_14);
	}
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_27)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_75(iLocal_27, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_61()
{
	...
	if (!does_entity_exist(_0x7fd78dfd0c5d7b9b(iLocal_15)))
	{
		func_92();
	}
	iVar0 = 756;
...
void func_92()
{
	func_130(754, iLocal_15, 1);
	func_130(755, iLocal_15, 0);
	func_130(756, iLocal_15, 0);
	_0x4a8fefc43fd8ac9b(iLocal_15, 3, 1);
	_0x53d05d60e5f5b40c(iLocal_15, 3, 1, func_127(755));
	_0x53d05d60e5f5b40c(iLocal_15, 3, 1, func_127(756));
}
...
{
	if (func_87(Global_1915715->f_3[iParam0]->f_21) && func_144(Global_1915715->f_3[iParam0]->f_21))
	{
...
{
	func_172(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_164(int iParam0, bool bParam1)
{
	...
	return !_0xeb98b38ca60742d7(func_127(iParam0));
}
...
bool func_165()
{
	...
	if (!func_167(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_169(vector3 vParam0, int iParam3)
{
