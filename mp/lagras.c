void __EntryFunction__()
{
	...
	func_2();
	func_3();
	iLocal_29 = get_game_timer();
	iVar0 = 0;
	while (func_4())
	{
		if (get_game_timer() > iLocal_29)
		{
			iLocal_29 = 0;
			...
			switch (iLocal_28)
			{
				case 0:
					if (Global_1901947->f_1.f_26 > 0)
					{
						iLocal_31 = (get_game_timer() + Global_1901947->f_1.f_26);
						iLocal_28 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_31 < get_game_timer())
					{
						bLocal_32 = false;
						iLocal_28 = 2;
					}
				...
				case 2:
					...
					_0x9bbdcb8df789ebc1(player_id(), func_12(iLocal_30));
					Global_1896620 = -1;
					iLocal_31 = (iLocal_27 + get_game_timer());
					iLocal_28 = 3;
					break;
				case 3:
					if (func_13() || iLocal_31 < get_game_timer())
					{
						func_14(iLocal_30);
						iLocal_31 = (iLocal_27 + get_game_timer());
						iLocal_28 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_30) || iLocal_31 < get_game_timer())
					{
						func_16(iLocal_30);
						iLocal_31 = (get_game_timer() + iLocal_27);
						iLocal_28 = 5;
					}
					break;
				case 5:
					if (func_17(iLocal_30) || iLocal_31 < get_game_timer())
					{
						func_18(iLocal_30);
						iLocal_31 = (iLocal_27 + get_game_timer());
						iLocal_28 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_30)))
					{
						if (func_19(func_9(iLocal_30), 4) && !iLocal_31 < get_game_timer())
						{
						}
						else
						{
							if (func_20(iLocal_30) || iLocal_31 < get_game_timer())
							{
								func_21(iLocal_30, 4);
								iLocal_31 = (iLocal_27 + get_game_timer());
								iLocal_28 = 8;
							...
							set_ambient_ped_range_multiplier_this_frame((*Global_1887339)[iLocal_30]->f_11);
							if ((*Global_1887339)[iLocal_30]->f_12 > 0f)
							{
								_0xa77fa7be9312f8c0((*Global_1887339)[iLocal_30]->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if ((*Global_1887339)[iLocal_30]->f_13 != 0)
						{
							_0x95423627a9ca598e((*Global_1887339)[iLocal_30]->f_13);
						}
						wait(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = (*Global_1887339)[3]->f_5;
	_0xb469cfd9e065eb99(iLocal_19, 1);
	iLocal_20 = _create_volume_box_with_custom_name(2162.926f, -618.1368f, 42.473f, 0f, 0f, 44.5f, 10.521f, 13f, 4f, "Lagras - m_volBaitShop");
	iLocal_21 = _create_volume_box_with_custom_name(2162.323f, -619.085f, 43.189f, 0f, 0f, -44f, 2.27f, 2.954f, 2.579f, "Lagras - m_volBaitPrompt");
	_0xb469cfd9e065eb99(iLocal_20, 10000);
	iLocal_22 = _create_volume_box_with_custom_name(1964.833f, -527.56f, 41.499f, 0f, 0f, 0f, 14.456f, 10.148f, 8.8f, "BAY Harriet - m_volHarriet");
	iLocal_23 = _create_volume_cylinder_with_custom_name(1966.679f, -527.5971f, 41.941f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "BAY Harriet - m_volHarrietPrompt");
	iLocal_24 = _create_volume_box_with_custom_name(1963.142f, -528.919f, 41.852f, 0f, 0f, 0f, 4.045f, 4.156f, 2f, "BAY Harriet - m_volHarrietOffLimits");
	vVar0.x = iLocal_24;
	vVar0.f_2 = -1;
	_0x733077295ab51304(&vVar0);
	uLocal_25 = _0x0eb78c2b156635b1(-1612834106, 1964.789f, -528.676f, 41.852f, 0f, 0f, 0f, 1f, 1f, 2f);
	_0xbe551c2cc421185d(uLocal_25, 1);
	_0x5b23dff8e0948bb2(uLocal_25, 1);
	uLocal_26 = _0x0eb78c2b156635b1(-1612834106, 1966.414f, -528.38f, 41.852f, 0f, 0f, 0f, 3.2f, 7.3f, 2f);
	_0xbe551c2cc421185d(uLocal_26, 1);
	_0x5b23dff8e0948bb2(uLocal_26, 0);
	return true;
}
...
{
	func_58(14, iLocal_20, iParam0, iLocal_21, 0, 4, 0, 0, -1082130432, 0);
	func_59(14, 0);
	func_58(39, iLocal_22, iParam0, iLocal_23, iLocal_24, 2097164, 1, 0, -1082130432, 0);
	func_60(39, 65536);
	func_60(39, 32768);
	set_ambient_zone_state("AZ_Naturalist_Camp", true, true);
	_0x3743ce6948194349("AZ_Naturalist_Camp", _0xf70f00013a62f866(iLocal_22), 0f);
	func_61(39, 4096);
}
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_67(&Global_1940258, 32768)) || func_67(&Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_30)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_80(iLocal_30, 0), 1);
					break;
			}
		}
		if (func_10(func_73()))
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_100(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_101(Global_1051439->f_72[iParam0]->f_18);
...
{
	if ((func_105(iParam0, 16384) || func_105(iParam0, 32768)) || func_106(Global_1051439->f_72[iParam0]->f_3))
	{
...
{
	func_111(&(Global_1051439->f_72[iParam0]->f_49), iParam1);
}
...
void func_61(int iParam0, int iParam1)
{
	...
	func_111(&(Global_1915715->f_3[iParam0]->f_7), iParam1);
}
...
bool func_71(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_117(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!_should_use_24_hour_clock())
		{
			...
			sVar2 = _create_var_string(674, sVar8, iVar4, func_131(&cVar6, 109029619), sVar9, func_131(&cVar10, 109029619));
		}
		else
		{
			...
			IntToString(&cVar10, round(fVar7), 8);
			sVar2 = _create_var_string(162, sVar8, iVar4, func_131(&cVar6, 109029619), func_131(&cVar10, 109029619));
		}
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_146(iParam0, _create_persistent_character(func_145(iParam0)));
		if (func_45() == -1)
		{
...
void func_98(bool bParam0, bool bParam1)
{
	...
	if (func_106(get_entity_coords(get_player_ped(player_id()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
void func_99(int iParam0, bool bParam1)
{
	...
	else if (func_160(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_163(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_166(iParam0, 2))
	{
...
int func_108(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_110(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_172(uParam1, vParam2, uParam5, 0, 0, 0);
...
char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
char* func_131(char* sParam0, int iParam1)
{
	...
	return func_183(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_184(Global_1940018->f_5[iParam0]->f_6, 1);
	func_185(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_92(Global_1915715->f_3[iParam0]->f_21) && func_187(Global_1915715->f_3[iParam0]->f_21))
	{
		func_188(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_189(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_163(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	return func_208(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_210(12, func_209(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
char* func_177(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_219(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_197(int iParam0, int iParam1)
{
	...
	{
		return func_227(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
