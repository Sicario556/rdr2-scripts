...
bool func_13()
{
	iLocal_19 = _create_volume_box_with_custom_name(-2183.916f, -2135.043f, 75.907f, 0f, 0f, 130f, 14.456f, 10.148f, 8.8f, "HEN Harriet - m_volHarriet");
	iLocal_20 = _create_volume_cylinder_with_custom_name(-2185.63f, -2132.347f, 75.0567f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "HEN Harriet - m_volHarrietPrompt");
	iLocal_21 = _create_volume_box_with_custom_name(-2182.134f, -2134.707f, 73.87f, 0f, 0f, 130f, 3.364f, 3.818f, 2f, "HEN Harriet - m_volHarrietOffLimits");
	vVar0.x = iLocal_21;
	vVar0.f_2 = -1;
	_0x733077295ab51304(&vVar0);
	uLocal_22 = _0x0eb78c2b156635b1(-1612834106, -2183.285f, -2133.454f, 73.87f, 0f, 0f, 130f, 1f, 1f, 2f);
	_0xbe551c2cc421185d(uLocal_22, 1);
	_0x5b23dff8e0948bb2(uLocal_22, 1);
	uLocal_23 = _0x0eb78c2b156635b1(-1612834106, -2184.635f, -2132.268f, 73.87f, 0f, 0f, 130f, 3.2f, 7.3f, 2f);
	_0xbe551c2cc421185d(uLocal_23, 1);
	_0x5b23dff8e0948bb2(uLocal_23, 0);
	return true;
}
...
{
	func_58(39, iLocal_19, iParam0, iLocal_20, iLocal_21, 2097164, 1, 0, -1082130432, 0);
	func_59(39, 65536);
	func_59(39, 32768);
	func_60(39, 4096);
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_27)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_76(iLocal_27, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_60(int iParam0, int iParam1)
{
	...
	func_101(&(Global_1915715->f_3[iParam0]->f_7), iParam1);
}
...
bool func_67(int iParam0)
{
	...
	return (((*Global_1887339)[iParam0]->f_21 == 1 || (*Global_1887339)[iParam0]->f_21 == 2) && !func_104(iParam0));
}
...
void func_94(bool bParam0, bool bParam1)
{
	...
	if (func_140(get_entity_coords(get_player_ped(player_id()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
void func_95(int iParam0, bool bParam1)
{
	...
	else if (func_150(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_156(iParam0, 2))
	{
...
char* func_118(char* sParam0, int iParam1)
{
	...
	return func_170(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_171(Global_1940018->f_5[iParam0]->f_6, 1);
	func_172(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_88(Global_1915715->f_3[iParam0]->f_21) && func_174(Global_1915715->f_3[iParam0]->f_21))
	{
		func_175(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_176(Global_1915715->f_3[iParam0]->f_9, 0);
...
{
	return func_195(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_197(12, func_196(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
char* func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_205(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
