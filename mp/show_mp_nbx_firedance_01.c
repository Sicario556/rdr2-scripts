...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				reserve_network_mission_objects((6 - get_num_reserved_mission_objects(0)));
				return;
			}
			if (get_num_reserved_mission_peds(0) < uParam0->f_23)
			{
				reserve_network_mission_peds((2 - get_num_reserved_mission_peds(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
bool func_21(var uParam0)
{
	if (network_is_host_of_this_script())
	{
		...
		if (!_does_anim_scene_exist(_net_to_anim_scene(uParam0->f_1374)))
		{
			uParam0->f_1373 = _create_anim_scene("script@shows@fire_performer@act1_p1@action", 2, 0, true, true);
			uParam0->f_1374 = _anim_scene_to_net(uParam0->f_1373);
		}
	}
	request_clip_set("script_shows@fireperformer@act1_p1");
	return true;
}
...
void func_48(var uParam0, var uParam1, var uParam2)
{
	...
	{
		func_128((*uParam1)[uParam2->f_1], 1);
	}
	...
	{
		func_128((*uParam1)[uParam2->f_1], 2);
	}
}
...
void func_49(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_129(uParam0->f_12[iVar0], uParam1->f_3[iVar0]))
			{
				func_130(uParam0->f_12[iVar0], uParam1->f_3[iVar0]);
			}
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	switch (*uParam1)
	{
		...
		case 3:
			...
			{
				set_anim_scene_entity(uParam0->f_9, func_135(iParam2), uParam0->f_2, 0);
				iVar0 = 0;
				while (iVar0 <= (5 - 1))
				{
					set_anim_scene_entity(uParam0->f_9, func_136(iParam2, iVar0), &(uParam0->f_3[iVar0]), 0);
					iVar0++;
				}
...
{
	if (!has_clip_set_loaded("script_shows@fireperformer@act1_p1"))
	{
		return false;
	}
	return true;
...
bool func_94(var uParam0)
{
	...
	if (!does_entity_exist(&(uParam0->f_1393[0])))
	{
		...
		{
			set_anim_scene_entity(iVar0, "BOTTLE", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[1])))
	{
		if (func_151(uParam0->f_1393[1], &(uParam0->f_1385[1]), 2548.551f, -1308.547f, 48.2211f))
		{
			set_anim_scene_entity(iVar0, "lantern", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[2])))
	{
		if (func_151(uParam0->f_1393[2], &(uParam0->f_1385[2]), 2553.659f, -1313.054f, 48.2166f))
		{
			set_anim_scene_entity(iVar0, "BATON", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return false;
	...
	if (!does_entity_exist(&(uParam0->f_1393[3])))
	{
		if (func_151(uParam0->f_1393[3], &(uParam0->f_1385[3]), 2543.673f, -1308.602f, 48.2201f))
		{
			set_anim_scene_entity(iVar0, "TABLE", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return false;
	...
	network_request_control_of_entity(&(uParam0->f_1408[0]));
	if ((network_has_control_of_entity(&(uParam0->f_1408[0])) && !is_entity_dead(&(uParam0->f_1408[0]))) && has_clip_set_loaded("script_shows@fireperformer@act1_p1"))
	{
		set_blocking_of_non_temporary_events(&(uParam0->f_1408[0]), true);
		_0x3ae3552e7c207cc5(&(uParam0->f_1408[0]), "NMBS_SCRIPT_SHOWS_FIRE_PERFORMER", 0);
		set_anim_scene_entity(iVar0, "PERFORMER", &(uParam0->f_1408[0]), 0);
	}
	else
	{
		return false;
...
void func_118(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	{
		case 0:
			func_159(&((*uParam1)[uParam2->f_1]->f_17), 32);
			break;
		case 32:
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false))
			{
			...
			if (uParam0->f_1 > 32)
			{
				func_159(&((*uParam1)[uParam2->f_1]->f_17), 33);
			}
			break;
		case 33:
			if (uParam0->f_1 > 33)
			{
				func_159(&((*uParam1)[uParam2->f_1]->f_17), 34);
			}
			break;
		case 34:
			if ((fParam3 > 0.9f && !func_13(*uParam2, 1)) && load_stream(func_160(3), func_161()))
			{
				func_18(uParam2, 1);
			}
			if (_is_anim_scene_started(_net_to_anim_scene(uParam0->f_1374), false) && _get_anim_scene_progress(_net_to_anim_scene(uParam0->f_1374)) > 0.978f)
			{
				...
				{
					play_stream_from_position(2552.53f, -1310.069f, 49.21665f, _0x0556c784fa056628(func_160(3), func_161()));
				}
				func_159(&((*uParam1)[uParam2->f_1]->f_17), 37);
			}
			break;
		case 37:
			if (!func_13(uParam0->f_1358, 8388608))
			...
			func_18(&(uParam2->f_247), 32);
			func_159(&((*uParam1)[uParam2->f_1]->f_17), 40);
			break;
		case 40:
			break;
	}
...
int func_131(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_173((*uParam0)[iVar0], func_171(iParam2), func_172(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_173(uParam0->f_31[iVar0], func_175(iParam2), func_176(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_173(uParam0->f_107[iVar0], func_178(iParam2), func_179(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_173(uParam0->f_118[0], func_180(iParam2, 0), func_181(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_173(uParam0->f_118[1], func_180(iParam2, 1), func_181(iParam2, 1), 1065353216)) && func_173(uParam0->f_118[2], func_180(iParam2, 2), func_181(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_173(uParam0->f_118[iVar0], func_180(iParam2, 0), func_181(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_132(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_197(uParam1->f_118[0], func_195(uParam1), &(uParam1->f_238), func_196(uParam1), func_185(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_199(uParam1->f_118[0], func_198(uParam1), &(uParam1->f_238), func_196(uParam1), func_185(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_197(uParam1->f_118[0], func_195(uParam1), &(uParam1->f_238), 0.5f, func_185(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_199(uParam1->f_118[0], func_198(uParam1), &(uParam1->f_238), 0.5f, func_185(uParam1)))
			{
...
bool func_186(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_220((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_188(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_221((*uParam0)[iVar0], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
bool func_202(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_220((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
bool func_204(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_221((*uParam2)[iVar3], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_210(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_224());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_224());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_224());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_225(get_player_team(iVar5)));
	}
...
bool func_231(int iParam0, int iParam1)
{
	...
	{
		return func_234(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
