	...
	while (!_0x9e4ef615e307fbbe())
	{
		...
		switch (Var0)
		{
			...
			case 1:
				...
				{
					_0xcb9401f918cb0f75(Global_34, "BLOCK_COFFEE_DISCARD_PROMPT", 1, 1);
					_0xcb9401f918cb0f75(Global_34, "SHOW_COFFEE_KNEEL_DISCARD_PROMPT", 1, 1);
				}
				...
				break;
			case 2:
				_0xcb9401f918cb0f75(Global_34, "BLOCK_COFFEE_DRINK_PROMPT", 1, 1);
				_0xcb9401f918cb0f75(Global_34, "BLOCK_COFFEE_DISCARD_PROMPT", 1, 1);
				if (_get_item_interaction_from_ped(Global_34) != -2123939384)
				{
				}
				else
				{
					if (is_ped_active_in_scenario(Global_34, 0) && ((_0x569f1e1237508deb(Global_34) == 254049387 || _0x569f1e1237508deb(Global_34) == -1451987280) || _0x569f1e1237508deb(Global_34) == 1135271674))
					{
						_0xb35370d5353995cb(Global_34, 2140481581, 1048576000);
					}
					else
					{
						_0xb35370d5353995cb(Global_34, -541529715, 1048576000);
					}
					func_5(&Var0, 3);
					set_object_as_no_longer_needed(&(Var0.f_179));
				}
				break;
			case 3:
...
void func_11(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_11)
	{
		...
		{
			case -943921969:
				fVar1 = func_16(0, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				func_17((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				iVar9 = 1;
				break;
			case -1104847406:
				fVar2 = func_16(2, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				func_18((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), 0);
				bVar8 = true;
				break;
			case 381158954:
				fVar3 = func_16(1, (IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				func_19((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2));
				break;
			case -416929031:
				fVar4 = func_20((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
				func_21(0, fVar4, 1, 1, bVar10);
				iVar9 = 1;
				break;
			case 1857353317:
				fVar5 = func_20((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
				func_21(2, fVar5, 1, 1, bVar10);
				bVar8 = true;
				break;
			case 1681823811:
				fVar6 = func_20((IntToFloat(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), (uParam0->f_33[iVar0]->f_5 / uParam0->f_2));
				func_21(1, fVar6, 1, 1, bVar10);
				break;
			case -816334026:
				func_22((to_float(uParam0->f_33[iVar0]->f_2) / uParam0->f_2), 1 == uParam0->f_1);
				break;
			default:
				if (bParam1)
				{
					...
					{
						case 2062242710:
							fVar7 = func_23(to_float(uParam0->f_33[iVar0]->f_3), uParam0->f_33[iVar0]->f_4);
		...
		if (!does_entity_exist(*uParam1))
		{
			...
			if (has_model_loaded(iParam3) && can_register_mission_objects(1))
			{
				*uParam1 = create_object(iParam3, Global_35, true, false, false, false, true);
				_0xcaaf2bccfef37f77(*uParam1, 80);
...
void func_25(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1879593571:
		case 1934214136:
			func_44(-1196069774, -179343615, 8100);
			break;
	}
}
...
void func_26(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		func_46(func_45(-704089207), 1);
	}
	if (func_14(iParam0, -1457797660))
	{
		func_46(func_45(-1909697259), 1);
	}
	...
	{
		func_46(func_49(1368284188, -939665347), 1);
	}
	if (func_14(iParam0, 1992556171))
	{
		func_46(func_45(-1295035230), 1);
	}
	if (func_14(iParam0, 1239889275))
	{
		func_46(func_45(905765416), 1);
	}
	switch (iParam0)
	{
		case -1921080134:
		case -635441454:
		case 1448771675:
			func_46(func_49(1368284188, -2049431929), 1);
			break;
	}
	switch (iParam0)
	{
		case -611782825:
			func_46(func_49(1368284188, -1875859641), 1);
			break;
		case 299161628:
			func_46(func_49(1368284188, 304473406), 1);
			break;
		case -1907044919:
		case 688258043:
			func_46(func_49(1368284188, 894597474), 1);
			break;
		case -541584777:
		case 206762213:
			func_46(func_49(1368284188, 2119695263), 1);
			break;
		case -653299524:
		case -486559882:
		case 376981280:
			func_46(func_49(1368284188, -1791969490), 1);
			break;
		case -324053813:
		case 998010398:
			func_46(func_49(1368284188, -155567636), 1);
			break;
		case -2042563684:
		case -1871448371:
		case -834705084:
		case -623409049:
			func_46(func_49(1368284188, 497247514), 1);
			break;
		case 1929383243:
		case 2036955137:
			func_46(func_49(1368284188, -868741806), 1);
			break;
		case -1635450397:
		case 1831763320:
			func_46(func_49(1368284188, -208442209), 1);
			break;
	}
	if (func_50() == -1)
	{
		...
		{
			func_46(func_49(1368284188, 595572217), 1);
		}
	}
	if (bParam1)
	{
		func_46(func_45(704570463), 1);
	}
...
{
	Var0 = { func_49(-372368982, func_90(iParam0)) };
	_0x6a0184e904cdf25e(&Var0, iParam1);
	func_46(func_91(106002964), iParam1);
}
...
{
	fVar0 = (func_95(iParam0) - _0xdf66a37936d5f3d9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_62(int iParam0, int iParam1, float fParam2)
{
	...
	_set_attribute_core_value(iParam0, func_105(iParam1), ceil(fParam2));
	return true;
}
...
void func_64(int iParam0, int iParam1, float fParam2)
{
	...
	{
		_0x437c08db4febe2bd(iParam0, func_107(iParam1), fParam2, -1);
	}
}
...
void func_77(int iParam0)
{
	...
	iVar1 = func_31(2);
	func_32(to_float((iParam0 * iVar1)), 0);
}
...
void func_79(int iParam0)
{
	...
	iVar1 = func_35(2);
	func_36(to_float((iParam0 * iVar1)), 0);
}
...
void func_80(int iParam0, bool bParam1)
{
	...
	iVar0 = func_33(2);
	func_34(to_float((iParam0 * iVar0)), 0, bParam1);
}
...
bool func_86(int iParam0)
{
	...
	return &Global_1146212->f_35859.f_919[func_118(iParam0, 1)] == -1;
}
...
int func_87(int iParam0)
{
	...
	iVar0 = func_118(iParam0, 1);
	if (!func_83(&(Global_1146212->f_35859.f_919[iVar0])))
	{
		return 1;
	}
	iVar3 = func_119(&(Global_1146212->f_35859.f_919[iVar0]), 1);
	iVar4 = 0;
		...
		switch (func_120(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212->f_35859.f_11700)
				{
					...
					{
						func_121(iVar1, iParam0, iVar4);
						func_122(Global_1146212->f_35859.f_9503[iVar5]);
						...
						*Global_1146212->f_35859.f_9503[iVar5] = { *Global_1146212->f_35859.f_9503[Global_1146212->f_35859.f_11700] };
						func_122(Global_1146212->f_35859.f_9503[Global_1146212->f_35859.f_11700]);
					}
					else
					{
						iVar5++;
			...
			func_126(Global_1146212->f_35859.f_919[iVar0]);
			return 1;
		}
...
{
	return (_0x592f58bc4d2a2cf3(iParam0, 0) - IntToFloat(func_136(2)));
}
...
int func_121(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_149(*Global_1146212->f_35859.f_3116[iVar0]) && func_150(iParam0, Global_1146212->f_35859.f_3116[iVar0]->f_4))
	{
		vVar1 = { func_151(Global_1146212->f_35859.f_3116[iVar0]->f_4) };
		if (func_152(vVar1))
		{
			if (func_153(vVar1.x, vVar1.y, vVar1.z))
			{
				func_154(Global_1146212->f_35859.f_3116[iVar0]->f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_155(Global_1146212->f_35859.f_3116[iVar0]->f_4);
			}
		}
		else
		{
...
int func_128(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_149(*Global_1146212->f_35859.f_3116[iVar0]);
	if (bVar1 && func_157(Global_1146212->f_35859.f_3116[iVar0]->f_4))
	{
		vVar2 = { func_158(Global_1146212->f_35859.f_3116[iVar0]->f_4) };
	...
	if (func_153(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_154(Global_1146212->f_35859.f_3116[iVar0]->f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_148(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_119(&(Global_1146212->f_35859.f_919[iVar0]), 1);
	...
	while (iVar4 < Global_1146212->f_35859.f_3116[iVar1]->f_16)
	{
		...
		else
		{
			...
			Global_1146212->f_2169[iVar5]->f_201 = (Global_1146212->f_2169[iVar5]->f_201 - func_161(Global_1146212->f_35859.f_3116[iVar1]->f_6[iVar4]));
			func_162(iVar3);
		}
		iVar4++;
	}
...
bool func_153(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212->f_35859.f_3116[iVar1]->f_28)
	{
		...
		else if (!func_170(Global_1146212->f_35859.f_3116[iVar1]->f_17[iVar7]))
		{
		}
		else
		{
	...
	func_172(Global_1146212->f_35859.f_3116[iVar1]->f_2);
	return true;
}
...
void func_162(int iParam0)
{
	...
	iVar0 = func_159(iParam0, 1);
	if (!func_175(&(Global_1146212->f_2169[iVar0])))
	{
		return;
	}
	...
	if (!func_176(Global_1146212->f_2169[iVar0]->f_203))
	{
		return;
	}
	iVar1 = func_177(Global_1146212->f_2169[iVar0]->f_203, 1);
...
void func_165(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50982971:
			...
			_0xc5cb91d65852ed7e(func_180(iParam0));
			break;
		case 1870637439:
			_0xc5cb91d65852ed7e(func_180(iParam0));
			break;
...
int func_168(int iParam0)
{
	...
	{
		iVar64 = func_123(&(Global_1146212->f_35859.f_9503[iVar65]), 1);
		...
		else if (!func_184(&(Global_1146212->f_35859.f_9503[iVar65]), Global_1146212->f_35859.f_9503[iVar65]->f_1))
		{
		}
		else
		{
			Var1 = { func_185(&(Global_1146212->f_35859.f_9503[iVar65])) };
...
void func_171(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50982971:
			...
			animpostfx_play(func_180(iParam0));
			break;
		case 1870637439:
			animpostfx_play(func_180(iParam0));
			break;
		...
		case 482459685:
			...
			iVar3 = get_entity_bone_index_by_name(iVar0, func_187(iParam0, 0));
			func_188(iVar2, 0, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_187(iParam0, 1));
			func_188(iVar2, 1, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_187(iParam0, 2));
			func_188(iVar2, 2, 1, iVar3, 0);
			iVar3 = get_entity_bone_index_by_name(iVar0, func_187(iParam0, 3));
			func_188(iVar2, 2, 1, iVar3, 0);
			break;
		case -1655894020:
			iVar2 = func_181(iParam0);
...
void func_178()
{
	...
	{
		if (!func_193((*Global_1298536)[&Global_1296859]->f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_184(int iParam0, int iParam1)
{
	...
	if (func_149(*Global_1146212->f_35859.f_3116[iVar0]))
	{
		iVar3 = &Global_1146212->f_35859.f_9286[func_167(iVar2, 1)];
		Var4 = { func_185(iVar3) };
