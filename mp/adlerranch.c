	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_77(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_134(iParam0, _create_persistent_character(func_133(iParam0)));
		if (func_45() == -1)
		{
...
bool func_93(int iParam0)
{
	...
	if (func_139(iVar1))
	{
		if (Global_1071686->f_19648.f_24 && !func_140(iParam0))
		{
			return false;
		}
...
char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_146(Global_1893587->f_162);
	}
	if (is_string_null_or_empty(sVar0) && bParam4)
	{
		sVar0 = func_148(func_147(Global_35));
	}
...
{
	func_153(Global_1940018->f_5[iParam0]->f_6, 1);
	func_154(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_89(Global_1915715->f_3[iParam0]->f_21) && func_156(Global_1915715->f_3[iParam0]->f_21))
	{
		func_157(Global_1915715->f_3[iParam0]->f_21, 0, 1, 0, 0);
	}
	...
	func_158(Global_1915715->f_3[iParam0]->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_161(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
void func_132(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_161(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_175(iParam0, 2))
	{
...
{
	func_185(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
{
	return func_196(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
bool func_178()
{
	...
	if (!func_180(*Global_1051213) && Global_1572887->f_7 & 1 != 0)
	{
		return true;
	}
	return false;
