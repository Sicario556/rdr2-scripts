...
bool func_13()
{
	iLocal_19 = _create_volume_aggregate_with_custom_name("Big Valley Trapper - m_volTrapper");
	_0x6e0d3c3f828da773(iLocal_19, _create_volume_box(-2844.917f, 138.528f, 183f, 0f, 0f, 20.486f, 7.713f, 16.738f, 5.708f));
	_0x6e0d3c3f828da773(iLocal_19, _create_volume_box(-2837.196f, 136.839f, 183f, 0f, 0f, 20.486f, 5.852f, 7.961f, 5.708f));
	iLocal_20 = _create_volume_cylinder_with_custom_name(-2840.46f, 137.2f, 184.28f, 0f, 0f, 81.946f, 2.478f, 2.442f, 3.076f, "Big Valley Trapper - m_volTrapperPrompt");
	iLocal_21 = _create_volume_box_with_custom_name(-2844.08f, 136.749f, 184.743f, 0f, 0f, 19.872f, 2.5f, 3f, 3.076f, "Big Valley Trapper - m_volTrapperOfflimits");
	return true;
}
...
{
	func_58(15, iLocal_19, iParam0, iLocal_20, iLocal_21, 12, 0, 0, -1082130432, 0);
	func_59(15, 536870912);
	func_60(15, 0);
	set_ambient_zone_state("AZ_Naturalist_Camp", true, true);
	_0x3743ce6948194349("AZ_Naturalist_Camp", _0xf70f00013a62f866(iLocal_19), 0f);
}
...
{
	if ((vdist(Global_35, 0f, 0f, 0f) <= 5f || func_63(&Global_1940258, 32768)) || func_63(&Global_1940258, 16777216))
	{
		return;
	}
			...
			case 1:
				if (_does_volume_exist(uParam0[iVar3]))
				{
					if (_0xf256a75210c5c0eb(uParam0[iVar3], Global_35))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_66((*uParam0)[iVar3], 1) && func_67(iParam1)) && !func_68(iParam1, 16))
							{
								func_70(iParam1, func_69(), -1, 0, -1, 0);
								func_71((*uParam0)[iVar3], 1);
							}
							func_72(iParam1, 0);
						}
						bVar0 = true;
	...
	if (iParam0 == 0)
	{
		...
		if (chal_is_goal_active(-663946200, 1055032020))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					chal_add_goal_progress_int_by_score_id(func_76(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439->f_72[iParam0]->f_18 = func_96(iParam2, iParam0);
	...
	Global_1051439->f_72[iParam0]->f_63 = func_97(Global_1051439->f_72[iParam0]->f_18);
...
{
	func_101(&(Global_1051439->f_72[iParam0]->f_49), iParam1);
}

int func_60(int iParam0, bool bParam1)
{
	if ((func_102(iParam0, 16384) || func_102(iParam0, 32768)) || func_103(Global_1051439->f_72[iParam0]->f_3))
	{
...
void func_95(int iParam0, bool bParam1)
{
	...
	else if (func_153(iParam0, 67108864) && does_entity_exist(Global_1051439->f_72[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_156(&(Global_1051439->f_72[iParam0]->f_31[iVar2]));
	...
	if (_does_volume_exist(Global_1051439->f_72[iParam0]->f_24) && func_159(iParam0, 2))
	{
...
int func_105(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_107(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439->f_72[iParam0]->f_6 = func_165(uParam1, vParam2, uParam5, 0, 0, 0);
...
char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
char* func_123(char* sParam0, int iParam1)
{
	...
	return func_175(_create_var_string(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_176(Global_1940018->f_5[iParam0]->f_6, 1);
	func_177(Global_1940018->f_5[iParam0]->f_6, 0);
...
{
	if (func_88(Global_1915715->f_3[iParam0]->f_21) && func_179(Global_1915715->f_3[iParam0]->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_156(&(Global_1915715->f_3[iParam0]->f_318[iVar0]));
...
{
	return func_200(Global_1051439->f_72[iParam0]->f_50, iParam1);
}
...
{
	if (_0x603ac35fd4602c76(Global_1139381->f_7) && !func_202(12, func_201(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
char* func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_211(&(Global_1940018->f_5[iParam0]->f_7), iParam1);
}
...
bool func_189(int iParam0, int iParam1)
{
	...
	{
		return func_221(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
