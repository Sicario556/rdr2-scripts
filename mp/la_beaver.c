...
void func_1(int iParam0)
{
	...
	func_8();
	func_9();
	network_register_host_broadcast_variables(&Local_13, 50, 56);
	func_10(_0xba24095ea96dfe17(&Local_13), 50, "m_hostData");
	network_register_player_broadcast_variables(&Local_63, 577, 57);
	func_11(_0x690806bc83bc8ca2(Local_63[0]), 577, "m_clientData");
	func_12(0);
...
{
	iVar0 = 255;
	_copy_memory(&Local_640, uParam0, 5);
...
void func_34()
{
	func_112();
	func_113();
	Local_640.f_173.f_3 = participant_id_to_int();
	func_114();
	switch (func_115())
	{
		case 2:
			func_116(0, -1328036758, 0, 10f);
			break;
		case 3:
			func_117(0, 20f, 10f);
			break;
		case 1:
			request_waypoint_recording(func_118());
			break;
	}
}
...
void func_43()
{
	iVar0 = Global_1198046->f_231.f_1066[Local_640.f_12]->f_5;
	...
	Local_13.f_6 = func_122(_0x4be6c13a45cca8ec(_0x901e0dc25080c8b9(iVar0)));
	func_123(256);
...
void func_44()
{
	...
	{
		clear_area(Local_640.f_15, Var0.f_10, 2442122);
		func_121(2);
	}
	else if (bVar31)
	{
...
void func_49()
{
	...
	if (func_131(512))
	{
		if (func_66(64) && func_122(player_id()) == Local_13.f_6)
		{
			func_67(Local_13.f_6);
			func_143(64);
		}
	...
	{
		if (func_122(player_id()) == Local_13.f_6)
		{
			func_144(Local_13.f_6, 1, 1);
			func_145(64);
		}
	}
	else if (func_122(player_id()) != Local_13.f_6)
	{
		func_67(Local_13.f_6);
		func_143(64);
	}
...
bool func_59()
{
	return (func_131(4) || (network_is_game_in_progress() && network_get_num_participants() <= 1));
}
	...
	if (func_59())
	{
		...
		while (iVar1 < 1)
		{
			...
			while (iVar2 < 1)
			{
				...
				{
					iVar0 = &Local_640.f_311[iVar1]->f_5[iVar2];
				...
				else if (network_does_network_id_exist(Local_13.f_47[iVar1][iVar2]))
				{
					iVar0 = net_to_obj(Local_13.f_47[iVar1][iVar2]);
					if (network_has_control_of_entity(iVar0))
					{
						if (func_174(iVar1, iVar2))
						{
...
void func_68()
{
	...
	if (is_audio_scene_active("DLC_MP007_Leg_Beav_Event_Chew_scene"))
	{
		stop_audio_scene("DLC_MP007_Leg_Beav_Event_Chew_scene");
	}
}
...
void func_110()
{
	...
	while (iVar1 < 32)
	{
		...
		while (iVar0 < 8)
		{
			Local_63[iVar1]->f_7.f_2[iVar0] = -1f;
			iVar0++;
		}
		iVar1++;
	}
...
void func_114()
{
	...
	func_232(&(Local_640.f_118), 1106247680);
...
bool func_124(int iParam0)
{
	...
	return (func_243(iParam0) && (*Global_1131196)[iParam0]->f_18.f_1 != 0);
}
...
bool func_126(struct<31> Param0, var uParam31)
{
	...
	{
		if (_0x397769175a7dbb30(Local_640.f_15, Param0.f_10, 0, 0, 0))
		{
			_0xfa15c9a320e707b0();
			*uParam31 = 1;
			return false;
...
bool func_130(int iParam0, int iParam1)
{
	...
	return func_180(&(Local_63[iParam1]), iParam0);
}
...
bool func_140()
{
	if (does_entity_exist(func_256(0)))
	{
		func_257(get_entity_coords(func_256(0), true, false));
	}
	if (func_251())
	{
		return false;
...
int func_144(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_261(&((*Global_1134390)[iVar1]->f_70.f_1), 1);
	}
	else
	{
		func_262(&((*Global_1134390)[iVar1]->f_70.f_1), 1);
	}
	return 1;
}
...
{
	if (func_180(&(Local_63[participant_id_to_int()]), iParam0))
	{
		func_259(Local_63[participant_id_to_int()], iParam0);
	}
}
...
bool func_150()
{
	...
	iVar0 = 1;
	if (func_115() == 1 && !get_is_waypoint_recording_loaded(func_118()))
	{
		iVar0 = 0;
	}
...
void func_159()
{
	...
	func_279(&(Local_640.f_53), 0, vVar0, 1112014848);
...
void func_162()
{
	...
	{
		fVar0 = vdist(get_entity_coords(player_ped_id(), false, false), Local_640.f_15);
		if (fVar0 < 200f)
		{
			func_147(4096);
		}
...
void func_167()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_640.f_5 = (Local_640.f_5 || Local_63[iVar0]) // PointerArith;
			Local_640.f_6 = (Local_640.f_6 && Local_63[iVar0]) // PointerArith;
		}
		iVar0++;
	}
}
...
{
	if (does_blip_exist(Local_640.f_186.f_7[iParam0]->f_1))
	{
		remove_blip(&(Local_640.f_186.f_7[iParam0]->f_1));
	}
}

bool func_171(int iParam0, int iParam1)
{
	return func_180(Local_640.f_186.f_7[iParam0]->f_2, iParam1);
}

bool func_172(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 1024);
}

bool func_173(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 8);
}

bool func_174(int iParam0, int iParam1)
{
	return is_bit_set(Local_640.f_311[iParam0]->f_4, iParam1);
}
...
void func_175()
{
	...
	if ((does_entity_exist(Local_640.f_53) && is_entity_dead(Local_640.f_53)) || Local_640.f_53.f_2 == 12)
	{
		return;
	}
	if (func_296(16))
...
void func_182()
{
	...
	while (iVar0 <= 7)
	{
		...
		{
			set_animal_tuning_float_param(iVar1, 74, 0f);
		}
		iVar0++;
	}
	if (network_has_control_of_entity(func_256(0)))
	{
		func_308(0);
	}
	if (network_is_host_of_this_script())
...
{
	Local_640.f_186.f_7[iParam0]->f_3 = iParam1;
}
...
{
	Local_640.f_186.f_7[iParam0]->f_4 = iParam1;
}
...
{
	Local_640.f_186.f_7[iParam0]->f_6 = { vParam1 };
	Local_640.f_186.f_7[iParam0]->f_5 = uParam4;
	if (bParam5)
	{
		func_242(&(Local_640.f_186.f_7[iParam0]->f_2), 2);
	}
	else
	{
		func_259(&(Local_640.f_186.f_7[iParam0]->f_2), 2);
	}
}

void func_217(int iParam0)
{
	set_bit(&(Local_640.f_19), iParam0);
}
...
bool func_250(bool bParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			...
			else if (is_bit_set(Local_640.f_311[iVar0]->f_2, iVar1))
			{
				if (func_335(iVar0, iVar1))
				{
					if (network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
					{
						if (network_request_control_of_network_id(Local_13.f_47[iVar0][iVar1]))
						{
							_0x7182edda1ee7db5a(Local_13.f_47[iVar0][iVar1]);
						}
					}
				}
			}
				...
				if (!network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
				{
					...
					if (func_338(iVar0, iVar1))
					{
						...
						else
						{
							...
							{
								iVar13 = _0x9641a9a20310f6b8(Local_640.f_311[iVar0]->f_5[iVar1]->f_3, vVar7, 0f, 0f, 0f, 1, 0, 0);
								...
								{
									(*Local_13.f_47[iVar0])[iVar1] = obj_to_net(iVar13);
									if (!network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
									{
										*bParam0 = 1;
										return false;
							...
							{
								iVar13 = _create_weapon_object(Local_640.f_311[iVar0]->f_5[iVar1]->f_5, Local_640.f_311[iVar0]->f_5[iVar1]->f_4, func_337(iVar0, iVar1), true, 1f);
								if (!does_entity_exist(iVar13))
								{
									*bParam0 = 1;
								}
								else
								{
									...
									{
										set_network_id_exists_on_all_machines(Local_13.f_47[iVar0][iVar1], true);
									}
								}
							}
							else if (iVar2 == 0)
							...
							else if (!func_342((*Local_13.f_47[iVar0])[iVar1], iVar2, vVar7, 1, 0))
							{
								*bParam0 = 1;
								return false;
							}
							if (network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
							{
								iVar13 = net_to_obj(Local_13.f_47[iVar0][iVar1]);
								if (func_335(iVar0, iVar1))
								{
									if (network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
									{
								...
								set_bit(&(Local_640.f_311[iVar0]->f_2), iVar1);
...
{
	return &(Local_640.f_186.f_7[iParam0]);
}
...
bool func_270()
{
	...
	while (iVar0 < 8)
	{
		if (is_bit_set(Local_640.f_186.f_3, iVar0))
		{
		}
		else
		{
			...
			{
				if (!is_bit_set(Local_640.f_186.f_4, iVar0))
				{
					request_model(iVar2, false);
					set_bit(&(Local_640.f_186.f_4), iVar0);
				}
				...
				{
					set_bit(&(Local_640.f_186.f_3), iVar0);
				}
			}
		}
		iVar0++;
...
bool func_271()
{
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			if (is_bit_set(Local_640.f_311[iVar0]->f_1, iVar1))
			{
			}
			else
			{
				...
				if (func_361(iVar1))
				{
					if (Local_640.f_311[iVar0]->f_5[iVar1]->f_6 == 0 || !_0x93ffd92f05ec32fd(Local_640.f_311[iVar0]->f_5[iVar1]->f_6))
					{
						Local_640.f_311[iVar0]->f_5[iVar1]->f_6 = _0x91fe941f9fcfb702(Local_640.f_311[iVar0]->f_5[iVar1]->f_3, 0);
						bVar2 = true;
					}
					else if (!_0xb0b2c6d170b0e8e5(Local_640.f_311[iVar0]->f_5[iVar1]->f_6))
					{
						bVar2 = true;
					}
					else if (!is_bit_set(Local_640.f_311[iVar0]->f_1, iVar1))
					{
						set_bit(&(Local_640.f_311[iVar0]->f_1), iVar1);
					}
				}
				else if (func_362(iVar1))
				{
					_0x72d4cb5db927009c(Local_640.f_311[iVar0]->f_5[iVar1]->f_5, -1, 0);
					if (!_0xff07cf465f48b830(Local_640.f_311[iVar0]->f_5[iVar1]->f_5))
					{
						bVar2 = true;
					}
					else if (!is_bit_set(Local_640.f_311[iVar0]->f_1, iVar1))
				...
				{
					if (!is_bit_set(&(Local_640.f_311[iVar0]), iVar1))
					{
						request_model(iVar3, false);
						set_bit(Local_640.f_311[iVar0], iVar1);
					}
	...
	while (iVar0 < 1)
	{
		...
		while (iVar1 < 1)
		{
			...
			else if (!func_173(iVar0, iVar1))
			{
				if (network_is_host_of_this_script())
				{
					if (is_bit_set(Local_640.f_311[iVar0]->f_2, iVar1))
					{
						if (func_335(iVar0, iVar1))
						{
							if (network_does_network_id_exist(Local_13.f_47[iVar0][iVar1]))
			...
			else
			{
				...
				if (func_338(iVar0, iVar1))
				{
					...
					else
					{
						if (func_340(iVar0, iVar1))
						{
							iVar13 = _0x9641a9a20310f6b8(Local_640.f_311[iVar0]->f_5[iVar1]->f_3, vVar7, 0f, 0f, 0f, 0, 0, 0);
							if (!does_entity_exist(iVar13))
							{
								return false;
							}
						...
						Local_640.f_311[iVar0]->f_5[iVar1] = iVar13;
						if (func_350(iVar0, iVar1))
						{
							func_351(iVar0, iVar1, 1);
						}
...
void func_276()
{
	...
	while (iVar1 < 1)
	{
		...
		while (iVar2 < 1)
		{
			...
			{
				iVar0 = net_to_obj(Local_13.f_47[iVar1][iVar2]);
				Local_640.f_311[iVar1]->f_5[iVar2] = iVar0;
				if (func_335(iVar1, iVar2))
				{
					if (network_does_network_id_exist(Local_13.f_47[iVar1][iVar2]))
					{
						if (network_request_control_of_network_id(Local_13.f_47[iVar1][iVar2]))
						{
							_0x7182edda1ee7db5a(Local_13.f_47[iVar1][iVar2]);
						}
					}
				}
...
void func_277()
{
	...
	if (func_115() == 1)
	{
		add_entity_to_audio_mix_group(iVar0, "DLC_MP007_Leg_Beav_Event_Chew_group", 0f);
	}
	iVar1 = 1;
	while (iVar1 <= 7)
	{
		...
		func_366(iVar1);
		if (func_367() < 2 && get_random_int_in_range(0, 100) < 25)
		{
			func_368(iVar1);
		}
		...
		else
		{
			...
			if (iVar1 <= 3)
			{
				task_wander_in_area(iVar2, get_entity_coords(iVar2, true, false), 15f, 1077936128, 1086324736, 0);
			}
		}
		iVar1++;
	}
...
void func_278()
{
	set_entity_visible(func_369(0), false);
}
...
bool func_282(int iParam0, int iParam1)
{
	...
	Var0 = { func_375(iParam0, 1178968787) };
...
void func_285()
{
	...
	bVar7 = false;
	bVar8 = false;
	if (network_is_in_mp_cutscene() != Local_640.f_186.f_124)
	{
		bVar8 = true;
	...
	while (iVar0 < 1)
	{
		...
		iVar1 = &Local_640.f_186.f_7[iVar0];
		...
		if (bVar4)
		{
			if (&Local_63[iVar3]->f_7.f_2[iVar0] > -1f)
			{
				Local_63[iVar3]->f_7.f_2[iVar0] = -1f;
			}
			if (is_bit_set(Local_640.f_186.f_5, iVar0))
			{
				clear_bit(&(Local_640.f_186.f_5), iVar0);
				clear_bit(&(Local_640.f_186.f_6), iVar0);
				clear_bit(&(Local_640.f_186.f_97), iVar0);
			}
		}
		else
		{
		...
		if (is_bit_set(Local_640.f_186.f_97, iVar0))
		{
			if (bVar4 || !bVar7)
			{
				clear_bit(&(Local_640.f_186.f_97), iVar0);
		...
		else if (!bVar4)
		{
			if (bVar7)
			{
				set_bit(&(Local_640.f_186.f_97), iVar0);
			}
		}
		if (!bVar4)
		{
			...
			{
				if (!is_bit_set(Local_63[iVar3]->f_7.f_1, iVar0))
				{
					set_bit(&(Local_63[iVar3]->f_7.f_1), iVar0);
				}
				func_380(Local_640.f_186.f_98[iVar0]);
			}
		}
		if (is_bit_set(Local_63[iVar3]->f_7.f_1, iVar0))
		{
			if (bVar4 || (!is_any_speech_playing(iVar1) && (!func_381(Local_640.f_186.f_98[iVar0]) || func_382(Local_640.f_186.f_98[iVar0], 0.5f))))
			{
				func_383(Local_640.f_186.f_98[iVar0]);
				clear_bit(&(Local_63[iVar3]->f_7.f_1), iVar0);
			}
		}
		if ((!bVar4 && bVar8) && func_171(iVar9, 256))
		{
			set_entity_visible_in_cutscene(iVar1, Local_640.f_186.f_124, 0, 256);
		}
		if (func_171(iVar9, 4))
		{
			if (bVar4)
			...
			else if ((_0xb07d3185e11657a5(iVar1) && network_has_control_of_entity(iVar1)) && !func_171(iVar9, 8))
			{
				if (!func_384(iVar9))
				{
...
{
	bVar0 = true;
	if (bVar0 && !_unlock_is_unlocked(Local_640.f_14))
	{
		return false;
	}
	if (func_401())
...
void func_289(int iParam0, int iParam1)
{
	...
	if (!func_403(&(Local_640.f_53), 128))
	{
		...
		{
			func_406(iParam0, func_405(get_entity_model(iParam0)), iParam1, &(Local_640.f_53));
...
{
	iVar0 = func_256(0);
	if (is_entity_dead(iVar0) || (get_ped_config_flag(iVar0, 580, false) && is_ped_in_writhe(iVar0)))
	{
		if ((is_entity_in_water(iVar0) && !func_407(128)) && func_298("LA_BEAVER_H_LASSO") != 0)
		{
			func_408(128);
		}
	}
...
void func_292()
{
	...
	while (iVar0 <= (network_get_max_num_participants() - 1))
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_640.f_173.f_1 = (Local_640.f_173.f_1 || Local_63[iVar0]->f_6);
			Local_640.f_173.f_2 = (Local_640.f_173.f_2 && Local_63[iVar0]->f_6);
		}
		iVar0++;
	}
}
...
bool func_295(int iParam0, int iParam1)
{
	...
	return func_241(Local_63[iParam1]->f_4, iParam0);
}
...
{
	if (does_entity_exist(&(Local_640.f_186.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_640.f_186.f_7[iParam0])))
		{
			delete_ped(Local_640.f_186.f_7[iParam0]);
			Local_640.f_186.f_7[iParam0] = 0;
			return true;
		}
	}
	return false;
...
{
	Local_640.f_311[iParam0]->f_5[iParam1]->f_2 = iParam2;
}
...
{
	Local_640.f_311[iParam0]->f_5[iParam1]->f_7 = { vParam2 };
	Local_640.f_311[iParam0]->f_5[iParam1]->f_10 = { 0f, 0f, fParam5 };
	Local_640.f_311[iParam0]->f_5[iParam1]->f_13 = iParam6;
}
	...
	*bParam2 = 0;
	if (iVar8 != 0)
	{
		if (!network_does_network_id_exist(&(Local_13.f_38[iParam0])))
		{
			...
			if (!func_180(Local_640.f_186.f_7[iParam0]->f_2, 2))
			{
				vVar1 = { _get_object_offset_from_coords(vVar4, 0f, func_425(iParam0)) };
			}
			else
			{
				vVar1 = { func_425(iParam0) };
			}
			if (!func_426(Local_13.f_38[iParam0], iVar8, vVar1, fVar0, 1, 0, (iVar9 == 0 || _is_this_model_a_horse(iVar8)), 1, 1))
			{
				*bParam1 = 1;
			}
			else
			{
				...
				if (does_entity_exist(iVar7))
				{
					...
					if (iVar9 != 0)
					{
						...
						_update_ped_variation(iVar7, func_171(iParam0, 1), true, true, true, false);
					}
...
{
	return Local_640.f_311[iParam0]->f_5[iParam1]->f_2;
}

bool func_335(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 64);
}

bool func_336(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 16);
}

Vector3 func_337(int iParam0, int iParam1)
{
	return Local_640.f_311[iParam0]->f_5[iParam1]->f_7;
}

bool func_338(int iParam0, int iParam1)
{
	return Local_640.f_311[iParam0]->f_5[iParam1]->f_13;
}
...
{
	return is_bit_set(Local_640.f_311[iParam0]->f_3, iParam1);
}

bool func_341(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 1);
}
...
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 2);
}

bool func_344(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 4);
}

bool func_345(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 128);
}

Vector3 func_346(int iParam0, int iParam1)
{
	return Local_640.f_311[iParam0]->f_5[iParam1]->f_10;
}

bool func_347(int iParam0, int iParam1, int iParam2)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, iParam2);
}
...
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 256);
}

void func_351(int iParam0, int iParam1, bool bParam2)
{
	freeze_entity_position(&(Local_640.f_311[iParam0]->f_5[iParam1]), bParam2);
}

bool func_352(int iParam0, int iParam1)
{
	return func_180(Local_640.f_311[iParam0]->f_5[iParam1]->f_1, 512);
}
	...
	switch (uParam0->f_2)
	{
		...
		case 11:
			...
			if ((func_441(uParam1, 32) && is_ped_fleeing(iVar0)) && func_442(&(uParam0->f_6)) > 10f)
			{
				...
				{
					if ((func_404(iVar1, iVar0, 15f, 1, 1) || (func_404(iVar1, iVar0, 40f, 1, 1) && is_ped_shooting(iVar1))) || func_444(64))
					{
						func_445(uParam0, 1);
						func_434(uParam0, 8);
					}
...
{
	return Local_640.f_186.f_7[iParam0]->f_3;
}
...
void func_363(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!is_bit_set(Local_640.f_186.f_5, iParam0))
	{
		if (network_does_network_id_exist(&(Local_13.f_38[iParam0])))
		{
			...
			Local_640.f_186.f_7[iParam0] = iVar1;
			if (bVar3)
			{
				if (is_entity_dead(iVar1) || is_entity_dead(player_ped_id()))
				{
					Local_63[iParam1]->f_7.f_2[iParam0] = -1f;
				}
				else
				{
					Local_63[iParam1]->f_7.f_2[iParam0] = vdist(get_entity_coords(iVar1, true, false), get_entity_coords(player_ped_id(), true, false));
				}
			}
			if (network_is_host_of_this_script())
			{
			...
			if (does_entity_exist(iVar1))
			{
				...
				set_bit(&(Local_640.f_186.f_5), iParam0);
				if (bParam2)
				{
					func_460(iParam0);
				}
...
{
	Local_640.f_163.f_5 = func_405(get_entity_model(iParam0));
...
void func_365(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1)
	{
		...
		_0x18ff3110cf47115d(*iParam0, 23, 0);
		if (func_115() == 0)
		{
			_0xc6170856e54557b2(*iParam0, 1, 10f);
		}
		if (func_251())
		{
...
{
	func_242(&(Local_640.f_186.f_7[iParam0]->f_2), iParam1);
}

char* func_371(int iParam0)
{
	iVar0 = func_405(get_entity_model(iParam0));
	switch (iVar0)
	{
		case 0:
...
void func_377(int iParam0, bool bParam1, int iParam2)
{
	if (bParam1)
	{
		Local_640.f_186.f_2 = (Local_640.f_186.f_2 || Local_63[iParam0]->f_7);
		Local_640.f_186.f_1 = (Local_640.f_186.f_1 && Local_63[iParam0]->f_7);
		Local_640.f_186.f_6 = (Local_640.f_186.f_6 || Local_63[iParam0]->f_7.f_1);
	}
}
...
int func_379(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	Local_63[iParam3]->f_7.f_2[iParam2] = fVar0;
	if (fVar0 > Local_640.f_186.f_7[iParam2]->f_9)
	{
		return 0;
	}
	return 1;
...
{
	func_259(&(Local_640.f_186.f_7[iParam0]->f_2), iParam1);
}
...
bool func_386(int iParam0, int iParam1)
{
	...
	return func_180(Local_63[iParam1]->f_7, iParam0);
}
...
void func_387(int iParam0)
{
	...
	func_242(&(Local_63[iVar0]->f_7), iParam0);
}
...
void func_388(int iParam0)
{
	...
	func_259(&(Local_63[iVar0]->f_7), iParam0);
}
...
void func_389()
{
	...
	while (iVar0 <= (network_get_max_num_participants() - 1))
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			Local_640.f_163.f_1 = (Local_640.f_163.f_1 || Local_63[iVar0]->f_4);
			Local_640.f_163.f_2 = (Local_640.f_163.f_2 && Local_63[iVar0]->f_4);
			Local_640.f_25.f_22 = (Local_640.f_25.f_22 || Local_63[iVar0]->f_5);
			Local_640.f_25.f_23 = (Local_640.f_25.f_23 && Local_63[iVar0]->f_5);
			Local_640.f_53.f_64 = (Local_640.f_53.f_64 || Local_63[iVar0]->f_1);
			Local_640.f_53.f_63 = (Local_640.f_53.f_63 && Local_63[iVar0]->f_1);
		}
		iVar0++;
	}
}
...
void func_390()
{
	...
	if (is_bit_set(Local_640.f_163.f_3, Local_640.f_163.f_4))
	{
		return;
	}
	if (!does_entity_exist(iVar0))
...
void func_392(var uParam0)
{
	...
	else if (!func_241(uParam0->f_2, 4))
	{
		...
		if (func_241(uParam0->f_2, 1) && does_entity_exist(*uParam0))
		{
			Var3 = { func_469(1368284188, -1530824760) };
...
void func_393(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_482() && func_483(uParam1->f_1, 40f, 60f, 100f, 1065353216, 5, 0, 1))
	{
		func_484();
	}
	if (!func_435())
	...
	if (!func_441(uParam1, 8) && func_435())
	{
		...
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)) && func_489(4, -1))
			{
	...
	switch (uParam0->f_2)
	{
		case 0:
			if (!func_489(1, -1))
			{
				...
				while (iVar1 <= 7)
				{
					iVar2 = &Local_640.f_186.f_7[iVar1];
		...
		case 7:
			...
			{
				if (func_500(uParam1->f_16) || _0xb89fcff19dafff28(uParam1->f_16, &(uParam1->f_14)))
				{
		...
		case 1:
			if (bVar3 && !is_ped_using_any_scenario(iVar0))
			{
				if (func_441(uParam1, 1))
				{
					...
					{
						task_start_scenario_at_position(iVar0, uParam1->f_3, Local_640.f_186.f_7[uParam1->f_1]->f_6, Local_640.f_186.f_7[uParam1->f_1]->f_5, 0, false, true, 0, -1f, false);
					}
				}
				else
				{
		...
		case 3:
			...
			{
				task_wander_in_area(iVar0, Local_640.f_186.f_7[uParam1->f_1]->f_6, uParam1->f_26, 1077936128, 1086324736, 0);
			}
			break;
		case 4:
			break;
		...
		case 9:
			...
			break;
		case 11:
			if ((!is_entity_dead(iVar0) && !get_ped_config_flag(iVar0, 580, true)) && !func_489(64, -1))
			{
				if (func_404(Global_34, iVar0, 15f, 1, 1) || (func_404(Global_34, iVar0, 40f, 1, 1) && is_ped_shooting(Global_34)))
				{
					func_499(64);
				}
			}
			...
			{
				if (!func_404(Global_34, iVar0, 40f, 1, 1) || get_ped_config_flag(iVar0, 580, true))
				{
					func_504(64);
				}
			}
			...
			{
				if (is_entity_dead(get_player_ped(uParam1->f_20)) || !func_404(get_player_ped(uParam1->f_20), iVar0, 100f, 1, 1))
				{
...
void func_394()
{
	...
	if (!does_entity_exist(Local_640.f_53))
	{
		return;
	}
	if (is_entity_dead(Local_640.f_53))
	{
		return;
	}
		...
		case 1:
			...
			else if (uParam0->f_28 == -1 || uParam0->f_55 < uParam0->f_28)
			{
				if (!func_381(&(uParam0->f_58)) || func_472(&(uParam0->f_58)) > uParam0->f_29)
				{
					...
					{
						vVar3 = { func_517(get_entity_coords(*uParam0, true, false), uParam0->f_32, 0f) };
...
int func_396(var uParam0)
{
	...
	{
		if ((!func_505(2, -1) && !is_entity_dead(*uParam0)) && is_ped_fleeing(*uParam0))
		{
			func_510(2);
		}
	...
	if (func_403(uParam0, 64) && does_blip_exist(uParam0->f_54))
	{
	...
	if (((uParam0->f_2 < 3 && Local_13.f_18.f_1) && does_entity_exist(*uParam0)) && !func_529(*uParam0))
	{
		func_524(uParam0, 3);
		func_493(uParam0);
		func_494(uParam0);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			...
			{
				uParam0->f_54 = _blip_add_for_coord(func_531(), uParam0->f_51);
		...
		case 2:
			...
			while (iVar1 <= 7)
			{
				...
				if ((does_entity_exist(iVar0) && is_bit_set(uParam0->f_62, iVar1)) && func_483(iVar1, uParam0->f_34, uParam0->f_35, uParam0->f_36, 1065353216, 5, 0, 1))
				{
					func_493(uParam0);
				}
				else
			...
			iVar0 = *uParam0;
			if (does_entity_exist(iVar0) && func_483(uParam0->f_61, uParam0->f_34, uParam0->f_35, uParam0->f_36, 1065353216, 5, 0, 1))
			{
				func_493(uParam0);
			}
		...
		case 7:
			...
			else if (func_472(&(uParam0->f_58)) > (uParam0->f_41 + ((vdist(Global_35, get_entity_coords(*uParam0, true, false)) / 25f) * uParam0->f_42)) || ((func_381(&(Local_640.f_19.f_3)) && func_472(&(Local_640.f_19.f_3)) < Global_1901947->f_852.f_4) && func_472(&(uParam0->f_58)) > 2f))
			{
...
void func_397(int iParam0)
{
	...
	if ((Local_13.f_18 == 255 && !func_433(2)) || (Local_13.f_18 != 255 && Local_13.f_18 != player_id()))
	{
...
void func_399(int iParam0)
{
	...
	if (!func_433(16))
	{
		if (is_entity_dead(iParam0) && get_ped_index_from_entity_index(func_542(Global_34)) == iParam0)
		{
			func_543();
			func_539(16);
		}
...
void func_400(int iParam0, float fParam1)
{
	...
	if (((!func_433(4) && (get_frame_count() % 10) == 0) && does_entity_exist(Local_640.f_53)) && _0x920684be432875b1(Local_640.f_53))
	{
		func_539(4);
	}
...
bool func_404(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	else if (func_547(get_entity_coords(iParam0, bParam3, false), get_entity_coords(iParam1, bParam3, false)) <= (fParam2 * fParam2))
	{
		return true;
	}
	return false;
...
void func_406(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		set_blip_name_from_text_file(uParam3->f_1, func_549(iParam1, iParam2));
	}
}
...
bool func_409()
{
	...
	if (Local_63[iVar1]->f_2.f_1 != 0)
	{
	}
	Local_63[iVar1]->f_2.f_1 = get_network_time_accurate();
	return true;
}
...
void func_410(int iParam0)
{
	...
	switch (Local_640.f_19.f_2)
	{
		case 0:
			if (Local_63[iVar1]->f_2.f_1 != 0)
			{
				Local_640.f_19.f_1 = player_ped_id();
				if (func_550())
				{
...
int func_417(int iParam0)
{
	...
	{
		iVar0 = ((func_554() - _0xe13634bb6baf0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
{
	func_242(&(Local_640.f_311[iParam0]->f_5[iParam1]->f_1), 16);
}

int func_423(int iParam0)
{
	return Local_640.f_186.f_7[iParam0]->f_4;
}

float func_424(int iParam0)
{
	return Local_640.f_186.f_7[iParam0]->f_5;
}

Vector3 func_425(int iParam0)
{
	return Local_640.f_186.f_7[iParam0]->f_6;
}
...
bool func_437(var uParam0, var uParam1)
{
	...
	set_anim_scene_origin(uParam1->f_16, Local_640.f_186.f_7[uParam1->f_1]->f_6, 0f, 0f, Local_640.f_186.f_7[uParam1->f_1]->f_5, 2);
...
{
	return (to_float(func_559(uParam0)) * 0.001f);
}

int func_443(int iParam0)
{
	return get_player_ped(func_560(iParam0));
}
...
{
	iVar0 = func_256(0);
	if (get_ped_config_flag(iVar0, 580, true) && Local_13.f_24.f_1 < 12)
	{
		func_562(12);
	}
	if (is_entity_dead(iVar0) && Local_13.f_24.f_1 < 11)
	{
		func_562(10);
	}
...
void func_450(int iParam0)
{
	...
	if (func_115() == 0)
	{
		...
		if (_0x3ab6c7b0bb0df4b1(iVar0, Local_640.f_173.f_5) && _network_has_control_of_anim_scene(Local_640.f_173.f_5))
		{
			set_anim_scene_rate(Local_640.f_173.f_5, func_572());
		}
		if (network_has_control_of_entity(iVar0))
		{
			set_ped_desired_move_blend_ratio(iVar0, func_572());
		}
	}
}
...
void func_451(int iParam0)
{
	...
	if (func_115() == 1)
	{
		...
		if (network_has_control_of_entity(iVar0))
		{
			...
			{
				_0x463803429297117c(iVar0, get_entity_coords(get_player_ped(Local_640.f_173.f_8), true, false), 3, 0);
			}
			task_follow_nav_mesh_to_coord(iVar0, func_570(), 3f, -1, 0.25f, 6299657, 40000f);
		}
		iVar2 = 1;
		while (iVar2 <= 3)
		{
...
void func_454(int iParam0)
{
	...
	if (_0x3f59fe6f37869576(iParam0->f_1, get_player_index()) && func_413(255))
	{
		if (!func_526())
		{
			func_527();
...
{
	return Local_640.f_186.f_7[iParam0]->f_10;
}
...
{
	return &(Local_640.f_311[iParam0]->f_5[iParam1]);
}
...
bool func_474(int iParam0)
{
	if (does_entity_exist(&(Local_640.f_186.f_7[iParam0])))
	{
		if (network_has_control_of_entity(&(Local_640.f_186.f_7[iParam0])))
		{
			uVar0 = &Local_640.f_186.f_7[iParam0];
...
bool func_483(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (bParam7)
	{
		if (func_592(player_id(), iVar0) || is_player_free_aiming_at_entity(player_id(), iVar0))
		{
			return true;
		}
	}
	...
	else if (func_404(Global_34, iVar0, fParam2, 1, 1) && is_tracked_ped_visible(iVar0))
	{
		bVar1 = true;
	}
	else if ((func_404(Global_34, iVar0, fParam3, 1, 1) && func_593()) && is_tracked_ped_visible(iVar0))
	{
		bVar1 = true;
	}
	if (bVar1)
	{
		if (!func_381(Local_640.f_53.f_3[iParam0]))
		{
			func_509(Local_640.f_53.f_3[iParam0], 0);
		}
		else if (func_472(Local_640.f_53.f_3[iParam0]) > fParam4)
		{
			return true;
		}
	}
	else if (func_381(Local_640.f_53.f_3[iParam0]))
	{
		func_383(Local_640.f_53.f_3[iParam0]);
	}
	return false;
}
...
bool func_486(int iParam0, var uParam1, bool bParam2)
{
	...
	{
		if (((func_404(Global_34, iParam0, _0x79b1a6e780266db0(Global_34), 1, 1) && _0x285d36c5c72b0569(Global_34) <= 0.5f) && func_597(iParam0, 0.45f, 0.55f, 0.45f, 0.55f)) && !is_entity_occluded(iParam0))
		{
			uParam1->f_33 = 4;
			return true;
		}
...
void func_488(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (bVar2)
	{
		if ((!is_ped_fleeing(iVar0) || !func_503(iVar0, 518218985)) || bParam3)
		{
	...
	{
		case 1:
			if ((!is_ped_in_combat(iVar0, 0) || !func_503(iVar0, 780511057)) || bParam3)
			{
...
bool func_489(int iParam0, int iParam1)
{
	...
	return func_241(Local_63[iParam1]->f_5, iParam0);
}
...
bool func_490(var uParam0, int iParam1)
{
	...
	{
		case 1:
			return (func_503(iParam1, 780511057) || is_ped_in_combat(iParam1, 0));
		case 0:
			return (func_503(iParam1, 518218985) || is_ped_fleeing(iParam1));
	}
	return false;
}
...
void func_495(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar2 <= 7)
	{
		iVar0 = &Local_640.f_186.f_7[iVar2];
...
void func_496(var uParam0, var uParam1)
{
	...
	{
		iVar0 = &Local_640.f_186.f_7[iVar2];
		if ((((((iVar2 != uParam1->f_1 && iVar2 != uParam1->f_2) && does_entity_exist(iVar0)) && network_has_control_of_entity(iVar0)) && !is_entity_dead(iVar0)) && !get_ped_config_flag(iVar0, 580, true)) && !func_490(uParam0, iVar0))
		{
			switch (uParam0->f_1)
			{
				case 1:
...
void func_497(var uParam0)
{
	...
	while (iVar1 <= 7)
	{
		iVar0 = &Local_640.f_186.f_7[iVar1];
		...
		{
			task_wander_in_area(iVar0, Local_640.f_186.f_7[uParam0->f_1]->f_6, uParam0->f_27, 1077936128, 1086324736, 0);
			set_ped_keep_task(iVar0, true);
			if (Local_13.f_7.f_1 == 1)
			{
...
{
	set_bit(&(Local_640.f_53.f_62), iParam0);
}

void func_499(int iParam0)
{
	if (!func_412(participant_id_to_int(), 0, 1))
	{
		return;
	}
	func_261(&(Local_63[participant_id_to_int()]->f_5), iParam0);
}
...
void func_504(int iParam0)
{
	...
	func_262(&(Local_63[participant_id_to_int()]->f_5), iParam0);
}
...
bool func_505(int iParam0, int iParam1)
{
	...
	return func_241(Local_63[iParam1]->f_1, iParam0);
}
...
void func_507(int iParam0)
{
	...
	func_262(&(Local_63[participant_id_to_int()]->f_1), iParam0);
}
...
void func_510(int iParam0)
{
	...
	func_261(&(Local_63[participant_id_to_int()]->f_1), iParam0);
}
...
bool func_515(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_547(get_entity_coords(iParam0, bParam5, false), vParam1) <= (bParam4 * bParam4))
	{
		return true;
	}
	return false;
...
void func_523(int iParam0, var uParam1, bool bParam2)
{
	...
	if ((((!is_entity_dead(iParam0) && func_522(uParam1)) && !get_ped_config_flag(iParam0, 580, true)) && network_has_control_of_entity(iParam0)) && (get_frame_count() % 10) == 0)
	{
...
void func_532(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		*uParam1 = _blip_add_for_entity(func_614(), iParam0);
		...
		set_blip_name_from_text_file(*uParam1, func_615(func_405(get_entity_model(iParam0))));
	}
}
...
void func_541(int iParam0)
{
	...
	func_261(&(Local_63[participant_id_to_int()]->f_4), iParam0);
}
...
void func_545(int iParam0)
{
	...
	func_262(&(Local_63[participant_id_to_int()]->f_4), iParam0);
}
...
{
	if (!does_entity_exist(Local_640.f_19.f_1))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < *iParam0)
	{
		if (is_bit_set(Local_640.f_19, iVar0))
		{
...
void func_552()
{
	...
	iVar5 = func_256(0);
	bVar6 = network_has_control_of_entity(iVar5);
	func_619(iVar5);
	func_620();
	func_621();
	func_622();
	...
	switch (Local_13.f_24.f_1)
	{
		...
		case 1:
			...
			{
				task_wander_in_area(iVar5, get_entity_coords(iVar5, true, false), 5f, 1077936128, 1086324736, 0);
			}
			break;
		case 2:
			if (((bVar6 && !func_407(2)) && !func_503(iVar5, 713668775)) && func_442(&(Local_13.f_24.f_2)) < 3f)
			{
				task_follow_nav_mesh_to_coord(iVar5, func_626(), func_572(), -1, 0.25f, 0, 40000f);
			}
			if (!func_564(64))
			{
				if (!get_ped_config_flag(iVar5, 580, true))
				{
					if (func_407(2) || func_515(iVar5, func_626(), 3f, 1, 1))
					{
						if (_network_has_control_of_anim_scene(Local_640.f_173.f_5) && func_628(get_entity_coords(iVar5, true, false), func_627()))
						{
							func_629(64);
						}
					}
		...
		case 3:
			...
			if (bVar6 && func_632(iVar5, 1069547520, 0))
			{
			}
			break;
		case 4:
			...
			if (((!func_564(8) && func_571(&(Local_13.f_24.f_2)) > 8f) && bVar6) && func_633())
			{
				if (func_407(2))
				{
					_task_smart_flee_style_ped(iVar5, get_player_ped(Local_640.f_173.f_8), 3, 67108864, -1082130432, -1, 0);
				}
				else
				{
					task_follow_nav_mesh_to_coord(iVar5, func_626(), func_572(), -1, 0.25f, 0, 40000f);
		...
		case 6:
			if (bVar4)
			{
				if (!start_audio_scene("DLC_MP007_Leg_Beav_Event_Chew_scene"))
				{
				}
			}
			if (bVar6)
			{
				if (!func_503(iVar5, -1098463898))
				{
					...
					if (bVar7)
					{
						iVar8 = _find_closest_active_scenario_point_of_type(vVar0, -1910512666, 0.5f, 0, false);
						if (_does_scenario_point_exist(iVar8))
						{
							vVar0 = { _get_scenario_point_coords(iVar8, true) };
							fVar3 = _get_scenario_point_heading(iVar8, true);
						}
					}
					task_start_scenario_at_position(iVar5, -1910512666, vVar0, fVar3, 0, false, true, 0, -1f, false);
				}
				else
				{
					func_629(256);
		...
		case 8:
			...
			if (bVar6)
			{
				...
				{
					if (is_ped_using_any_scenario(iVar5))
					{
						_0xeeed8fafec331a70(iVar5, get_entity_coords(get_player_ped(Local_640.f_173.f_8), true, false), 3);
					}
					task_follow_waypoint_recording(iVar5, func_118(), 0, 27656, -1, 0, 0, -1);
				}
			}
			break;
		case 9:
			if ((!func_564(64) && _network_has_control_of_anim_scene(Local_640.f_173.f_5)) && func_628(get_entity_coords(iVar5, true, false), func_627()))
			{
				func_629(64);
			}
		...
		case 10:
			...
			if (bVar6 && !is_entity_dead(iVar5))
			{
				if (!func_503(iVar5, 518218985))
				{
					_task_smart_flee_style_ped(iVar5, get_player_ped(Local_640.f_173.f_8), 3, 0, -1082130432, -1, 0);
				}
				if (func_442(&(Local_13.f_24.f_2)) > 45f)
				{
					set_ped_max_move_blend_ratio(iVar5, 2f);
				}
			}
			break;
		case 12:
			if (get_ped_config_flag(iVar5, 580, true) && !is_ped_fleeing(iVar5))
			{
				_task_smart_flee_style_ped(iVar5, func_635(iVar5), 3, 0, -1082130432, -1, 0);
			}
			func_636(iVar5, 1);
			break;
	}
...
{
	return func_640(get_entity_coords(iParam0, true, false), 1203982208, 1, 1);
}
...
var func_561(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = _create_volume_cylinder_with_custom_name(vParam0, vParam3, vParam6, func_642());
				break;
			case -432403087:
				iVar8 = _create_volume_sphere_with_custom_name(vParam0, vParam3, vParam6, func_642());
				break;
			case -1612834106:
				iVar8 = _create_volume_box_with_custom_name(vParam0, vParam3, vParam6, func_642());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_643(get_player_team(iVar5)));
	}
...
Vector3 func_563(vector3 vParam0)
{
	...
	{
		case 5:
			*vVar3[0] = { 2448.226f, 553.928f, 66.09f };
			*vVar3[1] = { 2405.875f, 579.4902f, 66.09f };
			*vVar3[2] = { 2397.45f, 582.4436f, 66.09f };
			*vVar3[3] = { 2436.396f, 565.3154f, 66.9758f };
			*vVar3[4] = { 2423.566f, 557.0493f, 66.325f };
			*vVar3[5] = { 2417.013f, 572.5357f, 66.4459f };
			*vVar3[6] = { 2405.802f, 571.2469f, 66.3501f };
			*vVar3[7] = { 2399.464f, 594.1443f, 66.4332f };
			*vVar3[8] = { 2458.75f, 549.3206f, 66.4149f };
			*vVar3[9] = { 2454.482f, 540.7951f, 66.5154f };
			*vVar3[10] = { 2388.843f, 612.4101f, 66.9082f };
			*vVar3[11] = { 2393.639f, 636.9825f, 66.3028f };
			*vVar3[12] = { 2379.371f, 649.1469f, 66.437f };
			*vVar3[13] = { 2396.942f, 657.5465f, 66.148f };
			break;
		case 6:
			*vVar3[0] = { 2269.086f, 246.5402f, 43.6415f };
			*vVar3[1] = { 2290.032f, 233.1136f, 43.6296f };
			*vVar3[2] = { 2307.678f, 227.3275f, 43.5611f };
			*vVar3[3] = { 2298.581f, 244.8045f, 43.5391f };
			*vVar3[4] = { 2278.559f, 262.9825f, 43.5704f };
			*vVar3[5] = { 2269.502f, 280.6956f, 43.565f };
			*vVar3[6] = { 2246.879f, 281.0435f, 43.6619f };
			*vVar3[7] = { 2260.029f, 269.8175f, 43.6423f };
			*vVar3[8] = { 2293.865f, 221.8443f, 43.789f };
			*vVar3[9] = { 2315.018f, 234.8486f, 43.6802f };
			*vVar3[10] = { 2304.44f, 240.3391f, 43.6297f };
			*vVar3[11] = { 2269.086f, 246.5402f, 43.6415f };
			*vVar3[12] = { 2269.086f, 246.5402f, 43.6415f };
			*vVar3[13] = { 2269.086f, 246.5402f, 43.6415f };
			break;
		case 7:
			*vVar3[0] = { 2336.061f, 895.5226f, 72.6033f };
			*vVar3[1] = { 2336.429f, 909.5871f, 72.4671f };
			*vVar3[2] = { 2352.156f, 911.7427f, 72.6241f };
			*vVar3[3] = { 2374.058f, 910.8492f, 72.6276f };
			*vVar3[4] = { 2383.966f, 915.916f, 72.597f };
			*vVar3[5] = { 2399.135f, 916.9211f, 72.622f };
			*vVar3[6] = { 2400.476f, 910.9594f, 72.6115f };
			*vVar3[7] = { 2408.721f, 912.1439f, 72.6998f };
			*vVar3[8] = { 2419.699f, 908.816f, 72.6805f };
			*vVar3[9] = { 2431.15f, 913.2443f, 72.6392f };
			*vVar3[10] = { 2442.831f, 910.0598f, 72.6474f };
			*vVar3[11] = { 2452.621f, 917.3195f, 72.6166f };
			*vVar3[12] = { 2455.711f, 923.9888f, 72.7492f };
			*vVar3[13] = { 2451.96f, 934.7285f, 72.5998f };
			break;
		default:
			return 0f, 0f, 0f;
	}
	...
	{
		vVar0 = { get_entity_coords(get_player_ped(Local_640.f_173.f_8), true, false) };
	}
	else if (Local_640.f_173.f_7 != 255)
	{
		vVar0 = { get_entity_coords(get_player_ped(Local_640.f_173.f_7), true, false) };
	}
	else
	{
		vVar0 = { get_entity_coords(func_647(vParam0), true, false) };
	}
	vVar47 = { func_349(vVar0 - vParam0) };
	iVar46 = 0;
	while (iVar46 <= 13)
	{
		if ((func_648(vParam0, *vVar3[iVar46], 30f, 1) || !func_648(vParam0, *vVar3[iVar46], 80f, 1)) || iVar46 == Local_640.f_173.f_6)
		{
		}
		else
		{
			fVar55 = vdist2(*vVar3[iVar46], vParam0);
			if (fVar55 < fVar54)
			{
				fVar54 = fVar55;
				iVar53 = iVar46;
			}
			vVar50 = { func_349(*vVar3[iVar46] - vParam0) };
...
bool func_566(var uParam0, var uParam1, int iParam2)
{
	...
	{
		case 5:
			*vVar0[0] = { 2401.643f, 589.0543f, 64.4702f };
			*vVar0[1] = { 2397.292f, 582.7505f, 63.6331f };
			*vVar0[2] = { 2392.488f, 617.6112f, 64.8442f };
			*vVar0[3] = { 2457.879f, 549.8177f, 64.2408f };
			*vVar0[4] = { 2434.69f, 554.0707f, 63.8013f };
			*vVar0[5] = { 2409.164f, 696.7398f, 63.8978f };
			*vVar0[6] = { 2427.733f, 570.5942f, 64.6635f };
			*vVar0[7] = { 2409.233f, 567.8948f, 64.2056f };
			*vVar0[8] = { 2406.356f, 579.4111f, 64.3457f };
			*vVar0[9] = { 2447.459f, 546.5974f, 63.6034f };
			fVar31[0] = 0f;
			fVar31[1] = 0f;
			fVar31[2] = 0f;
			fVar31[3] = 0f;
			...
			break;
		case 6:
			*vVar0[0] = { 2269.086f, 246.5402f, 42.6415f };
			*vVar0[1] = { 2290.032f, 233.1136f, 42.6296f };
			*vVar0[2] = { 2307.678f, 227.3275f, 42.5611f };
			*vVar0[3] = { 2298.581f, 244.8045f, 42.5391f };
			*vVar0[4] = { 2278.559f, 262.9825f, 42.5704f };
			*vVar0[5] = { 2269.502f, 280.6956f, 42.565f };
			*vVar0[6] = { 2246.879f, 281.0435f, 42.6619f };
			*vVar0[7] = { 2260.029f, 269.8175f, 42.6423f };
			*vVar0[8] = { 2293.865f, 221.8443f, 42.789f };
			*vVar0[9] = { 2315.018f, 234.8486f, 42.6802f };
			fVar31[0] = 0f;
			fVar31[1] = 0f;
			fVar31[2] = 0f;
			fVar31[3] = 0f;
			...
			break;
		case 7:
			*vVar0[0] = { 2336.061f, 895.5226f, 71.6033f };
			*vVar0[1] = { 2352.156f, 911.7427f, 71.6241f };
			*vVar0[2] = { 2374.058f, 910.8492f, 71.6276f };
			*vVar0[3] = { 2383.966f, 915.916f, 71.597f };
			*vVar0[4] = { 2399.135f, 916.9211f, 71.622f };
			*vVar0[5] = { 2408.721f, 912.1439f, 71.6998f };
			*vVar0[6] = { 2419.699f, 908.816f, 71.6805f };
			*vVar0[7] = { 2431.15f, 913.2443f, 71.6392f };
			*vVar0[8] = { 2442.831f, 910.0598f, 71.6474f };
			*vVar0[9] = { 2451.96f, 934.7285f, 71.5998f };
			fVar31[0] = 0f;
			fVar31[1] = 0f;
			fVar31[2] = 0f;
			fVar31[3] = 0f;
	...
	Var42.f_17 = -2;
	Var42.f_18 = -1;
	Var42 = { get_entity_coords(iParam2, true, false) };
	Var42.f_7 = 40f;
	Var42.f_9 = 60f;
	func_650(&Var42);
	if (func_407(2))
	...
	{
		*uParam0 = { *vVar0[Var42.f_18] };
		*uParam1 = &fVar31[Var42.f_18];
		if (func_407(2))
		{
			*uParam1 = func_652(get_entity_coords(get_player_ped(Local_640.f_173.f_8), true, false), *uParam0, 1);
		}
		return true;
	}
	return false;
...
Vector3 func_570()
{
	if (!waypoint_recording_get_num_points(func_118(), &iVar0))
	{
		return 0f, 0f, 0f;
	}
	else if (!waypoint_recording_get_coord(func_118(), (iVar0 - 1), &vVar1))
	{
	}
	else
	{
...
void func_573(int iParam0, bool bParam1)
{
	...
	bVar1 = false;
	if (((is_entity_dead(func_256(0)) || get_ped_config_flag(func_256(0), 580, true)) || !func_404(iVar0, get_player_ped(Local_640.f_173.f_8), 70f, 1, 1)) || func_466(iParam0))
	{
		bVar1 = true;
	}
	if (!func_653(iParam0))
	...
	else if (bVar1)
	{
		...
		{
			_task_smart_flee_style_ped(iVar0, get_player_ped(Local_640.f_173.f_8), 3, 67108864, -1082130432, -1, 0);
			set_ped_keep_task(iVar0, true);
			set_blocking_of_non_temporary_events(iVar0, false);
		}
	}
	else if ((get_frame_count() % 120) == 0 && !is_ped_in_combat(iVar0, 0))
	{
		func_656(iVar0);
	}
}
...
{
	_0xd9130842d7226045(func_657(iParam0), 0);
}
...
void func_590(var uParam0, var uParam1)
{
	...
	bVar0 = false;
	if (does_entity_exist(*uParam1) && func_659(*uParam1, Global_35, 1) < 300f)
	{
		bVar0 = true;
	}
	bVar1 = false;
...
{
	switch (func_582(func_405(get_entity_model(iParam0))))
	{
		case -1630294353:
			return 5f;
		case -1754709769:
...
bool func_596(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1940258->f_6 && !is_entity_dead(iParam0))
	{
		...
		if (Global_1940258->f_20 && func_683(player_id(), 0, 1, uParam2->f_2 & 524288 == 0))
		{
...
bool func_597(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(iParam0))
	{
		if (func_698(get_entity_coords(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
Vector3 func_603(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_700(vVar0, get_random_float_in_range(0f, fParam3)) };
...
{
	Var0 = { func_375(iParam0, -1797584255) };
...
void func_606(int iParam0, int iParam1)
{
	...
	Var31 = { func_375(iParam0, 1346578557) };
...
{
	if (func_127(Global_1272030[iParam0]))
	{
		return;
	}
	...
	func_128((*Global_1272030)[iParam0]);
	iVar33 = Var2.f_5;
	if (iVar33 != 0)
	{
		Var34 = { func_704(153786159) };
		stat_id_set_int(&Var34, iVar33, true);
		Var34 = { func_704(217123284) };
		stat_id_set_int(&Var34, Global_1296859->f_21, true);
	}
	iVar36 = Var2.f_9;
	if (iVar36 != 0)
	{
		Var37 = { func_704(945205875) };
		stat_id_set_int(&Var37, iVar36, true);
		Var37 = { func_704(890183498) };
...
{
	Var0.f_10 = 255;
	_copy_memory(&(Var0.f_4), &Local_640, 5);
	Var0.f_9 = iParam0;
	Var0 = 182;
	Var0.f_1 = player_id();
	Var0.f_2 = get_network_time_accurate();
...
void func_620()
{
	...
	while (iVar1 <= 3)
	{
		...
		{
			task_wander_in_area(iVar0, get_entity_coords(iVar0, true, false), 15f, 1077936128, 1086324736, 0);
		}
		iVar1++;
	}
	...
	{
		iVar0 = func_256(iVar1);
		if (!does_entity_exist(iVar0) || func_529(iVar0))
		{
		}
		else
		{
...
void func_621()
{
	if (!func_407(1) && func_483(0, 10f, 30f, 80f, 1065353216, 5, 0, 1))
	{
		func_711();
	}
}
...
void func_623()
{
	if ((Local_13.f_24.f_13 == 255 && !func_407(64)) || (Local_13.f_24.f_13 != 255 && Local_13.f_24.f_13 != player_id()))
	{
		if (is_entity_dead(func_256(0)) && _0xef2d9ed7ce684f08(func_256(0)) == Global_34)
		{
			func_713();
			func_408(64);
		}
...
void func_624()
{
	...
	if (func_407(16) && !is_entity_in_water(iVar0))
	{
		func_714(0);
	}
	else if (!func_407(16) && is_entity_in_water(iVar0))
	{
		func_714(1);
	}
}
...
{
	iVar0 = func_369(0);
	if ((Local_13.f_24.f_1 >= 3 && does_entity_exist(iVar0)) && network_has_control_of_entity(iVar0))
	{
		if ((!_does_anim_scene_exist(Local_640.f_173.f_5) || _is_anim_scene_finished(Local_640.f_173.f_5, false)) || _is_anim_scene_active(Local_640.f_173.f_5))
		{
			delete_object(&iVar0);
		}
	}
...
Vector3 func_627()
{
	return 0f, 0f, get_entity_heading(func_256(0));
}

bool func_628(vector3 vParam0, vector3 vParam3)
{
	if (_is_anim_scene_started(Local_640.f_173.f_5, false))
	{
		return true;
	}
	if (!_network_has_control_of_anim_scene(Local_640.f_173.f_5))
	{
		return false;
	}
	set_anim_scene_entity(Local_640.f_173.f_5, "beaver", func_256(0), 0);
	set_anim_scene_origin(Local_640.f_173.f_5, vParam0, vParam3, 2);
	start_anim_scene(Local_640.f_173.f_5);
	return true;
}

void func_629(int iParam0)
{
	func_261(&(Local_63[Local_640.f_173.f_3]->f_6), iParam0);
}
...
bool func_630(int iParam0, int iParam1)
{
	...
	return func_241(Local_63[iParam1]->f_6, iParam0);
}

void func_631(int iParam0)
{
	func_262(&(Local_63[Local_640.f_173.f_3]->f_6), iParam0);
}
...
bool func_632(int iParam0, float fParam1, bool bParam2)
{
	...
	{
		if ((_is_anim_scene_finished(Local_640.f_173.f_5, false) && !is_entity_dead(iParam0)) && !get_ped_config_flag(iParam0, 580, false))
		{
			set_entity_coords(iParam0, get_entity_coords(iParam0, true, false) + Vector(-fParam1, 0f, 0f), true, false, true, true);
			freeze_entity_position(iParam0, true);
			func_629(4);
			return true;
		}
...
bool func_633()
{
	...
	_set_entity_coords_and_heading(iVar4, vVar0, fVar3, true, false, true);
	return true;
}
...
void func_634(bool bParam0, bool bParam1)
{
	...
	if (bParam1 && _does_anim_scene_exist(Local_640.f_173.f_5))
	{
		_delete_anim_scene(Local_640.f_173.f_5);
	}
	func_629(16);
}
...
{
	return get_player_ped(func_717(iParam0));
}

void func_636(int iParam0, bool bParam1)
{
	if ((!func_718(1) && bParam1) && get_animal_tuning_float_param(iParam0, 74) > 0f)
	{
	...
	if (network_has_control_of_entity(iParam0))
	{
		if (!func_718(1))
		{
			...
			{
				_task_smart_flee_style_ped(iParam0, func_635(iParam0), 3, 67117056, 9999f, -1, 0);
	...
	while (iVar0 <= 31)
	{
		...
		else
		{
			...
			else
			{
				...
				if (bParam5)
				{
					if (((_is_ped_hogtied(iVar6) || _0x833f0053340ef413(iVar6)) || func_505(4, iVar1)) || is_ped_in_any_vehicle(iVar6, false))
					{
					}
					else
					{
...
{
	return get_player_ped(func_640(vParam0, 1203982208, 1, 0));
}
...
bool func_651(var uParam0, var uParam1)
{
	...
	while (iVar0 <= (iVar2 - 1))
	{
		...
		{
			if (func_648(*uParam0, *(*uParam1)[iVar0], uParam0->f_8, 1) || !func_648(*uParam0, *(*uParam1)[iVar0], uParam0->f_9, 1))
			{
				iVar3[iVar0] = (uParam0->f_11 - 1);
			}
			else if (func_725(uParam0, 2))
			{
				if (!func_726(*(*uParam1)[iVar0], 1f, uParam0->f_10))
				{
				...
				else
				{
					if (func_725(uParam0, 1))
					{
						if (!func_648(*uParam0, *(*uParam1)[iVar0], uParam0->f_6, 1))
						{
							iVar3[iVar0] = (&iVar3[iVar0] + uParam0->f_13);
						}
						if (func_648(*uParam0, *(*uParam1)[iVar0], uParam0->f_7, 1))
						{
					...
					{
						if (func_727(uParam0->f_3, 0f, 0f, 0f, 1056964608, 1))
						{
						}
...
{
	return does_blip_exist(Local_640.f_186.f_7[iParam0]->f_1);
}
...
void func_654(int iParam0)
{
	if (!func_653(iParam0))
	{
		func_729(iParam0, 831283580, 0, 0, 0);
	}
}
...
{
	task_combat_ped(iParam0, get_player_ped(Local_640.f_173.f_8), 0, 0);
	set_animal_tuning_float_param(iParam0, 74, 1f);
	set_ped_keep_task(iParam0, true);
	set_blocking_of_non_temporary_events(iParam0, false);
}
...
{
	switch (func_405(get_entity_model(iParam0)))
	{
		case 0:
			return "LEGENDARY_ALLIGATOR_CALL_SOUNDS";
		case 1:
...
void func_663(int iParam0)
{
	...
	_play_sound_from_position(func_733(iParam0), vVar0, func_657(iParam0), false, 0, true, 0);
}
...
bool func_677(int iParam0, var uParam1)
{
	...
	{
		fVar1 = -1f;
		fVar2 = func_748(_0x2ba9d7bf629f920c(iParam0), (fVar0 + 5f));
...
bool func_681(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_759(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_756(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_3 != 0)
			{
				if (get_game_timer() - uParam2->f_3) > func_757(uParam2)
				{
					func_743(uParam2, 1);
					return true;
				}
...
bool func_682(int iParam0, var uParam1)
{
	...
	if (func_751(iParam0, uParam1, iVar1))
	{
		...
		else if (get_game_timer() - uParam1->f_4) > func_757(uParam1)
		{
...
bool func_690(var uParam0, int iParam1)
{
	...
	if (func_772(iVar0, iParam1, 1060437492) != 0)
	{
		return false;
	}
...
int func_696(int iParam0, var uParam1)
{
	...
	{
		return func_781(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_702(int iParam0)
{
	...
	Var1 = { func_375(iParam0, 1178968787) };
...
bool func_709()
{
	...
	{
		iVar1 = func_256(iVar0);
		if (does_entity_exist(iVar1) && func_529(iVar1))
		{
			iVar2 = 0;
		}
		iVar0++;
...
int func_710()
{
	...
	{
		iVar1 = func_256(iVar0);
		if ((!does_entity_exist(iVar1) || !network_has_control_of_entity(iVar1)) || !func_529(iVar1))
		{
		}
		else
		{
			Var7 = 52;
			Var7.f_1 = { get_entity_coords(get_player_ped(Local_640.f_173.f_8), true, false) };
			...
			{
				set_entity_coords(iVar1, vVar3, true, false, true, true);
				func_784(iVar1);
				set_ped_desired_move_blend_ratio(iVar1, 3f);
				task_combat_ped(iVar1, get_player_ped(Local_640.f_173.f_8), 0, 0);
...
bool func_712()
{
	if (_does_anim_scene_exist(Local_640.f_173.f_5) && _is_anim_scene_started(Local_640.f_173.f_5, false))
	{
		return _get_anim_scene_time(Local_640.f_173.f_5) > 1f;
	}
...
{
	return func_640(get_entity_coords(iParam0, true, false), 1203982208, 1, 0);
}
...
bool func_720(int iParam0, int iParam1)
{
	...
	{
		return func_785(&((*Global_1100469)[iParam1]->f_4), iVar0, 5);
	}
	return false;
}
...
{
	if (func_515(Global_34, vParam0, fParam4, 1, 1) && is_sphere_visible(vParam0, fParam3))
	{
		return true;
	}
	iVar0 = 0;
...
void func_729(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4)
{
	...
	iVar0 = _blip_add_for_entity(iParam1, &(Local_640.f_186.f_7[iParam0]));
	if (iParam2 != 0)
	{
	...
	Local_640.f_186.f_7[iParam0]->f_1 = iVar0;
}
...
bool func_740(int iParam0, int iParam1)
{
	...
	if (!_is_weapon_lasso(func_800(iParam0, 1, 0, 0)) && !func_800(iParam0, 1, 0, 0) == 1151374672)
	{
		return false;
	}
...
bool func_754(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((_0xcb690f680a3ea971(iVar0, 1) && is_player_targetting_entity(iVar1, iParam0, bParam5)) && is_player_free_aiming_at_entity(iVar1, iParam0)) && func_476(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (_is_weapon_sniper(func_805(iVar0, 0)))
		{
...
bool func_759(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (is_player_free_aiming(iVar1))
	{
		if (_is_weapon_sniper(func_805(iVar0, 0)))
		{
			if (func_698(get_entity_coords(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
int func_774(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_476(iParam0, player_ped_id(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_813(var uParam0)
{
	...
	while (iVar0 <= 4)
	{
		if (!func_829(&((*Global_1275441)[iVar0]->f_1), uParam0))
		{
		}
		else
		{
